...
A Bazel macro will be created to centralize the usage of Jest unit testing. The macro will, at minimum, accept a Jest configuration file, add the [Jest preset](https://github.com/elastic/kibana/blob/main/src/ops/kbn-test/jest-preset.js) and its dependencies as sources, then use the Jest CLI to execute tests. 

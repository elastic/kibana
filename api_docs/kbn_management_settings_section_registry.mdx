...
### Classes
<DocDefinitionList data={kbnManagementSettingsSectionRegistryObj.client.classes}/>

### Interfaces
<DocDefinitionList data={kbnManagementSettingsSectionRegistryObj.client.interfaces}/>

### Consts, variables and types
<DocDefinitionList data={kbnManagementSettingsSectionRegistryObj.client.misc}/>

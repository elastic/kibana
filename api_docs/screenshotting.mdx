...
---
import screenshottingObj from './screenshotting.json';
...
### Start
<DocDefinitionList data={[screenshottingObj.client.start]}/>

### Objects
<DocDefinitionList data={screenshottingObj.client.objects}/>

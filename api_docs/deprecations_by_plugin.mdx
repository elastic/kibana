...
| <DocLink id="kibDataPluginApi" section="def-public.DataPublicPluginStart.fieldFormats" text="fieldFormats"/> | [ranges.tsx](https://github.com/elastic/kibana/tree/master/x-pack/plugins/lens/public/indexpattern_datasource/operations/definitions/ranges/ranges.tsx#:~:text=fieldFormats) | - |
...
| <DocLink id="kibCorePluginApi" section="def-public.IHttpFetchError.req" text="req"/> | [fetch_effect.test.ts](https://github.com/elastic/kibana/tree/master/x-pack/plugins/synthetics/public/legacy_uptime/state/effects/fetch_effect.test.ts#:~:text=req), [fetch_effect.test.ts](https://github.com/elastic/kibana/tree/master/x-pack/plugins/synthetics/public/legacy_uptime/state/effects/fetch_effect.test.ts#:~:text=req) | 8.8.0

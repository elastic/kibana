...
####
id: kibKbnCoreUserProfileBrowserMocksPluginApi
slug: /kibana-dev-docs/api/kbn-core-user-profile-browser-mocks
...
### Objects
<DocDefinitionList data={kbnCoreUserProfileBrowserMocksObj.client.objects}/>

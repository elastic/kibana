...
####
id: kibKbnCoreCustomBrandingServerMocksPluginApi
slug: /kibana-dev-docs/api/kbn-core-custom-branding-server-mocks
...
### Objects
<DocDefinitionList data={kbnCoreCustomBrandingServerMocksObj.common.objects}/>

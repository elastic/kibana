...
### Interfaces
<DocDefinitionList data={kbnCoreElasticsearchClientServerInternalObj.server.interfaces}/>

### Consts, variables and types
<DocDefinitionList data={kbnCoreElasticsearchClientServerInternalObj.server.misc}/>

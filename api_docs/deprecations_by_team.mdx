...
| Plugin | Deprecated API | Reference location(s) | Remove By |
| --------|-------|-----------|-----------|
| guidedOnboarding | <DocLink id="kibFeaturesPluginApi" section="def-public.FeatureKibanaPrivileges.disabled" text="disabled"/> | [feature.ts](https://github.com/elastic/kibana/tree/main/src/plugins/guided_onboarding/server/feature.ts#:~:text=disabled) | 8.8.0 |
| guidedOnboarding | <DocLink id="kibFeaturesPluginApi" section="def-common.FeatureKibanaPrivileges.disabled" text="disabled"/> | [feature.ts](https://github.com/elastic/kibana/tree/main/src/plugins/guided_onboarding/server/feature.ts#:~:text=disabled) | 8.8.0 |
| guidedOnboarding | <DocLink id="kibFeaturesPluginApi" section="def-server.FeatureKibanaPrivileges.disabled" text="disabled"/> | [feature.ts](https://github.com/elastic/kibana/tree/main/src/plugins/guided_onboarding/server/feature.ts#:~:text=disabled) | 8.8.0 |

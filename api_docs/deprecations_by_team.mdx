...
| Plugin | Deprecated API | Reference location(s) | Remove By |
| --------|-------|-----------|-----------|
| workflowsManagement | <DocLink id="kibKbnLicensingTypesPluginApi" section="def-common.PublicLicense.mode" text="mode"/> | [availability_updater.test.ts](https://github.com/elastic/kibana/tree/main/src/platform/plugins/shared/workflows_management/server/availability/availability_updater.test.ts#:~:text=mode), [availability_updater.test.ts](https://github.com/elastic/kibana/tree/main/src/platform/plugins/shared/workflows_management/server/availability/availability_updater.test.ts#:~:text=mode), [availability_updater.test.ts](https://github.com/elastic/kibana/tree/main/src/platform/plugins/shared/workflows_management/server/availability/availability_updater.test.ts#:~:text=mode), [with_license_check.test.ts](https://github.com/elastic/kibana/tree/main/src/platform/plugins/shared/workflows_management/server/api/routes/utils/with_license_check.test.ts#:~:text=mode), [with_license_check.test.ts](https://github.com/elastic/kibana/tree/main/src/platform/plugins/shared/workflows_management/server/api/routes/utils/with_license_check.test.ts#:~:text=mode) | 8.8.0 |
...
####
id: kibKbnCoreSavedObjectsImportExportServerMocksPluginApi
slug: /kibana-dev-docs/api/kbn-core-saved-objects-import-export-server-mocks
...
### Objects
<DocDefinitionList data={kbnCoreSavedObjectsImportExportServerMocksObj.server.objects}/>

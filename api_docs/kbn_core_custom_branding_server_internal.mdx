...
####
id: kibKbnCoreCustomBrandingServerInternalPluginApi
slug: /kibana-dev-docs/api/kbn-core-custom-branding-server-internal
...
### Classes
<DocDefinitionList data={kbnCoreCustomBrandingServerInternalObj.server.classes}/>

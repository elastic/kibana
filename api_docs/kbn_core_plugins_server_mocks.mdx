...
####
id: kibKbnCorePluginsServerMocksPluginApi
slug: /kibana-dev-docs/api/kbn-core-plugins-server-mocks
...
### Objects
<DocDefinitionList data={kbnCorePluginsServerMocksObj.common.objects}/>

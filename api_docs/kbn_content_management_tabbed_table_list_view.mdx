...
####
id: kibKbnContentManagementTabbedTableListViewPluginApi
slug: /kibana-dev-docs/api/kbn-content-management-tabbed-table-list-view
...
### Functions
<DocDefinitionList data={kbnContentManagementTabbedTableListViewObj.client.functions}/>

### Interfaces
<DocDefinitionList data={kbnContentManagementTabbedTableListViewObj.client.interfaces}/>

### Consts, variables and types
<DocDefinitionList data={kbnContentManagementTabbedTableListViewObj.client.misc}/>

...
### Functions
<DocDefinitionList data={kbnSharedUxPromptNoDataViewsMocksObj.server.functions}/>

### Classes
<DocDefinitionList data={kbnSharedUxPromptNoDataViewsMocksObj.server.classes}/>

### Consts, variables and types
<DocDefinitionList data={kbnSharedUxPromptNoDataViewsMocksObj.server.misc}/>

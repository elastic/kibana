...
### Functions
<DocDefinitionList data={kbnSharedUxButtonExitFullScreenMocksObj.server.functions}/>

### Classes
<DocDefinitionList data={kbnSharedUxButtonExitFullScreenMocksObj.server.classes}/>

### Consts, variables and types
<DocDefinitionList data={kbnSharedUxButtonExitFullScreenMocksObj.server.misc}/>

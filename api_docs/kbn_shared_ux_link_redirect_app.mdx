...
### Functions
<DocDefinitionList data={kbnSharedUxLinkRedirectAppObj.client.functions}/>

### Interfaces
<DocDefinitionList data={kbnSharedUxLinkRedirectAppObj.client.interfaces}/>

### Consts, variables and types
<DocDefinitionList data={kbnSharedUxLinkRedirectAppObj.client.misc}/>

...
| <DocLink id="kibApmPluginApi" text="apm"/> | [APM UI](https://github.com/orgs/elastic/teams/apm-ui) | The user interface for Elastic APM | 40 | 0 | 40 | 52 |
...
| <DocLink id="kibCorePluginApi" text="core"/> | [Kibana Core](https://github.com/orgs/elastic/teams/kibana-core) | - | 2524 | 15 | 956 | 33 |
...
| <DocLink id="kibFieldFormatsPluginApi" text="fieldFormats"/> | [App Services](https://github.com/orgs/elastic/teams/kibana-app-services) | Index pattern fields and ambiguous values formatters | 294 | 5 | 255 | 3 |
...
| <DocLink id="kibObservabilityPluginApi" text="observability"/> | [Observability UI](https://github.com/orgs/elastic/teams/observability-ui) | - | 382 | 2 | 379 | 30 |
...
| <DocLink id="kibSecurityPluginApi" text="security"/> | [Platform Security](https://github.com/orgs/elastic/teams/kibana-security) | This plugin provides authentication and authorization features, and exposes functionality to understand the capabilities of the currently authenticated user. | 179 | 0 | 99 | 0 |
...
| <DocLink id="kibTriggersActionsUiPluginApi" text="triggersActionsUi"/> | [Response Ops](https://github.com/orgs/elastic/teams/response-ops) | - | 383 | 0 | 369 | 33 |
...
| <DocLink id="kibKbnCoreBaseCommonPluginApi" text="@kbn/core-base-common"/> | [Owner missing] | - | 11 | 0 | 2 | 0 |
...
| <DocLink id="kibKbnEsQueryPluginApi" text="@kbn/es-query"/> | [Owner missing] | - | 222 | 1 | 168 | 11 |
...
| <DocLink id="kibKbnSharedUxComponentsPluginApi" text="@kbn/shared-ux-components"/> | [Owner missing] | - | 17 | 0 | 12 | 3 |
| <DocLink id="kibKbnSharedUxPageAnalyticsNoDataPluginApi" text="@kbn/shared-ux-page-analytics-no-data"/> | [Owner missing] | - | 6 | 0 | 3 | 3 |
| <DocLink id="kibKbnSharedUxPromptNoDataViewsPluginApi" text="@kbn/shared-ux-prompt-no-data-views"/> | [Owner missing] | - | 16 | 0 | 7 | 1 |

...
| <DocLink id="kibCorePluginApi" text="core"/> | [Kibana Core](https://github.com/orgs/elastic/teams/kibana-core) | - | 2529 | 15 | 977 | 33 |
...
| <DocLink id="kibEmbeddablePluginApi" text="embeddable"/> | [App Services](https://github.com/orgs/elastic/teams/kibana-app-services) | Adds embeddables service to Kibana | 478 | 0 | 388 | 4 |
...
| <DocLink id="kibEventLogPluginApi" text="eventLog"/> | [Response Ops](https://github.com/orgs/elastic/teams/response-ops) | - | 99 | 0 | 99 | 9 |
...
| <DocLink id="kibExpressionXYPluginApi" text="expressionXY"/> | [Vis Editors](https://github.com/orgs/elastic/teams/kibana-vis-editors) | Expression XY plugin adds a `xy` renderer and function to the expression plugin. The renderer will display the `xy` chart. | 137 | 0 | 127 | 13 |
| <DocLink id="kibExpressionsPluginApi" text="expressions"/> | [App Services](https://github.com/orgs/elastic/teams/kibana-app-services) | Adds expression runtime to Kibana | 2166 | 17 | 1718 | 5 |
...
| <DocLink id="kibFleetPluginApi" text="fleet"/> | [Fleet](https://github.com/orgs/elastic/teams/fleet) | - | 1393 | 8 | 1274 | 10 |
...
| <DocLink id="kibMapsPluginApi" text="maps"/> | [GIS](https://github.com/orgs/elastic/teams/kibana-gis) | - | 225 | 0 | 224 | 25 |
| <DocLink id="kibMapsEmsPluginApi" text="mapsEms"/> | [GIS](https://github.com/orgs/elastic/teams/kibana-gis) | - | 67 | 0 | 67 | 0 |
| <DocLink id="kibMlPluginApi" text="ml"/> | [Machine Learning UI](https://github.com/orgs/elastic/teams/ml-ui) | This plugin provides access to the machine learning features provided by Elastic. | 198 | 8 | 79 | 30 |
...
| <DocLink id="kibTriggersActionsUiPluginApi" text="triggersActionsUi"/> | [Response Ops](https://github.com/orgs/elastic/teams/response-ops) | - | 330 | 0 | 316 | 27 |
...
| <DocLink id="kibKbnAnalyticsShippersElasticV3BrowserPluginApi" text="@kbn/analytics-shippers-elastic-v3-browser"/> | [Owner missing] | - | 13 | 1 | 13 | 0 |
...
| <DocLink id="kibKbnAnalyticsShippersElasticV3ServerPluginApi" text="@kbn/analytics-shippers-elastic-v3-server"/> | [Owner missing] | - | 13 | 1 | 13 | 0 |
...
| <DocLink id="kibKbnOptimizerPluginApi" text="@kbn/optimizer"/> | [Owner missing] | - | 46 | 0 | 46 | 10 |
...
| <DocLink id="kibKbnSharedUxComponentsPluginApi" text="@kbn/shared-ux-components"/> | [Owner missing] | - | 39 | 0 | 7 | 5 |
...
| <DocLink id="kibKbnTestPluginApi" text="@kbn/test"/> | Operations | - | 236 | 5 | 198 | 9 |
...
| <DocLink id="kibKbnUtilityTypesPluginApi" text="@kbn/utility-types"/> | [Owner missing] | - | 28 | 0 | 10 | 1 |

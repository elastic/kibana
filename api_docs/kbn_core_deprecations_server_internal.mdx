...
####
id: kibKbnCoreDeprecationsServerInternalPluginApi
slug: /kibana-dev-docs/api/kbn-core-deprecations-server-internal
...
### Interfaces
<DocDefinitionList data={kbnCoreDeprecationsServerInternalObj.server.interfaces}/>

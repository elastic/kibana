...
####
id: kibKbnSharedUxErrorBoundaryPluginApi
slug: /kibana-dev-docs/api/kbn-shared-ux-error-boundary
...
### Functions
<DocDefinitionList data={kbnSharedUxErrorBoundaryObj.common.functions}/>

...
| <DocLink id="kibKbnCoreSavedObjectsCommonPluginApi" section="def-common.SavedObjectReference" text="SavedObjectReference"/> | @kbn/core, savedObjectsManagement, savedObjects, savedObjectsTagging, maps, streamsApp, kibanaUtils, expressions, data, embeddable, savedObjectsTaggingOss, @kbn/lens-embeddable-utils, canvas, uiActionsEnhanced, globalSearchProviders | - |
...
| <DocLink id="kibKbnScoutPluginApi" section="def-common.Locator.type" text="type"/> | ux, synthetics, @kbn/scout | - |
...
| <DocLink id="kibKbnEvalsPluginApi" section="def-common.EvaluationWorkerFixtures.phoenixClient" text="phoenixClient"/> | @kbn/evals-suite-streams | - |

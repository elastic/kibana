...
| <DocLink id="kibKbnCoreSavedObjectsServerPluginApi" section="def-server.SavedObjectsType.convertToMultiNamespaceTypeVersion" text="convertToMultiNamespaceTypeVersion"/> | @kbn/core, dataViews, data, dashboard, savedObjectsTagging, actions, alerting, savedSearch, lens, maps, canvas, graph, cases, @kbn/test-suites-xpack-platform, visualizations, lists, securitySolution | - |
...
| <DocLink id="kibKbnSecurityPluginTypesServerPluginApi" section="def-server.SecurityPluginSetup.audit" text="audit"/> | security, actions, alerting, files, ruleRegistry, fleet, cases, securitySolution | - |
...
| <DocLink id="kibKbnColoringPluginApi" section="def-common.CustomPaletteParams.progression" text="progression"/> | @kbn/lens-common, visualizations, @kbn/lens-embeddable-utils, lens, exploratoryView, securitySolution, expressionHeatmap, visTypeTimeseries | - |
...
| <DocLink id="kibKbnCoreSavedObjectsServerPluginApi" section="def-server.SavedObjectsModelVersion" text="SavedObjectsModelVersion"/> | @kbn/core, encryptedSavedObjects, productDocBase, fleet, cases, osquery, synthetics, securitySolution, @kbn/check-saved-objects-cli | - |
...
| <DocLink id="kibKbnCoreChromeBrowserPluginApi" section="def-public.ChromeBreadcrumbsAppendExtension.mount" text="mount"/> | @kbn/core, dashboard | - |
| <DocLink id="kibKbnCoreChromeBrowserPluginApi" section="def-public.ChromeHelpExtension.content" text="content"/> | @kbn/core, canvas | - |
| <DocLink id="kibKbnCoreChromeBrowserPluginApi" section="def-public.ChromeNavControl.mount" text="mount"/> | @kbn/core, cps, spaces, security, aiAssistantManagementSelection, agentBuilder, feedback, globalSearchBar, observabilityAIAssistantApp, searchAssistant, newsfeed, elasticAssistant, inspectComponent, mockIdpPlugin | - |
...
| <DocLink id="kibKbnCoreChromeBrowserPluginApi" section="def-public.ChromeUserBanner.mount" text="mount"/> | @kbn/core | - |
...
| <DocLink id="kibKbnCoreSavedObjectsCommonPluginApi" section="def-common.SavedObjectReference" text="SavedObjectReference"/> | @kbn/core, savedObjectsManagement, savedObjects, savedObjectsTagging, maps, streamsApp, kibanaUtils, expressions, data, embeddable, savedObjectsTaggingOss, @kbn/lens-embeddable-utils, canvas, globalSearchProviders | - |
...
| <DocLink id="kibKbnScoutPluginApi" section="def-common.Locator.isVisible.$1.timeout" text="timeout"/> | synthetics, @kbn/scout | - |
...
| <DocLink id="kibLicensingPluginApi" section="def-public.LicensingPluginSetup.license$" text="license$"/> | security, licenseManagement, ml, crossClusterReplication, grokdebugger, logstash, monitoring, painlessLab, watcher, searchprofiler, slo, securitySolution | 8.8.0 |

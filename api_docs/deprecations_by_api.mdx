...
| <DocLink id="kibDataViewsPluginApi" section="def-common.AbstractDataView.title" text="title"/> | data, @kbn/search-errors, savedObjectsManagement, kql, unifiedSearch, @kbn/unified-field-list, @kbn/lens-embeddable-utils, lens, triggersActionsUi, dataVisualizer, ml, canvas, upgradeAssistant, fleet, graph, transform, @kbn/ml-data-view-utils, stackAlerts, datasetQuality, maps, exploratoryView, controls, visTypeTimeseries, uptime, ux, enterpriseSearch, timelines, securitySolution, @kbn/test-suites-xpack-observability, @kbn/cloud-security-posture-graph, eventAnnotationListing, inputControlVis, visDefaultEditor, dataViewManagement, workflowsManagement, visTypeTimelion, visTypeVega | - |
...
| <DocLink id="kibKbnStreamsSchemaPluginApi" section="def-common.StreamQuery.feature" text="feature"/> | streams, streamsApp, @kbn/test-suites-xpack-platform | - |
| <DocLink id="kibKbnStreamsSchemaPluginApi" section="def-common.StreamQuery.kql" text="kql"/> | streams, streamsApp, @kbn/test-suites-xpack-platform | - |

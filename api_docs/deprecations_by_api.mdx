...
| <DocLink id="kibKbnSharedUxLinkRedirectAppPluginApi" section="def-public.RedirectAppLinks" text="RedirectAppLinks"/> | management, data, esUiShared, spaces, savedObjectsManagement, security, visualizations, lens, agentBuilder, discover, ml, upgradeAssistant, fleet, indexManagement, indexLifecycleManagement, monitoring, exploratoryView, observability, profiling, slo, apm, infra, observabilityAIAssistantApp, observabilityOnboarding, synthetics, uptime, ux, enterpriseSearch, searchAssistant, cloudDefend, cloudSecurityPosture, workplaceAIApp, dataViewManagement, visTypeTimeseries | - |

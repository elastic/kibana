...
| <DocLink id="kibSecurityPluginApi" section="def-server.SecurityPluginStart.authc" text="authc"/> | alerting, fleet, observabilityAIAssistant, reindexService, transform, entityManager, osquery, @kbn/test-suites-xpack-platform, observabilityAgent, synthetics, serverlessSearch, securitySolution, cloudSecurityPosture, security | - |

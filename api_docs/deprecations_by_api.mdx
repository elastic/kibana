...
| <DocLink id="kibLicensingPluginApi" section="def-server.LicensingPluginSetup.license$" text="license$"/> | graph, spaces, security, actions, alerting, remoteClusters, indexLifecycleManagement, painlessLab, rollup, snapshotRestore, transform, upgradeAssistant, aiops, ml, osquery, securitySolution, searchprofiler | 8.8.0 |

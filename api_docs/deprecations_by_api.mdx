...
| <DocLink id="kibSecurityPluginApi" section="def-server.SecurityPluginStart.authc" text="authc"/> | alerting, observabilityAIAssistant, fleet, reindexService, taskManagerDependencies, transform, entityManager, osquery, @kbn/test-suites-xpack-platform, synthetics, serverlessSearch, securitySolution, cloudSecurityPosture, entityStore, security | - |

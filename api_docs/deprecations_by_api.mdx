...
| <DocLink id="kibKbnSharedUxLinkRedirectAppPluginApi" section="def-public.RedirectAppLinks" text="RedirectAppLinks"/> | management, data, esUiShared, spaces, savedObjectsManagement, visualizations, lens, security, ml, discover, upgradeAssistant, fleet, indexManagement, indexLifecycleManagement, monitoring, agentBuilder, exploratoryView, observability, profiling, apm, infra, observabilityAIAssistantApp, observabilityOnboarding, slo, synthetics, uptime, ux, enterpriseSearch, searchAssistant, cloudDefend, cloudSecurityPosture, workplaceAIApp, dataViewManagement, visTypeTimeseries | - |

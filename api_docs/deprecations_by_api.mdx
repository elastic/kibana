...
| <DocLink id="kibKbnCoreApplicationBrowserPluginApi" section="def-public.AppMountParameters.setHeaderActionMenu" text="setHeaderActionMenu"/> | @kbn/core, visualizations, lens, maps, dashboard, ml, discover, fleet, graph, monitoring, security, observabilityShared, exploratoryView, observability, profiling, slo, apm, infra, observabilityOnboarding, synthetics, uptime, ux, enterpriseSearch, securitySolution | - |
...
| <DocLink id="kibKbnSharedUxLinkRedirectAppPluginApi" section="def-public.RedirectAppLinks" text="RedirectAppLinks"/> | management, data, esUiShared, spaces, savedObjectsManagement, visualizations, lens, security, agentBuilder, ml, discover, upgradeAssistant, fleet, indexManagement, indexLifecycleManagement, monitoring, exploratoryView, observability, profiling, slo, apm, infra, observabilityAIAssistantApp, observabilityOnboarding, synthetics, uptime, ux, enterpriseSearch, searchAssistant, cloudDefend, cloudSecurityPosture, workplaceAIApp, dataViewManagement, visTypeTimeseries | - |
...
| <DocLink id="kibSecurityPluginApi" section="def-server.SecurityPluginStart.authc" text="authc"/> | alerting, fleet, observabilityAIAssistant, reindexService, taskManagerDependencies, transform, entityManager, osquery, @kbn/test-suites-xpack-platform, synthetics, serverlessSearch, securitySolution, cloudSecurityPosture, entityStore, security | - |
...
| <DocLink id="kibKbnCoreSavedObjectsServerPluginApi" section="def-server.SavedObjectsType.convertToMultiNamespaceTypeVersion" text="convertToMultiNamespaceTypeVersion"/> | @kbn/core, dataViews, data, dashboard, savedObjectsTagging, actions, alerting, lens, savedSearch, maps, canvas, graph, cases, @kbn/test-suites-xpack-platform, visualizations, lists, securitySolution | - |

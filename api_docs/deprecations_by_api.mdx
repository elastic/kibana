...
| <DocLink id="kibKbnSharedUxLinkRedirectAppPluginApi" section="def-public.RedirectAppLinks" text="RedirectAppLinks"/> | management, data, esUiShared, spaces, savedObjectsManagement, visualizations, lens, security, ml, discover, upgradeAssistant, fleet, indexManagement, indexLifecycleManagement, monitoring, onechat, streamsApp, exploratoryView, observability, profiling, apm, infra, observabilityAIAssistantApp, observabilityOnboarding, slo, synthetics, uptime, ux, enterpriseSearch, searchAssistant, cloudSecurityPosture, workplaceAIApp, dataViewManagement, visTypeTimeseries | - |
...
| <DocLink id="kibSecurityPluginApi" section="def-server.SecurityPluginStart.authc" text="authc"/> | alerting, fleet, observabilityAIAssistant, reindexService, transform, entityManager, @kbn/test-suites-xpack-platform, synthetics, serverlessSearch, securitySolution, cloudSecurityPosture, security | - |

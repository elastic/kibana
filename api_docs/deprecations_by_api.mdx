...
| <DocLink id="kibDataPluginApi" section="def-public.IIndexPattern" text="IIndexPattern"/> | savedObjects, observability, timelines, infra, ml, securitySolution, stackAlerts, transform | - |
| <DocLink id="kibDataPluginApi" section="def-common.IIndexPattern" text="IIndexPattern"/> | savedObjects, observability, timelines, infra, ml, securitySolution, stackAlerts, transform | - |

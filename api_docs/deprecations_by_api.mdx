...
| <DocLink id="kibLensPluginApi" section="def-public.LensTagCloudState.palette" text="palette"/> | visTypeTagcloud | - |
| <DocLink id="kibKbnLensCommonPluginApi" section="def-common.LensTagCloudState.palette" text="palette"/> | visTypeTagcloud | - |

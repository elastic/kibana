...
| <DocLink id="kibCloudExperimentsPluginApi" section="def-common.CloudExperimentsPluginStart" text="CloudExperimentsPluginStart"/> | securitySolution, cloudChat, observabilityOnboarding | - |
...
| <DocLink id="kibKbnCoreSavedObjectsCommonPluginApi" section="def-common.SavedObjectReference" text="SavedObjectReference"/> | @kbn/core-saved-objects-api-browser, @kbn/core, savedObjects, savedObjectsManagement, visualizations, savedObjectsTagging, eventAnnotation, lens, maps, graph, dashboard, savedObjectsTaggingOss, kibanaUtils, expressions, data, embeddable, uiActionsEnhanced, canvas, dashboardEnhanced, globalSearchProviders, controls | - |
...
| <DocLink id="kibCloudExperimentsPluginApi" section="def-common.CloudExperimentsPluginStart.reportMetric" text="reportMetric"/> | cloudExperiments | 

...
| <DocLink id="kibKbnSecurityPluginTypesPublicPluginApi" section="def-public.SecurityPluginStart.authc" text="authc"/> | dataViews, security, securitySolution, serverlessSearch, cloudLinks, observabilityAIAssistantApp, cases, apm | - |

...
| <DocLink id="kibDataPluginApi" section="def-public.KueryNode" text="KueryNode"/> | unifiedSearch | 8.1 |
...
| <DocLink id="kibDataPluginApi" section="def-common.KueryNode" text="KueryNode"/> | unifiedSearch | 8.1 |
...
| <DocLink id="kibDataPluginApi" section="def-server.KueryNode" text="KueryNode"/> | unifiedSearch | 8.1 |
| <DocLink id="kibDataPluginApi" section="def-public.SearchSource.fetch" text="fetch"/> | stackAlerts, inputControlVis | 8.1 |
| <DocLink id="kibDataPluginApi" section="def-common.SearchSource.fetch" text="fetch"/> | stackAlerts, inputControlVis | 8.1 |

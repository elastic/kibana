...
| <DocLink id="kibKbnCoreSavedObjectsServerPluginApi" section="def-server.SavedObjectsType.migrations" text="migrations"/> | @kbn/core, taskManager, dataViews, ml, spaces, data, fleet, actions, share, apmSourcesAccess, savedSearch, lens, alerting, dashboard, canvas, graph, cases, maps, @kbn/test-suites-xpack-platform, uptime, lists, securitySolution, apm, visualizations, infra, slo, synthetics, cloudSecurityPosture, eventAnnotation, links, savedObjectsManagement | - |
...
| <DocLink id="kibKbnCoreSavedObjectsCommonPluginApi" section="def-common.SavedObjectReference" text="SavedObjectReference"/> | @kbn/core, savedObjectsManagement, savedObjects, savedObjectsTagging, maps, streamsApp, kibanaUtils, expressions, data, savedObjectsTaggingOss, embeddable, uiActionsEnhanced, controls, canvas, dashboardEnhanced, globalSearchProviders | - |

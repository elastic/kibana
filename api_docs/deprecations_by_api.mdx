...
| <DocLink id="kibKbnCoreSavedObjectsApiBrowserPluginApi" section="def-public.SavedObjectsCreateOptions" text="SavedObjectsCreateOptions"/> | @kbn/core-saved-objects-browser-internal, @kbn/core, graph, visualizations | - |
...
| <DocLink id="kibKbnCoreSavedObjectsApiBrowserPluginApi" section="def-public.ResolvedSimpleSavedObject" text="ResolvedSimpleSavedObject"/> | @kbn/core-saved-objects-browser-internal, @kbn/core, spaces, graph, savedSearch, visualizations, lens, cases, maps, canvas | - |
...
| <DocLink id="kibSavedObjectsFinderPluginApi" section="def-public.SavedObjectMetaData.includeFields" text="includeFields"/> | graph, visualizations | - |
...
| <DocLink id="kibLicensingPluginApi" section="def-server.LicensingPluginSetup.license$" text="license$"/> | spaces, security, graph, actions, alerting, upgradeAssistant, remoteClusters, indexLifecycleManagement, painlessLab, rollup, snapshotRestore, transform, aiops, ml, osquery, securitySolution, searchprofiler | 8.8.0 |
...
| <DocLink id="kibSavedObjectsPluginApi" section="def-public.SavedObjectSaveModal" text="SavedObjectSaveModal"/> | graph, presentationUtil, visualizations, lens, dashboard, discover, links | 8.8.0 |

...
| <DocLink id="kibKbnCoreSavedObjectsApiBrowserPluginApi" section="def-common.SavedObjectsClientContract.resolve" text="resolve"/> | @kbn/core-saved-objects-browser-mocks, dataViews, savedSearch, dashboard, graph, @kbn/core-saved-objects-browser-internal | - |

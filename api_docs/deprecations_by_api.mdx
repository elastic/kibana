...
| <DocLink id="kibManagementPluginApi" section="def-public.ManagementAppMountParams.theme$" text="theme$"/> | spaces, security, savedObjectsTagging, triggersActionsUi, reporting | - |

...
| <DocLink id="kibKbnCoreSavedObjectsCommonPluginApi" section="def-common.SavedObjectReference" text="SavedObjectReference"/> | @kbn/core, savedObjectsManagement, savedObjects, savedObjectsTagging, maps, streamsApp, kibanaUtils, expressions, data, embeddable, savedObjectsTaggingOss, uiActionsEnhanced, @kbn/lens-embeddable-utils, canvas, globalSearchProviders | - |

...
| <DocLink id="kibDataViewsPluginApi" section="def-common.AbstractDataView.title" text="title"/> | data, @kbn/search-errors, savedObjectsManagement, unifiedSearch, @kbn/unified-field-list, controls, lens, triggersActionsUi, dataVisualizer, @kbn/lens-embeddable-utils, ml, canvas, fleet, stackAlerts, datasetQuality, graph, transform, @kbn/ml-data-view-utils, upgradeAssistant, timelines, maps, securitySolution, exploratoryView, visTypeTimeseries, uptime, ux, enterpriseSearch, @kbn/test-suites-xpack-observability, @kbn/cloud-security-posture-graph, eventAnnotationListing, inputControlVis, visDefaultEditor, dataViewManagement, visTypeTimelion, visTypeVega | - |
...
| <DocLink id="kibKbnCoreSavedObjectsBrowserPluginApi" section="def-public.SavedObjectsStart" text="SavedObjectsStart"/> | @kbn/core, exploratoryView | - |

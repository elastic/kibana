...
| <DocLink id="kibCorePluginApi" section="def-public.SavedObjectAttributes" text="SavedObjectAttributes"/> | actions, alerting, canvas, enterpriseSearch, securitySolution, taskManager, dashboard, savedSearch, visualizations, ml, savedObjects, embeddable, fleet, infra, graph, @kbn/core-saved-objects-server-internal | - |
| <DocLink id="kibCorePluginApi" section="def-server.SavedObjectAttributes" text="SavedObjectAttributes"/> | actions, alerting, canvas, enterpriseSearch, securitySolution, taskManager, dashboard, savedSearch, visualizations, ml, savedObjects, embeddable, fleet, infra, graph, @kbn/core-saved-objects-server-internal | - |

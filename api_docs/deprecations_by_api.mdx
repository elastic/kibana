...
| <DocLink id="kibKbnEsqlValidationAutocompletePluginApi" section="def-common.CommandOptionsDefinition" text="CommandOptionsDefinition"/> | @kbn/esql-validation-autocomplete | 

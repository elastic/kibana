...
| <DocLink id="kibKbnCoreSavedObjectsServerPluginApi" section="def-server.SavedObjectsModelVersion" text="SavedObjectsModelVersion"/> | @kbn/core, encryptedSavedObjects, fleet, productDocBase, cases, osquery, synthetics, securitySolution | - |

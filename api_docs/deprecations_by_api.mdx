...
| <DocLink id="kibCloudExperimentsPluginApi" section="def-common.CloudExperimentsPluginStart" text="CloudExperimentsPluginStart"/> | spaces, navigation, securitySolution, cloudChat, observabilityOnboarding | - |
...
| <DocLink id="kibEmbeddablePluginApi" section="def-public.EmbeddableSetup.registerEmbeddableFactory" text="registerEmbeddableFactory"/> | visualizations, lens, controls, dashboard, discover | - |
...
| <DocLink id="kibEmbeddablePluginApi" section="def-public.EmbeddableStart.getEmbeddableFactory" text="getEmbeddableFactory"/> | lens, controls, dashboard | - |
...
| <DocLink id="kibEmbeddablePluginApi" section="def-public.EmbeddableSetup.registerSavedObjectToPanelMethod" text="registerSavedObjectToPanelMethod"/> | savedSearch, visualizations, lens | - |

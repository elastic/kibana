...
| <DocLink id="kibKbnCoreSavedObjectsCommonPluginApi" section="def-common.SavedObjectReference" text="SavedObjectReference"/> | @kbn/core, savedObjectsManagement, savedObjectsTagging, savedObjects, maps, streamsApp, kibanaUtils, expressions, data, embeddable, savedObjectsTaggingOss, uiActionsEnhanced, @kbn/lens-embeddable-utils, canvas, dashboardEnhanced, globalSearchProviders | - |

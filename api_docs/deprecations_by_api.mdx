...
| <DocLink id="kibKbnImportResolverPluginApi" section="def-common.ImportResolver.isBazelPackage" text="isBazelPackage"/> | @kbn/eslint-plugin-imports, @kbn/repo-source-classifier, @kbn/find-used-node-modules | - |

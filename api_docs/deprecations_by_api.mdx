...
| <DocLink id="kibAlertingPluginApi" section="def-server.RuleExecutorServices.alertFactory" text="alertFactory"/> | ruleRegistry, observability, ml, infra, monitoring, securitySolution, synthetics, transform, uptime | - |
...
| <DocLink id="kibDataPluginApi" section="def-public.DataPublicPluginStart.indexPatterns" text="indexPatterns"/> | stackAlerts, graph, infra, inputControlVis, securitySolution, savedObjects | - |

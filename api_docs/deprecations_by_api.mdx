...
| <DocLink id="kibKbnCoreSavedObjectsServerPluginApi" section="def-server.SavedObjectsType.convertToMultiNamespaceTypeVersion" text="convertToMultiNamespaceTypeVersion"/> | @kbn/core, actions, dataViews, data, alerting, dashboard, savedSearch, canvas, savedObjectsTagging, graph, lens, cases, maps, lists, securitySolution, visualizations | - |

...
| <DocLink id="kibFleetPluginApi" section="def-public.NewPackagePolicy.policy_id" text="policy_id"/> | @kbn/test-suites-xpack-platform, securitySolution, synthetics, @kbn/test-suites-xpack-observability, cloudDefend, @kbn/test-suites-xpack-security, @kbn/cloud-security-posture | - |
| <DocLink id="kibFleetPluginApi" section="def-common.NewPackagePolicy.policy_id" text="policy_id"/> | @kbn/test-suites-xpack-platform, securitySolution, synthetics, @kbn/test-suites-xpack-observability, cloudDefend, @kbn/test-suites-xpack-security, @kbn/cloud-security-posture | - |
...
| <DocLink id="kibDiscoverPluginApi" section="def-public.DiscoverStateContainer.internalStateActions" text="internalStateActions"/> | securitySolution | - |
...
| <DocLink id="kibKbnReactQueryPluginApi" section="def-common.QueryObserverOptions.onSuccess" text="onSuccess"/> | @kbn/alerts-ui-shared, triggersActionsUi, cases, onechat, osquery, @kbn/securitysolution-list-hooks, infra, slo, securitySolution | - |
...
| <DocLink id="kibKbnSecuritysolutionListConstantsPluginApi" section="def-common.ENDPOINT_TRUSTED_APPS_LIST_ID" text="ENDPOINT_TRUSTED_APPS_LIST_ID"/> | lists, securitySolution, @kbn/securitysolution-io-ts-list-types, @kbn/test-suites-security-solution-apis | - |
...
| <DocLink id="kibKbnCoreSavedObjectsServerPluginApi" section="def-server.SavedObjectsType.schemas" text="schemas"/> | @kbn/core, spaces, data, savedSearch, dashboard, visualizations, cloudSecurityPosture | - |
...
| <DocLink id="kibKbnLensCommonPluginApi" section="def-common.XYDataLayerConfig.palette" text="palette"/> | lens | - |

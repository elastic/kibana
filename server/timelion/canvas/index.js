...
const toMS = require('../../../../../src/core_plugins/timelion/server/lib/to_milliseconds.js');
...
module.exports = new Datasource('canvas', {
  args: [
    {
      name: 'q',
      types: ['string', 'null'],
  ...
  help: 'Query Elasticsearch, enriched for Kibana Canvas',
  aliases: ['cv'],
  fn: function canvasFn(args, tlConfig) {

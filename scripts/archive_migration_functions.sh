...
orig_archive="x-pack/test/functional/es_archives/kibana_scripted_fields_on_logstash"
new_archive="x-pack/test/functional/fixtures/kbn_archiver/kibana_scripted_fields_on_logstash"

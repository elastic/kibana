        ...
        githubPr.withDefaultPrComments {
          catchError {
            ...
            parallel([
              ...
              'kibana-oss-agent': kibanaPipeline.functionalWorker('kibana-oss-tests', { kibanaPipeline.buildOss() }, [
              ...
              'kibana-xpack-agent': kibanaPipeline.functionalWorker('kibana-xpack-tests', { kibanaPipeline.buildXpack() }, [
                ...
                'xpack-accessibility': kibanaPipeline.functionalTestProcess('./test/scripts/jenkins_xpack_accessibility.sh'),

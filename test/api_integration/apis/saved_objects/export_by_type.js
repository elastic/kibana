    ...
    describe('with kibana index', () => {
      describe('basic amount of saved objects', () => {
        ...
        it('should return objects in dependency order', async () => {
          await supertest
            .post('/api/saved_objects/_export_by_type/index-pattern,search,visualization,dashboard')
            .expect(200)
            .then((resp) => {
        ...
        it('should validate types', async () => {
          await supertest
            .post('/api/saved_objects/_export_by_type/foo')
            .expect(400)
            .then((resp) => {
              expect(resp.body).to.eql({
                statusCode: 400,
                error: 'Bad Request',
                message: 'Unsupported types: "foo"',
              });
            });
        });
      });
      ...
      describe('10,000 objects', () => {
        ...
        it('should return 400 when exporting without type passed in', async () => {
          await supertest
            .post('/api/saved_objects/_export_by_type')
            .expect(400)
            .then((resp) => {
              expect(resp.body).to.eql({
                statusCode: 400,
        ...
        it('should return 200 when exporting by single type', async () => {
          await supertest
            .post('/api/saved_objects/_export_by_type/dashboard')
            .expect(200)
            .then((resp) => {
      ...
      describe('10,001 objects', () => {
        ...
        it('should return 400 when exporting more than 10,000', async () => {
          await supertest
            .post('/api/saved_objects/_export_by_type/dashboard,visualization,search,index-pattern')
            .expect(400)
            .then((resp) => {
              expect(resp.body).to.eql({
                statusCode: 400,

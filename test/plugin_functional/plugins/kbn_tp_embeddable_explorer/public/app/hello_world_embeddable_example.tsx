...
import { GreetingEmbeddable } from 'plugins/embeddable_api/__test__';

export class GreetingEmbeddableExample extends React.Component<{}> {
  private embeddableRoot: React.RefObject<HTMLDivElement>;
  private embeddable?: GreetingEmbeddable;
  ...
  public async componentDidMount() {
    if (this.embeddableRoot.current) {
      this.embeddable = new GreetingEmbeddable({ id: 'hello', firstName: 'George' });

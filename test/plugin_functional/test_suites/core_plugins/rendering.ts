  ...
  describe('rendering service', () => {
    it('exposes plugin config settings to authenticated users', async () => {
      ...
      const expectedExposedConfigKeys = [
        ...
        'unified_search.autocomplete.querySuggestions.enabled (boolean)',
        'unified_search.autocomplete.valueSuggestions.enabled (boolean)',
        'unified_search.autocomplete.valueSuggestions.terminateAfter (duration)',
        'unified_search.autocomplete.valueSuggestions.tiers (array)',
        'unified_search.autocomplete.valueSuggestions.timeout (duration)',

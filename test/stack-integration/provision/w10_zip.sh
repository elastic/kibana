...
OSS=
XPACK=YES
# If you have SECURITY=NO make sure you also have http not https in URLs and ESPROTO
SECURITY=YES
TLS=YES
# TLS=NO
# LICENSE=TRIAL
...
PRODUCTS="metricbeat packetbeat filebeat winlogbeat elasticsearch kibana logstash apm-server"

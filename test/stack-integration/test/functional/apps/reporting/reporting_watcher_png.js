...
bdd.describe('watcher app', function describeIndexTests() {
  ...
  bdd.describe('PNG Reporting watch', function () {
    ...
    bdd.it('should successfully add a new watch for png Reporting', function () {
        ...
        "actions": {
          "email_admin": {
            "email": {
              ...
              "subject": "PNG " + varHashMap.VERSION_NUMBER + " " + watchId + ", VM=" + varHashMap.VM
    ...
    bdd.it('should delete watch and update revision', function () {

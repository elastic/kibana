...
var jade_mixins = {};
var jade_interp;
;var locals_for_with = (locals || {});(function (cov, coverageClass, id, undefined) {
buf.push("<div id=\"coverage\"><h1 id=\"overview\">Coverage</h1><div id=\"menu\"><li><a href=\"#overview\">overview<span" + (jade.cls(['cov',coverageClass(cov.coverage)], [null,true])) + ">" + (jade.escape((jade_interp = cov.coverage | 0) == null ? '' : jade_interp)) + "</span></a></li>");
// iterate cov.dirs
;(function(){
  var $$obj = cov.dirs;
...
buf.push("<li class=\"dirname\">" + (jade.escape((jade_interp = dir.name || '.') == null ? '' : jade_interp)) + "<span class=\"cov\">&#9733;</span></li>");
// iterate dir.files
;(function(){
  var $$obj = dir.files;
  if ('number' == typeof $$obj.length) {
...
buf.push("<li><span" + (jade.cls(['cov',coverageClass(file.coverage)], [null,true])) + ">" + (jade.escape((jade_interp = file.coverage | 0) == null ? '' : jade_interp)) + "</span><a" + (jade.attr("href", '#' + (file.filename) + '', true, false)) + "><span class=\"basename\">" + (jade.escape(null == (jade_interp = file.relname) ? "" : jade_interp)) + "</span></a></li>");
    }
...
if ( line.coverage > 0)
{
buf.push("<tr" + (jade.attr("id", id, true, false)) + " class=\"hit\"><td class=\"line\"><a" + (jade.attr("href", '#' + id, true, false)) + ">" + (jade.escape(null == (jade_interp = number) ? "" : jade_interp)) + "</a></td><td class=\"hits\">" + (jade.escape(null == (jade_interp = line.coverage) ? "" : jade_interp)) + "</td><td class=\"source\">" + (jade.escape(null == (jade_interp = line.source) ? "" : jade_interp)) + "</td></tr>");
}
else if ( 0 === line.coverage)
{
buf.push("<tr" + (jade.attr("id", id, true, false)) + " class=\"miss\"><td class=\"line\"><a" + (jade.attr("href", '#' + id, true, false)) + ">" + (jade.escape(null == (jade_interp = number) ? "" : jade_interp)) + "</a></td><td class=\"hits\">0</td><td class=\"source\">" + (jade.escape(null == (jade_interp = line.source) ? "" : jade_interp)) + "</td></tr>");
}
else
{
buf.push("<tr" + (jade.attr("id", id, true, false)) + "><td class=\"line\"><a" + (jade.attr("href", '#' + id, true, false)) + ">" + (jade.escape(null == (jade_interp = number) ? "" : jade_interp)) + "</a></td><td class=\"hits\"></td><td class=\"source\">" + (jade.escape(null == (jade_interp = line.source || ' ') ? "" : jade_interp)) + "</td></tr>");
}
    }

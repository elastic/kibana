...
var buf = [];
var jade_mixins = {};
var locals_ = (locals || {}),coverageClass = locals_.coverageClass,cov = locals_.cov;
...
buf.push("<li class=\"dirname\">" + (jade.escape(null == (jade.interp = dir.name || '.') ? "" : jade.interp)) + "</li>");
// iterate dir.files
;(function(){
  var $$obj = dir.files;
  if ('number' == typeof $$obj.length) {
...
if ( line.coverage > 0)
{
buf.push("<tr class=\"hit\"><td class=\"line\">" + (jade.escape(null == (jade.interp = number) ? "" : jade.interp)) + "</td><td class=\"hits\">" + (jade.escape(null == (jade.interp = line.coverage) ? "" : jade.interp)) + "</td><td class=\"source\">" + (jade.escape(null == (jade.interp = line.source) ? "" : jade.interp)) + "</td></tr>");
}
else if ( 0 === line.coverage)
{
buf.push("<tr class=\"miss\"><td class=\"line\">" + (jade.escape(null == (jade.interp = number) ? "" : jade.interp)) + "</td><td class=\"hits\">0</td><td class=\"source\">" + (jade.escape(null == (jade.interp = line.source) ? "" : jade.interp)) + "</td></tr>");
}
else
{
buf.push("<tr><td class=\"line\">" + (jade.escape(null == (jade.interp = number) ? "" : jade.interp)) + "</td><td class=\"hits\"></td><td class=\"source\">" + (jade.escape(null == (jade.interp = line.source || ' ') ? "" : jade.interp)) + "</td></tr>");
}
    }

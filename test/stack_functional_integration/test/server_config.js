...
const TEST_KIBANA_URL = url.parse(process.env.KIBANAURL ? process.env.KIBANAURL : 'https://elastic:changeit@localhost:5601');
...
const TEST_ES_URL = url.parse(process.env.ESURL ? process.env.ESURL : 'https://elastic:changeit@localhost:9200');

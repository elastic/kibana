...
import SecurityPage from './security_page';
...
class PageObjects {
  ...
  init(remote) {
    ...
    securityPage.init(remote);
    codePage.init(remote);
  }
  ...
  get security() {
    return this.assertInitialized() && securityPage;
  }

  get code() {
    return this.assertInitialized() && codePage;
  }

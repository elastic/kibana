 ...
 * Returns a `testRunner` for an FTR configuration with tests implemented in Cypress,
 * to be used in for E2E test campaign execution after the Kibana tests server is in a ready state.

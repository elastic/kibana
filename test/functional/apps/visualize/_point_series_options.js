...
export default function ({ getService, getPageObjects }) {
  ...
  const PageObjects = getPageObjects(['common', 'visualize', 'visualizePointSeries', 'header']);
  ...
  describe('visualize app', function describeIndexTests() {
    before(function () {
      ...
      .then(function gotoAxisOptions() {
        ...
        return PageObjects.visualizePointSeries.clickAxisOptions();
      })
      // add another value axis
      .then(function addAxis() {
        log.debug('adding axis');
        return PageObjects.visualizePointSeries.clickAddAxis();
      })
      // set average count to use second value axis
      .then(function setAxis() {
        return PageObjects.visualizePointSeries.toggleCollapsibleTitle('Average machine.ram')
          .then(function () {
            log.debug('Average memory value axis - ValueAxis-2');
            return PageObjects.visualizePointSeries.setSeriesAxis(1, 'ValueAxis-2');
          });
      })
    ...
    describe('secondary value axis', function () {
      ...
      it('should put secondary axis on the right', function () {
        PageObjects.visualizePointSeries.getRightValueAxes().then(length => {
    ...
    describe('multiple chart types', function () {
      it('should change average series type to histogram', function () {
        return PageObjects.visualizePointSeries.toggleCollapsibleTitle('RightAxis-1')
          .then(function () {
            return PageObjects.visualizePointSeries.setSeriesType(1, 'bar');
          })
          .then(function () {
            return PageObjects.visualize.clickGo();
          })
          ...
          .then(function checkSeriesTypes() {
            PageObjects.visualizePointSeries.getHistogramSeries().then(length => {
              expect(length).to.be(1);
            });
          });
      });
    ...
    describe('grid lines', function () {
      before(function () {
        return PageObjects.visualizePointSeries.clickOptions();
      });

      it('should show category grid lines', function () {
        return PageObjects.visualizePointSeries.toggleGridCategoryLines()
          .then(function () {
            return PageObjects.visualize.clickGo();
          })
          .then(function () {
          ...
          .then(function () {
            return PageObjects.visualizePointSeries.getGridLines();
          })
      ...
      it('should show value axis grid lines', function () {
        return PageObjects.visualizePointSeries.setGridValueAxis('ValueAxis-2')
          .then(function () {
            return PageObjects.visualizePointSeries.toggleGridCategoryLines();
          })
          .then(function () {

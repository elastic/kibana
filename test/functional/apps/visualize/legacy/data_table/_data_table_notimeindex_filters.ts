...
export default function ({ getService, getPageObjects }: FtrProviderContext) {
  ...
  describe('legacy data table with index without time filter filters', function indexPatternCreation() {
    ...
    it('should add to dashboard and allow filtering', async function () {
      ...
      await PageObjects.legacyDataTableVis.filterOnTableCell(1, 2);

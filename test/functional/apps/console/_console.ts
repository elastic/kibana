...
export default function({ getService, getPageObjects }: FtrProviderContext) {
  ...
  describe('console app', function describeIndexTests() {
    ...
    it('should show the default request with correct information', async () => {
      ...
      log.info('sub it: default request response should include `"timed_out" : false`');
      ...
      log.info('sub it: settings should allow changing the text size');

...
export default function ({ getService, getPageObjects }) {
  ...
  describe('discover app', function describeIndexTests() {
    ...
    describe('query', function () {
      ...
      it('should show correct initial chart interval of 3 hours', async function () {
      ...
      it('should show Auto chart interval of 3 hours', async function () {
    ...
    describe('shared-item', function () {
      it('should have correct shared-item title and description', async () => {
        const expected = {

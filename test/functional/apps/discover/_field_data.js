      ...
      bdd.describe('field data', function () {
        ...
        bdd.it('doc view should show oldest time first', function () {
          ...
          var ExpectedDoc =
            ...
            + ' _type:apache _index:logstash-2015.09.22 _score:(empty) relatedContent.article:modified_time:November 27th'
        ...
        bdd.it('doc view should sort ascending', function () {
          ...
          var ExpectedDoc =
            ...
            + ' machine.ram:15,032,385,536 _id:AU_x3_g3GFA8no6QjkFm _type:apache _index:logstash-2015.09.20 _score:(empty)'

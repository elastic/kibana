...
export default function ({ getService, getPageObjects }) {
  ...
  describe('discover tab', function describeIndexTests() {
    ...
    describe('field data', function () {
      ...
      it('doc view should show oldest time first', async function () {
        ...
        await PageObjects.discover
          ...
          .then(async function (rowData) {
            try {
              ...
              log.info(
                'Attemping to get more debug info on this flaky test. Ping @bargs if you see this fail'
              );
              ...
              const esResponse = JSON.parse(
                await PageObjects.visualize.getVisualizationResponse()
              );
              const spyPanelDoc = esResponse.hits.hits.find(function (hit) {
                return (
                  hit._id === 'AU_x3_g4GFA8no6QjkYX' &&
                  hit._index === 'logstash-2015.09.22'
                );
              });

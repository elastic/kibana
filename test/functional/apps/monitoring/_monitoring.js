  ...
  bdd.describe('main page', function () {
    ...
    bdd.it('should show Elasticsearch status not red', function () {
      ...
      .then(function (actualQueryNameString) {
        expect(actualQueryNameString).to.be('Yellow');
      });
    });

    bdd.it('should show Elasticsearch Uptime > 0', function () {
      return PageObjects.monitoring.getElasticsearchSmallPanelUptime()
      .then(function (actualQueryNameString) {
        expect(actualQueryNameString).to.be('Green');
      });
    });

...
(function () {
  ...
  chrome.storage.sync.get(
    ['domTreeRoot', 'outputType', 'depth'],
    ({ domTreeRoot, outputType, depth = 2 }) => {
      ...
      const findTestSubjects = (
        ...
        const updatedPath = testSubjectOnNode ? [...path, testSubjectOnNode] : path;
      ...
      window.__test_utils__ = window.__test_utils__ || {
        documentClicksHandler,
        isTracking: false,
        dataTestSubjects: new Set(),
      };

...
`x-pack/test_serverless` cover the serverless functionality introduced by the
 ...
 [src/dev/packages/es/README](https://github.com/elastic/kibana/blob/main/src/dev/packages/es/README.mdx).
...
Each serverless project has its own set of SAML roles with [specfic permissions defined in roles.yml](https://github.com/elastic/kibana/blob/main/src/dev/packages/es/src/serverless_resources/project_roles)

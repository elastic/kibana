    ...
    describe('non partition by SLO', () => {
      ...
      it('creates the rollup and summary transforms', async () => {
        const expectedTransforms: ExpectedTransforms = {
          count: 2,
          results: {
            transform0: { id: 'slo-my-custom-id1-1', destIndex: '.slo-observability.sli-v4' },
            transform1: {
              id: 'slo-summary-my-custom-id1-1',
              destIndex: '.slo-observability.summary-v4',
            },
          },
          typeOfVersion: 'string',
    ...
    describe('Total transforms', () => {
      it('returns all the transforms for above created SLOs', async () => {
        const expectedTransforms: ExpectedTransforms = {
          ...
          results: {
            transform0: { id: 'slo-my-custom-id1-1', destIndex: '.slo-observability.sli-v4' },
            transform1: { id: 'slo-my-custom-id2-1', destIndex: '.slo-observability.sli-v4' },
            transform2: { id: 'slo-my-custom-id3-1', destIndex: '.slo-observability.sli-v4' },
            transform3: { id: 'slo-my-custom-id4-1', destIndex: '.slo-observability.sli-v4' },
            transform4: {
              id: 'slo-summary-my-custom-id1-1',
              destIndex: '.slo-observability.summary-v4',
            },

...
export default function ({ getService }: FtrProviderContext) {
  ...
  describe('conflicts', function () {
    before(async () => {
      ...
      await esArchiver.load('src/platform/test/api_integration/fixtures/es_archiver/index_patterns/conflicts');
    });
    after(async () => {
      await esArchiver.unload('src/platform/test/api_integration/fixtures/es_archiver/index_patterns/conflicts');

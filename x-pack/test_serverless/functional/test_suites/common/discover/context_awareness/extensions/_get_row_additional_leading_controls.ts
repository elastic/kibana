  ...
  describe('extension getRowAdditionalLeadingControls', () => {
    ...
    describe('ES|QL mode', () => {
      it('should render logs controls for logs data source', async () => {
        ...
        await testSubjects.existOrFail('unifiedDataTable_additionalRowControl_actions');
      });
      ...
      it('should not render logs controls for non-logs data source', async () => {
        ...
        await testSubjects.missingOrFail('unifiedDataTable_additionalRowControl_actions');
      });
    });

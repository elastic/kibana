...
import { IntegrationAutoImportCard } from './integration_auto_import_card';
import * as i18n from './translations';

export const IntegrationImportLanding = React.memo(() => {
                  ...
                  >
                    ...
                    <EuiFlexItem>
                      <EuiText size="s" color="subdued">
                        <FormattedMessage
                          id="xpack.integrationImport.landing.uploadPackageDescription"
                          defaultMessage="If you have an existing integration package, {link}"
                          values={{
                            link: (
                              <EuiLink onClick={() => navigate(Page.upload)}>
                                <FormattedMessage
                                  id="xpack.integrationImport.landing.uploadPackageLink"
...
IntegrationImportLanding.displayName = 'IntegrationImportLanding';

...
const STEP_CONNECTOR = i18n.translate('xpack.integrationImport.step.connector', {
  defaultMessage: 'Connector',
});

const STEP_INTEGRATION = i18n.translate('xpack.integrationImport.step.integration', {
  defaultMessage: 'Integration',
});

const STEP_DATA_STREAM = i18n.translate('xpack.integrationImport.step.dataStream', {
  defaultMessage: 'Data stream',
});

const STEP_REVIEW = i18n.translate('xpack.integrationImport.step.review', {

...
export const DEPLOYING = i18n.translate('xpack.integrationImport.step.deploy.loadingTitle', {
  defaultMessage: 'Deploying',
});

export const DOWNLOAD_ZIP_TITLE = i18n.translate(
  'xpack.integrationImport.step.deploy.downloadZip.title',
  {
    defaultMessage: 'Download .zip package',
  }
);
export const DOWNLOAD_ZIP_DESCRIPTION = i18n.translate(
  'xpack.integrationImport.step.deploy.downloadZip.description',
  {
...
export const DOWNLOAD_ZIP_LINK = i18n.translate(
  'xpack.integrationImport.step.deploy.downloadZip.link',
  {

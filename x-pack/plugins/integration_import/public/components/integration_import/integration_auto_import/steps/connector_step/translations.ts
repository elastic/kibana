...
export const TITLE = i18n.translate('xpack.integrationImport.steps.connector.title', {
  defaultMessage: 'Choose your AI connector',
});

export const DESCRIPTION = i18n.translate(
  'xpack.integrationImport.steps.connector.description',
  {
...
export const CREATE_CONNECTOR = i18n.translate(
  'xpack.integrationImport.steps.connector.createConnectorLabel',
  {
...
export const SUPPORTED_MODELS_INFO = i18n.translate(
  'xpack.integrationImport.steps.connector.supportedModelsInfo',
  {
    defaultMessage:

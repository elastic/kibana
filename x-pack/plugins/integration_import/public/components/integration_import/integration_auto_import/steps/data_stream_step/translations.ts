...
export const INTEGRATION_NAME_TITLE = i18n.translate(
  'xpack.integrationImport.step.dataStream.integrationNameTitle',
  {
    defaultMessage: 'Define package name',
  }
);
export const INTEGRATION_NAME_DESCRIPTION = i18n.translate(
  'xpack.integrationImport.step.dataStream.integrationNameDescription',
  {
    defaultMessage:
...
export const DATA_STREAM_TITLE = i18n.translate(
  'xpack.integrationImport.step.dataStream.dataStreamTitle',
  {
    defaultMessage: 'Define data stream and upload logs',
  }
);
export const DATA_STREAM_DESCRIPTION = i18n.translate(
  'xpack.integrationImport.step.dataStream.dataStreamDescription',
  {
    defaultMessage:
...
export const INTEGRATION_NAME_LABEL = i18n.translate(
  'xpack.integrationImport.step.dataStream.integrationName.label',
  {
    defaultMessage: 'Integration package name',
  }
);
export const NO_SPACES_HELP = i18n.translate(
  'xpack.integrationImport.step.dataStream.noSpacesHelpText',
  {
...
export const PACKAGE_NAMES_FETCH_ERROR = i18n.translate(
  'xpack.integrationImport.step.dataStream.packageNamesFetchError',
  {
    defaultMessage: 'Error fetching package names',
  }
);
export const NAME_ALREADY_EXISTS_ERROR = i18n.translate(
  'xpack.integrationImport.step.dataStream.nameAlreadyExistsError',
  {
...
export const DATA_STREAM_TITLE_LABEL = i18n.translate(
  'xpack.integrationImport.step.dataStream.dataStreamTitle.label',
  {
...
export const DATA_STREAM_DESCRIPTION_LABEL = i18n.translate(
  'xpack.integrationImport.step.dataStream.dataStreamDescription.label',
  {
...
export const DATA_STREAM_NAME_LABEL = i18n.translate(
  'xpack.integrationImport.step.dataStream.dataStreamName.label',
  {
...
export const DATA_COLLECTION_METHOD_LABEL = i18n.translate(
  'xpack.integrationImport.step.dataStream.dataCollectionMethod.label',
  {
...
export const LOGS_SAMPLE_LABEL = i18n.translate(
  'xpack.integrationImport.step.dataStream.logsSample.label',
  {
    defaultMessage: 'Logs',
  }
);
...
export const LOGS_SAMPLE_WARNING = i18n.translate(
  'xpack.integrationImport.step.dataStream.logsSample.warning',
  {
    defaultMessage:
...
export const LOGS_SAMPLE_DESCRIPTION = i18n.translate(
  'xpack.integrationImport.step.dataStream.logsSample.description',
  {
    defaultMessage: 'Drag and drop a file or Browse files.',
  }
);
export const LOGS_SAMPLE_DESCRIPTION_2 = i18n.translate(
  'xpack.integrationImport.step.dataStream.logsSample.description2',
  {
    defaultMessage: 'JSON/NDJSON format',
  }
);
export const LOGS_SAMPLE_TRUNCATED = (maxRows: number) =>
  i18n.translate('xpack.integrationImport.step.dataStream.logsSample.truncatedWarning', {
    values: { maxRows },
...
export const LOGS_SAMPLE_ERROR = {
  CAN_NOT_READ: i18n.translate(
    'xpack.integrationImport.step.dataStream.logsSample.errorCanNotRead',
    {
      defaultMessage: 'Failed to read the logs sample file',
    }
  ),
  FORMAT: (fileType: string) =>
    i18n.translate('xpack.integrationImport.step.dataStream.logsSample.errorFormat', {
      values: { fileType },
      defaultMessage: 'The logs sample file has not a valid {fileType} format',
    }),
  NOT_ARRAY: i18n.translate('xpack.integrationImport.step.dataStream.logsSample.errorNotArray', {
    defaultMessage: 'The logs sample file is not an array',
  }),
  EMPTY: i18n.translate('xpack.integrationImport.step.dataStream.logsSample.errorEmpty', {
    defaultMessage: 'The logs sample file is empty',
  }),
  NOT_OBJECT: i18n.translate(
    'xpack.integrationImport.step.dataStream.logsSample.errorNotObject',
    {
...
export const ANALYZING = i18n.translate('xpack.integrationImport.step.dataStream.analyzing', {
  defaultMessage: 'Analyzing',
});
export const PROGRESS_ECS_MAPPING = i18n.translate(
  'xpack.integrationImport.step.dataStream.progress.ecsMapping',
  {
    defaultMessage: 'Mapping ECS fields',
  }
);
export const PROGRESS_CATEGORIZATION = i18n.translate(
  'xpack.integrationImport.step.dataStream.progress.categorization',
  {
    defaultMessage: 'Adding categorization',
  }
);
export const PROGRESS_RELATED_GRAPH = i18n.translate(
  'xpack.integrationImport.step.dataStream.progress.relatedGraph',
  {
    defaultMessage: 'Generating related fields',
  }
);
export const GENERATION_ERROR = (progressStep: string) =>
  i18n.translate('xpack.integrationImport.step.dataStream.generationError', {
    values: { progressStep },
    defaultMessage: 'An error occurred during: {progressStep}',
  });

export const RETRY = i18n.translate('xpack.integrationImport.step.dataStream.retryButtonLabel', {

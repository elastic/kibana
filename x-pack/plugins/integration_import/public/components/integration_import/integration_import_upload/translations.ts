...
export const UPLOAD_TITLE = i18n.translate(
  'xpack.integrationImport.createIntegrationUpload.title',
  {
...
export const UPLOAD_INPUT_TEXT = i18n.translate(
  'xpack.integrationImport.createIntegrationUpload.inputText',
  {
...
export const INSTALL_BUTTON = i18n.translate(
  'xpack.integrationImport.createIntegrationUpload.install',
  {
...
export const CLOSE_BUTTON = i18n.translate(
  'xpack.integrationImport.createIntegrationUpload.close',
  {
...
export const UPLOAD_ERROR = i18n.translate(
  'xpack.integrationImport.createIntegrationUpload.error',
  {

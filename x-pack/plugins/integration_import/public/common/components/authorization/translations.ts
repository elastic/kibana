...
export const PRIVILEGES_MISSING_TITLE = i18n.translate(
  'xpack.integrationImport.missingPrivileges.title',
  {
...
export const PRIVILEGES_REQUIRED_TITLE = i18n.translate(
  'xpack.integrationImport.missingPrivileges.privilegesNeededTitle',
  {
...
export const REQUIRED_PRIVILEGES = {
  FLEET_ALL: i18n.translate(
    'xpack.integrationImport.missingPrivileges.requiredPrivileges.fleet',
    {
      defaultMessage: 'Management > Fleet: All',
    }
  ),
  INTEGRATIONS_ALL: i18n.translate(
    'xpack.integrationImport.missingPrivileges.requiredPrivileges.integrations',
    {
      defaultMessage: 'Management > Integrations: All',
    }
  ),
  CONNECTORS_READ: i18n.translate(
    'xpack.integrationImport.missingPrivileges.requiredPrivileges.connectorsRead',
    {
      defaultMessage: 'Management > Connectors: Read',
    }
  ),
  CONNECTORS_ALL: i18n.translate(
    'xpack.integrationImport.missingPrivileges.requiredPrivileges.connectorsAll',
    {
...
export const CONTACT_ADMINISTRATOR = i18n.translate(
  'xpack.integrationImport.missingPrivileges.contactAdministrator',
  {

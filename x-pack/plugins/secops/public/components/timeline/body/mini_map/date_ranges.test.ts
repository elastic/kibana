...
describe('dateRanges', () => {
  describe('#getDates', () => {
    ...
    test('given a unit of "month", it returns all the weeks of the month', () => {
      ...
      const end = moment('Wed, 31 Oct 2018 23:59:59 -0600');
      const current = moment('Mon, 01 Oct 2018 00:00:00 -0600');
    ...
    test('given a unit of "week", it returns all the days of the week', () => {
      ...
      const end = moment('Sat, 27 Oct 2018 23:59:59 -0600');
      const current = moment('Sun, 21 Oct 2018 00:00:00 -0600');
    ...
    test('given a unit of "day", it returns all the hours of the day', () => {
      ...
      const end = moment('Tue, 23 Oct 2018 23:59:59 -0600');
      const current = moment('Tue, 23 Oct 2018 00:00:00 -0600');
  ...
  describe('#getDateRange', () => {
    ...
    test('given a unit of "day", it returns all the hours of the day', () => {
      ...
      getDateRange(unit, dates =>
        expect(dates).toEqual(
          [
            '2018-11-22T07:00:00.000Z',
            '2018-11-22T08:00:00.000Z',
            '2018-11-22T09:00:00.000Z',
            '2018-11-22T10:00:00.000Z',
            '2018-11-22T11:00:00.000Z',
            '2018-11-22T12:00:00.000Z',
            '2018-11-22T13:00:00.000Z',
            '2018-11-22T14:00:00.000Z',
            '2018-11-22T15:00:00.000Z',
            '2018-11-22T16:00:00.000Z',
            '2018-11-22T17:00:00.000Z',
            '2018-11-22T18:00:00.000Z',
            '2018-11-22T19:00:00.000Z',
            '2018-11-22T20:00:00.000Z',
            '2018-11-22T21:00:00.000Z',
            '2018-11-22T22:00:00.000Z',
            '2018-11-22T23:00:00.000Z',

...
export const IN = i18n.translate('xpack.secops.auditd.inDescription', {
  defaultMessage: 'in',
});

export const WAS_AUTHORIZED_TO_USE = i18n.translate(
  'xpack.secops.auditd.wasAuthorizedToUseDescription',
  {
...
export const ACQUIRED_CREDENTIALS_TO = i18n.translate(
  'xpack.secops.auditd.acquiredCredentialsDescription',
  {
    defaultMessage: 'acquired credentials to',
  }
);

export const ENDED_FROM = i18n.translate('xpack.secops.auditd.endedFromDescription', {
  defaultMessage: 'ended from',
});

export const STARTED = i18n.translate('xpack.secops.auditd.startedAtDescription', {
  defaultMessage: 'started',
});

export const DISPOSED_CREDENTIALS_TO = i18n.translate(
  'xpack.secops.auditd.disposedCredentialsDescription',
  {
    defaultMessage: 'disposed credentials to',
  }
);

export const ATTEMPTED_LOGIN = i18n.translate('xpack.secops.auditd.attemptedLoginDescription', {
  defaultMessage: 'attempted a login via',
});

export const WITH_RESULT = i18n.translate('xpack.secops.auditd.withResultDescription', {
  defaultMessage: 'with result',
});
export const EXECUTED = i18n.translate('xpack.secops.auditd.executedDescription', {
  defaultMessage: 'executed',
});

export const AS = i18n.translate('xpack.secops.auditd.asDescription', {
  defaultMessage: 'as',
});

export const CONNECTED_USING = i18n.translate('xpack.secops.auditd.connectedUsingDescription', {
  defaultMessage: 'connected using',
});

export const USING = i18n.translate('xpack.secops.auditd.usingDescription', {
  defaultMessage: 'using',
});

export const OPENED_FILE = i18n.translate('xpack.secops.auditd.OpenedFileDescription', {
  defaultMessage: 'opened file',
});

export const CHANGED_FILE_ATTRIBUTES_OF = i18n.translate(
  'xpack.secops.auditd.ChangedFileAttributesOfDescription',
  {
...
export const CHANGED_FILE_PERMISSIONS_OF = i18n.translate(
  'xpack.secops.auditd.changedFilePermissionOfDescription',
  {
...
export const CHANGED_FILE_OWNERSHIP_OF = i18n.translate(
  'xpack.secops.auditd.changeidleOwernshipOfDescription',
  {
...
export const LOADED_KERNEL_MODULE = i18n.translate(
  'xpack.secops.auditd.loaedKernelModuleOfDescription',
  {
...
export const UNLOADED_KERNEL_MODULE_OF = i18n.translate(
  'xpack.secops.auditd.unloadedKernelModuleOfDescription',
  {
    defaultMessage: 'unloaded kernel module of',
  }
);

export const CREATED_DIRECTORY = i18n.translate('xpack.secops.auditd.createdDirectoryDescription', {
  defaultMessage: 'created directory',
});

export const MOUNTED = i18n.translate('xpack.secops.auditd.mountedDescription', {
  defaultMessage: 'mounted',
});

export const RENAMED = i18n.translate('xpack.secops.auditd.renamedDescription', {
  defaultMessage: 'renamed',
});

export const CHECKED_METADATA_OF = i18n.translate(
  'xpack.secops.auditd.chedckedMetaDataOfDescription',
  {
...
export const CHECKED_FILE_SYSTEM_METADATA_OF = i18n.translate(
  'xpack.secops.auditd.checkedFileSystemMetadataOfDescription',
  {
    defaultMessage: 'checked filesystem metadata of',
  }
);

export const SYMLINKED = i18n.translate('xpack.secops.auditd.symLinkedDescription', {
  defaultMessage: 'symbolically linked',
});

export const UNMOUNTED = i18n.translate('xpack.secops.auditd.unmountedDescription', {
  defaultMessage: 'unmounted',
});

export const DELETED = i18n.translate('xpack.secops.auditd.deletedDescription', {
  defaultMessage: 'deleted',
});

export const CHANGED_TIME_STAMP_OF = i18n.translate(
  'xpack.secops.auditd.changedTimeStampOfDescription',
  {
...
export const LISTEN_FOR_CONNECTIONS = i18n.translate(
  'xpack.secops.auditd.ListeningForConnectionsUsingDescription',
  {
    defaultMessage: 'listening for connections using',
  }
);

export const BOUND_SOCKET_FROM = i18n.translate('xpack.secops.auditd.boundSocketFromDescription', {
  defaultMessage: 'bound socket from',
});

export const RECEIVED_FROM = i18n.translate('xpack.secops.auditd.receivedFromDescription', {
  defaultMessage: 'received from',
});

export const SENT_TO = i18n.translate('xpack.secops.auditd.sentToDescription', {
  defaultMessage: 'sent to',
});

export const KILLED_PROCESS_ID_OF = i18n.translate(
  'xpack.secops.auditd.killedProcessIdDescription',
  {
...
export const CHANGED_IDENTITY_USING = i18n.translate(
  'xpack.secops.auditd.changedIdentityUsingDescription',
  {
...
export const CHANGED_SYSTEM_TIME_WITH = i18n.translate(
  'xpack.secops.auditd.changedSystemTimeWithDescription',
  {
    defaultMessage: 'changed system time with',
  }
);

export const MADE_DEVICE_WITH = i18n.translate('xpack.secops.auditd.madeDeviceWithDescription', {
  defaultMessage: 'made device with',
});

export const CHANGED_SYSTEM_NAME = i18n.translate(
  'xpack.secops.auditd.changedSystemNameDescription',
  {
...
export const ALLOCATED_MEMORY_FOR = i18n.translate(
  'xpack.secops.auditd.allocatedMemoryForDescription',
  {
...
export const SCHEDULED_POLICY_OF = i18n.translate(
  'xpack.secops.auditd.scheduledPolicyOFDescription',
  {
...
export const ADDED_USER_ACCOUNT = i18n.translate(
  'xpack.secops.auditd.addedUserAccountDescription',
  {
...
export const CAUSED_MAC_POLICY_ERROR = i18n.translate(
  'xpack.secops.auditd.causedMacPolicyErrorDescription',
  {
...
export const LOADED_FIREWALL_RULE = i18n.translate(
  'xpack.secops.auditd.loadedFirewallRuleDescription',
  {
...
export const CHANGED_PROMISCUOUS_MODE = i18n.translate(
  'xpack.secops.auditd.promiscuousModeDescription',
  {
    defaultMessage: 'changed promiscuous mode on the device using',
  }
);

export const LOCKED_ACCOUNT = i18n.translate('xpack.secops.auditd.lockedAccountDescription', {
  defaultMessage: 'locked account',
});

export const UNLOCKED_ACCOUNT = i18n.translate('xpack.secops.auditd.unlockedAccountDescription', {
  defaultMessage: 'unlocked account',
});

export const ADDED_GROUP_ACCOUNT_USING = i18n.translate(
  'xpack.secops.auditd.adddedGroupAccountUsingDescription',
  {
    defaultMessage: 'added group account using',
  }
);

export const CRASHED_PROGRAM = i18n.translate('xpack.secops.auditd.crashedProgramDescription', {
  defaultMessage: 'crashed program',
});

export const EXECUTION_OF_FORBIDDEN_PROGRAM = i18n.translate(
  'xpack.secops.auditd.executionOfForbiddenProgramDescription',
  {
...
export const USED_SUSPICIOUS_PROGRAM = i18n.translate(
  'xpack.secops.auditd.suspiciousProgramDescription',
  {
...
export const FAILED_LOGIN_TOO_MANY_TIMES = i18n.translate(
  'xpack.secops.auditd.failedLoginTooManyTimesDescription',
  {
...
export const ATTEMPTED_LOGIN_FROM_UNUSUAL_PLACE = i18n.translate(
  'xpack.secops.auditd.attemptedLoginFromUnusalPlaceDescription',
  {
...
export const OPENED_TOO_MANY_SESSIONS = i18n.translate(
  'xpack.secops.auditd.openedTooManySessionsDescription',
  {
...
export const ATTEMPTED_LOGIN_FROM_UNUSUAL_HOUR = i18n.translate(
  'xpack.secops.auditd.attemptedLoginFromUnusualHourDescription',
  {
...
export const TESTED_FILE_SYSTEM_INTEGRITY = i18n.translate(
  'xpack.secops.auditd.testedFileSystemIntegrityDescription',
  {
...
export const VIOLATED_SELINUX_POLICY = i18n.translate(
  'xpack.secops.auditd.violatedSeLinuxPolicyDescription',
  {
...
export const VIOLATED_APP_ARMOR_POLICY_FROM = i18n.translate(
  'xpack.secops.auditd.violatedAppArmorPolicyFromDescription',
  {
    defaultMessage: 'violated app armor policy from',
  }
);

export const CHANGED_GROUP = i18n.translate('xpack.secops.auditd.changedGroupDescription', {
  defaultMessage: 'changed group',
});

export const CHANGED_USER_ID = i18n.translate('xpack.secops.auditd.changedUserIdDescription', {
  defaultMessage: 'changed user id',
});

export const CHANGED_AUDIT_CONFIGURATION = i18n.translate(
  'xpack.secops.auditd.changedAuditConfigurationDescription',
  {
...
export const REFRESHED_CREDENTIALS_FOR = i18n.translate(
  'xpack.secops.auditd.refreshedCredentialsForDescription',
  {
...
export const NEGOTIATED_CRYPTO_KEY = i18n.translate(
  'xpack.secops.auditd.negotiatedCryptoKeyDescription',
  {
...
export const CRYPTO_OFFICER_LOGGED_IN = i18n.translate(
  'xpack.secops.auditd.cryptoOfficerLoggedInDescription',
  {
...
export const CRYPTO_OFFICER_LOGGED_OUT = i18n.translate(
  'xpack.secops.auditd.cryptoOfficerLoggedOutDescription',
  {
...
export const STARTED_CRYPTO_SESSION = i18n.translate(
  'xpack.secops.auditd.startedCryptoSessionDescription',
  {
    defaultMessage: 'started crypto session',
  }
);

export const ACCESS_RESULT = i18n.translate('xpack.secops.auditd.accessResultDescription', {
  defaultMessage: 'access result',
});

export const ABORTED_AUDIT_STARTUP = i18n.translate(
  'xpack.secops.auditd.abortedAuditStartupDescription',
  {
...
export const REMOTE_AUDIT_CONNECTED = i18n.translate(
  'xpack.secops.auditd.remoteAuditConnectedDescription',
  {
...
export const REMOTE_AUDIT_DISCONNECTED = i18n.translate(
  'xpack.secops.auditd.remoteAuditDisconnectedDescription',
  {
    defaultMessage: 'remote audit disconnected',
  }
);

export const SHUTDOWN_AUDIT = i18n.translate('xpack.secops.auditd.shutDownAuditDescription', {
  defaultMessage: 'shutdown audit',
});

export const AUDIT_ERROR = i18n.translate('xpack.secops.auditd.auditErrorDescription', {
  defaultMessage: 'audit error',
});

export const RECONFIGURED_AUDIT = i18n.translate(
  'xpack.secops.auditd.reconfiguredAuditDescription',
  {
...
export const RESUMED_AUDIT_LOGGING = i18n.translate(
  'xpack.secops.auditd.resumedAuditLoggingDescription',
  {
...
export const ROTATED_AUDIT_LOGS = i18n.translate(
  'xpack.secops.auditd.rotatedAuditLogsDescription',
  {
    defaultMessage: 'rotated-audit-logs',
  }
);

export const STARTED_AUDIT = i18n.translate('xpack.secops.auditd.startedAuditDescription', {
  defaultMessage: 'started audit',
});

export const DELETED_GROUP_ACCOUNT_USING = i18n.translate(
  'xpack.secops.auditd.deletedGroupAccountUsingDescription',
  {
...
export const DELETED_USER_ACCOUNT_USING = i18n.translate(
  'xpack.secops.auditd.deletedUserAccountUsingDescription',
  {
...
export const CHANGED_AUDIT_FEATURE = i18n.translate(
  'xpack.secops.auditd.changedAuditFeatureDescription',
  {
...
export const RELABELED_FILESYSTEM = i18n.translate(
  'xpack.secops.auditd.relabeledFileSystemDescription',
  {
...
export const AUTHENTICATED_TO_GROUP = i18n.translate(
  'xpack.secops.auditd.authenticatedToGroupDescription',
  {
...
export const CHANGED_GROUP_PASSWORD = i18n.translate(
  'xpack.secops.auditd.changedGroupPasswordDescription',
  {
...
export const MODIFIED_GROUP_ACCOUNT = i18n.translate(
  'xpack.secops.auditd.modifiedGroupAccountDescription',
  {
...
export const INITIALIZED_AUDIT_SUBSYSTEM = i18n.translate(
  'xpack.secops.auditd.initializedAuditSubsystemDescription',
  {
    defaultMessage: 'initialized audit subsystem',
  }
);

export const MODIFIED_LEVEL_OF = i18n.translate('xpack.secops.auditd.modifiedLevelOfDescription', {
  defaultMessage: 'modified level of',
});

export const OVERRODE_LABEL_OF = i18n.translate('xpack.secops.auditd.overrodeLabelOfDescription', {
  defaultMessage: 'overrode label of',
});

export const CHANGED_LOGIN_ID_TO = i18n.translate(
  'xpack.secops.auditd.changedLoginIdToDescription',
  {
    defaultMessage: 'changed login id to',
  }
);

export const MAC_PERMISSION = i18n.translate('xpack.secops.auditd.macPermissionDescription', {
  defaultMessage: 'mac permission',
});

export const CHANGED_SELINUX_BOOLEAN = i18n.translate(
  'xpack.secops.auditd.changedSeLinuxBooleanDescription',
  {
...
export const LOADED_SELINUX_POLICY = i18n.translate(
  'xpack.secops.auditd.loadedSeLinuxPolicyDescription',
  {
...
export const CHANGED_SELINUX_ENFORCEMENT = i18n.translate(
  'xpack.secops.auditd.changedSelinuxEnforcementDescription',
  {
...
export const ASSIGNED_USER_ROLE_TO = i18n.translate(
  'xpack.secops.auditd.assignedUserRoleToDescription',
  {
    defaultMessage: 'assigned user role to',
  }
);

export const MODIFIED_ROLE = i18n.translate('xpack.secops.auditd.modifiedRoleDescription', {
  defaultMessage: 'modified role',
});

export const REMOVED_USER_ROLE_FROM = i18n.translate(
  'xpack.secops.auditd.removedUserRoleFromDescription',
  {
...
export const VIOLATED_SECCOMP_POLICY_WITH = i18n.translate(
  'xpack.secops.auditd.violatedSeccompPolicyWithDescription',
  {
    defaultMessage: 'violated seccomp policy with',
  }
);

export const STARTED_SERVICE = i18n.translate('xpack.secops.auditd.startedServiceDescription', {
  defaultMessage: 'started service',
});

export const STOPPED_SERVICE = i18n.translate('xpack.secops.auditd.stoppedServiceDescription', {
  defaultMessage: 'stopped service',
});

export const BOOTED_SYSTEM = i18n.translate('xpack.secops.auditd.bootedSystemDescription', {
  defaultMessage: 'booted system',
});

export const CHANGED_TO_RUN_LEVEL_WITH = i18n.translate(
  'xpack.secops.auditd.changedToRunLevelWithDescription',
  {
    defaultMessage: 'changed to run level with',
  }
);

export const SHUTDOWN_SYSTEM = i18n.translate('xpack.secops.auditd.shutdownSystemDescription', {
  defaultMessage: 'shutdown system',
});

export const SENT_TEST = i18n.translate('xpack.secops.auditd.sentTestDescription', {
  defaultMessage: 'sent test',
});

export const UNKNOWN = i18n.translate('xpack.secops.auditd.unknownDescription', {
  defaultMessage: 'unknown',
});

export const SENT_MESSAGE = i18n.translate('xpack.secops.auditd.sentMessageDescription', {
  defaultMessage: 'sent message',
});

export const ACCESS_PERMISSION = i18n.translate('xpack.secops.auditd.accessPermissionDescription', {
  defaultMessage: 'access permission',
});

export const AUTHENTICATED_USING = i18n.translate(
  'xpack.secops.auditd.authenticatedUsingDescription',
  {
...
export const CHANGED_PASSWORD_WITH = i18n.translate(
  'xpack.secops.auditd.changedPasswordWithDescription',
  {
    defaultMessage: 'changed password with',
  }
);

export const RAN_COMMAND = i18n.translate('xpack.secops.auditd.ranCommandDescription', {
  defaultMessage: 'ran command',
});

export const ERROR_FROM = i18n.translate('xpack.secops.auditd.errorFromDescription', {
  defaultMessage: 'error from',
});

export const LOGGED_OUT = i18n.translate('xpack.secops.auditd.loggedOutDescription', {
  defaultMessage: 'logged out',
});

export const CHANGED_MAC_CONFIGURATION = i18n.translate(
  'xpack.secops.auditd.changedMacConfigurationDescription',
  {
    defaultMessage: 'changed mac configuration',
  }
);

export const LOADED_MAC_POLICY = i18n.translate('xpack.secops.auditd.loadedMacPolicyDescription', {
  defaultMessage: 'loaded mac policy',
});

export const MODIFIED_USER_ACCOUNT = i18n.translate(
  'xpack.secops.auditd.modifiedUserAccountDescription',
  {
    defaultMessage: 'modified user account',
  }
);
export const CHANGED_ROLE_USING = i18n.translate(
  'xpack.secops.auditd.changedRoleUsingDescription',
  {
    defaultMessage: 'changed role using',
  }
);

export const ACCESS_ERROR = i18n.translate('xpack.secops.auditd.accessErrorDescription', {
  defaultMessage: 'access error',
});

export const CHANGED_CONFIGURATION_WITH = i18n.translate(
  'xpack.secops.auditd.changedConfigurationWIthDescription',
  {
    defaultMessage: 'changed configuration with',
  }
);

export const ISSUED_VM_CONTROL = i18n.translate('xpack.secops.auditd.issuedVmControlDescription', {
  defaultMessage: 'issued vm control',
});

export const CREATED_VM_IMAGE = i18n.translate('xpack.secops.auditd.createdVmImageDescription', {
  defaultMessage: 'created vm image',
});

export const DELETED_VM_IMAGE = i18n.translate('xpack.secops.auditd.deletedVmImageDescription', {
  defaultMessage: 'deleted vm image',
});

export const CHECKED_INTEGRITY_OF = i18n.translate(
  'xpack.secops.auditd.checkedIntegrityOfDescription',
  {
    defaultMessage: 'checked integrity of',
  }
);

export const ASSIGNED_VM_ID = i18n.translate('xpack.secops.auditd.assignedVmIdDescription', {
  defaultMessage: 'assigned vm id',
});

export const MIGRATED_VM_FROM = i18n.translate('xpack.secops.auditd.migratedVmFromDescription', {
  defaultMessage: 'migrated vm from',
});

export const MIGRATED_VM_TO = i18n.translate('xpack.secops.auditd.migratedVmToDescription', {
  defaultMessage: 'migrated vm to',
});

export const ASSIGNED_VM_RESOURCE = i18n.translate(
  'xpack.secops.auditd.assignedVMResourceDescription',
  {

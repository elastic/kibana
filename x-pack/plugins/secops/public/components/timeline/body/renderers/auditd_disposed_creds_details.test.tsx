...
import { AuditdDisposedDetails, AuditdDisposedLine } from './auditd_disposed_creds_details';

describe('AuditDisposedCredsDetails', () => {
  describe('rendering', () => {
    test('it renders the default AuditDisposedCredsDetails', () => {
    ...
    test('it returns auditd disposed if the data does contain auditd disposed data', () => {
      const wrapper = mountWithIntl(
        <TestProviders>
          <AuditdDisposedDetails browserFields={mockBrowserFields} data={mockEcsData[19]} />
        </TestProviders>
      );
    ...
    test('it returns null for text if the data contains no auditd data', () => {
      const wrapper = mountWithIntl(
        <TestProviders>
          <AuditdDisposedDetails browserFields={mockBrowserFields} data={mockEcsData[0]} />
        </TestProviders>
      );
  ...
  describe('#AuditdDisposedLine', () => {
    test('it returns pretty output if you send in all your happy path data', () => {
      ...
      expect(wrapper.text()).toEqual(
        'Sessionsession-1username-1@host-1inworking-directory-1disposed credentials toprocess-1arg1 arg2 arg3'
      );
    });
    ...
    test('it returns a session with "as" wording if username, primary, and secondary are all different', () => {
      ...
      expect(wrapper.text()).toEqual(
        'Sessionsession-1[username-2]as[username-3]@host-1inworking-directory-1disposed credentials toprocess-1arg1 arg2 arg3'
      );
    });
    ...
    test('it returns a session with "as" wording if username and primary are the same but secondary is different', () => {
      ...
      expect(wrapper.text()).toEqual(
        'Sessionsession-1[username-1]as[username-2]@host-1inworking-directory-1disposed credentials toprocess-1arg1 arg2 arg3'
      );
    });
    ...
    test('it returns a session with primary if username and secondary are unset with different casing', () => {
      ...
      expect(wrapper.text()).toEqual(
        'Sessionsession-1[username-primary]@host-1inworking-directory-1disposed credentials toprocess-1arg1 arg2 arg3'
      );
    });
    ...
    test('it returns only a process name if only given a process name and id', () => {
      ...
      expect(wrapper.text()).toEqual('Sessiondisposed credentials tosome-process-name');
    });

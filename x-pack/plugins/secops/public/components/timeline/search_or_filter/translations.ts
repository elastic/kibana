...
export const FILTER_DESCRIPTION = i18n.translate(
  'xpack.secops.timeline.searchOrFilter.filterDescription',
  {
...
export const FILTER_KQL_TOOLTIP = i18n.translate(
  'xpack.secops.timeline.searchOrFilter.filterKqlTooltip',
  {
...
export const FILTER_KQL_PLACEHOLDER = i18n.translate(
  'xpack.secops.timeline.searchOrFilter.filterKqlPlaceholder',
  {
...
export const FILTER_KQL_SELECTED_TEXT = i18n.translate(
  'xpack.secops.timeline.searchOrFilter.filterKqlSelectedText',
  {
...
export const SEARCH_DESCRIPTION = i18n.translate(
  'xpack.secops.timeline.searchOrFilter.searchDescription',
  {
    defaultMessage:
...
export const SEARCH_KQL_TOOLTIP = i18n.translate(
  'xpack.secops.timeline.searchOrFilter.searchKqlTooltip',
  {
...
export const SEARCH_KQL_PLACEHOLDER = i18n.translate(
  'xpack.secops.timeline.searchOrFilter.searchKqlPlaceholder',
  {
...
export const SEARCH_KQL_SELECTED_TEXT = i18n.translate(
  'xpack.secops.timeline.searchOrFilter.searchKqlSelectedText',
  {

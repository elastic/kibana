export const ECSFIELDS = {
  ...
  'cloud.origin.project.id': 'The cloud project identifier.\nExamples: Google Cloud Project id, Azure Project id.',
  ...
  'cloud.project.id': 'The cloud project identifier.\nExamples: Google Cloud Project id, Azure Project id.',
  ...
  'cloud.target.project.id': 'The cloud project identifier.\nExamples: Google Cloud Project id, Azure Project id.',
  ...
  'process.title':
    'Process title.\nThe proctitle, some times the same as process name. Can also be different: for example a browser setting its title to the web page currently opened.',
  'process.tty': 'Information about the controlling TTY device. If set, the process belongs to an interactive session.',
  ...
  'threat.indicator.url.registered_domain':
    'The highest registered url domain, stripped of the subdomain.\nFor example, the registered domain for "foo.example.com" is "example.com".\nThis value can be determined precisely with a list like the public suffix list (http://publicsuffix.org). Trying to approximate this by simply taking the last two labels will not work well for TLDs such as "co.uk".',
  'threat.indicator.url.scheme': 'Scheme of the request, such as "https".\nNote: The `:` is not part of the scheme.',

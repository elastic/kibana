...
- When creating if conditions, the path should not try to access a key that only exists inside a stringified object. Only use it to access field paths that are available in the current context.

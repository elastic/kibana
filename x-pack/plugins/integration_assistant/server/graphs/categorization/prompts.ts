...
export const CATEGORIZATION_VALIDATION_PROMPT = ChatPromptTemplate.fromMessages([
  ...
  {invalid_categorization}
    ...
    ["human", "Please go through each error above, carefully review the provided current processors, and resolve the most likely cause to the supplied error by returning an updated version of the current_processors.

...
import { LOCAL_STORAGE_PAGINATION_RULES_KEY } from '../../../common/constants';
...
export const RulesContainer = () => {
  ...
  const [pageSizes, setPageSize] = useLocalStorage<number>(LOCAL_STORAGE_PAGINATION_RULES_KEY, 10);

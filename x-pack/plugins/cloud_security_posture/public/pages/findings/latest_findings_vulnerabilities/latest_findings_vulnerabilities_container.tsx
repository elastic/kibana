...
import { useLatestFindingsVulnerabilities } from './use_latest_findings_vulnerabilities';
import type { FindingsGroupByNoneQuery } from './use_latest_findings_vulnerabilities';
...
export const LatestFindingsVulnerabilitiesContainer = ({ dataView }: FindingsBaseProps) => {
   ...
   */
  const findingsGroupByNone = useLatestFindingsVulnerabilities({
  ...
  return (
    <div data-test-subj={TEST_SUBJECTS.FINDINGS_CONTAINER}>
      ...
      <EuiFlexGroup>
        <EuiFlexItem>
          <LatestFindingsVulnerabilitiesPageTitle />
        </EuiFlexItem>
...
const LatestFindingsVulnerabilitiesPageTitle = () => (
  <PageTitle>
    <PageTitleText
      title={
        <CloudPosturePageTitle
          title={i18n.translate(
            'xpack.csp.findings.latestFindings.latestFindingsVulnerabilitiesPageTitle',
            {
              defaultMessage: 'Vulnerabilities',
            }
          )}

...
import { LOCAL_STORAGE_PAGINATION_BENCHMARK_KEY } from '../../../common/constants';
...
export const Benchmarks = () => {
  const [pageSizes, setPageSize] = useLocalStorage<number>(
    LOCAL_STORAGE_PAGINATION_BENCHMARK_KEY,
    10
  );

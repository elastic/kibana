 ...
 * This needs to match the cloud security posture page entries in `SecurityPageName` in `x-pack/solutions/security/solutions/security/plugins/security_solution/common/constants.ts`.
 */

    ...
    .addVersion(
      ...
      async (context, request, response) => {
        ...
        try {
          ...
          const updatedBenchmarkRules = handlerResponse.newCspSettings.attributes.rules;
          const disabledDetectionRules = handlerResponse.disabledRules.rules.length;
          return response.ok({
            body: {
              updated_benchmark_rules: updatedBenchmarkRules,
              detection_rules: `disabled ${disabledDetectionRules} detections rules.`,

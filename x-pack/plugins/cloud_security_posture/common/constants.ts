...
export const LOCAL_STORAGE_PAGE_SIZE_RESOURCE_FINDINGS_KEY = 'cloudPosture:resourceFindings:pageSize';
export const LOCAL_STORAGE_PAGE_SIZE_FINDINGS_BY_RESOURCE_KEY = 'cloudPosture:findingsByResource:pageSize';

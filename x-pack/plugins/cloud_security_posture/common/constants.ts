...
export const CDR_LATEST_THIRD_PARTY_VULNERABILITIES_INDEX_PATTERN =
  'logs-wiz.vulnerability-default'; // TODO: Update before merge to security_solution-wiz.vulnerability_latest-*
export const CDR_VULNERABILITIES_INDEX_PATTERN = `${CDR_LATEST_THIRD_PARTY_VULNERABILITIES_INDEX_PATTERN},${CDR_LATEST_NATIVE_VULNERABILITIES_INDEX_PATTERN}`; // TODO: use the same naming as Missconfiguration

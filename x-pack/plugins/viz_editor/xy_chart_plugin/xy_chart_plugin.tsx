...
import { SelectOperation, SelectOperator, TermsOperation } from '../common';
...
function dataPanel(props: PanelComponentProps<XyChartVisModel>) {
  // TODO: This is only pulling from the XY visualization, not going across plugins
  return <IndexPatternPanel {...props} getSuggestionsForField={getSuggestionsForField} />;
}

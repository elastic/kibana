              ...
              steps={[
                ...
                },
                {
                    ...
                    <>
                      ...
                      <EuiText size="s">
                        <FormattedMessage
                          ...
                          defaultMessage="We automatically generate a connector configuration, a new Elasticsearch index, and an API key. This information will be added to the {configYaml} file of your connector. You can also use an existing API key. "
                          values={{
                            configYaml: (
                              <EuiCode>
                                {i18n.translate(
                  ...
                  title: i18n.translate(
                    ...
                    {
                      defaultMessage: 'Generate index and API key',
                    }
                  ),
                  titleSize: 'xs',
                },

...
const ManagedPipelineBadge: React.FC<React.PropsWithChildren<unknown>> = () => (
  <EuiToolTip
    position="top"
...
const UnmanagedPipelineBadge: React.FC<React.PropsWithChildren<unknown>> = () => (
  <EuiToolTip
    position="top"
    content={
      <FormattedMessage
...
const SharedPipelineBadge: React.FC<React.PropsWithChildren<unknown>> = () => (
  <EuiToolTip
    position="top"
    content={i18n.translate(
...
const IndexPipelineBadge: React.FC<React.PropsWithChildren<unknown>> = () => (
  <EuiToolTip
    position="top"
    content={i18n.translate(
...
const MlInferenceBadge: React.FC<React.PropsWithChildren<unknown>> = () => (
  <EuiToolTip
    position="top"
    content={i18n.translate(
...
export const PipelineJSONBadges: React.FC<React.PropsWithChildren<unknown>> = () => {
  const {
    indexName,

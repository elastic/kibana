...
export const AddMLInferencePipelineButton: React.FC<React.PropsWithChildren<AddMLInferencePipelineButtonProps>> = ({
  onClick,
}) => {
...
const AddButton: React.FC<React.PropsWithChildren<{
  disabled?: boolean;

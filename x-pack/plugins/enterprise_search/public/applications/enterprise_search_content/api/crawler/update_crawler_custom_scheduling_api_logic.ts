...
interface UpdateCrawlerCustomSchedulingRequest {
  index_name: string;
  language: LanguageForOptimization;
}
...
export const updateCrawlerCustomScheduling = async ({ indexName, customScheduling }: CreateCrawlerIndexArgs) => {
  ...
  return await HttpLogic.values.http.post<>(

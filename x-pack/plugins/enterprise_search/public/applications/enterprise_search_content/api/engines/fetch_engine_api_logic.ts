...
export type FetchEngineApiResponse = EnterpriseSearchEngineDetailsResponse;
...
export const fetchEngine = async ({
  ...
  return await HttpLogic.values.http.get<EnterpriseSearchEngineDetailsResponse>(route);
};

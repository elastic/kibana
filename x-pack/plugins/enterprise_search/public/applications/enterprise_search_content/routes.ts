...
export const SEARCH_INDICIES_PATH = `${ROOT_PATH}search_indices`;
export const SETTINGS_PATH = `${ROOT_PATH}settings`;

export const NEW_INDEX_PATH = `${SEARCH_INDICIES_PATH}/new_index`;
...
export const SEARCH_INDEX_PATH = `${SEARCH_INDICIES_PATH}/:indexSlug`;

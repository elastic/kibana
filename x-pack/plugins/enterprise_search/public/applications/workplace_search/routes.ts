...
export const ADD_SHAREPOINT_EXTERNAL_PATH = `${SOURCES_PATH}/add/share_point_external`;
...
export const EDIT_SHAREPOINT_EXTERNAL_PATH = `${ORG_SETTINGS_CONNECTORS_PATH}/share_point_external/edit`;

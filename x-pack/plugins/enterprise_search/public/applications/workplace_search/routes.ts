...
export const DOCS_PREFIX = docLinksService.workplaceSearchBase;
...
export const ENT_SEARCH_LICENSE_MANAGEMENT = `${docLinksService.enterpriseSearchBase}/license-management.html`;

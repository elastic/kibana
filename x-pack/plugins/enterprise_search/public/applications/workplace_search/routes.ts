...
// TODO: Find a way to get this here correctly in Kibana.
export const PRODUCT_VERSION = '7.10';
...
export const DOCS_PREFIX = `https://www.elastic.co/guide/en/workplace-search/${PRODUCT_VERSION}`;
export const ENT_SEARCH_DOCS_PREFIX = `https://www.elastic.co/guide/en/enterprise-search/${PRODUCT_VERSION}`;

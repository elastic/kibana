...
export const ADD_ONEDRIVE_PATH = `${SOURCES_PATH}/add/one-drive`;
...
export const ADD_SERVICENOW_PATH = `${SOURCES_PATH}/add/service-now`;
export const ADD_SHAREPOINT_PATH = `${SOURCES_PATH}/add/share-point`;
...
export const EDIT_ONEDRIVE_PATH = `${ORG_SETTINGS_CONNECTORS_PATH}/one-drive/edit`;
...
export const EDIT_SERVICENOW_PATH = `${ORG_SETTINGS_CONNECTORS_PATH}/service-now/edit`;
export const EDIT_SHAREPOINT_PATH = `${ORG_SETTINGS_CONNECTORS_PATH}/share-point/edit`;

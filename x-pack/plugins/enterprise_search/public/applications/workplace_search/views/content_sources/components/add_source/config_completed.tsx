...
export const ConfigCompleted: React.FC<ConfigCompletedProps> = ({ advanceStep, header }) => {
  const { sourceConfigData } = useValues(AddSourceLogic);

  const { name, serviceType, accountContextOnly, privateSourcesEnabled } = sourceConfigData;

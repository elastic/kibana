...
import { FeatureIds, SourceDataConfig, SourceDataItem } from '../../types';

export const staticSourceConfig: SourceDataConfig[] = [
  {
...
export const staticSourceData: SourceDataItem[] = staticSourceConfig
  .map((value) => value.internal)
  .filter((value) => value !== undefined) as SourceDataItem[];

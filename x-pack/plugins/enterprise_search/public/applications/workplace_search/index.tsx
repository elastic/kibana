...
export const WorkplaceSearch: React.FC<React.PropsWithChildren<InitialAppData>> = (props) => {
...
export const WorkplaceSearchUnconfigured: React.FC<React.PropsWithChildren<unknown>> = () => (
  <Switch>

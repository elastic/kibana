...
export const InvalidDocumentsSummary: React.FC<React.PropsWithChildren<unknown>> = () => {
  const {
...
export const ValidDocumentsSummary: React.FC<React.PropsWithChildren<unknown>> = () => {
  const {
...
export const SchemaFieldsSummary: React.FC<React.PropsWithChildren<unknown>> = () => {
  const {

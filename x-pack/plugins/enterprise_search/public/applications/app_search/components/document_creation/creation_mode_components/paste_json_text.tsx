...
export const PasteJsonTextTabContent: React.FC<React.PropsWithChildren<unknown>> = () => {
  const {
    configuredLimits: {
...
export const PasteJsonTextFooterContent: React.FC<React.PropsWithChildren<unknown>> = () => {

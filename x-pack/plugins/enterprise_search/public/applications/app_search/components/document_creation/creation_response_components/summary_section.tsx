...
export const SummarySectionAccordion: React.FC<
  React.PropsWithChildren<SummarySectionAccordionProps>
...
export const SummarySectionEmpty: React.FC<React.PropsWithChildren<SummarySectionEmptyProps>> = ({
  title,
}) => {
  return (

...
export const SummarySectionAccordion: React.FC<React.PropsWithChildren<SummarySectionAccordionProps>> = ({
  id,
  status,
  title,
  children,
...
export const SummarySectionEmpty: React.FC<React.PropsWithChildren<SummarySectionEmptyProps>> = ({ title }) => {
  return (

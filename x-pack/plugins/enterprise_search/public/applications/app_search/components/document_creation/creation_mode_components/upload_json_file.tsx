...
export const UploadJsonFileTabContent: React.FC<React.PropsWithChildren<unknown>> = () => {
  const {
    configuredLimits: {
...
export const UploadJsonFileFooterContent: React.FC<React.PropsWithChildren<unknown>> = () => {

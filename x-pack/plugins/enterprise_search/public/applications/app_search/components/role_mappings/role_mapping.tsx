...
import { AppLogic, AppValues } from '../../app_logic';
...
export const RoleMapping: React.FC<RoleMappingProps> = ({ isNew }) => {
  ...
  const { myRole } = useValues(AppLogic) as AppValues;
  ...
  const {
    ...
    resetState,
  } = useActions(RoleMappingsLogic) as RoleMappingsActions;
  ...
  } = useValues(RoleMappingsLogic) as RoleMappingsValues;

                ...
                },
                {
                  ...
                  children: [
                    ...
                    },
                    {
                      ...
                      title: i18n.translate(
                        'xpack.enterpriseSearch.searchNav.ml.anomaly_detection',
                        {
                      ...
                      children: [
                        {
                          ...
                          title: i18n.translate(
                            'xpack.enterpriseSearch.searchNav.ml.anomaly_detection.jobs',
                            {
                              defaultMessage: 'Jobs',
                            }
                          ),
                    ...
                    },
                    {
                      ...
                      title: i18n.translate(
                        'xpack.enterpriseSearch.searchNav.ml.data_frame_analytics',
                        {
                      ...
                      children: [
                        {
                          ...
                          title: i18n.translate(
                            'xpack.enterpriseSearch.searchNav.ml.data_frame_analytics.jobs',
                            {
                              defaultMessage: 'Jobs',
                            }
                          ),
                    ...
                    },
                    {
                      ...
                      title: i18n.translate(
                        'xpack.enterpriseSearch.searchNav.ml.model_management',
                        {
                    ...
                    },
                    {
                      ...
                      title: i18n.translate('xpack.enterpriseSearch.searchNav.ml.data_visualizer', {
                      ...
                      children: [
                        {
                          link: 'ml:fileUpload',
                          title: i18n.translate(
                            'xpack.enterpriseSearch.searchNav.ml.data_visualizer.file_data_visualizer',
                            {
                    ...
                    },
                    {
                      ...
                      title: i18n.translate('xpack.enterpriseSearch.searchNav.ml.aiops_labs', {

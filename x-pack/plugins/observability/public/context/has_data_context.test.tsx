  ...
  describe('when no plugin has registered', () => {
    it('hasAnyData returns undefined and all apps return undefined', async () => {
      ...
      expect(result.current).toEqual({
        hasDataMap: {
          apm: { hasData: undefined, status: 'success', show: true },
          synthetics: { hasData: undefined, status: 'success', show: true },
          infra_logs: { hasData: undefined, status: 'success', show: true },
          infra_metrics: { hasData: undefined, status: 'success', show: true },
          ux: { hasData: undefined, status: 'success', show: true },
          alert: { hasData: false, status: 'success', show: true },
        },
        hasAnyData: false,
  ...
  describe('when plugins have registered', () => {
    describe('all apps return false', () => {
      ...
      it('hasAnyData returns false and all apps return false', async () => {
        ...
        expect(result.current).toEqual({
          hasDataMap: {
            apm: { hasData: false, status: 'success', show: true },
            synthetics: {
              hasData: false,
              status: 'success',
              show: true,
            },
            infra_logs: { hasData: false, indices: 'test-index', status: 'success', show: true },
            infra_metrics: { hasData: false, status: 'success', show: true },
            ux: {
              hasData: false,
              status: 'success',
              show: true,
    ...
    describe('at least one app returns true', () => {
      ...
      it('hasAnyData returns true apm returns true and all other apps return false', async () => {
        ...
        expect(result.current).toEqual({
          hasDataMap: {
            apm: { hasData: true, status: 'success', show: true },
            synthetics: {
              hasData: false,
            ...
            infra_logs: { hasData: false, indices: 'test-index', status: 'success', show: true },
            infra_metrics: { hasData: false, indices: 'metric-*', status: 'success', show: true },
            ux: {
              hasData: false,
              indices: 'apm-*',
              status: 'success',
      ...
      it('hasAnyData returns true and all apps return true', async () => {
        ...
        expect(result.current).toEqual({
          hasDataMap: {
            ...
            infra_logs: { hasData: true, indices: 'test-index', status: 'success', show: true },
            infra_metrics: { hasData: true, indices: 'metric-*', status: 'success', show: true },
            ux: {
              hasData: true,
              serviceName: 'ux',
              indices: 'apm-*',
    ...
    describe('only apm is registered', () => {
      describe('when apm returns true', () => {
        ...
        it('hasAnyData returns true, apm returns true and all other apps return undefined', async () => {
          ...
          expect(result.current).toEqual({
            hasDataMap: {
              apm: { hasData: true, indices: sampleAPMIndices, status: 'success', show: true },
              synthetics: { hasData: undefined, status: 'success', show: true },
              infra_logs: { hasData: undefined, status: 'success', show: true },
              infra_metrics: { hasData: undefined, status: 'success', show: true },
              ux: { hasData: undefined, status: 'success', show: true },
    ...
    describe('when an app throws an error while fetching', () => {
      ...
      it('hasAnyData returns true, apm is undefined and all other apps return true', async () => {
        ...
        expect(result.current).toEqual({
          hasDataMap: {
            apm: { hasData: undefined, status: 'failure', show: true },
            synthetics: {
              hasData: true,
              indices: 'heartbeat-*, synthetics-*',
              status: 'success',
    ...
    describe('when all apps throw an error while fetching', () => {
      ...
      it('hasAnyData returns false and all apps return undefined', async () => {
        ...
        expect(result.current).toEqual({
          hasDataMap: {
            apm: { hasData: undefined, status: 'failure', show: true },
            synthetics: { hasData: undefined, status: 'failure', show: true },
            infra_logs: { hasData: undefined, status: 'failure', show: true },
            infra_metrics: { hasData: undefined, status: 'failure', show: true },
            ux: { hasData: undefined, status: 'failure', show: true },
            alert: { hasData: false, status: 'success', show: true },
          },
          hasAnyData: false,
          isAllRequestsComplete: true,

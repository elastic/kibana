...
const groupByOptions: Option[] = [
  {
    text: i18n.translate('xpack.observability.slo.list.groupBy.tags', {
  ...
  {
    text: i18n.translate('xpack.observability.slo.list.groupBy.sliType', {
...
export function SloGroupConfiguration({ onSelected }) {
  ...
  return (
    <>
      <EuiFormRow
        fullWidth
        label={i18n.translate('xpack.observability.sloGroupConfiguration.groupTypeLabel', {
      ...
      <EuiFlexGroup>
        <EuiFlexItem>
          <EuiText>
            {i18n.translate('xpack.observability.sloGroupConfiguration.viewModeTextLabel', {

...
const fieldValuesSearchRoute = createObservabilityServerRoute({
  endpoint: 'GET /api/observability/field_values_search',
  options: {
    tags: [],
  },
  params: t.type({
...
export const fieldValuesRouteRepository = createObservabilityServerRouteRepository().add(
  fieldValuesSearchRoute
);

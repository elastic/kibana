...
export class OIDCAuthenticationProvider extends BaseAuthenticationProvider {
  ...
  public async login(
    ...
    } else if (attempt.type === OIDCLogin.LoginInitiatedByUser) {
    ...
    } else if (attempt.type === OIDCLogin.LoginWithImplicitFlow) {
  ...
  private async initiateOIDCAuthentication(
    ...
    try {
      ...
      return AuthenticationResult.redirectTo(
        ...
        { state: { state, nonce, nextURL: redirectURL, realm: this.realm } }
      );
    } catch (err) {

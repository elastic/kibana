  ...
  test('actions defined at the feature cascade to the privileges', () => {
    ...
    expect(actual).toHaveProperty('features.foo-feature', {
      all: [
        ...
        actions.savedObject.get('telemetry', 'bulk_get'),
        actions.savedObject.get('telemetry', 'get'),
        actions.savedObject.get('telemetry', 'find'),
        actions.savedObject.get('telemetry', 'create'),
        actions.savedObject.get('telemetry', 'bulk_create'),
        actions.savedObject.get('telemetry', 'update'),
        actions.savedObject.get('telemetry', 'delete'),
        actions.savedObject.get('config', 'bulk_get'),
        actions.savedObject.get('config', 'get'),
        actions.savedObject.get('config', 'find'),
        actions.ui.get('savedObjectsManagement', 'telemetry', 'delete'),
        actions.ui.get('savedObjectsManagement', 'telemetry', 'edit'),
        actions.ui.get('savedObjectsManagement', 'telemetry', 'read'),
        actions.ui.get('savedObjectsManagement', 'config', 'read'),
        actions.allHack,
      ],
      read: [
        actions.login,

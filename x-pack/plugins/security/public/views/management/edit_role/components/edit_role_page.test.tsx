...
import { actionsFactory } from 'x-pack/plugins/security/server/lib/authorization/actions';
...
const buildPrivilegeMap = () => {
  ...
  return privilegesFactory(['config', 'feature2'], actions, xpackMainPlugin).get();
};

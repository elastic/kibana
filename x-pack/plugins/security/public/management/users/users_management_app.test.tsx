...
describe('usersManagementApp', () => {
  ...
  it('mount() works for the `grid` page', async () => {
    ...
    expect(container).toMatchInlineSnapshot(`
      <div>
        Users Page: {"notifications":{"toasts":{}},"userAPIClient":{"http":{"basePath":{"basePath":""},"anonymousPaths":{}}},"rolesAPIClient":{"http":{"basePath":{"basePath":""},"anonymousPaths":{}}}}
      </div>
    `);
  ...
  it('mount() works for the `create user` page', async () => {
    ...
    expect(container).toMatchInlineSnapshot(`
      <div>
        User Edit Page: {"authc":{},"userAPIClient":{"http":{"basePath":{"basePath":""},"anonymousPaths":{}}},"rolesAPIClient":{"http":{"basePath":{"basePath":""},"anonymousPaths":{}}},"notifications":{"toasts":{}}}
      </div>
    `);
  ...
  it('mount() works for the `edit user` page', async () => {
    ...
    expect(container).toMatchInlineSnapshot(`
      <div>
        User Edit Page: {"authc":{},"userAPIClient":{"http":{"basePath":{"basePath":""},"anonymousPaths":{}}},"rolesAPIClient":{"http":{"basePath":{"basePath":""},"anonymousPaths":{}}},"notifications":{"toasts":{}},"username":"someUserName"}
      </div>
    `);

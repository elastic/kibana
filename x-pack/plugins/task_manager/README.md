...
- `internal.exclude_task_types` - Which task types to exclude from execution by ensuring they are never claimed. Supports wildcard usage (such as `actions:*`). This is intended for debugging use only

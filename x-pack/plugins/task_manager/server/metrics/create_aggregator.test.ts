        ...
        taskRunAggregator
          ...
          .subscribe((metrics: Array<AggregatedStat<TaskRunMetric>>) => {
            expect(metrics[0]).toEqual({
              key: 'task_run',
              value: {
                overall: { success: 1, on_time: 1, total: 1 },
                by_type: {
            ...
            expect(metrics[2]).toEqual({
              key: 'task_run',
              value: {
                overall: { success: 3, on_time: 3, total: 3 },
                by_type: {
            ...
            expect(metrics[3]).toEqual({
              key: 'task_run',
              value: {
                overall: { success: 4, on_time: 4, total: 4 },
                by_type: {
                  alerting: { success: 2, on_time: 2, total: 2 },
                  'alerting:example': { success: 2, on_time: 2, total: 2 },
            ...
            expect(metrics[4]).toEqual({
              key: 'task_run',
              value: {
                overall: { success: 4, on_time: 5, total: 5 },
                by_type: {
            ...
            expect(metrics[5]).toEqual({
              key: 'task_run',
              value: {
                overall: { success: 5, on_time: 6, total: 6 },
                by_type: {
            ...
            expect(metrics[6]).toEqual({
              key: 'task_run',
              value: {
                overall: { success: 6, on_time: 7, total: 7 },
                by_type: {
            ...
            expect(metrics[7]).toEqual({
              key: 'task_run',
              value: {
                overall: { success: 6, on_time: 8, total: 8 },
                by_type: {
            ...
            expect(metrics[8]).toEqual({
              key: 'task_run',
              value: {
                overall: { success: 7, on_time: 9, total: 9 },
                by_type: {
            ...
            expect(metrics[9]).toEqual({
              key: 'task_run',
              value: {
                overall: { success: 7, on_time: 10, total: 10 },
                by_type: {
        ...
        taskRunAggregator
          ...
          .subscribe((metrics: Array<AggregatedStat<TaskRunMetric>>) => {
            ...
            expect(metrics[7]).toEqual({
              key: 'task_run',
              value: {
                overall: { success: 2, on_time: 3, total: 3 },
                by_type: {
                  alerting: { success: 2, on_time: 3, total: 3 },
                  'alerting:example': { success: 2, on_time: 3, total: 3 },
                  report: { success: 0, on_time: 0, total: 0 },
            ...
            expect(metrics[8]).toEqual({
              key: 'task_run',
              value: {
                overall: { success: 3, on_time: 4, total: 4 },
                by_type: {
                  alerting: { success: 3, on_time: 4, total: 4 },
                  'alerting:example': { success: 3, on_time: 4, total: 4 },
                  report: { success: 0, on_time: 0, total: 0 },
            ...
            expect(metrics[9]).toEqual({
              key: 'task_run',
              value: {
                overall: { success: 3, on_time: 5, total: 5 },
                by_type: {
                  actions: { success: 0, on_time: 1, total: 1 },
                  alerting: { success: 3, on_time: 4, total: 4 },
                  'actions:webhook': { success: 0, on_time: 1, total: 1 },

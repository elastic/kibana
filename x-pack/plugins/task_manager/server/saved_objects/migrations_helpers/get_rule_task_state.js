...
/*
Used to get task documents for rules for a migration test.  Run it 
against a specific stack version you want to capture data for, as 
the "old" version.

It generates task documents you can paste into a test, or probably
just parts of.
...
const KBN_URL = process.env.KBN_URL || 'http://elastic:changeme@localhost:5601';
const ES_URL = process.env.ES_URL || 'http://elastic:changeme@localhost:9200';

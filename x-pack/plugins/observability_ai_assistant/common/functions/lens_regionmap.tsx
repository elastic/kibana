...
export const lensRegionmapFunctionDefinition = {
  ...
  parameters: {
    ...
    required: ['esql', 'start', 'end', 'value', 'breakdown'],
  } as const,
};

export type LensRegionmapFunctionArguments = FromSchema<
  typeof lensRegionmapFunctionDefinition['parameters']
>;

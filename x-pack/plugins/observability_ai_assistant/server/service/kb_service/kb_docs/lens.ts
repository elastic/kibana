  ...
  service.addToKnowledgeBase([
    {
      ...
      * Math functions like \`round()\`
      ...
      Formula should never be empty, as this will produce an error.`,
      ],
    },
    {
    ...
    },
    {
      ...
      lens() function is used to generate charts. Below are some common examples of how the function can be used:',
        'to show a bar chart:
      ...
      lens({
        ...
        "args": {
          ...
          "timeField": "products.category.keyword",
          "start": "now-30d",
          "end": "now",
          "chartType": "heatmap"
        }

...
describe('ES|QL query generation', () => {
  ...
  describe('APM queries', () => {
    ...
    it('error logs rate', async () => {
      await evaluateEsqlQuery({
        question: `i have logs in logs-apm* . errors are found when log.level contais the value ERROR. generate a query to obtain the error rate as a percetage of the total logs per day for the last 7 days`,

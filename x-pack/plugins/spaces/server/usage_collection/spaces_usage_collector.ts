  ...
  return usageCollection.makeUsageCollector<UsageData>({
    ...
    schema: {
      ...
      'apiCalls.copySavedObjects.total': {
        type: 'long',
        _meta: {
          description: 'The number of times the "Copy to Space" API has been called.',
        },
      },
      'apiCalls.copySavedObjects.kibanaRequest.yes': {
        type: 'long',
        _meta: {
          description: 'The number of times the "Copy to Space" API has been called via Kibana.',
        },
      },
      'apiCalls.copySavedObjects.kibanaRequest.no': {
        ...
        _meta: {
          description:
            'The number of times the "Copy to Space" API has been called via an API consumer (e.g. curl).',
        },
      },
      'apiCalls.copySavedObjects.createNewCopiesEnabled.yes': {
        ...
        _meta: {
          description:
            'The number of times the "Copy to Space" API has been called with "createNewCopies" set to true.',
        },
      },
      'apiCalls.copySavedObjects.createNewCopiesEnabled.no': {
        ...
        _meta: {
          description:
            'The number of times the "Copy to Space" API has been called with "createNewCopies" set to false.',
        },
      },
      'apiCalls.copySavedObjects.overwriteEnabled.yes': {
        ...
        _meta: {
          description:
            'The number of times the "Copy to Space" API has been called with "overwrite" set to true.',
        },
      },
      'apiCalls.copySavedObjects.overwriteEnabled.no': {
        ...
        _meta: {
          description:
            'The number of times the "Copy to Space" API has been called with "overwrite" set to false.',
        },
      },
      'apiCalls.resolveCopySavedObjectsErrors.total': {
        ...
        _meta: {
          description:
            'The number of times the "Resolve Copy to Space Conflicts" API has been called.',
        },
      },
      'apiCalls.resolveCopySavedObjectsErrors.kibanaRequest.yes': {
        ...
        _meta: {
          description:
            'The number of times the "Resolve Copy to Space Conflicts" API has been called via Kibana.',
        },
      },
      'apiCalls.resolveCopySavedObjectsErrors.kibanaRequest.no': {
        ...
        _meta: {
          description:
            'The number of times the "Resolve Copy to Space Conflicts" API has been called via an API consumer (e.g. curl).',
        },
      },
      'apiCalls.resolveCopySavedObjectsErrors.createNewCopiesEnabled.yes': {
        ...
        _meta: {
          description:
            'The number of times the "Resolve Copy to Space Conflicts" API has been called with "createNewCopies" set to true.',
        },
      },
      'apiCalls.resolveCopySavedObjectsErrors.createNewCopiesEnabled.no': {
        ...
        _meta: {
          description:
            'The number of times the "Resolve Copy to Space Conflicts" API has been called with "createNewCopies" set to false.',
        },
      },
    },

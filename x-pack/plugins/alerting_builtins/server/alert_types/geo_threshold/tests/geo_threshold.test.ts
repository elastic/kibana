      ...
      expect(transformedResults).toEqual([
        {
          ...
          entityName: '936',
          location: ['40.62806099653244, -82.8814151789993'],
        ...
        },
        {
          ...
          entityName: 'AAL2019',
          location: ['39.006176185794175, -82.22068064846098'],
          shapeLocationId: '0DrJu3QB6yyY-xQxv6Ip',
        },
        {
          dateInShape: '2020-09-28T18:01:41.191Z',
          docId: 'n-ng1XQB6yyY-xQxnGSM',
          entityName: 'AAL2323',
          location: ['41.6677269525826, -84.71324851736426'],
          shapeLocationId: '0DrJu3QB6yyY-xQxv6Ip',
        },
        {
          ...
          entityName: 'ABD5250',
          location: ['39.07997465226799, 6.073727197945118'],
          shapeLocationId: '0DrJu3QB6yyY-xQxv6Ip',
        },
      ]);
    });
      ...
      const currLocationArr = [
        {
          ...
          docId: 'N-ng1XQB6yyY-xQxnGSM',
          entityName: '936',
          location: ['41.62806099653244, -82.8814151789993'],
        ...
        },
        {
          ...
          docId: 'iOng1XQB6yyY-xQxnGSM',
          entityName: 'AAL2019',
          location: ['38.006176185794175, -82.22068064846098'],
      ...
      const prevLocationArr = [
        {
          ...
          entityName: '936',
          location: ['20.62806099653244, -82.8814151789993'],

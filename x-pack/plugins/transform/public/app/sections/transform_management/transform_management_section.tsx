        ...
        <EuiTitle size="s">
          <EuiText color="subdued">
            <FormattedMessage
              ...
              defaultMessage="Use transforms to pivot existing Elasticsearch indices into summarized entity-centric indices or to find the latest document for each unique key."
            />
          </EuiText>
        </EuiTitle>
        <EuiPageContentBody>

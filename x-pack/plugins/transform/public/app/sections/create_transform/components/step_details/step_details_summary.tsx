...
export const StepDetailsSummary: FC<React.PropsWithChildren<StepDetailsExposedState>> = React.memo(
  (props) => {
    const {
      ...
      <div data-test-subj="transformStepDetailsSummary">
        ...
        {isRetentionPolicyEnabled && (
          <>
            ...
            <EuiFormRow
              label={i18n.translate(
                'xpack.transform.stepDetailsSummary.retentionPolicyMaxAgeLabel',
                {

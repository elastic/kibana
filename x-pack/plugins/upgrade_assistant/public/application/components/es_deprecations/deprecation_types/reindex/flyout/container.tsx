...
export const ReindexFlyout: React.FunctionComponent<
  React.PropsWithChildren<ReindexFlyoutProps>
> = ({ reindexState, startReindex, cancelReindex, closeFlyout, deprecation }) => {

...
const StepStatus: React.FunctionComponent<
  React.PropsWithChildren<{ status: STATUS; idx: number }>
> = ({ status, idx }) => {
...
const Step: React.FunctionComponent<
  React.PropsWithChildren<StepProgressStep & { idx: number }>
> = ({ title, status, children, idx }) => {

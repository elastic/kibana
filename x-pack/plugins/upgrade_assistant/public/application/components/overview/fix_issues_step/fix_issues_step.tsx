        ...
        <EuiText>
          <p>
            <FormattedMessage
              ...
              defaultMessage="Update your Elasticsearch and Kibana deployments to be compatible with Elastic Stack 8. Critical issues must be resolved before you upgrade. Warning issues can be ignored at your discretion."
            />
          </p>
        </EuiText>

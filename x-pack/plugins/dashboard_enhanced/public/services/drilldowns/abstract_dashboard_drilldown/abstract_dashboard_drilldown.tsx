  ...
  implements Drilldown<Config, Context>
{
  ...
  private readonly ReactCollectConfig: React.FC<
    React.PropsWithChildren<CollectConfigProps<Config, BaseActionFactoryContext>>
  >;

  public readonly CollectConfig: React.FC<
    React.PropsWithChildren<CollectConfigProps<DrilldownConfig, BaseActionFactoryContext>>
  >;

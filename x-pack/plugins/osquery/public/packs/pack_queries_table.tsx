...
const ViewResultsInLensActionComponent: React.FC<ViewResultsInDiscoverActionProps> = ({
  ...
  if (buttonType === ViewResultsActionButtonType.button) {
    return (
      ...
      >
        <FormattedMessage
          id="xpack.osquery.pack.queriesTable.viewLensResultsActionAriaLabel"
  ...
  return (
    <EuiToolTip
      content={i18n.translate('xpack.osquery.pack.queriesTable.viewLensResultsActionAriaLabel', {
        defaultMessage: 'View results in Lens',
      })}
    >
      <EuiButtonIcon
  ...
  if (buttonType === ViewResultsActionButtonType.button) {
    return (
      <EuiButtonEmpty size="xs" iconType="discoverApp" href={discoverUrl}>
        <FormattedMessage
          id="xpack.osquery.pack.queriesTable.viewDiscoverResultsActionAriaLabel"
...
const PackQueriesTableComponent: React.FC<PackQueriesTableProps> = ({
  ...
  const columns = useMemo(
    () => [
      ...
      {
        name: editMode
          ? i18n.translate('xpack.osquery.pack.queriesTable.actionsColumnTitle', {
              defaultMessage: 'Actions',
            })
          : i18n.translate('xpack.osquery.pack.queriesTable.viewResultsColumnTitle', {

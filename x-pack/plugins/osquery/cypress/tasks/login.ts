...
export const postRoleAndUser = (role: ROLES) => {
  ...
  const detectionsRoleScriptPath = `./scripts/roles_users/${role}/post_detections_role.sh`;
  const detectionsRoleJsonPath = `./scripts/roles_users/${role}/detections_role.json`;
  const detectionsUserScriptPath = `./scripts/roles_users/${role}/post_detections_user.sh`;
  const detectionsUserJsonPath = `./scripts/roles_users/${role}/detections_user.json`;
...
export const deleteRoleAndUser = (role: ROLES) => {
  const env = getCurlScriptEnvVars();
  const detectionsUserDeleteScriptPath = `./scripts/roles_users/${role}/delete_detections_user.sh`;

  ...
  describe('#getDataFromFieldsHits', () => {
    ...
    it('get data from threat enrichments', () => {
      ...
      const ruleParametersResultFields = [
        ...
        {
          category: 'kibana',
          field: 'kibana.alert.rule.parameters.threat_mapping.entries.field',
          isObjectArray: false,
        ...
        {
          category: 'kibana',
          field: 'kibana.alert.rule.parameters.threat_mapping.entries.type',
          isObjectArray: false,
          originalValue: ['mapping'],
          values: ['mapping'],
        },
        {
          category: 'kibana',
          field: 'kibana.alert.rule.parameters.threat_mapping.entries.value',
          isObjectArray: false,
          originalValue: ['threat.indicator.file.hash.sha256'],
          values: ['threat.indicator.file.hash.sha256'],
        },
        {
          category: 'kibana',

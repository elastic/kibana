...
const apm_indices_1 = require("../apm_indices");
const migrate_legacy_apm_indices_to_space_aware_1 = require("./migrate_legacy_apm_indices_to_space_aware");
const loggerMock = {
    debug: jest.fn(),
    warn: jest.fn(),
    error: jest.fn(),
...
describe('migrateLegacyAPMIndicesToSpaceAware', () => {
    describe('when legacy APM indices is not found', () => {
        ...
        it('does not save any new saved object', () => {
            (0, migrate_legacy_apm_indices_to_space_aware_1.migrateLegacyAPMIndicesToSpaceAware)({
                coreStart: core,
                logger: loggerMock,
            });
    ...
    describe('when only default space is available', () => {
        ...
        it('creates new default saved object with space awareness and delete legacy', async () => {
            await (0, migrate_legacy_apm_indices_to_space_aware_1.migrateLegacyAPMIndicesToSpaceAware)({
                coreStart: core,
                logger: loggerMock,
            });
            expect(mockCreate).toBeCalledWith(apm_indices_1.APM_INDEX_SETTINGS_SAVED_OBJECT_TYPE, {
                apmIndices: {
                    transaction: 'default-apm-*',
                    span: 'default-apm-*',
                    error: 'default-apm-*',
                ...
                id: apm_indices_1.APM_INDEX_SETTINGS_SAVED_OBJECT_ID,
                overwrite: true,
            });
        });
    });
    describe('when multiple spaces are found', () => {
        ...
        it('creates multiple saved objects with space awareness and delete legacies', async () => {
            ...
            expect(mockBulkCreate).toBeCalledWith(savedObjects
                ...
                .map(({ id }) => {
                return {
                    type: apm_indices_1.APM_INDEX_SETTINGS_SAVED_OBJECT_TYPE,
                    id: apm_indices_1.APM_INDEX_SETTINGS_SAVED_OBJECT_ID,

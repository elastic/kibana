...
import { AGENT_NAME, AGENT_VERSION, SERVICE_ENVIRONMENT, SERVICE_NAME, SERVICE_NODE_NAME } from "../../../common/elasticsearch_fieldnames";
...
export async function getAgentInstances({
  ...
  return ({
    ...
    items: response.aggregations?.sample.serviceNodes.buckets.map((agentInstance) => ({

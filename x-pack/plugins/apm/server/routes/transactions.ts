  ...
  handler: async ({ context, request }) => {
    ...
    if (!setup.uiFilters.environment) {
      throw Boom.badRequest(
        `environment is a required property of the ?uiFilters JSON for transactions/charts.`
      );
    }
...
export const transactionDistributionRoute = createRoute({
  endpoint: 'GET /api/apm/services/{serviceName}/transactions/distribution',
  params: t.type({
    path: t.type({
      serviceName: t.string,
    }),
...
export const transactionBreakdownRoute = createRoute({
  endpoint: 'GET /api/apm/services/{serviceName}/transactions/breakdown',
  params: t.type({
    path: t.type({
      serviceName: t.string,
    }),
...
export const transactionErrorRateRoute = createRoute({

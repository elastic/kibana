...
import type { TermsEnumRequest } from '@elastic/elasticsearch/lib/api/typesWithBodyKey';
...
export interface APMInfraEventClientConfig {
...
export class APMInfraEventClient {
  ...
  constructor(config: APMInfraEventClientConfig) {

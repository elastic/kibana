    ...
    alerts: [
      {
        ...
        'kibana.alert.evaluation.value': [2001708.19],
        'service.name': ['frontend-rum'],
        'rule.name': ['Latency threshold | frontend-rum'],
        'kibana.alert.duration.us': [10000000000],
        'kibana.alert.status': ['open'],
        tags: ['apm', 'service.name:frontend-rum'],
        'transaction.type': ['page-load'],
        'kibana.alert.producer': ['apm'],
        'kibana.alert.uuid': ['af2ae371-df79-4fca-b0eb-a2dbd9478180'],
        'rule.uuid': ['82e0ee40-c2f4-11eb-9a42-a9da66a1722f'],
        'event.action': ['active'],
        '@timestamp': ['2021-06-01T20:27:48.833Z'],
        'kibana.alert.id': ['apm.transaction_duration_All'],
        'processor.event': ['transaction'],
        'kibana.alert.evaluation.threshold': [500000],
        'kibana.alert.start': ['2021-06-02T04:00:00.000Z'],
        'event.kind': ['state'],
      ...
      },
      {
        ...
        'kibana.alert.uuid': ['af2ae371-df79-4fca-b0eb-a2dbd9478181'],
        'rule.uuid': ['82e0ee40-c2f4-11eb-9a42-a9da66a1722f'],
        'event.action': ['active'],
        '@timestamp': ['2021-06-01T20:27:48.833Z'],
        'kibana.alert.id': ['apm.transaction_duration_All'],
        'processor.event': ['transaction'],
        'kibana.alert.evaluation.threshold': [500000],
        'kibana.alert.start': ['2021-06-02T10:45:00.000Z'],
        'event.kind': ['state'],
        'rule.category': ['Latency threshold'],
      },
      {
        ...
        'service.name': ['frontend-rum'],
        'rule.name': ['Latency threshold | frontend-rum'],
        'kibana.alert.duration.us': [1000000000],
        'kibana.alert.status': ['open'],
        tags: ['apm', 'service.name:frontend-rum'],
        'transaction.type': ['page-load'],
        'kibana.alert.producer': ['apm'],
        'kibana.alert.severity.level': ['critical'],
        'kibana.alert.uuid': ['af2ae371-df79-4fca-b0eb-a2dbd9478182'],
        'rule.uuid': ['82e0ee40-c2f4-11eb-9a42-a9da66a1722f'],
        'event.action': ['active'],
        '@timestamp': ['2021-06-01T20:27:48.833Z'],
        'kibana.alert.id': ['apm.transaction_duration_All'],
        'processor.event': ['transaction'],
        'kibana.alert.evaluation.threshold': [500000],
        'kibana.alert.start': ['2021-06-02T16:50:00.000Z'],
        'event.kind': ['state'],
        'rule.category': ['Latency threshold'],
      },
    ],

...
const renderTransaction = async (transaction: Record<string, any>) => {
  const rendered = render(<TransactionActionMenu transaction={transaction as Transaction} />, {
    wrapper: Wrapper,
  });
...
describe('TransactionActionMenu component', () => {
  ...
  it('always renders the trace logs link', async () => {
    const { getByText } = await renderTransaction(Transactions.transactionWithMinimalData);

    expect((getByText('Trace logs').parentElement as HTMLAnchorElement).href).toEqual(
  ...
  describe('when there is a pod id', () => {
    it('renders the pod logs link', async () => {
      ...
      expect((getByText('Pod logs').parentElement as HTMLAnchorElement).href).toEqual(
  ...
  describe('when there is a container id', () => {
    it('renders the Container logs link', async () => {
      ...
      expect((getByText('Container logs').parentElement as HTMLAnchorElement).href).toEqual(
  ...
  describe('when there is a hostname', () => {
    it('renders the Host logs link', async () => {
      ...
      expect((getByText('Host logs').parentElement as HTMLAnchorElement).href).toEqual(

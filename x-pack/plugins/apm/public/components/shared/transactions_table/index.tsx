...
export function TransactionsTable({
  ...
  const currentPageItems = orderBy(
    transactionGroups,
    [field],
    [direction]
  ...
  const {
    ...
    (callApmApi) => {
      const transactionGroupNames = compact(
      ...
      if (
        ...
        latencyAggregationType &&
        preferred &&
        transactionGroupNames.length > 0
      ) {
        return callApmApi(
          'GET /internal/apm/services/{serviceName}/transactions/groups/detailed_statistics',
          {
            params: {
              ...
              query: {
                ...
                latencyAggregationType:
                  latencyAggregationType as LatencyAggregationType,
                transactionNames: JSON.stringify(transactionGroupNames.sort()),
                offset:
  ...
  }, [maxCountExceeded, setSearchQueryDebounced]);

  ...
  return [
    {
      ...
      children: (
        <EuiMarkdownFormat>
          {i18n.translate('xpack.apm.tutorial.otel.download.textPre', {
            defaultMessage:
    ...
    },
    {
      ...
      children: (
        <>
          <EuiMarkdownFormat>
            {i18n.translate('xpack.apm.tutorial.otel.configureAgent.textPre', {
              defaultMessage:
          ...
          <EuiSpacer />
          <EuiMarkdownFormat>
            {i18n.translate('xpack.apm.tutorial.otel.configureAgent.textPost', {
              defaultMessage:

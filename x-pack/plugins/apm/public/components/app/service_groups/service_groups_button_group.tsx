...
export function ServiceGroupsButtonGroup({
  ...
  selectedNavButton: 'serviceGroups' | 'allServices' | undefined;
}) {
    ...
    <>
      <EuiButtonGroup
        ...
        idToSelectedMap={{
          ...
          serviceGroups: selectedNavButton === 'serviceGroups',
        }}
        onChange={(id) => {
          const { pathname } =
            buttonGroupOptions[id as NonNullable<typeof selectedNavButton>];

...
import { RendererFunction } from './typed_react';

interface WithKueryAutocompletionLifecycleProps {
  kibana: KibanaReactContextValue<ApmPluginStartDeps & KibanaServices>;
...
> {
  ...
  private loadSuggestions = async (
    ...
    const hasQuerySuggestions =
      this.props.kibana.services.unifiedSearch.autocomplete.hasQuerySuggestions(
        language
      );
...
export const WithKueryAutocompletion =
  withKibana<WithKueryAutocompletionLifecycleProps>(

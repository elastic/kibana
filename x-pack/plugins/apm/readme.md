...
```sh
node x-pack/plugins/apm/scripts/create-apm-users.js --username elastic --password changeme --kibana-url http://localhost:6501 --role-suffix <github-username-or-something-unique>
```

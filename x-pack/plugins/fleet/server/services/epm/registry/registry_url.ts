...
const PRODUCTION_REGISTRY_URL_CDN = 'https://epr-v2.ea-web.elastic.dev';
const STAGING_REGISTRY_URL_CDN = 'https://epr-v2.ea-web.elastic.dev';
const SNAPSHOT_REGISTRY_URL_CDN = 'https://epr-v2.ea-web.elastic.dev';

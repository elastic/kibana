...
import type { Agent, FullAgentPolicy, PackageInfo, NewPackagePolicy } from '../../types';
  ...
  return [
    {
      ...
      streams: [
        {
          enabled: false,
          data_stream: { type: 'logs', dataset: 'redis.log' },
          vars: {
            paths: { value: ['/var/log/redis/redis-server.log*'], type: 'text' },
            tags: { value: ['redis-log'], type: 'text' },

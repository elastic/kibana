...
import redisPkgRaw from './test_data/redis_pkg.json';
import nginxPkgRaw from './test_data/nginx_pkg.json';
const redisPkg = redisPkgRaw as unknown as PackageInfo;
const nginxPkg = nginxPkgRaw as unknown as PackageInfo;
...
describe('generatePackagePolicy', () => {
  ...
  it('should return the right policy for nginx (host)', () => {
    ...
    expect(generatedPolicy).toEqual(expectedNginxPolicy);
  });
});

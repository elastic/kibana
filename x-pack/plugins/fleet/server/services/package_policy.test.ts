...
describe('Package policy service', () => {
  ...
  describe('update', () => {
    ...
    describe('remove protections', () => {
      ...
      it('should never remove protections for non-endpoint packages, regardless of policy_ids change', async () => {
        ...
        // Both old and new policies are NOT endpoint
        setupSOClientMocks(savedObjectsClient, testPolicyIds, [], {
  ...
  describe('bulkUpdate', () => {
    ...
    describe('remove protections', () => {
      ...
      it('should never remove protections for non-endpoint packages, regardless of policy_ids change (bulkUpdate)', async () => {
        const savedObjectsClient = savedObjectsClientMock.create();

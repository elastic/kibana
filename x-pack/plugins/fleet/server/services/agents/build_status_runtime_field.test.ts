...
describe('buildStatusRuntimeField', () => {
  ...
  it('should revert to standard inactivity timeout of 2 weeks if there are too many policies with inactivity timeout', () => {
    const inactivityTimeouts: InactivityTimeouts = [
      {
        inactivityTimeout: 300,

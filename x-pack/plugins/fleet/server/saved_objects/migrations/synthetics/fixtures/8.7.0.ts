...
export const browserPolicy = {
  ...
  id: '26c9011b-e637-4f12-9311-75143fec7043-fa2e69b0-dec6-11ed-8746-c5b1a1a12ec1-default',
  attributes: {
    name: 'Invalid browser monitor with 2 minute schedule-A private location-default',
    namespace: 'default',
        ...
        streams: [
          {
            ...
            id: 'synthetics/http-http-26c9011b-e637-4f12-9311-75143fec7043-fa2e69b0-dec6-11ed-8746-c5b1a1a12ec1-default',
          },
        ],
      },
      {
        ...
        streams: [
          {
            ...
            id: 'synthetics/tcp-tcp-26c9011b-e637-4f12-9311-75143fec7043-fa2e69b0-dec6-11ed-8746-c5b1a1a12ec1-default',
          },
        ],
      },
      {
        ...
        streams: [
          {
            ...
            id: 'synthetics/icmp-icmp-26c9011b-e637-4f12-9311-75143fec7043-fa2e69b0-dec6-11ed-8746-c5b1a1a12ec1-default',
          },
        ],
      },
      {
        ...
        streams: [
          {
            ...
            vars: {
              ...
              name: { value: 'Invalid browser monitor with 2 minute schedule', type: 'text' },
              ...
              'source.inline.script': { value: '"kljlekjre"', type: 'yaml' },
              ...
              id: { value: '26c9011b-e637-4f12-9311-75143fec7043', type: 'text' },
              config_id: { value: '26c9011b-e637-4f12-9311-75143fec7043', type: 'text' },
              run_once: { value: false, type: 'bool' },
              origin: { value: 'ui', type: 'text' },
              'monitor.project.id': { value: null, type: 'text' },
              'monitor.project.name': { value: null, type: 'text' },
            },
            id: 'synthetics/browser-browser-26c9011b-e637-4f12-9311-75143fec7043-fa2e69b0-dec6-11ed-8746-c5b1a1a12ec1-default',
            compiled_stream: {
              __ui: {
              ...
              type: 'browser',
              name: 'Invalid browser monitor with 2 minute schedule',
              id: '26c9011b-e637-4f12-9311-75143fec7043',
              origin: 'ui',
              ...
              'source.inline.script': 'kljlekjre',
              screenshots: 'on',
              processors: [
                {
                  add_fields: {
                    ...
                    fields: {
                      ...
                      config_id: '26c9011b-e637-4f12-9311-75143fec7043',
                    },
                  },
                },
              ],
          ...
          },
          {
            ...
            id: 'synthetics/browser-browser.network-26c9011b-e637-4f12-9311-75143fec7043-fa2e69b0-dec6-11ed-8746-c5b1a1a12ec1-default',
            compiled_stream: {
              processors: [
          ...
          },
          {
            ...
            id: 'synthetics/browser-browser.screenshot-26c9011b-e637-4f12-9311-75143fec7043-fa2e69b0-dec6-11ed-8746-c5b1a1a12ec1-default',
            compiled_stream: {
              processors: [
                { add_fields: { target: '', fields: { 'monitor.fleet_managed': true } } },
              ],
    ...
    is_managed: true,
    revision: 1,
    created_at: '2023-04-19T15:33:36.536Z',
    created_by: 'system',
    updated_at: '2023-04-19T15:33:36.536Z',
    updated_by: 'system',
  },
  references: [],
  coreMigrationVersion: '8.8.0',
  updated_at: '2023-04-19T15:33:36.617Z',
  created_at: '2023-04-19T15:33:36.617Z',

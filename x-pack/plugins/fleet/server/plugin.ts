  ...
  implements Plugin<FleetSetupContract, FleetStartContract, FleetSetupDeps, FleetStartDeps>
{
  ...
  public setup(core: CoreSetup, deps: FleetSetupDeps) {
    ...
    const getTaskDepsPromise = core.getStartServices().then(([coreServices]) => ({
      esClient: coreServices.elasticsearch.client.asInternalUser,
      soClient: new SavedObjectsClient(coreServices.savedObjects.createInternalRepository()),
    }));

    registerSavedObjects(core.savedObjects, deps.encryptedSavedObjects);
    registerEncryptedSavedObjects(deps.encryptedSavedObjects);
    registerHintsTask(deps.taskManager, () => getTaskDepsPromise, this.logger);

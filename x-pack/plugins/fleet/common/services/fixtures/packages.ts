...
export const packageWithPolicyTemplates: PackageInfo = {
  name: 'aws',
  title: 'AWS',
  version: '0.5.2',
  release: 'beta',
  ...
  assets: {},
  input_groups: [
    { name: 'logs', title: 'Logs', description: 'Collect logs for AWS services' },
    { name: 'metrics', title: 'Metrics', description: 'Collect metrics for AWS services' },
  ],
  policy_templates: [
    {
      name: 'billing',
...
export const packagePolicyForPolicyTemplates: NewPackagePolicy = {
  name: 'aws-1',
  namespace: 'default',
  package: { name: 'aws', title: 'AWS', version: '0.5.2' },
  enabled: true,

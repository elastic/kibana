  ...
  const policyMsg =
    isK8s === 'IS_KUBERNETES' ? (
      <FormattedMessage
        ...
        defaultMessage="Copy or download the Kubernetes manifest inside the Kubernetes cluster. Modify {ESUsernameVariable} and {ESPasswordVariable} environment variables in the Daemonset to use your Elasticsearch credentials."
        values={{

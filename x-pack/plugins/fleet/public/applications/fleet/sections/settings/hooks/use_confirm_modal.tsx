...
export function withConfirmModalProvider<T>(
  WrappedComponent: React.FunctionComponent<React.PropsWithChildren<T>>
) {
  return (props: T) => (
...
export const ConfirmModalProvider: React.FunctionComponent<React.PropsWithChildren<unknown>> = ({
  children,
}) => {

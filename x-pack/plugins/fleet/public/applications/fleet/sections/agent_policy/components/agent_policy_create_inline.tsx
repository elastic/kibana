      ...
      <EuiText>
        {isFleetServerPolicy ? (
          <FormattedMessage
            ...
            defaultMessage="Agent policies allow you to configure your agents remotely. We recommend creating a dedicated agent policy for Fleet Server that runs on dedicated hosts."
          />
        ) : (
          <FormattedMessage
            ...
            values={{
              agentPolicy: (
                <EuiLink href={'TODO'} target="_blank">
                  <FormattedMessage

...
const ErrorLayout: FunctionComponent<
  React.PropsWithChildren<{ isAddIntegrationsPath: boolean }>
...
const PermissionsError: React.FunctionComponent<React.PropsWithChildren<{ error: string }>> = memo(
  ({ error }) => {
...
export const WithPermissionsAndSetup: React.FC<React.PropsWithChildren<unknown>> = memo(
  ({ children }) => {
    useBreadcrumbs('base');

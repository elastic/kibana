...
export const PipelineForm: React.FunctionComponent<PipelineFormProps> = ({
  ...
  */
  useUnsavedChangesPrompt({
    ...
    confirmButtonText: i18n.translate('xpack.ingestPipelines.form.unsavedPrompt.leavePageText', {
      defaultMessage: `Leave page`,
    }),
    cancelButtonText: i18n.translate('xpack.ingestPipelines.form.unsavedPrompt.keepEditingText', {

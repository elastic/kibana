...
const CreateConnectorFlyoutComponent: React.FC<
  React.PropsWithChildren<CreateConnectorFlyoutProps>
> = ({ actionTypeRegistry, featureId, onClose, onConnectorCreated, onTestConnector }) => {
  const {

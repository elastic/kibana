...
export type InitialConnectorReducer<Config, Secrets> = Reducer<
  { connector: InitialConnector<Config, Secrets> },
  ConnectorReducerAction<Config, Secrets>
>;
export type ConcreteConnectorReducer<Config, Secrets> = Reducer<

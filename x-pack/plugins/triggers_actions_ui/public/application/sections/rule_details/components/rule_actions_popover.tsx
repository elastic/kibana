...
export const RuleActionsPopover: React.FunctionComponent<
  React.PropsWithChildren<RuleActionsPopoverProps>
> = ({ rule, canSaveRule, onDelete, onApiKeyUpdate, onEnableDisable, onRunRule }) => {

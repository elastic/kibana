...
export const AlertDetails: React.FunctionComponent<AlertDetailsProps> = ({
  ...
  const [isManageLicenseModalOpen, setIsManageLicenseModalOpen] = useState<boolean>(false);
  ...
  return (
    <>
      ...
      {isManageLicenseModalOpen && (
        <ManageLicenseModal
          message={alert.executionStatus.error?.message}
          onConfirm={() => {

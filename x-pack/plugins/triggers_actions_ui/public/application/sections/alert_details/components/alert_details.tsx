...
export const AlertDetails: React.FunctionComponent<AlertDetailsProps> = ({
  ...
  const tabs: Array<{
  ...
  }> = [
    {
      ...
      name: (
        <FormattedMessage
          id="xpack.triggersActionsUI.sections.alertDetails.detailsTabTitle"
    ...
    },
    {
      ...
      name: (
        <FormattedMessage
          id="xpack.triggersActionsUI.sections.alertDetails.monitoringTabTitle"

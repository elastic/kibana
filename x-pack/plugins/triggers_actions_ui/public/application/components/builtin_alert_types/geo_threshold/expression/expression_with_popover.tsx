...
export const ExpressionWithPopover: React.FunctionComponent<AlertTypeParamsExpressionProps<
  GeoThresholdAlertParams,
  AlertsContextValue
>> = ({ popoverContent, expressionDescription, defaultValue = '', value = defaultValue }) => {

...
const NotificationPoliciesHome = lazy(
  () => import('./sections/notifications_list/components/notification_policies_home')
);
...
export const App = ({ deps }: { deps: TriggersAndActionsUiServices }) => {
  ...
  const sections: Section[] = ['policies'];
    ...
    <ConnectorProvider value={{ services: { validateEmailAddresses } }}>
      <Routes>
        <Route
          ...
          component={suspendedComponentWithProps(NotificationPoliciesHome, 'xl')}
        />

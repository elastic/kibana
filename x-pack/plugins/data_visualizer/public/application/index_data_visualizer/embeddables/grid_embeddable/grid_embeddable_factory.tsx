...
export class DataVisualizerGridEmbeddableFactory
  implements EmbeddableFactoryDefinition<FieldStatisticTableEmbeddableState>
{
  ...
  public async create(initialInput: FieldStatisticTableEmbeddableState, parent?: IContainer) {

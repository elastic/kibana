...
import { type IExternalUrl, type ThemeServiceStart } from '@kbn/core/public';
import {
...
import { type ActionExecutionContext, ROW_CLICK_TRIGGER } from '@kbn/ui-actions-plugin/public';
import type { CollectConfigProps as CollectConfigPropsBase } from '@kbn/kibana-utils-plugin/public';
import { KibanaContextProvider, type UrlTemplateEditorVariable } from '@kbn/kibana-react-plugin/public';
import {
  type UiActionsEnhancedBaseActionFactoryContext as BaseActionFactoryContext,
  type UiActionsEnhancedDrilldownDefinition as Drilldown,
  UrlDrilldownCollectConfig,
  urlDrilldownCompileUrl,
  type UrlDrilldownConfig,
  type UrlDrilldownGlobalScope,

    ...
    (settings, fromPath, addDeprecation) => {
      ...
      if (stackAlerts?.enabled === false || stackAlerts?.enabled === true) {
        addDeprecation({
          ...
          title: i18n.translate('xpack.stack_alerts.deprecations.enabledTitle', {
            defaultMessage: 'Setting "xpack.stack_alerts.enabled" is deprecated',
          }),
          message: i18n.translate('xpack.stack_alerts.deprecations.enabledMessage', {
            defaultMessage:
          ...
          correctiveActions: {
            manualSteps: [
              i18n.translate('xpack.stack_alerts.deprecations.enabled.manualStepOneMessage', {
                defaultMessage: 'Remove "xpack.stack_alerts.enabled" from kibana.yml.',
              }),
              i18n.translate('xpack.stack_alerts.deprecations.enabled.manualStepTwoMessage', {

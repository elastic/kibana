...
import { useTCPSimpleFieldsContext } from '../../../fleet_package/contexts';
import { ConfigKey } from '../../../../../../common/constants/monitor_management';
import { ProjectReadonlyCommonFields } from './readonly_common_fields';
const noop = () => {};

export const ProjectTCPReadonlyFields = ({ minColumnWidth }: { minColumnWidth: string }) => {
  const { fields } = useTCPSimpleFieldsContext();

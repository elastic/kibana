...
export const HOURS = i18n.translate(
  'xpack.synthetics..alerts.monitorStatus.timerangeOption.hours',
  {
...
export const WEEKS = i18n.translate(
  'xpack.synthetics..alerts.monitorStatus.timerangeOption.weeks',
  {
...
export const YEARS = i18n.translate(
  'xpack.synthetics..alerts.monitorStatus.timerangeOption.years',
  {
...
export const LOCATION = i18n.translate(
  'xpack.synthetics..alerts.monitorStatus.addFilter.location',
  {

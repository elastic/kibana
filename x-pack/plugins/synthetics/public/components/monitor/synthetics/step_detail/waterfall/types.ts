...
export const FriendlyTimingLabels = {
  ...
  [Timings.Send]: i18n.translate(
    'xpack.synthetics..synthetics.waterfallChart.labels.timings.send',
    {
      defaultMessage: 'Sending request',
    }
  ),
  [Timings.Wait]: i18n.translate(
    'xpack.synthetics..synthetics.waterfallChart.labels.timings.wait',
    {

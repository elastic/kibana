...
export const SyntheticsEmbeddableContext: React.FC<{ search: string }> = ({ search, children }) => {
  ...
  return (
    <EuiErrorBoundary>
      <props.i18n.Context>
        <KibanaThemeProvider
          theme$={props.coreStart.theme.theme$}
          modify={{
            breakpoint: {
              xxl: 1600,
              xxxl: 2000,
                  ...
                  <SyntheticsSettingsContextProvider {...props}>
                    <KibanaContextProvider
                      services={{
                        ...
                        share: kibanaService.startPlugins.share,
                        exploratoryView: kibanaService.startPlugins.exploratoryView,
                      }}
                    >
                      <SyntheticsRefreshContextProvider>
                        <RedirectAppLinks coreStart={props.coreStart}>
                          <EuiPanel hasShadow={false} style={{ overflow: 'auto' }}>
                            {children}
                          </EuiPanel>
                        </RedirectAppLinks>
                      </SyntheticsRefreshContextProvider>

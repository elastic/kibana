...
export const STATUS_GRID_EMBEDDABLE = 'STATUS_GRID_EMBEDDABLE';

export class StatusGridEmbeddable extends Embeddable {
  ...
  public render(node: HTMLElement) {
    ...
    this.node = node;
    ReactDOM.render(<StatusGridComponent />, node);
  }

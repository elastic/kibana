      ...
      >
        <p>
          <FormattedMessage
            ...
            defaultMessage={
              'You have at least 1 monitor configured with alerting but have no default connectors configured, meaning you will not receive any alerts. Configure your default connector {here}.'
            }
            values={{
              here: (

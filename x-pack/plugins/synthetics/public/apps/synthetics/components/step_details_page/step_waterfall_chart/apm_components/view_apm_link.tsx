...
export const ViewApmLink = () => {
  ...
  // const relatedServiceLink = `${basePath}/app/apm/services?comparisonEnabled=true&environment=ENVIRONMENT_ALL&rangeFrom=${gte}&rangeTo=${lt}&offset=1d`;
  const serviceOverviewLink = serviceName
    ? `${basePath}/app/apm/services/${serviceName}/overview?comparisonEnabled=true&environment=ENVIRONMENT_ALL&offset=1d&rangeFrom=${gte}&rangeTo=${lt}`
    : undefined;
...
const VIEW_APM_SERVICES = i18n.translate('xpack.synthetics.waterfall.viewAPMTransactions.label', {
  defaultMessage: 'View APM Service',
});

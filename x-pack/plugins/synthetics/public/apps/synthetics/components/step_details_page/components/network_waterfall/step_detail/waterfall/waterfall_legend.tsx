...
import { FriendlyTimingLabels, MIME_FILTERS, MimeType, Timings } from './types';
...
const EuiFlexGroupLegendItem = styled(EuiFlexGroup)<{ isClickable: boolean }>`
  flex-grow: 0;
  flex-shrink: 0;
  &:active {
    ${({ isClickable }) => (isClickable ? 'border: 1px solid gray; border-radius: 2;' : '')}
  }
`;

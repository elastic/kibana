...
## **Architecture**
The `security_solution_serverless` plugin interacts with the main `security_solution` plugin through the plugin lifecycle contract. 
...
- **Other Plugins**: Other plugins may also expose contract APIs to configure serverless-specific content. 

...
describe('formatChromeProjectNavNodes', () => {
  const formatChromeProjectNavNodes = getFormatChromeProjectNavNodes(testServices);
  ...
  it('should format regular chrome nav nodes', async () => {
    const chromeNavNodes = formatChromeProjectNavNodes([link1]);
    expect(chromeNavNodes).toEqual([
      {
  ...
  it('should format external chrome nav nodes', async () => {
    const chromeNavNodes = formatChromeProjectNavNodes([link3]);
  ...
  it('should format nested links to chrome nav nodes', async () => {
    const chromeNavNodes = formatChromeProjectNavNodes([{ ...link1, links: [link2] }]);
  ...
  it('should use the preset nav for ML lings', async () => {
    ...
    const chromeNavNodes = formatChromeProjectNavNodes([
      { ...link1, id: SecurityPageName.mlLanding },
    ]);
  ...
  it('should not include links that are not in the chrome navLinks', async () => {
    ...
    const chromeNavNodes = formatChromeProjectNavNodes([link1, link2]);

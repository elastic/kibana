...
export const GET_STARTED_PAGE_TITLE = i18n.translate('xpack.serverlessSecurity.getStarted.title', {
  defaultMessage: `Welcome`,
});

export const GET_STARTED_PAGE_SUBTITLE = i18n.translate(
  'xpack.serverlessSecurity.getStarted.subTitle',
  {
...
export const GET_STARTED_PAGE_DESCRIPTION = i18n.translate(
  'xpack.serverlessSecurity.getStarted.description',
  {
...
export const WELCOME_PANEL_PROJECT_CREATED_TITLE = i18n.translate(
  'xpack.serverlessSecurity.getStarted.welcomePanel.projectCreated.title',
  {
...
export const WELCOME_PANEL_PROJECT_CREATED_DESCRIPTION = i18n.translate(
  'xpack.serverlessSecurity.getStarted.welcomePanel.projectCreated.description',
  {
...
export const WELCOME_PANEL_INVITE_YOUR_TEAM_TITLE = i18n.translate(
  'xpack.serverlessSecurity.getStarted.welcomePanel.inviteYourTeam.title',
  {
...
export const WELCOME_PANEL_INVITE_YOUR_TEAM_DESCRIPTION = i18n.translate(
  'xpack.serverlessSecurity.getStarted.welcomePanel.inviteYourTeam.description',
  {
...
export const WELCOME_PANEL_PROGRESS_TRACKER_TITLE = i18n.translate(
  'xpack.serverlessSecurity.getStarted.welcomePanel.progressTracker.title',
  {
...
export const BRING_IN_YOUR_DATA_TITLE = i18n.translate(
  'xpack.serverlessSecurity.getStarted.togglePanel.bringInYourData.title',
  {
...
export const ACTIVATE_AND_CREATE_RULES_TITLE = i18n.translate(
  'xpack.serverlessSecurity.getStarted.togglePanel.activateAndCreateRules.title',
  {
...
export const GET_MORE_TITLE = i18n.translate(
  'xpack.serverlessSecurity.getStarted.togglePanel.getMoreFromElasticSecurity.title',
  {
...
export const MASTER_THE_INVESTIGATION_TITLE = i18n.translate(
  'xpack.serverlessSecurity.getStarted.togglePanel.masterTheInvestigationsWorkflow.title',
  {
...
export const RESPOND_TO_THREATS_TITLE = i18n.translate(
  'xpack.serverlessSecurity.getStarted.togglePanel.respondToThreatsWithAutomation.title',
  {
...
export const OPTIMIZE_YOUR_WORKSPACE_TITLE = i18n.translate(
  'xpack.serverlessSecurity.getStarted.togglePanel.optimizeYourWorkspace.title',
  {
...
export const TOGGLE_PANEL_TITLE = i18n.translate(
  'xpack.serverlessSecurity.getStartedProductLabel.title',
  {
...
export const ANALYTICS_SWITCH_LABEL = i18n.translate(
  'xpack.serverlessSecurity.getStarted.togglePanel.switch.analytics.label',
  {
    defaultMessage: 'Analytics',
  }
);
...
export const CLOUD_SWITCH_LABEL = i18n.translate(
  'xpack.serverlessSecurity.getStarted.togglePanel.switch.cloud.label',
...
export const ENDPOINT_SWITCH_LABEL = i18n.translate(
  'xpack.serverlessSecurity.getStarted.togglePanel.switch.endpoint.label',
  {
...
export const TOGGLE_PANEL_EMPTY_TITLE = i18n.translate(
  'xpack.serverlessSecurity.getStarted.togglePanel.empty.title',
  {
...
export const TOGGLE_PANEL_EMPTY_DESCRIPTION = i18n.translate(
  'xpack.serverlessSecurity.getStarted.togglePanel.empty.description',
  {

...
export enum AnalyticsEvents {
  ...
  queryBuilderFieldsUpdated = 'view_query_builder_fields_updated',
  queryModeLoaded = 'query_mode_loaded',
  queryBuilderModeLoaded = 'query_builder_mode_loaded',
  ...
  setupQueryBuilderPageLoaded = 'query_builder_page_loaded',

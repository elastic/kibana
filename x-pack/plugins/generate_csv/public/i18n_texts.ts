...
export const i18nTexts = {
  escapedFormulaValuesMessage: i18n.translate(
    'generateCSV.exportTypes.csv.generateCsv.escapedFormulaValues',
    {
  ...
  authenticationError: {
    partialResultsMessage: i18n.translate(
      'generateCSV.exportTypes.csv.generateCsv.authenticationExpired.partialResultsMessage',
      {
        defaultMessage:
  ...
  esErrorMessage: (statusCode: number, message: string) =>
    i18n.translate('generateCSV.exportTypes.csv.generateCsv.esErrorMessage', {
  ...
  unknownError: (message: string = 'unknown') =>
    i18n.translate('generateCSV.exportTypes.csv.generateCsv.unknownErrorMessage', {
      defaultMessage: 'Encountered an unknown error: {message}',
      values: { message },
    }),
  csvRowCountError: ({ expected, received }: { expected?: number; received: number }) =>
    i18n.translate('generateCSV.exportTypes.csv.generateCsv.incorrectRowCount', {
      defaultMessage:
  ...
  csvUnableToClosePit: () =>
    i18n.translate('generateCSV.exportTypes.csv.generateCsv.csvUnableToClosePit', {
      defaultMessage:

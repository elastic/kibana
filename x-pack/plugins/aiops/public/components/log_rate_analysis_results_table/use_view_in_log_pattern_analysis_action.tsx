...
const viewInLogPatternAnalysisMessage = i18n.translate(
  'xpack.aiops.logRateAnalysisResultsTable.linksMenu.viewInLogPatternAnalysis',
  {
  ...
  const logPatternAnalysisUrlError = useMemo(() => {
    if (!mlLocator) {
      return i18n.translate(
        'xpack.aiops.logRateAnalysisResultsTable.mlLocatorMissingErrorMessage',
        {
    ...
    if (!dataViewId) {
      return i18n.translate(
        'xpack.aiops.logRateAnalysisResultsTable.autoGeneratedLogPatternAnalysisLinkErrorMessage',
        {
          defaultMessage:

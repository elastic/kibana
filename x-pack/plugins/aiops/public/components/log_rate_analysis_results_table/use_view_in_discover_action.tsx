...
const viewInDiscoverMessage = i18n.translate(
  'xpack.aiops.logRateAnalysisResultsTable.linksMenu.viewInDiscover',
  {
  ...
  const discoverUrlError = useMemo(() => {
    if (!application.capabilities.discover?.show) {
      const discoverNotEnabled = i18n.translate(
        'xpack.aiops.logRateAnalysisResultsTable.discoverNotEnabledErrorMessage',
        {
    ...
    if (!discoverLocator) {
      const discoverLocatorMissing = i18n.translate(
        'xpack.aiops.logRateAnalysisResultsTable.discoverLocatorMissingErrorMessage',
        {
    ...
    if (!dataViewId) {
      const autoGeneratedDiscoverLinkError = i18n.translate(
        'xpack.aiops.logRateAnalysisResultsTable.autoGeneratedDiscoverLinkErrorMessage',
        {

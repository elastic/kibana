...
export const uiSettings: Record<string, UiSettingsParams> = {
  [OBSERVABILITY_LOGS_DATA_ACCESS_LOG_SOURCES_ID]: {
    ...
    description: i18n.translate('xpack.logsDataAccess.logSourcesDescription', {
      defaultMessage:
        'Sources to be used for logs data. If the data contained in these indices is not logs data, you may experience degraded functionality. Changes to this setting will impact the sources queried in Log Threshold rules.',
    }),
    type: 'array',

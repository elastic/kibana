...
export const ENTITY_INDEX_TEMPLATE =
  `${ENTITY_BASE_PREFIX}_${ENTITY_SCHEMA_VERSION_V1}_index_template` as const;
export const ENTITY_BASE_COMPONENT_TEMPLATE =
  `${ENTITY_BASE_PREFIX}_${ENTITY_SCHEMA_VERSION_V1}_base` as const;
export const ENTITY_ENTITY_COMPONENT_TEMPLATE =
  `${ENTITY_BASE_PREFIX}_${ENTITY_SCHEMA_VERSION_V1}_entity` as const;
export const ENTITY_EVENT_COMPONENT_TEMPLATE =
  `${ENTITY_BASE_PREFIX}_${ENTITY_SCHEMA_VERSION_V1}_event` as const;

// History constants
export const ENTITY_HISTORY = 'history' as const;
export const ENTITY_HISTORY_PREFIX =
  `${ENTITY_BASE_PREFIX}-${ENTITY_SCHEMA_VERSION_V1}-${ENTITY_HISTORY}` as const;
export const ENTITY_HISTORY_INDEX_PREFIX =
  `${ENTITY_INDEX_PREFIX}.${ENTITY_SCHEMA_VERSION_V1}.${ENTITY_HISTORY}` as const;

// Latest constants
export const ENTITY_LATEST = 'latest' as const;
export const ENTITY_LATEST_PREFIX =
  `${ENTITY_BASE_PREFIX}-${ENTITY_SCHEMA_VERSION_V1}-${ENTITY_LATEST}` as const;
export const ENTITY_LATEST_INDEX_PREFIX =

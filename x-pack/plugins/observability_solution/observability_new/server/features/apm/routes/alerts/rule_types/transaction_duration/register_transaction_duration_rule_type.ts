...
import { getAlertDetailsUrl } from '../../../../../alerts_and_slos/lib/rules/custom_threshold/utils';
import {
  asDuration,
...
import { getEnvironmentEsField } from '../../../../../../../common/features/apm/environment_filter_values';
import {
  PROCESSOR_EVENT,
  SERVICE_ENVIRONMENT,
  SERVICE_NAME,
...
import {
  ...
  RULE_TYPES_CONFIG,
} from '../../../../../../../common/features/apm/rules/apm_rule_types';
import { transactionDurationParamsSchema } from '../../../../../../../common/features/apm/rules/schema';
  ...
  const ruleType = createLifecycleRuleType({
    ...
    executor: async ({ params: ruleParams, services, spaceId, getTimeRange }) => {
      ...
      const searchAggregatedTransactions =
        apmConfig.apm.searchAggregatedTransactions !== SearchAggregatedTransactionSetting.never;

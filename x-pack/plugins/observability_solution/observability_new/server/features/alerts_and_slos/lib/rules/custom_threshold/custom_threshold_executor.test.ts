...
import { getViewInAppUrl } from '../../../../../../common/features/alerts_and_slos/custom_threshold_rule/get_view_in_app_url';
import { searchSourceCommonMock } from '@kbn/data-plugin/common/search/search_source/mocks';

jest.mock('./lib/evaluate_rule', () => ({ evaluateRule: jest.fn() }));
jest.mock(
  '../../../../../../common/features/alerts_and_slos/custom_threshold_rule/get_view_in_app_url',
  () => ({

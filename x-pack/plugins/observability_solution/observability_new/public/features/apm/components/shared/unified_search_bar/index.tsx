...
import { UIProcessorEvent } from '../../../../../../common/features/apm/processor_event';
...
import { getKueryFields } from '../../../../../../common/features/apm/utils/get_kuery_fields';
...
export function UnifiedSearchBar({
  ...
  const { services } = useKibana<ObservabilityPluginStartDependencies & ApmServices>();
  const {
    data: {

...
import { asBigNumber, asInteger } from '../../../../../../common/features/apm/utils/formatters';
import type { ApmEvent } from '../../../../../../server/features/apm/routes/diagnostics/bundle/get_apm_events';
...
export function DiagnosticsApmDocuments() {
  ...
  const { discover } = useKibana<ObservabilityPluginStartDependencies>().services;

...
export const JavaWithLongLines: StoryObj<Args> = {
  args: {
    codeLanguage: 'java',
    exceptions: [
      {
...
export const JavaScriptWithSomeContext: StoryObj<Args> = {
  name: 'JavaScript With Some Context',
...
export const RubyWithContextAndLibraryFrames: StoryObj<Args> = {
  args: {
    codeLanguage: 'ruby',
    exceptions: [
      {

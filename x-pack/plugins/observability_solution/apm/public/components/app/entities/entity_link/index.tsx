...
import { EuiButtonEmpty, EuiEmptyPrompt, EuiLink, EuiLoadingSpinner } from '@elastic/eui';
...
export function EntityLink() {
  ...
  if (
    ...
    (serviceEntitySummary?.signalTypes && serviceEntitySummary.signalTypes.length > 0)
  ) {
    return (
      <Redirect

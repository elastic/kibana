...
import React, { createContext, useCallback, useMemo, useRef, useState, PropsWithChildren} from 'react';
...
const UrlParamsProvider: React.ComponentClass<PropsWithChildren> = withRouter(({ location, children }) => {

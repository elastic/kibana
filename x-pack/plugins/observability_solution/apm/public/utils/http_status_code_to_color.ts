...
export const useGetStatusColor = (status: string | number) => {
  ...
  const httpStatusCodeColors: Record<string, string> = {
    1: euiTheme.colors.backgroundBaseSubdued,
    2: euiTheme.colors.backgroundBaseSuccess,
    3: euiTheme.colors.backgroundBaseSubdued,
    4: euiTheme.colors.backgroundBaseWarning,
    5: euiTheme.colors.backgroundBaseDanger,
  };

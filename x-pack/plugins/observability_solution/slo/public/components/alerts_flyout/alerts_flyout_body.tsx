...
import { asDuration, observabilityPaths } from '@kbn/observability-plugin/common';
import { formatAlertEvaluationValue, TopAlert } from '@kbn/observability-plugin/public';
import { useKibana } from '../../utils/kibana_react';
import { RULE_DETAILS_PAGE_ID } from '../alerts_table/constants';
...
export function AlertsFlyoutBody({ alert, rawAlert, id: pageId }: FlyoutProps) {
  ...
  const linkToRule =
    pageId !== RULE_DETAILS_PAGE_ID && ruleId && prepend
      ? prepend(observabilityPaths.ruleDetails(ruleId))
      : null;

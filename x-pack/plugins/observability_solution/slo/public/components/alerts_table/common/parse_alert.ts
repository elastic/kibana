...
import type { ObservabilityRuleTypeRegistry, TopAlert } from '@kbn/observability-plugin/public';
import { asDuration, asPercent } from '@kbn/observability-plugin/common';

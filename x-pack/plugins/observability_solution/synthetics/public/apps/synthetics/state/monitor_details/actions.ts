...
import { Ping, PingsResponse, SyntheticsMonitor } from '../../../../../common/runtime_types';
...
export const getMonitorAction = createAsyncAction<{ monitorId: string }, SyntheticsMonitor>(

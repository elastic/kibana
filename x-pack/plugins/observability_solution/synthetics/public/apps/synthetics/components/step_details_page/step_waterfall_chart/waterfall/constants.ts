...
// Flex grow value
export const SIDEBAR_GROW_SIZE = 3;
// Axis height
...
// Font size of the request titles/links in the left sidebar
export const RESOURCE_TITLE_FONT_SIZE = 14;
...
export const CHART_HEADER_HEIGHT = 146;

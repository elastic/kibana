...
/**
 * Simplified version of https://github.com/elastic/kibana/blob/master/x-pack/solutions/security/solutions/security/plugins/security_solution/server/lib/telemetry/sender.ts

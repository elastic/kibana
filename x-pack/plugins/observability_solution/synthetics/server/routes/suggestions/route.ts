...
import { QuerySchema, SEARCH_FIELDS, getMonitorFilters } from '../common';
/*
...
export const getSyntheticsSuggestionsRoute: SyntheticsRestApiRouteFactory<MonitorFiltersResult> =
  () => ({
    method: 'GET',

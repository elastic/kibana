...
export function AssistantAvatar({ size = 's', background }: AssistantAvatarProps) {
  ...
  return (
    <svg
      ...
      fill="none"
    >
      {background ? <circle cx={32} cy={32} r={32} fill="white" /> : null}
      <g transform={background ? 'scale(0.5) translate(32,32)' : ''}>

...
export function TechnicalPreviewBadge() {
  return (
    <EuiBetaBadge
      label={i18n.translate('xpack.observability.slo.technicalPreviewBadgeTitle', {
        defaultMessage: 'Technical Preview',
      })}
      size="s"
      tooltipPosition="bottom"
      tooltipContent={i18n.translate('xpack.observability.slo.technicalPreviewBadgeDescription', {
        defaultMessage:

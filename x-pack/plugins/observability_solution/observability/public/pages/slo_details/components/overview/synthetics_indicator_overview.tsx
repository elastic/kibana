...
import { syntheticsMonitorDetailLocatorID } from '../../../../../common';
...
const MONITOR_LABEL = i18n.translate(
  'xpack.observability.slo.sloDetails.overview.syntheticsMonitor',
  {
...
const MONITOR_ARIA_LABEL = i18n.translate(
  'xpack.observability.slo.sloDetails.overview.syntheticsMonitorDetails',
  {

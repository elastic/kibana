...
export function RunTimeFieldUsed({ dataView }: { dataView?: DataView }) {
  const { watch } = useFormContext<CreateSLOForm>();
  const indicator = watch('indicator');

  const fieldNames = useRunTimeFieldBeingUsed(dataView, indicator);
  ...
  return (
    <EuiCallOut title="Runtime fields being used" color="warning" iconType="warning">
      <p>
        <FormattedMessage
          id="xpack.observability.runTimeFieldUsed.p.theRuntimeFieldLabel"

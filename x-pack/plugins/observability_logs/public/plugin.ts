  ...
  implements Plugin<ObservabilityLogsPluginSetup, ObservabilityLogsPluginStart>
{
  public setup(core: CoreSetup): ObservabilityLogsPluginSetup {
    ...
    core.application.register({
      id: 'observabilityLogs',
      title: PLUGIN_NAME,
      appRoute: '/app/observability-logs',
    ...
    return {
      getGreeting() {
        return i18n.translate('observabilityLogs.greetingText', {
  ...
  public start(core: CoreStart): ObservabilityLogsPluginStart {
    return {};
  }

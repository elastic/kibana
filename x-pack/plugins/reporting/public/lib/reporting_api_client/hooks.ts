...
import { IlmPolicyStatusResponse, DefaultPolicyStatusResponse } from '../../../common/types';
...
export const useCheckDefaultPolicyStatus = (): UseRequestResponse<DefaultPolicyStatusResponse> => {
  const {
    services: { http },
  } = useKibana();

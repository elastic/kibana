...
import { CancellationToken, generatePdfObservableV2, LocatorParams } from '@kbn/reporting-common';
...
jest.mock('@kbn/reporting-common/export_type_helpers/generate_pdf_v2.ts');

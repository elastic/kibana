...
import { CreateJobFn, ReportingRequestHandlerContext } from '../../../types';
import type { BaseParamsPDF, JobParamsPDF, JobParamsPDFLegacy, TaskPayloadPDF } from '../types';

function isLegacyJob(
  jobParams: JobParamsPDF | JobParamsPDFLegacy
): jobParams is JobParamsPDFLegacy {
  return (jobParams as BaseParamsPDF).relativeUrls != null;
}

...
import { CSV_JOB_TYPE, CSV_JOB_TYPE_DEPRECATED, ExportType } from '@kbn/reporting-common';
...
export function getDocumentPayloadFactory(reporting: ReportingCore) {
  ...
  async function getCompleted({
    ...
    const exportType = exportTypesRegistry.get((item: ExportType) => item.jobType === jobType);

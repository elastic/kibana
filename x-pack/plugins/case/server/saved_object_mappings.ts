...
import { NewCaseFormatted, NewCommentFormatted } from './';
...
export const caseSavedObjectConfig: SavedObjectsType = {
...
export const caseCommentSavedObjectConfig: SavedObjectsType = {

...
import { getSecurityGetStartedESSComponent } from './components/get_started';
    ...
    >
{
  ...
  public start(
    ...
    securitySolution.setGetStartedPage(getSecurityGetStartedESSComponent(core, startDeps));

...
import { Logger, PluginInitializerContext, RecursiveReadonly } from '../../../../src/core/server';
import { deepFreeze } from '../../../../src/core/utils';
import { FeatureWithAllOrReadPrivileges } from './feature_registry';
...
export class Plugin {
  ...
  public async setup(): Promise<RecursiveReadonly<PluginSetupContract>> {
    return deepFreeze({
      registerFeature(feature: FeatureWithAllOrReadPrivileges) {},
    });
  }

...
export function createDataQualityAlertType(
  config: MonitoringConfig
): RuleTypeModel<MonitoringAlertTypeParams> {
  return {
    id: RULE_DATA_QUALITY,
    description: RULE_DETAILS[RULE_DATA_QUALITY].description,
    iconClass: 'bell',
    ...
    ruleParamsExpression: (props: LazyExpressionProps) => (
      <LazyExpression
        {...props}
        config={config}
        paramDetails={RULE_DETAILS[RULE_DATA_QUALITY].paramDetails}
      />
    ),
    validate,

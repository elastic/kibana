...
export const LogstashTemplate: React.FC<LogstashTemplateProps> = ({
  ...
  if (!instance && !pipelineId) {
    ...
    tabs.push({
      ...
      route: `/logstash/node/${instance}`, //IDK if this is right
    })
    tabs.push({
      id: 'pipeline',
      ...
      route: `/logstash/node/${instance}/pipelines`, //IDK if this is right
    })
    tabs.push({
      id: 'advanced',
      ...
      route: `/logstash/node/${instance}/advanced`, //IDK if this is right
    })
  }

...
export function formatMsg(err: Record<string, any> | string, source: string = '') {
  ...
  if (typeof err === 'string') {
    ...
    if (err.status === -1) {
      ...
      message += i18n.translate('xpack.monitoring.notify.toaster.unavailableServerErrorMessage', {
        defaultMessage:
      ...
      message += i18n.translate('xpack.monitoring.notify.toaster.errorStatusMessage', {

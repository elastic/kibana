...
export const parseProps = (props) => {
  const {
    ...
    start_time: { ms: mbStartTimeInMillis },
    total_time: { ms: mbTotalTimeInMillis },
    source,
    target,
    translog,
    type,
  ...
  return {
    ...
    startTime: formatDateTimeLocal(startTimeInMillis || mbStartTimeInMillis, timezone),
    totalTime: formatMetric(
      Math.floor((totalTimeInMillis || mbTotalTimeInMillis) / 1000),
      '00:00:00'
    ),

          ...
          <EuiFlexItem>
            <EuiPanel paddingSize="m">
                    ...
                    <h3>
                      ...
                      >
                        <FormattedMessage
                          ...
                          values={{
                            rulesCount: (
                              <span data-test-subj="number_of_kibana_rules">
                                {props.rules.count}
                              </span>
                            ),
                          }}
              ...
              <EuiDescriptionList type="column">
                <EuiDescriptionListTitle className="eui-textBreakWord">
                  <FormattedMessage
                    id="xpack.monitoring.cluster.overview.kibanaPanel.ruleDurationLabel"
                    defaultMessage="Average duration"
                  />
                </EuiDescriptionListTitle>
                <EuiDescriptionListDescription data-test-subj="kbnRuleDuration">
                  {formatNumber(props.rules.averageDuration, 'int_commas')}ms
                </EuiDescriptionListDescription>
              </EuiDescriptionList>
            </EuiPanel>
          </EuiFlexItem>

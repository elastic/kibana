...
import { fetchTaskManagerDurationStats } from '../lib/alerts/fetch_task_manager_duration_stats';
...
export class TaskManagerDurationAlert extends BaseAlert {
  constructor(public rawAlert?: SanitizedAlert) {
    super(rawAlert, {
      ...
      name: ALERT_DETAILS[ALERT_TASK_MANAGER_DURATION].label,
      accessorKey: 'taskManagerDuration',
      defaultParams: {
        threshold: 200,
        duration: '5m',
      },
      actionVariables: [
        ...
        //   name: 'count',
        //   description: i18n.translate(
        //     'xpack.monitoring.alerts.taskManagerDuration.actionVariables.count',
        //     {
  ...
  protected async fetchData(
    ...
    return stats.map((stat) => {
      return {
        ...
        shouldFire: stat.p99 > params.threshold!,
  ...
  protected getUiMessage(alertState: AlertState, item: AlertData): AlertMessage {
    ...
    return {
      ...
      nextSteps: [
        createLink(
          i18n.translate('xpack.monitoring.alerts.taskManagerDuration.ui.nextSteps.hotThreads', {
        ...
        createLink(
          i18n.translate('xpack.monitoring.alerts.taskManagerDuration.ui.nextSteps.runningTasks', {
  ...
  protected executeActions(
    ...
    if (firingCount > 0) {
      ...
      const internalShortMessage = i18n.translate(
        'xpack.monitoring.alerts.taskManagerDuration.firing.internalShortMessage',
        {
      ...
      const internalFullMessage = i18n.translate(
        'xpack.monitoring.alerts.taskManagerDuration.firing.internalFullMessage',
        {

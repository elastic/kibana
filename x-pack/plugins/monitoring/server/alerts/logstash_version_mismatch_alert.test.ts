...
describe('LogstashVersionMismatchAlert', () => {
  it('should have defaults', () => {
    ...
    expect(alert.actionVariables).toStrictEqual([
      ...
      {
        name: 'clusterName',
        description: 'The name of the cluster to which the nodes belong.',
      },
        ...
        alertStates: [
          {
            ...
            ui: {
              ...
              message: {
                text:
                  'There are different versions of Logstash ([8.0.0, 7.2.1]) running in this cluster.',
              },
              severity: 'warning',
              resolvedMS: 0,
              triggeredMS: 1,
        ...
        alertStates: [
          {
            ...
            ui: {
              isFiring: false,
              message: {
                text: 'All versions are the same for Logstash in this cluster.',
              },
              severity: 'danger',
              resolvedMS: 1,
              triggeredMS: 1,

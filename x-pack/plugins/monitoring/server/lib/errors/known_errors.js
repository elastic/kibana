...
const mapTypeMessage = {
  ConnectionError: i18n.translate('xpack.monitoring.errors.connectionFaultErrorMessage', {
  ...
  NoLivingConnectionsError: i18n.translate('xpack.monitoring.errors.noConnectionsErrorMessage', {
    defaultMessage: 'Check the Elasticsearch Monitoring cluster network connection and refer to the Kibana logs for more information.' }),
  ResponseError: i18n.translate('xpack.monitoring.errors.statusCodeErrorMessage', {

    ...
    this.calculation = (
      ...
      if (_bucket.metric_deriv) {
        ...
        if (
          ...
          return successes / total /*/ bucketSizeInMillis*/ * 100;
        }
      }
      return null;
    };
...
export class ApmFailureResponseMetric extends ApmMetric {
  constructor(opts) {
    ...
    this.calculation = (
      ...
      // console.log('ApmSuccessFailureMetric.calculation', _bucket);
      if (_bucket.metric_deriv) {
        const total = _bucket.metric_deriv.normalized_value;
        ...
        if (
          ...
          // console.log(`Value=${((okDerivNormalizedValue + acceptedDerivNormalizedValue) / totalDerivNormalizedValue) /*/ bucketSizeInMillis */* 100}`);
          return failures  / total /*/ bucketSizeInMillis*/ * 100;
        }
      }
      return null;
    };

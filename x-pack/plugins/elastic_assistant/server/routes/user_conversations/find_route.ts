    ...
    .addVersion(
      ...
      async (context, request, response): Promise<IKibanaResponse<FindConversationsResponse>> => {
        ...
        try {
          ...
          // MUST MATCH THE LENGTH OF BASE_SECURITY_CONVERSATIONS from 'x-pack/solutions/security/solutions/security/plugins/security_solution/public/assistant/content/conversations/index.tsx'

...
} from './hooks/use_side_navigation_settings';

function getNavigationTree(settings: SideNavigationSettings): NavigationTreeDefinition {
  return {
    body: [
...
export const getObservabilitySideNavComponent =
  ...
  () => {
    const settings = useSideNavigationSettings(core);

    const navigationTree = useMemo(() => {
      return getNavigationTree(settings);
    }, [settings]);

...
export const genAiSavedObjectId = 'f23c4320-00aa-11ee-a91d-genaisoid088';

export const genAiUsageDashboard: SavedObject<DashboardAttributes> = {
  attributes: {

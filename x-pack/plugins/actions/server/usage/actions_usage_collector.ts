...
export function createActionsUsageCollector(
  ...
  return usageCollection.makeUsageCollector<ActionsUsage>({
    ...
    schema: {
      ...
      count_actions_executions_failed: { type: 'long' },
      count_actions_executions_failed_by_type: byTypeSchema,
    ...
    fetch: async () => {
      try {
        ...
        return {
          ...
          count_actions_executions_failed: 0,
          count_actions_executions_failed_by_type: {},

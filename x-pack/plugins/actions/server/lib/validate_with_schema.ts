      ...
      switch (key) {
        case 'params':
          ...
          if (actionType.validate.params) {
            ...
            return actionType.validate.params.validate(validatedValue as Params, validatorServices);
          }
          break;
        case 'config':
          ...
          if (actionType.validate.config) {
            ...
            return actionType.validate.config.validate(validatedValue as Config, validatorServices);
          }
        ...
        case 'secrets':
          ...
          if (actionType.validate.secrets) {
            ...
            return actionType.validate.secrets.validate(

    ...
    return (
      <EuiKeyPadMenu>
        <EuiKeyPadMenuItem label="Hosts" onClick={this.handleClick(InfraNodeType.host)}>
          <img src="../plugins/ingest/images/hosts.svg" className="euiIcon euiIcon--large" />
        </EuiKeyPadMenuItem>
        <EuiKeyPadMenuItem label="Kubernetes" onClick={this.handleClick(InfraNodeType.pod)}>
          <img src="../plugins/ingest/images/k8.svg" className="euiIcon euiIcon--large" />
        </EuiKeyPadMenuItem>
        <EuiKeyPadMenuItem label="Docker" onClick={this.handleClick(InfraNodeType.container)}>
          <img src="../plugins/ingest/images/docker.svg" className="euiIcon euiIcon--large" />
        </EuiKeyPadMenuItem>
      </EuiKeyPadMenu>
    );
  }

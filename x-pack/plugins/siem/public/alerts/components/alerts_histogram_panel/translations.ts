...
export const STACK_BY_LABEL = i18n.translate(
  'xpack.siem.detectionEngine.alerts.histogram.stackByOptions.stackByLabel',
  {
...
export const STACK_BY_RISK_SCORES = i18n.translate(
  'xpack.siem.detectionEngine.alerts.histogram.stackByOptions.riskScoresDropDown',
  {
...
export const STACK_BY_SEVERITIES = i18n.translate(
  'xpack.siem.detectionEngine.alerts.histogram.stackByOptions.severitiesDropDown',
  {
...
export const STACK_BY_DESTINATION_IPS = i18n.translate(
  'xpack.siem.detectionEngine.alerts.histogram.stackByOptions.destinationIpsDropDown',
  {
...
export const STACK_BY_SOURCE_IPS = i18n.translate(
  'xpack.siem.detectionEngine.alerts.histogram.stackByOptions.sourceIpsDropDown',
  {
...
export const STACK_BY_CATEGORIES = i18n.translate(
  'xpack.siem.detectionEngine.alerts.histogram.stackByOptions.eventCategoriesDropDown',
  {
...
export const STACK_BY_HOST_NAMES = i18n.translate(
  'xpack.siem.detectionEngine.alerts.histogram.stackByOptions.hostNamesDropDown',
  {
...
export const STACK_BY_RULE_TYPES = i18n.translate(
  'xpack.siem.detectionEngine.alerts.histogram.stackByOptions.ruleTypesDropDown',
  {
...
export const STACK_BY_RULE_NAMES = i18n.translate(
  'xpack.siem.detectionEngine.alerts.histogram.stackByOptions.rulesDropDown',
  {
...
export const STACK_BY_USERS = i18n.translate(
  'xpack.siem.detectionEngine.alerts.histogram.stackByOptions.usersDropDown',
  {
...
export const HISTOGRAM_HEADER = i18n.translate(
  'xpack.siem.detectionEngine.alerts.histogram.headerTitle',
  {
...
export const ALL_OTHERS = i18n.translate(
  'xpack.siem.detectionEngine.alerts.histogram.allOthersGroupingLabel',
  {
...
export const VIEW_ALERTS = i18n.translate(
  'xpack.siem.detectionEngine.alerts.histogram.viewAlertsButtonLabel',
  {
...
export const SHOWING_ALERTS = (
  ...
  i18n.translate('xpack.siem.detectionEngine.alerts.histogram.showingAlertsTitle', {

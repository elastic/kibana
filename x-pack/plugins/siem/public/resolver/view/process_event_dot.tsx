...
ChildEventsButton.displayName = 'ChildEventsButton';
...
RelatedAlertsButton.displayName = 'RelatedAlertsButton';

/**
 * An artefact that represents a process node.
 */
const ProcessEventDotComponent = React.memo(
  ({
    className,
    position,
    event,
...
ProcessEventDotComponent.displayName = 'ProcessEventDotComponent';

export const ProcessEventDot = styled(ProcessEventDotComponent)`
  position: absolute;
  text-align: left;
  font-size: 10px;
  user-select: none;

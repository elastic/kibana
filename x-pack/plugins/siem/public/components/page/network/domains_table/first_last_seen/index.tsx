...
import { useDomainLastFirstSeenQuery } from '../../../../../containers/domains/last_first_seen';
...
export const FirstLastSeen = pure<FirstLastSeenProps>(({ ip, domainName, flowTarget, type }) => {
  return (
    <ApolloConsumer>
      {client => {
        const { loading, firstSeen, lastSeen } = useDomainLastFirstSeenQuery(
          ip,
          domainName,
          flowTarget,
          'default',

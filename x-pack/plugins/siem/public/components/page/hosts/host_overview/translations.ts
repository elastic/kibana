...
export const HOST_ID = i18n.translate('xpack.siem.host.details.overview.hostIdTitle', {
...
export const VERSION = i18n.translate('xpack.siem.host.details.versionLabel', {
  defaultMessage: 'Version',
});

export const ARCHITECTURE = i18n.translate('xpack.siem.host.details.architectureLabel', {

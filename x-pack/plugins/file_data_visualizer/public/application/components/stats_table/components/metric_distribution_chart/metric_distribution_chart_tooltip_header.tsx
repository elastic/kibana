  ...
  return (
    <div style={{ maxWidth }}>
      {chartPoint.dataMax > chartPoint.dataMin ? (
        <FormattedMessage
          id="xpack.fileUpload.fieldDataCard.metricDistributionChart.tooltipValueBetweenLabel"
        ...
        <FormattedMessage
          id="xpack.fileUpload.fieldDataCard.metricDistributionChart.tooltipValueEqualLabel"

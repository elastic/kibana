...
import type { ActionFactory } from '../../../dynamic_actions/action_factory';
import type { DynamicActionManager } from '../../../dynamic_actions/dynamic_action_manager';
...
import type { CreateFlyoutManageDrilldownsProps } from './connected_flyout_manage_drilldowns';
...
export default function FlyoutManageDrilldownsComponent(
  props: ConnectedFlyoutManageDrilldownsProps & CreateFlyoutManageDrilldownsProps
) {
  const allActionFactories = props.actionFactories;

  const { storage, toastService, docsLink, getTrigger, triggerPickerDocsLink } = props;
  ...
  const { drilldowns, createDrilldown, editDrilldown, deleteDrilldown } = useDrilldownsStateManager(
    props.dynamicActionManager,
    toastService
  );

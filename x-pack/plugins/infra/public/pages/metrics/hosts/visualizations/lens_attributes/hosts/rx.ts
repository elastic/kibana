...
export const rx: LensAttributes = {
            ...
            columns: {
              'cc38b286-dc51-46b3-b3e0-81c5c9888949': {
                ...
                params: {
                  ...
                  orderAgg: {
                    label: 'Maximum of host.network.ingress.bytes',
                    dataType: 'number',
                    operationType: 'max',
              ...
              'ad3b61d1-d2b2-416c-b5ae-e034c3c111b7X0': {
                label:
                  'Part of average(host.network.ingress.bytes) / (max(metricset.period) / 1000)',
                dataType: 'number',
              ...
              'ad3b61d1-d2b2-416c-b5ae-e034c3c111b7X2': {
                ...
                params: {
                  tinymathAst: {
                    ...
                    text: 'average(host.network.ingress.bytes) / (max(metricset.period) / 1000)',
                  },
                },
                references: [
                  'ad3b61d1-d2b2-416c-b5ae-e034c3c111b7X0',
              ...
              'ad3b61d1-d2b2-416c-b5ae-e034c3c111b7': {
                label: 'average(host.network.ingress.bytes) / (max(metricset.period) / 1000)',
                dataType: 'number',
                operationType: 'formula',
                isBucketed: false,
                scale: 'ratio',
                params: {
                  formula: 'average(host.network.ingress.bytes) / (max(metricset.period) / 1000)',

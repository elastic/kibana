...
export const HostsTable = () => {
  ...
  const { columns, items, isFlyoutOpen, closeFlyout, clickedItemIndex } = useHostsTable(hostNodes, {
  ...
  return (
    <>
      ...
      />
      {isFlyoutOpen && <Flyout node={items[clickedItemIndex]} closeFlyout={closeFlyout} />}
    </>
  );
};

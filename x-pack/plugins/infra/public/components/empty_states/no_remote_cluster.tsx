...
export const NoRemoteCluster = () => {
  ...
  const goToSettings = (
    <EuiButton data-test-subj="infraHostsPageGoToSettings" color="danger" {...settingLinkProps}>
      {i18n.translate(
        'xpack.infra.hostsPage.goToMetricsSettings', { defaultMessage: 'Go to Metrics Settings' }
      )}
    </EuiButton>
  )
  ...
  return <NoIndices
    ...
    title={i18n.translate('xpack.infra.sourceConfiguration.noRemoteClusterTitle', {
      defaultMessage: 'Remote Cluster Unavailable',
    })}
    body={i18n.translate(
      'xpack.infra.sourceConfiguration.noRemoteClusterMessage',
      {
        defaultMessage:

...
export const ExpressionChart: React.FC<Props> = ({
  ...
  const ThresholdAnnotations = ({
    ...
    color,
    id,
  }: Partial<InventoryMetricConditions> & {
      ...
      <>
        <LineAnnotation
          ...
          dataValues={sortedThresholds.map((t) => ({
            dataValue: thresholdFormatter(t),
          }))}
          style={{
            line: {
              strokeWidth: 2,
              ...
              dataValues={[
                {
                  coordinates: {
                    ...
                    x1: lastTimestamp,
                    y0: domain.min,
                    y1: thresholdFormatter(first(threshold)),
                  },
                },
              ]}
            />
              ...
              dataValues={[
                {
                  coordinates: {
                    x0: firstTimestamp,
                    x1: lastTimestamp,
                    y0: thresholdFormatter(last(threshold)),
                    y1: domain.max,
                  },
                },
              ]}
            ...
            dataValues={[
              {
                coordinates: {
                  x0: firstTimestamp,
                  x1: lastTimestamp,
                  y0: thresholdFormatter(first(threshold)),
                  y1: domain.max,
                },
              },
            ]}

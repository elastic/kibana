...
export namespace InfraSourceResolvers {
  ...
  export type ServiceMetadataBetweenResolver<
    R = (ServiceMetadata | null)[],
    Parent = InfraSource,
    Context = InfraContext
  > = Resolver<R, Parent, Context, ServiceMetadataBetweenArgs>;
...
export namespace ServiceMetadataResolvers {
  export interface Resolvers<Context = InfraContext, TypeParent = ServiceMetadata> {
    /** One metadata entry for a service */
    name?: NameResolver<string, TypeParent, Context>;

    hosts?: HostsResolver<boolean, TypeParent, Context>;

    pods?: PodsResolver<boolean, TypeParent, Context>;

    containers?: ContainersResolver<boolean, TypeParent, Context>;

    logs?: LogsResolver<boolean, TypeParent, Context>;
  }

  export type NameResolver<R = string, Parent = ServiceMetadata, Context = InfraContext> = Resolver<
    R,
    Parent,
    Context
  >;

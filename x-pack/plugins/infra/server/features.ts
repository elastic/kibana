...
export const LOGS_FEATURE = {
  ...
  alerting: [LOG_DOCUMENT_COUNT_RULE_TYPE_ID, 'observability.rules.threshold'],
  privileges: {
    all: {
      app: ['infra', 'logs', 'kibana'],
      catalogue: ['infralogging', 'logs'],
      ...
      alerting: {
        rule: {
          all: [LOG_DOCUMENT_COUNT_RULE_TYPE_ID, 'observability.rules.threshold'],
        },
        alert: {
          all: [LOG_DOCUMENT_COUNT_RULE_TYPE_ID, 'observability.rules.threshold'],
        },
    ...
    read: {
      ...
      alerting: {
        rule: {
          read: [LOG_DOCUMENT_COUNT_RULE_TYPE_ID, 'observability.rules.threshold'],
        },
        alert: {
          read: [LOG_DOCUMENT_COUNT_RULE_TYPE_ID, 'observability.rules.threshold'],
        },

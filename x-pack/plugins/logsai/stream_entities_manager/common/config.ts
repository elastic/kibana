...
export type StreamEntitiesManagerConfig = TypeOf<typeof configSchema>;
...
export type StreamEntitiesManagerPublicConfig = Pick<StreamEntitiesManagerConfig, ValidKeys>;

...
import { CsvSearchsourceExportType, PdfExportType, PngExportType } from './export_types';
...
{
  exportTypes = [new CsvSearchsourceExportType(), new PdfExportType(), new PngExportType()];

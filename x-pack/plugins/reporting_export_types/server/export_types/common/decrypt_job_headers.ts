...
export const decryptJobHeaders = async (
  ...
  try {
    ...
    throw new Error(
      i18n.translate('xpack.reportingExportTypes.failedToDecryptReportJobDataErrorMessage', {
        defaultMessage:
          'Failed to decrypt report job data. Please ensure that {encryptionKey} is set and re-generate this report. {err}',
        values: { encryptionKey: 'xpack.reportingExportTypes.encryptionKey', err: err.toString() },
      })
    );
  }
};

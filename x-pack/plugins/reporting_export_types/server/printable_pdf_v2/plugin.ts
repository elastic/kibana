...
import {
  ...
  GetScreenshotsFn,
} from '@kbn/reporting-plugin/server/export_types/printable_pdf_v2/lib/generate_pdf';
import { metadata } from '@kbn/reporting-plugin/server/export_types/printable_pdf_v2/metadata';

...
jest.mock('@kbn/reporting-plugin/server/export_types/printable_pdf/lib/generate_pdf');
...
import { PdfExportType } from '../export_types';
import { generatePdfObservable } from '../export_types/printable_pdf_v2/lib/generate_pdf';

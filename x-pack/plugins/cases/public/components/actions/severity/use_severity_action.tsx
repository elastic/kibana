    ...
    return [
      {
        ...
        'data-test-subj': 'cases-bulk-action-severity-open',
        key: 'cases-bulk-action-severity-open',
      },
      {
        ...
        'data-test-subj': 'cases-bulk-action-severity-in-progress',
        key: 'cases-bulk-action-severity-in-progress',
      },
      {
        ...
        'data-test-subj': 'cases-bulk-action-severity-closed',
        key: 'cases-bulk-severity-action',
      },
      {

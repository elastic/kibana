...
describe('getEuiTableColumn ', () => {
  ...
  it('render function renders a text column correctly', async () => {
    ...
    expect(screen.getByTestId(`date-custom-field-column-view-${key}`)).toBeInTheDocument();
    expect(screen.getByTestId(`date-custom-field-column-view-${key}`)).toHaveTextContent(value);
  });
});

...
const FormWrapperComponent: React.FC<FormWrapper> = ({
  ...
  const formFieldConfig = getDateFieldConfig({
...
const EditComponent: CustomFieldType<CaseCustomFieldDate>['Edit'] = ({
  customField,
  customFieldConfiguration,
  onSubmit,
  isLoading,
  ...
  return (
    <>
      ...
      >
        ...
        {isLoading && (
          <EuiLoadingSpinner
            data-test-subj={`case-date-custom-field-loading-${customFieldConfiguration.key}`}
          />
        )}
        {!isLoading && canUpdate && (
          <EuiFlexItem grow={false}>
            <EuiButtonIcon
              data-test-subj={`case-date-custom-field-edit-button-${customFieldConfiguration.key}`}
      ...
      <EuiFlexGroup
        gutterSize="m"
        data-test-subj={`case-date-custom-field-${customFieldConfiguration.key}`}
        direction="column"
      >
            ...
            <EuiFlexItem>
              <EuiFlexGroup alignItems="center" responsive={false}>
                <EuiFlexItem grow={false}>
                  <EuiButton
                    color="success"
                    data-test-subj={`case-date-custom-field-submit-button-${customFieldConfiguration.key}`}
                    fill
                    iconType="save"
                ...
                <EuiFlexItem grow={false}>
                  <EuiButtonEmpty
                    data-test-subj={`case-date-custom-field-cancel-button-${customFieldConfiguration.key}`}
                    iconType="cross"
                    onClick={onCancel}
                    size="s"
                  >

...
const CustomCodeBlockComponent = ({ value }: { value: string }) => {
...
CustomCodeBlockComponent.displayName = 'CustomCodeBlock';

export const CustomCodeBlock = React.memo(CustomCodeBlockComponent);

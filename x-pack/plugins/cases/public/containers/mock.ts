...
export const similarCasesCamel = {
  cases: [
    {
      assignees: [{ uid: 'u_J41Oh6L9ki-Vo2tOogS8WRTENzhHurGtRc87NgEAlkc_0' }],
      category: null,
      ...
      createdBy: { email: 'leslie.knope@elastic.co', fullName: 'Leslie Knope', username: 'lknope' },
      customFields: [],
      description: 'Security banana Issue',
      duration: null,
      externalService: null,
      ...
      updatedBy: { email: 'leslie.knope@elastic.co', fullName: 'Leslie Knope', username: 'lknope' },
      version: 'WzQ3LDFd',
    },
    {
      assignees: [{ uid: 'u_J41Oh6L9ki-Vo2tOogS8WRTENzhHurGtRc87NgEAlkc_0' }],
      ...
      closedAt: null,
      closedBy: null,
      connector: { fields: null, id: 'servicenow-1', name: 'My SN connector', type: '.servicenow' },
      createdAt: '2020-02-19T23:06:33.798Z',
      createdBy: { email: 'leslie.knope@elastic.co', fullName: 'Leslie Knope', username: 'lknope' },
      customFields: [],
      description: 'Security banana Issue',
      ...
      externalService: {
        ...
        externalTitle: 'external title',
        externalUrl: 'basicPush.com',
        pushedAt: '2023-01-17T09:46:29.813Z',
        pushedBy: {
          email: 'leslie.knope@elastic.co',
          fullName: 'Leslie Knope',
          username: 'lknope',
    ...
    },
    {
      ...
      totalAlerts: 0,
      totalComment: 0,
      updatedAt: '2023-01-18T09:46:29.813Z',
      updatedBy: { email: 'leslie.knope@elastic.co', fullName: 'Leslie Knope', username: 'lknope' },
      version: 'WzQ3LDFd',
    },
    {
    ...
    },
    {
      ...
      duration: null,
      externalService: null,
      id: 'case-with-alerts-syncoff-id',
      observables: [],
      owner: 'securitySolution',

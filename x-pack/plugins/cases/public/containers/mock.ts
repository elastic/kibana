...
import type { ActionLicense, CaseUI, CasesStatus, UserActionUI, AttachmentUI } from './types';
...
import type { Case, CasesFindResponse, Cases, CasesStatusResponse } from '../../common/api';

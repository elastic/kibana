[Cases Client API Interface](../README.md) / [configure/client](../modules/configure_client.md) / [\_\_internalNamespace](../modules/configure_client.__internalNamespace.md) / UpdateMappingsArgs

...
import { ServiceNowITSMCaseConnector, ServiceNowSIRCaseConnector } from './types';

export const getServiceNowITSMCaseConnector = (): ServiceNowITSMCaseConnector => ({
  getMapping: getServiceNowITSMMapping,
  format: formatServiceNowITSM,
});

export const getServiceNowSIRCaseConnector = (): ServiceNowSIRCaseConnector => ({

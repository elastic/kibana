...
describe('common utils', () => {
  ...
  describe('getOrUpdateLensReferences', () => {
    ...
    const nonLensCurrentCommentReferences = [
      ...
      { type: 'timeline', id: '0f847d31-9683-4ebd-92b9-454e3e39aec1', name: 'Test case timeline' },
    ];
    ...
    const expectedReferences = [...nonLensCurrentCommentReferences, ...newCommentStringReferences];

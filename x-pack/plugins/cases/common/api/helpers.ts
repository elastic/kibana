...
import {
  ...
  INTERNAL_GET_CASE_ATTACHMENTS_STATS_URL,
} from '../constants';
...
export const getCaseAttachmentStatsUrl = (id: string): string => {
  return INTERNAL_GET_CASE_ATTACHMENTS_STATS_URL.replace('{case_id}', id);
};

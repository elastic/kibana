...
import {
  ...
  INTERNAL_GET_CASE_FILE_EXTENSIONS_URL,
} from '../constants';
...
export const getCaseFileExtensionsUrl = (id: string): string => {
  return INTERNAL_GET_CASE_FILE_EXTENSIONS_URL.replace('{case_id}', id);
};

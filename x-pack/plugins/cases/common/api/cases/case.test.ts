...
describe('Case', () => {
  ...
  describe('CaseFullExternalServiceRt', () => {
    ...
    describe('CaseAttributesRt', () => {
      ...
      it('removes foo:bar attributes from connector', () => {
          const query = CaseAttributesRt.decode({...defaultRequest, connector: {...defaultRequest.connector, foo: 'bar' }});
  ...
  describe('CasePostRequestRt', () => {
      ...
      it('removes foo:bar attributes from connector', () => {
          const query = CasePostRequestRt.decode({...defaultRequest, connector: {...defaultRequest.connector, foo: 'bar' }});

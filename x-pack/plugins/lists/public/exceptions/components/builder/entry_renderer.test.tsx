...
import { validateWildcardInput } from '@kbn/securitysolution-utils';
...
describe('BuilderEntryItem', () => {
  ...
  test('it invokes "setWarningsExist" when invalid value in field value input', async () => {
    ...
    (validateWildcardInput as jest.Mock).mockReturnValue('some warning message');
    wrapper = mount(
      <BuilderEntryItem
        autocompleteService={autocompleteStartMock}
        entry={{
  ...
  test('it does not invoke "setWarningsExist" when valid value in field value input', async () => {
    ...
    (validateWildcardInput as jest.Mock).mockReturnValue(undefined);
    wrapper = mount(
      <BuilderEntryItem
        autocompleteService={autocompleteStartMock}
        entry={{

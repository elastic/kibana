...
import { CommentsNewArray, DefaultCommentsNewArray, DefaultEntryArray } from '../types';
...
export const createExceptionListItemSchema = t.intersection([
  ...
  t.exact(
    t.partial({
      ...
      comments: DefaultCommentsNewArray, // defaults to empty array if not set during decode

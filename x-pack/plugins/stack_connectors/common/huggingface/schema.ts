...
import { DEFAULT_HUGGINGFACE_MODEL, HuggingFaceProviderType } from './constants';

// Connector schema
export const ConfigSchema = schema.oneOf([
  schema.object({
    apiProvider: schema.oneOf([schema.literal(HuggingFaceProviderType.HuggingFace)]),
    apiUrl: schema.string(),
    defaultModel: schema.string({ defaultValue: DEFAULT_HUGGINGFACE_MODEL }),

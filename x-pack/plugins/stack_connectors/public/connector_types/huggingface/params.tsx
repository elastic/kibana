...
import { HuggingFaceActionConnector, ActionParams } from './types';
...
const ParamsFields: React.FunctionComponent<ActionParamsProps<ActionParams>> = ({
  ...
  const typedActionConnector = actionConnector as unknown as HuggingFaceActionConnector;

...
// Have to change the url to our api
...
export const huggingFaceConfig: ConfigFieldSchema[] = [
  {
    id: 'apiUrl',
  ...
  },
  {
    ...
    defaultValue: DEFAULT_HUGGINGFACE_MODEL,
  },
];

export const huggingFaceSecrets: SecretsFieldSchema[] = [
  {
    id: 'apiKey',
...
export const providerOptions = [
  {
    value: HuggingFaceProviderType.HuggingFace,
    text: i18n.OPENAI,
    label: i18n.OPENAI,
  },
];

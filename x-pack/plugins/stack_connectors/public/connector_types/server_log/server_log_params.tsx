...
export const ServerLogParamsFields: React.FunctionComponent<React.PropsWithChildren<ActionParamsProps<ServerLogActionParams>>> = ({ actionParams, editAction, index, errors, messageVariables, defaultMessage }) => {

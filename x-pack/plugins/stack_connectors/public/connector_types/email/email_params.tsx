...
export const EmailParamsFields = ({
  ...
  const isToInvalid: boolean = to !== undefined && errors.to !== undefined && !!errors.to.length;
  const isSubjectInvalid: boolean =
    subject !== undefined && errors.subject !== undefined && !!errors.subject.length;
  const isCCInvalid: boolean = errors.cc !== undefined && !!errors.cc.length && cc !== undefined;
  const isBCCInvalid: boolean =
    errors.bcc !== undefined && !!errors.bcc.length && bcc !== undefined;

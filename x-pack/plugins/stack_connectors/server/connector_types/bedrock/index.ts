...
import { GenerativeAIForSecuritySolutionConnectorFeatureId } from '@kbn/actions-plugin/common';
...
export const getConnectorType = (): SubActionConnectorType<Config, Secrets> => ({
  ...
  supportedFeatureIds: [GenerativeAIForSecuritySolutionConnectorFeatureId],

...
import { getConnectorType as getSlackConnectorType } from './slack/v1';
import { getConnectorType as getSlackV2ConnectorType } from './slack/v2';
...
export { ConnectorTypeId as SlackConnectorTypeId } from './slack/v1';
export type { ActionParamsType as SlackActionParams } from './slack/v1';
export { SLACK_CONNECTOR_ID as SlackV2ConnectorTypeId } from '../../common/slack/constants';
export type { ActionParamsType as SlackV2ActionParams } from './slack/v2';
...
export function registerConnectorTypes({
  ...
  actions.registerType(getSlackV2ConnectorType());

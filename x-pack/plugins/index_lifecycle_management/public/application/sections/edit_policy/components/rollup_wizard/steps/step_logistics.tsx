            ...
            <EuiText>
              <p>
                <FormattedMessage
                  ...
                  // TODO: Copy required
                  defaultMessage="[Describe options presented here for managing a rollup index lifecycle]"
                />
              </p>
            </EuiText>
          </EuiFlexItem>
              ...
              <EuiTitle size="s">
                <h3>
                  <FormattedMessage
                    ...
                    // TODO: Copy required
                    defaultMessage="[Field label for the ILM policy that will manage the rollup index]"
                  />
                </h3>
              </EuiTitle>
            }
            description={
              <>
                <FormattedMessage
                  ...
                  // TODO: Copy required
                  defaultMessage="[Description; specify a policy to manage the rollup index generated by this action. By default, the current ILM policy is used to manage the new rollup index.]"
                />
                <EuiSpacer />
                <EuiSwitch
                  label={i18n.translate(
                    ...
                    // TODO: Copy required
                    { defaultMessage: '[Toggle to enable use of non-default ILM policy]' }
                  )}

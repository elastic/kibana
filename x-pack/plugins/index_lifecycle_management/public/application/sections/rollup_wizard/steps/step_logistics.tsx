...
interface Props {
  ...
  isValidatingIndexPattern: boolean;
  hasMatchingIndices: boolean;
  indexPatternAsyncErrors: string[];
}
      ...
      <>
        ...
        <EuiForm>
          <DescribedFormRow
            ...
            description={
              <FormattedMessage
                id="xpack.indexLifecycleMgmt.stepLogistics.sectionRollupIndexILMPolicyDescription"

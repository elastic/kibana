...
import { createLatestMonitorsResolvers, latestMonitorsSchema } from './latest_monitors';
import { createMonitorsResolvers, monitorsSchema } from './monitor_charts';

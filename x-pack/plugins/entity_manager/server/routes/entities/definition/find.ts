 ...
 * 2.0.
 */
<<<<<<<< HEAD:x-pack/plugins/entity_manager/server/routes/entities/get.ts
...
>>>>>>>> e83ab3a71f9 ([EEM] UI Poc):x-pack/plugins/entity_manager/server/routes/entities/definition/find.ts

...
module.exports = async ({ config }) => {
        ...
        options: {
          prependData(loaderContext) {
            return `@import ${stringifyRequest(
              loaderContext,
              path.resolve(KIBANA_ROOT, 'src/legacy/ui/public/styles/_styling_constants_v7light.scss')
            )};\n`;
          },
          sassOptions: {
  ...
  config.resolve.alias['src/legacy/ui/public/styles/styling_constants'] = path.resolve(KIBANA_ROOT, 'src/legacy/ui/public/styles/_styling_constants_v7light.scss');

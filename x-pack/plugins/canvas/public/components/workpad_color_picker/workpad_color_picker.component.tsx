...
export const WorkpadColorPicker = (props: Props) => {
  ...
  const onAddColor = useCallback((payload: any) => dispatch(addColor(payload)), [dispatch]);
  const onRemoveColor = useCallback((payload: any) => dispatch(removeColor(payload)), [dispatch]);

...
const { WaffleVis: waffleVisStrings, PartitionVis: strings } = ViewStrings;

export const waffleVis = () => ({
  name: 'waffleVis',
  displayName: waffleVisStrings.getDisplayName(),
  args: [
    {
      name: 'metric',
    ...
    },
    {
      ...
      displayName: waffleVisStrings.getShowValuesInLegendDisplayName(),
      help: waffleVisStrings.getShowValuesInLegendHelp(),
      argType: 'toggle',
      default: true,
    },
    {

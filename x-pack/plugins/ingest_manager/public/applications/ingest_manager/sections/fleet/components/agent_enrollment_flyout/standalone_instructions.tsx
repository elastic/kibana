        ...
        <>
          <EuiText>
            <FormattedMessage
              ...
              defaultMessage="From the agent directory, run that command to install, enroll and start an Elastic Agent. You can reuse that command to set up agents on more than one host. Requires administrator privileges."
            />
            <EuiSpacer size="m" />

...
type DateType = t.Type<Date, string, unknown>;
const DateFromString: DateType = new t.Type<Date, string, unknown>(
  'DateFromString',
...
const createPolicyInterface = (beatPolicyInterface: t.Mixed = t.Dictionary) =>
  t.interface(
    {

...
import { createColumnarViewModel } from '@kbn/profiling-shared-ui/common/columnar_view_model';
import { FRAME_TYPE_COLOR_MAP, rgbToRGBA } from '@kbn/profiling-shared-ui/common/frame_type_colors';

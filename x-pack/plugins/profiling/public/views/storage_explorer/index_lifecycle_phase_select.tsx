  ...
  const options = [
    {
      ...
      label: i18n.translate('xpack.profiling.storageExplorer.indexLifecyclePhase.all.label', {
        defaultMessage: 'All',
      }),
      description: i18n.translate(
        'xpack.profiling.storageExplorer.indexLifecyclePhase.all.description',
        {
    ...
    },
    {
      ...
      label: i18n.translate('xpack.profiling.storageExplorer.indexLifecyclePhase.hot.label', {
        defaultMessage: 'Hot',
      }),
      description: i18n.translate(
        'xpack.profiling.storageExplorer.indexLifecyclePhase.hot.description',
        {
    ...
    },
    {
      ...
      label: i18n.translate('xpack.profiling.storageExplorer.indexLifecyclePhase.warm.label', {
        defaultMessage: 'Warm',
      }),
      description: i18n.translate(
        'xpack.profiling.storageExplorer.indexLifecyclePhase.warm.description',
        {
          defaultMessage:
    ...
    },
    {
      ...
      label: i18n.translate('xpack.profiling.storageExplorer.indexLifecyclePhase.cold.label', {
        defaultMessage: 'Cold',
      }),
      description: i18n.translate(
        'xpack.profiling.storageExplorer.indexLifecyclePhase.cold.description',
        {
          defaultMessage:
    ...
    },
    {
      ...
      label: i18n.translate('xpack.profiling.storageExplorer.indexLifecyclePhase.frozen.label', {
        defaultMessage: 'Frozen',
      }),
      description: i18n.translate(
        'xpack.profiling.storageExplorer.indexLifecyclePhase.frozen.description',
        {

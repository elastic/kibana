...
import { CustomIcon, IconDynamicOptions, IconStaticOptions } from '../../../../../../common/descriptor_types';
...
export function VectorStyleIconEditor(props: IconEditorProps & { customIcons: CustomIcon[], onCustomIconsChange: (customIcons: CustomIcon[]) => void; }) {

...
export class AbstractLayer implements ILayer {
  ...
  static createDescriptor(options: Partial<LayerDescriptor>): LayerDescriptor {
    return {
      ...
      isFittable: typeof options.isFittable === 'boolean' ? options.isFittable : true,
    };
  }
  ...
  async isFittable(): Promise<boolean> {
    return (await this.supportsFitToBounds()) && this.isVisible() && this.isFittableFlagOn();
  }

  isFittableFlagOn(): boolean {
    return !!this._descriptor.isFittable;
  }

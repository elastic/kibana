...
export class AlertingLayerTemplate extends Component<RenderWizardArguments, State> {
  state = {
    indexPatternId: null,
  ...
  _previewLayer() {
    ...
    this.props.previewLayers(
      createAlertingLayerDescriptors(this.state.indexPatternId!, this.state.indexPatternTitle!)
    );
  }

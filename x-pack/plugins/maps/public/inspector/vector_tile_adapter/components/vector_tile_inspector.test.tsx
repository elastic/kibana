...
describe('VectorTileInspector', () => {
  ...
  test('should show first layer, first tile, and request tab when options not provided', () => {
    render(<VectorTileInspector adapters={{ vectorTiles: vectorTileAdapter }} title="Vector tiles" />);
  ...
  test('should show layer, tile, and tab specified by options', () => {
    ...
    render(<VectorTileInspector adapters={{ vectorTiles: vectorTileAdapter! }} options={options} title="Vector tiles" />);

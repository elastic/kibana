...
import { IKbnUrlStateStorage, syncState, BaseStateContainer } from '@kbn/kibana-utils-plugin/public';
import { getData } from '../../../kibana_services';
import { AppStateManager } from './app_state_manager';

export function startAppStateSyncing(appStateManager: AppStateManager, kbnUrlStateStorage: IKbnUrlStateStorage) {

...
export class FeatureEditControl extends Component<Props, State> {
  ...
  _renderToolsButton() {
    return (
      <EuiButtonIcon
        ...
        aria-label={i18n.translate('xpack.maps.toolbarOverlay.FeatureEditControlTitle', {
          defaultMessage: 'Tools',
        })}
        title={i18n.translate('xpack.maps.toolbarOverlay.FeatureEditControlTitle', {
          defaultMessage: 'Tools',
        })}
      />
    );
  ...
  render() {
    ...
    if (!this.props.isDrawingFilter) {
      return featureEditControlPopoverButton;
    }

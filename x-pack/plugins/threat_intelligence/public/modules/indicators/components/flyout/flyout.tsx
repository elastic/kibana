...
import { DateFormatter } from '../../../dates/components/date_formatter/date_formatter';
...
export interface IndicatorFlyoutProps {
  /**
 ...
 */
export const IndicatorFlyout: VFC<IndicatorFlyoutProps> = ({ indicator, closeFlyout }) => {

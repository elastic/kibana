 ...
 * (reverse of https://github.com/elastic/kibana/blob/main/x-pack/solutions/security/solutions/security/plugins/security_solution/common/cti/constants.ts#L35)
 */

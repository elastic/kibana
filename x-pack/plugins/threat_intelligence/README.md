...
The Threat Intelligence plugin is loaded lazily within the [security_solution](https://github.com/elastic/kibana/tree/main/x-pack/solutions/security/solutions/security/plugins/security_solution) plugin,
from `x-pack/solutions/security/solutions/security/plugins/security_solution/public/threat_intelligence` owned by the Threat Hunting Investigations Team.

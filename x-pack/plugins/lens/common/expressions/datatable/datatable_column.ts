...
export const datatableColumn: DatatableColumnFunction = {
  ...
  args: {
    ...
    sortingHint: { types: ['string'] },
    hidden: { types: ['boolean'] },
    oneClickFilter: { types: ['boolean'] },
    width: { types: ['number'] },
    isTransposed: { types: ['boolean'] },
    transposable: { types: ['boolean'] },
    colorMode: { types: ['string'] },
    palette: {
      types: ['palette'],
    },
    summaryRow: { types: ['string'] },
    summaryLabel: { types: ['string'] },
  },

...
import { getEsDSLDatasource, IndexPatternColumn, uniqueLabels } from './indexpattern';
import { DatasourcePublicAPI, Operation, Datasource } from '../types';
import { coreMock } from 'src/core/public/mocks';
import { EsDSLPersistedState, EsDSLPrivateState } from './types';
...
function stateFromPersistedState(
  persistedState: EsDSLPersistedState
): EsDSLPrivateState {
  return {
...
describe('IndexPattern Data Source', () => {
  let persistedState: EsDSLPersistedState;
  let indexPatternDatasource: Datasource<EsDSLPrivateState, EsDSLPersistedState>;

  beforeEach(() => {
    indexPatternDatasource = getEsDSLDatasource({
  ...
  describe('#toExpression', () => {
    ...
    it('should generate an expression for an aggregated query', async () => {
      const queryPersistedState: EsDSLPersistedState = {
        currentIndexPatternId: '1',
        layers: {
          first: {
            indexPatternId: '1',

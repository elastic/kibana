...
type SetState = StateSetter<EsDSLPrivateState>;
...
export async function loadInitialState({
  ...
  state?: EsDSLPersistedState;
  savedObjectsClient: SavedObjectsClient;
  defaultIndexPatternId?: string;
}): Promise<EsDSLPrivateState> {
...
function isSingleEmptyLayer(layerMap: EsDSLPrivateState['layers']) {

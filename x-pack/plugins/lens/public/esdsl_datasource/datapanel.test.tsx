...
import { InnerIndexPatternDataPanel, EsDSLDataPanel, MemoizedDataPanel } from './datapanel';
...
const initialState: EsDSLPrivateState = {
  indexPatternRefs: [],
  existingFields: {},
...
describe('IndexPattern Data Panel', () => {
  ...
  describe('loading existence data', () => {
    ...
    it('shows a loading indicator when loading', async () => {
      const load = async () => {};
      const inst = mountWithIntl(<EsDSLDataPanel {...testProps()} />);

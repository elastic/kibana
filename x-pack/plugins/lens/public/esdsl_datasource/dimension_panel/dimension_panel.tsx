...
import { EsDSLPrivateState, IndexPatternField } from '../types';
...
type Props = Pick<
  DatasourceDimensionDropProps<EsDSLPrivateState>,
...
export function canHandleDrop(props: DatasourceDimensionDropProps<EsDSLPrivateState>) {
...
export function onDrop(
  props: DatasourceDimensionDropHandlerProps<EsDSLPrivateState>
): boolean {
  const operationFieldSupportMatrix = getOperationFieldSupportMatrix(props);

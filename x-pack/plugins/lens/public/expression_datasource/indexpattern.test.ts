...
import { getExpressionBasedDatasource, IndexPatternColumn, uniqueLabels } from './indexpattern';
import { DatasourcePublicAPI, Operation, Datasource } from '../types';
import { coreMock } from 'src/core/public/mocks';
import { ExpressionBasedPersistedState, ExpressionBasedPrivateState } from './types';
...
function stateFromPersistedState(
  persistedState: ExpressionBasedPersistedState
...
describe('IndexPattern Data Source', () => {
  let persistedState: ExpressionBasedPersistedState;
  let indexPatternDatasource: Datasource<ExpressionBasedPrivateState, ExpressionBasedPersistedState>;

  beforeEach(() => {
    indexPatternDatasource = getExpressionBasedDatasource({
  ...
  describe('#toExpression', () => {
    ...
    it('should generate an expression for an aggregated query', async () => {
      const queryPersistedState: ExpressionBasedPersistedState = {
        currentIndexPatternId: '1',
        layers: {
          first: {
            indexPatternId: '1',

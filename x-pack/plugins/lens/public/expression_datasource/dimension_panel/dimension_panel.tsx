...
import { ExpressionBasedPrivateState, IndexPatternField } from '../types';
...
type Props = Pick<
  DatasourceDimensionDropProps<ExpressionBasedPrivateState>,
...
export function canHandleDrop(props: DatasourceDimensionDropProps<ExpressionBasedPrivateState>) {
...
export function onDrop(
  props: DatasourceDimensionDropHandlerProps<ExpressionBasedPrivateState>
): boolean {
  const operationFieldSupportMatrix = getOperationFieldSupportMatrix(props);

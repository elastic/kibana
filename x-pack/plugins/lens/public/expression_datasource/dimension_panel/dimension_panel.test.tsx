...
describe('IndexPatternDimensionEditorPanel', () => {
  let state: ExpressionBasedPrivateState;
  ...
  describe('Editor component', () => {
    ...
    it('should keep the operation when switching to another field compatible with this operation', () => {
      const initialState: ExpressionBasedPrivateState = {
        ...state,
        layers: {
          first: {
            ...state.layers.first,
    ...
    it('allows custom format', () => {
      const stateWithNumberCol: ExpressionBasedPrivateState = {
        ...state,
        layers: {
          first: {
            indexPatternId: '1',
  ...
  describe('Drag and drop', () => {
    function dragDropState(): ExpressionBasedPrivateState {
      return {
        indexPatternRefs: [],
        existingFields: {},
        indexPatterns: {

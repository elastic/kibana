...
import { shiftTimeRange, join, mapColumn, math } from './pipeline_functions';
...
export class EditorFrameService {
  ...
  public setup(
    ...
    plugins.expressions.registerFunction(() => mapColumn);
    plugins.expressions.registerFunction(() => math);

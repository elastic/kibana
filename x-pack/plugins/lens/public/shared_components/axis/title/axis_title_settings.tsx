...
export const AxisTitleSettings: React.FunctionComponent<
  React.PropsWithChildren<AxisTitleSettingsProps>
> = ({ axis, axisTitle, updateTitleState, isAxisTitleVisible }) => {

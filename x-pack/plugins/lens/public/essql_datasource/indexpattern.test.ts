...
import { getEsSQLDatasource, IndexPatternColumn, uniqueLabels } from './indexpattern';
import { DatasourcePublicAPI, Operation, Datasource } from '../types';
import { coreMock } from 'src/core/public/mocks';
import { EsSQLPersistedState, EsSQLPrivateState } from './types';
...
function stateFromPersistedState(
  persistedState: EsSQLPersistedState
): EsSQLPrivateState {
  return {
...
describe('IndexPattern Data Source', () => {
  let persistedState: EsSQLPersistedState;
  let indexPatternDatasource: Datasource<EsSQLPrivateState, EsSQLPersistedState>;

  beforeEach(() => {
    indexPatternDatasource = getEsSQLDatasource({
  ...
  describe('#toExpression', () => {
    ...
    it('should generate an expression for an aggregated query', async () => {
      const queryPersistedState: EsSQLPersistedState = {
        currentIndexPatternId: '1',
        layers: {
          first: {
            indexPatternId: '1',

...
import { EsSQLPrivateState, IndexPatternField } from '../types';
...
type Props = Pick<
  DatasourceDimensionDropProps<EsSQLPrivateState>,
...
export function canHandleDrop(props: DatasourceDimensionDropProps<EsSQLPrivateState>) {
...
export function onDrop(
  props: DatasourceDimensionDropHandlerProps<EsSQLPrivateState>
): boolean {
  const operationFieldSupportMatrix = getOperationFieldSupportMatrix(props);

  ...
  it('should parse valid job configuration messages', () => {
    expect(parseMessages(basicValidJobMessages, docLinksService)).toStrictEqual([
      ...
      },
      {
        ...
        url: 'https://www.elastic.co/guide/en/machine-learning/mocked-test-branch/create-jobs.html#detectors',
      },
      {
        bucketSpan: '15m',
        heading: 'Bucket span',
        ...
        url: 'https://www.elastic.co/guide/en/machine-learning/mocked-test-branch/create-jobs.html#bucket-span',
      },
      {
        heading: 'Time range',
      ...
      },
      {
        ...
        url: 'https://www.elastic.co/guide/en/machine-learning/mocked-test-branch/create-jobs.html#model-memory-limits',
      },
    ]);
  });
  ...
  it('should parse non-basic issues messages', () => {
    expect(parseMessages(nonBasicIssuesMessages, docLinksService)).toStrictEqual([
      ...
      },
      {
        ...
        url: 'https://www.elastic.co/guide/en/machine-learning/mocked-test-branch/create-jobs.html#cardinality',
      },
      {
        heading: 'Bucket span',
        id: 'bucket_span_high',
      ...
      },
      {
        ...
        url: 'https://www.elastic.co/guide/en/machine-learning/mocked-test-branch/ml-influencers.html',
      },
      {

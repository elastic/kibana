...
export const ML_ELSER_CALLOUT_VISIBLE = 'ml.elserUpdateCalloutVisible';
...
export interface MlStorageRecord {
  ...
  [ML_ELSER_CALLOUT_VISIBLE]: boolean | undefined;
}
...
export type TMlStorageMapped<T extends MlStorageKey> = T extends typeof ML_ENTITY_FIELDS_CONFIG
  ...
  : T extends typeof ML_ELSER_CALLOUT_VISIBLE
  ? boolean | undefined
  : null;

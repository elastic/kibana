...
import { Subscription, BehaviorSubject, combineLatest, map } from 'rxjs';
...
export const getAnomalyChartsReactEmbeddableFactory = (
  ...
  > = {
    ...
    buildEmbeddable: async (state, buildApi, uuid, parentApi) => {
      ...
      // @TODO: remove
      console.log(`--@@coreStartServices`, coreStartServices);
      console.log(`--@@pluginsStartServices`, pluginsStartServices);
      ...
      const api = buildApi(
        {
          ...
          // dataViews: pluginsStartServices.data.dataViews,
          dataLoading,
          serializeState: () => {
            return {
              rawState: {
      ...
      const onInputChange = (input) => console.log('onInputChange', input);
      const onOutputChange = (output) => console.log('onOutputChange', output);

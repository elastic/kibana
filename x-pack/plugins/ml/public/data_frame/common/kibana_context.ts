...
interface KibanaExtendedContextValue extends KibanaContextValue {
  indexPatterns: any;
  kibanaConfig: any;
}
...
export type NullableKibanaContextValue = KibanaExtendedContextValue | KibanaContextValue | null;
...
export function isKibanaContext(arg: any): arg is KibanaContextValue {
  return arg.currentIndexPattern !== undefined;
}

export function isKibanaExtendedContext(arg: any): arg is KibanaExtendedContextValue {
  return (

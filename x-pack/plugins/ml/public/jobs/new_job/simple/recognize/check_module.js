...
export function checkViewOrCreateJobs(Private, $route, kbnBaseUrl, kbnUrl, i18n) {
    ...
    ml.dataRecognizerModuleJobsExist({ moduleId })
      ...
      .catch((err) => {
        ...
        toastNotifications.addWarning({
          ...
          text: i18n('xpack.ml.newJob.simple.recognize.moduleCheckJobsExistWarningDescription', {

...
export const RareInPopulationCard: FC<React.PropsWithChildren<CardProps>> = ({
  onClick,
  isSelected,
}) => (
  <EuiFlexItem>
...
export const FrequentlyRareInPopulationCard: FC<React.PropsWithChildren<CardProps>> = ({
  onClick,
  isSelected,
}) => (
  <EuiFlexItem>

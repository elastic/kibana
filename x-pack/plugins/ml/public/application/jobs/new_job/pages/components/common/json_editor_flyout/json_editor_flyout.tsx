              ...
              <>
                ...
                >
                  <FormattedMessage
                    ...
                    defaultMessage="It is not possible to alter the indices being used by the datafeed here. If you wish to select a different index pattern or saved search, please start the job creation again select a different index pattern."
                  />
                </EuiCallOut>
              </>
            )}

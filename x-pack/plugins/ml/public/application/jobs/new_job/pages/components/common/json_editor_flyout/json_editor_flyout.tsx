              ...
              <>
                ...
                >
                  <FormattedMessage
                    ...
                    defaultMessage="You cannot alter the indices being used by the datafeed here. To select a different data view or discover view, go to step 1 of the wizard and select the Change data view option."
                  />
                </EuiCallOut>
              </>
            )}

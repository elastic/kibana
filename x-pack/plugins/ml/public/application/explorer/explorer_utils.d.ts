...
export declare const escapeParens: (input: string) => string;

export declare const getQueryPattern: (fieldName: string, fieldValue: unknown) => RegExp;

export declare const escapeDoubleQuotes: (input: string) => string;

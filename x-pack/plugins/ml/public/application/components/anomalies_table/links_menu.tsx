  ...
  useEffect(() => {
    ...
    const generateDiscoverUrl = async () => {
      ...
      if (!discoverLocator) {
        ...
        console.error(discoverLocatorMissing);
      ...
      if (!dataViewId) {
        const autoGeneratedDiscoverLinkError = i18n.translate(
          ...
          {
            defaultMessage: `Unable to generate link to Discover because no data view exists for index '{index}'`,
            values: { index },
          }
        );

        // eslint-disable-next-line no-console
        console.error(autoGeneratedDiscoverLinkError);

 ...
 */
export const FormattedTooltip: FC<React.PropsWithChildren<{ tooltipData: TooltipData }>> = ({ tooltipData }) => {
  return (
 ...
 */
const Tooltip: FC<React.PropsWithChildren<{ service: ChartTooltipService }>> = React.memo(({ service }) => {
...
export const MlTooltipComponent: FC<React.PropsWithChildren<MlTooltipComponentProps>> = ({ children }) => {

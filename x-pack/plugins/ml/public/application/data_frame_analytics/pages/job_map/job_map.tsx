...
import { EuiTheme, useEuiTheme } from '../../../../../../../../src/plugins/kibana_react/common';
...
export const JobMap: FC<Props> = ({ analyticsId, modelId }) => {
  ...
  return (
    <div data-test-subj="mlPageDataFrameAnalyticsMap">
      ...
      <div style={{ height: height - parseInt(eui.gutterTypes.gutterLarge, 10) - 20 }} ref={ref}>
        <Cytoscape
          theme={eui}
          height={height - 20}
          elements={elements}
          width={width}
          style={getCytoscapeDivStyle(eui)}

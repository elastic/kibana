...
export async function deleteFilterLists(filterListsToDelete) {
  ...
  toastNotifications.add(
    i18n.translate('xpack.ml.settings.filterLists.deleteFilterLists.deletingNotificationMessage', {
      defaultMessage:
        'Deleting {filterListsToDeleteLength, plural, one {{filterListToDeleteId}} other {# filter lists}}',
      values: {
  ...
  for (const filterList of filterListsToDelete) {
    ...
    try {
      ...
      toastNotifications.addDanger(
        i18n.translate('xpack.ml.settings.filterLists.deleteFilterLists.deletingErrorMessage', {
  ...
  toastNotifications.addSuccess(
    i18n.translate(
      'xpack.ml.settings.filterLists.deleteFilterLists.filtersSuccessfullyDeletedNotificationMessage',
      {
        defaultMessage:
          '{filterListsToDeleteLength, plural, one {{filterListToDeleteId}} other {# filter lists}} deleted',
        values: {
          filterListsToDeleteLength: filterListsToDelete.length,
          filterListToDeleteId: !!filterListsToDelete.length && filterListsToDelete[0].filter_id,
        },

            ...
            <Fragment>
              <p>
                {i18n.translate('xpack.ml.overview.anomalyDetection.emptyPromptText', {
                  defaultMessage: `Anomaly detection enables you to find unusual behavior in time series data stored in Elasticsearch. Start automatically spotting the anomalies hiding in your data and resolve issues faster.`,
                })}
              </p>
            </Fragment>
          }

...
- [Scenarios](#scenarios)
  ...
  - [Rule upgrade workflow: simple diff algorithm](#rule-upgrade-workflow-simple-diff-algorithm)
    - [**Scenario: Simple rule field doesn't have an update and has no custom value**](#scenario-simple-rule-field-doesnt-have-an-update-and-has-no-custom-value)
    - [**Scenario: Simple rule field doesn't have an update but has a custom value**](#scenario-simple-rule-field-doesnt-have-an-update-but-has-a-custom-value)
    - [**Scenario: Simple rule field has an update and doesn't have a custom value**](#scenario-simple-rule-field-has-an-update-and-doesnt-have-a-custom-value)
    - [**Scenario: Simple rule field has an update and a custom value that are the same**](#scenario-simple-rule-field-has-an-update-and-a-custom-value-that-are-the-same)
    - [**Scenario: Simple rule field has an update and a custom value that are NOT the same**](#scenario-simple-rule-field-has-an-update-and-a-custom-value-that-are-not-the-same)
    - [**Scenario: Simple rule field has an update and a custom value that are NOT the same and the rule base version doesn't exist**](#scenario-simple-rule-field-has-an-update-and-a-custom-value-that-are-not-the-same-and-the-rule-base-version-doesnt-exist)
    - [**Scenario: Simple rule field has an update and a custom value that are the same and the rule base version doesn't exist**](#scenario-simple-rule-field-has-an-update-and-a-custom-value-that-are-the-same-and-the-rule-base-version-doesnt-exist)
  - [Rule upgrade workflow: scalar array diff algorithm](#rule-upgrade-workflow-scalar-array-diff-algorithm)
    - [**Scenario: Scalar array rule field doesn't have an update and has no custom value**](#scenario-scalar-array-rule-field-doesnt-have-an-update-and-has-no-custom-value)
    - [**Scenario: Scalar array rule field doesn't have an update but has a custom value**](#scenario-scalar-array-rule-field-doesnt-have-an-update-but-has-a-custom-value)
    - [**Scenario: Scalar array rule field has an update and doesn't have a custom value**](#scenario-scalar-array-rule-field-has-an-update-and-doesnt-have-a-custom-value)
    - [**Scenario: Scalar array rule field has an update and a custom value that are the same**](#scenario-scalar-array-rule-field-has-an-update-and-a-custom-value-that-are-the-same)
    - [**Scenario: Scalar array rule field has an update and a custom value that are NOT the same**](#scenario-scalar-array-rule-field-has-an-update-and-a-custom-value-that-are-not-the-same)
    - [**Scenario: Scalar array rule field has an update and a custom value that are NOT the same and the rule base version doesn't exist**](#scenario-scalar-array-rule-field-has-an-update-and-a-custom-value-that-are-not-the-same-and-the-rule-base-version-doesnt-exist)
    - [**Scenario: Scalar array rule field has an update and a custom value that are the same and the rule base version doesn't exist**](#scenario-scalar-array-rule-field-has-an-update-and-a-custom-value-that-are-the-same-and-the-rule-base-version-doesnt-exist)
...
#### **Scenario: Simple rule field doesn't have an update and has no custom value**
...
#### **Scenario: Simple rule field doesn't have an update but has a custom value**
...
#### **Scenario: Simple rule has an update and doesn't have a custom value**
...
#### **Scenario: Simple rule has an update and a custom value that are the same**
...
#### **Scenario: Simple rule has an update and a custom value that are NOT the same**
...
#### **Scenario: Simple rule has an update and a custom value that are NOT the same and the rule base version doesn't exist**
...
#### **Scenario: Simple rule has an update and a custom value that are the same and the rule base version doesn't exist**
...
### Rule upgrade workflow: scalar array diff algorithm

#### **Scenario: Scalar array rule field doesn't have an update and has no custom value**
...
#### **Scenario: Scalar array rule field doesn't have an update but has a custom value**
...
#### **Scenario: Scalar array rule field has an update and doesn't have a custom value**
...
#### **Scenario: Scalar array rule field has an update and a custom value that are the same**
...
Examples:
| field_name | base_version | current_version | target_version  |
| tags       | ["A", "B"]   | ["A", "B", "C"] | ["A", "B", "C"] |
```

#### **Scenario: Scalar array rule field has an update and a custom value that are NOT the same**
...
And <field_name> field is updated by Elastic in this upgrade (target version != base version)
And customized <field_name> field is different than the Elastic update in this upgrade (current version != target version)
Then for <field_name> field the diff algorithm should output a custom merged version without a conflict
And <field_name> field should be returned from the `upgrade/_review` API endpoint
And <field_name> field should be shown in the upgrade preview UI

Examples:
| field_name | base_version | current_version | target_version | merged_version  |
| tags       | ["A", "B"]   | ["B", "C"]      | ["B", "D"]     | ["B", "C", "D"] |
```

#### **Scenario: Scalar array rule field has an update and a custom value that are NOT the same and the rule base version doesn't exist**
...
#### **Scenario: Scalar array rule field has an update and a custom value that are the same and the rule base version doesn't exist**

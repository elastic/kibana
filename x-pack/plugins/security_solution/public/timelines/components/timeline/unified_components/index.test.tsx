...
describe('unified timeline', () => {
  ...
  describe('columns', () => {
    it('should move column left correctly ', async () => {
      const field = {
        name: 'message',
      };
      ...
      expect(container.querySelector(`[data-gridcell-column-id="${field.name}"]`)).toHaveAttribute(
    ...
    it('should be able to edit DataView Field', async () => {
      const field = {
        name: 'message',
      };
      const { container } = renderTestComponents();
  ...
  describe('unified field list', () => {
    it('should be able to add filters', async () => {
      const field = {
        name: 'event.severity',
      };

...
const StatefulEventComponent: React.FC<Props> = memo(
  ({
    actionsColumnWidth,
    containerRef,
    columnHeaders,
    ...
    const hasRowRenderers: boolean = useMemo(() => {
      return getRowRenderer({ data: event.ecs, rowRenderers }) != null;
...
StatefulEventComponent.displayName = 'StatefulEventComponent';

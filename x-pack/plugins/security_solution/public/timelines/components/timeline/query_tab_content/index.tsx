...
const compareQueryProps = (prevProps: Props, nextProps: Props) =>
  prevProps.kindQuery === nextProps.kindQuery &&
...
export const QueryTabContentComponent: React.FC<Props> = ({
  ...
  } = { query: kqlQueryExpression, language: kindQuery !== 'eql' ? 'kuery' : 'eql' };

  const combinedQueries =
    kqlQuery.language !== 'eql'
      ? combineQueries({
  ...
  const canQueryTimeline = () => {
    const tempVal =
      loadingSourcerer != null && !loadingSourcerer && !isEmpty(start) && !isEmpty(end);
    if (kqlQuery.language === 'eql') {
      return tempVal && !isBlankTimeline;
    }
    return combinedQueries != null && tempVal;
  };
            ...
            >
              ...
              <TimelineHeaderContainer data-test-subj="timelineHeader">
                <TimelineHeader
                  ...
                  show={show && activeTab === TimelineTabs.query && kindQuery !== 'eql'}
...
const makeMapStateToProps = () => {
  ...
  const mapStateToProps = (state: State, { timelineId }: OwnProps) => {
    ...
    return {
      ...
      columns,
      dataProviders,
      eqlOptions: kqlQueryTimeline?.kind === 'eql' ? eqlOptions : undefined,
      ...
      kqlMode,
      kqlQueryExpression,
      kindQuery: kqlQueryTimeline?.kind ?? '',

...
export const useTimelineTypes = ({
  ...
  const [timelineType, setTimelineTypes] = useState<SavedObjectTimelineTypeLiteralWithNull>(
    tabName === SavedObjectTimelineType.default || tabName === SavedObjectTimelineType.template
      ? tabName
      : SavedObjectTimelineType.default
  );

  const timelineUrl = formatUrl(getTimelineTabsUrl(SavedObjectTimelineType.default, urlSearch));
  const templateUrl = formatUrl(getTimelineTabsUrl(SavedObjectTimelineType.template, urlSearch));
  ...
  const getFilterOrTabs: (timelineTabsStyle: TimelineTabsStyle) => TimelineTab[] = useCallback(
    (timelineTabsStyle: TimelineTabsStyle) => [
      {
        id: SavedObjectTimelineType.default,
      ...
      {
        id: SavedObjectTimelineType.template,

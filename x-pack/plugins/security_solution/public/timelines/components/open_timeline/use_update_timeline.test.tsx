...
describe('dispatchUpdateTimeline', () => {
  ...
  it('it invokes date range picker dispatch', () => {
  ...
  it('it invokes add timeline dispatch', () => {
    const { result } = renderHook(() => useUpdateTimeline(), {
      wrapper: TestProviders,
    });
    // await waitFor();
  ...
  it('it does not invoke kql filter query dispatches if timeline.kqlQuery.filterQuery is null', () => {
    const { result } = renderHook(() => useUpdateTimeline(), {
      wrapper: TestProviders,
    });
    result.current(defaultArgs);
  ...
  it('it does not invoke notes dispatch if duplicate is true', () => {
    const { result } = renderHook(() => useUpdateTimeline(), {
      wrapper: TestProviders,
    });
    // await waitFor();
  ...
  it('it does not invoke kql filter query dispatches if timeline.kqlQuery.kuery is null', () => {
    const { result } = renderHook(() => useUpdateTimeline(), {
      wrapper: TestProviders,
    });
    // await waitFor();
  ...
  it('it invokes kql filter query dispatches if timeline.kqlQuery.filterQuery.kuery is not null', () => {
    const { result } = renderHook(() => useUpdateTimeline(), {
      wrapper: TestProviders,
    });
    // await waitFor();
  ...
  it('it invokes dispatchAddNotes if duplicate is false', () => {
    const { result } = renderHook(() => useUpdateTimeline(), {
      wrapper: TestProviders,
    });
    // await waitFor();
  ...
  it('it invokes dispatch to create a timeline note if duplicate is true and ruleNote exists', () => {
    const { result } = renderHook(() => useUpdateTimeline(), {
      wrapper: TestProviders,
    });
    result.current({

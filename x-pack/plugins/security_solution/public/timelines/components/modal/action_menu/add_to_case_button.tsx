...
/**
 * Button that opens a popover with options to add to new or existing case
 */
export const AddToCaseButton: React.FC<AddToCaseButtonProps> = React.memo(({ timelineId }) => {
...
AddToCaseButton.displayName = 'AddToCaseButton';

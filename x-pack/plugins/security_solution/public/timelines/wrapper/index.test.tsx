...
describe('TimelineWrapper', () => {
  ...
  test('should render correctly the main timeline elements', () => {
    const { getByTestId } = render(
      <TestProviders>
        <TimelineWrapper {...props} />
      </TestProviders>
    );
    expect(getByTestId('timeline-modal-wrapper-ref')).toBeInTheDocument();
    expect(getByTestId('timeline-bottom-bar-title-button')).toBeInTheDocument();
  });

  test('should render the default timeline state as a bottom bar', () => {
  ...
  test('should show timeline when bottom bar button is clicked', () => {
    const { getByTestId } = render(
      <TestProviders>
        <TimelineWrapper {...props} />
      </TestProviders>
  ...
  test('should hide timeline when user presses keyboard esc key', () => {
    render(
      <TestProviders>
        <TimelineWrapper {...props} />
      </TestProviders>

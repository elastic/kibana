...
export const ExceptionsTableUtilityBar: React.FC<
  React.PropsWithChildren<ExceptionsTableUtilityBarProps>
> = ({ onRefresh, totalExceptionLists, setSort, sort, sortFields }) => {

...
export const CASE_CONNECTOR_DESC = i18n.translate(
  'xpack.securitySolution.cases.components.connectors.cases.selectMessageText',
  {
...
export const CASE_CONNECTOR_TITLE = i18n.translate(
  'xpack.securitySolution.cases.components.connectors.cases.actionTypeTitle',
  {
...
export const CASE_CONNECTOR_COMMENT_LABEL = i18n.translate(
  'xpack.securitySolution.cases.components.connectors.cases.commentLabel',
  {
...
export const CASE_CONNECTOR_COMMENT_REQUIRED = i18n.translate(
  'xpack.securitySolution.cases.components.connectors.cases.commentRequired',
  {
...
export const CASE_CONNECTOR_CASES_DROPDOWN_ROW_LABEL = i18n.translate(
  'xpack.securitySolution.cases.components.connectors.cases.casesDropdownRowLabel',
  {
...
export const CASE_CONNECTOR_CASES_DROPDOWN_PLACEHOLDER = i18n.translate(
  'xpack.securitySolution.cases.components.connectors.cases.casesDropdownPlaceholder',
  {
...
export const CASE_CONNECTOR_CASES_OPTION_NEW_CASE = i18n.translate(
  'xpack.securitySolution.cases.components.connectors.cases.optionAddNewCase',
  {
...
export const CASE_CONNECTOR_CASES_OPTION_EXISTING_CASE = i18n.translate(
  'xpack.securitySolution.cases.components.connectors.cases.optionAddToExistingCase',
  {
...
export const CASE_CONNECTOR_CASE_REQUIRED = i18n.translate(
  'xpack.securitySolution.cases.components.connectors.cases.caseRequired',
  {
...
export const CASE_CONNECTOR_CALL_OUT_TITLE = i18n.translate(
  'xpack.securitySolution.cases.components.connectors.cases.callOutTitle',
  {
...
export const CASE_CONNECTOR_CALL_OUT_MSG = i18n.translate(
  'xpack.securitySolution.cases.components.connectors.cases.callOutMsg',
  {
    defaultMessage:
...
export const CASE_CONNECTOR_ADD_NEW_CASE = i18n.translate(
  'xpack.securitySolution.cases.components.connectors.cases.addNewCaseOption',
  {
...
export const CREATE_CASE = i18n.translate(
  'xpack.securitySolution.cases.components.connectors.cases.createCaseLabel',
  {
...
export const CONNECTED_CASE = i18n.translate(
  'xpack.securitySolution.cases.components.connectors.cases.connectedCaseLabel',
  {

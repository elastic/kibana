...
export const ERROR_PUSH_SERVICE_CALLOUT_TITLE = i18n.translate(
  'xpack.securitySolution.cases.caseView.errorsPushServiceCallOutTitle',
  {
...
export const PUSH_THIRD = (thirdParty: string) => {
  ...
  return i18n.translate('xpack.securitySolution.cases.caseView.pushNamedIncident', {
    values: { thirdParty },
...
export const UPDATE_THIRD = (thirdParty: string) => {
  if (thirdParty === 'none') {
    return i18n.translate('xpack.securitySolution.cases.caseView.updateThirdPartyIncident', {
      defaultMessage: 'Update external incident',
    });
  }

  return i18n.translate('xpack.securitySolution.cases.caseView.updateNamedIncident', {
    values: { thirdParty },
...
export const PUSH_DISABLE_BY_NO_CONFIG_TITLE = i18n.translate(
  'xpack.securitySolution.cases.caseView.pushToServiceDisableByNoConfigTitle',
  {
...
export const PUSH_DISABLE_BY_NO_CASE_CONFIG_TITLE = i18n.translate(
  'xpack.securitySolution.cases.caseView.pushToServiceDisableByNoCaseConfigTitle',
  {
...
export const PUSH_DISABLE_BY_KIBANA_CONFIG_TITLE = i18n.translate(
  'xpack.securitySolution.cases.caseView.pushToServiceDisableByConfigTitle',
  {
...
export const PUSH_DISABLE_BY_LICENSE_TITLE = i18n.translate(
  'xpack.securitySolution.cases.caseView.pushToServiceDisableByLicenseTitle',
  {
...
export const LINK_CLOUD_DEPLOYMENT = i18n.translate(
  'xpack.securitySolution.cases.caseView.cloudDeploymentLink',
  {
...
export const LINK_APPROPRIATE_LICENSE = i18n.translate(
  'xpack.securitySolution.cases.caseView.appropiateLicense',
  {
...
export const LINK_CONNECTOR_CONFIGURE = i18n.translate(
  'xpack.securitySolution.cases.caseView.connectorConfigureLink',
  {

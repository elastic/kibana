...
export const DELETE_TITLE = (caseTitle: string) =>
  i18n.translate('xpack.securitySolution.cases.confirmDeleteCase.deleteTitle', {
    values: { caseTitle },
    defaultMessage: 'Delete "{caseTitle}"',
  });

export const DELETE_THIS_CASE = (caseTitle: string) =>
  i18n.translate('xpack.securitySolution.cases.confirmDeleteCase.deleteThisCase', {
    defaultMessage: 'Delete this case',
  });

export const CONFIRM_QUESTION = i18n.translate(
  'xpack.securitySolution.cases.confirmDeleteCase.confirmQuestion',
  {
    defaultMessage:
...
export const DELETE_SELECTED_CASES = i18n.translate(
  'xpack.securitySolution.cases.confirmDeleteCase.selectedCases',
  {
...
export const CONFIRM_QUESTION_PLURAL = i18n.translate(
  'xpack.securitySolution.cases.confirmDeleteCase.confirmQuestionPlural',
  {
    defaultMessage:

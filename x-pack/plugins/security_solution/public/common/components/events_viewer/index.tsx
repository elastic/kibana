...
const StatefulEventsViewerComponent: React.FC<
  React.PropsWithChildren<EventsViewerProps & PropsFromRedux>
> = ({
  defaultCellActions,
  defaultModel,
  end,
...
export const StatefulEventsViewer: React.FunctionComponent<
  React.PropsWithChildren<EventsViewerProps>
> = connector(StatefulEventsViewerComponent);

...
import { setFilters, updateProviders } from '../../../../timelines/store/actions';
...
export const InvestigateInTimelineButton: FC<PropsWithChildren<InvestigateInTimelineButtonProps>> =
  ({
    asEmptyButton,
    children,
    dataProviders,

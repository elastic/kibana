...
export const mockAlertDetailsData = [
  ...
  { category: 'kibana', field: ALERT_WORKFLOW_STATUS, values: ['open'], originalValue: 'open' },
  {
    category: 'kibana',
  ...
  { category: 'kibana', field: ALERT_RULE_AUTHOR, values: [], originalValue: [] },
  { category: 'kibana', field: ALERT_RULE_FALSE_POSITIVES, values: [], originalValue: [] },
  ...
  { category: 'kibana', field: ALERT_RULE_INTERVAL, values: ['5m'], originalValue: '5m' },
  { category: 'kibana', field: ALERT_RULE_LANGUAGE, values: ['kuery'], originalValue: 'kuery' },
  { category: 'kibana', field: ALERT_RULE_LICENSE, values: [''], originalValue: '' },
  { category: 'kibana', field: ALERT_RULE_NAME, values: ['xxx'], originalValue: 'xxx' },
  {
    category: 'kibana',
  ...
  { category: 'kibana', field: ALERT_RULE_TO, values: ['now'], originalValue: 'now' },
  {
    category: 'kibana',
  ...
  { category: 'kibana', field: ALERT_RULE_THREAT, values: [], originalValue: [] },
  { category: 'kibana', field: ALERT_RULE_VERSION, values: [2], originalValue: 2 },
  {
    category: 'kibana',
  ...
  { category: 'kibana', field: ALERT_RULE_EXCEPTIONS_LIST, values: [], originalValue: [] },
  { category: 'kibana', field: ALERT_DEPTH, values: [1], originalValue: 1 },
  {
    category: 'kibana',
  ...
  { category: 'kibana', field: ALERT_ANCESTORS_TYPE, values: ['event'], originalValue: 'event' },
  {
    category: 'kibana',
  ...
  { category: 'kibana', field: ALERT_ANCESTORS_DEPTH, values: [0], originalValue: 0 },
  {
    category: 'kibana',
  ...
  { category: 'kibana', field: ALERT_ORIGINAL_EVENT_CODE, values: [4625], originalValue: 4625 },
  {
    category: 'signal',

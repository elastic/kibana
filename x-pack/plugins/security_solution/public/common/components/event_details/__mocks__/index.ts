...
export const mockAlertDetailsData = [
  ...
  { category: 'signal', field: 'kibana.alert.rule.actions', values: [], originalValue: [] },
  { category: 'signal', field: 'kibana.alert.rule.author', values: [], originalValue: [] },
  { category: 'signal', field: 'kibana.alert.rule.false_positives', values: [], originalValue: [] },
  { category: 'signal', field: 'kibana.alert.rule.meta.from', values: ['1m'], originalValue: '1m' },
  {
    category: 'signal',
  ...
  { category: 'signal', field: 'kibana.alert.rule.max_signals', values: [100], originalValue: 100 },
  { category: 'signal', field: 'kibana.alert.rule.risk_score', values: [21], originalValue: 21 },
  {
    category: 'signal',
  ...
  { category: 'signal', field: 'kibana.alert.rule.interval', values: ['5m'], originalValue: '5m' },
  {
    category: 'signal',
  ...
  { category: 'signal', field: 'kibana.alert.rule.license', values: [''], originalValue: '' },
  { category: 'signal', field: 'kibana.alert.rule.name', values: ['xxx'], originalValue: 'xxx' },
  {
    category: 'signal',
  ...
  { category: 'signal', field: 'kibana.alert.rule.references', values: [], originalValue: [] },
  {
    category: 'signal',
  ...
  { category: 'signal', field: 'kibana.alert.rule.tags', values: [], originalValue: [] },
  {
    category: 'signal',
  ...
  { category: 'signal', field: 'kibana.alert.rule.to', values: ['now'], originalValue: 'now' },
  {
    category: 'signal',
  ...
  { category: 'signal', field: 'kibana.alert.rule.threat', values: [], originalValue: [] },
  { category: 'signal', field: 'kibana.alert.rule.version', values: [2], originalValue: 2 },
  {
    category: 'signal',
  ...
  { category: 'signal', field: 'kibana.alert.rule.exceptions_list', values: [], originalValue: [] },
  { category: 'signal', field: 'kibana.alert.depth', values: [1], originalValue: 1 },
  {
    category: 'signal',
  ...
  { category: 'signal', field: 'kibana.alert.parent.depth', values: [0], originalValue: 0 },
  {
    category: 'signal',

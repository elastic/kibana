...
export const mockAlertDetailsData = [
  ...
  { category: 'signal', field: ALERT_RULE_AUTHOR, values: [], originalValue: [] },
  { category: 'signal', field: ALERT_RULE_FALSE_POSITIVES, values: [], originalValue: [] },
  ...
  { category: 'signal', field: ALERT_RULE_MAX_SIGNALS, values: [100], originalValue: 100 },
  { category: 'signal', field: ALERT_RULE_RISK_SCORE, values: [21], originalValue: 21 },
  { category: 'signal', field: ALERT_RULE_RISK_SCORE_MAPPING, values: [], originalValue: [] },
  {
    category: 'signal',
    field: ALERT_RULE_OUTPUT_INDEX,
    values: ['.siem-signals-angelachuang-default'],
    originalValue: '.siem-signals-angelachuang-default',
  },
  { category: 'signal', field: ALERT_RULE_DESCRIPTION, values: ['xxx'], originalValue: 'xxx' },
  {
    category: 'signal',
    field: ALERT_RULE_FROM,
    values: ['now-360s'],
    originalValue: 'now-360s',
  },
  {
    category: 'signal',
    field: ALERT_RULE_INDEX,
    values: [
      'apm-*-transaction*',
      'traces-apm*',
      'auditbeat-*',
  ...
  { category: 'signal', field: ALERT_RULE_INTERVAL, values: ['5m'], originalValue: '5m' },
  { category: 'signal', field: ALERT_RULE_LANGUAGE, values: ['kuery'], originalValue: 'kuery' },
  { category: 'signal', field: ALERT_RULE_LICENSE, values: [''], originalValue: '' },
  { category: 'signal', field: ALERT_RULE_NAME, values: ['xxx'], originalValue: 'xxx' },
  {
    category: 'signal',
    field: ALERT_RULE_QUERY,
    values: ['@timestamp : * '],
    originalValue: '@timestamp : * ',
  },
  { category: 'signal', field: ALERT_RULE_REFERENCES, values: [], originalValue: [] },
  { category: 'signal', field: ALERT_RULE_SEVERITY, values: ['low'], originalValue: 'low' },
  { category: 'signal', field: ALERT_RULE_SEVERITY_MAPPING, values: [], originalValue: [] },
  { category: 'signal', field: ALERT_RULE_TAGS, values: [], originalValue: [] },
  { category: 'signal', field: ALERT_RULE_TYPE, values: ['query'], originalValue: 'query' },
  { category: 'signal', field: ALERT_RULE_TO, values: ['now'], originalValue: 'now' },
  {
    category: 'signal',
    field: ALERT_RULE_FILTERS,
    values: [
  ...
  {
    category: 'signal',
    field: ALERT_RULE_CREATED_BY,
    values: ['angela'],
    originalValue: 'angela',
  },
  {
    category: 'signal',
    field: ALERT_RULE_UPDATED_BY,
    values: ['angela'],
    originalValue: 'angela',
  },
  { category: 'signal', field: ALERT_RULE_THREAT, values: [], originalValue: [] },
  { category: 'signal', field: ALERT_RULE_VERSION, values: [2], originalValue: 2 },
  {
    category: 'signal',
    field: ALERT_RULE_CREATED_AT,
    values: ['2020-11-24T10:30:33.660Z'],
    originalValue: '2020-11-24T10:30:33.660Z',
  },
  {
    category: 'signal',
    field: ALERT_RULE_UPDATED_AT,
    values: ['2020-11-25T15:37:40.939Z'],
    originalValue: '2020-11-25T15:37:40.939Z',
  },
  { category: 'signal', field: ALERT_RULE_EXCEPTIONS_LIST, values: [], originalValue: [] },
  { category: 'signal', field: ALERT_DEPTH, values: [1], originalValue: 1 },
  {
    category: 'signal',
  ...
  { category: 'signal', field: ALERT_ANCESTORS_TYPE, values: ['event'], originalValue: 'event' },
  {
    category: 'signal',
    field: ALERT_ANCESTORS_INDEX,
    values: ['winlogbeat-7.10.0-2020.11.12-000001'],
    originalValue: 'winlogbeat-7.10.0-2020.11.12-000001',
  },
  { category: 'signal', field: ALERT_ANCESTORS_DEPTH, values: [0], originalValue: 0 },
  {
    category: 'signal',
    field: ALERT_ORIGINAL_TIME,
    values: ['2020-11-25T15:36:38.847Z'],
    originalValue: '2020-11-25T15:36:38.847Z',
  },
  {
    category: 'signal',
    field: ALERT_ORIGINAL_EVENT_INGESTED,
    values: ['2020-11-25T15:36:40.924914552Z'],
    originalValue: '2020-11-25T15:36:40.924914552Z',
  },
  { category: 'signal', field: ALERT_ORIGINAL_EVENT_CODE, values: [4625], originalValue: 4625 },
  {
    category: 'signal',
  ...
  {
    category: 'signal',
    field: ALERT_ORIGINAL_EVENT_PROVIDER,
    values: ['Microsoft-Windows-Security-Auditing'],
    originalValue: 'Microsoft-Windows-Security-Auditing',
  },
  {
    category: 'signal',
    field: ALERT_ORIGINAL_EVENT_CREATED,
    values: ['2020-11-25T15:36:39.922Z'],
    originalValue: '2020-11-25T15:36:39.922Z',
  },
  {
  ...
  {
    category: 'signal',
    field: ALERT_ORIGINAL_EVENT_ACTION,
    values: ['logon-failed'],
    originalValue: 'logon-failed',
  },
  {
    category: 'signal',
    field: ALERT_ORIGINAL_EVENT_TYPE,
    values: ['start'],
    originalValue: 'start',
  },
  {
    category: 'signal',
    field: ALERT_ORIGINAL_EVENT_CATEGORY,
    values: ['authentication'],
    originalValue: 'authentication',
  },
  {
    category: 'signal',
    field: ALERT_ORIGINAL_EVENT_OUTCOME,
    values: ['failure'],

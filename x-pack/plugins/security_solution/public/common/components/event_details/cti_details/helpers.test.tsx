    ...
    const data = [
      {
        ...
        isObjectArray: true,
        originalValue: [
          `{"indicator.first_seen":"2021-03-21T19:40:19.000Z","indicator.provider":"provider","indicator.reference":"http://reference.url","indicator.ip":"192.168.1.19","indicator.type":"ip","matched.atomic":"192.168.1.19","matched.field":"host.ip","matched.id":"0SIZMnoB_Blp1Ib9ZYHU","matched.index":"filebeat-8.0.0-2021.05.28-000001","matched.type":"indicator_match_rule"}`,
          `{"indicator.first_seen":"2021-03-21T19:40:19.000Z","indicator.provider":"other","indicator.reference":"http://reference.url","indicator.ip":"192.168.1.19","indicator.type":"ip","matched.atomic":"192.168.1.19","matched.field":"host.ip","matched.id":"iiL9NHoB_Blp1Ib9yoJo","matched.index":"filebeat-8.0.0-2021.05.28-000001","matched.type":"indicator_match_rule"}`,
        ],
        values: [
          `{"indicator.first_seen":"2021-03-21T19:40:19.000Z","indicator.provider":"provider","indicator.reference":"http://reference.url","indicator.ip":"192.168.1.19","indicator.type":"ip","matched.atomic":"192.168.1.19","matched.field":"host.ip","matched.id":"0SIZMnoB_Blp1Ib9ZYHU","matched.index":"filebeat-8.0.0-2021.05.28-000001","matched.type":"indicator_match_rule"}`,
          `{"indicator.first_seen":"2021-03-21T19:40:19.000Z","indicator.provider":"other","indicator.reference":"http://reference.url","indicator.ip":"192.168.1.19","indicator.type":"ip","matched.atomic":"192.168.1.19","matched.field":"host.ip","matched.id":"iiL9NHoB_Blp1Ib9yoJo","matched.index":"filebeat-8.0.0-2021.05.28-000001","matched.type":"indicator_match_rule"}`,

    ...
    () => [
      {
        ...
        name: i18n.translate(
          'xpack.securitySolution.markdownEditor.plugins.lens.insertLensSavedObjectModal.searchSelection.savedObjectType.lens',
          {
            defaultMessage: 'Lens',
          }
        ),
      ...
      <ModalContainer>
        <EuiModalHeader>
          <EuiModalHeaderTitle>
            <h1>
              {' '}
              <FormattedMessage
                id="xpack.securitySolution.markdownEditor.plugins.lens.insertLensSavedObjectModal.modalTitle"
        ...
        <EuiModalBody>
          <SavedObjectFinderUi
            ...
            noItemsMessage={
              <FormattedMessage
                id="xpack.securitySolution.markdownEditor.plugins.lens.insertLensSavedObjectModal.searchSelection.notFoundLabel"

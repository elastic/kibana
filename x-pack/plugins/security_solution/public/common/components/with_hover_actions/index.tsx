...
interface WithCellActionsProps {
  /**
   * Always show the hover menu contents (default: false)
   */
  alwaysShow?: boolean;
 ...
 */
export const WithCellActions = React.memo<WithCellActionsProps>(
  ({ alwaysShow, data, onCloseRequested, render, scopeId = TimelineId.active }) => {
    ...
    return (
      ...
      >
        <SecurityCellActions
          ...
          showActionTooltips
          triggerId={SecurityCellActionsTrigger.DEFAULT} // TODO: parameter?
          data={data}
...
WithCellActions.displayName = 'WithCellActions';

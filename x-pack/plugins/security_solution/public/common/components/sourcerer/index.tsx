...
export const MaybeSourcerer = React.memo(
  ({ scope }: { scope?: sourcererModel.SourcererScopeName }) => {
    const {
    ...
    const scopeId = useMemo(() => (scope != null ? scope : activeSourcererScopeId), [
      scope,
      activeSourcererScopeId,
    ]);
    const {
    ...
    } = useMemo(() => getSourcererScopeById(scopeId), [getSourcererScopeById, scopeId]);
    ...
    const onChangeIndexPattern = useCallback(
      ...
      [scopeId, updateSourcererScopeIndices]
    );

...
export const GET_STARTED_PAGE_TITLE = (userName: string) =>
  i18n.translate('xpack.securitySolution.getStarted.Title', {
    defaultMessage: `Hi {userName}!`,
    values: { userName },
  });

export const GET_STARTED_PAGE_SUBTITLE = i18n.translate(
  'xpack.securitySolution.getStarted.subTitle',
  {
...
export const GET_STARTED_PAGE_DESCRIPTION = i18n.translate(
  'xpack.securitySolution.getStarted.description',
  {
...
export const CURRENT_PLAN_LABEL = i18n.translate(
  'xpack.securitySolution.getStarted.currentPlan.label',
  {
...
export const PROGRESS_TRACKER_LABEL = i18n.translate(
  'xpack.securitySolution.getStarted.progressTracker.progressBar.label',
  { defaultMessage: 'PROGRESS' }
);

export const SECTION_1_TITLE = i18n.translate(
  'xpack.securitySolution.getStarted.togglePanel.section1.title',
  {
...
export const SECTION_2_TITLE = i18n.translate(
  'xpack.securitySolution.getStarted.togglePanel.section2.title',
  {
...
export const SECTION_3_TITLE = i18n.translate(
  'xpack.securitySolution.getStarted.togglePanel.section3.title',
  {
...
export const CREATE_PROJECT_TITLE = i18n.translate(
  'xpack.securitySolution.getStarted.step.createProject.title',
  {
...
export const CREATE_PROJECT_DESCRIPTION = i18n.translate(
  'xpack.securitySolution.getStarted.step.createProject.description',
  {
...
export const WATCH_VIDEO_TITLE = i18n.translate(
  'xpack.securitySolution.getStarted.step.watchVideo.title',
  {
...
export const WATCH_VIDEO_BUTTON_TITLE = i18n.translate(
  'xpack.securitySolution.getStarted.step.watchVideo.button.title',
  {
...
export const WATCH_VIDEO_DESCRIPTION1 = i18n.translate(
  'xpack.securitySolution.getStarted.step.watchVideo.description1',
  {
...
export const WATCH_VIDEO_DESCRIPTION2 = i18n.translate(
  'xpack.securitySolution.getStarted.step.watchVideo.description2',
  {
...
export const ADD_INTEGRATIONS_TITLE = i18n.translate(
  'xpack.securitySolution.getStarted.step.addIntegrations.title',
  {
...
export const ADD_INTEGRATIONS_DESCRIPTION = i18n.translate(
  'xpack.securitySolution.getStarted.step.addIntegrations.description',
  {
    defaultMessage:
...
export const ADD_INTEGRATIONS_IMAGE_TITLE = i18n.translate(
  'xpack.securitySolution.getStarted.step.addIntegrations.image.title',
  {
...
export const VIEW_DASHBOARDS = i18n.translate(
  'xpack.securitySolution.getStarted.step.viewDashboards.title',
  {
...
export const VIEW_DASHBOARDS_DESCRIPTION = i18n.translate(
  'xpack.securitySolution.getStarted.step.viewDashboards.description',
  {
    defaultMessage:
...
export const VIEW_DASHBOARDS_IMAGE_TITLE = i18n.translate(
  'xpack.securitySolution.getStarted.step.viewDashboards.image.title',
  {
...
export const ENABLE_RULES = i18n.translate(
  'xpack.securitySolution.getStarted.step.enableRules.title',
  {
...
export const ENABLE_RULES_DESCRIPTION = i18n.translate(
  'xpack.securitySolution.getStarted.step.enableRules.description',
  {
    defaultMessage:
...
export const VIEW_ALERTS_TITLE = i18n.translate(
  'xpack.securitySolution.getStarted.step.viewAlerts.title',
  {
...
export const VIEW_ALERTS_DESCRIPTION = i18n.translate(
  'xpack.securitySolution.getStarted.step.viewAlerts.description',
  {
    defaultMessage:
...
export const PRODUCT_BADGE_ANALYTICS = i18n.translate(
  'xpack.securitySolution.getStarted.togglePanel.productBadge.analytics',
  {
...
export const PRODUCT_BADGE_CLOUD = i18n.translate(
  'xpack.securitySolution.getStarted.togglePanel.productBadge.cloud',
  {
...
export const PRODUCT_BADGE_EDR = i18n.translate(
  'xpack.securitySolution.getStarted.togglePanel.productBadge.edr',
  {
    defaultMessage: 'EDR',
  }
);
...
export const TOGGLE_PANEL_TITLE = i18n.translate(
  'xpack.securitySolution.getStartedProductLabel.title',
  {
...
export const ANALYTICS_SWITCH_LABEL = i18n.translate(
  'xpack.securitySolution.getStarted.togglePanel.switch.analytics.label',
  {
    defaultMessage: 'Analytics',
  }
);
...
export const CLOUD_SWITCH_LABEL = i18n.translate(
  'xpack.securitySolution.getStarted.togglePanel.switch.cloud.label',
...
export const ENDPOINT_SWITCH_LABEL = i18n.translate(
  'xpack.securitySolution.getStarted.togglePanel.switch.endpoint.label',
  {
...
export const MARK_AS_DONE_TITLE = i18n.translate(
  'xpack.securitySolution.getStarted.togglePanel.markAsDoneTitle',
  {
...
export const UNDO_MARK_AS_DONE_TITLE = i18n.translate(
  'xpack.securitySolution.getStarted.togglePanel.undoMarkAsDoneTitle',
  {
...
export const TOGGLE_PANEL_EMPTY_TITLE = i18n.translate(
  'xpack.securitySolution.getStarted.togglePanel.empty.title',
  {
...
export const TOGGLE_PANEL_EMPTY_DESCRIPTION = i18n.translate(
  'xpack.securitySolution.getStarted.togglePanel.empty.description',
  {
...
export const ALL_DONE_TEXT = i18n.translate(
  'xpack.securitySolution.getStarted.togglePanel.done.title',
  {
...
export const COLLAPSE_STEP_BUTTON_LABEL = i18n.translate(
  'xpack.securitySolution.getStarted.togglePanel.collapseStepButton.label',
  {
...
export const EXPAND_STEP_BUTTON_LABEL = i18n.translate(
  'xpack.securitySolution.getStarted.togglePanel.expandStepButton.label',
  {

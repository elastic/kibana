...
import { useDataIngestionHubHeaderVideoModalStyles } from './data_ingestion_hub_video_modal.styles';
...
const DataIngestionHubVideoModalComponent: React.FC<DataIngestionHubVideoModalComponentProps> = (
  props
) => {
        ...
        <EuiFlexGroup wrap={true} justifyContent="center">
          ...
          <EuiFlexItem grow={false}>
            <EuiButton color="primary" onClick={onCloseModal}>
              {isOnboardingHubVisited ? 'Close' : DATA_INGESTION_HUB_VIDEO_MODAL_BUTTON}
            </EuiButton>
          </EuiFlexItem>
        </EuiFlexGroup>
      </EuiModalFooter>
...
export const DataIngestionHubVideoModal = React.memo(DataIngestionHubVideoModalComponent);

...
const registerAlertsTableConfiguration = (
  ...
  const timelineStorage = getDataTablesInStorageByIds(storage, [TableId.detectionsPage]);
  const columnsFormStorage = timelineStorage?.[TableId.detectionsPage]?.columns ?? [];

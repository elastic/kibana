...
import { installPrebuiltRulesAndTimelines } from '../../../common/api/detection_engine/prebuilt_rules/install_prebuilt_rules_and_timelines/install_prebuilt_rules_and_timelines_route.api_method.gen';
    import type { PerformBulkActionsRequestBody, PerformBulkActionsRequestQuery } from '../../../common/api/detection_engine/rule_management/bulk_actions/perform_bulk_actions_route.gen';
import { performBulkActions } from '../../../common/api/detection_engine/rule_management/bulk_actions/perform_bulk_actions_route.api_method.gen';
    import type { ExportRulesRequestBody, ExportRulesRequestQuery } from '../../../common/api/detection_engine/rule_management/export_rules/export_rules_route.gen';
...
export class ApiClient<TClient extends HttpClient> {
  ...
  */
  public async setAlertAssignees(
  params: SetAlertAssigneesRequestBody, 
  signal?: AbortSignal
  ) {
    return setAlertAssignees(
      this.client,
        params,
      signal
    );
  ...
  */
  public async suggestUserProfiles(
  ...
  * 
  */
  public async getPrebuiltRulesAndTimelinesStatus(
  signal?: AbortSignal
  ) {
    return getPrebuiltRulesAndTimelinesStatus(
      this.client,
      signal
    );
  }
  ...
  * 
  */
  public async installPrebuiltRulesAndTimelines(
  signal?: AbortSignal
  ) {
    return installPrebuiltRulesAndTimelines(
      this.client,
      signal
    );
  }
  ...
  */
  public async bulkPatchRules(
  params: BulkPatchRulesRequestBody, 
  signal?: AbortSignal
  ) {
    return bulkPatchRules(
      this.client,
        params,
      signal
    );
  ...
  */
  public async bulkUpdateRules(
  params: BulkUpdateRulesRequestBody, 
  signal?: AbortSignal
  ) {
    return bulkUpdateRules(
      this.client,
        params,
      signal
    );

...
// import { dedupeIndexName, getSourceDefaults, useSourcerer, UseSourcerer } from '.';
...
//     it.only('dedupe from kibana index', async () => {
//       expect(dedupeIndexName(['*:auditbeat-*', 'kibana-index-*'], ["*:auditbeat-*", "*:endgame-*", "*:filebeat-*", "*:winlogbeat-*", "*:gsuite*"])).toEqual([
//           "*:endgame-*",
//           "*:filebeat-*",
//           "*:winlogbeat-*",
//           "*:gsuite*",

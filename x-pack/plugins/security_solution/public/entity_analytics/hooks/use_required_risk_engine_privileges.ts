...
import type { RiskEngineIndexPrivilege } from '../../../common/constants';
import { useRiskEnginePrivileges } from '../api/hooks/use_risk_engine_privileges';
import type { RiskEngineMissingPrivilegesResponse } from './use_missing_risk_engine_privileges';

export const useRequiredRiskEnginePrivileges = (
  ...
  return useMemo<RiskEngineMissingPrivilegesResponse>(() => {
    ...
    // `privilegesResponse.has_all_required` is slightly misleading, it checks if it has *all* privileges.

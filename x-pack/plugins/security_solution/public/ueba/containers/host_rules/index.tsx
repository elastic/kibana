...
export const useHostRules = ({
  ...
  const [hostRulesRequest, setHostRulesRequest] = useState<HostRulesRequestOptions | null>(null);
  ...
  const [hostRulesResponse, setHostRulesResponse] = useState<HostRulesState>({
    data: [],
    endDate,
    id: ID,
    inspect: {
    ...
    (request: HostRulesRequestOptions | null) => {
      ...
      const asyncSearch = async () => {
        ...
        searchSubscription.current = data.search
          .search<HostRulesRequestOptions, HostRulesStrategyResponse>(request, {

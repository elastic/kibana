...
export const COUNT = (totalCount: number, techniqueCount: number) =>
  i18n.translate('xpack.securitySolution.uebaTable.tacticTechnique', {
...
export const TACTIC = i18n.translate('xpack.securitySolution.uebaTable.tactic', {
...
export const TECHNIQUE = i18n.translate('xpack.securitySolution.uebaTable.technique', {

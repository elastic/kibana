...
import {
  ...
  RiskScoreSortField,
  RiskScoreFields,
} from '../../../../common/search_strategy/security_solution/ueba';
...
const getNodeField = (field: RiskScoreFields): string => {
  switch (field) {
    case RiskScoreFields.hostName:
      return 'node.host.name';
    case RiskScoreFields.riskScore:
      return 'node.riskScore';
    case RiskScoreFields.riskKeyword:
      return 'node.riskKeyword';
  }

...
export function HideExpandConversationListButton(props: HideExpandConversationListButtonProps) {
  return (
    <EuiButtonEmpty
      data-test-subj="aiAssistantHideExpandConversationListButton"
      iconType={props.isExpanded ? 'menuLeft' : 'menuRight'}
      size="xs"
      {...props}
    >
      {props.isExpanded
        ? i18n.translate('xpack.securitySolution.aiAssistant.hideExpandConversationButton.hide', {
            defaultMessage: 'Hide chats',
          })
        : i18n.translate('xpack.securitySolution.aiAssistant.hideExpandConversationButton.show', {

...
export const PolicyList = React.memo(() => {
  ...
  const columns: Array<EuiTableFieldDataColumnType<Immutable<PolicyData>>> = useMemo(
    () => [
      ...
      {
        field: 'revision',
        name: i18n.translate('xpack.securitySolution.endpoint.policyList.revisionField', {
      ...
      {
        field: 'package',
        name: i18n.translate('xpack.securitySolution.endpoint.policyList.versionField', {
      ...
      {
        field: 'description',
        name: i18n.translate('xpack.securitySolution.endpoint.policyList.descriptionField', {
      ...
      {
        field: 'config_id',
        name: i18n.translate('xpack.securitySolution.endpoint.policyList.agentConfigField', {

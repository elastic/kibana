...
import { RulesTableEmptyColumn } from '../rules_table_empty_column_name';
...
const TAGS_COLUMN: TableColumn = {
  field: 'tags',
  name: <RulesTableEmptyColumn name={i18n.COLUMN_TAGS} />,
  align: 'center',
...
const INTEGRATIONS_COLUMN: TableColumn = {
  ...
  name: <RulesTableEmptyColumn name={i18n.COLUMN_INTEGRATIONS} />,
  align: 'center',
...
const createInstallButtonColumn = (
  ...
  field: 'rule_id',
  name: <RulesTableEmptyColumn name={i18n.INSTALL_RULE_BUTTON} />,

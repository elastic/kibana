...
const Template: StoryFn<TemplateProps<keyof DiffableAllFields>> = (args) => {
  return (
    <ComparisonSide
...
export const WithResolvedValue = {
  render: Template,
...
export const OptionalFieldBecomesDefined = {
  render: Template,
...
export const SubfieldsWithLabels = {
  render: Template,
...
export const SingleLineStringSubfieldChanges = {
  render: Template,
...
export const MultiLineStringSubfieldChanges = {
  render: Template,
...
export const NumberSubfieldChanges = {
  render: Template,
...
export const ArraySubfieldChanges = {
  render: Template,
...
export const QuerySubfieldChanges = {
  render: Template,
...
export const SetupGuideSubfieldChanges = {
  render: Template,

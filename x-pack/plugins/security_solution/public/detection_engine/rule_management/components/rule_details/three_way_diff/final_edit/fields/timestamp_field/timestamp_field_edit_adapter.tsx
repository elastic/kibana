...
export function TimestampFieldEditAdapter({
  finalDiffableRule,
}: RuleFieldEditComponentProps): JSX.Element {
  const { dateFields } = useDiffableRuleEqlFieldsComboBoxOptions(finalDiffableRule);
  ...
  return (
    <UseField path="timestampField" component={ComboBoxField} componentProps={comboBoxFieldProps} />
  );
}

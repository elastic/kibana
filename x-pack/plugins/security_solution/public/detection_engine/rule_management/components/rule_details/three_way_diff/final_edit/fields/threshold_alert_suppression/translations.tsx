...
export const ALERT_SUPPRESSION_DURATION_PER_RULE_EXECUTION_OPTION = i18n.translate(
  'xpack.securitySolution.ruleManagement.threeWayDiff.finalEdit.thresholdAlertSuppression.suppressionDuration.perRuleExecutionOption',
  {
...
export const ALERT_SUPPRESSION_DURATION_PER_TIME_PERIOD_OPTION = i18n.translate(
  'xpack.securitySolution.ruleManagement.threeWayDiff.finalEdit.thresholdAlertSuppression.suppressionDuration.perTimePeriodOption',
  {
...
export const enableSuppressionForFields = (fields: string[]) => (
  <FormattedMessage
    id="xpack.securitySolution.ruleManagement.threeWayDiff.finalEdit.thresholdAlertSuppression.enableForFields"
...
export const SUPPRESS_ALERTS = i18n.translate(
  'xpack.securitySolution.ruleManagement.threeWayDiff.finalEdit.thresholdAlertSuppression.enable',
  {
...
export const THRESHOLD_SUPPRESSION_PER_RULE_EXECUTION_WARNING = i18n.translate(
  'xpack.securitySolution.ruleManagement.threeWayDiff.finalEdit.thresholdAlertSuppression.perRuleExecutionWarning',
  {

...
const ExceptionsLinkedToListsComponent: React.FC<
  React.PropsWithChildren<ExceptionsLinkedToListComponentProps>
> = ({ isLoadingReferences, errorFetchingReferences, listAndReferences }): JSX.Element => {

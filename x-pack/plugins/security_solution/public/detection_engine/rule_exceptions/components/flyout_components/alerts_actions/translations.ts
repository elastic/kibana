...
export const CLOSE_ALERTS_SECTION_TITLE = i18n.translate(
  'xpack.securitySolution.exceptions.alertsActions.sectionTitle',
  {
...
export const SINGLE_ALERT_CLOSE_LABEL = i18n.translate(
  'xpack.securitySolution.exceptions.alertsActions.singleAlertCloseLabel',
  {
...
export const BULK_CLOSE_LABEL_DISABLED = i18n.translate(
  'xpack.securitySolution.exceptions.alertsActions.bulkCloseLabel.disabled',
  {
    defaultMessage:
...
export const BULK_CLOSE_LABEL = i18n.translate(
  'xpack.securitySolution.exceptions.alertsActions.bulkCloseLabel',
  {
    defaultMessage:
...
export const ENDPOINT_QUARANTINE_TEXT = i18n.translate(
  'xpack.securitySolution.exceptions.alertsActions.endpointQuarantineText',
  {
    defaultMessage:

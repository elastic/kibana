...
const ExceptionsAddToRulesTableComponent: React.FC<
  React.PropsWithChildren<ExceptionsAddToRulesComponentProps>
> = ({ initiallySelectedRules, onRuleSelectionChange }) => {
  const {
    isLoading,

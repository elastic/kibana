...
export const EXCEPTION_ITEM_EDIT_BUTTON = (listType: string) =>
  i18n.translate('xpack.securitySolution.exceptions.exceptionItem.editItemButton', {
    values: { listType },
    defaultMessage: 'Edit {listType} exception',
  });

export const EXCEPTION_ITEM_DELETE_BUTTON = (listType: string) =>
  i18n.translate('xpack.securitySolution.exceptions.exceptionItem.deleteItemButton', {
    values: { listType },

...
const CytoscapeComponent: FC<CytoscapeProps> = ({
  children,
  elements,
  height,
  layout,
  ...
  useCytoscapeEventHandlers({ cy, theme, layout });
  ...
  const divStyle = { ...cssStyle, height };
...
export const Cytoscape = memo(CytoscapeComponent, (prevProps, nextProps) => {
  ...
  const propsAreEqual =
    ...
    isEqual(prevProps.cssStyle, nextProps.cssStyle) &&

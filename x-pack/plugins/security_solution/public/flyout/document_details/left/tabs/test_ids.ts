...
export const INSIGHTS_TAB_ENTITIES_TEST_ID = `${INSIGHTS_TAB_TEST_ID}Entities` as const;
export const INSIGHTS_TAB_THREAT_INTELLIGENCE_BUTTON_TEST_ID =
  `${INSIGHTS_TAB_TEST_ID}ThreatIntelligenceButton` as const;
export const INSIGHTS_TAB_PREVALENCE_TEST_ID = `${INSIGHTS_TAB_TEST_ID}Prevalence` as const;

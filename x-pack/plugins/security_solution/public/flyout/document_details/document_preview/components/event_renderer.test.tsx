...
import { DocumentPreviewPanelContext } from '../context';
...
const renderEventRenderer = (contextValue: DocumentPreviewPanelContext) =>
  render(
...
describe('<EventRenderer />', () => {
  ...
  it('should render empty component if event renderer is not available', async () => {
    const { container } = renderEventRenderer({} as unknown as DocumentPreviewPanelContext);

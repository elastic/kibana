...
import { useFetchThreatIntelligence } from '../../right/hooks/use_fetch_threat_intelligence';
...
jest.mock('../../right/hooks/use_expand_section');
...
jest.mock('../../right/hooks/use_fetch_threat_intelligence');
...
const renderInsightsSection = (contextValue: DocumentPreviewPanelContext) =>
  render(
    <TestProviders>

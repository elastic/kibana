...
import { useObservedHostFields } from '../host_right/hooks/use_observed_host_fields';
import type { EntityDetailsLeftPanelTab } from '../shared/components/left_panel/left_panel_header';

interface HostPreviewPanelContentProps {
...
export const HostPreviewPanelContent = ({
  hostName,
  observedHost,
  riskScoreState,
  recalculatingScore,

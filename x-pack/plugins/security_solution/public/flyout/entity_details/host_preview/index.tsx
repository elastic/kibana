...
import { HostPreviewPanelContent } from './content';
import { HostPreviewPanelHeader } from './header';
...
export const HostPreviewPanel = ({
  ...
  const openTabPanel = useCallback(
    ...
    [telemetry, openFlyout, hostName, isRiskScoreExist, scopeId]
  );
      ...
      {({ isLoadingAnomaliesData, anomaliesData, jobNameById }) => {
        ...
        return (
          <>
            ...
            />
            <HostPreviewPanelHeader hostName={hostName} observedHost={observedHostWithAnomalies} />
            <HostPreviewPanelContent
              hostName={hostName}
...
HostPreviewPanel.displayName = 'HostPreviewPanel';

...
import { useObservedUserItems } from '../user_right/hooks/use_observed_user_items';
import type { EntityDetailsLeftPanelTab } from '../shared/components/left_panel/left_panel_header';

interface UserPreviewPanelContentProps {
  userName: string;
...
export const UserPreviewPanelContent = ({
  userName,
  observedUser,
  managedUser,
  riskScoreState,

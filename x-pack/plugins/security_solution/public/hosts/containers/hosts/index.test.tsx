...
describe('useAllHost', () => {
  ...
  it('returns result', () => {
    ...
    const { result } = renderHook(() => useAllHost(props), {
      wrapper: TestProviders,
    });
    expect(result.current[0]).toEqual(true);

    expect(result.current[1].id).toEqual('hostsAllQuery');
    ...
    expect(result.current[1].hosts).toEqual(initialResult.edges);

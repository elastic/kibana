...
export const ALERT_SUMMARIZATION_TITLE = i18n.translate(
  'xpack.securitySolution.securityAssistant.quickPrompts.alertSummarizationTitle',
  {
...
export const ALERT_SUMMARIZATION_PROMPT = i18n.translate(
  'xpack.securitySolution.securityAssistant.quickPrompts.alertSummarizationPrompt',
  {
...
export const WORKFLOW_ANALYSIS_TITLE = i18n.translate(
  'xpack.securitySolution.securityAssistant.quickPrompts.workflowAnalysisTitle',
  {
...
export const WORKFLOW_ANALYSIS_PROMPT = i18n.translate(
  'xpack.securitySolution.securityAssistant.quickPrompts.workflowAnalysisPrompt',
  {
    defaultMessage:
...
export const THREAT_INVESTIGATION_GUIDES_TITLE = i18n.translate(
  'xpack.securitySolution.securityAssistant.quickPrompts.threatInvestigationGuidesTitle',
  {
...
export const THREAT_INVESTIGATION_GUIDES_PROMPT = i18n.translate(
  'xpack.securitySolution.securityAssistant.quickPrompts.threatInvestigationGuidesPrompt',
  {
    defaultMessage:
...
export const OMNI_QUERY_5000_TITLE = i18n.translate(
  'xpack.securitySolution.securityAssistant.quickPrompts.omniQuery5000Title',
  {
...
export const OMNI_QUERY_5000_PROMPT = i18n.translate(
  'xpack.securitySolution.securityAssistant.quickPrompts.omniQuery5000Prompt',
  {

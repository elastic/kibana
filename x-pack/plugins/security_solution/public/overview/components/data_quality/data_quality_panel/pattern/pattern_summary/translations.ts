...
export const DOCS = i18n.translate('xpack.securitySolution.dataQuality.patternSummary.docsLabel', {
  defaultMessage: 'Docs',
});

export const INDICES = i18n.translate(
  'xpack.securitySolution.dataQuality.patternSummary.indicesLabel',
  {
...
export const PATTERN_OR_INDEX_TOOLTIP = i18n.translate(
  'xpack.securitySolution.dataQuality.patternSummary.patternOrIndexTooltip',
  {

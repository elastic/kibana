...
describe('RecentCases', () => {
  ...
  it('if no cases, you should be able to create a case by clicking on the link "start a new case"', () => {
    ...
    expect(navigateToApp).toHaveBeenCalledWith('securitySolution:case', {
      path:
        "/create?sourcerer=(default:!((id:config,title:'apm-*-transaction*'),(id:config,title:'auditbeat-*'),(id:config,title:'endgame-*'),(id:config,title:'filebeat-*'),(id:config,title:'logs-*'),(id:config,title:'packetbeat-*'),(id:config,title:'winlogbeat-*')))&timerange=(global:(linkTo:!(timeline),timerange:(from:'2020-07-07T08:20:18.966Z',fromStr:now-24h,kind:relative,to:'2020-07-08T08:20:18.966Z',toStr:now)),timeline:(linkTo:!(global),timerange:(from:'2020-07-07T08:20:18.966Z',fromStr:now-24h,kind:relative,to:'2020-07-08T08:20:18.966Z',toStr:now)))",
    });
  });
});

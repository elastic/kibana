...
describe('useNetworkTopCountries', () => {
  ...
  it('returns result', () => {
    ...
    const { result } = renderHook(() => useNetworkTopCountries(props), {
      wrapper: TestProviders,
    });
    ...
    expect(result.current[1].networkTopCountries).toEqual(initialResult.edges);

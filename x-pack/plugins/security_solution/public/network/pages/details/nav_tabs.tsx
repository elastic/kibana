...
const getTabsOnNetworkDetailsUrl = (ipAddress: string, tabName: NetworkDetailsRouteType) =>
  `${NETWORK_PATH}/${ipAddress}/${tabName}`;
...
export const navTabsNetworkDetails = (
  ...
  const networkDetailsNavTabs: NetworkDetailsNavTabs = {
    [NetworkDetailsRouteType.flows]: {
      ...
      href: getTabsOnNetworkDetailsUrl(ipAddress, NetworkDetailsRouteType.flows),
      disabled: false,
    },
    [NetworkDetailsRouteType.users]: {
      id: NetworkDetailsRouteType.users,
      name: i18n.NAVIGATION_USERS_TITLE,
      href: getTabsOnNetworkDetailsUrl(ipAddress, NetworkDetailsRouteType.users),
      disabled: false,
    },
    [NetworkDetailsRouteType.http]: {
      id: NetworkDetailsRouteType.http,
      name: i18n.NAVIGATION_HTTP_TITLE,
      href: getTabsOnNetworkDetailsUrl(ipAddress, NetworkDetailsRouteType.http),
      disabled: false,
    },
    [NetworkDetailsRouteType.tls]: {
      id: NetworkDetailsRouteType.tls,
      name: i18n.NAVIGATION_TLS_TITLE,
      href: getTabsOnNetworkDetailsUrl(ipAddress, NetworkDetailsRouteType.tls),
      disabled: false,
    },

...
export const SIGNAL_FETCH_FAILURE = i18n.translate(
  'xpack.securitySolution.containers.detectionEngine.signals.errorFetchingSignalsDescription',
  {
...
export const SIGNAL_GET_NAME_FAILURE = i18n.translate(
  'xpack.securitySolution.containers.detectionEngine.signals.errorGetSignalDescription',
  {
...
export const SIGNAL_POST_FAILURE = i18n.translate(
  'xpack.securitySolution.containers.detectionEngine.signals.errorPostSignalDescription',
  {

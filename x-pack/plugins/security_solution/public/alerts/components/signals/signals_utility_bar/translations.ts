...
export const SHOWING_SIGNALS = (totalSignalsFormatted: string, totalSignals: number) =>
  i18n.translate('xpack.securitySolution.detectionEngine.signals.utilityBar.showingSignalsTitle', {
...
export const SELECTED_SIGNALS = (selectedSignalsFormatted: string, selectedSignals: number) =>
  i18n.translate('xpack.securitySolution.detectionEngine.signals.utilityBar.selectedSignalsTitle', {
...
export const SELECT_ALL_SIGNALS = (totalSignalsFormatted: string, totalSignals: number) =>
  i18n.translate(
    'xpack.securitySolution.detectionEngine.signals.utilityBar.selectAllSignalsTitle',
    {
      values: { totalSignalsFormatted, totalSignals },
      defaultMessage:
...
export const CLEAR_SELECTION = i18n.translate(
  'xpack.securitySolution.detectionEngine.signals.utilityBar.clearSelectionTitle',
  {
...
export const BATCH_ACTIONS = i18n.translate(
  'xpack.securitySolution.detectionEngine.signals.utilityBar.batchActionsTitle',
  {
...
export const BATCH_ACTION_VIEW_SELECTED_IN_HOSTS = i18n.translate(
  'xpack.securitySolution.detectionEngine.signals.utilityBar.batchActions.viewSelectedInHostsTitle',
  {
...
export const BATCH_ACTION_VIEW_SELECTED_IN_NETWORK = i18n.translate(
  'xpack.securitySolution.detectionEngine.signals.utilityBar.batchActions.viewSelectedInNetworkTitle',
  {
...
export const BATCH_ACTION_VIEW_SELECTED_IN_TIMELINE = i18n.translate(
  'xpack.securitySolution.detectionEngine.signals.utilityBar.batchActions.viewSelectedInTimelineTitle',
  {
...
export const BATCH_ACTION_OPEN_SELECTED = i18n.translate(
  'xpack.securitySolution.detectionEngine.signals.utilityBar.batchActions.openSelectedTitle',
  {
...
export const BATCH_ACTION_CLOSE_SELECTED = i18n.translate(
  'xpack.securitySolution.detectionEngine.signals.utilityBar.batchActions.closeSelectedTitle',
  {

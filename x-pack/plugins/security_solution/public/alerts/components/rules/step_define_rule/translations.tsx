...
export const CONFIG_INDICES = i18n.translate(
  ...
  {
    defaultMessage: 'Use Elasticsearch indices from Security advanced settings',
  }
);
...
export const INDEX_HELPER_TEXT = i18n.translate(
  ...
  {
    defaultMessage:
      'Enter the pattern of Elasticsearch indices where you would like this rule to run. By default, these will include index patterns defined in Security advanced settings.',
  }
);

...
import { createAddToTimelineDiscoverAction, getInvestigatedValue } from './add_to_timeline';
...
describe('createAddToTimelineDiscoverAction', () => {
  const addToTimelineAction = createAddToTimelineDiscoverAction({ store, order: 1 });

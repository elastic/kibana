...
const CustomWarning: React.FC<React.PropsWithChildren<{ message: string }>> = ({ message }) => (
...
export const PreviewLogsComponent: React.FC<React.PropsWithChildren<PreviewLogsComponentProps>> = ({
  logs,
  hasNoiseWarning,
  isAborted,
}) => {

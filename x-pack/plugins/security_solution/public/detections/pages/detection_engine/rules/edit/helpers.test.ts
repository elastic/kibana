...
describe('helpers', () => {
  ...
  describe('formatRule', () => {
    ...
    test('returns PatchRule with type of saved_query when saved_id exists', () => {
      const result: PatchRule = formatRule(mockDefine, mockAbout, mockSchedule, mockActions);

      expect(result.type).toEqual('saved_query');
    });

    test('returns PatchRule with type of query when saved_id does not exist', () => {
      ...
      const result: PatchRule = formatRule(
    ...
    test('returns PatchRule without id if ruleId does not exist', () => {
      const result: PatchRule = formatRule(mockDefine, mockAbout, mockSchedule, mockActions);

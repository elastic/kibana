...
// TODO: duplicate of `EndpointHostResponseActionsStatus`
// remove original EndpointHostResponseActionsStatus usage/code when `agentStatusClientEnabled` FF is enabled

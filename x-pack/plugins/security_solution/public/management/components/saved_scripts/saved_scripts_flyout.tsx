...
import { SavedScriptsForm } from './form';
import { useCreateSavedScript } from './use_create_saved_script';
...
const SavedScriptsFlyoutComponent: React.FC<AddQueryFlyoutProps> = ({
  defaultValue,
  onClose,
  isExternal,
}) => {
  const createSavedQueryMutation = useCreateSavedScript({ withRedirect: false });
  ...
  const onSubmit = useCallback(
    async (payload: SavedScriptsFormData) => {
      ...
      >
        ...
        <EuiFlyoutFooter>
          <EuiFlexGroup justifyContent="spaceBetween">
            ...
            <EuiFlexItem grow={false}>
              <EuiButton
                data-test-subj="savedScriptsFlyoutSaveButton"
...
export const SavedScriptsFlyout = React.memo(SavedScriptsFlyoutComponent);

...
export interface ConsoleRegistrationInterface<TMeta extends object = any> {
  ...
  PageTitleComponent?: ComponentType<
    React.PropsWithChildren<ManagedConsoleExtensionComponentProps<TMeta>>
  >;

  /**
   * An optional component that will be rendered in the Responder page overlay, above the Console area
   */
  PageBodyComponent?: ComponentType<
    React.PropsWithChildren<ManagedConsoleExtensionComponentProps<TMeta>>
  >;
  ...
  ActionComponents?: Array<
    ComponentType<React.PropsWithChildren<ManagedConsoleExtensionComponentProps<TMeta>>>
  >;

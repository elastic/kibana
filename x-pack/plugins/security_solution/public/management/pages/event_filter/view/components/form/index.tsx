...
export const EventFilterForm: React.FC<EventFilterFormProps> = memo(({ allowSelectOs = false }) => {
  ...
  const commentsInputMemo = useMemo(
    () => (
      <AddExceptionComments newCommentValue={comment} newCommentOnChange={handleOnChangeComment} />
    ),

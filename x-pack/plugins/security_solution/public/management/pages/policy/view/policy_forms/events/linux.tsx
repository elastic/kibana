...
const SUPPLEMENTAL_OPTIONS: ReadonlyArray<SupplementalEventFormOption<OperatingSystem.LINUX>> = [
  ...
  },
  {
    ...
    tooltipText: i18n.translate(
      ...
      {
        defaultMessage:
        'Turn this on to collect terminal (tty) output. Terminal output appears in Session View, and you can view it separately to see what commands were executed and how they were typed, provided the terminal is in echo mode. Currently only works when kernel capture_mode is ebpf.',
      }
    ),
    indented: true,
    isDisabled: (config: UIPolicyConfig) => {

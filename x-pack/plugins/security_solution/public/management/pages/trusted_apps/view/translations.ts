...
export const ENTRY_PROPERTY_TITLES: Readonly<{
  ...
  field: i18n.translate('xpack.securitySolution.trustedApps.entry.field', {
    defaultMessage: 'Field',
  }),
  operator: i18n.translate('xpack.securitySolution.trustedApps.entry.operator', {
    defaultMessage: 'Operator',
  }),
  value: i18n.translate('xpack.securitySolution.trustedApps.entry.value', {

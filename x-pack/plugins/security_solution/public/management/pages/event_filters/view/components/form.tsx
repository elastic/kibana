...
export const EventFiltersForm: React.FC<
  React.PropsWithChildren<ArtifactFormComponentProps & { allowSelectOs?: boolean }>
> = memo(
  ({ allowSelectOs = true, item: exception, policies, policiesIsLoading, onChange, mode }) => {

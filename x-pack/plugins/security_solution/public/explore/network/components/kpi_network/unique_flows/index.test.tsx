...
import { uniqueFlowsStatItems, NetworkKpiUniqueFlows } from '.';
import { KpiBaseComponent } from '../../../../components/kpi';

jest.mock('../../../../components/kpi');

describe('Network unique flow KPI', () => {
  ...
  it('renders correctly', () => {
    render(<NetworkKpiUniqueFlows from={from} to={to} />, {
      wrapper: TestProviders,
    });
    expect(MockKpiBaseComponent.mock.calls[0][0].statItems).toEqual(uniqueFlowsStatItems);

...
import { NetworkKpiTlsHandshakes, tlsStatItems } from '.';
...
describe('TLS handshakes KPI', () => {
  ...
  it('renders correctly', () => {
    render(<NetworkKpiTlsHandshakes from={from} to={to} />, {
      wrapper: TestProviders,
    });
    expect(MockKpiBaseComponent.mock.calls[0][0].statItems).toEqual(tlsStatItems);

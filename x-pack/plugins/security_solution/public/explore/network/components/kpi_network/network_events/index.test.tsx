...
import { NetworkKpiNetworkEvents, networkEventsStatsItems } from '.';
...
describe('Network events KPI', () => {
  ...
  it('renders correctly', () => {
    render(<NetworkKpiNetworkEvents from={from} to={to} />, {
      wrapper: TestProviders,
    });
    expect(MockKpiBaseComponent.mock.calls[0][0].statItems).toEqual(networkEventsStatsItems);

...
import { IS_EXPERIMENTAL_SOURCERER_ENABLED } from '../experimental/is_enabled';
...
export const useSourcererDataView = (
  ...
  const experimentalSourcererValues = useUnstableSecuritySolutionDataView(scopeId);

  return IS_EXPERIMENTAL_SOURCERER_ENABLED ? experimentalSourcererValues : stableSourcererValues;
};

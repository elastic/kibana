...
export const expectedExportedTimelineTemplate = (templateResponse: Cypress.Response<unknown>) => {
  // @ts-expect-error
...
export const expectedExportedTimeline = (timelineResponse: Cypress.Response<unknown>) => {
  // @ts-expect-error

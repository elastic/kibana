...
import { EXCEPTION_ITEM_COMMENTS_CONTAINER_TEXT } from '../../../../screens/exceptions';
...
Cypress._.times(50, () => {
  describe('Endpoint exceptions - Add, copy comments in different exceptions type and validate sharing them between users', () => {
    beforeEach(() => {

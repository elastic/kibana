...
export const VIZ_SAVE_BUTTON = `[data-test-subj="viz-actions-save"]`;
export const VIZ_OPEN_IN_LENS_BUTTON = '[data-test-subj="viz-actions-open-in-lens"]';
export const VIZ_ADD_TO_NEW_CASE_BUTTON = '[data-test-subj="viz-actions-add-to-new-case"]';
export const VIZ_ADD_TO_EXISTING_CASE_BUTTON =
  '[data-test-subj="viz-actions-add-to-existing-case"]';

export const SELECT_CASE_MODAL = '[data-test-subj="all-cases-modal"]';
export const SELECT_CASE_MODAL_CLOSE_BUTTON = `${SELECT_CASE_MODAL} .euiModal__closeIcon`;

export const SAVE_LENS_MODAL = '[data-test-subj="savedObjectSaveModal"]';
export const SAVE_LENS_MODAL_CLOSE_BUTTON = `${SAVE_LENS_MODAL} .euiModal__closeIcon`;
export const CREATE_CASE_FLYOUT = '[data-test-subj="create-case-flyout"]';
export const CREATE_CASE_FLYOUT_CLOSE_BUTTON = `${CREATE_CASE_FLYOUT} [data-test-subj="euiFlyoutCloseButton"]`;

export interface VizActionsButtonMetadata {
  altInspectId?: string;
  id: string;
  title: string;
  tabId?: string;
...
export const VIZ_ACTIONS_HOSTS_DETAILS_BUTTONS_IN_SECURITY: VizActionsButtonMetadata[] = [
  {
...
export const VIZ_ACTIONS_HOSTS_BUTTONS_IN_SECURITY: VizActionsButtonMetadata[] = [
  {
...
export const VIZ_ACTIONS_BUTTONS_IN_SECURITY: VizActionsButtonMetadata[] = [
  {

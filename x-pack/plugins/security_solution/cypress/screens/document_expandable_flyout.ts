...
export const DOCUMENT_DETAILS_FLYOUT_OVERVIEW_TAB_INSIGHTS =
  getDataTestSubjectSelector(INSIGHTS_TEST_ID);
export const DOCUMENT_DETAILS_FLYOUT_OVERVIEW_TAB_INSIGHTS_ENTITIES =
  getDataTestSubjectSelector(ENTITIES_TEST_ID);

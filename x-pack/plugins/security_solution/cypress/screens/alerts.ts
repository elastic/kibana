...
export const ALERT_RISK_SCORE_HEADER =
  '[data-test-subj="header-text-kibana.alert.rule.risk_score"]';

export const ALERT_RULE_METHOD = '[data-test-subj="draggable-content-kibana.alert.rule.type"]';

export const ALERT_RULE_NAME = '[data-test-subj="draggable-content-kibana.alert.rule.name"]';

export const ALERT_RULE_RISK_SCORE =
  '[data-test-subj="draggable-content-kibana.alert.rule.risk_score"]';

export const ALERT_RULE_SEVERITY =
  '[data-test-subj="draggable-content-kibana.alert.rule.severity"]';

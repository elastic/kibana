    ...
    lensVisualizations: [
      {
        ...
        tab: ALL_HOSTS_TAB,
        embeddableId: 'hostsKpiHostsQuery',
      },
      {
        title: 'Unique IPs',
        panelSelector: UNIQUE_IPS_VISUALIZATIONS,
        tab: ALL_HOSTS_TAB,
        embeddableId: 'hostsKpiUniqueIpsQuery',
      },
    ],
  },
  {
    ...
    lensVisualizations: [
      {
        ...
        embeddableId: 'networkKpiNetworkEventsQuery',
      },
      {
        title: 'DNS queries',
...

      {
        ...
        tab: NETWORK_FLOW_TAB,
        embeddableId: 'networkKpiUniqueFlowsQuery',
      },
      {
        title: 'TLS handshakes',
        panelSelector: NETWORK_TLS_HANDSHAKE_VISUALIZATION,
        tab: NETWORK_FLOW_TAB,
        embeddableId: 'networkKpiTlsHandshakesQuery',
      },
      {
        title: 'Unique private IPs',
        panelSelector: UNIQUE_IPS_VISUALIZATIONS,
        tab: NETWORK_FLOW_TAB,
        embeddableId: 'networkKpiUniquePrivateIpsQuery',
      },
    ],
    tables: [
      {
    ...
    lensVisualizations: [
      {
        ...
        embeddableId: 'TotalUsersKpiQuery',
        tab: ALL_USERS_TAB,
      },
      {
        title: 'User authentications',
        panelSelector: AUTHENTICATION_VISUALIZATION,
        embeddableId: 'usersKpiAuthenticationsQuery',
        tab: ALL_USERS_TAB,
      },
      {
        title: 'Events',

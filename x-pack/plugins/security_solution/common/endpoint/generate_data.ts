    ...
    return {
      ...
      savedObject: {
        ...
        attributes: {
          ...
          package_assets: [],
          es_index_patterns: [
            { title: 'alerts', name: 'logs-endpoint.alerts-*' },
            { title: 'events', name: 'events-endpoint-*' },
            { title: 'file', name: 'logs-endpoint.events.file-*' },
            { title: 'library', name: 'logs-endpoint.events.library-*' },
            { title: 'metadata', name: 'metrics-endpoint.metadata-*' },
            { title: 'metadata_mirror', name: 'metrics-endpoint.metadata_mirror-*' },
            { title: 'network', name: 'logs-endpoint.events.network-*' },
            { title: 'policy', name: 'metrics-endpoint.policy-*' },
            { title: 'process', name: 'logs-endpoint.events.process-*' },
            { title: 'registry', name: 'logs-endpoint.events.registry-*' },
            { title: 'security', name: 'logs-endpoint.events.security-*' },
            { title: 'telemetry', name: 'metrics-endpoint.telemetry-*' },
          ],
          name: 'endpoint',
          version: '0.5.0',
          internal: false,

...
/**
 * Represents an alert and its related events (including other related alerts.)
 */
export interface GeneratedAlertTree {
  /**
   * The events in the lineage of `alertEvent`.
   */
  ancestry: Event[];
  /**
   * the 'origin' alert event
   */
  alertEvent: Event;
  /**
   * events generated by descendant processes (of the process that caused `alertEvent`)
   */
  descendants: Generator<Event>;
}
...
export class EndpointDocGenerator {
   ...
   */
  public generatedAlertTree(options: TreeOptions = {}): GeneratedAlertTree {
   ...
   * @param alwaysGenMaxChildrenPerNode - flag to always return the max children per node instead of it being a random number of children
   */
  public fullResolverTreeGenerator(options: TreeOptions = {}): GeneratedAlertTree {

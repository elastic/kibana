    ...
    return {
      ...
      savedObject: {
        ...
        attributes: {
          ...
          package_assets: [],
          data_streams: [
            { name: 'alerts', pattern: 'logs-endpoint.alerts-*' },
            { name: 'events', pattern: 'events-endpoint-*' },
            { name: 'file', pattern: 'logs-endpoint.events.file-*' },
            { name: 'library', pattern: 'logs-endpoint.events.library-*' },
            { name: 'metadata', pattern: 'metrics-endpoint.metadata-*' },
            { name: 'metadata_mirror', pattern: 'metrics-endpoint.metadata_mirror-*' },
            { name: 'network', pattern: 'logs-endpoint.events.network-*' },
            { name: 'policy', pattern: 'metrics-endpoint.policy-*' },
            { name: 'process', pattern: 'logs-endpoint.events.process-*' },
            { name: 'registry', pattern: 'logs-endpoint.events.registry-*' },
            { name: 'security', pattern: 'logs-endpoint.events.security-*' },
            { name: 'telemetry', pattern: 'metrics-endpoint.telemetry-*' },
          ],
          name: 'endpoint',
          version: '0.5.0',
          internal: false,

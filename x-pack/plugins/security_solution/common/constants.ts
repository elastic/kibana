...
// It's useful to fetch extra data without extending security solution's APIs. For example it helps to decouple
// features like rule snoozing. It's TEMPORAL solution.

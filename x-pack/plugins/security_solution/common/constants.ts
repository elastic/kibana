...
export const DETECTION_ENGINE_UPGRADE_SIGNALS_URL = `${DETECTION_ENGINE_SIGNALS_URL}/upgrade`;
export const DETECTION_ENGINE_FINALIZE_SIGNALS_UPGRADE_URL = `${DETECTION_ENGINE_SIGNALS_URL}/finalize_upgrade`;

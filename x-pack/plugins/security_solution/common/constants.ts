...
export enum BulkActionsDryRunErrCode {
  ...
  BACKFILL_DISABLED_RULE = 'BACKFILL_DISABLED_RULE',
  BACKFILL_IN_THE_FUTURE = 'BACKFILL_IN_THE_FUTURE',
  BACKFILL_START_FAR_IN_THE_PAST = 'BACKFILL_START_FAR_IN_THE_PAST',
  BACKFILL_START_GREATER_THAN_END = 'BACKFILL_START_GREATER_THAN_END',
}

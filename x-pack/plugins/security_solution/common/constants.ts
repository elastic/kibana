...
export const DETECTION_ENGINE_SIGNALS_MIGRATE_URL = `${DETECTION_ENGINE_SIGNALS_URL}/migrate`;
export const DETECTION_ENGINE_SIGNALS_UPGRADE_URL = `${DETECTION_ENGINE_SIGNALS_URL}/upgrade`;
export const DETECTION_ENGINE_SIGNALS_FINALIZE_UPGRADE_URL = `${DETECTION_ENGINE_SIGNALS_URL}/finalize_upgrade`;

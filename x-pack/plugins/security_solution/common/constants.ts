...
export const ATTACK_DISCOVERY_FEATURE_ID =
  "securitySolutionAttackDiscovery" as const;
...
export const ADD_THREAT_INTELLIGENCE_DATA_PATH =
  `${APP_INTEGRATIONS_PATH}/browse/threat_intel`;
...
export const DEFAULT_REFRESH_RATE_INTERVAL =
  "timepicker:refreshIntervalDefaults" as const;
export const DEFAULT_APP_TIME_RANGE = "securitySolution:timeDefaults" as const;
export const DEFAULT_APP_REFRESH_INTERVAL =
  "securitySolution:refreshIntervalDefaults" as const;
...
export const DEFAULT_ANOMALY_SCORE =
  "securitySolution:defaultAnomalyScore" as const;
...
export const DEFAULT_TIMEPICKER_QUICK_RANGES =
  "timepicker:quickRanges" as const;
export const SCROLLING_DISABLED_CLASS_NAME = "scrolling-disabled" as const;
export const NO_ALERT_INDEX =
  "no-alert-index-049FC71A-4C2C-446F-9901-37XMC5024C51" as const;
...
export const SECURITY_TAG_DESCRIPTION =
  "Security Solution auto-generated tag" as const;
...
export const DEFAULT_THREAT_INDEX_KEY =
  "securitySolution:defaultThreatIndex" as const;
...
export const EXCEPTION_LIST_DETAIL_PATH =
  `${EXCEPTIONS_PATH}/details/:detailName` as const;
...
export const RESPONSE_ACTIONS_HISTORY_PATH =
  `${MANAGEMENT_PATH}/response_actions_history` as const;
export const ENTITY_ANALYTICS_PATH = "/entity_analytics" as const;
export const ENTITY_ANALYTICS_MANAGEMENT_PATH =
  `/entity_analytics_management` as const;
...
export const APP_EVENT_FILTERS_PATH =
  `${APP_PATH}${EVENT_FILTERS_PATH}` as const;
...
export const ENABLE_NEWS_FEED_SETTING =
  "securitySolution:enableNewsFeed" as const;
...
export const ENABLE_CCS_READ_WARNING_SETTING =
  "securitySolution:enableCcsWarning" as const;

/** This Kibana Advanced Setting sets the auto refresh interval for the detections all rules table */
export const DEFAULT_RULES_TABLE_REFRESH_SETTING =
  "securitySolution:rulesTableRefresh" as const;
...
export const NEWS_FEED_URL_SETTING_DEFAULT =
  "https://feeds.elastic.co/security-solution" as const;

/** This Kibana Advanced Setting specifies the URLs of `IP Reputation Links`*/
export const IP_REPUTATION_LINKS_SETTING =
  "securitySolution:ipReputationLinks" as const;
...
export const MAX_UNASSOCIATED_NOTES =
  "securitySolution:maxUnassociatedNotes" as const;
 ...
 */
export const UPDATE_OR_CREATE_LEGACY_ACTIONS =
  "/internal/api/detection/legacy/notifications";

/**
 * Exceptions management routes
 */
export const SHARED_EXCEPTION_LIST_URL =
  `/api${EXCEPTIONS_PATH}/shared` as const;

/**
 * Detection engine routes
 */
export const DETECTION_ENGINE_URL = "/api/detection_engine" as const;
export const DETECTION_ENGINE_PRIVILEGES_URL =
  `${DETECTION_ENGINE_URL}/privileges` as const;
export const DETECTION_ENGINE_INDEX_URL =
  `${DETECTION_ENGINE_URL}/index` as const;

export const DETECTION_ENGINE_RULES_URL =
  `${DETECTION_ENGINE_URL}/rules` as const;
export const DETECTION_ENGINE_RULES_URL_FIND =
  `${DETECTION_ENGINE_RULES_URL}/_find` as const;
export const DETECTION_ENGINE_TAGS_URL =
  `${DETECTION_ENGINE_URL}/tags` as const;
export const DETECTION_ENGINE_RULES_BULK_ACTION =
  `${DETECTION_ENGINE_RULES_URL}/_bulk_action` as const;
export const DETECTION_ENGINE_RULES_PREVIEW =
  `${DETECTION_ENGINE_RULES_URL}/preview` as const;
 ...
 */
export const INTERNAL_DETECTION_ENGINE_URL =
  "/internal/detection_engine" as const;
 ...
 * to see the contents
 */
export const SECURITY_TELEMETRY_URL =
  `/internal/security_solution/telemetry` as const;
...
export const SOURCERER_API_URL =
  "/internal/security_solution/sourcerer" as const;
export const RISK_SCORE_INDEX_STATUS_API_URL =
  "/internal/risk_score/index_status" as const;

export const EVENT_GRAPH_VISUALIZATION_API =
  "/internal/cloud_security_posture/graph" as const;
...
export const DETECTION_ENGINE_SIGNALS_URL =
  `${DETECTION_ENGINE_URL}/signals` as const;
export const DETECTION_ENGINE_SIGNALS_STATUS_URL =
  `${DETECTION_ENGINE_SIGNALS_URL}/status` as const;
export const DETECTION_ENGINE_QUERY_SIGNALS_URL =
  `${DETECTION_ENGINE_SIGNALS_URL}/search` as const;
...
export const DETECTION_ENGINE_ALERT_TAGS_URL =
  `${DETECTION_ENGINE_SIGNALS_URL}/tags` as const;
...
export const SECURITY_INTEGRATIONS_CRIBL_ROUTING_PIPELINE =
  "cribl-routing-pipeline" as const;
...
export const LIMITED_CONCURRENCY_ROUTE_TAG_PREFIX =
  `${APP_ID}:limitedConcurrency`;
...
export const ALERTS_TABLE_VIEW_SELECTION_KEY =

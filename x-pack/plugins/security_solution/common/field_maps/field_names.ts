...
export const ALERT_HOST_CRITICALITY = `${ALERT_NAMESPACE}.host.criticality` as const;
export const ALERT_USER_CRITICALITY = `${ALERT_NAMESPACE}.user.criticality` as const;

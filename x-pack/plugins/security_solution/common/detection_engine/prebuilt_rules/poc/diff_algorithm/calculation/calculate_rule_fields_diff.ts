...
import type {
  ...
  ThresholdFieldsDiff,
} from '../../diff_model/rule_diff';

import type { FieldsDiffAlgorithmsFor } from '../../diff_model/fields_diff';
import type { ThreeVersionsOf } from '../../diff_model/three_way_diff';
...
const commonFieldsDiffAlgorithms: FieldsDiffAlgorithmsFor<DiffableCommonFields> = {
  ...
  rule_content_version: simpleDiffAlgorithm,
  stack_version_min: simpleDiffAlgorithm,
  stack_version_max: simpleDiffAlgorithm,

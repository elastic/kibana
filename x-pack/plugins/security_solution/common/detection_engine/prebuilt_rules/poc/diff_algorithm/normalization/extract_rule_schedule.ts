...
import type { RuleSchedule } from '../../diffable_rule_model/diffable_field_types';

export const extractRuleSchedule = (rule: RuleResponse | PrebuiltRuleContent): RuleSchedule => {

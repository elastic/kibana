...
import { getFullCreateSchemaMock } from './rule_schemas.mock';
...
describe('create_rules_bulk_schema', () => {
  ...
  test('single array element does validate', () => {
    const payload: CreateRulesBulkSchema = [getFullCreateSchemaMock()];
  ...
  test('two array elements do validate', () => {
    const payload: CreateRulesBulkSchema = [getFullCreateSchemaMock(), getFullCreateSchemaMock()];
  ...
  test('single array element with a missing value (risk_score) will not validate', () => {
    const singleItem = getFullCreateSchemaMock();
    // @ts-expect-error
  ...
  test('two array elements where the first is valid but the second is invalid (risk_score) will not validate', () => {
    const singleItem = getFullCreateSchemaMock();
    const secondItem = getFullCreateSchemaMock();
    // @ts-expect-error
  ...
  test('You cannot set the severity to a value other than low, medium, high, or critical', () => {
    const badSeverity = { ...getFullCreateSchemaMock(), severity: 'madeup' };
  ...
  test('You can set "note" to a string', () => {
    const payload: CreateRulesBulkSchema = [
      { ...getFullCreateSchemaMock(), note: '# test markdown' },
    ];
  ...
  test('You can set "note" to an empty string', () => {
    const payload: CreateRulesBulkSchema = [{ ...getFullCreateSchemaMock(), note: '' }];

 ...
 */
const addPrepackagedRulesBaseRequired = {
  description,
  risk_score,
  name,
  severity,
...
const addPrepackagedRulesBaseOptional = {
...
export const addPrepackagedRulesSchema = t.intersection([
  t.exact(t.type(addPrepackagedRulesBaseRequired)),
  t.exact(t.partial(addPrepackagedRulesBaseOptional)),
]);

export type AddPrepackagedRulesSchema = t.TypeOf<typeof addPrepackagedRulesSchema>;

export const racAddPrepackagedRulesSchema = t.intersection([
  t.exact(
    t.type({
      ...addPrepackagedRulesBaseRequired,
      namespace: t.string,
    })
  ),
  t.exact(t.partial(addPrepackagedRulesBaseOptional)),
...
export type RACAddPrepackagedRulesSchema = t.TypeOf<typeof racAddPrepackagedRulesSchema>;

...
export type CalculateCustomRiskScoreRequest = z.infer<typeof CalculateCustomRiskScoreRequest>;
export const CalculateCustomRiskScoreRequest = z.object({
  /**
...
export type CalculateCustomRiskScoreResponse = z.infer<typeof CalculateCustomRiskScoreResponse>;
export const CalculateCustomRiskScoreResponse = z.object({
  /**
...
export type CustomRiskScoreCalculationRequestBody = z.infer<
  typeof CustomRiskScoreCalculationRequestBody
>;
export const CustomRiskScoreCalculationRequestBody = CalculateCustomRiskScoreRequest;
export type CustomRiskScoreCalculationRequestBodyInput = z.input<
  typeof CustomRiskScoreCalculationRequestBody
>;

export type CustomRiskScoreCalculationResponse = z.infer<typeof CustomRiskScoreCalculationResponse>;
export const CustomRiskScoreCalculationResponse = CalculateCustomRiskScoreResponse;

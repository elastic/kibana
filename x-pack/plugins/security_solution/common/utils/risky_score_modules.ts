...
export const getRiskyScoreLevelScriptId = (riskScoreEntity: RiskScoreEntity) =>
  `ml_${riskScoreEntity}riskscore_levels_script`;
export const getRiskyScoreInitScriptId = (riskScoreEntity: RiskScoreEntity) =>
  `ml_${riskScoreEntity}riskscore_init_script`;
export const getRiskyScoreMapScriptId = (riskScoreEntity: RiskScoreEntity) =>
  `ml_${riskScoreEntity}riskscore_map_script`;
export const getRiskyScoreReduceScriptId = (riskScoreEntity: RiskScoreEntity) =>
 ...
 */
export const getRiskyHostCreateLevelScriptOptions = (stringifyScript?: boolean) => {
  const source =
 ...
 */
export const getRiskyHostCreateInitScriptOptions = (stringifyScript?: boolean) => {
  const source =
 ...
 */
export const getRiskyHostCreateMapScriptOptions = (stringifyScript?: boolean) => {
  const source =
 ...
 */
export const getRiskyHostCreateReduceScriptOptions = (stringifyScript?: boolean) => {
  const source =
 ...
 */
export const getRiskyUserCreateLevelScriptOptions = (stringifyScript?: boolean) => {
  const source =
 ...
 */
export const getRiskyUserCreateMapScriptOptions = (stringifyScript?: boolean) => {
  const source =
 ...
 */
export const getRiskyUserCreateReduceScriptOptions = (stringifyScript?: boolean) => {
  const source =

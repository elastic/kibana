...
import type { AppClient, SecuritySolutionRequestHandlerContext } from './types';

export type SecuritySolutionPluginRouterMock = RouterMock<SecuritySolutionRequestHandlerContext>;

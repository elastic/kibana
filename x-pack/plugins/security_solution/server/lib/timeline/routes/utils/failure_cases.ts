...
export const UPDATE_TEMPLATE_TIMELINE_ERROR_MESSAGE =
  "CREATE timeline template with PATCH is not allowed, please use POST instead (Given timeline template doesn't exist)";
...
export const CREATE_TEMPLATE_TIMELINE_WITHOUT_VERSION_ERROR_MESSAGE =
  'Create timeline template without a valid templateTimelineVersion is not allowed. Please start from 1 to create a new timeline template';

...
/**
 * The reference name for the filter set ID field within the timeline saved object definition
 */
...
/**
 * This needs to match the type of the filter set saved object. That type is defined here:

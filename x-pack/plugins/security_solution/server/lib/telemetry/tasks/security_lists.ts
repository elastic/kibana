  ...
  return {
    ...
    runTask: async (
      ...
      if (trustedApps?.data) {
        ...
        logger.info(`Trusted Apps: ${trustedAppsJson}`);
      ...
      if (epExceptions?.data) {
        ...
        logger.info(`EP Exceptions: ${epExceptionsJson}`);
      ...
      if (epFilters?.data) {
        ...
        logger.info(`EP Event Filters: ${epFiltersJson}`);
      ...
      cloudOnlyLogger.log(`Value List Meta Data: ${JSON.stringify(valueListMetaData)}`);

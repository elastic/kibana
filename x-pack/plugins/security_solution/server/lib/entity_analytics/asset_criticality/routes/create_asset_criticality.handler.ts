...
export const createAssetCriticalityRecordRoute = (router: RoutesDeps['router'], logger: Logger) => {
  router.versioned
    .post({
      access: 'public',
    ...
    .addVersion(
      ...
      async (
        ...
        try {
          const body: CreateAssetCriticalityRecordResponse = undefined;

          return response.ok({ body });
        } catch (e) {
          logger.error('Error in CreateAssetCriticalityRecord:', e);

...
import rule21 from './command_and_control_accepted_default_telnet_port_connection.json';
...
import rule52 from './execution_file_transfer_or_listener_established_via_netcat.json';
...
import rule674 from './privilege_escalation_pod_created_with_sensitive_hostpath_volume.json';
...
import rule681 from './discovery_posh_invoke_sharefinder.json';
import rule682 from './privilege_escalation_posh_token_impersonation.json';
import rule683 from './collection_google_drive_ownership_transferred_via_google_workspace.json';
import rule684 from './persistence_google_workspace_user_group_access_modified_to_allow_external_access.json';
import rule685 from './defense_evasion_application_removed_from_blocklist_in_google_workspace.json';
import rule686 from './defense_evasion_google_workspace_restrictions_for_google_marketplace_changed_to_allow_any_app.json';
import rule687 from './persistence_google_workspace_2sv_policy_disabled.json';
import rule688 from './credential_access_generic_localdumps.json';
import rule689 from './defense_evasion_persistence_temp_scheduled_task.json';
import rule690 from './lateral_movement_remote_task_creation_winlog.json';

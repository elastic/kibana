...
import rule675 from './privilege_escalation_pod_created_with_sensitive_hostpath_volume.json';
...
import rule707 from './privilege_escalation_container_created_with_excessive_linux_capabilities.json';

...
describe('_createRule', () => {
  ...
  it('should create a rule with the correct parameters', async () => {
    const params = getCreateRulesSchemaMock();

    await _createRule(rulesClient, params, options);
  ...
  it('calls the rulesClient with legacy ML params', async () => {
    await _createRule(rulesClient, getCreateMachineLearningRulesSchemaMock(), options);

...
export const convertPatchAPIToInternalSchema = (
  ...
  return {
    ...
    params: {
      ...
      investigationOptions: nextParams.investigation_options ?? existingParams.investigationOptions,
...
export const convertCreateAPIToInternalSchema = (
  ...
  return {
    ...
    params: {
      ...
      investigationOptions: input.investigation_options,
...
export const commonParamsCamelToSnake = (params: BaseRuleParams) => {
  return {
    ...
    investigation_options: params.investigationOptions,

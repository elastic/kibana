...
import { SanitizedAlert, RuleTypeParams } from '../../../../../alerting/common';
...
): Array<Promise<SanitizedAlert<RuleTypeParams>>> =>
  rules.reduce<Array<Promise<SanitizedAlert<RuleTypeParams>>>>((acc, rule) => {
    const {

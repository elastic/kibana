 ...
 * @param includeLegacyId - Ask the alerting framework's rulesClient to include the pre-8.0 _id of
 * the rule saved object so we can also query for alerts as data generated by this rule
 * before the rule's _id was changed.
 */

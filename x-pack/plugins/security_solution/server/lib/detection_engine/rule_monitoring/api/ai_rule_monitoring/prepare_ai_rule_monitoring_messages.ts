...
const GOAL =
  'Analyze provided Kibana security rules monitoring data. Name top errors and warnings. Give concrete instructions to resolve errors. Give your guesses of what can be wrong with the cluster.';

...
export const getSavedScriptRequestHandler = (
...
> => {
  return async (context, request, response) => {
    ...
    try {
      const savedScript = await savedObjectsClient.get<SavedScriptSavedObject>(
      ...
      const data = {
        ...
        updated_by: updatedBy,
        // prebuilt,
        saved_object_id: savedScript.id,
      };

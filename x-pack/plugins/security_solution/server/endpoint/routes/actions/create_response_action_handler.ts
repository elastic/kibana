...
export const createResponseActionHandler = async (
  ...
  // introduced getStartServices in context, in order to be able to get esClient on the server side - it's gonna be used in schedule_notification_response_actions where we do not have access to api context

...
import { downloadEndpointExceptionList } from '../lib/detection_engine/routes/exceptions/download_endpoint_exception_list';
import { getEndpointExceptionListManifest } from '../lib/detection_engine/routes/exceptions/get_endpoint_exception_list_manifest';
...
export const initRoutes = (
  ...
  downloadEndpointExceptionList(router);
  getEndpointExceptionListManifest(router);

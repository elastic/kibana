...
import { getTimelineByTemplateTimelineIdRoute } from '../lib/timeline/routes/get_timeline_by_template_timeline_id_route';
...
export const initRoutes = (
  ...
  getTimelineByTemplateTimelineIdRoute(router, config, security);

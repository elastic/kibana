...
import { SnapshotErrorType, SnapshotError } from './snapshot_error';

export const SnapshotEmptyPrompt: React.FunctionComponent<{
  errors: SnapshotErrorType['errors'];
  policiesCount: number;
}> = ({ errors, policiesCount }) => {

...
describe('SimpleTestResults', function () {
  ...
  it('should displays results', async function () {
    const searchFn = jest.fn().mockReturnValue(rxjsFrom(new Promise((resolve) => resolve(data))));
    render(<SimpleTestResults monitorId={'test-id'} />, {
      core: {
        data: {
          search: {
...
const data = {
  id: 0,
  result: {
    id: 'FkNjYVh3MW85VExXNzdMaWlOZnZWa3ceQzFmYXdWWTlRMi1ZN2dremhBV2FWdzozOTIzMjM1',
    rawResponse: {
      took: 201,
      timed_out: false,

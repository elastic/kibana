...
export class RulesClientFactory {
  ...
  private onRuleCreate$!: Subject<{ id: string; type: string }>;
  private onRuleUpdate$!: Subject<{ id: string; type: string }>;
  private onRuleDelete$!: Subject<{ id: string }>;
  ...
  public initialize(options: RulesClientFactoryOpts) {
    ...
    this.onRuleCreate$ = new Subject();
    this.onRuleUpdate$ = new Subject();
    this.onRuleDelete$ = new Subject();
  }
  ...
  public create(request: KibanaRequest, savedObjects: SavedObjectsServiceStart): RulesClient {
    ...
    return new RulesClient({
      ...
      onRuleCreate$: this.onRuleCreate$,
  ...
  public get events() {
    return {
      onRuleCreate$: this.onRuleCreate$.asObservable(),
      onRuleUpdate$: this.onRuleUpdate$.asObservable(),
      onRuleDelete$: this.onRuleDelete$.asObservable(),
    };
  }
}

...
import { RecoveredActionGroup, RuleNotifyWhen } from '../types';
    ...
    test.each(testParams)(
      ...
      async ({ shouldLogAlerts }) => {
        ...
        const alertsClient = new LegacyAlertsClient({
          ...
          activeAlertsFromState: {},
          recoveredAlertsFromState: {
            '1': { meta: { flappingHistory: [true, true, false, false], uuid: 'UUID1' } },
          },
          ruleTypeState: {},
        });
      ...
      async ({ shouldLogAlerts }) => {
        ...
        const alertsClient = new LegacyAlertsClient({
          ...
          activeAlertsFromState: {
            '1': {
              state: { start: '1969-12-30T00:00:00.000Z', duration: 33000 },
              meta: { flappingHistory: [true, true, false, false], uuid: 'UUID1' },
            },
            '2': {
        ...
        const alertsClient = new LegacyAlertsClient({
          ...
          recoveredAlertsFromState: {
            '3': {
              ...
              meta: { flappingHistory: [false, false], uuid: 'UUID3' },
            },
          },
          ruleTypeState: {},
        });
        ...
        const alertsClient = new LegacyAlertsClient({
          ...
          activeAlertsFromState: {
            ...
            '3': {
              ...
              meta: { flappingHistory: [false], uuid: 'UUID3' },
            },
          },
          recoveredAlertsFromState: {
            '4': {
              ...
              meta: { flappingHistory: [false, false], uuid: 'UUID4' },
            },
          },
          ruleTypeState: {},
        });
    ...
    test('should return recovered alerts only if they have been reported as recovered greater than the configured amount', async () => {
      ...
      const alertsClient = new LegacyAlertsClient({
        ...
        activeAlertsFromState: {
          '1': {
            state: { start: '1969-12-30T00:00:00.000Z', duration: 33000 },
            meta: { flappingHistory: flapping, pendingRecoveredCount: 3, uuid: 'UUID1' },
          },
          '2': {
            state: { start: '1969-12-31T07:34:00.000Z', duration: 23532 },
            meta: { flappingHistory: flapping, pendingRecoveredCount: 0, uuid: 'UUID2' },
          },
        },
        recoveredAlertsFromState: {
          '3': {
            ...
            meta: { flappingHistory: notFlapping, pendingRecoveredCount: 0, uuid: 'UUID3' },
          },
        },
        ruleTypeState: {},
      });
...
const generateAlertOpts = ({ action, group, state, id, uuid }: GeneratorParams = {}) => {
  id = id ?? '1';
  let message: string = '';
  switch (action) {

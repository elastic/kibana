...
describe('get()', () => {
  ...
  test('should call inject saved object references if defined for rule type', async () => {
  ...
  test('throws an error if inject saved object references function throws an error', async () => {

...
import { findRulesRequestQuerySchemaV1, findRulesInternalRequestQuerySchemaV1 } from '..';

export type FindRulesRequestQuery = TypeOf<typeof findRulesRequestQuerySchemaV1>;
export type FindRulesInternalRequestQuery = TypeOf<typeof findRulesInternalRequestQuerySchemaV1>;

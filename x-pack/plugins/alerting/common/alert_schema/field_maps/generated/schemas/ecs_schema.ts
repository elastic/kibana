...
const EcsRequiredSchema = rt.type({
  '@timestamp': schemaDate,
  ecs: rt.type({
    version: schemaString,
  }),
});
const EcsOptionalSchema = rt.partial({
  agent: rt.partial({
    build: rt.partial({
...
export const EcsSchema = rt.intersection([EcsRequiredSchema, EcsOptionalSchema]);

...
|ruleTaskTimeout|The value could be used to override the task manager default timeout for a rule task. By default value will be set from alerting configuration "10m".|string|

...
/**
 * Hook version of <ToastNotificationText> for use with the EuiToast `actionProps` API.
 * Returns a function that produces `{ text, actionProps? }` to spread into toast service calls.
 */

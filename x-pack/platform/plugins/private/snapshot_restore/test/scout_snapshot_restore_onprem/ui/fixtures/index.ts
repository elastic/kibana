...
import { RegisterRepositoryPage } from './page_objects';

export interface ExtScoutTestFixtures extends ScoutTestFixtures {
  pageObjects: PageObjects & {
    registerRepository: RegisterRepositoryPage;
  };
}
...
export const test = baseTest.extend<ExtScoutTestFixtures, ScoutWorkerFixtures>({
  pageObjects: async (
    ...
    await use({
      ...pageObjects,
      registerRepository: createLazyPageObject(RegisterRepositoryPage, page),
    });
  },
});

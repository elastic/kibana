...
import { type LicenseFeature, type ILicense } from '@kbn/licensing-plugin/server';
import type {
...
import { type RouteConfig, type RouteMethod, type Headers } from '@kbn/core/server';
...
import { type configSchema, type MonitoringConfig } from './config';

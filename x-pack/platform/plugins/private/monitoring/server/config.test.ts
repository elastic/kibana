...
describe('createConfig()', () => {
  const MOCKED_PATHS = [
    'src/dev/packages/dev-utils/certs/ca.crt',
    'src/dev/packages/dev-utils/certs/elasticsearch.crt',
    'src/dev/packages/dev-utils/certs/elasticsearch.key',
  ];
  ...
  it('should attempt to read PEM files', async () => {
    const ssl = {
      certificate: 'src/dev/packages/dev-utils/certs/elasticsearch.crt',
      key: 'src/dev/packages/dev-utils/certs/elasticsearch.key',
      certificateAuthorities: 'src/dev/packages/dev-utils/certs/ca.crt',
    };
    const config = createConfig(
      configSchema.validate({
        ui: {
    ...
    const expected = expect.objectContaining({
      certificate: 'contents-of-src/dev/packages/dev-utils/certs/elasticsearch.crt',
      key: 'contents-of-src/dev/packages/dev-utils/certs/elasticsearch.key',
      certificateAuthorities: ['contents-of-src/dev/packages/dev-utils/certs/ca.crt'],
    });

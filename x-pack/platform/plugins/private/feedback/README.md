...
Once clicked, a modal containing feedback questions and CSAT score buttons are displayed to the user. The questions are context-aware and are defined per application in [`@kbn/feedback-registry`](../../../packages/private/feedback-registry/README.md). In case when an application has no defined questions a default set of questions is displayed.

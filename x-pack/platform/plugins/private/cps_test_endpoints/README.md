...
2. **Verify deployment (browser console - recommended for OAuth)**:
   ```javascript
   // Log into Kibana UI, open browser console (F12)
...
4. **Or use curl (if you have basic auth)**:
   ```bash
   ...
   > **Note**: Replace `keepbriando-cps-test-proj-linked-ce713c` with your actual linked project alias. Use indices from your origin project (not linked project).

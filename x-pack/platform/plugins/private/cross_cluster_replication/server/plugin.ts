...
import { type CoreSetup, type CoreStart, type Plugin, type Logger, type PluginInitializerContext } from '@kbn/core/server';
import { type IScopedClusterClient } from '@kbn/core/server';

import { type Index } from '@kbn/index-management-plugin/server';
import { PLUGIN } from '../common/constants';
import { type SetupDependencies, type StartDependencies } from './types';

...
export const UIM_AUTO_FOLLOW_PATTERN_PAUSE = 'auto_follow_pattern_pause';
export const UIM_AUTO_FOLLOW_PATTERN_PAUSE_MANY = 'auto_follow_pattern_pause_many';
export const UIM_AUTO_FOLLOW_PATTERN_RESUME = 'auto_follow_pattern_resume';
export const UIM_AUTO_FOLLOW_PATTERN_RESUME_MANY = 'auto_follow_pattern_resume_many';

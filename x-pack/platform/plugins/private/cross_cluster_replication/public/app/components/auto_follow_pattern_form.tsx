...
type AutoFollowPatternFormFields = Omit<ParsedAutoFollowPattern, 'active'> & {
  active?: boolean;
};
...
export class AutoFollowPatternForm extends PureComponent<Props, State> {
  ...
  onFieldsChange = (fields: Partial<AutoFollowPatternFormFields>) => {

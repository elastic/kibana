...
import { type Plugin, type CoreSetup, type PluginInitializerContext } from '@kbn/core/public';
...
import { type SetupDependencies, type StartDependencies, type AppDependencies, type ClientConfigType } from './types';

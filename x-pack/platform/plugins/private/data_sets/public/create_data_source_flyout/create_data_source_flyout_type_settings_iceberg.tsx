...
export function CreateDataSourceFlyoutTypeSettingsIceberg({
  ...
  return (
    <>
      <EuiFormRow
        label={i18n.translate('dataSets.createFlyout.iceberg.fields.region', {
      ...
      <EuiFormRow
        label={i18n.translate('dataSets.createFlyout.iceberg.fields.endpoint', {
      ...
      <EuiFormRow
        label={i18n.translate('dataSets.createFlyout.iceberg.fields.accessKey', {
      ...
      <EuiFormRow
        label={i18n.translate('dataSets.createFlyout.iceberg.fields.secretKey', {

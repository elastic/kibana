...
import type { PdfScreenshotOptions as BasePdfScreenshotOptions, PngScreenshotOptions as BasePngScreenshotOptions, ScreenshottingStart } from '@kbn/screenshotting-plugin/server';
import type { SecurityPluginSetup, SecurityPluginStart } from '@kbn/security-plugin/server';
import type { SpacesPluginSetup } from '@kbn/spaces-plugin/server';
import type { RruleSchedule, TaskManagerSetupContract, TaskManagerStartContract } from '@kbn/task-manager-plugin/server';
...
import type { RawNotification, RawScheduledReport } from './saved_objects/scheduled_report/schemas/latest';
import type { GenerateSystemReportRequestParams, HandleResponseFunc } from './routes/common/request_handler/generate_system_report_request_handler';
/**
...
export interface ReportingSetup {
     ...
     */
    handleGenerateSystemReportRequest: (path: string, requestParams: GenerateSystemReportRequestParams, handleResponseFunc: HandleResponseFunc) => Promise<IKibanaResponse>;
}
/**
...
export type ScheduledReportApiJSON = Omit<ReportSource, 'attempts' | 'migration_version' | 'output' | 'payload' | 'status'> & {
    id: string;

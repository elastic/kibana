...
const getKey = mutationKeys.bulkDeleteScheduledReports;
  ...
  return useMutation({
    ...
    onError: (error: ServerError) => {
      toasts.addError(error, {
        title: i18n.translate('xpack.reporting.schedules.reports.deleteError', {
    ...
    onSuccess: () => {
      toasts.addSuccess(
        i18n.translate('xpack.reporting.schedules.reports.deleted', {

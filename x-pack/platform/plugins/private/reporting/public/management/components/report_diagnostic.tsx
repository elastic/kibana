...
export interface ReportDiagnosticHandle {
  open: () => void;
}
...
export const ReportDiagnostic = forwardRef<ReportDiagnosticHandle, Props>(
  ({ apiClient, clientConfig, hideTrigger = false }, ref) => {

...
import {
  getPainlessLabLeftPaneStyles,
  getPainlessLabMainContainerStyles,
  painlessLabPanelsContainerStyles,
} from '../../styles';
...
export const Main: React.FunctionComponent = () => {
  ...
  return (
    <div css={getPainlessLabMainContainerStyles(euiTheme)}>
      <EuiFlexGroup responsive={false} gutterSize="none" css={painlessLabPanelsContainerStyles}>
        <EuiFlexItem css={getPainlessLabLeftPaneStyles(euiTheme)}>

...
/**
 * Discover sessions shared by data_visualizer and ML Scout UI tests.
 * Owned here (not ml-plugin) so moon deps stay ml → data_visualizer and avoid a cycle.
 * Titles match FTR / SavedObjectFinder selection so selection stays stable.
 */

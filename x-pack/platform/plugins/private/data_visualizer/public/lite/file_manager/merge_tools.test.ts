...
describe('merge_tools', () => {
  ...
  describe('getMappingClashInfo', () => {
    it('should return file clashes based on mapping clashes', () => {
      const mappingClashes = [
        {
          fieldName: 'field1',
          existingType: 'text',
          clashingType: { fileName: 'file2', newType: 'keyword', fileIndex: 1 },
        },
      ];
      ...
      expect(result).toEqual([
        { fileName: 'file1', clash: false, clashType: CLASH_TYPE.MAPPING },
        { fileName: 'file2', clash: true, clashType: CLASH_TYPE.MAPPING },
      ]);
    });
  });
  ...
  describe('getFormatClashes', () => {
    ...
    it('should return unsupported format clashes', () => {
      ...
      expect(result).toEqual([
        { fileName: 'file1', clash: false },
        { fileName: 'file2', clash: true, clashType: CLASH_TYPE.UNSUPPORTED },
      ]);
    });
  });
});

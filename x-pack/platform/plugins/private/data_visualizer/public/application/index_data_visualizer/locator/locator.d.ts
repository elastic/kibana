...
export declare class IndexDataVisualizerLocatorDefinition implements LocatorDefinition<IndexDataVisualizerLocatorParams> {
    ...
    constructor();
    readonly getTimeRange: (params: IndexDataVisualizerLocatorParams) => TimeRange | undefined;
    readonly setTimeRange: (params: IndexDataVisualizerLocatorParams, timeRange?: TimeRange) => {

...
export type { FieldStatsInitialState, FieldStatisticsTableEmbeddableState, } from '../../../../../common/embeddables/types';
...
export type ESQLDataVisualizerGridEmbeddableState = Omit<FieldStatisticTableEmbeddableProps, 'query'> & {
    query?: ESQLQuery;
};
...
export interface ESQLDataVisualizerIndexBasedAppState extends Omit<DataVisualizerIndexBasedAppState, 'query'> {

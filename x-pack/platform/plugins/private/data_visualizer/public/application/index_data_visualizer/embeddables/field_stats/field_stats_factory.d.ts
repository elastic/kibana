...
export declare const getDependencies: (getStartServices: StartServicesAccessor<DataVisualizerStartDependencies, DataVisualizerPluginStart>) => Promise<{
    ...
    userStorage: import("@kbn/core/packages/user-storage/browser").IUserStorageClient;
...
export declare const getFieldStatsChartEmbeddableFactory: (getStartServices: StartServicesAccessor<DataVisualizerStartDependencies, DataVisualizerPluginStart>) => EmbeddablePublicDefinition<Readonly<{

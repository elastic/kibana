...
export declare const getFieldStatsChartEmbeddableFactory: (getStartServices: StartServicesAccessor<DataVisualizerStartDependencies, DataVisualizerPluginStart>) => EmbeddablePublicDefinition<FieldStatisticsTableEmbeddableState, FieldStatisticsTableEmbeddableApi>;

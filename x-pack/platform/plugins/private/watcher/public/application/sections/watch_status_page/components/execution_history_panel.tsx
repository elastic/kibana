    ...
    },
    {
      ...
      render: (startTime: Moment, item: any) => {
        ...
        if (startTime.isSame(lastExecution)) {
          return <EuiIcon color="green" type="check" aria-label={i18n.translate('xpack.watcher.sections.watchHistory.watchTable.conditionMetAriaLabel', { defaultMessage: 'Condition met' })} />;
        }
      },
    },
    {

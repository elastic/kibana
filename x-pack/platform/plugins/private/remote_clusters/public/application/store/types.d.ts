...
import type { OPEN_DETAIL_PANEL, CLOSE_DETAIL_PANEL, LOAD_CLUSTERS_START, LOAD_CLUSTERS_SUCCESS, LOAD_CLUSTERS_FAILURE, REFRESH_CLUSTERS_SUCCESS, ADD_CLUSTER_START, ADD_CLUSTER_SUCCESS, ADD_CLUSTER_FAILURE, CLEAR_ADD_CLUSTER_ERRORS, EDIT_CLUSTER_START, EDIT_CLUSTER_STOP, EDIT_CLUSTER_SAVE, EDIT_CLUSTER_SUCCESS, EDIT_CLUSTER_FAILURE, CLEAR_EDIT_CLUSTER_ERRORS, REMOVE_CLUSTERS_START, REMOVE_CLUSTERS_FINISH } from './action_types';
...
export type RemoteClustersAction = {
    ...
    type: typeof LOAD_CLUSTERS_SUCCESS;
    payload: {
        clusters: RemoteCluster[];
    };
} | {
    type: typeof LOAD_CLUSTERS_FAILURE;
    payload: {
        error: unknown;
    };
} | {
    type: typeof REFRESH_CLUSTERS_SUCCESS;
    payload: {
        clusters: RemoteCluster[];
    };
} | {
    ...
    type: typeof ADD_CLUSTER_FAILURE;
    payload: {
        error: unknown;
    };
} | {
    ...
    type: typeof EDIT_CLUSTER_START;
    payload: {
        clusterName: string;
    };
} | {
    ...
    type: typeof EDIT_CLUSTER_FAILURE;
    payload: {
        error: unknown;
    };
} | {
    ...
    type: typeof REMOVE_CLUSTERS_FINISH;
    payload: string[];
};
/**
 ...
 */
export type AppThunk<ReturnType = void> = ThunkAction<ReturnType, RemoteClustersState, undefined, RemoteClustersAction>;

...
export const getDetailPanelCluster = (state: RemoteClustersState) => {
  const clusterName = state.detailPanel.clusterName;
  return clusterName ? getClusterByName(state, clusterName) : undefined;
};
...
export const getEditedCluster = (state: RemoteClustersState) => {
  const clusterName = state.editCluster.clusterName;
  return clusterName ? getClustersByName(state)[clusterName] : undefined;
};

  ...
  public setup(
    ...
    developerExamples.register({
      ...
      links: [
        {
          label: 'README',
          href: 'https://github.com/elastic/kibana/tree/main/x-pack/platform/plugins/private/Users/gsoldevila/Work/kibana-secondary/Users/gsoldevila/Work/kibana-secondary/x-pack/examples/ui_actions_enhanced_examples#ui-actions-enhanced-examples',
          iconType: 'logoGithub',
          size: 's',
          target: '_blank',
        },

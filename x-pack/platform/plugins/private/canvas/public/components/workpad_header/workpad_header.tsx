...
import { type CommitFn, type ElementSpec, type State } from '../../../types';
import { WorkpadHeader as Component, type Props as ComponentProps } from './workpad_header.component';

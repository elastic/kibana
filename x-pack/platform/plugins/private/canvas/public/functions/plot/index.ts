...
import { type ExpressionFunctionDefinition, type Style } from '@kbn/expressions-plugin/common';
...
import { type AxisConfig, type PointSeries, type Render, type SeriesStyle, Legend } from '../../../types';

...
import { type CoreSetup, type PluginInitializerContext, type Plugin, type Logger, type CoreStart } from '@kbn/core/server';
import {
...
import { type CanvasRouteHandlerContext, createWorkpadRouteContext } from './workpad_route_context';

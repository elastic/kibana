...
import { type ExpressionAstArgument, type ExpressionAstFunction } from '@kbn/expressions-plugin/common';
import { identifyPalette, type ColorPalette, identifyPartialPalette } from '../../../../common/lib';

...
export const PaletteArgInput: CanvasFunctionComponent<Props> = ({
  onValueChange,
  argId,
  argValue,
  renderError,
...
export const SimplePaletteArgInput: CanvasFunctionComponent<Props> = (props) => {
...
export const StopsPaletteArgInput: CanvasFunctionComponent<Props> = (props) => (
  <PaletteArgInput
    {...props}
    typeInstance={{
      ...props.typeInstance,

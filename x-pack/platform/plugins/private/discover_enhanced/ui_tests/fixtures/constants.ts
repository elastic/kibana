...
export const ES_ARCHIVES = {
  ...
  NO_TIME_FIELD: 'src/platform/test/functional/fixtures/es_archiver/index_pattern_without_timefield',
  ECOMMERCE: 'x-pack/test/functional/es_archives/reporting/ecommerce',
};

export const KBN_ARCHIVES = {
  INVALID_SCRIPTED_FIELD: 'src/platform/test/functional/fixtures/kbn_archiver/invalid_scripted_field',
  NO_TIME_FIELD: 'src/platform/test/functional/fixtures/kbn_archiver/index_pattern_without_timefield',

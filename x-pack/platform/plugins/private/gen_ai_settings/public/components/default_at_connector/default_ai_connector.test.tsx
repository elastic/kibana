...
function setupTest() {
    ...
    let settingsValue: ReturnType<typeof useSettingsContext> | undefined = undefined;
...
describe("DefaultAIConnector", () => {
    describe("rendering", () => {
        it("renders all component elements correctly", () => {
            ...
            expect(screen.getByTestId("comboBoxSearchInput")).toHaveAttribute("value", "No default connector");
            expect(
                container.querySelector('[class$="square-unselected"]')
            ).not.toBeNull();
        });
    });
    ...
    describe("combobox interaction", () => {
        ...
        it("updates selection when connector is chosen", async () => {
            ...
            expect(screen.getByTestId("comboBoxSearchInput")).toHaveAttribute("value", "Custom Connector 1");
        });
    });
    ...
    describe("checkbox interaction", () => {
        it("updates checkbox state when clicked", async () => {
            ...
            expect(
                container.querySelector('[class$="square-selected"]')
            ).not.toBeNull();
        });
    });

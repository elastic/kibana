...
export const AlertValidationWorkflowRuleAttachmentSection: React.FC = () => {
  ...
  const statsQuery = useQuery<RuleAttachmentStats, RuleAttachmentError>({
    ...
    onError: (error) => {
      showRuleAttachmentError(
        i18n.translate(
          'xpack.genAiSettings.alertValidationWorkflow.ruleAttachmentStatsErrorMessage',
          {
  ...
  const ruleAttachmentsQuery = useQuery<RuleAttachmentPage, RuleAttachmentError>({
    ...
    onError: (error) => {
      showRuleAttachmentError(
        i18n.translate(
          'xpack.genAiSettings.alertValidationWorkflow.ruleAttachmentListErrorMessage',
          {
  ...
  >({
    ...
    onError: (error) => {
      showRuleAttachmentError(
        i18n.translate(
          'xpack.genAiSettings.alertValidationWorkflow.ruleAttachmentSelectionErrorMessage',
          {
  ...
  const updateMutation = useMutation<UpdateRuleAttachmentsResult, RuleAttachmentError>({
    ...
    onSuccess: (response: UpdateRuleAttachmentsResult) => {
      ...
      notifications.toasts.addSuccess(
        i18n.translate('xpack.genAiSettings.alertValidationWorkflow.ruleAttachmentSuccessMessage', {
          defaultMessage:
            'Updated alert validation workflow on {updated, plural, one {# rule} other {# rules}}.',
    ...
    onError: (error) => {
      showRuleAttachmentError(
        i18n.translate('xpack.genAiSettings.alertValidationWorkflow.ruleAttachmentErrorMessage', {
          defaultMessage: 'Failed to update alert validation workflow on detection rules',
        }),
        error
      );
    },
    ...
    () => [
      {
        field: 'name',
        name: i18n.translate(
          'xpack.genAiSettings.alertValidationWorkflow.ruleAttachmentRuleNameColumnLabel',
          {
            defaultMessage: 'Rule',
          }
        ),
      ...
      },
      {
        field: 'enabled',
        name: i18n.translate(
          'xpack.genAiSettings.alertValidationWorkflow.ruleAttachmentEnabledColumnLabel',
          {
        ...
        render: (enabled: boolean) =>
          enabled ? (
            <EuiBadge color="success">
              <FormattedMessage
                id="xpack.genAiSettings.alertValidationWorkflow.ruleAttachmentEnabledBadgeLabel"
            ...
            <EuiBadge color="hollow">
              <FormattedMessage
                id="xpack.genAiSettings.alertValidationWorkflow.ruleAttachmentDisabledBadgeLabel"
  ...
  return (
    <EuiDescribedFormGroup
      ...
      title={
        <h4>
          <FormattedMessage
            id="xpack.genAiSettings.alertValidationWorkflow.ruleAttachmentTitle"
      ...
      description={
        <p>
          <FormattedMessage
            id="xpack.genAiSettings.alertValidationWorkflow.ruleAttachmentDescription"
            defaultMessage="Select the detection rules that should run the managed alert validation workflow. Existing workflow attachments are shown before you apply changes."
          />
        </p>
      }
    >
        ...
        <EuiFlexItem>
          <EuiFormRow
            ...
            label={i18n.translate(
              'xpack.genAiSettings.alertValidationWorkflow.ruleAttachmentFilterQueryLabel',
              {
                defaultMessage: 'Rule filter',
              }
            )}
            helpText={i18n.translate(
              'xpack.genAiSettings.alertValidationWorkflow.ruleAttachmentFilterQueryHelpText',
              {
                defaultMessage:
          ...
          >
            <EuiFieldSearch
              ...
              placeholder={i18n.translate(
                'xpack.genAiSettings.alertValidationWorkflow.ruleAttachmentFilterQueryPlaceholder',
                {
        ...
        <EuiFlexItem>
          ...
          >
            <EuiFlexItem grow>
              <EuiFlexGroup alignItems="center" gutterSize="s" responsive={false} wrap>
                <EuiFlexItem grow={false}>
                  ...
                  >
                    <FormattedMessage
                      id="xpack.genAiSettings.alertValidationWorkflow.ruleAttachmentShowingRulesLabel"
                ...
                <EuiFlexItem grow={false}>
                  ...
                  >
                    <FormattedMessage
                      id="xpack.genAiSettings.alertValidationWorkflow.ruleAttachmentSelectedRulesLabel"
                ...
                <EuiFlexItem grow={false}>
                  ...
                  >
                    {bulkSelectionButtonAction === 'select' ? (
                      <FormattedMessage
                        id="xpack.genAiSettings.alertValidationWorkflow.ruleAttachmentSelectAllButtonLabel"
                        defaultMessage="Select all {selectableRules, plural, one {# rule} other {# rules}}"
                        values={{ selectableRules }}
                      />
                    ) : (
                      <FormattedMessage
                        id="xpack.genAiSettings.alertValidationWorkflow.ruleAttachmentDeselectAllButtonLabel"
                ...
                <EuiFlexItem grow={false}>
                  ...
                  >
                    <FormattedMessage
                      id="xpack.genAiSettings.alertValidationWorkflow.ruleAttachmentClearSelectionButtonLabel"
            ...
            <EuiFlexItem grow={false}>
              ...
              >
                <FormattedMessage
                  id="xpack.genAiSettings.alertValidationWorkflow.ruleAttachmentAttachButtonLabel"
          ...
          <EuiBasicTable
            ...
            tableCaption={i18n.translate(
              'xpack.genAiSettings.alertValidationWorkflow.ruleAttachmentTableCaption',
              {
                defaultMessage: 'Detection rules matching the alert validation workflow filter',
              }
            )}
            selection={{
      ...
      {isConfirmModalVisible && (
        <EuiConfirmModal
          ...
          title={i18n.translate(
            'xpack.genAiSettings.alertValidationWorkflow.ruleAttachmentConfirmModalTitle',
            {
          ...
          cancelButtonText={i18n.translate(
            'xpack.genAiSettings.alertValidationWorkflow.ruleAttachmentConfirmModalCancelButtonLabel',
            {
              defaultMessage: 'Cancel',
            }
          )}
          confirmButtonText={i18n.translate(
            'xpack.genAiSettings.alertValidationWorkflow.ruleAttachmentConfirmModalConfirmButtonLabel',
            {
              defaultMessage: 'Update {changedRulesCount, plural, one {# rule} other {# rules}}',
              values: { changedRulesCount },
            }
        ...
        >
          <EuiText size="s">
            <p>
              <FormattedMessage
                id="xpack.genAiSettings.alertValidationWorkflow.ruleAttachmentConfirmModalDescription"
                defaultMessage="This will update the alert validation workflow attachment state for {changedRulesCount, plural, one {# rule} other {# rules}}."
                values={{ changedRulesCount }}
              />
            </p>
            {isUpdatingRuleAttachments && (
              ...
              >
                ...
                <EuiFlexItem grow={false}>
                  <FormattedMessage
                    id="xpack.genAiSettings.alertValidationWorkflow.ruleAttachmentConfirmModalLoadingLabel"

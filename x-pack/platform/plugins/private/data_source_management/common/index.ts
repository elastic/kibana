...
export const registerConnectorFailedMessage = () =>
  i18n.translate('dataSourceManagement.errors.registerConnectorFailed', {
    defaultMessage: 'Could not register the connector as a source.',
  });

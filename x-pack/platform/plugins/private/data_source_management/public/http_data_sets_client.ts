 ...
 */
export class HttpDataSetsClient {
  ...
  public async add(dataSet: DataSetWithName): Promise<void> {
    ...
    if (!nameTrimmed) {
      throw new Error(
        i18n.translate('dataSourceManagement.errors.dataSetNameRequired', {
   ...
   * Names are sent as the path id (same convention as {@link HttpDataSetsClient.add}).
   */

...
export function KbDocSetting({
  knowledgeBase,
  currentlyDeployedInferenceId,
}: {
  knowledgeBase: UseKnowledgeBaseResult;
  currentlyDeployedInferenceId?: string;
}) {
  ...
  return (
    <EuiDescribedFormGroup
      ...
      title={
        <h3>
          {i18n.translate('xpack.observabilityAiAssistantManagement.settingsPage.kbDocTitle', {
      ...
      description={
        <>
          <EuiText size="s" color="subdued">
            {i18n.translate(
              'xpack.observabilityAiAssistantManagement.settingsPage.kbDocDescription',
              {
                defaultMessage:
            ...
            >
              {i18n.translate(
                'xpack.observabilityAiAssistantManagement.settingsPage.kbDocLearnMore',
          ...
          <EuiFlexGroup gutterSize="s" alignItems="center" css={{ marginTop: 8 }}>
            <EuiFlexItem grow={false}>
              <EuiText size="s">
                •{' '}
                {i18n.translate('xpack.observabilityAiAssistantManagement.kb.status.label', {

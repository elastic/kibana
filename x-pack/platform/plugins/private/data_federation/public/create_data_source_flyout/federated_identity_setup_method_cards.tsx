...
const LEGEND_LABEL = i18n.translate(
  'xpack.dataFederation.createFlyout.federated.setupMethod.legend',
...
export function FederatedIdentitySetupMethodCards({
  ...
  return (
    <EuiFormFieldset legend={{ children: LEGEND_LABEL, display: 'hidden' }}>

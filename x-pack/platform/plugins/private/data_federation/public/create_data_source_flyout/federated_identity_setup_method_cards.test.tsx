...
// EuiCheckableCard puts the test subject on the radio wrapper, not the input itself.
const radio = (id: string) =>
  within(screen.getByTestId(`testPrefixSetupMethod-${id}`)).getByRole('radio');
...
describe('FederatedIdentitySetupMethodCards', () => {
  ...
  it('marks the selected method and leaves the other unchecked', () => {
    ...
    expect(radio('cloudformation')).toBeChecked();

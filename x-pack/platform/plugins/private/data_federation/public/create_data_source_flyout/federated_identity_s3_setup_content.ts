...
export const s3FederatedIdentitySetupStrings = {
  ...
  cloudFormationMethod: () =>
    i18n.translate('xpack.dataFederation.createFlyout.s3.federated.setupMethod.cloudFormation', {
      defaultMessage: 'CloudFormation',
    }),

  manualMethod: () =>
    i18n.translate('xpack.dataFederation.createFlyout.s3.federated.setupMethod.manual', {
...
/** Empty until the template is published; the quick create console rejects a blank templateURL. */
const S3_CLOUDFORMATION_TEMPLATE_URL = '';

export const isS3CloudFormationSetupAvailable = (): boolean =>
  S3_CLOUDFORMATION_TEMPLATE_URL.length > 0;

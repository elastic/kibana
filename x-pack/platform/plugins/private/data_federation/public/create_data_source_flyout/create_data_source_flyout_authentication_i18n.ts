...
export const authenticationStrings = {
  title: i18n.translate('xpack.dataFederation.createFlyout.authentication.title', {
    defaultMessage: 'Authentication',
  }),

  preferredMethodLabel: i18n.translate('xpack.dataFederation.createFlyout.authentication.label', {
  ...
  federatedIdentityLabel: i18n.translate(
  ...
  accessAndSecretKeysLabel: i18n.translate(
  ...
  azureCredentialsLabel: i18n.translate(
  ...
  anonymousLabel: i18n.translate('xpack.dataFederation.createFlyout.authentication.anonymous', {
  ...
  anonymousDescription: {
    s3: i18n.translate('xpack.dataFederation.createFlyout.authentication.anonymousDescription.s3', {
      defaultMessage:

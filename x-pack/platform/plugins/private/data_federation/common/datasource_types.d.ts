 ...
 */
export declare const SECRET_FIELDS_BY_TYPE: Record<DataSourceType, readonly string[]>;
/**
 ...
 * doesn't manage.
 */
export declare const UI_MANAGED_SECRET_FIELDS_BY_TYPE: Record<DataSourceType, readonly string[]>;
/** All supported data source type values, for select components and validation. */
export declare const ALL_DATA_SOURCE_TYPES: DataSourceType[];
/**
 * UI icon types for data source types (EUI icon names).
 * Consumers should treat this as optional per type.
 */
export declare const DATA_SOURCE_TYPES_TO_ICONS: Record<DataSourceType, string>;
export declare const DATA_SOURCE_TYPES_TO_HELP_TEXT: Partial<Record<DataSourceType, string>>;

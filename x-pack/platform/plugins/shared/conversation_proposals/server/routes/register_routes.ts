...
const registerCreateProposalRoute = ({
  ...
  router.versioned
    .post({
      ...
      security: { authz: { requiredPrivileges: [PROPOSALS_API_PRIVILEGE_WRITE] } },
      summary: 'Create a conversation proposal',
    })
    .addVersion(
      {
...
const registerListProposalsRoute = ({
  ...
  router.versioned
    .get({
      ...
      summary: 'List conversation proposals',
    })
    .addVersion(
      {
        version: PROPOSALS_API_VERSION,
...
const registerGetProposalRoute = ({
  ...
  router.versioned
    .get({
      ...
      access: INTERNAL_ACCESS,
      security: { authz: { requiredPrivileges: [PROPOSALS_API_PRIVILEGE_READ] } },
      summary: 'Get a conversation proposal',
    })
    .addVersion(
      {
        version: PROPOSALS_API_VERSION,
...
const registerApproveProposalRoute = ({
  ...
  router.versioned
    .post({
      ...
      access: INTERNAL_ACCESS,
      security: { authz: { requiredPrivileges: [PROPOSALS_API_PRIVILEGE_WRITE] } },
      summary: 'Approve a conversation proposal',
    })
    .addVersion(
      {
        version: PROPOSALS_API_VERSION,
...
const registerDismissProposalRoute = ({
  ...
  router.versioned
    .post({
      ...
      access: INTERNAL_ACCESS,
      security: { authz: { requiredPrivileges: [PROPOSALS_API_PRIVILEGE_WRITE] } },
      summary: 'Dismiss a conversation proposal',
    })
    .addVersion(
      {
        version: PROPOSALS_API_VERSION,

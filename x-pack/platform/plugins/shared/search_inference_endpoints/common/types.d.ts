...
import type { InferenceConnector, EisInferenceEndpointMetadata, CspRegion } from '@kbn/inference-common';
...
export declare const APIRoutes: {
    ...
    readonly REGION_POLICY: "/internal/search_inference_endpoints/region_policy";
};

...
import type { CspRegion, EisInferenceEndpoint, InferenceEndpointWithMetadata, InferenceEndpointWithDisplayNameMetadata, InferenceEndpointWithDisplayCreatorMetadata } from './types';
/**
...
export declare const isCspRegion: (value: unknown) => value is CspRegion;

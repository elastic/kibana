...
const DISPLAY_OPTION_ROWS: DisplayOptionRowConfig[] = [
  ...
  {
    field: 'showEndOfLifeModels',
    label: i18n.translate(
      'xpack.searchInferenceEndpoints.eisModelsPage.displayOptions.endOfLifeModelsLabel',
      { defaultMessage: 'End-of-life models' }
    ),
    helpText: i18n.translate(
    ...
    showId: 'eisDisplayOptionsEndOfLifeModelsShow',
    testSubj: 'eisDisplayOptionsEndOfLifeModels',
  },
  {
...
export const DisplayOptions = ({
  ...
  const isEndOfLifeDirty = draft.showEndOfLifeModels !== value.showEndOfLifeModels;
  const isPreviewDirty = draft.showPreviewModels !== value.showPreviewModels;
  const isStatusDirty = isEndOfLifeDirty || isPreviewDirty;

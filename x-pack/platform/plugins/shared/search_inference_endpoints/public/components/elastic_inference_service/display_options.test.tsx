...
describe('DisplayOptions', () => {
  it('selects Hide for every option by default and disables Apply', () => {
    ...
    expect(getByTestId('eisDisplayOptionsDeprecatedModelsHide')).toHaveAttribute(
      'aria-pressed',
      'true'
    );
    ...
    expect(getByTestId('eisDisplayOptionsDeprecatedModels')).toHaveTextContent(
  ...
  it('discards draft changes when the popover is closed without Apply', () => {
    ...
    fireEvent.click(getByTestId('eisDisplayOptionsButton'));
    fireEvent.click(getByTestId('eisDisplayOptionsDeprecatedModelsShow'));
    fireEvent.click(getByTestId('eisDisplayOptionsButton'));
    fireEvent.click(getByTestId('eisDisplayOptionsButton'));

      ...
      rightSideItems={[
        ...
        <EuiLink
          aria-label={i18n.translate(
            'xpack.searchInferenceEndpoints.header.apiDocumentationAriaLabel',
        ...
        <EuiLink
          aria-label={i18n.translate(
            'xpack.searchInferenceEndpoints.header.mlTrainedModelsAriaLabel',
        ...
        <EuiLink
          aria-label={i18n.translate(
            'xpack.searchInferenceEndpoints.header.elasticInferenceServiceAriaLabel',

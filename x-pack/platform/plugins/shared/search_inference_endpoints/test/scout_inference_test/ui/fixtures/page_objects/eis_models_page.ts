...
export class EisModelsPage {
  ...
  readonly deprecatedModelsShowButton: Locator;
  ...
  constructor(private readonly page: ScoutPage) {
    ...
    this.deprecatedModelsShowButton = this.page.testSubj.locator(
      'eisDisplayOptionsDeprecatedModelsShow'
    );
  ...
  public async showDeprecatedModels() {
    await this.displayOptionsButton.click();
    await this.deprecatedModelsShowButton.click();

...
import { InferenceManagementPage } from './page_objects';

export interface ExtScoutTestFixtures extends ScoutTestFixtures {
  pageObjects: PageObjects & {
    inferenceManagement: InferenceManagementPage;
  };
}
...
export const test = baseTest.extend<ExtScoutTestFixtures, ScoutWorkerFixtures>({
  pageObjects: async (
    ...
    const extendedPageObjects = {
      ...pageObjects,
      inferenceManagement: createLazyPageObject(InferenceManagementPage, page),
    };

...
> = {
  ...
  label: i18n.translate('inferenceWorkflows.AiPromptStep.label', {
    defaultMessage: 'AI Prompt',
  }),
  description: i18n.translate('inferenceWorkflows.AiPromptStep.description', {
    defaultMessage: 'Sends a prompt to an AI connector and returns the response',
  }),
  documentation: {
    details: i18n.translate('inferenceWorkflows.AiPromptStep.documentation.details', {

...
import { EmbeddedConversationRounds } from './rounds_layout';
import { EmbeddedConversationInput } from './input_layout';
import { EmbeddedNewConversationPrompt } from './new_conversation_prompt';
...
export const EmbeddableConversation: React.FC<{}> = () => {
        ...
        return (
          <>
            ...
            <EuiResizablePanel initialSize={20} minSize="20%">
              <EmbeddedConversationInput className={contentStyles}>

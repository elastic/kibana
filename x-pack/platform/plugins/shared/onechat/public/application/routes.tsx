...
import { MonitoringListPage } from './pages/monitoring_list';
import { MonitoringDetailPage } from './pages/monitoring_detail';
...
export const OnechatRoutes: React.FC<{}> = () => {
  return (
    <Routes>
      ...
      <Route path="/monitoring/conversation/:conversationId">

...
const labels = {
  ariaLabel: i18n.translate('xpack.onechat.embeddable.conversationHeader.ariaLabel', {
    defaultMessage: 'Conversation title',
  }),
  newConversationDisplay: i18n.translate(
    'xpack.onechat.embeddable.conversationHeader.newConversationDisplay',
    {
  ...
  return (
    <div css={containerStyles}>
      ...
      <EuiButtonIcon
        iconType="cross"
        onClick={onClose}
        aria-label={i18n.translate('xpack.onechat.embeddable.conversationHeader.closeLabel', {

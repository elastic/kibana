          ...
          body: {
            evaluators: [
              ...
              },
              {
                ...
                description: 'Checks if the response is grounded in the provided tool history.',
                type: 'text',
              },
              {
                id: EvaluatorId.Recall,
                name: 'Recall Evaluator',
                description: 'Measures whether the agent retrieved all the relevant documents.',
                type: 'number',
              },
              {
                id: EvaluatorId.Precision,
                name: 'Precision Evaluator',
                description: 'Assesses the proportion of relevant documents retrieved.',
                type: 'number',
              },
              {
                id: EvaluatorId.Regex,
                name: 'Regex Evaluator',
                description: 'Uses regex patterns to validate the response format.',
                type: 'text',
              },
              {

...
import { START as _START_ } from '@langchain/langgraph';
 ...
 */
export const advanceState = async (compiledGraph: ReturnType<typeof createAgentGraph>, options: AdvanceStateOptions) => {
    ...
    return async () => {
        ...
        const revertState = {
            ...
            initialMessages: [new RemoveMessage({ id: REMOVE_ALL_MESSAGES }), ...oldValues.initialMessages],
        } satisfies Partial<StateType>;

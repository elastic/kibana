...
export const FindPacksResponse = z.object({
  ...
  data: z.array(
    z.object({
      ...
      /**
       * Pack queries in saved-object storage format (array). Note: the read endpoint returns object format. Phase 1.9 will normalize all endpoints to object format.
       */
      queries: z
        .array(
          z.object({

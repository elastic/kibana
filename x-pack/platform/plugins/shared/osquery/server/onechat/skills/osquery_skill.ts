...
const OSQUERY_SKILL: Omit<Skill, 'tools'> = {
  ...
  description:
    'Single entrypoint for Osquery: status, schema, packs, saved queries, live queries, and results',
  content: `# Osquery
            ...
            params: z
              .object({
                ...
                confirmReason: z
                  ...
                  .optional()
                  .describe(
                    'Optional reason why this live query is necessary (for audit/traceability).'
                  ),
              })
              .passthrough()
              .optional(),

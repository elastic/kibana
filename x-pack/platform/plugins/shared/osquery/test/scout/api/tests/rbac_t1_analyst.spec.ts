...
apiTest.describe(
  ...
  () => {
    ...
    apiTest.beforeAll(async ({ requestAuth, samlAuth, apiClient }) => {
      ...
      // Create a saved query as admin for the t1_analyst to run
    ...
    apiTest('returns 200 when running a saved query via live query', async ({ apiClient }) => {

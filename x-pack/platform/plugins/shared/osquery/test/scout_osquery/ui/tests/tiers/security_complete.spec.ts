...
test.describe.skip('App Features for Security Complete PLI', { tag: ['@svlSecurity'] }, () => {
  let ruleId: string;
  ...
  test('response actions should not be available', async ({ page }) => {
    ...
    // TODO: Check that osquery response actions are not available in Security Complete tier

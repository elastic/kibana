...
export class AutomaticImportV2ResponseFactory {
...
export const buildAutomaticImportV2Response = (response: KibanaResponseFactory) =>
  new AutomaticImportV2ResponseFactory(response);

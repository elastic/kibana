...
export const ADD_CONNECTOR_BUTTON_LABEL = i18n.translate(
  'xpack.automaticImportV2.components.connectorSelector.addConnectorButtonLabel',
  {
...
export const CREATE_AI_CONNECTOR_TITLE = i18n.translate(
  'xpack.automaticImportV2.components.connectorSetup.createAiConnectorTitle',
  {
...
export const SELECT_CONNECTOR_TYPE_DESCRIPTION = i18n.translate(
  'xpack.automaticImportV2.components.connectorSetup.selectConnectorTypeDescription',
  {
...
export const NO_CONNECTOR_TYPES_AVAILABLE = i18n.translate(
  'xpack.automaticImportV2.components.connectorSetup.noConnectorTypesAvailable',
  {

...
import type { AutoImportV2ApiService } from '../services/automatic_import_v2_api_service';
import { getAutoImportV2ApiService } from '../services/automatic_import_v2_api_service';
...
export interface AutoImportApiServicesFixture extends ApiServicesFixture {
  autoImport: AutoImportV2ApiService;
}
...
export const autoImportApiTest = apiTest.extend<{
  ...
  apiServices: async ({ apiServices, kbnClient }, use) => {
    ...
    extendedApiServices.autoImport = getAutoImportV2ApiService(kbnClient);

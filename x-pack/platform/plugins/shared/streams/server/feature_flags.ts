          ...
          core.uiSettings.register({
            [OBSERVABILITY_STREAMS_ENABLE_SIGNIFICANT_EVENTS_ALERTING_V2]: {
              ...
              description: i18n.translate(
                ...
                {
                  defaultMessage:
                    'Switches significant event queries from Alerting v1 to Alerting v2. Enabling this setting will migrate all promoted queries to Alerting v2 rules on the next Kibana restart. Note: This migration is one-way and cannot be reversed.',
                }
              ),
              type: 'boolean',
              schema: schema.boolean(),

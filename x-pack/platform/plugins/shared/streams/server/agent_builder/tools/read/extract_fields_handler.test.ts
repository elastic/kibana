...
// `isExtractionStepOnField`, `stepWritesOrRemovesField`, `getStepWriteTargets`,
// `buildPlacementWarning`, `buildDuplicationWarning`, and `buildOverwriteWarning`
// have moved to `extract_fields_warnings.ts` (#N8) and their unit tests live in
// `extract_fields_warnings.test.ts`. The integration coverage that asserts
// `runExtractFieldsFlow` actually wires these helpers through still lives in
// the `runExtractFieldsFlow` describe block below.

...
import { internalSignificantEventsRoutes } from './internal/significant_events/ki_query_occurrences/route';
...
import { internalKiExtractionRoutes } from './internal/significant_events/ki_extraction/route';

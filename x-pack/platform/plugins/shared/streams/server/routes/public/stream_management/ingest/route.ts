...
import { WiredIngestUpsertRequest } from '@kbn/streams-schema/src/stream_management/models/ingest/wired';
import type { ClassicIngestUpsertRequest } from '@kbn/streams-schema/src/stream_management/models/ingest/classic';
import { IngestUpsertRequest } from '@kbn/streams-schema/src/stream_management/models/ingest';

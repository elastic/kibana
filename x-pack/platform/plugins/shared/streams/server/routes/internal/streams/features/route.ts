...
export const upsertFeatureRoute = createServerRoute({
  ...
  handler: async ({
    ...
    const { licensing, uiSettingsClient, streamsClient } = await getScopedClients({
      request,
    });
    ...
    return await streamsClient.upsertFeature(params.path.name, {
      ...params.body,
...
export const deleteFeatureRoute = createServerRoute({
  ...
  handler: async ({
    ...
    return await streamsClient.deleteFeature(params.path.name, params.path.uuid);
  },
});
...
export const bulkFeaturesRoute = createServerRoute({
  ...
  handler: async ({
    ...
    return await streamsClient.bulkFeatures(name, operations);
  },
});

...
import type { StreamsMappingProperties } from '@kbn/streams-schema/src/stream_management/fields';
import type { DocumentWithIgnoredFields } from '@kbn/streams-schema/src/stream_management/shared/record_types';
import type { AggregationsAggregate, SearchResponse } from '@elastic/elasticsearch/lib/api/types';
import { getRoot } from '@kbn/streams-schema/src/stream_management/shared/hierarchy';
import { LOGS_ROOT_STREAM_NAME } from '../../../../lib/stream_management/root_stream_definition';
import { MAX_PRIORITY } from '../../../../lib/stream_management/index_templates/generate_index_template';
...
import { checkAccess } from '../../../../lib/stream_management/stream_crud';

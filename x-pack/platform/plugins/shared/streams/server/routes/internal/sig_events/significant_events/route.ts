...
} from '../../../../lib/sig_events/tasks/task_definitions/significant_events_queries_generation';
import { taskActionSchema } from '../../../../lib/sig_events/tasks/task_action_schema';
import { createServerRoute } from '../../../create_server_route';
import { assertSignificantEventsAccess } from '../../../../lib/sig_events/assert_significant_events_access';
import { readSignificantEventsFromAlertsIndices } from '../../../../lib/sig_events/significant_events/read_significant_events_from_alerts_indices';
import { handleTaskAction } from '../../../../lib/sig_events/tasks/task_helpers';
import { resolveConnectorId } from '../../../../lib/utils/resolve_connector_id';

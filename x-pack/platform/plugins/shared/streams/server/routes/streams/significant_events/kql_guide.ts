...
KQL (Kibana Query Language) is a query language available in Kibana, that will be
converted into Elasticsearch Query DSL.
...
find anything beginning with “dark” like “darker”, “darkest”, “darkness”, etc:
\`dark*\`.

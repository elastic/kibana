...
import { readSignificantEventsFromAlertsIndices, V2_ALERTS_SOURCE } from './read_significant_events_from_alerts_indices';
...
describe('readSignificantEventsFromAlertsIndices', () => {
  ...
  describe('v2 rule-events read path', () => {
    ...
    it('queries .rule-events with COUNT_DISTINCT(group_hash)', async () => {
      ...
      await readSignificantEventsFromAlertsIndices(defaultV2Params, {
        kiClient,
        scopedClusterClient,
      });

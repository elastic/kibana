...
export type VerdictsDataStreamClient = IDataStreamClient<typeof verdictsMappings, StoredVerdict>;

export type VerdictsPaginatedSearchOptions = CommonSearchOptions & PaginationSearchOptions;
...
export class VerdictsClient {
  ...
  async findLatestPaginated(
    options: VerdictsPaginatedSearchOptions = {}

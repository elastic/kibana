...
/**
 * Returns whether identification should run, based on whether the most
 * recent active inferred-feature revision is older than `thresholdHours`.
 * Tombstones and excluded revisions are filtered out by

...
/**
 * An open question generated by the memory update agent.
 */
...
export interface MemoryService {
  ...
  getOpenQuestions(params: { space: string; size?: number }): Promise<MemoryQuestion[]>;
  answerQuestion(params: { id: string; answer: string; space: string }): Promise<MemoryQuestion>;
  dismissQuestion(params: { id: string; space: string }): Promise<void>;
}

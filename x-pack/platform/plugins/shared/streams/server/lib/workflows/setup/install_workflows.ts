...
const WORKFLOWS_TO_INSTALL: Array<{
  ...
  { workflowId: SIGEVENTS_DISCOVERY_V2_WORKFLOW_ID, spaceId: GLOBAL_WORKFLOW_SPACE_ID },
  { workflowId: SIGEVENTS_RULE_ON_RULE_PROVISION_WORKFLOW_ID, spaceId: GLOBAL_WORKFLOW_SPACE_ID },
  {
    workflowId: SIGEVENTS_RULE_ON_RULE_DEPROVISION_WORKFLOW_ID,

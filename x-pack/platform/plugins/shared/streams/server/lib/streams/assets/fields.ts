...
/** ISO timestamp of the latest revision. Additive bridge field; populated by the KI data stream path. */
export const QUERY_UPDATED_AT = 'updated_at';
/** ISO timestamp after which this query is considered stale. Additive bridge field. */

import type { ClusterPutComponentTemplateRequest, IndicesPutIndexTemplateRequest, IngestProcessorContainer, IngestPutPipelineRequest } from '@elastic/elasticsearch/lib/api/types';
...
export type ElasticsearchAction = UpsertComponentTemplateAction | DeleteComponentTemplateAction | UpsertIndexTemplateAction | DeleteIndexTemplateAction | UpsertIngestPipelineAction | DeleteIngestPipelineAction | AppendProcessorToIngestPipelineAction | DeleteProcessorFromIngestPipelineAction | UpsertDatastreamAction | RolloverAction | UpdateLifecycleAction | DeleteDatastreamAction | UpdateDefaultIngestPipelineAction | UpsertDotStreamsDocumentAction | DeleteDotStreamsDocumentAction | UpdateDataStreamMappingsAction | DeleteQueriesAction | UnlinkAssetsAction | UnlinkSystemsAction | UnlinkFeaturesAction | UpdateFailureStoreAction | UpdateIngestSettingsAction | UpsertEsqlViewAction | DeleteEsqlViewAction;

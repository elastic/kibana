...
import type { ATTACHMENT_TYPE, ATTACHMENT_ID, ATTACHMENT_UUID, STREAM_NAMES } from './storage_settings';
export declare const ATTACHMENT_TYPES: readonly ["dashboard", "rule", "slo"];

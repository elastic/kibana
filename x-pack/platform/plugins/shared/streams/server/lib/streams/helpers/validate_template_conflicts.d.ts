 ...
 * ```
 */
export declare function indexPatternToRegex(pattern: string): RegExp;
/**
 ...
 * ```
 */
export declare function matchesPattern(indexName: string, pattern: string): boolean;
 ...
 * ```
 */
export declare function findConflictingTemplates(streamName: string, selectedTemplateName: string, selectedTemplatePriority: number, allTemplates: IndexTemplate[]): ConflictingTemplate[];
export {};

...
/** All Sig Events tool IDs that this skill exposes. */
...
export const createSigEventsSkill = () =>
  defineSkillType({
    ...
    content: DEFAULT_SIG_EVENTS_SKILL_CONTENT,
    getRegistryTools: () => [...SIG_EVENTS_SKILL_REGISTRY_TOOL_IDS],
  });

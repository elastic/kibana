...
import { isMappingProperties } from '@kbn/streams-schema/src/stream_management/fields';
import {
  isDisabledLifecycleFailureStore,
  isInheritFailureStore,
} from '@kbn/streams-schema/src/stream_management/models/ingest/failure_store';

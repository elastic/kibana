...
export const STEP_1_TITLE = i18n.translate('xpack.cloudConnected.wizard.step1.title', {
  defaultMessage: 'Sign up/login to Elastic Cloud and get the API key',
});

export const STEP_1_DESCRIPTION = i18n.translate('xpack.cloudConnected.wizard.step1.description', {
  defaultMessage:
...
export const STEP_2_TITLE = i18n.translate('xpack.cloudConnected.wizard.step2.title', {
  defaultMessage: 'Configure an encryption key in Kibana',
});

export const STEP_2_DESCRIPTION = i18n.translate('xpack.cloudConnected.wizard.step2.description', {
  defaultMessage:
    'You should configure an encryption key in Kibana before pasting the Cloud API key and establishing connection.',
});

export const STEP_3_TITLE = i18n.translate('xpack.cloudConnected.wizard.step3.title', {
  defaultMessage: 'Paste your Cloud API key in Kibana and establish the connection',
});

export const STEP_3_DESCRIPTION = i18n.translate('xpack.cloudConnected.wizard.step3.description', {
  defaultMessage:
...
export const SIGN_UP_BUTTON = i18n.translate('xpack.cloudConnected.wizard.signUpButton', {
  defaultMessage: 'Sign up',
});

export const LOGIN_BUTTON = i18n.translate('xpack.cloudConnected.wizard.loginButton', {
  defaultMessage: 'Login',
});

export const CONNECT_BUTTON = i18n.translate('xpack.cloudConnected.wizard.connectButton', {
  defaultMessage: 'Connect',
});

export const API_KEY_PLACEHOLDER = i18n.translate('xpack.cloudConnected.wizard.apiKeyPlaceholder', {
  defaultMessage: 'Paste your cloud connected API key',
});

export const OPTIONAL_STEP = i18n.translate('xpack.cloudConnected.wizard.optionalStep', {
  defaultMessage: 'Optional step',
});

export const getStep2Description = (docLinksSecureSavedObject: string) => (
  <FormattedMessage
    id="xpack.cloudConnected.wizard.step2.description"
    ...
    values={{
      encryptionKeyLink: (
        <EuiLink href={docLinksSecureSavedObject} target="_blank">
          <FormattedMessage
            id="xpack.cloudConnected.wizard.step2.encryptionKeyLink"

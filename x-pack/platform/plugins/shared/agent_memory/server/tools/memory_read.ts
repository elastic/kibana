...
import { MAX_MEMORY_ID_LENGTH, MAX_MEMORY_TITLE_LENGTH } from '@kbn/agent-memory-common';
...
const memoryReadSchema = z.object({
  ...
  id: z.string().max(MAX_MEMORY_ID_LENGTH).optional().describe('Read page by its UUID.'),
  heading: z
    .string()

...
import { MAX_MEMORY_ID_LENGTH } from '@kbn/agent-memory-common';
...
const memoryDeleteSchema = z.object({
  id: z.string().max(MAX_MEMORY_ID_LENGTH).optional().describe('Delete page by UUID.'),
  name: z.string().max(MAX_MEMORY_ID_LENGTH).optional().describe('Delete page by unique name.'),
});

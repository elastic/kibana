...
const memoryPatchSchema = z.object({
  id: z.string().max(MAX_MEMORY_ID_LENGTH).optional().describe('Target page by UUID.'),
  name: z.string().max(MAX_MEMORY_ID_LENGTH).optional().describe('Target page by unique name.'),
  operations: z

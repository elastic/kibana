...
const memoryWriteSchema = z.object({
  ...
  title: z.string().max(MAX_MEMORY_TITLE_LENGTH).describe('Human-readable title for the page.'),
  content: z.string().max(MAX_MEMORY_TEXT_LENGTH).describe('Full markdown content for the page.'),
  categories: z

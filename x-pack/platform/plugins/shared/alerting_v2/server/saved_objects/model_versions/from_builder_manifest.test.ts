...
import {
  ...
  ruleSavedObjectAttributesSchemaV7 as latestV7,
...
describe('fromBuilderManifest', () => {
  ...
  describe('open-record assertion: metadata.builder_fields stays an open record', () => {
    it('currentRuleSavedObjectAttributesSchema is the latest versioned schema (v7)', () => {
      ...
      //
      // Ref: rule-data-migration.md "Rollback behavior"
      expect(currentRuleSavedObjectAttributesSchema).toBe(latestV7);
    });

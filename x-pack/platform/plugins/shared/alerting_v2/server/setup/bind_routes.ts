...
import { BulkCreateSeriesActionRoute } from '../routes/alert_actions/series/bulk_create_series_action_route';
...
import { BulkCreateEpisodeActionRoute } from '../routes/alert_actions/episodes/bulk_create_episode_action_route';
...
export function bindRoutes({ bind }: ContainerModuleLoadOptions) {
  ...
  bind(Route).toConstantValue(BulkCreateSeriesActionRoute);
  ...
  bind(Route).toConstantValue(BulkCreateEpisodeActionRoute);

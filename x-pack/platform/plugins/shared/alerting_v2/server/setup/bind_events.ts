 ...
 *
 * Future subscribers (event log, telemetry, workflow triggers, …) and
 * additional publishers (rule executor, dispatcher) should be registered
 * here so that the events subsystem's wiring lives in a single place,
 * parallel to its code in `lib/events/`.
 */

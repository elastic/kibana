...
@injectable()
export class DeleteRuleBuilderConfigRoute extends BaseAlertingRoute {
  ...
  static routeOptions = {
    access: 'internal',
    summary: 'Delete rule builder config for a rule',
  } as const;
  static validate = {
    request: {
  ...
  protected readonly routeName = 'delete_rule_builder_config';
  ...
  protected async execute() {
    await this.rulesClient.deleteRuleBuilderConfig({

...
export const deleteRulesByQueryOasExamples = (): AlertingOasOperationObject =>
  buildOasOperation({
    requestBody: {
      name: 'deleteRulesByQueryRequest',
      summary:
        'Delete rules tagged production (dry-run by default, or set `force: true` to execute)',
      value: BULK_BY_QUERY_REQUEST,
    },
    responses: {
      200: {
        name: 'deleteRulesByQueryDryRunResponse',

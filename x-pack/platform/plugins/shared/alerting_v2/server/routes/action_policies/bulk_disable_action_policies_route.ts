...
export class BulkDisableActionPoliciesRoute extends BaseAlertingRoute {
  ...
  static path = `${ALERTING_V2_ACTION_POLICY_API_PATH}/_bulk_disable`;
  ...
  protected readonly routeName = 'bulk disable action policies';
  ...
  protected async execute() {
    const result = await this.actionPolicyClient.bulkDisableActionPolicies({

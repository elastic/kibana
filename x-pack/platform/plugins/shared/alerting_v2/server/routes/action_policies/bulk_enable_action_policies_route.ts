...
export class BulkEnableActionPoliciesRoute extends BaseAlertingRoute {
  ...
  static path = `${ALERTING_V2_ACTION_POLICY_API_PATH}/_bulk_enable`;
  ...
  protected readonly routeName = 'bulk enable action policies';
  ...
  protected async execute() {
    const result = await this.actionPolicyClient.bulkEnableActionPolicies({

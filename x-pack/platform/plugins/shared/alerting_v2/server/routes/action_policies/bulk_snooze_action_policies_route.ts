...
export class BulkSnoozeActionPoliciesRoute extends BaseAlertingRoute {
  ...
  static path = `${ALERTING_V2_ACTION_POLICY_API_PATH}/_bulk_snooze`;
  ...
  static schemas = {
    request: {
      body: bulkSnoozeActionPoliciesBodySchema,
    },
    response: {
      200: {
  ...
  protected readonly routeName = 'bulk snooze action policies';

  constructor(
    @inject(AlertingRouteContext) ctx: AlertingRouteContext,
    @inject(Request)
    private readonly request: KibanaRequest<unknown, unknown, BulkSnoozeActionPoliciesBody>,

...
describe('RulesClient', () => {
  const request: KibanaRequest = httpServerMock.createKibanaRequest({ spaceId: 'space-1' });
  ...
  function createClient() {
    return new RulesClient(request, rulesSavedObjectService, taskManager, userService);
  }

 ...
 *
 * Walks {@link ALERT_ACTION_WORKFLOW_TRIGGERS}, {@link RULE_EXECUTOR_WORKFLOW_TRIGGERS}
 * and {@link RULE_WORKFLOW_TRIGGERS}, the same catalogs their respective workflow
 * subscribers walk at dispatch time, so the registered schema, the trigger id,
 * and the runtime payload mapping cannot drift across the codebase.
 *

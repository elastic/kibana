...
export class ComposeDiscoverPage {
  ...
  public readonly recoveryTypeSelect: EuiSuperSelectWrapper;
  ...
  constructor(private readonly page: ScoutPage) {
    ...
    this.recoveryTypeSelect = new EuiSuperSelectWrapper(page, 'composeDiscoverRecoveryType');
  }
  ...
  async selectRecoveryType(strategy: RecoveryStrategyValue) {
    await this.recoveryTypeSelect.selectOption(strategy);
  }

  /** Reads the recovery-strategy dropdown's committed value. */
  async getSelectedRecoveryType(): Promise<string> {
    return this.recoveryTypeSelect.valueInputLocator.inputValue();
  }
}

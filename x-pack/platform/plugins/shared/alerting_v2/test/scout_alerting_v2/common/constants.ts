...
export {
  ...
  ALERTING_V2_SERIES_API_PATH as SERIES_API_PATH,

  ALERTING_V2_ACTION_POLICY_API_PATH as ACTION_POLICY_API_PATH,
  ALERTING_V2_INTERNAL_ACTION_POLICY_API_PATH as INTERNAL_ACTION_POLICY_API_PATH,
...
// ALERTING_V2_EPISODES_API_PATH was removed; alert actions now live under ALERTING_V2_ALERT_API_PATH.
// EPISODES_API_PATH kept for test-internal compatibility while urls.ts is updated in the UI pass (U2).
import { ALERTING_V2_ALERT_API_PATH } from '@kbn/alerting-v2-constants';
export const EPISODES_API_PATH = ALERTING_V2_ALERT_API_PATH;

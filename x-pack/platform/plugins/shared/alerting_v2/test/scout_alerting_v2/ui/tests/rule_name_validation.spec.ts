 ...
 */
/*
 * TODO(#268958): These tests cover name validation on the dedicated rule-form page.
 * The equivalent validation in the ComposeDiscoverFlyout (step-1 "Next does not advance
 * when name is empty") is tracked in https://github.com/elastic/kibana/issues/268958.
 * The page-object helpers and test cases here can be ported / reused when that work lands.
 */
test.describe.skip(
  'Rule name validation — dedicated page',

...
export const useFetchRuleEventFields = (matcher?: string) => {
  ...
  return useQuery<string[], Error>({
    queryKey: matcherSuggestionKeys.ruleEventFields(debouncedMatcher),
    queryFn: () => actionPoliciesApi.fetchRuleEventFields(debouncedMatcher),

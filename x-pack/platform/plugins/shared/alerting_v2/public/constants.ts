...
export const MANAGEMENT_RULES_BASE_PATH = `/app/management/${ALERTING_V2_RULES_APP_ID}`;
/** In-app path for the classic v1 Rules tab on `/app/management/rules`. */
export const MANAGEMENT_RULES_V1_TAB_PATH = '/v1';
...
export const MANAGEMENT_RULES_MANAGEMENT_PATH = ALERTING_V2_RULES_APP_ID;

...
export declare function writeEpisodesListAppStateToUrlStorage(storage: IKbnUrlStateStorage, filter: EpisodesFilterState, timeRange: TimeRange, histogramBreakdownField?: string): Promise<void>;

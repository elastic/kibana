...
export declare const ActionPolicyActionsCell: ({ policy, onViewDetails, onEdit, onClone, onDelete, onEnable, onDisable, onSnooze, onCancelSnooze, onUpdateApiKey, isStateLoading, isDisabled, }: ActionPolicyActionsCellProps) => React.JSX.Element;
export {};

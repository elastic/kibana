...
export const ActionPoliciesBulkActions = ({
  selectedPolicies,
  onClearSelection,
  onBulkAction,
  isLoading,
  ...
  const panels = [
    {
      ...
      items: [
        {
          name: i18n.translate('xpack.alertingV2.actionPolicy.bulkAction.enable', {
        ...
        {
          name: i18n.translate('xpack.alertingV2.actionPolicy.bulkAction.snooze', {
        ...
        {
          name: i18n.translate('xpack.alertingV2.actionPolicy.bulkAction.unsnooze', {
        ...
        {
          name: i18n.translate('xpack.alertingV2.actionPolicy.bulkAction.updateApiKey', {
        ...
        {
          name: i18n.translate('xpack.alertingV2.actionPolicy.bulkAction.delete', {
    ...
    <>
      <EuiFlexGroup alignItems="center" gutterSize="s" responsive={false}>
        <EuiFlexItem grow={false}>
          <EuiPopover
            aria-label={i18n.translate('xpack.alertingV2.actionPolicy.bulkAction.selectedCount', {
            ...
            button={
              ...
              >
                <FormattedMessage
                  id="xpack.alertingV2.actionPolicy.bulkAction.selectedCount"
                  defaultMessage="{count} Selected"
                  values={{ count }}
                />
              </EuiButtonEmpty>
        ...
        <EuiFlexItem grow={false}>
          <EuiButtonEmpty size="xs" onClick={onClearSelection} disabled={isLoading}>
            <FormattedMessage
              id="xpack.alertingV2.actionPolicy.bulkAction.clearSelection"

...
export const BulkDeleteConfirmationModal = ({
  ...
  return (
    <EuiConfirmModal
      ...
      title={i18n.translate('xpack.alertingV2.notificationPolicy.bulkDeleteModal.title', {
        defaultMessage:
          'Delete {count} {count, plural, one {notification policy} other {notification policies}}?',
        values: { count },
      })}
      onCancel={onCancel}
      onConfirm={onConfirm}
      cancelButtonText={i18n.translate(
        'xpack.alertingV2.notificationPolicy.bulkDeleteModal.cancelButton',
        { defaultMessage: 'Cancel' }
      )}
      confirmButtonText={i18n.translate(
        'xpack.alertingV2.notificationPolicy.bulkDeleteModal.confirmButton',

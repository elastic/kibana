...
import { MatchedPolicyReason, WorkflowConnectorIcons } from '@kbn/alerting-v2-rule-form';
...
export const ActionPoliciesSubsectionHeader = ({
  openHref,
  showTitle,
}: {
  openHref: string;
...
export const ActionPoliciesArtifactsBody = ({
  items,
  evaluatedCount,
  isMatchTruncated,
  isLoading,

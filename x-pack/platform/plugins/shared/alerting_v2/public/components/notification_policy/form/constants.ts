...
export const EPISODE_STATUS_FILTER_OPTIONS: EpisodeStatusFilterOption[] = [
  {
    ...
    title: i18n.translate(
      'xpack.alertingV2.notificationPolicy.form.quickFilters.status.active.title',
      { defaultMessage: 'Active' }
    ),
    badgeColor: 'danger',
    description: i18n.translate(
      'xpack.alertingV2.notificationPolicy.form.quickFilters.status.active.description',
  ...
  },
  {
    value: 'recovering',
    title: i18n.translate(
      'xpack.alertingV2.notificationPolicy.form.quickFilters.status.recovering.title',
      { defaultMessage: 'Recovering' }
    ),
    badgeColor: 'success',
    description: i18n.translate(
      'xpack.alertingV2.notificationPolicy.form.quickFilters.status.recovering.description',
  ...
  },
  {
    value: 'pending',
    title: i18n.translate(
      'xpack.alertingV2.notificationPolicy.form.quickFilters.status.pending.title',
      { defaultMessage: 'Pending' }
    ),
    badgeColor: 'warning',
    description: i18n.translate(
      'xpack.alertingV2.notificationPolicy.form.quickFilters.status.pending.description',
  ...
  },
  {
    value: 'inactive',
    title: i18n.translate(
      'xpack.alertingV2.notificationPolicy.form.quickFilters.status.inactive.title',
      { defaultMessage: 'Inactive' }
    ),
    badgeColor: 'default',
    description: i18n.translate(
      'xpack.alertingV2.notificationPolicy.form.quickFilters.status.inactive.description',

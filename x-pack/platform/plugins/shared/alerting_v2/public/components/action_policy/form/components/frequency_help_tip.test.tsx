...
describe('FrequencyHelpTip', () => {
  it('lists every per_episode frequency option with its explanation when opened', () => {
    renderTip('per_episode');

    fireEvent.click(screen.getByTestId('frequencyHelpTip'));
  ...
  it('lists the aggregate frequency options for group/digest modes when opened', () => {
    renderTip('all');

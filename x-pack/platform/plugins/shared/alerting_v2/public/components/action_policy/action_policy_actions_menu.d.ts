...
export declare const ActionPolicyActionsMenu: ({ policy, onViewDetails, onEdit, onClone, onDelete, onEnable, onDisable, isStateLoading, onSnooze, onCancelSnooze, onUpdateApiKey, isDisabled, "data-test-subj": dataTestSubj, }: Props) => React.JSX.Element;
export {};

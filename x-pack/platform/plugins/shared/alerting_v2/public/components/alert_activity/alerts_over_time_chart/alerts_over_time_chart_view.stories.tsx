...
const longWindowData: AlertSummaryResponse = {
...
const meta: Meta<typeof AlertsOverTimeChartView> = {
  title: 'Alerting V2/Alert Activity/Over Time Chart',
  component: AlertsOverTimeChartView,
  parameters: {
    layout: 'padded',
  },
};
...
type Story = StoryObj<typeof AlertsOverTimeChartView>;
...
export const SingleRuleWithData: Story = {
  args: {
    data: singleRuleData,
    discoverHref: '/app/discover#/?_g=example',
  },
};
...
export const WithoutDiscoverLink: Story = {
  args: {
    data: singleRuleData,
  },
};

...
describe('DashboardCanvasContent', () => {
  ...
  const renderDashboardCanvasContent = (
    ...
    const openChat: jest.MockedFunction<DashboardCanvasContentProps['openChat']> = jest.fn();
  ...
  describe('Edit in Dashboards button', () => {
    it('should call closeCanvas and openChat when isSidebar is false', async () => {
      const { registerActionButtons, closeCanvas, openChat, mockApi } =
      ...
      expect(openChat).toHaveBeenCalledWith({ conversationId: 'test-conversation-id' });
    });

    it('should call closeCanvas but not openChat when isSidebar is true', async () => {
      const { registerActionButtons, closeCanvas, openChat, mockApi } =
        renderDashboardCanvasContent({
          isSidebar: true,
        });

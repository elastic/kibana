...
import { AIClientToolsBaseSetupDependencies, AIClientToolsBaseStartDependencies } from './types';
...
describe('AIClientToolsBasePlugin', () => {
  let initContext: ReturnType<typeof coreMock.createPluginInitializerContext>;
  let plugin: AIClientToolsBasePlugin;
  let pluginSetupDeps: AIClientToolsBaseSetupDependencies;
  let pluginStartDeps: AIClientToolsBaseStartDependencies;

  beforeEach(() => {
    initContext = coreMock.createPluginInitializerContext();
    plugin = new AIClientToolsBasePlugin(initContext);
    pluginSetupDeps = {

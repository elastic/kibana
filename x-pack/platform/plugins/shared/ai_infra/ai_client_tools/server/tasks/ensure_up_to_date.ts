...
export const ENSURE_DOC_UP_TO_DATE_TASK_TYPE = 'AIClientToolsBase:EnsureUpToDate';
export const ENSURE_DOC_UP_TO_DATE_TASK_ID = 'AIClientToolsBase:EnsureUpToDate';
export const ENSURE_DOC_UP_TO_DATE_TASK_ID_MULTILINGUAL =
  'AIClientToolsBase:EnsureUpToDateMultilingual';

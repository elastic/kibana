...
export const INSTALL_ALL_TASK_TYPE = 'AIClientToolsBase:InstallAll';
export const INSTALL_ALL_TASK_ID = 'AIClientToolsBase:InstallAll';
export const INSTALL_ALL_TASK_ID_MULTILINGUAL = 'AIClientToolsBase:InstallAllMultilingual';

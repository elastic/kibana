...
export const UNINSTALL_ALL_TASK_TYPE = 'AIClientToolsBase:UninstallAll';
export const UNINSTALL_ALL_TASK_ID = 'AIClientToolsBase:UninstallAll';
export const UNINSTALL_ALL_TASK_ID_MULTILINGUAL = 'AIClientToolsBase:UninstallAllMultilingual';

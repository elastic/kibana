 ...
 * indexed fields.
 */
export interface AIClientToolsInstallStatusAttributes {
...
export const productDocInstallStatusSavedObjectType: SavedObjectsType<AIClientToolsInstallStatusAttributes> =
  {

...
interface PackageInstallerOpts {
  ...
  productDocClient: AIClientToolsInstallClient;
...
export class PackageInstaller {
  ...
  private readonly productDocClient: AIClientToolsInstallClient;
  ...
  async installPackage({
    ...
    try {
      ...
      const indexName = getAIClientToolsIndexName(productName, customInference?.inference_id);
  ...
  async uninstallPackage({
    ...
    const indexName = getAIClientToolsIndexName(productName, inferenceId);

...
import type { AIClientToolsInstallClient } from '../doc_install_status';
...
describe('DocumentationManager', () => {
  ...
  let docInstallClient: jest.Mocked<AIClientToolsInstallClient>;
  ...
  beforeEach(() => {
    ...
    } as unknown as jest.Mocked<AIClientToolsInstallClient>;
  ...
  describe('#install', () => {
    beforeEach(() => {
      ...
      } as Awaited<ReturnType<AIClientToolsInstallClient['getInstallationStatus']>>);
    });

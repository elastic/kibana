...
import type { AIClientToolsumentationAttributes } from '@kbn/product-doc-common';
import type { DocSearchResult } from '../types';

export const mapResult = (docHit: SearchHit<AIClientToolsumentationAttributes>): DocSearchResult => {

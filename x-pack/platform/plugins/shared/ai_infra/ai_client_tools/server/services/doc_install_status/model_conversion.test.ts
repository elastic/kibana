...
import type { AIClientToolsInstallStatusAttributes } from '../../saved_objects';
import { soToModel } from './model_conversion';

const createObj = (
  attrs: AIClientToolsInstallStatusAttributes
): SavedObject<AIClientToolsInstallStatusAttributes> => {
  return {
    id: 'some-id',
    type: 'client-ai-tools',
    attributes: attrs,
    references: [],
  };
};

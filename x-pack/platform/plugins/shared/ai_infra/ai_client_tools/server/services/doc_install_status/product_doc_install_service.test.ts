...
import type { AIClientToolsInstallStatusAttributes as TypeAttributes } from '../../saved_objects';
import { savedObjectsClientMock } from '@kbn/core/server/mocks';
import { AIClientToolsInstallClient } from './product_doc_install_service';
...
describe('AIClientToolsInstallClient', () => {
  let soClient: ReturnType<typeof savedObjectsClientMock.create>;
  let service: AIClientToolsInstallClient;
  let log: Logger;

  beforeEach(() => {
    soClient = savedObjectsClientMock.create();
    log = loggingSystemMock.createLogger();
    service = new AIClientToolsInstallClient({ soClient, log });
  });

...
const UI_TO_STORED_MINIMUM_TIME_RANGE: Readonly<Record<string, MinimumTimeRangeStoredOption>> = {
  ...
  [MINIMUM_TIME_RANGE_OPTION.NO_MINIMUM]: MINIMUM_TIME_RANGE_OPTION.NO_MINIMUM,
  [MINIMUM_TIME_RANGE_OPTION.ONE_WEEK]: MINIMUM_TIME_RANGE_OPTION.ONE_WEEK,
  [MINIMUM_TIME_RANGE_OPTION.ONE_MONTH]: MINIMUM_TIME_RANGE_OPTION.ONE_MONTH,
  [MINIMUM_TIME_RANGE_OPTION.THREE_MONTHS]: MINIMUM_TIME_RANGE_OPTION.THREE_MONTHS,
  [MINIMUM_TIME_RANGE_OPTION.SIX_MONTHS]: MINIMUM_TIME_RANGE_OPTION.SIX_MONTHS,
};
...
export const toStoredMinimumTimeRange = (
  ...
  return UI_TO_STORED_MINIMUM_TIME_RANGE[minimumTimeRange] ?? DEFAULT_MINIMUM_TIME_RANGE;
};

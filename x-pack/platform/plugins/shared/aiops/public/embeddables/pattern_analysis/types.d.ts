...
export interface PatternAnalysisComponentApi {
    ...
    minimumTimeRangeOption: PublishingSubject<PatternAnalysisEmbeddableState['minimumTimeRangeOption']>;
    randomSamplerMode: PublishingSubject<PatternAnalysisEmbeddableState['randomSamplerMode']>;
    randomSamplerProbability: PublishingSubject<PatternAnalysisEmbeddableState['randomSamplerProbability']>;
    updateUserInput: (update: PatternAnalysisEmbeddableState) => void;
}
export type PatternAnalysisEmbeddableApi = DefaultEmbeddableApi<PatternAnalysisEmbeddableState> & HasEditCapabilities & PublishesDataViews & PublishesTimeRange & PatternAnalysisComponentApi;

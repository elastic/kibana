...
import type { AnalyticsServiceStart, CoreStart, ExecutionContextStart, HttpStart, IUiSettingsClient, ThemeServiceStart, UserProfileService, NotificationsStart } from '@kbn/core/public';
 ...
 */
export declare const AiopsAppContext: import("react").Context<AiopsAppContextValue | undefined>;
/**
 * Custom hook to get AIOps app dependency context.
 */
export declare const useAiopsAppContext: () => AiopsAppContextValue;

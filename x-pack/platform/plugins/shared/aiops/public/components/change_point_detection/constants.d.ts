...
export declare const fnOperationTypeMapping: Record<ChangePointAggregationFunction, string>;
export declare const DEFAULT_AGG_FUNCTION: ChangePointAggregationFunction;

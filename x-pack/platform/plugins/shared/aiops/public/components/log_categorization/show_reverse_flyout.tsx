...
import { ReverseCategorizationFlyout } from './reverse_categorization';

const localStorage = new Storage(window.localStorage);

export async function showReverseCategorizeFieldFlyout(
  field: DataViewField,
  dataView: DataView,
  fieldValue: string,
  coreStart: CoreStart,
  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      const flyoutSession = overlays.openFlyout(
        ...
        {
          'data-test-subj': 'aiopsReverseCategorizeFieldFlyout',
          ownFocus: true,

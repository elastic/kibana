...
export const RECOMMENDED = i18n.translate(
  'xpack.integrationAssistant.celFlyout.step.confirmSettings.recommended',
  {
    defaultMessage: 'Recommended',
  }
);
export const ENTER_MANUALLY = i18n.translate(
  'xpack.integrationAssistant.celFlyout.step.confirmSettings.enterManually',
  {
...
export const CONFIRM_ENDPOINT_DESCRIPTION = i18n.translate(
  'xpack.integrationAssistant.celFlyout.step.confirmSettings.confirmEndpointDescription',
  {
    defaultMessage: 'Recommended API endpoints (chosen from your spec file):',
  }
);
export const CONFIRM_AUTH = i18n.translate(
  'xpack.integrationAssistant.celFlyout.step.confirmSettings.confirmAuth',
  {
...
export const AUTH_SELECTION_TITLE = i18n.translate(
  'xpack.integrationAssistant.celFlyout.step.confirmSettings.authSelectionTitle',
  {
    defaultMessage: 'Preferred method',
  }
);
export const AUTH_DOES_NOT_ALIGN = i18n.translate(
  'xpack.integrationAssistant.celFlyout.step.confirmSettings.authDoesNotAlign',
  {
    defaultMessage: 'This method does not align with your spec file',
  }
);
export const GENERATION_ERROR = i18n.translate(
  'xpack.integrationAssistant.celFlyout.step.confirmSettings.generationError',
  {
    defaultMessage: 'An error occurred during: CEL input generation',
  }
);
export const GENERATE = i18n.translate(
  'xpack.integrationAssistant.celFlyout.step.confirmSettings.generateButtonLabel',
  {
...
export const CANCEL = i18n.translate(
  'xpack.integrationAssistant.celFlyout.step.confirmSettings.cancel',
  {

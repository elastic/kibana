...
export const API_DEFINITION_TITLE = i18n.translate(
  'xpack.integrationAssistant.celFlyout.step.uploadSpec.apiDefinition.title',
  {
    defaultMessage: 'Upload an OpenAPI spec file',
  }
);
export const API_DEFINITION_DESCRIPTION = i18n.translate(
  'xpack.integrationAssistant.celFlyout.step.uploadSpec.apiDefinition.description',
  {
    defaultMessage: 'Drag and drop a file or browse files.',
  }
);
export const API_DEFINITION_DESCRIPTION_2 = i18n.translate(
  'xpack.integrationAssistant.celFlyout.step.uploadSpec.apiDefinition.description2',
  {
...
export const API_DEFINITION_ERROR = {
  CAN_NOT_READ: i18n.translate(
    'xpack.integrationAssistant.celFlyout.step.uploadSpec.openapiSpec.errorCanNotRead',
    {
      defaultMessage: 'Failed to read the uploaded file',
    }
  ),
  INVALID_OAS: i18n.translate(
    'xpack.integrationAssistant.celFlyout.step.uploadSpec.openapiSpec.errorInvalidFormat',
    {
  ...
  CAN_NOT_READ_WITH_REASON: (reason: string) =>
    i18n.translate(
      'xpack.integrationAssistant.celFlyout.step.uploadSpec.openapiSpec.errorCanNotReadWithReason',
      {
        values: { reason },
  ...
  TOO_LARGE_TO_PARSE: i18n.translate(
    'xpack.integrationAssistant.celFlyout.step.uploadSpec.openapiSpec.errorTooLargeToParse',
    {
...
export const ANALYZE = i18n.translate(
  'xpack.integrationAssistant.celFlyout.step.uploadSpec.analyze',
  {
...
export const SUCCESS = i18n.translate(
  'xpack.integrationAssistant.celFlyout.step.uploadSpec.success',
  {

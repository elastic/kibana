...
export type BulkResponseErrorAggregation = Record<string, {
    count: number;
    statusCode: number;
}>;
/**
 ...
 */
export declare const errorAggregator: (response: estypes.BulkResponse, ignoreStatusCodes: number[]) => BulkResponseErrorAggregation;

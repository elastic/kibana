import type { ALERT_INSTANCE_ID, ALERT_RULE_CATEGORY, ALERT_RULE_CONSUMER, ALERT_RULE_EXECUTION_UUID, ALERT_RULE_NAME, ALERT_RULE_PRODUCER, ALERT_RULE_TAGS, ALERT_RULE_TYPE_ID, ALERT_RULE_UUID, SPACE_IDS, TIMESTAMP, ALERT_SUPPRESSION_TERMS, ALERT_SUPPRESSION_START, ALERT_SUPPRESSION_END, ALERT_SUPPRESSION_DOCS_COUNT, ALERT_RULE_PARAMETERS, ALERT_RULE_REVISION } from '@kbn/rule-data-utils';
/**
 ...
 */
export type LeafNodeTypes = object | object[] | string | string[] | number | number[] | boolean | boolean[] | null | undefined;
...
export type ConvertSchemaType<ModelVersion extends string, Schema extends SchemaType> = Expand<{
    [k in keyof Schema as Required<Schema>[k]['version'] extends ModelVersion ? k : never]: ConvertSchemaNode<ModelVersion, Required<Schema>[k]>;
}>;
export type ConvertSchemaNode<ModelVersion extends string, N extends SchemaNode> = N extends SchemaInternalNode ? N['type'] extends object[] ? Array<ConvertSchemaType<ModelVersion, N['fields']>> : ConvertSchemaType<ModelVersion, N['fields']> : N['type'];
export type ConvertSchemaTypeToReadSchema<OriginalVersion extends string, Schema extends SchemaType> = Expand<{
    [k in keyof Schema]: Required<Schema>[k]['version'] extends OriginalVersion ? ConvertSchemaNode<OriginalVersion, Required<Schema>[k]> : ConvertSchemaNode<OriginalVersion, Required<Schema>[k]> | undefined;
}>;

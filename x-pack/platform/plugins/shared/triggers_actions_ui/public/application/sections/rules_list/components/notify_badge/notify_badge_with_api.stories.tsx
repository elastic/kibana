...
import { StoryObj, Meta, StoryFn } from 'storybook-react-rsbuild';
...
export const DefaultRuleNotifyBadgeWithApi = {
  render: Template,
};
...
export const IndefinitelyRuleNotifyBadgeWithApi = {
  render: Template,
...
export const ScheduleSnoozesRuleNotifyBadgeWithApi: StoryObj<RulesListNotifyBadgePropsWithApi> = {
  render: (args) => {
    return (
      <div>

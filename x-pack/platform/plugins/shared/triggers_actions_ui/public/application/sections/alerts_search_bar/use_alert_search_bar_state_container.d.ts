...
export declare const alertSearchBarStateContainer: import("@kbn/kibana-utils-plugin/common").ReduxLikeStateContainer<AlertSearchBarContainerState, AlertSearchBarStateTransitions, {}>;
export declare const Provider: import("react").Provider<import("@kbn/kibana-utils-plugin/common").ReduxLikeStateContainer<AlertSearchBarContainerState, AlertSearchBarStateTransitions, {}>>, useContainer: () => import("@kbn/kibana-utils-plugin/common").ReduxLikeStateContainer<AlertSearchBarContainerState, AlertSearchBarStateTransitions, {}>;

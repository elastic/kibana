...
export declare const CreateConnectorForm: (props: CreateConnectorFormProps) => import("react").JSX.Element;
...
export type { CreateConnectorFormProps, CreateConnectorFormHandle, CreateConnectorFormStatus, } from './create_connector_form';

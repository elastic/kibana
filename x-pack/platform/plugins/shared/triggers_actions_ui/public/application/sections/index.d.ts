...
export declare const RulesListNotifyBadgeWithApi: (props: Pick<import("./rules_list/components/notify_badge/types").RulesListNotifyBadgeProps, "loading" | "disabled" | "showOnHover" | "snoozeSettings" | "onRuleChanged" | "showTooltipInline"> & {
    ruleId: string;

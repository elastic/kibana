...
import { alertProducersData } from 'x-pack/platform/packages/shared/response-ops/alerts-table/constants';
import { alertsTableQueryClient } from 'x-pack/platform/packages/shared/response-ops/alerts-table/query_client';
import { defaultAlertsTableSort } from 'x-pack/platform/packages/shared/response-ops/alerts-table/configuration';
import type { AlertsTableSupportedConsumers } from 'x-pack/platform/packages/shared/response-ops/alerts-table/types';

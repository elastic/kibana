...
export declare const NON_SIEM_CONSUMERS: ("observability" | "alerts" | "discover" | "ml" | "monitoring" | "streams" | "apm" | "infrastructure" | "uptime" | "logs" | "slo" | "stackAlerts" | "AlertingExample")[];

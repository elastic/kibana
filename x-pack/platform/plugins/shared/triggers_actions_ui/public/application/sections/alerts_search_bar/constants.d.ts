...
export declare const NON_SIEM_CONSUMERS: ("observability" | "alerts" | "discover" | "monitoring" | "ml" | "streams" | "stackAlerts" | "infrastructure" | "apm" | "logs" | "slo" | "uptime" | "AlertingExample")[];

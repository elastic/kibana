...
describe('health check', () => {
  ...
  test('renders warning if API keys are disabled', async () => {
    ...
    const [description] = await screen.findAllByText(/API keys/i);
    const [action] = await screen.findAllByText(/Learn more/i);
  ...
  test('renders warning if encryption key is ephemeral and keys are disabled', async () => {
    ...
    const description = await screen.findByText(/You must enable/i);

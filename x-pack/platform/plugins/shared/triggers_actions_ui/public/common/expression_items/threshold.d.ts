...
export declare const ThresholdExpression: ({ thresholdComparator, errors, onChangeSelectedThresholdComparator, onChangeSelectedThreshold, customComparators, display, threshold, popupPosition, unit, initialPopoverOpen, badge, }: ThresholdExpressionProps) => React.JSX.Element;

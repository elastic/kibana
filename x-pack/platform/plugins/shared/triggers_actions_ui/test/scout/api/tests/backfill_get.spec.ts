 ...
 * matrix and saved-object level assertions.
 */
...
apiTest.describe('backfill get API', { tag: tags.stateful.classic }, () => {
  ...
  // ────────────────────────────────────────────────────────────────────────────
  apiTest('gets existing backfills by ID', async ({ apiClient, kbnClient }) => {
    expect(apiClient).toBeDefined();
  ...
  // Not found
  // ────────────────────────────────────────────────────────────────────────────
  apiTest('returns 404 for a non-existent backfill ID', async ({ apiClient, kbnClient }) => {
    expect(apiClient).toBeDefined();
  ...
  // ────────────────────────────────────────────────────────────────────────────
  apiTest(
    'returns 404 when getting a backfill from a different space',
  ...
  apiTest(
    ...
    async ({ apiClient, kbnClient, samlAuth }) => {
      ...
      const response = await apiClient.get(`internal/alerting/rules/backfill/${backfillId}`, {

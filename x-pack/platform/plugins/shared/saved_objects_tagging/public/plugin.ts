...
import { type CoreSetup, type CoreStart, type PluginInitializerContext, type Plugin } from '@kbn/core/public';
...
import { SavedObjectsTaggingClientConfig, type SavedObjectsTaggingClientConfigRawType } from './config';

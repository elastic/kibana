 ...
 */
export interface SubFeaturePrivilegeConfig extends Omit<FeatureKibanaPrivileges, 'composedOf' | 'replacedBy'> {
    /**
        ...
        privileges: readonly Readonly<{
            ...
            alerting?: Readonly<{
                rule?: Readonly<{
                    ...
                    mute_alerts?: readonly Readonly<{
                        ruleTypeId: string;
                        consumers: readonly string[];
                    }>[] | undefined;
                    read_muted_alerts?: readonly Readonly<{
                        ruleTypeId: string;
                        consumers: readonly string[];
                    }>[] | undefined;
                }> | undefined;

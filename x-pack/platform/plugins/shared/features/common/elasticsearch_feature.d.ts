...
export declare class ElasticsearchFeature {
    protected readonly config: RecursiveReadonly<ElasticsearchFeatureConfig>;
    constructor(config: RecursiveReadonly<ElasticsearchFeatureConfig>);
    get id(): string;
    get catalogue(): import("@kbn/utility-types").RecursiveReadonlyArray<string> | undefined;
    get management(): Readonly<{
        [x: string]: import("@kbn/utility-types").RecursiveReadonlyArray<string>;
    }> | undefined;
    get privileges(): import("@kbn/utility-types").RecursiveReadonlyArray<FeatureElasticsearchPrivileges>;
    toRaw(): ElasticsearchFeatureConfig;
}

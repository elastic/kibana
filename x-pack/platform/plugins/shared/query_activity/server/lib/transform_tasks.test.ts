...
import { QUERY_ACTIVITY_MIN_RUNNING_TIME_DEFAULT_MS } from '../../common/constants';
import {
  extractSource,
  getQueryType,
  capitalise,
...
const DEFAULT_THRESHOLD_NANOS = QUERY_ACTIVITY_MIN_RUNNING_TIME_DEFAULT_MS * 1_000_000;

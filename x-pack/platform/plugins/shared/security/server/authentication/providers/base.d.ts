 ...
 */
export declare abstract class BaseAuthenticationProvider {
     ...
     * @param [state] Optional state object associated with the provider.
     */
    login(request: KibanaRequest, loginAttempt: unknown, state?: unknown): Promise<AuthenticationResult>;
    /**
     ...
     */
    protected getUser(request: KibanaRequest, authHeaders?: Headers): Promise<Readonly<{

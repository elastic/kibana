 ...
 */
export declare class OIDCAuthenticationProvider extends BaseAuthenticationProvider {
     ...
     */
    login(request: KibanaRequest, attempt: ProviderLoginAttempt, state?: ProviderState | null): Promise<AuthenticationResult>;
    /**
     * Performs OpenID Connect request authentication.
     * @param request Request instance.
     * @param [state] Optional state object associated with the provider.

...
export declare class AnonymousAuthenticationProvider extends BaseAuthenticationProvider {
     ...
     */
    login(request: KibanaRequest, state?: unknown): Promise<AuthenticationResult>;
    /**
     * Performs request authentication.
     * @param request Request instance.
     * @param state Optional state value previously stored by the provider.
     */
    authenticate(request: KibanaRequest, state?: unknown): Promise<AuthenticationResult>;
    /**
     * Redirects user to the logged out page.
     * @param request Request instance.
     * @param state Optional state value previously stored by the provider.
     */
    logout(request: KibanaRequest, state?: unknown): Promise<DeauthenticationResult>;
    /**

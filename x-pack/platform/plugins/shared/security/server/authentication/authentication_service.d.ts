...
export interface InternalAuthenticationServiceStart extends AuthenticationServiceStart {
    apiKeys: Pick<APIKeysType, 'areAPIKeysEnabled' | 'areCrossClusterAPIKeysEnabled' | 'create' | 'update' | 'invalidate' | 'validate' | 'grantAsInternalUser' | 'invalidateAsInternalUser' | 'uiam'>;

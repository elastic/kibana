...
import type { CreateAPIKeyParams, CreateAPIKeyResult, CreateRestAPIKeyParams, CreateRestAPIKeyWithKibanaPrivilegesParams, GrantAPIKeyResult, InvalidateAPIKeyResult, InvalidateAPIKeysParams, NativeAPIKeysType, ValidateAPIKeyParams } from '@kbn/security-plugin-types-server';

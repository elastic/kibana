...
import type { CreateUiamOAuthClientParams, UiamOAuthClientResponse, UiamOAuthConnectionResponse, UiamOAuthType, UiamResolvedUsersResponse, UpdateUiamOAuthClientParams, UpdateUiamOAuthConnectionParams } from '@kbn/core-security-server';
...
export declare class UiamOAuth implements UiamOAuthType {
    ...
    listConnections(request: KibanaRequest, clientId?: string, connectionId?: string, projectId?: string): Promise<{

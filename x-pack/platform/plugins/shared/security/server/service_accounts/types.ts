...
/**
 * Query parameters for UIAM's collection GET. `q` format is still TBD upstream.
 */
...
/**
 * The principal that created a service account, as returned by UIAM get and list.
 */

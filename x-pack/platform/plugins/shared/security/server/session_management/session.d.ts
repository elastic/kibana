...
export declare class Session {
     ...
     */
    create(request: KibanaRequest, sessionValue: Readonly<Omit<SessionValue, 'sid' | 'idleTimeoutExpiration' | 'lifespanExpiration' | 'createdAt' | 'metadata'>>, stateCookieOptions?: SessionStorageSetOptions): Promise<Readonly<SessionValue>>;
    /**
     * Updates session value for the specified request.
     * @param request Request instance to set session value for.
     * @param sessionValue Session value parameters.
     */
    update(request: KibanaRequest, sessionValue: Readonly<SessionValue>): Promise<Readonly<SessionValue> | null>;
    /**
     * Extends existing session.
     * @param request Request instance to set session value for.
     * @param sessionValue Session value parameters.
     */
    extend(request: KibanaRequest, sessionValue: Readonly<SessionValue>): Promise<Readonly<SessionValue> | null>;
    /**

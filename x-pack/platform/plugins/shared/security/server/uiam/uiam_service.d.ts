...
import type { CreateUiamOAuthClientParams, UiamOAuthClientLogo, UiamOAuthClientResponse, UiamOAuthClientType, UiamOAuthConnectionResponse, UiamResolvedUsersResponse, UpdateUiamOAuthClientParams, UpdateUiamOAuthConnectionParams } from '@kbn/core-security-server';
...
export interface UiamServicePublic {
     ...
     * @param projectId Optional project ID filter.
     */
    listOAuthConnections(accessToken: string, clientId?: string, connectionId?: string, projectId?: string): Promise<OAuthConnectionsResponse>;
    /**

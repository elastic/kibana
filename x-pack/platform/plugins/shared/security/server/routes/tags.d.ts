 ...
 */
export declare const ROUTE_TAG_API = "api";
/**
 ...
 */
export declare const ROUTE_TAG_CAN_REDIRECT = "security:canRedirect";
/**
 ...
 */
export declare const ROUTE_TAG_AUTH_FLOW = "security:authFlow";
/**
 ...
 */
export declare const ROUTE_TAG_ACCEPT_JWT = "security:acceptJWT";
/**
 ...
 */
export declare const ROUTE_TAG_ACCEPT_UIAM_OAUTH = "security:acceptUiamOAuth";

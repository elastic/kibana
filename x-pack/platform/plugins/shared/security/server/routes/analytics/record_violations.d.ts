...
declare const cspViolationReportSchema: import("@kbn/config-schema").ObjectType<{
    ...
    age: import("@kbn/config-schema").Type<number | null | undefined>;
    url: import("@kbn/config-schema").Type<string>;
    user_agent: import("@kbn/config-schema").Type<string | null | undefined>;
    body: import("@kbn/config-schema").ObjectType<{
        documentURL: import("@kbn/config-schema").Type<string>;
        referrer: import("@kbn/config-schema").Type<string | null | undefined>;
        blockedURL: import("@kbn/config-schema").Type<string | null | undefined>;
        effectiveDirective: import("@kbn/config-schema").Type<string>;
        originalPolicy: import("@kbn/config-schema").Type<string>;
        sourceFile: import("@kbn/config-schema").Type<string | null | undefined>;
        sample: import("@kbn/config-schema").Type<string | null | undefined>;
        disposition: import("@kbn/config-schema").Type<"report" | "enforce">;
        statusCode: import("@kbn/config-schema").Type<number>;
        lineNumber: import("@kbn/config-schema").Type<number | null | undefined>;
        columnNumber: import("@kbn/config-schema").Type<number | null | undefined>;
    }>;
}>;
/**
...
export declare const permissionsPolicyViolationReportSchema: import("@kbn/config-schema").ObjectType<{
    ...
    body: import("@kbn/config-schema").ObjectType<{
         ...
         */
        policyId: import("@kbn/config-schema").Type<string | null | undefined>;
        /**
         * The string identifying the policy-controlled feature whose policy has been violated. This string can be used for grouping and counting related reports.
         */
        featureId: import("@kbn/config-schema").Type<string | null | undefined>;
        /**
         ...
         */
        allowAttribute: import("@kbn/config-schema").Type<string | null | undefined>;
        /**
         * For reports attributable to a specific `iframe` element, the value of that element's
         * `src` attribute, or null otherwise.
         */
        srcAttribute: import("@kbn/config-schema").Type<string | null | undefined>;
    }>;
}>;
/**

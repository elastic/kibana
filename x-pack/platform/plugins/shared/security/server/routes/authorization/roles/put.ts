        ...
        validate: {
          request: {
            params: schema.object(
              ...
              {
                meta: {
                  id: 'security_put_role_params',
                  description: 'Path parameters for creating or updating a role.',
                },
              }
            ),
            query: schema.object(
              ...
              {
                meta: {
                  id: 'security_put_role_query',
                  description: 'Query parameters for creating or updating a role.',
                },
              }
            ),

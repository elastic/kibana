...
export declare const AUDIT_OTEL_FIELD_RENAMES: Record<string, string | string[]>;
export declare const AUDIT_OTEL_FIELD_DROPS: string[];
export declare const AUDIT_OTEL_FIELD_DEFAULTS: Record<string, string | string[]>;
export declare const AUDIT_OTEL_FIELD_UPPERCASE: string[];
export declare const AUDIT_OTEL_FIELD_ADDITIONS: Record<string, string>;
export declare const AUDIT_OTEL_RESOURCE_ATTRIBUTES: Record<string, string>;
export declare const AUDIT_OTEL_PROMOTE_RESOURCE_ATTRIBUTES: string[];
...
export declare class AuditService {
    ...
    setup({ license, config, logging, http, isServerless, getCurrentUser, getSID, getSpaceId, recordAuditLoggingUsage, }: AuditServiceSetupParams): AuditServiceSetup;
    stop(): void;
}
export declare const createLoggingConfig: (config: ConfigType["audit"], isServerless?: boolean) => import("rxjs").OperatorFunction<Pick<SecurityLicenseFeatures, "allowAuditLogging">, LoggerContextConfigInput>;
/**

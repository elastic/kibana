...
const CurrentUserContent = ({
  ...
  const isToolboxRight = useIsToolbarRight();
  const isSearchInToolbox = useIsSearchInToolbar();
              ...
              <EuiFlexGroup direction="column" gutterSize="s">
                ...
                <EuiFlexItem>
                  <EuiSwitch
                    ...
                    onChange={() => {
                      dispatch(setIsToolbarRight(!isToolboxRight));
                    }}
                  />
                </EuiFlexItem>
                <EuiFlexItem>
                  <EuiSwitch
                    ...
                    onChange={() => {
                      dispatch(setIsSearchInToolbar(!isSearchInToolbox));
                    }}
                  />
                </EuiFlexItem>
              </EuiFlexGroup>

...
export const UIM_TEMPLATE_SHOW_DETAILS_CLICK = 'template_show_details_click';
export const UIM_TEMPLATE_DETAIL_PANEL_SUMMARY_TAB = 'template_details_summary_tab';

...
// weave: run 'weave explain x-pack/platform/plugins/shared/index_management/server/lib/data_stream_serialization.test.ts' for per-hunk detail, 'weave check' to verify your resolution

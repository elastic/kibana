...
import { type ModelDownloadState, type TrainedModelStat } from '@kbn/ml-plugin/common/types/trained_models';
...
import { type AppDependencies, useAppContext } from '../application/app_context';

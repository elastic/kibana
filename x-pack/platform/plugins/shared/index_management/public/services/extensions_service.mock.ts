...
import type { ExtensionsSetup } from '@kbn/index-management-shared-types/src/services/extensions_service';
import type { ExtensionsService } from './extensions_service';

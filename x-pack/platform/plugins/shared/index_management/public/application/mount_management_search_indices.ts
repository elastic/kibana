...
import { ChromeBreadcrumb, CoreSetup, CoreStart, ScopedHistory } from '@kbn/core/public';
...
interface SearchIndicesAppMountParams {
...
export function getIndexManagementDependenciesIndices({
  core,
  usageCollection,
  extensionsService,
  history,
...
export async function mountIndexManagementSection({
  coreSetup,
  usageCollection,
  params,
  extensionsService,
  ...
  usageCollection: UsageCollectionSetup;
  params: SearchIndicesAppMountParams;
  extensionsService: ExtensionsService;
  isFleetEnabled: boolean;
  kibanaVersion: SemVer;
  config: AppDependencies['config'];
  ...
  console.log("mountIndexManagementSection")
  ...
  const appDependencies = getIndexManagementDependenciesIndices({
    cloud,
    config,
    core,
    extensionsService,

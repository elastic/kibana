      ...
      content={{
        ...
        center: (
          <EuiFlexGroup gutterSize="xs" alignItems="center">
            ...
            <EuiTextColor color="subdued">
              {i18n.translate('xpack.idxMgmt.indexDetails.overviewTab.aiSearch.denseVectorFields', {
        ...
        right: (
          <EuiFlexGroup gutterSize="xs" alignItems="center">
            ...
            <EuiTextColor color="subdued">
              {i18n.translate(
                'xpack.idxMgmt.indexDetails.overviewTab.aiSearch.sparseVectorFields',
                {

...
import { type TemplateDeserialized, type TemplateType, type TemplateListItem } from '../../common';
import { type IndexSettings, type Aliases, type Mappings, type DataStream } from '../../common/types';

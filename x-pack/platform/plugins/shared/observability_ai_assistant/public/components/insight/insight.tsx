...
export function Insight({
  ...
  const {
    services: {
      http,
      plugins: {
        start: { licensing, aiAssistantManagementSelection },
      },
    },
  } = useKibana();

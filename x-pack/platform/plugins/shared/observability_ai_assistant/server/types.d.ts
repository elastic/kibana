...
import type { DataViewsServerPluginSetup, DataViewsServerPluginStart } from '@kbn/data-views-plugin/server';
...
import type { SearchInferenceEndpointsPluginSetup, SearchInferenceEndpointsPluginStart } from '@kbn/search-inference-endpoints/server';

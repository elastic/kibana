...
export const getTitleSystemMessage = (scopes: AssistantScope[]) =>
  ...
  }. Assume the following message is the start of a conversation between you and a user; give this conversation a title based on the content below. DO NOT UNDER ANY CIRCUMSTANCES wrap this title in single or double quotes. DO NOT include any labels like "Title:", "**Title:**", or similar prefixes. Return ONLY the title text itself. This title is shown in a list of conversations to the user, so title it for the user, not for you.`;
      ...
      functions: [
        {
          ...
          description:
            'Use this function to title the conversation. Return only the title text without any labels, quotes, or prefixes like "Title:"',
          parameters: {
            type: 'object',
            properties: {
              title: {

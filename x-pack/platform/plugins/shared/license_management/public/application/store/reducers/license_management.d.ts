...
export declare const licenseManagement: import("redux-v4").Reducer<import("redux-v4").CombinedState<{
...
export declare const getLicenseState: ((state: LicenseManagementState) => {
    ...
    status: string;
}) & import("reselect-v4").OutputSelectorFields<(args_0: import("@kbn/licensing-types").ILicense | null, args_1: string | null, args_2: boolean) => {
    type: "Basic" | "Standard" | "Gold" | "Platinum" | "Enterprise" | "Trial";
    isExpired: boolean;
    expirationDate: string | null;
    status: string;

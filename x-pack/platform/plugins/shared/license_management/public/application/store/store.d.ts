import { type CombinedState, type PreloadedState, type StoreEnhancer } from 'redux-v4';
...
export declare const licenseManagementStore: (initialState: PreloadedState<CombinedState<LicenseManagementState>>, services: ThunkServices) => import("redux-v4").Store<import("redux-v4").EmptyObject & {
    ...
    dispatch: import("redux-thunk-v2").ThunkDispatch<any, ThunkServices, import("redux-v4").AnyAction>;
};

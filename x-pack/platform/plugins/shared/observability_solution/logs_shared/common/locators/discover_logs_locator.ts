 ...
 */
export const DISCOVER_LOGS_LOCATOR_ID = 'DISCOVER_LOGS_LOCATOR';

/**
 * Accepts the same parameters as `DiscoverAppLocatorParams`, but automatically sets the `dataViewSpec` param to all log sources.
 */
export type DiscoverLogsLocatorParams = DiscoverAppLocatorParams;

export class DiscoverLogsLocatorDefinition implements LocatorDefinition<DiscoverLogsLocatorParams> {
  ...
  public readonly getLocation = async (params: DiscoverLogsLocatorParams) => {

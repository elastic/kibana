...
// cannot be imported from x-pack/solutions/observability/plugins/observability_solution/observability_ai_assistant_app/server/functions/query/index.ts due to circular dependency

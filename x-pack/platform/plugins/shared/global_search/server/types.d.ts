...
import type { ISavedObjectTypeRegistry, IUiSettingsClient, SavedObjectsClientContract, Capabilities, IRouter, CustomRequestHandlerContext, IScopedClusterClient } from '@kbn/core/server';
import type { GlobalSearchBatchedResults, GlobalSearchProviderFindOptions, GlobalSearchProviderResult, GlobalSearchProviderFindParams, GlobalSearchFindParams } from '../common/types';
...
export interface GlobalSearchResultProvider {
     ...
     * ```
     */
    find(search: GlobalSearchProviderFindParams, options: GlobalSearchProviderFindOptions, context: GlobalSearchProviderContext): Observable<GlobalSearchProviderResult[]>;
    /**

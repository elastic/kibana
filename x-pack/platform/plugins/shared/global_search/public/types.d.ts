...
import type { GlobalSearchProviderFindOptions, GlobalSearchProviderResult, GlobalSearchProviderFindParams } from '../common/types';
...
export interface GlobalSearchResultProvider {
     ...
     * ```
     */
    find(search: GlobalSearchProviderFindParams, options: GlobalSearchProviderFindOptions): Observable<GlobalSearchProviderResult[]>;
    /**

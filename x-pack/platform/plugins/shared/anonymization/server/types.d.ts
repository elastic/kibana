...
export interface AnonymizationProfileInitializerContext {
    ...
    logger: Logger;
    findProfileByTarget: (targetType: AnonymizationTarget['type'], targetId: string) => Promise<AnonymizationProfile | null>;
...
export interface AnonymizationPolicyService {
     ...
     */
    resolveEffectivePolicy: (namespace: string, target: AnonymizationTarget) => Promise<EffectivePolicy>;
    /**

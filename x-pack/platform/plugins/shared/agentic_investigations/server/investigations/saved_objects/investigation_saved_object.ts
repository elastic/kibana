...
export const investigationDetailsSavedObjectType: SavedObjectsType<InvestigationAttributes> = {
  ...
  mappings: {
    ...
    properties: {
      ...
      // Nested so compound entity queries work: "name=X AND type=service" on the same entity.
      impact: {
        type: 'nested',
        properties: {
          entities: {
            ...
            properties: {
              ...
              feature_id: { type: 'keyword', ignore_above: 1024 },
              stream_name: { type: 'keyword', ignore_above: 1024 },
            },
          },
        },
      },
      hypotheses: {
        type: 'nested',
        properties: {
          candidate: { type: 'keyword', ignore_above: 1024 },

...
The loop adopts in exactly two places — step 1 for the settles that run before the gate, step 6 for everything that runs after it. Every step that writes is downstream of one of them.

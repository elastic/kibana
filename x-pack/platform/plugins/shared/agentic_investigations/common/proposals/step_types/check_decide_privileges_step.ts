...
> = {
  ...
  label: i18n.translate('xpack.agenticInvestigations.steps.checkDecidePrivileges.label', {
    defaultMessage: 'Check proposal decide privileges',
  }),
  description: i18n.translate(
    'xpack.agenticInvestigations.steps.checkDecidePrivileges.description',
    {
      defaultMessage:
  ...
  documentation: {
    details: i18n.translate(
      'xpack.agenticInvestigations.steps.checkDecidePrivileges.documentation.details',
      {
        defaultMessage:

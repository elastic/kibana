...
- **Experiments** — list, detail, protocol and execution summary, paginated runs, batched trace retrieval, scores, dataset-level examples, and statistical comparison of two experiments

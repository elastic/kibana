...
- **Experiments** — list, detail (per-evaluator inventory and execution summary included), paginated runs, batched trace retrieval, scores, dataset-level examples, and statistical comparison of two experiments

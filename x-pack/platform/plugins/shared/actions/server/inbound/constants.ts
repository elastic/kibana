...
export const INBOUND_EVENTS_DISABLED_MESSAGE = 'Inbound connector events are disabled';
export const INBOUND_EVENTS_UNEXPECTED_ERROR_MESSAGE =
  'Unable to process inbound connector event request.';

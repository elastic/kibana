 ...
 */
export declare const getOAuthAuthorizationCodeAccessToken: ({ connectorId, logger, configurationUtilities, credentials, connectorTokenClient, scope, authMode, profileUid, forceRefresh, }: GetOAuthAuthorizationCodeAccessTokenOpts) => Promise<string | null>;
export {};

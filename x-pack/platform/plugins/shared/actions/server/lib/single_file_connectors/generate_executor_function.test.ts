...
describe('generateExecutorFunction', () => {
  ...
  it('passes all expected params to the action', () => {
    expect(JSON.stringify(generateParamsSchema(mockActions))).toMatch(
      JSON.stringify({
        schema: z.discriminatedUnion('subAction', [
          z
  ...
  it('calls getAxiosInstanceWithAuth with secrets', () => {
    expect(JSON.stringify(generateParamsSchema(mockActions))).toMatch(
      JSON.stringify({
        schema: z.discriminatedUnion('subAction', [
          z
  ...
  describe('error handling', () => {
    it('throws if action is not defined', () => {
      expect(JSON.stringify(generateParamsSchema(mockActions))).toMatch(
        JSON.stringify({
          schema: z.discriminatedUnion('subAction', [
            z

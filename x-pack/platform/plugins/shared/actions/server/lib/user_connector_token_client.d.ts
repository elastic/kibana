...
export declare class UserConnectorTokenClient {
    ...
    constructor({ unsecuredSavedObjectsClient, encryptedSavedObjectsClient, logger, configurationUtilities, }: ConstructorOptions);
     ...
     */
    private getOAuthConnectorAuthInfo;
     ...
     */
    private listOAuthTokensForConnector;
    /**
     * Revokes the EARS grant before deletion; called from deleteConnectorTokens so it can't be skipped.
     */
    private revokeOAuthTokens;
    deleteConnectorTokens({ profileUid, connectorId, tokenType, credentialType, authType, provider, skipRevocation, }: {
        profileUid: string;
        connectorId: string;
        tokenType?: string;
        credentialType?: string;
    ...
    deleteAllConnectorTokens({ connectorId, credentialType, authType, provider, skipRevocation, }: {
        connectorId: string;
        credentialType?: string;
        authType?: string;
        provider?: string;

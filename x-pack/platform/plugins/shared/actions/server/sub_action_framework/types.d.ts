...
import type { ActionTypeParams, RenderParameterTemplates, Services, ValidatorType as ValidationSchema } from '../types';
...
export type IService<Config, Secrets> = new (params: ServiceParams<Config, Secrets>) => SubActionConnector<Config, Secrets>;
export type IServiceAbstract<Config, Secrets> = abstract new (params: ServiceParams<Config, Secrets>) => SubActionConnector<Config, Secrets>;
export type ICaseServiceAbstract<Config, Secrets, Incident, GetIncidentResponse> = abstract new (params: ServiceParams<Config, Secrets>, pushToServiceIncidentParamsSchema: Record<string, z4.ZodType<unknown>>) => SubActionConnector<Config, Secrets>;
...
export type Validators<Config, Secrets> = Array<ConfigValidator<Config> | SecretsValidator<Secrets>>;

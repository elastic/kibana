...
export declare class ActionsClient {
    ...
    constructor({ logger, actionTypeRegistry, authTypeRegistry, kibanaIndices, scopedClusterClient, encryptedSavedObjectsClient, unsecuredSavedObjectsClient, inMemoryConnectors, actionExecutor, bulkExecutionEnqueuer, request, spaceId, authorization, auditLogger, usageCounter, connectorTokenClient, getEventLogClient, getAxiosInstanceWithAuth, spaces, isESOCanEncrypt, connectorLifecycleListeners, getCurrentUserProfileIdFromAPIKey, }: ConstructorOptions);
    /**
     * Create an action
     */

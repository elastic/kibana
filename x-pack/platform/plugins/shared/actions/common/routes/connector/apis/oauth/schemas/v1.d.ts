...
export declare const cancelOAuthPathParamsSchema: import("@kbn/config-schema").ObjectType<{
    connectorId: import("@kbn/config-schema").Type<string>;
}>;
export declare const cancelOAuthBodySchema: import("@kbn/config-schema").ObjectType<{

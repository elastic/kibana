...
> => ({
  ...
  getAgentDescription: () =>
    [
      ...
      '`ask_user_question` whenever an authoring choice is a fixed set of options — which automation',
      'to edit, which strategy to use, what should change — rather than paraphrasing the options as',
      'chat text.',
      ...
      'Running is a separate request. Do not run a workflow, or offer to, unless the user asks for it',

...
import type { EsqlTable, EsqlHit } from '../../../common/esql';
import { getEsqlQueryHits } from '../../../common/esql';
import type { ESQLSourceFields } from './types';
...
function getSourceFields(results: Record<string, EsqlHit[]>, sourceFieldsParams: ESQLSourceFields) {
  const sourceFieldsPerResult: Record<string, { [key: string]: string[] }> = {};
  for (const alertId of Object.keys(results)) {
    ...
    sourceFieldsPerResult[alertId] = sourceFields;
  }

...
export const TestQueryRow: React.FC<TestQueryRowProps> = ({
  ...
  const { onTestQuery, testQueryResult, testQueryError, testQueryLoading, testQueryPreview } =
    useTestQuery(fetch);
      ...
      <EuiFormRow>
        <EuiFlexGroup alignItems="center" responsive={false} gutterSize="s">
          <EuiFlexItem grow={false}>
            ...
            >
              <FormattedMessage
                id="xpack.stackAlerts.esql.ui.testQuery"
          ...
          {copyQuery && (
            <EuiFlexItem grow={false}>
              ...
              >
                <EuiButtonEmpty
                  ...
                  onClick={() => {
                    ...
                    if (copied) {
                      setCopiedMessage(
                        <FormattedMessage
                          id="xpack.stackAlerts.esql.ui.queryCopiedToClipboard"
                ...
                >
                  <FormattedMessage
                    id="xpack.stackAlerts.esql.ui.copyQuery"
      ...
      {testQueryLoading && (
        <EuiFormRow>
          <EuiText color="subdued" size="s">
            <p>
              <FormattedMessage
                id="xpack.stackAlerts.esql.ui.testQueryIsExecuted"

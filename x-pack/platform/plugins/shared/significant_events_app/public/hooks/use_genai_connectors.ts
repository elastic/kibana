...
// Kept on the streams_app storage key so the connector selection users made before
// the Significant Events UI moved into its own plugin is preserved.
const CONNECTOR_STORAGE_KEY = 'xpack.streamsApp.lastUsedConnector';

...
const TITLE = i18n.translate('xpack.significantEventsApp.codeIntelligence.distribution.title', {
  defaultMessage: 'Services',
});
const SUBTITLE = i18n.translate(
  'xpack.significantEventsApp.codeIntelligence.distribution.subtitle',
  {
    defaultMessage: 'Services discovered in code vs. observed in logs',
  }
);
const CODE_ONLY_LABEL = i18n.translate(
  'xpack.significantEventsApp.codeIntelligence.distribution.codeOnly',
  {
    defaultMessage: 'Code only',
  }
);
const BOTH_LABEL = i18n.translate('xpack.significantEventsApp.codeIntelligence.distribution.both', {
  defaultMessage: 'Code + logs',
});
const LOGS_ONLY_LABEL = i18n.translate(
  'xpack.significantEventsApp.codeIntelligence.distribution.logsOnly',
  {
    defaultMessage: 'Logs only',
  }
);
const NOT_SHIPPING_LOGS_LABEL = i18n.translate(
  'xpack.significantEventsApp.codeIntelligence.distribution.notShippingLogs',
  { defaultMessage: 'Found in code, not found in logs yet:' }
);
const VIEW_SERVICE_DETAILS_LABEL = (serviceName: string) =>
  i18n.translate('xpack.significantEventsApp.codeIntelligence.distribution.viewServiceDetails', {

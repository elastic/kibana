...
const TITLE = i18n.translate('xpack.significantEventsApp.codeIntelligence.languages.title', {
  defaultMessage: 'Languages',
});
const SUBTITLE = i18n.translate('xpack.significantEventsApp.codeIntelligence.languages.subtitle', {
  defaultMessage: 'Languages identified across ingested code',
});
const EMPTY_LABEL = i18n.translate('xpack.significantEventsApp.codeIntelligence.languages.empty', {

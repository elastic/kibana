...
const TITLE = i18n.translate('xpack.significantEventsApp.codeIntelligence.repositoryTypes.title', {
  defaultMessage: 'Repository types',
});
const SUBTITLE = i18n.translate(
  'xpack.significantEventsApp.codeIntelligence.repositoryTypes.subtitle',
  {
    defaultMessage: 'How ingested repositories were classified',
  }
);
const EMPTY_LABEL = i18n.translate(
  'xpack.significantEventsApp.codeIntelligence.repositoryTypes.empty',
  {

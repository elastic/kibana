...
import type { KnowledgeIndicatorFilterCriteria } from '../../../../components/knowledge_indicators/utils/matches_knowledge_indicator_filters';
    ...
    <KnowledgeIndicatorSelectableFilter
      ...
      labels={{
        button: i18n.translate(
          'xpack.significantEventsApp.codeIntelligence.repositoryFilterLabel',
          {
            defaultMessage: 'Repository',
          }
        ),
        groupLabel: i18n.translate(
          'xpack.significantEventsApp.codeIntelligence.repositoryFilterGroupLabel',
          {
            defaultMessage: 'Filter by repository',
          }
        ),
        popoverAriaLabel: i18n.translate(
          'xpack.significantEventsApp.codeIntelligence.repositoryFilterPopoverLabel',
          { defaultMessage: 'Repository filter' }
        ),
        selectableAriaLabel: i18n.translate(
          'xpack.significantEventsApp.codeIntelligence.repositoryFilterSelectableAriaLabel',

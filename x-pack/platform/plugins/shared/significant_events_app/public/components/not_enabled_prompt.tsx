...
export function SignificantEventsNotEnabledPrompt({ reason }: { reason: NotEnabledReason }) {
  return (
    <EuiEmptyPrompt
      data-test-subj="significantEventsNotEnabledPrompt"
      iconType="bell"
      color="subdued"
      title={
        <h2>
          {i18n.translate('xpack.significantEventsApp.notEnabledPrompt.title', {

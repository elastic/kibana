...
> = {
  code: {
    label: i18n.translate('xpack.significantEventsApp.knowledgeIndicatorSourceBadge.codeLabel', {
      defaultMessage: 'Code',
    }),
    color: 'accent',
    tooltip: i18n.translate(
      'xpack.significantEventsApp.knowledgeIndicatorSourceBadge.codeTooltip',
      {
  ...
  logs: {
    label: i18n.translate('xpack.significantEventsApp.knowledgeIndicatorSourceBadge.logsLabel', {
      defaultMessage: 'Logs',
    }),
    color: 'hollow',
    tooltip: i18n.translate(
      'xpack.significantEventsApp.knowledgeIndicatorSourceBadge.logsTooltip',
      {
  ...
  both: {
    label: i18n.translate('xpack.significantEventsApp.knowledgeIndicatorSourceBadge.bothLabel', {
      defaultMessage: 'Code + Logs',
    }),
    color: 'success',
    tooltip: i18n.translate(
      'xpack.significantEventsApp.knowledgeIndicatorSourceBadge.bothTooltip',
      {
...
export function KnowledgeIndicatorSourceBadge({ source }: { source: KnowledgeIndicatorSource[] }) {
  ...
  return (
    <EuiToolTip content={tooltip}>
      <EuiBadge color={color} tabIndex={0}>
        {label}
      </EuiBadge>
    </EuiToolTip>
  );

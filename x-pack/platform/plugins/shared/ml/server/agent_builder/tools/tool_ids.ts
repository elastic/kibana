...
export const AD_GET_JOB_INFO_TOOL_ID = `${internalNamespaces.ml}.ad_get_job_info`;
...
export const CREATE_ML_CHARTS_TOOL_ID = `${internalNamespaces.ml}.create_ml_charts`;

...
const SOURCE_ARCHIVE = 'x-pack/platform/test/fixtures/es_archives/ml/module_apache';
const MODULE_ID = 'apache_ecs';
const DATA_VIEW = { name: 'ft_module_apache', timeField: '@timestamp' };

const EXPECTED: SetupModuleExpected = {
  responseCode: 200,
  jobs: [
    { jobId: 'pf3_low_request_rate_ecs', jobState: 'closed', datafeedState: 'stopped' },
    { jobId: 'pf3_source_ip_request_rate_ecs', jobState: 'closed', datafeedState: 'stopped' },
    { jobId: 'pf3_source_ip_url_count_ecs', jobState: 'closed', datafeedState: 'stopped' },
    { jobId: 'pf3_status_code_rate_ecs', jobState: 'closed', datafeedState: 'stopped' },
    { jobId: 'pf3_visitor_rate_ecs', jobState: 'closed', datafeedState: 'stopped' },
  ],
...
apiTest.describe(
  'setup_module: apache_ecs with startDatafeed true',
  ...
  () => {
    ...
    apiTest(
      'sets up apache_ecs module with datafeed and verifies saved objects',

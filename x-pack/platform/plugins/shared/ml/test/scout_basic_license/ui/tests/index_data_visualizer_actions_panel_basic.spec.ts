...
} from '../../../scout/ui/fixtures/test_setup';

test.describe('index based actions panel on basic license', { tag: tags.stateful.classic }, () => {
  ...
  test('view in discover page action', async ({ pageObjects }) => {

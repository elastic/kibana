...
export declare function getIndicesOptions(datafeedConfig?: Datafeed): Pick<import("@elastic/elasticsearch/lib/api/types").IndicesOptions, "ignore_unavailable" | "allow_no_indices" | "expand_wildcards">;

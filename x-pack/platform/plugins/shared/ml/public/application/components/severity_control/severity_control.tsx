...
export const SeverityControl: FC<SeveritySelectorProps> = React.memo(
  ({ value, onChange, disabled }) => {
    ...
    return (
      <EuiFormRow
        ...
        helpText={
          disabled
            ? i18n.translate('xpack.ml.severitySelector.disabledHelpText', {
                defaultMessage:
                  'This control is disabled because the anomaly filter includes a score condition.',
              })
            : undefined
        }
      >

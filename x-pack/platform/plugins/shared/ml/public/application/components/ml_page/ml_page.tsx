...
import * as jobsListRoutes from '../../routing/routes/jobs_list';
import * as newJobRoutes from '../../routing/routes/new_job';
...
export const MlPage: FC<{ pageDeps: PageDependencies; entryPoint?: string }> = React.memo(
  ({ pageDeps, entryPoint }) => {
    ...
    const routeList = useMemo(
      () => {
        if (entryPoint === 'jobs') {
          const jobsRoutes = [...Object.values(newJobRoutes), ...Object.values(jobsListRoutes)];
          return jobsRoutes

        ...
        <p>
          <EuiTextColor color="subdued">
            <FormattedMessage
              ...
              defaultMessage="If there are jobs or local models that do not have accompanying saved objects, they will be created in the current space."
            />
          </EuiTextColor>
        </p>
      </EuiText>
        ...
        <p>
          <EuiTextColor color="subdued">
            <FormattedMessage
              ...
              defaultMessage="If there are saved objects that do not have an accompanying job or local model, they will be deleted."
            />
          </EuiTextColor>
        </p>
      </EuiText>

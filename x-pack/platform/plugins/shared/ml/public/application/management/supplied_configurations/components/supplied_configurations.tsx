...
import { SuppliedConfigurations } from '../../../supplied_configurations/supplied_configurations';
...
export const SuppliedConfigurationsPage: FC<Props> = ({
  coreStart,
  share,
  history,
  spacesApi,
  ...
  return (
    ...
    >
      <EuiPageTemplate.Header
        pageTitle={
          <FormattedMessage
            id="xpack.ml.management.overview.suppliedConfigurationsPageTitle"

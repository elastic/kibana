export declare const useMlApi: () => {
    ...
    estimateBucketSpan(obj: import("@kbn/ml-common-types/job_service").BucketSpanEstimatorData): Promise<import("../../services/ml_api_service").BucketSpanEstimatorResponse>;
    validateJob(payload: {
    ...
    validateCardinality$(job: import("@kbn/ml-common-types/anomaly_detection_jobs/combined_job").CombinedJob): import("rxjs").Observable<import("../../services/ml_api_service").CardinalityValidationResults>;
    getDatafeeds(obj: {
        datafeedId: string;
    }): Promise<any>;
    ...
    deleteForecast({ jobId, forecastId }: {
        jobId: string;
        forecastId: string;
    }): Promise<import("../../services/ml_api_service").DeleteForecastResponse>;
    ...
    hasPrivileges(obj: any): Promise<import("../../services/ml_api_service").MlHasPrivilegesResponse>;
    ...
    mlInfo(): Promise<import("../../services/ml_api_service").MlInfoResponse>;
    ...
    getTimeFieldRange({ index, timeFieldName, query, runtimeMappings, indicesOptions, allowFutureTime, projectRouting, }: {
        ...
        projectRouting?: string;
    }): Promise<import("../../services/ml_api_service").GetTimeFieldRangeResponse>;
    esSearch(obj: any): Promise<any>;
    esSearch$(obj: any): import("rxjs").Observable<any>;
    getIndices(): Promise<{
        name: string;
    }[]>;
    getModelSnapshots(jobId: string, snapshotId?: string): Promise<import("../../services/ml_api_service").GetModelSnapshotsResponse>;
    ...
    dataFrameAnalytics: {
        getDataFrameAnalytics(analyticsId?: string, excludeGenerated?: boolean, size?: number): Promise<import("../../services/ml_api_service/data_frame_analytics").GetDataFrameAnalyticsResponse>;
        getDataFrameAnalyticsStats(analyticsId?: string): Promise<import("../../services/ml_api_service/data_frame_analytics").GetDataFrameAnalyticsStatsResponse>;
        ...
        jobsExist(analyticsIds: string[], allSpaces?: boolean): Promise<import("../../services/ml_api_service/data_frame_analytics").JobsExistsResponse>;
        ...
        deleteDataFrameAnalyticsAndDestIndex(analyticsId: string, deleteDestIndex: boolean, deleteDestDataView: boolean, force?: boolean): Promise<import("../../services/ml_api_service/data_frame_analytics").DeleteDataFrameAnalyticsWithIndexResponse>;
    ...
    results: {
        ...
        getCategoryDefinition(jobId: string, categoryId: string): Promise<import("../../services/ml_api_service/results").CategoryDefinition>;
        ...
        fetchPartitionFieldsValues(jobId: import("@kbn/ml-common-types/anomaly_detection_jobs/job").JobId, searchTerm: Record<string, string>, criteriaFields: Array<{
            fieldName: string;
            fieldValue: any;
        }>, earliestMs: number, latestMs: number, fieldsConfig?: import("@kbn/ml-common-types/storage").PartitionFieldsConfig): import("rxjs").Observable<import("../../services/results_service/result_service_rx").PartitionFieldsDefinition>;
    ...
    jobs: {
        ...
        getAllJobAndGroupIds(): Promise<import("../../services/job_service").ExistingJobsAndGroups>;
    ...
    jsonSchema: {
        getSchemaDefinition(params: import("../../services/ml_api_service/json_schema").GetSchemaDefinitionParams): Promise<object>;
    };
};

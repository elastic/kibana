        ...
        switch (config.vCPUUsage) {
          case 'low':
            return i18n.translate(
              ...
              {
                defaultMessage:
                  'This level limits resources to the minimum required for model to run if supported by your Cloud console selection. It may not be sufficient for a production application.',
              }
            );
          case 'medium':
            return i18n.translate(
        ...
        switch (config.vCPUUsage) {
          case 'low':
            return i18n.translate(
              ...
              {
                defaultMessage:
                  'This level sets resources to the minimum required for model to run if supported by your Cloud console selection. It may not be sufficient for a production application.',
              }
            );
          case 'medium':
            return i18n.translate(
        ...
        switch (config.vCPUUsage) {
          case 'low':
            return i18n.translate(
              ...
              {
                defaultMessage:
                  'This level sets resources to the minimum required for model to run. It may not be sufficient for a production application.',
              }
            );
          case 'medium':
            return i18n.translate(

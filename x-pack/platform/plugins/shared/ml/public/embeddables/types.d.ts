...
import type { AnomalyChartsEmbeddableOverridableState, AnomalyChartsEmbeddableState, SeverityThreshold } from '@kbn/ml-server-schemas/embeddables/anomaly_charts';
...
import type { EmbeddableApiContext, HasEditCapabilities, HasParentApi, HasType, PublishesUnifiedSearch, PublishingSubject, PublishesTimeRange, PublishesWritableTitle, PublishesDataViews } from '@kbn/presentation-publishing';
...
import type { AnomalyExplorerChartsEmbeddableType, AnomalySwimLaneEmbeddableType, MlEmbeddableTypes } from './constants';
export type { AnomalySwimLaneEmbeddableApi } from './anomaly_swimlane/types';
/**
 * Common API for all ML embeddables
 */
export interface MlEmbeddableBaseApi<StateType extends object = object> extends DefaultEmbeddableApi<StateType>, PublishesTimeRange {
}
...
export type EditSwimLaneActionApi = HasType<AnomalySwimLaneEmbeddableType> & Partial<HasParentApi<PublishesUnifiedSearch>>;
...
export type AnomalyChartsEmbeddableApi = MlEmbeddableBaseApi<AnomalyChartsEmbeddableState> & PublishesDataViews & PublishesWritableTitle & HasEditCapabilities & AnomalyChartsApi;
 ...
 */
export type SingleMetricViewerEmbeddableApi = MlEmbeddableBaseApi<SingleMetricViewerEmbeddableState> & PublishesWritableTitle & HasEditCapabilities & SingleMetricViewerComponentApi;
/**
 ...
 */
export type SingleMetricViewerRuntimeState = Omit<SingleMetricViewerEmbeddableState, 'id' | 'filters' | 'query' | 'refreshConfig' | 'forecastId'>;
...
export type MappedEmbeddableTypeOf<TEmbeddableType extends MlEmbeddableTypes> = TEmbeddableType extends AnomalyExplorerChartsEmbeddableType ? AnomalyChartsEmbeddableState : unknown;

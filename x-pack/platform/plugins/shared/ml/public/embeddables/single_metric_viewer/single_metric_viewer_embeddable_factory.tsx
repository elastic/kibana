...
import { initializeSingleMetricViewerControls, singleMetricViewerComparators } from './single_metric_viewer_controls_initializer';
...
export const getSingleMetricViewerEmbeddableFactory = (
  ...
  > = {
    ...
    buildEmbeddable: async ({ initialState, finalizeApi, uuid, parentApi }) => {
      ...
      const singleMetricManager = initializeSingleMetricViewerControls(initialState.rawState, titleManager.api);

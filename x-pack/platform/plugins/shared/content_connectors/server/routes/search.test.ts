...
describe('Elasticsearch Search', () => {
  ...
  describe('POST /internal/content_connectors/indices/{index_name}/search with query on request body', () => {
  ...
  describe('POST /internal/content_connectors/indices/{index_name}/search', () => {

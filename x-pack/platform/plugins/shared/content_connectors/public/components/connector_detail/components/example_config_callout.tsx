  ...
  <>
    <EuiCallOut
      ...
      title={i18n.translate(
        'xpack.contentConnectors.content.connectors.overview.connectorUnsupportedCallOut.title',
        {
    ...
    >
      ...
      <EuiText size="s">
        <FormattedMessage
          id="xpack.contentConnectors.content.connectors.overview.connectorUnsupportedCallOut.description"

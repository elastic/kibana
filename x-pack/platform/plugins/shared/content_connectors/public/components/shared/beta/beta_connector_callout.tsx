...
export const BetaConnectorCallout: React.FC = () => (
  <BetaCallOut
    title={i18n.translate('xpack.contentConnectors.betaConnectorCalloutTitle', {
      defaultMessage: 'Beta connector',
    })}
    description={i18n.translate('xpack.contentConnectors.betaConnectorCalloutDescription', {
      defaultMessage:

      ...
      ? [
          {
            ...
            name: i18n.translate(
              'xpack.contentConnectors.content.index.connector.syncRules.basicTabTitle',
              {
      ...
      ? [
          {
            ...
            name: i18n.translate(
              'xpack.contentConnectors.content.index.connector.syncRules.advancedTabTitle',
              {
  ...
  return (
    <EuiFlyout ownFocus onClose={() => setIsEditing(false)} aria-labelledby="rulesFlyout" size="l">
      <EuiFlyoutHeader>
        ...
        <EuiText size="s">
          {i18n.translate(
            'xpack.contentConnectors.content.index.connector.syncRules.flyout.description',
            {

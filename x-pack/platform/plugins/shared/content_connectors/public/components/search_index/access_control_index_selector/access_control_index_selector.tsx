...
export const DEFAULT_INDEX_SELECTOR_OPTIONS: AccessControlSelectorOption[] = [
  {
    description: i18n.translate(
      'xpack.contentConnectors.content.searchIndex.documents.selector.contentIndex.description',
      {
        defaultMessage: 'Browse documents ingested by content syncs',
      }
    ),
    title: i18n.translate(
      'xpack.contentConnectors.content.searchIndex.documents.selector.contentIndex.title',
      {
  ...
  {
    description: i18n.translate(
      'xpack.contentConnectors.content.searchIndex.documents.selector.accessControl.description',
      {
        defaultMessage: 'Browse access control lists ingested by access control syncs',
      }
    ),
    title: i18n.translate(
      'xpack.contentConnectors.content.searchIndex.documents.selector.accessControl.title',
      {

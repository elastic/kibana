...
import { uploadedFileAttachmentDefinition } from './uploaded_file_attachment';
...
export const registerAttachmentUiDefinitions = ({
  ...
  attachments.addAttachmentType(AttachmentType.uploadedFile, uploadedFileAttachmentDefinition);

...
> => {
  return {
    ...
    getAgentDescription: () => {
      return 'A visualization attachment contains a Lens visualization configuration. It can be rendered inline using <render_attachment id="..." /> and can also be added to dashboard compositions through dashboard panel-ingestion operations. It must be provided a time_range directly on the attachment.data with from and to fields.';
    },

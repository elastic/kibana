...
const VISUALIZATION_CE_TYPE = 'visualization';
...
export const visualizationContextEngineType: ContextEngineTypeDefinition = {
  id: VISUALIZATION_CE_TYPE,
  fetchFrequency: () => '1h',
  ...
  getContextEngineData: async (originId, context) => {
    try {
      ...
      context.logger.warn(
        `Context Engine visualization: failed to get data for '${originId}': ${

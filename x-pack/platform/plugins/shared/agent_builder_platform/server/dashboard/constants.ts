...
export const AGENT_BUILDER_OVERVIEW_DASHBOARD_VERSION = 3;
/** Placeholder in dashboard ES|QL queries replaced with the traces namespace pattern at install time. */

...
export const INTERNAL_ALERTING_GAPS_GET_SUMMARY_FOR_ALL_RULES_API_PATH =
  `${INTERNAL_ALERTING_GAPS_API_PATH}/_get_gaps_summary_for_all_rules` as const;

export const INTERNAL_ALERTING_GAPS_FILL_BY_ID_API_PATH =
  `${INTERNAL_ALERTING_GAPS_API_PATH}/_fill_by_id` as const;

export const INTERNAL_ALERTING_GAPS_GAP_AUTO_FILL_SCHEDULER_API_PATH =
  `${INTERNAL_ALERTING_GAPS_API_PATH}/gap_auto_fill_scheduler` as const;

...
export const OBSERVABILITY_CONSUMER_ID = 'observability';
export const STACK_ALERTS_CONSUMER_ID = 'stackAlerts';
export const MONITORING_HISTORY_LIMIT = 200;

export const DEPRECATED_ALERTING_CONSUMERS = [OBSERVABILITY_CONSUMER_ID, STACK_ALERTS_CONSUMER_ID];

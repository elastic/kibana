 ...
 * 2.0.
 */
import { transformScheduleToRRule } from './v1';

describe('transformScheduleToRRule', () => {
  it('transforms start and duration correctly', () => {
    expect(transformScheduleToRRule({ duration: '2h', start: '2021-05-10T00:00:00.000Z' })).toEqual(
      {
        duration: 7200000,
        rRule: {
          bymonth: undefined,
  ...
  it('transforms duration as indefinite correctly', () => {
    expect(transformScheduleToRRule({ duration: '-1', start: '2021-05-10T00:00:00.000Z' })).toEqual(
      {
        duration: -1,
        rRule: {
          bymonth: undefined,

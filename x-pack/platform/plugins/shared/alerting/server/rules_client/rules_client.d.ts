...
import type { SnoozeAlertInstanceParams, SnoozeAlertInstanceQuery, SnoozeAlertInstanceBody } from '../application/rule/methods/snooze_alert_instance/types';
...
export declare class RulesClient {
    ...
    clone: <Params extends RuleTypeParams = never>(params: CloneRuleParams) => Promise<import("@kbn/alerting-types").SanitizedRule<Params>>;
    create: <Params extends RuleTypeParams = never>(params: CreateRuleParams<Params>) => Promise<import("@kbn/alerting-types").SanitizedRule<Params>>;
    ...
    findMutedAlerts: (params?: FindMutedAlertsParams) => Promise<import("../application/rule/methods/find_muted_alerts").FindMutedAlertsResult>;
    get: <Params extends RuleTypeParams = never>(params: GetRuleParams) => Promise<import("@kbn/alerting-types").SanitizedRule<Params> | import("../types").SanitizedRuleWithLegacyId<Params>>;
    resolve: <Params extends RuleTypeParams = never>(params: ResolveParams) => Promise<import("@kbn/alerting-types").ResolvedSanitizedRule<Params>>;
    update: <Params extends RuleTypeParams = never>(params: UpdateRuleParams<Params>) => Promise<import("@kbn/alerting-types").SanitizedRule<Params>>;
    ...
    bulkCreateRules: <Params extends RuleTypeParams = never>(params: BulkCreateRulesParams<Params>) => Promise<import("..").BulkCreateRulesResult>;
    ...
    snooze: (options: SnoozeRuleOptions) => Promise<import("@kbn/alerting-types").SanitizedRule<never>>;
    ...
    unsnoozeAlertInstance: (options: UnsnoozeAlertParams) => Promise<void>;
    bulkUntrackAlerts: (options: BulkUntrackBody) => Promise<void>;
    runSoon: (options: RunSoonParams) => Promise<string | undefined>;
    listRuleTypes: (options?: ListRuleTypesOptions) => Promise<import("../authorization").RegistryAlertTypeWithAuth[]>;

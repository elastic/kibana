...
export declare function getRuleHistory(context: RulesClientContext, { module, ruleId, from, size, sort, filters }: GetRuleHistoryParams): Promise<GetRuleHistoryResult>;

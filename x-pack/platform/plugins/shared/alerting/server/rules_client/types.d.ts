...
import type { Logger, KibanaRequest, SavedObjectsClientContract, PluginInitializerContext, ISavedObjectsRepository, UiSettingsServiceStart } from '@kbn/core/server';
...
import type { RuleTypeRegistry, IntervalSchedule, RuleSnoozeSchedule, RawRuleAlertsFilter, RuleSystemAction, RuleAction } from '../types';

...
describe('snoozeRule change tracking', () => {
  ...
  const snoozeSchedule: SnoozeRuleOptions['snoozeSchedule'] = {
    id: 'snooze-1',
    duration: 28800000,
    rRule: {
      dtstart: '2030-01-01T00:00:00.000Z',
      count: 1,
      tzid: 'UTC',
    },
  };
  ...
  test('logs the change with action "rule_snooze" after the saved object update succeeds', async () => {

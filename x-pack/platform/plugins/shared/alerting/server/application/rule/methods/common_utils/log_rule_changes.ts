...
import type { LogChangeHistoryOptions, ObjectChangeUserActivity } from '@kbn/change-history';
  ...
  for (const ruleSO of effectiveRuleSOs) {
    ...
    try {
      ...
      changes.push({
        ...
        // Opt-in dual write: presence of this block makes @kbn/change-history also emit
        // one Kibana user-activity entry for this change after a successful ES write.
        ...(userActivityMapping
          ? {

...
export declare const ruleLastRunSchema: import("@kbn/config-schema").ObjectType<{
    ...
    warning: import("@kbn/config-schema").Type<"license" | "unknown" | "timeout" | "validate" | "disabled" | "execute" | "read" | "decrypt" | "maxExecutableActions" | "maxAlerts" | "maxQueuedActions" | "ruleExecution" | null | undefined>;

...
export declare const ruleLastRunSchema: import("@kbn/config-schema").ObjectType<{
    ...
    warning: import("@kbn/config-schema").Type<"disabled" | "execute" | "unknown" | "read" | "validate" | "timeout" | "decrypt" | "license" | "maxExecutableActions" | "maxAlerts" | "maxQueuedActions" | "ruleExecution" | null | undefined>;

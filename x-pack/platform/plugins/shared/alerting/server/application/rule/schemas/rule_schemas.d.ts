...
export declare const ruleLastRunSchema: import("@kbn/config-schema").ObjectType<{
    ...
    warning: import("@kbn/config-schema").Type<"execute" | "disabled" | "validate" | "unknown" | "license" | "timeout" | "read" | "decrypt" | "maxExecutableActions" | "maxAlerts" | "maxQueuedActions" | "ruleExecution" | null | undefined>;

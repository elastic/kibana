...
export declare const transformResolveResponse: <Params extends RuleParams = never>(rule: ResolvedRule<Params>) => {
    ...
    execution_status?: Readonly<{
        error?: Readonly<{} & {
            message: string;
            reason: "disabled" | "execute" | "unknown" | "read" | "validate" | "timeout" | "decrypt" | "license";
        }> | undefined;
        warning?: Readonly<{} & {
            message: string;
    ...
    last_run?: Readonly<{
        warning?: "disabled" | "execute" | "unknown" | "read" | "validate" | "timeout" | "decrypt" | "license" | "maxExecutableActions" | "maxAlerts" | "maxQueuedActions" | "ruleExecution" | null | undefined;

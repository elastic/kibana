  ...
  router.post(
    {
      ...
      options: {
        ...
        description:
          'Mutes an alert instance. When called with an optional request body, creates a conditional per-alert snooze with time-based expiry and/or field-change conditions.',

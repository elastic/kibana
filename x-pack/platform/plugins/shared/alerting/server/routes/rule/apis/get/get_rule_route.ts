  ...
  router.get(
    ...
    router.handleLegacyErrors(
      verifyAccessAndContext(licenseState, async function (context, req, res) {
        ...
        const includeInternalFlag =
          excludeFromPublicApi !== undefined ? !excludeFromPublicApi : false;
        const response: GetRuleResponseV1<RuleParamsV1> = {
          body: transformGetResponseV1<RuleParamsV1>(rule, includeArtifacts, includeInternalFlag),
        };

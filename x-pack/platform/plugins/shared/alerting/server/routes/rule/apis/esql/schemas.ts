...
import {
  ...
  validateHoursV1,
  validateTimezoneV1,
} from '../../../../../common/routes/rule/validation';
import { notifyWhenSchemaV1, alertDelaySchemaV1 } from '../../../../../common/routes/rule/response';
import { artifactsSchemaV1 } from '../../../../../common/routes/rule/request';
import { alertsFilterQuerySchemaV1 } from '../../../../../common/routes/alerts_filter_query';
import { flappingSchemaV1 } from '../../../../../common/routes/rule/common';
...
export const createESQLBodySchemaV1 = schema.object({
  name: schema.string({
    meta: {
      description:

...
import { getRuleTypesRoute } from './rule/apis/list_types/get_rule_types_route';
import { getRuleTypesInternalRoute } from './rule/apis/internal_list_types/get_rule_types_internal_route';

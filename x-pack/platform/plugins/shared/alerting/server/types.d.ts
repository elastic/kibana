...
export * from '../common';
import type { Rule, RuleTypeParams, RuleTypeState, ActionGroup, AlertInstanceContext, AlertInstanceState, WithoutReservedActionGroups, ActionVariable, SanitizedRuleConfig, SanitizedRule, RuleAlertData, Artifacts } from '../common';
...
export interface PublicMetricsSetters {
    ...
    setLastRunMetricsGapRange: (gapRange: {
        lte: string;
        gte: string;
    } | null) => void;
}

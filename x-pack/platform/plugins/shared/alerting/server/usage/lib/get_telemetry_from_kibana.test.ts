        ...
        aggregations: {
          ...
          sum_rules_snoozed_by_type: {
            ...
            by_alert_type: {
              ...
              buckets: [
                {
                  key: 'observability.rules.custom_threshold',
                  doc_count: 1,
                },
                {
                  key: 'slo.rules.burnRate',
                  doc_count: 1,
                },
              ],
            },
          ...
          sum_rules_with_elasticagent_tag: { value: 3 },
          ...
          sum_rules_with_api_key_created_by_user: { value: 3 },
        },
      });
  ...
  describe('getTotalCountInUse', () => {
    ...
    test('should return empty results and log debug log if query throws search_phase_execution_exception error', async () => {
      ...
      expect(loggerCalls.debug[0][0]).toEqual(
        `query for getTotalCountInUse - {\"index\":\"test\",\"track_total_hits\":true,\"size\":0,\"query\":{\"bool\":{\"filter\":[{\"term\":{\"type\":\"alert\"}},{\"term\":{\"alert.enabled\":true}}]}},\"aggs\":{\"namespaces_count\":{\"cardinality\":{\"field\":\"namespaces\"}},\"by_rule_type_id\":{\"terms\":{\"field\":\"alert.alertTypeId\",\"size\":39}},\"by_search_type\":{\"terms\":{\"field\":\"alert.params.searchType\"}}}}`
      );
      expect(loggerCalls.debug[1][0]).toMatchInlineSnapshot(`

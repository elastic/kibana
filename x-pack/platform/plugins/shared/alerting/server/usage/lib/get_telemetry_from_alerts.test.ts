...
describe('kibana index telemetry', () => {
  ...
  it('should return total alert counts and alert counts by rule type id', async () => {
    ...
    expect(debugLogs[0][0]).toEqual(
      `query for getTotalAlertsCountAggregations - {\"index\":\".alerts-*\",\"size\":0,\"query\":{\"match_all\":{}},\"aggs\":{\"by_rule_type_id\":{\"terms\":{\"field\":\"kibana.alert.rule.rule_type_id\",\"size\":33},\"aggs\":{\"ignored_field\":{\"terms\":{\"field\":\"_ignored\",\"size\":33}}}}}}`
    );

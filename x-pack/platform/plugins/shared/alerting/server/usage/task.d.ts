...
export declare function initializeAlertingTelemetry(logger: Logger, core: CoreSetup<AlertingPluginsStart>, taskManager: TaskManagerSetupContract, eventLogIndex: string): void;
export declare function scheduleAlertingTelemetry(logger: Logger, taskManager?: TaskManagerStartContract): void;
export declare function telemetryTaskRunner(logger: Logger, core: CoreSetup<AlertingPluginsStart>, eventLogIndex: string, taskManagerIndex: string): ({ taskInstance }: RunContext) => {
    run(): Promise<{
        state: Readonly<{

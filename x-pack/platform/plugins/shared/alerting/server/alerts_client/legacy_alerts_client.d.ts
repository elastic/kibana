...
export declare class LegacyAlertsClient<State extends AlertInstanceState, Context extends AlertInstanceContext, ActionGroupIds extends string, RecoveryActionGroupId extends string> implements IAlertsClient<{}, State, Context, ActionGroupIds, RecoveryActionGroupId> {
    ...
    initializeExecution({ maxAlerts, ruleLabel, startedAt, flappingSettings, activeAlertsFromState, recoveredAlertsFromState, snoozedInstances, }: InitializeExecutionOpts): Promise<void>;
    getAlert(id: string): import("..").Alert<State, Context, WithoutReservedActionGroups<ActionGroupIds, RecoveryActionGroupId>> | null | undefined;
    ...
    clearSnoozedStatusForAlerts(_conditionExpiredInstanceIds: string[]): Promise<void>;
    setAlertStatusToUntracked(): Promise<void>;
    getBuiltActiveAlertDataByInstanceId(_instanceId: string): undefined;

...
export function setupSavedObjects(
  ...
  savedObjects.registerType({
    ...
    snapshots: true, // <-- Creates the snapshot index for alerting rules. Note: This should be limited to detection rules.
    snapshotFilter: {
      alert: {
        name: true,
        tags: true,
        ...
        schedule: true,
        actions: true,
        params: true, // <-- This contains an object, so anything inside it will get included.
        mapped_params: true,
        createdBy: true,
        updatedBy: true,
        createdAt: false,
      ...
      managed: true,
      namespaces: true,
      coreMigrationVersion: true,
      typeMigrationVersion: true,
      updated_at: false,
      created_at: false,
    },
    hidden: true,

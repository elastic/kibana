export declare const rawRuleSnoozedInstanceSchema: import("@kbn/config-schema").ObjectType<Omit<{
    ...
    conditions: import("@kbn/config-schema").Type<(Readonly<{} & {
        ...
        value: "info" | "medium" | "high" | "low" | "critical";
...
export declare const rawRuleSchema: import("@kbn/config-schema").ObjectType<Omit<Omit<Omit<Omit<Omit<Omit<Omit<Omit<Omit<{

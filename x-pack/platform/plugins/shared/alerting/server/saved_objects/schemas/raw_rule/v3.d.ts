...
export declare const ISOWeekdaysSchema: import("@kbn/config-schema").Type<2 | 1 | 4 | 5 | 3 | 7 | 6>;
...
export declare const outcome: import("@kbn/config-schema").Type<"warning" | "succeeded" | "failed">;
export declare const rawRuleLastRunSchema: import("@kbn/config-schema").ObjectType<{
    outcome: import("@kbn/config-schema").Type<"warning" | "succeeded" | "failed">;

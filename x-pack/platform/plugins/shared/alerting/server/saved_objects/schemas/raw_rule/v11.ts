...
import { rawRuleSchema as rawRuleSchemaV10 } from './v10';

// v11: adds gap_reason to monitoring metrics.
// The monitoring schema is fully redefined here (same pattern as v4 extending v3)
// because schema.object().extends() only works on top-level keys,
// not on deeply nested fields like run.last_run.metrics.
...
export const rawRuleSchema = rawRuleSchemaV10.extends({

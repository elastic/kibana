...
export { atomicRemoveSnoozedInstancesWithEs, partiallyUpdateRule, partiallyUpdateRuleWithEs, type ExpiredSnoozedInstance, } from './partially_update_rule';
...
export type AdHocRunAttributesNotPartiallyUpdatable = 'rule' | 'spaceId' | 'apiKeyToUse' | 'uiamApiKey';

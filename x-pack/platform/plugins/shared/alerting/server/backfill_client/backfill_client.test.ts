...
import { type SavedObject, type SavedObjectsBulkResponse } from '@kbn/core/server';
...
const mockCreatePointInTimeFinderAsInternalUser = (
  response = {
    saved_objects: [
      { id: 'abc', type: AD_HOC_RUN_SAVED_OBJECT_TYPE, attributes: getMockAdHocRunAttributes() },
    ],
  }
) => {

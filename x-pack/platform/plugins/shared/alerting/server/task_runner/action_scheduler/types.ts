...
> {
   ...
   * invalidation task's in-use guard can find them. Supplied only when `apiKey` resolved to the
   * UIAM key rather than to an Elasticsearch fallback — see `credentialType` from

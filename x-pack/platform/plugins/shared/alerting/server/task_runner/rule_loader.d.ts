...
export declare function getFakeKibanaRequest(context: TaskRunnerContext, spaceId: string, apiKey: RawRule['apiKey'], uiamApiKey?: RawRule['uiamApiKey']): import("@kbn/core-http-server").KibanaRequest<unknown, unknown, unknown, any>;
export {};

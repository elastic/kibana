...
import { type RuleExecutionStatus, type RuleLastRun } from '../../../common';
import { type ElasticsearchError } from '../../lib';
import { type ILastRun, lastRunFromError, lastRunFromState } from '../../lib/last_run_status';
import { map, type Result } from '../../lib/result_type';
import {
  executionStatusFromError,
  executionStatusFromState,
  type IExecutionStatusAndMetrics,

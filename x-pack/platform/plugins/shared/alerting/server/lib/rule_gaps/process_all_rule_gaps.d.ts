 ...
 */
export declare const processAllRuleGaps: <T>({ ruleIds, start, end, statuses, options, logger, eventLogClient, processGapsBatch, }: ProcessAllRuleGapsParams<T>) => Promise<void>;
export {};

...
export declare function processRuleBatches({ signal, gapsPerPage, gapFetchMaxIterations, logger, loggerMessage, logEvent, remainingBackfills, ruleIds, rulesBatchSize, rulesClient, rulesClientContext, sortOrder, startISO, endISO, taskInstanceId, numRetries, excludedReasons, }: {
    signal: AbortSignal;
    gapsPerPage: number;
...
export declare function processGapsForRules({ signal, aggregatedByRule, endISO, gapsPerPage, gapFetchMaxIterations, logger, loggerMessage, logEvent, remainingBackfills, rulesClientContext, sortOrder, startISO, taskInstanceId, toProcessRuleIds, numRetries, excludedReasons, }: {
    signal: AbortSignal;
    aggregatedByRule: Map<string, AggregatedByRuleEntry>;
    endISO: string;
    gapsPerPage: number;

...
export declare function processRuleBatches({ abortController, gapsPerPage, gapFetchMaxIterations, logger, loggerMessage, logEvent, remainingBackfills, ruleIds, rulesBatchSize, rulesClient, rulesClientContext, sortOrder, startISO, endISO, taskInstanceId, numRetries, }: {
...
export declare function processGapsForRules({ abortController, aggregatedByRule, endISO, gapsPerPage, gapFetchMaxIterations, logger, loggerMessage, logEvent, remainingBackfills, rulesClientContext, sortOrder, startISO, taskInstanceId, toProcessRuleIds, numRetries, }: {
    abortController: AbortController;
    aggregatedByRule: Map<string, AggregatedByRuleEntry>;
    endISO: string;
    gapsPerPage: number;

...
export declare function createAlertFactory<State extends AlertInstanceState, Context extends AlertInstanceContext, ActionGroupIds extends string>({ alerts, logger, configuredMaxAlerts, autoRecoverAlerts, canSetRecoveryContext, snoozedInstancesMap, }: CreateAlertFactoryOpts<State, Context>): AlertFactory<State, Context, ActionGroupIds>;

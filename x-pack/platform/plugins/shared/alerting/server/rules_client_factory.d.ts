...
export declare class RulesClientFactory {
     ...
     */
    create(request: KibanaRequest, savedObjects: SavedObjectsServiceStart): Promise<RulesClient>;
    /**
     ...
     */
    createWithSpaceId(request: KibanaRequest, savedObjects: SavedObjectsServiceStart, spaceId: string): Promise<RulesClient>;
    /**

...
const STREAMS_SIGNIFICANT_EVENTS_INSIGHT_FEEDBACK_EVENT_TYPE =
  'streams-significant-events-insight-feedback';
const STREAMS_SIGNIFICANT_EVENTS_INVESTIGATION_FEEDBACK_EVENT_TYPE =
  'streams-significant-events-investigation-feedback';

    ...
    async ({ signal }) => {
      return streamsRepositoryClient
        ...
        .then((response) => {
          ...
          if (
            Streams.GroupStream.GetResponse.is(response) ||
            Streams.QueryStream.GetResponse.is(response)
          ) {
            return response;
          }

          throw new Error('Stream detail only supports Ingest, Query and Group streams.');
        });
    },

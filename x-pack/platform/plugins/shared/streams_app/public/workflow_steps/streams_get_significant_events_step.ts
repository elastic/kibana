...
export const streamsGetSignificantEventsStepDefinition: PublicStepDefinition = {
  ...
  label: i18n.translate('xpack.streams.streamsGetSignificantEventsStep.label', {
    defaultMessage: 'Get Significant Events',
  }),
  description: i18n.translate('xpack.streams.streamsGetSignificantEventsStep.description', {
    defaultMessage: 'Retrieve significant events for a stream within a time range',
  }),
  actionsMenuGroup: ActionsMenuGroup.kibana,
  documentation: {
    details: i18n.translate('xpack.streams.streamsGetSignificantEventsStep.documentation.details', {

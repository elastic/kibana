...
describe('LifecycleSummary', () => {
  ...
  describe('ILM Lifecycle', () => {
    ...
    it('gives the "Add data phase" button an accessible name matching its visible label', () => {
      ...
      // The accessible name must match the visible text (WCAG 2.5.3 Label in Name).
      const addPhaseButton = screen.getByTestId('dataLifecycleSummaryAddPhaseButton');
      expect(addPhaseButton).toHaveAccessibleName('Add data phase');
    });

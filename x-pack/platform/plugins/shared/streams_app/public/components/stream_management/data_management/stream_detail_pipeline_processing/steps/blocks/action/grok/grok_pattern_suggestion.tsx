...
import type { GrokFormState, GrokPatternField } from '../../../../types';
...
const getPatternValue = (pattern: string | GrokPatternField): string =>
...
export const GrokPatternAISuggestions = ({
  ...
  const fieldValue = useWatch<GrokFormState, 'field'>({ name: 'field' });
...
export function GrokPatternSuggestion({
  ...
  const patterns = grokProcessor.patterns.map(getPatternValue);
  return (
    <EuiCallOut
      iconType="sparkles"

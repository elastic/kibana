...
export type SimulationEvent =
  ...
  | { type: 'simulation.receive_steps'; steps: PipelineStepWithUIAttributes[] }
  | { type: 'simulation.updateSteps'; steps: PipelineStepWithUIAttributes[] }
  | { type: 'simulation.reset' }
  | { type: 'step.change'; steps: PipelineStepWithUIAttributes[] }
  | { type: 'step.delete'; steps: PipelineStepWithUIAttributes[] };

...
// blocks are kept from the copied Streams UI until ingest pipelines can
...
export const WhereBlockSummary = ({
  ...
  if (!isPipelineConditionStep(step)) return null;
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {i18n.translate(
              'xpack.streams.streamDetailEnrichment.whereBlockSummary.parkedConditionLabel',
              {
                defaultMessage: 'WHERE condition',
              }
            )}
          </EuiButtonEmpty>
        </EuiToolTip>

...
export const ActionBlockListItem = (props: ActionBlockProps) => {
  ...
  if (!isPipelineProcessorStep(step)) return null;
                ...
                <EuiFlexGroup alignItems="center" gutterSize="xs">
                  ...
                  {hasValidationErrors && (
                    <EuiFlexItem>
                      ...
                      >
                        <EuiBadge tabIndex={0} color="danger" iconType="warning">
                          {i18n.translate(
          ...
          >
            {step.action === 'drop' ? (
              <EuiText size="s">
                {step.if
                  ? i18n.translate(
                      'xpack.streams.streamDetailView.managementTab.enrichment.dropProcessorWithIfDescription',
                      {
                        defaultMessage: 'Drops documents when {condition}',
                        values: {
                          condition:
                            typeof step.if === 'string' ? step.if : JSON.stringify(step.if),
                        },
                      }
                    )
                  : i18n.translate(

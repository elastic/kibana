...
jest.mock('../../../../../hooks/common/use_ai_features', () => ({
  useAIFeatures: () => null,
}));

// Mock the useStreamsPrivileges hook
jest.mock('../../../../../hooks/common/use_streams_privileges');
...
jest.mock(
  '../../../../sig_events/stream_detail_systems/stream_systems/hooks/use_stream_systems',
  () => ({
    useStreamSystems: () => ({
      systems: [],
...
jest.mock('../../../../../hooks/sig_events/use_stream_systems_api', () => ({
  useStreamSystemsApi: () => ({
...
jest.mock('../../../../common/connector_list_button/connector_list_button', () => ({

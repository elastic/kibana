import type { FieldDefinitionConfig, FieldDefinitionConfigAdvancedParameters, Streams } from '@kbn/streams-schema';
...
export declare const isSchemaFieldTyped: (field: SchemaField) => field is MappedSchemaField;

 ...
 */
export declare function createOriginalGrokFieldValuesMap(previewDocuments: FlattenRecord[], originalSamples: SampleWithDataSource[], grokField: string): WeakMap<FlattenRecord, string | undefined>;
/**
 ...
 */
export declare function getGrokFieldDisplayValue(document: SampleDocument | FlattenRecord, columnId: string, grokField: string, originalGrokFieldValues?: WeakMap<FlattenRecord, string | undefined>): string | undefined;
/**
 ...
 */
export declare function hasPrecedingProcessorTouchedField(stepIds: string[], currentStepId: string | undefined, processorsMetrics: Record<string, ProcessorMetrics> | undefined, grokSourceField: string): boolean;
/**
 ...
 */
export declare function grokExpressionOverwritesSourceField(grokExpressions: DraftGrokExpression[], sourceField: string): boolean;

...
type StreamEnrichmentMachineInternal = ReturnType<typeof streamEnrichmentMachineSetup.createMachine>;

const streamEnrichmentMachineInternal =
  streamEnrichmentMachineSetup.createMachine({

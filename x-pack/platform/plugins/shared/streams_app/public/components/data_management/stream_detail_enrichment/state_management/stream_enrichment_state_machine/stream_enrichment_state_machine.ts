...
// Use an IIFE to hide the setup const from module scope, avoiding TS4023/TS7056
// errors when TypeScript tries to serialize the complex inferred xstate types.
...
export type StreamEnrichmentMachine = typeof streamEnrichmentMachineInternal;

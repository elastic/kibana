      ...
      if (phases.frozen) {
        desc.push({
          description: i18n.translate('xpack.streams.phases.frozen', {
            defaultMessage:
              'Frozen {previosStartAge, select, undefined {indefinite} other {till {previosStartAge}}}',
      ...
      if (phases.cold) {
        desc.push({
          description: i18n.translate('xpack.streams.phases.cold', {
            defaultMessage:
              'Cold {previosStartAge, select, undefined {indefinite} other {till {previosStartAge}}}',
            values: { previosStartAge },
          }),
      ...
      if (phases.warm) {
        desc.push({
          description: i18n.translate('xpack.streams.phases.warm', {
            defaultMessage:
              'Warm {previosStartAge, select, undefined {indefinite} other {till {previosStartAge}}}',
            values: { previosStartAge },
          }),
      ...
      if (phases.hot) {
        desc.push({
          description: i18n.translate('xpack.streams.phases.hot', {
            defaultMessage:
              'Hot {previosStartAge, select, undefined {indefinite} other {till {previosStartAge}}}',
            values: { previosStartAge },
          }),

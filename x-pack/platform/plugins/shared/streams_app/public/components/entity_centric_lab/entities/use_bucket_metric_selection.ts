...
// Bumped to v4 to drop persisted Custom/Steps colouring that was seeded
// by picker mount (wrong thresholds / a Gradient ramp). v3 had already
// reset Color-by to Health; this pass also resets per-bucket palette
// config so unedited Steps can match Automatic again. Older keys are
// left behind so rolling back a lab build keeps prior setups.
const STORAGE_KEY = 'entityCentricLab.bucketMetricSelection.v4';

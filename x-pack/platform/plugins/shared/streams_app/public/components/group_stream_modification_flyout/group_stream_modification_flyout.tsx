...
import { RelationshipsTab } from './relationship_tab';
import type { GroupStreamFormData } from './types';

type GroupStreamModificationFlyoutTabId = 'overview' | 'relationships' | 'dashboards';
...
export function GroupStreamModificationFlyout({
  ...
  const [formData, setFormData] = React.useState<GroupStreamFormData>({
    ...
    runbookLinks: existingStream?.group.runbook_links ?? [],
    documentationLinks: existingStream?.group.documentation_links ?? [],
    repositoryLinks: existingStream?.group.repository_links ?? [],
          ...
          body: {
            ...
            stream: {
              ...
              group: {
                ...
                runbook_links: formData.runbookLinks,
                documentation_links: formData.documentationLinks,
                repository_links: formData.repositoryLinks,
                relationships: mergeRelationships(formData),
              },
            },
          },
        },
  ...
  const tabs: GroupStreamModificationFlyoutTab[] = [
    ...
    {
      id: 'relationships',
      name: i18n.translate('xpack.streams.groupStreamModificationFlyout.relationshipsTabLabel', {
...
function mergeRelationships(formData: GroupStreamFormData) {

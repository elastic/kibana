...
export interface AwsCatalogIntegrationParametersProps {
  ...
  /** When true, omit the section title (e.g. when wrapped in a parent EuiStep). */
...
export const AwsCatalogIntegrationParameters: React.FC<AwsCatalogIntegrationParametersProps> = ({
  catalog,
  selectedServiceIds,
  values,
  onValuesChange,
  ...
  return (
    <div
      data-test-subj="awsOnboardingIntegrationParameters"
      style={hideSectionHeader ? undefined : { paddingTop: 32 }}
    >

...
import { useTimeRangeUpdate } from '../../../hooks/common/use_time_range_update';
...
jest.mock('../../../hooks/common/use_time_range');
jest.mock('../../../hooks/common/use_time_range_update');
jest.mock('../../../hooks/common/use_timefilter');

...
test.describe('Stream data processing - simulation preview', { tag: ['@ess', '@svlOblt'] }, () => {
  ...
  // Regression test for https://github.com/elastic/observability-error-backlog/issues/440
  // When a document flyout is open and the user changes the preview filter, the flyout
  // should not crash due to out-of-bounds array access

...
test.describe(
  ...
  () => {
    ...
    test.beforeAll(async ({ logsSynthtraceEsClient }, testInfo) => {
      ...
      classicStreamName = getUniqueClassicStreamName(testInfo, 'classic-test');
    ...
    test.beforeEach(async ({ apiServices, browserAuth, pageObjects }) => {
      ...
      await safeClearStreamMappings(apiServices, classicStreamName);

      await pageObjects.streams.gotoSchemaEditorTab(classicStreamName);

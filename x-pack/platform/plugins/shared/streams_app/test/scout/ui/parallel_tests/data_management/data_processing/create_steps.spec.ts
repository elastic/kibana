...
test.describe('Stream data processing - creating steps', { tag: ['@ess', '@svlOblt'] }, () => {
  ...
  test.beforeAll(async ({ logsSynthtraceEsClient }, testInfo) => {
    // Generate unique classic stream name for this worker
    classicStreamName = getUniqueClassicStreamName(testInfo, 'processing');
  ...
  test.beforeEach(async ({ apiServices, browserAuth, pageObjects }) => {
    ...
    await pageObjects.streams.gotoProcessingTab(classicStreamName);
  });

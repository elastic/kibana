...
import type { WebhookSecretConfigurationSchema } from '../../../common/auth/schema';
...
// secrets definition
export type ConnectorTypeSecretsType = TypeOf<typeof WebhookSecretConfigurationSchema>;

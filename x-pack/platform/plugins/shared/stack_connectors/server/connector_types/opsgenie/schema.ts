...
export const CloseAlertParamsSchema = z.object({
  alias: z.string(),
 ...
 */
export const CreateAlertParamsSchema = z.object({
  message: z
    .string()
    .min(1)
    .max(130)
  ...
  responders: z
    .array(
      z.union([
        ...
        z.object({ id: z.string(), type: responderTypes }),
        /**
         ...
         */
        z.object({ username: z.string(), type: z.literal('user') }),
      ])
    )
    .max(50)
    .optional(),

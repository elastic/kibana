...
/**
 * Aggregates `action` saved objects on `actionTypeId` and `specVersion`. Used at boot to
 * materialize every version a saved connector still needs and by health to detect missing pins.
 */

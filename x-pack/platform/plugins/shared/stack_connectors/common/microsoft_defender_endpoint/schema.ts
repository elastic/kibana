...
// ----------------------------------
export const MicrosoftDefenderEndpointConfigSchema = z.object({
...
export const MicrosoftDefenderEndpointSecretsSchema = z.object({
...
export const TestConnectorParamsSchema = z.object({});

export const AgentDetailsParamsSchema = z.object({
  id: z.string().min(1),
});
...
export const IsolateHostParamsSchema = z.object({
  id: z.string().min(1),
  comment: z.string().min(1),
});

export const ReleaseHostParamsSchema = z.object({
  id: z.string().min(1),
  comment: z.string().min(1),
});

export const RunScriptParamsSchema = z.object({
  id: z.string().min(1),
...
export const GetActionResultsParamsSchema = z.object({
  id: z.string().min(1),
});
...
const ReleaseHostSchema = z.object({

...
/**
 * This schema must match the CloseAlertParamsSchema in x-pack/platform/plugins/shared/stack_connectors/server/connector_types/stack/jira-service-management/schema.ts

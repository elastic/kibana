...
interface PriorityComponentProps {
  priority: JiraServiceManagementCreateAlertParams['priority'];
...
const PriorityComponent: React.FC<PriorityComponentProps> = ({ priority, onChange }) => {
  ...
  return (
    <EuiFormRow
      ...
      data-test-subj="jsm-priority-row"
      labelAppend={OptionalFieldLabel}
    >
      <EuiSelect
        fullWidth
        data-test-subj="jsm-prioritySelect"
...
const priorityOptions = [
  {
    ...
    ['data-test-subj']: 'jsm-priority-p1',
  },
  {
    value: 'P2',
    text: i18n.PRIORITY_2,
    ['data-test-subj']: 'jsm-priority-p2',
  },
  {
    value: 'P3',
    text: i18n.PRIORITY_3,
    ['data-test-subj']: 'jsm-priority-p3',
  },
  {
    value: 'P4',
    text: i18n.PRIORITY_4,
    ['data-test-subj']: 'jsm-priority-p4',
  },
  {
    value: 'P5',
    text: i18n.PRIORITY_5,
    ['data-test-subj']: 'jsm-priority-p5',
  },
];

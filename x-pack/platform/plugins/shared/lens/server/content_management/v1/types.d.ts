...
import type { GetResultSO, SOWithMetadata, SOWithMetadataPartial } from '@kbn/content-management-utils';
import type { CreateIn, CreateResult, DeleteIn, DeleteResult, GetIn, SearchIn, SearchResult, UpdateIn, UpdateResult } from '@kbn/content-management-plugin/common';
import type { LENS_CONTENT_TYPE } from '@kbn/lens-common/content_management/constants';
import type { lensItemAttributesSchemaV1, lensCMCreateOptionsSchema, lensCMUpdateOptionsSchema, lensCMSearchOptionsSchema, lensItemSchemaV1 } from './schema';

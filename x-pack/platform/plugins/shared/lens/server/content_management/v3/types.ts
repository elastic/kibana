...
import type { LensAttributesV2 } from '../../../common/content_management/v2';

export type LensAttributes = TypeOf<typeof lensItemAttributesSchemaV3>;
export type LensItem = TypeOf<typeof lensItemSchemaV3>;
...
export type LensCreateIn = CreateIn<
  LENS_CONTENT_TYPE,
  LensAttributes | LensAttributesV0 | LensAttributesV1 | LensAttributesV2,
  LensCreateOptions
>;

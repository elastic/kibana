...
export type LensAttributes = z.output<typeof lensItemAttributesSchemaV1>;
export type LensItem = z.output<typeof lensItemSchemaV1>;

export type LensCreateOptions = z.output<typeof lensCMCreateOptionsSchema>;
export type LensUpdateOptions = z.output<typeof lensCMUpdateOptionsSchema>;
export type LensSearchOptions = z.output<typeof lensCMSearchOptionsSchema>;

...
import { lensItemAttributesSchemaV2 } from '../../v2';
import { lensItemAttributesSchemaV3, lensSavedObjectSchemaV3 } from './common';
...
export const lensCMCreateBodySchema = z
  .object({
    ...
    data: z.union([
      ...
      lensItemAttributesSchemaV2, // Temporarily permit passing old v2 SO attributes on create
      lensItemAttributesSchemaV3,
    ]),
  })
  .strict();

export const lensCMCreateResultSchema = createResultSchema(lensSavedObjectSchemaV3);

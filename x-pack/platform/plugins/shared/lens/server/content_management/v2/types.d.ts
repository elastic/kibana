...
import type { lensItemAttributesSchemaV2, lensCMCreateOptionsSchema, lensCMUpdateOptionsSchema, lensCMSearchOptionsSchema, lensItemSchemaV2 } from './schema';
...
export type LensCreateIn = CreateIn<LENS_CONTENT_TYPE, LensAttributes | LensAttributesV0 | LensAttributesV1, LensCreateOptions>;
export type LensCreateOut = CreateResult<LensSavedObject>;
export type LensUpdateIn = UpdateIn<LENS_CONTENT_TYPE, LensAttributes | LensAttributesV0 | LensAttributesV1, LensUpdateOptions>;

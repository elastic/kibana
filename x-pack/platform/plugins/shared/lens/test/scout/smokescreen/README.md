...
reproduce yet; they no longer run in the plain stateful FTR config. `dimension_editor.ts` is still
loaded for both stateful FTR and CCS until that FTR file is unwired.

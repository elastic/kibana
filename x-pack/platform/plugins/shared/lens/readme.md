...
- Performance journeys:
  - Run `node scripts/functional_tests_server.js --config x-pack/platform/test/performance/journeys_e2e/data_stress_test_lens/config.ts`
  - Run `node scripts/functional_test_runner --config x-pack/platform/test/performance/journeys_e2e/data_stress_test_lens/config.ts`

...
import type { TypedLensSerializedState, Visualization, FramePublicAPI, DatasourceDimensionEditorProps, UserMessagesGetter, AddLayerFunction, RegisterLibraryAnnotationGroupFunction, StateSetter, DragDropOperation, VisualizationDimensionGroupConfig, LensInspector } from '@kbn/lens-common';
...
export interface LayerPanelProps extends LensConfigPanelBaseProps {
    ...
    updateDatasource: (datasourceId: string | undefined, newState: unknown, dontSyncLinkedDimensions?: boolean) => void;
    ...
    onCloneLayer: () => void;
    onRemoveDimension: (props: {
        columnId: string;
        layerId: string;
    }) => void;
    toggleFullscreen: () => void;
    onEmptyDimensionAdd: (columnId: string, group: {
        groupId: string;
    }) => void;

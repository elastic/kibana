...
}) & import("reselect-v4/es").OutputSelectorFields<(args_0: import("@kbn/es-query").Query | import("@kbn/es-query").AggregateQuery, args_1: import("@kbn/es-query").Filter[], args_2: import("@kbn/lens-common").DateRange, args_3: import("@kbn/es-query").ProjectRouting) => {
    now: number;
    dateRange: import("@kbn/lens-common").DateRange;
    query: import("@kbn/es-query").Query | import("@kbn/es-query").AggregateQuery;
    filters: import("@kbn/es-query").Filter[];
...
export declare const selectExecutionContextSearch: ((state: LensState) => {
    ...
    projectRouting: import("@kbn/es-query").ProjectRouting;
}) & import("reselect-v4/es").OutputSelectorFields<(args_0: {
    now: number;
    dateRange: import("@kbn/lens-common").DateRange;
    query: import("@kbn/es-query").Query | import("@kbn/es-query").AggregateQuery;
    filters: import("@kbn/es-query").Filter[];
...
export declare const selectCurrentVisualization: ((state: LensState) => import("@kbn/lens-common").VisualizationState) & import("reselect-v4/es").OutputSelectorFields<(args_0: import("@kbn/lens-common").VisualizationState, args_1: import("@kbn/lens-common").PreviewState | undefined) => import("@kbn/lens-common").VisualizationState, {
    clearCache: () => void;
}> & {
    clearCache: () => void;
};
export declare const selectCurrentDatasourceStates: ((state: LensState) => import("@kbn/lens-common").DatasourceStates) & import("reselect-v4/es").OutputSelectorFields<(args_0: import("@kbn/lens-common").DatasourceStates, args_1: import("@kbn/lens-common").PreviewState | undefined) => import("@kbn/lens-common").DatasourceStates, {
    clearCache: () => void;
}> & {
    clearCache: () => void;
};
export declare const selectAreDatasourcesLoaded: ((state: LensState) => boolean) & import("reselect-v4/es").OutputSelectorFields<(args_0: import("@kbn/lens-common").DatasourceStates) => boolean, {
    clearCache: () => void;
}> & {
    clearCache: () => void;
};
export declare const selectDatasourceLayers: ((state: LensState, dependencies: DatasourceMap) => Partial<Record<string, import("@kbn/lens-common").DatasourcePublicAPI>>) & import("reselect-v4/es").OutputSelectorFields<(args_0: import("@kbn/lens-common").DatasourceStates, args_1: DatasourceMap, args_2: import("@kbn/lens-common").DataViewsState) => Partial<Record<string, import("@kbn/lens-common").DatasourcePublicAPI>>, {
    clearCache: () => void;
}> & {
    clearCache: () => void;
};
...
}) & import("reselect-v4/es").OutputSelectorFields<(args_0: import("@kbn/lens-common").DatasourceStates, args_1: import("@kbn/lens-common").TableInspectorAdapter | undefined, args_2: DatasourceMap, args_3: import("@kbn/lens-common").DataViewsState, args_4: {
    now: number;
    dateRange: import("@kbn/lens-common").DateRange;
    query: import("@kbn/es-query").Query | import("@kbn/es-query").AggregateQuery;
    filters: import("@kbn/es-query").Filter[];

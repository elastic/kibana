...
import type { TypedLensSerializedState, FramePublicAPI, UserMessagesGetter, LensDocument, LensInspector, LensDatasourceId } from '@kbn/lens-common';
...
export interface EditConfigPanelProps {
    ...
    updatePanelState: (datasourceState: unknown, visualizationState: unknown, visualizationId?: string, 
    /** When restoring state (e.g. on cancel), pass the datasource the state belongs to. */
    datasourceId?: LensDatasourceId) => void;
    ...
    onApply?: (attrs: TypedLensSerializedState['attributes']) => Promise<TypedLensSerializedState['attributes'] | void> | void;

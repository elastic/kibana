...
export { AxisBoundsControl, validateAxisDomain, validateZeroInclusivityExtent, hasNumericHistogramDimension, getDataBounds, axisExtentConfigToExpression, } from './axis/extent';

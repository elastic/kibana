...
export declare const getUsageCollectionStart: import("@kbn/kibana-utils-plugin/common").Get<UsageCollectionStart>, setUsageCollectionStart: import("@kbn/kibana-utils-plugin/common").Set<UsageCollectionStart>;
/** @internal **/

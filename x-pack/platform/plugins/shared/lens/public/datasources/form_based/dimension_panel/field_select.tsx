    ...
    <FieldPicker<FieldChoiceWithOperationType>
      activeField={
        (selectedOperationType && selectedField
          ...
          : undefined) as unknown as UiFieldOption<FieldChoiceWithOperationType>
      }
      options={memoizedFieldOptions as Array<UiFieldOption<FieldChoiceWithOperationType>>}
      onChoose={(choice) => {

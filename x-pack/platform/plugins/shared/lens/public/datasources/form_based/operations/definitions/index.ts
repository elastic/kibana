...
import { type IUiSettingsClient, type HttpSetup, type CoreStart } from '@kbn/core/public';
...
import { type DataViewDragDropOperation, type FormBasedLayer } from '../../types';
import { type DateRange, type LayerType } from '../../../../../common/types';
import { rangeOperation } from './ranges';
import { type FormBasedDimensionEditorProps, type OperationSupportMatrix } from '../../dimension_panel';

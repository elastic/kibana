...
import { type EuiFormRowProps, EuiSpacer, EuiComboBox, type EuiComboBoxOptionOption } from '@elastic/eui';
...
import { type FieldChoiceWithOperationType, FieldSelect } from './field_select';

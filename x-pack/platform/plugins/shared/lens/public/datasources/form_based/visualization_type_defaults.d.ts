import { type FormBasedPrivateState, type LensDocument } from '@kbn/lens-common';
 ...
 */
export declare function applyVisualizationTypeDatasourceDefaults(context: VisualizationTypeDefaultsContext): FormBasedPrivateState;
export {};

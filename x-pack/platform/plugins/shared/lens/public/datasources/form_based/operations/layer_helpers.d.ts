...
import type { TimeScaleUnit, DateRange, FormBasedLayer, GenericIndexPatternColumn, FormBasedPrivateState, IndexPattern, IndexPatternField, VisualizationDimensionGroupConfig, BaseIndexPatternColumn, DatasourceFixAction } from '@kbn/lens-common';
...
export declare function replaceColumn({ layer, columnId, indexPattern, op, field, visualizationGroups, initialParams, shouldResetLabel, shouldCombineField, columnParams, }: ColumnChange): FormBasedLayer;

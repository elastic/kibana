...
import { type PaletteOutput, type PaletteRegistry } from '@kbn/coloring';
...
import { type PieLayerState, type PieVisualizationState, EmptySizeRatios } from '../../../common/types';
import {
  CategoryDisplay,
  LegendDisplay,
  NumberDisplay,

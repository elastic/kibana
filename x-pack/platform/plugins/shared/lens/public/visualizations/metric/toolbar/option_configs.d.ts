...
import type { PrimaryMetricFontSize, IconPosition, Alignment, PrimaryMetricPosition, MetricDensity } from '@kbn/lens-common';
...
export declare const densityOptions: Array<EuiButtonGroupOptionProps & {
    id: MetricDensity;
}>;

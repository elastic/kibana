...
export const convertToOtherColorMappingFn = (state: XYVisualizationState): XYVisualizationState => {
  ...
  return { ...state, layers: convertedLayers } satisfies XYVisualizationState;
};

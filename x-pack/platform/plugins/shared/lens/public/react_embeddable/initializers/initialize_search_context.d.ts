import type { PublishesEsqlUsage, PublishesProjectRoutingOverrides, PublishesUnifiedSearch, StateComparators } from '@kbn/presentation-publishing';
...
export interface SearchContextConfig {
    api: PublishesUnifiedSearch & PublishesSearchSession & PublishesProjectRoutingOverrides & PublishesEsqlUsage;

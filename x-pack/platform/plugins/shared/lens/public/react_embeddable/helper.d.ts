...
export declare function getParentContext(parentApi: unknown): import("@kbn/core/public").KibanaExecutionContext | undefined;
 ...
 */
export declare function saveUpdatedLinkedAnnotationsToLibrary(visState: unknown, eventAnnotationService: EventAnnotationServiceType): Promise<unknown>;

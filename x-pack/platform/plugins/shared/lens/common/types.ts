...
import { type CustomPaletteParams, type PaletteOutput, type ColorMapping } from '@kbn/coloring';
...
import { type CategoryDisplay, type LegendDisplay, type NumberDisplay, type PieChartTypes } from './constants';

...
interface DeprecatedColorMappingGradientColorMode {
    type: 'gradient';
    steps: Array<(DeprecatedColorMappingCategoricalColor | DeprecatedColorMappingColorCode) & {
        touched: boolean;
    }>;
    sort: 'asc' | 'desc';
}

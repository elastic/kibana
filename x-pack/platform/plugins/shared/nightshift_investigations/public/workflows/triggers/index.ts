...
/**
 * Registers the nightshift-investigations custom workflow triggers on the public side using async
 * loaders, so the trigger definition module (and its zod schemas) stays out of the plugin's main
 * bundle.
 */

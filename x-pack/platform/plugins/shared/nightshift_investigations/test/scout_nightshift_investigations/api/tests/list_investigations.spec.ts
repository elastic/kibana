  ...
  () => {
    ...
    apiTest.beforeAll(async ({ kbnClient, samlAuth }) => {
      ...
      await seedInvestigation(kbnClient, {
        ...
        startedAt: times.iso({ day: 0, hour: 10 }),
        completedAt: times.iso({ day: 0, hour: 11 }),
      ...
      await seedInvestigation(kbnClient, {
        ...
        subjectId: 'se-1',
        triggerType: 'manual',
        createdAt: times.iso({ day: 1, hour: 10 }),
        startedAt: times.iso({ day: 1, hour: 10 }),
      });
      await seedInvestigation(kbnClient, {
        id: IDS[2],
        status: 'failed',
        ...
        subjectId: 'alert-2',
        triggerType: 'automatic',
        createdAt: times.iso({ day: 2, hour: 10 }),
        startedAt: times.iso({ day: 2, hour: 10 }),
        completedAt: times.iso({ day: 2, hour: 10, minute: 30 }),
      ...
      await seedInvestigation(kbnClient, {
        ...
        subjectId: 'alert-3',
        triggerType: 'automatic',
        createdAt: times.iso({ day: 3, hour: 10 }),
      });
    });

...
// Not available in platformCoreTools. Owned by @kbn/observability-agent-builder-plugin,
// which is group=observability/visibility=private, so it cannot be imported from this
// platform/shared plugin — the literal ids are inlined here instead.

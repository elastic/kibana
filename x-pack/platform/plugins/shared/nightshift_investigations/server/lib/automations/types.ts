...
export type SignificantEventSeverity = '80-critical' | '60-high' | '40-medium' | '20-low';
export type SignificantEventStatus = 'pending' | 'open' | 'closed' | 'dismissed';
export type AlertStatus = 'firing' | 'recovered' | 'any';
export type RuleNameMatchMode = 'substring' | 'regex';
export type SchedulePreset = 'hourly' | 'daily' | 'weekly' | 'custom';
export type DedupeMode = 'event_id' | 'rule_id' | 'none';
...
export type NightshiftTriggerRow =
  | {
      ...
      severities?: SignificantEventSeverity[];

...
const STATUS_BADGE_LABELS: Record<ProposalStatus, string> = {
  pending: i18n.translate('xpack.proposals.proposals.attachments.statusBadge.pending', {
    defaultMessage: 'Pending',
  }),
  executing: i18n.translate('xpack.proposals.proposals.attachments.statusBadge.executing', {
    defaultMessage: 'Executing',
  }),
  succeeded: i18n.translate('xpack.proposals.proposals.attachments.statusBadge.succeeded', {
    defaultMessage: 'Succeeded',
  }),
  failed: i18n.translate('xpack.proposals.proposals.attachments.statusBadge.failed', {
    defaultMessage: 'Failed',
  }),
  expired: i18n.translate('xpack.proposals.proposals.attachments.statusBadge.expired', {
  ...
  superseded: i18n.translate('xpack.proposals.proposals.attachments.statusBadge.superseded', {
...
const DECISION_BADGE_LABELS: Record<ProposalDecision, string> = {
  approved: i18n.translate('xpack.proposals.proposals.attachments.statusBadge.approved', {
    defaultMessage: 'Approved',
  }),
  dismissed: i18n.translate('xpack.proposals.proposals.attachments.statusBadge.dismissed', {
  ...
  (): AttachmentUIDefinition<ProposalAttachment> => ({
    ...
    getHeader: ({ attachment }) => {
      ...
      if (data.expired || data.status === 'expired') {
        badges.push({
          label: i18n.translate('xpack.proposals.proposals.attachments.expiredBadgeLabel', {
            defaultMessage: 'Expired',
          }),
          color: 'danger',
        });
      ...
      // Impact badge
      badges.push({
        label: i18n.translate('xpack.proposals.proposals.attachments.impactBadgeLabel', {

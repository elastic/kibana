...
type GlobalServices = Pick<CoreStart, 'application' | 'http' | 'theme' | 'uiSettings' | 'userProfile'> & Pick<CasesPublicStartDependencies, 'serverless' | 'savedObjectsTaggingOss'>;
export declare class KibanaServices {
    private static kibanaVersion?;
    private static services?;
    private static config?;
    static init({ application, config, http, serverless, savedObjectsTaggingOss, kibanaVersion, ...startServices }: GlobalServices & {

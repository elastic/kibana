...
import type { TriggersAndActionsUIPublicPluginSetup as TriggersActionsSetup, TriggersAndActionsUIPublicPluginStart as TriggersActionsStart } from '@kbn/triggers-actions-ui-plugin/public';
...
import type { CasesByAlertIDRequest, GetRelatedCasesByAlertResponse, CasesFindRequest, CasesBulkGetRequest, CasesBulkGetResponse, CasesMetricsRequest } from '../common/types/api';
import type { AlertAttachmentPayload, UserCommentAttachmentPayload, PersistableStateAttachmentPayload, ExternalReferenceNoSOAttachmentPayload, ExternalReferenceSOAttachmentPayload, EventAttachmentPayload, UnifiedAttachmentPayload } from '../common/types/domain';
...
export interface CasesPublicStart {
    ...
    api: {
        getRelatedCases: (alertId: string, query: CasesByAlertIDRequest) => Promise<GetRelatedCasesByAlertResponse>;
        cases: {
    ...
    ui: {
         ...
         */
        getAllCasesSelectorModal: (props: GetAllCasesSelectorModalProps) => ReactElement<GetAllCasesSelectorModalProps>;
        /**
...
export type SupportedCaseAttachment = AlertAttachmentPayload | EventAttachmentPayload | UserCommentAttachmentPayload | PersistableStateAttachmentPayload | ExternalReferenceNoSOAttachmentPayload | ExternalReferenceSOAttachmentPayload | UnifiedAttachmentPayload | DashboardAttachmentPayload | MapAttachmentPayload | DiscoverSessionAttachmentPayload;

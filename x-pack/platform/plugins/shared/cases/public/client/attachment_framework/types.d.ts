...
export interface UnifiedReferenceAttachmentViewProps<Metadata = ReferenceMetadata, Id = AttachmentId, Data = ReferenceData> extends UnifiedAttachmentViewPropsBase {
    attachmentId: Id;
    data?: Data;
    metadata?: Metadata;
}
/** Value attachments store all renderable content directly on the case comment. */
export interface UnifiedValueAttachmentViewProps<Data = ValueData> extends UnifiedAttachmentViewPropsBase {
    data: Data;
}
/** Hybrid attachments support value and reference payloads under one attachment type id. */
export interface UnifiedHybridAttachmentViewProps<Data = HybridData, Metadata = ReferenceMetadata, Id = AttachmentId> extends UnifiedAttachmentViewPropsBase {
    attachmentId?: Id;
    metadata?: Metadata;
    data?: Data;
}
...
export type UnifiedReferenceAttachmentType<Metadata = ReferenceMetadata, Id = AttachmentId, Data = ReferenceData> = UnifiedAttachmentRegistration<UnifiedReferenceAttachmentViewProps<Metadata, Id, Data>>;
export type UnifiedValueAttachmentType<Data = ValueData> = UnifiedAttachmentRegistration<UnifiedValueAttachmentViewProps<Data>>;
export type UnifiedHybridAttachmentType<Data = HybridData, Metadata = ReferenceMetadata, Id = AttachmentId> = UnifiedAttachmentRegistration<UnifiedHybridAttachmentViewProps<Data, Metadata, Id>>;
export type RegisteredUnifiedAttachmentType = UnifiedReferenceAttachmentType | UnifiedValueAttachmentType | UnifiedHybridAttachmentType;

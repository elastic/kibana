...
describe('getUICapabilities', () => {
  ...
  it('returns true for manageTemplates when cases_manage_templates is set to true in the ui capabilities', () => {
    expect(getUICapabilities({ cases_manage_templates: true })).toMatchInlineSnapshot(`
      Object {
        "all": false,
        "assign": false,
        "connectors": false,

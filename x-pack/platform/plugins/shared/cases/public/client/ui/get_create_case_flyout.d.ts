...
export declare const getCreateCaseFlyoutLazy: ({ externalReferenceAttachmentTypeRegistry, persistableStateAttachmentTypeRegistry, unifiedAttachmentTypeRegistry, getFilesClient, owner, permissions, features, afterCaseCreated, onClose, onSuccess, attachments, }: GetCreateCaseFlyoutPropsInternal) => React.JSX.Element;

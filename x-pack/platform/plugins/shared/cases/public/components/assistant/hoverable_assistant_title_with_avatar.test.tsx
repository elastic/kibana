...
import { HoverableAssistantTitleWithAvatar } from './hoverable_assistant_title_with_avatar';

describe('HoverableAssistantTitleWithAvatar', () => {
  it('renders assistant title', async () => {
    render(<HoverableAssistantTitleWithAvatar />);

    expect(screen.getByTestId('assistant-title')).toBeInTheDocument();
  });

  it('renders assistant avatar', async () => {
    render(<HoverableAssistantTitleWithAvatar />);

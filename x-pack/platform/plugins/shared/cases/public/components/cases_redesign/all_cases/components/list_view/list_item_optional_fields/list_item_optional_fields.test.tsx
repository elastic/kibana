...
import { useGlobalInlineFields } from '../../../../../all_cases/extended_field_columns';
...
jest.mock('../../../../../all_cases/extended_field_columns', () => ({
  ...jest.requireActual('../../../../../all_cases/extended_field_columns'),

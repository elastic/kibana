 ...
 */
export declare const TEMPLATE_DEFINITION_KEY_ORDER: readonly ["name", "description", "severity", "category", "tags", "assignees", "fields"];
/**
 ...
 */
export declare const reorderTemplateDefinitionKeys: (doc: Document) => boolean;

 ...
 */
export type EditableCaseDefaultField = 'name' | 'description' | 'severity' | 'category' | 'tags' | 'assignees';
...
export type OnCaseDefaultChange = (field: EditableCaseDefaultField, value: EditableCaseDefaultValue) => void;

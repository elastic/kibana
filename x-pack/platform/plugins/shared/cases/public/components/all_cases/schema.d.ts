...
export declare const AllCasesURLQueryParamsRt: rt.ExactC<rt.PartialC<{
    search: rt.StringC;
    severity: rt.ArrayC<rt.UnionC<[rt.LiteralC<import("../../../common").CaseSeverity.LOW>, rt.LiteralC<import("../../../common").CaseSeverity.MEDIUM>, rt.LiteralC<import("../../../common").CaseSeverity.HIGH>, rt.LiteralC<import("../../../common").CaseSeverity.CRITICAL>]>>;
    status: rt.ArrayC<rt.UnionC<[rt.LiteralC<import("@kbn/cases-components").CaseStatuses.open>, rt.LiteralC<typeof import("@kbn/cases-components").CaseStatuses["in-progress"]>, rt.LiteralC<import("@kbn/cases-components").CaseStatuses.closed>]>>;

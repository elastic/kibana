...
describe('stringifyUrlParams', () => {
  ...
  it('encodes defaults correctly', () => {
    ...
    expect(stringifyUrlParams(urlParams)).toMatchInlineSnapshot(
      `"cases=(assignees:!(),category:!(),customFields:(my_field:!(foo,bar)),owner:!(),page:1,perPage:10,reporters:!(),search:'',searchFields:!(title,description,incremental_id),severity:!(),sortField:createdAt,sortOrder:desc,status:!(),tags:!())"`
    );
  });

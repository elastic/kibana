...
export declare const UserActionsList: React.MemoExoticComponent<({ caseUserActions, attachments, caseConnectors, userProfiles, currentUserProfile, data: caseData, casesConfiguration, commentRefs, handleManageQuote, bottomActions, isExpandable, }: UserActionListProps) => React.JSX.Element>;

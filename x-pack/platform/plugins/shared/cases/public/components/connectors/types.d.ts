...
export interface CaseConnector<UIProps = unknown> {
    ...
    previewComponent: React.LazyExoticComponent<React.ComponentType<ConnectorFieldsPreviewProps<UIProps>>> | null;
}
export interface CaseConnectorsRegistry {
    has: (id: string) => boolean;
    register: <UIProps extends ConnectorTypeFields['fields']>(connector: CaseConnector<UIProps>) => void;

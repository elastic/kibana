...
export declare const usePersistConfiguration: () => import("@tanstack/react-query").UseMutationResult<import("../types").CasesConfigurationUI, ServerError, Request, unknown>;

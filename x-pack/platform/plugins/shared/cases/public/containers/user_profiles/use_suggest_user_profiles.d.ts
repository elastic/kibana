...
export declare const useSuggestUserProfiles: ({ name, owners, size, onDebounce, }: Props) => UseQueryResult<UserProfile<import("@kbn/core-user-profile-common").UserProfileData>[], ServerError>;

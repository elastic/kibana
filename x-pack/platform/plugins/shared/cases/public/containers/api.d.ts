...
import type { AttachmentRequest, BulkCreateAttachmentsRequestV2, CasePatchRequest, CasePostRequest, CustomFieldPutRequest, AddObservableRequest, UpdateObservableRequest, UpdateSummary } from '../../common/types/api';

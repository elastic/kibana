import type { CasesFindResponse, CasesSearchResponse, CasesBulkGetResponse, CasesMetricsResponse, CasesSimilarResponse } from '../../common/types/api';
 ...
 */
export declare const decodeCasesSearchResponse: (respCases?: CasesSearchResponse) => {
    cases: ({
        description: string;
        tags: string[];
        title: string;

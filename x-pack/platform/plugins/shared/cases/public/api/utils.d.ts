import type { AttachmentRequestV2, CaseResolveResponse, CasesSearchResponse, CasesSimilarResponse } from '../../common/types/api';
...
export declare const convertAllCasesToCamel: (snakeCases: CasesSearchResponse) => CasesFindResponseUI;

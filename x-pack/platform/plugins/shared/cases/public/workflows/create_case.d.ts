export declare const createCaseStepDefinition: import("@kbn/workflows-extensions/public").PublicStepDefinition<import("zod").ZodObject<{
    description: import("zod").ZodString;
    title: import("zod").ZodString;
    template: import("zod").ZodOptional<import("zod").ZodNullable<import("zod").ZodObject<{

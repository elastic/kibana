...
export declare const getAddAttachmentsStepDefinition: (registry: UnifiedAttachmentTypeRegistry) => import("@kbn/workflows-extensions/public").PublicStepDefinition<import("zod").ZodObject<{
    case_id: import("zod").ZodString;
    attachments: import("zod").ZodArray<import("zod").ZodDiscriminatedUnion<readonly import("zod/v4/core").$ZodType<unknown, unknown, import("zod/v4/core").$ZodTypeInternals<unknown, unknown>>[], string>>;
    ...
    'push-case': import("zod").ZodOptional<import("zod").ZodDefault<import("zod").ZodOptional<import("zod").ZodBoolean>>>;

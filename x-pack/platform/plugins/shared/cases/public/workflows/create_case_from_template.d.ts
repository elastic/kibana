export declare const createCreateCaseFromTemplateStepDefinition: import("@kbn/workflows-extensions/public").PublicStepDefinition<import("zod").ZodObject<{
    owner: import("zod").ZodEnum<{
        cases: "cases";
        observability: "observability";
        securitySolution: "securitySolution";
    }>;
    case_template_id: import("zod").ZodString;
    overwrites: import("zod").ZodOptional<import("zod").ZodObject<{

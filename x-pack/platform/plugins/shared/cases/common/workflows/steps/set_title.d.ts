...
export declare const SetTitleStepTypeId = "cases.setTitle";
...
export declare const setTitleStepCommonDefinition: CommonStepDefinition<SetTitleStepInputSchema, SetTitleStepOutputSchema>;
export {};

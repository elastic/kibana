...
export declare const UpdateCasesStepTypeId = "cases.updateCases";
...
export declare const updateCasesStepCommonDefinition: CommonStepDefinition<UpdateCasesStepInputSchema, UpdateCasesStepOutputSchema>;
export {};

...
export declare const SetCategoryStepTypeId = "cases.setCategory";
...
export declare const setCategoryStepCommonDefinition: CommonStepDefinition<SetCategoryStepInputSchema, SetCategoryStepOutputSchema>;
export {};

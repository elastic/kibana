...
export declare const CloseCaseStepTypeId = "cases.closeCase";
...
export declare const closeCaseStepCommonDefinition: CommonStepDefinition<CloseCaseStepInputSchema, CloseCaseStepOutputSchema>;
export {};

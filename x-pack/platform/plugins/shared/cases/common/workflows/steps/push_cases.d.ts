...
export declare const PushCasesStepTypeId = "cases.pushCases";
...
export declare const pushCasesStepCommonDefinition: CommonStepDefinition<PushCasesStepInputSchema, PushCasesStepOutputSchema>;
export {};

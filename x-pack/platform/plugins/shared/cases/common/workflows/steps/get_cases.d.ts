...
export declare const GetCasesStepTypeId = "cases.getCases";
...
export declare const getCasesStepCommonDefinition: CommonStepDefinition<GetCasesStepInputSchema, GetCasesStepOutputSchema>;
export {};

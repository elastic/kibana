...
export declare const SetStatusStepTypeId = "cases.setStatus";
...
export declare const setStatusStepCommonDefinition: CommonStepDefinition<SetStatusStepInputSchema, SetStatusStepOutputSchema>;
export {};

...
export declare const AddTagsStepTypeId = "cases.addTags";
...
export declare const addTagsStepCommonDefinition: CommonStepDefinition<AddTagsStepInputSchema, AddTagsStepOutputSchema>;
export {};

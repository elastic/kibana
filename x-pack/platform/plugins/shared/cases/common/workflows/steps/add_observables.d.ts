...
export declare const AddObservablesStepTypeId = "cases.addObservables";
...
export declare const addObservablesStepCommonDefinition: CommonStepDefinition<AddObservablesStepInputSchema, AddObservablesStepOutputSchema>;
export {};

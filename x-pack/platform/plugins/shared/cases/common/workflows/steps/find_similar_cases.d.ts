...
export declare const FindSimilarCasesStepTypeId = "cases.findSimilarCases";
...
export declare const findSimilarCasesStepCommonDefinition: CommonStepDefinition<FindSimilarCasesStepInputSchema, FindSimilarCasesStepOutputSchema>;
export {};

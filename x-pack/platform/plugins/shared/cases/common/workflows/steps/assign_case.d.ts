...
export declare const AssignCaseStepTypeId = "cases.assignCase";
...
export declare const assignCaseStepCommonDefinition: CommonStepDefinition<AssignCaseStepInputSchema, AssignCaseStepOutputSchema>;
export {};

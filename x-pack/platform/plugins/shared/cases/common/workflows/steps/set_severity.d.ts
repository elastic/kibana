...
export declare const SetSeverityStepTypeId = "cases.setSeverity";
...
export declare const setSeverityStepCommonDefinition: CommonStepDefinition<SetSeverityStepInputSchema, SetSeverityStepOutputSchema>;
export {};

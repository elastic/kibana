...
export declare const AddAlertsStepTypeId = "cases.addAlerts";
...
export declare const addAlertsStepCommonDefinition: CommonStepDefinition<AddAlertsStepInputSchema, AddAlertsStepOutputSchema>;
export {};

...
export declare const UnassignCaseStepTypeId = "cases.unassignCase";
...
export declare const unassignCaseStepCommonDefinition: CommonStepDefinition<UnassignCaseStepInputSchema, UnassignCaseStepOutputSchema>;
export {};

...
export declare const UpdateObservableStepTypeId = "cases.updateObservable";
...
export declare const updateObservableStepCommonDefinition: CommonStepDefinition<UpdateObservableStepInputSchema, UpdateObservableStepOutputSchema>;
export {};

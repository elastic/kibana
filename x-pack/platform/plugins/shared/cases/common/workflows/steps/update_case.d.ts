...
export declare const UpdateCaseStepTypeId = "cases.updateCase";
...
export declare const updateCaseStepCommonDefinition: CommonStepDefinition<UpdateCaseStepInputSchema, UpdateCaseStepOutputSchema>;
export {};

...
export declare const RemoveTagsStepTypeId = "cases.removeTags";
...
export declare const removeTagsStepCommonDefinition: CommonStepDefinition<RemoveTagsStepInputSchema, RemoveTagsStepOutputSchema>;
export {};

...
export declare const SetDescriptionStepTypeId = "cases.setDescription";
...
export declare const setDescriptionStepCommonDefinition: CommonStepDefinition<SetDescriptionStepInputSchema, SetDescriptionStepOutputSchema>;
export {};

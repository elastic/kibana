...
export declare const AddEventsStepTypeId = "cases.addEvents";
...
export declare const addEventsStepCommonDefinition: CommonStepDefinition<AddEventsStepInputSchema, AddEventsStepOutputSchema>;
export {};

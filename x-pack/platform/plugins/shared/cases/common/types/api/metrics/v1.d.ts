...
export declare const SingleCaseMetricsFeatureFieldRt: rt.UnionC<[rt.LiteralC<CaseMetricsFeature.ALERTS_COUNT>, rt.LiteralC<CaseMetricsFeature.ALERTS_USERS>, rt.LiteralC<CaseMetricsFeature.ALERTS_HOSTS>, rt.LiteralC<CaseMetricsFeature.CONNECTORS>, rt.LiteralC<CaseMetricsFeature.LIFESPAN>]>;
export declare const CasesMetricsFeatureFieldRt: rt.UnionC<[rt.UnionC<[rt.LiteralC<CaseMetricsFeature.ALERTS_COUNT>, rt.LiteralC<CaseMetricsFeature.ALERTS_USERS>, rt.LiteralC<CaseMetricsFeature.ALERTS_HOSTS>, rt.LiteralC<CaseMetricsFeature.CONNECTORS>, rt.LiteralC<CaseMetricsFeature.LIFESPAN>]>, rt.LiteralC<CaseMetricsFeature.MTTR>, rt.LiteralC<CaseMetricsFeature.STATUS>]>;
...
export declare const SingleCaseMetricsRequestRt: rt.ExactC<rt.TypeC<{
     ...
     */
    features: rt.ArrayC<rt.UnionC<[rt.LiteralC<CaseMetricsFeature.ALERTS_COUNT>, rt.LiteralC<CaseMetricsFeature.ALERTS_USERS>, rt.LiteralC<CaseMetricsFeature.ALERTS_HOSTS>, rt.LiteralC<CaseMetricsFeature.CONNECTORS>, rt.LiteralC<CaseMetricsFeature.LIFESPAN>]>>;
}>>;
export declare const CasesMetricsRequestRt: rt.IntersectionC<[rt.ExactC<rt.TypeC<{
    /**
     * The metrics to retrieve.
     */
    features: rt.ArrayC<rt.UnionC<[rt.UnionC<[rt.LiteralC<CaseMetricsFeature.ALERTS_COUNT>, rt.LiteralC<CaseMetricsFeature.ALERTS_USERS>, rt.LiteralC<CaseMetricsFeature.ALERTS_HOSTS>, rt.LiteralC<CaseMetricsFeature.CONNECTORS>, rt.LiteralC<CaseMetricsFeature.LIFESPAN>]>, rt.LiteralC<CaseMetricsFeature.MTTR>, rt.LiteralC<CaseMetricsFeature.STATUS>]>>;

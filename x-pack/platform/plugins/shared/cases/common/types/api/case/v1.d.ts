 ...
 */
export declare const CaseRequestTemplateRt: rt.IntersectionC<[rt.ExactC<rt.TypeC<{
    id: rt.StringC;
}>>, rt.ExactC<rt.PartialC<{
    version: rt.Type<number, number, unknown>;
}>>]>;
...
export declare const CasePostRequestRt: rt.IntersectionC<[rt.ExactC<rt.TypeC<{
    ...
    template: rt.UnionC<[rt.IntersectionC<[rt.ExactC<rt.TypeC<{
        id: rt.StringC;
    }>>, rt.ExactC<rt.PartialC<{
        version: rt.Type<number, number, unknown>;
    }>>]>, rt.NullC]>;
...
export declare const CasesFindRequestBaseFieldsRt: rt.IntersectionC<[rt.ExactC<rt.PartialC<{
     ...
     */
    status: rt.UnionC<[rt.UnionC<[rt.LiteralC<import("@kbn/cases-components").CaseStatuses.open>, rt.LiteralC<typeof import("@kbn/cases-components").CaseStatuses["in-progress"]>, rt.LiteralC<import("@kbn/cases-components").CaseStatuses.closed>]>, rt.ArrayC<rt.UnionC<[rt.LiteralC<import("@kbn/cases-components").CaseStatuses.open>, rt.LiteralC<typeof import("@kbn/cases-components").CaseStatuses["in-progress"]>, rt.LiteralC<import("@kbn/cases-components").CaseStatuses.closed>]>>]>;
    /**
     * The severity of the case
     */
 ...
 */
export declare const CasesSearchResponseRt: rt.IntersectionC<[rt.IntersectionC<[rt.ExactC<rt.TypeC<{
    cases: rt.ArrayC<rt.IntersectionC<[rt.IntersectionC<[rt.ExactC<rt.TypeC<{
        description: rt.StringC;
        tags: rt.ArrayC<rt.StringC>;
        title: rt.StringC;

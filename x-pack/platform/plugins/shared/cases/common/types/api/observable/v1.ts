...
export const BulkUpdateObservablesRequestRt = rt.strict({
  observables: rt.array(ObservablePatchRt),
});
...
export type BulkUpdateObservablesRequest = rt.TypeOf<typeof BulkUpdateObservablesRequestRt>;

...
export interface OwnerCaseFeatures {
  alerts: { sync: boolean };
  observables: { enabled: boolean; autoExtract: boolean; autoExtractDefault: boolean };
}
...
export const OWNER_INFO: Record<Owner, RouteInfo> = {
  [SECURITY_SOLUTION_OWNER]: {
    ...
    features: {
      alerts: { sync: true },
      observables: { enabled: true, autoExtract: true, autoExtractDefault: true },
    },
  ...
  [OBSERVABILITY_OWNER]: {
    ...
    features: {
      alerts: { sync: false },
      observables: { enabled: false, autoExtract: false, autoExtractDefault: false },
    },
    validRuleConsumers: [
  ...
  [GENERAL_CASES_OWNER]: {
    ...
    features: {
      alerts: { sync: false },
      observables: { enabled: true, autoExtract: false, autoExtractDefault: false },
    },
    validRuleConsumers: [
      AlertConsumers.ML,

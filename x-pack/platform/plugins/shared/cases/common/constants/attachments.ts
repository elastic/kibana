...
export const SO_DASHBOARD_ATTACHMENT_TYPE = 'so.dashboard';
export const SO_VISUALIZATION_ATTACHMENT_TYPE = 'so.visualization';
export const SO_DISCOVER_SESSION_ATTACHMENT_TYPE = 'so.search';
export const SO_RULE_ATTACHMENT_TYPE = 'so.rule';
export const SO_LENS_ATTACHMENT_TYPE = 'so.lens';
export const SO_MAP_ATTACHMENT_TYPE = 'so.map';

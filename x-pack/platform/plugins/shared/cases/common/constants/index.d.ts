...
export declare const CASE_TEMPLATES_URL: "/api/cases/templates";
export declare const CASE_TEMPLATE_DETAILS_URL: "/api/cases/templates/{template_id}";
export declare const CASE_FIELDS_URL: "/api/cases/fields";
export declare const CASE_APPLICABLE_FIELDS_URL: "/api/cases/{case_id}/fields";
 ...
 * fetched actions.
 */
export declare const MAX_USER_ACTIONS_FOR_SEARCH: 5000;
...
export declare const MAX_USER_ACTION_AUTHORS_FILTER_LENGTH: 100;
export declare const MAX_SUPPORTED_CONNECTORS_RETURNED: 1000;
/**
 * Validation
 */
export declare const MAX_TITLE_LENGTH: 160;
export declare const MAX_OWNER_LENGTH: 30;
export declare const MAX_ISO_DATE_LENGTH: 30;
export declare const MAX_ATTACHMENT_ID_LENGTH: 512;
export declare const MAX_ATTACHMENT_TYPE_LENGTH: 50;
export declare const MAX_USERNAME_LENGTH: 1024;
...
export declare const MAX_CASE_ID_LENGTH: 512;
export declare const MAX_TEMPLATE_VERSION_STRING_LENGTH: 10;
export declare const MAX_TEMPLATE_NAME_LENGTH: 50;
export declare const MAX_TEMPLATE_DESCRIPTION_LENGTH: 1000;
export declare const MAX_TEMPLATE_DEFINITION_LENGTH: 30000;
 ...
 */
export declare const MAX_TEMPLATES_PER_OWNER: 200;
export declare const MAX_FIELDS_PER_TEMPLATE: 200;
/**
 * Backstop on the UTF-8 byte size of a single stored extended-field value.
 * Lucene rejects keyword terms over 32,766 bytes.
 */
export declare const MAX_EXTENDED_FIELD_VALUE_BYTES: 30000;
export declare const MAX_FILENAME_LENGTH: 160;
export declare const MAX_CUSTOM_OBSERVABLE_TYPES_LABEL_LENGTH: 50;
export declare const MAX_USER_ACTION_SEARCH_LENGTH: 256;
export declare const MAX_USER_ACTION_AUTHOR_LENGTH: 256;
/**
 * Cases features
 */
...
export declare const LOCAL_STORAGE_KEYS: {
    ...
    casesListFields: string;
    casesTableFiltersConfig: string;
    casesViewMode: string;
    casesTableState: string;
    templatesTableState: string;
    templatesYamlEditorCreateState: string;
    templatesYamlEditorEditState: string;
    userActivitySortOrder: string;
    userActivityFilters: string;
    attachmentFilters: string;
    casesUtilityBarHideMaxLimitWarning: string;
    caseViewSidebarOpen: string;
    caseViewSidebarAccordions: string;
    casesListBannerDismissed: string;
    caseDetailsTourSeen: string;
    templateEditorTourSeen: string;
    templatesListInfoPanelDismissed: string;
    showLegacyCustomFields: string;
};
/**
 * Connectors
 */
...
export declare const CASES_LIST_VIEW_MODE_CHANGED_EVENT_TYPE: "cases_list_view_mode_changed";
export declare const CASES_LIST_PAGE_VIEW_EVENT_TYPE: "cases_list_page_view";
export declare const CASE_VIEW_ATTACHMENT_ACCORDION_OPENED_EVENT_TYPE: "case_view_attachment_accordion_opened";
export declare const CASE_VIEW_ATTACH_BUTTON_CLICKED_EVENT_TYPE: "case_view_attach_button_clicked";
export declare const CASE_VIEW_ATTACH_MENU_ITEM_CLICKED_EVENT_TYPE: "case_view_attach_menu_item_clicked";
export declare const CASE_MARKDOWN_EDITOR_PLUGIN_CLICKED_EVENT_TYPE: "case_markdown_editor_plugin_clicked";
/**
 ...
 */
export declare const VIEW_TOGGLE_LIST_ID: "list";
export declare const VIEW_TOGGLE_TABLE_ID: "table";

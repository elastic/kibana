...
import type { CasePatchRequest, CasesSearchResponse, CaseUserActionStatsResponse, GetCaseConnectorsResponse, GetCaseUsersResponse, UserActionFindRequestTypes, UserActionFindResponse, CaseMetricsFeature, CasesMetricsResponse, SingleCaseMetricsResponse, CasesSimilarResponse } from '../types/api';
type DeepRequired<T> = {

 ...
 */
export type CloseReasonValidator = (closeReason: string, request: KibanaRequest) => Promise<boolean>;
import type { ActionTypeConfig, ActionTypeSecrets, ActionTypeParams, ActionType } from '@kbn/actions-plugin/server/types';
...
export type RegisterActionType = <Config extends ActionTypeConfig = ActionTypeConfig, Secrets extends ActionTypeSecrets = ActionTypeSecrets, Params extends ActionTypeParams = ActionTypeParams, ExecutorResultData = void>(actionType: ActionType<Config, Secrets, Params, ExecutorResultData>) => void;
/**

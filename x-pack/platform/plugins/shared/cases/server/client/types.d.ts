...
import type { CaseConfigureService, CasesService, CaseUserActionService, ConnectorMappingsService, AttachmentService, AlertService, TemplatesService, FieldDefinitionsService } from '../services';
...
export type CasesSearchParams = Partial<Pick<CasesSearchRequest, 'tags' | 'reporters' | 'status' | 'severity' | 'owner' | 'from' | 'to' | 'assignees' | 'category' | 'sortField' | 'customFields'> & {

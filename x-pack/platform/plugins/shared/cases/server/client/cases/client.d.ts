...
import type { CasePostRequest, CasesFindResponse, CaseResolveResponse, CasesBulkGetRequest, CasesPatchRequest, AllTagsFindRequest, AllCategoriesFindRequest, AllReportersFindRequest, GetRelatedCasesByAlertResponse, CasesBulkGetResponse, BulkCreateCasesRequest, BulkCreateCasesResponse, CasesSearchRequest, CasesFindRequestWithCustomFields, SimilarCasesSearchRequest, CasesSimilarResponse, AddObservableRequest, UpdateObservableRequest, BulkAddObservablesRequest, CasesPatchResponse } from '../../../common/types/api';
...
export interface CasesSubClient {
     ...
     * Updates observable
     */
    updateObservable(caseId: string, observableId: string, params: UpdateObservableRequest): Promise<Case>;
    /**
     * Removes observable
     */
 ...
 * @ignore
 */
export declare const createCasesSubClient: (clientArgs: CasesClientArgs, casesClient: CasesClient, casesClientInternal: CasesClientInternal) => CasesSubClient;

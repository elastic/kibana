...
import type { CasesConnectorConfigSchema, CasesConnectorSecretsSchema, CasesConnectorRuleActionParamsSchema, CasesConnectorParamsSchema, CasesGroupedAlertsSchema, ZCasesConnectorRunParamsSchema } from './schema';
...
export type CasesConnectorRunParams = Omit<z.infer<typeof ZCasesConnectorRunParamsSchema>, 'alerts'> & {
    alerts: CaseAlert[];
};
...
export type CaseIdPayload = OracleKey & {
    counter: number;
};

...
import type { AttachmentAttributes, ExternalReferenceSOAttachmentPayload, FileAttachmentMetadata } from '../../common/types/domain';
/**
...
export type FindOptions = Pick<SavedObjectsFindOptions, 'defaultSearchOperator' | 'hasReferenceOperator' | 'perPage' | 'hasReference' | 'fields' | 'page' | 'search' | 'searchFields' | 'sortField' | 'sortOrder' | 'rootSearchFields'>;
export type SavedObjectFindOptionsKueryNode = FindOptions & {
    filter?: KueryNode;
};
export type FileAttachmentRequest = Omit<ExternalReferenceSOAttachmentPayload, 'externalReferenceMetadata'> & {

import type { SavedObjectReference, SavedObjectsClientContract, Logger, ISavedObjectsSerializer, SavedObjectsRawDoc } from '@kbn/core/server';
import type { KueryNode } from '@kbn/es-query';
import type { AuditLogger } from '@kbn/security-plugin/server';
import type { UserActionAction, CaseUserActionWithoutReferenceIds, CommentUserAction, ConnectorUserAction, PushedUserAction, UserActionType, CaseSeverity, CaseStatuses, User, CaseAssignees, CaseCustomFields } from '../../../common/types/domain';
import type { PersistableStateAttachmentTypeRegistry } from '../../attachment_framework/persistable_state_registry';
import type { UserActionPersistedAttributes, UserActionSavedObjectTransformed } from '../../common/types/user_actions';
import type { IndexRefresh } from '../types';
import type { PatchCasesArgs } from '../cases/types';
import type { AttachmentRequestV2, CasePostRequest, UserActionFindRequest } from '../../../common/types/api';
...
export interface BuilderParameters {
    ...
    observables: {
        parameters: {
            payload: {
                observables: {
                    actionType: ObservablesActionType;
                    count: number;
                };
            };
        };
...
export type UserActionParameters<T extends keyof BuilderParameters> = BuilderParameters[T]['parameters'] & CommonArguments;
...
export type CreatePayloadFunction<Item, ActionType extends UserActionType> = (items: Item[]) => UserActionParameters<ActionType>['payload'];
...
export interface BulkCreateAttachmentUserAction extends Omit<CommonUserActionArgs, 'owner'>, IndexRefresh {
    attachments: Array<{
        id: string;
        owner: string;

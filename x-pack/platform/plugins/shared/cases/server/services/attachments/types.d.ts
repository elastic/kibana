...
import type { Logger, SavedObject, SavedObjectReference, SavedObjectsBulkResponse, SavedObjectsClientContract, SavedObjectsUpdateOptions } from '@kbn/core/server';
import type { KueryNode } from '@kbn/es-query';
import type { AttachmentType } from '../../../common';
import type { AttachmentMode, AttachmentAttributesV2, AttachmentPatchAttributesV2 } from '../../../common/types/domain';
...
export type MixSavedObjectResponse = SavedObject<AttachmentPersistedAttributes> | SavedObject<UnifiedAttachmentAttributes> | {
    id: string;
    error: unknown;
};
...
export interface BulkOptionalAttributes<T> extends Omit<SavedObjectsBulkResponse<T>, 'saved_objects'> {

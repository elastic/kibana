export declare const casesSchema: import("@kbn/config-schema").ObjectType<Omit<Omit<Omit<Omit<Omit<Omit<Omit<{
    ...
    total_observables: import("@kbn/config-schema").Type<number>;
}, "template" | "extended_fields"> & {
    template: import("@kbn/config-schema").Type<Readonly<{} & {
        id: string;
        version: number;
    }> | null | undefined>;
    extended_fields: import("@kbn/config-schema").Type<Record<string, string> | null | undefined>;
}>;

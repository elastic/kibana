export declare const casesSchema: import("@kbn/config-schema").ObjectType<Omit<Omit<Omit<Omit<Omit<{
...
}, "in_progress_at" | "time_to_acknowledge" | "time_to_investigate" | "time_to_resolve"> & {
    in_progress_at: import("@kbn/config-schema").Type<string | null | undefined>;
    time_to_acknowledge: import("@kbn/config-schema").Type<number | null | undefined>;
    time_to_investigate: import("@kbn/config-schema").Type<number | null | undefined>;
    time_to_resolve: import("@kbn/config-schema").Type<number | null | undefined>;
}, "settings"> & {
    settings: import("@kbn/config-schema").ObjectType<{
        extractObservables: import("@kbn/config-schema").Type<boolean | undefined>;
    }>;
}, "total_events"> & {
    total_events: import("@kbn/config-schema").Type<number>;
}>;

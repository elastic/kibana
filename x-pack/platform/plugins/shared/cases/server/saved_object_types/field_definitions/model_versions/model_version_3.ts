...
import { fieldDefinitionSchemaV2 } from './model_version_2';

/**
 * v3 adds the optional server-managed `legacyKey` linking a migrated/mirrored
 ...
 */
export const fieldDefinitionSchemaV3 = fieldDefinitionSchemaV2.extends({
...
export const modelVersion3: SavedObjectsModelVersion = {
  changes: [],
  schemas: {
    create: fieldDefinitionSchemaV3,
    forwardCompatibility: fieldDefinitionSchemaV3.extends({}, { unknowns: 'ignore' }),
  },
};

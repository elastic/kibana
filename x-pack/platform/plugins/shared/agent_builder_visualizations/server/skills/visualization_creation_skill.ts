...
- Pass \`renderer: "vega"\` when:
  ...
  - No Lens chart type fits — e.g. small multiples / faceting, layered or combination charts (bars plus an overlaid line), scatter / bubble plots with an encoded size dimension, sunburst / hierarchy, radar / spider, or custom tooltips/encodings.
...
- **Needs unsupported Raw Vega (beyond Vega-Lite and allowlisted charts such as sunburst and radar):** do not fake it or ship a broken chart. State plainly that the requested chart is not supported yet, then offer alternatives (closest Vega-Lite approximation, a Lens chart, or multiple charts) and let the user choose.
`,
  referencedContent: [
    {

...
export declare enum AgentlessDeploymentReleaseStatus {
    Beta = "beta",
    GA = "ga"
}
...
export type RegistryVarType = 'integer' | 'bool' | 'password' | 'select' | 'text' | 'yaml' | 'string' | 'textarea' | 'duration' | 'url';
...
export interface Installation {
    ...
    previous_dependency_versions?: Array<{
        name: string;
        previous_version: string | null;
    }> | null;
}

...
// Mock toYaml implementation based on JSON.stringify for testing
const mockToYaml = (data: any): string => {
...
describe('fullAgentPolicyToYaml', () => {
  it('should replace secrets', () => {
    ...
    const yaml = fullAgentPolicyToYaml(agentPolicyWithSecrets, mockToYaml);

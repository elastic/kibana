...
const _allowedExperimentalValues = {
  ...
  enableCloudConnectorVarGroups: false, // When enabled, cloud connector support is activated for integrations using var_groups with provider options. Requires enableVarGroups.

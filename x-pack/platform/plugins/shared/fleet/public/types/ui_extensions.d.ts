...
import type { Agent, AgentPolicy, NewPackagePolicy, PackageInfo, PackagePolicy, SetupTechnology } from '.';
 ...
 */
export type PackagePolicyReplaceDefineStepExtensionComponent = ComponentType<PackagePolicyReplaceDefineStepExtensionComponentProps>;
export type PackagePolicyReplaceDefineStepExtensionComponentProps = ((PackagePolicyEditExtensionComponentProps & {
    isEditPage: true;
 ...
 */
export type PackagePolicyResponseExtensionComponent = ComponentType<PackagePolicyResponseExtensionComponentProps>;
...
export type UIExtensionPoint = PackagePolicyReplaceDefineStepExtension | PackagePolicyEditExtension | PackagePolicyResponseExtension | PackagePolicyEditTabsExtension | PackageCustomExtension | PackagePolicyCreateExtension | PackageAssetsExtension | PackageGenericErrorsListExtension | AgentEnrollmentFlyoutFinalStepExtension | PackagePolicyCreateMultiStepExtension | EndpointAgentTamperProtectionExtension | PliAuthBlockExtension;

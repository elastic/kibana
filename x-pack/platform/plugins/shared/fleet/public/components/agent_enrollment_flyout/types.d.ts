import type { AgentPolicy, DownloadSource, EnrollmentSettingsProxy, FleetServerHost } from '../../types';
import type { InstalledIntegrationPolicy } from './use_get_agent_incoming_data';
export type K8sMode = 'IS_LOADING' | 'IS_KUBERNETES' | 'IS_NOT_KUBERNETES' | 'IS_KUBERNETES_MULTIPAGE';

 ...
 */
export type UpdatePolicy = ({ updatedPolicy, isValid, isExtensionLoaded, }: {
...
export type CloudConnectorCredentials = AwsCloudConnectorCredentials | AzureCloudConnectorCredentials | GcpCloudConnectorCredentials;
...
export type CloudSetupForCloudConnector = Pick<CloudSetup, 'isCloudEnabled' | 'cloudId' | 'cloudHost' | 'deploymentUrl' | 'serverless' | 'isServerlessEnabled'>;

...
export const GCPReusableConnectorForm: React.FC<{
  ...
  return (
    <>
      ...
      <EuiText size="s" color="subdued">
        <FormattedMessage
          id="xpack.fleet.cloudConnector.gcp.reusableConnectorInstructions"
          defaultMessage="To streamline your GCP integration process, you can reuse the same Service Account for different use cases within Elastic. Simply choose the existing Service Account from the options below:"
        />
      </EuiText>
      <EuiSpacer size="m" />

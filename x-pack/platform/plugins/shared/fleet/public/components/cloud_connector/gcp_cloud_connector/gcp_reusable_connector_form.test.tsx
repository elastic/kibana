...
import { GCP_CLOUD_CONNECTOR_SUPER_SELECT_TEST_SUBJ } from '../../../../common/services/cloud_connectors/test_subjects';
...
const mockCloudConnectors = [
  {
    ...
    vars: {
      service_account: {
        value: 'service-account-1@project-123.iam.gserviceaccount.com',
      },
      audience: {
        value:
          '//iam.googleapis.com/projects/123/locations/global/workloadIdentityPools/pool-1/providers/provider-1',
      },
      gcp_credentials_cloud_connector_id: { value: 'gcp-cc-789' },
    },
  },
  {
    id: 'connector-2',
    ...
    vars: {
      service_account: {
        value: 'service-account-2@project-456.iam.gserviceaccount.com',
      },
      audience: {
        value:
          '//iam.googleapis.com/projects/456/locations/global/workloadIdentityPools/pool-2/providers/provider-2',
      },
      gcp_credentials_cloud_connector_id: { value: 'gcp-cc-abc' },
    },
  },
];
...
describe('GCPReusableConnectorForm', () => {
  ...
  const defaultProps = {
    ...
    credentials: {
      ...
      audience: undefined,
      gcp_credentials_cloud_connector_id: undefined,
      cloudConnectorId: undefined,
  ...
  describe('Rendering', () => {
    it('renders the combo box with instructions', () => {
      renderWithIntl(<GCPReusableConnectorForm {...defaultProps} />);
    ...
    it('renders with no connectors available', () => {
      ...
      expect(screen.getByTestId(GCP_CLOUD_CONNECTOR_SUPER_SELECT_TEST_SUBJ)).toBeInTheDocument();
    });
    ...
    it('renders with selected connector when cloudConnectorId is provided', async () => {
      ...
      renderWithIntl(<GCPReusableConnectorForm {...propsWithSelection} />);
  ...
  describe('User Interactions', () => {
    it('calls setCredentials with correct values when a connector is selected', async () => {
      ...
      await userEvent.click(screen.getByText('GCP Connector 1'));
      ...
      expect(mockSetCredentials).toHaveBeenCalledWith({
        ...
        audience:
          '//iam.googleapis.com/projects/123/locations/global/workloadIdentityPools/pool-1/providers/provider-1',
        gcp_credentials_cloud_connector_id: 'gcp-cc-789',
        cloudConnectorId: 'connector-1',
      });
    });
    ...
    it('calls setCredentials with second connector values when selected', async () => {
      ...
      await userEvent.click(screen.getByText('GCP Connector 2'));
      ...
      expect(mockSetCredentials).toHaveBeenCalledWith({
        ...
        audience:
          '//iam.googleapis.com/projects/456/locations/global/workloadIdentityPools/pool-2/providers/provider-2',
        gcp_credentials_cloud_connector_id: 'gcp-cc-abc',
        cloudConnectorId: 'connector-2',
      });
    });
  });
  ...
  describe('Hook Integration', () => {
    it('calls useGetCloudConnectors with correct provider', () => {
      ...
      // Verify hook was called with GCP_PROVIDER
    ...
    it('calls useGetCloudConnectors with single-account filter', () => {
      renderWithIntl(<GCPReusableConnectorForm {...defaultProps} accountType="single-account" />);
    ...
    it('calls useGetCloudConnectors with organization-account filter', () => {
      renderWithIntl(
        <GCPReusableConnectorForm {...defaultProps} accountType="organization-account" />
      );
    ...
    it('handles empty connector list', async () => {
      ...
      await waitFor(() => {
        ...
        expect(screen.queryByText('GCP Connector 1')).not.toBeInTheDocument();
        expect(screen.queryByText('GCP Connector 2')).not.toBeInTheDocument();
      });
    });
  });
});

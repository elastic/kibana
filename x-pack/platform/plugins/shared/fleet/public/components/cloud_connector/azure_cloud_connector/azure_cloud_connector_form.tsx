...
export const AzureCloudConnectorForm: React.FC<CloudConnectorFormProps> = ({
  ...
  // Use scope-aware accessor to get vars from the correct location (package or input level)
  const inputVars = extractRawCredentialVars(newPolicy, 'azure', packageInfo);

  ...
  const macCallout = (
    <EuiCallOut
      title={i18n.translate('xpack.fleet.enrollmentInstructions.macCallout', {
        defaultMessage:
          'Cloudbeat does not support macOS. Please use Linux or Kubernetes for this integration.',
      })}
      color="warning"
      iconType="warning"
    />
  ...
  const windowsCallout = (
    <EuiCallOut
      title={i18n.translate('xpack.fleet.enrollmentInstructions.windowsCallout', {
        defaultMessage:
          'Cloudbeat does not support Windows. Please use Linux or Kubernetes for this integration.',
      })}
      color="warning"
      iconType="warning"
    />

...
export const PlatformSelector: React.FunctionComponent<Props> = ({
  ...
  const systemPackageCloudBeatCallout = (
    <EuiCallOut
      title={i18n.translate('xpack.fleet.enrollmentInstructions.cloudbeatSystemPackageCallout', {
        defaultMessage:
          'Cloudbeat only supports Linux and Kubernetes. While the agent can be installed on RPM/DEB systems, this integration will not function properly on these package-based installations.',
      })}
      color="warning"
      iconType="warning"
    />
  ...
  const macCallout = (
    <EuiCallOut
      title={i18n.translate('xpack.fleet.enrollmentInstructions.macCallout', {
        defaultMessage:
          'Cloudbeat only supports Linux and Kubernetes. This integration cannot be deployed on macOS.',
      })}
      color="warning"
      iconType="warning"
    />
  ...
  const windowsCallout = (
    <EuiCallOut
      title={i18n.translate('xpack.fleet.enrollmentInstructions.windowsCallout', {
        defaultMessage:
          'Cloudbeat only supports Linux and Kubernetes. This integration cannot be deployed on Windows.',
      })}
      color="warning"
      iconType="warning"
    />

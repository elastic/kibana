...
const CONDITIONS_DOCS_URL =
  'https://www.elastic.co/docs/reference/fleet/dynamic-input-configuration#conditions';
  ...
  <EuiFormRow
    ...
    helpText={
      <FormattedMessage
        ...
        values={{
          learnMore: (
            <EuiLink href={CONDITIONS_DOCS_URL} target="_blank">

...
For a list of supported Fleet pages, see the type `AnyIntraAppRouteState` and its associated Union types in `x-pack/platform/plugins/shared/fleet/public/types/intra_app_route_state.ts`

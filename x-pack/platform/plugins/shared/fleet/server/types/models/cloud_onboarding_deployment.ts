...
export const CloudOnboardingDeploymentSchemaV1 = schema.object({
  ...
  mechanisms: schema.arrayOf(schema.string()),
  ...
  serviceVars: schema.recordOf(schema.string(), schema.arrayOf(schema.any())),
  secrets: schema.recordOf(schema.string(), schema.string()),
  packagePolicyIds: schema.maybe(schema.arrayOf(schema.string())),

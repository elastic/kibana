...
export declare const AgentComponentStateSchema: import("@kbn/config-schema").Type<"FAILED" | "STARTING" | "STOPPING" | "HEALTHY" | "STOPPED" | "CONFIGURING" | "DEGRADED">;
...
export declare const AgentStatusSchema: import("@kbn/config-schema").Type<"online" | "error" | "offline" | "degraded" | "inactive" | "uninstalled" | "updating" | "enrolling" | "unenrolling" | "unenrolled" | "orphaned">;
export declare const AgentResponseSchema: import("@kbn/config-schema").ObjectType<{
    ...
    status: import("@kbn/config-schema").Type<"online" | "error" | "offline" | "degraded" | "inactive" | "uninstalled" | "updating" | "enrolling" | "unenrolling" | "unenrolled" | "orphaned" | undefined>;
    last_known_status: import("@kbn/config-schema").Type<"online" | "error" | "offline" | "degraded" | "inactive" | "uninstalled" | "updating" | "enrolling" | "unenrolling" | "unenrolled" | "orphaned" | undefined>;
    ...
    last_checkin_status: import("@kbn/config-schema").Type<"online" | "error" | "degraded" | "updating" | "starting" | "disconnected" | undefined>;
    ...
    components: import("@kbn/config-schema").Type<Readonly<{
        units?: Readonly<{
            ...
            status: "FAILED" | "STARTING" | "STOPPING" | "HEALTHY" | "STOPPED" | "CONFIGURING" | "DEGRADED";
            type: "" | "input" | "output";
            id: string;
            message: string;
        }>[] | undefined;
    ...
    signals: import("@kbn/config-schema").Type<string[] | undefined>;
}>;
export declare const GetAgentsResponseSchema: import("@kbn/config-schema").ObjectType<Omit<{
    ...
    statusSummary: import("@kbn/config-schema").Type<Record<"online" | "error" | "offline" | "degraded" | "inactive" | "uninstalled" | "updating" | "enrolling" | "unenrolling" | "unenrolled" | "orphaned", number> | undefined>;
}>;
...
export declare const ListAgentUploadsResponseSchema: import("@kbn/config-schema").ObjectType<{
    items: import("@kbn/config-schema").Type<Readonly<{
        ...
        status: "READY" | "IN_PROGRESS" | "EXPIRED" | "FAILED" | "AWAITING_UPLOAD" | "DELETED";
        id: string;
        name: string;
        actionId: string;
        createTime: string;
...
export declare const GetActionStatusResponseSchema: import("@kbn/config-schema").ObjectType<{
    items: import("@kbn/config-schema").Type<Readonly<{
        ...
        status: "IN_PROGRESS" | "COMPLETE" | "CANCELLED" | "EXPIRED" | "FAILED" | "ROLLOUT_PASSED";

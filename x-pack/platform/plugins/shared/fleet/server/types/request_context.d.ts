import type { KibanaResponseFactory, RequestHandler, CustomRequestHandlerContext, RouteMethod, SavedObjectsClientContract, IRouter } from '@kbn/core/server';
 ...
 * @internal
 */
export type FleetRequestHandler<P = unknown, Q = unknown, B = unknown, Method extends RouteMethod = any, ResponseFactory extends KibanaResponseFactory = KibanaResponseFactory> = RequestHandler<P, Q, B, FleetRequestHandlerContext, Method, ResponseFactory>;
/**

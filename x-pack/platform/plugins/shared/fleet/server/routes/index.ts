...
import { registerRoutes as registerIacProviderRoutes } from './iac_provider';
...
export function registerRoutes(
  ...
  if (experimentalFeatures.enableIacProvider) {
    registerIacProviderRoutes(fleetAuthzRouter);
  }

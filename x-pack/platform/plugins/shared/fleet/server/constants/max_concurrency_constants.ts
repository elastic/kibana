...
export const MAX_CONCURRENT_ESQL_VIEWS_OPERATIONS = 50;
...
export const MAX_CONCURRENT_RULE_CREATION_OPERATIONS = 10;
export const BUMP_AGENT_POLICIES_BATCH_SIZE = 100;
export const DEPLOY_AGENT_POLICIES_BATCH_SIZE = 50;

...
export declare function comparePreconfiguredPolicyToCurrent(policyFromConfig: PreconfiguredAgentPolicy, currentPolicy: AgentPolicy): {
    hasChanged: boolean;
    fields: Pick<PreconfiguredAgentPolicy, "description" | "name" | "overrides" | "advanced_settings" | "space_ids" | "is_preconfigured" | "is_default" | "agentless" | "is_managed" | "supports_agentless" | "global_data_tags" | "is_default_fleet_server" | "has_fleet_server" | "monitoring_enabled" | "unenroll_timeout" | "inactivity_timeout" | "data_output_id" | "monitoring_output_id" | "download_source_id" | "fleet_server_host_id" | "schema_version" | "agent_features" | "is_protected" | "keep_monitoring_alive" | "monitoring_pprof_enabled" | "monitoring_http" | "monitoring_diagnostics" | "required_versions" | "has_agent_version_conditions" | "is_verifier">;
};
export {};

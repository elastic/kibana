...
spec:
  ...
  template:
    ...
    spec:
      ...
      #        curl -sL https://github.com/elastic/elastic-agent/archive/9.3.tar.gz | tar xz -C /etc/elastic-agent/inputs.d --strip=5 "elastic-agent-9.3/deploy/kubernetes/elastic-agent-standalone/templates.d"
      #    volumeMounts:

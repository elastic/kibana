...
describe('extractKnowledgeBaseFiles', () => {
  it('should return null when no knowledge base files exist', () => {
    const paths = [
      'test-package-1.0.0/manifest.yml',
      'test-package-1.0.0/docs/README.md',
      'test-package-1.0.0/data_stream/logs/manifest.yml',
    ];
    const assetsMap = {};
  ...
  it('should return null when docs directory exists but no knowledge_base subdirectory', () => {
    const paths = [
      'test-package-1.0.0/manifest.yml',
      'test-package-1.0.0/docs/README.md',
      'test-package-1.0.0/docs/other-file.md',
    ];
    const assetsMap = {};
  ...
  it('should return null when knowledge_base directory exists but contains no .md files', () => {
    const paths = [
      'test-package-1.0.0/manifest.yml',
      'test-package-1.0.0/docs/knowledge_base/config.yml',
      'test-package-1.0.0/docs/knowledge_base/data.json',
    ];
    const assetsMap = {};
  ...
  it('should extract single knowledge base file with content', () => {
    const paths = [
      'test-package-1.0.0/manifest.yml',
      'test-package-1.0.0/docs/knowledge_base/guide.md',
    ];
    const content = '# Knowledge Base Guide\n\nThis is a guide for using the package.';
    const assetsMap = {
      'test-package-1.0.0/docs/knowledge_base/guide.md': Buffer.from(content, 'utf8'),
    };
  ...
  it('should extract multiple knowledge base files with content', () => {
    const paths = [
      'test-package-1.0.0/manifest.yml',
      'test-package-1.0.0/docs/knowledge_base/overview.md',
      'test-package-1.0.0/docs/knowledge_base/troubleshooting.md',
      'test-package-1.0.0/docs/knowledge_base/advanced.md',
    ];
    const overviewContent = '# Overview\n\nPackage overview documentation.';
    const troubleshootingContent = '# Troubleshooting\n\nCommon issues and solutions.';
    const advancedContent = '# Advanced Usage\n\nAdvanced configuration options.';

    const assetsMap = {
      'test-package-1.0.0/docs/knowledge_base/overview.md': Buffer.from(overviewContent, 'utf8'),
      'test-package-1.0.0/docs/knowledge_base/troubleshooting.md': Buffer.from(
        troubleshootingContent,
        'utf8'
      ),
      'test-package-1.0.0/docs/knowledge_base/advanced.md': Buffer.from(advancedContent, 'utf8'),
    };
  ...
  it('should handle missing buffer for a knowledge base file', () => {
    const paths = [
      'test-package-1.0.0/manifest.yml',
      'test-package-1.0.0/docs/knowledge_base/guide.md',
    ];
    const assetsMap = {}; // No buffer for the file
  ...
  it('should handle empty buffer for a knowledge base file', () => {
    const paths = [
      'test-package-1.0.0/manifest.yml',
      'test-package-1.0.0/docs/knowledge_base/empty.md',
    ];
    const assetsMap = {
      'test-package-1.0.0/docs/knowledge_base/empty.md': Buffer.alloc(0), // Empty buffer
    };
  ...
  it('should ignore non-.md files in knowledge_base directory', () => {
    const paths = [
      'test-package-1.0.0/manifest.yml',
      'test-package-1.0.0/docs/knowledge_base/guide.md',
      'test-package-1.0.0/docs/knowledge_base/config.yml',
      'test-package-1.0.0/docs/knowledge_base/data.json',
      'test-package-1.0.0/docs/knowledge_base/script.js',
      'test-package-1.0.0/docs/knowledge_base/styles.css',
    ];
    const content = '# Guide\n\nThis is the only markdown file.';
    const assetsMap = {
      'test-package-1.0.0/docs/knowledge_base/guide.md': Buffer.from(content, 'utf8'),
      'test-package-1.0.0/docs/knowledge_base/config.yml': Buffer.from('config: value', 'utf8'),
      'test-package-1.0.0/docs/knowledge_base/data.json': Buffer.from('{"key": "value"}', 'utf8'),
    };
  ...
  it('should work with different package names and versions', () => {
    const paths = [
      'my-custom-integration-2.5.3/manifest.yml',
      'my-custom-integration-2.5.3/docs/knowledge_base/setup.md',
    ];
    const content = '# Setup Guide\n\nSetup instructions for my custom integration.';
    const assetsMap = {
      'my-custom-integration-2.5.3/docs/knowledge_base/setup.md': Buffer.from(content, 'utf8'),
    };
  ...
  it('should handle Unicode content in knowledge base files', () => {
    const paths = [
      'test-package-1.0.0/manifest.yml',
      'test-package-1.0.0/docs/knowledge_base/unicode.md',
    ];
    const unicodeContent =
      '# Unicode Test 🚀\n\nThis contains émojis and spëcial characters: 你好世界';
    const assetsMap = {
      'test-package-1.0.0/docs/knowledge_base/unicode.md': Buffer.from(unicodeContent, 'utf8'),
    };

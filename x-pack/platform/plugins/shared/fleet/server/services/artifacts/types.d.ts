 ...
 */
export type ArtifactElasticsearchProperties = Pick<Artifact, 'identifier' | 'body' | 'created' | 'type' | 'relative_url'> & {
...
export type ArtifactEncodedMetadata = Pick<Artifact, 'decodedSha256' | 'decodedSize' | 'encodedSha256' | 'encodedSize' | 'compressionAlgorithm' | 'body'>;

...
export declare function canDeployCustomPackageAsAgentlessOrThrow(packagePolicy: Pick<NewPackagePolicy, 'supports_agentless'>, packageInfo: PackageInfo): boolean;

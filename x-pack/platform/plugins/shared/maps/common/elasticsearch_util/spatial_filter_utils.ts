...
import { type Feature, type Geometry, type MultiPolygon, type Polygon, type Position } from 'geojson';
// @ts-expect-error
import turfCircle from '@turf/circle';
import { type Filter, type FilterMeta, FILTERS } from '@kbn/es-query';

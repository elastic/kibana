export declare enum EMS_BASEMAP_KEYS {
    ROADMAP_DESATURATED = "roadmap_desaturated",
    ROADMAP = "roadmap",
    AUTO = "auto",
    DARK = "dark"
}
export declare enum JOIN_KEYS {
    DISTANCE = "distance",
    TERM = "term"
}
export declare enum LAYER_KEYS {
    ES_DOCS = "es_docs",
...
export declare enum RESOLUTION_KEYS {
    COARSE = "coarse",
    FINE = "fine",
    MOST_FINE = "most_fine",
    SUPER_FINE = "super_fine"
}
export declare enum SCALING_KEYS {
    LIMIT = "limit",
    MVT = "mvt",
    CLUSTERS = "clusters"
}

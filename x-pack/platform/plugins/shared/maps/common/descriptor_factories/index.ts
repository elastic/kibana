...
export { createRasterTileLayerDescriptor } from './raster_tile_layer_descriptor';
export { createTileStyleDescriptor } from './tile_style_descriptor';
export { createWmsSourceDescriptor } from './wms_source_descriptor';
export { createXyzTmsSourceDescriptor } from './xyz_tms_source_descriptor';
export { createKibanaTilemapSourceDescriptor } from './kibana_tilemap_source_descriptor';

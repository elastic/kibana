...
export declare const plugin: PluginInitializer<MapsPluginSetup, MapsPluginStart>;
...
export type { GetFeatureActionsArgs, IVectorSource, GeoJsonWithMeta, } from './classes/sources/vector_source/vector_source';
...
export type { BoundsRequestMeta, SourceStatus, } from './classes/sources/vector_source/vector_source';

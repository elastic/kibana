...
export declare const hasMapSettingsChanges: ((state: MapStoreState) => boolean) & import("reselect-v4").OutputSelectorFields<(args_0: Required<Readonly<{
...
}) & import("reselect-v4").OutputSelectorFields<(args_0: MapExtent | undefined, args_1: MapExtent | undefined, args_2: number, args_3: TimeRange, args_4: import("../../common/descriptor_types").Timeslice | undefined, args_5: Query | undefined, args_6: Filter[], args_7: {
    query?: Query;
    filters: Filter[];
...
export declare const getSpatialFiltersLayer: ((state: MapStoreState) => GeoJsonVectorLayer) & import("reselect-v4").OutputSelectorFields<(args_0: Filter[], args_1: {
    query?: Query;
    filters: Filter[];
...
export declare const getLayerList: ((state: MapStoreState) => ILayer[]) & import("reselect-v4").OutputSelectorFields<(args_0: LayerDescriptor[], args_1: (value: string) => string | null, args_2: Readonly<{} & {
    label: string;
    svg: string;
    radius: number;
    symbolId: string;
...
export declare const getLayerListConfigOnly: ((state: MapStoreState) => any) & import("reselect-v4").OutputSelectorFields<(args_0: LayerDescriptor[]) => any, {
    clearCache: () => void;
}> & {
    clearCache: () => void;
};
export declare function getLayerById(layerId: string | null, state: MapStoreState): ILayer | undefined;
export declare const getSelectedLayer: ((state: MapStoreState) => ILayer | undefined) & import("reselect-v4").OutputSelectorFields<(args_0: string | null, args_1: ILayer[]) => ILayer | undefined, {
    clearCache: () => void;
}> & {
    clearCache: () => void;
};
export declare const hasPreviewLayers: ((state: MapStoreState) => boolean) & import("reselect-v4").OutputSelectorFields<(args_0: ILayer[]) => boolean, {
    clearCache: () => void;
}> & {
    clearCache: () => void;
};
export declare const getMapColors: ((state: MapStoreState) => string[]) & import("reselect-v4").OutputSelectorFields<(args_0: LayerDescriptor[]) => string[], {
    clearCache: () => void;
}> & {
    clearCache: () => void;
};
export declare const getSelectedLayerJoinDescriptors: ((state: MapStoreState) => Partial<import("../../common/descriptor_types").JoinDescriptor>[]) & import("reselect-v4").OutputSelectorFields<(args_0: ILayer | undefined) => Partial<import("../../common/descriptor_types").JoinDescriptor>[], {
    clearCache: () => void;
}> & {
    clearCache: () => void;
};
export declare const getQueryableUniqueIndexPatternIds: ((state: MapStoreState) => string[]) & import("reselect-v4").OutputSelectorFields<(args_0: ILayer[], args_1: LayerDescriptor[]) => string[], {
    clearCache: () => void;
}> & {
    clearCache: () => void;
};
export declare const getMostCommonDataViewId: ((state: MapStoreState) => string | undefined) & import("reselect-v4").OutputSelectorFields<(args_0: ILayer[], args_1: LayerDescriptor[]) => string | undefined, {
    clearCache: () => void;
}> & {
    clearCache: () => void;
};
export declare const getGeoFieldNames: ((state: MapStoreState) => string[]) & import("reselect-v4").OutputSelectorFields<(args_0: ILayer[], args_1: LayerDescriptor[]) => string[], {
    clearCache: () => void;
}> & {
    clearCache: () => void;
};
export declare const hasDirtyState: ((state: MapStoreState) => boolean) & import("reselect-v4").OutputSelectorFields<(args_0: LayerDescriptor[]) => boolean, {
    clearCache: () => void;
}> & {
    clearCache: () => void;
};
export declare const isMapLoading: ((state: MapStoreState) => boolean) & import("reselect-v4").OutputSelectorFields<(args_0: ILayer[], args_1: LayerDescriptor[], args_2: number) => boolean, {
    clearCache: () => void;
}> & {
    clearCache: () => void;
};

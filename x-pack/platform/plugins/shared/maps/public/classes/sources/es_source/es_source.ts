...
import { type DataViewField, type DataView, type ISearchSource } from '@kbn/data-plugin/common';
...
import { AbstractVectorSource, type BoundsRequestMeta } from '../vector_source';
import {

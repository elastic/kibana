...
import { AGG_TYPE, type FIELD_ORIGIN } from '../../../../common/constants';
import { type AggDescriptor, type TileMetaFeature } from '../../../../common/descriptor_types';
...
import { type IESAggField, type CountAggFieldParams } from './agg_field_types';

...
import type { TOCEntry } from './toc_entry';
declare const connected: import("react-redux").ConnectedComponent<typeof TOCEntry, import("react-redux").Omit<import("react").ClassAttributes<TOCEntry> & ReduxStateProps & ReduxDispatchProps & OwnProps, "inspectorAdapters" | "zoom" | "isReadOnly" | "isFeatureEditorOpenForLayer" | "fitToBounds" | "selectedLayer" | "isEditButtonDisabled" | "toggleVisible" | "hasDirtyStateSelector" | "isLegendDetailsOpen" | "openLayerPanel" | "hideTOCDetails" | "showTOCDetails" | "cancelEditing"> & OwnProps>;

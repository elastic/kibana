...
export declare function getByReferenceState(state: MapEmbeddableState | undefined, savedObjectId: string): {
    ...
    mapCenter?: import("../../common/descriptor_types").MapCenterAndZoom;
    mapBuffer?: import("../../common/descriptor_types").MapExtent;
    mapSettings?: Partial<import("../../server").MapSettings>;
    hiddenLayers?: string[];
    filterByMapExtent?: boolean;
    isMovementSynchronized?: boolean;
};
export declare function getByValueState(state: MapEmbeddableState | undefined, attributes: MapAttributes): {
    attributes: Readonly<{
        filters?: Readonly<{
...
export declare function initializeLibraryTransforms(isByReference: boolean, serializeByReference: (libraryId: string) => MapByReferenceState, serializeByValue: () => MapByValueState): HasLibraryTransforms<MapByReferenceState, MapByValueState>;

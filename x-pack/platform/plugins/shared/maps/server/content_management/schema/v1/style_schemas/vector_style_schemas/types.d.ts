...
import type { colorDynamicSchema, colorStaticSchema, colorSchema, colorDynamicOptions, colorStaticOptions, ordinalColorStop, categoryColorStop } from './color_schemas';
import type { iconDynamicOptions, iconSchema, iconStaticOptions, iconStop, orientationDynamicOptions, orientationSchema, orientationStaticOptions, sizeDynamicOptions, sizeSchema, sizeStaticOptions, symbolizeAsOptions } from './marker_schemas';
import type { vectorStylePropertiesSchema, vectorStyleSchema } from './vector_style_schemas';
import type { labelBorderSizeOptions, labelDynamicOptions, labelPositionSchema, labelSchema, labelStaticOptions, labelZoomRangeSchema } from './label_schemas';
...
export type DynamicStylePropertyOptions = ColorDynamicOptions | IconDynamicOptions | LabelDynamicOptions | OrientationDynamicOptions | SizeDynamicOptions;
export interface DynamicStyleProperties {
    type: STYLE_TYPE.DYNAMIC;
    options: DynamicStylePropertyOptions;
}
export type StaticStylePropertyOptions = ColorStaticOptions | IconStaticOptions | LabelStaticOptions | OrientationStaticOptions | SizeStaticOptions;
export type StylePropertyOptions = LabelBorderSizeOptions | LabelPositionStylePropertyDescriptor['options'] | LabelZoomRangeStylePropertyDescriptor['options'] | SymbolizeAsOptions | DynamicStylePropertyOptions | StaticStylePropertyOptions;

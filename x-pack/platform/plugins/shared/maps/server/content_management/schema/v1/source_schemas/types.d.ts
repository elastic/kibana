...
import type { countAggSchema, fieldedAggSchema, percentileAggSchema, BaseESAggSourceSchema, ESGeoGridSourceSchema, ESGeoLineSourceSchema, ESPewPewSourceSchema } from './es_agg_source_schemas';
import type { ESDistanceSourceSchema, ESJoinSourceSchema, ESTermSourceSchema, joinSourceSchema } from './es_join_source_schemas';
import type { BaseESSourceSchema, ESQLSourceSchema, ESSearchSourceSchema } from './es_source_schemas';
import type { EMSFileSourceSchema, EMSTMSSourceSchema, kibanaTilemapSourceSchema, MVTFieldSchema, sourceSchema, TiledSingleLayerVectorSourceSchema, WMSSourceSchema, XYZTMSSourceSchema } from './source_schemas';
...
export type TiledSingleLayerVectorSourceDescriptor = TypeOf<typeof TiledSingleLayerVectorSourceSchema>;

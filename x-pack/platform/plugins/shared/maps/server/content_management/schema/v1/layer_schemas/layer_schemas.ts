...
export const attributionSchema = lazySchema(() =>
  z
    .object({
      label: z.string(),
      url: z.url(),
...
export const EMSVectorTileLayerSchema = lazySchema(() =>
  layerSchema
    .extend({
...
export const heatmapLayerSchema = lazySchema(() =>
  layerSchema
    .extend({
...
export const layerGroupSchema = lazySchema(() =>
  layerSchema
    .extend({
      label: z.string(),
...
export const rasterLayerSchema = lazySchema(() =>
  layerSchema
    .extend({
...
export const vectorLayerSchema = lazySchema(() =>
  layerSchema
    .extend({
...
export const layersSchema = lazySchema(() =>
  z.union([

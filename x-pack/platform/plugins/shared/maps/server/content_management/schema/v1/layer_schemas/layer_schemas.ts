...
export const EMSVectorTileLayerSchema = layerSchema.extend({
...
export const heatmapLayerSchema = layerSchema.extend({
  sourceDescriptor: ESGeoGridSourceSchema,
  style: heatmapStyleSchema.optional(),
  type: z.literal(LAYER_TYPE.HEATMAP),
});

export const layerGroupSchema = layerSchema.extend({
  label: z.string(),
  type: z.literal(LAYER_TYPE.LAYER_GROUP),
  visible: z.boolean(),
});

export const rasterLayerSchema = layerSchema.extend({
...
export const vectorLayerSchema = layerSchema.extend({

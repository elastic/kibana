export declare const mapCenterSchema: import("@kbn/config-schema").ObjectType<{
    lat: import("@kbn/config-schema").Type<number>;
    lon: import("@kbn/config-schema").Type<number>;
}>;
export declare const adhocDataViewSchema: import("@kbn/config-schema").ObjectType<{
...
export declare const mapAttributesSchema: import("@kbn/config-schema").ObjectType<{

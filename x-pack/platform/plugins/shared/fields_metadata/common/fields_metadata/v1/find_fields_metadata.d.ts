...
export declare const findFieldsMetadataRequestQueryRT: rt.Type<{
    attributes?: ("pattern" | "description" | "normalize" | "source" | "type" | "name" | "required" | "example" | "index" | "beta" | "format" | "doc_values" | "ignore_above" | "scaling_factor" | "short" | "level" | "multi_fields" | "otel" | "flat_name" | "allowed_values" | "dashed_name" | "expected_values" | "input_format" | "object_type" | "original_fieldset" | "output_format" | "output_precision" | "documentation_url" | "otel_equivalent")[] | undefined;
    fieldNames?: string[] | undefined;
    source?: "metadata" | "unknown" | "ecs" | "integration" | "otel" | ("metadata" | "unknown" | "ecs" | "integration" | "otel")[] | undefined;

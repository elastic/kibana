...
export declare const findFieldsMetadataRequestQueryRT: rt.Type<{
    attributes?: ("normalize" | "description" | "type" | "index" | "source" | "beta" | "pattern" | "name" | "required" | "format" | "short" | "example" | "otel" | "flat_name" | "allowed_values" | "dashed_name" | "doc_values" | "expected_values" | "ignore_above" | "input_format" | "level" | "multi_fields" | "object_type" | "original_fieldset" | "output_format" | "output_precision" | "scaling_factor" | "documentation_url" | "otel_equivalent")[] | undefined;
    fieldNames?: string[] | undefined;
    source?: "metadata" | "unknown" | "ecs" | "integration" | "otel" | "streams" | ("metadata" | "unknown" | "ecs" | "integration" | "otel" | "streams")[] | undefined;

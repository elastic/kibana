...
function actions(...groups: ReadonlyArray<readonly string[]>): ProviderPermissions {
  return { actions: [...new Set(groups.flat())] };
}
 ...
 */
export const AWS_SERVICE_PROVIDER_PERMISSIONS: Record<string, ProviderPermissions> = {
  // ── Serverless & Compute ────────────────────────────────────────────────

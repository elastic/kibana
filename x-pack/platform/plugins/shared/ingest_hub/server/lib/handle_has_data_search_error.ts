...
// Copied from x-pack/solutions/observability/plugins/observability_onboarding/server/lib/handle_has_data_search_error.ts
// Cross-importing across the platform/solution boundary is not allowed.

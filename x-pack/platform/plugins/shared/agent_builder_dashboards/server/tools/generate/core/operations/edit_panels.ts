...
export const editPanelsOperation = defineOperation({
  schema: z
    ...
    .describe(
      'Edit existing panels in place by panelId. Supports ES|QL-backed Lens and Vega visualization panels (source: "request", which keep their existing renderer), markdown panels (source: "config", type: "markdown"), custom content panels (source: "config", type: "custom_content"), and ML anomaly panels (source: "config", type: "ml_anomaly_charts" | "ml_anomaly_swimlane" | "ml_single_metric_viewer"). DSL, form-based, and other non-ES|QL visualization panels are not supported for direct editing and should be recreated as new ES|QL-based panels instead.'
    ),

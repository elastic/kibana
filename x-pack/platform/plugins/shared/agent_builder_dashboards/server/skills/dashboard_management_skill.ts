...
When the user asked to prettify this dashboard and an image is attached, call \`platform.dashboard.prettify_dashboard\` once. Do not read the image. Do not describe the screenshot. Do not call \`platform.dashboard.generate_dashboard\` for this request. Without an image, this is a normal dashboard edit.

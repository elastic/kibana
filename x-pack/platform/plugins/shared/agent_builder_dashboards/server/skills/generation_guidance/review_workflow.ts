...
4. **Report.** Summarize what changed, what the review still flags, and what could not be assessed or edited (\`could_not_assess\` panels, \`review_complete: false\`, unsupported panel types). There is no post-edit screenshot, so never claim the updated dashboard was visually verified.

...
- If the generation result includes \`data.review.problems\`, mention the issues in plain language. Do not call generation again just to fix them unless the user asks.

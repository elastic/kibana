...
Prefer modify and expand. Do not remove visualization panels. Do not call \`platform.dashboard.prettify_dashboard\`. Call \`${dashboardTools.generateDashboard}\` once to apply. Then render the updated attachment. Read \`${DASHBOARD_DESIGN_PRACTICES_REFERENCE_NAME}\` only for composition and grid packing.

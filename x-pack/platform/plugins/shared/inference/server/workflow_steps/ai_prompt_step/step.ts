...
import { createServerStepDefinition } from '@kbn/workflows/server';
import { AiPromptStepCommonDefinition } from '../../../common/workflow_steps/ai_prompt_step';
import type { InferenceServerStart } from '../../types';
import { resolveConnectorId } from '../utils/resolve_connector_id';

export const aiPromptStepDefinition = <TStartDeps extends { inference: InferenceServerStart }>(

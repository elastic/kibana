...
import { AiSummarizeStepCommonDefinition } from '../../../common/workflow_steps/ai_summarize_step';
import type { InferenceServerStart } from '../../types';
import { resolveConnectorId } from '../utils/resolve_connector_id';

export const aiSummarizeStepDefinition = <TStartDeps extends { inference: InferenceServerStart }>(

import type { PluginStartContract as ActionsPluginStart, PluginSetupContract as ActionsPluginSetup, ActionsClient } from '@kbn/actions-plugin/server';
...
import type { BoundInferenceClient, BoundOptions, InferenceClient, InferenceConnector } from '@kbn/inference-common';
...
import type { AnonymizationPluginStart, AnonymizationPluginSetup } from '@kbn/anonymization-plugin/server';
 ...
 * Options to create an inference client using the {@link InferenceServerStart.getClient} API.
 */
export type InferenceClientCreateOptions = InferenceUnboundClientCreateOptions | InferenceBoundClientCreateOptions;
/**
...
export interface InferenceServerStart {
     ...
     * ```
     */
    getClient: <T extends InferenceClientCreateOptions>(options: T) => T extends InferenceBoundClientCreateOptions ? BoundInferenceClient : InferenceClient;
    /**
     ...
     */
    getClientWithoutRequest: (actionsClient: PublicMethodsOf<ActionsClient>, esClient: ElasticsearchClient) => InferenceClient;
    /**
     ...
     * @throws Error if the connector with the specified ID does not exist
     */
    getConnectorByIdWithoutClientRequest: (id: string, actionsClient: PublicMethodsOf<ActionsClient>, esClient: ElasticsearchClient) => Promise<InferenceConnector>;
    /**

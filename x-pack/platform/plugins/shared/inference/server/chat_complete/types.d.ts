...
import type { ChatCompletionChunkEvent, ChatCompletionTokenCountEvent, FunctionCallingMode, Message, ToolOptions, ChatCompleteMetadata, AnonymizationRule } from '@kbn/inference-common';
...
export interface InferenceConnectorAdapter {
    chatComplete: (options: InferenceAdapterChatCompleteOptions) => Observable<InferenceConnectorAdapterChatCompleteEvent>;
}
/**
 ...
 * @internal
 */
export type InferenceConnectorAdapterChatCompleteEvent = ChatCompletionChunkEvent | ChatCompletionTokenCountEvent;
/**

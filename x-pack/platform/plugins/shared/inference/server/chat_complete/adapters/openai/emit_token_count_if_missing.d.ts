 ...
 */
export declare function emitTokenCountEstimateIfMissing({ request, }: {
    request: OpenAIRequest;
}): OperatorFunction<ChatCompletionChunkEvent | ChatCompletionTokenCountEvent, ChatCompletionChunkEvent | ChatCompletionTokenCountEvent>;

import type { ToolResultBlock, ToolUseBlock, ImageBlock, Message } from '@aws-sdk/client-bedrock-runtime';
/**
...
export type BedRockMessagePart = BedRockTextPart | BedRockToolUsePart | BedRockToolResultPart | BedRockImagePart;
...
export declare const isMessageStopChunk: (chunk: unknown) => chunk is MessageStopChunk;
export type CompletionChunk = MessageStartChunk | ContentBlockStartChunk | ContentBlockDeltaChunk | ContentBlockStopChunk | MessageDeltaChunk | MessageStopChunk;
export {};

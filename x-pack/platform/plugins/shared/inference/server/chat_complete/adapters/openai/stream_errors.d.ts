...
export declare const convertStreamError: ({ error }: ErrorLine) => import("@kbn/inference-common/src/chat_complete/errors").ChatCompletionContextLengthExceededError | import("@kbn/inference-common").InferenceTaskProviderError;

...
import type { RegexAnonymizationTask } from '@kbn/inference-common';
...
export default function ({ rule, records }: RegexAnonymizationTask) {
  ...
  return { nextRecords, anonymizations };
}

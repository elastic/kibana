...
export const AiPromptOutputSchema = StringOutputSchema;

export const AiPromptStepCommonDefinition: BaseStepDefinition<
...
> = {
  ...
  label: i18n.translate('xpack.inference.workflowSteps.aiPrompt.label', {
    defaultMessage: 'AI Prompt',
  }),
  description: i18n.translate('xpack.inference.workflowSteps.aiPrompt.description', {
    defaultMessage: 'Sends a prompt to an AI connector and returns the response',
  }),
  documentation: {
    details: i18n.translate('xpack.inference.workflowSteps.aiPrompt.documentation.details', {

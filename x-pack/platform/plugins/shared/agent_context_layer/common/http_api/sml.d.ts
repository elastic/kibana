 ...
 */
export declare const SML_HTTP_LIST_PER_PAGE_DEFAULT = 20;
export declare const SML_HTTP_LIST_PER_PAGE_MAX = 1000;
export declare const SML_HTTP_LIST_PAGE_DEFAULT = 1;
/**

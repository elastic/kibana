    ...
    >
{
  ...
  setup(
    ...
    const isContextEngineEnabledForRequest = async (request: KibanaRequest) => {
    ...
    const checkWritePrivilegeForRequest = async (request: KibanaRequest) => {
      const [, startDeps] = await coreSetup.getStartServices();
    ...
    registerStepDefinitions({
      ...
      feedbackAnalysis: {
        ...
        isContextEngineEnabled: isContextEngineEnabledForRequest,
        isFeedbackLoopEnabled: () => this.isFeedbackLoopEnabled(),
        checkWritePrivilege: checkWritePrivilegeForRequest,

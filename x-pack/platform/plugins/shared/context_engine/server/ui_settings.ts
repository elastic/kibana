...
export const registerUISettings = ({
  ...
  uiSettings.register({
    [CONTEXT_ENGINE_ENABLED_SETTING_ID]: {
      name: i18n.translate('xpack.contextEngine.uiSettings.contextEngine.name', {
        defaultMessage: 'Context Engine',
      }),
      description: i18n.translate('xpack.contextEngine.uiSettings.contextEngine.description', {

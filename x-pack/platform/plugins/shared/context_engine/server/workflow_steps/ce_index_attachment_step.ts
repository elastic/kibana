...
import type { CeEntry, CePermissions } from '../services/ce/types';
 ...
 * privileges without registering an CE type. `delete` calls
    ...
    handler: async (context) => {
      try {
        ...
        if (action === 'delete') {
          ...
          // arrays to match the fully-shaped `CePermissions` the contract expects.

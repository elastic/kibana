...
/**
 * ES|QL applies the request filter to a view's output, where the nested space permissions of
 * managed KIs are not visible, so managed AI indices are queried through their backing store.
 */

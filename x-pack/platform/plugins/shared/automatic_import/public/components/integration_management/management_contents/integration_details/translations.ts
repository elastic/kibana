...
export const LOGO_DESCRIPTION_PART_1 = i18n.translate(
  'xpack.automaticImport.step.integration.logo.descriptionPart1',
  {
    defaultMessage: 'Drag and drop',
  }
);
export const LOGO_DESCRIPTION_PART_2 = i18n.translate(
  'xpack.automaticImport.step.integration.logo.descriptionPart2',
  {
...
export const getLogoTooLargeError = (fileName: string) =>
  i18n.translate('xpack.automaticImport.step.integration.logo.tooLarge', {
    defaultMessage: '{fileName} is too large, maximum size is 1MB.',
    values: { fileName },
  });
export const LOGO_INVALID_FORMAT = i18n.translate(
  'xpack.automaticImport.step.integration.logo.invalidFormat',
  {

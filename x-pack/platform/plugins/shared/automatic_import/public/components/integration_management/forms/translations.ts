...
export const NAME_MUST_START_WITH_LETTER = i18n.translate(
  'xpack.automaticImport.forms.nameMustStartWithLetter',
  {
    defaultMessage: 'Name must start with a letter',
  }
);

export const NAME_TOO_SHORT = i18n.translate('xpack.automaticImport.forms.nameTooShort', {

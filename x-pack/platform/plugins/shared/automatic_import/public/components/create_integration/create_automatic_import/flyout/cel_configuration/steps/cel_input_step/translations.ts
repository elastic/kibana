...
export const DATA_STREAM_TITLE_REQUIRED = i18n.translate(
  'xpack.automaticImport.celFlyout.step.celInput.dataStreamTitleRequired',
  {
...
export const OPEN_API_UPLOAD_INSTRUCTIONS = i18n.translate(
  'xpack.automaticImport.celFlyout.step.celInput.uploadInstructions',
  {
    defaultMessage:
...
export const API_DEFINITION_DESCRIPTION = i18n.translate(
  'xpack.automaticImport.celFlyout.step.celInput.apiDefinition.description',
  {
...
export const API_DEFINITION_DESCRIPTION_2 = i18n.translate(
  'xpack.automaticImport.celFlyout.step.celInput.apiDefinition.description2',
  {
    defaultMessage: 'OpenAPI specification',
  }
);
...
export const API_DEFINITION_ERROR = {
  CAN_NOT_READ: i18n.translate(
    'xpack.automaticImport.celFlyout.step.celInput.openapiSpec.errorCanNotRead',
    {
      defaultMessage: 'Failed to read the uploaded file',
    }
  ),
  INVALID_OAS: i18n.translate(
    'xpack.automaticImport.celFlyout.step.celInput.openapiSpec.errorInvalidFormat',
    {
  ...
  CAN_NOT_READ_WITH_REASON: (reason: string) =>
    i18n.translate(
      'xpack.automaticImport.celFlyout.step.celInput.openapiSpec.errorCanNotReadWithReason',
      {
        values: { reason },
  ...
  TOO_LARGE_TO_PARSE: i18n.translate(
    'xpack.automaticImport.celFlyout.step.celInput.openapiSpec.errorTooLargeToParse',
    {
...
export const PROGRESS_CEL_INPUT_GRAPH = i18n.translate(
  'xpack.automaticImport.celFlyout.step.celInput.generating',
  {
...
export const GENERATION_ERROR = i18n.translate(
  'xpack.automaticImport.celFlyout.step.celInput.generationError',
  {
...
export const RETRY = i18n.translate(
  'xpack.automaticImport.celFlyout.step.celInput.retryButtonLabel',
  {

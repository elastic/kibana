...
export const ANALYZING = i18n.translate(
  'xpack.automaticImport.celFlyout.step.celConfirm.analyzing',
  {
...
export const RECOMMENDED = i18n.translate(
  'xpack.automaticImport.celFlyout.step.celConfirm.recommended',
  {
    defaultMessage: 'Recommended',
  }
);
export const ENTER_MANUALLY = i18n.translate(
  'xpack.automaticImport.celFlyout.step.celConfirm.enterManually',
  {
...
export const CONFIRM_ENDPOINT = i18n.translate(
  'xpack.automaticImport.celFlyout.step.celConfirm.confirmEndpoint',
  {
    defaultMessage: 'Choose API endpoint',
  }
);
export const CONFIRM_ENDPOINT_DESCRIPTION = i18n.translate(
  'xpack.automaticImport.celFlyout.step.celConfirm.confirmEndpointDescription',
  {
...
export const CONFIRM_AUTH = i18n.translate(
  'xpack.automaticImport.celFlyout.step.celConfirm.confirmAuth',
  {
    defaultMessage: 'Choose Authentication method',
  }
);
export const CONFIRM_AUTH_DESCRIPTION = i18n.translate(
  'xpack.automaticImport.celFlyout.step.celConfirm.confirmAuthDescription',
  {
...
export const AUTH_SELECTION_TITLE = i18n.translate(
  'xpack.automaticImport.celFlyout.step.celConfirm.authSelectionTitle',
  {
...
export const AUTH_DOES_NOT_ALIGN = i18n.translate(
  'xpack.automaticImport.celFlyout.step.celConfirm.authDoesNotAlign',
  {
...
export const PROGRESS_CEL_INPUT_GRAPH = i18n.translate(
  'xpack.automaticImport.celFlyout.step.celConfirm.progress.relatedGraph',
  {
...
export const GENERATION_ERROR = i18n.translate(
  'xpack.automaticImport.celFlyout.step.celConfirm.generationError',
  {
...
export const RETRY = i18n.translate(
  'xpack.automaticImport.celFlyout.step.celConfirm.retryButtonLabel',
  {

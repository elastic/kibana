...
export declare const taskSchemaV1: import("@kbn/config-schema").ObjectType<{
    ...
    status: import("@kbn/config-schema").Type<"running" | "idle" | "failed" | "claiming" | "unrecognized" | "dead_letter">;
...
export declare const taskSchemaV10: import("@kbn/config-schema").ObjectType<Omit<Omit<Omit<Omit<Omit<Omit<Omit<Omit<Omit<{
    taskType: import("@kbn/config-schema").Type<string>;
    scheduledAt: import("@kbn/config-schema").Type<string>;
    startedAt: import("@kbn/config-schema").Type<string | null>;
    retryAt: import("@kbn/config-schema").Type<string | null>;
...
export declare const taskSchemaV11: import("@kbn/config-schema").ObjectType<Omit<Omit<Omit<Omit<Omit<Omit<Omit<Omit<Omit<Omit<{
    taskType: import("@kbn/config-schema").Type<string>;
    scheduledAt: import("@kbn/config-schema").Type<string>;
    startedAt: import("@kbn/config-schema").Type<string | null>;
    retryAt: import("@kbn/config-schema").Type<string | null>;
...
export declare const taskSchemaV12: import("@kbn/config-schema").ObjectType<Omit<Omit<Omit<Omit<Omit<Omit<Omit<Omit<Omit<Omit<Omit<{
    taskType: import("@kbn/config-schema").Type<string>;
    scheduledAt: import("@kbn/config-schema").Type<string>;
    startedAt: import("@kbn/config-schema").Type<string | null>;
    retryAt: import("@kbn/config-schema").Type<string | null>;

...
export declare function either<T, E>(result: Result<T, E>, onOk: (value: T) => void, onErr: (error: E) => void): Result<T, E>;
export declare function eitherAsync<T, E>(result: Result<T, E>, onOk: (value: T) => Promise<void>, onErr: (error: E) => Promise<void>): Promise<Result<T, E> | void>;

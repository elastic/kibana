...
export declare function tasksClaimedByOwner(taskManagerId: string, ...taskFilters: estypes.QueryDslQueryContainer[]): {
    bool: {
...
export declare function claimSort(definitions: TaskTypeDictionary, tasks: ConcreteTaskInstance[]): ConcreteTaskInstance[];
...
export declare const updateFieldsAndMarkAsFailed: ({ fieldUpdates, claimableTaskTypes, skippedTaskTypes, taskMaxAttempts, }: UpdateFieldsAndMarkAsFailedOpts) => ScriptClause;

...
export declare class TaskPollingLifecycle implements ITaskEventEmitter<TaskLifecycleEvent> {
     ...
     * mechanism.
     */
    constructor({ logger, middleware, config, elasticsearchAndSOAvailability$, taskStore, definitions, executionContext, usageCounter, taskPartitioner, startingCapacity, apiKeyStrategy, eventLogger, enrichFakeRequest, }: TaskPollingLifecycleOpts);

 ...
 */
export declare const invalidationTargetsFromUiamTaskBulkUpdates: (updates: Array<SavedObjectsBulkUpdateObject<UiamBulkUpdateAttrs>>) => InvalidationTarget[];
/**
 ...
 */
export declare const buildSavedObjectBulkUpdatesForUiamKeys: (converted: UiamKeyResult[]) => Array<SavedObjectsBulkUpdateObject<UiamBulkUpdateAttrs>>;
export {};

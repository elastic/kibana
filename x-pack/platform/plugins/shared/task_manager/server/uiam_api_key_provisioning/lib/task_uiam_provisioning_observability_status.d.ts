...
export interface TaskUiamProvisioningStatusDoc {
    ...
    attributes: {
        ...
        status: typeof UiamApiKeyProvisioningStatus.SKIPPED | typeof UiamApiKeyProvisioningStatus.FAILED | typeof UiamApiKeyProvisioningStatus.COMPLETED;
        message?: string;
        errorCode?: string;
    };
}
export declare const createSkippedTaskProvisioningStatus: (taskId: string, message: string) => TaskUiamProvisioningStatusDoc;
export declare const createFailedConversionTaskProvisioningStatus: (taskId: string, message: string, errorCode?: string) => TaskUiamProvisioningStatusDoc;
 ...
 */
export declare const prepareTaskProvisioningStatusWrite: (payload: TaskProvisioningStatusWritePayload) => {
 ...
 */
export declare const writeTaskUiamProvisioningObservabilityStatus: (savedObjectsClient: ISavedObjectsRepository, logger: Logger, payload: TaskUiamProvisioningObservabilityStatusPayload) => Promise<void>;

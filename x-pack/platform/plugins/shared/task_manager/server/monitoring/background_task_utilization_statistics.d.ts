...
export declare function createBackgroundTaskUtilizationAggregator(taskPollingLifecycle: TaskPollingLifecycle, adHocTaskCounter: AdHocTaskCounter, pollInterval: number, workerUtilizationRunningAverageWindowSize?: number): AggregatedStatProvider<BackgroundTaskUtilizationStat>;
...
export declare function summarizeUtilizationStats({ lastUpdate, monitoredStats, isInternal, }: SummarizeUtilizationStatsOpts): SummarizeUtilizationStatsResult;
export {};

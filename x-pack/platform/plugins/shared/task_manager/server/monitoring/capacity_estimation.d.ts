...
export type CapacityEstimationParams = Omit<Required<RawMonitoringStats['stats']>, 'capacity_estimation'>;
export declare function estimateCapacity(logger: Logger, capacityStats: CapacityEstimationParams, assumedKibanaInstances: number): RawMonitoredStat<CapacityEstimationStat>;
export declare function withCapacityEstimate(logger: Logger, monitoredStats: RawMonitoringStats['stats'], assumedKibanaInstances: number): RawMonitoringStats['stats'];

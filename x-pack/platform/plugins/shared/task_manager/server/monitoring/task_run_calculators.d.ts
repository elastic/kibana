 ...
 */
export declare function createRunningAveragedStat<T>(runningAverageWindowSize: number): (value?: T) => T[];
export declare function createMapOfRunningAveragedStats<T>(runningAverageWindowSize: number): (key?: string, value?: T) => {
    [x: string]: T[];
};

...
export declare function asPending(
  task: InstanceOf<TaskRunningStage.PENDING, PendingTask>
): PendingTask;
export declare function isReadyToRun(
  taskRunning: TaskRunningInstance
): taskRunning is ReadyToRunTask;
export declare function asReadyToRun(

...
export declare class TaskManagerRunner implements TaskRunner {
     ...
     */
    constructor({ instance, definitions, logger, store, beforeRun, beforeMarkRunning, defaultMaxAttempts, onTaskEvent, executionContext, usageCounter, config, allowReadingInvalidState, strategy, getPollInterval, apiKeyStrategy, eventLogger, enrichFakeRequest, }: Opts);
    /**

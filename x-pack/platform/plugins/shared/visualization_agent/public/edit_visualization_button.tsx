...
export const editButtonLabel = i18n.translate(
  'xpack.agentVisualization.conversation.visualization.edit',
  {
...
export const saveButtonLabel = i18n.translate(
  'xpack.agentVisualization.conversation.visualization.saveToDashboard',
  {
...
export const dashboardWriteControlsDisabledReason = i18n.translate(
  'xpack.agentVisualization.conversation.visualization.dashboardWriteControlsDisabledReason',
  {
    defaultMessage:

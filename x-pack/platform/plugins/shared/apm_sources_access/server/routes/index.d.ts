...
export declare const apmSourcesSettingsRouteRepository: {
    "POST /internal/apm-sources/settings/apm-indices/save": import("@kbn/server-route-repository-utils").ServerRoute<"POST /internal/apm-sources/settings/apm-indices/save", t.TypeC<{
        body: t.PartialC<{
            error: t.StringC;
    ...
    "GET /internal/apm-sources/settings/apm-index-settings": import("@kbn/server-route-repository-utils").ServerRoute<"GET /internal/apm-sources/settings/apm-index-settings", undefined, APMSourcesRouteHandlerResources, import("./settings").ApmIndexSettingsResponse, {}>;
    "GET /internal/apm-sources/settings/apm-indices": import("@kbn/server-route-repository-utils").ServerRoute<"GET /internal/apm-sources/settings/apm-indices", undefined, APMSourcesRouteHandlerResources, Readonly<{} & {
        error: string;
        span: string;
        metric: string;
        transaction: string;

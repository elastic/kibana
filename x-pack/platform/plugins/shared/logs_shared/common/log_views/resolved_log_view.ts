...
const resolveLegacyReference = async (
  ...
  const createDataViewPromise = useDataViewLazy
  ...
  return {
    ...
    // TODO: Fix " Property 'fields' does not exist on type 'DataView | DataViewLazy'."
    fields: useDataViewLazy ? dataViewReference.fields : [],
    runtimeMappings: {},

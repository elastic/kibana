...
import { type DataView, type DataViewsContract, type FieldSpec } from '@kbn/data-views-plugin/common';
...
import { type LogViewAttributes, type LogViewColumnConfiguration, type LogViewsStaticConfig } from './types';

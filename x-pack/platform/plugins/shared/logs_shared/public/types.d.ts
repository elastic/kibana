...
import type { LogsDataAccessPluginSetup, LogsDataAccessPluginStart } from '@kbn/logs-data-access-plugin/public';
...
export type LogsSharedClientCoreSetup = CoreSetup<LogsSharedClientStartDeps, LogsSharedClientStartExports>;
export type LogsSharedClientCoreStart = CoreStart;
export type LogsSharedClientPluginClass = PluginClass<LogsSharedClientSetupExports, LogsSharedClientStartExports, LogsSharedClientSetupDeps, LogsSharedClientStartDeps>;
...
export type LogsSharedClientStartServices = UnwrapPromise<ReturnType<LogsSharedClientStartServicesAccessor>>;

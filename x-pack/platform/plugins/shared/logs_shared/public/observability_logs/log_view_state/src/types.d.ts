...
import type { LogView, LogViewAttributes, LogViewReference, LogViewStatus, ResolvedLogView } from '../../../../common/log_views';
...
export type LogViewTypestate = {
    ...
    context: LogViewContextWithReference & LogViewContextWithLogView & LogViewContextWithResolvedLogView;
} | {
    value: 'resolvedPersistedLogView';
    context: LogViewContextWithReference & LogViewContextWithLogView & LogViewContextWithResolvedLogView & LogViewContextWithStatus;
} | {
...
export type LogViewNotificationChannel = NotificationChannel<LogViewContext, LogViewEvent, LogViewNotificationEvent>;

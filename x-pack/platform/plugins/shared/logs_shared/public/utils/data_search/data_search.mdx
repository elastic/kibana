...
<Canvas>
  {/* <Story id="infra-datasearch-datasearchprogress--undetermined-progress" /> is deprecated, please migrate it to <Story of={referenceToStory} /> see: https://storybook.js.org/migration-guides/7.0 */}
...
<Canvas>
  {/* <Story id="infra-datasearch-datasearchprogress--cancelable-determined-progress" /> is deprecated, please migrate it to <Story of={referenceToStory} /> see: https://storybook.js.org/migration-guides/7.0 */}
...
<Canvas>
  {/* <Story id="infra-datasearch-datasearcherrorcallout--error-callout-with-retry" /> is deprecated, please migrate it to <Story of={referenceToStory} /> see: https://storybook.js.org/migration-guides/7.0 */}

...
import { defaultLogViewsStaticConfig, type LogViewReference } from '../../../common/log_views';
import { type BuiltEsQuery, useLogStream } from '../../containers/logs/log_stream';
...
import { ScrollableLogTextStreamView, type VisibleInterval } from '../logging/log_text_stream';

import type { ElasticsearchClient, ElasticsearchServiceStart, KibanaRequest, SavedObjectsClientContract, SavedObjectsServiceStart } from '@kbn/core/server';
...
export type LogViewFallbackHandler = ((sourceId: string, options: LogViewFallbackHandlerOptions) => Promise<LogView>) | null;
...
export interface LogViewsServiceStart {
    getClient(savedObjectsClient: SavedObjectsClientContract, elasticsearchClient: ElasticsearchClient, logSourcesService: Promise<LogSourcesService>, request?: KibanaRequest): ILogViewsClient;

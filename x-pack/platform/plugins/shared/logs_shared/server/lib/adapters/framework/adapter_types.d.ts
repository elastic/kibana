...
export interface LogsSharedDatabaseSearchResponse<Hit = {}, Aggregations = undefined> extends LogsSharedDatabaseResponse {
    _shards: {
        total: number;
        successful: number;
        skipped: number;
...
export interface LogsSharedDatabaseMultiResponse<Hit, Aggregation> extends LogsSharedDatabaseResponse {

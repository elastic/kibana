...
import type { Dashboard, DataStreamSettings, DegradedFieldAnalysis, DegradedFieldValues, FailedDocsError, QualityIssue, UpdateFieldLimitResponse, DataStreamDetails } from '../../../common/api_types';
...
export type DefaultDatasetQualityDetailsContext = Pick<WithDefaultControllerState, 'qualityIssues' | 'failedDocsErrors' | 'timeRange' | 'isIndexNotFoundError' | 'showCurrentQualityIssues' | 'selectedIssueTypes' | 'selectedFields' | 'qualityIssuesChart' | 'view' | 'streamDefinition' | 'streamsUrls'>;
export type DatasetQualityDetailsControllerTypeState = {
    ...
    value: 'initializing.dataStreamSettings.doneFetchingQualityIssues' | 'initializing.dataStreamSettings.qualityIssues.dataStreamDegradedFields.fetchingDataStreamDegradedFields' | 'initializing.dataStreamSettings.qualityIssues.dataStreamDegradedFields.errorFetchingDegradedFields' | 'initializing.dataStreamSettings.qualityIssues.dataStreamFailedDocs.pending' | 'initializing.dataStreamSettings.qualityIssues.dataStreamFailedDocs.fetchingFailedDocs' | 'initializing.dataStreamSettings.qualityIssues.dataStreamFailedDocs.errorFetchingFailedDocs';
    context: WithDefaultControllerState & WithDataStreamSettings;
} | {
    value: 'initializing.dataStreamSettings.qualityIssues.dataStreamDegradedFields.doneFetchingDegradedFields' | 'initializing.dataStreamSettings.qualityIssues.dataStreamFailedDocs.doneFetchingFailedDocs';
    context: WithDefaultControllerState & WithDataStreamSettings & WithQualityIssuesData;
} | {
    value: 'initializing.checkAndLoadIntegrationAndDashboards.loadingIntegrationDashboards' | 'initializing.checkAndLoadIntegrationAndDashboards.unauthorizedToLoadDashboards';
    ...
    value: 'initializing.qualityIssueFlyout.open.degradedFieldFlyout.ignoredValues.fetching' | 'initializing.qualityIssueFlyout.open.degradedFieldFlyout.mitigation.analyzing' | 'initializing.qualityIssueFlyout.open.failedDocsFlyout.fetching';
    ...
    context: WithDefaultControllerState & WithQualityIssuesData & WithDegradedFieldValues & WithDegradeFieldAnalysis & WithNewFieldLimit & WithNewFieldLimitResponse;
} | {
...
export type DatasetQualityDetailsControllerContext = DatasetQualityDetailsControllerTypeState['context'];

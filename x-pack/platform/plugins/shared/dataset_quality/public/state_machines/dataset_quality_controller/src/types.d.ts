...
import type { DataStreamType, QualityIndicators, TableCriteria, TimeRangeConfig } from '../../../../common/types';
...
export type DefaultDatasetQualityControllerState = WithTableOptions & WithDataStreamStats & WithTotalDocs & WithDegradedDocs & WithFailedDocs & WithDatasets & WithFilters & WithAuthorizedDatasetTypes & WithNonAggregatableDatasets & Partial<WithIntegrations>;

...
import type { DataStreamDocsStat, NonAggregatableDatasets, UpdateFailureStoreResponse } from '../../../common/api_types';
...
export interface IDataStreamsStatsClient {
    ...
    getDataStreamsDegradedStats(params?: GetDataStreamsDegradedDocsStatsQuery): Promise<DataStreamDocsStat[]>;
    getDataStreamsFailedStats(params?: GetDataStreamsFailedDocsStatsQuery): Promise<DataStreamDocsStat[]>;
    getDataStreamsTotalDocs(params: GetDataStreamsTotalDocsQuery): Promise<DataStreamDocsStat[]>;
    getIntegrations(): Promise<Integration[]>;
    getNonAggregatableDatasets(params: GetNonAggregatableDataStreamsParams): Promise<NonAggregatableDatasets>;

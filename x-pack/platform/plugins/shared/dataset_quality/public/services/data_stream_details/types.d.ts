...
import type { GetDataStreamSettingsParams, DataStreamSettings, GetDataStreamDetailsParams, DataStreamDetails, GetIntegrationDashboardsParams, GetDataStreamDegradedFieldsParams, DegradedFieldResponse, GetDataStreamDegradedFieldValuesPathParams, GetDataStreamFailedDocsDetailsParams, GetDataStreamFailedDocsErrorsParams, GetDataStreamNonAggregatableParams } from '../../../common/data_streams_stats';
import type { AnalyzeDegradedFieldsParams, IntegrationType, CheckAndLoadIntegrationParams, UpdateFieldLimitParams, UpdateFailureStoreParams } from '../../../common/data_stream_details/types';
import type { Dashboard, DataStreamRolloverResponse, DegradedFieldAnalysis, DegradedFieldValues, FailedDocsDetails, FailedDocsErrorsResponse, UpdateFieldLimitResponse, UpdateFailureStoreResponse, NonAggregatableDatasets } from '../../../common/api_types';
...
export interface IDataStreamDetailsClient {
    ...
    getFailedDocsErrors(params: GetDataStreamFailedDocsErrorsParams): Promise<FailedDocsErrorsResponse>;
    getDataStreamDegradedFields(params: GetDataStreamDegradedFieldsParams): Promise<DegradedFieldResponse>;
    getDataStreamDegradedFieldValues(params: GetDataStreamDegradedFieldValuesPathParams): Promise<DegradedFieldValues>;

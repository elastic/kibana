...
import { type DatasetDetailsEbtProps, NavigationSource, NavigationTarget } from '../services/telemetry';
import { type BasicDataStream, type TimeRangeConfig } from '../../common/types';

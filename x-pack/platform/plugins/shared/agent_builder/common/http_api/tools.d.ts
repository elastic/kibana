...
export type CreateToolPayload = Omit<ToolDefinition, 'description' | 'tags' | 'readonly' | 'experimental'> & Partial<Pick<ToolDefinition, 'description' | 'tags'>>;
export type UpdateToolPayload = Partial<Pick<ToolDefinition, 'description' | 'tags' | 'confirmation'>> & {

...
export function registerPluginsRoutes({ router, getInternalServices, logger }: RouteDependencies) {
  ...
  router.versioned
    .get({
      ...
      description: 'Get a specific plugin by ID. To learn more, refer to the [plugins documentation](https://www.elastic.co/docs/explore-analyze/ai-features/agent-builder/plugins).',
      options: {
        tags: ['plugins', 'oas-tag:agent builder'],
        availability: {
          stability: 'experimental',
  ...
  router.versioned
    .delete({
      ...
      description: 'Delete an installed plugin by ID. This action cannot be undone. To learn more, refer to the [plugins documentation](https://www.elastic.co/docs/explore-analyze/ai-features/agent-builder/plugins).',
      options: {
        tags: ['plugins', 'oas-tag:agent builder'],
        availability: {
          stability: 'experimental',
  ...
  router.versioned
    .post({
      ...
      description:
        'Install a plugin from a [GitHub Claude plugin URL](https://code.claude.com/docs/en/plugins) or a direct ZIP URL. Plugins bundle agent capabilities such as skills. To learn more, refer to the [plugins documentation](https://www.elastic.co/docs/explore-analyze/ai-features/agent-builder/plugins).',
      options: {
        tags: ['plugins', 'oas-tag:agent builder'],
        availability: {
          stability: 'experimental',

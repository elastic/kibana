...
const MARK_PINNED_PATH = `${internalApiPath}/conversations/{conversation_id}/_mark_pinned`;
...
describe('registerInternalConversationRoutes - _mark_pinned', () => {
  let routeHandler: (ctx: any, req: any, res: any) => Promise<any>;
  let update: jest.Mock;
  ...
  beforeEach(() => {
    ...
    routeHandler = routeHandlers[MARK_PINNED_PATH];
  });

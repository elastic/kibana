...
export function registerA2ARoutes({
  ...
  router.versioned
    .get({
      ...
      description:
        'Get agent discovery metadata in JSON format. Use this endpoint to provide agent information for A2A protocol integration and discovery. To learn more, refer to the [A2A server documentation](https://www.elastic.co/docs/explore-analyze/ai-features/agent-builder/a2a-server).',
      options: {
...
To learn more, refer to the [A2A server documentation](https://www.elastic.co/docs/explore-analyze/ai-features/agent-builder/a2a-server).`,
      options: {
        tags: ['a2a', 'oas-tag:agent builder'],
        xsrfRequired: false,
        availability: {

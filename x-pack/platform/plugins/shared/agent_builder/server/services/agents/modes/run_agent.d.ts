import type { AgentCapabilities, Conversation, ConversationRound, ConverseInput, AgentConfiguration, RuntimeAgentConfigurationOverrides, ConversationAction } from '@kbn/agent-builder-common';
...
export declare const runAgent: (params: RunAgentParams, context: AgentHandlerContext) => Promise<RunAgentResponse>;

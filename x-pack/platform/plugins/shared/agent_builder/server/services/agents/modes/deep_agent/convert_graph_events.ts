...
import { createErrorResult, RunToolReturn } from '@kbn/agent-builder-server';
...
/**
 * Custom extractToolReturn because the one from @kbn/agent-builder-genai-utils/langchain

...
import { hasAgentVisibilityAccessOverrideFromRequest, getUserFromRequest } from '../../../utils';
import type {
  AgentCreateRequest,
  AgentDeleteRequest,
  AgentListOptions,
...
class AgentClientImpl implements AgentClient {
  ...
  private readonly hasAgentVisibilityAccessOverride: boolean;
  ...
  constructor({
    ...
    this.user = user;
    this.hasAgentVisibilityAccessOverride = hasAgentVisibilityAccessOverride;
    this.space = space;
    this.logger = logger;
  }
  ...
  async list(options: AgentListOptions = {}): Promise<PersistedAgentDefinition[]> {
    ...
    if (!this.hasAgentVisibilityAccessOverride) {
  ...
  async update(
    ...
    if (
      !validateVisibilityUpdateAccess({
        ...
        user: this.user,
        hasAgentVisibilityAccessOverride: this.hasAgentVisibilityAccessOverride,
      })
    ) {

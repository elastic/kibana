 ...
 */
export interface ToolTypeDefinition<TType extends ToolType = ToolType, TConfig extends object = {}, TSchema extends ZodObject<any> = ZodObject<any>, 
/**
...
TPersistedConfig extends object = TConfig> {
     ...
     */
    convertFromPersistence?: (config: TPersistedConfig, context: ToolTypeConversionContext) => TConfig;
    /**
...
export type AnyToolTypeDefinition<TType extends ToolType = ToolType, TConfig extends object = {}, TSchema extends ZodObject<any> = ZodObject<any>> = ToolTypeDefinition<TType, TConfig, TSchema> | DisabledToolTypeDefinition<TType> | BuiltinToolTypeDefinition;
export declare const isEnabledDefinition: <TType extends ToolType, TConfig extends object = {}, TSchema extends ZodObject<any> = ZodObject<any>>(definition: AnyToolTypeDefinition<TType, TConfig, TSchema>) => definition is ToolTypeDefinition<TType, TConfig, TSchema>;
export declare const isBuiltinDefinition: <TType extends ToolType, TConfig extends object = {}, TSchema extends ZodObject<any> = ZodObject<any>>(definition: AnyToolTypeDefinition<TType, TConfig, TSchema>) => definition is BuiltinToolTypeDefinition;
export declare const isDisabledDefinition: <TType extends ToolType, TConfig extends object = {}, TSchema extends ZodObject<any> = ZodObject<any>>(definition: AnyToolTypeDefinition<TType, TConfig, TSchema>) => definition is DisabledToolTypeDefinition<TType>;
export interface ToolHandlerDynamicProps<TConfig extends object = {}, TSchema extends ZodObject<any> = ZodObject<any>> {
    /**
...
export type ToolHandlerDynamicPropsFn<TConfig extends object = {}, TSchema extends ZodObject<any> = ZodObject<any>> = (config: TConfig, ctx: ToolDynamicPropsContext) => MaybePromise<ToolHandlerDynamicProps<TConfig, TSchema>>;

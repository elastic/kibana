...
import type { InternalToolDefinition, ToolCreateParams, ToolUpdateParams } from '@kbn/agent-builder-server/tools';
...
export declare const isReadonlyToolProvider: (provider: ToolProvider) => provider is ReadonlyToolProvider;
export declare const isWritableToolProvider: (provider: ToolProvider) => provider is WritableToolProvider;

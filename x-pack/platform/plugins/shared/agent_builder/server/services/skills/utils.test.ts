...
describe('internalToPublicDefinition', () => {
  ...
  it('preserves readonly flag for builtin skills', () => {
  ...
  it('preserves readonly flag for persisted skills', () => {
  ...
  it('converts referencedContent to referenced_content', () => {
    const skill = createMockInternalSkill({
      referencedContent: [
  ...
  it('does not include basePath or getInlineTools in the public definition', () => {
    const skill = createMockInternalSkill({

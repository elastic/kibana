...
export const FOLLOW_EXECUTION_TIMEOUT_MS = 25 * 60 * 1000; // 25 minutes (must exceed idle timeout)
...
export const FOLLOW_EXECUTION_IDLE_TIMEOUT_MS = 20 * 60 * 1000; // 20 minutes (long-running tools e.g. malware analysis)

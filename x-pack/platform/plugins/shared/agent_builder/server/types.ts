...
import type { RunToolFn } from '@kbn/agent-builder-server';
...
export interface AttachmentsSetup {
  /**
   * Register an attachment type to be available in Agent Builder.
   */
  registerType: AttachmentServiceSetup['registerType'];
}

/**
 * Agent Builder tool service's setup contract
 */
export interface ToolsSetup {
  /**
   * Register a built-in tool to be available in Agent Builder.
   */
  register: ToolsServiceSetup['register'];
}

/**
 * Agent Builder tool service's start contract
 */
...
export interface AgentsSetup {
  /**
   * Register a built-in agent to be available in Agent Builder.
   */
  register: (definition: BuiltInAgentDefinition) => void;
}

/**
 * Setup contract of the Agent Builder plugin.
 */
...
/**
 * Start contract of the Agent Builder plugin.
 */

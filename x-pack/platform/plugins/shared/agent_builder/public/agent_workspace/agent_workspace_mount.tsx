...
export const setAgentWorkspaceMountContext = (
  context: AgentWorkspaceMountContext | null
): void => {
...
export function AgentWorkspaceMount() {
  ...
  return (
    <div css={mountRootStyles} data-test-subj={AGENT_WORKSPACE_MOUNT_TEST_SUBJ}>
      <div
        ref={elementRef}
        css={css`
          display: flex;

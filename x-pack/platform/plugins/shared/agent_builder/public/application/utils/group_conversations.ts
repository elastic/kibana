...
const toLabel = (section: SectionGroup): string => {
  switch (section) {
    case SectionGroup.Today:
      return i18n.translate('xpack.agentBuilder.conversationsHistory.group.today', {
        defaultMessage: 'Today',
      });
    case SectionGroup.Yesterday:
      return i18n.translate('xpack.agentBuilder.conversationsHistory.group.yesterday', {
        defaultMessage: 'Yesterday',
      });
    case SectionGroup.LastWeek:
      return i18n.translate('xpack.agentBuilder.conversationsHistory.group.lastWeek', {
        defaultMessage: 'Last Week',
      });
    case SectionGroup.Last2Weeks:
      return i18n.translate('xpack.agentBuilder.conversationsHistory.group.last2Weeks', {
        defaultMessage: 'Last 2 Weeks',
      });
    case SectionGroup.LastMonth:
      return i18n.translate('xpack.agentBuilder.conversationsHistory.group.lastMonth', {
        defaultMessage: 'Last Month',
      });
    case SectionGroup.Last3Months:
      return i18n.translate('xpack.agentBuilder.conversationsHistory.group.last3Months', {
        defaultMessage: 'Last 3 Months',
      });
    case SectionGroup.Older:
      return i18n.translate('xpack.agentBuilder.conversationsHistory.group.older', {

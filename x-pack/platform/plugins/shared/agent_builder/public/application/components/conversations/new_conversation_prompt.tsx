...
const createAgentCard: QuickNavigationCard = {
  ...
  title: (
    <FormattedMessage
      id="xpack.agentBuilder.welcome.quickNavigation.agentCreation.title"
      defaultMessage="Create a new agent"
    />
  ),
  description: (
    <FormattedMessage
      id="xpack.agentBuilder.welcome.quickNavigation.agentCreation.description"
...
const cards: Array<QuickNavigationCard> = [
  // Manage agents
  {
    ...
    title: (
      <FormattedMessage
        id="xpack.agentBuilder.welcome.quickNavigation.agentManagement.title"
        defaultMessage="Manage agents"
      />
    ),
    description: (
      <FormattedMessage
        id="xpack.agentBuilder.welcome.quickNavigation.agentManagement.description"
  ...
  // Manage tools
  {
    ...
    title: (
      <FormattedMessage
        id="xpack.agentBuilder.welcome.quickNavigation.toolManagement.title"
        defaultMessage="Manage tools"
      />
    ),
    description: (
      <FormattedMessage
        id="xpack.agentBuilder.welcome.quickNavigation.toolManagement.description"
  ...
  // Documentation - Get Started
  {
    ...
    title: (
      <FormattedMessage
        id="xpack.agentBuilder.welcome.quickNavigation.documentation.title"
        defaultMessage="Get started"
      />
    ),
    description: (
      <FormattedMessage
        id="xpack.agentBuilder.welcome.quickNavigation.documentation.description"
        ...
        return (
          <EuiFlexItem key={key} component="li">
            <EuiCard
              ...
              href={'url' in link ? link.url : createAgentBuilderUrl(link.path)}
            />
          </EuiFlexItem>
        );
      })}

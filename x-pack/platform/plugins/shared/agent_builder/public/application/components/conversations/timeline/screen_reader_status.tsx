...
const useGeneratingAnnouncements = (isActive: boolean) => {
  ...
  useEffect(() => {
    ...
    setAnnouncement(
      i18n.translate('xpack.agentBuilder.timelineScreenReaderStatus.generatingAnnouncement', {
    ...
    const scheduleNext = () => {
      timeoutId = window.setTimeout(() => {
        ...
        setAnnouncement(
          i18n.translate(
            'xpack.agentBuilder.timelineScreenReaderStatus.stillGeneratingAnnouncement',
            {
...
export const TimelineScreenReaderStatus: React.FC<{ responseMessage?: string }> = ({
  responseMessage,
}) => {
    ...
    >
      ...
      <div role="status" aria-live="polite" aria-atomic="true">
        {shouldAnnounceResponse && responseMessage
          ? i18n.translate('xpack.agentBuilder.timelineScreenReaderStatus.agentResponse', {

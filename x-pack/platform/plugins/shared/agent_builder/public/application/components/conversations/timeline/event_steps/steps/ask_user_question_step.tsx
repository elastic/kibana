...
export const AskUserQuestionStepEvent: React.FC<AskUserQuestionStepEventProps> = ({ step }) => {
  ...
  const labelText =
    skipped > 0
      ? i18n.translate('xpack.agentBuilder.eventSteps.askUserQuestionStep.labelWithSkipped', {
          defaultMessage: 'Clarification • {answered} answered, {skipped} skipped',
          values: { answered, skipped },
        })
      : i18n.translate('xpack.agentBuilder.eventSteps.askUserQuestionStep.label', {

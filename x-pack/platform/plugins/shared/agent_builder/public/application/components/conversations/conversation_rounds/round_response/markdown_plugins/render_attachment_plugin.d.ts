 ...
 */
export declare const createRenderAttachmentRenderer: ({ attachmentsService, conversationAttachments, attachmentRefs, conversationId, isSidebar, isStreaming, }: RenderAttachmentRendererProps) => (props: RenderAttachmentElementAttributes) => React.JSX.Element | null;
export {};

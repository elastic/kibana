...
import { useConversationRounds, useConversationAttachments } from '../../../hooks/use_conversation';
      ...
      {conversationRounds.map((round, index) => {
        ...
        return (
          <RoundLayout
            ...
            rawRound={round}
            conversationAttachments={isCurrentRound ? conversationAttachments : undefined}
          />
        );
      })}
    </EuiFlexGroup>

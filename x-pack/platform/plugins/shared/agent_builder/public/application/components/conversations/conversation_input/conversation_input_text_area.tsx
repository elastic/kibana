...
export const ConversationInputTextArea: React.FC<ConversationInputTextAreaProps> = ({
  ...
  const disabledPlaceholder = i18n.translate(
    'xpack.agentBuilder.conversationInputForm.disabledPlaceholder',
    {
  ...
  return (
    <EuiFlexItem css={inputContainerStyles}>
      <EuiTextArea
        ...
        name={i18n.translate('xpack.agentBuilder.conversationInputForm.textArea.name', {
          defaultMessage: 'Conversation input',
        })}
        css={textareaStyles}
        data-test-subj="agentBuilderAppConversationInputFormTextArea"
        value={input}
        onChange={(event) => {
        ...
        placeholder={
          disabled
            ? disabledPlaceholder
            : i18n.translate('xpack.agentBuilder.conversationInputForm.placeholder', {

...
describe('RoundResponseActions', () => {
  ...
  it('renders feedback buttons for a completed, editable round', () => {
    render(
  ...
  it('hides feedback when the conversation is read-only', () => {
  ...
  it('hides feedback while the read-only state is loading', () => {
  ...
  it('hides feedback when no rawRound is provided', () => {
    render(<RoundResponseActions content="the answer" isVisible />);

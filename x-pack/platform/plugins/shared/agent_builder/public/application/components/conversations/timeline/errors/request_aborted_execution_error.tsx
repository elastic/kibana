...
export const RequestAbortedExecutionError: React.FC = () => {
  return (
    <EuiFlexGroup
      direction="column"
      gutterSize="s"
      data-test-subj="agentBuilderExecutionErrorRequestAborted"
    >
      <EuiFlexItem grow={false}>
        <EuiText size="s">
          <p>
            <FormattedMessage
              id="xpack.agentBuilder.executionError.requestAborted.description"

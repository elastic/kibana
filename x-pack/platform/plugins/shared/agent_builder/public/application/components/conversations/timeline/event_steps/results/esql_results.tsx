  ...
  return (
    <EuiFlexGroup direction="row" gutterSize="xs" alignItems="center">
      <EuiText size="s">
        ...
        >
          <FormattedMessage
            id="xpack.agentBuilder.eventSteps.results.esqlResults.foundRecordsMessage"
            defaultMessage="Found {totalResults, plural, one {{totalResults, number} result} other {{totalResults, number} results}}"
            values={{ totalResults: data.values.length }}
          />
        </EuiLink>
      </EuiText>
    </EuiFlexGroup>

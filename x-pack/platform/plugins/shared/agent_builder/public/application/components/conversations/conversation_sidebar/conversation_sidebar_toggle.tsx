...
export const ConversationSidebarToggle: React.FC<ConversationSidebarToggleProps> = ({
  ...
  const labels = {
    open: i18n.translate('xpack.agentBuilder.conversationSidebarToggle.open', {
      defaultMessage: 'Open sidebar',
    }),
    close: i18n.translate('xpack.agentBuilder.conversationSidebarToggle.close', {
  ...
  return (
    <EuiPageHeaderSection>
      <EuiButtonIcon
        ...
        display="empty"
        data-test-subj="agentBuilderSidebarToggleBtn"
      />
    </EuiPageHeaderSection>
  );
};

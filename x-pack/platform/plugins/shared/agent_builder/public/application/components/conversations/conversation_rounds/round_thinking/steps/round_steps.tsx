...
const labels = {
  ...
  toolResponse: i18n.translate('xpack.agentBuilder.thinking.toolResponseLabel', {
    defaultMessage: 'Tool response',
  }),
  inspectResponse: i18n.translate('xpack.agentBuilder.thinking.inspectResponseLabel', {
          ...
          <p id={responseId} role="status" aria-label={labels.toolResponse}>
            <FormattedMessage
              ...
              values={{
                tool: (
                  <EuiCode
                    aria-label={i18n.translate('xpack.agentBuilder.thinking.toolName', {
                ...
                inspectResponse: (
                  <EuiLink
                    ...
                    role="button"
                  >
                    {i18n.translate('xpack.agentBuilder.conversation.roundResultsButton', {

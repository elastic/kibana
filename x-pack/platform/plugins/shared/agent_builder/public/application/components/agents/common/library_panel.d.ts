...
export declare const LibraryPanel: <T extends LibraryItem>({ onClose, allItems, activeItemIdSet, onToggleItem, flyoutTitleId, libraryLabels, manageLibraryPath, getItemName, getSearchableText, disabledItemIdSet, readOnlyItemIdSet, callout, ebtEntityType, }: LibraryPanelProps<T>) => React.JSX.Element;

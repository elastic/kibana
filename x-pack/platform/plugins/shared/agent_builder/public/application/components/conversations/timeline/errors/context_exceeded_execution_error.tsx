...
const labels = {
  learnMore: i18n.translate('xpack.agentBuilder.executionError.contextExceeded.learnMore', {
    defaultMessage: 'Learn more',
  }),
};

export const ContextExceededExecutionError: React.FC = () => {
  ...
  return (
    <EuiFlexGroup
      direction="column"
      gutterSize="s"
      data-test-subj="agentBuilderExecutionErrorContextExceeded"
    >
      <EuiFlexItem grow={false}>
        <EuiText size="s">
          <p>
            <FormattedMessage
              id="xpack.agentBuilder.executionError.contextExceeded.description"

...
const backLabel = i18n.translate('xpack.agentBuilder.eventSteps.subAgentExecutionFlyout.back', {
  defaultMessage: 'Back',
});

const subAgentExecutionTitle = i18n.translate(
  'xpack.agentBuilder.eventSteps.subAgentExecutionFlyout.title',
  { defaultMessage: 'Sub-agent execution' }
);

const executionIdLabel = i18n.translate(
  'xpack.agentBuilder.eventSteps.subAgentExecutionFlyout.executionIdLabel',
  ...
  const euiSteps = [
      ...
      : []),
    {
      ...
      status: (hasError ? 'danger' : isRunning && !isCompleted ? 'loading' : 'complete') as
        ...
        | 'loading'
        | 'complete',
      children: <EventSteps steps={executionSteps} />,
    },
              ...
              <>
                {hasError ? (
                  <EuiCallOut
                    ...
                    title={
                      <FormattedMessage
                        id="xpack.agentBuilder.eventSteps.subAgentExecutionFlyout.errorTitle"

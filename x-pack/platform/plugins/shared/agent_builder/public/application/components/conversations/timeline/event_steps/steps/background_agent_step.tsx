...
const viewJsonLabel = i18n.translate(
  'xpack.agentBuilder.eventSteps.steps.backgroundAgent.viewJson',
  { defaultMessage: 'View JSON' }
);

const flyoutTitle = i18n.translate(
  'xpack.agentBuilder.eventSteps.steps.backgroundAgent.flyoutTitle',
      ...
      <EuiFlexItem grow={false}>
        <EuiText color={isFailure ? 'danger' : 'inherit'}>
          <p role="status">
            {isFailure ? (
              <FormattedMessage
                id="xpack.agentBuilder.eventSteps.steps.backgroundAgent.failed"
              ...
              <FormattedMessage
                id="xpack.agentBuilder.eventSteps.steps.backgroundAgent.completed"

...
export declare const useDeleteConnectorService: ({ onSuccess, onError, }?: {
    ...
    deleteConnectorSync: import("@tanstack/react-query").UseMutateFunction<void, Error, DeleteConnectorMutationVariables, unknown>;
    deleteConnector: import("@tanstack/react-query").UseMutateAsyncFunction<void, Error, DeleteConnectorMutationVariables, unknown>;
    isLoading: boolean;
};
...
export declare const useBulkDeleteConnectorsService: ({ onSuccess, onError, }?: {
    ...
    deleteConnectorsSync: import("@tanstack/react-query").UseMutateFunction<BulkDeleteConnectorsResponse, Error, BulkDeleteConnectorsMutationVariables, unknown>;
    deleteConnectors: import("@tanstack/react-query").UseMutateAsyncFunction<BulkDeleteConnectorsResponse, Error, BulkDeleteConnectorsMutationVariables, unknown>;
    isLoading: boolean;
};

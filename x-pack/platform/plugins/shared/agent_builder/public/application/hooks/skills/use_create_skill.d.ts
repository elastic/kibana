...
export declare const useCreateSkillService: ({ onSuccess, onError }?: UseCreateSkillServiceProps) => {
    createSkillSync: import("@tanstack/react-query").UseMutateFunction<import("@kbn/agent-builder-common").PublicSkillDefinition, Error, import("@kbn/agent-builder-common").PersistedSkillCreateRequest, unknown>;
    createSkill: import("@tanstack/react-query").UseMutateAsyncFunction<import("@kbn/agent-builder-common").PublicSkillDefinition, Error, import("@kbn/agent-builder-common").PersistedSkillCreateRequest, unknown>;
    isLoading: boolean;
};

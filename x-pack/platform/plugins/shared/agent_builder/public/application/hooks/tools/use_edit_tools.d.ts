...
export declare const useEditToolService: ({ onSuccess, onError }?: UseEditToolServiceProps) => {
    updateToolSync: import("@tanstack/react-query").UseMutateFunction<UpdateToolResponse, Error, EditToolMutationVariables, unknown>;
    updateTool: import("@tanstack/react-query").UseMutateAsyncFunction<UpdateToolResponse, Error, EditToolMutationVariables, unknown>;
    isLoading: boolean;
};

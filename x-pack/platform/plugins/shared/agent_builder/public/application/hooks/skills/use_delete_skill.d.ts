...
export declare const useDeleteSkillService: ({ onSuccess, onError, }?: {
    ...
    deleteSkillSync: import("@tanstack/react-query").UseMutateFunction<DeleteSkillResponse, Error, DeleteSkillMutationVariables, unknown>;
    deleteSkill: import("@tanstack/react-query").UseMutateAsyncFunction<DeleteSkillResponse, Error, DeleteSkillMutationVariables, unknown>;
    isLoading: boolean;
};

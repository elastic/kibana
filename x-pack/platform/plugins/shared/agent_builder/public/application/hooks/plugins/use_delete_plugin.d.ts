...
export declare const useDeletePluginService: ({ onSuccess, onError, }?: {
    ...
    deletePluginSync: import("@tanstack/react-query").UseMutateFunction<DeletePluginResponse, Error, DeletePluginMutationVariables, unknown>;
    deletePlugin: import("@tanstack/react-query").UseMutateAsyncFunction<DeletePluginResponse, Error, DeletePluginMutationVariables, unknown>;
    isLoading: boolean;
};

...
export declare const useEditSkillService: ({ onSuccess, onError }?: UseEditSkillServiceProps) => {
    updateSkillSync: import("@tanstack/react-query").UseMutateFunction<import("@kbn/agent-builder-common").PublicSkillDefinition, Error, EditSkillMutationVariables, unknown>;
    updateSkill: import("@tanstack/react-query").UseMutateAsyncFunction<import("@kbn/agent-builder-common").PublicSkillDefinition, Error, EditSkillMutationVariables, unknown>;
    isLoading: boolean;
};

...
export declare const useDeleteToolService: ({ onSuccess, onError, }?: {
    ...
    deleteToolSync: import("@tanstack/react-query").UseMutateFunction<DeleteToolResponse, Error, DeleteToolMutationVariables, unknown>;
    deleteTool: import("@tanstack/react-query").UseMutateAsyncFunction<DeleteToolResponse, Error, DeleteToolMutationVariables, unknown>;
    isLoading: boolean;
};
export declare const useDeleteToolsService: ({ onSuccess, onError, }?: {
    ...
    deleteToolsSync: import("@tanstack/react-query").UseMutateFunction<BulkDeleteToolResponse, Error, DeleteToolsMutationVariables, unknown>;
    deleteTools: import("@tanstack/react-query").UseMutateAsyncFunction<BulkDeleteToolResponse, Error, DeleteToolsMutationVariables, unknown>;
    isLoading: boolean;
};

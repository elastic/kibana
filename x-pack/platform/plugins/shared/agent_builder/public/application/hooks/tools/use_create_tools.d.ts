...
export declare const useCreateToolService: ({ onSuccess, onError }?: UseCreateToolServiceProps) => {
    createToolSync: import("@tanstack/react-query").UseMutateFunction<CreateToolResponse, Error, CreateToolPayload, unknown>;
    createTool: import("@tanstack/react-query").UseMutateAsyncFunction<CreateToolResponse, Error, CreateToolPayload, unknown>;
    isLoading: boolean;
};

...
in `x-pack/platform/packages/shared/agent_builder/agent-builder-server/allow_lists.ts`
...
to the `protectedNamespaces` array in `x-pack/platform/packages/shared/agent_builder/agent-builder-common/base/namespaces.ts`
...
Refer to `ToolHandlerContext` in `x-pack/platform/packages/shared/agent_builder/agent-builder-server/tools/handler.ts` to
...
See the `ToolResultType` and corresponding types in `x-pack/platform/packages/shared/agent_builder/agent-builder-common/tools/tool_result.ts`
...
Refer to [`AgentConfiguration`](https://github.com/elastic/kibana/blob/main/x-pack/platform/packages/shared/agent_builder/agent-builder-common/agents/definition.ts)
...
Refer to [`AttachmentTypeDefinition`](https://github.com/elastic/kibana/blob/main/x-pack/platform/packages/shared/agent_builder/agent-builder-server/attachments/type_definition.ts)
for the full list of available configuration options.

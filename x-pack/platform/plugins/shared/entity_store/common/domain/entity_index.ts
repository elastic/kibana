...
/** @deprecated Legacy Security-scoped concrete latest index; used only for upgrade migration. */
export const getLegacySecurityLatestEntitiesIndexName = (namespace: string) =>
...
/** @deprecated Legacy Security-scoped latest index pattern; used only for upgrade migration. */
export const getLegacySecurityLatestEntityIndexPattern = (namespace: string) =>
  `${getLegacySecurityEntityIndexPattern({
    schemaVersion: ENTITY_SCHEMA_VERSION_V2,
    dataset: ENTITY_LATEST,
    namespace,

...
export const EngineDescriptor = z.object({
  ...
  /** Non-priority process cursor. Absent on descriptors written before model version 9, and null
   * while dual-process is off. Both mean "no cursor": extraction starts from now - lookbackPeriod. */

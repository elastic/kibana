...
export const MAX_HISTORY_SNAPSHOT_RETENTION_DAYS = 3650;
...
export const HistorySnapshotState = z.object({
  ...
  /** Calendar days of history snapshot indices to keep. Age is taken from the index name date, not the hour. */
  retentionDays: z
    .number()
    .int()
    .min(1)

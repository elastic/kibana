...
export const getMetadataIndexIngestPipelineId = (namespace: string): string =>
  `.${ENTITY_BASE_PREFIX}.${ENTITY_SCHEMA_VERSION_V2}.${ENTITY_METADATA}.${namespace}_ingest_pipeline`;

/** @deprecated Legacy Security-scoped name; used only for upgrade migration. */
export const getLegacySecurityMetadataIndexIngestPipelineId = (namespace: string): string =>

...
export const getMetadataIndexTemplateId = (namespace: string) =>
  `.${ENTITY_BASE_PREFIX}_${ENTITY_SCHEMA_VERSION_V2}_${ENTITY_METADATA}_${namespace}_index_template` as const;

/** @deprecated Legacy Security-scoped name; used only for upgrade migration. */
export const getLegacySecurityMetadataIndexTemplateId = (namespace: string) =>

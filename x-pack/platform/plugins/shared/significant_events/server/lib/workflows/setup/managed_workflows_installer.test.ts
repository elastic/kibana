...
// the full set: 9 base workflows + 4 memory workflows (both via `installWorkflows`). The
// investigation workflow is no longer installed here — its managed-workflow ownership moved to

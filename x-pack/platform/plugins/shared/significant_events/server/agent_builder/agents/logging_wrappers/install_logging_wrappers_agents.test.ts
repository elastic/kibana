...
import { installLoggingWrappersAgents } from './install_logging_wrappers_agents';

describe('installLoggingWrappersAgents', () => {
  it('ensures system-owned persisted typed agents in the requested space', async () => {
    ...
    await installLoggingWrappersAgents({ agentBuilder, spaceId: 'space-1', availability });

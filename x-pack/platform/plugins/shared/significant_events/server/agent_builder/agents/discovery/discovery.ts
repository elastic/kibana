...
export const discoveryAgentType = {
  ...
  description:
    'Triages statistical detection signals across rules, correlates related detections into significant events using shared infrastructure, temporal proximity, and causal plausibility, verifies current state, and writes final event records with status, calibrated severity, and supporting evidence.',

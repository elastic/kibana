...
### Discovering Existing Workflows (Context Engine)

To list or find existing workflows, use the Context Engine (Context Engine) tools — do NOT use \`${platformCoreTools.search}\` to query internal indices.

export declare const maintenanceWindowsStatusSchema: import("@kbn/config-schema").Type<"disabled" | "running" | "finished" | "upcoming" | "archived">;
export declare const findMaintenanceWindowsParamsSchema: import("@kbn/config-schema").ObjectType<{
    status: import("@kbn/config-schema").Type<("disabled" | "running" | "finished" | "upcoming" | "archived")[] | undefined>;

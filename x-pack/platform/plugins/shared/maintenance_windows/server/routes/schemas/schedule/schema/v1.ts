...
export const scheduleRequestSchema = schema.object(
  {
    ...
    recurring: schema.maybe(
      schema.object(
        ...
        { meta: { id: 'maintenance_window_schedule_recurring_request' } }
      )
    ),
  },
  {
    validate: validateScheduleV1,
    meta: { id: 'maintenance_window_schedule_request' },
  }
);
...
export const scheduleResponseSchema = schema.object(
  {
    ...
    recurring: schema.maybe(
      schema.object(
        ...
        { meta: { id: 'maintenance_window_schedule_recurring_response' } }
      )
    ),
  },
  { meta: { id: 'maintenance_window_schedule_response' } }
);

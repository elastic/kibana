...
import { InitialSolutionSetupPage } from './page_objects';

export interface ExtScoutTestFixtures extends ScoutTestFixtures {
  pageObjects: PageObjects & {
    initialSolutionSetup: InitialSolutionSetupPage;
  };
}
...
export const test = baseTest.extend<ExtScoutTestFixtures, ScoutWorkerFixtures>({
  pageObjects: async (
    ...
    const extendedPageObjects = {
      ...pageObjects,
      initialSolutionSetup: createLazyPageObject(InitialSolutionSetupPage, page),
    };

...
export type { CopyToSpaceFlyoutProps, CopyToSpaceSavedObjectTarget, CopySavedObjectsToSpaceResponse, } from './copy_saved_objects_to_space';
export type { LegacyUrlConflictProps, EmbeddableLegacyUrlConflictProps, RedirectLegacyUrlParams, } from './legacy_urls';
export type { ShareToSpaceFlyoutProps, ShareToSpaceSavedObjectTarget, } from './share_saved_objects_to_space';
...
export declare const plugin: (initializerContext: PluginInitializerContext) => SpacesPlugin;

...
export type CckConfig = TypeOf<typeof configSchema>;

export type CckServerDefinition = CckConfig['servers'][number];
...
export type CckPublicConfig = Pick<CckConfig, ValidKeys>;

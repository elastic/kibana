 ...
 */
export declare const fetchFieldCandidates: import("@reduxjs/toolkit").AsyncThunk<void, FetchFieldCandidatesParams, import("@reduxjs/toolkit").AsyncThunkConfig>;
...
}, "log_rate_analysis_field_candidates", "log_rate_analysis_field_candidates", import("@reduxjs/toolkit").SliceSelectors<FieldCandidatesState>>;

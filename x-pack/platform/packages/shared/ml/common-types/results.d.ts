...
import type { ES_AGGREGATION, ML_JOB_AGGREGATION, MlAnomaliesTableRecord } from '@kbn/ml-anomaly-utils';
...
export declare const defaultSearchQuery: NonNullable<estypes.QueryDslQueryContainer>;
...
export type InfluencersByFieldResponse = Record<string, Array<{

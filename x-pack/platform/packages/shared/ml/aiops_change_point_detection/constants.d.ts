...
export declare const CHANGE_POINT_CHART_MAX_SERIES = 50;
export declare const CHANGE_POINT_CHART_DEFAULT_SERIES = 6;
export declare const CHANGE_POINT_CHART_DEFAULT_AGG_FUNCTION: "avg";

import type { QueryDslQueryContainer, Refresh, SortCombinations } from '@elastic/elasticsearch/lib/api/types';
/**
...
export declare const CHANGE_HISTORY_AGGREGATE_FIELDS: readonly ["user.name", "user.id", "event.action", "event.type"];

...
/**
 * W3C baggage key used by offline eval runs to tag all inference spans with the current eval thread id.
 *
 * This is intended to be set by clients (e.g. Scout/evals test runner) via the `baggage` HTTP header,
 * and then propagated through tracing context.
 */
export const EVAL_THREAD_ID_BAGGAGE_KEY = 'kibana.evals.thread_id';

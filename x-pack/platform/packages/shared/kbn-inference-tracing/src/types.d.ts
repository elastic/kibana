...
interface GenAISemConvEvent<TName extends string, TBody extends {}, TAttributeName extends keyof GenAISemConvAttributes> {
    name: TName;
    body: TBody;
    attributes?: {
...
export type SystemMessageEvent = GenAISemConvEvent<GenAISemanticConventions.GenAISystemMessage, {
    role: 'system';
    content: string;
}, GenAISemanticConventions.GenAISystem>;
export type UserMessageEvent = GenAISemConvEvent<GenAISemanticConventions.GenAIUserMessage, {
    role: 'user';
    content: string;
}, GenAISemanticConventions.GenAISystem>;
export type AssistantMessageEvent = GenAISemConvEvent<GenAISemanticConventions.GenAIAssistantMessage, {
    content?: unknown;
    role: 'assistant';
    tool_calls?: Array<{
        function: {
...
export type ToolMessageEvent = GenAISemConvEvent<GenAISemanticConventions.GenAIToolMessage, {
    content?: string;
    id: string;
    role: 'tool' | 'function';
}, GenAISemanticConventions.GenAISystem>;
export type ChoiceEvent = GenAISemConvEvent<GenAISemanticConventions.GenAIChoice, {
    index: number;
...
export type MessageEvent = SystemMessageEvent | UserMessageEvent | AssistantMessageEvent | ToolMessageEvent | ChoiceEvent;

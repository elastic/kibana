...
export interface SystemEvaluationExample {
  input: {
    stream: {
      name: string;
    };
...
export interface SystemEvaluationDataset {
  name: string;
  description: string;
  examples: SystemEvaluationExample[];
}

export const SYSTEM_IDENTIFICATION_DATASETS: {
  loghub: SystemEvaluationDataset[];
  serverless: SystemEvaluationDataset[];
  mixed: SystemEvaluationDataset[];
} = {
  loghub: [
    {

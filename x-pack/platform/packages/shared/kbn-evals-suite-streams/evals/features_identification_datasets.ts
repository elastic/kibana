      ...
      sample_documents: [
        {
          ...
          message: 'checkout-api v4.8.0 initializing... runtime: Go go1.22.1 arch=linux/amd64 build=9f2c1a7',
        ...
        },
        {
          ...
          message: 'cache connection successful redis-cache.internal:6379 server_version=7.2.5 mode=standalone',
          'service.name': 'checkout-api',
          'log.level': 'INFO'
        },
        {
    ...
    input: {
      sample_documents: [
        ...
        },
        {
          ...
          message: 'HikariPool-1 starting up... driver: MySQL Connector/J 8.2.0 autoCommit=false poolSize=10',
          'service.name': 'order-service',
          'log.level': 'INFO'
        },
        {
          '@timestamp': '2026-02-05T14:30:00.280Z',
          message: 'MySQL 8.0.35 connection established mysql-primary.internal:3306 schema=orders charset=utf8mb4',
          'service.name': 'order-service',
          'log.level': 'INFO'
        },
        {
        ...
        },
        {
          ...
          message: 'loaded GCP environment: project_id=acme-prod compute_zone=us-central1-f vm_instance=order-svc-7d8f9c',
          'cloud.provider': 'gcp',
        ...
        },
        {
          ...
          message: 'service registration complete: Eureka registry order-service @ 10.128.0.15:8080 status=UP',
          'service.name': 'order-service',
          'log.level': 'INFO'
        },
        {
          '@timestamp': '2026-02-05T14:30:00.780Z',
          message: 'Feign HTTP client ready: target inventory-service url=http://inventory.internal:8080',
          'service.name': 'order-service',
          'log.level': 'INFO'
        },
        {
      ...
      sample_documents: [
        {
          ...
          message: 'telemetry-collector v1.2.0 boot sequence rustc 1.75.0 target=x86_64-unknown-linux-gnu opt-level=3',
        ...
        },
        {
          ...
          message: 'messaging layer ready: nats://nats.internal:4222 server=NATS Server v2.10.7 cluster_support=true',
          'service.name': 'telemetry-collector',
          'log.level': 'INFO'
        },
        {
    ...
    input: {
      sample_documents: [
        ...
        },
        {
          ...
          message: 'search backend connected https://es-cluster.internal:9200 cluster_version=8.12.0 status=green',
          'service.name': 'search-api',
          'log.level': 'INFO'
        },
        {
          '@timestamp': '2026-04-22T16:15:00.400Z',
          message: 'cache cluster ready: redis-cluster.internal nodes=[6379,6380,6381] version=7.0.12 mode=cluster',
          'service.name': 'search-api',
          'log.level': 'INFO'
        },
        {
        ...
        },
        {
          ...
          message: 'outgoing request POST /api/recommend -> recommendation-engine responded 200 took=89ms',
          'service.name': 'search-api',
    ...
    input: {
      sample_documents: [
        ...
        },
        {
          ...
          message: 'healthcheck upstream=postgres-primary target=http://health.internal/pg interval=30s',
          'service.name': 'api-proxy',
          'log.level': 'DEBUG'
        },
        {
        ...
        },
        {
          ...
          message: 'request processing customer_id=mongodb-inc account_tier=enterprise region=us-east',
          'service.name': 'api-proxy',
          'log.level': 'INFO'
        },
        {
    ...
    input: {
      sample_documents: [
        ...
        },
        {
          ...
          message: 'ERROR: missing dependencies - need postgresql mongodb redis elasticsearch cassandra kafka rabbitmq mysql oracle',
          'service.name': 'task-processor',
          'log.level': 'ERROR'
        },
        {
    ...
    input: {
      sample_documents: [
        ...
        },
        {
          ...
          message: 'model eval: accuracy comparison our_model=0.9412 azure_ml_baseline=0.9087 improvement=+3.25%',
          'service.name': 'ml-inference',
          'log.level': 'INFO'
        },
        {
          '@timestamp': '2026-02-28T11:20:00.540Z',
          message: 'benchmark suite complete: TensorFlow=245ms PyTorch=312ms JAX=198ms test_set=validation',
          'service.name': 'ml-inference',
          'log.level': 'DEBUG'
        },
        {
        ...
        },
        {
          ...
          message: 'db latency analysis: MySQL_avg=50.2ms current_pg=35.1ms delta=-30.1% sample_size=1000',
          'service.name': 'ml-inference',
          'log.level': 'DEBUG'
        },
        {

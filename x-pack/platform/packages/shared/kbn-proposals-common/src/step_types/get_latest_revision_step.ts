...
> = {
  ...
  label: i18n.translate('xpack.proposals.steps.getLatestRevision.label', {
    defaultMessage: 'Get latest revision',
  }),
  description: i18n.translate('xpack.proposals.steps.getLatestRevision.description', {
  ...
  documentation: {
    details: i18n.translate('xpack.proposals.steps.getLatestRevision.documentation.details', {
      defaultMessage:

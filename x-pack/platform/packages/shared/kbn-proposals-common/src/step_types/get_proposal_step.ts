...
> = {
  ...
  label: i18n.translate('xpack.proposals.steps.getProposal.label', {
    defaultMessage: 'Read proposal',
  }),
  description: i18n.translate('xpack.proposals.steps.getProposal.description', {
  ...
  documentation: {
    details: i18n.translate('xpack.proposals.steps.getProposal.documentation.details', {
      defaultMessage:

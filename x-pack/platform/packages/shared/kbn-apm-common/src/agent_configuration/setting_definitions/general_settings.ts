...
export const generalSettings: RawSettingDefinition[] = [
  // API Request Size
  {
    ...
    type: 'bytes',
    defaultValue: '768kb',
    label: i18n.translate('apmCommon.agentConfig.apiRequestSize.label', {
      defaultMessage: 'API Request Size',
    }),
    description: i18n.translate('apmCommon.agentConfig.apiRequestSize.description', {
      defaultMessage:
  ...
  // API Request Time
  {
    ...
    type: 'duration',
    defaultValue: '10s',
    label: i18n.translate('apmCommon.agentConfig.apiRequestTime.label', {
      defaultMessage: 'API Request Time',
    }),
    description: i18n.translate('apmCommon.agentConfig.apiRequestTime.description', {
      defaultMessage:
  ...
  // Capture body
  {
    ...
    description: i18n.translate('apmCommon.agentConfig.captureBody.description', {
      defaultMessage:
...

  {
    ...
    label: i18n.translate('apmCommon.agentConfig.captureBodyContentTypes.label', {
      defaultMessage: 'Capture Body Content Types',
    }),
    description: i18n.translate('apmCommon.agentConfig.captureBodyContentTypes.description', {
      defaultMessage:
  ...
  // Capture headers
  {
    ...
    type: 'boolean',
    defaultValue: 'true',
    label: i18n.translate('apmCommon.agentConfig.captureHeaders.label', {
      defaultMessage: 'Capture Headers',
    }),
    description: i18n.translate('apmCommon.agentConfig.captureHeaders.description', {
      defaultMessage:
...

  {
    ...
    type: 'boolean',
    defaultValue: 'true',
    label: i18n.translate('apmCommon.agentConfig.dedotCustomMetrics.label', {
      defaultMessage: 'Dedot custom metrics',
    }),
    description: i18n.translate('apmCommon.agentConfig.dedotCustomMetrics.description', {
      defaultMessage:
...

  {
    ...
    type: 'text',
    defaultValue: '',
    label: i18n.translate('apmCommon.agentConfig.disableInstrumentations.label', {
      defaultMessage: 'Disable instrumentations',
    }),
    description: i18n.translate('apmCommon.agentConfig.disableInstrumentations.description', {
      defaultMessage:
...

  {
    ...
    type: 'boolean',
    defaultValue: 'true',
    label: i18n.translate('apmCommon.agentConfig.disableOutgoingTracecontextHeaders.label', {
      defaultMessage: 'Disable outgoing tracecontext headers',
    }),
    description: i18n.translate(
      'apmCommon.agentConfig.disableOutgoingTracecontextHeaders.description',
      {
        defaultMessage:
...

  {
    ...
    defaultValue: '0ms',
    min: '0ms',
    label: i18n.translate('apmCommon.agentConfig.exitSpanMinDuration.label', {
      defaultMessage: 'Exit span min duration',
    }),
    description: i18n.translate('apmCommon.agentConfig.exitSpanMinDuration.description', {
      defaultMessage:
...

  {
    ...
    type: 'text',
    defaultValue: '',
    label: i18n.translate('apmCommon.agentConfig.ignoreMessageQueues.label', {
      defaultMessage: 'Ignore message queues',
    }),
    description: i18n.translate('apmCommon.agentConfig.ignoreMessageQueues.description', {
      defaultMessage:
...

  {
    ...
    description: i18n.translate('apmCommon.agentConfig.logEcsReformatting.description', {
      defaultMessage:
  ...
  // LOG_LEVEL
  {
    ...
    description: i18n.translate('apmCommon.agentConfig.logLevel.description', {
...

  {
    ...
    type: 'boolean',
    defaultValue: 'false',
    label: i18n.translate('apmCommon.agentConfig.mongodbCaptureStatementCommands.label', {
      defaultMessage: 'MongoDB capture statement commands',
    }),
    description: i18n.translate(
      'apmCommon.agentConfig.mongodbCaptureStatementCommands.description',
      {
        defaultMessage:
  ...
  // Recording
  {
    ...
    type: 'boolean',
    defaultValue: 'true',
    label: i18n.translate('apmCommon.agentConfig.recording.label', {
      defaultMessage: 'Recording',
    }),
    description: i18n.translate('apmCommon.agentConfig.recording.description', {
      defaultMessage:
...

  {
    ...
    type: 'boolean',
    defaultValue: 'false',
    label: i18n.translate('apmCommon.agentConfig.context_propagation_only.label', {
      defaultMessage: 'Context Propagation Only',
    }),
    description: i18n.translate('apmCommon.agentConfig.context_propagation_only.description', {
      defaultMessage:
  ...
  // SERVER_TIMEOUT
  {
    ...
    type: 'duration',
    defaultValue: '5s',
    label: i18n.translate('apmCommon.agentConfig.serverTimeout.label', {
      defaultMessage: 'Server Timeout',
    }),
    description: i18n.translate('apmCommon.agentConfig.serverTimeout.description', {
      defaultMessage:
...

  {
    ...
    type: 'boolean',
    defaultValue: 'true',
    label: i18n.translate('apmCommon.agentConfig.spanCompressionEnabled.label', {
      defaultMessage: 'Span compression enabled',
    }),
    description: i18n.translate('apmCommon.agentConfig.spanCompressionEnabled.description', {
      defaultMessage:
...

  {
    ...
    defaultValue: '50ms',
    min: '0ms',
    label: i18n.translate('apmCommon.agentConfig.spanCompressionExactMatchMaxDuration.label', {
      defaultMessage: 'Span compression exact match max duration',
    }),
    description: i18n.translate(
      'apmCommon.agentConfig.spanCompressionExactMatchMaxDuration.description',
      {
        defaultMessage:
  ...
  },
  {
    ...
    defaultValue: '0ms',
    min: '0ms',
    label: i18n.translate('apmCommon.agentConfig.spanCompressionSameKindMaxDuration.label', {
      defaultMessage: 'Span compression same kind max duration',
    }),
    description: i18n.translate(
      'apmCommon.agentConfig.spanCompressionSameKindMaxDuration.description',
      {
        defaultMessage:
  ...
  // SPAN_FRAMES_MIN_DURATION
  {
    ...
    min: '-1ms',
    defaultValue: '5ms',
    label: i18n.translate('apmCommon.agentConfig.spanFramesMinDuration.label', {
      defaultMessage: 'Span frames minimum duration',
    }),
    description: i18n.translate('apmCommon.agentConfig.spanFramesMinDuration.description', {
      defaultMessage:
...

  {
    ...
    min: '-1ms',
    defaultValue: '5ms',
    label: i18n.translate('apmCommon.agentConfig.spanStackTraceMinDuration.label', {
      defaultMessage: 'Span stack trace minimum duration',
    }),
    description: i18n.translate('apmCommon.agentConfig.spanStackTraceMinDuration.description', {
      defaultMessage:
  ...
  // STACK_TRACE_LIMIT
  {
    ...
    type: 'integer',
    defaultValue: '50',
    label: i18n.translate('apmCommon.agentConfig.stackTraceLimit.label', {
      defaultMessage: 'Stack trace limit',
    }),
    description: i18n.translate('apmCommon.agentConfig.stackTraceLimit.description', {
      defaultMessage:
...

  {
    ...
    description: i18n.translate('apmCommon.agentConfig.traceContinuationStrategy.description', {
      defaultMessage:
  ...
  // Transaction max spans
  {
    ...
    min: 0,
    defaultValue: '500',
    label: i18n.translate('apmCommon.agentConfig.transactionMaxSpans.label', {
      defaultMessage: 'Transaction max spans',
    }),
    description: i18n.translate('apmCommon.agentConfig.transactionMaxSpans.description', {
  ...
  // Transaction sample rate
  {
    ...
    type: 'float',
    defaultValue: '1.0',
    label: i18n.translate('apmCommon.agentConfig.transactionSampleRate.label', {
      defaultMessage: 'Transaction sample rate',
    }),
    description: i18n.translate('apmCommon.agentConfig.transactionSampleRate.description', {
      defaultMessage:
  ...
  // Sanitize field names
  {
    ...
    label: i18n.translate('apmCommon.agentConfig.sanitizeFiledNames.label', {
      defaultMessage: 'Sanitize field names',
    }),
    description: i18n.translate('apmCommon.agentConfig.sanitizeFiledNames.description', {
      defaultMessage:
  ...
  // Ignore transactions based on URLs
  {
    ...
    label: i18n.translate('apmCommon.agentConfig.transactionIgnoreUrl.label', {
      defaultMessage: 'Ignore transactions based on URLs',
    }),
    description: i18n.translate('apmCommon.agentConfig.transactionIgnoreUrl.description', {
      defaultMessage:
...

  {
    ...
    type: 'text',
    defaultValue: '',
    label: i18n.translate('apmCommon.agentConfig.transactionIgnoreUserAgents.label', {
      defaultMessage: 'Transaction ignore user agents',
    }),
    description: i18n.translate('apmCommon.agentConfig.transactionIgnoreUserAgents.description', {
      defaultMessage:
...

  {
    ...
    type: 'boolean',
    defaultValue: 'false',
    label: i18n.translate('apmCommon.agentConfig.usePathAsTransactionName.label', {
      defaultMessage: 'Use path as transaction name',
    }),
    description: i18n.translate('apmCommon.agentConfig.usePathAsTransactionName.description', {
      defaultMessage:
        'If set to `true`,\n' +
...

  {
    ...
    type: 'text',
    defaultValue: '',
    label: i18n.translate('apmCommon.agentConfig.transactionNameGroups.label', {
      defaultMessage: 'Transaction name groups',
    }),
    description: i18n.translate('apmCommon.agentConfig.transactionNameGroups.description', {
      defaultMessage:
        'With this option,\n' +

 ...
 *
 * info:
 *   title: Dismiss attack discovery generations Internal API endpoint (deprecated, use public API instead)
 *   version: 1
 */
...
export type PostAttackDiscoveryGenerationsDismissInternalRequestParams = z.infer<
  typeof PostAttackDiscoveryGenerationsDismissInternalRequestParams
>;
export const PostAttackDiscoveryGenerationsDismissInternalRequestParams = z.object({
  /**
   * The Attack discovery generations execution_uuid
   */
  execution_uuid: NonEmptyString,
});
export type PostAttackDiscoveryGenerationsDismissInternalRequestParamsInput = z.input<
  typeof PostAttackDiscoveryGenerationsDismissInternalRequestParams
>;

export type PostAttackDiscoveryGenerationsDismissInternalResponse = z.infer<
  typeof PostAttackDiscoveryGenerationsDismissInternalResponse
>;
export const PostAttackDiscoveryGenerationsDismissInternalResponse = z.object({
  /**

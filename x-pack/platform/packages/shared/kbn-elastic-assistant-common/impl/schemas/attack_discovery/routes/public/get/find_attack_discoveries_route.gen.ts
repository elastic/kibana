 ...
 */
export const AttackDiscoveryFindSortField = lazySchema(() => z.literal('@timestamp'));
export type AttackDiscoveryFindSortField = z.infer<typeof AttackDiscoveryFindSortField>;

export const AttackDiscoveryFindRequestQuery = lazySchema(() =>
  z.object({
    /**
...
export const AttackDiscoveryFindResponse = lazySchema(() =>
  z.object({
    /**

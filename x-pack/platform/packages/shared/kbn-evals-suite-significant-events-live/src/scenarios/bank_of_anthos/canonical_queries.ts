...
import type { CanonicalRuleQuery } from '../types';

/**
 * Canonical rule-backed KI queries for the bank-of-anthos replay evals.
 *
 ...
 * the detection workflow's `lookback`/`bucketInterval` inputs, which the seeded replay spec sizes to the
...
const CASCADE_QUERIES: CanonicalRuleQuery[] = [
  {
    query_id: 'replay-transactionhistory-sql-connection-error',
  ...
  {
    query_id: 'replay-frontend-transactionhistory-connection-failures',
  ...
  {
    query_id: 'replay-frontend-balancereader-connection-failures',
  ...
  {
    query_id: 'replay-ledger-cache-errors',
  ...
  {
    query_id: 'replay-ledgerwriter-balance-retrieval-failure',
  ...
  {
    query_id: 'replay-frontend-ledgerwriter-deposit-error',
  ...
  {
    query_id: 'replay-frontend-ledgerwriter-payment-error',
...
const BENIGN_AUTH_QUERIES: CanonicalRuleQuery[] = [
  {
    query_id: 'replay-userservice-successful-login',
  ...
  {
    query_id: 'replay-userservice-account-created',
...
export const canonicalRuleQueries: CanonicalRuleQuery[] = [
  ...CASCADE_QUERIES,
  ...BENIGN_AUTH_QUERIES,
];

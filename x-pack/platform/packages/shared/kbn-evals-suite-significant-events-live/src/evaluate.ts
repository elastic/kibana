...
import type { SignificantEventsLiveSpecificEvaluationWorkerFixtures } from './types';

const base = withPhoenixExecutor(evalsBase);

export const evaluate = base.extend<{}, SignificantEventsLiveSpecificEvaluationWorkerFixtures>({
  logger: [
    async ({ log }, use) => {

...
export const elasticsearchRoleSchema = schema.object(
    ...
    remote_cluster: schema.maybe(
      schema.arrayOf(
        schema.object(
          ...
          {
            meta: {
              id: 'security_role_remote_cluster_privileges',
    ...
    indices: schema.maybe(
      schema.arrayOf(
        schema.object(
          ...
          {
            meta: {
              id: 'security_role_indices_privileges',
    ...
    remote_indices: schema.maybe(
      schema.arrayOf(
        schema.object(
          ...
          {
            meta: {
              id: 'security_role_remote_indices_privileges',
  ...
  {
    meta: {
      id: 'security_role_elasticsearch',
      description:
...
export const getKibanaRoleSchema = (
  ...
  schema.arrayOf(
    schema.object(
      ...
      {
        meta: {
          id: 'security_role_kibana_privilege',

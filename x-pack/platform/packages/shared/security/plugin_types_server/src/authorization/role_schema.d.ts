...
export declare const elasticsearchRoleSchema: import('@kbn/config-schema').ObjectType<{
   ...
   * users with this role are able to execute
   */
  remote_cluster: import('@kbn/config-schema').Type<
    | Readonly<
        {} & {
          privileges: string[];
          clusters: string[];
   ...
   */
  indices: import('@kbn/config-schema').Type<
    | Readonly<
        {
   ...
   */
  remote_indices: import('@kbn/config-schema').Type<
    | Readonly<
        {
          query?: string | undefined;
          field_security?: Record<'grant' | 'except', string[]> | undefined;
 ...
 */
export declare const getKibanaRoleSchema: (
  getBasePrivilegeNames: () => {
    global: string[];
    space: string[];
  }
) => import('@kbn/config-schema').Type<
  Readonly<
    {

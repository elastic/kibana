...
export interface CheckPrivileges {
    atSpace(spaceId: string, privileges: CheckPrivilegesPayload, options?: CheckPrivilegesOptions): Promise<CheckPrivilegesResponse>;
    atSpaces(spaceIds: string[], privileges: CheckPrivilegesPayload, options?: CheckPrivilegesOptions): Promise<CheckPrivilegesResponse>;
    globally(privileges: CheckPrivilegesPayload, options?: CheckPrivilegesOptions): Promise<CheckPrivilegesResponse>;
}
/**
...
export interface CheckUserProfilesPrivileges {
    atSpace(spaceId: string, privileges: CheckUserProfilesPrivilegesPayload): Promise<CheckUserProfilesPrivilegesResponse>;
}
/**

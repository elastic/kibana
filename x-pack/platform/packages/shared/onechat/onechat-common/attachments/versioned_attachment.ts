 ...
 */
export interface AttachmentVersion<Type extends string = string, DataType = unknown> {
...
> {
  ...
  versions: AttachmentVersion<Type, DataType>[];
...
): AttachmentVersion<string, T> | undefined => {

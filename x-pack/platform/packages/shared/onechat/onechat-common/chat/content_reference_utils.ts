...
import type { ContentReferenceId } from './conversation';
 ...
 * @returns KnowledgeBaseEntryContentReference
 */
...
/**
 * Generates a contentReference for the product documentation.
 * @param id id of the contentReference
 * @param title title of the documentation
 * @param url URL to the documentation
 * @returns ProductDocumentationContentReference
 */

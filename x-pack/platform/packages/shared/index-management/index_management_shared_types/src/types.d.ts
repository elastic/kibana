import type { IlmExplainLifecycleLifecycleExplain, HealthStatus, IndicesStatsIndexMetadataState, Uuid } from '@elastic/elasticsearch/lib/api/types';
...
export type IndexManagementAppMountParams = Pick<ManagementAppMountParams, 'setBreadcrumbs' | 'history'> & {

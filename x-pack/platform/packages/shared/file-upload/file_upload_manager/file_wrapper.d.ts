...
export declare class FileWrapper {
    ...
    getMappings(): {
        properties: {
            [fieldName: string]: {
                type: Exclude<import("@kbn/field-types").ES_FIELD_TYPES, import("@kbn/field-types").ES_FIELD_TYPES._ID | import("@kbn/field-types").ES_FIELD_TYPES._INDEX | import("@kbn/field-types").ES_FIELD_TYPES._SOURCE | import("@kbn/field-types").ES_FIELD_TYPES._TYPE>;
                format?: string;
            };
        };
    } | undefined;

      ...
      >
        <EuiText size="s">
          <FormattedMessage
            ...
            defaultMessage="AI Agent, built on the Agent Builder platform, will become the default chat experience in an upcoming release. You can switch back to the AI Assistant at any time via {genAiSettingsLink}."
            values={{
              genAiSettingsLink: (

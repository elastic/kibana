  ...
  const middleware: AgentMiddleware[] = [
    ...
    createSubAgentMiddleware({
      ...
      defaultMiddleware: [
        ...
        // DISABLED: Subagent middleware: Anthropic prompt caching for improved performance
        /* anthropicPromptCachingMiddleware({
    ...
    // DISABLED: Enables Anthropic prompt caching for improved performance and reduced costs
    /* anthropicPromptCachingMiddleware({
      unsupportedModelBehavior: "ignore",
    }), */

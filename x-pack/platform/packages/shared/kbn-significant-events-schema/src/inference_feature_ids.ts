...
/** Cheap gate deciding whether computed-feature changes warrant re-running query generation. */
export const SIGNIFICANT_EVENTS_KI_QUERY_GATE_INFERENCE_FEATURE_ID =
  'significant_events_ki_query_gate' as const;

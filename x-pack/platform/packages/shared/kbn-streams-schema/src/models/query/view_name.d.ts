 ...
 */
export declare const ESQL_VIEW_PREFIX = "$.";
/**
 ...
 */
export declare function getEsqlViewName(streamName: string): string;
/**
 ...
 */
export declare function getStreamNameFromViewName(viewName: string): string | null;
/**
 ...
 *   => 'FROM logs.otel.leaf'
 */
export declare function getWiredStreamViewQuery(streamName: string, directChildrenNames?: string[]): string;

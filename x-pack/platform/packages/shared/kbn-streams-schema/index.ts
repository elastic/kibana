...
export {
  ...
  type IlmPolicyPhase,
  type IlmPolicyDownsampleAction,
  type IlmPolicySearchableSnapshotAction,
  type IlmPolicyPhaseWithDownsampleAndReadOnly,
  type IlmPolicyHotPhase,
  type IlmPolicyColdPhase,
  type IlmPolicyFrozenPhase,

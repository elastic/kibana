...
export type ReasoningPromptResponseOf<TPrompt extends Prompt = Prompt, TPromptOptions extends PromptOptions<TPrompt> = PromptOptions<TPrompt>, TToolCallbacks extends ToolCallbacksOfToolOptions<ToolOptionsOfPrompt<TPrompt>> = ToolCallbacksOfToolOptions<ToolOptionsOfPrompt<TPrompt>>> = PromptResponse<TPromptOptions> & {

...
declare const StateAnnotation: import("@langchain/langgraph").AnnotationRoot<{
    ...
    currentTry: import("@langchain/langgraph").BinaryOperatorAggregate<number, number>;
...
export declare const createNlToEsqlGraph: ({ model, esClient, docBase, esqlCallbacks, }: {
    model: ScopedModel;
    ...
    currentTry?: number | undefined;
    actions?: Action[] | undefined;
    answer?: string | undefined;
    query?: string | undefined;
    results?: EsqlResponse | undefined;
    error?: string | undefined;
}, "generate_esql" | "finalize" | "request_documentation" | "autocorrect_query" | "execute_query" | "validate_query" | "__start__" | "resolve_target", {
    nlQuery: import("@langchain/langgraph").LastValue<string>;
    target: import("@langchain/langgraph").LastValue<string>;
    executeQuery: import("@langchain/langgraph").LastValue<boolean>;
    maxRetries: import("@langchain/langgraph").LastValue<number>;
    ...
    resolve_target: {
        resource: {
            fields: import("../utils/sampling").MappingFieldWithStats[];
            name: string;

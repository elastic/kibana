 ...
 */
export declare const listSearchSources: ({ pattern, perTypeLimit, includeHidden, includeKibanaIndices, excludeIndicesRepresentedAsAlias, excludeIndicesRepresentedAsDatastream, esClient, }: {
    pattern: string;
    perTypeLimit?: number;

...
import type { MessageChunkEvent, MessageCompleteEvent, ReasoningEvent, ThinkingCompleteEvent, ToolCallEvent, PromptRequestEvent, BrowserToolCallEvent, ToolResultEvent } from '@kbn/agent-builder-common/chat/events';
...
export declare const createReasoningEvent: (reasoning: string, { transient }?: {
    transient?: boolean;
}) => ReasoningEvent;

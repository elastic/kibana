...
evaluate.describe('Security Skills - Threat Hunting', () => {
  evaluate('threat hunting queries activate the correct skill and tools', async ({ evaluateDataset }) => {
...
evaluate.describe('Security Skills - Alert Analysis', () => {
  evaluate('alert analysis queries activate the correct skill and tools', async ({ evaluateDataset }) => {
    await evaluateDataset({
      dataset: {
...
evaluate.describe('Security Skills - Detection Engineering', () => {
  evaluate('detection engineering queries activate the correct skill and tools', async ({ evaluateDataset }) => {
    await evaluateDataset({
      dataset: {

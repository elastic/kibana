            ...
            examples: [
              {
                ...
                output: {
                  expected:
                    'I will activate the automatic-migration-rules-start-migration skill, resolve the migration ' +
              ...
              },
              {
                ...
                output: {
                  expected:
                    'I will activate the automatic-migration-rules-start-migration skill to reprocess failed ' +
              ...
              },
              {
                ...
                output: {
                  expected:
                    'I will activate the automatic-migration-rules-start-migration skill to resume the stopped ' +

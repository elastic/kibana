 ...
 */
export interface BuiltinToolDefinition<RunInput extends ZodObject<any> = ZodObject<any>, TResult extends ToolResult = ToolResult> extends Omit<ToolDefinition, 'type' | 'readonly' | 'configuration'>, BuiltInToolSpecificConfig {
    /**
     * built-in tool types
     */
...
type StaticToolRegistrationMixin<T extends ToolDefinition> = Omit<T, 'readonly'> & BuiltInToolSpecificConfig;

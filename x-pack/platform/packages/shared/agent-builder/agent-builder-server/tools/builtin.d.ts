...
export interface ToolConfirmationPolicy<TParams extends Record<string, unknown> = Record<string, unknown>> {
    /**
 ...
 */
export interface BuiltinToolDefinition<RunInput extends ZodObject<any> = ZodObject<any>, TResult extends ToolResult = ToolResult> extends Omit<ToolDefinition, 'type' | 'readonly' | 'configuration' | 'experimental'>, BuiltInToolSpecificConfig<z.infer<RunInput>> {
    /**
     * built-in tool types
     */

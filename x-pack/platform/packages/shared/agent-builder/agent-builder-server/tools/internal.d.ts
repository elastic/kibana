...
import type { ToolAvailabilityContext, ToolAvailabilityResult, ToolReturnSummarizerFn, BuiltInToolConfirmationPolicy } from './builtin';
import type { LlmDescriptionHandler } from '../runner';
/**
 * Internal generic representation for a tool definition
 */
export interface InternalToolDefinition<TType extends ToolType = ToolType, TConfig extends object = {}, TSchema extends ZodObject<any> = ZodObject<any>> extends ToolDefinition<TType, TConfig> {
    /**
...
export type InternalToolAvailabilityHandler = (context: ToolAvailabilityContext) => MaybePromise<ToolAvailabilityResult>;

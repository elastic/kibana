...
import type { AgentCapabilities, AgentExecutionMode, ChatEvent, ConverseInput, AgentConfigurationOverrides, BrowserApiToolMetadata, ConversationAction, ConversationAccessControl, ConversationRoundOrigin, ConversationOrigin, ConversationRoundAuthor, ExecutionStatus, SerializedExecutionError } from '@kbn/agent-builder-common';
 ...
 */
export type ExecutionConversationOrigin = ConversationOrigin & ConversationRoundOrigin & {

import type { ChatEventType, ToolProgressEventData, ToolUiEventData, ChatEventBase } from '@kbn/agent-builder-common';
export type InternalToolProgressEventData = Omit<ToolProgressEventData, 'tool_call_id'>;
export type InternalToolProgressEvent = ChatEventBase<ChatEventType.toolProgress, InternalToolProgressEventData>;
export type InternalToolUiEventData<TEvent = string, TData extends object = object> = Omit<ToolUiEventData<TEvent, TData>, 'tool_call_id' | 'tool_id'>;
export type InternalToolUiEvent<TEvent = string, TData extends object = object> = ChatEventBase<ChatEventType.toolUi, InternalToolUiEventData<TEvent, TData>>;
...
export interface ToolEventEmitter {
     ...
     */
    reportProgress: (progressMessage: string, options?: {

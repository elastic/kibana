import type { AuthorizationPromptDefinition, AuthorizationStatus, ConfirmPromptDefinition, ConfirmationStatus, PromptResponseState, PromptStorageState } from '@kbn/agent-builder-common/agents/prompts';

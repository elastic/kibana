 ...
 */
export type BuiltInAgentDefinition = Pick<AgentDefinition, 'id' | 'name' | 'description' | 'labels' | 'avatar_icon' | 'avatar_symbol' | 'avatar_color'> & {
    configuration: BuiltInAgentConfiguration | ((ctx: AgentConfigContext) => MaybePromise<BuiltInAgentConfiguration>);
    /**
 ...
 */
export type AgentAvailabilityHandler = (context: AgentAvailabilityContext) => MaybePromise<AgentAvailabilityResult>;

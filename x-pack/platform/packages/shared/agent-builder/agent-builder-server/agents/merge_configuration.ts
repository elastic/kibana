...
export const mergeAgentConfiguration = (
  ...
  if (base.post_execution_workflow_ids !== undefined) {
    result.post_execution_workflow_ids = dedupConcat(
      base.post_execution_workflow_ids,
      delta.post_execution_workflow_ids ?? []
    );
  }

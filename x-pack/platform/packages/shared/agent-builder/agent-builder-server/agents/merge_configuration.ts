 ...
 * - tools / skill_ids / plugin_ids / workflow_ids / post_round_workflow_ids / connector_ids / ai_indices: union, base-first,
...
export const mergeAgentConfiguration = (
  ...
  if (base.post_round_workflow_ids !== undefined) {
    result.post_round_workflow_ids = dedupConcat(
      base.post_round_workflow_ids,
      delta.post_round_workflow_ids ?? []
    );
  }

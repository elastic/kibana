...
import type { Conversation, ConversationRound, ConversationRoundAuthor, ConverseInput, ChatAgentEvent, AgentCapabilities, AgentConfigurationOverrides, ConversationAction, AgentExecutionMode, ChatEvent, ExecutionStatus, SerializedExecutionError } from '@kbn/agent-builder-common';
import type { IScopedClusterClient } from '@kbn/core-elasticsearch-server';
import type { KibanaRequest } from '@kbn/core-http-server';
import type { SavedObjectsClientContract } from '@kbn/core-saved-objects-api-server';
import type { BrowserApiToolMetadata } from '@kbn/agent-builder-common';
import type { ModelProvider, ScopedRunner, ToolProvider, WritableToolResultStore, WritableSkillsStore, AttachmentsService, PromptManager, ConversationStateManager, SkillsService, PluginsService, RenderersService, ToolManager, TodoStateManager, IFilesystemService, IBashService } from '../runner';
...
export type AgentHandlerFn = (params: AgentHandlerParams, context: AgentHandlerContext) => Promise<AgentHandlerReturn>;

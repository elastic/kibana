...
import type { AgentCreateRequest, Conversation, ConversationWithoutRounds, ConversationListOptions } from '@kbn/agent-builder-common';
...
import type { BuiltInAgentDefinition, AgentTypeDefinition, AgentRegistry, AgentAvailabilityConfig } from './agents';
...
import type { ExecuteAgentParams, ExecuteAgentResult, AgentExecution, FindExecutionsOptions } from './execution';
/**
...
export interface ExecutionStart {
     ...
     */
    findExecutions(request: KibanaRequest, options?: FindExecutionsOptions): Promise<AgentExecution[]>;
}
...
export interface ConversationsStart {
     ...
     */
    getScopedClient(opts: {
        request: KibanaRequest;
    }): Promise<ReadOnlyConversationClient>;
}
/**

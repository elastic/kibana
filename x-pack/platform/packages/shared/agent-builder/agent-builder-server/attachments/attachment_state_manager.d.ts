import type { VersionedAttachment, AttachmentVersion, AttachmentVersionRef, AttachmentDiff, VersionedAttachmentInput, AttachmentType, AttachmentRefActor } from '@kbn/agent-builder-common/attachments';
...
export interface AttachmentStateManager {
    ...
    add<TType extends string>(input: VersionedAttachmentInput<TType>, actor?: AttachmentRefActor, resolveContext?: AttachmentResolveContext): Promise<VersionedAttachment<TType>>;

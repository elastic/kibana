...
import type { Attachment, VersionedAttachmentWithOrigin } from '@kbn/agent-builder-common/attachments';
...
export interface AttachmentTypeDefinition<TType extends string = string, TContent = unknown> {
     ...
     */
    format: (attachment: Attachment<TType, TContent>, context: AttachmentFormatContext) => MaybePromise<AgentFormattedAttachment>;
    /**
     ...
     */
    isStale?: (attachment: VersionedAttachmentWithOrigin<TType, TContent>, context: AttachmentResolveContext) => MaybePromise<boolean>;
    /**

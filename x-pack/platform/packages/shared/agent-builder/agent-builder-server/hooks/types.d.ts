...
export type HookHandlerResult<E extends HookLifecycle = HookLifecycle> = HookHandlerResultByLifecycle[E];
export type BlockingHookHandler<E extends HookLifecycle = HookLifecycle> = (context: HookContext<E>) => Promise<void | HookHandlerResult<E>> | void | HookHandlerResult<E>;
/**
 ...
 */
type NonBlockingHookHandler<E extends HookLifecycle = HookLifecycle> = (context: HookContext<E>) => void | Promise<void>;
...
type HookRegistrationEntry<E extends HookLifecycle> = BlockingHookRegistrationEntry<E> | NonBlockingHookRegistrationEntry<E>;
/**
 * Single hook registration (one lifecycle event). When expanded from a bundle,
 */
export type HookRegistration<E extends HookLifecycle = HookLifecycle> = Pick<HookRegistrationsBundle, 'id' | 'priority'> & HookRegistrationEntry<E>;
/**

...
import { SkillBoundedTool } from "./tools";
import { Directory, FileDirectory, FilePathsFromStructure, StringWithoutSlash, StringWithoutSpace } from "./type_utils";
import { AgentBuilderBuiltinTool } from "../allow_lists";
 ...
 */
export interface SkillTypeDefinition<TName extends string = string, TPath extends DirectoryPath = DirectoryPath> {
    /**
...
>(definition: SkillTypeDefinition<TName, TPath>): SkillTypeDefinition<TName, TPath> {
  return definition;
}
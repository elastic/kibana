...
export type BuiltinSkillBoundedTool<RunInput extends ZodObject<any> = ZodObject<any>> = Omit<BuiltinToolDefinition<RunInput>, 'tags' | 'availability'>;
 ...
 */
export type SkillBoundedTool<RunInput extends ZodObject<any> = ZodObject<any>> = BuiltinSkillBoundedTool<RunInput> | StaticEsqlSkillBoundedTool | IndexSearchSkillBoundedTool | WorkflowSkillBoundedTool;
export {};

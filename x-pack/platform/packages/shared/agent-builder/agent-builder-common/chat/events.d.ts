...
import type { PromptRequestSource, PromptRequest, AskUserQuestionItem, AskUserQuestionAnswer } from '../agents/prompts';
...
export type UserQuestionAskedEvent = ChatEventBase<ChatEventType.userQuestionAsked, UserQuestionAskedEventData>;
export declare const isUserQuestionAskedEvent: (event: AgentBuilderEvent<string, any>) => event is UserQuestionAskedEvent;
export declare const createUserQuestionAskedEvent: (data: UserQuestionAskedEventData) => UserQuestionAskedEvent;
export interface UserQuestionAnsweredEventData {
    prompt_id: string;
    answers: AskUserQuestionAnswer[];
}
export type UserQuestionAnsweredEvent = ChatEventBase<ChatEventType.userQuestionAnswered, UserQuestionAnsweredEventData>;
export declare const isUserQuestionAnsweredEvent: (event: AgentBuilderEvent<string, any>) => event is UserQuestionAnsweredEvent;
export declare const createUserQuestionAnsweredEvent: (data: UserQuestionAnsweredEventData) => UserQuestionAnsweredEvent;
 ...
 */
export type ChatAgentEvent = ToolCallEvent | BrowserToolCallEvent | ToolProgressEvent | ToolUiEvent | ToolResultEvent | PromptRequestEvent | ReasoningEvent | MessageChunkEvent | MessageCompleteEvent | ThinkingCompleteEvent | RoundCompleteEvent | CompactionStartedEvent | CompactionCompletedEvent | BackgroundAgentCompleteEvent | UserQuestionAskedEvent | UserQuestionAnsweredEvent;
/**

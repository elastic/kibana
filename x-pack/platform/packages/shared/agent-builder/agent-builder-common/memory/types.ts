 ...
 * id and updated_at are auto-generated by the service.
 * created_at defaults to now but can be overridden to preserve
 * the original event timestamp (e.g. conversation round time).
 */
export interface MemoryCreateRequest {
  ...
  user_id?: string;
  user_name: string;
  /** Override the created_at timestamp (ISO 8601). Defaults to now. */
  created_at?: string;
}

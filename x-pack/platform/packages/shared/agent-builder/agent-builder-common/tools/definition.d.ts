 ...
 */
export declare enum ToolOrigin {
    registry = "registry",
    inline = "inline",
    internal = "internal"
}
 ...
 */
export interface ToolDefinition<TType extends ToolType = ToolType, TConfig extends object = Record<string, unknown>> {
    /**
...
export interface ToolDefinitionWithSchema<TType extends ToolType = ToolType, TConfig extends object = Record<string, unknown>> extends ToolDefinition<TType, TConfig> {
    /**

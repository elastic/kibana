...
/**
 * One allowlisted Kibana OpenAPI operation on a Kibana API tool. Execution uses
 * @kbn/workflows `buildKibanaRequest('kibana.request', { method, path, … })` with
 * `method`, `path_template`, and resolved path/query/body params.
 */

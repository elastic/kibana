...
export {
  ...
  type TextInputPromptDefinition,
  type TextInputPrompt,
  type TextInputPromptResponse,
  type TextInputPromptResponseState,
  type SelectionOption,
  type SelectionPromptDefinition,
  type SelectionPrompt,
  type SelectionPromptResponse,
  type SelectionPromptResponseState,
  type PromptResponse,
  type PromptRequest,

 ...
 */
export declare const chatAgentTypeId = "chat";
/**
 ...
 */
export type RuntimeAgentConfigurationOverrides = Pick<AgentConfigurationOverrides, 'instructions' | 'tools' | 'skill_ids' | 'enable_elastic_capabilities'>;

...
export const AGENT_BUILDER_UI_EBT = {
  ...
  action: {
    ...
    manageTools: {
      ...
      MCP_CREATE_SERVER_OPEN: 'manage_tools_mcp_create_server_open',
      MCP_CLIENTS_TABLE_ACTIONS_OPEN: 'manage_tools_mcp_clients_table_actions_open',
      HEALTH_BANNER_DELETE_TOOL: 'manage_tools_health_banner_delete_tool',
      HEALTH_BANNER_CREATE_NEW_TOOL: 'manage_tools_health_banner_create_new_tool',
      HEALTH_BANNER_VIEW_CONNECTORS: 'manage_tools_health_banner_view_connectors',
      HEALTH_BANNER_VIEW_MCP_SERVER: 'manage_tools_health_banner_view_mcp_server',
      ...
      FORM_ESQL_PARAM_ADD: 'manage_tools_form_esql_param_add',
      FORM_ESQL_PARAM_REMOVE: 'manage_tools_form_esql_param_remove',
    ...
    manageAgent: {
      ...
      OVERVIEW_CAPABILITY_SKILLS: 'manage_agent_overview_capability_skills',
      OVERVIEW_CAPABILITY_PLUGINS: 'manage_agent_overview_capability_plugins',
      OVERVIEW_CAPABILITY_TOOLS: 'manage_agent_overview_capability_tools',
      OVERVIEW_INSTRUCTIONS_CARD_OPEN: 'manage_agent_overview_instructions_card_open',
      OVERVIEW_AGENT_SETTINGS_CARD_OPEN: 'manage_agent_overview_agent_settings_card_open',
      OVERVIEW_ADD_INSTRUCTIONS_LINK: 'manage_agent_overview_add_instructions_link',
      ...
      FORM_PLUGINS_MANAGE_LIBRARY_LINK: 'manage_agent_form_plugins_manage_library_link',
      FORM_PLUGINS_SELECTION_TOGGLE: 'manage_agent_form_plugins_selection_toggle',
      FORM_PLUGINS_SHOW_ACTIVE_ONLY: 'manage_agent_form_plugins_show_active_only',
      FORM_ENABLE_ELASTIC_CAPABILITIES: 'manage_agent_form_enable_elastic_capabilities',

...
export const AGENT_BUILDER_UI_EBT = {
  ...
  action: {
    ...
    manageConnectors: {
      ...
      TABLE_CONTEXT_OPEN: 'manage_connectors_table_context_open',
      TABLE_CONTEXT_EDIT: 'manage_connectors_table_context_edit',
      TABLE_CONTEXT_DISCONNECT: 'manage_connectors_table_context_disconnect',
      TABLE_CONTEXT_DELETE: 'manage_connectors_table_context_delete',
      TABLE_QUICK_DELETE: 'manage_connectors_table_quick_delete',
      TABLE_BULK_DELETE: 'manage_connectors_table_bulk_delete',

...
export declare const AgentBuilderErrorUtils: {
    ...
    isForbiddenError: (err: unknown) => err is AgentBuilderForbiddenError;
    ...
    isAgentUnavailableError: (err: unknown, _agentId?: string) => err is AgentBuilderAgentUnavailableError;
    ...
    createForbiddenError: (message: string, meta?: Record<string, any>) => AgentBuilderForbiddenError;
    ...
    createAgentUnavailableError: ({ agentId, customMessage, meta, }: {
        agentId: string;
        customMessage?: string;
        meta?: Record<string, any>;
    }) => AgentBuilderAgentUnavailableError;

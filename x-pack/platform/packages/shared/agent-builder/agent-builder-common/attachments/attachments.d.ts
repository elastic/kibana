 ...
 */
export interface Attachment<Type extends string = string, DataType = Type extends AttachmentType ? AttachmentDataOf<Type> : Record<string, unknown>> {
 ...
 */
export type AttachmentInput<Type extends string = string, DataType = Type extends AttachmentType ? AttachmentDataOf<Type> : Record<string, unknown>> = Omit<Attachment<Type, DataType>, 'id'> & Partial<Pick<Attachment<Type, DataType>, 'id'>>;

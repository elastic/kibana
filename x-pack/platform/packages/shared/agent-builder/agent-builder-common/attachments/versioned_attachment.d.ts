 ...
 */
export interface VersionedAttachmentInput<Type extends string = string, DataType = Type extends AttachmentType ? AttachmentDataOf<Type> : unknown> {
...
export declare const versionedAttachmentInputSchema: z.ZodObject<{

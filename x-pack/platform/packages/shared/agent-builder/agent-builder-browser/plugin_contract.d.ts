...
import type { AttachmentInput, ConversationAttachment, UpdateOriginResponse } from '@kbn/agent-builder-common/attachments';
import type { BrowserApiToolDefinition } from './tools/browser_api_tool';
import type { AgentsServiceStartContract, AttachmentServiceStartContract, RendererServiceStartContract, EventsServiceStartContract, ToolServiceStartContract } from '.';
/**
...
export interface AgentBuilderPluginStart {
     ...
     * ```
     */
    EmbeddableConversationInput: ComponentType<PublicEmbeddableConversationInputProps & RefAttributes<EmbeddableConversationInputRef>>;
}

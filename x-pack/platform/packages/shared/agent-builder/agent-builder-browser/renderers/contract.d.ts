 ...
 */
export interface RendererUIDefinition<TSchema extends ZodObject<any> = ZodObject<any>> extends RendererDefinition<string, TSchema> {
    /**
     ...
     */
    getActionButtons?: (params: RendererActionButtonsParams<z.infer<TSchema>>) => RendererActionButton[];
    /**

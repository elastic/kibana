 ...
 */
import type { Annotations as SdkAnnotations, EmbeddedResource as SdkEmbeddedResource, ResourceLink as SdkResourceLink, TextContent as SdkTextContent } from '@modelcontextprotocol/sdk/types.js';
/**
...
export declare function isResourceLinkPart(part: ContentPart | null | undefined): part is ResourceLinkPart;
export declare function isEmbeddedResourcePart(part: ContentPart | null | undefined): part is EmbeddedResourcePart;
/**

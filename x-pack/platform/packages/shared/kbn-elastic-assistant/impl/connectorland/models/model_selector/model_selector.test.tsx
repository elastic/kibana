...
import { MODEL_GPT_5_CHAT, MODEL_GPT_5_NANO, ModelSelector } from './model_selector';
...
describe('ModelSelector', () => {
  it('should render with correct default selection', () => {
    ...
    expect(getByTestId('comboBoxSearchInput')).toHaveValue(MODEL_GPT_5_CHAT);
  });
  ...
  it('should call onModelSelectionChange when existing option is selected', () => {
    ...
    fireEvent.click(getByTestId(MODEL_GPT_5_NANO));
    expect(onModelSelectionChange).toHaveBeenCalledWith(MODEL_GPT_5_NANO);
  });
});

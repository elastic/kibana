...
const TOOLTIP_CONTENT = i18n.translate(
  'xpack.elasticAssistant.assistantContext.oneChatNavLinkShortcutTooltip',
  {
    values: { keyboardShortcut: isMac ? '⌘ ;' : 'Ctrl ;' },
    defaultMessage: 'Keyboard shortcut {keyboardShortcut}',
  }
);
const LINK_LABEL = i18n.translate('xpack.elasticAssistant.assistantContext.oneChatNavLink', {
  defaultMessage: 'One Chat',
});

export const OneChatNavLink: FC = () => {
  const { chrome, showOneChatOverlay, assistantAvailability } = useAssistantContext();

...
describe('formatDocumentAnalysis', () => {
  it('creates nested yaml with value distributions and missing coverage', () => {
    ...
    expect(result).toEqual({
      ...
      fields: {
        host: {
          'name (text)': ['web-01 (67%)', 'web-02 (33%)', '... (+1 more)'],
          'ip (keyword)': ['10.0.0.1 (67%)', '10.0.0.2 (33%)', '(no value) (33%)'],
        },
      },
    });
  });

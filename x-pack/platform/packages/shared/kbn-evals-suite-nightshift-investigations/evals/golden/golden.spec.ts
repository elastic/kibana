...
const dataset = readGoldenDataset(snapshot);
    ...
    evaluate(
      ...
      async ({
        ...
        const experimentMetadata = {
          ...
          anti_leakage_suffix: DOORDASH_ALERT_EVAL_CONSTRAINTS,
        ...
        const scores = await evalsClient.getExperimentScores(experiment.id);

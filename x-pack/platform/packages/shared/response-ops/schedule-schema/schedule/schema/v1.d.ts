...
export declare const getScheduleRequestSchema: ({ metaId, recurringMetaId, }?: GetScheduleSchemaOptions) => import("@kbn/config-schema").ObjectType<{
...
export declare const getScheduleResponseSchema: ({ metaId, recurringMetaId, }?: GetScheduleSchemaOptions) => import("@kbn/config-schema").ObjectType<{
    start: import("@kbn/config-schema").Type<string>;
    duration: import("@kbn/config-schema").Type<string>;
    timezone: import("@kbn/config-schema").Type<string | undefined>;
    recurring: import("@kbn/config-schema").Type<Readonly<{

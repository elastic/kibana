...
import {
  ...
  bulkCreateSeriesAlertActionItemBodySchema,
  bulkCreateSeriesAlertActionBodySchema,
  bulkCreateEpisodeAlertActionItemBodySchema,
...
const EXPECTED_IDS: ReadonlyArray<readonly [z.ZodType, string]> = [
  ...
  [createTagSeriesActionBodySchema, 'alerting_new_tag_series_action'],
  ...
  [bulkCreateSeriesAlertActionItemBodySchema, 'alerting_bulk_create_series_action_item'],
  [bulkCreateSeriesAlertActionBodySchema, 'alerting_bulk_create_series_actions_request'],
  [bulkCreateEpisodeAlertActionItemBodySchema, 'alerting_bulk_create_episode_action_item'],
  [bulkCreateEpisodeAlertActionBodySchema, 'alerting_bulk_create_episode_actions_request'],
  // matched policies

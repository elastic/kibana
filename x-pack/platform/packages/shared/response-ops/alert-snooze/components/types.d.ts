...
import type { ALERT_SEVERITY_CRITICAL, ALERT_SEVERITY_HIGH, ALERT_SEVERITY_MEDIUM, ALERT_SEVERITY_LOW, ALERT_SEVERITY_INFO } from '@kbn/rule-data-utils';
...
export type AlertSeverityLevel = typeof ALERT_SEVERITY_CRITICAL | typeof ALERT_SEVERITY_HIGH | typeof ALERT_SEVERITY_MEDIUM | typeof ALERT_SEVERITY_LOW | typeof ALERT_SEVERITY_INFO;
/**
 ...
 */
export declare enum DataConditionType {
...
export interface DataConditionTypeDescriptor {
    ...
    renderInput: (entry: DataConditionEntry, onChange: (next: DataConditionEntry) => void) => ReactNode;

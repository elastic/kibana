...
import { RunbookArtifactField } from './runbook_artifact_field';
...
describe('RunbookArtifactField', () => {
  it('renders runbook title and add button', () => {
    render(<RunbookArtifactField />, { wrapper: createFormWrapper() });

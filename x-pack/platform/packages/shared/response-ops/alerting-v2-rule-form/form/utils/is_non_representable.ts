 ...
 * - `standalone` query format — the form authors alert queries as `composed`
 *   (base + breach segment). Standalone is reserved for signal rules and for
 *   API/YAML multi-query alert rules the form has no editor for.

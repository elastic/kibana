 ...
 */
export declare const YamlRuleForm: ({ services, onSubmit, isDisabled, isSubmitting, yamlText, setYamlText, onBlurSync, fullHeight, onValidate, }: YamlRuleFormProps) => React.JSX.Element;

...
const TIME_UNITS: Record<TimeUnit, string> = {
  ...
  m: i18n.translate('xpack.alertingV2.ruleForm.timeUnits.minutes', {
    defaultMessage: 'minutes',
  }),
  h: i18n.translate('xpack.alertingV2.ruleForm.timeUnits.hours', {
    defaultMessage: 'hours',
  }),
  d: i18n.translate('xpack.alertingV2.ruleForm.timeUnits.days', {
    defaultMessage: 'days',
  }),
};
...
export const firstFieldOption = {
  text: i18n.translate('xpack.alertingV2.ruleForm.timeField.selectPlaceholder', {

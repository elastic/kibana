...
const baseRuleResponse: RuleResponse = {
  ...
  kind: 'alert',
  enabled: true,
  metadata: { name: 'Test Rule', signature_id: 'test-sig-id', version: 1, revision: 0, source: { type: 'internal' as const, version: 1 }, owner: 'test-owner', tags: ['tag1'], ownership: { managed: false } },

...
export function ComposeDiscoverFlyout({
  ...
  const handleSubmit = methods.handleSubmit((values) => {
    ...
    if (isCreate) {
      onCreateRule(composeFormToCreateRequest(values, builderType, resolvedBuilderFields));
    } else if (ruleId && onUpdateRule) {
      onUpdateRule(ruleId, composeFormToUpdateRequest(values, builderType, resolvedBuilderFields));
    }
  });

...
export type StepId = 'alertCondition' | 'builderCondition' | 'recoveryCondition' | 'details' | 'notifications';
export declare const isAlertConditionStepId: (id: StepId) => boolean;
export declare const isBuilderConditionStepId: (id: StepId) => boolean;
...
export interface StepDefinition {
    ...
    validate?: (methods: UseFormReturn<FormValues>, state: ComposeDiscoverState, services?: RuleFormServices, builderState?: BuilderState) => Promise<boolean> | boolean;
}
/**

...
export declare const useBulkGetCasesQuery: ({ caseIds, http, notifications: { toasts } }: UseBulkGetCasesQueryParams, options?: Pick<QueryOptionsOverrides<typeof bulkGetCases>, "enabled">) => import("@tanstack/react-query").UseQueryResult<Map<string, Case>, ServerError>;

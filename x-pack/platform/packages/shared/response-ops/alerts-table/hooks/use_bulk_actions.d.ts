...
import type { BulkActionsConfig, BulkActionsPanelConfig, BulkActionsState, BulkActionsReducerAction, TimelineItem, BulkEditTagsFlyoutState } from '../types';
...
export declare function useBulkActions({ alertsCount, casesConfig, query, refresh, additionalBulkActions, ruleTypeIds, hideBulkActions, http, notifications, application, casesService, }: BulkActionsProps): UseBulkActions;
export {};

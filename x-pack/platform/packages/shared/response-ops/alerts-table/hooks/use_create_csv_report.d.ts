...
export declare const useCreateCsvReport: ({ http, notifications: { toasts }, rendering, }: UseCreateCsvReportParams) => import("@tanstack/react-query").UseMutationResult<void, Error & {
    body?: {
        message?: string;
    };

import type { ComponentClass, ComponentProps, ComponentType, Dispatch, FC, JSX, Key, MutableRefObject, ReactNode, RefAttributes } from 'react';
import type { ALERT_CASE_IDS, ALERT_MAINTENANCE_WINDOW_IDS, ALERT_STATUS, AlertConsumers } from '@kbn/rule-data-utils';
...
export interface AlertsTableProps<AC extends AdditionalContext = AdditionalContext> extends PublicAlertsDataGridProps {
     ...
     */
    renderCellValue?: MergeProps<EuiDataGridProps['renderCellValue'], RenderContext<AC> & {
        alert: Alert;
    }>;
    /**
     ...
     */
    renderActionsCell?: MergeProps<EuiDataGridControlColumn['rowCellRender'], RenderContext<AC> & {
        alert: Alert;
...
} & SetRequired<Pick<AlertsTableProps<AC>, 'columns' | 'pageIndex' | 'onPageIndexChange' | 'pageSize' | 'onPageSizeChange' | 'renderCellValue' | 'renderCellPopover' | 'renderActionsCell' | 'expandedAlertIndex' | 'onExpandedAlertIndexChange' | 'renderExpandedAlertView' | 'services' | 'kibanaVersion' | 'casesConfiguration' | 'openLinksInNewTab' | 'isMutedAlertsEnabled' | 'getAlertFormatter' | 'alertDetailsNavigation'>, 'columns' | 'pageIndex' | 'onPageIndexChange' | 'pageSize' | 'onPageSizeChange' | 'openLinksInNewTab' | 'expandedAlertIndex' | 'onExpandedAlertIndexChange' | 'isMutedAlertsEnabled'> & AC;

...
export declare const useBulkUnmuteAlerts: ({ http, notifications: { toasts }, onSuccess, }: UseBulkUnmuteAlertsParams) => import("@tanstack/react-query").UseMutationResult<void, ServerError, BulkUnmuteAlertsParams, unknown>;

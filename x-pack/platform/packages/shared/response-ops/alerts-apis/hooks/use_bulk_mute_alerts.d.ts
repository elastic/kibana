...
export declare const useBulkMuteAlerts: ({ http, notifications: { toasts }, onSuccess, }: UseBulkMuteAlertsParams) => import("@tanstack/react-query").UseMutationResult<void, ServerError, BulkMuteAlertsParams, unknown>;

 ...
 */
export declare const fetchAlertingEpisodes: ({ spaceId, abortSignal, pageSize, services: { expressions }, filterState, sortState, timeRange, }: FetchAlertingEpisodesOptions) => Promise<AlertEpisodeEsqlRow[]>;

 ...
 */
export declare const fetchAlertActionTagSuggestions: ({ spaceId, services: { expressions }, abortSignal, }: FetchAlertActionTagSuggestionsOptions) => Promise<AlertActionTagSuggestionRow[]>;

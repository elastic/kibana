 ...
 */
export declare const fetchEpisodeTagOptions: ({ spaceId, abortSignal, timeRange, services: { expressions }, }: FetchEpisodeTagOptionsParams) => Promise<EpisodeTagOptionRow[]>;

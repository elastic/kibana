 ...
 */
export declare const useFetchEpisodeEventsQuery: ({ episodeId, services, }: UseFetchEpisodeEventsQueryOptions) => import("@tanstack/react-query").UseQueryResult<EpisodeEventRow[], unknown>;

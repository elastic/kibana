 ...
 */
export declare const useFetchSameGroupEpisodesQuery: ({ ruleId, excludeEpisodeId, pageSize, groupHash, services, toastDanger, }: UseFetchSameGroupEpisodesQueryOptions) => import("@tanstack/react-query").UseQueryResult<import("../queries/episodes_query").AlertEpisode[], unknown>;

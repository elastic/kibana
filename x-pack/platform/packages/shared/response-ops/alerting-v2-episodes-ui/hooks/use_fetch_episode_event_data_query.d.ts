 ...
 */
export declare const useFetchEpisodeEventDataQuery: ({ episodeId, services, }: UseFetchEpisodeEventDataQueryOptions) => import("@tanstack/react-query").UseQueryResult<EpisodeEventData | null, unknown>;

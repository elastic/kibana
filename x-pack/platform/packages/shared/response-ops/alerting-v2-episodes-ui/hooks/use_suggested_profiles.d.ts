 ...
 */
export declare function useSuggestedProfiles({ userProfile, searchTerm, toasts, errorTitle, }: UseSuggestedProfilesParams): import("@tanstack/react-query").UseQueryResult<UserProfileWithAvatar[], unknown>;

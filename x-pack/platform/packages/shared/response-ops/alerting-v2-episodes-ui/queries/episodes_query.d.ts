...
export declare const ALERT_EPISODE_FIELDS: readonly ["@timestamp", "episode.id", "episode.status", "rule.id", "group_hash", "first_timestamp", "last_timestamp", "duration", "last_ack_action", "last_assignee_uid", "last_snooze_action", "snooze_expiry", "last_deactivate_action", "last_tags", "episode_data"];
 ...
 */
export declare const buildEpisodesBaseQuery: (search?: string) => ComposerQuery;
/**
 ...
 */
export declare const buildEpisodesQuery: (sortState?: EpisodesSortState, filterState?: EpisodesFilterState) => ComposerQuery;

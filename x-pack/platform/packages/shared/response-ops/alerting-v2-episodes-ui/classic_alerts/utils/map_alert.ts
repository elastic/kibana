...
export const isClassicAlertSource = (v: unknown): v is ClassicAlertSource =>
  v != null && typeof v === 'object' && TIMESTAMP in v && ALERT_UUID in v;

export const isClassicAlertActionContext = (v: unknown): v is ClassicAlertActionContext =>
  v != null && typeof v === 'object' && 'alertUuid' in v && 'index' in v;

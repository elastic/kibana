 ...
 */
export declare const openAssigneeFlyout: (overlays: OverlayStart, rendering: CoreStart["rendering"], deps: OpenAssigneeFlyoutDeps, { lastAssigneeUid, episodeCount }?: OpenAssigneeFlyoutOptions) => Promise<string | null | undefined>;
export {};

...
describe('RuleFilter', () => {
  ...
  describe('rendering', () => {
    it('renders the filter button with correct label', () => {
      render(<RuleFilter {...defaultProps} />);
      expect(screen.getByText('Rule')).toBeInTheDocument();
    });

    it('applies custom data-test-subj to button', () => {
      render(<RuleFilter {...defaultProps} data-test-subj="custom-filter" />);
    ...
    it('applies default data-test-subj when not provided', () => {
      ...
      render(<RuleFilter {...propsWithoutDataTestSubj} />);
  ...
  describe('InlineFilterPopover props', () => {
    ...
    it('passes selectedRuleId as selectedValues array', async () => {
      render(<RuleFilter {...defaultProps} selectedRuleId="rule-beta" />);
      await openPopover();
      expect(InlineFilterPopoverSpy).toHaveBeenCalledWith(
        expect.objectContaining({
  ...
  describe('selection callback', () => {
    it('calls onRuleChange with rule id when single value is provided', async () => {
      ...
      render(<RuleFilter {...defaultProps} onRuleChange={onRuleChange} />);
      await openPopover();
  ...
  describe('edge cases', () => {
    it('handles undefined selectedRuleId', async () => {
      render(<RuleFilter {...defaultProps} selectedRuleId={undefined} />);
      await openPopover();
      expect(InlineFilterPopoverSpy).toHaveBeenCalledWith(
        expect.objectContaining({
          selectedValues: [],
    ...
    it('handles empty ruleOptions array', async () => {
      render(<RuleFilter {...defaultProps} ruleOptions={[]} />);
      await openPopover();
      expect(InlineFilterPopoverSpy).toHaveBeenCalledWith(
        expect.objectContaining({
          options: [],

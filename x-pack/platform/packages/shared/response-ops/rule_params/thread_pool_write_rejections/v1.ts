...
export const threadPoolWriteRejectionsParamsSchema = threadPoolRejectionsCommonSchema.extends(
  ...
  {
    meta: {
      id: 'thread-pool-write-rejections-rule-params',
      title: 'Thread Pool Write Rejections Rule Params',
      description:
        'The parameters for the thread pool write rejections rule. These parameters are appropriate when `rule_type_id` is `monitoring.thread_pool_write_rejections`.',
    },
  }
);

...
export const logstashVersionMismatchParamsSchema = stackMonitoringCommonSchema.extends(
  ...
  {
    meta: {
      id: 'logstash-version-mismatch-rule-params',
      title: 'Logstash Version Mismatch Rule Params',
      description:
        'The parameters for the logstash version mismatch rule. These parameters are appropriate when `rule_type_id` is `monitoring.logstash_version_mismatch`.',
    },
  }
);

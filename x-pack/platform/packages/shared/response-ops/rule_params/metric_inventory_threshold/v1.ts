...
export const metricInventoryThresholdRuleParamsSchema = schema.object(
  ...
  },
  {
    unknowns: 'allow',
    meta: {
      id: 'metric-inventory-threshold-rule-params',
      title: 'Metric Inventory Threshold Rule Params',
      description:
        'The parameters for the metric inventory threshold rule. These parameters are appropriate when `rule_type_id` is `monitoring.metric_inventory_threshold`.',
    },
  }
);

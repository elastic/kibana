...
export const ccrReadExceptionsParamsSchema = stackMonitoringCommonSchema.extends(
  ...
  {
    meta: {
      id: 'ccr-read-exceptions-rule-params',
      title: 'CCR Read Exceptions Rule Params',
      description:
        'The parameters for the CCR read exceptions rule. These parameters are appropriate when `rule_type_id` is `monitoring.ccr_read_exceptions`.',
    },
  }
);

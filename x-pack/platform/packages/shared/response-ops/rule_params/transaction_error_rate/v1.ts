...
export const transactionErrorRateParamsSchema = schema.object(
  ...
  {
    meta: {
      id: 'transaction-error-rate-params',
      title: 'Transaction error rate rule params',
      description:
        'The parameters for the transaction duration rule. These parameters are appropriate when `rule_type_id` is `apm.transaction_error_rate`.',
    },
  }
);

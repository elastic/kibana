...
export declare const tlsRuleParamsSchema: import("@kbn/config-schema").ObjectType<{
    ...
    includeBrowserCerts: import("@kbn/config-schema").Type<boolean | undefined>;
    certOrigin: import("@kbn/config-schema").Type<string[] | undefined>;
    browserResourceTypes: import("@kbn/config-schema").Type<string[] | undefined>;
    issuers: import("@kbn/config-schema").Type<string[] | undefined>;
}>;

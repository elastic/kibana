...
const ruleParamsSchemasWithRuleTypeId: Record<string, { title: string; params: Type<unknown> }> = {
  monitoring_ccr_read_exceptions: { title: 'CCR read exceptions', params: ccrReadExceptionsParamsSchemaV1 },
  ...
  monitoring_alert_elasticsearch_version_mismatch: { title: 'Elasticsearch version mismatch', params: esVersionMismatchParamsSchemaV1 },
  monitoring_alert_kibana_version_mismatch: { title: 'Kibana version mismatch', params: kibanaVersionMismatchParamsSchemaV1 },
  monitoring_alert_license_expiration: { title: 'License expiration', params: licenseExpirationParamsSchemaV1 },
  monitoring_alert_logstash_version_mismatch: { title: 'Logstash version mismatch', params: logstashVersionMismatchParamsSchemaV1 },
  monitoring_alert_jvm_memory_usage: { title: 'JVM memory usage', params: memoryUsageParamsSchemaV1 },
  monitoring_alert_missing_monitoring_data: { title: 'Missing monitoring data', params: missingMonitoringDataParamsSchemaV1 },
  ...
  monitoring_alert_thread_pool_search_rejections: { title: 'Thread pool search rejections', params: threadPoolSearchRejectionsParamsSchemaV1 },
  monitoring_alert_thread_pool_write_rejections: { title: 'Thread pool write rejections', params: threadPoolWriteRejectionsParamsSchemaV1 },
  'xpack.ml.anomaly_detection_alert': { title: 'Anomaly detection', params: mlAnomalyDetectionAlertParamsSchemaV1 },
  'xpack.ml.anomaly_detection_jobs_health': { title: 'Anomaly detection jobs health', params: anomalyDetectionJobsHealthRuleParamsSchemaV1 },
  ...
  'apm.transaction_error_rate': { title: 'Transaction error rate', params: transactionErrorRateParamsSchemaV1 },
  'apm.transaction_duration': { title: 'Transaction duration', params: transactionDurationParamsSchemaV1 },
  'xpack.synthetics.alerts.monitorStatus': { title: 'Synthetics monitor status', params: syntheticsMonitorStatusRuleParamsSchemaV1 },
  'xpack.synthetics.alerts.tls': { title: 'Synthetics TLS', params: tlsRuleParamsSchemaV1 },
  'xpack.uptime.alerts.monitorStatus': { title: 'Uptime monitor status', params: uptimeMonitorStatusRuleParamsSchemaV1 },
  'xpack.uptime.alerts.tlsCertificate': { title: 'Uptime TLS certificate', params: uptimeTLSRuleParamsSchemaV1 },
  'xpack.uptime.alerts.durationAnomaly': { title: 'Uptime duration anomaly', params: uptimeDurationAnomalyRuleParamsSchemaV1 },
  'metrics.alert.inventory.threshold': { title: 'Metric inventory threshold', params: metricInventoryThresholdRuleParamsSchemaV1 },
  'metrics.alert.threshold': { title: 'Metric threshold', params: metricThresholdRuleParamsSchemaV1 },
  'observability.rules.custom_threshold': { title: 'Custom threshold', params: customThresholdParamsSchemaV1 },

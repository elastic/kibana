...
export const uptimeMonitorStatusRuleParamsSchema = schema.object(
  ...
  {
    meta: {
      id: 'uptime-monitor-status-rule-params',
      title: 'Uptime monitor status rule params',
      description:
        'The parameters for the uptime monitor status rule. These parameters are appropriate when `rule_type_id` is `uptime.monitor_status`.',
    },
  }
);

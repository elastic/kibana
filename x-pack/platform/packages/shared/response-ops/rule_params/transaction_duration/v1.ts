...
export const transactionDurationParamsSchema = schema.object(
  ...
  {
    meta: {
      id: 'transaction-duration-rule-params',
      title: 'Transaction Duration Rule Params',
      description:
        'The parameters for the transaction duration rule. These parameters are appropriate when `rule_type_id` is `apm.transaction_duration`.',
    },
  }
);

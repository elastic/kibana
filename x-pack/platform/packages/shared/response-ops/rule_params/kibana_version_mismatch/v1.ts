...
export const kibanaVersionMismatchParamsSchema = stackMonitoringCommonSchema.extends(
  ...
  {
    meta: {
      id: 'kibana-version-mismatch-rule-params',
      title: 'Kibana Version Mismatch Rule Params',
      description:
        'The parameters for the Kibana version mismatch rule. These parameters are appropriate when `rule_type_id` is `monitoring.kibana_version_mismatch`.',
    },
  }
);

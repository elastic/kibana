...
type SecretTextareaWidgetProps = BaseWidgetProps<z.ZodString, EuiTextAreaProps>;

const DEFAULT_ROWS = 6;

const SHOW_LABEL = i18n.translate('responseOpsFormGenerator.secretTextareaWidget.showAriaLabel', {
  defaultMessage: 'Show secret',
});

const HIDE_LABEL = i18n.translate('responseOpsFormGenerator.secretTextareaWidget.hideAriaLabel', {
  defaultMessage: 'Hide secret',
});

interface SecretTextareaFieldProps {
  field: FieldHook;
 ...
 */
const SecretTextareaField: React.FC<SecretTextareaFieldProps> = ({
  field,
  euiFieldProps,
  idAria,
  ...rest
    ...
    <EuiFormRow
      ...
      labelAppend={
        <EuiButtonIcon
          ...
          data-test-subj="secretTextareaToggle"
        />
      }
      {...rest}
    >
...
export const SecretTextareaWidget: React.FC<SecretTextareaWidgetProps> = ({
  path,
  fieldProps,
  fieldConfig,
}) => {

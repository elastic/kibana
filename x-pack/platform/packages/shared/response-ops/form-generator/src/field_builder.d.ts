...
export declare const getFieldFromSchema: ({ schema: outerSchema, path, formConfig, meta, }: GetFieldFromSchemaProps) => {
    ...
    defaultValue: unknown;
    isOptional: boolean;
    validate: (data: import("@kbn/data-view-editor-plugin/public/shared_imports").ValidationFuncArg<import("@kbn/es-ui-shared-plugin/static/forms/hook_form_lib").FormData, unknown>) => ReturnType<ValidationFunc>;
};

...
import type { AnonymizationEntityClass, anonymizationProfileSchema, anonymizationProfileRulesSchema, createAnonymizationProfileRequestSchema, findAnonymizationProfilesQuerySchema, fieldRuleSchema, regexRuleSchema, nerRuleSchema, replacementsSetSchema, tokenSourceEntrySchema, tokenSourceRefSchema, updateAnonymizationProfileRequestSchema } from './schemas';
...
export type CreateAnonymizationProfileRequest = z.infer<typeof createAnonymizationProfileRequestSchema>;
export type UpdateAnonymizationProfileRequest = z.infer<typeof updateAnonymizationProfileRequestSchema>;

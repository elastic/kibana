 ...
 */
export type AssistantMessage<TToolCalls extends ToolCall[] | undefined = ToolCall[] | undefined> = MessageBase<MessageRole.Assistant> & {
    /**
 ...
 */
export type ToolMessage<TName extends string = string, TToolResponse extends ToolResponse = ToolResponse, TToolData extends ToolData | undefined = ToolData | undefined> = MessageBase<MessageRole.Tool> & {
    /**
 ...
 */
export type AssistantMessageOf<TToolOptions extends ToolOptions> = AssistantMessage<ToolCallsOfToolOptions<TToolOptions>>;
/**
 ...
 */
export type ToolMessageOf<TToolOptions extends ToolOptions, TToolResponses extends ToolResponses = ToolResponses> = ValuesType<{
 ...
 */
export type MessageOf<TToolOptions extends ToolOptions, TToolResponses extends Record<ToolNamesOf<TToolOptions>, any> = Record<ToolNamesOf<TToolOptions>, unknown>> = UserMessage | AssistantMessageOf<TToolOptions> | ToolMessageOf<TToolOptions, TToolResponses>;
export {};

 ...
 */
export interface PromptVersion<TTools extends ToolDefinitions | undefined = ToolDefinitions | undefined> {
    /**
 ...
 */
export interface PromptFactory<TInput = any, TPromptVersions extends PromptVersion[] = PromptVersion[]> {
    version<TNextPromptVersion extends PromptVersion>(version: TNextPromptVersion): PromptFactory<TInput, [...TPromptVersions, TNextPromptVersion]>;
 ...
 */
export type ToolOptionsOfPrompt<TPrompt extends Prompt> = TPrompt['versions'] extends Array<infer TPromptVersion> ? TPromptVersion extends PromptVersion ? Pick<TPromptVersion, 'tools'> : {} : {};

...
export declare class InferenceChatModel extends BaseChatModel<InferenceChatModelCallOptions> {
    ...
    bindTools(tools: BindToolsInput[], kwargs?: Partial<InferenceChatModelCallOptions>): Runnable<BaseLanguageModelInput, AIMessageChunk, InferenceChatModelCallOptions>;

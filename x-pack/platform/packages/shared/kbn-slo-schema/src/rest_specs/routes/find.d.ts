...
declare const findSLOParamsSchema: t.PartialC<{
    query: t.PartialC<{
        filters: t.StringC;
        kqlQuery: t.StringC;
        page: t.StringC;
        perPage: t.StringC;
        sortBy: t.UnionC<[t.LiteralC<"error_budget_consumed">, t.LiteralC<"error_budget_remaining">, t.LiteralC<"sli_value">, t.LiteralC<"status">, t.LiteralC<"burn_rate_5m">, t.LiteralC<"burn_rate_1h">, t.LiteralC<"burn_rate_1d">]>;
        sortDirection: t.UnionC<[t.LiteralC<"asc">, t.LiteralC<"desc">]>;
        hideStale: t.Type<boolean, boolean, unknown>;
        searchAfter: t.Type<(string | number)[], string, unknown>;
        size: t.StringC;
    }>;
}>;
declare const findSLOResponseSchema: t.IntersectionC<[t.TypeC<{
    page: t.NumberC;
    perPage: t.NumberC;
    total: t.NumberC;
    ...
    searchAfter: t.ArrayC<t.UnionC<[t.StringC, t.NumberC]>>;
    size: t.NumberC;
}>]>;

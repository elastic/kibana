...
declare const targetSchema: t.TypeC<{
    target: t.NumberC;
}>;
declare const objectiveSchema: t.IntersectionC<[t.TypeC<{
    target: t.NumberC;
}>, t.PartialC<{
    timesliceTarget: t.NumberC;
    timesliceWindow: t.Type<import("../models").Duration, string, unknown>;
}>]>;
declare const settingsSchema: t.IntersectionC<[t.TypeC<{
...
declare const groupBySchema: t.UnionC<[t.LiteralC<"*">, t.StringC, t.ArrayC<t.UnionC<[t.LiteralC<"*">, t.StringC]>>]>;
declare const optionalSettingsSchema: t.PartialC<{
    syncDelay: t.Type<import("../models").Duration, string, unknown>;
    frequency: t.Type<import("../models").Duration, string, unknown>;
    preventInitialBackfill: t.BooleanC;
    syncField: t.UnionC<[t.StringC, t.NullC]>;
}>;
declare const tagsSchema: t.ArrayC<t.StringC>;
declare const sloIdSchema: t.Type<string, string, unknown>;
declare const dashboardsWithIdSchema: t.PartialC<{
    dashboards: t.ArrayC<t.TypeC<{
        id: t.StringC;
    }>>;
}>;
declare const sloDefinitionSchema: t.IntersectionC<[t.IntersectionC<[t.TypeC<{
...
declare const storedSloDefinitionSchema: t.IntersectionC<[t.IntersectionC<[t.TypeC<{
    id: t.Type<string, string, unknown>;
    name: t.StringC;
    description: t.StringC;
    indicator: t.UnionC<[t.TypeC<{
...
export { budgetingMethodSchema, dashboardsWithIdSchema, groupBySchema, objectiveSchema, occurrencesBudgetingMethodSchema, optionalSettingsSchema, settingsSchema, sloDefinitionSchema, sloIdSchema, storedSloDefinitionSchema, tagsSchema, targetSchema, timeslicesBudgetingMethodSchema, };

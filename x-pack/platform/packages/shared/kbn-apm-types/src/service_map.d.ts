...
import type { AGENT_NAME, SERVICE_ENVIRONMENT, SERVICE_NAME, SPAN_DESTINATION_SERVICE_RESOURCE, SPAN_SUBTYPE, SPAN_TYPE } from './es_fields/apm';
...
export type ConnectionNodeLegacy = Omit<ServiceConnectionNode, 'id'> | Omit<ExternalConnectionNode, 'id'>;

...
export type ProcessorsMetrics = APIReturnType<'POST /internal/streams/{name}/processing/_simulate'>['processors_metrics'];
export type ProcessorMetrics = ProcessorsMetrics[string];
export type StepStatus = 'pending' | 'running' | 'failure' | 'success' | 'successWithWarnings' | 'skipped' | 'disabled';

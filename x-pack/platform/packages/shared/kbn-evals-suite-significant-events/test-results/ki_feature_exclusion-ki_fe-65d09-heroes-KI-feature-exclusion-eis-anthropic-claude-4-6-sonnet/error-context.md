...
- Name: ki_feature_exclusion/ki_feature_exclusion.spec.ts >> Streams features exclusion >> quarkus-super-heroes >> KI feature exclusion
- Location: x-pack/platform/packages/shared/kbn-evals-suite-significant-events/evals/ki_feature_exclusion/ki_feature_exclusion.spec.ts:71:36

# Error details

```
KbnClientRequesterError: [PUT - http://localhost:5620/internal/core/_settings] request failed (attempt=5/5): undefined -- Status: N/A, Cause: fetch failed -- and ran out of retries
```

 ...
 * discovery, triage) to one connector, so a live e2e experiment measures a single evaluated
 ...
 * recommended defaults. Failures are logged, not thrown — the eval cluster is ephemeral and a
 * leftover pin must not mask the run's actual result.
 */

...
import type { E2ELiveEvaluator, E2ELivePipelineOutput } from './types';
...
const totalUsage = (output: E2ELivePipelineOutput | undefined): LiveStageTokenUsage => {
...
export const liveToolCallsEvaluator: E2ELiveEvaluator = {
  name: 'live_tool_calls',
  kind: 'CODE',
  evaluate: ({ output }) => {
    const countToolCalls = (steps: E2ELivePipelineOutput['steps']) =>
...
export const livePipelineDurationEvaluator: E2ELiveEvaluator = {

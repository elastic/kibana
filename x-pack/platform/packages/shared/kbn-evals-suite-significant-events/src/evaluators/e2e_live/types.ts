 ...
 */
export interface E2ELivePipelineOutput extends DiscoveryAgentOutput {
...
export interface E2ELiveEvaluationExample {
  input: {
    scenario_id: string;
    stream_name: string;
...
export type E2ELiveEvaluator = Evaluator<E2ELiveEvaluationExample, E2ELivePipelineOutput>;

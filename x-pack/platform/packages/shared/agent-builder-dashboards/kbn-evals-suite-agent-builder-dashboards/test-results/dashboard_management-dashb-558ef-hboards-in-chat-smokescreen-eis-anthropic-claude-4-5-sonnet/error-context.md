...
- Name: dashboard_management/dashboard_management.spec.ts >> Agent Builder Dashboards - Dashboard Management >> dashboards in chat smokescreen
- Location: x-pack/platform/packages/shared/agent-builder-dashboards/kbn-evals-suite-agent-builder-dashboards/evals/dashboard_management/dashboard_management.spec.ts:54:5

# Error details

```
KbnClientRequesterError: [POST - http://localhost:5620/api/sample_data/logs] request failed (attempt=1/0): undefined -- Status: N/A, Cause: fetch failed -- and ran out of retries
```

...
import type { Phases, ShrinkAction, ForcemergeAction, SearchableSnapshotAction, SetPriorityAction, AllocateAction, MigrateAction, DownsampleAction } from '@kbn/index-lifecycle-management-common-shared';
...
export declare const getAllocationLabel: (migrate: MigrateAction | undefined, phase: "warm" | "cold") => string;

...
describe(`feature_privilege_builder`, () => {
  describe(`alerting`, () => {
    ...
    describe(`within feature`, () => {
      test('grants `read` privileges to rules under feature consumer', () => {
        ...
        expect(alertingFeaturePrivileges.getActions(privilege, feature)).toMatchInlineSnapshot(`
          Array [
            ...
            "alerting:alert-type/my-consumer/rule/getGapAutoFillSchedulerLogs",
          ]
        `);
      });
      ...
      test('grants `enable` privileges to rules under feature consumer', () => {
        const actions = new Actions();
        const alertingFeaturePrivileges = new FeaturePrivilegeAlertingBuilder(actions);
      ...
      test('grants both `all` and `read` to rules privileges under feature consumer', () => {
        ...
        expect(alertingFeaturePrivileges.getActions(privilege, feature)).toMatchInlineSnapshot(`
          Array [
            ...
            "alerting:readonly-alert-type/my-consumer/rule/getGapAutoFillSchedulerLogs",
          ]
        `);
      });

      test('grants all possible privileges to rules privileges under feature consumer', () => {
        const actions = new Actions();
        const alertingFeaturePrivileges = new FeaturePrivilegeAlertingBuilder(actions);
      ...
      test('grants all possible privileges to rules and alerts privileges under feature consumer', () => {
        const actions = new Actions();
        const alertingFeaturePrivileges = new FeaturePrivilegeAlertingBuilder(actions);
      ...
      test('handles multiple rule types and consumers correctly', () => {
        ...
        expect(alertingFeaturePrivileges.getActions(privilege, feature)).toMatchInlineSnapshot(`
          Array [
            ...
            "alerting:alert-type-1/my-consumer-1/rule/getGapAutoFillSchedulerLogs",
            ...
            "alerting:alert-type-1/my-consumer-2/rule/getGapAutoFillSchedulerLogs",
            ...
            "alerting:alert-type-2/my-consumer-3/rule/getGapAutoFillSchedulerLogs",
            ...
            "alerting:readonly-alert-type-1/my-read-consumer-1/rule/getGapAutoFillSchedulerLogs",
            ...
            "alerting:readonly-alert-type-1/my-read-consumer-2/rule/getGapAutoFillSchedulerLogs",
            ...
            "alerting:readonly-alert-type-2/my-read-consumer-3/rule/getGapAutoFillSchedulerLogs",
            ...
            "alerting:readonly-alert-type-2/my-read-consumer-4/rule/getGapAutoFillSchedulerLogs",
            "alerting:enable-alert-type-1/my-consumer-1/rule/enable",
            ...
            "alerting:manual_run-alert-type-1/my-read-consumer-2/rule/deleteBackfill",
            "alerting:manual_run-alert-type-1/my-read-consumer-2/rule/fillGaps",
            "alerting:manual_run-alert-type-1/my-read-consumer-2/rule/scheduleBackfill",
            "alerting:manual_run-alert-type-2/my-read-consumer-3/rule/deleteBackfill",
            "alerting:manual_run-alert-type-2/my-read-consumer-3/rule/fillGaps",
            "alerting:manual_run-alert-type-2/my-read-consumer-3/rule/scheduleBackfill",
            "alerting:manual_run-alert-type-2/my-read-consumer-4/rule/deleteBackfill",
            "alerting:manual_run-alert-type-2/my-read-consumer-4/rule/fillGaps",

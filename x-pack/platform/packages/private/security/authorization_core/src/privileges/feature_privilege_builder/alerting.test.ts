      ...
      test('handles multiple rule types and consumers correctly', () => {
        ...
        expect(alertingFeaturePrivileges.getActions(privilege, feature)).toMatchInlineSnapshot(`
          Array [
            ...
            "alerting:manual_run-alert-type-1/my-read-consumer-2/rule/createGapAutoFillScheduler",
            ...
            "alerting:manual_run-alert-type-2/my-read-consumer-3/rule/createGapAutoFillScheduler",
            ...
            "alerting:manual_run-alert-type-2/my-read-consumer-4/rule/createGapAutoFillScheduler",

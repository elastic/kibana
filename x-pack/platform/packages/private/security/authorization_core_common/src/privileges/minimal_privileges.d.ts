 ...
 */
export declare function isMinimalPrivilegeId(privilegeId: string): privilegeId is "minimal_all" | "minimal_read";
/**
 ...
 */
export declare function getMinimalPrivilegeId(privilegeId: string): string;

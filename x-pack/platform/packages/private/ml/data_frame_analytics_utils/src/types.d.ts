 ...
 */
export interface DataFrameAnalyticsConfig extends Omit<estypes.MlDataframeAnalyticsSummary, 'analyzed_fields'> {
    /**
 ...
 */
export declare function isDataFrameAnalyticsConfigs(arg: unknown): arg is DataFrameAnalyticsConfig;
/**
 ...
 */
export interface FieldSelectionItem extends Omit<estypes.MlDataframeAnalyticsFieldSelection, 'mapping_types'> {
    /**

...
export default function ({ getService }: FtrProviderContext) {
  ...
  describe('security/response_headers', function () {
    const baseCSP = `script-src 'report-sample' 'self' 'wasm-unsafe-eval'; worker-src 'report-sample' 'self' blob:; style-src 'report-sample' 'self' 'unsafe-inline'; object-src 'report-sample' 'none'; frame-ancestors 'self'`;

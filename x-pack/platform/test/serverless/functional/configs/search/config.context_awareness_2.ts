...
export default createTestConfig({
  ...
  testFiles: [require.resolve('../../test_suites/discover/context_awareness/index_2')],
  junit: {
    reportName: 'Serverless Search Discover Context Awareness Functional Tests (Part 2)',
  },

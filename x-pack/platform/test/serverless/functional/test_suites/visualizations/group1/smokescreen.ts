...
export default function ({ getService, getPageObjects }: FtrProviderContext) {
  ...
  describe('lens smokescreen tests', function () {
    ...
    it('should not show static value tab for data layers', async () => {
      ...
      await testSubjects.existOrFail('lens-dimensionTabs-quickFunctions');
      await testSubjects.existOrFail('lens-dimensionTabs-formula');
      // Static value tab should not be visible
      expect(await testSubjects.waitForExists('lens-dimensionTabs-static_value')).to.eql(false);

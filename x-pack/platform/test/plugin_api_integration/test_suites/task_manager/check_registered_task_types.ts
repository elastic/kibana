  ...
  describe('check_registered_task_types', () => {
    it('should check changes on all registered task types', async () => {
      ...
      expect(types).to.eql([
        ...
        'Synthetics:Rebalance-Private-Location-Shards',
        ...
        'alerting_v2:invalidate_api_keys',
        'alerting_v2:rule_executor',
        'alerting_v2:telemetry',
        ...
        'entity_store:v2:entity_maintainer_task:owns',
        ...
        'entity_store:v2:extract_entity_non_priority_task:user',
        ...
        'entity_store:v2:legacy_security_assets_migration',
        ...
        'task_manager:snapshot_telemetry',

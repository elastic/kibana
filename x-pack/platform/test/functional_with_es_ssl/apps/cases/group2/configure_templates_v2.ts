 ...
 * reachable when `xpack.cases.templates.enabled` is ON — the new default. This
 * suite runs under the default group2 config (flag ON) and asserts the pages
 * are wired, reachable, and render their primary surface.
 *

        ...
        expect(grokMetrics.errors).to.eql([
          {
            ...
            message:
              'The fields generated by the processor do not match streams log record fields - put custom fields into attributes, body.structured or resource.attributes: [abc]',
          },
        ]);
      });

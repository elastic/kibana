...
node scripts/functional_tests_server.js --config x-pack/platform/test/functional/apps/dashboard/group1/config.ts

# Run tests (replace with your actual config file path)
node scripts/functional_test_runner.js --config x-pack/platform/test/functional/apps/dashboard/group1/config.ts
```

  ...
  return {
    ...
    esTestCluster: {
      ...
      serverArgs: [
        ...
        `xpack.security.authc.realms.saml.saml1.sp.entity_id=http://localhost:${5621}`,
        `xpack.security.authc.realms.saml.saml1.sp.logout=http://localhost:${5621}/logout`,
        `xpack.security.authc.realms.saml.saml1.sp.acs=http://localhost:${5621}/api/security/saml/callback`,

...
export default async function ({ readConfigFile }: FtrConfigProviderContext) {
  ...
  return {
    ...
    testFiles: [resolve(__dirname, './tests/session_idle_hack')],
    services,
    servers: {
    ...
    esTestCluster: {
      ...
      serverArgs: [
        ...
        `xpack.security.authc.realms.saml.saml1.sp.entity_id=http://localhost:${5622}`,
        `xpack.security.authc.realms.saml.saml1.sp.logout=http://localhost:${5622}/logout`,
        `xpack.security.authc.realms.saml.saml1.sp.acs=http://localhost:${5622}/api/security/saml/callback`,
    ...
    kbnTestServer: {
      ...
      serverArgs: [
        ...
        '--server.port=5622',
        '--elasticsearch.hosts=http://localhost:9222',

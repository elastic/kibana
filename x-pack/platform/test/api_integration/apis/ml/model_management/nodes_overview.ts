...
export default ({ getService }: FtrProviderContext) => {
  ...
  describe('GET model_management/nodes_overview', () => {
    ...
    it('returns nodes overview', async () => {
      ...
      // kibana startup installs integrations which triggers indexing readme files to knowledge base
      expect(body.nodes[0].memory_overview.trained_models.total).to.be.greaterThan(2000000000);
    });

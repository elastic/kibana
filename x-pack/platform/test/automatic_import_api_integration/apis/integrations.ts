...
import { createAutomaticImportApiClient } from '../utils/automatic_import_client';

export default function ({ getService }: AutomaticImportApiFtrProviderContext) {
  const supertest = getService('supertest');
  const automaticImportClient = createAutomaticImportApiClient(supertest);

  describe('Automatic Import Integration Routes', function () {
    describe('GET /api/automatic_import/integrations', function () {
      it('should return empty array when no integrations exist', async function () {
        const response = await automaticImportClient.getAllIntegrations();
      ...
      it('should return all integrations even without data streams', async function () {
        ...
        const createResponse = await automaticImportClient.createIntegration({
        ...
        const allIntegrations = await automaticImportClient.getAllIntegrations();
    ...
    describe('GET /api/automatic_import/integrations/{integration_id}', function () {
      it('should return integration by id even without data streams', async function () {
        ...
        const response = await automaticImportClient.getIntegrationById(integrationId);
    ...
    describe('PUT /api/automatic_import/integrations', function () {
      it('should create a new integration without data streams', async function () {
        ...
        const response = await automaticImportClient.createIntegration(integrationData);
      ...
      it('should create an integration with a single data stream', async function () {
        ...
        const integration = await automaticImportClient.getIntegrationById(integrationId);
      ...
      it('should reflect data streams in the get all integrations endpoint', async function () {
        ...
        const createResponse = await automaticImportClient.createIntegration(integrationData);
        const integrationId = createResponse.integration_id;
        expect(integrationId).to.be.a('string');

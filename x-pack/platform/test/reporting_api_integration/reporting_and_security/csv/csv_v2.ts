...
const LOGSTASH_SAVED_OBJECTS = 'x-pack/platform/test/functional/fixtures/kbn_archives/reporting/logs';
const ECOM_SAVED_SEARCH_ID = '6091ead0-1c6d-11ea-a100-8589bb9d7c6b';
const TIMELESS_SAVED_OBJECTS = 'x-pack/platform/test/functional/fixtures/kbn_archives/reporting/timeless';

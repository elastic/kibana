...
export default function ({ getService, getPageObjects }: FtrProviderContext) {
  ...
  describe('URL capture', function () {
    ...
    it('can login preserving original URL', async () => {
      ...
      // PKI cannot authenticate automatically via browser (no client certificate),
      // so we fall through to the basic auth login form.
      await PageObjects.security.loginPage.login();

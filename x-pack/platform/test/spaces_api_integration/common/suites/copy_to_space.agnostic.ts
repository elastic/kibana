...
const SPACE_DATA_TO_LOAD: Array<{ spaceName: string | null; dataUrl: string }> = [
  {
    spaceName: null,
    dataUrl:
      'x-pack/platform/test/spaces_api_integration/common/fixtures/kbn_archiver/default_space.json',
  },
  {
    spaceName: SPACE_1.id,
    dataUrl:
      'x-pack/platform/test/spaces_api_integration/common/fixtures/kbn_archiver/space_1.json',
  },
  {
    spaceName: SPACE_2.id,
    dataUrl:
      'x-pack/platform/test/spaces_api_integration/common/fixtures/kbn_archiver/space_2.json',
  },
];

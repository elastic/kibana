...
export default function ({ getService, loadTestFile }: FtrProviderContext) {
  ...
  describe('aiops', function () {
    ...
    // Cases
    loadTestFile(require.resolve('./cases/log_rate_analysis_cases'));
    loadTestFile(require.resolve('./cases/change_point_detection_cases'));
    loadTestFile(require.resolve('./cases/log_pattern_analysis_cases'));
  });
}

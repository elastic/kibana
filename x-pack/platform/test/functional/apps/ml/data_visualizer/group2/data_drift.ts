...
// Data drift coverage is retained in FTR pending Scout migration. Chart brush selection
// depends on the FTR elasticChart service; migrate to Scout in a follow-up once an
// elastic-charts click helper is available in x-pack/platform/plugins/private/data_visualizer/test/scout/.

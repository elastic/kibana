...
export default function ({ getService, getPageObjects }) {
  ...
  describe('Elasticsearch node detail mb', () => {
    describe('Active Nodes', () => {
      ...
      before(async () => {
        await setup(
          'x-pack/platform/test/fixtures/es_archives/monitoring/singlecluster_three_nodes_shard_relocation_mb',
          {
    ...
    describe('Offline Node', () => {
      ...
      before(async () => {
        await setup(
          'x-pack/platform/test/fixtures/es_archives/monitoring/singlecluster_red_platinum_mb',
          {

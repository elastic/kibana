...
export default function ({ getService, getPageObjects }) {
  ...
  describe('pipeline list route', () => {
    ...
    before(async () => {
      ...
      await esArchiver.load('x-pack/platform/test/fixtures/es_archives/logstash/example_pipelines');
    });
    ...
    after(async () => {
      await esArchiver.unload(
        'x-pack/platform/test/fixtures/es_archives/logstash/example_pipelines'
      );

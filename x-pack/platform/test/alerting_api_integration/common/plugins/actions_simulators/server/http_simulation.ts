  ...
  return (request: http.IncomingMessage, response: http.ServerResponse) => {
    ...
    request.on('end', () => {
      switch (data) {
        ...
        case 'success_delete_method':
          return validateRequestUsesMethod(request.method ?? '', 'delete', response);
        case 'success_get_method':
          return validateRequestUsesMethod(request.method ?? '', 'get', response);

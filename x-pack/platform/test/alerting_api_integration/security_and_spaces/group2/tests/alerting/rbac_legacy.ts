...
export default function alertTests({ getService }: FtrProviderContext) {
  ...
  describe('alerts', () => {
    ...
    before(async () => {
      ...
      // we have flakiness
      await esArchiver.load('x-pack/platform/test/fixtures/es_archives/alerting_legacy/rules');
      await esArchiver.load('x-pack/platform/test/fixtures/es_archives/alerting_legacy/tasks');
    ...
    after(async () => {
      ...
      await esArchiver.unload('x-pack/platform/test/fixtures/es_archives/alerting_legacy/tasks');
      await esArchiver.unload('x-pack/platform/test/fixtures/es_archives/alerting_legacy/rules');
    });

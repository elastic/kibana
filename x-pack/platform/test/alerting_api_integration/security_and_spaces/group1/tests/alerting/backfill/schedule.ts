...
import { RunBackfillOnlyUserAtSpace1, UserAtSpaceScenarios } from '../../../../scenarios';
...
export default function scheduleBackfillTests({ getService }: FtrProviderContext) {
  ...
  describe('schedule backfill', () => {
    ...
    const ScenariosToTest = [...UserAtSpaceScenarios, RunBackfillOnlyUserAtSpace1];
      ...
      describe(scenario.id, () => {
        ...
        it('should handle scheduling backfill job requests appropriately', async () => {
          ...
          switch (scenario.id) {
            ...
            // User has read privileges and schedule backfill subfeature privilege
            case 'run_backfill_only at space1':

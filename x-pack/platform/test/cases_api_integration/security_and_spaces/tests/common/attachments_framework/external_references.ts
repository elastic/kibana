  ...
  describe('External references', () => {
    ...
    describe('check registered external reference attachment types', () => {
      ...
      it('should check changes on all registered external reference attachment types', async () => {
        ...
        //
        // `osquery` was likewise migrated to the unified registry. Unlike `endpoint`,
        // the legacy `osquery` external-reference registration was dropped because
        // legacy-shape POSTs are routed through `EXTERNAL_REFERENCE_TYPE_MAP` and
        // validated against the unified zod schema.
        expect(types).to.eql({

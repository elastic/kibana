...
export default ({ getService }: FtrProviderContext): void => {
  ...
  describe('bulk_create_cases', () => {
    ...
    it('should bulk create cases generated by the Assistant', async () => {
      const createdCases = await bulkCreateCases({
        data: {
          cases: [getPostCaseRequest(), getPostCaseRequest({ isGeneratedByAssistant: true })],
        },
      });
      ...
      expect(firstCase).to.eql(postCaseResp(null, getPostCaseRequest()));
      expect(secondCase).to.eql({
        ...postCaseResp(null, getPostCaseRequest()),

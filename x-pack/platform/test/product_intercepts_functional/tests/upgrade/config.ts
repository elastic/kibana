...
export default async function ({ readConfigFile }: FtrConfigProviderContext) {
  ...
  return {
    ...
    testFiles: [require.resolve('./product_intercepts_upgrade_test.ts')],
    servers: {
    ...
    junit: {
      reportName: 'X-Pack Upgrade Product Intercepts Functional Tests',
    },
    ...
    kbnTestServer: {
      ...
      serverArgs: [
        ...
        '--xpack.product_intercept.upgradeInterceptInterval=10s',
      ],
    },
  };
}

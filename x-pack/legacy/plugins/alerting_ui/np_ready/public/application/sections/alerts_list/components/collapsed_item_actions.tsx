  ...
  const button = (
    <EuiButtonIcon
      ...
      aria-label={i18n.translate(
        'xpack.alertingUI.sections.alertsList.collapsedItemActons.popoverButtonTitle',
    ...
    <EuiPopover button={button} isOpen={isPopoverOpen} closePopover={() => setIsPopoverOpen(false)}>
      <EuiFormRow>
        <EuiSwitch
          ...
          label={
            <FormattedMessage
              id="xpack.alertingUI.sections.alertsList.collapsedItemActons.enableTitle"
      ...
      <EuiFormRow>
        <EuiSwitch
          ...
          label={
            <FormattedMessage
              id="xpack.alertingUI.sections.alertsList.collapsedItemActons.muteTitle"
              defaultMessage="Mute"
            />
          }
        />
      ...
      <EuiPopoverFooter>
        <EuiFormRow>
          ...
          >
            <FormattedMessage
              id="xpack.alertingUI.sections.alertsList.collapsedItemActons.deleteTitle"

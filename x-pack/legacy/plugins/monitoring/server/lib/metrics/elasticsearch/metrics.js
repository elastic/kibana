...
const indexThrottleTimeTitle = i18n.translate('xpack.monitoring.metrics.esIndex.throttleTimeTitle', {
...
const nodeCgroupCpuPerformance = i18n.translate('xpack.monitoring.metrics.esNode.cgroupCpuPerformanceTitle', {
  defaultMessage: 'Cgroup CPU Performance'
});
const nodeCpuUtilizationLabel = i18n.translate('xpack.monitoring.metrics.esNode.cpuUtilizationLabel', {
...
export const metrics = {
  cluster_index_request_rate_primary: new RequestRateMetric({
    ...
    description: i18n.translate('xpack.monitoring.metrics.es.indexingRate.primaryShardsDescription', {
  ...
  index_indexing_primaries_time: new ElasticsearchMetric({
    ...
    description: i18n.translate('xpack.monitoring.metrics.esIndex.requestTime.indexingPrimariesDescription', {
  ...
  index_indexing_total_time: new ElasticsearchMetric({
    ...
    description: i18n.translate('xpack.monitoring.metrics.esIndex.requestTime.indexingDescription', {
  ...
  index_indexing_total: new ElasticsearchMetric({
    ...
    description: i18n.translate('xpack.monitoring.metrics.esIndex.requestRate.indexTotalDescription', {
  ...
  index_mem_overall_1: new SingleIndexMemoryMetric({
    ...
    description: i18n.translate('xpack.monitoring.metrics.esIndex.indexMemoryLucene1.luceneTotalDescription', {
      defaultMessage: 'Total heap memory used by Lucene for current index. This is the sum of other fields for primary and replica shards.'
    })
  }),
  index_mem_overall_2: new SingleIndexMemoryMetric({
    ...
    description: i18n.translate('xpack.monitoring.metrics.esIndex.indexMemoryLucene2.luceneTotalDescription', {
      defaultMessage: 'Total heap memory used by Lucene for current index. This is the sum of other fields for primary and replica shards.'
    })
  }),
  index_mem_overall_3: new SingleIndexMemoryMetric({
    ...
    description: i18n.translate('xpack.monitoring.metrics.esIndex.indexMemoryLucene3.luceneTotalDescription', {
      defaultMessage: 'Total heap memory used by Lucene for current index. This is the sum of other fields for primary and replica shards.'
    })
  }),
  ...
  index_mem_query_cache: new IndexMemoryMetric({
    ...
    description: i18n.translate('xpack.monitoring.metrics.esIndex.indexMemoryEs.queryCacheDescription', {
  ...
  index_request_rate_primary: new ElasticsearchMetric({
    ...
    description: i18n.translate('xpack.monitoring.metrics.esIndex.indexingRate.primaryShardsDescription', {
      defaultMessage: 'Number of documents being indexed for primary shards.'
    }),
    format: LARGE_FLOAT,
    metricAgg: 'max',
  ...
  index_request_rate_total: new RequestRateMetric({
    ...
    description: i18n.translate('xpack.monitoring.metrics.esIndex.indexingRate.totalShardsDescription', {
      defaultMessage: 'Number of documents being indexed for primary and replica shards.'
    }),
    type: 'index'
  }),
  ...
  index_searching_total: new ElasticsearchMetric({
    ...
    description: i18n.translate('xpack.monitoring.metrics.esIndex.requestRate.searchTotalDescription', {
  ...
  index_segment_count_primaries: new ElasticsearchMetric({
    ...
    description: i18n.translate('xpack.monitoring.metrics.esIndex.segmentCount.primariesDescription', {
  ...
  index_segment_merge_primaries_size: new ElasticsearchMetric({
    ...
    description: i18n.translate('xpack.monitoring.metrics.esIndex.disk.mergesPrimariesDescription', {
  ...
  index_segment_refresh_primaries_time: new ElasticsearchMetric({
    ...
    description: i18n.translate('xpack.monitoring.metrics.esIndex.refreshTime.primariesDescription', {
  ...
  index_throttling_indexing_primaries_time: new ElasticsearchMetric({
    ...
    description: i18n.translate('xpack.monitoring.metrics.esIndex.throttleTime.indexingPrimariesDescription', {
  ...
  index_throttling_indexing_total_time: new ElasticsearchMetric({
    ...
    description: i18n.translate('xpack.monitoring.metrics.esIndex.throttleTime.indexingDescription', {
  ...
  node_cgroup_periods: new ElasticsearchMetric({
    ...
    label: i18n.translate('xpack.monitoring.metrics.esNode.cgroupCfsStats.cgroupElapsedPeriodsLabel', {
  ...
  node_cgroup_throttled: new ElasticsearchMetric({
    ...
    label: i18n.translate('xpack.monitoring.metrics.esNode.cgroupCpuPerformance.cgroupThrottlingLabel', {
  ...
  node_cgroup_throttled_count: new ElasticsearchMetric({
    ...
    title: nodeCgroupCfsStats,
    label: i18n.translate('xpack.monitoring.metrics.esNode.cgroupCfsStats.cgroupThrottledCountLabel', {
  ...
  ...(() => {
    ...
    const quotaMetricConfig = {
      ...
      label: i18n.translate('xpack.monitoring.metrics.esNode.cpuUtilization.cgroupCpuUtilizationLabel', {
  ...
  node_load_average: new ElasticsearchMetric({
    ...
    description: i18n.translate('xpack.monitoring.metrics.esNode.systemLoad.last1MinuteDescription', {
  ...
  node_index_mem_query_cache: new IndexMemoryMetric({
    ...
    description: i18n.translate('xpack.monitoring.metrics.esNode.indexMemoryEs.queryCacheDescription', {
      defaultMessage: 'Heap memory used by Query Cache (e.g., cached filters). This is for the same shards, but not a part of Lucene Total.'
    }),
    type: 'node'
  }),
  ...
  node_index_threads_get_rejected: new ElasticsearchMetric({
    ...
    description: i18n.translate('xpack.monitoring.metrics.esNode.readThreads.getRejectionsDescription', {
  ...
  node_index_threads_search_queue: new ElasticsearchMetric({
    ...
    description: i18n.translate('xpack.monitoring.metrics.esNode.readThreads.searchQueueDescription', {
  ...
  node_index_threads_search_rejected: new ElasticsearchMetric({
    ...
    description: i18n.translate('xpack.monitoring.metrics.esNode.indexingThreads.searchRejectionsDescription', {
  ...
  node_index_total: new ElasticsearchMetric({
    ...
    description: i18n.translate('xpack.monitoring.metrics.esNode.requestRate.indexingTotalDescription', {
      defaultMessage: 'Amount of indexing operations.'
    }),
    type: 'node',
    derivative: true,
  ...
  node_index_time: new ElasticsearchMetric({
    ...
    description: i18n.translate('xpack.monitoring.metrics.esNode.indexingTime.indexTimeDescription', {
  ...
  node_search_total: new ElasticsearchMetric({
    ...
    description: i18n.translate('xpack.monitoring.metrics.esNode.requestRate.searchTotalDescription', {
      defaultMessage: 'Amount of search operations (per shard).'
    }),
    type: 'node',
    derivative: true,
  ...
  node_threads_queued_generic: new ThreadPoolQueueMetric({
    ...
    description: i18n.translate('xpack.monitoring.metrics.esNode.threadsQueued.genericDescription', {
  ...
  node_threads_queued_management: new ThreadPoolQueueMetric({
    ...
    description: i18n.translate('xpack.monitoring.metrics.esNode.threadsQueued.managementDescription', {
  ...
  node_threads_queued_watcher: new ThreadPoolQueueMetric({
    ...
    description: i18n.translate('xpack.monitoring.metrics.esNode.threadsQueued.watcherDescription', {
  ...
  node_threads_rejected_generic: new ThreadPoolRejectedMetric({
    ...
    description: i18n.translate('xpack.monitoring.metrics.esNode.threadsRejected.genericDescription', {
  ...
  node_threads_rejected_index: new ThreadPoolRejectedMetric({
    ...
    description: i18n.translate('xpack.monitoring.metrics.esNode.threadsRejected.indexDescription', {
  ...
  node_threads_rejected_management: new ThreadPoolRejectedMetric({
    ...
    description: i18n.translate('xpack.monitoring.metrics.esNode.threadsRejected.managementDescription', {
  ...
  node_threads_rejected_search: new ThreadPoolRejectedMetric({
    ...
    description: i18n.translate('xpack.monitoring.metrics.esNode.threadsRejected.searchDescription', {
  ...
  node_threads_rejected_watcher: new ThreadPoolRejectedMetric({
    ...
    description: i18n.translate('xpack.monitoring.metrics.esNode.threadsRejected.watcherDescription', {
  ...
  node_throttle_index_time: new ElasticsearchMetric({
    ...
    description: i18n.translate('xpack.monitoring.metrics.esNode.indexingTime.indexThrottlingTimeDescription', {

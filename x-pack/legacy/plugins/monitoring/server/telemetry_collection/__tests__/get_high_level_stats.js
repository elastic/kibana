  ...
  const expectedClusters = {
    ...
    b: {
      ...
      os: {
        ...
        platforms: [{ platform: 'linux', count: 1 }, { platform: 'darwin', count: 1 }],
      ...
      cloud: [
        {
          ...
          count: 4,
          vms: 2,
          vm_types: [{ vm_type: 'x1', count: 1 }, { vm_type: 'ps4', count: 2 }],
          regions: [{ region: 'abc-123', count: 1 }, { region: 'def-123', count: 2 }],

...
describe('get_all_stats', () => {
  ...
  const kibanaStats = {
      ...
      cloud: [
        {
          ...
          count: 4,
          vms: 2,
          vm_types: [{ vm_type: 'x1', count: 2 }, { vm_type: 'ps4', count: 2 }],
          regions: [{ region: 'abc-123', count: 2 }, { region: 'def-123', count: 2 }],
    ...
    b: {
      count: 3,
      versions: [{ version: '2.3.4-rc1', count: 1 }, { version: '2.3.4', count: 1 }],
    },
  };
  const logstashStats = {
    a: {
    ...
    b: {
      count: 32,
      versions: [{ version: '2.3.4-beta2', count: 15 }, { version: '2.3.4', count: 17 }],
    },
  };
  ...
  describe('addStackStats', () => {
    it('searches for clusters', () => {
      ...
      const stats = {
        a: {
          count: 2,
          versions: [{ version: '5.4.0', count: 1 }, { version: '5.5.0', count: 1 }],
        },
        b: {
          count: 2,

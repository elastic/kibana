  ...
  series: [
    {
      ...
      label: 'Max Heap',
      id: 'Max Heap',
      data: [[1562958960000, 1037959168], [1562958990000, 1037959168], [1562959020000, 1037959168]],
    },
    {
      color: '#3b73ac',
      label: 'Max Heap Used',
      id: 'Max Heap Used',
      data: [[1562958960000, 639905768], [1562958990000, 622312416], [1562959020000, 555967504]],
    },
  ],
  timeRange: {
    min: 1562958939851,

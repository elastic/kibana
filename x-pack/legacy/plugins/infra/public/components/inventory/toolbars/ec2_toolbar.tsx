...
export const EC2Toolbar = (props: ToolbarProps) => {
  const options = useMemo(() => {
    ...
    const DiskWrite = i18n.translate('xpack.infra.waffle.metricOptions.inboundTrafficText', {
      defaultMessage: 'Disk Write',
    });

    const DiskRead = i18n.translate('xpack.infra.waffle.metricOptions.inboundTrafficText', {
      defaultMessage: 'Disk Read',
    });
    ...
    return [
      ...
      {
        text: DiskRead,
        value: InfraSnapshotMetricType.diskRead,
      },
      {
        text: DiskWrite,
        value: InfraSnapshotMetricType.diskWrite,
      },
      {
        text: InboundTraffic,

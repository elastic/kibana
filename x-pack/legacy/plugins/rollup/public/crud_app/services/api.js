...
export async function startJobs(jobIds) {
  const body = { jobIds };
  const request = getHttp().post(`${apiPrefix}/start`, { body: JSON.stringify(body) });
...
export async function stopJobs(jobIds) {
  const body = { jobIds };
  const request = getHttp().post(`${apiPrefix}/stop`, { body: JSON.stringify(body) });
...
export async function deleteJobs(jobIds) {
  const body = { jobIds };
  const request = getHttp().post(`${apiPrefix}/delete`, { body: JSON.stringify(body) });
...
export async function createJob(job) {
  const body = { job };
  const request = getHttp().put(`${apiPrefix}/create`, { body: JSON.stringify(body) });

...
import { ExpressionRendererComponent as ExpressionRendererReactComponent } from '../../../../../../../src/plugins/expressions/public';
...
export interface SuggestionPanelProps {
  ...
  ExpressionRenderer: ExpressionRendererReactComponent;
...
const PreviewRenderer = ({
  ...
  withLabel: boolean;
  expression: string;
  ExpressionRendererComponent: ExpressionRendererReactComponent;
}) => {
  return (
    <div

...
import { FIELD_ORIGIN, LABEL_BORDER_SIZES, SYMBOLIZE_AS_TYPES, VECTOR_STYLES, STYLE_TYPE, LAYER_STYLE_TYPE } from './constants';
...
export type VectorStylePropertiesDescriptor = {
  ...
  [VECTOR_STYLES.LABEL_BORDER_SIZE]?: LabelBorderSizeOptions,
}

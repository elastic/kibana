    ...
    description: () => (
      <p>
        <FormattedMessage
          ...
          defaultMessage="Text fields support full-text search by breaking a string into individual, searchable terms. To index structured content, such as an email address, use the {keyword}."
          values={{
            keyword: (

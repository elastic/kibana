...
export class HeadlessChromiumDriver {
  ...
  constructor(page: puppeteer.Page, { inspect }: ChromiumDriverOptions) {
    this.page = page;
  ...
  public async waitForSelector(selector: string, opts: WaitForSelectorOpts = {}, logger: Logger) {
  ...
  public async setViewport({ width, height, zoom }: ViewZoomWidthHeight, logger: Logger) {

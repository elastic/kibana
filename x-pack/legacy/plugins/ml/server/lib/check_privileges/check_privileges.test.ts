...
describe('check_privileges', () => {
  ...
  describe('getPrivileges() with security', () => {
    test('ml_user capabilities only', async done => {
      ...
      expect(capabilities.canGetTransform).toBe(false);
      expect(capabilities.canDeleteTransform).toBe(false);
      expect(capabilities.canPreviewTransform).toBe(false);
      expect(capabilities.canCreateTransform).toBe(false);
      expect(capabilities.canStartStopTransform).toBe(false);
    ...
    test('full capabilities', async done => {
      ...
      expect(capabilities.canFindFileStructure).toBe(true);
      expect(capabilities.canGetTransform).toBe(true);
      expect(capabilities.canDeleteTransform).toBe(true);
      expect(capabilities.canPreviewTransform).toBe(true);
      expect(capabilities.canCreateTransform).toBe(true);
      expect(capabilities.canStartStopTransform).toBe(true);
      expect(capabilities.canGetDataFrameAnalytics).toBe(true);

...
import { getDateFormatTz, restoreAppState } from './explorer_utils';
...
export const Explorer = injectI18n(
  injectObservablesAsProps(
    ...
    class Explorer extends React.Component {
              ...
              if (selection !== undefined) {
                if (!initialized) {
                  explorerService.initialize(
                    selection,
                    restoreAppState(this.props.explorerState.appState)
                  );
                  initialized = true;
                } else {
                  explorerService.updateJobSelection(
                    selection,
                    restoreAppState(this.props.explorerState.appState)
                  );
                }
      ...
      render() {
        const { globalState, intl, jobSelectService$, showCharts } = this.props;
        ...
        const mainColumnWidthClassName =
          noInfluencersConfigured === true ? 'col-xs-12' : 'col-xs-10';

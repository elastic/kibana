...
import { filterAggTypes } from 'plugins/ml/jobs/new_job/simple_old/components/utils/filter_agg_types';
import { validateJob } from 'plugins/ml/jobs/new_job/simple_old/components/utils/validate_job';
import { adjustIntervalDisplayed } from 'plugins/ml/jobs/new_job/simple_old/components/utils/adjust_interval';
import { CHART_STATE, JOB_STATE } from 'plugins/ml/jobs/new_job/simple_old/components/constants/states';
import { createFields } from 'plugins/ml/jobs/new_job/simple_old/components/utils/create_fields';
import { loadCurrentIndexPattern, loadCurrentSavedSearch, timeBasedIndexCheck } from 'plugins/ml/util/index_utils';
import { ChartDataUtilsProvider } from 'plugins/ml/jobs/new_job/simple_old/components/utils/chart_data_utils.js';
...
import { preLoadJob } from 'plugins/ml/jobs/new_job/simple_old/components/utils/prepopulate_job_settings';
...
uiRoutes
  .when('/jobs/new_job/simple_old/population', {
    template,

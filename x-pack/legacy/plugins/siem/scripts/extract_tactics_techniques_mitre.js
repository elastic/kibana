...
const MITRE_ENTREPRISE_ATTACK_URL = 'https://raw.githubusercontent.com/mitre/cti/master/enterprise-attack/enterprise-attack.json';



const getTacticsOptions = tactics => tactics.map(t => `{
  id: '${t.id}',
  name: '${t.name}',

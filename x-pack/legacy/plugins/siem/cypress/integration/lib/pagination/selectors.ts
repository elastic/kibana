...
export const AUTHENTICATIONS_TABLE = '[data-test-subj="table-authentications-false"]';
...
export const UNCOMMON_PROCCESSES_TABLE = '[data-test-subj="table-uncommonProcesses-false"]';

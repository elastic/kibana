...
import { createBulkErrorObject, ImportRuleResponse, buildRouteValidation } from '../utils';
...
export const importRulesRoute = (router: IRouter, config: LegacyServices['config']) => {
  router.post(
    ...
    async (context, request, response) => {
      ...
      const readStream = createRulesStreamFromNdJson(request.body.file, objectLimit);

...
import { OnInsertTimeline, OnToggleShowNotes, InsertTimelineResult } from '../types';
...
export const getCommonColumns = ({
  ...
  {
    isExpander: true,
    render: ({ notes, savedObjectId }: InsertTimelineResult) =>
  ...
  },
  {
    ...
    render: (date: number, timelineResult: InsertTimelineResult) => (

...
describe('#getActionsColumns', () => {
  ...
  test('it renders an empty star when favorite is undefined', () => {
    const undefinedFavorite: InsertTimelineResult[] = [omit('favorite', { ...mockResults[0] })];
  ...
  test('it renders an empty star when favorite is null', () => {
    const nullFavorite: InsertTimelineResult[] = [{ ...mockResults[0], favorite: null }];
  ...
  test('it renders an empty star when favorite is empty', () => {
    const emptyFavorite: InsertTimelineResult[] = [{ ...mockResults[0], favorite: [] }];
  ...
  test('it renders an filled star when favorite has one entry', () => {
    const emptyFavorite: InsertTimelineResult[] = [
      {
        ...mockResults[0],
        favorite: [
          {

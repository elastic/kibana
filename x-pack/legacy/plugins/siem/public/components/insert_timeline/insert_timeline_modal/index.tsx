...
export interface InsertTimelineModalProps {
  onClose: () => void;
...
export const InsertTimelineModal = React.memo<InsertTimelineModalProps>(
...
InsertTimelineModal.displayName = 'InsertTimelineModal';

...
import { InsertTimelineProps, ActionTimelineToShow } from '../types';
...
export const InsertTimelineModalBody = memo<InsertTimelineProps>(
  ({
    deleteTimelines,
    defaultPageSize,
    hideActions = [],
...
InsertTimelineModalBody.displayName = 'InsertTimelineModalBody';

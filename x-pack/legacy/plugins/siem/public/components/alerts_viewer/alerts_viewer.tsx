...
import { AlertsQuery } from '../../containers/alerts';
...
export const AlertsViewer = React.memo<Props>(
  ({
    browserFields,
    columns,
    dataProviders,
    ...
    return (
      <EuiPanel data-test-subj="alerts-viewer-panel" grow={false}>
        <AutoSizer detectAnyWindowResize={true} content>
          {({ measureRef, content: { width = 0 } }) => (
            <>
              <WrappedByAutoSizer ref={measureRef}>
                <div
                  data-test-subj="alerts-viewer-measured"
                ...
                >
                  {({
                    ...
                    <>
                      ...
                      <div
                        data-test-subj={`alerts-container-loading-${loading}`}
...
AlertsViewer.displayName = 'AlertsViewer';

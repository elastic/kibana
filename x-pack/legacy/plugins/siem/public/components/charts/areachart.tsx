...
export const AreaChartBaseComponent: React.FC<AreaChartBaseComponentProps> = React.memo(
  ({ data, ...chartConfigs }) => {
...
export const AreaChart: React.FC<AreaChartProps> = React.memo(({ areaChart, configs }) => {

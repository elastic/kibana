...
type HostsTableProps = OwnProps & HostsTableReduxProps;
...
type HostsTableReduxProps = ConnectedProps<typeof connector>;

export const HostsTable = HostsTableComponent;

          ...
          {({ timelines, loading, totalCount }) => (
            <EuiSelectableContainer isLoading={loading}>
              <EuiSelectable
                ...
                options={[
                  ...(!isInsertTimeline && !onlyFavorites && searchTimelineValue === ''
                    ...
                    .map(
                      (t, index) =>
                        ({
                          ...
                          title: t.title,
                          checked:
                            t.savedObjectId === timelineId && !isInsertTimeline ? 'on' : undefined,
                        } as EuiSelectableOption)
                    ),
                ]}
              >

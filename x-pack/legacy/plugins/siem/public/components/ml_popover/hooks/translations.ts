...
export const INDEX_PATTERN_FETCH_FAILURE = i18n.translate(
  'xpack.siem.containers.errors.indexPatternFetchFailureTitle',
  {
...
export const JOB_SUMMARY_FETCH_FAILURE = i18n.translate(
  'xpack.siem.containers.errors.jobSummaryFetchFailureTitle',
  {
...
export const SIEM_JOB_FETCH_FAILURE = i18n.translate(
  'xpack.siem.containers.errors.siemJobFetchFailureTitle',
  {

...
export const SHOWING = i18n.translate('xpack.siem.anomaliesTable.showing', {
  defaultMessage: 'Showing',
});

export const ANOMALIES = i18n.translate('xpack.siem.anomaliesTable.anomaliesDescription', {

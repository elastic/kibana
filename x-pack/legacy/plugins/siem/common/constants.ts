...
export const DETECTION_ENGINE_RULES_STATUS_URL = `${DETECTION_ENGINE_URL}/rules/_find_statuses`;
export const DETECTION_ENGINE_PREPACKAGED_RULES_STATUS_URL = `${DETECTION_ENGINE_URL}/rules/prepackaged/_status`;

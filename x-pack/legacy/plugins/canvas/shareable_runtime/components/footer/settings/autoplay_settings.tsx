 ...
 */
export const AutoplaySettingsComponent: FC<Props> = ({ isEnabled, interval, onSetAutoplay, onSetInterval }: Props) => (
...
export const AutoplaySettings = () => {
  ...
  const onSetAutoplay: onSetAutoplayFn = (enabled: boolean) =>

...
export const getCanvas = (wrapper: ReactWrapper) => wrapper.find('Canvas > Canvas');

export const getFooter = (wrapper: ReactWrapper) => wrapper.find('Footer > Footer');

export const getScrubber = (wrapper: ReactWrapper) => wrapper.find('Scrubber > Scrubber');
...
export const getToolbarPanel = (wrapper: ReactWrapper) =>
  wrapper.find('ToolbarSettings > ToolbarSettings');
...
export const getAutoplayPanel = (wrapper: ReactWrapper) =>
  wrapper.find('AutoplaySettings > AutoplaySettings');
...
export const getSettingsPanel = (wrapper: ReactWrapper) => wrapper.find('Settings > Settings');

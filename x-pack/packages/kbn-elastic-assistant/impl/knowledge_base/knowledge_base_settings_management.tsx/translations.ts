...
export const INDEX = i18n.translate(
  'xpack.elasticAssistant.assistant.settings.knowledgeBaseSettingsManagement.indexButtonLabel',
  {
...
export const ENTRY = i18n.translate(
  'xpack.elasticAssistant.assistant.settings.knowledgeBaseSettingsManagement.entryButtonLabel',
  {

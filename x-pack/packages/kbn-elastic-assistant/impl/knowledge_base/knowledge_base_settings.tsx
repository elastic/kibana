...
export const KnowledgeBaseSettings: React.FC = React.memo(() => {
  ...
  const { knowledgeBase, setUpdatedKnowledgeBaseSettings, resetSettings, saveSettings } =
    useSettingsUpdater(
      {}, // Knowledge Base settings do not require conversations
      false, // Knowledge Base settings do not require conversations
      { page: 0, perPage: 0, total: 0, data: [] } // Knowledge Base settings do not require anonymizationFields
    );
  ...
  const handleUpdateKnowledgeBaseSettings = useCallback(
    (updatedKnowledgebase) => {
      handleChange(setUpdatedKnowledgeBaseSettings(updatedKnowledgebase));
    },
    [handleChange, setUpdatedKnowledgeBaseSettings]
  );

...
import { AssistantMessage, ToolMessage } from '@kbn/inference-plugin/common/chat_complete';
import { ToolChoiceType } from '@kbn/inference-plugin/common/chat_complete/tools';

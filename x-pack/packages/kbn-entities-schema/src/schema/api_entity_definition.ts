...
import { semVerSchema, metricNameSchema } from './common';
...
export const apiEntityDefinitionSchema = z.object({
  id: z.string().regex(/^[\w-]+$/),
...
export type APIEntityDefinition = z.infer<typeof apiEntityDefinitionSchema>;

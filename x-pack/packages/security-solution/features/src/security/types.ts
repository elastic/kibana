...
export interface SecurityFeatureParams {
   ...
   * @see https://github.com/elastic/kibana/blob/main/x-pack/solutions/security/solutions/security/plugins/security_solution/common/experimental_features.ts#L14
   */

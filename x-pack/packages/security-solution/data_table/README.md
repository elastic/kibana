...
`x-pack/solutions/security/solutions/security/plugins/security_solution/public/common/components/events_viewer/index.tsx`

The following file:
`kibana/x-pack/solutions/security/solutions/security/plugins/security_solution/public/common/store/reducer.ts`

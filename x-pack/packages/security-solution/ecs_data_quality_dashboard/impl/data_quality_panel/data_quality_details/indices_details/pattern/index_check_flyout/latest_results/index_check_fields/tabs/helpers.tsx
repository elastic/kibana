...
export const getIncompatibleFieldsTab = ({
  docsCount,
  formatBytes,
  formatNumber,
  ilmPhase,
...
export const getSameFamilyFieldsTab = ({
  docsCount,
  formatBytes,
  formatNumber,
  ilmPhase,
...
export const getEcsCompliantFieldsTab = ({
  indexName,
  partitionedFieldMetadata,
}: Pick<TabOpts, 'indexName' | 'partitionedFieldMetadata'>): Tab => ({
  append: (
...
export const getTabs = ({
  ...
  getEcsCompliantFieldsTab({ indexName, partitionedFieldMetadata }),
  getAllFieldsTab({ indexName, partitionedFieldMetadata }),
];

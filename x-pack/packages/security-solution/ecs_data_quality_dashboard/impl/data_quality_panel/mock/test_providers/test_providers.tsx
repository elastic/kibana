...
import { ChromeNavControls, ChromeStart, UserProfileService } from '@kbn/core/public';
...
const TestExternalProvidersComponent: React.FC<TestExternalProvidersProps> = ({ children, navControls = new NavControlsService().start(),  }) => {

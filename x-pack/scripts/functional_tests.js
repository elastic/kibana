...
const onlyNotInCoverageTests = [
  ...
  require.resolve('../test/rule_registry/security_and_spaces/tests/config_basic.ts'),
  require.resolve('../test/rule_registry/security_and_spaces/tests/config_trial.ts'),

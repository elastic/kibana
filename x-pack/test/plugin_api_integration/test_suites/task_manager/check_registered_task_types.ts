    ...
    it('should check changes on all registered task types', async () => {
      ...
      expect(types).to.eql(
        [
          ...
          'alerting:untrack:.es-query',
          'alerting:untrack:.geo-containment',
          'alerting:untrack:.index-threshold',
          'alerting:untrack:apm.anomaly',
          'alerting:untrack:apm.error_rate',
          'alerting:untrack:apm.transaction_duration',
          'alerting:untrack:apm.transaction_error_rate',
          'alerting:untrack:logs.alert.document.count',
          'alerting:untrack:metrics.alert.anomaly',
          'alerting:untrack:metrics.alert.inventory.threshold',
          'alerting:untrack:metrics.alert.threshold',
          'alerting:untrack:monitoring_alert_cluster_health',
          'alerting:untrack:monitoring_alert_cpu_usage',
          'alerting:untrack:monitoring_alert_disk_usage',
          'alerting:untrack:monitoring_alert_elasticsearch_version_mismatch',
          'alerting:untrack:monitoring_alert_jvm_memory_usage',
          'alerting:untrack:monitoring_alert_kibana_version_mismatch',
          'alerting:untrack:monitoring_alert_license_expiration',
          'alerting:untrack:monitoring_alert_logstash_version_mismatch',
          'alerting:untrack:monitoring_alert_missing_monitoring_data',
          'alerting:untrack:monitoring_alert_nodes_changed',
          'alerting:untrack:monitoring_alert_thread_pool_search_rejections',
          'alerting:untrack:monitoring_alert_thread_pool_write_rejections',
          'alerting:untrack:monitoring_ccr_read_exceptions',
          'alerting:untrack:monitoring_shard_size',
          'alerting:untrack:siem.eqlRule',
          'alerting:untrack:siem.indicatorRule',
          'alerting:untrack:siem.mlRule',
          'alerting:untrack:siem.newTermsRule',
          'alerting:untrack:siem.notifications',
          'alerting:untrack:siem.queryRule',
          'alerting:untrack:siem.savedQueryRule',
          'alerting:untrack:siem.thresholdRule',
          'alerting:untrack:slo.rules.burnRate',
          'alerting:untrack:transform_health',
          'alerting:untrack:xpack.ml.anomaly_detection_alert',
          'alerting:untrack:xpack.ml.anomaly_detection_jobs_health',
          'alerting:untrack:xpack.synthetics.alerts.monitorStatus',
          'alerting:untrack:xpack.synthetics.alerts.tls',
          'alerting:untrack:xpack.uptime.alerts.durationAnomaly',
          'alerting:untrack:xpack.uptime.alerts.monitorStatus',
          'alerting:untrack:xpack.uptime.alerts.tls',
          'alerting:untrack:xpack.uptime.alerts.tlsCertificate',

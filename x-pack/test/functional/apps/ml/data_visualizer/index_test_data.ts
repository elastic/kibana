...
export const farequoteDataViewTestData: TestData = {
  ...
  sampleSizeValidations: [
    { size: 1000, expected: { field: 'airline', docCountFormatted: '86274 (100%)' } },
    { size: 5000, expected: { field: '@timestamp', docCountFormatted: '86274 (100%)' } },
  ],
  expected: {
...
export const farequoteKQLSearchTestData: TestData = {
  ...
  sampleSizeValidations: [
    { size: 1000, expected: { field: 'airline', docCountFormatted: '34415 (100%)' } },
    { size: 5000, expected: { field: '@timestamp', docCountFormatted: '34415 (100%)' } },
  ],
  expected: {
...
export const farequoteKQLFiltersSearchTestData: TestData = {
  ...
  fieldTypeFilters: [ML_JOB_FIELD_TYPES.DATE, ML_JOB_FIELD_TYPES.TEXT],
  sampleSizeValidations: [
    { size: 1000, expected: { field: 'airline', docCountFormatted: '5674 (100%)' } },
    { size: 5000, expected: { field: '@timestamp', docCountFormatted: '5674 (100%)' } },
  ],
  expected: {
...
export const farequoteLuceneSearchTestData: TestData = {
  ...
  sampleSizeValidations: [
    { size: 1000, expected: { field: 'airline', docCountFormatted: '34416 (100%)' } },
    { size: 5000, expected: { field: '@timestamp', docCountFormatted: '34416 (100%)' } },
  ],
  expected: {

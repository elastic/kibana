      ...
      for (const testUser of testUsers) {
        describe(`(${testUser.user})`, function () {
          ...
          it('should display elements on Stack Management ML Overview page correctly', async () => {
            ...
            await ml.testExecution.logTestStep('should not show memory usage panel');
            await ml.memoryUsage.assertMemoryUsageExpandedDetailsPanelExists(false);

            await ml.testExecution.logTestStep('should not show nodes panel');
            await ml.memoryUsage.assertNodeExpandedDetailsPanelExists(false);
            ...
            await ml.overviewPage.assertADJobButtonEnabled('mlCreateNewJobButton', false);

            await ml.testExecution.logTestStep('should not show data frame analytics jobs panel');
          ...
          it('should display elements on ML Overview page correctly', async () => {
            ...
            await ml.overviewPage.assertADManageJobsButtonExists(false);

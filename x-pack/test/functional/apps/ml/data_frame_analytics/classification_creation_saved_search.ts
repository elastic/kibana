        ...
        const testDataList = [
            {
                ...
                jobDescription: "Classification job based on a saved search with filter' with dependentVariable 'airline' and trainingPercent '20'",
                        ...
                        jobDetails: [
                            {
                                ...
                                expectedEntries: {
                                    ...
                                    state: 'stopped',
                                    data_counts:
                                        '{"training_docs_count":17248,"test_docs_count":69026,"skipped_docs_count":0}',
                                    description:
                                        "Classification job based on a saved search with filter' with dependentVariable 'airline' and trainingPercent '20'",
                                },
                            },

...
export default function ({ getService, getPageObjects }: FtrProviderContext) {
  ...
  const createDrilldown = async () => {
    ...
    await toasts.clearAllToasts(); // toasts get in the way of bottom "Create drilldown" button in flyout
  ...
  const createControls = async (
    ...
    await toasts.clearAllToasts(); // toasts get in the way of bottom "Save and close" button in create control flyout

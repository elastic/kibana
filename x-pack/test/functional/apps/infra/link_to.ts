  ...
  describe('Infra link-to', function() {
    ...
    it('redirects to the logs app and parses URL search params correctly', async () => {
      ...
      const expectedSearchString =
        "logPosition=(position:(tiebreaker:0,time:1565707203194),streamLive:!f)&logFilter=(expression:'trace.id:433b4651687e18be2c6c8e3b11f53d09',kind:kuery)&sourceId=default";

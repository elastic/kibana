...
export default function({ getPageObjects, getService }: KibanaFunctionalTestDefaultProviders) {
  ...
  describe.only('hybrid', () => {
    ...
    it('hybrid visualization', async () => {
      ...
      const inspectorExpectedData = [ [ '2019-08-19 00:00', 'gif', '2' ],
         ...
         [ '2019-08-22 16:00', 'jpg', '3' ] ] to sort of equal [ [ '2019-08-19 00:00', 'gif', '2' ],
         [ '2019-08-19 00:00', 'jpg', '2' ],
         [ '2019-08-19 00:00', 'css', '1' ],
         [ '2019-08-19 08:00', 'jpg', '599' ],
         [ '2019-08-19 08:00', 'css', '116' ],
...
//title: hybrid_histogram_line_chart


//start date 2019-08-19 01:55:07.240




//end date: 2019-08-22 23:09:36.205

//URL
//http://localhost:5620/app/kibana#/visualize/edit/2f8a0d70-c374-11e9-9d0b-e919aba203a4?_g=(refreshInterval%3A(pause%3A!t%2Cvalue%3A0)%2Ctime%3A(from%3A'2019-08-19T01%3A55%3A07.240Z'%2Cto%3A'2019-08-22T23%3A09%3A36.205Z'))

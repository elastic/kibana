...
export default function({ getPageObjects, getService }: KibanaFunctionalTestDefaultProviders) {
  ...
  describe('spaces feature controls', () => {
    describe('space with no features disabled', () => {
      ...
      it('shows Registered navlink', async () => {
        ...
        expect(navLinks).to.contain('Registered App');
      });
    ...
    describe('space with Registered App disabled', () => {
      ...
      it('does not show Registered navlink', async () => {
        await PageObjects.common.navigateToApp('home', {
          basePath: '/s/custom_space',
        });
        const navLinks = (await appsMenu.readLinks()).map(
        ...
        expect(navLinks).not.to.contain('Registered App');
      });
      ...
      it(`does not allow navigation to registered app`, async () => {
        await PageObjects.common.navigateToActualUrl('registeredApp', '', {
          basePath: '/s/custom_space',

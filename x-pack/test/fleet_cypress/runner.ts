...
export async function FleetCypressCliTestRunner({ getService }: FtrProviderContext) {
...
export async function FleetCypressVisualTestRunner({ getService }: FtrProviderContext) {
  const log = getService('log');
  const config = getService('config');

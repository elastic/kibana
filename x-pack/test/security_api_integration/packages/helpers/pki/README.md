...
```
bin/elasticsearch-certutil cert -days 18250 --ca $KIBANA_HOME/src/dev/packages/dev-utils/certs/ca.p12 --ca-pass castorepass --name first_client --pass ""
bin/elasticsearch-certutil cert -days 18250 --ca $KIBANA_HOME/src/dev/packages/dev-utils/certs/ca.p12 --ca-pass castorepass --name second_client --pass ""
```

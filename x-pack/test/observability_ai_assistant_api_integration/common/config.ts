...
import { type Config, type FtrConfigProviderContext } from '@kbn/test';
...
import { type InheritedFtrProviderContext, type InheritedServices } from './ftr_provider_context';

...
import { CasePostRequest, Case, getCaseConnectorsUrl } from '@kbn/cases-plugin/common/api';
...
import { GetCaseConnectorsResponse } from '@kbn/cases-plugin/common/types/api';

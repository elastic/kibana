...
import { UserActionActionTypes, CommentUserAction } from '@kbn/cases-plugin/common/types/domain';
import {
  globalRead,
  noKibanaPrivileges,
  obsOnly,
    ...
    describe('sorting', () => {
      it('sorts the results in descending order by the created_at field', async () => {
        ...
        const response = await findCaseUserActions({
          ...
          options: {
            sortOrder: 'desc',
            types: [UserActionActionTypes.comment, UserActionActionTypes.create_case],
          },
        });
    ...
    describe('filters using the type query parameter', () => {
      ...
      it('retrieves only the connector user actions', async () => {
        ...
        const response = await findCaseUserActions({
          ...
          options: {
            sortOrder: 'asc',
            types: [UserActionActionTypes.connector],
          },
        });
      ...
      it('retrieves only the description user actions', async () => {
        ...
        const response = await findCaseUserActions({
          ...
          options: {
            sortOrder: 'asc',
            types: [UserActionActionTypes.description],
          },
        });
      ...
      it('retrieves only the tags user actions', async () => {
        ...
        const response = await findCaseUserActions({
          ...
          options: {
            sortOrder: 'asc',
            types: [UserActionActionTypes.tags],
          },
        });
      ...
      it('retrieves only the title user actions', async () => {
        ...
        const response = await findCaseUserActions({
          ...
          options: {
            sortOrder: 'asc',
            types: [UserActionActionTypes.title],
          },
        });
      ...
      it('retrieves only the status user actions', async () => {
        ...
        const response = await findCaseUserActions({
          ...
          options: {
            sortOrder: 'asc',
            types: [UserActionActionTypes.status],
          },
        });
      ...
      it('retrieves only the settings user actions', async () => {
        ...
        const response = await findCaseUserActions({
          ...
          options: {
            sortOrder: 'asc',
            types: [UserActionActionTypes.settings],
          },
        });
      ...
      it('retrieves only the severity user actions', async () => {
        ...
        const response = await findCaseUserActions({
          ...
          options: {
            sortOrder: 'asc',
            types: [UserActionActionTypes.severity],
          },
        });
      ...
      it('retrieves only the create_case user actions', async () => {
        ...
        const response = await findCaseUserActions({
          ...
          options: {
            sortOrder: 'asc',
            types: [UserActionActionTypes.create_case],
          },
        });
      ...
      describe('filtering on multiple types', () => {
        it('retrieves the create_case and comment user actions', async () => {
          ...
          const response = await findCaseUserActions({
            ...
            options: {
              sortOrder: 'asc',
              types: [UserActionActionTypes.create_case, UserActionActionTypes.comment],
            },
          });

...
export default ({ getService }: FtrProviderContext) => {
  ...
  describe('Security lists task telemetry', async () => {
    ...
    describe('endpoint lists', () => {
      it('should give telemetry/stats for 1 exception list', async () => {
        ...
        await retry.try(async () => {
          ...
          const securityLists = stats.securityLists
            .flat()
            .map((rule: { endpoint_exception: any }) => rule.endpoint_exception);
    ...
    describe('trusted application lists', () => {
      it('should give telemetry/stats for 1 exception list', async () => {
        ...
        await retry.try(async () => {
          ...
          const trustedApplication = stats.securityLists
            .flat()
            .map((rule: { trusted_application: any }) => rule.trusted_application);

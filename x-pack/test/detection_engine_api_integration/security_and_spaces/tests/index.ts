...
export default ({ loadTestFile }: FtrProviderContext): void => {
  describe('detection engine api security and spaces enabled', function () {
    ...
    loadTestFile(require.resolve('./exception_operators_data_types/date'));
    loadTestFile(require.resolve('./exception_operators_data_types/double'));
    loadTestFile(require.resolve('./exception_operators_data_types/ip'));

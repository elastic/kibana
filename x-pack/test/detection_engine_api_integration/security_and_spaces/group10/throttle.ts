  ...
  describe('throttle', () => {
    describe('adding actions', () => {
      ...
      describe('creating a rule', () => {
        ...
        it('When creating throttle with "NOTIFICATION_THROTTLE_NO_ACTIONS" set and no actions, the rule should have its kibana alerting "mute_all" set to "true"', async () => {

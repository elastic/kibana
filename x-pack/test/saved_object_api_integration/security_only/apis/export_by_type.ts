...
export default function({ getService }: TestInvoker) {
  ...
  describe('export_by_type', () => {
    ...
    exportByTypeTest('user with no access', {
    ...
    exportByTypeTest('dual-privileges user', {
    ...
    exportByTypeTest('dual-privileges readonly user', {
    ...
    exportByTypeTest('rbac user with all globally', {
    ...
    exportByTypeTest('rbac user with read globally', {
    ...
    exportByTypeTest('rbac user with all at default space', {
    ...
    exportByTypeTest('rbac user with read at default space', {
    ...
    exportByTypeTest('rbac user with all at space_1', {
    ...
    exportByTypeTest('rbac user with read at space_1', {

...
export default function({ getService }: TestInvoker) {
  ...
  } = findRelationshipsTestSuiteFactory(esArchiver, supertest);

  describe('find_relationships', () => {
    findRelationshipsTest('can access objects belonging to the current space (default)', {
      ...SPACES.DEFAULT,
      tests: {
        spaceAware: {
          statusCode: 200,
    ...
    findRelationshipsTest('can access objects belonging to the current space (space_1)', {
      ...SPACES.SPACE_1,
      tests: {
        spaceAware: {
          statusCode: 200,
    ...
    findRelationshipsTest(`can't access space aware objects belonging to anohter space (space_1)`, {

...
export default function({ getService }: TestInvoker) {
  ...
  describe('export_objects', () => {
    ...
    [
      ...
      exportObjectsTest(`user with no access within the ${scenario.spaceId} space`, {
      ...
      exportObjectsTest(`superuser with the ${scenario.spaceId} space`, {
      ...
      exportObjectsTest(`legacy user within the ${scenario.spaceId} space`, {
      ...
      exportObjectsTest(`dual-privileges user within the ${scenario.spaceId} space`, {
      ...
      exportObjectsTest(`dual-privileges readonly user within the ${scenario.spaceId} space`, {
      ...
      exportObjectsTest(`rbac user with all globally within the ${scenario.spaceId} space`, {
      ...
      exportObjectsTest(`rbac user with read globally within the ${scenario.spaceId} space`, {
      ...
      exportObjectsTest(`rbac user with all at the space within the ${scenario.spaceId} space`, {
      ...
      exportObjectsTest(`rbac user with read at the space within the ${scenario.spaceId} space`, {
      ...
      exportObjectsTest(`rbac user with all at the other space within ${scenario.spaceId} space`, {

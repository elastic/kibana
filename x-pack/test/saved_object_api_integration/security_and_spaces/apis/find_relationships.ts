...
export default function({ getService }: TestInvoker) {
  ...
  describe('find_relationships', () => {
    [
      ...
      findRelationshipsTest(`user with no access within the ${scenario.spaceId} space`, {
      ...
      findRelationshipsTest(`superuser within the ${scenario.spaceId} space`, {
      ...
      findRelationshipsTest(`legacy user within the ${scenario.spaceId} space`, {
      ...
      findRelationshipsTest(`legacy readonly user within the ${scenario.spaceId} space`, {
      ...
      findRelationshipsTest(`dual-privileges user within the ${scenario.spaceId} space`, {
      ...
      findRelationshipsTest(`dual-privileges readonly user within the ${scenario.spaceId} space`, {
      ...
      findRelationshipsTest(`rbac user with all globally within the ${scenario.spaceId} space`, {

...
export const LEGEND_ACTIONS = {
  ...
  FILTER_FOR: (ruleName: string) => `[data-test-subj="legend-${ruleName}-histogramLegendActionFilterIn"]`,
  FILTER_OUT: (ruleName: string) => `[data-test-subj="legend-${ruleName}-histogramLegendActionFilterOut"]`,

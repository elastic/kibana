...
describe.skip('Changing alert status', { tags: ['@iss', '@serverliss'] }, () => {
  before(() => {
  ...
  context('Opening alerts', { tags: ['@iss', '@serverliss'] }, () => {
    beforeEach(() => {
      login();
  ...
  context('Marking alerts as acknowledged', { tags: ['@iss', '@serverliss'] }, () => {
    beforeEach(() => {
      login();
      deleteAlertsAndRules();
      createRule(getNewRule());
  ...
  context('Closing alerts', { tags: ['@iss', '@serverliss'] }, () => {
    beforeEach(() => {
      login();
      deleteAlertsAndRules();
  ...
  context('User is readonly', { tags: ['@iss', '@brokenInServerless'] }, () => {
    beforeEach(() => {
      login();
      visit(ALERTS_URL);
      deleteAlertsAndRules();

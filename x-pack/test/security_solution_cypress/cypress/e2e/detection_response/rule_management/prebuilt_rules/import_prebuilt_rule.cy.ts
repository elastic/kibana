...
describe(
  ...
  () => {
    ...
    describe('when file is modified prebuilt rule with matching rule_id and a future version number', () => {
      const PREBUILT_RULE_1 = createRuleAssetSavedObject({
        name: 'original rule 1',
        rule_id: 'rule_1',
        version: 1, // Our imported rule will have a version number of 2
      });
    ...
    describe('when file is modified prebuilt rule with matching rule_id and a past version number', () => {
      const PREBUILT_RULE_1 = createRuleAssetSavedObject({
        name: 'original rule 1',
        rule_id: 'rule_1',
        version: 3, // Our imported rule will have a version number of 2
      });

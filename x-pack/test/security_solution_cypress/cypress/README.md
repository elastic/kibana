...
| cypress:rule_management:prebuilt_rules:management:run:ess    | Runs all tests tagged as ESS in the `e2e/detection_response/rule_management/prebuilt_rules/management` directory in headless mode                                                                                                                                                                                           |

...
export default function ({ getService }: FtrProviderContext) {
  describe('security_network_dashboard', () => {
    ...
    it('security_network_dashboard', async () => {
      await performance.runUserJourney(
        'security_network_dashboard',
        [
          {
            name: 'Go to Security Network Page',
            handler: async ({ page, kibanaUrl }: StepCtx) => {
              await page.goto(`${kibanaUrl}/app/security/network`);
              await page.waitForSelector('[data-test-subj="mapContainer"]');
            },
          },
          {
            ...
            handler: async ({ page }) => {
              ...
              await page.waitForSelector('[data-test-subj="table-topNFlowSource-loading-false"]');
            },
          },
          {
          ...
          {
            name: 'Open DNS sub-tab',
            handler: async ({ page }) => {
              await page.click('[data-test-subj="navigation-dns"]');
              await page.waitForSelector('[data-test-subj="paginated-basic-table"]');
            },
          },
          {
            name: 'Open HTTP sub-tab',
            handler: async ({ page }) => {
              await page.click('[data-test-subj="navigation-http"]');
              await page.waitForSelector('[data-test-subj="paginated-basic-table"]');
            },
          },
          {
            name: 'Open TLS sub-tab',
            handler: async ({ page }) => {
              await page.click('[data-test-subj="navigation-tls"]');
              await page.waitForSelector('[data-test-subj="paginated-basic-table"]');
            },
          },
          {
            ...
            handler: async ({ page }) => {
              ...
              await page.waitForSelector('[data-test-subj="network-anomalies-table"]');
            },
          },
          {

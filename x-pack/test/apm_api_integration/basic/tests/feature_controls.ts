...
export default function featureControlsTests({ getService }: FtrProviderContext) {
  ...
  const endpoints: Endpoint[] = [
    ...
    {
      req: {
        url: `/api/apm/services/foo/transactions?start=${start}&end=${end}&transactionType=bar&uiFilters=%7B%7D`,
      },
      expectForbidden: expect403,
      expectResponse: expect200,
    },
    ...
    {
      req: {
        url: `/api/apm/services/foo/transactions/distribution?start=${start}&end=${end}&transactionType=bar&transactionName=baz&uiFilters=%7B%7D`,
      },
      expectForbidden: expect403,
      expectResponse: expect200,
    },

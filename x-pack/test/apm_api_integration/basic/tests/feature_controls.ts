...
export default function featureControlsTests({ getService }: FtrProviderContext) {
  ...
  const endpoints: Endpoint[] = [
    ...
    {
      req: {
        url: `/api/apm/services/foo/transactions/groups/charts?start=${start}&end=${end}&transactionType=bar&uiFilters=%7B%22environment%22%3A%22testing%22%7D`,
      },
      expectForbidden: expect403,
      expectResponse: expect200,
    },
    {
      req: {
        url: `/api/apm/services/foo/transactions/groups/charts?start=${start}&end=${end}&uiFilters=%7B%22environment%22%3A%22testing%22%7D`,
      },
      expectForbidden: expect403,
      expectResponse: expect200,
    },
    {
      req: {
        url: `/api/apm/services/foo/transactions/groups/charts?start=${start}&end=${end}&transactionType=bar&transactionName=baz&uiFilters=%7B%22environment%22%3A%22testing%22%7D`,
      },
      expectForbidden: expect403,
      expectResponse: expect200,
    },
    {
      req: {
        url: `/api/apm/services/foo/transactions/groups/distribution?start=${start}&end=${end}&transactionType=bar&transactionName=baz&uiFilters=%7B%7D`,
      },
      expectForbidden: expect403,
      expectResponse: expect200,
    },

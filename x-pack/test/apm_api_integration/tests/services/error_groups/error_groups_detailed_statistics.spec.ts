...
export default function ApiTest({ getService }: FtrProviderContext) {
  ...
  async function callApi(
    overrides?: RecursivePartial<
      APIClientRequestParamsOf<'GET /internal/apm/services/{serviceName}/errors/detailed_statistics'>['params']
    >
  ) {
    return await apmApiClient.readUser({
      endpoint: `GET /internal/apm/services/{serviceName}/errors/detailed_statistics`,
      params: {

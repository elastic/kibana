...
export default ({ getService }: FtrProviderContext): void => {
  ...
  describe('get_case', () => {
    ...
    it('responds with a 400 when attempting to retrieve sub case comments', async () => {
      await supertest.get(`${CASES_URL}/invalid-case-id?includeSubCaseComments=true`).expect(400);
    });

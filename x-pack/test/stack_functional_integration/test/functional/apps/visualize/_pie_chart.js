...
export default function({ getService, getPageObjects }) {
  ...
  describe('visualize app', function describeIndexTests() {
    ...
    describe('pie chart', function indexPatternCreation() {
      ...
      it('should show 10 slices in pie chart, take screenshot', function pageHeader() {
        const expectedPieChartSliceCount = 10;

        return PageObjects.visualize.getPieChartData().then(function(pieData) {
          // const barHeightTolerance = 1;
          log.debug('pieData.length = ' + pieData.length);
          return screenshot.take('Visualize-pie-chart').then(() => {

...
export default function({ getService, getPageObjects }) {
  ...
  describe('visualize app', function describeIndexTests() {
    ...
    describe('tile map chart', function indexPatternCreation() {
      it('should show correct tile map data on default zoom level', function pageHeader() {
      ...
      it('should zoom out to level 1 from default level 2', function pageHeader() {
        const expectedPrecision2Circles = [
      ...
      it('"Fit data bounds" should zoom to level 3', function pageHeader() {
       ...
       */
      it('should save with zoom level and load, take screenshot', function pageHeader() {
        ...
        return (
          PageObjects.visualize
            ...
            .then(function takeScreenshot() {
              ...
              return screenshot.take('Visualize-site-map');
            })
        );
      });

      it('should zoom in to level 10', function pageHeader() {
        // 6
        return (
          PageObjects.visualize
            .clickMapZoomIn()

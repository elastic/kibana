...
export default function({ getService, getPageObjects }) {
  ...
  describe('discover app', function describeIndexTests() {
    before(function() {
      ...
      log.debug('discover');
      return PageObjects.common.navigateToApp('discover').then(function() {
    ...
    describe('field data', function() {
      ...
      it('search php should show the correct hit count', function() {
        ...
        return PageObjects.discover.query('php').then(function() {
          return retry.try(function tryingForTime() {
            return PageObjects.discover.getHitCount().then(function compareData(hitCount) {
              return screenshot.take('Discover-field-data').then(() => {
      ...
      it('the search term should be highlighted in the field data', function() {
        ...
        return PageObjects.discover.getMarks().then(function(marks) {
      ...
      it('search _type:apache should show the correct hit count', function() {
        ...
        return PageObjects.discover.query('_type:apache').then(function() {
          return retry.try(function tryingForTime() {
            return PageObjects.discover.getHitCount().then(function compareData(hitCount) {
              expect(hitCount).to.be(expectedHitCount);
            });
      ...
      it('doc view should show Time and _source columns', function() {
        ...
        return PageObjects.discover.getDocHeader().then(function(header) {
      ...
      it('doc view should show oldest time first', function() {
        ...
        return PageObjects.discover.getDocTableIndex(1).then(function(rowData) {
      ...
      it('doc view should sort ascending', function() {
        ...
        return PageObjects.discover
          ...
          .then(function() {
            return retry.try(function tryingForTime() {
              return PageObjects.discover.getDocTableIndex(1).then(function(rowData) {
                return screenshot.take('Discover-sort-down').then(() => {
                  expect(rowData).to.be(ExpectedDoc);
                });
              });
            });
      ...
      it('a bad syntax query should show an error message', function() {
        ...
        return PageObjects.discover
          ...
          .then(function(toastMessage) {
            return screenshot.take('Discover-syntax-error-toast').then(() => {

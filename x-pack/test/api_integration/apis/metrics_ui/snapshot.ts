...
import { METRICS_INDEX_PATTERN, TIMESTAMP_FIELD } from '../../../../plugins/infra/common/constants';
import {
    ...
    describe('6.6.0', () => {
      ...
      it('should basically work', () => {
        const resp = fetchSnapshot({
          indexPattern: METRICS_INDEX_PATTERN,
          nodeField: 'container.id',
          timerange: {
            to: max,
            from: min,
            interval: '1m',

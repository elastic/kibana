  ...
  describe('Elasticsearch version precheck', function () {
    ...
    describe('Elasticsearch 8.x running against Kibana 7.last', () => {
      ...
      it('returns 426 for GET /es_deprecations', async () => {
        await supertest.get(`${API_BASE_PATH}/es_deprecations`).set('kbn-xsrf', 'xxx').expect(426);
      });

      it('returns 426 for GET /remote_clusters', async () => {
        await supertest.get(`${API_BASE_PATH}/remote_clusters`).set('kbn-xsrf', 'xxx').expect(426);
      });

  ...
  describe('Component templates', function () {
    ...
    describe('Delete', () => {
      ...
      it('should delete multiple component templates', async () => {
        ...
        } = await deleteComponentTemplate(`${componentTemplate1Name},${componentTemplate2Name}`).expect(200);
      ...
      it('should return an error for any component templates not sucessfully deleted', async () => {
        ...
        const { body } = await deleteComponentTemplate(`${componentTemplateName},${COMPONENT_DOES_NOT_EXIST}`).expect(200);

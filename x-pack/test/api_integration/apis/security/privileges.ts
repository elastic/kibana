            ...
            features: {
              ...
              gis: {
                all: [
                  ...
                  'saved_object:gis-map/get',
                  'saved_object:gis-map/find',
                  'saved_object:gis-map/create',
                  'saved_object:gis-map/bulk_create',
                  'saved_object:gis-map/update',
                  'saved_object:gis-map/delete',
                  'saved_object:config/bulk_get',
                  'saved_object:config/get',
                  'saved_object:config/find',
                  'ui:navLinks/gis',

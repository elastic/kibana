            ...
            features: {
              ...
              visualization_lens: {
                all: [
                  'login:',
                  `version:${version}`,
                  `api:${version}:visualization_lens`,
                  `app:${version}:visualization_lens`,
                  `app:${version}:kibana`,
                  `ui:${version}:catalogue/visualization_lens`,
                  `ui:${version}:navLinks/visualization_lens`,
                  `saved_object:${version}:telemetry/bulk_get`,
                  `saved_object:${version}:telemetry/get`,
                  `saved_object:${version}:telemetry/find`,
                  `saved_object:${version}:telemetry/create`,
                  ...
                  `ui:${version}:savedObjectsManagement/telemetry/read`,
                  `ui:${version}:savedObjectsManagement/config/read`,
                  `ui:${version}:visualization_lens/show`,
                  'allHack:',
                ],
                read: [
                  'login:',

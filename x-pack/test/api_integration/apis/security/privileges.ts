            ...
            features: {
              ...
              visualization_editor: {
                all: [
                  'login:',
                  `version:${version}`,
                  `api:${version}:visualization_editor`,
                  `app:${version}:visualization_editor`,
                  `app:${version}:kibana`,
                  `ui:${version}:catalogue/visualization_editor`,
                  `ui:${version}:navLinks/visualization_editor`,
                  `saved_object:${version}:telemetry/bulk_get`,
                  `saved_object:${version}:telemetry/get`,
                  `saved_object:${version}:telemetry/find`,
                  `saved_object:${version}:telemetry/create`,
                  ...
                  `ui:${version}:savedObjectsManagement/telemetry/read`,
                  `ui:${version}:savedObjectsManagement/config/read`,
                  `ui:${version}:visualization_editor/show`,
                  'allHack:',
                ],
                read: [
                  'login:',

 ...
 * 2.0.
 */
import { type FtrConfigProviderContext, type Config, defineDockerServersConfig } from '@kbn/test';

import { type ServerlessProjectType } from '@kbn/es';
import path from 'path';
import { dockerImage } from '../../../fleet_api_integration/config.base';
import { type DeploymentAgnosticCommonServices, services } from '../services';

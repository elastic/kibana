                      ...
                      references: [
                        {
                          type: 'index-pattern',
                          id: '593f894a-3378-42cc-bafc-61b4877b64b0',
                          name: 'indexpattern-datasource-layer-62d3121e-b476-4660-ab15-c16580e22003',
                        },
                        {
                          type: 'index-pattern',
                          id: '593f894a-3378-42cc-bafc-61b4877b64b0',
                          name: 'indexpattern-datasource-layer-82ae8318-02fd-4afc-8957-59d25c9d0758',
                        },
                      ],
                      state: {
                        visualization: {
                          ...
                          layers: [
                            {
                              layerId: '62d3121e-b476-4660-ab15-c16580e22003',
                              accessors: ['a889b058-082b-47ac-a5e9-a649617f3992'],
                              position: 'top',
                              seriesType: 'bar_stacked',
                              showGridlines: false,
                              layerType: 'data',
                              ...
                              xAccessor: 'a4185ce7-4e0d-46eb-afa2-8b973e4d4f02',
                            },
                            {
                              layerId: '82ae8318-02fd-4afc-8957-59d25c9d0758',
                              layerType: 'data',
                              accessors: ['cd468e18-c44c-494f-9628-841167d75405'],
                              seriesType: 'bar_stacked',
                              xAccessor: '732b0cd4-c146-4f7f-83e2-9993eda8217e',
                              yConfig: [
                                {
                                  forAccessor: 'cd468e18-c44c-494f-9628-841167d75405',
                                  color: '#f6726a',
                                },
                              ],
                            },
                        ...
                        datasourceStates: {
                          formBased: {
                            layers: {
                              '62d3121e-b476-4660-ab15-c16580e22003': {
                                columns: {
                                  'a4185ce7-4e0d-46eb-afa2-8b973e4d4f02': {
                                    label: '@timestamp',
                                    dataType: 'date',
                                    operationType: 'date_histogram',
                                    sourceField: '@timestamp',
                                  ...
                                  'a889b058-082b-47ac-a5e9-a649617f3992': {
                                    label: 'Processed',
                                    dataType: 'number',
                                    operationType: 'sum',
                                    sourceField: 'processor.processed',
                              ...
                              '82ae8318-02fd-4afc-8957-59d25c9d0758': {
                                linkToLayers: [],
                                columns: {
                                  '732b0cd4-c146-4f7f-83e2-9993eda8217e': {
                                    label: '@timestamp',
                                    dataType: 'date',
                                    operationType: 'date_histogram',
                                    sourceField: '@timestamp',
                                  ...
                                  'cd468e18-c44c-494f-9628-841167d75405X0': {
                                    label:
                                      'Part of sum(processor.accepted) - sum(processor.processed)',
                                    dataType: 'number',
                                    operationType: 'sum',
                                  ...
                                  'cd468e18-c44c-494f-9628-841167d75405X1': {
                                    label:
                                      'Part of sum(processor.accepted) - sum(processor.processed)',
                                    dataType: 'number',
                                    operationType: 'sum',
                                  ...
                                  'cd468e18-c44c-494f-9628-841167d75405X2': {
                                    label:
                                      'Part of sum(processor.accepted) - sum(processor.processed)',
                                    dataType: 'number',
                                    operationType: 'math',
                                  ...
                                  'cd468e18-c44c-494f-9628-841167d75405': {
                                    label: 'Rejected',
                                    dataType: 'number',
                                    operationType: 'formula',
                                    isBucketed: false,
                                    ...
                                    references: ['cd468e18-c44c-494f-9628-841167d75405X2'],
                                    customLabel: true,
                                  },
                                },
                                columnOrder: [

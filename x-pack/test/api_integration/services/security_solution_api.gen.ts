...
import {
  type CreateRuleMigrationRequestParamsInput,
  type CreateRuleMigrationRequestBodyInput,
...
import {
  type CreateUpdateProtectionUpdatesNoteRequestParamsInput,
  type CreateUpdateProtectionUpdatesNoteRequestBodyInput,
...
import {
  type DeleteEntityEngineRequestQueryInput,
  type DeleteEntityEngineRequestParamsInput,
...
import { type EndpointUploadActionRequestBodyInput } from '@kbn/security-solution-plugin/common/api/endpoint/actions/response_actions/upload/upload.gen';
import {
  type ExportRulesRequestQueryInput,
  type ExportRulesRequestBodyInput,
} from '@kbn/security-solution-plugin/common/api/detection_engine/rule_management/export_rules/export_rules_route.gen';
import {
  type ExportTimelinesRequestQueryInput,
  type ExportTimelinesRequestBodyInput,
...
import {
  type GetEndpointSuggestionsRequestParamsInput,
  type GetEndpointSuggestionsRequestBodyInput,
...
import {
  type GetRuleExecutionEventsRequestQueryInput,
  type GetRuleExecutionEventsRequestParamsInput,
...
import {
  ...
  type GetRuleExecutionResultsRequestParamsInput,
...
import {
  type GetRuleMigrationRequestQueryInput,
  type GetRuleMigrationRequestParamsInput,
} from '@kbn/security-solution-plugin/common/siem_migrations/model/api/rules/rule_migration.gen';
...
import {
  type GetRuleMigrationResourcesRequestQueryInput,
  type GetRuleMigrationResourcesRequestParamsInput,
} from '@kbn/security-solution-plugin/common/siem_migrations/model/api/rules/rule_migration.gen';
...
import {
  type InitEntityEngineRequestParamsInput,
...
import {
  type InstallMigrationRulesRequestParamsInput,
  type InstallMigrationRulesRequestBodyInput,
} from '@kbn/security-solution-plugin/common/siem_migrations/model/api/rules/rule_migration.gen';
...
import { type InstallTranslatedMigrationRulesRequestParamsInput } from '@kbn/security-solution-plugin/common/siem_migrations/model/api/rules/rule_migration.gen';
...
import {
  type RetryRuleMigrationRequestParamsInput,
  type RetryRuleMigrationRequestBodyInput,
} from '@kbn/security-solution-plugin/common/siem_migrations/model/api/rules/rule_migration.gen';
import {
  type RulePreviewRequestQueryInput,
...
import {
  type StartRuleMigrationRequestParamsInput,
  type StartRuleMigrationRequestBodyInput,
} from '@kbn/security-solution-plugin/common/siem_migrations/model/api/rules/rule_migration.gen';
...
import { type UpdateRuleMigrationRequestBodyInput } from '@kbn/security-solution-plugin/common/siem_migrations/model/api/rules/rule_migration.gen';
import {
  type UpdateWorkflowInsightRequestParamsInput,
  type UpdateWorkflowInsightRequestBodyInput,
} from '@kbn/security-solution-plugin/common/api/endpoint/workflow_insights/workflow_insights.gen';
import {
  type UpsertRuleMigrationResourcesRequestParamsInput,
  type UpsertRuleMigrationResourcesRequestBodyInput,
} from '@kbn/security-solution-plugin/common/siem_migrations/model/api/rules/rule_migration.gen';

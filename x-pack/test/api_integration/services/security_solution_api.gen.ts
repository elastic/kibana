...
import { ConfigureRiskEngineSavedObjectRequestBodyInput } from '@kbn/security-solution-plugin/common/api/entity_analytics/risk_engine/so_configure_route.gen';
...
import { InitRiskEngineRequestBodyInput } from '@kbn/security-solution-plugin/common/api/entity_analytics/risk_engine/engine_init_route.gen';
...
> If the user already has a draft Timeline, the existing draft Timeline is cleared and returned.
    ...
    configureRiskEngineSavedObject(
      ...
      return supertest
        .post(routeWithNamespace('/api/risk_engine/saved_object/configure', kibanaSpace))
        .set('kbn-xsrf', 'true')
        .set(ELASTIC_HTTP_VERSION_HEADER, '2023-10-31')
        .set(X_ELASTIC_INTERNAL_ORIGIN_REQUEST, 'kibana')
        .send(props.body as object);

...
export default function infraTests({ getService }: KibanaFunctionalTestDefaultProviders) {
      ...
      it(`${scenario.id}`, async () => {
        ...
        switch (scenario.id) {
          ...
          case 'everything_space_all at everything_space':
            ...
            expect(uiCapabilities.value).to.have.property('infra');
            expect(uiCapabilities.value!.infra).to.eql({
              show: true,
            });
            break;

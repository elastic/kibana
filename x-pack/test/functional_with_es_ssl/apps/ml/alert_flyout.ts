...
export default ({ getPageObjects, getService }: FtrProviderContext) => {
  ...
  const job = {
    job_id: 'ec-high_sum_total_sales',
  ...
  const dataFeed = {
    datafeed_id: 'datafeed-ec-high_sum_total_sales',
    job_id: 'ec-high_sum_total_sales',
    query: {
      bool: {
        must: [
  ...
  describe('anomaly detection alert', () => {
    ...
    describe('overview page alert flyout controls', () => {
      it('can create an anomaly detection alert', async () => {
        ...
        await ml.alerting.selectJobs(['ec-high_sum_total_sales']);
        ...
        await ml.alerting.clickPreviewButton();

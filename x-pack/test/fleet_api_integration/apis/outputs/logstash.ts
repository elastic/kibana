...
export default function (providerContext: FtrProviderContext) {
  ...
  describe('fleet_outputs_logstash', async function () {
    ...
    describe('PUT /outputs/{outputId}/logstash', () => {
      ...
      it('should allow to update a non-default ES output to logstash', async function () {
        const { body: postResponse2 } = await supertest
          .post(`/api/fleet/outputs/logstash`)
          .set('kbn-xsrf', 'xxxx')
          .send({
        ...
        await supertest
          .put(`/api/fleet/outputs/${logstashOutput1Id}/logstash`)
          .set('kbn-xsrf', 'xxxx')
          .send({
            name: 'A Logstash Output',
            hosts: ['test.fr:443'],
      ...
      it('should allow to update a logstash output with the shipper values', async function () {
        ...
        await supertest
          .put(`/api/fleet/outputs/${newOutputId}/logstash`)
          .set('kbn-xsrf', 'xxxx')
          .send({
            name: 'My Logstash Output',
            hosts: ['test.fr:443'],
      ...
      it('should explicitly set the port on hosts field', async function () {
        await supertest
          .put(`/api/fleet/outputs/${defaultOutputId}/logstash`)
          .set('kbn-xsrf', 'xxxx')
    ...
    describe('POST /outputs/logstash', () => {

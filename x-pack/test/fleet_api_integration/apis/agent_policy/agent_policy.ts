...
export default function (providerContext: FtrProviderContext) {
  ...
  describe('fleet_agent_policies', () => {
    ...
    describe('POST /api/fleet/agent_policies', () => {
      ...
      it.only('should allow to create policy with the system integration policy and increment correctly the name if there is more than 10 package policy', async () => {
        // load a bunch of fake system integration policy
        for (let i = 0; i < 10; i++) {
          await kibanaServer.savedObjects.create({

...
export default ({ getService }: FtrProviderContext) => {
  ...
  // @skipInServerless tag because the simulators do not work in the QA env
  describe('@ess @serverless @skipInServerless Basic Security AI Assistant Invoke AI [non-streaming, non-LangChain]', async () => {
    after(() => {

...
//     junitReportName:
//       'EDR Workflows - Package Integration Tests - Serverless Env - Complete Licenses',
//     target: 'serverless',
...
export default createTestConfig({
  testFiles: [require.resolve('..')],
  junit: {
    reportName: 'EDR Workflows - Package Integration Tests - Serverless Env - Complete Licenses',
  },
});

    ...
    context('with auditbeat data', () => {
      ...
      describe('with some alerts containing hosts', () => {
        ...
        describe('initializing the risk engine', () => {
          ...
          it('@skipInServerless calculates and persists risk scores for alert documents', async () => {
          ...
          it('@skipInServerless starts the latest transform', async () => {
            await waitForRiskScoresToBePresent({ es, log, scoreCount: 10 });
          ...
          describe('@skipInServerless disabling and re-enabling the risk engine', () => {
            beforeEach(async () => {
              await waitForRiskScoresToBePresent({ es, log, scoreCount: 10 });
          ...
          describe('@skipInServerless disabling the risk engine', () => {
            beforeEach(async () => {
              await waitForRiskScoresToBePresent({ es, log, scoreCount: 10 });
            });
      ...
      describe('with some alerts containing hosts and others containing users', () => {
        ...
        it('@skipInServerless calculates and persists risk scores for both types of entities', async () => {
          await riskEngineRoutes.init();
          await waitForRiskScoresToBePresent({ es, log, scoreCount: 20 });
          const riskScores = await readRiskScores(es);

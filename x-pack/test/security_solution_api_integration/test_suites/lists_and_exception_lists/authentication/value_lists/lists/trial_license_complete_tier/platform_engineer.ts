...
export default ({ getService }: FtrProviderContext): void => {
  ...
  describe('@serverless @serverlessQA platform_engineer value lists API behaviors', () => {
    before(async () => {
    ...
    describe('find value list', () => {
      it('should return 200 for platform_engineer', async () => {
        ...
        await platformEngineer.get(`${LIST_URL}/_find`).set('kbn-xsrf', 'true').send().expect(200);
      });
    });
    ...
    describe('update value list', () => {
      it('should return 200 for platform_engineer', async () => {
        ...
        await platformEngineer.put(LIST_URL).set('kbn-xsrf', 'true').send(updatedList).expect(200);
      });
    });
  });
};

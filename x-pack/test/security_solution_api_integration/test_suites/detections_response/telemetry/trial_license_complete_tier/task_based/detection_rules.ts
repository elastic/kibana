...
export default ({ getService }: FtrProviderContext) => {
  ...
  describe('@ess @serverless Detection rule task telemetry', async () => {
    ...
    describe('custom rules should never show any detection_rules telemetry data for each list type', () => {
      it('@skipInServerless should NOT give telemetry/stats for an exception list of type "detection"', async () => {
      ...
      it('@skipInServerless should NOT give telemetry/stats for an exception list of type "endpoint"', async () => {
        const rule = getRuleForAlertTesting(['telemetry'], 'rule-1', false);
      ...
      it('@skipInServerless should NOT give telemetry/stats for an exception list of type "endpoint_trusted_apps"', async () => {
        const rule = getRuleForAlertTesting(['telemetry'], 'rule-1', false);
      ...
      it('@skipInServerless should NOT give telemetry/stats for an exception list of type "endpoint_events"', async () => {
        const rule = getRuleForAlertTesting(['telemetry'], 'rule-1', false);
      ...
      it('@skipInServerless should NOT give telemetry/stats for an exception list of type "endpoint_host_isolation_exceptions"', async () => {
        const rule = getRuleForAlertTesting(['telemetry'], 'rule-1', false);
    ...
    describe('@skipInServerless pre-built/immutable/elastic rules should show detection_rules telemetry data for each list type', () => {
      beforeEach(async () => {
    ...
    describe('@skipInServerless pre-built/immutable/elastic rules should show detection_rules telemetry data for multiple list items and types', () => {
      beforeEach(async () => {
        // install prepackaged rules to get immutable rules for testing
        await installMockPrebuiltRules(supertest, es);
      });

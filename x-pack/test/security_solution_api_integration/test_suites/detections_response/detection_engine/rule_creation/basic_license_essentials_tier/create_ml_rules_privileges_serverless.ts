...
export default ({ getService }: FtrProviderContext) => {
  ...
  describe('@serverless Create ML rule privileges - Serverless env - Essentials tier', () => {
    describe('Creating Machine Learning rules', () => {
      ...
      it('should give a 200 when trying to create a single Machine Learning rule since the license is essentials', async () => {

...
import { getAlertStatus, setAlertAssignees, setAlertStatus, setAlertTags } from '../../../../utils';
...
export default ({ getService }: FtrProviderContext): void => {
  ...
  describe('@serverless @serverlessQA endpoint_policy_manager alerts API behaviors', () => {
    before(async () => {

...
import { createRule, deleteAllRules, getCustomQueryRuleParams, fetchRule } from '../../../utils';
...
export default ({ getService }: FtrProviderContext): void => {
  ...
  describe('@ess @brokenInServerless @skipInQA import_rules with rule overwrite set to "true"', () => {
    beforeEach(async () => {
     ...
     */
    it('ensures overwritten rule DOES NOT preserve missed in the imported rule fields', async () => {
      await createRule(
        supertest,
        log,
        getCustomQueryRuleParams({

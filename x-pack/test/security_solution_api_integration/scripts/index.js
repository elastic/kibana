...
const [, , type, area, domain, subdomain, license, projectType, environment, ...args] =
  process.argv;

const configPath = `./test_suites/${area}/${domain}/${subdomain}/${license}/configs/${projectType}.config.ts`;

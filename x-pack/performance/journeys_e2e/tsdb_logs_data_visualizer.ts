...
export const journey = new Journey({
  kbnArchives: ['test/functional/fixtures/kbn_archiver/kibana_sample_data_logs_logsdb'],
  esArchives: ['test/functional/fixtures/es_archiver/kibana_sample_data_logs_logsdb'],
})

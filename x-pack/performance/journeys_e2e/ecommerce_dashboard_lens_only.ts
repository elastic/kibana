...
export const journey = new Journey({
  ...
  kbnArchives: ['x-pack/performance/kbn_archives/ecommerce_lens_only_dashboard'],
})
  ...
  .step('Go to Ecommerce No Map Dashboard', async ({ page, kibanaPage }) => {
    await page.click(subj('dashboardListingTitleLink-[eCommerce]-Lens-Only'));

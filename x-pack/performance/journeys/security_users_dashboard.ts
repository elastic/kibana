...
export const journey = new Journey({
  ...
  .step('Open Authentications sub-tab', async ({ page }) => {
    await page.click(subj('navigation-authentications'));
    await page.waitForSelector(subj('table-users-authentications-loading-false'));
  })

  .step('Open Anomalies sub-tab', async ({ page }) => {
    await page.click(subj('navigation-anomalies'));
    await page.waitForSelector(subj('user-anomalies-table'));
  })

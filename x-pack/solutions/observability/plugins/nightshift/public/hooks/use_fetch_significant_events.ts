...
import { canShowNightshiftLanding, getNightshiftCapabilities } from '@kbn/nightshift-shared';
...
> => {
  ...
  const canFetchEvents = canShowNightshiftLanding(
    getNightshiftCapabilities(application.capabilities.nightshift)
  );

...
import type { AggregationField, BaseFlameGraph, ESTopNFunctions, ProfilingStatusResponse, StackTraceResponse } from '@kbn/profiling-utils';
export interface ProfilingESClient {
    search<TDocument = unknown, TSearchRequest extends ESSearchRequest = ESSearchRequest>(operationName: string, searchRequest: TSearchRequest): Promise<InferSearchResponseOf<TDocument, TSearchRequest>>;
    ...
    profilingStatus(params?: {
        waitForResourcesCreated?: boolean;
    }): Promise<ProfilingStatusResponse>;

  ...
  () => {
    ...
    test.describe('Install the Elastic Agent step', () => {
      ...
      test.describe('When Auto download config', () => {
        ...
        test('is not selected autoDownloadConfig flag is not added to installation script', async ({
          ...
          await expect(customLogsPage.installCodeSnippet()).not.toContainText(
            'autoDownloadConfig=1'
          );
        });
      });
        ...
        test.describe('updates on steps are shown in the flow', () => {
          ...
          test.describe('Download elastic Agent step', () => {
            test('shows a loading callout when elastic agent is downloading', async ({
              ...
              await expect(
                customLogsPage.stepStatusLoading().getByText('Downloading Elastic Agent')
              ).toBeVisible();
            });
            ...
            test('shows a success callout when elastic agent is downloaded', async ({
              ...
              await expect(
                customLogsPage.stepStatusComplete().getByText('Elastic Agent downloaded')
              ).toBeVisible();
            });
            ...
            test('shows a danger callout when elastic agent was not downloaded', async ({
              ...
              await expect(
                customLogsPage.stepStatusDanger().getByText('Download Elastic Agent')
              ).toBeVisible();
            });
          });
          ...
          test.describe('Extract elastic Agent step', () => {
            ...
            test('shows a loading callout when elastic agent is extracting', async ({
              ...
              await expect(
                customLogsPage.stepStatusLoading().getByText('Extracting Elastic Agent')
              ).toBeVisible();
            });
            ...
            test('shows a success callout when elastic agent is extracted', async ({
              ...
              await expect(
                customLogsPage.stepStatusComplete().getByText('Elastic Agent extracted')
              ).toBeVisible();
            });
            ...
            test('shows a danger callout when elastic agent was not extracted', async ({
              ...
              await expect(
                customLogsPage.stepStatusDanger().getByText('Extract Elastic Agent')
              ).toBeVisible();
            });
          });
          ...
          test.describe('Install elastic Agent step', () => {
            ...
            test('shows a loading callout when elastic agent is installing', async ({
              ...
              await expect(
                customLogsPage.stepStatusLoading().getByText('Installing Elastic Agent')
              ).toBeVisible();
            });
            ...
            test('shows a success callout when elastic agent is installed', async ({
              ...
              await expect(
                customLogsPage.stepStatusComplete().getByText('Elastic Agent installed')
              ).toBeVisible();
            });
            ...
            test('shows a danger callout when elastic agent was not installed', async ({
              ...
              await expect(
                customLogsPage.stepStatusDanger().getByText('Install Elastic Agent')
              ).toBeVisible();
            });
          });
          ...
          test.describe('Check elastic Agent status step', () => {
            ...
            test('shows a loading callout when getting elastic agent status', async ({
              ...
              await expect(
                customLogsPage.stepStatusLoading().getByText('Connecting to the Elastic Agent')
              ).toBeVisible();
            });
            ...
            test('shows a success callout when elastic agent status is healthy', async ({
              ...
              await expect(
                customLogsPage.stepStatusComplete().getByText('Connected to the Elastic Agent')
              ).toBeVisible();
            });
            ...
            test('shows a warning callout when elastic agent status is not healthy', async ({
              ...
              await expect(
                customLogsPage.stepStatusWarning().getByText('Connect to the Elastic Agent')
              ).toBeVisible();
            });
          });
        });
    ...
    test.describe('Configure Elastic Agent step', () => {
      ...
      test.describe('When user select Linux OS', () => {
        ...
        test('shows loading callout when config is being downloaded to the host', async ({
          ...
          await expect(
            customLogsPage.stepStatusLoading().getByText('Downloading Elastic Agent config')
          ).toBeVisible();
        });
        ...
        test('shows success callout when the configuration has been written to the host', async ({
          ...
          await expect(
            customLogsPage
              .stepStatusComplete()
              .getByText('Elastic Agent config written to /opt/Elastic/Agent/elastic-agent.yml')
          ).toBeVisible();
        });
        ...
        test('shows warning callout when the configuration was not written in the host', async ({
          ...
          await expect(
            customLogsPage.stepStatusWarning().getByText('Configure the agent')
          ).toBeVisible();
        });
      });
      ...
      test.describe('When user select Mac OS', () => {
        ...
        test('shows success callout when the configuration has been written to the host', async ({
          ...
          await expect(
            customLogsPage
              .stepStatusComplete()
              .getByText('Elastic Agent config written to /Library/Elastic/Agent/elastic-agent.yml')
          ).toBeVisible();
        });
      ...
      test.describe('When user select Windows', () => {
        ...
        test('step is disabled', async ({ pageObjects: { customLogsPage }, page }) => {
          await expect(
            customLogsPage.configureElasticAgentStep().getByText('Step 2 is disabled')
          ).toBeVisible();
        });
      });
    });
    ...
    test.describe('When logs are being shipped', () => {
      ...
      test('when user clicks on Explore Logs it navigates to observability logs explorer', async ({
        ...
        await expect(
          page
            .locator('[data-test-subj="dataSourceSelectorPopoverButton"]')
            .getByText('[Mylogs] mylogs', { exact: false })
        ).toBeVisible();
      });
    });
  }

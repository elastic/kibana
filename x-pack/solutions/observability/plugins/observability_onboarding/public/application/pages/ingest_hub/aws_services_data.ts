...
const BEDROCK_AGENTCORE = 'https://raw.githubusercontent.com/elastic/integrations/main/packages/aws_bedrock_agentcore/img';
...
export const AWS_SERVICES: AwsService[] = [
  ...
  { id: 'amazon_bedrock_agentcore', name: 'Amazon Bedrock AgentCore', logoUrl: `${BEDROCK_AGENTCORE}/amazon_bedrock_agentcore.svg`, category: 'AI Ops', useCase: 'Monitor AI agent health, memory & tool execution', description: 'Observe agent runtime health, gateway traffic, memory access patterns, and browser or code tool usage in real time.', packageName: 'aws_bedrock', badge: 'Technical preview' },

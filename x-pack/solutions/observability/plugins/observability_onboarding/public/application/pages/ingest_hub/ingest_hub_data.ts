...
export const OBSERVABILITY_INTEGRATIONS: IntegrationTile[] = [
  ...
  { id: 'crowdstrike', name: 'CrowdStrike', description: 'Collect CrowdStrike Falcon endpoint logs and alerts.', logoDomain: 'crowdstrike.com', logoUrl: 'https://companieslogo.com/img/orig/CRWD-442a5e7d.png?t=1720244491' },

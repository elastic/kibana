...
export const ELASTIC_LOGOS = 'https://raw.githubusercontent.com/elastic/integrations/main/packages';
...
export const EXPAND_STACK_TILES: IntegrationTile[] = [
  {
    id: 'nginx',
    name: 'Nginx',
    description: 'Collect Nginx access and error logs and metrics.',
  ...
  },
  {
    id: 'redis',
    name: 'Redis',
    description: 'Monitor Redis performance and memory usage.',
    logoDomain: 'redis.io',
  ...
  },
  {
    id: 'postgresql',
    name: 'PostgreSQL',
    description: 'Track PostgreSQL queries and database health.',
  ...
  },
  {
    id: 'mysql',
    name: 'MySQL',
    description: 'Monitor MySQL server performance and queries.',
  ...
  },
  {
    id: 'rabbitmq',
    name: 'RabbitMQ',
    description: 'Collect RabbitMQ queue and node metrics.',
  ...
  },
  {
    id: 'mongodb',
    name: 'MongoDB',
    description: 'Monitor MongoDB replica sets and performance.',
...
export const OBSERVABILITY_INTEGRATIONS: IntegrationTile[] = [
  ...
  },
  {
    id: 'airflow',
    name: 'Airflow',
    description: 'Monitor Airflow DAGs and tasks.',
    logoDomain: 'airflow.apache.org',
    logoUrl: `${ELASTIC_LOGOS}/airflow/img/logo_airflow.svg`,
  },
  {
    id: 'amazon_bedrock',
    name: 'Amazon Bedrock',
    description: 'Track Bedrock model invocations and metrics.',
    logoDomain: 'aws.amazon.com',
    logoUrl: `${ELASTIC_LOGOS}/aws_bedrock/img/logo_bedrock.svg`,
  },
  {
    id: 'amazon_cloudfront',
    name: 'Amazon CloudFront',
    description: 'Collect CloudFront access logs.',
    logoDomain: 'aws.amazon.com',
    logoUrl: `${ELASTIC_LOGOS}/aws/img/logo_cloudfront.svg`,
  },
  {
    id: 'amazon_data_firehose',
    name: 'Amazon Data Firehose',
    description: 'Stream data from Firehose into Elastic.',
    logoDomain: 'aws.amazon.com',
    logoUrl: `${ELASTIC_LOGOS}/awsfirehose/img/logo_firehose.svg`,
  },
  {
    id: 'amazon_dynamodb',
    name: 'Amazon DynamoDB',
    description: 'Collect DynamoDB table metrics.',
    logoDomain: 'aws.amazon.com',
    logoUrl: `${ELASTIC_LOGOS}/aws/img/logo_dynamodb.svg`,
  },
  {
    id: 'amazon_ebs',
    name: 'Amazon EBS',
    description: 'Monitor EBS volume metrics.',
    logoDomain: 'aws.amazon.com',
    logoUrl: `${ELASTIC_LOGOS}/aws/img/logo_ebs.svg`,
  },
  {
    id: 'amazon_ec2',
    name: 'Amazon EC2',
    description: 'Collect EC2 instance logs and metrics.',
    logoDomain: 'aws.amazon.com',
    logoUrl: `${ELASTIC_LOGOS}/aws/img/logo_ec2.svg`,
  },
  {
    id: 'amazon_ecs',
    name: 'Amazon ECS',
    description: 'Monitor ECS container service metrics.',
    logoDomain: 'aws.amazon.com',
    logoUrl: `${ELASTIC_LOGOS}/aws/img/logo_ecs.svg`,
  },
  {
    id: 'amazon_emr',
    name: 'Amazon EMR',
    description: 'Collect EMR cluster logs and metrics.',
    logoDomain: 'aws.amazon.com',
    logoUrl: `${ELASTIC_LOGOS}/aws/img/logo_emr.svg`,
  },
  {
    id: 'amazon_guardduty',
    name: 'Amazon GuardDuty',
    description: 'Ingest GuardDuty threat findings.',
    logoDomain: 'aws.amazon.com',
  ...
  },
  {
    ...
    description: 'Collect Inspector vulnerability findings.',
    logoDomain: 'aws.amazon.com',
    logoUrl: `${ELASTIC_LOGOS}/aws/img/logo_inspector.svg`,
  },
  {
    id: 'amazon_kinesis',
    name: 'Amazon Kinesis Data Stream',
    description: 'Monitor Kinesis stream metrics.',
    logoDomain: 'aws.amazon.com',
    logoUrl: `${ELASTIC_LOGOS}/aws/img/logo_kinesis.svg`,
  },
  {
    id: 'amazon_msk',
    name: 'Amazon MSK',
    description: 'Collect managed Kafka metrics.',
    logoDomain: 'aws.amazon.com',
    logoUrl: `${ELASTIC_LOGOS}/aws/img/logo_msk.svg`,
  },
  {
    id: 'amazon_mq',
    name: 'Amazon MQ',
    description: 'Monitor Amazon MQ broker metrics.',
    logoDomain: 'aws.amazon.com',
    logoUrl: `${ELASTIC_LOGOS}/aws/img/logo_mq.svg`,
  },
  {
    id: 'amazon_nat_gateway',
    name: 'Amazon NAT Gateway',
    description: 'Track NAT Gateway traffic metrics.',
    logoDomain: 'aws.amazon.com',
    logoUrl: `${ELASTIC_LOGOS}/aws/img/logo_nat_gateway.svg`,
  },
  {
    id: 'amazon_rds',
    name: 'Amazon RDS',
    description: 'Collect RDS database metrics.',
    logoDomain: 'aws.amazon.com',
    logoUrl: `${ELASTIC_LOGOS}/aws/img/logo_rds.svg`,
  },
  {
    id: 'amazon_redshift',
    name: 'Amazon Redshift',
    description: 'Monitor Redshift cluster metrics.',
    logoDomain: 'aws.amazon.com',
    logoUrl: `${ELASTIC_LOGOS}/aws/img/logo_redshift.svg`,
  },
  {
    id: 'amazon_route53',
    name: 'Amazon Route 53',
    description: 'Collect Route 53 DNS logs and metrics.',
    logoDomain: 'aws.amazon.com',
    logoUrl: `${ELASTIC_LOGOS}/aws/img/logo_route53.svg`,
  },
  {
    id: 'amazon_s3',
    name: 'Amazon S3',
    description: 'Monitor S3 bucket metrics and access logs.',
    logoDomain: 'aws.amazon.com',
  ...
  },
  {
    id: 'amazon_sns',
    name: 'Amazon SNS',
    description: 'Collect SNS notification metrics.',
    logoDomain: 'aws.amazon.com',
    logoUrl: `${ELASTIC_LOGOS}/aws/img/logo_sns.svg`,
  },
  {
    id: 'amazon_sqs',
    name: 'Amazon SQS',
    description: 'Monitor SQS queue metrics.',
    logoDomain: 'aws.amazon.com',
    logoUrl: `${ELASTIC_LOGOS}/aws/img/logo_sqs.svg`,
  },
  {
    id: 'amazon_vpc_flow',
    name: 'Amazon VPC Flow Logs',
    description: 'Collect VPC network flow logs.',
    logoDomain: 'aws.amazon.com',
  ...
  },
  {
    id: 'ceph',
    name: 'Ceph',
    description: 'Monitor Ceph storage cluster metrics.',
    logoDomain: 'ceph.io',
    logoUrl: `${ELASTIC_LOGOS}/ceph/img/logo_ceph.svg`,
  },
  {
    id: 'consul',
    name: 'Consul',
    description: 'Collect Consul service mesh metrics.',
    logoDomain: 'consul.io',
    logoUrl: `${ELASTIC_LOGOS}/consul/img/logo_consul.svg`,
  },
  {
    id: 'crowdstrike',
    name: 'CrowdStrike',
    description: 'Collect CrowdStrike Falcon endpoint logs and alerts.',
    logoDomain: 'crowdstrike.com',
    logoUrl: 'https://companieslogo.com/img/orig/CRWD-442a5e7d.png?t=1720244491',
  },
  {
    id: 'docker-int',
    name: 'Docker',
  ...
  },
  {
    id: 'etcd',
    name: 'Etcd',
    description: 'Collect Etcd key-value store metrics.',
    logoDomain: 'etcd.io',
    logoUrl: `${ELASTIC_LOGOS}/etcd/img/logo_etcd.svg`,
  },
  {
    id: 'gcp_pubsub',
  ...
  },
  {
    id: 'kibana-int',
    name: 'Kibana',
    description: 'Monitor Kibana instance health.',
    logoDomain: 'elastic.co',
  ...
  },
  {
    id: 'logstash',
    name: 'Logstash',
    description: 'Track Logstash pipeline metrics.',
    logoDomain: 'elastic.co',
    logoUrl: `${ELASTIC_LOGOS}/logstash/img/logo_logstash.svg`,
  },
  {
    id: 'memcached',
    name: 'Memcached',
    description: 'Collect Memcached cache metrics.',
    logoDomain: 'memcached.org',
    logoUrl: `${ELASTIC_LOGOS}/memcached/img/logo_memcached.svg`,
  },
  {
    id: 'mongodb',
    name: 'MongoDB',
  ...
  },
  {
    id: 'traefik',
    name: 'Traefik',
    description: 'Collect Traefik proxy logs and metrics.',
    logoDomain: 'traefik.io',
    logoUrl: `${ELASTIC_LOGOS}/traefik/img/logo_traefik.svg`,
  },
  {
    id: 'zookeeper',
    name: 'ZooKeeper',
...
export const ASSET_TILES: IntegrationTile[] = [
  ...
  {
    id: 'asset-cloud-discovery',
    name: 'Cloud Discovery',
    description: 'Discover and Create Cloud Assets Discovery.',
    logoDomain: 'elastic.co',
    logoUrl: `${ELASTIC_LOGOS}/cloud_security_posture/img/logo_cloud.svg`,
  },
  {
    id: 'asset-docker-otel',
    name: 'Docker',
    description:
      'Pre-built dashboard for OTel-native metrics of Docker hosts and their running containers.',
    logoDomain: 'docker.com',
    logoUrl: `${ELASTIC_LOGOS}/docker/img/logo_docker.svg`,
  },
  {
    id: 'asset-gcp-audit-otel',
    name: 'GCP Audit Logs',
  ...
  },
  {
    ...
    name: 'Kubernetes',
    description:
      'Pre-built dashboard for OTel-native metrics and events collected from a Kubernetes cluster.',
    logoDomain: 'kubernetes.io',
    logoUrl: `${ELASTIC_LOGOS}/kubernetes/img/logo_kubernetes.svg`,
  },
  {
  ...
  {
    id: 'asset-profiling-otel',
    name: 'Profiling Metrics',
    description: 'Create metrics from profiling data.',
    logoDomain: 'elastic.co',
    logoUrl: `${ELASTIC_LOGOS}/profiler_agent/img/logo_profiling.svg`,
  },
  {
    id: 'asset-rum-otel',
    name: 'RUM',
...
export const CONNECTOR_TILES: IntegrationTile[] = [
  ...
  },
  {
    ...
    logoDomain: 'box.com',
    logoUrl: `${ELASTIC_LOGOS}/box_events/img/logo_box.svg`,
  },
  {
    id: 'conn-confluence',
    name: 'Confluence',
  ...
  },
  {
    ...
    logoUrl: `${ELASTIC_LOGOS}/google_workspace/img/logo_google_workspace.svg`,
  },
  {
    id: 'conn-gcs',
  ...
  },
  {
    ...
    logoDomain: 'microsoft.com',
    logoUrl: `${ELASTIC_LOGOS}/microsoft/img/logo_microsoft.svg`,
  },
  {
    id: 'conn-mongodb',
    name: 'MongoDB',
  ...
  {
    id: 'conn-network-drive',
    name: 'Network Drive',
    description: 'Use a connector to sync from your Network Drive data source.',
    logoDomain: 'elastic.co',
    logoUrl: `${ELASTIC_LOGOS}/network_traffic/img/logo_network.svg`,
  },
  {
    id: 'conn-notion',
    name: 'Notion',
  ...
  },
  {
    ...
    logoUrl: `${ELASTIC_LOGOS}/oracle/img/logo_oracle.svg`,
  },
  {
    id: 'conn-outlook',
    name: 'Outlook',
  ...
  },
  {
    ...
    logoUrl: `${ELASTIC_LOGOS}/servicenow/img/logo_servicenow.svg`,
  },
  {
    id: 'conn-sharepoint-online',
  ...
  },
  {
    ...
    logoDomain: 'zoom.us',
    logoUrl: `${ELASTIC_LOGOS}/zoom/img/logo_zoom.svg`,
  },
];
...
export const API_ENDPOINTS: ApiEndpoint[] = [
  ...
  },
  {
    ...
    sampleSecret:
      'TkxPVF9pbmdlc3Q6VjJWbGMzUmhkR1ZoWTJobGMzTjNiM0prYjIxaGFXNHVZMjl0T2pFMU56azJOVEkxT0RreU5EazFOVGs1TnpVeE16VXpPVFUzTURJeg',
    keyType: 'api_key',
    keyRole: 'write',
  ...
  },
  {
    ...
    sampleSecret:
      'QVBNX2FnZW50X2tleTpabTl2Y21WaGRHbHZibk01T2pReE9UazFPVE16TnpnM09EazROVE0zTlRVMU5UUTNOVFkxTlRreE5UQXdNVEU9',
    keyType: 'api_key',
    keyBehavior: 'reused',
    badge: 'legacy',
    keyTypeLabel: 'Endpoint',
  ...
  },
  {
    ...
    sampleSecret:
      'eyJ2ZXIiOiI4LjE1LjAiLCJhZCI6ImE4ZjIxYzRiLTk3M2UtNGU1Yi1hYmNkLTAxMjM0NTY3ODlhIiwiZnVyZSI6IjIwMjYtMDQtMTEifQ',
  ...
  },
  {
    ...
    sampleSecret:
      'Q2xvdWRfYXBpX2tleTpabTl2Y21WaGRHbHZibk01T2pReE9UazFPVE16TnpnM09EazROVE0zTlRVMU5UUTNOVFkxTlRreE5UQXdNVEU9',
    keyType: 'api_key',
    keyBehavior: 'legacy',
    badge: 'legacy',
    keyTypeLabel: 'Endpoint',
...
export const INSTALLED_INTEGRATIONS = [
  'kubernetes',
  'aws',
  'confluence',
  'salesforce',
    ...
    tiles: [
      {
        id: 'rec-prometheus',
        name: 'Prometheus',
        description: 'Scrape and visualize Prometheus metrics from your K8s cluster.',
        logoDomain: 'prometheus.io',
        logoUrl: `${ELASTIC_LOGOS}/prometheus/img/logo_prometheus.svg`,
      },
      {
        id: 'rec-fluentbit',
        name: 'Fluent Bit',
        description: 'Lightweight log forwarder optimized for Kubernetes.',
        logoDomain: 'fluentbit.io',
        logoUrl: `${LOGO_FALLBACK}/fluentd/fluentd-icon.svg`,
      },
      {
        id: 'rec-otel',
        name: 'OpenTelemetry',
        description: 'Unified telemetry collection for traces, metrics, and logs.',
        logoDomain: 'opentelemetry.io',
        logoUrl: 'https://opentelemetry.io/img/logos/opentelemetry-logo-nav.png',
      },
      {
        id: 'rec-istio',
        name: 'Istio',
        description: 'Monitor service mesh traffic and mTLS across your cluster.',
        logoDomain: 'istio.io',
        logoUrl: `${ELASTIC_LOGOS}/istio/img/logo_istio.svg`,
      },
      {
        id: 'rec-nginx-ingress',
        name: 'Nginx Ingress',
        description: 'Track ingress controller logs and performance.',
        logoDomain: 'nginx.org',
        logoUrl: `${ELASTIC_LOGOS}/nginx_ingress_controller/img/logo_nginx.svg`,
      },
      {
        id: 'rec-etcd',
        name: 'Etcd',
        description: 'Monitor the distributed key-value store backing your cluster.',
        logoDomain: 'etcd.io',
        logoUrl: `${ELASTIC_LOGOS}/etcd/img/logo_etcd.svg`,
      },
    ],
  },
  {
    ...
    tiles: [
      ...
      },
      {
        ...
        description: 'Centralize CloudWatch metrics and alarms.',
        logoDomain: 'aws.amazon.com',
        logoUrl: `${ELASTIC_LOGOS}/aws/img/logo_cloudwatch.svg`,
      },
      {
        id: 'rec-rds',
        name: 'Amazon RDS',
        description: 'Monitor RDS database performance and health.',
        logoDomain: 'aws.amazon.com',
        logoUrl: `${ELASTIC_LOGOS}/aws/img/logo_rds.svg`,
      },
      {
        id: 'rec-lambda',
        name: 'AWS Lambda',
        description: 'Collect invocation metrics and error logs from Lambda functions.',
        logoDomain: 'aws.amazon.com',
        logoUrl: `${ELASTIC_LOGOS}/aws/img/logo_lambda.svg`,
      },
      {
        id: 'rec-s3',
        name: 'Amazon S3',
      ...
      },
      {
        ...
        description: 'Track ALB/NLB request metrics and access logs.',
        logoDomain: 'aws.amazon.com',
        logoUrl: `${ELASTIC_LOGOS}/aws/img/logo_elb.svg`,
      },
    ],
    ...
    tiles: [
      {
        id: 'rec-pagerduty',
        name: 'PagerDuty',
        description: 'Route alerts and manage on-call incidents.',
        logoDomain: 'pagerduty.com',
        logoUrl: `${ELASTIC_LOGOS}/pagerduty/img/logo_pagerduty.svg`,
      },
      {
        id: 'rec-opsgenie',
        name: 'Opsgenie',
        description: 'Centralize alerting and incident management.',
        logoDomain: 'opsgenie.com',
        logoUrl: `${ELASTIC_LOGOS}/opsgenie/img/logo_opsgenie.svg`,
      },
      {
        id: 'rec-github',
        name: 'GitHub',
        description: 'Correlate code changes with incidents and deployments.',
        logoDomain: 'github.com',
        logoUrl: `${ELASTIC_LOGOS}/github/img/logo_github.svg`,
      },
      {
        ...
        description: 'Get observability alerts in your Teams channels.',
        logoDomain: 'microsoft.com',
        logoUrl: `${ELASTIC_LOGOS}/microsoft/img/logo_microsoft.svg`,
      },
    ],
...
export const DATA_MANAGEMENT_NAV_ITEMS = [{ id: 'data-management', label: 'Streams' }];

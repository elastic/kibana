...
import { type PackageDataStreamTypes, type Output } from '@kbn/fleet-plugin/common/types';
...
import { type ElasticAgentStepPayload, type InstalledIntegration, StepProgressPayloadRT } from '../types';

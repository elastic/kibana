...
export const appLabels: Record<DataContextApps, string> = {
  alert: i18n.translate('xpack.observabilityOverview.overview.alertsLabel', {
    defaultMessage: 'Alerts',
  }),
  apm: i18n.translate('xpack.observabilityOverview.overview.apmLabel', {
    defaultMessage: 'APM',
  }),
  infra_logs: i18n.translate('xpack.observabilityOverview.overview.logsLabel', {
    defaultMessage: 'Logs',
  }),
  infra_metrics: i18n.translate('xpack.observabilityOverview.overview.metricsLabel', {
    defaultMessage: 'Metrics',
  }),
  universal_profiling: i18n.translate('xpack.observabilityOverview.overview.profilingLabel', {
    defaultMessage: 'Profiling',
  }),
  uptime: i18n.translate('xpack.observabilityOverview.overview.uptimeLabel', {
    defaultMessage: 'Uptime',
  }),
  ux: i18n.translate('xpack.observabilityOverview.overview.uxLabel', {
    defaultMessage: 'UX',
  }),
};

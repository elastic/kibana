...
const CORE_WEB_VITALS = i18n.translate('xpack.observabilityOverview.ux.coreWebVitals', {
  defaultMessage: 'Core web vitals',
});

const BROWSER_CORE_WEB_VITALS = i18n.translate(
  'xpack.observabilityOverview.ux.coreWebVitals.browser.support',
  {
...
export function WebCoreVitalsTitle({
  ...
  const helpAriaLabel = i18n.translate(
    'xpack.observabilityOverview.ux.dashboard.webCoreVitals.helpAriaLabel',
    { defaultMessage: 'help' }
  );
        ...
        <EuiFlexItem grow={false}>
          <EuiText size="s">
            <EuiLink
              ...
              target="_blank"
            >
              {i18n.translate('xpack.observabilityOverview.ux.dashboard.webCoreVitals.help', {
      ...
      {displayTrafficMetric && totalPageViews > 0 && (
        <EuiFlexItem grow={false}>
          {loading ? (
            ...
            <EuiText size="s">
              <FormattedMessage
                id="xpack.observabilityOverview.ux.dashboard.webCoreVitals.traffic"
              ...
              >
                <div>
                  <EuiText>
                    <FormattedMessage
                      id="xpack.observabilityOverview.ux.dashboard.webCoreVitals.browser.help"

...
import { EuiBasicTable, EuiLoadingChart, useEuiTheme } from '@elastic/eui';
...
export function MetricsSection({ bucketSize }: Props) {
  ...
  const columns: Array<EuiBasicTableColumn<MetricsFetchDataSeries>> = [
    {
      field: 'uptime',
      name: i18n.translate('xpack.observabilityOverview.overview.metrics.colunms.uptime', {
    ...
    {
      field: 'name',
      name: i18n.translate('xpack.observabilityOverview.overview.metrics.colunms.hostname', {
    ...
    {
      field: 'cpu',
      name: i18n.translate('xpack.observabilityOverview.overview.metrics.colunms.cpu', {
        defaultMessage: 'CPU %',
      }),
      sortable: true,
    ...
    {
      field: 'load',
      name: i18n.translate('xpack.observabilityOverview.overview.metrics.colunms.load15', {
  ...
  return (
    <SectionContainer
      title={i18n.translate('xpack.observabilityOverview.overview.metrics.title', {
        defaultMessage: 'Hosts',
      })}
      appLink={{
        href: appLink,
        label: i18n.translate('xpack.observabilityOverview.overview.metrics.appLink', {

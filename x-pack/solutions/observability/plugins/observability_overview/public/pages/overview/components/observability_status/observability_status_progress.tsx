        ...
        <EuiFlexGroup>
          <EuiFlexItem>
            <EuiTitle size="xxs">
              <h2>
                <FormattedMessage
                  id="xpack.observabilityOverview.status.progressBarTitle"
            ...
            <EuiText size="xs" color="subdued">
              <p>
                <FormattedMessage
                  id="xpack.observabilityOverview.status.progressBarDescription"
          ...
          <EuiFlexItem grow={false}>
            <EuiFlexGroup responsive={false} direction="row" alignItems="center">
              <EuiFlexItem>
                ...
                >
                  <FormattedMessage
                    id="xpack.observabilityOverview.status.progressBarDismiss"
              ...
              <EuiFlexItem>
                ...
                >
                  <FormattedMessage
                    id="xpack.observabilityOverview.status.progressBarViewDetails"

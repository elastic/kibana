...
const SERVICE_LABEL = i18n.translate('xpack.observabilityOverview.ux.coreWebVitals.service', {
  defaultMessage: 'Service',
});

const SERVICE_LABEL_HELP = i18n.translate('xpack.observabilityOverview.ux.service.help', {

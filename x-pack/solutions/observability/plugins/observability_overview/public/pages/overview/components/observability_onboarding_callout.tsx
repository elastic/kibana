        ...
        <EuiFlexGroup>
          <EuiFlexItem>
            <EuiTitle size="xxs">
              <h2>
                <FormattedMessage
                  id="xpack.observabilityOverview.overview.observabilityOnboarding"
            ...
            <EuiText size="xs" color="subdued">
              <p>
                <FormattedMessage
                  id="xpack.observabilityOverview.overview.observabilityOnboarding.description"
          ...
          <EuiFlexItem grow={false}>
            <EuiFlexGroup responsive={false} direction="row" alignItems="center">
              <EuiFlexItem>
                ...
                >
                  <FormattedMessage
                    id="xpack.observabilityOverview.overview.observabilityOnboarding.dismiss"
              ...
              <EuiFlexItem>
                ...
                >
                  <FormattedMessage
                    id="xpack.observabilityOverview.overview.observabilityOnboarding.action"

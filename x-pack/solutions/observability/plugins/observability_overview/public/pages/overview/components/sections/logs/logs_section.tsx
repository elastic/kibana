...
import { onBrushEnd } from '../../../../../utils/on_brush_end';
...
export function LogsSection({ bucketSize }: Props) {
  ...
  return (
    <SectionContainer
      title={i18n.translate('xpack.observabilityOverview.overview.logs.title', {
        defaultMessage: 'Log Events',
      })}
      appLink={{
        href: appLink,
        label: i18n.translate('xpack.observabilityOverview.overview.logs.appLink', {
    ...
    >
      <EuiTitle size="xxs">
        <h4>
          {i18n.translate('xpack.observabilityOverview.overview.logs.subtitle', {

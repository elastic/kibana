...
export function OverviewPage() {
  ...
  useBreadcrumbs(
    [
      {
        text: i18n.translate('xpack.observabilityOverview.breadcrumbs.overviewLinkText', {
          ...
          ? [
              {
                title: i18n.translate(
                  'xpack.observabilityOverview.aiAssistant.starterPrompts.explainNoData.title',
                  {
                    defaultMessage: 'Explain',
                  }
                ),
                prompt: i18n.translate(
                  'xpack.observabilityOverview.aiAssistant.starterPrompts.explainNoData.prompt',
                  {
  ...
  return (
    <ObservabilityPageTemplate
      ...
      pageHeader={{
        pageTitle: i18n.translate('xpack.observabilityOverview.overview.pageTitle', {
          defaultMessage: 'Overview',
        }),
    ...
    >
      ...
      {hasAnyData ? (
        ...
        <EuiEmptyPrompt
          ...
          title={
            <h2>
              {i18n.translate('xpack.observabilityOverview.overview.emptyState.title', {
          ...
          body={
            <p>
              {i18n.translate('xpack.observabilityOverview.overview.emptyState.body', {
                defaultMessage:
          ...
          actions={
            <EuiButton
              ...
              href={onboardingHref}
            >
              {i18n.translate('xpack.observabilityOverview.overview.emptyState.action', {

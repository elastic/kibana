...
export function getCoreVitalTooltipMessage(
  ...
  return i18n.translate('xpack.observabilityOverview.ux.dashboard.webVitals.palette.tooltip', {
    defaultMessage:
    ...
    values: {
      ...
      averageMessage: average
        ? i18n.translate('xpack.observabilityOverview.ux.coreVitals.averageMessage', {

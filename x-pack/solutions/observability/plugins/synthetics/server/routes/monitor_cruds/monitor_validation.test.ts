...
import {
  type BrowserAdvancedFields,
  type BrowserFields,
  type BrowserSimpleFields,
  CodeEditorMode,
  type CommonFields,
  ConfigKey,
  MonitorTypeEnum,
  FormMonitorType,
  type HTTPAdvancedFields,
  type HTTPFields,
  type HTTPSimpleFields,
  type ICMPSimpleFields,
  type Metadata,
  type MonitorFields,
  ResponseBodyIndexPolicy,
  ScheduleUnit,
  SourceType,
  type TCPAdvancedFields,
  type TCPFields,
  type TCPSimpleFields,
  type TLSFields,
  TLSVersion,
  VerificationMode,

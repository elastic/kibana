...
export const httpFormatters: HTTPFormatMap = {
  ...
  [ConfigKey.IPV4]: null,
  [ConfigKey.IPV6]: null,
  [ConfigKey.KERBEROS_ENABLED]: null,
  [ConfigKey.KERBEROS_AUTH_TYPE]: stringToJsonFormatter,
  [ConfigKey.KERBEROS_USERNAME]: stringToJsonFormatter,
  [ConfigKey.KERBEROS_PASSWORD]: stringToJsonFormatter,
  [ConfigKey.KERBEROS_KEYTAB]: stringToJsonFormatter,
  [ConfigKey.KERBEROS_CONFIG_PATH]: stringToJsonFormatter,
  [ConfigKey.KERBEROS_REALM]: stringToJsonFormatter,
  [ConfigKey.KERBEROS_SERVICE_NAME]: stringToJsonFormatter,
  [ConfigKey.NTLM_ENABLED]: null,
  [ConfigKey.NTLM_USERNAME]: stringToJsonFormatter,
  [ConfigKey.NTLM_PASSWORD]: stringToJsonFormatter,
  [ConfigKey.NTLM_DOMAIN]: stringToJsonFormatter,
};

...
export const journeySummary = ({
  ...
  synthetics: { journey: { name: 'inline', id: 'inline', tags: null }, type: 'heartbeat/summary' },
  monitor: {
    duration: { us: 2218379 },
    origin: 'ui',
    ...
    timespan: { lt: '2022-12-29T09:04:45.789Z', gte: '2022-12-29T08:54:45.789Z' },
    type: 'browser',
    status: 'up',
  },
  url: {
...
export const journeyStart = ({
  ...
  package: { name: '@elastic/synthetics', version: '1.0.0-beta.38' },
  os: { platform: 'linux' },
  synthetics: {
  ...
  monitor: {
    ...
    check_group: testRunId ?? '6e7ce5d2-8756-11ed-98ca-6a95015d8678',
    id: monitorId ?? '07e339f4-4d56-4cdb-b314-96faacaee645',
    timespan: { lt: '2022-12-29T09:04:42.284Z', gte: '2022-12-29T08:54:42.284Z' },
    type: 'browser',
  },
...
export const step1 = ({ name, timestamp, monitorId, testRunId, location }: DocOverrides = {}) => ({
  ...
  monitor: {
    ...
    timespan: { lt: '2022-12-29T10:05:23.730Z', gte: '2022-12-29T09:55:23.730Z' },
    type: 'browser',
  },
  url: {
    path: '/',
...
export const step2 = ({ name, timestamp, monitorId, testRunId, location }: DocOverrides = {}) => ({
  ...
  monitor: {
    ...
    check_group: testRunId ?? 'e81de0da-875e-11ed-8f2a-7eb894226a99',
    id: monitorId ?? 'c16b1614-7f48-4791-8f46-9ccf3a896e20',
    timespan: { lt: '2022-12-29T10:05:24.550Z', gte: '2022-12-29T09:55:24.550Z' },
    type: 'browser',
  },
  url: {
    path: '/',

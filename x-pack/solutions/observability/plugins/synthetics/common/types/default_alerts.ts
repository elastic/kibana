...
import { type SanitizedRule, type SanitizedRuleAction, type RuleSystemAction } from '@kbn/alerting-plugin/common';
import { type SYNTHETICS_STATUS_RULE, type SYNTHETICS_TLS_RULE } from '../constants/synthetics_alerts';

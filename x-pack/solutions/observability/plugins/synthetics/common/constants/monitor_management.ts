...
export enum ConfigKey {
  ...
  // Kerberos (SPNEGO) authentication for HTTP monitors. Keys mirror the
  // libbeat Kerberos client config consumed by Heartbeat.
  KERBEROS_ENABLED = 'kerberos.enabled',
  KERBEROS_AUTH_TYPE = 'kerberos.auth_type',
  KERBEROS_USERNAME = 'kerberos.username',
  KERBEROS_PASSWORD = 'kerberos.password',
  KERBEROS_KEYTAB = 'kerberos.keytab',
  KERBEROS_CONFIG_PATH = 'kerberos.config_path',
  KERBEROS_REALM = 'kerberos.realm',
  KERBEROS_SERVICE_NAME = 'kerberos.service_name',
  // NTLM authentication for HTTP monitors.
  NTLM_ENABLED = 'ntlm.enabled',
  NTLM_USERNAME = 'ntlm.username',

...
export const buildMonitorScopingFilter = ({
  ...
  // When there are no local enabled monitors the local branch is omitted
  // entirely: CCS-enabled + empty SO list should not surface stale local
  // certs from previously-disabled/deleted monitors.

...
/**
 * POC: Header app actions config for the Service inventory page (apm/services).
 * Single secondary overflow action (•••) with a context menu containing Give feedback,
 * Storage explorer, Alerts (child menu), SLOs (child menu), and Settings.
 * All actions are dumb (noop) for visual parity only.
 */
export function getServiceInventoryHeaderAppActionsConfig(): ChromeHeaderAppActionsConfig {
  return {
    overflowPanels: [
      {
        id: 0,

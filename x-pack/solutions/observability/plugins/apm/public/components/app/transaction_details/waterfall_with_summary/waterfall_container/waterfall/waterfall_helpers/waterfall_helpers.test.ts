...
describe('waterfall_helpers', () => {
  ...
  describe('assignColorsAndGenerateLegends', () => {
    ...
    describe('assignColorsAndGenerateLegends', () => {
      it('should generate legends for multiple services', () => {
        ...
        const { legends, colorBy } = assignColorsAndGenerateLegends(waterfallItems);
      ...
      it('should handle empty input without errors', () => {
        expect(() => assignColorsAndGenerateLegends([])).not.toThrow();
      });
    });
  });
});

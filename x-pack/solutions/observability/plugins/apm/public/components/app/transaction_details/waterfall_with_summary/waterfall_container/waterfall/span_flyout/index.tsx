      ...
      <Summary
        items={[
          ...
          <ContainerWithMarginRight>
            ...
            >
              <EuiBadge color="hollow" tabIndex={0}>{spanTypes.spanType}</EuiBadge>
            </EuiToolTip>
            {spanTypes.spanSubtype && (
              ...
              >
                <EuiBadge color="hollow" tabIndex={0}>{spanTypes.spanSubtype}</EuiBadge>
              </EuiToolTip>
            )}
            {spanTypes.spanAction && (
              ...
              >
                <EuiBadge color="hollow" tabIndex={0}>{spanTypes.spanAction}</EuiBadge>
              </EuiToolTip>
            )}

  ...
  return (
    <EuiToolTip
      ...
      content={i18n.translate('xpack.apm.transactionDetails.agentMissingTransactionMessage', {
        defaultMessage:
          'This trace is incomplete, and {itemsCount} items could not be displayed in the timeline. This could be a temporary issue caused by an ingest delay, or a permanent issue caused by some events being dropped or a broken parent–child span relationship.',

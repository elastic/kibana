...
In most cases we should use [`cy.visitKibana`](https://github.com/elastic/kibana/blob/main/x-pack/solutions/observability/plugins/apm/ftr_e2e/cypress/support/commands.ts#L96-L108) instead of `cy.visit`.

...
export const serviceMapCustomStateSchema = lazySchema(() =>
  z
    .object({
      ...
      alert_status_filter: z
        ...
        .optional(),
      slo_status_filter: z
        .array(z.enum(SLO_STATUS_VALUES))
        .max(SLO_STATUS_VALUES.length)
        .optional(),
      connection_filter: z
        .array(z.enum(CONNECTION_VALUES))
        .max(CONNECTION_VALUES.length)
        .optional(),

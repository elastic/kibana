...
export declare const getTransformOut: (transformDrilldownsOut: DrilldownTransforms["transformOut"]) => (storedState: OverviewEmbeddableState, panelReferences?: Reference[]) => import("@kbn/config-schema/src/types").ObjectResultUnionType<{

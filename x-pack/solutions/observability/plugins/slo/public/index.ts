 ...
 */
export const services = declare<SLOPublicStart>(({ provide }) => {
  provide(SloCreateFlyoutToken, (start) => start.getCreateSLOFormFlyout);
  provide(SloDetailsFlyoutToken, (start) => start.getSLODetailsFlyout);
});

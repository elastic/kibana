...
import { type DefaultClientOptions, type RouteRepositoryClient } from '@kbn/server-route-repository-client';
...
import { type SecurityPluginSetup, type SecurityPluginStart } from '@kbn/security-plugin-types-public';

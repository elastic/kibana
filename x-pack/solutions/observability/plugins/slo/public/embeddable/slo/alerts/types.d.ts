...
import type { PublishesWritableTitle, PublishesTitle, HasEditCapabilities } from '@kbn/presentation-publishing';
...
import type { AlertsCustomState, AlertsEmbeddableState } from '../../../../common/embeddables/alerts/types';
/** Re-exported from common (derived from server schema) */
export type { AlertsCustomState, AlertsEmbeddableState, SloItem, } from '../../../../common/embeddables/alerts/types';
export type SloAlertsEmbeddableState = AlertsEmbeddableState;
export type SloAlertsApi = DefaultEmbeddableApi<AlertsEmbeddableState> & PublishesWritableTitle & PublishesTitle & HasDrilldowns & HasSupportedTriggers & HasSloAlertsConfig & HasEditCapabilities;

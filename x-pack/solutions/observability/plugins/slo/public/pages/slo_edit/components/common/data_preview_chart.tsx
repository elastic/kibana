    ...
    return (
      <EuiFlexItem>
        ...
        <EuiFormRow fullWidth>
          <EuiPanel hasBorder={true} hasShadow={false} css={{ minHeight: 194 }}>
            <EuiFlexGroup justifyContent="center" alignItems="center" css={{ minHeight: 160 }}>
  ...
  return (
    <EuiFlexItem>
      ...
      <EuiFormRow fullWidth>
        <EuiPanel hasBorder={true} hasShadow={false} css={{ minHeight: 194 }}>
          {(isLoading || isError) && (
            <EuiFlexGroup justifyContent="center" alignItems="center" css={{ height: 160 }}>
              <EuiFlexItem grow={false}>

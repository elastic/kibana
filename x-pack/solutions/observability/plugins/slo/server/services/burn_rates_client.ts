...
import {
  ...
  type AggregationsDateRangeAggregate,
  type AggregationsSumAggregate,
  type AggregationsValueCountAggregate,
...
import { type DateRange, type Duration, type SLODefinition } from '../domain/models';

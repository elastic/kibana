export declare const findSLORoute: Record<"GET /api/observability/slos 2023-10-31", import("@kbn/server-route-repository-utils").ServerRoute<"GET /api/observability/slos 2023-10-31", import("io-ts").PartialC<{

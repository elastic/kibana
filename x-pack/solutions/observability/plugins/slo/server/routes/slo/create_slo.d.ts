export declare const createSLORoute: Record<"POST /api/observability/slos 2023-10-31", import("@kbn/server-route-repository-utils").ServerRoute<"POST /api/observability/slos 2023-10-31", import("io-ts").TypeC<{

export declare const resetSLORoute: Record<"POST /api/observability/slos/{id}/_reset 2023-10-31", import("@kbn/server-route-repository-utils").ServerRoute<"POST /api/observability/slos/{id}/_reset 2023-10-31", import("io-ts").TypeC<{

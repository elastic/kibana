...
import type { CoreSetup, IScopedClusterClient, KibanaRequest, Logger, SavedObjectsClientContract } from '@kbn/core/server';
...
export type GetScopedClients = ({ request, logger, }: {

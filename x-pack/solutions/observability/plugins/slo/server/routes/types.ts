 ...
 * 2.0.
 */
import { type CoreSetup, type CustomRequestHandlerContext } from '@kbn/core/server';
import type { DefaultRouteHandlerResources } from '@kbn/server-route-repository';
import { type SLOPluginSetupDependencies, type SLOPluginStartDependencies } from '../types';

  ...
  [searchExcludedDataTiers]: {
    ...
    description: i18n.translate(
      'xpack.observability.advancedSettings.searchExcludedDataTiersDesc',
      {
        ...
        When configured, indices allocated in the selected tiers will be ignored from search requests. Affected apps: APM, Logs, Infrastructure, Profiling, Synthetics, Uptime, UX`,
      }
    ),
    value: [],

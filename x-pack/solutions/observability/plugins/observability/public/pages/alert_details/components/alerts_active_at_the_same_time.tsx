...
export function AlertsActiveAtSameTime({ alert }: AlertInsightProps) {
  ...
  return (
    <EuiPanel hasShadow={false} hasBorder={true} color="accent">
      <EuiTitle size="xs">
        <h5>
          {i18n.translate('xpack.observability.alertsActiveAtSameTime.h5.activeAtTheSameLabel', {
            defaultMessage: 'Active at the same time',
          })}
        </h5>
      </EuiTitle>
      <EuiSpacer size="s" />

...
export declare enum TelemetryEventTypes {
...
export type TelemetryEvent = AlertDetailsPageViewEvent | RelatedAlertsLoadedEvent | AlertAddedToCaseEvent | LinkedDashboardViewEvent | SuggestedDashboardAddedEvent;
export type TelemetryEventParams = RelatedAlertsLoadedParams | AlertDetailsPageViewParams | AlertAddedToCaseParams | LinkedDashboardViewParams | SuggestedDashboardAddedParams;
export {};

...
import { EuiIcon, euiPaletteColorBlind, type EuiThemeComputed, useEuiTheme } from '@elastic/eui';
import { type QuerySuggestion, QuerySuggestionTypes } from '@kbn/unified-search-plugin/public';

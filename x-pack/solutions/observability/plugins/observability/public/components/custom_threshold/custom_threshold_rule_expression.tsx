...
import { useFetchAlertsRuntimeFieldsQuery } from '@kbn/alerts-ui-shared/src/common/hooks/use_fetch_alerts_runtime_fields_query';
...
export default function Expressions(props: Props) {
  ...
  const fieldsQuery = useFetchAlertsRuntimeFieldsQuery(
    {
      http,

...
import { type ISearchSource, type Query } from '@kbn/data-plugin/common';
...
import { type AlertContextMeta, type AlertParams, type MetricExpression } from './types';
import { ExpressionRow } from './components/expression_row';
import { type MetricsExplorerFields, GroupBy } from './components/group_by';

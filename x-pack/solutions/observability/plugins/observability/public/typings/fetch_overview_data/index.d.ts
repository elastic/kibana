...
export type FetchData<T extends FetchDataResponse = FetchDataResponse> = (fetchDataParams: FetchDataParams) => Promise<T>;
export type HasData<T extends ObservabilityFetchDataPlugins> = (params?: HasDataParams) => Promise<ObservabilityHasDataResponse[T]>;
export type ObservabilityFetchDataPlugins = Exclude<ObservabilityApp, 'observability-overview' | 'fleet' | 'synthetics'>;
export interface DataHandler<T extends ObservabilityFetchDataPlugins = ObservabilityFetchDataPlugins> {

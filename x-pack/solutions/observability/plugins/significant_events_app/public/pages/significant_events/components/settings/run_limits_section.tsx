      ...
      <EuiPanel hasBorder hasShadow={false} paddingSize="none" grow={false}>
        ...
        <EuiPanel hasShadow={false}>
          ...
          {quotas.isError && (
            ...
            >
              <EuiButton
                data-test-subj="significantEventsAppRunLimitsSectionRetryButton"
                size="s"
              ...
              {saveError && (
                <>
                  ...
                  >
                    ...
                    <EuiButton
                      data-test-subj="significantEventsAppRunLimitsSectionTryAgainButton"
                      color="danger"
                      size="s"
                      onClick={handleSave}
                    >
              ...
              {isDirty && (
                <>
                  ...
                  <EuiFlexGroup justifyContent="flexEnd" gutterSize="s">
                    <EuiFlexItem grow={false}>
                      <EuiButtonEmpty
                        data-test-subj="significantEventsAppRunLimitsSectionCancelButton"
                        onClick={() => {
                          setDraftState(createRunQuotaDraftState(response));
                          setSaveError(undefined);
                        }}

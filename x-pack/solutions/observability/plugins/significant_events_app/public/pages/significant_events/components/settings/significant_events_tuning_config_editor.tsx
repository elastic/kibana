...
export function configToAnnotatedYaml(config: SignificantEventsTuningConfig): string {
  return [
    ...
    '',
    '# Deadline (ms) per ES|QL sampling query, not additive across arms (1000-240000)',
    `sampling_timeout_ms: ${config.sampling_timeout_ms}`,
    '',
        ...
        <>
          ...
          <EuiCallOut
            ...
            title={i18n.translate(
              'xpack.significantEventsApp.settings.significantEventsTuningConfig.validationErrors',
              {

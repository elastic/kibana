...
export declare const metricsExplorerAggregationRT: rt.KeyofC<Record<"avg" | "cardinality" | "max" | "min" | "rate" | "sum" | "count" | "custom" | "p99" | "p95", null>>;
...
export declare const metricsExplorerMetricRequiredFieldsRT: rt.TypeC<{
    aggregation: rt.KeyofC<Record<"avg" | "cardinality" | "max" | "min" | "rate" | "sum" | "count" | "custom" | "p99" | "p95", null>>;
}>;

 ...
 */
export declare const useTrackedPromise: <Arguments extends any[], Result>({ createPromise, onResolve, onReject, cancelPreviousOn, triggerOrThrow, }: UseTrackedPromiseArgs<Arguments, Result>, dependencies: DependencyList) => [PromiseState<Result, unknown>, (...args: Arguments) => Promise<Result>, () => void];
...
export declare const isRejectedPromiseState: (promiseState: PromiseState<any, any>) => promiseState is RejectedPromiseState<any, any>;

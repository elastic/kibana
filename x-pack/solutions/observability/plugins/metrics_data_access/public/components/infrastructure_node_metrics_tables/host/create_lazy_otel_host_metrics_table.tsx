...
const LazyIntegratedHostMetricsTable = lazy(() => import('./integrated_otel_host_metrics_table'));

export function createLazyHostOtelMetricsTable(core: CoreStart, metricsClient: MetricsDataClient) {

...
import type { LastValueIndexPatternColumn, DateHistogramIndexPatternColumn, FieldBasedIndexPatternColumn, SeriesType, OperationType, YConfig, MetricState } from '@kbn/lens-plugin/public';
import type { PersistableFilter } from '@kbn/lens-plugin/common';
import type { DataView } from '@kbn/data-views-plugin/common';
import type { FieldFormatParams as BaseFieldFormatParams, SerializedFieldFormat } from '@kbn/field-formats-plugin/common';
import type { TermsIndexPatternColumn } from '@kbn/lens-plugin/public';
import type { FORMULA_COLUMN } from './configurations/constants';
export declare const ReportViewTypes: {
    readonly dist: "data-distribution";
    readonly kpi: "kpi-over-time";
    readonly cwv: "core-web-vitals";
    readonly mdd: "device-data-distribution";
    readonly smt: "single-metric";
    readonly htm: "heatmap";
};
...
export interface MetricOption {
    ...
    label: string;
    description?: string;
    columnType?: 'range' | 'operation' | 'FILTER_RECORDS' | 'TERMS_COLUMN' | 'unique_count' | typeof FORMULA_COLUMN;
...
export interface SeriesConfig {
    ...
    metricOptions?: Array<MetricOption | {
        id: string;
        field?: string;
        label: string;
        items: MetricOption[];
...
export type AppDataType = 'synthetics' | 'uptime' | 'ux' | 'infra_logs' | 'infra_metrics' | 'apm' | 'mobile' | 'alerts';

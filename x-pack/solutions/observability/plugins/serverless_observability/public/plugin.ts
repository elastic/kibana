...
import {
  type ServerlessObservabilityPublicSetup,
  type ServerlessObservabilityPublicStart,
  type ServerlessObservabilityPublicSetupDependencies,
  type ServerlessObservabilityPublicStartDependencies,
} from './types';

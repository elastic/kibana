...
From `~/x-pack/solutions/observability/solutions/observability/plugins/observability_solution/synthetics/scripts`, run `node e2e.js --server`. Wait for the server to startup. It will provide you
...
From `~/x-pack/solutions/observability/solutions/observability/plugins/observability_solution/synthetics/scripts`, run `node uptime_e2e.js --server`. Wait for the server to startup. It will provide you
with an example run command when it finishes.

...
export class Plugin implements InfraClientPluginClass {
  ...
  setup(core: InfraClientCoreSetup, pluginsSetup: InfraClientSetupDeps) {
    ...
    /** !! Need to be kept in sync with the deepLinks in x-pack/solutions/observability/solutions/observability/plugins/observability_solution/infra/public/plugin.ts */
    ...
    // !! Need to be kept in sync with the routes in x-pack/solutions/observability/solutions/observability/plugins/observability_solution/infra/public/pages/metrics/index.tsx

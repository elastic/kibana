...
```
yarn jest --config x-pack/solutions/observability/solutions/observability/plugins/observability_solution/dataset_quality/jest.config.js
```

You can also run a specific test by passing the filepath as an argument, e.g.:

```
yarn jest --config x-pack/solutions/observability/solutions/observability/plugins/observability_solution/dataset_quality/jest.config.js x-pack/solutions/observability/solutions/observability/plugins/observability_solution/dataset_quality/server/routes/data_streams/get_data_streams/get_data_streams.test.ts
```
...
```
node x-pack/solutions/observability/solutions/observability/plugins/observability_solution/dataset_quality/scripts/api [--help]
```
...
```sh
# start server
node x-pack/solutions/observability/solutions/observability/plugins/observability_solution/dataset_quality/scripts/api --server

# run tests
node x-pack/solutions/observability/solutions/observability/plugins/observability_solution/dataset_quality/scripts/api --runner --grep-files=data_stream_settings.spec.ts
```

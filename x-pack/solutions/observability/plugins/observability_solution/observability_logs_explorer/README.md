...
#### Logs Explorer
```
node scripts/type_check.js --project x-pack/solutions/observability/solutions/observability/plugins/observability_solution/logs_explorer/tsconfig.json
```
#### Observability Logs Explorer
```
node scripts/type_check.js --project x-pack/solutions/observability/solutions/observability/plugins/observability_solution/observability_logs_explorer/tsconfig.json
```

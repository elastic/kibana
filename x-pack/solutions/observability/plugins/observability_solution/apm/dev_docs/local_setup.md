...
```sh
node x-pack/solutions/observability/solutions/observability/plugins/observability_solution/apm/scripts/create_apm_users.js --username admin --password changeme --kibana-url http://localhost:5601
```

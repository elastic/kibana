...
```
node x-pack/solutions/observability/solutions/observability/plugins/observability_solution/apm/scripts/test/jest [--watch] [--updateSnapshot]
```
...
```
node x-pack/solutions/observability/solutions/observability/plugins/observability_solution/apm/scripts/test/api [--trial/--basic] [--help]
```
...
# start server
node x-pack/solutions/observability/solutions/observability/plugins/observability_solution/apm/scripts/test/api --server --basic

# run tests
node x-pack/solutions/observability/solutions/observability/plugins/observability_solution/apm/scripts/test/api --runner --basic --grep-files=error_group_list
```
...
```
node x-pack/solutions/observability/solutions/observability/plugins/observability_solution/apm/scripts/test/api --runner --basic --updateSnapshots
```
...
```
node x-pack/solutions/observability/solutions/observability/plugins/observability_solution/apm/scripts/test/dat [--serverless/--stateful] [--help]
```
...
# start server
node x-pack/solutions/observability/solutions/observability/plugins/observability_solution/apm/scripts/test/dat --server --stateful

# run tests
node x-pack/solutions/observability/solutions/observability/plugins/observability_solution/apm/scripts/test/dat --runner --stateful --grep-files=error_group_list
```
...
```
node x-pack/solutions/observability/solutions/observability/plugins/observability_solution/apm/scripts/test/dat --runner --stateful --updateSnapshots
```
...
The E2E tests are located in [`x-pack/solutions/observability/solutions/observability/plugins/observability_solution/apm/ftr_e2e`](../ftr_e2e).
...
```
node x-pack/solutions/observability/solutions/observability/plugins/observability_solution/apm/scripts/test/e2e --server
```

#### Run tests

```
node x-pack/solutions/observability/solutions/observability/plugins/observability_solution/apm/scripts/test/e2e --runner --open
```

### Run tests multiple times to check for flakiness

```
node x-pack/solutions/observability/solutions/observability/plugins/observability_solution/apm/scripts/test/e2e --runner --times <NUMBER> [--spec <FILE_NAME>]
```
...
diff --git a/x-pack/solutions/observability/solutions/observability/plugins/observability_solution/apm/scripts/test/README.md b/x-pack/solutions/observability/solutions/observability/plugins/observability_solution/apm/scripts/test/README.md

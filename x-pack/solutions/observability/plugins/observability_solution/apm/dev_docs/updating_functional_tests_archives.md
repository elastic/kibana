...
Usage:
`node x-pack/solutions/observability/solutions/observability/plugins/observability_solution/apm/scripts/create_functional_tests_archive --es-url=https://admin:changeme@localhost:9200 --kibana-url=https://localhost:5601`

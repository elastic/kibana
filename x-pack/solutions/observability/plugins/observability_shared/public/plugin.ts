...
interface ObservabilitySharedLocators {
  infra: {
    ...
    infraDashboardLocator: InfraDashboardLocator;
  };
  profiling: {
  ...
  private createLocators(urlService: BrowserUrlService): ObservabilitySharedLocators {
    return {
      infra: {
        ...
        infraDashboardLocator: urlService.locators.create(new InfraDashboardLocatorDefinition()),
      },
      profiling: {

 ...
 * filesystem, network). Mirrors the UI Scout fixture under
 * `test/scout/ui/fixtures/synthtrace/semconv_host_data.ts` but is
 * parameterized for reuse across the infra API suites.
 */

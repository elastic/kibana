...
export declare const INVENTORY_VIEW_URL = "/api/infra/inventory_views";
export declare const INVENTORY_VIEW_URL_ENTITY = "/api/infra/inventory_views/{inventoryViewId}";
export declare const getInventoryViewUrl: (inventoryViewId?: string) => string;
export declare const inventoryViewRequestParamsRT: rt.TypeC<{
    inventoryViewId: rt.Type<string, string, unknown>;
}>;
export declare const inventoryViewRequestQueryRT: rt.PartialC<{
    sourceId: rt.StringC;
}>;
export declare const inventoryViewResponsePayloadRT: rt.TypeC<{

...
export declare const METRIC_EXPLORER_AGGREGATIONS: readonly ["avg", "max", "min", "cardinality", "rate", "count", "sum", "p95", "p99", "custom", "last_value"];
export declare const OMITTED_AGGREGATIONS_FOR_CUSTOM_METRICS: string[];
export declare const metricsExplorerAggregationRT: rt.KeyofC<Record<"avg" | "cardinality" | "max" | "min" | "rate" | "sum" | "count" | "custom" | "p99" | "p95" | "last_value", null>>;
...
export declare const metricsExplorerRequestBodyOptionalFieldsRT: rt.PartialC<{
    ...
    filterQuery: rt.UnionC<[rt.StringC, rt.NullC, rt.UndefinedC]>;

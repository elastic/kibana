...
- [`PROPOSALS.md`](./PROPOSALS.md) — the full design doc: every proposal we considered, the empirical measurements behind it, what shipped vs what got dropped, and the rationale. The headline tables are at the bottom (deploy bench at 5000 hosts × 3 h and local bench at 1500 hosts × 24 h) — the rest is the reasoning trail.

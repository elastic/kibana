...
export const Expressions: React.FC<Props> = (props) => {
  ...
  const preFillAlertFilter = useCallback(() => {
    ...
    if (md && md.filter) {
      ...
      setRuleParams('filterQuery', convertKueryToElasticSearchQuery(md.filter, dataView) || '');
    }
  ...
  }, [metadata, dataView, defaultExpression]); // eslint-disable-line react-hooks/exhaustive-deps

...
/** Fetches whether any metrics exist so Inventory can keep AppHeader mounted on onboarding. */
export const useInventoryHasData = (): { hasData: boolean; loading: boolean } => {

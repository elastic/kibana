...
type InputAttributesOf<MigrationFn> =
  MigrationFn extends SavedObjectMigrationFn<infer InputAttributes, any> ? InputAttributes : never;
type MigratedAttributesOf<MigrationFn> =
  MigrationFn extends SavedObjectMigrationFn<any, infer MigratedAttributes>
    ? MigratedAttributes
    : never;

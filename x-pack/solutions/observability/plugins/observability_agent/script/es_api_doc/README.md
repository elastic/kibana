...
- An **OpenAPI JSON** file describing Elasticsearch endpoints  
   (default path:  
   `x-pack/solutions/observability/plugins/observability_agent/script/es_api_doc/elasticsearch_openapi_source.json`)
...
```bash
npx ts-node x-pack/solutions/observability/plugins/observability_agent/script/es_api_doc/generate_docs.ts
```
...
```bash
npx ts-node x-pack/solutions/observability/plugins/observability_agent/script/es_api_doc/ingest_docs.ts
```

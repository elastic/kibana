...
import { createInvestigationSkill } from './investigation';
import { createSignificantEventRemediationSkill } from './significant_event_remediation';
...
export const registerSkills = ({
  ...
  plugins.agentBuilder.skills.register(createSignificantEventRemediationSkill());

...
import {
  createGetApplicationMetricsTool,
  OBSERVABILITY_GET_APPLICATION_METRICS_TOOL_ID,
} from './get_application_metrics/tool';
import {
...
export async function registerTools({
  ...
  const observabilityTools: StaticToolRegistration<any>[] = [
    ...
    createGetApplicationMetricsTool({ core, dataRegistry, logger }),

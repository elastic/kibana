...
subgraph Kibana
  ...
  click BulkUploader "https://github.com/elastic/kibana/blob/main/x-pack/solutions/observability/plugins/monitoring/server/kibana_monitoring/bulk_uploader.ts"
end 

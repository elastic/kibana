...
Rules should have a `fetchData` setup [like this one](/x-pack/solutions/observability/plugins/monitoring/server/alerts/nodes_changed_rule.ts#L96). Tracing down will get you to `fetchNodesFromClusterStats`.

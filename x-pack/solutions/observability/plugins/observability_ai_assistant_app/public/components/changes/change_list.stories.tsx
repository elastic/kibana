...
import type { ChangeListProps } from './change_list';
import { ChangeList as Component, ChangeListItemImpact } from './change_list';
...
const Template: StoryFn<typeof Component> = (props: ChangeListProps) => (
  <div style={{ width: 480 }}>
    <Component {...props} />
  </div>
);

export const ChangeListMetrics = {
  render: Template,

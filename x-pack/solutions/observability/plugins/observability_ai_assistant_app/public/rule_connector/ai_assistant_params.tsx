...
import {
  ACTION_UNAVAILABLE_IN_AGENT_MODE,
  MESSAGE_REQUIRED,
  STATUS_REQUIRED,
} from './translations';
...
> = ({ errors, index, messageVariables, editAction, actionParams, isDisabled }) => {
  ...
  return (
    <EuiToolTip
      ...
      content={isDisabled ? ACTION_UNAVAILABLE_IN_AGENT_MODE : undefined}
    >
      <>
        <EuiFormRow
          fullWidth
          label={i18n.translate(
            'xpack.observabilityAiAssistant.alertConnector.selectLlmConnector',
            {

...
describe('Retrieve documentation function', () => {
  ...
  it('retrieves Elasticsearch documentation', async () => {
    ...
    const result = await chatClient.evaluate(conversation, [
      `The Elasticsearch documentation is available in tool call response for "context"`,
  ...
  it('retrieves Kibana documentation', async () => {
    ...
    const result = await chatClient.evaluate(conversation, [
      `The Kibana documentation is available in tool call response for "context"`,
  ...
  it('retrieves Observability documentation', async () => {
    ...
    const result = await chatClient.evaluate(conversation, [
      `The APM documentation is available in tool call response for "context"`,

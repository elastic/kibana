...
export default function ({ getService }: DeploymentAgnosticFtrProviderContext) {
  describe('inspectSyntheticsMonitor', function () {
    ...
    describe('inspects monitors in public locations', function () {
      this.tags(['skipCloud']);
                    ...
                    streams: [
                      {
                        ...
                        fields: {
                          ...
                          'monitor.project.name':
                            'test-project-cb47c83a-45e7-416a-9301-cb476b5bff01',
    ...
    describe('inspect http monitor in private location', () => {

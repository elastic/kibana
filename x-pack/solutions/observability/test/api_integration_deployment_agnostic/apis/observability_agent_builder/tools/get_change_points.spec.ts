...
export default function ({ getService }: DeploymentAgnosticFtrProviderContext) {
  ...
  describe('Change Points Tools', function () {
    ...
    describe.skip(`tool: ${OBSERVABILITY_GET_LOG_CHANGE_POINTS_TOOL_ID}`, () => {
      describe('when retrieving log change points', () => {
        ...
        before(async () => {
          const toolResults: ToolResult[] = await agentBuilderApiClient.executeTool({
            ...
            params: {
              start: CHANGE_POINTS_ANALYSIS_WINDOW.start,
              end: CHANGE_POINTS_ANALYSIS_WINDOW.end,
              logs: [
                {
    ...
    describe(`tool: ${OBSERVABILITY_GET_METRIC_CHANGE_POINTS_TOOL_ID}`, () => {

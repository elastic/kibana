...
export default ({ getPageObject, getService }: FtrProviderContext) => {
  ...
  describe('ES Query rule - consumers', function () {
    ...
    describe('both logs and infrastructure privileges', () => {
      ...
      createESQueryRule({ ruleName, consumersToVerify: new Set(['All', 'Logs', 'Metrics']) });
    ...
    describe('only logs privileges', () => {
      ...
      createESQueryRule({ ruleName, consumersToVerify: new Set(['All', 'Logs']) });
    ...
    describe('only infrastructure privileges', () => {
      ...
      createESQueryRule({ ruleName, consumersToVerify: new Set(['All', 'Metrics']) });

...
import type { GroupingProps, GroupOption, GroupPanelRenderer, GetGroupStats, NamedAggregation } from '@kbn/grouping/src';
...
export interface AlertsGroupingProps<T extends BaseAlertsGroupAggregations = BaseAlertsGroupAggregations> {
    /**

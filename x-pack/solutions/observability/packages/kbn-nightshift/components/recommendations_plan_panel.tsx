...
export function RecommendationsPlanPanel({
  ...
  const escalateLabel =
    escalateBadgeLabel ??
    i18n.translate('xpack.nightshift.sigeventsOverview.recommendationsPlan.escalateBadge', {
      defaultMessage: 'Escalate',
    });

  const openDetailsLabel = i18n.translate(
    'xpack.nightshift.sigeventsOverview.recommendationsPlan.openDetails',
    { defaultMessage: 'Open details' }
  );

  const closeDetailsLabel = i18n.translate(
    'xpack.nightshift.sigeventsOverview.recommendationsPlan.closeDetails',
    { defaultMessage: 'Close details' }
  );

  const remediateLabel = i18n.translate(
    'xpack.nightshift.sigeventsOverview.recommendationsPlan.remediateWithAgentBuilder',
    { defaultMessage: 'Remediate with Agent Builder' }
  );

  const stepMoreActionsAria = i18n.translate(
    'xpack.nightshift.sigeventsOverview.recommendationsPlan.stepMoreActionsAria',
    ...
    <EuiPanel hasBorder css={panelCss} data-test-subj="sigeventsOverviewRecommendationsPlanPanel">
      <div css={headerStripCss}>
            ...
            <EuiFlexGroup alignItems="center" gutterSize="s" responsive={false}>
              <EuiFlexItem grow={false}>
                <EuiText size="s" css={titleCss}>
                  {i18n.translate('xpack.nightshift.sigeventsOverview.recommendationsPlan.title', {
        ...
        <EuiText size="s">
          ...
          >
            <FormattedMessage
              id="xpack.nightshift.sigeventsOverview.recommendationsPlan.summary"
              defaultMessage="We recommend a {stepPlan} to understand what the remediation of this might be."
              values={{
                stepPlan: (
                  <strong>
                    <FormattedMessage
                      id="xpack.nightshift.sigeventsOverview.recommendationsPlan.summaryStepPlan"

...
import type { HealthyMetricCardItem } from './nightshift_overview';
import {
...
const meta: Meta<typeof NightshiftOverview> = {
  title: 'app/Nightshift/NightshiftOverview',
  component: NightshiftOverview,
...
export default meta;
type Story = StoryObj<typeof NightshiftOverview>;

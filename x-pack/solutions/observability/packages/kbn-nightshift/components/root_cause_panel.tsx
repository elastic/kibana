...
const DEFAULT_TITLE = i18n.translate('xpack.nightshift.sigeventsOverview.rootCausePanel.title', {
...
function DefaultDescription() {
  ...
  return (
    <p>
      ...
      <span css={codeCss}>
        {i18n.translate('xpack.nightshift.defaultDescription.span.placeorderLabel', {
          defaultMessage: 'placeOrder',
        })}
      </span>{' '}
      <span css={codeCss}>
        {i18n.translate('xpack.nightshift.defaultDescription.span.grpcLabel', {
          defaultMessage: 'gRPC',
        })}
      </span>
      {' call fails with '}
      <span css={codeCss}>
        {i18n.translate('xpack.nightshift.defaultDescription.span.econnrefusedLabel', {
          defaultMessage: 'ECONNREFUSED',
        })}
      </span>
      {' to '}
      <span css={codeCss}>
        {i18n.translate('xpack.nightshift.defaultDescription.span.Label', {
      ...
      <span css={codeCss}>
        {i18n.translate('xpack.nightshift.defaultDescription.span.grpcCodeLabel', {
          defaultMessage: 'gRPC code 13',
        })}
      </span>
      {' INTERNAL with connection refused errors originating from the frontend pod ('}
      <span css={codeCss}>
        {i18n.translate('xpack.nightshift.defaultDescription.span.frontendbcdgztbLabel', {

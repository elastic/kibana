...
<<<<<<<< HEAD:x-pack/solutions/observability/packages/kbn-evals-suite-observability-ai/evals/agent/investigation/payment_unreachable.spec.ts
...
import { GCS_BUCKET } from '../../src/scenarios/constants';
import { evaluate } from './evaluate';
>>>>>>>> 9.4:x-pack/solutions/observability/packages/kbn-evals-suite-observability-ai/evals/agent/payment_unreachable.spec.ts
...
evaluate.describe(
<<<<<<<< HEAD:x-pack/solutions/observability/packages/kbn-evals-suite-observability-ai/evals/agent/investigation/payment_unreachable.spec.ts
  'Investigation Skill: Payment Unreachable',
========

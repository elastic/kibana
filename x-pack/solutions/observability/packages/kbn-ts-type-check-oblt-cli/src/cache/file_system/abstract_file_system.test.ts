...
// kbn-ts-type-check-cli suite, which otherwise shares the identical hardcoded temp path.
jest.mock('../constants', () => {
  ...
  return {
    ...actual,
    TMP_DIR: fs.mkdtempSync(path.join(os.tmpdir(), 'kbn-ts-typecheck-oblt-test-')),
  };
});

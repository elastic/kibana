...
import { SvlWorkplaceAINavigationServiceProvider } from './svl_workplace_ai_navigation';

export const services = {
  ...svlPlatformServices,
  // Workplace AI Solution serverless FTR services
  svlWorkplaceAINavigation: SvlWorkplaceAINavigationServiceProvider,
};

...
export const GETTING_STARTED_SESSIONSTORAGE_KEY = 'gettingStartedVisited';
...
export const SEARCH_GETTING_STARTED_CHAT_FEATURE_FLAG = 'searchSolution.gettingStartedChatEnabled';

...
- `x-pack/solutions/search/solutions/search/plugins/enterprise_search/common/jest.config.js`
- `x-pack/solutions/search/solutions/search/plugins/enterprise_search/public/jest.config.js`
- `x-pack/solutions/search/solutions/search/plugins/enterprise_search/server/jest.config.js`
...
```bash
# Running the jest.sh script from the `x-pack/solutions/search/solutions/search/plugins/enterprise_search` folder (vs. kibana root)
...
Cypress tests can be run directly from the `x-pack/solutions/search/solutions/search/plugins/enterprise_search` folder. You can use our handy cypress.sh script to run specific product test suites:
...
All failed tests will output a screenshot to the `x-pack/solutions/search/solutions/search/plugins/enterprise_search/target/cypress/screenshots` folder. We strongly recommend starting there for debugging failed tests to inspect error messages and UI state at point of failure.

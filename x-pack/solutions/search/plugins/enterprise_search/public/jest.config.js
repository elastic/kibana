...
module.exports = {
  ...
  testMatch: [
    '<rootDir>/x-pack/solutions/search/plugins/enterprise_search/public/applications/*.test.{js,mjs,ts,tsx}',
  ],
  roots: ['<rootDir>/x-pack/solutions/search/plugins/enterprise_search/public'],

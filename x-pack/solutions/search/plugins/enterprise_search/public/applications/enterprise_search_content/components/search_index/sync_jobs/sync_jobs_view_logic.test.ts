...
import { type ConnectorSyncJob, SyncJobType, SyncStatus, TriggerMethod } from '@kbn/search-connectors';
...
import { type SyncJobView, SyncJobsViewLogic } from './sync_jobs_view_logic';

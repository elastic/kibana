...
import { type ClientConfigType, type InitialAppData, type ProductAccess } from '../../common/types';
import { type PluginsStart, type ClientData, type ESConfig, type UpdateSideNavDefinitionFn } from '../plugin';

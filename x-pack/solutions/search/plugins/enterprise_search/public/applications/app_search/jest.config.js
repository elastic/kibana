...
module.exports = {
  preset: '@kbn/test',
  rootDir: '../../../../../../../..',
  roots: ['<rootDir>/x-pack/solutions/search/plugins/enterprise_search/public/applications/app_search'],
  ...
  coverageDirectory:
    '<rootDir>/target/kibana-coverage/jest/x-pack/solutions/search/plugins/enterprise_search/public/applications/app_search',

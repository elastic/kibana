...
module.exports = {
  preset: '@kbn/test',
  rootDir: '../../../../../..',
  roots: ['<rootDir>/x-pack/solutions/search/plugins/enterprise_search/server'],
  collectCoverage: true,
  coverageReporters: ['text', 'html'],
  collectCoverageFrom: [
    '<rootDir>/x-pack/solutions/search/plugins/enterprise_search/**/*.{ts,tsx}',
  ...
  coverageDirectory: '<rootDir>/target/kibana-coverage/jest/x-pack/solutions/search/plugins/enterprise_search',

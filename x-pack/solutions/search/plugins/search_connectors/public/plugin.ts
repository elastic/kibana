...
import {
  type SearchConnectorsPluginSetup,
  type SearchConnectorsPluginSetupDependencies,
  type SearchConnectorsPluginStart,
  type SearchConnectorsPluginStartDependencies,
} from './types';

...
export async function createMcpServer({ configuration, elasticsearchClient, logger }: { configuration: WCIIndexSourceConfiguration, elasticsearchClient: ElasticsearchClient, logger: Logger }): Promise<McpServer> {

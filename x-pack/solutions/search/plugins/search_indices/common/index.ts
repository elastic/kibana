...
import type { SearchIndices, SearchStart, SearchIndexManagement } from '@kbn/deeplinks-search/deep_links';
import { SEARCH_INDICES, SEARCH_INDICES_START, SEARCH_INDEX_MANAGEMENT } from '@kbn/deeplinks-search';

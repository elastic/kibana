...
import { useUpsellingService } from '@kbn/security-solution-plugin/public';
...
export const useUpsellingPage = (pageName: SecurityPageNameAiSoc): React.ComponentType | null => {
  const upselling = useUpsellingService();

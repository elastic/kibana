...
spaceTest.describe(
  'Document flyout v2 — Response section',
  ...
  () => {
    ...
    spaceTest(
      'response section renders with the View response details button',
      async ({ pageObjects }) => {
        ...
        await expect(pageObjects.documentFlyoutV2.responseButton).toBeVisible();
      }
    );

    spaceTest(
      'clicking View response details opens the response tool overlay',

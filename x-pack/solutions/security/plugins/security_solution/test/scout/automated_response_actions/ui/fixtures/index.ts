...
import { DocumentResponseFlyout, RuleResponseActionsForm } from './page_objects';
...
export interface AutomatedResponseActionsFixtures extends SecurityTestFixtures {
  pageObjects: SecurityPageObjects & {
    ...
    ruleResponseActionsForm: RuleResponseActionsForm;
  };
}
...
export const test = baseTest.extend<AutomatedResponseActionsFixtures, SecurityWorkerFixtures>({
  pageObjects: async (
    ...
    await use({
      ...
      ruleResponseActionsForm: createLazyPageObject(RuleResponseActionsForm, page),
    });
  },
});

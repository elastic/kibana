...
import { entityRiskScoreToolInternal } from './assistant/tools/entity_risk_score/entity_analytics';
...
export class Plugin implements ISecuritySolutionPlugin {
  ...
  public setup(
    ...
    plugins.onechat.tools.register(entityRiskScoreToolInternal(core.getStartServices));

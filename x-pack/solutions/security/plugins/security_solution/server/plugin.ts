  ...
  public setup(
    ...
    if (plugins.agentSkills) {
      try {
        ...
        this.logger.info('Registered security.security_alerts skill');
      } catch (error) {
        this.logger.error(`Error registering security alerts skill: ${error}`);
      }
    }
    ...
    if (plugins.agentSkills) {
      try {
        ...
        this.logger.info('Registered security.fleet_management_and_wait skill');
      } catch (error) {
        this.logger.error(`Error registering fleet management and wait skill: ${error}`);
      }
    }

...
Go to the scripts folder `cd kibana/x-pack/solutions/security/solutions/security/plugins/security_solution/server/lib/detection_engine/scripts` and run:
...
go about doing so.
`cd x-pack/solutions/security/solutions/security/plugins/security_solution/server/lib/detection_engine/scripts`
...
* Then, from the detection engine scripts folder (`cd kibana/x-pack/solutions/security/solutions/security/plugins/security_solution/server/lib/detection_engine/scripts`) run `./post_rule.sh rules/queries/lists/query_with_list_plugin.json`

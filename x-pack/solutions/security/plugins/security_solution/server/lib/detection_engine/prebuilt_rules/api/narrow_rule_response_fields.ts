...
const REVIEW_RULE_BASELINE_FIELDS: ReadonlySet<ReviewRuleInstallationField> = new Set([
  'rule_id',
  'id',
  'version',
  'type',
...
export const narrowRuleResponseFields = (
  ...
  const allowed = new Set<ReviewRuleInstallationField>([...fields, ...REVIEW_RULE_BASELINE_FIELDS]);

...
export const buildEsqlSearchRequest = ({
  ...
  return {
    ...
    wait_for_completion_timeout: '4m', // hard limit request timeout is 5m set by ES proxy and alerting framework. So, we should be fine to wait 4m for async query completion. If rule execution is smaller than 4m and query won't complete, it will be aborted.
  };
};

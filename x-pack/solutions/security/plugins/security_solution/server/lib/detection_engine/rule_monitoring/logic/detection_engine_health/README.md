...
The assets' sources are located in the repo under `x-pack/solutions/security/solutions/security/plugins/security_solution/server/lib/detection_engine/rule_monitoring/logic/detection_engine_health/assets`.

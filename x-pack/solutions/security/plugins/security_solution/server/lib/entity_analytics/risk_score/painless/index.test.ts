...
describe('getPainlessScripts', () => {
  // to update snapshot run `yarn test:jest x-pack/solutions/security/solutions/security/plugins/security_solution/server/lib/entity_analytics/risk_score/painless/index.test.ts -u`

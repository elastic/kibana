...
export const genericEntityEngineDescription: EntityDescription = {
  ...
  fields: [
    ...
    newestValue({ source: 'endpoint.posture.score' }),
    newestValue({ source: 'endpoint.posture.level' }),
    newestValue({ source: 'endpoint.posture.disk_encryption' }),
    newestValue({ source: 'endpoint.posture.firewall_enabled' }),
    newestValue({ source: 'endpoint.posture.secure_boot' }),
    newestValue({ source: 'endpoint.privileges.admin_count' }),
    newestValue({ source: 'endpoint.privileges.local_admins' }),
    newestValue({ source: 'endpoint.privileges.elevated_risk' }),
    newestValue({ source: 'endpoint.lifecycle.first_seen' }),
    newestValue({ source: 'endpoint.lifecycle.last_seen' }),
    newestValue({ source: 'endpoint.drift.recently_changed' }),
    newestValue({ source: 'endpoint.software.installed_count' }),
    newestValue({ source: 'endpoint.hardware.cpu_cores' }),
    newestValue({ source: 'endpoint.hardware.memory_gb' }),

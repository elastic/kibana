    ...
    .addVersion(
      {
        ...
        validate: {
          request: {
            params: WatchlistDataSources.UpdateEntitySourceRequestParams,
            body: WatchlistDataSources.UpdateEntitySourceRequestBody,
          },
        },
      },
      withMinimumLicense(
        async (
          ...
          request,
          response
        ): Promise<IKibanaResponse<WatchlistDataSources.UpdateEntitySourceResponse>> => {

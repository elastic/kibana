...
export const createSiemMigrationTelemetryClientMock = () => {
  ...
  const mockStartItemTranslationReturn = {
    success: jest.fn(),
    failure: jest.fn(),
  };

  // Mock for the function returned by startSiemMigrationTask
  const mockStartItemTranslation = jest.fn().mockReturnValue(mockStartItemTranslationReturn);

  // Mock for startSiemMigrationTask return value
  const mockStartSiemMigrationTaskReturn = {
    startItemTranslation: mockStartItemTranslation,
    success: jest.fn(),
    failure: jest.fn(),
    aborted: jest.fn(),
  };
...
export const createSiemMigrationsTaskClientMock = () => ({
...
export const MockSiemMigrationsTaskClient = jest
  .fn()
  .mockImplementation(() => createSiemMigrationsTaskClientMock());

// Siem migrations task service
export const mockStopAll = jest.fn();
export const mockCreateClient = jest.fn(() => createSiemMigrationsTaskClientMock());

export const MockSiemMigrationsTaskService = jest.fn().mockImplementation(() => ({

      ...
      async (context, request, response): Promise<IKibanaResponse<GetNotesResponse>> => {
        try {
          ...
          if (createdByFilter) {
            ...
            // see pickSaveNote (https://github.com/elastic/kibana/blob/main/x-pack/solutions/security/solutions/security/plugins/security_solution/server/lib/timeline/saved_object/notes/saved_object.ts#L302)

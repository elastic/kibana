...
export class TelemetryReceiver implements ITelemetryReceiver {
  ...
  public async *fetchDiagnosticAlertsBatch(executeFrom: string, executeTo: string) {
    ...
    while (fetchMore) {
      try {
        ...
        this.logger.warn('Error fetching alerts', { error, error_message: error.message });
        fetchMore = false;
      }
  ...
  public async fetchLicenseInfo(): Promise<Nullable<ESLicense>> {
    try {
      ...
      this.logger.warn('failed retrieving license', { error, error_message: error.message });
      return undefined;
    }
  }
  ...
  public async *paginate<T>(
    ...
    try {
      ...
      this.logger.warn('Error running paginated query', { error, error_message: error.message });
      throw error;
    } finally {
  ...
  public async getIndices(): Promise<IndexSettings[]> {
    ...
    return es.indices
      ...
      .catch((error) => {
        this.logger.warn('Error fetching indices', { error, error_message: error.message });
        throw error;
      });
  }
  ...
  public async getDataStreams(): Promise<DataStream[]> {
    ...
    return es.indices
      ...
      .catch((error) => {
        this.logger.warn('Error fetching datastreams', { error, error_message: error.message });
        throw error;
      });
  }
  ...
  public async *getIndicesStats(indices: string[], chunkSize: number) {
    ...
    for (const group of groupedIndices) {
      ...
      try {
        ...
        this.logger.warn('Error fetching indices stats', { error, error_message: error.message });
        throw error;
      }
    }
  }
  ...
  public async *getIlmsStats(indices: string[], chunkSize: number) {
    ...
    for (const group of groupedIndices) {
      ...
      try {
        ...
        this.logger.warn('Error fetching ilm stats', { error, error_message: error.message });
        throw error;
      }
    }
  }
  ...
  public async getIndexTemplatesStats(): Promise<IndexTemplateInfo[]> {
    ...
    return es.indices
      ...
      .catch((error) => {
        this.logger.warn('Error fetching index templates', { error, error_message: error.message });
        throw error;
      });
  }
  ...
  public async *getIlmsPolicies(ilms: string[], chunkSize: number) {
    ...
    for (const group of groupedIlms) {
      ...
      try {
        ...
        this.logger.warn('Error fetching ilm policies', { error, error_message: error.message });
        throw error;
      }
    }
  }

...
export const prebuiltRuleAlertsResponse = {
  events: [
    ...
    {
      'kibana.alert.rule.execution.timestamp': '2025-06-05T08:42:54.943Z',
      'kibana.alert.start': '2025-06-05T08:42:54.943Z',
      'kibana.alert.last_detected': '2025-06-05T08:42:54.943Z',
      'kibana.version': '9.0.1',
      'kibana.alert.rule.category': 'ES|QL Rule',
      'kibana.alert.rule.consumer': 'siem',
      'kibana.alert.rule.execution.uuid': 'abc12345',
      'kibana.alert.rule.name': 'High Number of Egress Network Connections from Unusual Executable',
      'kibana.alert.rule.producer': 'siem',
      'kibana.alert.rule.revision': 0,
      'kibana.alert.rule.rule_type_id': 'siem.esqlRule',
      'kibana.alert.rule.uuid': 'abc12345',
      'kibana.space_ids': ['default'],
      ...
      '@timestamp': '2025-06-05T08:42:54.847Z',
      cc: 53,
      agent_count: 1,
      'host.name': 'demo',
      'agent.id': 'abc12345',
      'process.executable': '/tmp/nmap',
      'event.kind': 'signal',
      'kibana.alert.ancestors': [
        {
          id: '',
      ...
      'kibana.alert.depth': 1,
      'kibana.alert.reason':
        'event on demo created medium alert High Number of Egress Network Connections from Unusual Executable.',
      'kibana.alert.severity': 'medium',
      'kibana.alert.risk_score': 47,
      'kibana.alert.rule.actions': [],
      'kibana.alert.rule.author': ['Elastic'],
      'kibana.alert.rule.created_at': '2025-06-05T06:49:09.139Z',
      'kibana.alert.rule.created_by': 'abc12345',
      'kibana.alert.rule.description':
      ...
      'kibana.alert.rule.exceptions_list': [],
      'kibana.alert.rule.false_positives': [],
      'kibana.alert.rule.from': 'now-61m',
      'kibana.alert.rule.immutable': true,
      ...
      'kibana.alert.rule.references': [],
      'kibana.alert.rule.risk_score_mapping': [],
      'kibana.alert.rule.rule_id': '1fa350e0-0aa2-4055-bf8f-ab8b59233e59',
      'kibana.alert.rule.severity_mapping': [],
      'kibana.alert.rule.threat': [
        {
      ...
      'kibana.alert.rule.updated_at': '2025-06-05T08:40:56.795Z',
      'kibana.alert.rule.updated_by': 'abc12345',
      'kibana.alert.rule.version': 3,
      'kibana.alert.url': 'abc12345',
      'kibana.alert.uuid': 'abc12345',
      'kibana.alert.workflow_tags': [],
      'kibana.alert.workflow_assignee_ids': [],
      'kibana.alert.rule.risk_score': 47,
      'kibana.alert.rule.severity': 'medium',
      'kibana.alert.intended_timestamp': '2025-06-05T08:42:49.491Z',
...
export const prebuiltRuleAlertsEsql = {
  response: [
    {
      'kibana.alert.rule.execution.timestamp': '2025-06-05T08:42:54.943Z',
      'kibana.alert.start': '2025-06-05T08:42:54.943Z',
  ...
  expected: {
    ...
    kibana: {
      alert: {
        ancestors: [{ depth: 0, id: '', index: '', type: 'event' }],
        depth: 1,
        risk_score: 47,
        rule: {
          actions: [],
          category: 'ES|QL Rule',
          consumer: 'siem',
          created_at: '2025-06-05T06:49:09.139Z',
          enabled: true,
          exceptions_list: [],
          execution: { uuid: 'abc12345' },
          false_positives: [],
          from: 'now-61m',
          immutable: true,
          interval: '1h',
          ...
          timestamp_override: 'event.ingested',
          type: 'esql',
          updated_at: '2025-06-05T08:40:56.795Z',
          uuid: 'abc12345',
          version: 3,
        },
        severity: 'medium',
    ...
    licence_id: '4a7dde08-e5f8-4e50-80f8-bc85b72b4934',

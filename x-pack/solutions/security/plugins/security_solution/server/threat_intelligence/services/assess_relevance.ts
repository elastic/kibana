...
const buildRelevancePrompt = (params: AssessRelevanceParams): string => {
  ...
  return `You are a threat-intelligence editor. Assess the following article and return a strict JSON object with exactly seven keys.
...
export const assessRelevance = async (
  ...
  logStageUsage(logger, 'assess_relevance', connectorId, result.raw.response_metadata ?? {});

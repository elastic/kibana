...
1. When asked to modify, update, or create a detection rule, ALWAYS load the ${DETECTION_RULE_CREATE_EDIT_SKILL_ID} skill from the skills/security/rules directory.

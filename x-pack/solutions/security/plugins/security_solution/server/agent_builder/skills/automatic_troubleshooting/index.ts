...
- DON'T make more than 5 investigation tool calls after ${CHECK_ENDPOINT_PACKAGE_FRESHNESS_TOOL_ID}. Be efficient: most well-scoped investigations conclude in 3-5 tool calls. Avoid broad log searches when the user names a specific endpoint and symptom.

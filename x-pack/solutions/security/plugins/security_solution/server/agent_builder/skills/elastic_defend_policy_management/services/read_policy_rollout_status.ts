...
export const readPolicyRolloutStatus = async (
  ...
  const distributedRead = ccsEnabled || isCpsRead;
    ...
    return buildPolicyRolloutStatus({
      ...
      evidence: {
        ...
        currentRevisionResponses: {
          ...
          responseCoverageIncomplete: evaluateLatestPolicyResponseCoverageIncomplete({
      ...
      return buildPolicyRolloutStatus({
        ...
        evidence: {
          ...
          currentRevisionResponses: {
            ...EMPTY_RESPONSE_EVIDENCE,
            upstreamUnclassifiedHosts: evaluation.agentOverflow,
            responseCoverageIncomplete: true,
            source: 'policy_response_index_missing',
          },
        },
      });
    }

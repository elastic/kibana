...
- Do NOT use platform.core.search, other platform.core index/exploration tools, or workflow tools for any step covered by a dedicated security tool — no speculative index discovery or raw search.

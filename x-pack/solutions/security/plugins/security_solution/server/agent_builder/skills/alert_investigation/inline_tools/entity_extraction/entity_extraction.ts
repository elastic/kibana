...
export const ENTITY_EXTRACTION_TOOL_ID = 'security.entity_extraction';
...
export const getEntityExtractionInlineTool = (): SkillBoundedTool => ({
  ...
  handler: async ({ alert_ids: alertIds, index }, { esClient, spaceId, logger }) => {
    ...
    const result = extractEntitiesFromAlerts({ alerts, logger });

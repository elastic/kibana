...
describe('ruleMonitoringTool', () => {
  ...
  const tool = ruleMonitoringTool(mockCore, mockLogger, mockExperimentalFeatures);
  ...
  describe('tool properties', () => {
    ...
    it('has correct tags', () => {
      expect(tool.tags).toEqual(['security', 'detection', 'monitoring', 'health']);
    });
  });

  describe('availability', () => {
    it('returns unavailable when experimental feature is disabled', async () => {
      const toolWithFeatureDisabled = ruleMonitoringTool(mockCore, mockLogger, {

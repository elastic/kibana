        ...
        .array(
          z.object({
            ...
            index: z
              .string()
              .describe(
                'Alerts index that contains the alert (e.g. ".alerts-security.alerts-default")'
              ),
            ruleId: z.string().optional().describe('Optional rule id associated with the alert'),
            ruleName: z
              .string()
              .optional()
              .describe('Optional rule name associated with the alert'),
          })
        )
        .min(1)
        .max(200)
  ...
  z.object({
    ...
    params: z.object({
          ...
          z
            .object({
              ...
              owner: z
                .string()
                .optional()
                .describe('Ignored (tool always uses securitySolution owner)'),
            })
            .passthrough()
            .describe(
      ...
      confirm: z
        .literal(true)
        .describe(
          'Required for adding a comment. Set to true only if the user explicitly confirmed.'
        ),
    }),
  }),
]);

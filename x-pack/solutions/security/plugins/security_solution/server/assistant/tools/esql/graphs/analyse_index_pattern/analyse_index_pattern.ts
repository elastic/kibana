...
import { GET_FIELD_DESCRIPTORS, EXPLORE_PARTIAL_INDEX_RESPONDER, EXPLORE_PARTIAL_INDEX_AGENT, ANALYZE_COMPRESSED_INDEX_MAPPING_AGENT, TOOLS } from "./constants"
import { CreateLlmInstance, messageContainsToolCalls } from "../../utils/common"
...
export const getAnalyzeIndexPatternGraph = ({
    ...
    .addNode(ANALYZE_COMPRESSED_INDEX_MAPPING_AGENT, getAnalyzeCompressedIndexMappingAgent({createLlmInstance}))

    .addNode(EXPLORE_PARTIAL_INDEX_AGENT, getExplorePartialIndexMappingAgent({esClient, createLlmInstance}))
    ...
    .addNode(EXPLORE_PARTIAL_INDEX_RESPONDER, getExplorePartialIndexMappingResponder({createLlmInstance}))

    .addEdge(START, GET_FIELD_DESCRIPTORS)
    .addConditionalEdges(GET_FIELD_DESCRIPTORS, (state: typeof AnalyzeIndexPatternAnnotation.State) => {
    ...
    .addConditionalEdges(EXPLORE_PARTIAL_INDEX_AGENT, (state: typeof AnalyzeIndexPatternAnnotation.State) => {

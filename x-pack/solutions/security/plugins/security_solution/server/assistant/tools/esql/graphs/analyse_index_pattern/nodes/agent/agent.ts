...
Once you have gathered enough information about the index mapping, and you are confident that you can make a decision on wheather the data in the index can answer the users question, respond in the following format:

Index Pattern: ${state.indexPattern}
Contains required data: <yes/no>
Analysis: <Your analysis of the index mapping. Which fields should be used to answer the users question? Explain each field. If the index pattern can not be used, explain why?>.

...
export const buildContext = (messages: BaseMessage[]): Record<string, unknown> => {
    ...
    const orderedInspectIndexMappingToolCallIds = orderedInspectIndexMappingToolCalls
        .map((toolCall) => toolCall.id)

    const inspectIndexMappingToolCallByIds = orderedInspectIndexMappingToolCalls
        .reduce((acc, toolCall) => {
    ...
    const orderedInspectIndexMappingToolMessages = messages
        ...
        .sort((a, b) => orderedInspectIndexMappingToolCallIds.indexOf(a.tool_call_id) - orderedInspectIndexMappingToolCallIds.indexOf(b.tool_call_id))



    let context = {}

    for (let toolMessage of orderedInspectIndexMappingToolMessages) {

...
- To update \`kibana.alert.workflow_status\` (e.g. \`open\` → \`acknowledged\`), use \`operation: "acknowledge"\` (or \`operation: "set_workflow_status"\`) and you **must** include \`confirm: true\`.

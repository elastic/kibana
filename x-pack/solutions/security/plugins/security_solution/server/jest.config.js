...
module.exports = {
  ...
  testMatch: ['<rootDir>/x-pack/solutions/security/plugins/security_solution/server/*.test.{js,mjs,ts,tsx}'],
  ...
  collectCoverageFrom: ['<rootDir>/x-pack/solutions/security/plugins/security_solution/server/**/*.{ts,tsx}'],

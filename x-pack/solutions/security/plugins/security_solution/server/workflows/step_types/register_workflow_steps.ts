...
import { getEndpointFileStepDefinition } from './get_endpoint_file_step/get_endpoint_file_step';
import {
...
export const registerWorkflowSteps = (
  ...
  workflowsExtensions.registerStepDefinition(getEndpointFileStepDefinition);
};

...
import {
  SCRIPTS_LIBRARY_FILE_DATA_INDEX_NAME_TPL,
  SCRIPTS_LIBRARY_FILE_METADATA_INDEX_NAME_TPL,
} from '../constants';
...
export const ScriptsFileMetadataIndexTemplate = deepFreeze<IndicesPutIndexTemplateRequest>({
  name: SCRIPTS_LIBRARY_FILE_METADATA_INDEX_NAME_TPL,
  index_patterns: SCRIPTS_LIBRARY_FILE_METADATA_INDEX_NAME_TPL,
  priority: 500,
...
export const ScriptsFileDataIndexTemplate = deepFreeze<IndicesPutIndexTemplateRequest>({
  name: SCRIPTS_LIBRARY_FILE_DATA_INDEX_NAME_TPL,
  index_patterns: SCRIPTS_LIBRARY_FILE_DATA_INDEX_NAME_TPL,
  priority: 500,
  allow_auto_create: true,
  _meta: {

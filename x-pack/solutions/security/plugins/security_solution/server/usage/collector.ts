        ...
        detection_rules: {
          ...
          detection_rule_usage: {
            ...
            elastic_customized_total: {
              enabled: {
                type: 'long',
                _meta: { description: 'Number of customized elastic rules enabled' },
              },
              disabled: {
                type: 'long',
              ...
              cases: {
                ...
                _meta: {
                  description:
                    'Number of cases attached to customized elastic detection rule alerts',
                },
              },
              legacy_notifications_enabled: {
                type: 'long',
              ...
              alert_suppression: {
                enabled: {
                  ...
                  _meta: {
                    description:
                      'Number of enabled customized elastic rules configured with suppression',
                  },
                },
                disabled: {
                  type: 'long',
                  _meta: {
                    description:
                      'Number of disabled customized elastic rules configured with suppression',
                  },
                },
                suppressed_fields_count: {
                  one: {
                    ...
                    _meta: {
                      description:
                        'Number of customized elastic rules configured with one suppression field',
                    },
                  },
                  two: {
                    type: 'long',
                    _meta: {
                      description:
                        'Number of customized elastic rules configured with two suppression field',
                    },
                  },
                  three: {
                    type: 'long',
            ...
            elastic_noncustomized_total: {
              ...
              cases: {
                ...
                _meta: {
                  description:
                    'Number of cases attached to non-customized elastic detection rule alerts',
                },
              },
              legacy_notifications_enabled: {
                type: 'long',
              ...
              alert_suppression: {
                enabled: {
                  ...
                  _meta: {
                    description:
                      'Number of enabled non-customized elastic rules configured with suppression',
                  },
                },
                disabled: {
                  type: 'long',

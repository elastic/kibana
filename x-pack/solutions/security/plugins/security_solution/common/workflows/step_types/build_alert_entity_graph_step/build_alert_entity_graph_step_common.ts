...
export const buildAlertEntityGraphInputSchema = lazySchema(() =>
  z.object({
    ...
    max_alerts: z.coerce
      ...
      .default(300)
      .describe(
        'Hard cap on number of discovered alerts (including seed if included). Default: 300'
      ),
    page_size: z.coerce
      .number()
      .finite()
...
export const buildAlertEntityGraphOutputSchema = lazySchema(() =>
  z.object({

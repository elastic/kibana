...
export const getIngestPipelineName = (riskScoreEntity: RiskScoreEntityType, spaceId = 'default') =>
  `ml_${riskScoreEntity}riskscore_ingest_pipeline_${spaceId}`;

export const getPivotTransformIndex = (riskScoreEntity: RiskScoreEntityType, spaceId = 'default') =>
  `ml_${riskScoreEntity}_risk_score_${spaceId}`;

export const getLatestTransformIndex = (
  riskScoreEntity: RiskScoreEntityType,
  spaceId = 'default'
 ...
 */
export const getLegacyIngestPipelineName = (riskScoreEntity: RiskScoreEntityType) =>
  `ml_${riskScoreEntity}riskscore_ingest_pipeline`;
export const getLegacyRiskScoreLevelScriptId = (riskScoreEntity: RiskScoreEntityType) =>
  `ml_${riskScoreEntity}riskscore_levels_script`;
export const getLegacyRiskScoreInitScriptId = (riskScoreEntity: RiskScoreEntityType) =>
  `ml_${riskScoreEntity}riskscore_init_script`;
export const getLegacyRiskScoreMapScriptId = (riskScoreEntity: RiskScoreEntityType) =>
  `ml_${riskScoreEntity}riskscore_map_script`;
export const getLegacyRiskScoreReduceScriptId = (riskScoreEntity: RiskScoreEntityType) =>
...
export const getRiskHostCreateLevelScriptOptions = (
  ...
  return {
    id: getRiskScoreLevelScriptId(RiskScoreEntityType.host, spaceId),
    script: {
      lang: 'painless',
...
export const getRiskHostCreateInitScriptOptions = (
  ...
  return {
    id: getRiskScoreInitScriptId(RiskScoreEntityType.host, spaceId),
    script: {
      lang: 'painless',
      source: stringifyScript ? JSON.stringify(source) : source,
    },
...
export const getRiskHostCreateMapScriptOptions = (
  ...
  return {
    id: getRiskScoreMapScriptId(RiskScoreEntityType.host, spaceId),
    script: {
      lang: 'painless',
      source: stringifyScript ? JSON.stringify(source) : source,
    },
...
export const getRiskHostCreateReduceScriptOptions = (
  ...
  return {
    id: getRiskScoreReduceScriptId(RiskScoreEntityType.host, spaceId),
    script: {
      lang: 'painless',
      source: stringifyScript ? JSON.stringify(source) : source,
    },
...
export const getRiskUserCreateLevelScriptOptions = (
  ...
  return {
    id: getRiskScoreLevelScriptId(RiskScoreEntityType.user, spaceId),
    script: {
      lang: 'painless',
      source: stringifyScript ? JSON.stringify(source) : source,
    },
...
export const getRiskUserCreateMapScriptOptions = (
  ...
  return {
    id: getRiskScoreMapScriptId(RiskScoreEntityType.user, spaceId),
    script: {
      lang: 'painless',
      source: stringifyScript ? JSON.stringify(source) : source,
    },
...
export const getRiskUserCreateReduceScriptOptions = (
  ...
  return {
    id: getRiskScoreReduceScriptId(RiskScoreEntityType.user, spaceId),
    script: {
      lang: 'painless',
      source: stringifyScript ? JSON.stringify(source) : source,
    },
...
export const getCreateMLHostPivotTransformOptions = ({
  ...
  const options = {
    dest: {
      index: getPivotTransformIndex(RiskScoreEntityType.host, spaceId),
      pipeline: getIngestPipelineName(RiskScoreEntityType.host, spaceId),
    },
    frequency: '1h',
    pivot: {
      aggregations: {
...
export const getCreateMLUserPivotTransformOptions = ({
  ...
  const options = {
    dest: {
      index: getPivotTransformIndex(RiskScoreEntityType.user, spaceId),
      pipeline: getIngestPipelineName(RiskScoreEntityType.user, spaceId),
    },
    frequency: '1h',
    pivot: {
      aggregations: {

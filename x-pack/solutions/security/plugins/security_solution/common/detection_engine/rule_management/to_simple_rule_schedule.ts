...
import { toLargestTimeDuration } from '@kbn/securitysolution-utils/time_duration';
import type { RuleSchedule } from '../../api/detection_engine';
import type { SimpleRuleSchedule } from '../../api/detection_engine/model/rule_schema/simple_rule_schedule';
...
export function toSimpleRuleSchedule(ruleSchedule: RuleSchedule): SimpleRuleSchedule | undefined {
  ...
  return {
    ...
    lookback: toLargestTimeDuration(lookBackMs),
  };
}

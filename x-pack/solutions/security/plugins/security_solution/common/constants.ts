...
export const ENTITY_ANALYTICS_ENDPOINT_ASSETS_PATH = '/entity_analytics_endpoint_assets' as const;
export const ENTITY_ANALYTICS_ENDPOINT_ASSETS_HOST_DETAILS_PATH =
  '/entity_analytics_endpoint_assets/host/:hostId' as const;

...
export const RULES_V2_PATH = '/rules_v2' as const;
export const RULES_V2_CREATE_PATH = '/rules_v2/create' as const;
export const RULES_V2_VIEW_PATH = '/rules_v2/view/:id' as const;
export const RULES_V2_EDIT_PATH = '/rules_v2/edit/:id' as const;

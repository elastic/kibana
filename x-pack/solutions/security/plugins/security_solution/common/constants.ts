...
export const PRIV_USER_MON_PATH = '/privmon' as const;
...
export const ENTITY_ANALYTICS_THREAT_HUNTING_QUERIES_PATH =
  '/entity_analytics_threat_hunting_queries' as const;

...
```shell
yarn --cwd x-pack/solutions/security/solutions/security/plugins/security_solution openapi:generate
```
3. Create a new bundle with the updated APIs:
```shell
yarn --cwd x-pack/solutions/security/solutions/security/plugins/security_solution openapi:bundle:endpoint-management
```

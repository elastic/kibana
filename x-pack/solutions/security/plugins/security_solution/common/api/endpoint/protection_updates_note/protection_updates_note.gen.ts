...
export const CreateUpdateProtectionUpdatesNoteRequestParams = lazySchema(() =>
  z.object({
    ...
    package_policy_id: z
      .string()
      .max(256)
      .describe('The package policy ID to create or update the protection updates note for.'),
  })
);
...
export const CreateUpdateProtectionUpdatesNoteRequestBody = lazySchema(() =>
  z.object({
     ...
     * The note content.
     */
    note: z.string().max(10000).describe('The note content.'),
  })
);
...
export const GetProtectionUpdatesNoteRequestParams = lazySchema(() =>
  z.object({
    ...
    package_policy_id: z
      .string()
      .max(256)
      .describe('The package policy ID to retrieve the protection updates note for.'),
  })
);

...
export const RevertPrebuiltRulesRequest = lazySchema(() =>
  z.object({
...
export const BulkRevertSkipReason = lazySchema(() =>
  z.enum(['RULE_NOT_PREBUILT', 'RULE_NOT_CUSTOMIZED'])
);
export type BulkRevertSkipReasonEnum = typeof BulkRevertSkipReason.enum;
export const BulkRevertSkipReasonEnum = lazySchema(() => BulkRevertSkipReason.enum);

export type BulkActionReversionSkipResult = z.infer<typeof BulkActionReversionSkipResult>;
export const BulkActionReversionSkipResult = lazySchema(() =>
  z.object({
    id: z.string(),
...
export const RevertPrebuiltRulesResponseBody = lazySchema(() =>
  z.object({

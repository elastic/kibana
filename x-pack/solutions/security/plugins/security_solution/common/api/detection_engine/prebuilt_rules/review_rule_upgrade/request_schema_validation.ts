...
const validateSortFieldAndOrderCoexist = (body: ReviewRuleUpgradeRequestBodyInput): string[] => {
...
const validateSearchAfterRequiresSort = (body: ReviewRuleUpgradeRequestBodyInput): string[] => {
...
const validateAggregationsCountsUnique = (
  aggregations: ReviewRuleUpgradeRequestBodyInput['aggregations']
): string[] => {
...
const validateSearchMode = (search: ReviewRuleUpgradeRequestBodyInput['search']): string[] => {
...
const validateSearchTermLength = (
  search: ReviewRuleUpgradeRequestBodyInput['search']
): string[] => {

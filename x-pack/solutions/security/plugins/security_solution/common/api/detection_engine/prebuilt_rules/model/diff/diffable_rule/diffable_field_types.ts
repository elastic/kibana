...
export const DataSourceIndexPatterns = lazySchema(() =>
  z.object({
...
export const DataSourceDataView = lazySchema(() =>
  z.object({
...
export const RuleDataSource = lazySchema(() =>
  z.discriminatedUnion('type', [DataSourceIndexPatterns, DataSourceDataView])
);
...
export const InlineKqlQuery = lazySchema(() =>
  z.object({
...
export const SavedKqlQuery = lazySchema(() =>
  z.object({
...
export const RuleKqlQuery = lazySchema(() =>
  z.discriminatedUnion('type', [InlineKqlQuery, SavedKqlQuery])
);

export type RuleEqlQuery = z.infer<typeof RuleEqlQuery>;
export const RuleEqlQuery = lazySchema(() =>
  z.object({
    query: RuleQuery,
...
export const RuleEsqlQuery = lazySchema(() =>
  z.object({
    query: RuleQuery,
...
export const RuleNameOverrideObject = lazySchema(() =>
  z.object({
...
export const TimestampOverrideObject = lazySchema(() =>
  z.object({
...
export const TimelineTemplateReference = lazySchema(() =>
  z.object({
...
export const BuildingBlockObject = lazySchema(() =>
  z.object({

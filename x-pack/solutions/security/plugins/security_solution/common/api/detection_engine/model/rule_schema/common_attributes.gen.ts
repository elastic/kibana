...
> info
> This setting can be superseded by the [Kibana configuration setting](https://www.elastic.co/guide/en/kibana/8.17/alert-action-settings-kb.html#alert-settings) xpack.alerting.rules.run.alerts.max, which determines the maximum alerts generated by any rule in the Kibana alerting framework. For example, if xpack.alerting.rules.run.alerts.max is set to 1000, the rule can generate no more than 1000 alerts even if max_signals is set higher.
...
export const RuleExceptionList = z.object({
  /**
   * jacek ID of the exception container
   */
  id: NonEmptyString,
  /**

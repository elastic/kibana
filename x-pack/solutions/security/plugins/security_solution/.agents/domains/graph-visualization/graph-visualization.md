...
> **[VERIFY]:** Is moving grouping from ES|QL to TypeScript ever acceptable for this domain, or must grouping remain in ES|QL except where CPS LOOKUP JOIN constraints apply? ([PR #269755](https://github.com/elastic/kibana/pull/269755) · @kfirpeled)

...
| `stateful-ess` | `node scripts/scout start-server --arch stateful --domain ess &` |
| `serverless` | `node scripts/scout start-server --arch serverless --projectType <project-type> &` |

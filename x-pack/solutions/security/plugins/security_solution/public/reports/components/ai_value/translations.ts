...
export const EXECUTIVE_MESSAGE_START = i18n.translate(
  ...
  {
    defaultMessage: 'The Elastic EASE Engine continues to deliver measurable impact, driving ',
  }
);
...
export const EXECUTIVE_CALC2 = i18n.translate(
  ...
  {
    defaultMessage:
      'By automatically filtering out non-suspicious alerts, the EASE reduces triage workload at scale. Cost savings are calculated by multiplying the number of total alerts by an average review time of',
  }
);

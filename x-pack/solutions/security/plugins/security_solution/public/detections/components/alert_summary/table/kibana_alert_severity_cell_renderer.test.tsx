...
describe('KibanaAlertSeverityCellRenderer', () => {
  ...
  it('should show medium', () => {
    ...
    expect(getByTestId(BADGE_TEST_ID)).toHaveStyle('--euiBadgeBackgroundColor: #F1D86F');
  });
  ...
  it('should show high', () => {
    ...
    expect(getByTestId(BADGE_TEST_ID)).toHaveStyle('--euiBadgeBackgroundColor: #FF7E62');
  });
  ...
  it('should show critical', () => {
    ...
    expect(getByTestId(BADGE_TEST_ID)).toHaveStyle('--euiBadgeBackgroundColor: #bd271e');
  });
});

...
import { NO_INDEX_TEST_ID, NoIndexEmtpyPage } from './no_index_empty_page';
...
describe('AlertsPageNoIndex', () => {
  it('should render correctly', () => {
    const { getByTestId } = render(
      <NoIndexEmtpyPage needsSignalsIndex={true} needsListsIndex={true} />
    );
  ...
  it('should render needs signal index message', () => {
    const { getByTestId } = render(
      <NoIndexEmtpyPage needsSignalsIndex={true} needsListsIndex={false} />
    );
  ...
  it('should render needs lists indexes message', () => {
    const { getByTestId } = render(
      <NoIndexEmtpyPage needsSignalsIndex={false} needsListsIndex={true} />
    );
  ...
  it('should render empty message', () => {
    const { getByTestId } = render(
      <NoIndexEmtpyPage needsSignalsIndex={false} needsListsIndex={false} />
    );

...
import { AlertsTreemapPanel } from '../../alerts_kpis/alerts_treemap_panel';
...
export interface AttacksTreemapPanelProps extends AttacksKpiPanelBaseProps {
  /** The query object for filtering */
  query?: Query;
}

/**
 * Renders the Attacks Treemap KPI panel, wrapping the AlertsTreemapPanel.
 */
export const AttacksTreemapPanel = React.memo(
  ({ filters, query, title, isExpanded, setIsExpanded }: AttacksTreemapPanelProps) => {
...
AttacksTreemapPanel.displayName = 'AttacksTreemapPanel';

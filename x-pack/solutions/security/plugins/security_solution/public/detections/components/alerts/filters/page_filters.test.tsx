...
import type { PageFiltersProps } from './page_filters';
...
describe('PageFilters', () => {
  const mockProps: Partial<PageFiltersProps> = {
    filters: [],
  ...
  it('renders null if a spaceId is missing', () => {
    ...
    const { container } = render(<PageFilters {...mockProps} />);

...
import { useMissingPrivileges } from '../../components/callouts/missing_privileges_callout/use_missing_privileges';

jest.mock('../../components/user_info');
jest.mock('../../containers/detection_engine/lists/use_lists_config');
jest.mock('../../../sourcerer/containers/use_signal_helpers');
jest.mock('../../components/callouts/missing_privileges_callout/use_missing_privileges');
jest.mock('../../components/alerts/wrapper', () => ({
  AlertsPageDataViewWrapper: () => <div data-test-subj={'alerts-page-data-view-wrapper'} />,
}));

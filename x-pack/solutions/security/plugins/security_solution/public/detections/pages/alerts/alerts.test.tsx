...
import { useMissingPrivileges } from '../../../detection_engine/rule_management/hooks/use_missing_privileges';

jest.mock('../../components/user_info');
jest.mock('../../containers/detection_engine/lists/use_lists_config');
jest.mock('../../../sourcerer/containers/use_signal_helpers');
jest.mock('../../../detection_engine/rule_management/hooks/use_missing_privileges');

...
export const BULK_CLOSE_LABEL_DISABLED = i18n.translate(
  ...
  {
    defaultMessage:
      "Close all alerts that match this exception and were generated by this rule (Lists and fields not present on the rule's source indices are not supported)",
  }
);

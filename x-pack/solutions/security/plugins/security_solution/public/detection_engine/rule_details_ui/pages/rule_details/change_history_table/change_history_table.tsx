...
const MESSAGE = {
  [SecurityRuleChangeTrackingAction.ruleInstall]: 'Rule installed',
  [RuleChangeTrackingAction.ruleUpdate]: 'Rule updated',
  [RuleChangeTrackingAction.ruleEnable]: 'Rule enabled',
  [RuleChangeTrackingAction.ruleDisable]: 'Rule disabled',
...
export const CHANGE_HISTORY_COLUMNS: Array<EuiBasicTableColumn<ChangeHistoryResult>> = [
  ...
  },
  {
    ...
    render: (value, record) => {
      ...
      if (value.includes('rule-update') && record.changes?.length) {
        const limit = 2;

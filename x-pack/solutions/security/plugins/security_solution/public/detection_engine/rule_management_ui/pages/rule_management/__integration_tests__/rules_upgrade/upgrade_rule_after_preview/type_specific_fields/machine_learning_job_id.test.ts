...
import { mockKibanaFetchResponse } from '../../mock/rule_upgrade_flyout';

describe('Upgrade rule after preview - "machine_learning_job_id" field', () => {
  describe.each([
    {

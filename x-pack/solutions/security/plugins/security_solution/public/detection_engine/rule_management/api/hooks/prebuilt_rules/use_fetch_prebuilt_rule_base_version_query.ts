...
import type { GetPrebuiltRuleBaseVersionResponseBody } from '@kbn/securitysolution-api';
import { GET_PREBUILT_RULES_BASE_VERSION_URL } from '@kbn/securitysolution-api';

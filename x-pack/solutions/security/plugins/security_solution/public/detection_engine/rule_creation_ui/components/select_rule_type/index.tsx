          ...
          {(!isUpdateView || querySelectableConfig.isSelected) && (
            <EuiFlexItem>
              <EuiCard
                ...
                icon={<EuiIcon size="xl" type="search" aria-hidden={true} />}
          ...
          {(!isUpdateView || thresholdSelectableConfig.isSelected) && (
            <EuiFlexItem>
              <EuiCard
                ...
                icon={<EuiIcon size="l" type="indexFlush" aria-hidden={true} />}
          ...
          {(!isUpdateView || eqlSelectableConfig.isSelected) && (
            <EuiFlexItem>
              <EuiCard
                ...
                icon={<EuiIcon size="l" type="eql" aria-hidden={true} />}
          ...
          {(!isUpdateView || threatMatchSelectableConfig.isSelected) && (
            <EuiFlexItem>
              <EuiCard
                ...
                icon={<EuiIcon size="l" type="list" aria-hidden={true} />}
          ...
          {(!isUpdateView || newTermsSelectableConfig.isSelected) && (
            <EuiFlexItem>
              <EuiCard
                ...
                icon={<EuiIcon size="l" type="magnifyWithPlus" aria-hidden={true} />}

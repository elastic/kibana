...
import { ENTITY_ANALYTICS_RISK_ANALYTICS } from '../../app/translations';
...
const EntityAnalyticsRiskAnalyticsComponent: React.FC = () => {
    ...
    <>
      {showEmptyPrompt ? (
        ...
        <>
          ...
          <SecuritySolutionPageWrapper data-test-subj="riskAnalyticsPage">
            <HeaderPage title={ENTITY_ANALYTICS_RISK_ANALYTICS} />

            {isSourcererLoading ? (
              <EuiLoadingSpinner size="l" data-test-subj="riskAnalyticsLoader" />
            ) : (
...
export const EntityAnalyticsRiskAnalyticsPage = React.memo(EntityAnalyticsRiskAnalyticsComponent);

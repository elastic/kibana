...
// privileged_user_monitoring/components/key_insights_panel/active_privileged_users_tile/active_privileged_users_tile.tsx
...
export const activePrivilegedUsersLensAttributes: LensAttributes = {
  ...
  state: {
    visualization: {
      ...
      palette: undefined, // Add palette if needed
      subtitle: undefined, // Add subtitle if needed
    },
    query: {
      query: 'event_type : "active_privileged_user"',
      language: 'kuery',
    },
    filters: [],
    datasourceStates: {
    ...
    <EuiFlexItem grow={false}>
      ...
      >
        <VisualizationEmbeddable
          ...
          lensAttributes={activePrivilegedUsersLensAttributes} // TODO: Replace with actual attributes

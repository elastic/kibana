...
import {
  BEHAVIORAL_ANOMALIES_V3_PROTOTYPE_ENTITY_ID,
  BEHAVIORAL_ANOMALIES_V3_TIME_RANGE,
} from './constants';
import type { EntityBehavioralAnomaliesV3Summary, HeatmapRecordV3 } from './types';

/** Total anomaly count shown in the flyout overview (design mock). */
export const MOCK_ANOMALY_V3_TOTAL_COUNT = 35;
 ...
 */
export const getPrototypeHeatmapRecordsV3 = (): HeatmapRecordV3[] => {
  const fromMs = resolveTimeMillis(BEHAVIORAL_ANOMALIES_V3_TIME_RANGE.from);
  const entityId = BEHAVIORAL_ANOMALIES_V3_PROTOTYPE_ENTITY_ID;
 ...
 */
export const getMockBehavioralAnomaliesV3Summary = (): EntityBehavioralAnomaliesV3Summary => ({
  totalCount: MOCK_ANOMALY_V3_TOTAL_COUNT,
  heatmapRecords: getPrototypeHeatmapRecordsV3(),
});

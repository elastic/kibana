...
export const RISK_SCORE_TITLE = (riskEntity: RiskScoreEntityType) =>
...
export const ENTITY_RISK_LEVEL = (riskEntity?: RiskScoreEntityType) =>
  riskEntity
...
export const getRiskEntityTranslationText = (
  riskEntity: RiskScoreEntityType | undefined,
  plural: boolean
) => {
  switch (riskEntity) {
    case RiskScoreEntityType.host:
      return plural ? HOSTS : HOST;
    case RiskScoreEntityType.user:

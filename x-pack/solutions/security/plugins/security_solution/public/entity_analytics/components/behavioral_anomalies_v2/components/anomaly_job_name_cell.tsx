...
import { useAnomalyV2SingleMetricViewerUrl } from '../hooks/use_anomaly_single_metric_viewer_url';
import type { BehavioralAnomalyV2TableRow } from '../types';
import { BEHAVIORAL_ANOMALIES_V2_TABLE_JOB_NAME_LINK_TEST_ID } from '../test_ids';
...
interface AnomalyJobNameCellV2Props {
 ...
 */
export const AnomalyJobNameCellV2: React.FC<AnomalyJobNameCellV2Props> = ({ row }) => {
    ...
    <EuiToolTip content={row.jobDisplayName} anchorProps={{ css: truncatedAnchorCss }}>
      <EuiText size="xs" component="span">
        <EuiLink
          ...
          target="_blank"
          external={false}
          data-test-subj={BEHAVIORAL_ANOMALIES_V2_TABLE_JOB_NAME_LINK_TEST_ID}
        >
          {row.jobDisplayName}
        </EuiLink>
      </EuiText>

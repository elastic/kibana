...
/**
 * Summary tab body for the metric-charts accordion: two equal-width panels
 * (Entities by, Sources), matching Alerts Summary layout.
 */
...
import { useRiskDonutChartData } from '../../../risk_score_donut_chart/use_risk_donut_chart_data';
 ...
 * Summary panels use 16px (`size.m`) instead.
 */
...
const SummaryRiskDonut: React.FC<{ severityCount: ReturnType<typeof getSummaryRiskLevelCounts> }> = ({
  ...
  const [donutChartData, , total] = useRiskDonutChartData(severityCount);
...
const EntitiesByPanel: React.FC<{

...
/**
 * Shared mock corpus for facelift v.3.
 *
 * UI under `./` is an independent snapshot (copy of v.2) so engineers can take
 ...
 *
 * To detach v.3 later: replace this re-export with a local copy of `../v2/data`

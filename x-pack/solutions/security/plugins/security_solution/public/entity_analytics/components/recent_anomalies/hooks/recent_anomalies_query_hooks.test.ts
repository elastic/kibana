...
import { getLatestEntitiesAlias } from '@kbn/entity-store/common';
...
jest.mock('@kbn/entity-store/common', () => ({ getLatestEntitiesAlias: jest.fn() }));
...
const mockGetLatestEntitiesAlias = getLatestEntitiesAlias as jest.Mock;
...
describe('useRecentAnomaliesQuery', () => {
  beforeEach(() => {
    ...
    mockGetLatestEntitiesAlias.mockReturnValue('entities-latest-default');

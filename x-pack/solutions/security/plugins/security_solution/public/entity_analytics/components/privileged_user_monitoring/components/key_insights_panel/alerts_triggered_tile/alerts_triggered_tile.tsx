...
export const AlertsTriggeredTile: React.FC<{ spaceId: string; sourcerDataView: DataViewSpec }> = ({
  spaceId,
  sourcerDataView,
}) => {
  return (
    <KeyInsightsTile
      ...
      getEsqlQuery={(namespace) => getAlertsTriggeredEsqlCount(namespace, sourcerDataView)}

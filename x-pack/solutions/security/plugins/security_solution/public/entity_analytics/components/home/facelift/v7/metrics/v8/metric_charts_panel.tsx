...
export interface MetricChartsPanelV8Props {
...
/**
 * Metrics version v.8 — based on v.7, with the dimming of unselected metric
 * tiles removed: activating one tile leaves the others looking default.
 */
export const MetricChartsPanelV8: React.FC<MetricChartsPanelV8Props> = ({
  activeFilter,
  cards,
  pageFilters,
  tableView,

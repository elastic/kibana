...
const SESSION_STORAGE_FIELDS_MODAL_SHOW_SELECTED = 'entityAnalytics:fieldsModal:showSelected';
...
const VIEW_LABEL = i18n.translate(
  'xpack.securitySolution.entityAnalytics.entitiesTable.fieldsModal.viewLabel',
  {
    defaultMessage: 'View',
  }
);
...
const VIEW_VALUE_SELECTED = i18n.translate(
  'xpack.securitySolution.entityAnalytics.entitiesTable.fieldsModal.viewSelected',
  {
...
const VIEW_VALUE_ALL = i18n.translate(
  'xpack.securitySolution.entityAnalytics.entitiesTable.fieldsModal.viewAll',
  {
    defaultMessage: 'all',
  }
);
...
export const FieldsSelectorTable = ({
  ...
  const tableColumns: Array<EuiBasicTableColumn<Field>> = [
    {
      ...
      render: (_, { id }: Field) => (
        <EuiCheckbox
          ...
          id={`entity-analytics-fields-selector-item-${id}`}
          data-test-subj={`entity-analytics-fields-selector-item-${id}`}
          onChange={(e) => {
    ...
    {
      field: 'name',
      name: i18n.translate('xpack.securitySolution.entityAnalytics.entitiesTable.fieldsModalName', {
        defaultMessage: 'Name',
      }),
      sortable: true,
    },
  ...
  const error = useMemo(() => {
    if (!dataView || dataView.fields?.length === 0) {
      return i18n.translate(
        'xpack.securitySolution.entityAnalytics.entitiesTable.fieldsModalError',
        {
  ...
  const search: EuiSearchBarProps = {
    ...
    box: {
      ...
      placeholder: i18n.translate(
        'xpack.securitySolution.entityAnalytics.entitiesTable.fieldsModalSearch',
        {
  ...
  const tableHeader = useMemo(() => {
    ...
    return (
      <EuiFlexGroup>
        <EuiFlexItem>
          <EuiText data-test-subj="entityAnalytics:dataTable:fieldsModal:fieldsShowing" size="xs">
            <FormattedMessage
              id="xpack.securitySolution.entityAnalytics.entitiesTable.fieldsModalFieldsShowing"
              defaultMessage="Showing"
            />{' '}
            <strong data-test-subj="entityAnalytics:dataTable:fieldsModal:fieldsCount">
              {totalFields}
            </strong>{' '}
            <FormattedMessage
              id="xpack.securitySolution.entityAnalytics.entitiesTable.fieldsModalFieldsCount"

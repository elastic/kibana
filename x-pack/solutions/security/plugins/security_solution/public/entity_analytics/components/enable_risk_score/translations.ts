...
export const UPGRADE_RISK_SCORE = (riskEntity: RiskScoreEntityType) =>
...
export const ENABLE_RISK_SCORE = (riskEntity: RiskScoreEntityType) =>
...
export const ENABLE_RISK_SCORE_DESCRIPTION = (riskEntity: RiskScoreEntityType) =>

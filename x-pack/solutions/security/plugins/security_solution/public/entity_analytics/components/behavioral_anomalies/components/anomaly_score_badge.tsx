...
// Matches the risk-score badge palette in `RiskScoreCell` so anomaly scores
// look visually identical to risk scores. Score thresholds remain the standard
// ML anomaly buckets (3/25/50/75/100).

...
/**
 * Metrics version v.2 — duplicate of v.1 (Entities-by pie 40% + metrics grid 60%).
 * Edit freely; this folder is isolated from other metrics versions.
 */

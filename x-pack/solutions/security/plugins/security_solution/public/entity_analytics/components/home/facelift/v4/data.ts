...
/**
 * Shared mock corpus for facelift v.4.
 *
 * UI under `./` is an independent snapshot (copy of v.3) so engineers can take
 ...
 *
 * To detach v.4 later: replace this re-export with a local copy of `../v2/data`

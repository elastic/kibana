...
interface TimelineRowLabelV2 {
  id: string;
  label: string;
}

interface TimelineRowLabelsV2Props {
  rows: TimelineRowLabelV2[];
  compressed?: boolean;
}

export const TimelineRowLabelsV2: React.FC<TimelineRowLabelsV2Props> = ({
  rows,
  compressed = false,
}) => {

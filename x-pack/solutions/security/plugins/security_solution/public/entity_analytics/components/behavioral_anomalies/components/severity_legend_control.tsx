...
import { getSeverityRangeDisplay } from '../hooks/use_severity_options';
import { BEHAVIORAL_ANOMALIES_SEVERITY_LEGEND_TEST_ID } from '../test_ids';

/**
 * Local prototype copy of the ML Anomaly Explorer's `SeverityLegendControl`
...
export interface SeverityLegendControlProps {
...
export const SeverityLegendControl: FC<SeverityLegendControlProps> = ({
  allSeverityOptions,
  selectedSeverities,
  onChange,
  dataTestSubj = BEHAVIORAL_ANOMALIES_SEVERITY_LEGEND_TEST_ID,
}) => {
          ...
          <EuiFlexItem key={severity.val} grow={false}>
            <EuiButtonEmpty
              ...
              aria-label={i18n.translate(
                'xpack.securitySolution.entityAnalytics.behavioralAnomalies.severityLegendControl.anomalyScoreButtonLabel',
                {
  ...
  return (
    <EuiFormControlLayout
      ...
      prepend={i18n.translate(
        'xpack.securitySolution.entityAnalytics.behavioralAnomalies.severityLegendControl.anomalyScoreLabel',

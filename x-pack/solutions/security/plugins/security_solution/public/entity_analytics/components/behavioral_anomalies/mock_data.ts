...
import {
  BEHAVIORAL_ANOMALIES_PROTOTYPE_ENTITY_ID,
...
export const MOCK_ANOMALY_TOTAL_COUNT = 35;
 ...
 */
export const getPrototypeHeatmapRecords = (): HeatmapRecord[] => {
  const fromMs = resolveTimeMillis(BEHAVIORAL_ANOMALIES_TIME_RANGE.from);
 ...
 */
export const getMockBehavioralAnomaliesSummary = (): EntityBehavioralAnomaliesSummary => ({
  totalCount: MOCK_ANOMALY_TOTAL_COUNT,
  heatmapRecords: getPrototypeHeatmapRecords(),
});

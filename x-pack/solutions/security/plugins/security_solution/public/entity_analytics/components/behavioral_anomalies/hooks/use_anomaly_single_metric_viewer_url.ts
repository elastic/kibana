...
/**
 * Build a "Single metric viewer" URL targeting a specific anomaly row.
 *
 * Returns `undefined` when the ML plugin is not available, so the caller
 * can decide whether to render a link / fall back to a plain label.
 */

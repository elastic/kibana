...
interface BehavioralAnomaliesV2SwimlaneProps {
...
/**
 * BA-v.2 prototype anomaly swim lane. The chart window and x-axis bucket size
 ...
 */
export const BehavioralAnomaliesV2Swimlane: React.FC<BehavioralAnomaliesV2SwimlaneProps> = ({
  records,
  anomalyBands,
  entityNames,
  entityAccessor,
    ...
    >
      <Chart>
        ...
        <Heatmap
          ...
          data={records}
          name={i18n.translate(
            'xpack.securitySolution.entityAnalytics.behavioralAnomaliesV2.heatmap.maxAnomalyScore',
            { defaultMessage: 'Max anomaly score' }
          )}
          xAccessor="@timestamp"
          xAxisLabelName={i18n.translate(
            'xpack.securitySolution.entityAnalytics.behavioralAnomaliesV2.heatmap.xAxis',
            { defaultMessage: 'Date' }
          )}

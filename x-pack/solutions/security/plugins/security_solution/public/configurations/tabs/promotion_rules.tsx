...
import { useBootstrapPromotionRules } from './promotion_rules/use_bootstrap_promotion_rules';

export const PromotionRules: React.FC = () => {
  // Bootstrap promotion rules when this EASE-specific component mounts

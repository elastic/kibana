...
export const InstalledIntegrationsPage = React.memo<IntegrationsPageProps>(
      ...
      <EuiFlexGroup direction="column" gutterSize="none">
        ...
        <EuiFlexGroup>
          <IntegrationViewFacets
            ...
            selectedFacet={IntegrationsFacets.installed}
          />
          <EuiFlexItem
            css={css`
              max-width: 1200px;
...
InstalledIntegrationsPage.displayName = 'InstalledIntegrationsPage';

export const IntegrationsInstalledView = withLazyHook(InstalledIntegrationsPage, () =>
  import('@kbn/fleet-plugin/public').then((module) => module.AvailablePackagesHook())
);
IntegrationsInstalledView.displayName = 'IntegrationsInstalledView';

      ...
      <EuiPageSection>
        <EuiEmptyPrompt
          ...
          body={
            <EuiText>
              <p>
                This page is a placeholder for the SIEM Readiness Dashboard, which is currently
                under development.
              </p>
              <p>
                It will help you get a comprehensive view of your security posture and guide you
                through key steps to improve your readiness.
              </p>
            </EuiText>
          }
        />

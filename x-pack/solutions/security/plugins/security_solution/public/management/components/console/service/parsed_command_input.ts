...
export const getArgumentsForCommand = (command: CommandDefinition): string[] => {
  // TODO:PT refactor needed. Remove this utility in favor of `buildCommandUsageList` under `x-pack/solutions/security/plugins/security_solution/public/management/components/console/service/utils.ts`

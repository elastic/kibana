...
export const getPolicySettingsFormTestSubjects = (
  ...
  return {
    ...
    malware: {
      ...
      windowsModeSelect: malwareTestSubj('windowsModeSelect'),
      macModeSelect: malwareTestSubj('macModeSelect'),
      linuxModeSelect: malwareTestSubj('linuxModeSelect'),
      windowsNotifyUserCheckbox: malwareTestSubj('windowsNotifyUser-checkbox'),
      macNotifyUserCheckbox: malwareTestSubj('macNotifyUser-checkbox'),
      linuxNotifyUserCheckbox: malwareTestSubj('linuxNotifyUser-checkbox'),
    ...
    ransomware: {
      ...
      windowsModeSelect: ransomwareTestSubj('windowsModeSelect'),
      macModeSelect: ransomwareTestSubj('macModeSelect'),
      linuxModeSelect: ransomwareTestSubj('linuxModeSelect'),
      windowsNotifyUserCheckbox: ransomwareTestSubj('windowsNotifyUser-checkbox'),
      macNotifyUserCheckbox: ransomwareTestSubj('macNotifyUser-checkbox'),
      linuxNotifyUserCheckbox: ransomwareTestSubj('linuxNotifyUser-checkbox'),
    ...
    memory: {
      ...
      windowsModeSelect: memoryTestSubj('windowsModeSelect'),
      macModeSelect: memoryTestSubj('macModeSelect'),
      linuxModeSelect: memoryTestSubj('linuxModeSelect'),
      windowsNotifyUserCheckbox: memoryTestSubj('windowsNotifyUser-checkbox'),
      macNotifyUserCheckbox: memoryTestSubj('macNotifyUser-checkbox'),
      linuxNotifyUserCheckbox: memoryTestSubj('linuxNotifyUser-checkbox'),
    ...
    behaviour: {
      ...
      windowsModeSelect: behaviourTestSubj('windowsModeSelect'),
      macModeSelect: behaviourTestSubj('macModeSelect'),
      linuxModeSelect: behaviourTestSubj('linuxModeSelect'),
      reputationServiceCheckbox: behaviourTestSubj('windowsReputationService-switch'),
      windowsNotifyUserCheckbox: behaviourTestSubj('windowsNotifyUser-checkbox'),
      macNotifyUserCheckbox: behaviourTestSubj('macNotifyUser-checkbox'),
      linuxNotifyUserCheckbox: behaviourTestSubj('linuxNotifyUser-checkbox'),
    ...
    eventCollection: {
      card: eventCollectionTestSubj(),
      osValueContainer: eventCollectionTestSubj('osValueContainer'),
      windowsRow: eventCollectionTestSubj('windowsRow'),
      macRow: eventCollectionTestSubj('macRow'),
      linuxRow: eventCollectionTestSubj('linuxRow'),
      windowsOptionsContainer: eventCollectionTestSubj('windows-options'),
      macOptionsContainer: eventCollectionTestSubj('mac-options'),
      linuxOptionsContainer: eventCollectionTestSubj('linux-options'),
      windows: {
        credentialsCheckbox: eventCollectionTestSubj('windows-credential_access'),
        dllCheckbox: eventCollectionTestSubj('windows-dll_and_driver_load'),
        dnsCheckbox: eventCollectionTestSubj('windows-dns'),
        fileCheckbox: eventCollectionTestSubj('windows-file'),
        networkCheckbox: eventCollectionTestSubj('windows-network'),
        processCheckbox: eventCollectionTestSubj('windows-process'),
        registryCheckbox: eventCollectionTestSubj('windows-registry'),
        securityCheckbox: eventCollectionTestSubj('windows-security'),
      },
      mac: {
        dnsCheckbox: eventCollectionTestSubj('mac-dns'),
        fileCheckbox: eventCollectionTestSubj('mac-file'),
        networkCheckbox: eventCollectionTestSubj('mac-network'),
        processCheckbox: eventCollectionTestSubj('mac-process'),
        securityCheckbox: eventCollectionTestSubj('mac-security'),
      },
      linux: {
        dnsCheckbox: eventCollectionTestSubj('linux-dns'),
        fileCheckbox: eventCollectionTestSubj('linux-file'),
        networkCheckbox: eventCollectionTestSubj('linux-network'),
        processCheckbox: eventCollectionTestSubj('linux-process'),
        sessionDataSwitch: eventCollectionTestSubj('linux-session_data'),
        captureTerminalCheckbox: eventCollectionTestSubj('linux-tty_io'),
      },
    },
    antivirusRegistration: {
      card: antivirusTestSubj(),
      modeSelect: antivirusTestSubj('modeSelect'),
    ...
    deviceControl: {
      ...
      windowsAccessLevel: deviceControlTestSubj('windowsAccessLevel'),
      macAccessLevel: deviceControlTestSubj('macAccessLevel'),

...
import type { ScriptTagKey } from '../../../../../../common/endpoint/service/script_library/constants';
import { SCRIPT_TAGS } from '../../../../../../common/endpoint/service/script_library/constants';
...
interface GetScriptLibraryTableColumnsProps {
  queryParams: ScriptLibraryTableProps['queryParams'];
  formatBytes: (bytes: number) => string;
  getTestId: (suffix?: string | undefined) => string | undefined;
  onClickAction: ScriptLibraryTableProps['onClickAction'];
}

const getScriptLibraryTableColumns = ({
  formatBytes,
  queryParams,
  getTestId,
  onClickAction,
}: GetScriptLibraryTableColumnsProps) => {
  const columns = [
    {
      field: 'name',
...
export interface ScriptLibraryTableProps {
  'data-test-subj'?: string;
  error?: string;
  isLoading?: boolean;
  items: ScriptItems;
...
export const ScriptLibraryTable = memo<ScriptLibraryTableProps>(
  ({
...
ScriptLibraryTable.displayName = 'ScriptLibraryTable';

...
export const AdvancedPolicySchema: AdvancedPolicySchemaType[] = [
  ...
  },
  {
    ...
    documentation: i18n.translate(
      ...
      {
        defaultMessage:
          '[WARNING: this can break applications and macOS updates] Filter out file backed images mounted from internal drive from consideration by device control. Default: true.',
      }
    ),
  },
  {

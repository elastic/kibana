...
export const AdvancedPolicySchema: AdvancedPolicySchemaType[] = [
  ...
  },
  {
    ...
    documentation: i18n.translate(
      ...
      {
        defaultMessage:
          "Control whether kprobes, eBPF or Quark is used to gather data. Options are 'kprobe', 'ebpf', 'quark' or 'auto'. auto uses quark if possible (and supported), then tries legacy ebpf, and otherwise it uses kprobe. Quark is supported by Elastic Defend versions 9.3 (and newer) and 8.19.10 (and newer). Default: auto.",
      }
    ),
  },
  {

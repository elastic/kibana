...
```shell
yarn --cwd x-pack/solutions/security/solutions/security/plugins/security_solution
...
yarn --cwd x-pack/solutions/security/solutions/security/plugins/security_solution cypress:dw:run

# or against Serverless
yarn --cwd x-pack/solutions/security/solutions/security/plugins/security_solution cypress:dw:serverless:run
```
...
# launch the cypress test runner against ESS
yarn --cwd x-pack/solutions/security/solutions/security/plugins/security_solution cypress:dw:open

# or against Serverless
yarn --cwd x-pack/solutions/security/solutions/security/plugins/security_solution cypress:dw:serverless:open
```

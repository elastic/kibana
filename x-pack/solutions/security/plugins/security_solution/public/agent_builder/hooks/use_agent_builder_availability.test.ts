...
describe('useAgentBuilderAvailability', () => {
  ...
  it('returns hasValidAgentBuilderLicense true when serverless tier is complete', () => {
    mockUseKibana.mockReturnValue({
      services: {
        application: {
          capabilities: {
    ...
    expect(result.current.hasValidAgentBuilderLicense).toBe(true);
  });

  it('returns hasValidAgentBuilderLicense true when serverless tier is search_ai_lake', () => {
    mockUseKibana.mockReturnValue({
      services: {
        application: {
          capabilities: {
  ...
  it('returns hasValidAgentBuilderLicense false when serverless tier is essentials', () => {
    mockUseKibana.mockReturnValue({
      services: {
        application: {
          capabilities: {

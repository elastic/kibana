...
import { buildHostNamesFilter, buildUserNamesFilter, type RiskSeverity } from '../../../common/search_strategy';
...
import { useEntityPanelTabs, TABLE_TAB_ID } from '../../flyout/entity_details/shared/hooks/use_entity_panel_tabs';
...
import { HostPanelKey, ServicePanelKey, UserPanelKey } from '../../flyout/entity_details/shared/constants';
import type { EntityDetailsPath } from '../../flyout/entity_details/shared/components/left_panel/left_panel_header';
import { EntityEventTypes } from '../../common/lib/telemetry';
import { EntityType as SearchEntityType } from '../../../common/search_strategy';
...
const UserEntityFlyoutOverviewCanvas: React.FC<{
  ...
  chrome?: SecurityAgentBuilderChrome;
  openSidebarConversation?: () => void;
}> = ({ userName, entityId: entityIdProp, application, agentBuilder, chrome, openSidebarConversation }) => {
  const euidApi = useEntityStoreEuidApi();
  const entityStoreV2Enabled = useUiSetting<boolean>(FF_ENABLE_ENTITY_STORE_V2, false);
...
export const EntityCardFlyoutOverviewCanvas: React.FC<{
  ...
  const exploreRow = { entity_type: entityType, entity_id: entityId, entity_name: entityName, source };

...
import {
  ...
  type SeverityLevel,
  type SubscriptionConfirmationPayload,
  ...
  const handleSubmit = useCallback(async () => {
    if (form.tags.length === 0 || !form.delivery_target.trim()) {
      setSubmitState({
        ...
        message: i18n.translate(
          'xpack.securitySolution.threatIntelligence.attachments.subscriptionConfirmation.validationRequired',
          {
            defaultMessage:
    ...
    try {
      ...
      const message =
        ...
        i18n.translate(
          'xpack.securitySolution.threatIntelligence.attachments.subscriptionConfirmation.submitFailed',
  ...
  return (
    <EuiPanel hasBorder paddingSize="m">
      <EuiTitle size="xs">
        <h4>
          {i18n.translate(
            'xpack.securitySolution.threatIntelligence.attachments.subscriptionConfirmation.title',
            {
      ...
      {initial.template_id ? (
        <EuiText size="xs" color="subdued">
          {i18n.translate(
            'xpack.securitySolution.threatIntelligence.attachments.subscriptionConfirmation.templateNote',
            {
      ...
      <EuiFormRow
        label={i18n.translate(
          'xpack.securitySolution.threatIntelligence.attachments.subscriptionConfirmation.tagsLabel',
          { defaultMessage: 'Tags' }
        )}
        fullWidth
      >
        <EuiComboBox
          ...
          placeholder={i18n.translate(
            'xpack.securitySolution.threatIntelligence.attachments.subscriptionConfirmation.tagsPlaceholder',
      ...
      <EuiFlexGroup gutterSize="s">
        <EuiFlexItem>
          <EuiFormRow
            label={i18n.translate(
              'xpack.securitySolution.threatIntelligence.attachments.subscriptionConfirmation.severityLabel',
        ...
        <EuiFlexItem>
          <EuiFormRow
            label={i18n.translate(
              'xpack.securitySolution.threatIntelligence.attachments.subscriptionConfirmation.scheduleLabel',
      ...
      <EuiFormRow
        label={i18n.translate(
          'xpack.securitySolution.threatIntelligence.attachments.subscriptionConfirmation.scheduleRawLabel',
      ...
      <EuiFlexGroup gutterSize="s">
        <EuiFlexItem grow={1}>
          <EuiFormRow
            label={i18n.translate(
              'xpack.securitySolution.threatIntelligence.attachments.subscriptionConfirmation.deliveryTypeLabel',
        ...
        <EuiFlexItem grow={2}>
          <EuiFormRow
            label={i18n.translate(
              'xpack.securitySolution.threatIntelligence.attachments.subscriptionConfirmation.deliveryTargetLabel',
      ...
      <EuiFormRow
        label={i18n.translate(
          'xpack.securitySolution.threatIntelligence.attachments.subscriptionConfirmation.deliveryConnectorLabel',
          { defaultMessage: 'Delivery connector id (optional)' }
        )}
        helpText={i18n.translate(
          'xpack.securitySolution.threatIntelligence.attachments.subscriptionConfirmation.deliveryConnectorHelp',
          {
            defaultMessage:
      ...
      >
        <EuiFieldText
          ...
          placeholder={i18n.translate(
            'xpack.securitySolution.threatIntelligence.attachments.subscriptionConfirmation.deliveryConnectorPlaceholder',
        ...
        <>
          ...
          <EuiCallOut
            ...
            title={i18n.translate(
              'xpack.securitySolution.threatIntelligence.attachments.subscriptionConfirmation.errorTitle',
      ...
      {submitState.kind === 'submitted' ? (
        <>
          ...
          <EuiCallOut
            ...
            size="s"
            title={i18n.translate(
              'xpack.securitySolution.threatIntelligence.attachments.subscriptionConfirmation.submittedTitle',
              { defaultMessage: 'Subscription created' }
            )}
          >
            {i18n.translate(
              'xpack.securitySolution.threatIntelligence.attachments.subscriptionConfirmation.submittedBody',
              {
...
export const buildSubscriptionConfirmationUiDefinition = (
  ...
  getLabel: (attachment) =>
    ...
    i18n.translate(
      'xpack.securitySolution.threatIntelligence.attachments.subscriptionConfirmation.label',
      {
  ...
  getActionButtons: ({ attachment }) => [
    {
      label: i18n.translate(
        'xpack.securitySolution.threatIntelligence.attachments.subscriptionConfirmation.subscribeAction',
    ...
    {
      label: i18n.translate(
        'xpack.securitySolution.threatIntelligence.attachments.subscriptionConfirmation.cancelAction',

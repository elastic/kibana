...
describe('registerAttachmentUiDefinitions', () => {
  ...
  it('registers entity attachment type with correct config', async () => {
    registerAttachmentUiDefinitions({ attachments: mockAttachments });

...
export const integrationsSearchAILakeCardConfig: OnboardingCardConfig<IntegrationCardMetadata> = {
  id: OnboardingCardId.integrationsSearchAILake,
  title: i18n.translate('xpack.securitySolution.onboarding.integrationsSearchAILakeCard.title', {
  ...
  Component: React.lazy(
    () =>
      import(
        /* webpackChunkName: "onboarding_search_ai_lake_integrations_card" */
        './integrations_card'
      )
  ),

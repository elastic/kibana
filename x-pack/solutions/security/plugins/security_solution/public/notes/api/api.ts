...
/**
 * Adds a new note.
 * This code is very close to the persistNote found in x-pack/solutions/security/solutions/security/plugins/security_solution/public/timelines/containers/notes/api.ts.

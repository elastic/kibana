...
export const LAST_SEEN_TOOLTIP_ARIA_LABEL = i18n.translate(
  'xpack.securitySolution.hostsTable.lastSeenToolTipAriaLabel',
  {
    defaultMessage: 'More information about the last seen column',
  }
);

...
describe('User authentications KPI', () => {
  ...
  it('renders correctly', () => {
    render(<UsersKpiAuthentications from={from} to={to} />, {
      wrapper: TestProviders,
    });
    expect(MockKpiBaseComponent.mock.calls[0][0].statItems).toEqual(authenticationsStatItems);

...
export interface RegularQueryTabHeaderProps {
...
const RegularQueryTabHeaderComponent: React.FC<RegularQueryTabHeaderProps> = ({
  activeTab,
  currentIndices,
  dataViewId,
  filterManager,
  ...
  const { timelineEventsCountPortalNode, shouldShowQueryBuilder } =
    useQueryTabHeaderData(timelineId);
...
export const RegularQueryTabHeader = React.memo(RegularQueryTabHeaderComponent);

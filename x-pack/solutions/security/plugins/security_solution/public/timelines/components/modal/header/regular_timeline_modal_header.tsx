...
import { TimelinePanel, VerticalDivider, autoOverflowXCSS, whiteSpaceNoWrapCSS } from './styles';
...
export const RegularTimelineModalHeader = React.memo<TimelineModalHeaderBaseProps>(
...
RegularTimelineModalHeader.displayName = 'RegularTimelineModalHeader';

      ...
      >
        <p css={calloutDescriptionWidth}>
          <FormattedMessage
            ...
            defaultMessage="You can now schedule scans, generate attacks manually, and view validated attacks from Detections -> Attacks. This Attack Discovery page will be removed in the next release."
          />
        </p>

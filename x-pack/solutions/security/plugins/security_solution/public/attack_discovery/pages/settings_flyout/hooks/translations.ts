...
export const SETTINGS_TAB_LABEL = i18n.translate(
  'xpack.securitySolution.attackDiscovery.settingsFlyout.tabs.settingsTabLabel',
  {
    defaultMessage: 'Settings',
  }
);

export const SCHEDULE_TAB_LABEL = i18n.translate(

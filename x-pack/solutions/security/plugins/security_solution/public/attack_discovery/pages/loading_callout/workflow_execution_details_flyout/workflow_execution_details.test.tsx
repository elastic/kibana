...
describe('WorkflowExecutionDetails', () => {
  ...
  describe('flyout chrome', () => {
    it('does NOT render an EuiFlyout wrapper (renders inner content only)', () => {
      render(
        <TestProviders>
          <WorkflowExecutionDetails {...defaultProps} />
        </TestProviders>
      );
    ...
    it('does NOT render a flyout close button', () => {
      render(
        <TestProviders>
          <WorkflowExecutionDetails {...defaultProps} />
        </TestProviders>
  ...
  describe('LoadingCallout integration', () => {
    ...
    it('renders LoadingCallout with hideActions set to true', () => {
      ...
      expect(screen.getByTestId('loadingCallout')).toHaveAttribute('data-hide-actions', 'true');
    });
  });
  ...
  describe('hook integration', () => {
    ...
    it('handles null workflowRunId', () => {
      render(
        <TestProviders>
          <WorkflowExecutionDetails {...defaultProps} workflowRunId={null} />
        </TestProviders>
      );
    ...
    it('handles undefined workflowRunId', () => {
      render(
        <TestProviders>
          <WorkflowExecutionDetails {...defaultProps} workflowRunId={undefined} />
        </TestProviders>
      );
    ...
    it('prefers the live generation status over the generationStatus prop', () => {
      mockUseGetAttackDiscoveryGeneration.mockReturnValue({
      ...
      render(
        <TestProviders>
          <WorkflowExecutionDetails {...defaultProps} generationStatus="started" />
        </TestProviders>
      );

      expect(mockUseWorkflowExecutionDetails).toHaveBeenCalledWith(
        expect.objectContaining({
          stubData: expect.objectContaining({ generationStatus: 'succeeded' }),
        })
      );
    });
  });
  ...
  describe('refresh button', () => {
    ...
    it('does NOT render the Refresh button when generationStatus is undefined', () => {
      render(
        <TestProviders>
          <WorkflowExecutionDetails {...defaultProps} onRefresh={mockOnRefresh} />
        </TestProviders>
      );
    ...
    it('does NOT render the Refresh button when onRefresh is not provided', () => {
      render(
        <TestProviders>
          <WorkflowExecutionDetails {...defaultProps} generationStatus="succeeded" />
        </TestProviders>
      );
  ...
  describe('usePipelineData integration', () => {
    ...
    it('calls usePipelineData with isEnabled=false when generationStatus is undefined', () => {
      render(
        <TestProviders>
          <WorkflowExecutionDetails {...defaultProps} generationStatus={undefined} />
        </TestProviders>
      );
  ...
  describe('FailureSection rendering', () => {
    it('renders FailureSection when generationStatus is failed', () => {
      render(
        <TestProviders>
          <WorkflowExecutionDetails {...defaultProps} generationStatus="failed" />
        </TestProviders>
      );
    ...
    it('renders FailureSection when generationStatus is canceled', () => {
      render(
        <TestProviders>
          <WorkflowExecutionDetails {...defaultProps} generationStatus="canceled" />
        </TestProviders>
      );
    ...
    it('renders FailureSection when generationStatus is dismissed', () => {
      render(
        <TestProviders>
          <WorkflowExecutionDetails {...defaultProps} generationStatus="dismissed" />
        </TestProviders>
      );
  ...
  describe('prop forwarding to FailureSection', () => {
    ...
    it('passes sourceMetadata to FailureSection', () => {
      ...
      render(
        <TestProviders>
          <WorkflowExecutionDetails {...failedProps} sourceMetadata={sourceMetadata} />
        </TestProviders>
      );
    ...
    it('passes averageSuccessfulDurationMs to FailureSection', () => {
      render(
        <TestProviders>
          <WorkflowExecutionDetails {...failedProps} averageSuccessfulDurationMs={1500} />
        </TestProviders>
      );
    ...
    it('passes configuredMaxAlerts to FailureSection', () => {
      render(
        <TestProviders>
          <WorkflowExecutionDetails {...failedProps} configuredMaxAlerts={200} />
        </TestProviders>
      );
    ...
    it('passes connectorActionTypeId to FailureSection', () => {
      render(
        <TestProviders>
          <WorkflowExecutionDetails {...failedProps} connectorActionTypeId=".bedrock" />
        </TestProviders>
      );
    ...
    it('passes connectorModel to FailureSection', () => {
      render(
        <TestProviders>
          <WorkflowExecutionDetails {...failedProps} connectorModel="claude-3-5" />
        </TestProviders>
      );
    ...
    it('passes dateRangeEnd to FailureSection', () => {
      render(
        <TestProviders>
          <WorkflowExecutionDetails {...failedProps} dateRangeEnd="2025-01-15T10:00:00.000Z" />
        </TestProviders>
      );
    ...
    it('passes dateRangeStart to FailureSection', () => {
      render(
        <TestProviders>
          <WorkflowExecutionDetails {...failedProps} dateRangeStart="2025-01-14T10:00:00.000Z" />
        </TestProviders>
      );
    ...
    it('passes duplicatesDroppedCount to FailureSection', () => {
      render(
        <TestProviders>
          <WorkflowExecutionDetails {...failedProps} duplicatesDroppedCount={5} />
        </TestProviders>
      );
    ...
    it('passes generatedCount to FailureSection', () => {
      render(
        <TestProviders>
          <WorkflowExecutionDetails {...failedProps} generatedCount={12} />
        </TestProviders>
      );
    ...
    it('passes hallucinationsFilteredCount to FailureSection', () => {
      render(
        <TestProviders>
          <WorkflowExecutionDetails {...failedProps} hallucinationsFilteredCount={4} />
        </TestProviders>
      );
    ...
    it('passes persistedCount to FailureSection', () => {
      render(
        <TestProviders>
          <WorkflowExecutionDetails {...failedProps} persistedCount={8} />
        </TestProviders>
      );
    ...
    it('passes perWorkflowAlertRetrieval extracted from pipelineData to FailureSection', () => {
      ...
      render(
        <TestProviders>
          <WorkflowExecutionDetails {...failedProps} />
        </TestProviders>
      );
  ...
  describe('awaiting validation data polling', () => {
    // Validation tracking present so the content knows a validation workflow ran.

...
import { UserPreviewPanelKeyV2 } from '../../entity_details/user_right';
import { USER_PREVIEW_BANNER } from '../../document_details/right/components/user_entity_overview';
import {
  NETWORK_PREVIEW_BANNER,
  NetworkPanelKeyV2,
  NetworkPreviewPanelKeyV2,
} from '../../network_details';
import {
  RULE_PREVIEW_BANNER,
  RulePanelKeyV2,
  RulePreviewPanelKeyV2,
} from '../../rule_details/right';
import { DocumentDetailsPreviewPanelKeyV2 } from '../../document_details/shared/constants/panel_keys';

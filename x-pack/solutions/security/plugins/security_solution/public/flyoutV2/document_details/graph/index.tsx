...
import {
  ...
  GraphGroupedNodePreviewPanelKeyV2,
...
import { DocumentDetailsPreviewPanelKeyV2 } from '../shared/constants/panel_keys';
import {
...
import { GenericEntityPanelKeyV2 } from '../../entity_details/shared/constants';
  ...
  const onOpenEventPreview = useCallback(
    (node: NodeViewModel) => {
      ...
      if ((docMode === 'single-event' || docMode === 'single-alert') && singleDocumentData) {
        ...
        openChildPanel(
          {
            id: GraphGroupedNodePreviewPanelKeyV2,
            params: {
              id: node.id,
              scopeId,
              isPreviewMode: true,

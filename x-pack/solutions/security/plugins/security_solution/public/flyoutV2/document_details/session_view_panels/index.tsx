...
import { type FlyoutPanelProps, type PanelPath, useFlyoutApi } from '@kbn/flyout';
...
import { DocumentDetailsSessionViewPanelKeyV2 } from '../shared/constants/panel_keys';
...
export interface SessionViewPanelProps extends FlyoutPanelProps {
  key: typeof DocumentDetailsSessionViewPanelKeyV2;
  path?: PanelPath;
  params: {
    eventId: string;
    indexName: string;

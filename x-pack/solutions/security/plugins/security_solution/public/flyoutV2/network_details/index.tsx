...
export const NetworkPanelKeyV2: NetworkExpandableFlyoutProps['key'] = 'network-details-v2';
export const NetworkPreviewPanelKeyV2: NetworkExpandableFlyoutProps['key'] = 'network-preview-v2';

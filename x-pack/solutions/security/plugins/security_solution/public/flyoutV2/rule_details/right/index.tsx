...
export const RulePanelKeyV2: RulePanelExpandableFlyoutProps['key'] = 'rule-panel-v2';
export const RulePreviewPanelKeyV2: RulePanelExpandableFlyoutProps['key'] = 'rule-preview-panel-v2';

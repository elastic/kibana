...
export const getRuleMetadataStepDefinition: PublicStepDefinition = {
  ...
  documentation: {
    details: i18n.translate(
      'xpack.securitySolution.workflows.steps.getRuleMetadata.documentation.details',
      {
        defaultMessage:
          'Retrieves metadata about a rule including its name, description, category, severity, and MITRE ATT&CK mappings.',
      }
    ),
    examples: [
      `## Get rule metadata

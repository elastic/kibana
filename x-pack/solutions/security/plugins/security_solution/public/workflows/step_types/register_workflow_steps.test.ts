...
describe('registerWorkflowSteps (public)', () => {
  ...
  it('async loader returns step definitions when feature flag is enabled', async () => {
    ...
    const [loader1, loader2, loader3, loader4, loader5] =
    ...
    await expect(loader4()).resolves.toBe(assignAlertStepDefinition);
    await expect(loader5()).resolves.toBe(getEndpointFileStepDefinition);
  });

...
const getContentWrapperCss = (euiTheme: EuiThemeComputed<{}>) => css`
...
const UnifiedAttachmentChildren = ({ metadata }: UnifiedReferenceAttachmentViewProps) => {
...
export { UnifiedAttachmentChildren as default };

...
import UnifiedAttachmentEvent from './unified_event';
...
describe('UnifiedAttachmentEvent', () => {
  ...
  it('renders the expected text based on the command', () => {
    const { getByText, getByTestId, rerender } = render(
      <UnifiedAttachmentEvent {...defaultProps} />
    );
  ...
  it('navigates on link click', () => {
    const { getByTestId } = render(<UnifiedAttachmentEvent {...defaultProps} />);
  ...
  it('builds endpoint details URL correctly', () => {
    ...
    render(<UnifiedAttachmentEvent {...defaultProps} />);
  ...
  it('renders nothing when targets array is empty', () => {
    const { container } = render(
      <UnifiedAttachmentEvent
        {...defaultProps}
        metadata={{ ...defaultProps.metadata, targets: [] }}
      />
    );

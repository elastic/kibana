 ...
 * plugin was folded into `securitySolution`. Two functional changes:
 *
    ...
    <EuiFlexItem>
      <EuiPanel hasBorder paddingSize="m">
        <EuiStat
          ...
          description={i18n.translate('xpack.securitySolution.threatIntelligence.app.statHigh', {
            defaultMessage: 'High',
          })}
          titleColor="warning"
        />
    ...
    <EuiFlexItem>
      <EuiPanel hasBorder paddingSize="m">
        <EuiStat
          ...
          description={i18n.translate(
            'xpack.securitySolution.threatIntelligence.app.statAffectsYou',
            {
...
const RecentArticles: React.FC<{
  ...
  <EuiPanel hasBorder paddingSize="m">
    <PanelHeader
      title={i18n.translate('xpack.securitySolution.threatIntelligence.app.articlesTitle', {
          ...
          <EuiFlexItem key={article.report_id} grow={false}>
            <EuiFlexGroup gutterSize="s" alignItems="center" responsive={false}>
              ...
              <EuiFlexItem>
                ...
                <EuiText size="xs" color="subdued">
                  {i18n.translate(
                    'xpack.securitySolution.threatIntelligence.app.recentArticleMetaLine',
                    {
                      defaultMessage: '{sourceName} · {timestamp}',
                      values: {

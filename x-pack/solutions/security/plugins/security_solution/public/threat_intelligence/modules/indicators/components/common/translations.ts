...
export const COPY_TITLE = i18n.translate(
  'xpack.securitySolution.threatIntelligence.indicators.table.copyToClipboardLabel',
  {
...
export const LAST_SEEN = i18n.translate(
  'xpack.securitySolution.threatIntelligence.field.threat.indicator.last_seen',
  {
...
export const CONFIDENCE = i18n.translate(
  'xpack.securitySolution.threatIntelligence.field.threat.indicator.confidence',
  {
...
export const TLP_MARKETING = i18n.translate(
  'xpack.securitySolution.threatIntelligence.field.threat.indicator.marking.tlp',
  {

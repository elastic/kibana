...
/* Malware RE Analysis section */

const MALWARE_RE_ANALYSIS_TEST_ID = `${PREFIX}MalwareReAnalysis` as const;
export const MALWARE_RE_ANALYSIS_SECTION_TEST_ID = `${MALWARE_RE_ANALYSIS_TEST_ID}Section` as const;
export const MALWARE_RE_ANALYSIS_SECTION_HEADER_TEST_ID =
  MALWARE_RE_ANALYSIS_SECTION_TEST_ID + HEADER_TEST_ID;
export const MALWARE_RE_ANALYSIS_SECTION_CONTENT_TEST_ID =
  MALWARE_RE_ANALYSIS_SECTION_TEST_ID + CONTENT_TEST_ID;
export const MALWARE_RE_ANALYSIS_BUTTON_TEST_ID = `${MALWARE_RE_ANALYSIS_TEST_ID}Button` as const;
export const MALWARE_RE_ANALYSIS_LOADING_TEST_ID = `${MALWARE_RE_ANALYSIS_TEST_ID}Loading` as const;
export const MALWARE_RE_ANALYSIS_RESULTS_TEST_ID = `${MALWARE_RE_ANALYSIS_TEST_ID}Results` as const;
export const MALWARE_RE_ANALYSIS_ERROR_TEST_ID = `${MALWARE_RE_ANALYSIS_TEST_ID}Error` as const;

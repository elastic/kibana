...
import { ALERT_REASON_BANNER, Reason } from '../../../../flyout_v2/document_details/components/reason';
...
export const AboutSection = memo(() => {
  ...
  const openReasonPreview = useCallback(() => {
    openPreviewPanel({
  ...
  const content =
    eventKind === EventKind.signal ? (
      <>
        ...
        />
        <Reason hit={hit} onShowFullReason={openReasonPreview} />
        <MitreAttack />
        <AlertStatus />
      </>
    ) : (

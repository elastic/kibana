...
describe('useFetchPrevalence', () => {
  beforeEach(() => {
    ...
    (useEnableExperimental as jest.Mock).mockReturnValue({ newDataViewPickerEnabled: false });
  ...
  it('uses experimental patterns and does not exclude cold/frozen tiers when ui setting is disabled', async () => {
    uiSettingsGetMock.mockReturnValue(false);
    (useEnableExperimental as jest.Mock).mockReturnValue({ newDataViewPickerEnabled: true });

...
export const mockUserRiskScoreState: RiskScoreState<RiskScoreEntityType.user> = {
  data: [userRiskScore],
  inspect: {
    dsl: [],
    response: [],
...
export const mockHostRiskScoreState: RiskScoreState<RiskScoreEntityType.host> = {
  data: [hostRiskScore],
  inspect: {
    dsl: [],
    response: [],

...
export const HEADER_SEVERITY_TITLE_TEST_ID = 'ease-alert-flyout-header-severity';
export const HEADER_RISK_SCORE_TITLE_TEST_ID = 'ease-alert-flyout-header-risk-score';
export const HEADER_INTEGRATION_TITLE_TEST_ID = 'ease-alert-flyout-header-integration';

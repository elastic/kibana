...
export const LOADING_SKELETON_TEST_ID = 'ease-alert-flyout-conversation-loading-skeleton';
export const CONVERSATION_COUNT_TEST_ID = 'ease-alert-flyout-conversation-count';
export const VIEW_CONVERSATIONS_BUTTON_TEST_ID = 'ease-alert-flyout-view-conversations';
...
/**
 * Component rendered in the AI assistant section of EASE alert flyout.

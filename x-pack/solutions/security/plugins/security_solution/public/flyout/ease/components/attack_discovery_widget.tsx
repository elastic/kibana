...
export const ATTACK_DISCOVERY_NO_RESULTS_TEST_ID = 'ease-alert-flyout-attack-discovery-no-results';
export const ATTACK_DISCOVERY_ACCORDION_TEST_ID = 'ease-alert-flyout-attack-discovery-accordion';

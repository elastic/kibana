...
export const AI_ASSISTANT_SECTION_TEST_ID = 'ease-alert-flyout-ai-assistant-section';
export const SUGGESTED_PROMPTS_SECTION_TEST_ID = 'ease-alert-flyout-suggested-prompts-section';
...
export const AIAssistantSection = memo(({ getPromptContext }: AIAssistantSectionProps) => {
  const { eventId, getFieldsData } = useEaseDetailsContext();

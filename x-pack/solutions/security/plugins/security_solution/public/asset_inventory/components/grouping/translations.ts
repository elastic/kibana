...
export const ASSETS = i18n.translate('xpack.securitySolution.assetInventory.assets', {
  defaultMessage: 'Assets',
});

export const ASSETS_UNIT = (totalCount: number) =>
  i18n.translate('xpack.securitySolution.assetInventory.unit', {
    values: { totalCount },
    defaultMessage: `{totalCount, plural, =1 {asset} other {assets}}`,
  });

export const ASSET_GROUPS_UNIT = (
  totalCount: number,

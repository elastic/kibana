...
// import { getAssetPolicy, POLICY_TEMPLATE_FORM_DTS } from './utils';
// import {
//   CLOUDBEAT_AWS,
//   CLOUDBEAT_AZURE,
//   CLOUDBEAT_EKS,
...
//         status: 'success',
//         data: {
//           items: [getAssetPolicy(getMockPolicyEKS(), CLOUDBEAT_EKS)],
//         },
//       })
//     );
...
//       policy = getAssetPolicy(policy, CLOUDBEAT_EKS, {
...
//       policy = getAssetPolicy(policy, CLOUDBEAT_EKS, { role_arn: { value: 'a' } });
...
//       policy = getAssetPolicy(policy, CLOUDBEAT_EKS, { access_key_id: { value: 'a' } });
...
//       policy = getAssetPolicy(policy, CLOUDBEAT_EKS, { secret_access_key: { value: 'c' } });
...
//       policy = getAssetPolicy(policy, CLOUDBEAT_EKS, { session_token: { value: 'a' } });
...
//       await userEvent.type(getByLabelText('Role ARN'), 'a');
//       policy = getAssetPolicy(policy, CLOUDBEAT_AWS, { role_arn: { value: 'a' } });
...
//       await userEvent.type(getByLabelText('Access Key ID'), 'a');
//       policy = getAssetPolicy(policy, CLOUDBEAT_AWS, { access_key_id: { value: 'a' } });
...
//       policy = getAssetPolicy(policy, CLOUDBEAT_AWS, { secret_access_key: { value: 'b' } });
...
//       await userEvent.type(getByLabelText('Session Token'), 'a');
//       policy = getAssetPolicy(policy, CLOUDBEAT_AWS, { session_token: { value: 'a' } });

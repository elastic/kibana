...
import { useUrlQuery } from '../../hooks/use_asset_inventory_data_table/use_url_query';
import { useBaseEsQuery } from '../../hooks/use_asset_inventory_data_table/use_base_es_query';
import { usePersistedQuery } from '../../hooks/use_asset_inventory_data_table/use_persisted_query';

import type { AssetsBaseURLQuery } from '../../hooks/use_asset_inventory_data_table/use_asset_inventory_data_table';
...
*/
export const useCloudSecurityGrouping = <T>({
  dataView,
  groupingTitle,
  ...
  getDefaultQuery: (params: AssetsBaseURLQuery) => AssetsBaseURLQuery;

...
describe('SummaryTab', () => {
  ...
  it('renders the comments', () => {
    const { getByText } = render(<SummaryTab migrationRule={getRuleMigrationRuleMock()} />);
    expect(
      getByText(
  ...
  it('renders translated event details for fully translated rules', () => {
  ...
  it('renders translated event details for partially translated rules', () => {
    const { getAllByText } = render(
      <SummaryTab
        migrationRule={getRuleMigrationRuleMock({
  ...
  it('renders not translated event details for untranslatable rules', () => {
    const { getAllByText } = render(
      <SummaryTab
        migrationRule={getRuleMigrationRuleMock({

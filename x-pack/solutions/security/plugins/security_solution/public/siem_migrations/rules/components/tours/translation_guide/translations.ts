...
export const TRANSLATION_STATUS_TOUR_STEP_TITLE = i18n.translate(
  'xpack.securitySolution.siemMigrations.rules.tour.translationStatusStepTitle',
  {
...
export const MIGRATION_GUIDE_TOUR_STEP_TITLE = i18n.translate(
  'xpack.securitySolution.siemMigrations.rules.tour.migrationGuideStepTitle',
  {
...
export const MIGRATION_GUIDE_TOUR_STEP_CONTENT = i18n.translate(
  'xpack.securitySolution.siemMigrations.rules.tour.migrationGuideStepContent',
  {
    defaultMessage:
...
export const NEXT_TOUR_STEP_BUTTON = i18n.translate(
  'xpack.securitySolution.siemMigrations.rules.tour.nextStepButton',
  {
    defaultMessage: 'Next',
  }
);
...
export const INSTALL_LABEL = i18n.translate(
  'xpack.securitySolution.siemMigrations.rules.tour.installLabel',
  {
...
export const INSTALLED_LABEL = i18n.translate(
  'xpack.securitySolution.siemMigrations.rules.tour.installedLabel',
  {
...
export const VIEW_LABEL = i18n.translate(
  'xpack.securitySolution.siemMigrations.rules.tour.viewLabel',
  {
    defaultMessage: 'View',
  }
);
...
export const EDIT_LABEL = i18n.translate(
  'xpack.securitySolution.siemMigrations.rules.tour.editLabel',
  {
    defaultMessage: 'Edit',
  }
);
...
export const TRANSLATED_LABEL = i18n.translate(
  'xpack.securitySolution.siemMigrations.rules.tour.translatedLabel',
  {
...
export const REPROCESSED_LABEL = i18n.translate(
  'xpack.securitySolution.siemMigrations.rules.tour.reprocessedLabel',
  {
...
export const SIEM_MIGRATIONS_LINK_LABEL = i18n.translate(
  'xpack.securitySolution.siemMigrations.rules.tour.siemMigrationsLinkLabel',
  {

...
export const LOOKUPS_DATA_INPUT_FILE_UPLOAD_TITLE = i18n.translate(
  'xpack.securitySolution.siemMigrations.dashboards.dataInputFlyout.lookups.lookupsFileUpload.title',
  { defaultMessage: 'Update your lookups export' }
);
export const LOOKUPS_DATA_INPUT_FILE_UPLOAD_PROMPT = i18n.translate(
  'xpack.securitySolution.siemMigrations.dashboards.dataInputFlyout.lookups.lookupsFileUpload.prompt',
...
export const LOOKUPS_DATA_INPUT_FILE_UPLOAD_NOT_UPLOADED_TITLE = i18n.translate(
  'xpack.securitySolution.siemMigrations.dashboards.dataInputFlyout.lookups.lookupsFileUpload.notUploadedTitle',
  { defaultMessage: 'Lookups not uploaded' }
);
export const LOOKUPS_DATA_INPUT_FILE_UPLOAD_NOT_UPLOADED = (lookupsNames: string) =>
  i18n.translate(
    'xpack.securitySolution.siemMigrations.dashboards.dataInputFlyout.lookups.lookupsFileUpload.notUploaded',
    {
...
export const LOOKUPS_DATA_INPUT_FILE_UPLOAD_BUTTON = i18n.translate(
  'xpack.securitySolution.siemMigrations.dashboards.dataInputFlyout.lookups.lookupsFileUpload.button',

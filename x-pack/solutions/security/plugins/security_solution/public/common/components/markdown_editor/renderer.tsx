  ...
  return (
    <>
      {platinumPluginDetected && (
        <>
          <EuiCallOut announceOnMount title={i18n.PLATINUM_WARNING} color="primary" iconType="lock">
            <FormattedMessage
      ...
      {markdownParseResult !== null && (
        <>
          <EuiCallOut announceOnMount title={i18n.INVALID_MARKDOWN} color="danger" iconType="error">
            {markdownParseResult}
          </EuiCallOut>
          <EuiSpacer size="s" />
        </>

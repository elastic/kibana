...
const workflowConfigSchema = {
  ...
  alert_retrieval_mode: {
    type: 'keyword',
    _meta: {
      description: 'The alert retrieval mode (skill/custom_query/esql/custom_only)',
      optional: false,
    },
  },
  query_mode: {
...
export const attackDiscoveryAlertRetrievalModeChangedEvent: AttackDiscoveryTelemetryEvent = {
  ...
  schema: {
    mode: {
      type: 'keyword',
      _meta: {
        description: 'The alert retrieval mode selected (skill/custom_query/esql/custom_only)',
        optional: false,
      },
    },
  },

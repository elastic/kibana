...
export const RULE_DETAILS_BODY_TEST_ID = `${RULE_DETAILS_TEST_ID}Body` as const;
...
export const RULE_DETAILS_ERROR_TEST_ID = `${RULE_DETAILS_TEST_ID}Error` as const;

export const RULE_DETAILS_FOOTER_TEST_ID = `${RULE_DETAILS_TEST_ID}Footer` as const;
export const RULE_DETAILS_FOOTER_LINK_TEST_ID = `${RULE_DETAILS_TEST_ID}FooterLink` as const;

...
const LOADING = i18n.translate(
  'xpack.securitySolution.flyout.document.insights.insightSummaryLoadingAriaLabel',
  { defaultMessage: 'Loading' }
);
const BUTTON = i18n.translate(
  'xpack.securitySolution.flyout.document.insights.insightSummaryButtonAriaLabel',

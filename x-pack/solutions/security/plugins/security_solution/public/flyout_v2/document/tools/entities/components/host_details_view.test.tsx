...
jest.mock('../../../../../flyout/entity_details/host_right/hooks/use_observed_host');
  ...
  render(
    <TestProviders>
      <DocumentDetailsContext.Provider value={contextValue}>
        <HostDetailsView {...defaultProps} />
      </DocumentDetailsContext.Provider>
    </TestProviders>
  );

describe('<HostDetailsView />', () => {
  beforeEach(() => {
    jest.clearAllMocks();
  ...
  describe('Related users', () => {
    it('renders related users table when attack cell actions are used without DocumentDetailsContext', () => {
      const { getByTestId } = render(
        <TestProviders>
          <HostDetailsView {...defaultProps} isAttackDetails={true} />
        </TestProviders>
      );

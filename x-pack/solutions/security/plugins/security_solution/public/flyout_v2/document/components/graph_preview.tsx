...
const LoadingComponent = () => (
  <EuiSkeletonText
    ...
    contentAriaLabel={i18n.translate(
      'xpack.securitySolution.flyout.document.visualizations.graphPreview.loadingAriaLabel',
      {
...
export const GraphPreview: React.FC<GraphPreviewProps> = memo(
  ({ isLoading, isError, data }: GraphPreviewProps) => {
    ...
    return isLoading ? (
      ...
      <FormattedMessage
        id="xpack.securitySolution.flyout.document.visualizations.graphPreview.errorDescription"
      ...
      >
        <GraphLazy
          ...
          aria-label={i18n.translate(
            'xpack.securitySolution.flyout.document.visualizations.graphPreview.graphAriaLabel',
            {
              defaultMessage: 'Graph preview',
            }
          )}

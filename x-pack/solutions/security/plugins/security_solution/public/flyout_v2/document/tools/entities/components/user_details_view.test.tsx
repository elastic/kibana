...
import { HOST_PREVIEW_BANNER } from '../../../main/components/host_entity_overview';
...
jest.mock('../../../../../flyout/entity_details/user_right/hooks/use_observed_user');
  ...
  describe('Related hosts', () => {
    it('renders related hosts table when attack cell actions are used without DocumentDetailsContext', () => {
      const { getByTestId } = render(
        <TestProviders>
          <UserDetailsView {...defaultProps} isAttackDetails={true} />
        </TestProviders>
      );

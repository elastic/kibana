...
const SUCCESSFULLY_SAVED_RULE = (ruleName: string) =>
  i18n.translate(
    'xpack.securitySolution.flyout.document.investigation.highlightedFields.successfullySavedRuleTitle',
    {
      values: { ruleName },
...
const ADD_CUSTOM_FIELD_LABEL = i18n.translate(
  'xpack.securitySolution.flyout.document.investigation.highlightedFields.modalAddCustomFieldLabel',
  { defaultMessage: 'Add custom' }
);

const SELECT_PLACEHOLDER = i18n.translate(
  'xpack.securitySolution.flyout.document.investigation.highlightedFields.modalSelectPlaceholder',
    ...
    >
      <EuiModalHeader data-test-subj={HIGHLIGHTED_FIELDS_MODAL_TITLE_TEST_ID}>
        <EuiModalHeaderTitle id={modalTitleId} size="s">
          <FormattedMessage
            id="xpack.securitySolution.flyout.document.investigation.highlightedFields.modalTitle"
      ...
      <EuiModalBody>
        <EuiText size="s" data-test-subj={HIGHLIGHTED_FIELDS_MODAL_DESCRIPTION_TEST_ID}>
          <FormattedMessage
            id="xpack.securitySolution.flyout.document.investigation.highlightedFields.modalDescription"
        ...
        >
          <FormattedMessage
            id="xpack.securitySolution.flyout.document.investigation.highlightedFields.modalDefaultFieldsTitle"
      ...
      <EuiModalFooter>
        <EuiFlexGroup justifyContent="flexEnd">
          <EuiFlexItem grow={false}>
            ...
            >
              <FormattedMessage
                id="xpack.securitySolution.flyout.document.investigation.highlightedFields.modalCancelButton"
          ...
          <EuiFlexItem grow={false}>
            ...
            >
              <FormattedMessage
                id="xpack.securitySolution.flyout.document.investigation.highlightedFields.modalSaveButton"
                defaultMessage="Save"
              />
            </EuiButton>
          </EuiFlexItem>

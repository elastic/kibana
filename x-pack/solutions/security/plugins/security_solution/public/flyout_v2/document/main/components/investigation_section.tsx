  ...
  ({ hit, renderCellActions }: InvestigationSectionProps) => {
    ...
    const renderFlyoutLink = useCallback(
      (props: OpenFlyoutLinkProps) => {
        ...
        // Custom YARA Signature fields: navigate to the CYS management page for the matching
        // artifact (`entry_id` === exception `item_id`). Privilege and feature-flag gating live
        // in CustomYaraSignatureHighlightedFieldLink.

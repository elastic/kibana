...
### Events
- The browser ebt events come from `telemetryEvents` imported from `x-pack/solutions/security/solutions/security/plugins/security_solution/public/common/lib/telemetry/events/telemetry_events`
- The server ebt events come from:
  ...
  - `telemetryEvents` imported from `x-pack/solutions/security/solutions/security/plugins/security_solution_serverless/server/telemetry/event_based_telemetry`
  - `events` imported from `x-pack/solutions/security/solutions/security/plugins/security_solution/server/lib/telemetry/event_based/events`

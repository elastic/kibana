...
export const REF7707_CALDERA_ABILITIES: CalderaAbilityTemplate[] = [
  ...
  },
  {
    ...
    description:
      'Download benign artifacts from web-vm using the domain name (so DNS is involved).',
    tactic: 'collection',
  ...
  },
  {
    ...
    description:
      'Spawn a short process tree and make benign outbound HTTPS requests (C2-like shape).',
    tactic: 'execution',

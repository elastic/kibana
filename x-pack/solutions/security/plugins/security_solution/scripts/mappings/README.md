...
**NOTE:** The path to `es_archiver` is adjusted for the call of this script using `x-pack/solutions/security/solutions/security/plugins/security_solution/package.json`. If you call this script directly, you will need to adjust it accordingly.

...
import type {
  ...
  ProductFeaturesRulesConfig,
} from '@kbn/security-solution-features';
import {
  createEnabledProductFeaturesConfigMap,
  rulesDefaultProductFeaturesConfig,
} from '@kbn/security-solution-features/config';
import type { ProductFeatureRulesFeatureKey } from '@kbn/security-solution-features/keys';
 ...
 */
const rulesProductFeaturesConfig: Record<
...
export const getRulesProductFeaturesConfigurator =
  (enabledProductFeatureKeys: ProductFeatureKeys) => (): ProductFeaturesRulesConfig =>
    createEnabledProductFeaturesConfigMap(rulesProductFeaturesConfig, enabledProductFeatureKeys);

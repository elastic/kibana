...
import type { MitreHeatmapPayload } from '../../../common/attachment_payloads';
...
export const mitreHeatmapUiDefinition: AttachmentUIDefinition<HeatmapAttachment> = {
  getLabel: (attachment) => {
    ...
    return (
      ...
      (isCoverage
        ? i18n.translate('xpack.threatIntelligence.attachments.mitreHeatmap.labelCoverage', {
            defaultMessage: 'MITRE coverage heatmap',
          })
        : i18n.translate('xpack.threatIntelligence.attachments.mitreHeatmap.label', {
    ...
    return (
      <EuiPanel hasBorder paddingSize="m">
        <EuiTitle size="xs">
          <h4>
            {isCoverage
              ? i18n.translate('xpack.threatIntelligence.attachments.mitreHeatmap.titleCoverage', {
                  defaultMessage: 'MITRE coverage heatmap',
                })
              : i18n.translate('xpack.threatIntelligence.attachments.mitreHeatmap.title', {
                  defaultMessage: 'MITRE technique heatmap',
                })}
          </h4>
        </EuiTitle>
        <EuiText size="xs" color="subdued">
          ...
          {isCoverage
            ? ` · ${i18n.translate(
                'xpack.threatIntelligence.attachments.mitreHeatmap.uncoveredSummary',
                {
        ...
        {techniques.length === 0 ? (
          <EuiText size="s">
            {i18n.translate('xpack.threatIntelligence.attachments.mitreHeatmap.empty', {
                  ...
                  <EuiPanel hasShadow={false} hasBorder paddingSize="s">
                    ...
                    {showCoverageBadge ? (
                      <EuiBadge color={COVERAGE_BADGE_COLOR(t.has_coverage)}>
                        {t.has_coverage
                          ? i18n.translate(
                              'xpack.threatIntelligence.attachments.mitreHeatmap.coveredBadge',
                              {
                                defaultMessage:
                          ...
                          : i18n.translate(
                              'xpack.threatIntelligence.attachments.mitreHeatmap.uncoveredBadge',
                              {
                      ...
                      <EuiBadge color={SEVERITY_COLOR[t.severity_max]}>
                        {t.severity_max} · {t.article_count} report
                        {t.article_count === 1 ? '' : 's'}
                      </EuiBadge>
                    )}
                  </EuiPanel>

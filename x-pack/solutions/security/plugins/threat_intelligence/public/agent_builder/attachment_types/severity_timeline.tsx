...
import type { SeverityTimelinePayload } from '../../../common/attachment_payloads';
...
export const severityTimelineUiDefinition: AttachmentUIDefinition<TimelineAttachment> = {
  getLabel: (attachment) =>
    ...
    i18n.translate('xpack.threatIntelligence.attachments.severityTimeline.label', {
  ...
  renderInlineContent: ({ attachment }) => {
    ...
    return (
      <EuiPanel hasBorder paddingSize="m">
        <EuiTitle size="xs">
          <h4>
            {i18n.translate('xpack.threatIntelligence.attachments.severityTimeline.title', {
        ...
        <EuiText size="xs" color="subdued">
          {range} · {points.length}{' '}
          {i18n.translate('xpack.threatIntelligence.attachments.severityTimeline.reports', {
            defaultMessage: 'report(s)',
          })}
        </EuiText>
        <EuiSpacer size="s" />

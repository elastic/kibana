 ...
 */
<<<<<<< HEAD:x-pack/solutions/security/plugins/threat_intelligence/public/modules/query_bar/components/filter_in.tsx
export const FilterInContextMenu: VFC<FilterInProps> = ({
=======
export const FilterInContextMenu: FC<FilterInContextMenuProps> = ({
>>>>>>> 906a8284eba ([Security Solution][Intelligence] A11Y project: missing announcement for filter in/out actions on barchart (#227388)):x-pack/solutions/security/plugins/security_solution/public/threat_intelligence/modules/query_bar/components/filter_in.tsx
  data,
  field,
  'data-test-subj': dataTestSub,
  onAnnounce,

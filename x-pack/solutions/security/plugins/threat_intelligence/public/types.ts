...
import { type ComponentType, type NamedExoticComponent, type ReactElement, type ReactNode, type VFC } from 'react';
...
import { type DataViewBase, type Filter, type Query, type TimeRange } from '@kbn/es-query';

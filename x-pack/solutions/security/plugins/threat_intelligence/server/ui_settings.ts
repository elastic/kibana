...
import { DEFAULT_REGIONS_SETTING_KEY, THREAT_REGIONS } from '../common';
...
export const threatIntelligenceUiSettings: Record<string, UiSettingsParams<string[]>> = {
  [DEFAULT_REGIONS_SETTING_KEY]: {
    ...
    name: i18n.translate('xpack.threatIntelligence.uiSettings.defaultRegions.name', {
      defaultMessage: 'Threat Intelligence — default geographic regions',
    }),
    description: i18n.translate('xpack.threatIntelligence.uiSettings.defaultRegions.description', {
      defaultMessage:

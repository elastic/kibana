 ...
 *
 * Every attachment body is composed from the same handful of pieces so the cards read as one
 * family: a `Section` (small title, optional aside, consistent gap), a `MetaCard` headline
 * block, a `LabeledBadgeTable` (subdued label column + wrapping badge values), and small
 * badge lists.
 */

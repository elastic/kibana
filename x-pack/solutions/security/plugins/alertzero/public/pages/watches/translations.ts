...
export const PAGE_TITLE = i18n.translate('xpack.alertzero.watches.pageTitle', {
...
export const LOADING_WATCHES = i18n.translate('xpack.alertzero.watches.loading', {
  defaultMessage: 'Loading watches…',
});

export const LOADING_WATCH = i18n.translate('xpack.alertzero.watches.detail.loading', {
  defaultMessage: 'Loading watch…',
});

export const WATCH_NOT_FOUND_TITLE = i18n.translate('xpack.alertzero.watches.notFound.title', {
  defaultMessage: 'Watch not found',
});

export const WATCH_NOT_FOUND_BODY = i18n.translate('xpack.alertzero.watches.notFound.body', {
...
export const BACK_TO_WATCHES = i18n.translate('xpack.alertzero.watches.detail.back', {
...
export const SUBNAV_ARIA_LABEL = i18n.translate('xpack.alertzero.watches.subnav.ariaLabel', {

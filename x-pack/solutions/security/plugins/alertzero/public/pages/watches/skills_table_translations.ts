...
export const PAGE_TITLE = i18n.translate('xpack.alertzero.watches.skills.pageTitle', {
  defaultMessage: 'Skills',
});

export const PAGE_SUBTITLE = i18n.translate('xpack.alertzero.watches.skills.pageSubtitle', {
  defaultMessage: 'Capabilities a Watch’s Workers can call',
});

export const TABLE_CAPTION = i18n.translate('xpack.alertzero.watches.skills.tableCaption', {
  defaultMessage: 'Skills available to Security Watches',
});

export const COL_SKILL = i18n.translate('xpack.alertzero.watches.skills.col.skill', {
  defaultMessage: 'Skill',
});

export const COL_WATCHES = i18n.translate('xpack.alertzero.watches.skills.col.watches', {
  defaultMessage: 'Watches',
});

export const COL_LAST_RUN = i18n.translate('xpack.alertzero.watches.skills.col.lastRun', {
  defaultMessage: 'Last run',
});

export const COL_ENABLED = i18n.translate('xpack.alertzero.watches.skills.col.enabled', {
  defaultMessage: 'Enabled',
});

export const NO_SKILLS = i18n.translate('xpack.alertzero.watches.skills.empty', {
  defaultMessage: 'No skills are available yet.',
});

export const LOAD_ERROR = i18n.translate('xpack.alertzero.watches.skills.loadError', {
  defaultMessage: 'Unable to load skills.',
});

export const NOT_IMPLEMENTED_TITLE = i18n.translate(
  'xpack.alertzero.watches.skills.notImplemented.title',
  {
 ...
 * Keep in step with `SKILLS_SEED` in `@kbn/alertzero-common`.
 */
export const SKILL_NAMES: Record<string, string> = {
  'alert-triage': i18n.translate('xpack.alertzero.watches.skills.alertTriage.name', {
    defaultMessage: 'Alert triage',
  }),
  'mitre-attack-mapping': i18n.translate('xpack.alertzero.watches.skills.mitreAttackMapping.name', {
    defaultMessage: 'MITRE ATT&CK mapping',
  }),
  'dark-web-feeds': i18n.translate('xpack.alertzero.watches.skills.darkWebFeeds.name', {
    defaultMessage: 'Dark web feeds',
  }),
  'virustotal-lookup': i18n.translate('xpack.alertzero.watches.skills.virustotalLookup.name', {
    defaultMessage: 'VirusTotal lookup',
  }),
  'case-assembly': i18n.translate('xpack.alertzero.watches.skills.caseAssembly.name', {
    defaultMessage: 'Case assembly',
  }),
  escalation: i18n.translate('xpack.alertzero.watches.skills.escalation.name', {
    defaultMessage: 'Escalation',
  }),
  containment: i18n.translate('xpack.alertzero.watches.skills.containment.name', {
    defaultMessage: 'Containment',
  }),
  'rule-preview': i18n.translate('xpack.alertzero.watches.skills.rulePreview.name', {
    defaultMessage: 'Rule preview',
  }),
};

export const SKILL_DESCRIPTIONS: Record<string, string> = {
  'alert-triage': i18n.translate('xpack.alertzero.watches.skills.alertTriage.description', {
    defaultMessage: 'Classifies and prioritizes alerts; proposes cases or suppressions.',
  }),
  'mitre-attack-mapping': i18n.translate(
    'xpack.alertzero.watches.skills.mitreAttackMapping.description',
    {
  ...
  escalation: i18n.translate('xpack.alertzero.watches.skills.escalation.description', {
    defaultMessage: 'Routes high-severity paths to on-call or IR.',
  }),
  containment: i18n.translate('xpack.alertzero.watches.skills.containment.description', {
    defaultMessage: 'Scoped isolation and block actions for trusted runtime paths.',
  }),
  'rule-preview': i18n.translate('xpack.alertzero.watches.skills.rulePreview.description', {
    defaultMessage:

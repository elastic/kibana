...
describe('getWorkerCustomSettingsComponent', () => {
  ...
  // The scope guarantee. The agent picker ships for the Hunt Watch only, so every other Worker must
  // not get it. Listing the Workers from the catalog rather than by hand means a newly added Worker

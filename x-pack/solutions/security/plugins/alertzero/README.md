...
- `manage_escalations` is an AlertZero sub-feature (`includeIn: 'all'`). It is reserved for create/link incident APIs; approving an escalate proposal stays `manage_proposals`.

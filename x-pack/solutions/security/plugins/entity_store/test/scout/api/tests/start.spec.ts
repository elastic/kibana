...
import { PUBLIC_HEADERS, ENTITY_STORE_TAGS, QG_QA, QG_STAGING } from '../fixtures/constants';
import {
  getStatus,
...
apiTest.describe('Entity Store Start API tests', { tag: [...ENTITY_STORE_TAGS, ...QG_QA, ...QG_STAGING] }, () => {

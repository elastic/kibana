...
const REGISTERED_MAINTAINER_ID = 'entity_maintainers_chen';
...
const getRoleWithoutTargetIndexPrivileges = () =>
  buildRoleDescriptor({ withTargetIndex: false });
...
apiTest.describe(
  ...
  () => {
    ...
    apiTest.describe('init logic', () => {
      ...
      apiTest(
        'Should schedule never-started maintainers and return 200',
        async ({ apiClient }) => {

...
export const ENTITY_STORE_ROUTES = {
  ...
  ENTITY_MAINTAINERS_START: `${ENTITY_STORE_BASE_ROUTE}/entity-maintainers/start`,
  ENTITY_MAINTAINERS_STOP: `${ENTITY_STORE_BASE_ROUTE}/entity-maintainers/stop`,
  ENTITY_MAINTAINERS_GET: `${ENTITY_STORE_BASE_ROUTE}/entity-maintainers`,

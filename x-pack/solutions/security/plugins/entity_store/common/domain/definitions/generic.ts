...
// Deliberately no `creatableFromSingleDocument`: generic's EUID is `entity.id` verbatim with no
// gates, so creating it from any single document would be an arbitrary-string minting operation.

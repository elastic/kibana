...
import { ALERT_ZERO_API_PRIVILEGE_WRITE } from '../../../common/constants';
...
export const registerUpdateWorkerRoute = ({
  ...
  router.versioned
    .patch({
      path: ALERT_ZERO_WORKER_URL_TEMPLATE,
      access: INTERNAL_API_ACCESS,
      security: {
        authz: {
          requiredPrivileges: [ALERT_ZERO_API_PRIVILEGE_WRITE],
        },
      },
      summary: 'Update a Alert Zero worker and its settings',
    })
    .addVersion(
      {

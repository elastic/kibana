...
import { API_VERSIONS, ALERT_ZERO_WATCHES_URL, buildWatchUrl } from '@kbn/alert-zero-common';
import type { GetWatchResponse, ListWatchesResponse } from '@kbn/alert-zero-common';
...
export const useWatches = () => {
  ...
  return useQuery({
    ...
    queryFn: async (): Promise<ListWatchesResponse> =>
      services.http!.get<ListWatchesResponse>(ALERT_ZERO_WATCHES_URL, {

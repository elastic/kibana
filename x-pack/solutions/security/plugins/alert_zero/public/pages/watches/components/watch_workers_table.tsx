...
import type { WatchWorker, WatchWorkerAttachment } from '@kbn/alert-zero-common';
...
export const WatchWorkersTable: React.FC<WatchWorkersTableProps> = ({ attachments, onToggle }) => {
        ...
        render: (attachedEnabled: boolean, row: WorkerRow) => {
          ...
          const control = (
            <EuiSwitch
              ...
              data-test-subj={`alertZeroWatchWorkerToggle-${row.workerId}`}
  ...
  return (
    <EuiBasicTable
      ...
      data-test-subj="alertZeroWatchWorkersTable"
    />
  );
};

...
import type { ScopeAccess, WatchScope, WatchScopeRoutingSettings } from '@kbn/alert-zero-common';
...
export const WatchScopeRoutingSection: React.FC<WatchScopeRoutingSectionProps> = ({
  ...
  const selects = [
    {
      ...
      testSubj: 'alertZeroWatchDataSourcesSelect',
    },
    {
      ...
      testSubj: 'alertZeroWatchAssigneeQueueSelect',
    },
    {
      ...
      testSubj: 'alertZeroWatchEscalationContactSelect',
    },
  ];
  ...
  return (
    <SettingsSection
      ...
      data-test-subj="alertZeroWatchScopeRoutingSection"
    >
          ...
          <EuiBadgeGroup gutterSize="xs">
            {scopes.map((scope) => (
              <EuiBadge
                ...
                iconType="dot"
                iconSide="left"
                data-test-subj={`alertZeroWatchDataBoundary-${scope.name}`}

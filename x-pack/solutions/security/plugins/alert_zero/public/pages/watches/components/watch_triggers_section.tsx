...
import type { WatchTriggersSettings } from '@kbn/alert-zero-common';
...
export const WatchTriggersSection: React.FC<WatchTriggersSectionProps> = ({
  ...
  return (
    <SettingsSection
      ...
      data-test-subj="alertZeroWatchTriggersSection"
    >
      {sharedWithAttackDiscovery ? (
        <>
          <KbnInfoCallout
            ...
            size="s"
            data-test-subj="alertZeroWatchAdSharedCallout"
          />
          <EuiSpacer size="m" />
        </>
      ) : null}
      ...
      >
        <EuiSelect
          ...
          data-test-subj="alertZeroWatchScheduleSelect"
          fullWidth
        />
      </EuiFormRow>
      ...
      <EuiFormRow label={i18n.MANUAL_RUN_LABEL} helpText={i18n.MANUAL_RUN_HELP} fullWidth>
        <EuiSwitch
          ...
          data-test-subj="alertZeroWatchManualRunSwitch"
        />
      </EuiFormRow>
    </SettingsSection>
  );

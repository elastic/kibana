...
import { compareWatchesForDisplay, type Lifecycle, type Watch } from '@kbn/alert-zero-common';
import { ALERT_ZERO_WATCHES_SUBNAV_WIDTH } from '../../../components/layout/constants';
...
export const AlertZeroWatchesNav: React.FC<AlertZeroWatchesNavProps> = ({ active, onCollapse }) => {
  ...
  return (
    <aside
      ...
      css={css`
        width: ${ALERT_ZERO_WATCHES_SUBNAV_WIDTH}px;
        flex-shrink: 0;
        height: 100%;

...
import type { ApprovalRequirement, WatchApprovalGate } from '@kbn/alert-zero-common';
...
export const ApprovalGatesTable: React.FC<ApprovalGatesTableProps> = ({
      ...
      },
      {
        ...
        render: (requirement: ApprovalRequirement, gate: WatchApprovalGate) => {
          ...
          if (gate.requirementLocked) {
            return (
              <EuiText size="s" data-test-subj={`alertZeroGateRequirement-${gate.id}`}>
          ...
          return (
            <EuiSelect
              ...
              data-test-subj={`alertZeroGateRequirement-${gate.id}`}
              onChange={(event) =>
      ...
      },
      {
        ...
        render: (approverRoleId: string | null, gate: WatchApprovalGate) => {
          ...
          if (approverRoleId == null) {
            return (
              <EuiText size="s" color="subdued" data-test-subj={`alertZeroGateApprover-${gate.id}`}>
                {EM_DASH}
              </EuiText>
            );
          }
          ...
          return (
            <EuiSelect
              ...
              data-test-subj={`alertZeroGateApprover-${gate.id}`}
  ...
  return (
    <EuiBasicTable
      ...
      data-test-subj="alertZeroApprovalGatesTable"
    />
  );
};

...
import { AlertZeroWatchesNav, type WatchesSectionId } from './alert_zero_watches_nav';
import * as i18n from '../translations';

const SUBNAV_COLLAPSED_KEY = 'alert_zero.watches.subnavCollapsed';
    ...
    >
      {!isCollapsed ? (
        ...
        <EuiPageTemplate.Sidebar
          paddingSize="none"
          minWidth={ALERT_ZERO_WATCHES_SUBNAV_WIDTH}
          sticky
          css={css`
            /**

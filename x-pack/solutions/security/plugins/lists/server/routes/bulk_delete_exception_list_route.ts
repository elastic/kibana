...
// MAX_EXCEPTION_LIST_SIZE (10,000) items, processed at BULK_DELETE_LIST_CONCURRENCY=10,
// each list taking N page-delete round-trips (1,000 items/page) → ~10 sequential
// ES round-trips per slot × 10 slots = up to ~100 total sequential ES calls, each
// ~10–50ms, so worst-case ~1–5s in a healthy cluster.  Under network stress or a

...
/** The request body of the nth `esClient.search` call (reads are paged with `search_after`). */
...
export const sourceId = (value: string): string => `src:${sha256(`${TEST_LIST_ID}\n${value}`)}`;
...
export const equalityId = (value: string): string => sha256(`${TEST_LIST_ID}\n${value}`);

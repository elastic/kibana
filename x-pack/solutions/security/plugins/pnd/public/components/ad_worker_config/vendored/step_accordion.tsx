...
/**
 * POC SPIKE — vendored (copied) from the Security Solution Attack Discovery flyout
 * (`.../attack_discovery/pages/settings_flyout/workflow_configuration/step_accordion`).
 * Self-contained (EUI + Emotion only), so it drops in unchanged. In the real Option A this
 * lives in a shared `@kbn/attack-discovery-workflow-config` package consumed by both plugins.
 */

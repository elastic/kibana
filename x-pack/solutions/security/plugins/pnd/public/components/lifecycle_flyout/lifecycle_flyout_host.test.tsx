...
describe('LifecycleFlyoutHost', () => {
  ...
  describe('tabs', () => {
     ...
     */
    it('renders the three tabs the details flyout names, in the documented order', () => {
      render('/watches/activity?lifecycle=ad-1');
     ...
     */
    it('opens on Attachments when the URL names it', () => {
      render('/watches/activity?lifecycle=ad-1&lifecycleTab=attachments');

      expect(screen.getByTestId('pndLifecyclePanel-attachments')).toBeInTheDocument();
    });

    it.each(['tuning', 'lifecycle'] as const)(

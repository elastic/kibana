 ...
 *
 * Three tabs — Overview, Attachments, Timeline — matching main's details flyout. Attachments
 * also remains a section inside Overview so nothing that lived there is dropped.
 *
...
export const LifecycleFlyout: React.FC<LifecycleFlyoutProps> = ({ correlationId }) => {
  ...
  const tabs: EuiTabbedContentTab[] = useMemo(
    () => [
      ...
      {
        content: (
          <div data-test-subj="pndLifecyclePanel-attachments">
            <LifecycleAttachmentsSection correlationId={correlationId} />
          </div>
        ),
        'data-test-subj': 'pndLifecycleTab-attachments',
        id: 'attachments',
        name: i18n.TAB_ATTACHMENTS,
      },
      {

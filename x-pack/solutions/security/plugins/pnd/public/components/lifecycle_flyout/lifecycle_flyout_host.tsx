...
import { ConversationDetailsFlyout } from '../details';
 ...
 *
 * Everything the overlay *looks* like lives in `ConversationDetailsFlyout`, which is only rendered
 * once the discovery id is known, so no tab has to cope with an `undefined` id.
 */
export const LifecycleFlyoutHost: React.FC = () => {
  ...
  return <ConversationDetailsFlyout correlationId={correlationId} />;
};

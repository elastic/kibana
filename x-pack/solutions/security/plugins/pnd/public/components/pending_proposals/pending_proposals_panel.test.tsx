...
describe('PendingProposalsPanel', () => {
  ...
  it('should submit the action input it rendered, so a stale approval can be refused', async () => {
    ...
    await waitFor(() => expect(screen.getByTestId('pndApproveProposalModal')).toBeInTheDocument());
  ...
  it('should require a structured reason and rationale before dismissing', async () => {
    ...
    await waitFor(() => expect(screen.getByTestId('pndDismissReasonSelect')).toBeInTheDocument());
    ...
    fireEvent.change(screen.getByTestId('pndDismissReasonSelect'), {
  ...
  it('should disable approval for an expired proposal', () => {
    ...
    expect(screen.getByTestId('pndProposalApprove')).toBeDisabled();
    expect(screen.getByTestId('pndProposalExpired')).toBeInTheDocument();
  });

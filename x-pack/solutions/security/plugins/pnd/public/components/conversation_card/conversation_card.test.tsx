...
describe('ConversationCard', () => {
  ...
  it('opens the approval modal when the card is clicked', () => {
    renderWithPndProviders(<ConversationCard {...defaultProps} />);
  ...
  it('opens the approval modal on Enter', () => {
    renderWithPndProviders(<ConversationCard {...defaultProps} />);
  ...
  it('opens the approval modal on Space', () => {
    renderWithPndProviders(<ConversationCard {...defaultProps} />);
  ...
  it('opens the thread on the chats page', () => {
    const { history } = renderWithPndProviders(<ConversationCard {...defaultProps} />);
  ...
  it('selects the thread the card names on the chats page', () => {
    const { history } = renderWithPndProviders(<ConversationCard {...defaultProps} />);

    fireEvent.click(screen.getByTestId('pndRowOpenInChatButton'));

    expect(history.location.search).toBe('?conversationId=thread-1');
  });

...
import {
  ...
  CDR_LATEST_NATIVE_VULNERABILITIES_INDEX_PATTERN_V1,
...
export const latestIndexConfigs: LatestIndexConfig = {
  ...
  vulnerabilities: {
    ...
    indexPattern: CDR_LATEST_NATIVE_VULNERABILITIES_INDEX_PATTERN_V1,
    indexTemplateName: LATEST_VULNERABILITIES_INDEX_TEMPLATE_NAME,
    indexDefaultName: CDR_LATEST_NATIVE_VULNERABILITIES_INDEX_LATEST,
  },
};

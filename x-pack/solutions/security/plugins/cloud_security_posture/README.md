...
pnpm test:ftr --config x-pack/solutions/security/test/serverless/functional/configs/config.cloud_security_posture.ts
```
...
```bash
pnpm test:ftr:server --config x-pack/solutions/security/test/serverless/api_integration/configs/config.ts
pnpm test:ftr:runner --config x-pack/solutions/security/test/serverless/api_integration/configs/config.ts --include-tag=cloud_security_posture
```

run serverless e2e tests:

```bash
pnpm test:ftr:server --config x-pack/solutions/security/test/serverless/functional/configs/config.cloud_security_posture.ts
pnpm test:ftr:runner ---config x-pack/solutions/security/test/serverless/functional/configs/config.cloud_security_posture.ts
```

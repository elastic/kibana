...
const buildSuccessReportFromLastMessageRun = {
    ...
    "inputs": {
        "input": {
            "question": "Write an ES|QL query to retrieve suspicious login events. Include fields like username, IP address, timestamp, and event type if possible."
        },
        "messages": [
            {
                "lc": 1,
                ...
                "kwargs": {
                    "content": "Write an ES|QL query to retrieve suspicious login events. Include fields like username, IP address, timestamp, and event type if possible.",
                    "additional_kwargs": {},
                    "response_metadata": {},
    ...
    "child_runs": [
        {
            ...
            "extra": {
                "metadata": {
                    ...
                    "langgraph_path": [
                        "__pregel_pull",
                        "buildSuccessReportFromLastMessage"
                    ],
                    "langgraph_checkpoint_ns": "tools:0da83e7d-f462-55a1-8bd4-71d7aaa1c114|buildSuccessReportFromLastMessage:061a8141-fe72-5e78-9c4d-dc1b00b29bbe",
...
const buildUnvalidatedReportFromLastMessageRun = {
    ...
    "inputs": {
        "input": {
            "question": "Write an ES|QL query to read from the table 'payments' and calculate the average number of payments per user per second."
        },
        "messages": [
            {
                "lc": 1,
                ...
                "kwargs": {
                    "content": "Write an ES|QL query to read from the table 'payments' and calculate the average number of payments per user per second.",
                    "additional_kwargs": {},
                    "response_metadata": {},
    ...
    "child_runs": [
        {
            ...
            "extra": {
                "metadata": {
                    ...
                    "langgraph_triggers": [
                        "nlToEsqlAgentWithoutValidation"
                    ],
                    "langgraph_path": [
                        "__pregel_pull",
                        "buildUnvalidatedReportFromLastMessage"
                    ],
                    "langgraph_checkpoint_ns": "tools:83cef84b-1112-51c5-8aa3-e99b50c15a82|buildUnvalidatedReportFromLastMessage:1c677f2d-8374-512a-8f94-f42ea4fd99cd",
                    "__pregel_resuming": false,
            ...
            "dotted_order": "20250521T083229185001Zf3ddaf25-6552-4336-bc12-bdea353b1941.20250521T083232747009Ze60eba3b-1e62-4f6f-beb1-fbe54645c3d5.20250521T083232748010Z0ded9302-58d2-4543-a875-f69991c69305.20250521T083232748011Z50fc47bc-a6bc-4e75-af4a-73f735bbd0d6.20250521T083232749012Z67087c9d-e1d7-44e0-a777-798ed368e4ca.20250521T083246123033Z462bd7ef-9380-4edc-87e0-fdc4039c34c6.20250521T083246124034Z52bf7a96-e59a-4324-a4c6-b4b60dbf413c",
...
const channelWriteRun = {
    ...
    "dotted_order": "20250521T083508086001Z7f7db62d-dcce-4d36-ae4b-29c7f0ac328e.20250521T083508159002Zf52fa664-0bb9-48ec-bc52-2b68b97bcd63.20250521T083508159003Z83a0af31-fe85-484d-8068-b266f4ecdbdc",

 ...
 */
export const ExampleInput = lazySchema(() =>
  z.object({
    ...
    insights: z.array(AttackDiscovery).nullable().optional(),
 ...
 */
export const ExampleInputWithOverrides = lazySchema(() =>
  z.intersection(
    ExampleInput,
    z.object({

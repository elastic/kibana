            ...
            return {
              output: {
                ...
                summary:
                  ...
                  `Attack Discovery generation has been initiated for this case with **${alertIds.length} alerts**.\n\n` +
                  `Results will appear on the [Attack Discovery page](/app/security/attack_discovery) once the LLM analysis completes.\n\n` +
                  `Execution ID: \`${adResult.execution_uuid}\`\n\n` +
                  `---\n*Generated by Alert Investigation Pipeline using connector gpt-5.2*`,
              },
            };
          }

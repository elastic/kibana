...
// promptId must match internal tool ID
// cannot import from security_solution because it causes a circular dependency
export const localInternalToolPrompts: Prompt[] = [
  {
    promptId: 'alert-counts-internal-tool',
    promptGroupId,
    prompt: {
      default:
...
Never use this tool when they user wants to generate a ES|QL for their data.`,
  ...
  {
    promptId: 'product-documentation-internal-tool',
    promptGroupId,
    prompt: {
      default:
  ...
  {
    promptId: 'knowledge-base-retrieval-internal-tool',
    promptGroupId,
    prompt: {
...
- Only call this tool if the user's query is explicitly about their own saved data or preferences.`,
  ...
  {
    promptId: 'knowledge-base-write-internal-tool',
    promptGroupId,
    prompt: {
      default:
  ...
  {
    promptId: 'security-labs-knowledge-internal-tool',
    promptGroupId,
    prompt: {
      default:
  ...
  {
    promptId: 'open-and-acknowledged-alerts-internal-tool',
    promptGroupId,
    prompt: {
      default:
  ...
  {
    promptId: 'entity-risk-score-tool-internal',
    promptGroupId,
    prompt: {
      default:

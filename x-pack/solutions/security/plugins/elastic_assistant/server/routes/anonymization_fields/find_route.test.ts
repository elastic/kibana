...
import { ELASTIC_AI_ASSISTANT_ANONYMIZATION_FIELDS_URL_FIND } from '@kbn/elastic-assistant-common/constants';
  ...
  describe('request validation', () => {
    ...
    test('disallows invalid sort fields', async () => {
      ...
      expect(result.badRequest).toHaveBeenCalledWith(
        'sort_field: Invalid option: expected one of "created_at"|"anonymized"|"allowed"|"field"|"updated_at"'
      );
    });

...
import { postInvestigateAlertRoute } from './alert_investigation/post_investigate_alert';
...
export const registerRoutes = (
  ...
  // Alert Investigation (Foundation Spike)
  postInvestigateAlertRoute(router, config);

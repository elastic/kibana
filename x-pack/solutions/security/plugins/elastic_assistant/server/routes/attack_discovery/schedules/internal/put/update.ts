...
import {
  ...
  UpdateAttackDiscoverySchedulesInternalRequestParams,
  UpdateAttackDiscoverySchedulesInternalResponse,
} from '@kbn/elastic-assistant-common';
import { buildResponse } from '../../../../../lib/build_response';
import type { ElasticAssistantRequestHandlerContext } from '../../../../../types';
import { performChecks } from '../../../../helpers';

export const updateAttackDiscoverySchedulesInternalRoute = (
    ...
    .addVersion(
      {
        ...
        validate: {
          request: {
            ...
            body: buildRouteValidationWithZod(UpdateAttackDiscoverySchedulesInternalRequestBody),
          },
          response: {
            200: {
              body: {
                custom: buildRouteValidationWithZod(UpdateAttackDiscoverySchedulesInternalResponse),
              },
            },
          },
        },
      ...
      async (
        ...
        request,
        response
      ): Promise<IKibanaResponse<UpdateAttackDiscoverySchedulesInternalResponse>> => {

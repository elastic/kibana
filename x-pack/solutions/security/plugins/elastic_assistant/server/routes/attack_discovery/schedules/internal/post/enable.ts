...
import {
  ...
  EnableAttackDiscoverySchedulesInternalRequestParams,
  EnableAttackDiscoverySchedulesInternalResponse,
} from '@kbn/elastic-assistant-common';
import { buildResponse } from '../../../../../lib/build_response';
import type { ElasticAssistantRequestHandlerContext } from '../../../../../types';
import { performChecks } from '../../../../helpers';

export const enableAttackDiscoverySchedulesInternalRoute = (
    ...
    .addVersion(
      {
        ...
        validate: {
          ...
          response: {
            200: {
              body: {
                custom: buildRouteValidationWithZod(EnableAttackDiscoverySchedulesInternalResponse),
              },
            },
          },
        },
      ...
      async (
        ...
        request,
        response
      ): Promise<IKibanaResponse<EnableAttackDiscoverySchedulesInternalResponse>> => {

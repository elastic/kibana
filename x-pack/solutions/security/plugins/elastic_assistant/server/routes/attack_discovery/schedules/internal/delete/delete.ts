...
import {
  ...
  DeleteAttackDiscoverySchedulesInternalRequestParams,
  DeleteAttackDiscoverySchedulesInternalResponse,
} from '@kbn/elastic-assistant-common';
import { buildResponse } from '../../../../../lib/build_response';
import type { ElasticAssistantRequestHandlerContext } from '../../../../../types';
import { performChecks } from '../../../../helpers';

export const deleteAttackDiscoverySchedulesInternalRoute = (
    ...
    .addVersion(
      {
        ...
        validate: {
          ...
          response: {
            200: {
              body: {
                custom: buildRouteValidationWithZod(DeleteAttackDiscoverySchedulesInternalResponse),
              },
            },
          },
        },
      ...
      async (
        ...
        request,
        response
      ): Promise<IKibanaResponse<DeleteAttackDiscoverySchedulesInternalResponse>> => {

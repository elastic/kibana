...
import {
  ...
  DisableAttackDiscoverySchedulesInternalRequestParams,
  DisableAttackDiscoverySchedulesInternalResponse,
} from '@kbn/elastic-assistant-common';
import { buildResponse } from '../../../../../lib/build_response';
import type { ElasticAssistantRequestHandlerContext } from '../../../../../types';
import { performChecks } from '../../../../helpers';

export const disableAttackDiscoverySchedulesInternalRoute = (
  ...
  router.versioned
    ...
    .addVersion(
      ...
      async (
        ...
        request,
        response
      ): Promise<IKibanaResponse<DisableAttackDiscoverySchedulesInternalResponse>> => {

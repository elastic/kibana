...
import { disableAttackDiscoverySchedulesInternalRoute } from './disable';
...
describe('disableAttackDiscoverySchedulesInternalRoute', () => {
  beforeEach(() => {
    jest.clearAllMocks();
    context.elasticAssistant.getAttackDiscoverySchedulingDataClient.mockResolvedValue(
      mockSchedulingDataClient
    );
    disableAttackDiscoverySchedulesInternalRoute(server.router);
  });

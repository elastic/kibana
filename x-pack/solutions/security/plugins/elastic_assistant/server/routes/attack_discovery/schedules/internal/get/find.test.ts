...
import { findAttackDiscoverySchedulesInternalRoute } from './find';
...
describe('findAttackDiscoverySchedulesInternalRoute', () => {
  beforeEach(() => {
    jest.clearAllMocks();
    context.elasticAssistant.getAttackDiscoverySchedulingDataClient.mockResolvedValue(
      mockSchedulingDataClient
    );
    findAttackDiscoverySchedulesInternalRoute(server.router);

      ...
      expect(conversation).toEqual({
        ...
        messages: [
          ...
          },
          {
            ...
            content: 'You currently have 61 open alerts in your environment. {reference(oQ5xL)}',
            role: 'assistant',
            metadata: { contentReferences: { oQ5xL: { id: 'oQ5xL', type: 'SecurityAlertsPage' } }, interruptValue: { type: 'INPUT_TEXT', threadId: 'thread-1', description: 'Ask user for text input' }, interruptResumeValue: { type: 'INPUT_TEXT', value: 'User provided string' } },
            traceData: {
          ...
          messages: [
            ...
            },
            {
              ...
              metadata: {
                ...
                interruptValue: { type: 'INPUT_TEXT', threadId: 'thread-1', description: 'Ask user for text input' },

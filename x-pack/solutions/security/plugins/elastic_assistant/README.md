...
To run the tests for this plugin, run `node scripts/jest.ts --watch x-pack/solutions/security/plugins/elastic_assistant/jest.config.js --coverage` from the Kibana root directory.

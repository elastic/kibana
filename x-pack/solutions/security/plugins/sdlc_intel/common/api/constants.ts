...
export const SDLC_INTERNAL_API_BASE = '/internal/sdlc';
export const SDLC_INTERNAL_API_VERSION = '1';

export const SDLC_SYNC_STATUS_ROUTE = `${SDLC_INTERNAL_API_BASE}/sync_status`;

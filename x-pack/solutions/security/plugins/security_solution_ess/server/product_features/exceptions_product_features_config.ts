...
import type {
  ...
  ProductFeaturesExceptionsConfig,
} from '@kbn/security-solution-features';
import {
  createEnabledProductFeaturesConfigMap,
  exceptionsDefaultProductFeaturesConfig,
} from '@kbn/security-solution-features/config';
import type { ProductFeatureExceptionsFeatureKey } from '@kbn/security-solution-features/keys';
 ...
 */
const exceptionsProductFeaturesConfig: Record<
...
export const getExceptionsProductFeaturesConfigurator =
  (enabledProductFeatureKeys: ProductFeatureKeys) => (): ProductFeaturesExceptionsConfig =>
    createEnabledProductFeaturesConfigMap(
      exceptionsProductFeaturesConfig,

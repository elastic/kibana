...
describe('TTYPlayer/hooks', () => {
  ...
  describe('useXtermPlayer', () => {
    ...
    it('allows the user to play', async () => {
      ...
      await waitFor(() => expect(result.current.currentLine).toBe(10));
    });
    ...
    it('allows the user to stop', async () => {
      ...
      await waitFor(() => expect(result.current.currentLine).toBe(10)); // should not have advanced
    });
    ...
    it('should stop when it reaches the end of the array of lines', async () => {
      ...
      await waitFor(() => expect(result.current.currentLine).toBe(initialProps.lines.length - 1));
    });

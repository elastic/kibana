...
/**
 * Complete Alert Triage settings: shared autonomy dial plus its detection tuning fields
 * (confidence / false-positive-count thresholds).
 */
...
export const WorkerSettingsWrite = lazySchema(() =>
  z
    .object({
      ...
      analysisWindowDays: AnalysisWindowDays.optional(),
      detectionConfig: DetectionConfig.optional(),
    })
    .strict()
);

...
const containInvestigations: Investigation[] = [
  {
    ...
    watch_id: PREBUILT_WATCH_OFFICER_ID,
    ...
    events: [
      {
        ...
        actor: PREBUILT_WATCH_OFFICER_ID,
      },
      {
        id: 'evt-it-002',
  ...
  },
  {
    ...
    watch_id: PREBUILT_WATCH_FLOOR_ID,
...
const escalateInvestigations: Investigation[] = [
  {
    ...
    events: [
      {
        id: 'evt-db-001',
        timestamp: '2026-07-20T11:40:00Z',
        type: 'triage',
...
const investigateInvestigations: Investigation[] = [
  {
    ...
    watch_id: PREBUILT_WATCH_DARK_ID,

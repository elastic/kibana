...
export const ALERT_ATTACK_DISCOVERY_CONFIDENCE = `${ALERT_ATTACK_DISCOVERY}.confidence` as const;
export const ALERT_ATTACK_DISCOVERY_CONFIDENCE_SCORE =
  `${ALERT_ATTACK_DISCOVERY_CONFIDENCE}.score` as const;
export const ALERT_ATTACK_DISCOVERY_CONFIDENCE_BAND =
  `${ALERT_ATTACK_DISCOVERY_CONFIDENCE}.band` as const;
export const ALERT_ATTACK_DISCOVERY_CONFIDENCE_RATIONALE =
  `${ALERT_ATTACK_DISCOVERY_CONFIDENCE}.rationale` as const;
export const ALERT_ATTACK_DISCOVERY_CONFIDENCE_FACTORS =
  `${ALERT_ATTACK_DISCOVERY_CONFIDENCE}.factors` as const;
export const ALERT_ATTACK_DISCOVERY_CONFIDENCE_FACTORS_NAME =
  `${ALERT_ATTACK_DISCOVERY_CONFIDENCE}.factors.name` as const;
export const ALERT_ATTACK_DISCOVERY_CONFIDENCE_FACTORS_ASSESSMENT =
  `${ALERT_ATTACK_DISCOVERY_CONFIDENCE}.factors.assessment` as const;
export const ALERT_ATTACK_DISCOVERY_CONFIDENCE_FACTORS_WEIGHT =
  `${ALERT_ATTACK_DISCOVERY_CONFIDENCE}.factors.weight` as const;
export const ALERT_ATTACK_DISCOVERY_CONFIDENCE_FACTORS_EVIDENCE =
  `${ALERT_ATTACK_DISCOVERY_CONFIDENCE}.factors.evidence` as const;

...
describe('convertAlertingRuleToSchedule', () => {
  it('converts basic internal schedule', () => {
  ...
  it('defaults to `elastic` as a user if `createdBy` and/or `updatedBy` set to null', () => {
    const internalRule = getInternalAttackDiscoveryScheduleMock(basicAttackDiscoveryScheduleMock);
  ...
  it('combines `actions` and `systemActions` into one array', () => {
    const internalRule = getInternalAttackDiscoveryScheduleMock(basicAttackDiscoveryScheduleMock, {

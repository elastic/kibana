...
/**
 * Endpoint telemetry seed for the Forensics Watch leaf-quality and
 ...
 * Forensics Watch's dataset uses different fictional hosts, so this is a
...
export async function seedForensicTimeline(
  ...
  log.info(
    `Seeded ${EVENTS.length} Forensics Watch telemetry events across ` +

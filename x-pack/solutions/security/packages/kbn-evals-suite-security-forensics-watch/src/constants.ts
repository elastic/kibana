...
/** Well-known endpoint telemetry index patterns scoped by Forensics Watch. */
...
/** Default escalation context used in Forensics Watch flow and composite pipeline tests. */

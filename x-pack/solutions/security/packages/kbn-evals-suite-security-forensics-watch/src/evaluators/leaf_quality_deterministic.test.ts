...
/**
 * L2 Deterministic Quality — Forensics Watch
 *
...
function evalCall(input: { case_id?: string }, output: Partial<ForensicTaskOutput>) {
  return {
    input,
    output,
    expected: {},
...
describe('L2 Deterministic Evaluators — Forensics Watch', () => {
  // ── TimelineAccuracy ──────────────────────────────────────────────────────

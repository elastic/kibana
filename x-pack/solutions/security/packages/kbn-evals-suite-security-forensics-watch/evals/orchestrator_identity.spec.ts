...
evaluate.describe(
  'Forensics Watch — Family D Orchestrator-Identity Gates',
  ...
  () => {
    ...
    evaluate(
      ...
      async ({ kbnClient, log }) => {
        ...
        // In-scope: Forensics Watch reading its own forensic process telemetry → allowed.
        ...
        // Out-of-scope: Forensics Watch attempting to read the users/identity index →

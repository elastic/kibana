...
/**
 * Watch Invocation Glue Spec — Forensics Watch
 *
 * Verifies that the real Forensics Watch Worker `ai.agent` step
...
evaluate.describe('Forensics Watch — Watch Invocation', { tag: tags.stateful.classic }, () => {
  /**

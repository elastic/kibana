...
export const eventCategory: EcsCompliantFieldMetadata = {
  allowed_values: [
    {
      description:
...
export const eventCategoryWithUnallowedValues: IncompatibleFieldMetadata = {
  ...eventCategory,
  indexInvalidValues: [
    {
      count: 2,
...
export const hostNameWithTextMapping: IncompatibleFieldMetadata = {
...
export const sourceIpWithTextMapping: IncompatibleFieldMetadata = {
...
export const sourcePort: EcsCompliantFieldMetadata = {
...
export const mockIncompatibleMappings: IncompatibleFieldMetadata[] = [
  {
    dashed_name: 'host-name',
    description:
      'Name of the host.\nIt can contain what `hostname` returns on Unix systems, the fully qualified domain name, or a name specified by the user. The sender decides which value to use.',
...
export const mockAgentTypeSameFamilyField: SameFamilyFieldMetadata = {
...
export const mockHostNameSameFamilyField: SameFamilyFieldMetadata = {
  dashed_name: 'host-name',
  description:
    'Name of the host.\nIt can contain what `hostname` returns on Unix systems, the fully qualified domain name, or a name specified by the user. The sender decides which value to use.',
  flat_name: 'host.name',
...
export const mockSameFamilyFields: SameFamilyFieldMetadata[] = [
  mockAgentTypeSameFamilyField,
  mockHostNameSameFamilyField,
];

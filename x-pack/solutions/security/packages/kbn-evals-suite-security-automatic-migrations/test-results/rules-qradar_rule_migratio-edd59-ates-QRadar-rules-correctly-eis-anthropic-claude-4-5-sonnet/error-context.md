...
- Name: rules/qradar_rule_migration.spec.ts >> QRadar Rule Migration >> translates QRadar rules correctly
- Location: x-pack/solutions/security/packages/kbn-evals-suite-security-automatic-migrations/evals/rules/qradar_rule_migration.spec.ts:16:26

# Error details

```
KbnClientRequesterError: [POST - http://localhost:5621/internal/siem_migrations/rules/42b54e1e-3106-4017-a601-f2ff2e3386ce/start] request failed (attempt=1/0): undefined -- Status: N/A, Cause: fetch failed -- and ran out of retries
```

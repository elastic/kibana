...
const iconType: React.FC<SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" {...props}>
    <path
      ...
      clipRule="evenodd"
    />
    <path d="m3.9219 8.9287-1.7325 1-.5-.8662 1.7325-1 .5.8662Zm10.3965.1338-.5.8662-1.7315-1 .5-.8662 1.7315 1ZM3.004 6.4951h-2v-1h2v1Zm11.9999 0h-2v-1h2v1ZM3.9268 3.0625l-.501.8662-1.7315-1 .5-.8662 1.7325 1Zm10.3867-.1338-1.7315 1-.5-.8662 1.7315-1 .5.8662Z" />
  </svg>
);

...
import { ALERT_ZERO_APP_ID, SECURITY_UI_APP_ID } from './constants';
...
/**
 * Link id for a page on the Alert Zero app. Same registry of page names as `securityLink`, different app
 * prefix — which is what distinguishes e.g. Alert Zero's alerts page from the Security UI's.
 */
export const alertZeroLink = (pageName?: SecurityPageName): AppDeepLinkId =>
  (pageName ? `${ALERT_ZERO_APP_ID}:${pageName}` : ALERT_ZERO_APP_ID) as AppDeepLinkId;

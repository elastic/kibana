...
import { ProductFeatureExceptionsFeatureKey } from '../product_features_keys';
import type { ProductFeatureKibanaConfig } from '../types';

/**
 * App features privileges configuration for the exceptions feature.
 ...
 */
export const exceptionsDefaultProductFeaturesConfig: Record<
  ProductFeatureExceptionsFeatureKey,
  ProductFeatureKibanaConfig
> = {
  [ProductFeatureExceptionsFeatureKey.exceptions]: {
    privileges: {
      all: {

  ...
  privilegeGroups: [
    {
      ...
      privileges: [
        {
          replacedBy: [
            { feature: SECURITY_FEATURE_ID_V4, privileges: ['trusted_applications_all'] },
          ],
          api: [
            'lists-all',
            'lists-read',
  ...
  privilegeGroups: [
    {
      ...
      privileges: [
        {
          replacedBy: [{ feature: SECURITY_FEATURE_ID_V4, privileges: ['trusted_devices_all'] }],
          api: [
            'lists-all',
            'lists-read',
            'lists-summary',
        ...
        {
          replacedBy: [{ feature: SECURITY_FEATURE_ID_V4, privileges: ['trusted_devices_read'] }],
  ...
  privilegeGroups: [
    {
      ...
      privileges: [
        {
          replacedBy: [
            { feature: SECURITY_FEATURE_ID_V4, privileges: ['host_isolation_exceptions_all'] },
          ],
          api: [
            'lists-all',
            'lists-read',
  ...
  privilegeGroups: [
    {
      ...
      privileges: [
        {
          replacedBy: [{ feature: SECURITY_FEATURE_ID_V4, privileges: ['blocklist_all'] }],
          api: [
            'lists-all',
            'lists-read',
            'lists-summary',
  ...
  privilegeGroups: [
    {
      ...
      privileges: [
        {
          replacedBy: [{ feature: SECURITY_FEATURE_ID_V4, privileges: ['event_filters_all'] }],
          api: [
            'lists-all',
            'lists-read',
            'lists-summary',
  ...
  privilegeGroups: [
    {
      ...
      privileges: [
        {
          replacedBy: [
            { feature: SECURITY_FEATURE_ID_V4, privileges: ['endpoint_exceptions_all'] },
          ],

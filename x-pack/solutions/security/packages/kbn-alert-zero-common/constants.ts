...
export const ALERT_ZERO_FEATURE_ID = 'alertzero' as const;
export const ALERT_ZERO_PLUGIN_NAME = 'Alert Zero' as const;
export const ALERT_ZERO_APP_ID = 'alertzero' as const;
export const ALERT_ZERO_APP_PATH = '/app/alertzero' as const;

export const ALERT_ZERO_INTERNAL_URL = '/internal/alertzero' as const;

export const ALERT_ZERO_WATCHES_URL = `${ALERT_ZERO_INTERNAL_URL}/watches` as const;
export const ALERT_ZERO_WATCH_URL_TEMPLATE = `${ALERT_ZERO_WATCHES_URL}/{watchId}` as const;

export const buildWatchUrl = (watchId: string) =>
  `${ALERT_ZERO_WATCHES_URL}/${encodeURIComponent(watchId)}`;

/** Global worker / skill catalogs — shared across watches. */
export const ALERT_ZERO_WORKERS_URL = `${ALERT_ZERO_INTERNAL_URL}/workers` as const;
export const ALERT_ZERO_SKILLS_URL = `${ALERT_ZERO_INTERNAL_URL}/skills` as const;

export const ALERT_ZERO_WORKER_URL_TEMPLATE = `${ALERT_ZERO_WORKERS_URL}/{workerId}` as const;
export const ALERT_ZERO_SKILL_URL_TEMPLATE = `${ALERT_ZERO_SKILLS_URL}/{skillId}` as const;

export const buildWorkerUrl = (workerId: string) =>
  `${ALERT_ZERO_WORKERS_URL}/${encodeURIComponent(workerId)}`;

...
describe('reportMisconfiguration', () => {
  ...
  it('reports managed_workflow_disabled type', () => {
    reportMisconfiguration({
      analytics: mockAnalytics,
      logger: mockLogger,
      params: {
        detail: 'Required managed workflow is disabled',
        misconfiguration_type: 'managed_workflow_disabled',
        space_id: 'default',
        workflow_id: 'system-attack-discovery-run',
      },
    });

 ...
 */
export const logUnverifiableDiscoveries = <T extends DiscoveryWithAlertIds>(
  logger: Logger,
  allDiscoveries: T[],
  verifiableDiscoveries: T[]
): void => {
  ...
  const unverifiableDiscoveries = allDiscoveries.filter((discovery) => {

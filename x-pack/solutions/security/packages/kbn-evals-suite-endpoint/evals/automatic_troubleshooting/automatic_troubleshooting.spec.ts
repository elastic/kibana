...
import {
  CHECK_ENDPOINT_PACKAGE_FRESHNESS_TOOL_ID,
  GENERATE_INSIGHT_TOOL_ID,
  GET_ENDPOINT_ARTIFACTS_TOOL_ID,
} from '@kbn/security-solution-plugin/server/agent_builder/skills/automatic_troubleshooting';

...
- Name: endpoint_forensic_analysis/endpoint_forensic_analysis_smoke.spec.ts >> Endpoint Forensic Analysis — smoke >> patient zero happy path
- Location: x-pack/solutions/security/packages/kbn-evals-suite-endpoint/evals/endpoint_forensic_analysis/endpoint_forensic_analysis_smoke.spec.ts:53:26

# Error details

```
Error: Timed out waiting for endpoint package to be installed after 120000ms
```

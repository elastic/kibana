...
export const AttackDiscoveryRubricPrompt = createPrompt({
  name: 'attack_discovery_rubric_judge',
  description: 'Judge attack discoveries using legacy rubric',
  input: z.object({
    submission: z.string(),
    reference: z.string(),
  }),

...
/**
 * Distance from the graph canvas edge to floating chrome
 * (left controls, right minimap, search).
 */
export const GRAPH_PANEL_INSET = 16;
...
/**
 * Entity node elevation on hover. Replaces dimming the rest of the graph, so
 * hover reads as "this node lifts" rather than "everything else recedes".
 */
export const GRAPH_NODE_HOVER_SHADOW = 'box-shadow: 0 2px 6px 0 rgba(7, 16, 31, 0.12);';

...
export interface EntityNodeViewModel
  ...
  /** Integration that produced this entity, e.g. Active Directory, Okta. */
  dataSource?: string;
  /**
...
export interface LabelNodeViewModel
  ...
  /**
   * Returns the event hover-toolbar actions (related events + event details).
   */
  getEventActionItems?: () => EntityActionItem[];
}

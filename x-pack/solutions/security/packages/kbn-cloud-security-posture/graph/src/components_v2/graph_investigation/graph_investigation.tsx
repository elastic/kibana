        ...
        data?.nodes.map((node) => {
          if (isEntityNode(node)) {
            ...
            return {
              ...
              dataSource: nodeMetadata.dataSource ? node.dataSource : undefined,
              ...
              assetCriticalityCounts: nodeMetadata.assetCriticality
                ...
                : undefined,
              riskScore: entityStyleMode === 'colored' ? node.riskScore : undefined,
              riskScoreMin: entityStyleMode === 'colored' ? node.riskScoreMin : undefined,
              riskScoreMax: entityStyleMode === 'colored' ? node.riskScoreMax : undefined,

...
const NODE_METADATA_ORDER: Array<keyof GraphFiltersState['nodeMetadata']> = [
  'assetCriticality',
  'dataSource',
  'ipAddress',
  'geolocation',
...
const NODE_METADATA_LABELS: Record<keyof GraphFiltersState['nodeMetadata'], string> = {
  ...
  dataSource: i18n.translate('securitySolutionPackages.csp.graph.filters.nodeMetadata.dataSource', {

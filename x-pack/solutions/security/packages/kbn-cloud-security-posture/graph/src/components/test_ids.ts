...
export const GRAPH_ACTIONS_TOGGLE_SEARCH_ID = `${PREFIX}ToggleSearch` as const;
export const GRAPH_ACTIONS_INVESTIGATE_IN_TIMELINE_ID = `${PREFIX}InvestigateInTimeline` as const;

export const GRAPH_CONTROLS_ZOOM_IN_ID = `${PREFIX}ZoomIn` as const;
export const GRAPH_CONTROLS_ZOOM_OUT_ID = `${PREFIX}ZoomOut` as const;
export const GRAPH_CONTROLS_CENTER_ID = `${PREFIX}Center` as const;
export const GRAPH_CONTROLS_FIT_VIEW_ID = `${PREFIX}FitView` as const;

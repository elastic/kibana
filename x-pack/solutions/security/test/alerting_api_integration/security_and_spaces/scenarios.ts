...
import type {
  Space,
  User,
} from '@kbn/test-suites-xpack-platform/alerting_api_integration/common/types';
 ...
 * In x-pack/platform/test/alerting_api_integration/common/plugins/alerts/server/action_types.ts

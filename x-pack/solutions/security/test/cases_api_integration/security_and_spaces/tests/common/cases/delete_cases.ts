...
import type { Alerts } from '@kbn/test-suites-xpack-platform/cases_api_integration/common/lib/alerts';
...
} from '@kbn/test-suites-xpack-platform/cases_api_integration/common/users';
import { roles as api_int_roles } from '@kbn/test-suites-xpack-platform/cases_api_integration/common/roles';
import {
  createUsersAndRoles,
  deleteUsersAndRoles,

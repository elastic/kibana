...
export const selectSuppressionBehaviorOnAlertClosure = (setting: SUPPRESSION_BEHAVIOR_ON_ALERT_CLOSURE_SETTING_ENUM) => {
  selectAdvancedSetting("management-settings-editField-securitySolution:suppressionBehaviorOnAlertClosure", setting)
}

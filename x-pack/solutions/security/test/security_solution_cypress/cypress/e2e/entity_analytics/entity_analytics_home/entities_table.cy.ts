...
describe('Entities table - Data grid', FTR_CONFIG, () => {
  before(() => {
...
describe('Entities table - Custom column renderers', FTR_CONFIG, () => {
  before(() => {
    cy.task('esArchiverLoad', { archiveName: ARCHIVE_NAME });
  });
...
describe('Entities table - Row actions', FTR_CONFIG, () => {
  before(() => {
    cy.task('esArchiverLoad', { archiveName: ARCHIVE_NAME });
  });
...
describe('Entities table - Grouping', FTR_CONFIG, () => {
  before(() => {
    cy.task('esArchiverLoad', { archiveName: ARCHIVE_NAME });
  });

...
const runTranslatedRulesPageTests = (isClassicNavUpdateEnabled: boolean) => {
  beforeEach(() => {
    deleteConnectors();
    ...
    selectMigrationConnector();
    navigateToTranslatedRulesPage(isClassicNavUpdateEnabled);
  });
...
describe(
  'Rule Migrations - Translated Rules Page (securityClassicNavUpdate disabled)',
  {
  ...
  () => {
    ...
    runTranslatedRulesPageTests(false);
  }
);
...
describe(
  ...
  () => {
    ...
    runTranslatedRulesPageTests(true);
  }
);

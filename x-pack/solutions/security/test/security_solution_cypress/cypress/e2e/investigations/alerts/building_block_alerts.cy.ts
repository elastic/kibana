...
// FAILS after enabling the newDataViewPickerEnabled feature flag. For some reason the table does not show the building block alerts...
// The test is stuck in an infinite loop trying to rerender the table... This works fine when running the application locally though???
describe.skip('Alerts generated by building block rules', { tags: ['@ess', '@serverless'] }, () => {
  before(() => {

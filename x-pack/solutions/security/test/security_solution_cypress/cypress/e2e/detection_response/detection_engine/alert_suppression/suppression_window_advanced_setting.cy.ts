...
import { bulkCloseSelectedAlerts, closeAlertFromFlyoutActions, closeAlertFromStatusBadge, closeFirstAlert, closeFirstAlertModalOff, closeFirstGroupedAlerts, expandFirstAlert, expandFirstAlertActions, groupAlertsBy, selectNumberOfAlerts } from '../../../../tasks/alerts';
...
describe(
    ...
    () => {
        ...
        const headings: Record<SUPPRESSION_BEHAVIOR_ON_ALERT_CLOSURE_SETTING_ENUM, string> = {
            [SUPPRESSION_BEHAVIOR_ON_ALERT_CLOSURE_SETTING_ENUM.RestartWindow]: 'The alert suppression window will be restarted',
            [SUPPRESSION_BEHAVIOR_ON_ALERT_CLOSURE_SETTING_ENUM.ContinueWindow]: 'The alert suppression window will continue'
        }
        ...
        const verifyModal = (setting: SUPPRESSION_BEHAVIOR_ON_ALERT_CLOSURE_SETTING_ENUM) => {
            cy.get('[data-test-subj="alertCloseInfoModal"]')
                ...
                .should('contain.text', "This behavior can be modified in Kibana's Advanced Settings. Please contact your admin to make this change.")
        }
        const verifyModalContinue = () => verifyModal(SUPPRESSION_BEHAVIOR_ON_ALERT_CLOSURE_SETTING_ENUM.ContinueWindow)
        const verifyModalRestart = () => verifyModal(SUPPRESSION_BEHAVIOR_ON_ALERT_CLOSURE_SETTING_ENUM.RestartWindow)

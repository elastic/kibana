...
export const AI_RULE_CREATION_PROMPT_TEXTAREA = '[data-test-subj="prompt-textarea"]';
...
export const CREATE_RULE_MENU_POPOVER = '[data-test-subj="create-rule-context-menu-popover"]';

export const AI_RULE_CREATION_MENU_ITEM = '[data-test-subj="ai-rule-creation"]';

export const AI_RULE_CREATION_BACK_TO_PROMPT_LINK = '[data-test-subj="link-back-to-ai-prompt"]';

export const NEW_AGENT_BUILDER_ATTACHMENT_BUTTON = '[data-test-subj="newAgentBuilderAttachment"]';

export const AGENT_BUILDER_CONVERSATION_FLYOUT_WRAPPER =

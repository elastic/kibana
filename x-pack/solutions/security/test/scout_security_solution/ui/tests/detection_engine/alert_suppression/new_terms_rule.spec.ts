...
test.describe(
  'Alert suppression - new terms rule',
  {
  ...
  () => {
    ...
    test('Creates new terms rule with time interval suppression and verifies details', async ({
      page,
      pageObjects,
      kbnClient,
    }) => {
    ...
    test('Creates new terms rule with per-execution suppression and verifies details', async ({
      page,
      pageObjects,
      kbnClient,
    }) => {

...
test.describe(
  'Alert suppression - EQL sequence rule',
  {
  ...
  () => {
    ...
    test('Creates EQL sequence rule with per-execution suppression and verifies details', async ({
      page,
      pageObjects,
      kbnClient,
    }) => {
    ...
    test('Creates EQL sequence rule with time interval suppression and verifies details', async ({
      page,
      pageObjects,
      kbnClient,
    }) => {

...
test.describe(
  ...
  () => {
    ...
    test('Creates EQL rule with per-execution suppression and verifies details', async ({
      page,
      pageObjects,
      kbnClient,
    }) => {
    ...
    test('Creates EQL rule with time interval suppression and verifies details', async ({
      page,
      pageObjects,
      kbnClient,
    }) => {

...
export const RULES_UPGRADE_URL = '/app/security/rules/updates';
...
export const HOSTS_ALL_URL = '/app/security/hosts/allHosts';
export const GET_STARTED_URL_PATH = '/app/security/get_started';
export const HOSTS_URL = '/app/security/hosts';
export const NETWORK_URL = '/app/security/network';
export const USERS_URL = '/app/security/users';

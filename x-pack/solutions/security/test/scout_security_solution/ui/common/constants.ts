...
/** Security Solution navigation URLs */
...
export const CSP_INSIGHT_MISCONFIGURATION_TABLE =
  'securitySolutionFlyoutMisconfigurationFindingsTable';

/** Entity flyout buttons */
export const OPEN_HOST_FLYOUT_BUTTON = 'host-details-button';
export const OPEN_USER_FLYOUT_BUTTON = 'users-link-anchor';

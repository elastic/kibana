...
export default function ({ getService }: FtrProviderContext) {
  ...
  describe('sources', () => {
    before(() => esArchiver.load('x-pack/platform/test/fixtures/es_archives/auditbeat/default'));
    after(() => esArchiver.unload('x-pack/platform/test/fixtures/es_archives/auditbeat/default'));

...
export default function ({ getService }: FtrProviderContext) {
  ...
  describe('@ess @skipInServerless, @skipInServerlessMKI Endpoint Artifacts space awareness user role backwards compatibility until siemV5', function () {
    const afterEachDataCleanup: Array<Pick<ArtifactTestData, 'cleanup'>> = [];

    const SIEM_VERSIONS = ['siem', 'siemV2', 'siemV3', 'siemV4', 'siemV5'] as const;

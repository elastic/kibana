...
import { PolicyTestResourceInfo } from '@kbn/test-suites-xpack/security_solution_endpoint/services/endpoint_policy';
import { ArtifactTestData } from '@kbn/test-suites-xpack/security_solution_endpoint/services/endpoint_artifacts';

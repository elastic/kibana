...
export default function ({ loadTestFile, getService }: FtrProviderContext) {
  ...
  describe('Unified Alerts - Set Assignees APIs', function () {
    before(async () => {
    ...
    loadTestFile(require.resolve('./set_alert_assignees_ess'));
    loadTestFile(require.resolve('./set_alert_assignees_serverless'));
  });
}

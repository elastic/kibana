...
/**
 * Logged requests for the ES|QL execution path of the New Terms rule. The aggregation path
 * produces a different sequence of requests and is asserted in the basic-license tier spec of
 * the same name.
 */
export default ({ getService }: FtrProviderContext) => {
  ...
  describe('@ess @serverless @serverlessQA New terms preview logged requests - ES|QL approach', () => {

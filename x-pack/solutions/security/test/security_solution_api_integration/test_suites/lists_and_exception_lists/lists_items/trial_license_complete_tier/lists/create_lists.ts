...
export default ({ getService }: FtrProviderContext) => {
  ...
  describe('@ess @serverless @serverlessQA create_lists', () => {
    ...
    describe('creating lists', () => {
      ...
      it('should create a simple list without a list_id with a serializer param', async () => {
      ...
      it('should create a simple list without a list_id with a deserializer param', async () => {
        const { body, headers } = await supertest
          .post(`${LIST_URL}`)
          .set('kbn-xsrf', 'true')
          .send({

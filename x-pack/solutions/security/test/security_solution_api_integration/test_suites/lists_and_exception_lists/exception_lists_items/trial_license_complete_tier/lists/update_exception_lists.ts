  ...
  describe('@ess @serverless @serverlessQA update_exception_lists', () => {
    describe('update exception lists', () => {
      ...
      describe('@skipInServerless with read rules and all exceptions role', () => {
        ...
        it('should update a single exception list', async () => {
          ...
          const { body } = await restrictedApis
            .updateExceptionList({ body: updatedList })
            .expect(200);
          ...
          const outputList: Partial<ExceptionListSchema> = {
            ...
            name: 'some other name',
            version: 2,
            updated_by: 'rules_read_exceptions_all',
          };
          const bodyToCompare = removeExceptionListServerGeneratedProperties(body);
          expect(bodyToCompare).to.eql(outputList);
        });
      ...
      describe('@skipInServerless with read rules and read exceptions role', () => {
        ...
        it('should NOT update a single exception list', async () => {
          ...
          await restrictedApis.updateExceptionList({ body: updatedList }).expect(403);
        });
      });
    });
  });

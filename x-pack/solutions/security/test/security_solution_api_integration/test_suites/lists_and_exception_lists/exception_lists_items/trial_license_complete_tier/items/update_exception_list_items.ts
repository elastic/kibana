  ...
  describe('@ess @serverless @serverlessQA update_exception_list_items', () => {
    describe('update exception list items', () => {
      ...
      describe('@skipInServerless with read rules and all exceptions role', () => {
        ...
        it('should update a single exception list item', async () => {
          ...
          const { body } = await restrictedApis
            .updateExceptionListItem({ body: updatedList })
            .expect(200);
      ...
      describe('@skipInServerless with read rules and read exceptions role', () => {
        ...
        it('should not update a single exception list item', async () => {
          ...
          await restrictedApis.updateExceptionListItem({ body: updatedList }).expect(403);
        });
      });

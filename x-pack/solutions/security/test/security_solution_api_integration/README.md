...
4. Append a new entry in the `.buildkite/ftr-manifests/ftr_security_stateful_configs.yml` / `.buildkite/ftr-manifests/ftr_security_serverless_configs.yml` file to enable the execution of the newly added tests within the CI pipeline.

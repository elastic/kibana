...
export const JiraConnectorExample: SingleFileConnectorDefinition = {
  // ---- Metadata (required) ----
  metadata: {
    id: ".jira",
    displayName: "Jira",
    ...
    z.object({
      ...
      credentials: z.object({
        ...
        password: withUIMeta(
          UISchemas.secret(),
          {
            helpText: "Get your API token from https://id.atlassian.com/manage-profile/security/api-tokens",
    ...
    pushToService: {
      ...
      input: z.object({
        incident: z.object({
          ...
          externalId: z.string()
            .optional()
            .describe("Existing Issue Key (for updates)"),
          
          issueType: withUIMeta(
            z.string(),
            {
              widget: "select",
              optionsFrom: {
          ...
          otherFields: z.record(z.string(), z.any())
            .optional()
        ...
        ).optional().describe("Comments to add"),
      }),

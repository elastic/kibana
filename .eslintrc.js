  ...
  overrides: [
     ...
     */
    {
      ...
      files: [
        ...
        'x-pack/packages/kbn-cloud-security-posture/**/*.{js,mjs,ts,tsx}',
        'x-pack/packages/kbn-cloud-security-posture-common/**/*.{js,mjs,ts,tsx}',
    ...
    },
    {
      ...
      files: [
        ...
        'x-pack/packages/kbn-cloud-security-posture/**/*.{ts,tsx}',
        'x-pack/packages/kbn-cloud-security-posture-common/**/*.{ts,tsx}',
      ...
      excludedFiles: [
        ...
        'x-pack/packages/kbn-cloud-security-posture/**/*.{test,mock,test_helper}.{ts,tsx}',
        'x-pack/packages/kbn-cloud-security-posture-common/**/*.{test,mock,test_helper}.{ts,tsx}',

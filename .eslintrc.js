  ...
  overrides: [
     ...
     */
    {
      files: [
        ...
        'x-pack/plugins/serverless/test/**/config*.ts',
        'x-pack/plugins/serverless/test/*/test_suites/**/*',
        'x-pack/plugins/serverless_observability/test/**/config*.ts',
        'x-pack/plugins/serverless_observability/test/*/test_suites/**/*',
        'x-pack/plugins/serverless_search/test/**/config*.ts',
        'x-pack/plugins/serverless_search/test/*/test_suites/**/*',
        'x-pack/plugins/serverless_security/test/**/config*.ts',
        'x-pack/plugins/serverless_security/test/*/test_suites/**/*',
      ],
      rules: {

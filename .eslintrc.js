...
module.exports = {
  ...
  overrides: [
    ...
    {
      // All files
      files: ['x-pack/solutions/search/solutions/search/plugins/enterprise_search/**/*.{ts,tsx}'],
      rules: {
        'import/order': [
          'error',
          {
     ...
     */
    {
      files: ['x-pack/solutions/search/solutions/search/plugins/enterprise_search/server/**/*.{ts,tsx}'],
      rules: {
    ...
    },
    {
      ...
      files: ['x-pack/solutions/search/solutions/search/plugins/enterprise_search/**/*.{ts,tsx}'],
      excludedFiles: ['x-pack/solutions/search/solutions/search/plugins/enterprise_search/**/*.{test,mock,test_helper}.{ts,tsx}'],
      rules: {
        '@typescript-eslint/no-explicit-any': 'error',
      },
    },
    ...
    {
      // All files
      files: ['x-pack/solutions/search/solutions/search/plugins/serverless_search/**/*.{ts,tsx}', 'packages/kbn-search-*'],
      rules: {
        '@kbn/telemetry/event_generating_elements_should_be_instrumented': 'error',
      },
    },

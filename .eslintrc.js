...
module.exports = {
  ...
  overrides: [
     ...
     */
    {
      ...
      files: [
        'x-pack/plugins/integration_import/public/**/*.{js,mjs,ts,tsx}',
        'x-pack/plugins/integration_import/common/**/*.{js,mjs,ts,tsx}',
      ],
      rules: {
    ...
    },
    {
      ...
      files: [
        ...
        'x-pack/plugins/integration_import/**/*.{ts,tsx}',
      ...
      excludedFiles: [
        ...
        'x-pack/plugins/integration_import/**/*.{test,mock,test_helper}.{ts,tsx}',
    ...
    },
    {
      ...
      files: [
        ...
        'x-pack/plugins/integration_import/**/*.{js,mjs,ts,tsx}',
        'x-pack/packages/kbn-elastic-assistant/**/*.{js,mjs,ts,tsx}',
        'x-pack/packages/kbn-elastic-assistant-common/**/*.{js,mjs,ts,tsx}',

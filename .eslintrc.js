  ...
  overrides: [
    ...
    },
    {
      files: [
        ...
        'x-pack/solutions/observability/plugins/shared/**/!(*.stories.tsx|*.test.tsx|*.storybook_decorator.tsx|*.mock.tsx)',
      ],
      rules: {
        '@kbn/eui-a11y/eui_elements_should_have_a11y_props': 'warn',
      },
    },
    {

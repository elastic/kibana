...
const expandAgentQueue = (queueName: string = 'n2-4-spot', diskSizeGb?: number) => {
  ...
  return {
    ...
    spotZones:
      'europe-west1-b,us-central1-a,us-central1-b,us-central1-c,us-central1-f,northamerica-northeast2-a,southamerica-east1-b,southamerica-east1-c,asia-south2-a',
    ...additionalProps,
  };
};

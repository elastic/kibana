 ...
 * - kbn-workflow-step-schema-cli: the committed JSON Schema artifact is composed from
 *   connector types and workflows packages that sit upstream of the cli package.
 */

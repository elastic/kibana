...
# Lightweight bootstrap for Cypress test agents.
#
...
# Cypress agents only need node_modules installed — the @kbn/* module
...
echo "--- yarn install (lightweight Cypress bootstrap)"

# Use the packages baked into the agent image as a cache
# (same logic as bootstrap.sh)

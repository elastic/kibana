...
if [[ "$IS_TEST_EXECUTION_STEP" == "true" ]]; then
  ...
  buildkite-agent artifact upload 'x-pack/platform/test/serverless/functional/failure_debug/html/*.html'
  buildkite-agent artifact upload 'x-pack/solutions/*/test/**/screenshots/diff/*.png'
  buildkite-agent artifact upload 'x-pack/solutions/*/test/**/screenshots/failure/*.png'
  buildkite-agent artifact upload 'x-pack/solutions/*/test/**/screenshots/session/*.png'
  buildkite-agent artifact upload 'x-pack/solutions/*/test/serverless/**/screenshots/failure/*.png'
  buildkite-agent artifact upload 'x-pack/solutions/*/test/serverless/**/screenshots/session/*.png'
  buildkite-agent artifact upload 'x-pack/solutions/*/test/serverless/**/failure_debug/html/*.html'
  buildkite-agent artifact upload 'x-pack/solutions/*/test/functional/apps/reporting/reports/session/*.pdf'
  buildkite-agent artifact upload 'x-pack/solutions/*/test/functional/failure_debug/html/*.html'

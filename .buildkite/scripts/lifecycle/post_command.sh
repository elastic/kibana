...
if [[ "$IS_TEST_EXECUTION_STEP" == "true" ]]; then
  ...
  buildkite-agent artifact upload 'target/kibana-security-solution/playwright/**/*.zip'
  buildkite-agent artifact upload 'target/kibana-security-solution/playwright/**/*.webm'
  buildkite-agent artifact upload 'target/kibana-security-solution/playwright/**/*.png'
  buildkite-agent artifact upload 'target/kibana-security-solution/playwright/**/*.json'

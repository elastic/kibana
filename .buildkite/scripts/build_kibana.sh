...
BUILD_ARGS=""
is_pr_with_label "ci:build-all-platforms" && BUILD_ARGS="--all-platforms --skip-os-packages"
is_pr_with_label "ci:build-os-packages" && BUILD_ARGS="--all-platforms --docker-cross-compile"
...
node scripts/build $(echo "$BUILD_ARGS")

...
echo "BEATS URL: $BEATS_MANIFEST_LATEST"
curl -sv "$BEATS_MANIFEST_LATEST" 2>&1 | head -50
...
#
#
# echo $BEATS_MANIFEST_LATEST
# echo $KIBANA_MANIFEST_URL
# echo $KIBANA_BEATS_MANIFEST_URL

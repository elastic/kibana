...
KIBANA_WORKPLACE_AI_BASE_IMAGE="docker.elastic.co/kibana-ci/kibana-serverless-workplace-ai"
...
if [[ "$SKIP_BUILD" == "false" ]]; then
  ...
  retag_image_with_architecture "$KIBANA_WORKPLACE_AI_IMAGE" "kibana-serverless-workplace-ai-$BASE_VERSION-docker-image"

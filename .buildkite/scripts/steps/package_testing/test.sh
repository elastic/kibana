...
if [[ "$TEST_PACKAGE" == "deb" ]]; then
  ...
  # TODO: revert
  download_artifact kibana-default.tar.gz . --build "018ee88e-eb53-499f-a6a7-72ea1f7fb17b"
  download_artifact kibana-default-plugins.tar.gz . --build "018ee88e-eb53-499f-a6a7-72ea1f7fb17b"

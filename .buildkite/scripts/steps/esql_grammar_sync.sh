...
synchronize_lexer_grammar () {
  ...
  destination_file="./src/platform/packages/shared/kbn-esql-language/src/toolkit/parser/antlr/esql_lexer.g4"
  destination_lib_parent_dir="./src/platform/packages/shared/kbn-esql-language/src/toolkit/parser/antlr"
...
synchronize_promql_lexer_grammar () {
  ...
  destination_file="./src/platform/packages/shared/kbn-esql-language/src/toolkit/parser/antlr/promql_lexer.g4"
...
synchronize_parser_grammar () {
  ...
  destination_file="./src/platform/packages/shared/kbn-esql-language/src/toolkit/parser/antlr/esql_parser.g4"
  destination_lib_parent_dir="./src/platform/packages/shared/kbn-esql-language/src/toolkit/parser/antlr"
...
synchronize_promql_parser_grammar () {
  ...
  destination_file="./src/platform/packages/shared/kbn-esql-language/src/toolkit/parser/antlr/promql_parser.g4"
...
main () {
  ...
  antlr_dir="./src/platform/packages/shared/kbn-esql-language/src/toolkit/parser/antlr"
  set +e
  ...
  git add src/toolkit/parser/antlr/*

...
synchronize_lexer_grammar () {
  ...
  destination_file="./src/platform/packages/shared/kbn_esql_language/src/parser/antlr/esql_lexer.g4"
  destination_lib_parent_dir="./src/platform/packages/shared/kbn_esql_language/src/parser/antlr"
...
synchronize_promql_lexer_grammar () {
  ...
  destination_file="./src/platform/packages/shared/kbn_esql_language/src/parser/antlr/promql_lexer.g4"
...
synchronize_parser_grammar () {
  ...
  destination_file="./src/platform/packages/shared/kbn_esql_language/src/parser/antlr/esql_parser.g4"
  destination_lib_parent_dir="./src/platform/packages/shared/kbn_esql_language/src/parser/antlr"
...
synchronize_promql_parser_grammar () {
  ...
  destination_file="./src/platform/packages/shared/kbn_esql_language/src/parser/antlr/promql_parser.g4"
...
main () {
  ...
  antlr_dir="./src/platform/packages/shared/kbn_esql_language/src/parser/antlr"
  set +e
  ...
  cd ./src/platform/packages/shared/kbn_esql_language

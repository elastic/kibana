...
if [ -z "${CLOUD_DEPLOYMENT_ID}" ]; then
  ...
  retry 5 5 vault write "secret/ci/elastic-kibana/migrated/cloud-deploy/$CLOUD_DEPLOYMENT_NAME" username="$CLOUD_DEPLOYMENT_USERNAME" password="$CLOUD_DEPLOYMENT_PASSWORD"

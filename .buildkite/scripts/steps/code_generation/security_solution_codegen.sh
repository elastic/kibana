...
echo -e "\n[Security Solution OpenAPI Code Generation] kbn-discoveries-schemas Package\n"
(cd x-pack/solutions/security/packages/kbn-discoveries-schemas && yarn openapi:generate)

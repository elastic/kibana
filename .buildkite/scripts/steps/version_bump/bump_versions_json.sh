...
prUrl=$(gh pr create --repo elastic/kibana --base main --head "$branch" --title "[versions.json bump] $(date +%F) Bump versions.json to ${NEW_VERSION}" --body "Generated by $BUILDKITE_BUILD_URL" --label "release_note:skip" --label "backport:skip")

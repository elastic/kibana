...
if (process.env.NODE_ENV !== 'production') {
  (function () {
    ...
    const EventInternals = ReactDOM.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.Events; // const getInstanceFromNode = EventInternals[0];
    ...
    const IsSomeRendererActing = ReactSharedInternals.IsSomeRendererActing; // This is the public version of `ReactTestUtils.act`. It is implemented in
    ...
    const EventInternals$1 = ReactDOM.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.Events; // const getInstanceFromNode = EventInternals[0];
    // const getNodeFromInstance = EventInternals[1];
    // const getFiberCurrentPropsFromNode = EventInternals[2];
    // const enqueueStateRestore = EventInternals[3];
    // const restoreStateIfNeeded = EventInternals[4];
    ...
    const IsThisRendererActing$1 = EventInternals$1[6];
    const batchedUpdates$1 = ReactDOM.unstable_batchedUpdates;
    const IsSomeRendererActing$1 = ReactSharedInternals.IsSomeRendererActing; // This version of `act` is only used by our tests. Unlike the public version
    ...
    let actingUpdatesScopeDepth$1 = 0;
    function unstable_concurrentAct(scope) {
      ...
      const previousActingUpdatesScopeDepth = actingUpdatesScopeDepth$1;
      const previousIsSomeRendererActing = IsSomeRendererActing$1.current;
      const previousIsThisRendererActing = IsThisRendererActing$1.current;
      IsSomeRendererActing$1.current = true;
      IsThisRendererActing$1.current = true;
      actingUpdatesScopeDepth$1++;

      const unwind = function () {
        actingUpdatesScopeDepth$1--;
      ...
      try {
        const thenable = batchedUpdates$1(scope);
    ...
    const EventInternals$2 = ReactDOM.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.Events;
    const getInstanceFromNode = EventInternals$2[0];
    const getNodeFromInstance = EventInternals$2[1];
    const getFiberCurrentPropsFromNode = EventInternals$2[2];
    const enqueueStateRestore = EventInternals$2[3];
    const restoreStateIfNeeded = EventInternals$2[4]; // const flushPassiveEffects = EventInternals[5];

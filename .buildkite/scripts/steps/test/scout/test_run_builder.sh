...
# Rewrites **/test/**/.meta (manifest) files in the working tree. The next step ignores those
# paths (GENERATED_TEST_CONFIG_MANIFESTS) so a rewrite is not treated as a real change.

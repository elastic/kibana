...
while read -r config; do
  ...
  cmd="NODE_OPTIONS=\"--max-old-space-size=14336\" node ./scripts/jest --config="x-pack/plugins/triggers_actions_ui/jest.config.js" $parallelism --coverage=false --verbose"

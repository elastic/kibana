...
```bash
yarn test:jest src/platform/kbn-ui/side-navigation              # Run all tests
yarn test:jest src/platform/kbn-ui/side-navigation --watch      # Run in watch mode
yarn test:jest src/platform/kbn-ui/side-navigation --coverage   # Generate coverage report
```

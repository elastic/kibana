 ...
 */
export declare const Popover: ({ children, container, hasContent, isSidePanelOpen, isAnyPopoverLocked, setIsLocked, label, secondaryMenuTitle, persistent, trigger, }: PopoverProps) => JSX.Element;

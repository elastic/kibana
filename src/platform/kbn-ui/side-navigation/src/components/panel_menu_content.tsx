...
import React, { useCallback, type KeyboardEventHandler, type ReactNode } from 'react';
...
const PanelMenuMainPanel = (props: PanelMenuContentProps): JSX.Element => {
  const { collapseButton, getIsNewSecondary, item } = props;
...
const PanelMenuNestedPanels = (props: PanelMenuContentProps): JSX.Element => {
  ...
  const { collapseButton, getIsNewSecondary, item, renderNestedPanel } = props;

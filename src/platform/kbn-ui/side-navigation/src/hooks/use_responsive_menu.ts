 ...
 *
 * @param hidePrimaryLabels - whether primary nav labels are hidden (affects layout recalculation).
...
export function useResponsiveMenu(
  ...
  }, [hidePrimaryLabels, stableItemsReference, scheduleRecalculation, cancelRecalculation]);

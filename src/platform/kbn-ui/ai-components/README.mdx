...
Shared AI-related visual components for Kibana. Usable without Kibana Core.
...
`@kbn/shared-ux-ai-components` re-exports this package for existing consumers.
...
```bash
yarn test:jest src/platform/kbn-ui/ai-components
```

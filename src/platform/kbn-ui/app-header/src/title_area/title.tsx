...
const defaultAriaLabel = i18n.translate('kbnUI.appHeader.editableTitle.ariaLabel', {
  defaultMessage: 'Edit title',
});

const editInstructions = i18n.translate('kbnUI.appHeader.editableTitle.editInstructions', {
  defaultMessage: 'Editable title. Press Enter to edit.',
});

const emptyTitleErrorMessage = i18n.translate(
  'kbnUI.appHeader.editableTitle.emptyTitleErrorMessage',
  {
...
const invalidTitleErrorMessage = i18n.translate(
  'kbnUI.appHeader.editableTitle.invalidTitleErrorMessage',
  {

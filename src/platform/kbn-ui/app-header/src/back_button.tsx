...
const backLabel = i18n.translate('kbnUI.appHeader.backButtonAriaLabel', {
  defaultMessage: 'Back',
});

const getBackToLabel = (destination: string) =>
  i18n.translate('kbnUI.appHeader.backButtonAriaLabelWithDestination', {
    defaultMessage: 'Back to {destination}',
    values: { destination },
  });

const backMenuLabel = i18n.translate('kbnUI.appHeader.backButtonMenuAriaLabel', {

...
import type { AppHeaderDescription as AppHeaderDescriptionConfig } from './src';
...
const HeaderWithDescription = ({ title, description }: AppHeaderDescriptionStoryProps) => {
  return <AppHeaderView title={title} description={description} sticky={false} />;
};

const meta: Meta<AppHeaderDescriptionStoryProps> = {
  title: 'App Header Description',

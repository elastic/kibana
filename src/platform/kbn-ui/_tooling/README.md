...
- `affected_packages.js`: lists changed `@kbn/ui-*` package directories for the publish pipeline using Moon affected-project data, with kbn-ui-specific force-all handling for shared tooling and publish pipeline changes.

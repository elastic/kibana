...
Stories tagged `embeddable` are published as inline docs assets for `docs-builder` (see `@kbn/storybook` and `pnpm storybook_docs kbn_ui`). Tag a story and type it with `EmbeddableStoryObj`:

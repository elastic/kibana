...
export default function ({ getService, getPageObjects }: FtrProviderContext) {
  ...
  describe('Index editor', function () {
    ...
    it('Manual index creation', async function () {
      ...
      // Set column names in the placeholders
      expect((await indexEditor.getColumnNames()).length).to.be(4);
      ...
      expect((await indexEditor.getColumnNames()).length).to.be(5);

 ...
 * toggle) is ALREADY migrated to Scout as a shared page object exposed on the
 * `pageObjects.embeddedConsole` fixture from `@kbn/scout`
 * (`src/platform/packages/shared/kbn-scout/src/playwright/page_objects/embedded_console.ts`).
 * Usage example:
 ...
 * fixture instead of re-porting these methods.
 *

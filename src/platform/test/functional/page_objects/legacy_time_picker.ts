...
/**
 * Legacy time picker page object for pages that render EuiSuperDatePicker directly
 * (i.e. pages that have NOT been migrated to use the Unified Search bar with
 * kbn-date-range-picker). Use `TimePickerPageObject` (time_picker.ts) for pages
 * that render the Unified Search query bar.
 */
...
export class LegacyTimePickerPageObject extends FtrService {

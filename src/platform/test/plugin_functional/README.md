...
node scripts/functional_tests_server.js --config src/platform/test/plugin_functional/config_1.ts or config_2.ts
# Start a test run
node scripts/functional_test_runner.js --config src/platform/test/plugin_functional/config_1.ts or config_2.ts
```
...
```
node scripts/functional_tests_server --config src/platform/test/plugin_functional/config_1.ts or config_2.ts
```

  ...
  describe.skip('rendering service', () => {
    it('exposes plugin config settings to authenticated users', async () => {
      ...
      const expectedExposedConfigKeys = [
        ...
        'kql.autocomplete.querySuggestions.enabled (boolean?)',
        'kql.autocomplete.valueSuggestions.enabled (boolean?)',
        'kql.autocomplete.valueSuggestions.terminateAfter (duration?)',
        'kql.autocomplete.valueSuggestions.tiers (array?)',
        'kql.autocomplete.valueSuggestions.timeout (duration?)',

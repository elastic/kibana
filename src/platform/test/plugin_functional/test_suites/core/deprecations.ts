...
export default function ({ getService, getPageObjects }: PluginFunctionalProviderContext) {
  ...
  describe('deprecations service', () => {
    before(() => esArchiver.load('src/platform/test/functional/fixtures/es_archiver/deprecations_service'));
    after(() => esArchiver.unload('src/platform/test/functional/fixtures/es_archiver/deprecations_service'));

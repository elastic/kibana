...
import { useMuteAlertInstance } from 'x-pack/platform/packages/shared/response-ops/alerts-apis/hooks/use_mute_alert_instance';
import { useUnmuteAlertInstance } from 'x-pack/platform/packages/shared/response-ops/alerts-apis/hooks/use_unmute_alert_instance';

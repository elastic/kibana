...
const ERROR_TITLE = i18n.translate('alertsApis.bulkUnmuteAlerts.error', {
  defaultMessage: 'Error unmuting alerts',
});
...
export const getKey = mutationKeys.bulkUnmuteAlerts;

export const useBulkUnmuteAlerts = ({
  http,

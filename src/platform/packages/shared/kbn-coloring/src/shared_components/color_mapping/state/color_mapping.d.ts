...
export declare const updatePalette: import("@reduxjs/toolkit").ActionCreatorWithPayload<{
    ...
    color: ColorMapping.CategoricalColor | ColorMapping.ColorCode;
    at: number;
}, "colorMapping/addGradientColorStep">, changeGradientSortOrder: import("@reduxjs/toolkit").ActionCreatorWithPayload<"desc" | "asc", "colorMapping/changeGradientSortOrder">, updateModel: import("@reduxjs/toolkit").ActionCreatorWithPayload<ColorMapping.Config, "colorMapping/updateModel">;

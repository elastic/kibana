import type { PaletteContinuity, PaletteRegistry, DataBounds, CustomPaletteParams } from '../../../palettes';
...
export type ColorRangesActions = {
    ...
    payload: UpdateContinuityPayload;
} | {
    type: 'deleteColorRange';
    payload: DeleteColorRangePayload;
} | {
    type: 'addColorRange';
    payload: BasicPayload;
} | {

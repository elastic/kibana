...
import type { SourceContext } from "./painless_parser";
import type { FunctionContext } from "./painless_parser";
import type { ParametersContext } from "./painless_parser";
import type { StatementContext } from "./painless_parser";
import type { IfContext } from "./painless_parser";
import type { WhileContext } from "./painless_parser";
import type { ForContext } from "./painless_parser";
import type { EachContext } from "./painless_parser";
import type { IneachContext } from "./painless_parser";
import type { TryContext } from "./painless_parser";
import type { DoContext } from "./painless_parser";
import type { DeclContext } from "./painless_parser";
import type { ContinueContext } from "./painless_parser";
import type { BreakContext } from "./painless_parser";
import type { ReturnContext } from "./painless_parser";
import type { ThrowContext } from "./painless_parser";
import type { ExprContext } from "./painless_parser";
import type { TrailerContext } from "./painless_parser";
import type { BlockContext } from "./painless_parser";
import type { EmptyContext } from "./painless_parser";
import type { InitializerContext } from "./painless_parser";
import type { AfterthoughtContext } from "./painless_parser";
import type { DeclarationContext } from "./painless_parser";
import type { DecltypeContext } from "./painless_parser";
import type { TypeContext } from "./painless_parser";
import type { DeclvarContext } from "./painless_parser";
import type { TrapContext } from "./painless_parser";
import type { SingleContext } from "./painless_parser";
import type { CompContext } from "./painless_parser";
import type { BoolContext } from "./painless_parser";
import type { BinaryContext } from "./painless_parser";
import type { ElvisContext } from "./painless_parser";
import type { InstanceofContext } from "./painless_parser";
import type { NonconditionalContext } from "./painless_parser";
import type { ConditionalContext } from "./painless_parser";
import type { AssignmentContext } from "./painless_parser";
import type { PreContext } from "./painless_parser";
import type { AddsubContext } from "./painless_parser";
import type { NotaddsubContext } from "./painless_parser";
import type { ReadContext } from "./painless_parser";
import type { PostContext } from "./painless_parser";
import type { NotContext } from "./painless_parser";
import type { CastContext } from "./painless_parser";
import type { PrimordefcastContext } from "./painless_parser";
import type { RefcastContext } from "./painless_parser";
import type { PrimordefcasttypeContext } from "./painless_parser";
import type { RefcasttypeContext } from "./painless_parser";
import type { DynamicContext } from "./painless_parser";
import type { NewarrayContext } from "./painless_parser";
import type { PrecedenceContext } from "./painless_parser";
import type { NumericContext } from "./painless_parser";
import type { TrueContext } from "./painless_parser";
import type { FalseContext } from "./painless_parser";
import type { NullContext } from "./painless_parser";
import type { StringContext } from "./painless_parser";
import type { RegexContext } from "./painless_parser";
import type { ListinitContext } from "./painless_parser";
import type { MapinitContext } from "./painless_parser";
import type { VariableContext } from "./painless_parser";
import type { CalllocalContext } from "./painless_parser";
import type { NewobjectContext } from "./painless_parser";
import type { PostfixContext } from "./painless_parser";
import type { PostdotContext } from "./painless_parser";
import type { CallinvokeContext } from "./painless_parser";
import type { FieldaccessContext } from "./painless_parser";
import type { BraceaccessContext } from "./painless_parser";
import type { NewstandardarrayContext } from "./painless_parser";
import type { NewinitializedarrayContext } from "./painless_parser";
import type { ListinitializerContext } from "./painless_parser";
import type { MapinitializerContext } from "./painless_parser";
import type { MaptokenContext } from "./painless_parser";
import type { ArgumentsContext } from "./painless_parser";
import type { ArgumentContext } from "./painless_parser";
import type { LambdaContext } from "./painless_parser";
import type { LamtypeContext } from "./painless_parser";
import type { ClassfuncrefContext } from "./painless_parser";
import type { ConstructorfuncrefContext } from "./painless_parser";
import type { LocalfuncrefContext } from "./painless_parser";

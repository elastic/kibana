...
import 'monaco-editor/base/common/worker/webWorker';
import 'monaco-editor/platform/webWorker/browser/webWorkerService';
...
// import 'monaco-editor/editor/contrib/codeAction/browser/codeActionKeybindingResolver.js';
...
import 'monaco-editor/editor/contrib/find/browser/findController'; // Needed for Search bar functionality
...
import 'monaco-editor/editor/contrib/clipboard/browser/clipboard.js'; // Needed for native Cut/Copy/Paste context menu actions (#284086)
...
import 'monaco-editor/languages/definitions/javascript/register'; // Needed for basic javascript support
import 'monaco-editor/languages/definitions/xml/register'; // Needed for basic xml support
import 'monaco-editor/languages/definitions/yaml/register'; // Needed for yaml support
import 'monaco-editor/languages/definitions/liquid/register'; // Needed for liquid template support

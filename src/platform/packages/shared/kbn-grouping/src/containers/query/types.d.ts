import type { Script, MappingRuntimeField, MappingRuntimeFields } from '@elastic/elasticsearch/lib/api/types';
import type { RuntimeFieldSpec, RuntimePrimitiveTypes } from '@kbn/data-views-plugin/common';
import type { BoolQuery } from '@kbn/es-query';
import type { estypes } from '@elastic/elasticsearch';
type RunTimeMappings = Record<string, Omit<RuntimeFieldSpec, 'type'> & {
...
export type GroupingSort = Array<{
    [category: string]: {
        order: 'asc' | 'desc';
    };
}>;

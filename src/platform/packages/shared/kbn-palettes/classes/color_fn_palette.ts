...
export class KbnColorFnPalette extends KbnBasePalette implements IKbnPalette {
  ...
  private _colorFn: (n: number) => string[];
  private _defaultNumberOfColors: number;
  ...
  constructor({
    ...
    this._defaultNumberOfColors = defaultNumberOfColors ?? colorCount;
  }

  public colors = (n: number = this._defaultNumberOfColors) => {

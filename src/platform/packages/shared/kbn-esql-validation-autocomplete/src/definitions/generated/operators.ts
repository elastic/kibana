...
// Do not edit this manually... generated by scripts/generate_function_definitions.ts
const castDefinition: FunctionDefinition = {
  type: FunctionDefinitionTypes.OPERATOR,
  name: '::',
  ...
  validate: undefined,
  examples: ['ROW ver = CONCAT(("0"::INT + 1)::STRING, ".2.3")::VERSION'],
};
...
// Do not edit this manually... generated by scripts/generate_function_definitions.ts
const predicatesDefinition: FunctionDefinition = {
  type: FunctionDefinitionTypes.OPERATOR,
  name: 'predicates',
  description: i18n.translate('kbn-esql-validation-autocomplete.esql.definitions.predicates', {
    defaultMessage: 'For NULL comparison use the `IS NULL` and `IS NOT NULL` predicates:',
  }),
  preview: false,
  alias: undefined,
  signatures: [

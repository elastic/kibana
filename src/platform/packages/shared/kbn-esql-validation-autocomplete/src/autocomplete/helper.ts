...
import { getColumnForASTNode, compareTypesWithLiterals } from '@kbn/esql-ast/src/definitions/utils';
import {
...
export function isAggFunctionUsedAlready(command: ESQLCommand, argIndex: number) {
  ...
  return isFunctionItem(arg) ? checkContentPerDefinition(arg, FunctionDefinitionTypes.AGG) : false;
}

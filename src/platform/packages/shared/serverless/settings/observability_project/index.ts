...
export const OBSERVABILITY_STREAMS_TIERED_PROJECT_SETTINGS = [
  ...
  settings.OBSERVABILITY_STREAMS_SIG_EVENTS_INDEX_PATTERNS,
  ...
  settings.OBSERVABILITY_STREAMS_ENABLE_MEMORY,
...
export const OBSERVABILITY_AI_ASSISTANT_PROJECT_SETTINGS = [
  ...
  settings.AGENT_CONTEXT_LAYER_EXPERIMENTAL_FEATURES_SETTING_ID,
];

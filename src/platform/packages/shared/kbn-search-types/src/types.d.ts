 ...
 */
export type ISearchOptionsSerializable = Pick<ISearchOptions, 'strategy' | 'legacyHitsTotal' | 'sessionId' | 'isStored' | 'isSearchStored' | 'isRestore' | 'retrieveResults' | 'executionContext' | 'stream' | 'projectRouting'>;

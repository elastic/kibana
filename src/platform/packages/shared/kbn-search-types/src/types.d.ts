...
export type ISearchExtendGeneric = (id: string, keepAlive: string, options?: ISearchOptions) => Promise<void>;
 ...
 */
export type ISearchOptionsSerializable = Pick<ISearchOptions, 'strategy' | 'legacyHitsTotal' | 'sessionId' | 'isStored' | 'isSearchStored' | 'isRestore' | 'returnIntermediateResults' | 'executionContext' | 'stream' | 'projectRouting' | 'approximation'>;

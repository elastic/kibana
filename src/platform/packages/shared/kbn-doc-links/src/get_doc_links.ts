...
export const getDocLinks = ({ kibanaBranch, buildFlavor }: GetDocLinkOptions): DocLinks => {
  ...
  return deepFreeze({
    ...
    enterpriseSearch: {
      ...
      connectorsClients: `https://www.elastic.co/docs/reference/search-connectors`,
      ...
      upgrade9x: `https://www.elastic.co/guide/en/enterprise-search/current/upgrading-to-9-x.html`,

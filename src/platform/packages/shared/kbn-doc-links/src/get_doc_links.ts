...
export const getDocLinks = ({ kibanaBranch, buildFlavor }: GetDocLinkOptions): DocLinks => {
  ...
  return deepFreeze({
    ...
    agentBuilder: {
      agentBuilder: `${ELASTIC_DOCS}docs/solutions/search/elastic-agent-builder`,
      getStarted: `${ELASTIC_DOCS}docs/solutions/search/agent-builder/get-started`,
      chat: `${ELASTIC_DOCS}docs/solutions/search/agent-builder/chat`,
      agentBuilderAgents: `${ELASTIC_DOCS}docs/solutions/search/agent-builder/agent-builder-agents`,
      tools: `${ELASTIC_DOCS}docs/solutions/search/agent-builder/tools`,
      programmaticAccess: `${ELASTIC_DOCS}docs/solutions/search/agent-builder/programmatic-access`,
      kibanaApi: `${ELASTIC_DOCS}docs/solutions/search/agent-builder/kibana-api`,
      mcpServer: `${ELASTIC_DOCS}docs/solutions/search/agent-builder/mcp-server`,
      a2aServer: `${ELASTIC_DOCS}docs/solutions/search/agent-builder/a2a-server`,
      limitationsKnownIssues: `${ELASTIC_DOCS}docs/solutions/search/agent-builder/limitations-known-issues`,
    },
    inferenceManagement: {

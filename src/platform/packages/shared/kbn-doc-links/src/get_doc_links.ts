  ...
  return deepFreeze({
    ...
    securitySolution: {
      ...
      signalsMigrationApi: isServerless
        ? `${KIBANA_APIS}group/endpoint-security-detections-api`
        : `${KIBANA_SERVERLESS_APIS}group/endpoint-security-detections-api`,
      legacyEndpointManagementApiDeprecations: `${ELASTIC_DOCS}release-notes/kibana/breaking-changes#breaking-199598`,
      legacyRuleManagementBulkApiDeprecations: `${ELASTIC_DOCS}release-notes/kibana/breaking-changes#breaking-207091`,
    ...
    security: {
      ...
      deprecatedV1Endpoints: `${ELASTIC_DOCS}release-notes/security/breaking-changes#breaking-199656`,

...
export const getDocLinks = ({ kibanaBranch, buildFlavor }: GetDocLinkOptions): DocLinks => {
  ...
  return deepFreeze({
    ...
    agentBuilder: {
      ...
      skills: `${ELASTIC_DOCS}explore-analyze/ai-features/agent-builder/skills`,
      plugins: `${ELASTIC_DOCS}explore-analyze/ai-features/agent-builder/plugins`,
      connectors: `${ELASTIC_DOCS}explore-analyze/ai-features/agent-builder/connectors`,

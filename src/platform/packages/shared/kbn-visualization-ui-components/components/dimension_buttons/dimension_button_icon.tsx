...
const IconFromAccessorConfig = ({ accessorConfig }: { accessorConfig: AccessorConfig }) => {
  const { euiTheme } = useEuiTheme();
  const borderColor = euiTheme.colors.borderBaseFormsColorSwatch;
      ...
      <>
        {accessorConfig.triggerIconType !== 'none' && (
          <EuiFlexItem grow={false}>
            <IconFromAccessorConfig accessorConfig={accessorConfig} />
          </EuiFlexItem>
        )}
        {severity && (
          <EuiFlexItem grow={false}>

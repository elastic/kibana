...
export declare function BrowserPopoverWrapper<TItem extends {
    name: string;
}>({ items, isOpen, onClose, onSelect, isFilterOpen, setIsFilterOpen, position, i18nKeys, numTypes, numActiveFilters, filterPanel, isLoading, searchValue, setSearchValue, isMultiSelect, }: BrowserPopoverWrapperProps<TItem>): React.JSX.Element;

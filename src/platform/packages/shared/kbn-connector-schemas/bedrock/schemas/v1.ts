...
export const BedrockMessageSchema = lazySchema(() =>
  z
    .object({
      role: z.string(),
...
export const BedrockToolChoiceSchema = lazySchema(() =>
  z
    .object({
...
export const BedrockUsageSchema = lazySchema(() =>
  z
    .object({
...
export const InvokeAIRawActionParamsSchema = lazySchema(() =>
  z
    .object({
      messages: z.array(
        z
...
export const InvokeAIRawActionResponseSchema = lazySchema(() => z.object({}).passthrough());

export const ConverseResponseSchema = lazySchema(() =>
  z
    .object({
      output: z.object({
...
export const RunApiLatestResponseSchema = lazySchema(() =>
  z
    .object({
...
export const BedrockClientSendParamsSchema = lazySchema(() =>
  z
    .object({
...
export const BedrockClientSendResponseSchema = lazySchema(() => z.object({}).passthrough());

export const ConverseActionParamsSchema = lazySchema(() =>
  z
    .object({

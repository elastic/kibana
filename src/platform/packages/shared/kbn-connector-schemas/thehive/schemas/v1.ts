...
export const TheHiveConfigSchema = lazySchema(() =>
  z
    .object({
      url: z.string(),
...
export const TheHiveSecretsSchema = lazySchema(() =>
  z
    .object({
      apiKey: z.string(),
    })
...
export const ExecutorSubActionCreateAlertParamsSchema = lazySchema(() =>
  z
    .object({
      title: z.string(),
      description: z.string(),
...
export const TheHiveIncidentResponseSchema = lazySchema(() =>
  z.object({
    _id: z.string(),
    _type: z.string(),
    _createdBy: z.string(),
...
export const TheHiveUpdateIncidentResponseSchema = lazySchema(() => z.any());

export const TheHiveAddCommentResponseSchema = lazySchema(() =>
  z.object({
    _id: z.string(),
    _type: z.string(),
    createdBy: z.string(),
...
export const TheHiveCreateAlertResponseSchema = lazySchema(() =>
  z.object({
    _id: z.string(),
    _type: z.string(),
    _createdBy: z.string(),
...
export const TheHiveFailureResponseSchema = lazySchema(() =>
  z.object({

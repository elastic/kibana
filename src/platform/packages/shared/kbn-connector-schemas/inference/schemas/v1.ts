...
export const ChatCompleteParamsSchema = lazySchema(() =>
  z
    .object({
      input: z.string(),
    })
...
export const UnifiedChatCompleteParamsSchema = lazySchema(() =>
  z
    .object({
      body: z
        .object({
...
export const UnifiedChatCompleteResponseSchema = lazySchema(() =>
  z
    .object({
      id: z.string(),
      choices: z
...
export const ChatCompleteResponseSchema = lazySchema(() =>
  z
    .array(
      z
        .object({
...
export const RerankParamsSchema = lazySchema(() =>
  z
    .object({
...
export const RerankResponseSchema = lazySchema(() =>
  z
    .array(
      z
        .object({
...
export const SparseEmbeddingParamsSchema = lazySchema(() =>
  z
    .object({
      input: z.string(),
    })
...
export const SparseEmbeddingResponseSchema = lazySchema(() =>
  z.array(z.object({}).passthrough()).default([])
);

export const TextEmbeddingParamsSchema = lazySchema(() =>
  z
    .object({
      input: z.string(),
      inputType: z.string(),
...
export const TextEmbeddingResponseSchema = lazySchema(() =>
  z
    .array(
      z
        .object({
...
export const StreamingResponseSchema = lazySchema(() => z.any());

// Run action schema
export const DashboardActionParamsSchema = lazySchema(() =>
  z
    .object({
...
export const DashboardActionResponseSchema = lazySchema(() =>
  z
    .object({
      available: z.boolean(),
    })

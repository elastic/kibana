...
const SuccessfulResponse = lazySchema(() =>
  z
    .object({
...
export const FailureResponse = lazySchema(() =>
  z
    .object({
      took: z.coerce.number(),
      requestId: z.string(),
...
export const CloseAlertParamsSchema = lazySchema(() =>
  z
    .object({
      alias: z.string(),
...
const responderTypes = lazySchema(() => z.enum(['team', 'user', 'escalation', 'schedule']));

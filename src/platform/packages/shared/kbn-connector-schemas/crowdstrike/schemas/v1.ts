...
// Connector schema
export const CrowdstrikeConfigSchema = lazySchema(() =>
  z
    .object({
      url: z.string(),
    })
...
export const CrowdstrikeSecretsSchema = lazySchema(() =>
  z
    .object({
      clientId: z.string(),
...
export const CrowdstrikeApiDoNotValidateResponsesSchema = lazySchema(() => z.any());

export const RelaxedCrowdstrikeBaseApiResponseSchema = lazySchema(() =>
  z.object({}).passthrough().optional()
);

export const CrowdstrikeBaseApiResponseSchema = lazySchema(() =>
  z
    .object({
...
export const CrowdstrikeGetAgentOnlineStatusResponseSchema = lazySchema(() =>
  z
    .object({
      resources: z.array(
        z
...
export const CrowdstrikeGetAgentsResponseSchema = lazySchema(() =>
  z
    .object({
      resources: z.array(
        z
...
export const CrowdstrikeHostActionsResponseSchema = lazySchema(() =>
  z
    .object({
      resources: z.array(
        z
...
export const CrowdstrikeRTRCommandParamsSchema = lazySchema(() => z.any());
export const CrowdstrikeHostActionsParamsSchema = lazySchema(() =>
  z
    .object({
...
export const CrowdstrikeGetAgentsParamsSchema = lazySchema(() =>
  z
    .object({
      ids: z.array(z.string()),
    })
...
export const CrowdstrikeGetTokenResponseSchema = lazySchema(() =>
  z
    .object({
...
export const CrowdstrikeHostActionsSchema = lazySchema(() =>
  z
    .object({
...
export const CrowdstrikeInitRTRResponseSchema = lazySchema(() =>
  z
    .object({
      meta: z
        .object({
...
export const CrowdstrikeInitRTRParamsSchema = lazySchema(() =>
  z
    .object({
...
export const CrowdstrikeExecuteRTRResponseSchema = lazySchema(() =>
  z
    .object({
      combined: z
        .object({
...
export const CrowdstrikeGetScriptsResponseSchema = lazySchema(() =>
  z
    .object({
      meta: z
        .object({

...
export const ExternalIncidentServiceConfigurationBaseSchema = lazySchema(() =>
  z.object(ExternalIncidentServiceConfigurationBase).strict()
);
...
export const CommentsSchema = lazySchema(() =>
  z
    .array(
      z
        .object({
...
export const ExecutorSubActionGetChoicesParamsSchema = lazySchema(() =>
  z
    .object({
...
export const ExecutorSubActionCloseIncidentParamsSchema = lazySchema(() =>
  z
    .object({
      incident: z
        .object({

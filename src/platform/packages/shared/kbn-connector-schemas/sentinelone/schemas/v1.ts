...
// Connector schema
export const SentinelOneConfigSchema = lazySchema(() => z.object({ url: z.string() }).strict());
export const SentinelOneSecretsSchema = lazySchema(() =>
  z
    .object({
      token: z.string(),
    })
...
export const SentinelOneApiDoNotValidateResponsesSchema = lazySchema(() => z.any());

export const SentinelOneBaseApiResponseSchema = lazySchema(() =>
  z.object({}).passthrough().optional()
);

export const SentinelOneGetAgentsResponseSchema = lazySchema(() =>
  z
    .object({
      pagination: z
        .object({
      ...
      data: z.array(
        z
          .object({
            ...
            locations: z
              .array(
                z.object({ name: z.string(), scope: z.string(), id: z.string() }).passthrough()
              )
              .nullable()
              .default(null),
            id: z.string(),
...
export const SentinelOneIsolateHostResponseSchema = lazySchema(() =>
  z
    .object({
      errors: z.array(z.string()).nullable().default(null),
...
export const SentinelOneGetRemoteScriptsParamsSchema = lazySchema(() =>
  z
    .object({
...
export const SentinelOneFetchAgentFilesParamsSchema = lazySchema(() =>
  z
    .object({
...
export const SentinelOneFetchAgentFilesResponseSchema = lazySchema(() =>
  z
    .object({
      errors: z.array(z.string()).nullable().default(null),
      data: z
...
export const SentinelOneDownloadAgentFileParamsSchema = lazySchema(() =>
  z
    .object({
      agentId: z.string().min(1),
...
export const SentinelOneDownloadAgentFileResponseSchema = lazySchema(() => z.any());

export const SentinelOneGetActivitiesParamsSchema = lazySchema(() =>
  z
    .object({
...
export const SentinelOneGetActivitiesResponseDataSchema = lazySchema(() =>
  z
    .object({
      accountId: z.string(),
      accountName: z.string(),
...
export const SentinelOneGetActivitiesResponseNoDataSchema = lazySchema(() =>
  SentinelOneGetActivitiesResponseDataSchema.omit({ data: true })
);

export const SentinelOneGetActivitiesResponseSchema = lazySchema(() =>
  z
    .object({
...
export const SentinelOneGetRemoteScriptsResponseSchema = lazySchema(() =>
  z
    .object({
      errors: z.array(z.string()).nullable().default(null),
      pagination: z
...
export const SentinelOneExecuteScriptParamsSchema = lazySchema(() =>
  z
    .object({
      ...
      script: z
        .object({
          ...
          outputDestination: z
            .enum(['Local', 'None', 'SentinelCloud', 'SingularityXDR'])
            .optional(),
          passwordFromScope: z
            .object({
...
export const SentinelOneGetRemoteScriptResultsResponseSchema = lazySchema(() =>
  z
    .object({
      errors: z
...
export const SentinelOneDownloadRemoteScriptResultsParamsSchema = lazySchema(() =>
  z
    .object({
...
export const SentinelOneDownloadRemoteScriptResultsResponseSchema = lazySchema(() => z.any());

export const SentinelOneGetRemoteScriptStatusParamsSchema = lazySchema(() =>
  z
    .object({
...
export const SentinelOneGetRemoteScriptStatusResponseSchema = lazySchema(() =>
  z
    .object({
      pagination: z
        .object({
...
export const SentinelOneBaseFilterSchema = lazySchema(() =>
  z
    .object({
...
export const SentinelOneIsolateHostSchema = lazySchema(() =>
  z
    .object({
...
export const SentinelOneReleaseHostSchema = lazySchema(() =>
  z
    .object({
...
export const SentinelOneExecuteScriptSchema = lazySchema(() =>
  z
    .object({
...
export const SentinelOneActionParamsSchema = lazySchema(() =>
  z.union([

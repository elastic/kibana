 ...
 * @example
 * Input
 * const obj = lazyObject({ a: heavyCall(), b: 2 });
 *
 * @example
 * Output (conceptual)
 * const obj = (() => {
 *   const __t = {};
 *   Object.defineProperty(__t, 'a', {
 *     enumerable: true,
 *     configurable: true,
 *     get() {
 *       const v = heavyCall();
 *       Object.defineProperty(__t, 'a', { value: v, enumerable: true, configurable: true, writable: true });
 *       return v;
 *     },
 *     set(v) {
 *       Object.defineProperty(__t, 'a', { value: v, enumerable: true, configurable: true, writable: true });
 *     },
 *   });
 *   Object.defineProperty(__t, 'b', { value: 2, enumerable: true, configurable: true, writable: true });
 *   return __t;
 * })();
 *
 * @public

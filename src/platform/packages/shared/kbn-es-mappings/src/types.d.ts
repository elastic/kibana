...
type SupportedMappingPropertyType = AllMappingPropertyType & ('text' | 'match_only_text' | 'semantic_text' | 'integer' | 'keyword' | 'boolean' | 'date' | 'short' | 'byte' | 'float' | 'date_nanos' | 'double' | 'long' | 'flattened' | 'object' | 'flattened');

...
export declare const useLayoutApi: (state: ControlGroupCreationOptions["initialState"] | undefined, childrenApi: ReturnType<typeof useChildrenApi>["childrenApi"], lastSavedState$Ref: React.MutableRefObject<BehaviorSubject<ControlPanelsState>>) => {
    ...
    addNewPanel: <State extends PinnedControlState = import("@kbn/config-schema/src/types").ObjectResultUnionType<{
    ...
    replacePanel: <State extends PinnedControlState = import("@kbn/config-schema/src/types").ObjectResultUnionType<{
        id: import("@kbn/config-schema").Type<string | undefined>;
        width: import("@kbn/config-schema").Type<"small" | "medium" | "large">;
        grow: import("@kbn/config-schema").Type<boolean>;
        type: import("@kbn/config-schema").Type<"esql_control">;

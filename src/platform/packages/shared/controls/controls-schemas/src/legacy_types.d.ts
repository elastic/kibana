...
export interface LegacyStoredPinnedControlState {
    [id: string]: {
        ...
        width?: string;
        grow?: boolean;
        explicitInput: LegacyStoredOptionsListExplicitInput | LegacyStoredRangeSliderExplicitInput | LegacyStoredRangeSliderExplicitInput | LegacyStoredTimeSliderExplicitInput;
    };
}

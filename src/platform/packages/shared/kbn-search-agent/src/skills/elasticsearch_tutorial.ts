...
// @generated — DO NOT EDIT DIRECTLY. Edit .elasticsearch-agent/skills/recipes/elasticsearch-tutorial/SKILL.md and run ./build

export const elasticsearchTutorialSkill = {
  id: 'elasticsearch-tutorial',

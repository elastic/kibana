 ...
 */
export declare const getEditorExtensions: (http: HttpStart, queryString: string, activeSolutionId: ESQLRegistrySolutionId, signal?: AbortSignal) => Promise<EditorExtensions>;
export {};

 ...
 */
export declare function convertTimeseriesCommandNodeToFrom<T extends ESQLCommand>(cmd: T): T;
/**
 ...
 */
export declare const parseTimeFieldFromESQLQuery: (esql: string) => string | undefined;

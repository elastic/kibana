...
export declare function getESQLQueryColumnsRaw({ esqlQuery, search, signal, filter, dropNullColumns, timeRange, variables, includeColumnMetadata, }: {
    esqlQuery: string;
...
export declare function getESQLQueryColumns({ esqlQuery, search, signal, filter, dropNullColumns, timeRange, variables, includeColumnMetadata, }: {
    esqlQuery: string;
    search: ISearchGeneric;
    signal?: AbortSignal;
    filter?: unknown;
...
export declare function getESQLResults({ esqlQuery, search, signal, filter, dropNullColumns, timeRange, variables, timezone, executionContext, approximation, projectRouting, includeColumnMetadata, }: {
    esqlQuery: string;
    search: ISearchGeneric;
    signal?: AbortSignal;
    filter?: unknown;

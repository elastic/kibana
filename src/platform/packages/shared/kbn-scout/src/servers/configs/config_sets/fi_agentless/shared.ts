...
/**
 * AWS package version to pre-install.
 * Use 'latest' until the Identity Federation release (7.2.0) is published to the
 * package registry, then pin to the specific version so the suite is deterministic.
 */
export const AWS_PACKAGE_VERSION = 'latest';

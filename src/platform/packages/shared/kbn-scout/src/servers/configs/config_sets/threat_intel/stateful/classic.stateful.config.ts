 ...
 *
 * Threat-intel supply gates on `xpack.alertzero.enabled` (routes, tasks, and
 * bootstrap). Without it every threat intel route 404s and the suite fails
 * against Kibana's generic route-not-found rather than the handlers under
...
export const servers: ScoutServerConfig = {
  ...
  kbnTestServer: {
    ...
    serverArgs: [...defaultConfig.kbnTestServer.serverArgs, '--xpack.alertzero.enabled=true'],
  },
};

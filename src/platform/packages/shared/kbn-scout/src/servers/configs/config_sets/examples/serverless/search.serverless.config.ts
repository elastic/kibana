...
/**
 * Scout server config for example-plugin tests on local serverless Search.
 *
 * Usage:
 *   node scripts/scout.js start-server --arch serverless --domain search --serverConfigSet examples
 */

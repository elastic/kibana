...
/**
 * Scout server config for example-plugin tests on local serverless Security complete.
 *
 * Usage:
 *   node scripts/scout.js start-server --arch serverless --domain security_complete --serverConfigSet examples
 */

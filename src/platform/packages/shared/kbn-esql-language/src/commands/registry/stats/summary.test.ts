...
describe('STATS summary', () => {
  it.each([
    {
      description: 'returns new column for assignment',
    ...
    {
      description: 'returns new column for expression without assignment',
    ...
    {
      description: 'returns aggregation column and grouping column',
    ...
    {
      description: 'returns assigned aggregation and assigned grouping columns',
    ...
    {
      description: 'returns correct column name when using WHERE clause',
    ...
    {
      description: 'returns correct column name when using WHERE clause - with no assignment',

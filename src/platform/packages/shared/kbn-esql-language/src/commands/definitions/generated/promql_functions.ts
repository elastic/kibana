...
const absDefinition: PromQLFunctionDefinition = {
  type: PromQLFunctionDefinitionTypes.PROMQL_VALUE_TRANSFORMATION,
  name: 'abs',
...
const absentOverTimeDefinition: PromQLFunctionDefinition = {
  type: PromQLFunctionDefinitionTypes.PROMQL_WITHIN_SERIES,
...
const piDefinition: PromQLFunctionDefinition = {
  type: PromQLFunctionDefinitionTypes.PROMQL_SCALAR,
  name: 'pi',
...
const vectorDefinition: PromQLFunctionDefinition = {
  type: PromQLFunctionDefinitionTypes.PROMQL_VECTOR_CONVERSION,
  name: 'vector',

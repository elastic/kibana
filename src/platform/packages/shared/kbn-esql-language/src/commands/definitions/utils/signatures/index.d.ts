...
export { areParamsHomogeneous, hasVariadicSignature, hasRepeatingSignature, hasArbitraryExpressionSignature, hasBooleanSignature, isConstantParameter, } from './traits';

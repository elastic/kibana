 ...
 */
export declare const useSearchAlertsQuery: ({ data, skipAlertsQueryContext, ...params }: UseSearchAlertsQueryParams) => import("@tanstack/react-query").UseQueryResult<import("../apis/search_alerts/search_alerts").SearchAlertsResult, unknown>;

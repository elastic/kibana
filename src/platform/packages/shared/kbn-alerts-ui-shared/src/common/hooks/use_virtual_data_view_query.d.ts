 ...
 */
export declare const useVirtualDataViewQuery: ({ dataViewsService, indexNames }: UseVirtualDataViewParams, options?: QueryOptionsOverrides<DataViewsContract["create"]>) => import("@tanstack/react-query").UseQueryResult<import("@kbn/data-views-plugin/common").DataView, unknown>;

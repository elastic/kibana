 ...
 */
export declare const useGetAlertsGroupAggregationsQuery: <T>({ http, toasts, enabled, params, }: UseGetAlertsGroupAggregationsQueryProps) => import("@tanstack/react-query").UseQueryResult<SearchResponseBody<{}, T>, Error>;

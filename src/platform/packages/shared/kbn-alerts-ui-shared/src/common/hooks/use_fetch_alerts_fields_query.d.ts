 ...
 */
export declare const useFetchAlertsFieldsQuery: ({ http, ...params }: UseFetchAlertsFieldsQueryParams, options?: Pick<QueryOptionsOverrides<typeof fetchAlertsFields>, "placeholderData" | "context" | "onError" | "refetchOnWindowFocus" | "staleTime" | "enabled">) => import("@tanstack/react-query").UseQueryResult<{

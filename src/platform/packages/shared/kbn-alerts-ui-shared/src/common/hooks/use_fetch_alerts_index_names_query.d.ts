 ...
 */
export declare const useFetchAlertsIndexNamesQuery: ({ http, ruleTypeIds }: UseFetchAlertsIndexNamesQueryParams, options?: Pick<QueryOptionsOverrides<typeof fetchAlertsIndexNames>, "context" | "onError" | "refetchOnWindowFocus" | "staleTime" | "enabled">) => import("@kbn/react-query").UseQueryResult<string[], unknown>;

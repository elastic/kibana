 ...
 */
export declare const useFetchAlertsIndexNamesQuery: ({ http, ruleTypeIds }: UseFetchAlertsIndexNamesQueryParams, options?: Pick<QueryOptionsOverrides<typeof fetchAlertsIndexNames>, "context" | "enabled" | "onError" | "refetchOnWindowFocus" | "retry" | "staleTime">) => import("@tanstack/react-query").UseQueryResult<string[], unknown>;

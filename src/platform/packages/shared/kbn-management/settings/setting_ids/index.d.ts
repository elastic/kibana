...
export declare const OBSERVABILITY_STREAMS_SIG_EVENTS_INDEX_PATTERNS = "observability:streamsSigEventsIndexPatterns";
export declare const OBSERVABILITY_STREAMS_SIG_EVENTS_TUNING_CONFIG = "observability:streamsSigEventsTuningConfig";

...
export declare const AGENT_BUILDER_EXPERIMENTAL_FEATURES_SETTING_ID = "agentBuilder:experimentalFeatures";
export declare const AGENT_BUILDER_BASH_SUPPORT_SETTING_ID = "agentBuilder:bashSupport";
export declare const AGENT_BUILDER_PRE_PROMPT_WORKFLOW_IDS = "agentBuilder:prePromptWorkflowIds";
export declare const AGENT_BUILDER_UIAM_OAUTH_CLIENT_MANAGEMENT_SETTING_ID = "agentBuilder:uiamOAuthClientManagement";
export declare const AGENT_BUILDER_TRACING_ENABLED_SETTING_ID = "agentBuilder:tracing:enabled";
export declare const AGENT_BUILDER_TRACING_USER_PROMPTS_SETTING_ID = "agentBuilder:tracing:includeUserPrompts";
export declare const AGENT_BUILDER_TRACING_LLM_RESPONSES_SETTING_ID = "agentBuilder:tracing:includeLlmResponses";
export declare const AGENT_BUILDER_TRACING_TOOL_DETAILS_SETTING_ID = "agentBuilder:tracing:includeToolDetails";
export declare const AGENT_BUILDER_TRACING_SYSTEM_PROMPT_SETTING_ID = "agentBuilder:tracing:includeSystemPrompt";
export declare const AGENT_BUILDER_TRACING_REAL_NAMES_SETTING_ID = "agentBuilder:tracing:includeRealNames";
export declare const AGENT_BUILDER_TRACING_REAL_IDS_SETTING_ID = "agentBuilder:tracing:includeRealIds";
export declare const CONTEXT_ENGINE_ENABLED_SETTING_ID = "contextEngine:enabled";
...
export declare const ML_ANOMALY_DETECTION_RESULTS_ENABLE_TIME_DEFAULTS_ID = "ml:anomalyDetection:results:enableTimeDefaults";
export declare const ML_ANOMALY_DETECTION_RESULTS_TIME_DEFAULTS_ID = "ml:anomalyDetection:results:timeDefaults";
...
export declare const OBSERVABILITY_APM_AWS_LAMBDA_PRICE_FACTOR_ID = "observability:apmAWSLambdaPriceFactor";
export declare const OBSERVABILITY_APM_AWS_LAMBDA_REQUEST_COST_PER_MILLION_ID = "observability:apmAWSLambdaRequestCostPerMillion";
export declare const OBSERVABILITY_APM_DEFAULT_SERVICE_ENVIRONMENT_ID = "observability:apmDefaultServiceEnvironment";
export declare const OBSERVABILITY_APM_PROGRESSIVE_LOADING_ID = "observability:apmProgressiveLoading";
export declare const OBSERVABILITY_APM_SERVICE_GROUP_MAX_NUMBER_OF_SERVICE_ID = "observability:apmServiceGroupMaxNumberOfServices";
export declare const OBSERVABILITY_ENABLE_COMPARISON_BY_DEFAULT_ID = "observability:enableComparisonByDefault";
export declare const OBSERVABILITY_ENABLE_INFRASTRUCTURE_ASSET_CUSTOM_DASHBOARDS_ID = "observability:enableInfrastructureAssetCustomDashboards";
export declare const OBSERVABILITY_ENABLE_INSPECT_ES_QUERIES_ID = "observability:enableInspectEsQueries";
export declare const OBSERVABILITY_MAX_SUGGESTIONS_ID = "observability:maxSuggestions";
export declare const OBSERVABILITY_APM_ENABLE_TABLE_SEARCH_BAR = "observability:apmEnableTableSearchBar";
export declare const OBSERVABILITY_APM_ENABLE_SERVICE_INVENTORY_TABLE_SEARCH_BAR = "observability:apmEnableServiceInventoryTableSearchBar";
export declare const OBSERVABILITY_APM_TRACE_LOGS_DEFAULT_COLUMNS_ID = "observability:apmTraceLogsDefaultColumns";
export declare const OBSERVABILITY_LOGS_SHARED_NEW_LOGS_OVERVIEW_ID = "observability:newLogsOverview";
export declare const OBSERVABILITY_LOGS_DATA_ACCESS_LOG_SOURCES_ID = "observability:logSources";
export declare const OBSERVABILITY_AI_ASSISTANT_SIMULATED_FUNCTION_CALLING = "observability:aiAssistantSimulatedFunctionCalling";
export declare const OBSERVABILITY_AI_ASSISTANT_SEARCH_CONNECTOR_INDEX_PATTERN = "observability:aiAssistantSearchConnectorIndexPattern";
export declare const GEN_AI_SETTINGS_DEFAULT_AI_CONNECTOR = "genAiSettings:defaultAIConnector";
export declare const GEN_AI_SETTINGS_DEFAULT_AI_CONNECTOR_DEFAULT_ONLY = "genAiSettings:defaultAIConnectorOnly";
export declare const GEN_AI_SETTINGS_TOKEN_USAGE_TRACKING = "genAiSettings:tokenUsageTracking";
export declare const AI_ASSISTANT_PREFERRED_AI_ASSISTANT_TYPE = "aiAssistant:preferredAIAssistantType";
...
export declare const OBSERVABILITY_SEARCH_EXCLUDED_DATA_TIERS = "observability:searchExcludedDataTiers";
export declare const OBSERVABILITY_STREAMS_ENABLE_SIGNIFICANT_EVENTS = "observability:streamsEnableSignificantEvents";
export declare const OBSERVABILITY_STREAMS_ENABLE_SIGNIFICANT_EVENTS_DISCOVERY = "observability:streamsEnableSignificantEventsDiscovery";
export declare const OBSERVABILITY_STREAMS_ENABLE_GROUP_STREAMS = "observability:streamsEnableGroupStreams";
export declare const OBSERVABILITY_STREAMS_ENABLE_QUERY_STREAMS = "observability:streamsEnableQueryStreams";
export declare const OBSERVABILITY_STREAMS_ENABLE_CONTENT_PACKS = "observability:streamsEnableContentPacks";
export declare const OBSERVABILITY_STREAMS_ENABLE_WIRED_STREAM_VIEWS = "observability:streamsEnableWiredStreamViews";
export declare const OBSERVABILITY_STREAMS_ENABLE_DRAFT_STREAMS = "observability:streamsEnableDraftStreams";
export declare const OBSERVABILITY_STREAMS_ENABLE_CANVAS = "observability:streamsEnableCanvas";
export declare const OBSERVABILITY_STREAMS_CONTINUOUS_KI_EXTRACTION_ENABLED = "observability:streamsContinuousKiExtractionEnabled";
export declare const OBSERVABILITY_STREAMS_CONTINUOUS_KI_EXTRACTION_INTERVAL_HOURS = "observability:streamsContinuousKiExtractionIntervalHours";
export declare const OBSERVABILITY_STREAMS_CONTINUOUS_KI_EXTRACTION_EXCLUDED_STREAM_PATTERNS = "observability:streamsContinuousKiExtractionExcludedStreamPatterns";
export declare const OBSERVABILITY_STREAMS_SIGNIFICANT_EVENTS_INDEX_PATTERNS = "observability:streamsSigEventsIndexPatterns";
export declare const OBSERVABILITY_STREAMS_SIGNIFICANT_EVENTS_TUNING_CONFIG = "observability:streamsSigEventsTuningConfig";
export declare const OBSERVABILITY_STREAMS_SIGNIFICANT_EVENTS_SCHEDULED_DISCOVERY_ENABLED = "observability:streamsSigEventsScheduledDiscoveryEnabled";
export declare const OBSERVABILITY_STREAMS_SIGNIFICANT_EVENTS_SCHEDULED_DISCOVERY_DETECTION_INTERVAL_MINUTES = "observability:streamsSigEventsScheduledDiscoveryDetectionIntervalMinutes";
export declare const OBSERVABILITY_STREAMS_SIGNIFICANT_EVENTS_SCHEDULED_DISCOVERY_REVIEW_INTERVAL_MINUTES = "observability:streamsSigEventsScheduledDiscoveryReviewIntervalMinutes";
export declare const OBSERVABILITY_STREAMS_SIGNIFICANT_EVENTS_SCHEDULED_DISCOVERY_DISCOVERY_BATCH_SIZE = "observability:streamsSigEventsScheduledDiscoveryDiscoveryBatchSize";
export declare const OBSERVABILITY_STREAMS_SIGNIFICANT_EVENTS_SCHEDULED_DISCOVERY_TRIAGE_BATCH_SIZE = "observability:streamsSigEventsScheduledDiscoveryTriageBatchSize";
export declare const OBSERVABILITY_STREAMS_SIGNIFICANT_EVENTS_SCHEDULED_DISCOVERY_MAX_REVIEW_PASSES = "observability:streamsSigEventsScheduledDiscoveryMaxReviewPasses";
...
export declare const COURIER_IGNORE_FILTER_IF_FIELD_NOT_IN_INDEX_ID = "courier:ignoreFilterIfFieldNotInIndex";
...
export declare const SECURITY_SOLUTION_REFRESH_INTERVAL_DEFAULTS_ID = "securitySolution:refreshIntervalDefaults";
...
export declare const SECURITY_SOLUTION_DEFAULT_THREAT_INDEX_ID = "securitySolution:defaultThreatIndex";
export declare const SECURITY_SOLUTION_DEFAULT_ANOMALY_SCORE_ID = "securitySolution:defaultAnomalyScore";
export declare const SECURITY_SOLUTION_ENABLE_GROUPED_NAV_ID = "securitySolution:enableGroupedNav";
export declare const SECURITY_SOLUTION_RULES_TABLE_REFRESH_ID = "securitySolution:rulesTableRefresh";
...
export declare const SECURITY_SOLUTION_IP_REPUTATION_LINKS_ID = "securitySolution:ipReputationLinks";
export declare const SECURITY_SOLUTION_SHOW_RELATED_INTEGRATIONS_ID = "securitySolution:showRelatedIntegrations";
...
export declare const SECURITY_SOLUTION_INCLUDED_DATA_STREAM_NAMESPACES_FOR_RULE_EXECUTION: "securitySolution:includedDataStreamNamespacesForRuleExecution";
...
export declare const SECURITY_SOLUTION_ALERT_ANALYSIS_WORKFLOW_AUTO_CLOSE_ENABLED: "securitySolution:alertAnalysisWorkflowAutoCloseEnabled";
export declare const SECURITY_SOLUTION_ALERT_ANALYSIS_WORKFLOW_AUTO_CLOSE_CONFIDENCE_SCORE_MIN_THRESHOLD: "securitySolution:alertAnalysisWorkflowAutoCloseConfidenceScoreMinThreshold";
export declare const SECURITY_SOLUTION_ALERT_ANALYSIS_WORKFLOW_AUTO_CLOSE_CONFIDENCE_SCORE_MAX_THRESHOLD: "securitySolution:alertAnalysisWorkflowAutoCloseConfidenceScoreMaxThreshold";
export declare const SECURITY_SOLUTION_ALERT_ANALYSIS_WORKFLOW_CONNECTOR_ID: "securitySolution:alertAnalysisWorkflowConnectorId";
export declare const SECURITY_SOLUTION_ALERT_ANALYSIS_WORKFLOW_AGENT_ID: "securitySolution:alertAnalysisWorkflowAgentId";
export declare const SECURITY_SOLUTION_ALERT_ANALYSIS_WORKFLOW_CREATE_CONVERSATION: "securitySolution:alertAnalysisWorkflowCreateConversation";
export declare const SECURITY_SOLUTION_ALERT_ANALYSIS_WORKFLOW_ENABLED: "securitySolution:alertAnalysisWorkflowEnabled";
export declare const SECURITY_SOLUTION_ALERT_ANALYSIS_WORKFLOW_TAG_PREFIX: "securitySolution:alertAnalysisWorkflowTagPrefix";
...
export declare const VISUALIZATION_LEGACY_GAUGE_CHARTS_LIBRARY_ID = "visualization:visualize:legacyGaugeChartsLibrary";
export declare const VISUALIZATION_LEGACY_HEATMAP_CHARTS_LIBRARY_ID = "visualization:visualize:legacyHeatmapChartsLibrary";

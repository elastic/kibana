 ...
 */
export declare function getFieldInputValue(field: F<'array'>, change?: C<'array'>): [string[], boolean];
/**
 ...
 */
export declare function getFieldInputValue(field: F<'color'>, change?: C<'color'>): [string, boolean];
/**
 ...
 */
export declare function getFieldInputValue(field: F<'boolean'>, change?: C<'boolean'>): [boolean, boolean];
/**
 ...
 */
export declare function getFieldInputValue(field: F<'image'>, change?: C<'image'>): [string, boolean];
/**
 ...
 */
export declare function getFieldInputValue(field: F<'json'>, change?: C<'json'>): [string, boolean];
/**
 ...
 */
export declare function getFieldInputValue(field: F<'markdown'>, change?: C<'markdown'>): [string, boolean];
/**
 ...
 */
export declare function getFieldInputValue(field: F<'number'>, change?: C<'number'>): [number, boolean];
/**
 ...
 */
export declare function getFieldInputValue(field: F<'select'>, change?: C<'select'>): [string, boolean];
/**
 ...
 */
export declare function getFieldInputValue(field: F<'string'>, change?: C<'string'>): [string, boolean];
/**
 ...
 */
export declare function getFieldInputValue(field: F<'undefined'>, change?: C<'undefined'>): [string | null | undefined, boolean];
export {};

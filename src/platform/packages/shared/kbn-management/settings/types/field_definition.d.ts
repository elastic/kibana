...
import type { DeprecationSettings, TechnicalPreviewSettings, UiSettingsSolutions } from '@kbn/core-ui-settings-common';
 ...
 * @public
 */
export interface FieldDefinition<T extends SettingType = SettingType, V = KnownTypeToValue<T> | null> {

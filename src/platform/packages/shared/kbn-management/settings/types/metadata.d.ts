 ...
 * @public
 */
export interface UiSettingMetadata<T extends SettingType = SettingType, V = KnownTypeToValue<T> | null> extends UiSetting<V> {
    /**
 ...
 * @public
 */
export type KnownTypeToMetadata<T extends SettingType> = T extends 'array' ? ArrayUiSettingMetadata : T extends 'boolean' ? BooleanUiSettingMetadata : T extends 'color' ? ColorUiSettingMetadata : T extends 'image' ? ImageUiSettingMetadata : T extends 'json' ? JsonUiSettingMetadata : T extends 'markdown' ? MarkdownUiSettingMetadata : T extends 'number' ? NumberUiSettingMetadata : T extends 'select' ? SelectUiSettingMetadata : T extends 'string' ? StringUiSettingMetadata : T extends 'undefined' ? UndefinedUiSettingMetadata : never;

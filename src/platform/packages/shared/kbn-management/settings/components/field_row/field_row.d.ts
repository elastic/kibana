...
type Definition<T extends SettingType = SettingType> = Pick<FieldDefinition<T>, 'ariaAttributes' | 'defaultValue' | 'defaultValueDisplay' | 'displayName' | 'groupId' | 'id' | 'isCustom' | 'isDefaultValue' | 'isOverridden' | 'name' | 'savedValue' | 'type' | 'technicalPreview' | 'experimental' | 'unsavedFieldId'>;
/**

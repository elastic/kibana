...
export declare const useFieldStyles: <T extends SettingType>({ field, unsavedChange }: Params<T>) => {
    cssFieldFormGroup: import("@emotion/utils").SerializedStyles;
    cssFieldTitle: import("@emotion/utils").SerializedStyles;
    cssDescription: import("@emotion/utils").SerializedStyles;
};

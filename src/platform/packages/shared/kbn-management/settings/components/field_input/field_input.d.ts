 ...
 */
export declare const FieldInput: React.ForwardRefExoticComponent<FieldInputProps<import("@kbn/core/public").UiSettingsType> & React.RefAttributes<ResetInputRef>>;

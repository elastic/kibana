...
export type UnifiedFieldListSidebarCustomizableProps = Pick<UnifiedFieldListItemProps, 'services' | 'workspaceSelectedFieldNames' | 'dataView' | 'trackUiMetric' | 'onAddFilter' | 'onAddBreakdownField' | 'onAddFieldToWorkspace' | 'onRemoveFieldFromWorkspace' | 'additionalFilters'> & {
    /**

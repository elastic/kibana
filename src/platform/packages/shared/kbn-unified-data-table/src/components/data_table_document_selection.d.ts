...
export declare function DataTableDocumentToolbarBtn({ isPlainRecord, isFilterActive, rows, setIsFilterActive, selectedDocsState, enableComparisonMode, setIsCompareActive, fieldFormats, pageIndex, pageSize, toastNotifications, columns, customBulkActions, hideDefaultBulkActions, }: {

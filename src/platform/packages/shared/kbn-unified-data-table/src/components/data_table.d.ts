...
interface InternalUnifiedDataTableProps {
     ...
     */
    renderDocumentView?: (hit: DataTableRecord, displayedRows: DataTableRecord[], displayedColumns: string[], expandedDocSetter: (doc?: DataTableRecord, options?: {
        initialTabId?: string;
    }) => void, columnsMeta?: DataTableColumnsMeta) => JSX.Element | undefined;
    /**

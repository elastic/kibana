import { type EuiDataGridStyle, type EuiThemeComputed } from '@elastic/eui';
...
export declare const getDataGridDensityPadding: (euiTheme: EuiThemeComputed, density: DataGridDensity) => string;

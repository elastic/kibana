...
describe('copyValueToClipboard', () => {
  ...
  const textOutputWithFormulasTabular =
...
| --- | --- |
| false | abcd1 |`;
  const textOutputWithFormulasMarkdown = `| bool_enabled | scripted_string |
| --- | --- |
| false | hi there |
| true | =1+2";=1+2 |`;
...
| I'm multiline *&%$#\\|@ |`;
  describe.each([
    [
      CopyAsTextFormat.tabular,
      textOutputTabular,
      textOutputWithFormulasTabular,
      textOutputEscapedTabular,
    ],
    [
      CopyAsTextFormat.markdown,
      textOutputMarkdown,
      textOutputWithFormulasMarkdown,
      textOutputEscapedMarkdown,
    ],
  ])(
    'copyRowsAsTextToClipboard format: %s',
    (format, textOutput, textOutputWithFormulas, textOutputEscaped) => {

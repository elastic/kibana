 ...
 */
export interface PartFactory<TPresetMap extends object = Record<string, unknown>, TOutput = ReactNode, TContext = void> {
    /**
     ...
     */
    tagComponent: <C extends (...args: any[]) => null>(component: C, options?: {
...
export interface AssemblyFactory<TName extends string = string> {
     ...
     * ```
     */
    definePart: <TPresetMap extends object = Record<string, unknown>, TOutput = ReactNode, TContext = void>(partDefinition: {
        name: string;
     ...
     */
    parseChildren: (children: ReactNode, options?: {

...
import { type NameCellTagsProps } from './cell_tags';
 ...
 */
export declare const NameCell: React.MemoExoticComponent<({ item, showDescription, showTags, showStarred, onClick, shouldUseHref, onTagClick, }: NameCellProps) => React.JSX.Element>;

...
import type { ContentListFeatures, ContentListServices, SortingConfig } from '@kbn/content-list-provider';
 ...
 */
export type ContentListFilterConfig = ContentListFilterMap | ((defaults: ContentListFilterMap) => ContentListFilterMap);
...
export interface ContentListClientFeatures extends Omit<ContentListFeatures, 'contentEditor' | 'sorting'> {
    /**
 ...
 */
export type TableListViewFindItemsFn = (searchQuery: string, options?: TableListViewFindItemsOptions, 
/** Optional abort signal for request cancellation. */
signal?: AbortSignal) => Promise<TableListViewFindItemsResult>;

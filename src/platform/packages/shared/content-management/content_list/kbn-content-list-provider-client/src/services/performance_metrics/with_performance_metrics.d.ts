 ...
 * ```
 */
export declare const withPerformanceMetrics: <Args extends unknown[], Result>(fn: (...args: Args) => Promise<Result>, { analytics, eventName, savedObjectType, meta }: PerformanceMetricsOptions) => ((...args: Args) => Promise<Result>);

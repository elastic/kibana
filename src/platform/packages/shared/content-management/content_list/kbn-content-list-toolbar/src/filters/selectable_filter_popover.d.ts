...
export interface SelectableFilterPopoverProps<T extends object = Record<string, unknown>> {
    ...
    renderOption: (option: SelectableFilterOption<T>, state: {
 ...
 * ```
 */
export declare const SelectableFilterPopover: <T extends object = Record<string, unknown>>({ fieldName, title, query, onChange, options, renderOption, singleSelection, isLoading, emptyMessage, noMatchesMessage, panelWidth, panelMinWidth, footerContent, headerContent, onToggle: onToggleProp, "data-test-subj": dataTestSubj, }: SelectableFilterPopoverProps<T>) => React.JSX.Element;
/**
 ...
 */
export declare const StandardFilterOption: ({ children, count, isActive }: StandardOptionRenderProps) => React.JSX.Element;

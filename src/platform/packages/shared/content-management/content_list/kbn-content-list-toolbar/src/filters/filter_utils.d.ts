 ...
 */
export declare const isExcludeModifier: (e: { metaKey: boolean; ctrlKey: boolean }) => boolean;
 ...
 */
export declare const getCheckedState: (
  state: FilterType | null | undefined
) => 'on' | 'off' | undefined;
/**
 ...
 */
export declare const useFieldQueryFilter: ({
  fieldName,
  query,
  onChange,
  singleSelection,
 ...
 */
export declare const FilterCountBadge: ({
  count,
  isActive,
}: FilterCountBadgeProps) => React.JSX.Element;

 ...
 */
export declare const getIncludeExcludeFilter: (value: IncludeExcludeFilter | IncludeExcludeFlag | string | undefined) => IncludeExcludeFilter | undefined;
/**
 * Returns the filter value as {@link IncludeExcludeFlag} if it has a `state` field;
 * otherwise `undefined`.
 */
export declare const getIncludeExcludeFlag: (value: IncludeExcludeFilter | IncludeExcludeFlag | string | undefined) => IncludeExcludeFlag | undefined;
/**

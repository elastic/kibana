 ...
 * ```
 */
export declare const KibanaContentListPage: (({
  children,
  headingId: headingIdProp,
  restrictWidth,
  'data-test-subj': dataTestSubj,
}: KibanaContentListPageProps) => React.JSX.Element) & {
  Header: ({
    title,
    description,
    actions,
  ...
  }: KibanaContentListPageHeaderProps) => React.JSX.Element;
  Section: ({
    children,
    'aria-labelledby': ariaLabelledBy,
    'data-test-subj': dataTestSubjProp,
  }: KibanaContentListPageSectionProps) => React.JSX.Element;
};

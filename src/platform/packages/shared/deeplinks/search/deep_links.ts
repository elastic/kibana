...
import {
  type SERVERLESS_ES_APP_ID,
  type SERVERLESS_ES_CONNECTORS_ID,
  type SERVERLESS_ES_WEB_CRAWLERS_ID,
  type ENTERPRISE_SEARCH_APP_ID,
  type ENTERPRISE_SEARCH_CONTENT_APP_ID,
  type ENTERPRISE_SEARCH_APPLICATIONS_APP_ID,
  type ENTERPRISE_SEARCH_ANALYTICS_APP_ID,
  type ENTERPRISE_SEARCH_APPSEARCH_APP_ID,
  type ENTERPRISE_SEARCH_WORKPLACESEARCH_APP_ID,
  type ES_SEARCH_PLAYGROUND_ID,
  type SERVERLESS_ES_SEARCH_INFERENCE_ENDPOINTS_ID,
  type SEARCH_HOMEPAGE,
  type SEARCH_INDICES_START,
  type SEARCH_INDICES,
  type SEARCH_INDICES_CREATE_INDEX,
  type SEARCH_ELASTICSEARCH,
  type SEARCH_VECTOR_SEARCH,
  type SEARCH_SEMANTIC_SEARCH,
  type SEARCH_AI_SEARCH,
  type ES_SEARCH_SYNONYMS_ID,
} from './constants';

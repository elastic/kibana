...
import {
  ...
  type LOGS_APP_ID,
  type METRICS_APP_ID,
  type OBSERVABILITY_LOGS_EXPLORER_APP_ID,
  type LAST_USED_LOGS_VIEWER_APP_ID,
  type OBSERVABILITY_ONBOARDING_APP_ID,
  type OBSERVABILITY_OVERVIEW_APP_ID,
  type SYNTHETICS_APP_ID,
  type SLO_APP_ID,
  type AI_ASSISTANT_APP_ID,
  type OBLT_UX_APP_ID,
  type OBLT_PROFILING_APP_ID,
  type INVENTORY_APP_ID,
  type STREAMS_APP_ID,
} from './constants';

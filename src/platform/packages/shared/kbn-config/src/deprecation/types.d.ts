 ...
 * @public
 */
export type ConfigDeprecation = (config: RecursiveReadonly<Record<string, any>>, fromPath: string, addDeprecation: AddConfigDeprecation, context: ConfigDeprecationContext) => void | ConfigDeprecationCommand;
/**
...
/** @public */
export type FactoryConfigDeprecationDetails = Pick<DeprecatedConfigDetails, 'level'> & Partial<Omit<DeprecatedConfigDetails, 'level'>>;
/**
...
export interface ConfigDeprecationFactory {
     ...
     * ```
     */
    deprecate(deprecatedKey: string, removeBy: string, details: FactoryConfigDeprecationDetails): ConfigDeprecation;
    /**
     ...
     * ```
     */
    deprecateFromRoot(deprecatedKey: string, removeBy: string, details: FactoryConfigDeprecationDetails): ConfigDeprecation;
    /**
     ...
     * ```
     */
    rename(oldKey: string, newKey: string, details: FactoryConfigDeprecationDetails): ConfigDeprecation;
    /**
     ...
     * ```
     */
    renameFromRoot(oldKey: string, newKey: string, details: FactoryConfigDeprecationDetails): ConfigDeprecation;
    /**

...
node download_integrations_panels.js # update json file with integrations dashboards
```

This will update the `./lens_panels.json` file, which is used on the `./charts.test.ts` file.

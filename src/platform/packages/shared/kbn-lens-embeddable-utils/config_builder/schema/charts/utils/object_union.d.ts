...
type ObjectUnionBranchMeta = TypeOptions<unknown>['meta'] & {
    id?: string;
};
...
export type ObjectUnionExtendedBranchMeta = (branch: ObjectUnionBranch) => ObjectUnionBranchMeta | undefined;

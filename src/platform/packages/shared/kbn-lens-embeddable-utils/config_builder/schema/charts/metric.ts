...
export const metricStateSchemaWithoutEsql = schema.object({
...
export const metricStateSchema = schema.oneOf(
  [metricStateSchemaWithoutEsql, esqlMetricState]
);

export type MetricStateESQL = TypeOf<typeof esqlMetricState>;
export type MetricState = TypeOf<typeof metricStateSchema>;

// const inputMetricSchema = metricStateSchema.getInputSchema();
// export type MetricStateInput = TypeOf<typeof inputMetricSchema>;

// const test: MetricStateInput = {
//   type: 'metric',
//   dataset: {
//     type: 'esql',
//     query: 'from employees | limit 100',
//   },
//   metric: {
//     column: 'price',
//     fit: false,
...
// const layerSettingsInputSchema = layerSettingsSchema.getInputSchema();
// type LayerSettingsInput = TypeOf<typeof layerSettingsInputSchema>;

// const testLayerInput: LayerSettingsInput = {
//   // Both fields should be optional since they have defaults
//   // this works ok
// };
...
const testInputSchema = testSchema.getInputSchema();

type InputType = TypeOf<typeof testInputSchema>;

// This should work - sampling and ignore_global_filters should be optional
const testInput: InputType = {

  // sampling and ignore_global_filters should be optional since they have defaults
  // this doesnt work, this is what we need to fix.
  // we know layerSettungsSchema.getInputSchema() works correctly, but allOf seems to have issues
};


// const testSchemaUnion = schema.oneOf([
//   sharedPanelInfoSchema,
//   layerSettingsSchema,
// ]);

// const testUnionInputSchema = testSchemaUnion.getInputSchema();

// type InputUnionType = TypeOf<typeof testUnionInputSchema>;

// // This should work - sampling and ignore_global_filters should be optional
// const testUnionInput: InputUnionType = {
//   // sampling and ignore_global_filters should be optional since they have defaults
//   // this works ok
//   sampling: 0.5
// };

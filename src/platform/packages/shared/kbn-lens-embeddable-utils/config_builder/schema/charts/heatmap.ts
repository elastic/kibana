...
const heatmapAxesStateESQLSchemaProps = {
  xAxis: esqlColumnOperationWithLabelAndFormatSchema,
  yAxis: schema.maybe(esqlColumnOperationWithLabelAndFormatSchema),
};
...
export const heatmapStateSchemaESQL = schema.object(
  {
    ...
    metric: esqlColumnOperationWithLabelAndFormatSchema.extends(heatmapStateMetricOptionsSchemaProps),
  },
  { meta: { id: 'heatmapESQL' } }
);

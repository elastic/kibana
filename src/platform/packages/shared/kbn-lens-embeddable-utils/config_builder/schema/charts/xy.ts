 ...
 */
export const statisticsSchema = lazySchema(() =>
  z
    .union([
      z.literal('min'),
      z.literal('max'),
...
const domainRoundingSchema = lazySchema(() =>
  z.boolean().default(true).meta({
...
const domainFullConfigSchema = lazySchema(() =>
  z
    .object({
      type: z.literal('full'),
...
const domainFitConfigSchema = lazySchema(() =>
  z
    .object({
      type: z.literal('fit'),
      rounding: domainRoundingSchema.optional(),
...
const domainCustomConfigSchema = lazySchema(() =>
  z
    .object({
 ...
 */
const yDomainSchema = lazySchema(() =>
  z
 ...
 */
export const sharedAxisSchema = lazySchema(() =>
  z
    .object({
...
const xAxisSchema = lazySchema(() =>
  sharedAxisSchema
    .extend({
      scale: xScaleSchema.optional(),
      domain: z.union([domainFitConfigSchema, domainCustomConfigSchema]).optional().meta({
...
const legendSeriesHeaderSchema = lazySchema(() =>
  z
    .object({
      visible: z
        .boolean()
 ...
 */
const sharedLegendSchema = lazySchema(() =>
  z
    .object({
 ...
 * Layout Schemas
 */
const legendTruncateEnabledSchema = lazySchema(() =>
  z.boolean().optional().meta({
    description: 'Enable truncation of legend items',
  })
);
const gridLayout = lazySchema(() =>
  z
    .object({
      type: z.literal('grid'),
      truncate: z
...
const xyLegendOutsideHorizontalSchema = lazySchema(() =>
  sharedLegendSchema
    .extend({
...
const xyLegendOutsideVerticalSchema = lazySchema(() =>
  sharedLegendSchema
    .extend({
      placement: z.literal('outside').optional(),
...
const xyLegendInsideSchema = lazySchema(() =>
  sharedLegendSchema
    .extend({
      ...
      columns: z
        ...
        .max(5)
        .optional()
        .meta({ description: 'Number of legend columns' }),
...
const yMetricOnAxisSchema = lazySchema(() =>
  z
 ...
 */
const xyDataLayerSchemaNoESQL = lazySchema(() =>
  z
    .object({
 ...
 */
const xyDataLayerSchemaESQL = lazySchema(() =>
  z
    .object({
      ...layerSettingsSchema.shape,
 ...
 */
const referenceLineLayerSchemaNoESQL = lazySchema(() =>
  z
    .object({
      ...layerSettingsSchema.shape,
      ...dataSourceSchema.shape,
 ...
 */
const referenceLineLayerSchemaESQL = lazySchema(() =>
  z
    .object({
      ...layerSettingsSchema.shape,
      ...dataSourceEsqlTableSchema.shape,
...
const annotationEventShared = {
  color: z.union([staticColorSchema, autoColorSchema]).default(AUTO_COLOR).optional(),
  visible: z.boolean().optional().meta({ description: 'Show the annotation' }),
};
 ...
 */
const annotationTimestampSchema = lazySchema(() =>
  z.union([
 ...
 */
const annotationQuery = lazySchema(() =>
  z
    .object({
 ...
 */
const annotationManualEvent = lazySchema(() =>
  z
    .object({
      ...annotationPointShared,
 ...
 */
const annotationManualRange = lazySchema(() =>
  z
    .object({
      ...annotationEventShared,
 ...
 */
const annotationLayerByValueSchema = lazySchema(() =>
  z
    .object({
 ...
 */
const annotationByRefLayerSchema = lazySchema(() =>
  z
    .object({
...
const annotationLayerSchema = lazySchema(() =>
  z.union([annotationLayerByValueSchema, annotationByRefLayerSchema]).meta({
    id: 'xyAnnotationLayer',
    description: 'Annotation layer which can be defined by-value or by-reference',
  })
);

const xyLayerUnionNoESQL = lazySchema(() =>
  z
    .union([
...
const xyLayerUnionESQL = lazySchema(() =>
  xyDataLayerSchemaESQL.meta({
    id: 'xyLayersESQL',
 ...
 */
export const xyConfigSchemaNoESQL = lazySchema(() =>
  z
    .object({
      type: z.literal('xy'),
 ...
 */
export const xyConfigSchemaESQL = lazySchema(() =>
  z
    .object({
      type: z.literal('xy'),
      ...sharedPanelInfoSchema.shape,
 ...
 * XY chart state
 */
export const xyConfigSchema = lazySchema(() =>
  z.union([xyConfigSchemaNoESQL, xyConfigSchemaESQL]).meta({
    id: 'xyChart',
    title: 'XY Chart',

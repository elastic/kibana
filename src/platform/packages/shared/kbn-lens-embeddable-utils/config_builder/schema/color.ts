...
const colorByValueSchema = schema.object(
    ...
    steps: schema.arrayOf(
      schema.oneOf(
        [
          schema.object(
            ...
            },
            {
              meta: {
                description:
                  'Color step from a specific value - applies color from the specified value upwards',
              },
            }
          ),
          schema.object(
            ...
            },
            {
              meta: {
                description:
                  'Color step up to a specific value - applies color up to the specified value',
              },
            }
          ),
          schema.object(
            {
               ...
               */
              color: schema.string({
                meta: { description: 'The color to use for this exact value.' },
              }),
            },
            {
              meta: {
                description: 'Color step for exact value - applies color to a specific exact value',
              },
            }
          ),
        ],
        {
          meta: {
            description:
              'Color step definition - defines how colors are applied to values (from, to, or exact)',
          },
        }
      )
    ),
  },
  {
    meta: {
      description:
        'Dynamic color by value - assigns colors based on numeric values using configurable ranges and steps',
    },
  }
);
...
const staticColorSchema = schema.object(
  ...
  },
  {
    meta: {
      description:
        'Static color - applies a single color to all values regardless of their numeric value',
    },
  }
);
...
const colorDefinitionSchema = schema.object(
    ...
    categorical: schema.maybe(
      schema.object(
        ...
        },
        {
          meta: {
            description:
              'Categorical color assignment - assigns colors from a palette based on category index',
          },
        }
      )
    ),
  ...
  },
  {
    meta: {
      description:
        'Color definition - defines how colors are assigned (categorical from palette or static color)',
    },
  }
);
...
const colorMappingSchema = schema.oneOf(
    ...
    schema.object(
      {
         ...
         */
        type: schema.literal('categorical'), // The color mapping mode. Possible value: 'categorical'
        /**
        ...
        colorMapping: schema.object({
          values: schema.arrayOf(
            schema.string({
              meta: { description: 'A value to which the categorical color applies.' },
            })
          ),
        }),
        /**
      ...
      },
      {
        meta: {
          description:
            'Categorical color mapping - assigns colors from a palette to specific categorical values',
        },
      }
    ),
    /**
    ...
    schema.object(
      {
         ...
         */
        type: schema.literal('gradient'), // The color mapping mode. Possible value: 'gradient'
        /**
        ...
        colorMapping: schema.arrayOf(
          schema.object({
            values: schema.arrayOf(
              schema.string({
                meta: { description: 'A value to which the gradient color applies.' },
              })
            ),
          })
        ),
      ...
      {
        meta: {
          description: 'Gradient color mapping - assigns a gradient of colors to a range of values',
        },
      }
    ),
  ],
  {
    meta: {
      description:
        'Color mapping configuration - defines how colors are assigned to values (categorical or gradient)',
    },
  }
);

export const coloringTypeSchema = schema.oneOf(
  [colorByValueSchema, staticColorSchema, colorMappingSchema],
  {
    meta: {
      description:
        'Color configuration - defines how colors are applied to metric values (dynamic by value, static, or mapped)',
    },
  }
);

...
const colorByValueStepSchema = lazySchema(() =>
  z
    .object({
      /**
...
export const colorByValueStepsSchema = lazySchema(() =>
  z
...
const colorByValueBaseSchema = lazySchema(() =>
  z
    .object({
...
export const legacyColorByValueSchema = lazySchema(() =>
  colorByValueBaseSchema
    .extend({
...
export const legacyColorByValueAbsoluteSchema = lazySchema(() =>
...
export const colorByValueAbsoluteSchema = lazySchema(() =>
  colorByValueBaseSchema
    .extend({
      range: z.literal('absolute'),
    })
...
export const colorByValuePercentageSchema = lazySchema(() =>
  colorByValueBaseSchema
    .extend({
...
export const colorByValuePaletteSchema = lazySchema(() =>
  z
    .object({
...
export const colorByValueSchema = lazySchema(() =>
  z
    .union([
...
export const staticColorSchema = lazySchema(() =>
  z
    .object({
...
const colorFromPaletteSchema = lazySchema(() =>
  z
    .object({
...
const colorCodeSchema = lazySchema(() =>
  z
    .object({
...
const colorDefSchema = lazySchema(() => z.union([colorFromPaletteSchema, colorCodeSchema]));

const unassignedColorSchema = lazySchema(() =>
  z.union([colorFromPaletteSchema, colorCodeSchema]).meta({
    id: 'unassignedColorSchema',
    description: 'The color to use for unassigned values.',
  })
);

const categoricalColorMappingSchema = lazySchema(() =>
  z
    .object({
...
const gradientColorMappingSchema = lazySchema(() =>
  z
    .object({
...
export const colorMappingSchema = lazySchema(() =>
  z
    .union([
      /**
...
export const noColorSchema = lazySchema(() =>
  z
...
export const autoColorSchema = lazySchema(() =>
  z
...
export const allColoringTypeSchema = lazySchema(() =>
  z
    .union([
      colorByValueSchema,
      staticColorSchema,
 ...
 */
export const applyColorToSchema = lazySchema(() =>
  z.enum(['value', 'background']).meta({
    description:

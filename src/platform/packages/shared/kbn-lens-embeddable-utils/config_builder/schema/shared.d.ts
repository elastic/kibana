...
export declare const collapseBySchema: import("@kbn/config-schema").Type<"avg" | "max" | "min" | "sum">;
...
export declare const legendPositionSchema: import("@kbn/config-schema").Type<"top" | "bottom" | "left" | "right" | undefined>;
export {};

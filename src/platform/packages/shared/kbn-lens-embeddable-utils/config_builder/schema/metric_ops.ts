...
export const genericOperationOptionsSchema = lazySchema(() =>
  z.object({
    ...formatSchema.shape,
...
export const staticOperationDefinitionSchema = lazySchema(() =>
...
export const formulaOperationDefinitionSchema = lazySchema(() =>
  genericOperationOptionsSchema
    .extend({
...
export const esqlColumnSchema = lazySchema(() =>
  z
    .object({
      ...esqlColumn,
      ...labelSharedSchema.shape,
...
export const esqlColumnWithFormatSchema = lazySchema(() =>
  esqlColumnSchema.extend(formatSchema.shape)
);

export const metricOperationSharedSchema = lazySchema(() =>
  genericOperationOptionsSchema.extend(advancedOperationSettings)
);

export const fieldBasedOperationSharedSchema = lazySchema(() =>
  metricOperationSharedSchema.extend({
    /**
...
export const countMetricOperationSchema = lazySchema(() =>
...
export const uniqueCountMetricOperationSchema = lazySchema(() =>
  fieldBasedOperationSharedSchema
    .extend(emptyAsNullSchemaRawObject)
    .extend({
...
export const metricOperationSchema = lazySchema(() =>
  fieldBasedOperationSharedSchema
    .extend({
...
export const sumMetricOperationSchema = lazySchema(() =>
  fieldBasedOperationSharedSchema
    .extend(emptyAsNullSchemaRawObject)
    .extend({
...
export const lastValueOperationSchema = lazySchema(() =>
  fieldBasedOperationSharedSchema
    .extend({
...
export const percentileOperationSchema = lazySchema(() =>
  fieldBasedOperationSharedSchema
    .extend({
...
export const percentileRanksOperationSchema = lazySchema(() =>
  fieldBasedOperationSharedSchema
    .extend({
...
export const fieldMetricOperationsSchema = lazySchema(() =>
  z
    .union([
...
export const differencesOperationSchema = lazySchema(() =>
...
export const movingAverageOperationSchema = lazySchema(() =>
  metricOperationSharedSchema
    .extend({
      ...
      window: z
        .number()
        .default(LENS_MOVING_AVERAGE_DEFAULT_WINDOW)
        .meta({ description: 'Window' }),
    })
    .meta({ id: 'movingAverageOperation', title: METRIC_OP_TITLES.movingAverage })
);

export const cumulativeSumOperationSchema = lazySchema(() =>
  metricOperationSharedSchema
    .extend({
...
export const counterRateOperationSchema = lazySchema(() =>
  fieldBasedOperationSharedSchema
    .extend({
...
export const metricOperationDefinitionSchema = lazySchema(() =>
  z
    .union([
...
export const fieldMetricOrFormulaOperationDefinitionSchema = lazySchema(() =>
  z.union([fieldMetricOperationsSchema, formulaOperationDefinitionSchema]).meta({
...
export const fieldMetricOrStaticOrFormulaOperationDefinitionSchema = lazySchema(() =>
  z
    .union([
      fieldMetricOperationsSchema,
      staticOperationDefinitionSchema,

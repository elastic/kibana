...
export declare function getMetricAccessor(visualization: GaugeVisualizationState | MetricVisualizationState): string | undefined;
 ...
 * assigning IDs.
 */
export declare function processMetricColumnsWithReferences(convertedMetrics: AnyMetricLensStateColumn[][], getAccessorName: (index: number) => string, getRefAccessorName: (index: number) => string): {

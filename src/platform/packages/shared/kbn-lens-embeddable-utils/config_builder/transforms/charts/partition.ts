...
function convertAPINumberDisplayOption(option: PartitionConfig['values']): {
...
const donutHoleSizeCompat = getReversibleMappings<
  NonNullable<PieConfig['donut_hole']>,
...
): Pick<PartitionConfig, 'legend' | 'values'> | undefined {

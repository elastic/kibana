...
export declare function buildXYLayer(config: XYConfig, layer: unknown, i: number, annotationGroupReferences: SavedObjectReference[]): XYPersistedLayerConfig | undefined;

...
import type { FormulaValueConfig, LensAnnotationLayer, LensAttributes, LensBaseConfig, LensBaseLayer, LensBaseXYLayer, LensConfig, LensDataset, LensDataviewDataset } from './types';
...
export declare const buildDatasourceStates: (config: (LensBaseConfig & {
    layers: Array<LensBaseXYLayer | LensAnnotationLayer>;

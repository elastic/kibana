...
const absentDefinition: FunctionDefinition = {
  ...
  name: 'absent',
  description: i18n.translate('kbn-esql-ast.esql.definitions.absent', {
    defaultMessage:
...
const allFirstDefinition: FunctionDefinition = {
  type: FunctionDefinitionTypes.AGG,
  name: 'all_first',
  description: i18n.translate('kbn-esql-ast.esql.definitions.all_first', {
...
const allLastDefinition: FunctionDefinition = {
  type: FunctionDefinitionTypes.AGG,
  name: 'all_last',
  description: i18n.translate('kbn-esql-ast.esql.definitions.all_last', {
...
const presentDefinition: FunctionDefinition = {
  type: FunctionDefinitionTypes.AGG,
  name: 'present',
  description: i18n.translate('kbn-esql-ast.esql.definitions.present', {
    defaultMessage:

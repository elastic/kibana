...
import type { ESQLCommand, ESQLMessage, ESQLAstAllCommands } from '../../types';
 ...
 * The astProvider is optional, but if not provided the default one from '@kbn/esql-ast' will be used.

...
import { type JoinCommandContext, type JoinTargetContext } from '../../antlr/esql_parser';
import { type ESQLAstItem, type ESQLBinaryExpression, type ESQLCommand, type ESQLIdentifier } from '../../types';
import {

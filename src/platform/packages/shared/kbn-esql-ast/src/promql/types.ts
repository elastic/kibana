 ...
 * A PromQL AST node.
 */
export type PromQLAstNode = PromQLAstQueryExpression | PromQLAstExpression;
...
export interface PromQLSelector extends PromQLAstNodeBase {
   ...
   */
  metric: PromQLIdentifier | undefined;

  /**
   * Label matchers in curly braces.
   * 
   * @todo Use `map` node here...
   */
  labels: PromQLLabel[];

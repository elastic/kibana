import type { GetIn, GetResult, CreateIn, CreateResult, SearchIn, SearchResult, UpdateIn, UpdateResult, DeleteIn, DeleteResult } from '@kbn/content-management-plugin/common';
import type { ContentManagementServicesDefinition as ServicesDefinition, Version } from '@kbn/object-versioning';
...
import type { MutatingOperationRefreshSetting, SavedObjectsPitParams, SavedObjectsFindOptionsReference } from '@kbn/core-saved-objects-api-server';
type KueryNode = any;
...
export type GetResultSO<T extends object = object> = GetResult<T, {
...
export type SOWithMetadataPartial<Attributes extends object = object> = Omit<SOWithMetadata<Attributes>, 'attributes' | 'references'> & {
 ...
 */
export interface ContentManagementCrudTypes<ContentType extends string, Attributes extends object, CreateOptions extends object, UpdateOptions extends object, SearchOptions extends object> {
    Attributes: Attributes;
    /**
     * Complete saved object
     */

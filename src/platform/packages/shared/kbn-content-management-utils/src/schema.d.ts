...
export declare const updateOptionsSchema: {
    ...
    upsert: <T extends ObjectType<any>>(attributesSchema: T) => import("@kbn/config-schema").Type<Readonly<{ [K in keyof ("error" | "managed" | "version" | "namespaces" | "updatedAt" | "createdAt" | "originId" | "createdBy" | "updatedBy" | (undefined extends import("@kbn/config-schema").TypeOf<T> ? "attributes" : never) extends infer T_1 extends keyof {
        id: import("@kbn/config-schema").Type<string>;
        type: import("@kbn/config-schema").Type<string>;
        version: import("@kbn/config-schema").Type<string | undefined>;
        createdAt: import("@kbn/config-schema").Type<string | undefined>;
        ...
        originId: import("@kbn/config-schema").Type<string | undefined>;
        managed: import("@kbn/config-schema").Type<boolean | undefined>;
    }[K]> | undefined; } & { [K_1 in keyof ("type" | "id" | "references" | (undefined extends import("@kbn/config-schema").TypeOf<T> ? never : "attributes") extends infer T_2 extends keyof {
        id: import("@kbn/config-schema").Type<string>;
        type: import("@kbn/config-schema").Type<string>;
        version: import("@kbn/config-schema").Type<string | undefined>;
        createdAt: import("@kbn/config-schema").Type<string | undefined>;

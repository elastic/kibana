...
import { getFieldDisplayValueFromFilter, getDisplayValueFromFilter } from '@kbn/data-plugin/public';
        ...
        filters.map((filter, i) => (
          <EuiFlexItem grow={false} key={i}>
            <EuiBadge color="hollow">
              <EuiFlexGroup gutterSize="xs" responsive={false}>
                <EuiFlexItem grow={false}>
                  <EuiText size="xs">{getFieldDisplayValueFromFilter(filter, [dataView])}</EuiText>
                </EuiFlexItem>
                <EuiFlexItem grow={false}>
                  <EuiText size="xs" color="success">

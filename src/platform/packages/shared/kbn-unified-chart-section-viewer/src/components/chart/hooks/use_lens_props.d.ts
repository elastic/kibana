import { type LensLegendConfig, type LensSeriesLayer, type LensYBoundsConfig } from '@kbn/lens-embeddable-utils';
...
export declare const useLensProps: ({ chartId, title, description, query, services, fetchParams, discoverFetch$, chartRef, chartLayers, yBounds, legend, error, userMessages, profileId, }: {
    chartId: string;
    title: string;
    description?: string;
    query: string;

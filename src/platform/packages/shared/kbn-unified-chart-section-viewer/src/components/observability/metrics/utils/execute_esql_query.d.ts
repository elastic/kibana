 ...
 */
export declare function executeEsqlQuery<TDocument extends object = Record<string, unknown>>({ esqlQuery, search, signal, dataView, timeRange, filters, variables, uiSettings, profileId, }: ExecuteEsqlParams): Promise<ExecuteEsqlResult<TDocument>>;

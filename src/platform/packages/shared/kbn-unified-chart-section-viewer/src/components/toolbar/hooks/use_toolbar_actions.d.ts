...
export declare const useToolbarActions: ({ allDimensions, renderToggleActions, onDimensionsChange: onDimensionsChangeProp, hideDimensionsSelector, hideRightSideActions, isLoading, metricItems, onOpenGridSettings, }: UseToolbarActionsProps) => {

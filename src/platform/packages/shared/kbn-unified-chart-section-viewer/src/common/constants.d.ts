...
export declare const FEATURE_FLAGS: {
    readonly IS_EDIT_GRID_SETTINGS_ENABLED: "discover.metricsExperienceEditGridSettingsEnabled";
    readonly IS_SORTING_ENABLED: "discover.metricsExperienceSortEnabled";
};
export type FeatureFlag = (typeof FEATURE_FLAGS)[keyof typeof FEATURE_FLAGS];
export declare const FEATURE_FLAG_DEFAULTS: Record<FeatureFlag, boolean>;
export declare const METRICS_SORT_BY: {
    readonly alphabetically: "alphabetically";
    readonly recency: "recency";
};
export declare const METRICS_SORT_DIRECTION: {
    readonly asc: "asc";
    readonly desc: "desc";
};
export declare const DEFAULT_METRICS_SORT: readonly ["alphabetically", "asc"];

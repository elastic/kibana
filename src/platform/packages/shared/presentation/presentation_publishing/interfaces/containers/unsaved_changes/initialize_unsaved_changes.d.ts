...
export declare const initializeUnsavedChanges: <StateType extends object = object>({ uuid, onReset, parentApi, getComparators, defaultState, serializeState, anyStateChange$, }: {
    uuid: string;
    parentApi: unknown;

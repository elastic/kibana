 ...
 * Generated on: 2025-08-29T15:55:39.391Z
...
',
  ...
  'error.type': {
    name: 'error.type',
    description: 'The full name of exception type.',
    type: 'keyword',
    example: 'System.OperationCanceledException',
  },
  'error.message': {
    name: 'error.message',
  ...
  'http.response.status_code': {
    ...
    description: 'The HTTP status code of the last HTTP request performed in scope of this export call.',
    type: 'long',
    example: '200',
  },
  'http.route': {
  ...
  'cpu.mode': {
    name: 'cpu.mode',
    description: 'A process SHOULD be characterized _either_ by data points with no `mode` labels, _or only_ data points with `mode` labels.',
    type: 'keyword',
    example: 'user',
  },
  'cpu.logical_number': {

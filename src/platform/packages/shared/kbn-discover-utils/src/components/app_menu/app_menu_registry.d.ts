import type { DiscoverAppMenuConfig, DiscoverAppMenuItemType, DiscoverAppMenuPopoverItem, DiscoverAppMenuPrimaryActionItem, DiscoverAppMenuSecondaryActionItem } from '../../types';
/**
...
export declare class AppMenuRegistry {
     ...
     */
    setSecondaryActionItem(item: DiscoverAppMenuSecondaryActionItem): void;
    /**

 ...
 * @param options
 */
export declare function formatHitReact(hit: DataTableRecord, dataView: DataView, shouldShowFieldHandler: ShouldShowFieldInTableHandler, maxEntries: number, fieldFormats: FieldFormatsStart, columnsMeta: DataTableColumnsMeta | undefined, options?: FormatHitReactOptions): FormattedHit;
export {};

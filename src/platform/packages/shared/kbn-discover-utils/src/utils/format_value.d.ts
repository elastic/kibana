...
import type { ReactContextTypeOptions, TextContextTypeOptions } from '@kbn/field-formats-plugin/common/types';
 ...
 */
export declare const formatFieldValueReact: ({ value, hit, fieldFormats, dataView, field, options, }: FormatFieldValueReactParams) => ReactNode;
/**
 ...
 * @returns A ReactNode that can be rendered directly
 */
export declare const formatFieldStringValueWithHighlights: ({ value, hit, fieldFormats, dataView, fieldName, options, }: FormatFieldStringWithHighlightsParams) => ReactNode;
export {};

...
export declare const SIDEBAR_HIDDEN_KEY = "sidebarHidden";
 ...
 */
export declare const getSidebarHidden: (storage: Storage, localStorageKeyPrefix: string) => boolean | undefined;
/**
 ...
 */
export declare const setSidebarHidden: (storage: Storage, localStorageKeyPrefix: string, sidebarHidden: boolean | undefined) => false | void;
/**

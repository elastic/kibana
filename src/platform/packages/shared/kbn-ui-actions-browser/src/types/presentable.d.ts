...
export interface PresentableGroup<Context = unknown> extends Partial<Pick<Presentable<Context>, 'getDisplayName' | 'getDisplayNameTooltip' | 'getIconType' | 'order'>> {
    id: string;
}

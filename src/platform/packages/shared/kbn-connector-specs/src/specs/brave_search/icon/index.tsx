...
// Brave's own lion, which their guidelines require to stay full-color. Replaces
// a PNG whose baked-in white square showed as a light tile on dark surfaces.
const BraveSearchIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 56 64" {...props}>
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      ...
      fill="url(#braveSearchLionGradient)"
    />
    <path
      fillRule="evenodd"
      clipRule="evenodd"

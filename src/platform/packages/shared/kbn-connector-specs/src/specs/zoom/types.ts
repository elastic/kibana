...
export const ZoomPaginationOutputSchema = lazySchema(() =>
  z.object({
...
export const ZoomMeetingSummarySchema = lazySchema(() =>
  z.object({
...
export const ZoomRecordingFileSchema = lazySchema(() =>
  z.object({
...
export const ZoomParticipantSchema = lazySchema(() =>
  z.object({
...
export const ZoomRegistrantSchema = lazySchema(() =>
  z.object({
...
export const ZoomUserProfileSchema = lazySchema(() =>
  z.object({
...
export const ZoomWhoAmIInputSchema = lazySchema(() => z.object({}));
export type ZoomWhoAmIInput = z.infer<typeof ZoomWhoAmIInputSchema>;

export const ZoomListMeetingsInputSchema = lazySchema(() =>
  z.object({
    userId: z
      .string()
      .default('me')
...
export const ZoomListUserRecordingsInputSchema = lazySchema(() =>
  z.object({
    userId: z
      .string()
      .default('me')
...
export const ZoomDownloadRecordingFileInputSchema = lazySchema(() =>
  z.object({
    downloadUrl: z
      .string()
      .url()

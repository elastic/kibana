...
// The symbol on its own, not the lock-up — the wordmark this replaced was
// unreadable once scaled into a 16px step icon.
...
// Zendesk's primary brand color; reversed to white on dark surfaces.
export default createBrandIcon(ZendeskIcon, '#03363D');

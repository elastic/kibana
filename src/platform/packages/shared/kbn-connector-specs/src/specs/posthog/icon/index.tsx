...
// Three brand colors plus one black element. Only the black one needs to
// reverse — it is what made the mark look half-missing on a dark canvas.
const PostHogIcon = ({
  darkGlyphFill,
  ...props
}: React.SVGProps<SVGSVGElement> & { darkGlyphFill: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 30" {...props}>
    <path
...
export default (props: ConnectorIconProps) => {
  const darkGlyphFill = useBrandFill('#000000');
  return (
    <EuiIcon
      type={(iconProps) => <PostHogIcon darkGlyphFill={darkGlyphFill} {...iconProps} />}
      {...props}
    />
  );
};

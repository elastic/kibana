...
export const WebhookConnectorExample: ConnectorSpec = {
  // ---- Metadata (required) ----
  metadata: {
    id: '.webhook',
    displayName: 'Webhook',
  ...
  actions: {
    ...
    execute: {
      ...
      input: z.object({
        ...
        // Query parameters
        params: withUIMeta(z.record(z.string(), z.string()), {
          widget: 'keyValue',

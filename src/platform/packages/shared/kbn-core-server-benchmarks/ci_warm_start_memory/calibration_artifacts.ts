...
const DEFAULT_CALIBRATION_SEEDS: Record<WarmStartCalibrationOrientation, string> = {
  aa: 'calibration-linux-aa',
  ab: 'calibration-linux-ab',
  ba: 'calibration-linux-ba',
};
...
export const resolveWarmStartCalibrationOrientation = (
  ...
  return {
    ...
    left,
    right,
    seed: seedInput?.trim() || DEFAULT_CALIBRATION_SEEDS[orientation],
  };
};

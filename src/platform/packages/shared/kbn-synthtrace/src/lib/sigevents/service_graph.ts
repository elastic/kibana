...
const CORE_SERVICES = [
  {
    ...
    serviceLogs: {
      ...
      error: [
        ...
        'Message publish failed: Kafka broker unreachable',
      ],
    },
  } as const,
  {
  ...
  } as const,
  {
    ...
    serviceLogs: {
      success: ['Fraud check passed', 'No fraud detected'],
      error: [
        'Fraud detection model timeout: upstream scoring service unavailable',
        'Risk score evaluation failed: insufficient transaction history',
      ],
    },
  } as const,
  {

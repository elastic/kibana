...
const SCENARIO_ALIASES: Record<string, string> = {
  ...
  apm_ml_anomalies:
    'x-pack/solutions/observability/plugins/apm/test/scenarios/apm_ml_anomalies.ts',
  ...
  aws_lambda:
    'x-pack/solutions/observability/plugins/apm/test/scenarios/aws_lambda.ts',
  azure_functions:
    'x-pack/solutions/observability/plugins/apm/test/scenarios/azure_functions.ts',
  cloud_services_icons:
    'x-pack/solutions/observability/plugins/apm/test/scenarios/cloud_services_icons.ts',
  complete_trace:
    'x-pack/solutions/observability/plugins/apm/test/scenarios/complete_trace.ts',
  composite_spans:
    'x-pack/solutions/observability/plugins/apm/test/scenarios/composite_spans.ts',
  continuous_rollups:
    'x-pack/solutions/observability/plugins/apm/test/scenarios/continuous_rollups.ts',
  degraded_logs:
    'x-pack/platform/plugins/shared/streams/test/scenarios/degraded_logs.ts',
  ...
  high_throughput:
    'x-pack/solutions/observability/plugins/apm/test/scenarios/high_throughput.ts',
  http_access_logs:
    'x-pack/platform/plugins/shared/streams/test/scenarios/http_access_logs.ts',
  http_access_logs_otel:
    'x-pack/platform/plugins/shared/streams/test/scenarios/http_access_logs_otel.ts',
  infra_aws_rds:
    'x-pack/solutions/observability/plugins/infra/test/scenarios/infra_aws_rds.ts',
  infra_docker_containers:
    'x-pack/solutions/observability/plugins/infra/test/scenarios/infra_docker_containers.ts',
  infra_hosts_ecs:
    'x-pack/solutions/observability/plugins/infra/test/scenarios/infra_hosts_ecs.ts',
  infra_hosts_semconv:
  ...
  kafka_topics:
    'x-pack/solutions/observability/plugins/apm/test/scenarios/kafka_topics.ts',
  kubernetes_logs:
    'x-pack/platform/plugins/shared/streams/test/scenarios/kubernetes_logs.ts',
  low_throughput:
    'x-pack/solutions/observability/plugins/apm/test/scenarios/low_throughput.ts',
  many_dependencies:
    'x-pack/solutions/observability/plugins/apm/test/scenarios/many_dependencies.ts',
  many_errors:
    'x-pack/solutions/observability/plugins/apm/test/scenarios/many_errors.ts',
  many_instances:
    'x-pack/solutions/observability/plugins/apm/test/scenarios/many_instances.ts',
  many_otel_services:
    'x-pack/solutions/observability/plugins/apm/test/scenarios/many_otel_services.ts',
  many_services:
    'x-pack/solutions/observability/plugins/apm/test/scenarios/many_services.ts',
  many_transactions:
  ...
  serverless_logs:
    'x-pack/platform/plugins/shared/streams/test/scenarios/serverless_logs.ts',
  service_map:
    'x-pack/solutions/observability/plugins/apm/test/scenarios/service_map.ts',
  service_map_oom:
    'x-pack/solutions/observability/plugins/apm/test/scenarios/service_map_oom.ts',
  ...
  simple_otel_logs:
    'x-pack/platform/plugins/shared/streams/test/scenarios/simple_otel_logs.ts',
  simple_trace:
    'x-pack/solutions/observability/plugins/apm/test/scenarios/simple_trace.ts',
  ...
  unstructured_logs:
    'x-pack/platform/plugins/shared/streams/test/scenarios/unstructured_logs.ts',

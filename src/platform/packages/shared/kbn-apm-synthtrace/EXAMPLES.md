...
This document contains all usage examples for `@kbn/apm-synthtrace`. See the [README.md](./README.md) for general documentation.
...
`@kbn/apm-synthtrace` can also automatically generate transaction metrics, span destination metrics and transaction breakdown metrics based on the generated trace events:

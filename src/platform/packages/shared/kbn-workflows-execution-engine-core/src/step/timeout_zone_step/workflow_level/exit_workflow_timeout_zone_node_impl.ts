...
export class ExitWorkflowTimeoutZoneNodeImpl implements INodeImplementation {
  constructor(private wfExecutionRuntimeManager: IWorkflowExecutionRuntimeManager) {}

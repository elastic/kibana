...
export type NumberOptions<D extends DefaultValue<number>> = TypeOptions<number, number, D> & {
  min?: number;
  max?: number;
  /**
...
export class NumberType<D extends DefaultValue<number>> extends Type<number, number, D> {

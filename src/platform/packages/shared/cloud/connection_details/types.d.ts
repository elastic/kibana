...
export type ConnectionDetailsTelemetryEvents = ConnectionDetailsTelemetryEvent<'learn_more_clicked'> | ConnectionDetailsTelemetryEvent<'tab_switched', {
    tab: string;
}> | ConnectionDetailsTelemetryEvent<'copy_endpoint_url_clicked'> | ConnectionDetailsTelemetryEvent<'show_cloud_id_toggled'> | ConnectionDetailsTelemetryEvent<'copy_cloud_id_clicked'> | ConnectionDetailsTelemetryEvent<'new_api_key_created'> | ConnectionDetailsTelemetryEvent<'manage_api_keys_clicked'> | ConnectionDetailsTelemetryEvent<'key_encoding_changed', {
    format: string;
}> | ConnectionDetailsTelemetryEvent<'copy_api_key_clicked', {
    format: string;
}>;

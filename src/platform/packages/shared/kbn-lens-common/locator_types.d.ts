...
export declare const LENS_SHARE_STATE_ACTION = "LENS_SHARE_STATE_ACTION";
...
export interface MainHistoryLocationState {
    ...
    payload: LensShareableState | Omit<LensShareableState, 'activeDatasourceId' | 'visualization' | 'datasourceStates' | 'references'>;
}

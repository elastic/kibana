import type { XYByReferenceAnnotationLayerConfig, XYByValueAnnotationLayerConfig, XYDataLayerConfig, XYLayerConfig, XYReferenceLineLayerConfig, XYVisualizationState } from './types';
/**
...
export declare const isRuntimeByReferenceAnnotationsLayer: (layer: XYLayerConfig | XYPersistedLayerConfig) => layer is XYByReferenceAnnotationLayerConfig;

...
import type { LegendConfig, AxisExtentConfig, XYCurveType, FittingFunction, EndValue, YScaleType, XScaleType, LineStyle, IconPosition, FillStyle, YAxisConfig, PointVisibility } from '@kbn/expression-xy-plugin/common';
...
export type XYAnnotationLayerConfig = XYByReferenceAnnotationLayerConfig | XYByValueAnnotationLayerConfig;
export type XYLayerConfig = XYDataLayerConfig | XYReferenceLineLayerConfig | XYAnnotationLayerConfig;

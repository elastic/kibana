...
import type { LENS_DATAGRID_DENSITY, LENS_DATATABLE_COLUMN, LENS_EDIT_PAGESIZE_ACTION, LENS_EDIT_RESIZE_ACTION, LENS_EDIT_SORT_ACTION, LENS_ROW_HEIGHT_MODE, LENS_TOGGLE_ACTION } from './constants';
 ...
 */
export declare const COLUMN_CELL_DECORATION_MODE: {
    readonly NONE: "none";
    readonly CELL: "cell";

...
export type MetricStateOptinalsWithDefault = Pick<MetricVisualizationStateOptionals, 'titlesTextAlign' | 'primaryAlign' | 'secondaryAlign' | 'iconAlign' | 'valueFontMode' | 'density' | 'primaryPosition' | 'secondaryLabelPosition' | 'applyColorTo'>;

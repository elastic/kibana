...
export declare const WorkflowGraphActionsContext: import("react").Context<WorkflowGraphActions>;
export declare function useWorkflowGraphActions(): WorkflowGraphActions;

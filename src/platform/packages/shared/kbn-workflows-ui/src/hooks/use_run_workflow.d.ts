 ...
 * ```
 */
export declare const useRunWorkflow: <P extends object = {}>(options?: UseMutationOptions<RunWorkflowResponseDto, HttpError, RunWorkflowParams & P>) => import("@tanstack/react-query").UseMutationResult<{

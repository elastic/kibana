...
module.exports = {
  ...
  transformIgnorePatterns: [
    ...
    '[/\\\\]node_modules(?![\\/\\\\](@apidevtools/json-schema-ref-parser|langchain|langsmith|gpt-tokenizer|flat|@langchain|eventsource-parser|exit-hook|zod/v4|ansi-styles|inversify|@inversifyjs|uuid|globby|unicorn-magic|is-path-inside|slash|@sindresorhus/merge-streams))[/\\\\].+\\.js$',

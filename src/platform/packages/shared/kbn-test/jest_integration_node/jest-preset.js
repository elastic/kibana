...
module.exports = {
  ...
  transformIgnorePatterns: [
    ...
    '[/\\\\]node_modules(?![\\/\\\\](@apidevtools/json-schema-ref-parser|langchain|langsmith|gpt-tokenizer|flat|@langchain|eventsource-parser|zod/v4|ansi-styles|inversify|@inversifyjs|globby|unicorn-magic|is-path-inside|slash|@sindresorhus/merge-streams))[/\\\\].+\\.js$',

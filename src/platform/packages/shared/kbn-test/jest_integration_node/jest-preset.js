...
module.exports = {
  ...
  transformIgnorePatterns: [
    ...
    '[/\\\\]node_modules(?![\\/\\\\](@apidevtools/json-schema-ref-parser|langchain|langsmith|gpt-tokenizer|flat|@langchain|eventsource-parser|exit-hook|zod/v4|ansi-styles|inversify|@inversifyjs|uuid|globby|unicorn-magic|is-path-inside|slash|@sindresorhus/merge-streams|yargs|cliui|escalade|string-width|strip-ansi|ansi-regex|emoji-regex|get-east-asian-width|wrap-ansi))[/\\\\].+\\.js$',

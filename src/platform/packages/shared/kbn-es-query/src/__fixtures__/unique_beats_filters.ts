...
export const uniqueBeatsFilters = [
  {
    $state: {
      store: 'appState',
    },
  ...
  },
  {
    ...
    meta: {
      ...
      disabled: false,
      indexRefName: 'kibanaSavedObjectMeta.searchSourceJSON.filter[1].meta.index',
      key: 'threat.indicator.file.hash.sha1',
      negate: false,
      type: 'exists',
      value: 'exists',
    },
  ...
  },
  {
    ...
    meta: {
      ...
      disabled: false,
      indexRefName: 'kibanaSavedObjectMeta.searchSourceJSON.filter[1].meta.index',
      key: 'threat.indicator.file.hash.md5',
      negate: false,
      type: 'exists',
      value: 'exists',
    },
  ...
  },
  {
    ...
    meta: {
      ...
      disabled: false,
      indexRefName: 'kibanaSavedObjectMeta.searchSourceJSON.filter[1].meta.index',
      key: 'threat.indicator.url.domain',
      negate: false,
      type: 'exists',
      value: 'exists',
    },
  },
  {
    ...
    meta: {
      ...
      key: 'event.code',
      negate: false,
      params: ['4733', '4729', '4757', '4786', '4788', '4752', '4762', '4747'],
      type: 'phrases',
      value: '4733, 4729, 4757, 4786, 4788, 4752, 4762, 4747',
    },
    query: {
      bool: {
  ...
  },
  {
    ...
    meta: {
      ...
      disabled: false,
      indexRefName: 'kibanaSavedObjectMeta.searchSourceJSON.filter[1].meta.index',
      key: 'threat.indicator.file.pe.imphash',
      negate: false,
      type: 'exists',
      value: 'exists',
    },
  ...
  },
  {
    ...
    meta: {
      alias: 'Package',
      disabled: true,
      indexRefName: 'kibanaSavedObjectMeta.searchSourceJSON.filter[5].meta.index',
      key: 'event.dataset',
      negate: false,
      params: {
        query: 'package',
  ...
  },
  {
    ...
    meta: {
      alias: null,
      controlledBy: '1532342651170',
      disabled: false,
      indexRefName: 'kibanaSavedObjectMeta.searchSourceJSON.filter[0].meta.index',
      key: 'azure.application_id',
      negate: false,
      params: {
        query: '42cb59a9-d5be-400b-a5c4-69b0a0026ac6',
      },
      type: 'phrase',
    },
    query: {
      match_phrase: {
        'azure.application_id': '42cb59a9-d5be-400b-a5c4-69b0a0026ac6',
      },
    },
  },
  {
  ...
  },
  {
    ...
    meta: {
      ...
      disabled: false,
      indexRefName: 'kibanaSavedObjectMeta.searchSourceJSON.filter[1].meta.index',
      key: 'threat.indicator.url.original',
      negate: false,
      type: 'exists',
      value: 'exists',
    },
  ...
  },
  {
    ...
    meta: {
      ...
      disabled: false,
      indexRefName: 'kibanaSavedObjectMeta.searchSourceJSON.filter[1].meta.index',
      key: 'threat.indicator.file.hash.ssdeep',
      negate: false,
      type: 'exists',
      value: 'exists',
    },
  ...
  },
  {
    ...
    query: {
      match_phrase: {
        'event.dataset': 'kubernetes.proxy',
      },
    },
  },
  {
  ...
  },
  {
    ...
    meta: {
      ...
      key: 'event.code',
      negate: false,
      params: ['4734', '4730', '4758', '4748', '4763', '4753', '4792', '4789'],
      type: 'phrases',
      value: '4734, 4730, 4758, 4748, 4763, 4753, 4792, 4789',
    },
    query: {
      bool: {
        minimum_should_match: 1,
  ...
  },
  {
    ...
    query: {
      terms: {
        'cef.extensions.categoryDeviceGroup': ['/VPN', '/IDS/Network', '/Firewall'],
      },
    },
  },
  {
  ...
  },
  {
    ...
    exists: {
      field: 'threat.indicator.file.hash.tlsh',
    },
    meta: {
      alias: null,
      disabled: false,
      indexRefName: 'kibanaSavedObjectMeta.searchSourceJSON.filter[1].meta.index',
      key: 'threat.indicator.file.hash.tlsh',
      negate: false,
      type: 'exists',
      value: 'exists',
    },
  ...
  },
  {
    ...
    meta: {
      ...
      disabled: false,
      indexRefName: 'kibanaSavedObjectMeta.searchSourceJSON.filter[1].meta.index',
      key: 'threat.indicator.first_seen',
      negate: false,
      type: 'exists',
      value: 'exists',
    },
  ...
  },
  {
    ...
    exists: {
      field: 'abusech.url.threat',
    },
    meta: {
      alias: null,
      disabled: false,
      indexRefName: 'kibanaSavedObjectMeta.searchSourceJSON.filter[1].meta.index',
      key: 'abusech.url.threat',
      negate: false,
      type: 'exists',
      value: 'exists',
    },
  ...
  },
  {
    ...
    meta: {
      ...
      key: 'event.code',
      negate: false,
      params: ['ComplianceDLPSharePoint', 'ComplianceDLPExchange'],
      type: 'phrases',
  ...
  },
  {
    ...
    meta: {
      ...
      type: 'phrases',
      value:
        '4731, 4732, 4733, 4734, 4735, 4737, 4764, 4727, 4728, 4729, 4730, 4754, 4755, 4756, 4757, 4758, 4799, 4749, 4750, 4751, 4752, 4753, 4759, 4760, 4761, 4762, 4763, 4744, 4745, 4746, 4748',
    },
    query: {
      bool: {
        minimum_should_match: 1,
  ...
  },
  {
    ...
    meta: {
      ...
      key: 'event.code',
      negate: false,
      params: ['4731', '4727', '4754', '4744', '4759', '4779', '4790', '4783'],
      type: 'phrases',
      value: '4731, 4727, 4754, 4744, 4759, 4779, 4790, 4783',
    },
    query: {
      bool: {
        minimum_should_match: 1,
  ...
  },
  {
    ...
    meta: {
      ...
      key: 'event.code',
      negate: false,
      params: ['4735', '4737', '4755', '4750', '4760', '4745', '4791', '4784', '4764'],
      type: 'phrases',
  ...
  },
  {
    ...
    meta: {
      ...
      negate: false,
      params: {
        query: 'threatintel.threatq',
      },
      type: 'phrase',
    },
    query: {
      match_phrase: {
        'event.dataset': 'threatintel.threatq',
      },
    },
  },
  {
  ...
  },
  {
    ...
    meta: {
      ...
      key: 'event.code',
      negate: false,
      params: ['4732', '4728', '4756', '4751', '4761', '4746', '4785', '4787'],
      type: 'phrases',
  ...
  },
  {
    ...
    exists: {
      field: 'abusech.url.blacklists.spamhaus_dbl',
    },
    meta: {
      alias: null,
      disabled: false,
      indexRefName: 'kibanaSavedObjectMeta.searchSourceJSON.filter[1].meta.index',
      key: 'abusech.url.blacklists.spamhaus_dbl',
      negate: false,
      type: 'exists',
      value: 'exists',
    },
  },
  {
    ...
    exists: {
      field: 'abusech.url.blacklists.surbl',
    },
    meta: {
      alias: null,
      disabled: false,
      indexRefName: 'kibanaSavedObjectMeta.searchSourceJSON.filter[2].meta.index',
      key: 'abusech.url.blacklists.surbl',
      negate: false,
      type: 'exists',
      value: 'exists',
    },
  ...
  },
  {
    ...
    meta: {
      ...
      disabled: false,
      indexRefName: 'kibanaSavedObjectMeta.searchSourceJSON.filter[1].meta.index',
      key: 'threat.indicator.url.scheme',
      negate: false,
      type: 'exists',
      value: 'exists',
    },
  ...
  },
  {
    ...
    meta: {
      ...
      key: 'event.code',
      negate: false,
      params: ['308', '319', '295', '22', '38', '300', '302'],
      type: 'phrases',
  ...
  },
  {
    ...
    meta: {
      ...
      disabled: false,
      indexRefName: 'kibanaSavedObjectMeta.searchSourceJSON.filter[0].meta.index',
      key: 'powershell.command.invocation_details.type',
      negate: false,
      params: {
        query: 'CommandInvocation',
      },
      type: 'phrase',
    },
    query: {
      match_phrase: {
        'powershell.command.invocation_details.type': 'CommandInvocation',
      },
    },
  },
  {
  ...
  },
  {
    ...
    meta: {
      ...
      disabled: false,
      indexRefName: 'kibanaSavedObjectMeta.searchSourceJSON.filter[1].meta.index',
      key: 'abusech.malwarebazaar.intelligence.downloads',
      negate: false,
      type: 'exists',
      value: 'exists',
    },
  ...
  },
  {
    ...
    meta: {
      ...
      negate: false,
      params: {
        query: 'oracle.sysmetric',
      },
      type: 'phrase',
    },
    query: {
      match_phrase: {
        'event.dataset': 'oracle.sysmetric',
      },
    },
  },
  {
  ...
  },
  {
    ...
    meta: {
      ...
      disabled: false,
      indexRefName: 'kibanaSavedObjectMeta.searchSourceJSON.filter[1].meta.index',
      key: 'threat.indicator.file.mime_type',
      negate: false,
      type: 'exists',
      value: 'exists',
    },
  ...
  },
  {
    ...
    meta: {
      ...
      disabled: false,
      indexRefName: 'kibanaSavedObjectMeta.searchSourceJSON.filter[0].meta.index',
      key: 'azure.app_state.application_id',
      negate: false,
      params: {
        query: '42cb59a9-d5be-400b-a5c4-69b0a0026ac6',
      },
    ...
    query: {
      match_phrase: {
        'azure.app_state.application_id': '42cb59a9-d5be-400b-a5c4-69b0a0026ac6',
      },
    },
  },
  {
  ...
  },
  {
    ...
    query: {
      terms: {
        'auditd.data.syscall': ['accept', 'accept4', 'recvfrom', 'recvmsg'],
      },
    },
  },
  {
    ...
    exists: {
      field: 'abusech.url.url_status',
    },
    meta: {
      alias: null,
      disabled: false,
      indexRefName: 'kibanaSavedObjectMeta.searchSourceJSON.filter[1].meta.index',
      key: 'abusech.url.url_status',
      negate: false,
      type: 'exists',
      value: 'exists',
    },
  ...
  },
  {
    ...
    query: {
      match_phrase: {
        'event.dataset': 'kubernetes.scheduler',
      },
    },
  },
  {
    ...
    meta: {
      ...
      disabled: false,
      indexRefName: 'kibanaSavedObjectMeta.searchSourceJSON.filter[1].meta.index',
      key: 'abusech.malwarebazaar.tags',
      negate: false,
      type: 'exists',
      value: 'exists',
    },
  },
  {
    ...
    meta: {
      ...
      disabled: false,
      indexRefName: 'kibanaSavedObjectMeta.searchSourceJSON.filter[1].meta.index',
      key: 'abusech.malware.virustotal.link',
      negate: false,
      type: 'exists',
      value: 'exists',
    },
  },
  {
    ...
    meta: {
      ...
      disabled: false,
      indexRefName: 'kibanaSavedObjectMeta.searchSourceJSON.filter[2].meta.index',
      key: 'abusech.malware.virustotal.result',
      negate: false,
      type: 'exists',
      value: 'exists',
    },

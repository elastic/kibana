...
export declare const buildSimpleNumberRangeFilter: (fieldName: string, fieldType: "number" | "date", params: RangeFilterParams, value: string, dataViewId: string) => ScriptedRangeFilter | MatchAllRangeFilter | RangeFilter;
/**
 * @internal
 */

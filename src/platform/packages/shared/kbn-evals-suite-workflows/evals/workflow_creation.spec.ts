            ...
            examples: [
              {
                ...
                output: {
                  ...
                  expectedStepTypes: ['esql.query', 'email'],
                  expectedStepCount: { min: 2, max: 4 },
                  expectedMaxToolCalls: 6,
                  expectedToolSequence: ['platform.core.generate_workflow'],
                },
            ...
            examples: [
              {
                ...
                output: {
                  ...
                  expectedStepTypes: ['http', 'slack.postMessage', 'console'],
                  expectedStepCount: { min: 3, max: 5 },
                  expectedMaxToolCalls: 5,
                  expectedToolSequence: ['platform.core.generate_workflow'],
                },
          ...
          examples: [
            {
              ...
              output: {
                ...
                expectedStepTypes: ['http', 'esql.query', 'elasticsearch.index', 'console'],
            ...
            examples: [
              {
                ...
                output: {
                  ...
                  expectedStepTypes: ['slack.postMessage'],
                  expectedStepCount: { min: 1, max: 3 },

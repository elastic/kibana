...
export function SpanLinksBadge({ outgoingCount, incomingCount, id, onClick }: Props) {
  ...
  return (
    <EuiToolTip
      title={i18n.translate('apmUiShared.waterfall.spanLinks.tooltip.title', {
      ...
      content={
        <EuiFlexGroup direction="column" gutterSize="xs">
          <EuiFlexItem>
            {i18n.translate('apmUiShared.waterfall.spanLinks.tooltip.incomingCount', {
              defaultMessage: '{incomingCount} incoming',
              values: { incomingCount },
            })}
          </EuiFlexItem>
          <EuiFlexItem>
            {i18n.translate('apmUiShared.waterfall.spanLinks.tooltip.outgoingCount', {
    ...
    >
      ...
      >
        {i18n.translate('apmUiShared.waterfall.spanLinks.badge', {

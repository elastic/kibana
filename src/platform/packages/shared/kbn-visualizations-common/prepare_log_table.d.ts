...
export declare const prepareLogTable: (datatable: Datatable, dimensions: LayerDimension[] | Dimension[], removeUnmappedColumns?: boolean) => {
    columns: {
        meta: {
            ...
            type: import("@kbn/expressions-plugin/common").DatatableColumnType;
            esType?: string;
            field?: string;
            index?: string;
    ...
    type: "datatable";
    meta?: import("@kbn/expressions-plugin/common/expression_types").DatatableMeta;
    rows: import("@kbn/expressions-plugin/common").DatatableRow[];
    warning?: string;
};
export {};

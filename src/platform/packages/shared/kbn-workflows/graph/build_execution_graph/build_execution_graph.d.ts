...
import type { BaseStep, DataSetStep, ElasticsearchStep, KibanaStep, WaitForApprovalStep, WaitForInputStep, WaitStep, WorkflowExecuteAsyncStep, WorkflowExecuteStep, WorkflowSettings, WorkflowYaml } from '../../spec/schema';
...
export declare function visitWaitForApprovalStep(currentStep: WaitForApprovalStep, context: GraphBuildContext): WorkflowGraphType;
...
export declare function convertToWorkflowGraph(workflowSchema: WorkflowYaml, defaultSettings?: WorkflowSettings): WorkflowGraphType;

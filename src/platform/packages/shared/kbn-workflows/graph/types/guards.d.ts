import type { AtomicGraphNode, DataSetGraphNode, ElasticsearchGraphNode, KibanaGraphNode, WaitForApprovalGraphNode, WaitForInputGraphNode, WaitGraphNode, WorkflowOutputGraphNode } from './nodes/base';
...
export declare const isWaitForApproval: (node: GraphNodeUnion) => node is WaitForApprovalGraphNode;
...
export declare const isExitParallel: (node: GraphNodeUnion) => node is ExitParallelNode;

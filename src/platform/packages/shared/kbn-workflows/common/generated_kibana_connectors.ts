...
export const GENERATED_KIBANA_CONNECTORS: InternalConnectorContract[] = [
  ...
  },
  {
    ...
    parameterTypes: {
      pathParams: ["id"],
      urlParams: ["kbn-xsrf"],
      bodyParams: ["apiUrl","defaultModel","v1","url","clientId","from","hasAuth","host","oauthTokenUrl","port","secure","service","tenantId","gcpRegion","gcpProjectID","orgId","executionTimeField","index","refresh","projectKey","apiProvider","certificateData","privateKeyData","caData","verificationMode","headers","isOAuth","jwtKeyId","userIdentifierValue","usesTableApi","allowedChannels","id","name","appId","connectorType","mappings","alertIdConfig","fieldType","key","caseIdConfig","caseNameConfig","commentsConfig","descriptionConfig","ruleNameConfig","severityConfig","organisation","webhookIntegrationUrl","authType","ca","certType","method","createCommentJson","createCommentMethod","createCommentUrl","createIncidentJson","createIncidentMethod","createIncidentResponseKey","createIncidentUrl","getIncidentResponseExternalTitleKey","getIncidentUrl","updateIncidentJson","updateIncidentMethod","updateIncidentUrl","viewIncidentUrl","configUrl","usesBasic"]
    },
    paramsSchema: z.object({
    id: z.string().describe('Path parameter: id (required)'),
    'kbn-xsrf': z.string().optional().describe('Header parameter: kbn-xsrf'),
  ...
  },
  {
    ...
    parameterTypes: {
      pathParams: ["id"],
      urlParams: ["kbn-xsrf"],
      bodyParams: ["dedupKey","eventAction","documents","bcc","cc","message","subject","to","level","class","component","customDetails","group","links","href","text","severity","source","summary","timestamp","offset","subAction","subActionParams","additional_info","description","event_class","message_key","metric_name","node","resource","time_of_event","type","alias","note","user","actions","details","entity","priority","responders","id","name","username","sourceRef","tags","title","tlp","visibleTo","ids","fields","externalId","channelIds","channels","channelId"]
    },
    paramsSchema: z.object({
    id: z.string().describe('Path parameter: id (required)'),
    'kbn-xsrf': z.string().optional().describe('Header parameter: kbn-xsrf'),
  ...
  },
  {
    ...
    parameterTypes: {
      pathParams: [],
      urlParams: [],
      bodyParams: ["commandLine","raw","timeout","hostPath","cloudFile","inputParams","script"]
    },
    paramsSchema: z.object({

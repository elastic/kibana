 ...
 * Generated at: 2025-09-19T16:42:22.683Z
...
export const GENERATED_KIBANA_CONNECTORS: InternalConnectorContract[] = [
  ...
  },
  {
    ...
    parameterTypes: {
      pathParams: ["id"],
      urlParams: ["kbn-xsrf"],
      bodyParams: ["apiUrl","defaultModel","v1","url","clientId","from","hasAuth","host","oauthTokenUrl","port","secure","service","tenantId","gcpRegion","gcpProjectID","orgId","executionTimeField","index","refresh","projectKey","apiProvider","certificateData","privateKeyData","caData","verificationMode","headers","isOAuth","jwtKeyId","userIdentifierValue","usesTableApi","allowedChannels","name","appId","connectorType","mappings","alertIdConfig","fieldType","key","caseIdConfig","caseNameConfig","commentsConfig","descriptionConfig","ruleNameConfig","severityConfig","organisation","webhookIntegrationUrl","authType","ca","certType","method","createCommentJson","createCommentMethod","createCommentUrl","createIncidentJson","createIncidentMethod","createIncidentResponseKey","createIncidentUrl","getIncidentResponseExternalTitleKey","getIncidentUrl","updateIncidentJson","updateIncidentMethod","updateIncidentUrl","viewIncidentUrl","configUrl","usesBasic"]
    },
    paramsSchema: z.object({
    id: z.string().describe('Path parameter: id (required)'),
    'kbn-xsrf': z.string().optional().describe('Header parameter: kbn-xsrf'),
    ...
    getIncidentResponseExternalTitleKey: z.any().optional().describe('getIncidentResponseExternalTitleKey parameter'),
  ...
  },
  {
    ...
    parameterTypes: {
      pathParams: ["id"],
      urlParams: ["kbn-xsrf"],
      bodyParams: ["apiUrl","defaultModel","v1","url","clientId","from","hasAuth","host","oauthTokenUrl","port","secure","service","tenantId","gcpRegion","gcpProjectID","orgId","executionTimeField","index","refresh","projectKey","oAuthScope","oAuthServerUrl","apiProvider","isOAuth","jwtKeyId","userIdentifierValue","usesTableApi","allowedChannels","name","appId","connectorType","mappings","alertIdConfig","fieldType","key","caseIdConfig","caseNameConfig","commentsConfig","descriptionConfig","ruleNameConfig","severityConfig","organisation","webhookIntegrationUrl","authType","ca","certType","headers","method","verificationMode","createCommentJson","createCommentMethod","createCommentUrl","createIncidentJson","createIncidentMethod","createIncidentResponseKey","createIncidentUrl","getIncidentResponseExternalTitleKey","getIncidentUrl","updateIncidentJson","updateIncidentMethod","updateIncidentUrl","viewIncidentUrl","configUrl","usesBasic"]
    },
    paramsSchema: z.object({
    id: z.string().describe('Path parameter: id (required)'),
    'kbn-xsrf': z.string().optional().describe('Header parameter: kbn-xsrf'),
  ...
  },
  {
    ...
    parameterTypes: {
      pathParams: ["id"],
      urlParams: ["kbn-xsrf"],
      bodyParams: ["dedupKey","eventAction","documents","bcc","cc","message","subject","to","level","class","component","customDetails","group","links","href","text","severity","source","summary","timestamp","offset","subAction","subActionParams","additional_info","description","event_class","message_key","metric_name","node","resource","time_of_event","type","alias","note","user","actions","details","entity","priority","responders","name","username","sourceRef","tags","title","tlp","visibleTo","ids","fields","externalId","channelIds","channels","channelId"]
    },
    paramsSchema: z.object({
    id: z.string().describe('Path parameter: id (required)'),
    'kbn-xsrf': z.string().optional().describe('Header parameter: kbn-xsrf'),
  ...
  },
  {
    ...
    parameterTypes: {
      pathParams: [],
      urlParams: ["kbn-xsrf"],
      bodyParams: ["fields","id","name","type","issueType","parent","priority","issueTypes","severityCode","category","impact","severity","subcategory","urgency","destIp","malwareHash","malwareUrl","sourceIp","caseId"]
    },
    paramsSchema: z.object({
    'kbn-xsrf': z.string().optional().describe('Header parameter: kbn-xsrf'),
    fields: z.any().optional().describe('fields parameter'),
  ...
  },
  {
    ...
    timestamp_override_fallback_disabled: z.any().optional().describe('timestamp_override_fallback_disabled parameter'),
    to: z.any().optional().describe('to parameter'),
    version: z.any().optional().describe('version parameter'),
  ...
  },
  {
    ...
    parameterTypes: {
      pathParams: [],
      urlParams: ["dry_run"],
      bodyParams: ["action","gaps_range_end","gaps_range_start","ids","query","duplicate","include_exceptions","include_expired_exceptions","run","end_date","start_date","fill_gaps","edit"]
    },
    paramsSchema: z.object({
    ...
    include_expired_exceptions: z.any().optional().describe('include_expired_exceptions parameter'),
  ...
  },
  {
    ...
    parameterTypes: {
      ...
      bodyParams: ["actions","alias_purpose","alias_target_id","author","building_block_type","description","enabled","exceptions_list","false_positives","from","interval","investigation_fields","license","max_signals","meta","name","namespace","note","outcome","output_index","references","related_integrations","required_fields","response_actions","risk_score","risk_score_mapping","rule_id","rule_name_override","setup","severity","severity_mapping","tags","threat","throttle","timeline_id","timeline_title","timestamp_override","timestamp_override_fallback_disabled","to","version","invocationCount","timeframeEnd","offset"]
    },
    paramsSchema: z.object({
  ...
  },
  {
    ...
    parameterTypes: {
      pathParams: [],
      urlParams: [],
      bodyParams: ["commandLine","raw","timeout","hostPath","cloudFile","inputParams","script","args","scriptName"]
    },
    paramsSchema: z.object({
  ...
  },
  {
    ...
    parameterTypes: {
      pathParams: ["id"],
      urlParams: [],
      bodyParams: ["entity_analytics_monitoring","labels","field","source","value","source_ids","source_integrations","sources","user","is_privileged","name"]
    },
    paramsSchema: z.object({
    id: z.string().describe('Path parameter: id (required)'),
  ...
  },
  {
    ...
    parameterTypes: {
      pathParams: ["id"],
      urlParams: [],
      bodyParams: ["description","ecs_mapping","interval","platform","query","removed","snapshot","version"]
    },
    paramsSchema: z.object({
    id: z.string().describe('Path parameter: id (required)'),
    description: z.any().optional().describe('description parameter'),
  ...
  },
  {
    ...
    parameterTypes: {
      pathParams: ["id"],
      urlParams: [],
      bodyParams: ["apiConfig","category","excludeFromLastConversationStorage","messages","replacements","title","users"]
    },
    paramsSchema: z.object({
    id: z.string().describe('Path parameter: id (required)'),
    apiConfig: z.any().optional().describe('apiConfig parameter'),
  ...
  },
  {
    ...
    parameterTypes: {
      pathParams: ["id"],
      urlParams: ["kbn-xsrf"],
      bodyParams: ["_reserved","color","description","disabledFeatures","imageUrl","initials","name","solution"]
    },
    paramsSchema: z.object({
    id: z.string().describe('Path parameter: id (required)'),
    'kbn-xsrf': z.string().optional().describe('Header parameter: kbn-xsrf'),
  ...
  },
  {
    ...
    parameterTypes: {
      pathParams: ["spaceId"],
      urlParams: ["kbn-xsrf"],
      bodyParams: ["params","dataViewId","filter","good","index","timestampField","total","type","environment","service","transactionName","transactionType","threshold","meta","alias","controlledBy","disabled","field","group","isMultiIndex","key","negate","value","query","state","aggregation","from","to","name","percentile"]
    },
    paramsSchema: z.object({
    spaceId: z.string().describe('Path parameter: spaceId (required)'),
    'kbn-xsrf': z.string().optional().describe('Header parameter: kbn-xsrf'),
...
export const KIBANA_CONNECTOR_COUNT = 456;

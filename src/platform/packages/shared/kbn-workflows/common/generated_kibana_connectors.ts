...
export const GENERATED_KIBANA_CONNECTORS: InternalConnectorContract[] = [
  ...
  },
  {
    ...
    parameterTypes: {
      pathParams: [],
      urlParams: [],
      bodyParams: ["allow_edit","ca_sha256","ca_trusted_fingerprint","config_yaml","hosts","id","is_default","is_default_monitoring","is_internal","is_preconfigured","name","preset","proxy_id","secrets","ssl","key","id"]
    },

 ...
 * Generated at: 2025-11-13T07:42:56.915Z
...
export const GENERATED_ELASTICSEARCH_CONNECTORS: InternalConnectorContract[] = [
  ...
  },
  {
    ...
    filter_path: z.any().optional().describe('Parameter: filter_path'),
  ...
  },
  {
    ...
    docvalue_fields: z.any().optional().describe('Parameter: docvalue_fields'),
    ...
    stored_fields: z.any().optional().describe('Parameter: stored_fields'),
    ...
    _source_excludes: z.any().optional().describe('Parameter: _source_excludes'),
    _source_includes: z.any().optional().describe('Parameter: _source_includes'),
    ...
    sort: z.any().optional().describe('Parameter: sort'),
    body: z.any().optional().describe('Request body'),
    }),
  ...
  },
  {
    ...
    human: z.boolean().optional().describe('Boolean flag: human'),
    pretty: z.boolean().optional().describe('Boolean flag: pretty'),
    h: z.any().optional().describe('Parameter: h'),
    s: z.any().optional().describe('Parameter: s'),
    expand_wildcards: z.enum(['all', 'open', 'closed', 'hidden', 'none']).optional().describe('Enum parameter: expand_wildcards'),
    master_timeout: z.enum(['30s', '-1', '0']).optional().describe('Enum parameter: master_timeout'),
    body: z.any().optional().describe('Request body'),
    }),
  ...
  },
  {
    ...
    settings_filter: z.any().optional().describe('Parameter: settings_filter'),
  ...
  },
  {
    ...
    wait_for_nodes: z.any().optional().describe('Parameter: wait_for_nodes'),
  ...
  },
  {
    ...
    human: z.boolean().optional().describe('Boolean flag: human'),
    pretty: z.boolean().optional().describe('Boolean flag: pretty'),
    node_names: z.any().optional().describe('Parameter: node_names'),
    node_ids: z.any().optional().describe('Parameter: node_ids'),
    master_timeout: z.enum(['30s', '-1', '0']).optional().describe('Enum parameter: master_timeout'),
    timeout: z.enum(['30s', '-1', '0']).optional().describe('Enum parameter: timeout'),
    body: z.any().optional().describe('Request body'),
    }),
  ...
  },
  {
    ...
    from: z.union([z.string(), z.number()]).optional().describe('Parameter: from'),
    size: z.union([z.string(), z.number()]).optional().describe('Parameter: size'),
    index_name: z.any().optional().describe('Parameter: index_name'),
    connector_name: z.any().optional().describe('Parameter: connector_name'),
    service_type: z.any().optional().describe('Parameter: service_type'),
    include_deleted: z.boolean().optional().describe('Boolean flag: include_deleted'),
  ...
  },
  {
    ...
    allow_no_indices: z.boolean().optional().describe('Boolean flag: allow_no_indices'),
    expand_wildcards: z.enum(['all', 'open', 'closed', 'hidden', 'none']).optional().describe('Enum parameter: expand_wildcards'),
    fields: z.any().optional().describe('Parameter: fields'),
    ignore_unavailable: z.boolean().optional().describe('Boolean flag: ignore_unavailable'),
  ...
  },
  {
    ...
    human: z.boolean().optional().describe('Boolean flag: human'),
    pretty: z.boolean().optional().describe('Boolean flag: pretty'),
    completion_fields: z.any().optional().describe('Parameter: completion_fields'),
    expand_wildcards: z.enum(['all', 'open', 'closed', 'hidden', 'none']).optional().describe('Enum parameter: expand_wildcards'),
    fielddata_fields: z.any().optional().describe('Parameter: fielddata_fields'),
    fields: z.any().optional().describe('Parameter: fields'),
    forbid_closed_indices: z.boolean().optional().describe('Boolean flag: forbid_closed_indices'),
    groups: z.any().optional().describe('Parameter: groups'),
  ...
  },
  {
    ...
    human: z.boolean().optional().describe('Boolean flag: human'),
    pretty: z.boolean().optional().describe('Boolean flag: pretty'),
    advance_time: z.any().optional().describe('Parameter: advance_time'),
    calc_interim: z.boolean().optional().describe('Boolean flag: calc_interim'),
    end: z.any().optional().describe('Parameter: end'),
    skip_time: z.any().optional().describe('Parameter: skip_time'),
    start: z.any().optional().describe('Parameter: start'),
    body: z.any().optional().describe('Request body'),
    }),
  ...
  },
  {
    ...
    exclude_interim: z.boolean().optional().describe('Boolean flag: exclude_interim'),
    overall_score: z.any().optional().describe('Parameter: overall_score'),
    start: z.any().optional().describe('Parameter: start'),
  ...
  },
  {
    ...
    size: z.union([z.number(), z.array(z.number()), z.enum(['100'])]).optional().describe('Numeric parameter: size'),
    tags: z.any().optional().describe('Parameter: tags'),
    body: z.any().optional().describe('Request body'),
    }),
  ...
  },
  {
    ...
    human: z.boolean().optional().describe('Boolean flag: human'),
    pretty: z.boolean().optional().describe('Boolean flag: pretty'),
    reset_end: z.any().optional().describe('Parameter: reset_end'),
    reset_start: z.any().optional().describe('Parameter: reset_start'),
    body: z.any().optional().describe('Request body'),
    }),
  ...
  },
  {
    ...
    human: z.boolean().optional().describe('Boolean flag: human'),
    pretty: z.boolean().optional().describe('Boolean flag: pretty'),
    cache_size: z.any().optional().describe('Parameter: cache_size'),
  ...
  },
  {
    ...
    human: z.boolean().optional().describe('Boolean flag: human'),
    pretty: z.boolean().optional().describe('Boolean flag: pretty'),
    data: z.any().optional().describe('Parameter: data'),
    body: z.any().optional().describe('Request body'),
    }),
  ...
  },
  {
    ...
    human: z.boolean().optional().describe('Boolean flag: human'),
    pretty: z.boolean().optional().describe('Boolean flag: pretty'),
    actions: z.any().optional().describe('Parameter: actions'),
    nodes: z.union([z.string(), z.number()]).optional().describe('Parameter: nodes'),
    parent_task_id: z.union([z.string(), z.number()]).optional().describe('Parameter: parent_task_id'),
    wait_for_completion: z.boolean().optional().describe('Boolean flag: wait_for_completion'),
    body: z.any().optional().describe('Request body'),
  ...
  },
  {
    ...
    nodes: z.any().optional().describe('Parameter: nodes'),
    parent_task_id: z.union([z.string(), z.number()]).optional().describe('Parameter: parent_task_id'),
    timeout: z.enum(['30s', '-1', '0']).optional().describe('Enum parameter: timeout'),
    wait_for_completion: z.boolean().optional().describe('Boolean flag: wait_for_completion'),
    body: z.any().optional().describe('Request body'),

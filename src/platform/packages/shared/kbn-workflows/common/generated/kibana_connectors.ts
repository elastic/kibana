...
export const GENERATED_KIBANA_CONNECTORS: InternalConnectorContract[] = [
  ...
  },
  {
    ...
    paramsSchema: (() => {
      ...
      if (baseSchema._def && (baseSchema._def as any).options) {
        ...
        const hasTypeDiscriminator = (baseSchema._def as any).options.every(
          (option: any) =>
  ...
  },
  {
    ...
    paramsSchema: z.object({
      ...
      enable_field_rendering: z
        .any()
        .optional()
        .describe('Query parameter: enable_field_rendering'),
      end: z.any().optional().describe('Query parameter: end'),
      ids: z.any().optional().describe('Query parameter: ids'),
      include_unique_alert_ids: z
        .any()
        .optional()
        .describe('Query parameter: include_unique_alert_ids'),
      page: z.any().optional().describe('Query parameter: page'),
      per_page: z.any().optional().describe('Query parameter: per_page'),
      search: z.any().optional().describe('Query parameter: search'),
  ...
  },
  {
    ...
    summary:
      'Get the latest attack discovery generations (that are not dismissed) for the current user',
    methods: ['GET'],
  ...
  },
  {
    ...
    connectorIdRequired: false,
    description:
      'POST /api/attack_discovery/generations/:execution_uuid/_dismiss - Kibana API endpoint',
    methods: ['POST'],
  ...
  },
  {
    ...
    isInternal: true,
    documentation:
      'https://www.elastic.co/docs/api/doc/kibana/operation/operation-getattackdiscoveryschedules',
    parameterTypes: {
      pathParams: ['id'],
      urlParams: ['query'],
      bodyParams: [],
  ...
  },
  {
    ...
    isInternal: true,
    documentation:
      'https://www.elastic.co/docs/api/doc/kibana/operation/operation-post_fleet_agents_agentid_migrate',
    parameterTypes: {
      pathParams: ['agentId'],
      urlParams: [],
      bodyParams: [],
  ...
  },
  {
    ...
    isInternal: true,
    documentation:
      'https://www.elastic.co/docs/api/doc/kibana/operation/operation-post_fleet_agents_bulk_migrate',
    parameterTypes: {
      pathParams: [],
      urlParams: [],
      bodyParams: [
  ...
  },
  {
    ...
    connectorIdRequired: false,
    description:
      'POST /api/fleet/epm/packages/:pkgName/:pkgVersion/rule_assets - Kibana API endpoint',
    methods: ['POST'],
    patterns: ['/api/fleet/epm/packages/{pkgName}/{pkgVersion}/rule_assets'],
    isInternal: true,
    documentation:
      'https://www.elastic.co/docs/api/doc/kibana/operation/operation-post_fleet_epm_packages_pkgname_pkgversion_rule_assets',
    parameterTypes: {
      pathParams: ['pkgName', 'pkgVersion'],
      urlParams: [],
      bodyParams: ['body'],
    ...
    outputSchema: z
      .any()
      .describe('Response from post_fleet_epm_packages_pkgname_pkgversion_rule_assets API'),
  },
  {

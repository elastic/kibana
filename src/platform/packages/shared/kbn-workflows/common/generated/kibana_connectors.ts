 ...
 * Generated at: 2025-10-20T09:51:25.099Z
...
import {
  ...
  post_fleet_agents_agentid_migrate_Body,
  post_fleet_agents_agentid_upgrade_Body,
  post_fleet_agents_bulk_migrate_Body,
...
export const GENERATED_KIBANA_CONNECTORS: InternalConnectorContract[] = [
  ...
  },
  {
    ...
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-post_agent_builder_a2a_agentid',
    parameterTypes: {
      pathParams: ["agentId"],
      urlParams: [],
      bodyParams: ["body"]
  ...
  },
  {
    ...
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get_agent_builder_a2a_agentid_json',
    parameterTypes: {
  ...
  },
  {
    ...
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get_agent_builder_agents',
    parameterTypes: {
      pathParams: [],
      urlParams: ["query"],
      bodyParams: []
  ...
  },
  {
    ...
    patterns: ["/api/agent_builder/agents"],
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-post_agent_builder_agents',
    parameterTypes: {
      pathParams: [],
      urlParams: [],
      bodyParams: ["avatar_color","avatar_symbol","configuration","instructions","tools","tool_ids"]
    },
  ...
  },
  {
    ...
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-delete_agent_builder_agents_id',
    parameterTypes: {
      pathParams: ["id"],
      urlParams: [],
      bodyParams: []
  ...
  },
  {
    ...
    patterns: ["/api/agent_builder/agents/{id}"],
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get_agent_builder_agents_id',
    parameterTypes: {
      pathParams: ["id"],
      urlParams: ["query"],
      bodyParams: []
  ...
  },
  {
    ...
    patterns: ["/api/agent_builder/agents/{id}"],
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-put_agent_builder_agents_id',
    parameterTypes: {
      pathParams: ["id"],
      urlParams: [],
      bodyParams: []
  ...
  },
  {
    ...
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get_agent_builder_conversations',
    parameterTypes: {
      pathParams: [],
      urlParams: ["agent_id"],
      bodyParams: []
  ...
  },
  {
    ...
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-delete_agent_builder_conversations_conversation_id',
    parameterTypes: {
    ...
    outputSchema: z.any().describe('Response from delete_agent_builder_conversations_conversation_id API')
  },
  {
    ...
    patterns: ["/api/agent_builder/conversations/{conversation_id}"],
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get_agent_builder_conversations_conversation_id',
    parameterTypes: {
      pathParams: ["conversation_id"],
      urlParams: ["query"],
      bodyParams: []
    ...
    outputSchema: z.any().describe('Response from get_agent_builder_conversations_conversation_id API')
  },
  {
    ...
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-post_agent_builder_converse',
    parameterTypes: {
      pathParams: [],
      urlParams: [],
  ...
  },
  {
    ...
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-post_agent_builder_converse_async',
    parameterTypes: {
      pathParams: [],
      urlParams: [],
      bodyParams: ["agent_id","capabilities","visualizations"]
  ...
  },
  {
    ...
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-post_agent_builder_mcp',
    parameterTypes: {
      pathParams: [],
      urlParams: [],
      bodyParams: ["body"]
  ...
  },
  {
    ...
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get_agent_builder_tools',
    parameterTypes: {
      pathParams: [],
      urlParams: ["query"],
      bodyParams: []
  ...
  },
  {
    ...
    patterns: ["/api/agent_builder/tools"],
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-post_agent_builder_tools',
    parameterTypes: {
      pathParams: [],
      urlParams: [],
  ...
  },
  {
    ...
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-post_agent_builder_tools_execute',
    parameterTypes: {
      pathParams: [],
      urlParams: [],
  ...
  },
  {
    ...
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-delete_agent_builder_tools_id',
    parameterTypes: {
      pathParams: ["id"],
      urlParams: [],
      bodyParams: []
  ...
  },
  {
    ...
    patterns: ["/api/agent_builder/tools/{id}"],
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get_agent_builder_tools_id',
    parameterTypes: {
      pathParams: ["id"],
      urlParams: ["query"],
      bodyParams: []
  ...
  },
  {
    ...
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-put_agent_builder_tools_toolid',
    parameterTypes: {
      pathParams: ["toolId"],
      urlParams: [],
      bodyParams: []
  ...
  },
  {
    ...
    connectorIdRequired: false,
    description: 'POST /api/attack_discovery/_bulk - Kibana API endpoint',
    summary: 'Bulk update Attack discovery alerts',
    methods: ["POST"],
    patterns: ["/api/attack_discovery/_bulk"],
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-postattackdiscoverybulk',
    parameterTypes: {
      pathParams: [],
      urlParams: [],
      bodyParams: ["update","enable_field_rendering","ids","kibana_alert_workflow_status","visibility","with_replacements"]
    },
    paramsSchema: PostAttackDiscoveryBulk_Body,
    outputSchema: z.any().describe('Response from PostAttackDiscoveryBulk API')
  },
  {
    type: 'kibana.AttackDiscoveryFind',
    connectorIdRequired: false,
    description: 'GET /api/attack_discovery/_find - Kibana API endpoint',
    summary: 'Finds Attack discoveries that match the search criteria',
    methods: ["GET"],
    patterns: ["/api/attack_discovery/_find"],
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-attackdiscoveryfind',
    parameterTypes: {
      pathParams: [],
      urlParams: ["alert_ids","connector_names","enable_field_rendering","end","ids","include_unique_alert_ids","page","per_page","search","shared","sort_field"],
      bodyParams: []
    },
    paramsSchema: z.object({
    alert_ids: z.any().optional().describe('Query parameter: alert_ids'),
    connector_names: z.any().optional().describe('Query parameter: connector_names'),
    enable_field_rendering: z.any().optional().describe('Query parameter: enable_field_rendering'),
    end: z.any().optional().describe('Query parameter: end'),
    ids: z.any().optional().describe('Query parameter: ids'),
    include_unique_alert_ids: z.any().optional().describe('Query parameter: include_unique_alert_ids'),
    page: z.any().optional().describe('Query parameter: page'),
    per_page: z.any().optional().describe('Query parameter: per_page'),
    search: z.any().optional().describe('Query parameter: search'),
    shared: z.any().optional().describe('Query parameter: shared'),
    sort_field: z.any().optional().describe('Query parameter: sort_field'),
    }),
    outputSchema: z.any().describe('Response from AttackDiscoveryFind API')
  },
  {
    type: 'kibana.PostAttackDiscoveryGenerate',
    connectorIdRequired: false,
    description: 'POST /api/attack_discovery/_generate - Kibana API endpoint',
    summary: 'Generate attack discoveries from alerts',
    methods: ["POST"],
    patterns: ["/api/attack_discovery/_generate"],
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-postattackdiscoverygenerate',
    parameterTypes: {
      pathParams: [],
      urlParams: [],
      bodyParams: ["alertsIndexPattern","anonymizationFields","apiConfig","connectorName","end","filter"]
    },
    paramsSchema: Security_Attack_discovery_API_AttackDiscoveryGenerationConfig,
    outputSchema: z.any().describe('Response from PostAttackDiscoveryGenerate API')
  },
  {
    type: 'kibana.GetAttackDiscoveryGenerations',
    connectorIdRequired: false,
    description: 'GET /api/attack_discovery/generations - Kibana API endpoint',
    ...
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-getattackdiscoverygenerations',
    parameterTypes: {
      pathParams: [],
    ...
    outputSchema: z.any().describe('Response from GetAttackDiscoveryGenerations API')
  },
  {
    type: 'kibana.GetAttackDiscoveryGeneration',
    connectorIdRequired: false,
    description: 'GET /api/attack_discovery/generations/:execution_uuid - Kibana API endpoint',
    methods: ["GET"],
    patterns: ["/api/attack_discovery/generations/{execution_uuid}"],
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-getattackdiscoverygeneration',
    parameterTypes: {
    ...
    paramsSchema: z.object({
    execution_uuid: z.string().describe('Path parameter: execution_uuid (required)'),
    enable_field_rendering: z.any().optional().describe('Query parameter: enable_field_rendering'),
    with_replacements: z.any().optional().describe('Query parameter: with_replacements'),
    }),
    outputSchema: z.any().describe('Response from GetAttackDiscoveryGeneration API')
  },
  {
    type: 'kibana.PostAttackDiscoveryGenerationsDismiss',
    connectorIdRequired: false,
    description: 'POST /api/attack_discovery/generations/:execution_uuid/_dismiss - Kibana API endpoint',
    methods: ["POST"],
    patterns: ["/api/attack_discovery/generations/{execution_uuid}/_dismiss"],
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-postattackdiscoverygenerationsdismiss',
    parameterTypes: {
      pathParams: ["execution_uuid"],
      urlParams: [],
      bodyParams: ["body"]
    ...
    outputSchema: z.any().describe('Response from PostAttackDiscoveryGenerationsDismiss API')
  },
  {
    type: 'kibana.CreateAttackDiscoverySchedules',
    connectorIdRequired: false,
    description: 'POST /api/attack_discovery/schedules - Kibana API endpoint',
    summary: 'Create Attack discovery schedule',
    methods: ["POST"],
    patterns: ["/api/attack_discovery/schedules"],
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-createattackdiscoveryschedules',
    parameterTypes: {
      pathParams: [],
      urlParams: [],
      bodyParams: ["actions","enabled","name","params","schedule"]
    },
    paramsSchema: Security_Attack_discovery_API_AttackDiscoveryApiScheduleCreateProps,
    outputSchema: z.any().describe('Response from CreateAttackDiscoverySchedules API')
  },
  {
    type: 'kibana.FindAttackDiscoverySchedules',
    connectorIdRequired: false,
    description: 'GET /api/attack_discovery/schedules/_find - Kibana API endpoint',
    summary: 'Finds Attack discovery schedules that match the search criteria',
    methods: ["GET"],
    patterns: ["/api/attack_discovery/schedules/_find"],
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-findattackdiscoveryschedules',
    parameterTypes: {
      pathParams: [],
    ...
    outputSchema: z.any().describe('Response from FindAttackDiscoverySchedules API')
  },
  {
    type: 'kibana.DeleteAttackDiscoverySchedules',
    connectorIdRequired: false,
    description: 'DELETE /api/attack_discovery/schedules/:id - Kibana API endpoint',
    methods: ["DELETE"],
    patterns: ["/api/attack_discovery/schedules/{id}"],
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-deleteattackdiscoveryschedules',
    parameterTypes: {
      pathParams: ["id"],
      urlParams: [],
      bodyParams: []
    ...
    outputSchema: z.any().describe('Response from DeleteAttackDiscoverySchedules API')
  },
  {
    type: 'kibana.GetAttackDiscoverySchedules',
    connectorIdRequired: false,
    description: 'GET /api/attack_discovery/schedules/:id - Kibana API endpoint',
    methods: ["GET"],
    patterns: ["/api/attack_discovery/schedules/{id}"],
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-getattackdiscoveryschedules',
    parameterTypes: {
      pathParams: ["id"],
      urlParams: ["query"],
      bodyParams: []
    ...
    outputSchema: z.any().describe('Response from GetAttackDiscoverySchedules API')
  },
  {
    type: 'kibana.UpdateAttackDiscoverySchedules',
    connectorIdRequired: false,
    description: 'PUT /api/attack_discovery/schedules/:id - Kibana API endpoint',
    methods: ["PUT"],
    patterns: ["/api/attack_discovery/schedules/{id}"],
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-updateattackdiscoveryschedules',
    parameterTypes: {
      pathParams: ["id"],
      urlParams: [],
      bodyParams: []
    ...
    paramsSchema: (() => {
          const baseSchema = Security_Attack_discovery_API_AttackDiscoveryApiScheduleUpdateProps;
          const additionalFields = z.object({
    id: z.string().describe('Path parameter: id (required)'),
          });
    ...
    outputSchema: z.any().describe('Response from UpdateAttackDiscoverySchedules API')
  },
  {
    type: 'kibana.DisableAttackDiscoverySchedules',
    connectorIdRequired: false,
    description: 'PUT /api/attack_discovery/schedules/:id/_disable - Kibana API endpoint',
    methods: ["PUT"],
    patterns: ["/api/attack_discovery/schedules/{id}/_disable"],
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-disableattackdiscoveryschedules',
    parameterTypes: {
      pathParams: ["id"],
      urlParams: [],
      bodyParams: ["body"]
    ...
    outputSchema: z.any().describe('Response from DisableAttackDiscoverySchedules API')
  },
  {
    type: 'kibana.EnableAttackDiscoverySchedules',
    connectorIdRequired: false,
    description: 'PUT /api/attack_discovery/schedules/:id/_enable - Kibana API endpoint',
    methods: ["PUT"],
    patterns: ["/api/attack_discovery/schedules/{id}/_enable"],
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-enableattackdiscoveryschedules',
    parameterTypes: {
      pathParams: ["id"],
      urlParams: [],
      bodyParams: ["body"]
    ...
    outputSchema: z.any().describe('Response from EnableAttackDiscoverySchedules API')
  },
  {
  ...
  },
  {
    ...
    parameterTypes: {
      pathParams: [],
      urlParams: [],
      bodyParams: ["cases","assignees","category","connector","customFields","key","type","value"]
    },
  ...
  },
  {
    ...
    connectorIdRequired: false,
    description: 'PUT /api/entity_store/entities/bulk - Kibana API endpoint',
    summary: 'Upsert many entities in Entity Store',
    methods: ["PUT"],
    patterns: ["/api/entity_store/entities/bulk"],
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-upsertentitiesbulk',
    parameterTypes: {
      pathParams: [],
      urlParams: ["force"],
      bodyParams: []
    ...
    paramsSchema: (() => {
          const baseSchema = Security_Entity_Analytics_API_EntitiesContainer;
          const additionalFields = z.object({
    ...
    outputSchema: z.any().describe('Response from UpsertEntitiesBulk API')
  },
  {
  ...
  },
  {
    ...
    connectorIdRequired: false,
    description: 'POST /api/fleet/agents/:agentId/migrate - Kibana API endpoint',
    methods: ["POST"],
    patterns: ["/api/fleet/agents/{agentId}/migrate"],
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-post_fleet_agents_agentid_migrate',
    parameterTypes: {
      pathParams: ["agentId"],
      urlParams: [],
      bodyParams: []
    ...
    paramsSchema: (() => {
          const baseSchema = post_fleet_agents_agentid_migrate_Body;
          const additionalFields = z.object({
    agentId: z.string().describe('Path parameter: agentId (required)'),
          });
    ...
    outputSchema: z.any().describe('Response from post_fleet_agents_agentid_migrate API')
  },
  {
  ...
  },
  {
    ...
    connectorIdRequired: false,
    description: 'POST /api/fleet/agents/bulk_migrate - Kibana API endpoint',
    summary: 'Migrate multiple agents',
    methods: ["POST"],
    patterns: ["/api/fleet/agents/bulk_migrate"],
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-post_fleet_agents_bulk_migrate',
    parameterTypes: {
      pathParams: [],
      urlParams: [],
      bodyParams: ["agents","batchSize","enrollment_token","settings","ca_sha256","certificate_authorities","elastic_agent_cert","elastic_agent_cert_key","elastic_agent_cert_key_passphrase","headers","insecure","proxy_disabled","proxy_headers","proxy_url","staging","tags"]
    },
    paramsSchema: post_fleet_agents_bulk_migrate_Body,
    outputSchema: z.any().describe('Response from post_fleet_agents_bulk_migrate API')
  },
  {
  ...
  },
  {
    ...
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get_fleet_cloud_connectors',
    parameterTypes: {
      pathParams: [],
      urlParams: ["page","perPage"],
      bodyParams: []
  ...
  },
  {
    ...
    patterns: ["/api/fleet/cloud_connectors"],
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-post_fleet_cloud_connectors',
    parameterTypes: {
      pathParams: [],
      urlParams: [],
  ...
  },
  {
    ...
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-delete_fleet_cloud_connectors_cloudconnectorid',
    parameterTypes: {
    ...
    outputSchema: z.any().describe('Response from delete_fleet_cloud_connectors_cloudconnectorid API')
  },
  {
    ...
    patterns: ["/api/fleet/cloud_connectors/{cloudConnectorId}"],
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get_fleet_cloud_connectors_cloudconnectorid',
    parameterTypes: {
      pathParams: ["cloudConnectorId"],
      urlParams: ["query"],
      bodyParams: []
  ...
  },
  {
    ...
    patterns: ["/api/fleet/cloud_connectors/{cloudConnectorId}"],
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-put_fleet_cloud_connectors_cloudconnectorid',
    parameterTypes: {
      pathParams: ["cloudConnectorId"],
      urlParams: [],
      bodyParams: []
  ...
  },
  {
    ...
    connectorIdRequired: false,
    description: 'POST /api/fleet/epm/packages/:pkgName/:pkgVersion/rule_assets - Kibana API endpoint',
    methods: ["POST"],
    patterns: ["/api/fleet/epm/packages/{pkgName}/{pkgVersion}/rule_assets"],
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-post_fleet_epm_packages_pkgname_pkgversion_rule_assets',
    parameterTypes: {
      pathParams: ["pkgName","pkgVersion"],
      urlParams: [],
      bodyParams: ["body"]
    ...
    outputSchema: z.any().describe('Response from post_fleet_epm_packages_pkgname_pkgversion_rule_assets API')
  },
  {
  ...
  },
  {
    ...
    parameterTypes: {
      pathParams: [],
      urlParams: [],
      bodyParams: ["host_urls","id","is_default","is_internal","is_preconfigured","name","proxy_id","secrets","ssl","agent_key","id"]
    },
  ...
  },
  {
    ...
    parameterTypes: {
      pathParams: [],
      urlParams: [],
      bodyParams: ["allow_edit","ca_sha256","ca_trusted_fingerprint","config_yaml","hosts","id","is_default","is_default_monitoring","is_internal","is_preconfigured","name","preset","proxy_id","secrets","ssl","key","hash","id"]
    },
  ...
  },
  {
    ...
    parameterTypes: {
      pathParams: [],
      urlParams: [],
      bodyParams: ["additional_datastreams_permissions","cloud_connector_id","description","enabled","force","id","inputs","config","frozen","type","value"]
    },
  ...
  },
  {
    ...
    parameterTypes: {
      pathParams: [],
      urlParams: [],
      bodyParams: ["additional_yaml_config","delete_unenrolled_agents","enabled","is_preconfigured"]
    },
  ...
  },
  {
    ...
    parameterTypes: {
      pathParams: [],
      urlParams: [],
      bodyParams: ["enabled","schedule","custom","duration","recurring","end","every","occurrences","onMonth","onMonthDay","onWeekDay"]
    },
  ...
  },
  {
    ...
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get_maintenance_window_find',
    parameterTypes: {
      pathParams: [],
  ...
  },
  {
    ...
    parameterTypes: {
      pathParams: [],
      urlParams: [],
      bodyParams: ["agent_all","agent_ids","agent_platforms","agent_policy_ids","alert_ids","case_ids","ecs_mapping","event_ids","metadata"]
    },
  ...
  },
  {
    ...
    parameterTypes: {
      pathParams: [],
      urlParams: [],
      bodyParams: ["enable_reset_to_zero","exclude_alert_statuses","exclude_alert_tags","range","end","start"]
    },
  ...
  },
  {
    ...
    parameterTypes: {
      pathParams: [],
      urlParams: [],
      bodyParams: ["roles","description","elasticsearch","cluster","indices","allow_restricted_indices","field_security","names","privileges","query"]
    },
  ...
  },
  {
    ...
    parameterTypes: {
      pathParams: [],
      urlParams: [],
      bodyParams: ["compatibilityMode","createNewCopies","includeReferences","objects","id","type"]
    },
  ...
  },
  {
    ...
    isInternal: true,
    documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-post_streams_name_significant_events_generate',
    parameterTypes: {
      pathParams: ["name"],
    ...
    outputSchema: z.any().describe('Response from post_streams_name_significant_events_generate API')
  },
  {
  ...
  },
  {
    ...
    parameterTypes: {
      pathParams: [],
      urlParams: [],
      bodyParams: ["certAgeThreshold","certExpirationThreshold","defaultConnectors","defaultEmail","bcc","cc","to"]
    },
...
export const KIBANA_CONNECTOR_COUNT = 498;

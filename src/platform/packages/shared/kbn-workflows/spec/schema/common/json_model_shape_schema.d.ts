 ...
 */
export declare const JSON_SCHEMA_PROPERTY_KEYS: readonly ["type", "title", "description", "format", "default", "enum", "const", "properties", "additionalProperties", "required", "items", "anyOf", "oneOf", "$ref", "definitions", "minimum", "exclusiveMinimum", "maximum", "exclusiveMaximum", "minLength", "maxLength", "pattern", "multipleOf", "minItems", "maxItems"];
/**

 ...
 *
 * Source: elasticsearch-specification repository, operations: indices-resolve-index, indices-resolve-index-1
 *
...
import {
  indices_resolve_index1_request,
  indices_resolve_index1_response,
...
Multiple patterns and remote clusters are supported.
 ...
 Documentation: https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-indices-resolve-index`,
  ...
  paramsSchema: z.union([
    ...
    z.object({
      ...getShapeAt(indices_resolve_index1_request, 'body'),
      ...getShapeAt(indices_resolve_index1_request, 'path'),
      ...getShapeAt(indices_resolve_index1_request, 'query'),
    }),
  ]),
  outputSchema: z.union([indices_resolve_index_response, indices_resolve_index1_response]),
};

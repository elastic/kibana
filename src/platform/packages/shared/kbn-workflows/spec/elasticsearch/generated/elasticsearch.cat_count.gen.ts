 ...
 *
 * Source: elasticsearch-specification repository, operations: cat-count, cat-count-1, cat-count-2, cat-count-3
 *
...
NOTE: Starting in Elasticsearch 9.3.0, this endpoint also supports the \`POST\` method. This is primarily intended for project routing in serverless environments.
 ...
 Documentation: https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-cat-count`,
  ...
  paramsSchema: z.union([
    ...
    z.object({
      ...getShapeAt(cat_count2_request, 'body'),
      ...getShapeAt(cat_count2_request, 'path'),
      ...getShapeAt(cat_count2_request, 'query'),
    }),
    z.object({
      ...getShapeAt(cat_count3_request, 'body'),
      ...getShapeAt(cat_count3_request, 'path'),
      ...getShapeAt(cat_count3_request, 'query'),
    }),
  ]),

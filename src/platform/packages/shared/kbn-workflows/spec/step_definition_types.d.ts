...
export declare const StepCategories: StepCategory[];
/**
 ...
 */
export interface BaseStepDefinition<InputSchema extends z.ZodType = z.ZodType, OutputSchema extends z.ZodType = z.ZodType, ConfigSchema extends z.ZodObject = z.ZodObject> {
    /**

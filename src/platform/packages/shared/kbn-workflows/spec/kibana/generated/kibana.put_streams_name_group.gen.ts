 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: put-streams-name-group
 *
...
import { put_streams_name_group_request } from './schemas/kibana_openapi_zod.gen';
...
// export contract
export const PUT_STREAMS_NAME_GROUP_CONTRACT: InternalConnectorContract = {
...
Upserts the group settings of a group stream definition<br/><br/>[Required authorization] Route required privileges: manage_stream.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-put-streams-name-group',
  parameterTypes: {

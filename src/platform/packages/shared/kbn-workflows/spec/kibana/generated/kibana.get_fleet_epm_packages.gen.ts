 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: get-fleet-epm-packages
 *
...
// export contract
export const GET_FLEET_EPM_PACKAGES_CONTRACT: InternalConnectorContract = {
  type: 'kibana.get-fleet-epm-packages',
...
[Required authorization] Route required privileges: integrations-read OR fleet-setup OR fleet-all.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get-fleet-epm-packages',
  parameterTypes: {
    headerParams: [],
    pathParams: [],

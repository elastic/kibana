 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: put-fleet-agent-download-sources-sourceid
 *
...
// export contract
export const PUT_FLEET_AGENT_DOWNLOAD_SOURCES_SOURCEID_CONTRACT: InternalConnectorContract = {
...
Update an agent binary download source by ID.<br/><br/>[Required authorization] Route required privileges: fleet-settings-all.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-put-fleet-agent-download-sources-sourceid',
  parameterTypes: {

 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: get-fleet-settings
 *
...
// export contract
export const GET_FLEET_SETTINGS_CONTRACT: InternalConnectorContract = {
  type: 'kibana.get-fleet-settings',
...
[Required authorization] Route required privileges: fleet-settings-read.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get-fleet-settings',
  parameterTypes: {
    headerParams: [],
    pathParams: [],
    urlParams: [],

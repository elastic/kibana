 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: get-fleet-agents-tags
 *
...
// export contract
export const GET_FLEET_AGENTS_TAGS_CONTRACT: InternalConnectorContract = {
...
[Required authorization] Route required privileges: fleet-agents-read.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get-fleet-agents-tags',
  parameterTypes: {
    headerParams: [],
    pathParams: [],

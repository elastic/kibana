 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: get-maintenance-window-id
 *
...
// export contract
export const GET_MAINTENANCE_WINDOW_ID_CONTRACT: InternalConnectorContract = {
...
[Required authorization] Route required privileges: read-maintenance-window.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get-maintenance-window-id',
  parameterTypes: {
    headerParams: [],
    pathParams: ['id'],
    urlParams: [],

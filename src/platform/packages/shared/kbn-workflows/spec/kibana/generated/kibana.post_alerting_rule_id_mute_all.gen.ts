 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: post-alerting-rule-id-mute-all
 *
...
import { post_alerting_rule_id_mute_all_request } from './schemas/kibana_openapi_zod.gen';
...
// export contract
export const POST_ALERTING_RULE_ID_MUTE_ALL_CONTRACT: InternalConnectorContract = {
...
Refer to [Spaces](https://www.elastic.co/docs/deploy-manage/manage-spaces) for more information.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-post-alerting-rule-id-mute-all',
  parameterTypes: {

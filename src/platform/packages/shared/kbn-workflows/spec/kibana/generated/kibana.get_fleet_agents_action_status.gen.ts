 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: get-fleet-agents-action-status
 *
...
// export contract
export const GET_FLEET_AGENTS_ACTION_STATUS_CONTRACT: InternalConnectorContract = {
...
[Required authorization] Route required privileges: fleet-agents-read.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get-fleet-agents-action-status',
  parameterTypes: {
    headerParams: [],
    pathParams: [],

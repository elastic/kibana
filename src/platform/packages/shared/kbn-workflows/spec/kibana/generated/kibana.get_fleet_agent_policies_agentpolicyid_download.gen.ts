 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: get-fleet-agent-policies-agentpolicyid-download
 *
...
// export contract
export const GET_FLEET_AGENT_POLICIES_AGENTPOLICYID_DOWNLOAD_CONTRACT: InternalConnectorContract = {
...
Download an agent policy by ID.<br/><br/>[Required authorization] Route required privileges: fleet-agent-policies-read OR fleet-setup.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get-fleet-agent-policies-agentpolicyid-download',
  parameterTypes: {
    headerParams: [],

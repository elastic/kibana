 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: get-fleet-agents-files-fileid-filename
 *
...
// export contract
export const GET_FLEET_AGENTS_FILES_FILEID_FILENAME_CONTRACT: InternalConnectorContract = {
...
Get a file uploaded by an agent.<br/><br/>[Required authorization] Route required privileges: fleet-agents-read.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get-fleet-agents-files-fileid-filename',
  parameterTypes: {
    headerParams: [],

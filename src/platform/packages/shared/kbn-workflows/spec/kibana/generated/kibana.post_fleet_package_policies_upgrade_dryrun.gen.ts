 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: post-fleet-package-policies-upgrade-dryrun
 *
...
// export contract
export const POST_FLEET_PACKAGE_POLICIES_UPGRADE_DRYRUN_CONTRACT: InternalConnectorContract = {
...
[Required authorization] Route required privileges: fleet-agent-policies-read AND integrations-read.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-post-fleet-package-policies-upgrade-dryrun',
  parameterTypes: {

 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: get-fleet-kubernetes-download
 *
...
// export contract
export const GET_FLEET_KUBERNETES_DOWNLOAD_CONTRACT: InternalConnectorContract = {
...
[Required authorization] Route required privileges: fleet-agent-policies-read OR fleet-setup.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get-fleet-kubernetes-download',
  parameterTypes: {
    headerParams: [],
    pathParams: [],

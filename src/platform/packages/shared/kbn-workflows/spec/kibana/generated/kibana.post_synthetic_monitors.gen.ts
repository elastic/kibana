 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: post-synthetic-monitors
 *
...
import { post_synthetic_monitors_request } from './schemas/kibana_openapi_zod.gen';
...
// export contract
export const POST_SYNTHETIC_MONITORS_CONTRACT: InternalConnectorContract = {
...
`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-post-synthetic-monitors',
  parameterTypes: {
    headerParams: [],
    pathParams: [],
    urlParams: [],

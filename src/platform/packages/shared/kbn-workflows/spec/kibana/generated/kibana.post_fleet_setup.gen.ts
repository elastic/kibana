 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: post-fleet-setup
 *
...
// export contract
export const POST_FLEET_SETUP_CONTRACT: InternalConnectorContract = {
...
[Required authorization] Route required privileges: fleet-agents-read OR fleet-agent-policies-read OR fleet-settings-read OR fleet-setup.`,
  ...
  documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-post-fleet-setup',
  parameterTypes: {

 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: get-fleet-space-settings
 *
...
// export contract
export const GET_FLEET_SPACE_SETTINGS_CONTRACT: InternalConnectorContract = {
...
Refer to [Spaces](https://www.elastic.co/docs/deploy-manage/manage-spaces) for more information.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get-fleet-space-settings',
  parameterTypes: {
    headerParams: [],
    pathParams: [],
    urlParams: [],

 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: get-actions-connector-types
 *
...
// export contract
export const GET_ACTIONS_CONNECTOR_TYPES_CONTRACT: InternalConnectorContract = {
...
You do not need any Kibana feature privileges to run this API.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get-actions-connector-types',
  parameterTypes: {
    headerParams: [],
    pathParams: [],

 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: get-fleet-agent-download-sources
 *
...
// export contract
export const GET_FLEET_AGENT_DOWNLOAD_SOURCES_CONTRACT: InternalConnectorContract = {
...
[Required authorization] Route required privileges: fleet-agent-policies-read OR fleet-settings-read.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get-fleet-agent-download-sources',
  parameterTypes: {
    headerParams: [],
    pathParams: [],
    urlParams: [],

 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: ReadAlertsMigrationStatus
 *
...
Retrieve indices that contain detection alerts of a particular age, along with migration information for each of those indices.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-readalertsmigrationstatus',
  parameterTypes: {
    headerParams: [],
    pathParams: [],
    urlParams: ['from'],

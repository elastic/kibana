 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: get-fleet-epm-data-streams
 *
...
// export contract
export const GET_FLEET_EPM_DATA_STREAMS_CONTRACT: InternalConnectorContract = {
...
[Required authorization] Route required privileges: integrations-read OR fleet-setup OR fleet-all.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get-fleet-epm-data-streams',
  parameterTypes: {
    headerParams: [],
    pathParams: [],

 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: get-fleet-fleet-server-hosts
 *
...
// export contract
export const GET_FLEET_FLEET_SERVER_HOSTS_CONTRACT: InternalConnectorContract = {
...
[Required authorization] Route required privileges: fleet-agents-all OR fleet-settings-read.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get-fleet-fleet-server-hosts',
  parameterTypes: {
    headerParams: [],
    pathParams: [],
    urlParams: [],

 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: get-fleet-cloud-connectors
 *
...
// export contract
export const GET_FLEET_CLOUD_CONNECTORS_CONTRACT: InternalConnectorContract = {
...
[Required authorization] Route required privileges: fleet-agent-policies-read OR integrations-read.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get-fleet-cloud-connectors',
  parameterTypes: {
    headerParams: [],
    pathParams: [],

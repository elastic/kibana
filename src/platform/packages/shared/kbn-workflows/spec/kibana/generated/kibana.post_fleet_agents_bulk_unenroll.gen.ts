 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: post-fleet-agents-bulk-unenroll
 *
...
// export contract
export const POST_FLEET_AGENTS_BULK_UNENROLL_CONTRACT: InternalConnectorContract = {
...
[Required authorization] Route required privileges: fleet-agents-all.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-post-fleet-agents-bulk-unenroll',
  parameterTypes: {

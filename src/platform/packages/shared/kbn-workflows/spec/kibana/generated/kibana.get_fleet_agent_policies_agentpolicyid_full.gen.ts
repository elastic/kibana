 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: get-fleet-agent-policies-agentpolicyid-full
 *
...
// export contract
export const GET_FLEET_AGENT_POLICIES_AGENTPOLICYID_FULL_CONTRACT: InternalConnectorContract = {
...
Get a full agent policy by ID.<br/><br/>[Required authorization] Route required privileges: fleet-agent-policies-read.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get-fleet-agent-policies-agentpolicyid-full',
  parameterTypes: {
    headerParams: [],

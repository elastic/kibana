 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: put-agent-builder-agents-id
 *
...
import { put_agent_builder_agents_id_request } from './schemas/kibana_openapi_zod.gen';
...
// export contract
export const PUT_AGENT_BUILDER_AGENTS_ID_CONTRACT: InternalConnectorContract = {

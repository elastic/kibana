 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: get-fleet-agents-available-versions
 *
...
// export contract
export const GET_FLEET_AGENTS_AVAILABLE_VERSIONS_CONTRACT: InternalConnectorContract = {
...
[Required authorization] Route required privileges: fleet-agents-read.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get-fleet-agents-available-versions',
  parameterTypes: {
    headerParams: [],
    pathParams: [],
    urlParams: [],

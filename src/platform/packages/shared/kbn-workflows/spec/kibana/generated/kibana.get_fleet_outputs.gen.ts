 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: get-fleet-outputs
 *
...
// export contract
export const GET_FLEET_OUTPUTS_CONTRACT: InternalConnectorContract = {
  type: 'kibana.get-fleet-outputs',
  summary: `Get outputs`,
...
[Required authorization] Route required privileges: fleet-settings-read OR fleet-agent-policies-read.`,
  ...
  documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get-fleet-outputs',
  parameterTypes: {
    headerParams: [],
    pathParams: [],
    urlParams: [],

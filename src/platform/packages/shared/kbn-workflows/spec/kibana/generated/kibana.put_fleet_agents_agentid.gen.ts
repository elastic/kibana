 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: put-fleet-agents-agentid
 *
...
// export contract
export const PUT_FLEET_AGENTS_AGENTID_CONTRACT: InternalConnectorContract = {
...
Update an agent by ID.<br/><br/>[Required authorization] Route required privileges: fleet-agents-all.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-put-fleet-agents-agentid',
  parameterTypes: {

 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: get-actions-connector-id
 *
...
// export contract
export const GET_ACTIONS_CONNECTOR_ID_CONTRACT: InternalConnectorContract = {
...
Refer to [Spaces](https://www.elastic.co/docs/deploy-manage/manage-spaces) for more information.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get-actions-connector-id',
  parameterTypes: {
    headerParams: [],
    pathParams: ['id'],
    urlParams: [],

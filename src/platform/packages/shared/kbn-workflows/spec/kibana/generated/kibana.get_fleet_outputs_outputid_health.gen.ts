 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: get-fleet-outputs-outputid-health
 *
...
// export contract
export const GET_FLEET_OUTPUTS_OUTPUTID_HEALTH_CONTRACT: InternalConnectorContract = {
...
[Required authorization] Route required privileges: fleet-settings-read.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get-fleet-outputs-outputid-health',
  parameterTypes: {
    headerParams: [],
    pathParams: ['outputId'],
    urlParams: [],

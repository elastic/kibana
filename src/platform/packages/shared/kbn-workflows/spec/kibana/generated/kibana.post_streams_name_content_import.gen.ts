 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: post-streams-name-content-import
 *
...
import { post_streams_name_content_import_request } from './schemas/kibana_openapi_zod.gen';
...
// export contract
export const POST_STREAMS_NAME_CONTENT_IMPORT_CONTRACT: InternalConnectorContract = {
...
Links content objects to a stream.<br/><br/>[Required authorization] Route required privileges: manage_stream.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-post-streams-name-content-import',
  parameterTypes: {

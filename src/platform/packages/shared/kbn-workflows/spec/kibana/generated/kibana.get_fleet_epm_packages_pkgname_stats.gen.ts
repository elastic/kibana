 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: get-fleet-epm-packages-pkgname-stats
 *
...
// export contract
export const GET_FLEET_EPM_PACKAGES_PKGNAME_STATS_CONTRACT: InternalConnectorContract = {
...
[Required authorization] Route required privileges: integrations-read OR fleet-setup OR fleet-all.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get-fleet-epm-packages-pkgname-stats',
  parameterTypes: {
    headerParams: [],
    pathParams: ['pkgName'],
    urlParams: [],

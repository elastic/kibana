 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: get-fleet-epm-packages-bulk-rollback-taskid
 *
...
// export contract
export const GET_FLEET_EPM_PACKAGES_BULK_ROLLBACK_TASKID_CONTRACT: InternalConnectorContract = {
...
[Required authorization] Route required privileges: integrations-all AND fleet-agent-policies-all.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get-fleet-epm-packages-bulk-rollback-taskid',
  parameterTypes: {
    headerParams: [],
    pathParams: ['taskId'],
    urlParams: [],

 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: get-parameter
 *
...
import { get_parameter_request, get_parameter_response } from './schemas/kibana_openapi_zod.gen';
...
// export contract
export const GET_PARAMETER_CONTRACT: InternalConnectorContract = {
...
`,
  ...
  documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get-parameter',
  parameterTypes: {
    headerParams: [],
    pathParams: ['id'],
    urlParams: [],

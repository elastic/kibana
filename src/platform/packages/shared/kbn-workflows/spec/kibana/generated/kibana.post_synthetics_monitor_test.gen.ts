 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: post-synthetics-monitor-test
 *
...
// export contract
export const POST_SYNTHETICS_MONITOR_TEST_CONTRACT: InternalConnectorContract = {
...
`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-post-synthetics-monitor-test',
  parameterTypes: {
    headerParams: [],

 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: get-fleet-outputs-outputid
 *
...
// export contract
export const GET_FLEET_OUTPUTS_OUTPUTID_CONTRACT: InternalConnectorContract = {
...
Get output by ID.<br/><br/>[Required authorization] Route required privileges: fleet-settings-read OR fleet-agent-policies-read.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get-fleet-outputs-outputid',
  parameterTypes: {
    headerParams: [],
    pathParams: ['outputId'],
    urlParams: [],

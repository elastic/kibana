 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: post-streams-resync
 *
...
import { post_streams_resync_request } from './schemas/kibana_openapi_zod.gen';
...
// export contract
export const POST_STREAMS_RESYNC_CONTRACT: InternalConnectorContract = {
...
Resyncs all streams, making sure that Elasticsearch assets are up to date<br/><br/>[Required authorization] Route required privileges: manage_stream.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-post-streams-resync',
  parameterTypes: {

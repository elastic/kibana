 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: post-fleet-agent-download-sources
 *
...
// export contract
export const POST_FLEET_AGENT_DOWNLOAD_SOURCES_CONTRACT: InternalConnectorContract = {
...
[Required authorization] Route required privileges: fleet-settings-all.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-post-fleet-agent-download-sources',
  parameterTypes: {

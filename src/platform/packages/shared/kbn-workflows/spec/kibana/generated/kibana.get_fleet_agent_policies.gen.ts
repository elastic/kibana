 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: get-fleet-agent-policies
 *
...
// export contract
export const GET_FLEET_AGENT_POLICIES_CONTRACT: InternalConnectorContract = {
  type: 'kibana.get-fleet-agent-policies',
...
[Required authorization] Route required privileges: fleet-agent-policies-read OR fleet-agents-read OR fleet-setup.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get-fleet-agent-policies',
  parameterTypes: {
    headerParams: [],
    pathParams: [],
    urlParams: [

 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: get-fleet-agents-agentid
 *
...
// export contract
export const GET_FLEET_AGENTS_AGENTID_CONTRACT: InternalConnectorContract = {
...
Get an agent by ID.<br/><br/>[Required authorization] Route required privileges: fleet-agents-read.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get-fleet-agents-agentid',
  parameterTypes: {
    headerParams: [],
    pathParams: ['agentId'],

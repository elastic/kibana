 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: post-fleet-agents-bulk-migrate
 *
...
// export contract
export const POST_FLEET_AGENTS_BULK_MIGRATE_CONTRACT: InternalConnectorContract = {
...
Bulk migrate agents to another cluster.<br/><br/>[Required authorization] Route required privileges: fleet-agents-all.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-post-fleet-agents-bulk-migrate',
  parameterTypes: {

 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: get-fleet-proxies
 *
...
// export contract
export const GET_FLEET_PROXIES_CONTRACT: InternalConnectorContract = {
...
[Required authorization] Route required privileges: fleet-settings-read.`,
  ...
  documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get-fleet-proxies',
  parameterTypes: {
    headerParams: [],
    pathParams: [],
    urlParams: [],

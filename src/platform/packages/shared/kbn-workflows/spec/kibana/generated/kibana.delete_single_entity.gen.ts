 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: DeleteSingleEntity
 *
...
// export contract
export const DELETE_SINGLE_ENTITY_CONTRACT: InternalConnectorContract = {
...
`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-deletesingleentity',
  parameterTypes: {
    headerParams: [],

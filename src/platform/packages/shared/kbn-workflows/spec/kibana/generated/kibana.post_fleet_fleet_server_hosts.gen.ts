 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: post-fleet-fleet-server-hosts
 *
...
// export contract
export const POST_FLEET_FLEET_SERVER_HOSTS_CONTRACT: InternalConnectorContract = {
...
[Required authorization] Route required privileges: fleet-settings-all.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-post-fleet-fleet-server-hosts',
  parameterTypes: {

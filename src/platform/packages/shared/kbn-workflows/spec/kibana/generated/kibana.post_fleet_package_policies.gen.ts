 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: post-fleet-package-policies
 *
...
// export contract
export const POST_FLEET_PACKAGE_POLICIES_CONTRACT: InternalConnectorContract = {
...
Refer to [Spaces](https://www.elastic.co/docs/deploy-manage/manage-spaces) for more information.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-post-fleet-package-policies',
  parameterTypes: {

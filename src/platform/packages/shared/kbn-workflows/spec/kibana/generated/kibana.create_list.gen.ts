 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: CreateList
 *
...
import { create_list_request, create_list_response } from './schemas/kibana_openapi_zod.gen';
...
Create a new value list.`,
  ...
  parameterTypes: {
    ...
    pathParams: [],
    urlParams: [],
    bodyParams: ['description', 'id', 'meta', 'name', 'type', 'version'],
  },

 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: post-fleet-agents-agentid-actions
 *
...
// export contract
export const POST_FLEET_AGENTS_AGENTID_ACTIONS_CONTRACT: InternalConnectorContract = {
...
[Required authorization] Route required privileges: fleet-agents-all.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-post-fleet-agents-agentid-actions',
  parameterTypes: {

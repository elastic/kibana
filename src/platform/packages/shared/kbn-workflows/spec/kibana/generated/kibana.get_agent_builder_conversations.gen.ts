 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: get-agent-builder-conversations
 *
...
import { get_agent_builder_conversations_request } from './schemas/kibana_openapi_zod.gen';
...
// export contract
export const GET_AGENT_BUILDER_CONVERSATIONS_CONTRACT: InternalConnectorContract = {
...
List all conversations for a user. Use the optional agent ID to filter conversations by a specific agent.<br/><br/>[Required authorization] Route required privileges: read_onechat.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get-agent-builder-conversations',
  parameterTypes: {
    headerParams: [],
    pathParams: [],
    urlParams: ['agent_id'],

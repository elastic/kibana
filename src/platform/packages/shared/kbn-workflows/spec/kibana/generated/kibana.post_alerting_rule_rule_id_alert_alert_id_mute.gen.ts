 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: post-alerting-rule-rule-id-alert-alert-id-mute
 *
...
import { post_alerting_rule_rule_id_alert_alert_id_mute_request } from './schemas/kibana_openapi_zod.gen';
...
// export contract
export const POST_ALERTING_RULE_RULE_ID_ALERT_ALERT_ID_MUTE_CONTRACT: InternalConnectorContract = {
...
Refer to [Spaces](https://www.elastic.co/docs/deploy-manage/manage-spaces) for more information.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-post-alerting-rule-rule-id-alert-alert-id-mute',
  parameterTypes: {
    headerParams: ['kbn-xsrf'],
    pathParams: ['rule_id', 'alert_id'],
    urlParams: ['validate_alerts_existence'],
    bodyParams: [],
  },

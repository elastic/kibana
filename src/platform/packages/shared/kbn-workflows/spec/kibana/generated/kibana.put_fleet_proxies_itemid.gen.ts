 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: put-fleet-proxies-itemid
 *
...
// export contract
export const PUT_FLEET_PROXIES_ITEMID_CONTRACT: InternalConnectorContract = {
...
Update a proxy by ID.<br/><br/>[Required authorization] Route required privileges: fleet-settings-all.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-put-fleet-proxies-itemid',
  parameterTypes: {

 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: post-streams-name-fork
 *
...
import { post_streams_name_fork_request } from './schemas/kibana_openapi_zod.gen';
...
// export contract
export const POST_STREAMS_NAME_FORK_CONTRACT: InternalConnectorContract = {
  type: 'kibana.post-streams-name-fork',
...
Forks a wired stream and creates a child stream<br/><br/>[Required authorization] Route required privileges: manage_stream.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-post-streams-name-fork',

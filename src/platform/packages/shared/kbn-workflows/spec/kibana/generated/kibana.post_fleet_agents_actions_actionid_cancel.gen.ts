 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: post-fleet-agents-actions-actionid-cancel
 *
...
// export contract
export const POST_FLEET_AGENTS_ACTIONS_ACTIONID_CANCEL_CONTRACT: InternalConnectorContract = {
...
[Required authorization] Route required privileges: fleet-agents-all.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-post-fleet-agents-actions-actionid-cancel',
  parameterTypes: {

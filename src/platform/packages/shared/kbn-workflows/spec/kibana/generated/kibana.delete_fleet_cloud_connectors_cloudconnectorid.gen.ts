 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: delete-fleet-cloud-connectors-cloudconnectorid
 *
...
// export contract
export const DELETE_FLEET_CLOUD_CONNECTORS_CLOUDCONNECTORID_CONTRACT: InternalConnectorContract = {
...
[Required authorization] Route required privileges: fleet-agent-policies-all OR integrations-all.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-delete-fleet-cloud-connectors-cloudconnectorid',
  parameterTypes: {

 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: delete-agent-builder-agents-id
 *
...
import { delete_agent_builder_agents_id_request } from './schemas/kibana_openapi_zod.gen';
...
// export contract
export const DELETE_AGENT_BUILDER_AGENTS_ID_CONTRACT: InternalConnectorContract = {
...
Delete an agent by ID. This action cannot be undone.<br/><br/>[Required authorization] Route required privileges: manage_onechat.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-delete-agent-builder-agents-id',
  parameterTypes: {

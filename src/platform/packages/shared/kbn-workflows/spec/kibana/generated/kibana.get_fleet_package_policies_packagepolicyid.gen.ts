 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: get-fleet-package-policies-packagepolicyid
 *
...
// export contract
export const GET_FLEET_PACKAGE_POLICIES_PACKAGEPOLICYID_CONTRACT: InternalConnectorContract = {
...
Get a package policy by ID.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get-fleet-package-policies-packagepolicyid',
  parameterTypes: {
    headerParams: [],

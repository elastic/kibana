 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: post-fleet-service-tokens
 *
...
// export contract
export const POST_FLEET_SERVICE_TOKENS_CONTRACT: InternalConnectorContract = {
...
[Required authorization] Route required privileges: fleet-agents-all.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-post-fleet-service-tokens',
  parameterTypes: {

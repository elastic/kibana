 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: post-fleet-health-check
 *
...
// export contract
export const POST_FLEET_HEALTH_CHECK_CONTRACT: InternalConnectorContract = {
...
[Required authorization] Route required privileges: fleet-settings-all.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-post-fleet-health-check',
  parameterTypes: {

 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: get-fleet-data-streams
 *
...
// export contract
export const GET_FLEET_DATA_STREAMS_CONTRACT: InternalConnectorContract = {
...
[Required authorization] Route required privileges: fleet-agents-all AND fleet-agent-policies-all AND fleet-settings-all.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get-fleet-data-streams',
  parameterTypes: {
    headerParams: [],
    pathParams: [],
    urlParams: [],

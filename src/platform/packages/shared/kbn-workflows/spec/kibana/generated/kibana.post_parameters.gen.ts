 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: post-parameters
 *
...
// export contract
export const POST_PARAMETERS_CONTRACT: InternalConnectorContract = {
...
`,
  ...
  documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-post-parameters',
  parameterTypes: {
    headerParams: [],
    pathParams: [],
    urlParams: [],

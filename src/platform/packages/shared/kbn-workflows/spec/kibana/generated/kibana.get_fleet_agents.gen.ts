 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: get-fleet-agents
 *
...
// export contract
export const GET_FLEET_AGENTS_CONTRACT: InternalConnectorContract = {
  type: 'kibana.get-fleet-agents',
  summary: `Get agents`,
...
[Required authorization] Route required privileges: fleet-agents-read.`,
  ...
  documentation: 'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get-fleet-agents',
  parameterTypes: {
    headerParams: [],
    pathParams: [],
    urlParams: [

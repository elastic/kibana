 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: get-fleet-remote-synced-integrations-status
 *
...
// export contract
export const GET_FLEET_REMOTE_SYNCED_INTEGRATIONS_STATUS_CONTRACT: InternalConnectorContract = {
...
[Required authorization] Route required privileges: fleet-settings-read AND integrations-read.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get-fleet-remote-synced-integrations-status',
  parameterTypes: {
    headerParams: [],
    pathParams: [],
    urlParams: [],

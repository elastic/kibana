 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: post-fleet-agentless-policies
 *
...
// export contract
export const POST_FLEET_AGENTLESS_POLICIES_CONTRACT: InternalConnectorContract = {
...
Create an agentless policy`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-post-fleet-agentless-policies',
  parameterTypes: {

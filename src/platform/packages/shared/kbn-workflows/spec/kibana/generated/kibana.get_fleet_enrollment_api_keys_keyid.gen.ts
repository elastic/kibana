 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: get-fleet-enrollment-api-keys-keyid
 *
...
// export contract
export const GET_FLEET_ENROLLMENT_API_KEYS_KEYID_CONTRACT: InternalConnectorContract = {
...
Get an enrollment API key by ID.<br/><br/>[Required authorization] Route required privileges: fleet-agents-all OR fleet-setup.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get-fleet-enrollment-api-keys-keyid',
  parameterTypes: {
    headerParams: [],
    pathParams: ['keyId'],
    urlParams: [],

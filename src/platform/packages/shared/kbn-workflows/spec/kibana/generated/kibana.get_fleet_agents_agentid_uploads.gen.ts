 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: get-fleet-agents-agentid-uploads
 *
...
// export contract
export const GET_FLEET_AGENTS_AGENTID_UPLOADS_CONTRACT: InternalConnectorContract = {
...
[Required authorization] Route required privileges: fleet-agents-read.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get-fleet-agents-agentid-uploads',
  parameterTypes: {
    headerParams: [],
    pathParams: ['agentId'],
    urlParams: [],

 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: get-streams-streamname-attachments
 *
...
export const GET_STREAMS_STREAMNAME_ATTACHMENTS_CONTRACT: InternalConnectorContract = {
  type: 'kibana.get-streams-streamname-attachments',
...
Fetches all attachments linked to a stream that are visible to the current user in the current space. Optionally filter by attachment types, search query, and tags.<br/><br/>[Required authorization] Route required privileges: read_stream.`,
  ...
  parameterTypes: {
    ...
    urlParams: ['query', 'attachmentTypes', 'tags'],
    bodyParams: [],
  },

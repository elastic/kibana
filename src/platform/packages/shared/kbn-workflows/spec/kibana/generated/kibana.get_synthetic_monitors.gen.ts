 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: get-synthetic-monitors
 *
...
// export contract
export const GET_SYNTHETIC_MONITORS_CONTRACT: InternalConnectorContract = {
...
`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-get-synthetic-monitors',
  parameterTypes: {
    headerParams: [],
    pathParams: [],
    urlParams: [

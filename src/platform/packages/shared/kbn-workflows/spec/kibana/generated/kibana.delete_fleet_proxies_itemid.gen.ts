 ...
 *
 * Source: /oas_docs/output/kibana.yaml, operations: delete-fleet-proxies-itemid
 *
...
// export contract
export const DELETE_FLEET_PROXIES_ITEMID_CONTRACT: InternalConnectorContract = {
...
Delete a proxy by ID<br/><br/>[Required authorization] Route required privileges: fleet-settings-all.`,
  ...
  documentation:
    'https://www.elastic.co/docs/api/doc/kibana/operation/operation-delete-fleet-proxies-itemid',
  parameterTypes: {

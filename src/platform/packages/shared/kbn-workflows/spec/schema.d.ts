...
export declare const BuiltInStepTypes: ("wait" | "merge" | "switch" | "if" | "while" | "foreach" | "waitForInput" | "data.set" | "parallel" | "loop.break" | "loop.continue" | "workflow.execute" | "workflow.executeAsync" | "workflow.output" | "workflow.fail")[];

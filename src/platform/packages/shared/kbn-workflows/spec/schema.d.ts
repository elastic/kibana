...
export declare const BuiltInStepTypes: ("if" | "merge" | "switch" | "wait" | "foreach" | "while" | "waitForInput" | "data.set" | "parallel" | "workflow.execute" | "workflow.executeAsync" | "workflow.output" | "workflow.fail" | "loop.break" | "loop.continue")[];

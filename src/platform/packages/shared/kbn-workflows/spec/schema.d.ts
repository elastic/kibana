...
export declare const BuiltInStepTypes: ("switch" | "if" | "merge" | "wait" | "foreach" | "data.set" | "while" | "parallel" | "loop.break" | "loop.continue" | "workflow.execute" | "workflow.executeAsync" | "workflow.output" | "workflow.fail")[];

...
export declare const BuiltInStepTypes: ("foreach" | "if" | "while" | "switch" | "wait" | "waitForInput" | "data.set" | "parallel" | "merge" | "workflow.execute" | "workflow.executeAsync" | "workflow.output" | "workflow.fail" | "loop.break" | "loop.continue")[];

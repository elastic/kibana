...
type ManagedWorkflowValuesOption<TId extends ManagedWorkflowId> = ManagedWorkflowTemplateValuesForId<TId> extends never ? {
    values?: never;
} : {
    values?: ManagedWorkflowTemplateValuesForId<TId>;
};
export type ManagedWorkflowOperationOptions<TId extends ManagedWorkflowId = ManagedWorkflowId> = ManagedWorkflowOperationBaseOptions & ManagedWorkflowValuesOption<TId>;
export type ExecuteManagedWorkflowOptions<TId extends ManagedWorkflowId = ManagedWorkflowId> = Omit<ManagedWorkflowOperationOptions<TId>, 'values'> & {
...
export interface RegisteredManagedWorkflowsLifecycleApi {
    install: <TId extends ManagedWorkflowId>(id: TId, options: ManagedWorkflowOperationOptions<TId>) => Promise<void>;
    uninstall: <TId extends ManagedWorkflowId>(id: TId, options: ManagedWorkflowOperationOptions<TId>) => Promise<void>;
    /**
...
export interface RegisteredManagedWorkflowsApi extends RegisteredManagedWorkflowsLifecycleApi {
    execute: <TId extends ManagedWorkflowId>(id: TId, options: ExecuteManagedWorkflowOptions<TId>) => Promise<string>;
}
/**
 * Request-scoped workflows client API; pluginId is supplied by workflows_extensions.
 */
export interface ManagedWorkflowsApi {
    install: <TId extends ManagedWorkflowId>(pluginId: string, id: TId, options: ManagedWorkflowOperationOptions<TId>) => Promise<void>;
    uninstall: <TId extends ManagedWorkflowId>(pluginId: string, id: TId, options: ManagedWorkflowOperationOptions<TId>) => Promise<void>;
    execute: <TId extends ManagedWorkflowId>(pluginId: string, id: TId, options: ExecuteManagedWorkflowOptions<TId>) => Promise<string>;
}
/**
...
export interface PluginScopedManagedWorkflowsApi extends RegisteredManagedWorkflowsLifecycleApi {
    execute: <TId extends ManagedWorkflowId>(request: KibanaRequest, id: TId, options: ExecuteManagedWorkflowOptions<TId>) => Promise<string>;
}
/**
...
export type ManagedWorkflowsSystemApiProvider = (pluginId: string) => Promise<RegisteredManagedWorkflowsLifecycleApi>;
export {};

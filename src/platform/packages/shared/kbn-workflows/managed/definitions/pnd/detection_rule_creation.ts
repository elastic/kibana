...
export const PND_WORKER_DETECTION_RULE_CREATION_WORKFLOW_ID =
  'system-security-detection-rule-creation';

export const PND_WORKER_DETECTION_RULE_CREATION_WORKFLOW = {
  billable: false,
  id: PND_WORKER_DETECTION_RULE_CREATION_WORKFLOW_ID,

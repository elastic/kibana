...
import { DASHBOARD_KNOWLEDGE_INDICATORS_WORKFLOW } from './dashboard_knowledge_indicators';
import {
...
export {
  DASHBOARD_KNOWLEDGE_INDICATORS_WORKFLOW,
  DASHBOARD_KNOWLEDGE_INDICATORS_WORKFLOW_ID,
} from './dashboard_knowledge_indicators';
export {

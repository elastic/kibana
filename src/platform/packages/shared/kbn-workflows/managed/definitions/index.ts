...
import { NIGHTSHIFT_AUTOMATION_FLOOR_WORKFLOW } from './nightshift_investigations/watch_floor';
...
export {
  NIGHTSHIFT_AUTOMATION_FLOOR_WORKFLOW_ID,
} from './nightshift_investigations/watch_floor';
...
export const managedWorkflowDefinitions = [
  ...
  SIGNIFICANT_EVENTS_INVESTIGATION_COMPLETED_WORKFLOW,
  SIGNIFICANT_EVENTS_ORCHESTRATOR_WORKFLOW,
  NIGHTSHIFT_AUTOMATION_FLOOR_WORKFLOW,

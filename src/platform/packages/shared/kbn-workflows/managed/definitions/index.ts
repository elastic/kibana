...
import { SML_DASHBOARD_INGESTION_WORKFLOW } from './agent_builder_sml';
...
export { SML_DASHBOARD_INGESTION_WORKFLOW_ID } from './agent_builder_sml';
export {
...
export const managedWorkflowDefinitions = [
  ...
  SML_DASHBOARD_INGESTION_WORKFLOW,
  SECURITY_ALERT_ANALYSIS_WORKFLOW,
  SIGNIFICANT_EVENTS_KI_FEATURES_IDENTIFICATION_WORKFLOW,
  SIGNIFICANT_EVENTS_KI_QUERIES_GENERATION_WORKFLOW,
  SIGNIFICANT_EVENTS_KI_ONBOARDING_WORKFLOW,

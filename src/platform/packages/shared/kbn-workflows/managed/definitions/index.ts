...
import { NIGHTSHIFT_MEMORY_HYDRATE_WORKFLOW } from './nightshift_investigations/memory_hydrate';
import { NIGHTSHIFT_MEMORY_OPTIMIZE_WORKFLOW } from './nightshift_investigations/memory_optimize';
...
export { NIGHTSHIFT_MEMORY_HYDRATE_WORKFLOW_ID } from './nightshift_investigations/memory_hydrate';
export { NIGHTSHIFT_MEMORY_OPTIMIZE_WORKFLOW_ID } from './nightshift_investigations/memory_optimize';
...
export const managedWorkflowDefinitions = [
  ...
  NIGHTSHIFT_MEMORY_HYDRATE_WORKFLOW,
  NIGHTSHIFT_MEMORY_OPTIMIZE_WORKFLOW,

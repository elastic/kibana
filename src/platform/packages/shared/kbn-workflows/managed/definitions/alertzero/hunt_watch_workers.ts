...
export const ALERTZERO_HUNT_EXECUTE_WORKFLOW_ID = 'system-security-hunt-execute';
export const ALERTZERO_HUNT_CORRELATION_WORKFLOW_ID = 'system-security-hunt-correlation';
...
export const ALERTZERO_HUNT_EXECUTE_WORKFLOW = {
  billable: false,
  id: ALERTZERO_HUNT_EXECUTE_WORKFLOW_ID,
...
export const ALERTZERO_HUNT_CORRELATION_WORKFLOW = {
  billable: false,
  id: ALERTZERO_HUNT_CORRELATION_WORKFLOW_ID,
  management: ALERTZERO_RULE_WORKFLOW_MANAGEMENT,
  pluginId: ALERTZERO_MANAGED_WORKFLOW_PLUGIN_ID,
  version: 1,
...
export const ALERTZERO_HUNT_WATCH_WORKER_WORKFLOWS = [
...
export const ALERTZERO_HUNT_WATCH_WORKER_WORKFLOW_IDS = [

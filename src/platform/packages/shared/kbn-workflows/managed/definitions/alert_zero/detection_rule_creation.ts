...
export const ALERT_ZERO_WORKER_DETECTION_RULE_CREATION_WORKFLOW_ID =
  'system-security-detection-rule-creation';

export const ALERT_ZERO_WORKER_DETECTION_RULE_CREATION_WORKFLOW = {
  billable: false,
  id: ALERT_ZERO_WORKER_DETECTION_RULE_CREATION_WORKFLOW_ID,

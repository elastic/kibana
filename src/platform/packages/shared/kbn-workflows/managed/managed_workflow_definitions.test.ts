...
it.each([
  ...
  [ALERTZERO_WORKER_FLOOR_ATTACK_DISCOVERY_WORKFLOW_ID, FLOOR_ATTACK_DISCOVERY_YAML, '5:ceae137f'],
  [
    ALERTZERO_WORKER_FORENSICS_ENDPOINT_ANALYSIS_WORKFLOW_ID,
  ...
  [ALERTZERO_WORKER_DETECTION_RULE_TUNING_WORKFLOW_ID, DETECTION_RULE_TUNING_YAML, '8:f3649616'],
  [
    ALERTZERO_WORKER_DETECTION_RULE_CREATION_WORKFLOW_ID,

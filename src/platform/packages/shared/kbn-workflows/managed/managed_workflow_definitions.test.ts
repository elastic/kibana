...
const RUN_QUOTA_REPRESENTATIVE_VALUES = {
...
const templateRepresentativeValuesById: ManagedWorkflowTemplateValuesById = {
  ...
  // The seven workflows carrying the daily run-quota gate.
  [SIGNIFICANT_EVENTS_DISCOVERY_WORKFLOW_ID]: RUN_QUOTA_REPRESENTATIVE_VALUES,
  [SIGNIFICANT_EVENTS_INVESTIGATION_WORKFLOW_ID]: RUN_QUOTA_REPRESENTATIVE_VALUES,
  [SIGNIFICANT_EVENTS_KI_ONBOARDING_WORKFLOW_ID]: RUN_QUOTA_REPRESENTATIVE_VALUES,
  [SIGNIFICANT_EVENTS_MEMORY_SYNTHESIS_WORKFLOW_ID]: RUN_QUOTA_REPRESENTATIVE_VALUES,
  [SIGNIFICANT_EVENTS_MEMORY_CONSOLIDATION_WORKFLOW_ID]: RUN_QUOTA_REPRESENTATIVE_VALUES,
  [SIGNIFICANT_EVENTS_MEMORY_CONVERSATION_SCRAPER_WORKFLOW_ID]: RUN_QUOTA_REPRESENTATIVE_VALUES,
  [SIGNIFICANT_EVENTS_MEMORY_GAP_DETECTION_WORKFLOW_ID]: RUN_QUOTA_REPRESENTATIVE_VALUES,
};

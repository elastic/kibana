...
export declare function isInProgressStatus(status: ExecutionStatus): status is ExecutionStatus.PENDING | ExecutionStatus.WAITING | ExecutionStatus.WAITING_FOR_INPUT | ExecutionStatus.WAITING_FOR_CHILD | ExecutionStatus.RUNNING;
...
export declare function isCancelableStatus(status: ExecutionStatus): status is ExecutionStatus.PENDING | ExecutionStatus.WAITING | ExecutionStatus.WAITING_FOR_INPUT | ExecutionStatus.WAITING_FOR_CHILD | ExecutionStatus.RUNNING;

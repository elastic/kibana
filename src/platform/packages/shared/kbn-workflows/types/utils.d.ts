import type { ConnectorContractUnion, DynamicConnectorContract, EsWorkflowCreate, HttpMethod, InternalConnectorContract, StabilityLevel, WorkflowStepExecutionDto } from './v1';
...
export declare function isInProgressStatus(status: ExecutionStatus): status is ExecutionStatus.PENDING | ExecutionStatus.WAITING | ExecutionStatus.WAITING_FOR_INPUT | ExecutionStatus.WAITING_FOR_CHILD | ExecutionStatus.RUNNING | ExecutionStatus.QUEUED;

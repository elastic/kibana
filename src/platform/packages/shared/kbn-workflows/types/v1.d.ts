...
import type { SerializedError, WorkflowStepTokenUsageSchema, WorkflowTokenUsageSchema, WorkflowYaml } from '../spec/schema';
...
export declare const ConcurrencySlotOccupyingExecutionStatuses: readonly ExecutionStatus[];
...
export declare const WorkflowExecutionSortFields: readonly ["createdAt", "finishedAt"];
...
export declare const WorkflowExecutionCollapseFields: readonly ["concurrencyGroupKey", "status", "executedBy", "triggeredBy"];
...
export declare const EsWorkflowSchema: z.ZodObject<{
    ...
    billable: z.ZodOptional<z.ZodNullable<z.ZodBoolean>>;
    originManagedWorkflowId: z.ZodOptional<z.ZodNullable<z.ZodString>>;
    managedVersion: z.ZodOptional<z.ZodNullable<z.ZodNumber>>;
    ...
    definition: z.ZodOptional<z.ZodPipe<z.ZodObject<{
        ...
        steps: ({
            ...
            with: {
                request: {
                    method: "POST" | "GET" | "DELETE" | "HEAD" | "PATCH" | "PUT";
                    path: string;
                    body?: any;
                };
            } | ({
        ...
        settings?: {
            ...
            concurrency?: {
                ...
                strategy?: "drop" | "queue" | "cancel-in-progress" | undefined;
                max?: number | undefined;
...
export interface WorkflowExecutionEngineModel extends Pick<EsWorkflow, 'id' | 'name' | 'enabled' | 'definition' | 'yaml' | 'managed' | 'managedBy' | 'billable' | 'originManagedWorkflowId' | 'managedVersion' | 'version'> {
    isTestRun?: boolean;
    isEphemeral?: boolean;
    spaceId?: string;
}

    ...
    definition: z.ZodOptional<z.ZodPipe<z.ZodObject<{
        ...
        settings?: {
            ...
            concurrency?: {
                ...
                strategy?: "cancel-in-progress" | "drop" | undefined;
...
export interface WorkflowExecutionEngineModel extends Pick<EsWorkflow, 'id' | 'name' | 'enabled' | 'definition' | 'yaml' | 'managed' | 'managedBy' | 'originManagedWorkflowId'> {
    isTestRun?: boolean;
    spaceId?: string;
}

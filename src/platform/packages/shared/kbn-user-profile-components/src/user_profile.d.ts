 ...
 */
export declare function getUserAvatarColor(user: Pick<UserProfileUserInfo, 'username' | 'full_name'>, avatar?: UserProfileAvatarData): any;
/**
 ...
 * @param {UserProfileAvatarData} avatar User avatar
 */
export declare function getUserAvatarInitials(user: Pick<UserProfileUserInfo, 'username' | 'full_name'>, avatar?: UserProfileAvatarData): any;
/**

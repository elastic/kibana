...
export declare function ChartConfigPanel({ services, visContext, lensAdapters, dataLoading$, currentSuggestionContext, isFlyoutVisible, setIsFlyoutVisible, isPlainRecord, query, onSuggestionContextEdit, isApproximate, }: {

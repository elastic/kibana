...
export declare const useServicesBootstrap: (props: UseUnifiedHistogramProps, options?: {
    ...
    stateProps: {
        ...
        hits: {
            status: import("..").UnifiedHistogramFetchStatus | undefined;
        ...
        onTotalHitsChange: (newTotalHitsStatus: import("..").UnifiedHistogramFetchStatus, newTotalHitsResult?: number | Error) => void;
        onChartHiddenChange: (newChartHidden: boolean) => void;
        onChartLoad: (event: import("..").UnifiedHistogramChartLoadEvent) => void;

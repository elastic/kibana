...
import type { LensPublicStart, TypedLensByValueInput, LensEmbeddableInput, Suggestion } from '@kbn/lens-plugin/public';
import type { DataViewField, DataViewsPublicPluginStart } from '@kbn/data-views-plugin/public';
import type { RequestAdapter } from '@kbn/inspector-plugin/public';
import type { Datatable, DatatableColumn, DefaultInspectorAdapters } from '@kbn/expressions-plugin/common';
 ...
 */
export declare enum UnifiedHistogramFetchStatus {
...
export declare enum UnifiedHistogramExternalVisContextStatus {
    unknown = "unknown",
    applied = "applied",
...
export declare enum UnifiedHistogramSuggestionType {
...
export declare enum LensVisServiceStatus {
    'initial' = "initial",
    'completed' = "completed"
}
...
export type UnifiedHistogramFetchParams = Omit<UnifiedHistogramFetchParamsExternal, 'breakdownField' | 'timeInterval'> & {
    query: Query | AggregateQuery;
    filters: Filter[];
    timeRange: TimeRange;
    relativeTimeRange: TimeRange;

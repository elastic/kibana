...
export declare const MlAnomalyDetectionAlertSchema: rt.IntersectionC<[rt.TypeC<{
    'kibana.alert.job_id': rt.StringC;
}>, rt.PartialC<{
    'kibana.alert.anomaly_score': rt.ArrayC<rt.NumberC>;
    'kibana.alert.anomaly_timestamp': rt.UnionC<[rt.Type<string, string, unknown>, rt.NumberC]>;
    'kibana.alert.is_interim': rt.BooleanC;
    'kibana.alert.top_influencers': rt.ArrayC<rt.PartialC<{
        influencer_field_name: rt.StringC;
        influencer_field_value: rt.StringC;
        influencer_score: rt.NumberC;
        initial_influencer_score: rt.NumberC;
        is_interim: rt.BooleanC;
        job_id: rt.StringC;
        timestamp: rt.UnionC<[rt.Type<string, string, unknown>, rt.NumberC]>;
    }>>;
    'kibana.alert.top_records': rt.ArrayC<rt.PartialC<{
        actual: rt.NumberC;
        by_field_name: rt.StringC;
        by_field_value: rt.StringC;
        detector_index: rt.NumberC;
        field_name: rt.StringC;
        function: rt.StringC;
        initial_record_score: rt.NumberC;
        is_interim: rt.BooleanC;
        job_id: rt.StringC;
        over_field_name: rt.StringC;
        over_field_value: rt.StringC;
        partition_field_name: rt.StringC;
        partition_field_value: rt.StringC;
        record_score: rt.NumberC;
        timestamp: rt.UnionC<[rt.Type<string, string, unknown>, rt.NumberC]>;
        typical: rt.NumberC;
    }>>;

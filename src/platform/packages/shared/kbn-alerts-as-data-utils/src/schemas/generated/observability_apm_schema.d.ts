...
export declare const ObservabilityApmAlertSchema: rt.IntersectionC<[rt.TypeC<{}>, rt.PartialC<{
    'agent.name': rt.StringC;
    'anomaly.detector_type': rt.StringC;
    'anomaly.timestamp': rt.UnionC<[rt.Type<string, string, unknown>, rt.NumberC]>;
    'container.id': rt.StringC;
    'error.grouping_key': rt.StringC;
    'error.grouping_name': rt.StringC;
    ...
    labels: rt.UnknownC;
    'processor.event': rt.StringC;
    'service.environment': rt.StringC;
    'service.language.name': rt.StringC;
    'service.name': rt.StringC;
    'transaction.name': rt.StringC;
    'transaction.type': rt.StringC;

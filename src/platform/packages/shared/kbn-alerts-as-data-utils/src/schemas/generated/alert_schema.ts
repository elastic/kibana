...
const AlertOptional = rt.partial({
  ...
  'kibana.alert.snooze_expires_at': schemaDate,
  'kibana.alert.snooze_conditions': schemaUnknown,
  'kibana.alert.snooze_condition_operator': schemaString,
  'kibana.alert.snooze_snapshot': schemaUnknown,

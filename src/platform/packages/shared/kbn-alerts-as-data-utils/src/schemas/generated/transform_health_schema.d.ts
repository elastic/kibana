...
export declare const TransformHealthAlertSchema: rt.IntersectionC<[rt.TypeC<{}>, rt.PartialC<{
    'kibana.alert.results': rt.ArrayC<rt.PartialC<{
        description: rt.StringC;
        health_status: rt.StringC;
        issues: rt.UnknownC;
        node_name: rt.StringC;
        transform_id: rt.StringC;
        transform_state: rt.StringC;
    }>>;

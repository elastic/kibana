...
export type DocViewFilterFn = (mapping: FieldMapping | string | undefined, value: unknown, mode: '+' | '-') => void;
...
export type DocViewRenderFunction<TState extends object = object> = (props: DocViewRenderProps & RestorableStateProviderProps<TState>) => ReactElement;

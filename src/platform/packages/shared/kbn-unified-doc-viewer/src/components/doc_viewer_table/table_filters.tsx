...
import { FieldTypeFilter, type FieldTypeFilterFieldItem } from './field_type_filter';
...
interface TableFiltersCommonProps {
  ...
  onChangeFieldTypes: (fieldTypes: FieldTypeKnown[]) => void;
}

export interface TableFiltersProps extends TableFiltersCommonProps {
  allFields: FieldTypeFilterFieldItem[];

...
import { SHOW_MULTIFIELDS } from '@kbn/discover-utils';
...
const coreStart = {
  docLinks: {
    links: {
      discover: {
        fieldTypeHelp: 'https://example.invalid',
      },
    },
  },
} as unknown as Pick<CoreStart, 'docLinks'>;
const uiSettings = {
  get: jest.fn((key: string, defaultValue?: unknown) => {
    if (key === SHOW_MULTIFIELDS) return true;
    return defaultValue;
  }),

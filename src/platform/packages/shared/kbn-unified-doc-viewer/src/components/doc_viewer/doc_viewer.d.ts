...
} & Pick<import("@kbn/restorable-state").RestorableStateProviderProps<import(".").DocViewerRestorableState>, "initialState" | "onInitialStateChange">, "ref"> & RefAttributes<InternalDocViewerApi & import("@kbn/restorable-state").RestorableStateProviderApi>>;

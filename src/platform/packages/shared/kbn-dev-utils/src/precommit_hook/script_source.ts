...
export const POST_CHECKOUT_SCRIPT_SOURCE = `#!/usr/bin/env bash
#
# ** THIS IS AN AUTO-GENERATED FILE **
# ** PLEASE DO NOT CHANGE IT MANUALLY **
#
...
#
# Delegates to scripts/seed_worktree_caches.sh, which seeds a freshly-created
...
if [ -x "\${POST_CHECKOUT_LOCAL}" ]; then
  "\${POST_CHECKOUT_LOCAL}" "$@" || true
fi

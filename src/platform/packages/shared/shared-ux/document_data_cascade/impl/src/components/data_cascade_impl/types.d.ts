...
import type { CascadeVirtualizerProps, CascadeRootVirtualizerReturnValue } from '../../lib/core/virtualizer';
...
export interface CascadeRowCellPrimitiveProps<G extends GroupNode, L extends LeafNode> extends CellContext<G, unknown> {
    /**
...
export interface CascadeRowActionProps {
    ...
    headerRowActions: Array<Pick<EuiButtonIconProps, 'iconType' | 'aria-label' | 'data-test-subj'> & {
 ...
 */
export interface CascadeRowPrimitiveProps<G extends GroupNode, L extends LeafNode> extends Omit<CascadeRowHeaderPrimitiveProps<G, L>, 'isGroupNode'> {
    /**
...
export type DataCascadeRowCellProps<G extends GroupNode, L extends LeafNode> = Pick<CascadeRowCellPrimitiveProps<G, L>, 'onCascadeLeafNodeExpanded' | 'onCascadeLeafNodeCollapsed' | 'children'>;
export type DataCascadeRowProps<G extends GroupNode, L extends LeafNode> = Pick<CascadeRowPrimitiveProps<G, L>, 'onCascadeGroupNodeExpanded' | 'onCascadeGroupNodeCollapsed' | 'rowHeaderMetaSlots' | 'rowHeaderTitleSlot' | 'rowHeaderActions' | 'enableSecondaryExpansionAction'> & {
    /**
 ...
 * @internal
 */
interface DataCascadeImplBaseProps<G extends GroupNode, L extends LeafNode> extends Pick<CascadeVirtualizerProps<G>, 'overscan'>, Pick<CascadeRowPrimitiveProps<G, L>, 'enableRowSelection'> {
    /**
...
export type DataCascadeImplProps<G extends GroupNode, L extends LeafNode> = DataCascadeImplBaseProps<G, L> & ({

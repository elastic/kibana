...
- x-pack/solutions/observability/test/serverless/functional/test_suites/navigation.ts
- x-pack/solutions/search/test/serverless/functional/test_suites/navigation.ts
- x-pack/solutions/security/test/serverless/functional/test_suites/ftr/navigation.ts

Similarily for stateful you will find smoe tests with setup examples in the following directories:

- x-pack/solutions/observability/test/functional_solution_sidenav/tests
- x-pack/solutions/search/test/functional_solution_sidenav/tests
- x-pack/solutions/security/test/functional_solution_sidenav/tests

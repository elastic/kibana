...
All of the `EuiEmptyPrompt` props are available.  A default `description` and `buttonText` are provided, but can be overridden in specific use cases.
...
| `NoDataCardComponent` | The pure component, a pre-configured **EuiEmptyPrompt**. |
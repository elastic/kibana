...
1. `action: Record<string, NoDataPageActions>`: An object of `NoDataPageActions` configurations with a unique primary key _(required)_
...
- `disabledButtonTooltipText?: string`: Optional custom tooltip text for the disabled action button

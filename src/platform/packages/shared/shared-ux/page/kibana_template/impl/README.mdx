...
1. `docsLink: string`: Required to set the docs link for the whole solution _(required)_
2. `pageTitle?: string`: Optionally replace the auto-generated page title (h1)

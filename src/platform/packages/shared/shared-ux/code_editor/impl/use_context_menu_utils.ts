    ...
    cutAction.current = editor.addAction({
      ...
      run: async (ed) => {
        ...
        try {
          ...
          alert(
            i18n.translate('sharedUXPackages.codeEditor.contextMenuAction.cutActionFailedMessage', {
    ...
    copyAction.current = editor.addAction({
      ...
      run: async (ed) => {
        ...
        try {
          ...
          alert(
            i18n.translate(
              'sharedUXPackages.codeEditor.contextMenuAction.copyActionFailedMessage',
              {
    ...
    pasteAction.current = editor.addAction({
      ...
      run: async (ed) => {
        ...
        try {
          ...
          alert(
            i18n.translate(
              'sharedUXPackages.codeEditor.contextMenuAction.pasteActionFailedMessage',
              {

...
import type { DATE_TYPE_ABSOLUTE, DATE_TYPE_RELATIVE, DATE_TYPE_NOW, MODIFICATION_INCREASE, MODIFICATION_DECREASE } from './constants';
 ...
 */
export type TimeRangeFormatOptions = Omit<TimeRangeTransformOptions, 'inputDateFormats' | 'roundRelativeTime'>;

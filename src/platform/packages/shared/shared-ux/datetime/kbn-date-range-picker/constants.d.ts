...
export declare const NOW_KEYWORD = "now";
/** ArrowUp on a selected part: step its value up. */
export declare const MODIFICATION_INCREASE: 'increase';
/** ArrowDown on a selected part: step its value down. */
export declare const MODIFICATION_DECREASE: 'decrease';
...
export declare const DATE_RANGE_PICKER_FEATURE_FLAG = "unifiedSearch.newDateRangePickerEnabled";
/**
 ...
 */
export declare const CHAINED_DATE_MATH_RE: RegExp;
/**

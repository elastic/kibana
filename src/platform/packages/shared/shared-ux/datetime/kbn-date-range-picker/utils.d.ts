...
import type { TimePrecision, TimeRange, TimeRangeBounds, TimeRangeBoundsOption, TimeRangeTransformOptions, InitialFocus, AutoRefreshIntervalUnit } from './types';
 ...
 */
export declare function hasRoundedOffset(range: TimeRangeBounds): boolean;
/**
 ...
 */
export declare function getOptionDisplayLabel(option: TimeRangeBoundsOption, options?: Pick<TimeRangeTransformOptions, 'timePrecision' | 'presets' | 'locale'>): string;
/**
 ...
 */
export declare function getOptionInputText(option: TimeRangeBoundsOption, options?: Pick<TimeRangeTransformOptions, 'presets' | 'locale'>): string;

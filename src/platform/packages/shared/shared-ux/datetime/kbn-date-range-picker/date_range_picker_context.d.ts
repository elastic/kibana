 ...
 */
export declare function DateRangePickerProvider({ children, value, defaultValue, onChange, dateFormat, locale, isInvalid, disabled, readOnly, isLoading, compressed, collapsed, showTimeWindowButtons, presets, recent, onPresetSave, onPresetDelete, onInputChange, width, calendarOptions, settings, onSettingsChange, timeZone, onRefresh, refreshEpoch, prependBasePath: prependBasePathProp, canAccessAdvancedSettings, }: PropsWithChildren<DateRangePickerProps>): React.JSX.Element;
export {};

...
import type { TimeRangeBounds, TimeRangeBoundsOption, TimeRange, TimeRangeTransformOptions, InitialFocus, CalendarOptions, DateRangePickerSettings } from './types';
 ...
 */
export declare function DateRangePickerProvider({ children, value, defaultValue, onChange, inputDateFormats, locale, isInvalid, disabled, readOnly, isLoading, compressed, collapsed, showTimeWindowButtons, presets, recent, onPresetSave, onPresetDelete, onInputChange, width, calendarOptions, settings, onSettingsChange, timeZone, onRefresh, refreshEpoch, prependBasePath: prependBasePathProp, canAccessAdvancedSettings, }: PropsWithChildren<DateRangePickerProps>): React.JSX.Element;
export {};

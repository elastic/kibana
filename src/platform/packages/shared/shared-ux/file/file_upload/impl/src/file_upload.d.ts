 ...
 */
export declare const FileUpload: <Kind extends string = string>({ meta, onDone, onError, onFilesSelected, fullWidth, allowClear, onUploadEnd, onUploadStart, compressed, kind: kindId, multiple, initialPromptText, immediate, allowRepeatedUploads, className, }: Props<Kind>) => ReturnType<FunctionComponent>;

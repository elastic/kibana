...
The header renders three stacked regions: an always-visible title row, a collapsible region holding the description and the header blocks, and an always-visible trailing region carrying the tab bar and the full-bleed bottom divider. See [`tab/README.md`](tab/README.md) for the tab bar.

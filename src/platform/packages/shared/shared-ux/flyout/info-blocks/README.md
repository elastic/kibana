...
- The card is a `dl` and each block a `dt`/`dd` inside a wrapper element, keeping title/value associations programmatic. The `InfoBlock` renders this wrapper and acts as the grid cell.

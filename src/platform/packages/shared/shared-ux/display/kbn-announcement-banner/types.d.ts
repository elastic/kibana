 ...
 */
export type AnnouncementBannerActionPrimaryProps = DistributiveOmit<ComponentProps<typeof EuiButton>, 'color' | 'size'>;
/**
 * Props for the secondary action button. Rendered as an `EuiButtonEmpty`.
 * `color`, `size` and `flush` are controlled by the component.
 */
export type AnnouncementBannerActionSecondaryProps = DistributiveOmit<ComponentProps<typeof EuiButtonEmpty>, 'color' | 'size' | 'flush'>;
/**
 ...
 */
export type AnnouncementBannerDismissButtonProps = Partial<DistributiveOmit<ComponentProps<typeof EuiButtonIcon>, 'onClick'>>;

...
import type { LayoutConfig, LayoutAlignType } from '../../../lib/layout/layout_config';
  ...
  return (
    <>
      ...
      {config.alignType !== 'stretch' && (
        <EuiFormRow
          data-test-subj="layoutSettingsWidth"
          label={i18n.translate('kbnDesignTools.layout.settings.width', {

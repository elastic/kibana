...
export const SearchRequest = z.object({
  ...
  default_operator: QueryDslOperator.describe('The default operator for the query string query: `and` or `or`. This parameter can be used only when the `q` query string parameter is specified.').optional().meta({ found_in: 'query' }),

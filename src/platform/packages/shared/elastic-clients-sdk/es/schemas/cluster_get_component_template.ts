...
export const MappingPropertyBase = z.object({
  ...
  dynamic: MappingDynamicMapping.optional(),
...
export const MappingBooleanProperty = z.object({
  ...
  fielddata: IndicesNumericFielddata.optional(),
...
export const MappingIcuCollationProperty = z.object({
  ...
  case_first: AnalysisIcuCollationCaseFirst.optional(),
  numeric: z.boolean().optional(),
...
export const MappingTextProperty = z.object({
  ...
  fielddata_frequency_filter: IndicesFielddataFrequencyFilter.optional(),
  index: z.boolean().optional(),
  index_options: MappingIndexOptions.optional(),
  index_phrases: z.boolean().optional(),
  index_prefixes: z.union([MappingTextIndexPrefixes, z.null()]).optional(),
...
export const MappingTypeMapping = z.object({
  ...
  dynamic_templates: z.array(z.record(z.string(), MappingDynamicTemplate)).optional(),
  _field_names: MappingFieldNamesField.optional(),
  ...
  _routing: MappingRoutingField.optional(),
  _size: MappingSizeField.optional(),
  _source: MappingSourceField.optional(),
...
export const IndicesIndexSettingsAnalysis = z.object({
  analyzer: z.record(z.string(), AnalysisAnalyzer).optional(),
  char_filter: z.record(z.string(), AnalysisCharFilter).optional(),
  filter: z.record(z.string(), AnalysisTokenFilter).optional(),
  normalizer: z.record(z.string(), AnalysisNormalizer).optional(),
  tokenizer: z.record(z.string(), AnalysisTokenizer).optional()
...
export const ClusterComponentTemplateSummaryRes = z.object({
  ...
  mappings: MappingTypeMapping.optional(),

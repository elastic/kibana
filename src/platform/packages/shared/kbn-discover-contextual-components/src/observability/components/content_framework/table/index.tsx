...
export function ContentFrameworkTable({
  ...
  const { fieldsMetadata, fieldFormats, toasts } = useUnifiedDocViewerServices();
  const useFieldsMetadata = fieldsMetadata?.useFieldsMetadata;
  const { fieldsMetadata: fieldsMetadataResult = {} } = useFieldsMetadata
    ? useFieldsMetadata({
      ...
      fieldNames.reduce(
        (acc, fieldName) => {
          ...
          const fieldDescription =
            fieldConfiguration?.description || fieldsMetadataResult[fieldName]?.short;
          ...
          acc.fields[fieldName] = {
            ...
            type: fieldsMetadataResult[fieldName]?.type,

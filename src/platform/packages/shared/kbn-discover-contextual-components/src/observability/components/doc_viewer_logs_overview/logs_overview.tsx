...
import type { LogDocument, ObservabilityIndexes } from '@kbn/discover-utils';
import { getStacktraceFields } from '@kbn/discover-utils';
...
export const LogsOverview = forwardRef<LogsOverviewApi, LogsOverviewProps>(
  (
    ...
    const { fieldFormats } = useUnifiedDocViewerServices();

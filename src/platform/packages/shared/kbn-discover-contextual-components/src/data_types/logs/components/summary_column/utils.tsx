...
import { type LogDocument, type ResourceFields, getAvailableResourceFields } from '@kbn/discover-utils/src';
import { useEuiTheme } from '@elastic/eui';
import { FieldBadgeWithActions, type FieldBadgeWithActionsProps } from '../cell_actions_popover';

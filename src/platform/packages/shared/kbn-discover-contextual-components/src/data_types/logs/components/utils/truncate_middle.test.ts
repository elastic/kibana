...
describe('truncateMiddle', () => {
  ...
  describe("when there aren't <mark> tags", () => {
    describe('and text is shorter than maxLength', () => {
      const result = truncateMiddle(SHORT_TEXT, MAX_LENGTH);
    ...
    describe('and text is longer than or equal to maxLength', () => {
      const result = truncateMiddle(LONG_TEXT, MAX_LENGTH);
  ...
  describe('when there are <mark> tags', () => {
    describe('and text is shorter than maxLength', () => {
      const result = truncateMiddle(`<mark>${SHORT_TEXT}</mark>`, MAX_LENGTH);

      it('should return the original string with the tags', () => {
        expect(result).toBe('<mark>short</mark>');
      });
    });

    describe('and text is longer than or equal to maxLength', () => {
      const result = truncateMiddle(`<mark>${LONG_TEXT}</mark>`, MAX_LENGTH);

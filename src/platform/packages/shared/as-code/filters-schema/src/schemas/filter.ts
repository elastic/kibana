 ...
 */
const negatePropertySchema = lazySchema(() =>
 ...
 */
const commonBasePropertiesSchema = lazySchema(() =>
  z
    .object({
 ...
 */
const baseConditionSchema = lazySchema(() =>
  z
    .object({
      field: z
        .string()
 ...
 */
const singleConditionSchema = lazySchema(() =>
  baseConditionSchema
    .extend({
 ...
 */
const oneOfConditionSchema = lazySchema(() =>
  baseConditionSchema
    .extend({
 ...
 */
const rangeConditionSchema = lazySchema(() =>
  baseConditionSchema
    .extend({
 ...
 */
const existsConditionSchema = lazySchema(() =>
  baseConditionSchema
    .extend({
 ...
 */
const conditionSchema = lazySchema(() =>
  z
 ...
 */
export const asCodeConditionFilterSchema = lazySchema(() =>
 ...
 */
export const asCodeDSLFilterSchema = lazySchema(() =>
  commonBasePropertiesSchema
    .extend({
 ...
 */
export const asCodeSpatialFilterSchema = lazySchema(() =>
  commonBasePropertiesSchema
    .extend({
 ...
 */
export const asCodeFilterSchema = lazySchema(() =>
  z

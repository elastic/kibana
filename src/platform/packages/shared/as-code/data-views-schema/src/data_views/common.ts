...
export const indexPatternSchema = lazySchema(() =>
  z.string().min(1).meta({
...
export const timeFieldSchema = lazySchema(() =>
...
export const fieldSettingsFieldNameSchema = lazySchema(() =>
  z.string().min(1).meta({
...
export const allowHiddenIndicesSchema = lazySchema(() =>
...
export const nameSchema = lazySchema(() =>
  z.string().min(1).max(256).optional().meta({

...
export const fieldSettingsBaseSchema = lazySchema(() =>
  z
    .object({
      format: z
        .object({
...
const popularitySchema = lazySchema(() =>
  z.number().min(0).optional().meta({
...
export const fieldSettingsWithPopularitySchema = lazySchema(() =>

...
import { type AsCodeDataViewSpec, type AsCodeSavedDataView } from '@kbn/as-code-data-views-schema';
/**
 ...
 */
export declare function fromStoredFields<IncludePopularity extends boolean = false>(runtimeFields?: DataViewSpec['runtimeFieldMap'], fieldFormats?: DataViewSpec['fieldFormats'], fieldAttrs?: DataViewSpec['fieldAttrs'], includePopularity?: IncludePopularity): IncludePopularity extends false ? AsCodeDataViewSpec['field_settings'] : AsCodeSavedDataView['field_settings'];

...
export { MOVING_AVERAGE_ID, MOVING_AVERAGE_NAME, MOVING_AVERAGE_WINDOW_DEFAULT_VALUE, } from './src/operations/moving_average';
...
export declare const documentationMap: Record<string, OperationDocumentationType>;

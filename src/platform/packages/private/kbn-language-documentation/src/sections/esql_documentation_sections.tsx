...
An index that is used in \`LOOKUP JOIN\` needs to be in lookup mode. This [index mode](https://www.elastic.co/guide/en/elasticsearch/reference/8.x/index-modules.html#_static_index_settings) needs to be set when the index is created.

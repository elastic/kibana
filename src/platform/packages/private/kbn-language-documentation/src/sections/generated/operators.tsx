...
export const functions = {
  ...
  * \`?\` matches one character.
  ...
  `,
    ...
    // Do not edit manually... automatically generated by scripts/generate_esql_docs.ts
    {
      label: i18n.translate('languageDocumentation.documentationESQL.not_in (not in)', {
        defaultMessage: 'NOT_IN (NOT IN)',
      }),
      preview: false,
      license: undefined,
      description: {
        markdownContent: i18n.translate(
          'languageDocumentation.documentationESQL.not_in (not in).markdown',
          {
            defaultMessage: `
  ### NOT IN
  ...
  `,
    ...
    // Do not edit manually... automatically generated by scripts/generate_esql_docs.ts
    {
      label: i18n.translate('languageDocumentation.documentationESQL.not_like (not like)', {
        defaultMessage: 'NOT_LIKE (NOT LIKE)',
      }),
      preview: false,
      license: undefined,
      description: {
        markdownContent: i18n.translate(
          'languageDocumentation.documentationESQL.not_like (not like).markdown',
          {
            defaultMessage: `
  ### NOT LIKE
  Use \`LIKE\` to filter data based on string patterns using wildcards. \`LIKE\`
  ...
  * \`?\` matches one character.
  `,
    ...
    // Do not edit manually... automatically generated by scripts/generate_esql_docs.ts
    {
      label: i18n.translate('languageDocumentation.documentationESQL.not_rlike (not rlike)', {
        defaultMessage: 'NOT_RLIKE (NOT RLIKE)',
      }),
      preview: false,
      license: undefined,
      description: {
        markdownContent: i18n.translate(
          'languageDocumentation.documentationESQL.not_rlike (not rlike).markdown',
          {
            defaultMessage: `
  ### NOT RLIKE

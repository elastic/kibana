...
describe('migration visualization', () => {
  describe('6.7.2', () => {
    const migrate = (doc: any) =>
      SavedObjectsUtils.getMigrationFunction(legacyVisualizationSavedObjectMigrations['6.7.2'])(
  ...
  describe('7.0.0', () => {
    const migrate = (doc: any) =>
      SavedObjectsUtils.getMigrationFunction(legacyVisualizationSavedObjectMigrations['7.0.0'])(
        doc as Parameters<SavedObjectMigrationFn>[0],
        savedObjectMigrationContext
      );
  ...
  describe('7.2.0', () => {
    describe('date histogram custom interval removal', () => {
      const migrate = (doc: any) =>
        SavedObjectsUtils.getMigrationFunction(legacyVisualizationSavedObjectMigrations['7.2.0'])(
          doc as Parameters<SavedObjectMigrationFn>[0],
          savedObjectMigrationContext
        );
      let doc: any;
  ...
  describe('7.3.0', () => {
    ...
    const migrate = (doc: any) =>
      SavedObjectsUtils.getMigrationFunction(legacyVisualizationSavedObjectMigrations['7.3.0'])(
        doc as Parameters<SavedObjectMigrationFn>[0],
        logger
      );
  ...
  describe('7.3.1', () => {
    const migrate = (doc: any) =>
      SavedObjectsUtils.getMigrationFunction(legacyVisualizationSavedObjectMigrations['7.3.1'])(
        doc as Parameters<SavedObjectMigrationFn>[0],
        savedObjectMigrationContext
      );
  ...
  describe('7.4.2 tsvb split_filters migration', () => {
    const migrate = (doc: any) =>
      SavedObjectsUtils.getMigrationFunction(legacyVisualizationSavedObjectMigrations['7.4.2'])(
        doc as Parameters<SavedObjectMigrationFn>[0],
        savedObjectMigrationContext
      );
    const generateDoc = (params: any) => ({
  ...
  describe('7.7.0 tsvb opperator typo migration', () => {
    const migrate = (doc: any) =>
      SavedObjectsUtils.getMigrationFunction(legacyVisualizationSavedObjectMigrations['7.7.0'])(
        doc as Parameters<SavedObjectMigrationFn>[0],
        savedObjectMigrationContext
      );
  ...
  describe('7.9.3', () => {
    const migrate = (doc: any) =>
      SavedObjectsUtils.getMigrationFunction(legacyVisualizationSavedObjectMigrations['7.9.3'])(
        doc as Parameters<SavedObjectMigrationFn>[0],
        savedObjectMigrationContext
      );
  ...
  describe('7.8.0 tsvb split_color_mode', () => {
    const migrate = (doc: any) =>
      SavedObjectsUtils.getMigrationFunction(legacyVisualizationSavedObjectMigrations['7.8.0'])(
        doc as Parameters<SavedObjectMigrationFn>[0],
        savedObjectMigrationContext
      );
  ...
  describe('7.10.0 tsvb filter_ratio migration', () => {
    const migrate = (doc: any) =>
      SavedObjectsUtils.getMigrationFunction(legacyVisualizationSavedObjectMigrations['7.10.0'])(
        doc as Parameters<SavedObjectMigrationFn>[0],
        savedObjectMigrationContext
      );
  ...
  describe('7.11.0 Data table vis - enable toolbar', () => {
    const migrate = (doc: any) =>
      SavedObjectsUtils.getMigrationFunction(legacyVisualizationSavedObjectMigrations['7.11.0'])(
        doc as Parameters<SavedObjectMigrationFn>[0],
        savedObjectMigrationContext
      );
  ...
  describe('7.12.0 update vislib visualization defaults', () => {
    const migrate = (doc: any) =>
      SavedObjectsUtils.getMigrationFunction(legacyVisualizationSavedObjectMigrations['7.12.0'])(
        doc as Parameters<SavedObjectMigrationFn>[0],
        savedObjectMigrationContext
      );
    const getTestDoc = (
  ...
  describe('7.13.0 tsvb hide Last value indicator by default', () => {
    const migrate = (doc: any) =>
      SavedObjectsUtils.getMigrationFunction(legacyVisualizationSavedObjectMigrations['7.13.0'])(
        doc as Parameters<SavedObjectMigrationFn>[0],
        savedObjectMigrationContext
      );
  ...
  describe('7.13.0 and 7.13.1 tsvb migrations can run twice', () => {
    ...
    const migrateAgain = (doc: any) =>
      SavedObjectsUtils.getMigrationFunction(legacyVisualizationSavedObjectMigrations['7.13.1'])(
        doc as Parameters<SavedObjectMigrationFn>[0],
        savedObjectMigrationContext
      );
  ...
  describe('7.14.0 tsvb - add empty value rule to savedObjects with less and greater then zero rules', () => {
    const migrate = (doc: any) =>
      SavedObjectsUtils.getMigrationFunction(legacyVisualizationSavedObjectMigrations['7.14.0'])(
        doc as Parameters<SavedObjectMigrationFn>[0],
        savedObjectMigrationContext
      );
  ...
  describe('8.0.0 removeMarkdownLessFromTSVB', () => {
    const migrate = (doc: any) =>
      SavedObjectsUtils.getMigrationFunction(legacyVisualizationSavedObjectMigrations['8.0.0'])(
        doc as Parameters<SavedObjectMigrationFn>[0],
        savedObjectMigrationContext
      );
    const getTestDoc = () => ({
  ...
  describe('7.17.0 tsvb - add drop last bucket into TSVB model', () => {
    ...
    const migrateAgain = (doc: any) =>
      SavedObjectsUtils.getMigrationFunction(legacyVisualizationSavedObjectMigrations['7.17.0'])(
        doc as Parameters<SavedObjectMigrationFn>[0],
        savedObjectMigrationContext
      );
  ...
  describe('8.1.0 pie - labels and addLegend migration', () => {
    ...
    const migrate = (doc: any) =>
      SavedObjectsUtils.getMigrationFunction(legacyVisualizationSavedObjectMigrations['8.1.0'])(
        doc as Parameters<SavedObjectMigrationFn>[0],
        savedObjectMigrationContext
      );
  ...
  describe('8.3.0 - preserves default legend size for existing visualizations', () => {
    ...
    const migrate = (doc: any) =>
      SavedObjectsUtils.getMigrationFunction(legacyVisualizationSavedObjectMigrations['8.3.0'])(
        doc as Parameters<SavedObjectMigrationFn>[0],
        savedObjectMigrationContext
      );
  ...
  describe('8.5.0 tsvb - remove exclamation circle icon', () => {
    const migrate = (doc: any) =>
      SavedObjectsUtils.getMigrationFunction(legacyVisualizationSavedObjectMigrations['8.5.0'])(
        doc as Parameters<SavedObjectMigrationFn>[0],
        savedObjectMigrationContext
      );

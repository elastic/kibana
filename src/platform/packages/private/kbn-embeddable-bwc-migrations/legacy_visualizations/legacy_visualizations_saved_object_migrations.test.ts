...
describe('migration visualization', () => {
  const visualizationSavedObjectTypeMigrations = getLegacyVisualizationSavedObjectMigrations({});
  ...
  it('should apply search source migrations within visualization', () => {
    ...
    const visMigrations = getLegacyVisualizationSavedObjectMigrations({

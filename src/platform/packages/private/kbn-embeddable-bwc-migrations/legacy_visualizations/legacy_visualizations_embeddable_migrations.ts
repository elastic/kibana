...
} from './legacy_visualizations_common_migrations';

export interface MigrationSerializedVis {
  id?: string;
  title: string;
  description?: string;
  type: string;
...
export const legacyVisualizeEmbeddableMigrations: MigrateFunctionsObject = {

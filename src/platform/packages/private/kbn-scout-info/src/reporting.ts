...
export const SCOUT_VISUAL_REGRESSION_ENABLED = booleanFromEnv('SCOUT_VISUAL_REGRESSION_ENABLED');
export const SCOUT_VISUAL_REGRESSION_PLUGIN_NAME = process.env.SCOUT_VISUAL_REGRESSION_PLUGIN_NAME;

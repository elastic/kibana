...
server:
  ...
  ssl:
    ...
    key: /path/to/src/dev/packages/dev-utils/certs/kibana.key
    certificate: /path/to/src/dev/packages/dev-utils/certs/kibana.crt
    certificateAuthorities: /path/to/src/dev/packages/dev-utils/certs/ca.crt

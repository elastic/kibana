...
import { type Observable, fromEventPattern, lastValueFrom, of, throwError } from 'rxjs';
...
import { type TaskInstanceFields, type TaskRunResult } from '@kbn/reporting-common/types';
import {
  type JobParamsPDFDeprecated,
  PDF_JOB_TYPE,
  type TaskPayloadPDF,

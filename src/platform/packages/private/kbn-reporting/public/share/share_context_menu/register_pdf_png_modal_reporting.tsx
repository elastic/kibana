...
export const reportingExportModalProvider = ({
  ...
  const getShareMenuItems = ({
    ...
    const capabilityHasDashboardReporting = hasCapabilityByKey(application.capabilities, 'dashboard_v2');
    const capabilityHasVisualizeReporting = hasCapabilityByKey(application.capabilities, 'visualize_v2');
    ...
    if (
      isSupportedType &&
      !capabilityHasVisualizeReporting &&
      !capabilityHasDashboardReporting
    ) {
      return [];
    }

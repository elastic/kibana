...
export type ReportingCSVSharingDataLocatorParams = Array<LocatorParams<SerializableRecord & {
...
export type ReportParamsGetter<O extends ReportParamsGetterOptions = ReportParamsGetterOptions, T = unknown> = (options: O) => T;

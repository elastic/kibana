...
// Same glyph as EUI `sparkles`, split into three paths so each star can twinkle on its own.
export const SparklesIcon = ({ title, titleId, ...svgProps }: SparklesIconProps) => (
  <svg

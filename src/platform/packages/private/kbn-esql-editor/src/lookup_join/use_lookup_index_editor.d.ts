 ...
 */
export declare function getMonacoCommandString(indexName: string, isExistingIndex: boolean, indexPrivileges: LookupIndexPrivileges, isClosedIndex?: boolean): string | undefined;
/**
...
export declare const useLookupIndexCommand: (editorRef: React.MutableRefObject<monaco.editor.IStandaloneCodeEditor | undefined>, editorModel: React.MutableRefObject<monaco.editor.ITextModel | undefined>, getLookupIndices: (() => Promise<{
    ...
    lookupIndexBadgeStyle: import("@emotion/utils").SerializedStyles;
};

...
export declare const addEditorKeyBindings: (editor: monaco.editor.IStandaloneCodeEditor, onQuerySubmit: (source: QuerySource) => void, toggleVisor: () => void, onPrettifyQuery: () => void) => void;

...
export declare const VALIDATION_DEBOUNCE_MS = 256;
export declare const useQueryValidation: ({ code, lastErroredCode, editorRef, editorModel, esqlCallbacks, serverErrors, serverWarning, mergeExternalMessages, dataErrorsControl, isLoading, isQueryLoading, dataSourcesCache, esqlFieldsCache, getJoinIndicesCallback, onQueryUpdate, pickerProjectRouting, latencyTracking, }: UseQueryValidationParams) => {
    editorMessages: {
    ...
    queryValidation: ({ cancellationToken, invalidateColumnsCache, }?: {

...
export declare const useQueryActions: ({ editorRef, editorModel, isLoading, allowQueryCancellation, measuredEditorWidth, onTextLangQuerySubmit, onQueryUpdate, telemetryService, }: UseQueryActionsParams) => {

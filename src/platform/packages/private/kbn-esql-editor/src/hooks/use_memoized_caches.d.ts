...
export declare const useMemoizedCaches: ({ code, core, favoritesClient, pickerProjectRouting, }: UseMemoizedCachesParams) => {
    ...
    memoizedSources: ((args_0: CoreStart, args_1: (() => Promise<ILicense | undefined>) | undefined, args_2: ((sources: ESQLSourceResult[]) => Promise<ESQLSourceResult[]>) | undefined, args_3: AbortSignal | undefined) => {
        timestamp: number;

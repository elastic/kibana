...
export declare const useEditorConfig: ({ editorRef, editorModel, editorModelUriRef, editorCommandDisposables, esqlCallbacks, telemetryCallbacks, isSuggestFixEnabled, isDisabled, measuredEditorWidth, setMeasuredEditorWidth, resetPendingTracking, editorMessagesRef, }: UseEditorConfigParams) => {

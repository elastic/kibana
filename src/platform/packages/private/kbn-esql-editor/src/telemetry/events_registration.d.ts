...
export declare const ESQL_VISOR_NL_SUBMITTED = "esql.visor_nl_submitted";
export declare const ESQL_COMMENT_TO_ESQL_SUBMITTED = "esql.comment_to_esql_submitted";
export declare const ESQL_COMMENT_TO_ESQL_REVIEWED = "esql.comment_to_esql_reviewed";
export declare const ESQL_FIX_WITH_AI_SUBMITTED = "esql.fix_with_ai_submitted";
export declare const ESQL_FIX_WITH_AI_REVIEWED = "esql.fix_with_ai_reviewed";
/**

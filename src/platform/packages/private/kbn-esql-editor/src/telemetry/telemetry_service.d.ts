...
export declare class ESQLEditorTelemetryService {
    ...
    trackCommentToEsqlSubmitted(params: {
        nlLength: number;
    ...
    trackCommentToEsqlReviewed(params: {
        action: AiReviewAction;
        linesGenerated: number;
    }): void;
    trackFixWithAiSubmitted(params: {
        errorCode?: string;
        queryLength: number;
        success: boolean;
        durationMs: number;

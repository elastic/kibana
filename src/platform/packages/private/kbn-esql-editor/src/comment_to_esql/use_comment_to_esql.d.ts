...
export declare const useCommentToEsql: ({ editorRef, editorModel, http, notifications, isEnabled, clearGhostHintRef, telemetryService, onAfterInsert, }: UseCommentToEsqlParams) => {

 ...
 */
export declare const trackSuggestionPopupState: (editor: monaco.editor.IStandaloneCodeEditor, isSuggestionPopupOpenRef: React.MutableRefObject<boolean>) => monaco.IDisposable;
/**

...
describe('getMonacoCommandString', () => {
  it('should return create command for non-existing index with create permissions', () => {
    ...
    expect(result).toBe(
      '[Create lookup index](command:esql.lookup_index.create?%7B%22indexName%22%3A%22test-index%22%2C%22doesIndexExist%22%3Afalse%2C%22canEditIndex%22%3Atrue%2C%22triggerSource%22%3A%22esql_hover%22%2C%22higherPrivilege%22%3A%22create%22%7D)'
    );
  });
  ...
  it('should return edit command for existing index with edit permissions', () => {
    ...
    expect(result).toBe(
      '[Edit lookup index](command:esql.lookup_index.create?%7B%22indexName%22%3A%22test-index%22%2C%22doesIndexExist%22%3Atrue%2C%22canEditIndex%22%3Atrue%2C%22triggerSource%22%3A%22esql_hover%22%2C%22higherPrivilege%22%3A%22edit%22%7D)'
    );
  });
  ...
  it('should return view command for existing index with read permissions only', () => {
    ...
    expect(result).toBe(
      '[View lookup index](command:esql.lookup_index.create?%7B%22indexName%22%3A%22test-index%22%2C%22doesIndexExist%22%3Atrue%2C%22canEditIndex%22%3Afalse%2C%22triggerSource%22%3A%22esql_hover%22%2C%22higherPrivilege%22%3A%22read%22%7D)'
    );
  });
        ...
        expect.objectContaining({
          options: expect.objectContaining({
            hoverMessage: expect.objectContaining({
              value:
                '[Create lookup index](command:esql.lookup_index.create?%7B%22indexName%22%3A%22test-index%22%2C%22doesIndexExist%22%3Afalse%2C%22canEditIndex%22%3Afalse%2C%22triggerSource%22%3A%22esql_hover%22%2C%22higherPrivilege%22%3A%22create%22%7D)',
            }),
          }),
        }),
      ])

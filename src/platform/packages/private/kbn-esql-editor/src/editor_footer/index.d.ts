...
export declare const EditorFooter: React.MemoExoticComponent<({ styles, onUpdateAndSubmitQuery, onPrettifyQuery, editorIsInline, isSpaceReduced, resizableContainerButton, resizableContainerHeight, isHistoryOpen, setIsHistoryOpen, isLanguageComponentOpen, setIsLanguageComponentOpen, displayDocumentationAsFlyout, measuredContainerWidth, errors, warnings, onErrorClick, dataErrorsControl, starredQueriesService, queryStats, }: EditorFooterProps) => React.JSX.Element>;
export {};

...
import type { ActiveSectionEvent, CollapsibleSection, GridSectionData, MainSection } from './grid_section';
/**
...
export interface GridLayoutStateManager {
    ...
    sectionRefs: React.MutableRefObject<{
        [sectionId: string]: HTMLDivElement | null;
    }>;
    headerRefs: React.MutableRefObject<{
        [sectionId: string]: HTMLDivElement | null;
    }>;
    panelRefs: React.MutableRefObject<{
        [panelId: string]: HTMLDivElement | null;
    }>;
}
/**
...
export type UseCustomDragHandle = {
    ...
    renderPanelContents: (panelId: string, setDragHandles: (refs: Array<HTMLElement | null>) => void) => React.ReactNode;
} | {

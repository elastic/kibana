...
export class IndexUpdateService {
  ...
  public addEmptyRow() {
    ...
    this.telemetry.trackEditInteraction({ actionType: 'add_row', outcome: 'success' });
  }
  ...
  public updateDoc(id: string, update: Record<string, unknown>) {
    ...
    this.telemetry.trackEditInteraction({ actionType: 'edit_cell', outcome: 'success' });
  }
  ...
  public deleteDoc(ids: string[]) {
    ...
    this.telemetry.trackEditInteraction({ actionType: 'delete_row', outcome: 'success' });
  }
  ...
  public addNewColumn() {
    ...
    this.telemetry.trackEditInteraction({ actionType: 'add_column', outcome: 'success' });
  }

  public editColumn(name: string, previousName: string) {
    this.addAction('edit-column', { name, previousName });

    this.telemetry.trackEditInteraction({ actionType: 'edit_column', outcome: 'success' });
  }

  public deleteColumn(name: string) {
    this.addAction('delete-column', { name });

    this.telemetry.trackEditInteraction({ actionType: 'delete_column', outcome: 'success' });
  }

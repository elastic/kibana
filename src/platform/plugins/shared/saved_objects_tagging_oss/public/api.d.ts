...
export interface SavedObjectsTaggingApiUi {
     ...
     * ```
     */
    getTableColumnDefinition(options?: GetTableColumnDefinitionOptions): EuiTableFieldDataColumnType<SavedObject>;
    /**
     ...
     */
    getTagIdsFromReferences(references: Array<SavedObjectReference | SavedObjectsFindOptionsReference>): string[];
    /**
     ...
     */
    updateTagsReferences(references: SavedObjectReference[], newTagIds: string[]): SavedObjectReference[];
    /**
 ...
 * @public
 */
export type SavedObjectSaveModalTagSelectorComponentProps = EuiComboBoxProps<Tag | {

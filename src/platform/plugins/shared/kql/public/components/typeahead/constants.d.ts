 ...
 * @public
 */
export declare const SUGGESTIONS_LIST_REQUIRED_WIDTH = 600;
/**
 * Minimum bottom distance in px to display list of suggestions
 * @public
 */
export declare const SUGGESTIONS_LIST_REQUIRED_BOTTOM_SPACE = 250;
/**
 * A distance in px to display suggestions list right under the query input without a gap
 * @public
 */
export declare const SUGGESTIONS_LIST_REQUIRED_TOP_OFFSET = 0;

...
import type { IInterpreterRenderHandlers, ExpressionValue, ExpressionsService, RenderMode, IInterpreterRenderEvent } from '../../common';
...
export type RenderErrorHandlerFnType = (domNode: HTMLElement, error: ExpressionRenderError, handlers: IInterpreterRenderHandlers) => void;

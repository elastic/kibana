...
import type { AnyExpressionFunctionDefinition, ExpressionFunctionDefinition } from '../expression_functions/types';
import type { ExpressionAstExpressionBuilder } from './build_expression';
export type InferFunctionDefinition<FnDef extends AnyExpressionFunctionDefinition> = FnDef extends ExpressionFunctionDefinition<infer Name, infer Input, infer Arguments, infer Output, infer Context> ? {
    name: Name;
    input: Input;
    arguments: Arguments;
    output: Output;
...
type FunctionArgs<FnDef extends AnyExpressionFunctionDefinition> = InferFunctionDefinition<FnDef>['arguments'];

...
export type ExpressionFunctionMovingAverage = ExpressionFunctionDefinition<'moving_average', Datatable, MovingAverageArgs, Promise<Datatable>>;
/**
 ...
 */
export declare const movingAverage: ExpressionFunctionMovingAverage;

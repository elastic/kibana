...
export type ExpressionFunctionDerivative = ExpressionFunctionDefinition<'derivative', Datatable, DerivativeArgs, Promise<Datatable>>;
/**
 ...
 */
export declare const derivative: ExpressionFunctionDerivative;

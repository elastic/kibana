...
export type ClusterDetailsGetter = (config: StatsCollectionConfig, context: StatsCollectionContext) => Promise<ClusterDetails[]>;
export type StatsGetter<T extends BasicStatsPayload = BasicStatsPayload> = (clustersDetails: ClusterDetails[], config: StatsCollectionConfig, context: StatsCollectionContext) => Promise<T[]>;

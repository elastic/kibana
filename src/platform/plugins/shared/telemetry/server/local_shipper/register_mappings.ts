      ...
      properties: {
        ...
        context: {
          properties: {
            ...
            display_language: { type: 'keyword' },
            display_language_browser_preference: { type: 'keyword' },
            display_language_source: { type: 'keyword' },
            display_language_config_default: { type: 'keyword' },

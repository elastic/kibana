...
import type { UiActionsActionDefinition as ActionDefinition, UiActionsPresentable as Presentable } from '@kbn/ui-actions-plugin/public';
 ...
 */
export interface ActionFactoryDefinition<Config extends BaseActionConfig = BaseActionConfig, ExecutionContext extends object = object, FactoryContext extends BaseActionFactoryContext = BaseActionFactoryContext> extends Partial<Omit<Presentable<FactoryContext>, 'getHref'>>, Configurable<Config, FactoryContext>, PersistableStateDefinition<SerializedEvent> {
    /**

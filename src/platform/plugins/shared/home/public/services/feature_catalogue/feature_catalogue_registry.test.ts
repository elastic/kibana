...
import type { FeatureCatalogueEntry, FeatureCatalogueSolution } from './feature_catalogue_registry';
import { FeatureCatalogueRegistry } from './feature_catalogue_registry';

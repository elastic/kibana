import type { ChromeStart, DocLinksStart, HttpStart, NotificationsSetup, NotificationsStart, OverlayStart, IUiSettingsClient, ApplicationStart, ThemeServiceStart, I18nStart, AppMountParameters } from '@kbn/core/public';
...
export declare function setServices(newServices: HomeKibanaServices): void;
export declare function getServices(): HomeKibanaServices;

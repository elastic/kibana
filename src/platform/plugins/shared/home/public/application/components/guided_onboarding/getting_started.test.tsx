...
import { findTestSubject, registerTestBed, type TestBed, mountWithIntl } from '@kbn/test-jest-helpers';
...
import { type GuideFiltersProps } from '@kbn/guided-onboarding/src/components/landing_page/guide/guide_filters';

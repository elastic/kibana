...
import { ExitOnFailureNodeImpl } from '../exit_on_failure_node_impl';
import type { WorkflowExecutionRuntimeManager } from '../../../../workflow_context_manager/workflow_execution_runtime_manager';

describe('ExitOnFailureNodeImpl', () => {
  let underTest: ExitOnFailureNodeImpl;
  let workflowRuntime: WorkflowExecutionRuntimeManager;

  beforeEach(() => {
    workflowRuntime = {} as unknown as WorkflowExecutionRuntimeManager;
    underTest = new ExitOnFailureNodeImpl(workflowRuntime);
  });

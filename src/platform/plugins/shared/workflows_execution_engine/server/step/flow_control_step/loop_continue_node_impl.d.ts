...
export declare class LoopContinueNodeImpl implements NodeImplementation {
    ...
    constructor(node: LoopContinueNode, stepExecutionRuntime: StepExecutionRuntime, wfExecutionRuntimeManager: WorkflowExecutionRuntimeManager, workflowLogger: IWorkflowEventLogger, stepExecutionRuntimeFactory: StepExecutionRuntimeFactory, stepIoService: StepIoService, workflowGraph: WorkflowGraph);
    run(): void;
}

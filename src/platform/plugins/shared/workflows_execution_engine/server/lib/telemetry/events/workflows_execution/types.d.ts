 ...
 */
export declare enum WorkflowExecutionTelemetryEventTypes {
    /**
 ...
 */
export interface EventDrivenExecutionSuppressedParams extends Omit<BaseWorkflowExecutionTelemetryParams, 'compositionDepth' | 'parentWorkflowId' | 'parentWorkflowInvocation'> {
    eventName: string;
 ...
 */
export interface WorkflowExecutionCompletedParams extends BaseWorkflowExecutionTelemetryParams, OutputSizeTelemetryFields {
    eventName: string;
    /**
 ...
 */
export interface WorkflowExecutionFailedParams extends BaseWorkflowExecutionTelemetryParams, OutputSizeTelemetryFields {
    eventName: string;
    /**
     * Timestamp when the execution started (ISO string)
     */
 ...
 */
export interface WorkflowExecutionCancelledParams extends BaseWorkflowExecutionTelemetryParams, OutputSizeTelemetryFields {
    eventName: string;
    /**
     * Timestamp when the execution started (ISO string)
     */
 ...
 */
export type WorkflowExecutionTelemetryEventParams = WorkflowExecutionCompletedParams | WorkflowExecutionFailedParams | WorkflowExecutionCancelledParams | EventDrivenExecutionSuppressedParams | TriggerEventDispatchedParams;
/**

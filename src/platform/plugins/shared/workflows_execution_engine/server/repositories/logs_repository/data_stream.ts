...
const logsRepositoryMappings = mappings.createTypedMappings({
...
export type LogsRepositoryDataStreamClient = IDataStreamClient<typeof logsRepositoryMappings, {}>;
...
export const initializeLogsRepositoryDataStream = (coreDataStreams: DataStreamsSetup) => {
  return coreDataStreams.registerDataStream({
    ...
    template: {
      mappings: {
        dynamic: false,
        properties: logsRepositoryMappings,
      },
    },
  });
};

...
export const WORKFLOWS_EXECUTIONS_DATA_STREAM = '.workflows-executions-data-stream';
...
export const WORKFLOWS_STEP_EXECUTIONS_DATA_STREAM = '.workflows-step-executions-data-stream';

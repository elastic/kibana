...
import { RunStepResult } from '../step/step-base';
import { z } from 'zod';
import { 
    WorkflowEventLogger, 
    type IWorkflowEventLogger, 
    type WorkflowLogEvent 
} from '../../../workflows_management/server/workflow_event_logger';
...
export class WorkflowContextManager {
    ...
    public clearCurrentStep(): void {
        ...
        if (this.workflowLogger && this.originalEsClient && this.originalLogger && this.originalIndexName) {

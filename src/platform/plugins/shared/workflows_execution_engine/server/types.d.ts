...
export type ExecuteWorkflow = (workflow: WorkflowExecutionEngineModel, context: Record<string, unknown>, request: KibanaRequest) => Promise<ExecuteWorkflowResponse>;
export type ExecuteWorkflowStep = (workflow: WorkflowExecutionEngineModel, stepId: string, executionContext: Record<string, unknown> | undefined, contextOverride: Record<string, unknown>, request: KibanaRequest) => Promise<ExecuteWorkflowStepResponse>;
export type CancelWorkflowExecution = (workflowExecutionId: string, spaceId: string, schedulingRequest?: KibanaRequest) => Promise<void>;
export type CancelAllActiveWorkflowExecutions = (params: {
    spaceId: string;
    workflowId: string;
}) => Promise<void>;
export type ResumeWorkflowExecution = (executionId: string, spaceId: string, input: Record<string, unknown>, request: KibanaRequest) => Promise<ResumeWorkflowExecutionResponse>;
export type InternalResumeWorkflowExecution = (executionId: string, spaceId: string, context: Record<string, unknown> | undefined, request: KibanaRequest) => Promise<void>;
export type ScheduleWorkflow = (workflow: WorkflowExecutionEngineModel, context: Record<string, unknown>, request: KibanaRequest) => Promise<ExecuteWorkflowResponse>;
export type BulkScheduleWorkflow = (items: Array<{

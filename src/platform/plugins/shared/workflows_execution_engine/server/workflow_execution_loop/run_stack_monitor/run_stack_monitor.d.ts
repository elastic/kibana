 ...
 */
export declare function runStackMonitor(params: WorkflowExecutionLoopParams, monitoredStepExecutionRuntime: StepExecutionRuntime, monitorAbortController: AbortController): Promise<void>;

...
export async function workflowExecutionLoop(params: WorkflowExecutionLoopParams) {
  ...
  // Delete SQLite cache rows for this run (no-op when cache is disabled).
  // Fire-and-forget: failure is logged inside disposeCache, never thrown.
  void params.stepIoService.disposeCache();

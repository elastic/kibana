...
import type { ErrorsByTraceId, SpanLinks, TraceRootSpan, UnifiedSpanDocument } from '@kbn/apm-types';
...
export interface ObservabilityStreamsFeature {
    ...
    renderFlyoutStreamFieldByStreamName: (deps: ObservabilityStreamsFeatureRenderByStreamNameDeps) => JSX.Element;
...
export type SecuritySolutionFeature = SecuritySolutionCellRendererFeature | SecuritySolutionAlertFlyoutOverviewTabFeature | SecuritySolutionAlertFlyoutHeaderTitleFeature | SecuritySolutionAlertFlyoutFooterFeature | SecuritySolutionIOCFlyoutOverviewTabFeature | SecuritySolutionIOCFlyoutHeaderFeature | SecuritySolutionIOCFlyoutFooterFeature | SecuritySolutionAttackFlyoutOverviewTabFeature | SecuritySolutionAttackFlyoutHeaderFeature | SecuritySolutionAttackFlyoutFooterFeature;
/** ****************************************************************************************/

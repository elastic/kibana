...
interface SaveModalDashboardByValueAndByReferenceProps<SaveResponse = void> extends SaveModalDashboardBaseProps<SaveResponse> {
...
export type SaveModalDashboardProps<SaveResponse = void> = SaveModalDashboardByValueProps<SaveResponse> | SaveModalDashboardByValueAndByReferenceProps<SaveResponse>;
export {};

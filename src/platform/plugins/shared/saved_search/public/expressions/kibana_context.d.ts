 ...
 * @internal
 */
export declare function getKibanaContext({ getStartServices, }: {
    getStartServices: StartServicesAccessor<SavedSearchPublicStartDependencies, SavedSearchPublicPluginStart>;
}): import("../../../data/public").ExpressionFunctionKibanaContext;

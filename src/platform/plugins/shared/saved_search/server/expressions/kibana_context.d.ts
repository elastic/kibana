 ...
 * @internal
 */
export declare function getKibanaContext(getStartServices: StartServicesAccessor<SavedSearchServerStartDeps>): import("../../../data/public").ExpressionFunctionKibanaContext;

 ...
 * @internal
 */
export declare function getKibanaContext(getStartServices: StartServicesAccessor<SavedSearchServerStartDeps>): import("../../../data/common").ExpressionFunctionKibanaContext;

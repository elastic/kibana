...
import { SCHEMA_SEARCH_MODEL_VERSION_9 } from '../../../saved_objects/schema';

const savedSearchSavedObjectSchema = savedObjectSchema(SCHEMA_SEARCH_MODEL_VERSION_9);
...
export const serviceDefinition: ServicesDefinition = {
  ...
  create: {
    in: {
      ...
      data: {
        schema: SCHEMA_SEARCH_MODEL_VERSION_9,
      },
    },
    out: {
      result: {

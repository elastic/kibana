...
export const MAX_SAVED_SEARCH_COLUMNS = 10_000; // This is the default max array size in Kibana, so we can use it for columns when serverless validations are disabled
export const MAX_SAVED_SEARCH_COLUMNS_SERVERLESS = 50; // Cap for serverless

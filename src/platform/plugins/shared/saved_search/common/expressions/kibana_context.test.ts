...
import { type KibanaContext, type ExpressionFunctionKibanaContext } from '@kbn/data-plugin/common';
...
import { getKibanaContextFn, type KibanaContextStartDependencies } from './kibana_context';

...
import type { SearchLibraryRequestType, SearchLibraryResponseType } from '../server/search_route/types';
...
export interface EmbeddableStart {
    ...
    getEmbeddableDefinition: <SerializedState extends object = object, Api extends DefaultEmbeddableApi<SerializedState> = DefaultEmbeddableApi<SerializedState>>(type: string) => Promise<EmbeddablePublicDefinition<SerializedState, Api>>;

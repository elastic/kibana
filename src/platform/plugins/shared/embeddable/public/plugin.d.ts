...
export declare class EmbeddablePublicPlugin implements Plugin<EmbeddableSetup, EmbeddableStart> {
    ...
    setup(core: CoreSetup, { uiActions }: EmbeddableSetupDependencies): {
        ...
        registerEmbeddablePublicDefinition: <SerializedState extends object = object, Api extends import("./react_embeddable_system").DefaultEmbeddableApi<SerializedState> = import("./react_embeddable_system").DefaultEmbeddableApi<SerializedState>>(type: string, getEmbeddableDefinition: () => Promise<import("./react_embeddable_system").EmbeddablePublicDefinition<SerializedState, Api>>) => void;
        registerAddFromLibraryType: <TSavedObjectAttributes extends import("../../saved_objects_finder/common").FinderAttributes>({ onAdd, savedObjectType, savedObjectName, getIconForSavedObject, getSavedObjectSubType, getTooltipForSavedObject, }: {

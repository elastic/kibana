...
export declare function getLegacyURLTransform(embeddableType: string): Promise<((storedState: object, panelReferences?: import("@kbn/content-management-utils").Reference[], containerReferences?: import("@kbn/content-management-utils").Reference[], id?: string, useGASchemas?: boolean) => object) | undefined>;

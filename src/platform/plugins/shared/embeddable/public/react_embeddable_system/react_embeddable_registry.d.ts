 ...
 */
export declare const registerEmbeddablePublicDefinition: <SerializedState extends object = object, Api extends DefaultEmbeddableApi<SerializedState> = DefaultEmbeddableApi<SerializedState>>(type: string, getEmbeddableDefinition: () => Promise<EmbeddablePublicDefinition<SerializedState, Api>>) => void;
export declare const getEmbeddableDefinition: <SerializedState extends object = object, Api extends DefaultEmbeddableApi<SerializedState> = DefaultEmbeddableApi<SerializedState>>(key: string) => Promise<EmbeddablePublicDefinition<SerializedState, Api> | undefined>;

...
export interface BuildEmbeddableProps<SerializedState extends object = object, Api extends DefaultEmbeddableApi<SerializedState> = DefaultEmbeddableApi<SerializedState>> {
     ...
     *
     */
    initializeDrilldownsManager(embeddableUuid: string, state: SerializedDrilldowns): Promise<ReturnType<typeof initializeDrilldownsManager>>;
}
/**
 ...
 **/
export interface EmbeddableFactory<SerializedState extends object = object, Api extends DefaultEmbeddableApi<SerializedState> = DefaultEmbeddableApi<SerializedState>> {
    /**

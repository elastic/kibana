...
export type DrilldownActionState = DrilldownState & {
    actionId: string;
};
export type DrilldownDefinition<TDrilldownState extends DrilldownState = DrilldownState, ExecutionContext extends object = object, SetupContext extends object = object> = {
    /**
    ...
    action: {
         ...
         */
        getHref?(drilldownState: TDrilldownState, context: ExecutionContext): Promise<string | undefined>;
        /**
 ...
 */
export interface DrilldownEditorProps<TDrilldownState extends DrilldownState = DrilldownState, SetupContext extends object = object> {
    /**

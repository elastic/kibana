...
export const txtHelpText = i18n.translate(
  'embeddable.drilldowns.components.DrilldownHelloBar.helpText',
  {
    defaultMessage:
...
export const txtViewDocsLinkLabel = i18n.translate(
  'embeddable.drilldowns.components.DrilldownHelloBar.viewDocsLinkLabel',
  {
...
export const txtHideHelpButtonLabel = i18n.translate(
  'embeddable.drilldowns.components.DrilldownHelloBar.hideHelpButtonLabel',
  {
    defaultMessage: 'Hide',
  }
);

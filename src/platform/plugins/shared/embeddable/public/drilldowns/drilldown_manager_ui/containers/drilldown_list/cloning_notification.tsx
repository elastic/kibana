...
const txtDismiss = i18n.translate(
  'embeddableApi.drilldowns.containers.drilldownList.copyingNotification.dismiss',
  {
...
const txtBody = (count: number) =>
  i18n.translate('embeddableApi.drilldowns.containers.drilldownList.copyingNotification.body', {

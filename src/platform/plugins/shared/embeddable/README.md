...
| OPEN_FLYOUT_ADD_DRILLDOWN              | Create drilldown                                                                                  | ON_OPEN_PANEL_MENU         | HasDynamicActions, HasSupportedTriggers                                                                                                                        |
| OPEN_FLYOUT_EDIT_DRILLDOWN             | Edit drilldown                                                                                    | ON_OPEN_PANEL_MENU         | HasDynamicActions, HasSupportedTriggers                                                                                                                        |

...
Dashboard’s public panel union and generated OpenAPI include only embeddable types with a registered server schema (for example: `markdown`, `image`, `discover` session, and feature-flagged `vega`).

...
Commenting out code below to pay closer attention in successing PRs that will be removing setup guides across Kibana. (As part of effort to deprecate this plugin)

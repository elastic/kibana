...
export declare function createFilterAction(filterManager: FilterManager, timeFilter: TimefilterContract, coreStart: CoreStart, id: string, type: string): Promise<import("../../ui_actions/public").UiActionsActionDefinition<import(".").ApplyGlobalFilterActionContext>>;

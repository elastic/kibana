...
export declare function createSearchBar({ core, storage, data, usageCollection, isScreenshotMode, kql, cps, esql, licensing, }: StatefulSearchBarDeps): <QT extends AggregateQuery | Query = Query>(props: StatefulSearchBarProps<QT>) => React.JSX.Element;

...
export declare class UnifiedSearchPublicPlugin implements Plugin<UnifiedSearchPluginSetup, UnifiedSearchPublicPluginStart> {
    ...
    start(core: CoreStart, { data, dataViews, uiActions, screenshotMode, cps: crossProjectSearch, kql: { autocomplete: autocompleteStart }, esql, licensing, }: UnifiedSearchStartDependencies): UnifiedSearchPublicPluginStart;
}

...
type AggQuerySearchBarComp = <QT extends Query | AggregateQuery = Query>(props: StatefulSearchBarProps<QT>) => React.ReactElement;
/**
 ...
 */
export type FilterPanelOption = 'pinFilter' | 'editFilter' | 'negateFilter' | 'disableFilter' | 'deleteFilter';

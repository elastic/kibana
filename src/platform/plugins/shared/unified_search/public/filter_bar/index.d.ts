...
declare const LazyFilterItems: React.LazyExoticComponent<React.FC<import("react-intl").WithIntlProps<import(".").FilterItemsProps>> & {
    WrappedComponent: React.ComponentType<import(".").FilterItemsProps>;
}>;
/**

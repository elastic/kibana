...
declare const LazyFilterBar: React.LazyExoticComponent<React.FC<import("react-intl").WithIntlProps<import("./filter_bar").Props>> & {
    WrappedComponent: React.ComponentType<import("./filter_bar").Props>;
}>;

...
import { type Filter, type RangeFilter, type ScriptedRangeFilter, isRangeFilter } from '@kbn/es-query';
...
import { FILTER_OPERATORS, OPERATORS, type Operator } from './filter_operators';

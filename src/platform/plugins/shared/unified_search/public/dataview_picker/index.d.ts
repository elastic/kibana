 ...
 * a predefined fallback and error boundary.
 */
export declare const DataViewPicker: React.ForwardRefExoticComponent<import("@kbn/aiops-components").DataViewPickerProps & import("@kbn/shared-ux-utility").WithSuspenseExtendedDeps & React.RefAttributes<{}>>;

...
export declare const DataViewPicker: ({ isMissingCurrent, currentDataViewId, adHocDataViews, savedDataViews, onChangeDataView, onEditDataView, onAddField, onDataViewCreated, onClosePopover, trigger, selectableProps, onCreateDefaultAdHocDataView, isDisabled, getDataViewHelpText, }: DataViewPickerProps) => React.JSX.Element;

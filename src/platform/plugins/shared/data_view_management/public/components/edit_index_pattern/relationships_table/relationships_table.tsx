...
import type { HorizontalAlignment, EuiTableDataType, SearchFilterConfig } from '@elastic/eui';
import { EuiInMemoryTable, EuiText, EuiLink, EuiToolTip, EuiIcon } from '@elastic/eui';

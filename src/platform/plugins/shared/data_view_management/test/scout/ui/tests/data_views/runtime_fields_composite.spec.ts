...
const compositeFieldName = '@composite.test';
...
test.describe(
  ...
  () => {
    ...
    test('opens composite runtime field editor form', async ({ page }) => {
      await page.testSubj.click('addField');
      await page.testSubj.fill('nameField > input', compositeFieldName);

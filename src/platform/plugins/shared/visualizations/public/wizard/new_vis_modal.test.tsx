...
import { type TypesStart, VisGroups, type BaseVisType } from '../vis_types';
import NewVisModal, { type TypeSelectionProps } from './new_vis_modal';
import { type ApplicationStart, type DocLinksStart } from '@kbn/core/public';

...
import type { AggGroupNames, AggParam, AggGroupName, TimefilterContract } from '@kbn/data-plugin/public';
...
type DefaultEditorOptionsComponent<TVisParams> = React.ComponentType<VisEditorOptionsProps<TVisParams>>;
...
export interface VisTypeDefinition<TVisParams extends VisParams> {
     ...
     */
    readonly navigateToLens?: (vis?: Vis<TVisParams>, timeFilter?: TimefilterContract) => Promise<NavigateToLensContext | null> | undefined;
    /**
     ...
     */
    readonly getExpressionVariables?: (vis?: Vis<TVisParams>, timeFilter?: TimefilterContract) => Promise<Record<string, unknown>>;
    /**

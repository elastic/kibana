...
export declare class BaseVisType<TVisParams extends VisParams = VisParams> {
    ...
    readonly navigateToLens: ((vis?: import("..").Vis<TVisParams> | undefined, timeFilter?: import("../../../data/public").TimefilterContract) => Promise<import("@kbn/lens-common").NavigateToLensContext | null> | undefined) | undefined;
    readonly getExpressionVariables: ((vis?: import("..").Vis<TVisParams> | undefined, timeFilter?: import("../../../data/public").TimefilterContract) => Promise<Record<string, unknown>>) | undefined;
    readonly icon: import("@elastic/eui/src/components/icon/icon").IconType | undefined;
    readonly image: string | undefined;
    readonly stage: "production" | "beta" | "experimental";
    ...
    readonly setup: ((vis: import("..").Vis<TVisParams>) => Promise<import("..").Vis<TVisParams>>) | undefined;
    ...
    readonly usesEsql: ((visParams: VisParams) => boolean) | undefined;
    ...
    readonly toExpressionAst: import("..").VisToExpressionAst<TVisParams>;
    readonly getInfoMessage: ((vis: import("..").Vis) => React.ReactNode) | undefined;

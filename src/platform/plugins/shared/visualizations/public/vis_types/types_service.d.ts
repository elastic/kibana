...
export declare class TypesService {
    ...
    setup(): {
         ...
         * @param config - visualization type definition
         */
        createBaseVisualizationAsync: <TVisParams extends VisParams>(name: string, getVisDefinition: () => Promise<VisTypeDefinition<TVisParams>>) => void;
        /**
    ...
    start(): {
         ...
         */
        get: <TVisParams extends VisParams>(visualization: string) => Promise<BaseVisType<TVisParams> | undefined>;
        /**
         * returns all registered visualization types
         */
        all: () => Promise<BaseVisType<any>[]>;
        /**
         ...
         */
        getByGroup: (group: VisGroups) => Promise<BaseVisType<any>[]>;
    };
    stop(): void;
}
/** @internal */

...
const getReadOnlyBadgeText = () =>
  i18n.translate('visualizations.badge.readOnly.text', {
    defaultMessage: 'Read only',
  });

const getReadOnlyBadgeTooltip = () =>
  i18n.translate('visualizations.badge.readOnly.tooltip', {
    defaultMessage: 'Unable to save visualizations to the library',
  });

export const getReadOnlyBadge = (): AppHeaderBadge => ({
  label: getReadOnlyBadgeText(),

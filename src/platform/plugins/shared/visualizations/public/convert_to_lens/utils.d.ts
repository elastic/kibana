...
export declare const getBucketCollapseFn: (metrics: Array<SchemaConfig<SupportedAggregation>>, customBucketColumns: AggBasedColumn[], customBucketsMap: Record<string, string>, metricColumns: AggBasedColumn[]) => Record<"min" | "max" | "sum" | "avg", string[]>;

...
import { type IAggConfig, type METRIC_TYPES, type TimefilterContract } from '@kbn/data-plugin/public';
import { type AggBasedColumn, type PercentageModeConfig, type SchemaConfig, type VisParams } from '../../common';
...
import { getVisSchemas, type Schemas } from '../vis_schemas';
import {
  getBucketCollapseFn,
  getBucketColumns,

...
import {
  ...
  type VisualizeSavedObjectInputState,
  type VisualizeSerializedState,
  type VisualizeRuntimeState,
  type VisualizeSavedVisInputState,
  type ExtraSavedObjectProperties,

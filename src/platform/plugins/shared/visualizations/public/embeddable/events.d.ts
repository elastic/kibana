import type { ALERT_RULE_TRIGGER, ON_CLICK_ROW, ON_APPLY_FILTER, ON_SELECT_RANGE, ON_CLICK_VALUE, MULTI_VALUE_CLICK_TRIGGER } from '@kbn/ui-actions-plugin/common/trigger_ids';

...
import { ON_APPLY_FILTER, ON_OPEN_PANEL_MENU, ON_SELECT_RANGE } from '@kbn/ui-actions-plugin/common/trigger_ids';
...
export const getVisualizeEmbeddableFactory: (deps: {
  ...
  buildEmbeddable: async ({
    ...
    const api = finalizeApi({
      ...
      supportedTriggers: () => [ON_OPEN_PANEL_MENU, ACTION_CONVERT_TO_LENS, ON_APPLY_FILTER, ON_SELECT_RANGE],
      serializeState: () => {

...
import type { Operation, BaseColumn as GenericBaseColumn, Column as BaseColumn, GenericColumnWithMeta, PercentileColumn as BasePercentileColumn, PercentileRanksColumn as BasePercentileRanksColumn, FormulaColumn as BaseFormulaColumn, LastValueColumn as BaseLastValueColumn, AvgColumn as BaseAvgColumn, CountColumn as BaseCountColumn, CardinalityColumn as BaseCardinalityColumn, MaxColumn as BaseMaxColumn, MedianColumn as BaseMedianColumn, MinColumn as BaseMinColumn, SumColumn as BaseSumColumn, CumulativeSumColumn as BaseCumulativeSumColumn, MovingAverageColumn as BaseMovingAverageColumn, DerivativeColumn as BaseDerivativeColumn, DateHistogramColumn as BaseDateHistogramColumn, TermsColumn as BaseTermsColumn, FiltersColumn as BaseFiltersColumn, RangeColumn as BaseRangeColumn, AnyMetricColumnWithSourceFieldWithMeta, Meta } from '../../types';
export type MetricsWithField = Exclude<METRIC_TYPES, METRIC_TYPES.FILTERED_METRIC | METRIC_TYPES.AVG_BUCKET | METRIC_TYPES.SUM_BUCKET | METRIC_TYPES.MAX_BUCKET | METRIC_TYPES.MIN_BUCKET | METRIC_TYPES.MOVING_FN | METRIC_TYPES.CUMULATIVE_SUM | METRIC_TYPES.DERIVATIVE | METRIC_TYPES.SERIAL_DIFF | METRIC_TYPES.COUNT>;
...
export type SiblingPipelineMetric = METRIC_TYPES.AVG_BUCKET | METRIC_TYPES.SUM_BUCKET | METRIC_TYPES.MIN_BUCKET | METRIC_TYPES.MAX_BUCKET;
export type BucketColumn = DateHistogramColumn | TermsColumn | FiltersColumn | RangeColumn;
export interface CommonColumnConverterArgs<Agg extends SupportedAggregation = SupportedAggregation> {
    agg: SchemaConfig<Agg>;
    dataView: DataView;
    visType: string;
}
export interface ExtendedColumnConverterArgs<Agg extends SupportedAggregation = SupportedAggregation> extends CommonColumnConverterArgs<Agg> {
    aggs: Array<SchemaConfig<METRIC_TYPES>>;
}
export interface CommonBucketConverterArgs<Agg extends SupportedAggregation = SupportedAggregation> {
    visType: string;
    agg: SchemaConfig<Agg>;
    dataView: DataView;

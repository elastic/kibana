...
import type { AvgIndexPatternColumn, CardinalityIndexPatternColumn, CountIndexPatternColumn, CounterRateIndexPatternColumn, CumulativeSumIndexPatternColumn, DataType, DateHistogramIndexPatternColumn, DerivativeIndexPatternColumn, FiltersIndexPatternColumn, FormulaIndexPatternColumn, GenericIndexPatternColumn, LastValueIndexPatternColumn, MaxIndexPatternColumn, MedianIndexPatternColumn, MinIndexPatternColumn, MovingAverageIndexPatternColumn, PercentileIndexPatternColumn, PercentileRanksIndexPatternColumn, RangeIndexPatternColumn, StandardDeviationIndexPatternColumn, StaticValueIndexPatternColumn, SumIndexPatternColumn, TermsIndexPatternColumn, TimeScaleUnit, ValueFormatConfig } from '@kbn/lens-common';
...
export interface ColumnWithSourceField<Op extends OperationWithSourceField, Params = undefined> extends BaseColumn<Op, Params> {
    sourceField: string;
}
export interface ColumnWithReferences<Op extends OperationWithReferences, Params = undefined> extends BaseColumn<Op, Params> {
    references: string[];
}
...
export type TermsColumn = ToBaseColumnFormat<Omit<TermsIndexPatternColumn, 'params'> & {
...
export type LastValueColumn = Omit<ToBaseColumnFormat<LastValueIndexPatternColumn>, 'params'> & {
    params: Omit<LastValueIndexPatternColumn['params'], 'sortField'> & {
        sortField?: string;
    };
};
...
export type AnyColumnWithSourceField = RangeColumn | TermsColumn | DateHistogramColumn | AnyMetricColumnWithSourceField;
export type AnyMetricColumnWithSourceField = MinColumn | MaxColumn | AvgColumn | SumColumn | MedianColumn | StandardDeviationColumn | CardinalityColumn | PercentileColumn | PercentileRanksColumn | CountColumn | LastValueColumn;
export type AnyColumnWithReferences = CumulativeSumColumn | CounterRateColumn | DerivativeColumn | MovingAverageColumn | FormulaColumn | StaticValueColumn;
...
export type GenericColumnWithMeta<Col extends Column | {}, MetaData extends {} | unknown = undefined> = Col & (MetaData extends undefined ? undefined : {
    meta: MetaData;
});
...
export type AnyMetricColumnWithSourceFieldWithMeta = GenericColumnWithMeta<AnyMetricColumnWithSourceField, Meta>;
export type AnyBucketColumnWithMeta = GenericColumnWithMeta<DateHistogramColumn | TermsColumn | FiltersColumn | RangeColumn, Meta>;

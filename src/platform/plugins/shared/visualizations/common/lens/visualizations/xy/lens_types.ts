...
import type { AxesSettingsConfig, EventAnnotationConfig } from '@kbn/visualizations-plugin/common';
import type {
  LegendConfig,
  AxisExtentConfig,
  XYCurveType,
...
import { SeriesTypes, YAxisModes } from './constants';
import { ValueLabelConfig } from '../../lens_types';

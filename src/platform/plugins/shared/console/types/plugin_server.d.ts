...
declare class ElasticsearchConfig implements IElasticsearchConfig {
	/**
	 * @internal
...
declare class EsLegacyConfigService {
	/**
	 ...
	 */
	private cloudUrl?;
	setup(config$: Observable<ElasticsearchConfig>, cloud?: CloudSetup): void;
	stop(): void;
	readConfig(): Promise<ElasticsearchConfig>;
...
declare class SpecDefinitionsService {
	...
	addEndpointDescription(endpoint: string, description?: EndpointDescription, docsLinkToApiReference?: boolean): void;
	asJson(): {
		name: string;
...
declare const schemaLatest: ObjectType<{
	ui: ObjectType<{
		enabled: Type<boolean>;
		embeddedEnabled: Type<boolean>;
	}>;
	autocompleteDefinitions: ObjectType<{
		endpointsAvailability: Type<"stack" | "serverless">;
	}>;
}>;
...
export declare class ConsoleServerPlugin implements Plugin$1<ConsoleSetup, ConsoleStart> {
...
interface SpecDefinitionsDependencies {
...
type ConsoleConfig = TypeOf<typeof schemaLatest>;
type ConsoleSetup = ReturnType<ConsoleServerPlugin["setup"]> extends Promise<infer U> ? U : ReturnType<ConsoleServerPlugin["setup"]>;
...
type DefinitionUrlParams = Record<string, unknown>;

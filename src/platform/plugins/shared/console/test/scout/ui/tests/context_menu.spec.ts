...
test.describe('Console context menu', { tag: tags.deploymentAgnostic }, () => {
  ...
  test('opens with the copy, documentation and auto indent actions', async ({ pageObjects }) => {
  ...
  test('shows the keyboard shortcut badges of the auto indent and API reference actions', async ({
    pageObjects,
  }) => {
  ...
  test('auto indents the current request', async ({ pageObjects }) => {
  ...
  test('auto indents a comment inside the request body to its nesting level', async ({
    pageObjects,
  }) => {
    await pageObjects.console.clearEditorText();
  ...
  test('opens the API reference of the current request in a new tab', async ({
    page,
    pageObjects,
  }) => {
    await pageObjects.console.openContextMenu();

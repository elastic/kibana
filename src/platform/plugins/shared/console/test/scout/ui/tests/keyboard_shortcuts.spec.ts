...
test.describe('Console keyboard shortcuts', { tag: tags.deploymentAgnostic }, () => {
  ...
  test('opens and closes the shortcuts popover', async ({ pageObjects }) => {
  ...
  test('executes the request on Ctrl+Enter', async ({ pageObjects }) => {
  ...
  test('auto indents the current request on Ctrl+I', async ({ pageObjects }) => {
  ...
  test('jumps to the previous request on Ctrl+Up', async ({ pageObjects }) => {
  ...
  test('jumps back to the next request on Ctrl+Down', async ({ pageObjects }) => {
    await pageObjects.console.enterText(`${KIBANA_REQUEST}\n${SEARCH_REQUEST}`);
  ...
  test('opens the API reference of the current request on Ctrl+/', async ({
    page,
    pageObjects,
  }) => {
  ...
  test('stops handling shortcuts once they are turned off', async ({ pageObjects }) => {
    await pageObjects.console.enterText(SEARCH_REQUEST);

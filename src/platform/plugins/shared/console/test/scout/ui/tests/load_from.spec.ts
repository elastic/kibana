...
test.describe('Console load_from deep links', { tag: tags.deploymentAgnostic }, () => {
  ...
  test('appends the request carried in the data URI to the editor content', async ({
    pageObjects,
  }) => {
  ...
  test('shows an error toast when the data URI cannot be decoded', async ({
    pageObjects,
    page,
  }) => {

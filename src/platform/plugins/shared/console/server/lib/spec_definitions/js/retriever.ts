...
export const retriever = (specService: SpecDefinitionsService) => {
  specService.addGlobalAutocompleteRules('retriever', {
    ...
    pinned: {
      ...
      ids: {
        __description:
          "Specify an array of document IDs to pin. Only one of 'ids' or 'docs' can be used.",
      },
      docs: {
        __description:
          "Specify an array of full documents to pin. Only one of 'ids' or 'docs' can be used.",
      },
      match_criteria: {},
      rank_window_size: 10,
    },

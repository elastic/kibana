...
type MarkerRef = any;
export type EditorEvent = 'tokenizerUpdate' | 'changeCursor' | 'changeScrollTop' | 'change' | 'changeSelection' | 'changeFold';
export type AutoCompleterFunction = (pos: Position, prefix: string, callback: (e: Error | null, result: ResultTerm[] | null) => void, annotationControls: {

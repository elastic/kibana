...
export interface DataViewsServicePublicMethods {
     ...
     * @param displayErrors - If set false, API consumer is responsible for displaying and handling errors.
     */
    createAndSave: (spec: DataViewSpec, override?: boolean, skipFetchFields?: boolean, displayErrors?: boolean) => Promise<DataView>;
    /**
     * Save data view
     ...
     */
    getFieldsForIndexPattern: (indexPattern: DataView | DataViewSpec, options?: Omit<GetFieldsOptions, 'allowNoIndex' | 'pattern'>) => Promise<FieldSpec[]>;
    /**
     ...
     */
    refreshFields: (indexPattern: DataView, displayErrors?: boolean, forceRefresh?: boolean) => Promise<void>;
    /**
...
export declare class DataViewsService {
     ...
     * @param displayErrors  - If set false, API consumer is responsible for displaying and handling errors.
     */
    refreshFields: (dataView: DataView, displayErrors?: boolean, forceRefresh?: boolean) => Promise<void>;
    /**
     ...
     * @param displayErrors - If set false, API consumer is responsible for displaying and handling errors.
     */
    createAndSave(spec: DataViewSpec, overwrite?: boolean, skipFetchFields?: boolean, displayErrors?: boolean): Promise<DataView>;
    /**

...
import { type FieldFormatsStartCommon, FORMATS_UI_SETTINGS } from '@kbn/field-formats-plugin/common';
...
import {
  ...
  type FieldAttrs,
  type FieldAttrsAsObject,
  type FieldSpec,
  type DataViewFieldMap,
  type TypeMeta,
} from '../types';

import { META_FIELDS, type SavedObject } from '..';

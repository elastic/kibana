...
describe('#get', () => {
  it('calls rpcClient.get with input and returns output', async () => {
    ...
    expect(crudClient.get).toHaveBeenCalledWith({ ...input, version: 3 }); // latest version added
  });
  ...
  it('does not add the latest version if one is passed', async () => {
    ...
    expect(crudClient.get).toHaveBeenCalledWith(input);
  });
...
describe('#create', () => {
  it('calls rpcClient.create with input and returns output', async () => {
    ...
    expect(crudClient.create).toHaveBeenCalledWith({ ...input, version: 3 }); // latest version added
  });
  ...
  it('does not add the latest version if one is passed', async () => {
    ...
    expect(crudClient.create).toHaveBeenCalledWith(input);
  });
});
...
describe('#update', () => {
  it('calls rpcClient.update with input and returns output', async () => {
    ...
    expect(crudClient.update).toHaveBeenCalledWith({ ...input, version: 3 }); // latest version added
  });
  ...
  it('does not add the latest version if one is passed', async () => {
    ...
    expect(crudClient.update).toHaveBeenCalledWith(input);
  });
});
...
describe('#delete', () => {
  it('calls rpcClient.delete with input and returns output', async () => {
    ...
    expect(crudClient.delete).toHaveBeenCalledWith({ ...input, version: 3 }); // latest version added
  });
  ...
  it('does not add the latest version if one is passed', async () => {
    ...
    expect(crudClient.delete).toHaveBeenCalledWith(input);
  });
});
...
describe('#search', () => {
  it('calls rpcClient.search with input and returns output', async () => {
    ...
    expect(crudClient.search).toHaveBeenCalledWith({ ...input, version: 3 }); // latest version added
  });
  ...
  it('does not add the latest version if one is passed', async () => {
    ...
    expect(crudClient.search).toHaveBeenCalledWith(input);
  });
...
describe('#mSearch', () => {
  it('calls rpcClient.mSearch with input and returns output', async () => {
    ...
    expect(crudClient.mSearch).toHaveBeenCalledWith({

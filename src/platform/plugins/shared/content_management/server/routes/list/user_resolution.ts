 ...
 *
 * Uses the Kibana user profile `bulkGet` API to fetch profile data including username,
 * email, full name, and avatar. Failed lookups are logged as warnings but don't fail
 * the operation—the returned map will simply be missing entries for failed UIDs.
 *

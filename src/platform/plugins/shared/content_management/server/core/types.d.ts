...
import type { Version, ContentManagementServiceTransforms, ContentManagementServiceDefinitionVersioned } from '@kbn/object-versioning';
import type { SavedObjectsFindResult } from '@kbn/core-saved-objects-api-server';
import type { KibanaRequest } from '@kbn/core/server';
import type { GetResult, BulkGetResult, CreateResult, UpdateResult, DeleteResult, SearchQuery, SearchResult } from '../../common';
export type StorageContextGetTransformFn = (definitions: ContentManagementServiceDefinitionVersioned, requestVersion?: Version) => ContentManagementServiceTransforms;
...
export interface ContentStorage<T = unknown, U = T, TMSearchConfig extends MSearchConfig<T, any> = MSearchConfig<T, unknown>> {
    /** Get a single item */
    ...
    /** Update an item */
    update(ctx: StorageContext, id: string, data: object, options?: object): Promise<UpdateResult<U, any>>;
    /** Delete an item */
...
export interface MSearchConfig<T = unknown, TSavedObjectAttributes = unknown> {
     ...
     */
    toItemResult: (ctx: StorageContext, savedObject: SavedObjectsFindResult<TSavedObjectAttributes>) => T;
    /**

...
export declare const aiClassifyStepDefinition: (coreSetup: CoreSetup<WorkflowsExtensionsServerPluginStartDeps>) => import("../../../step_registry/types").ServerStepDefinition<import("zod").ZodObject<{

...
import { dataToJsonStepDefinition } from './data_to_json_step';
import type { StepHandlerContext } from '../../step_registry/types';

describe('dataToJsonStepDefinition', () => {
  ...
  describe('basic stringification', () => {
    it('should stringify an object', async () => {
      ...
      const result = await dataToJsonStepDefinition.handler(context);

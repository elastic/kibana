...
import type { ManagedWorkflowsSystemApiProvider, PluginScopedManagedWorkflowsApi, WorkflowsApiRequestHandlerContext, WorkflowsClient, WorkflowsClientProvider } from '@kbn/workflows/server/types';
...
export type ServerTriggerDefinition<EventSchema extends z.ZodType = z.ZodType> = CommonTriggerDefinition<EventSchema>;
/**
...
export type ServerStepDefinitionOrLoader<Input extends z.ZodType = z.ZodType, Output extends z.ZodType = z.ZodType, Config extends z.ZodObject = z.ZodObject> = ServerStepDefinition<Input, Output, Config> | (() => Promise<ServerStepDefinition<Input, Output, Config> | undefined>);
/**

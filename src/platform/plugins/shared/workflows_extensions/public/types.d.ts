...
export type PublicStepDefinitionOrLoader<Input extends z.ZodType = z.ZodType, Output extends z.ZodType = z.ZodType, Config extends z.ZodObject = z.ZodObject> = PublicStepDefinition<Input, Output, Config> | (() => Promise<PublicStepDefinition<Input, Output, Config>>);

...
export type PublicStepDefinitionOrLoader<Input extends z.ZodType = z.ZodType, Output extends z.ZodType = z.ZodType, Config extends z.ZodObject = z.ZodObject> = PublicStepDefinition<Input, Output, Config> | (() => Promise<PublicStepDefinition<Input, Output, Config> | undefined>);
export type PublicTriggerDefinitionOrLoader<EventSchema extends z.ZodType = z.ZodType> = PublicTriggerDefinition<EventSchema> | (() => Promise<PublicTriggerDefinition<EventSchema>>);
/**
...
export interface WorkflowsExtensionsPublicPluginSetup {
     ...
     */
    registerStepDefinition<Input extends z.ZodType = z.ZodType, Output extends z.ZodType = z.ZodType, Config extends z.ZodObject = z.ZodObject>(definition: PublicStepDefinitionOrLoader<Input, Output, Config>): void;
    /**
     ...
     */
    registerTriggerDefinition<EventSchema extends z.ZodType = z.ZodType>(definition: PublicTriggerDefinitionOrLoader<EventSchema>): void;
}
/**
 ...
 */
export type WorkflowsExtensionsPublicPluginStart = WorkflowsExtensionsStartContract<PublicStepDefinition> & TriggerRegistryStartContract;
/**

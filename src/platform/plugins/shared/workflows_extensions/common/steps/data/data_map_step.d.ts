...
export declare const MAP_BINDING_IDENTIFIER_REGEX: RegExp;
export declare const DEFAULT_ITEM_BINDING = "item";
export declare const DEFAULT_INDEX_BINDING = "index";
/**

...
import React, { useState, useEffect, useCallback, type RefCallback } from 'react';
import { useResizeObserver } from '@elastic/eui';
import {
  type ShapeRef,
  type ShapeAttributes,
  type ShapeContentAttributes,
  type SvgConfig,
  getDefaultShapeData,
} from '../reusable';
import { type Dimensions, type ShapeComponentProps } from './types';

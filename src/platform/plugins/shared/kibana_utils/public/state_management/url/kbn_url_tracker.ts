...
import { createHashHistory, type History, type UnregisterCallback } from 'history';
import { type BehaviorSubject, type Observable, type Subscription } from 'rxjs';
import { type AppUpdater, type ToastsSetup } from '@kbn/core/public';

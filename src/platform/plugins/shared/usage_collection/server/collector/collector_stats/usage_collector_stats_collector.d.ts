...
export declare const usageCollectorsStatsCollector: (usageCollection: Pick<ICollectorSet, "makeUsageCollector">, { nonReadyCollectorTypes, timedOutCollectorsTypes, isReadyExecutionDurationByType, fetchExecutionDurationByType, }: CollectorsStatsCollectorParams) => import("..").Collector<CollectorsStats, {}>;

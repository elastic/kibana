...
import type { ApplicationStart, IUiSettingsClient, NotificationsStart, DocLinksStart, HttpSetup, OverlayStart } from '@kbn/core/public';
import type { EuiComboBoxOptionOption } from '@elastic/eui';
import type { DataView, DataViewsServicePublic, INDEX_PATTERN_TYPE, MatchedItem } from '@kbn/data-views-plugin/public';

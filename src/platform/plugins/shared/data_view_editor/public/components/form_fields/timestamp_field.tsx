...
import { EuiFormRow, EuiComboBox, EuiFormHelpText, type EuiComboBoxOptionOption } from '@elastic/eui';
...
import { type TimestampOption, type MatchedIndicesSet } from '../../types';

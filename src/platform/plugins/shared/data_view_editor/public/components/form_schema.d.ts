...
export declare const schema: {
    title: {
        ...
        defaultValue: string;
        validations: {
            validator: (data: import("../shared_imports").ValidationFuncArg<import("@kbn/ingest-pipelines-plugin/public/shared_imports").FormData, unknown>) => ReturnType<ValidationFunc>;
        }[];
    };
    name: {
        label: string;

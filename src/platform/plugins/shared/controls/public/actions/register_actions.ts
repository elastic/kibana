...
export function registerActions(uiActions: UiActionsStart) {
  ...
  uiActions.attachAction(PANEL_HOVER_TRIGGER, ACTION_DELETE_CONTROL);
  ...
  uiActions.attachAction(PANEL_HOVER_TRIGGER, ACTION_EDIT_CONTROL);
  ...
  uiActions.attachAction(PANEL_HOVER_TRIGGER, ACTION_CLEAR_CONTROL);
}
...
export const ControlRendererDefault = memo(
  ({ disableMultiValueEmptySelection = false }: { disableMultiValueEmptySelection?: boolean }) => {
    ...
    const [
      excludeSelected, // whether the filter is negated
      existsSelected,
      selectedOptions,
      invalidSelections,
      field,
...
ControlRendererDefault.displayName = 'ControlRendererDefault';

...
import type { OptionsListSelection, OptionsListSortingType, DataControlState, OptionsListDSLControlState } from '@kbn/controls-schemas';
...
export type OptionsListControlApi = DefaultEmbeddableApi<OptionsListDSLControlState> & DataControlApi & PublishesUnsavedChanges & {
 ...
 * by the component
 */
export type OptionsListComponentState = Pick<DataControlState, 'field_name'> & SelectionsState & EditorState & TemporaryState<OptionsListSelection> & {
 ...
 */
Omit<OptionsListComponentState, 'title'> & {
    label: string;
}>;
type DSLOptionsListComponentStateSetters = SettersOf<OptionsListComponentState>;
export type DSLOptionsListComponentApi = HasType & HasUniqueId & PublishesField & OptionsListPublishesOptions<OptionsListSelection> & PublishesDSLOptionsListComponentState & DataControlApi & DSLOptionsListComponentStateSetters & OptionsListSelectionsApi & {

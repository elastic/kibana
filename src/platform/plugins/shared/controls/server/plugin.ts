...
import { optionsListPersistableState, rangeSliderPersistableState } from './bwc';
...
export class ControlsPlugin implements Plugin<object, object, SetupDeps> {
  public setup(core: CoreSetup, { embeddable, unifiedSearch }: SetupDeps) {
    embeddable.bwc.registerPersistableState(OPTIONS_LIST_CONTROL, optionsListPersistableState);
    embeddable.bwc.registerPersistableState(RANGE_SLIDER_CONTROL, rangeSliderPersistableState);

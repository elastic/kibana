...
export declare const JsonCodeEditorCommon: ({ jsonValue, width, height, hasLineNumbers, onEditorDidMount, hideCopyButton, enableFindAction, }: JsonCodeEditorCommonProps) => React.JSX.Element | null;

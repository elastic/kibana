...
export function PercentOfParent({ duration, totalDuration, parentType }: PercentOfParentProps) {
  ...
  const percentOfParentText = i18n.translate(
    'unifiedDocViewer.observability.traces.duration.percentOfParent',
    {
      defaultMessage:
      ...
      {isOver100 ? (
        <EuiToolTip
          content={i18n.translate(
            'unifiedDocViewer.observability.traces.duration.percentOfTraceLabelExplanation',
            {
              defaultMessage:

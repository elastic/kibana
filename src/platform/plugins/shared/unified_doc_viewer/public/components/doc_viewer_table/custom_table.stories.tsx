...
import type { CustomTableProps } from './custom_table';
import { CustomTable, GRID_COLUMN_FIELD_NAME, GRID_COLUMN_FIELD_VALUE } from './custom_table';
...
type Args = UnifiedDocViewerStorybookArgs<CustomTableProps>;
const meta = {
  title: 'Doc viewers/CustomTable',

...
export declare const setKibanaServices: (esql: EsqlPluginStart, kibanaCore: CoreStart, data: DataPublicPluginStart, storage: Storage, uiActions: UiActionsStart, kql: KqlPluginStart, fieldsMetadata?: FieldsMetadataPublicStart, usageCollection?: UsageCollectionStart) => void;

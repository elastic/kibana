...
export declare function ValueControlForm({ variableType, initialState, queryString, variableName, controlFlyoutType, search, setControlState, valuesRetrieval, timeRange, esqlVariables, }: ValueControlFormProps): React.JSX.Element;
export {};

...
export declare class CreateESQLControlAction implements Action<Context> {
    ...
    execute({ queryString, variableType, esqlVariables, onSaveControl, onCancelControl, cursorPosition, initialState, parentApi, triggerSource, controlId, returnFocus, }: Context): Promise<void>;
}
export {};

...
export declare class EsqlService {
     ...
     */
    getAllIndices(scope?: 'local' | 'all' | 'remote'): Promise<ESQLSourceResult[]>;
     ...
     */
    getInferenceEndpoints(taskType: InferenceTaskType): Promise<InferenceEndpointsAutocompleteResult>;
    /**

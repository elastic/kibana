...
We need to register the new command in the `kbn-esql-language` [package](https://github.com/elastic/kibana/blob/main/src/platform/packages/shared/esql/kbn-esql-language/README.md) in order to activate the autocomplete and validation features.

All commands are registered in our commands registry. Read [the doc](https://github.com/elastic/kibana/blob/main/src/platform/packages/shared/esql/kbn-esql-language/src/commands/registry/README.md) for context.
...
You can read how suggestions work [here](https://github.com/elastic/kibana/blob/main/src/platform/packages/shared/esql/kbn-esql-language/README.md#autocomplete-1).

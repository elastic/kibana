...
type Required<T> = T extends FormData ? {
...
export interface FormHook<T extends FormData = FormData, I extends FormData = T> {
     ...
     */
    submit: (e?: FormEvent<HTMLFormElement> | MouseEvent) => Promise<{
        data: T;
        isValid: boolean;
    }>;
     ...
     * ```
     */
    updateFieldValues: (updatedFormData: Partial<T> & FormData, options?: {
        /**
    ...
    __readFieldConfigFromSchema: <FieldType = unknown, FormType = FormData, InternalFieldType = FieldType>(fieldPath: string) => FieldConfig<FieldType, FormType, InternalFieldType> | undefined;
 ...
 * `react-hook-form` for new and existing forms.
 */
export type OnUpdateHandler<T extends FormData = FormData, I extends FormData = T> = (arg: OnFormUpdateArg<T, I>) => void;
/**
 * @deprecated `hook_form_lib` is deprecated and will no longer be supported. Consider using
 * `react-hook-form` for new and existing forms.
 */
 ...
 * `react-hook-form` for new and existing forms.
 */
export type FormSubmitHandler<T extends FormData = FormData> = (formData: T, isValid: boolean) => Promise<void>;
/**
 * @deprecated `hook_form_lib` is deprecated and will no longer be supported. Consider using
 * `react-hook-form` for new and existing forms.
 */
 ...
 * `react-hook-form` for new and existing forms.
 */
export type ValidationFunc<I extends FormData = FormData, E extends string = string, V = unknown> = (data: ValidationFuncArg<I, V>) => ValidationError<E> | void | undefined | ValidationCancelablePromise<E>;
/**
 * @deprecated `hook_form_lib` is deprecated and will no longer be supported. Consider using
 * `react-hook-form` for new and existing forms.
 */
export type ValidationResponsePromise<E extends string = string> = Promise<ValidationError<E> | void | undefined>;
/**
 * @deprecated `hook_form_lib` is deprecated and will no longer be supported. Consider using
 * `react-hook-form` for new and existing forms.
 */
export type ValidationCancelablePromise<E extends string = string> = ValidationResponsePromise<E> & {
    cancel?(): void;
};
/**
 * @deprecated `hook_form_lib` is deprecated and will no longer be supported. Consider using
 ...
 * `react-hook-form` for new and existing forms.
 */
export interface ValidationConfig<I extends FormData = FormData, E extends string = string, V = unknown> {

...
declare function UseFieldComp<T = unknown, FormType = FormData, I = T>(props: Props<T, FormType, I>): React.JSX.Element | null;
/**
 * @deprecated `hook_form_lib` is deprecated and will no longer be supported. Consider using
 * `react-hook-form` for new and existing forms.
 */
export declare const UseField: typeof UseFieldComp;
/**
 ...
 * </Form>
 */
export declare function getUseField<T1 = unknown, FormType1 = FormData, I1 = T1>(partialProps: Partial<Props<T1, FormType1, I1>>): <T2 = T1, FormType2 = FormType1, I2 = I1>(props: Partial<Props<T2, FormType2, I2>>) => React.JSX.Element;
export {};

...
export declare const SavedObjectFinderUi: React.FC<import("@kbn/shared-ux-table-persist").HOCProps<SavedObjectFinderItem, Omit<SavedObjectFinderProps & EuiTablePersistInjectedProps<SavedObjectFinderItem>, "euiTablePersist">>>;

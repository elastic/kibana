...
import type { CoreStart, SavedObjectAttributes, SavedObjectReference } from '@kbn/core/public';
import type { ISearchSource, SerializedSearchSourceFields } from '@kbn/data-plugin/public';

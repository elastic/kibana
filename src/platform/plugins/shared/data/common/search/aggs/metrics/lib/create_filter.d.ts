...
export declare const createTopHitFilter: <TMetricAggConfig extends AggConfig = IMetricAggConfig>(aggConfig: TMetricAggConfig, key: string) => import("@kbn/es-query").PhraseFilter | import("@kbn/es-query").CombinedFilter | import("@kbn/es-query").ScriptedPhraseFilter | undefined;

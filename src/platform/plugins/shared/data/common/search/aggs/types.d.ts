...
export interface AggsCommonStart {
    ...
    createAggConfigs: (indexPattern: DataView, configStates?: CreateAggConfigParams[], options?: Partial<AggConfigsOptions>) => InstanceType<typeof AggConfigs>;
...
/** @internal */
export type AggExpressionFunctionArgs<Name extends keyof SerializedAggParamsMapping> = SerializedAggParamsMapping[Name] & Pick<AggConfigSerialized, 'id' | 'enabled' | 'schema'>;
/**

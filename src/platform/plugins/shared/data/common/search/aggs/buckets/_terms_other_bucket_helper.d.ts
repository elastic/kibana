...
export declare const createOtherBucketPostFlightRequest: (otherFilterBuilder: (requestAgg: Record<string, any>, key: string, otherAgg: IAggConfig) => Filter) => (resp: estypes.SearchResponse<any>, aggConfigs: IAggConfigs, aggConfig: import("..").AggConfig, searchSource: import("../..").ISearchSource, inspectorRequestAdapter?: import("../../../../../inspector/common").RequestAdapter, abortSignal?: AbortSignal, searchSessionId?: string, disableWarningToasts?: boolean) => Promise<estypes.SearchResponse<any>>;

...
export declare const aggBucketMinFnName = "aggBucketMin";
type Input = any;
...
type FunctionDefinition = ExpressionFunctionDefinition<typeof aggBucketMinFnName, Input, Arguments, Output>;
export declare const aggBucketMin: () => FunctionDefinition;
export {};

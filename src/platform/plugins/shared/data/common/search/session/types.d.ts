...
export declare const SEARCH_SESSION_TYPE = "search-session";
...
export interface SearchSessionStatusesResponse {
     ...
     */
    sessions: Record<string, Pick<SearchSessionSavedObjectAttributes, 'name' | 'restoreState' | 'locatorId' | 'appId'>>;
    /**
 ...
 */
export type SearchSessionsFindResponse = SavedObjectsFindResponse<SearchSessionSavedObjectAttributes> & {
    statuses: Record<string, SearchSessionStatusResponse>;
};

 ...
 */
export declare function textBasedQueryStateToExpressionAst({ filters, query, inputQuery, time, timeFieldName, titleForInspector, descriptionForInspector, }: Args): import("@kbn/expressions-plugin/common").ExpressionAstExpression;
export {};

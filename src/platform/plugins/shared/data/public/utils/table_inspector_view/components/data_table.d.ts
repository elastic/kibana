...
export declare const DataTableFormat: React.FC<import("@kbn/shared-ux-table-persist").HOCProps<DatatableRow, Omit<DataTableFormatProps & EuiTablePersistInjectedProps<DatatableRow>, "euiTablePersist">>>;
export {};

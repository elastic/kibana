...
export declare class Timefilter {
     ...
     */
    createFilter: (indexPattern: DataView, timeRange?: TimeRange) => import("@kbn/es-query").RangeFilter | import("@kbn/es-query").ScriptedRangeFilter | import("@kbn/es-query/src/filters/build_filters").MatchAllRangeFilter | undefined;
    /**
     ...
     */
    createRelativeFilter: (indexPattern: DataView, timeRange?: TimeRange) => import("@kbn/es-query").RangeFilter | import("@kbn/es-query").ScriptedRangeFilter | import("@kbn/es-query/src/filters/build_filters").MatchAllRangeFilter | undefined;

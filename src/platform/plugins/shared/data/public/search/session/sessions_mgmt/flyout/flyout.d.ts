...
export declare const Flyout: ({ flyoutId, api, coreStart, usageCollector, ebtManager, config, kibanaVersion, locators, appId, trackingProps, onBackgroundSearchOpened, onClose, }: {
    flyoutId: string;

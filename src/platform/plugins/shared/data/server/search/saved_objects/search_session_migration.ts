...
import { type SavedObjectMigrationMap, type SavedObjectUnsanitizedDoc } from '@kbn/core/server';
import {
  type SearchSessionSavedObjectAttributes as SearchSessionSavedObjectAttributesLatest,
  SearchSessionStatus,
} from '../../../common';

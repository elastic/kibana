...
import type { IRouter, IScopedClusterClient, IUiSettingsClient, SavedObjectsClientContract, KibanaRequest, CustomRequestHandlerContext } from '@kbn/core/server';
import type { ISearchClient, IKibanaSearchResponse, IKibanaSearchRequest, ISearchOptions, IEsSearchResponse, IEsSearchRequest, ISearchMethods } from '@kbn/search-types';
...
export interface ISearchSetup {
     ...
     * strategies.
     */
    registerSearchStrategy: <SearchStrategyRequest extends IKibanaSearchRequest = IEsSearchRequest, SearchStrategyResponse extends IKibanaSearchResponse = IEsSearchResponse>(name: string | symbol, strategy: ISearchStrategy<SearchStrategyRequest, SearchStrategyResponse>) => void;
    /**
...
export interface ISearchStart<SearchStrategyRequest extends IKibanaSearchRequest = IEsSearchRequest, SearchStrategyResponse extends IKibanaSearchResponse = IEsSearchResponse> {
     ...
     */
    getSearchStrategy: (name?: string | symbol) => ISearchStrategy<SearchStrategyRequest, SearchStrategyResponse>;

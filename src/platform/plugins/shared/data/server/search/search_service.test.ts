...
import { type CoreSetup, type CoreStart, type SavedObject } from '@kbn/core/server';
import { coreMock } from '@kbn/core/server/mocks';
import { type IEsSearchRequest, type IEsSearchResponse } from '@kbn/search-types';
...
import { SearchService, type SearchServiceSetupDependencies } from './search_service';

...
const columnSettingsEntrySchema = lazySchema(() =>
  z
    .object({
...
export const viewModeSchema = lazySchema(() =>
  z
    .union([
...
export const dataTableSchema = lazySchema(() =>
  z
    .object({
      column_order: z
...
export const panelOverridesSchema = lazySchema(() =>
  z
    .object({
      column_order: z
        .array(z.string().meta({ description: 'Field name of a column in display order.' }))
...
export const classicTabSchema = lazySchema(() =>
  z
    .object({
...
export const esqlTabSchema = lazySchema(() =>
  z
    .object({
      ...dataTableSchema.shape,
      ...dataTableLimitsSchema.shape,
...
export const tabSchema = lazySchema(() => z.union([classicTabSchema, esqlTabSchema]));
...
const discoverSessionByValuePropsSchema = lazySchema(() =>
  z
    .object({
...
const discoverSessionByReferencePropsSchema = lazySchema(() =>
  z
    .object({
      ref_id: z.string(),

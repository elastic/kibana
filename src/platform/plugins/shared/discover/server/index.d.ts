...
export type { DiscoverSessionApiClassicTab, DiscoverSessionApiEsqlTab, DiscoverSessionApiResponse, DiscoverSessionApiTab, DiscoverSessionApiData, } from './api/schema';

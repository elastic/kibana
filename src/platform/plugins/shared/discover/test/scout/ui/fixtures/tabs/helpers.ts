...
import { EuiToastWrapper, type ScoutPage, type ScoutTestFixtures } from '@kbn/scout';
import { expect } from '@kbn/scout/ui';

type DiscoverApp = ScoutTestFixtures['pageObjects']['discover'];
...
export const createDataViewFromSearchBar = async (
  ...
  // Reuse the page object's switch resolution instead of a `*dataView-switch-link`
  // wildcard, which ambiguously matches both the current and legacy test subjects.
  await (await discover.getVisibleDataViewSwitch()).click();

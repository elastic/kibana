...
import type { AggregationSettings } from './aggregation_settings';
import { createAggregationSettings } from './aggregation_settings';
...
export class MetricsExperiencePage {
  ...
  public readonly aggregationSettings: AggregationSettings;
  ...
  constructor(page: ScoutPage) {
    ...
    this.aggregationSettings = createAggregationSettings(page);

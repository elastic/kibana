...
const COMPARISON_DISPLAY = 'Comparing 2 documents';
const TABLE_HEADERS = ['Field', 'AU_x3_g4GFA8no6QjkYX', 'AU_x3-TcGFA8no6Qjipx'];
...
spaceTest.describe(
  'Discover — document comparison (data view mode)',
  ...
  () => {
    ...
    spaceTest(
      'allows comparing documents and toggling comparison settings',

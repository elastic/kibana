...
const COMPARISON_DISPLAY = 'Comparing 2 results';
const TABLE_HEADERS = ['Field', 'Result 1', 'Result 2'];
...
spaceTest.describe(
  'Discover — document comparison (ES|QL mode)',
      ...
      async ({ page, pageObjects }) => {
        ...
        await spaceTest.step('shows comparison headers and allows selecting fields', async () => {
          ...
          expect(visibleFieldNames).toStrictEqual(
            FULL_FIELD_NAMES.slice(0, visibleFieldNames.length)
          );

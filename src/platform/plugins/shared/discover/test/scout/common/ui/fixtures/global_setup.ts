...
} from '../../../metrics_experience/ui/fixtures';
import { createSecurityTestIndices } from '../../../security_experience/ui/fixtures';
import {
  TRACES,
  richTrace,
  traceCorrelatedLogs,
  ...
  deepTrace,
} from '../../../traces_experience/ui/fixtures';

interface DiscoverGlobalSetupFixtures {
  esClient: EsClient;
  esArchiver: { loadIfNeeded: (name: string) => Promise<unknown> };
...
export const setupDiscoverTestData = async ({
  esClient,
  esArchiver,
  apiServices,
  config,

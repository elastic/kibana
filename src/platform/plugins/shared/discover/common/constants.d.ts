 ...
 */
export declare const isPersistedQueryMode: (value: unknown) => value is PersistedQueryMode;
/**
...
export declare const PROFILE_STATE_URL_KEY = "_p";
 ...
 */
export declare const DISCOVER_SESSION_API_BASE_PATH = "/api/discover_sessions";
export declare const DISCOVER_SESSION_API_VERSION = "1";

...
const fromStoredJsonModeSettings = (
  ...
  ...(jsonModeSettings.defaultRenderedLeafNodes !== undefined && {
    default_rendered_leaf_nodes: jsonModeSettings.defaultRenderedLeafNodes,
  }),
});
...
const toStoredJsonModeSettings = (
  ...
  ...(jsonModeSettings.default_rendered_leaf_nodes !== undefined && {
    defaultRenderedLeafNodes: jsonModeSettings.default_rendered_leaf_nodes,
  }),
});

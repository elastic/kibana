...
export const discoverSessionMetricsTabTypeStateSchema = z
  .object({
    ...
    dimensions: z
      ...
      .meta({ description: 'Fields used to group metrics in the metrics grid.' }),
...
export type MetricsTabTypeState = z.output<typeof discoverSessionMetricsTabTypeStateSchema>;

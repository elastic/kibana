...
import type { DiscoverAppState, InternalStateStore, internalStateActions, TabActionInjector, TabState } from '../application/main/state_management/redux';
/**
...
export interface ExtendedDiscoverStateContainer {
     ...
     */
    createTabPersistableStateObservable: () => Observable<Pick<TabState, 'appState' | 'globalState' | 'attributes'>>;
    /**
...
export type CustomizationCallback = (options: CustomizationCallbackContext) => void | (() => void) | Promise<void | (() => void)>;

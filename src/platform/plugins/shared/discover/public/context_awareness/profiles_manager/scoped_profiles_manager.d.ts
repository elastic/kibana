...
export declare class ScopedProfilesManager {
    ...
    private cachedRootContext;
    private cachedRootProfile;
    private dataSourceProfile;
    private prevDataSourceProfileParams?;
    private dataSourceProfileAbortController?;
    constructor(rootContext$: BehaviorSubject<ContextWithProfileId<RootContext>>, getRootProfile: () => AppliedProfile, dataSourceProfileService: DataSourceProfileService, documentProfileService: DocumentProfileService, scopedEbtManager: ScopedDiscoverEBTManager, toolkit: ContextAwarenessToolkit);
    /**
     * Whether this manager has completed at least one data source profile resolution
     */
    hasResolvedDataSourceProfile(): boolean;
    /**

...
jest.mock('../../../../../application/main/state_management/redux', () => ({
  ...
  useCurrentTabDispatch: jest.fn(),
}));

const mockDispatchCurrentTab = jest.fn();
...
describe('MetricsExperienceGridWrapper', () => {
  beforeEach(() => {
    ...
    (useCurrentTabDispatch as jest.Mock).mockReturnValue(mockDispatchCurrentTab);
    mockDispatchCurrentTab.mockClear();
  });
  ...
  it('dispatches breakdown updates from metrics grid callback', () => {
    ...
    expect(mockDispatchCurrentTab).toHaveBeenCalledWith(expect.any(Function), {

...
import { createUniversalSecurityDataSourceProfileProvider } from './common/universal_security_data_source_profile';
import { createUniversalSecurityDocumentProfileProvider } from './common/universal_security_document_profile';
...
const createDataSourceProfileProviders = (providerServices: ProfileProviderServices) => [
  ...
  // Universal profiles come last so solution-specific profiles take precedence
  createUniversalSecurityDataSourceProfileProvider(providerServices),
...
const createDocumentProfileProviders = (providerServices: ProfileProviderServices) => [
  ...
  // Universal document profiles come last so solution-specific profiles take precedence
  createUniversalSecurityDocumentProfileProvider(providerServices),

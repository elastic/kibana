...
import { registerMetricsAggregationStateDefinitions } from './common/metrics_data_source_profile/profile_state';
...
export const registerProfileStateDefinitions = (registry: ProfileStateRegistry) => {
  ...
  registerMetricsAggregationStateDefinitions(registry);
};

...
export interface ContextAwarenessToolkit {
     ...
     */
    readonly getStateAdapter: <TState extends SerializableRecord>(definition: ProfileStateDefinition<TState>) => ProfileStateAdapter<TState>;
}
/**
 * Default toolkit used when no host actions are available.
 */
export declare const EMPTY_CONTEXT_AWARENESS_TOOLKIT: ContextAwarenessToolkit;

...
import type { CustomCellRenderer, DataGridDensity, UnifiedDataTableProps, DataGridPaginationMode, CustomGridColumnsConfiguration } from '@kbn/unified-data-table';
...
import type { ChartSectionProps, UnifiedHistogramTopPanelHeightContext } from '@kbn/unified-histogram/types';
import type { TypedLensByValueInput } from '@kbn/lens-plugin/public';
import type { RestorableStateProviderProps } from '@kbn/restorable-state';
import type { DiscoverDataSource } from '../../common/data_sources';
import type { DiscoverAppState, UpdateESQLQueryActionPayload } from '../application/main/state_management/redux';
export type UpdateESQLQueryFn = (queryOrUpdater: UpdateESQLQueryActionPayload['queryOrUpdater']) => void;
/**
...
export type ChartSectionConfiguration<T extends object = object> = {
     ...
     */
    renderChartSection: (props: ChartSectionProps & RestorableStateProviderProps<T>) => React.ReactElement;
    /**
...
export interface RowControlsExtensionParams {
    ...
    actions: {
         ...
         */
        setExpandedDoc?: (record?: DataTableRecord, options?: {
            initialTabId?: string;
        }) => void;
    };
    /**
 ...
 */
export type AdditionalCellActionContext = CellActionsData & Omit<OmitIndexSignature<DiscoverCellActionMetadata>, 'instanceId'>;
/**
...
export interface AdditionalCellAction {
     ...
     */
    isCompatible?: (context: Omit<AdditionalCellActionContext, 'value'>) => boolean | Promise<boolean>;
    /**
...
export interface Profile {
     ...
     */
    getDefaultAdHocDataViews: () => Array<Omit<DataViewSpec, 'id'> & {
        id: NonNullable<DataViewSpec['id']>;
    }>;
    /**
     ...
     */
    getModifiedVisAttributes: (params: ModifiedVisAttributesExtensionParams) => TypedLensByValueInput['attributes'];
    /**
     ...
     */
    getChartSectionConfiguration: (params: ChartSectionConfigurationExtensionParams) => ChartSectionConfiguration;
    /**
     * Data grid
     */
    /**
     ...
     */
    getRowIndicatorProvider: (params: RowIndicatorExtensionParams) => UnifiedDataTableProps['getRowIndicator'] | undefined;
    /**
     ...
     */
    getRowAdditionalLeadingControls: (params: RowControlsExtensionParams) => UnifiedDataTableProps['rowAdditionalLeadingControls'] | undefined;
    /**
     ...
     */
    getDeepAnalysisPlaybook: (params: DeepAnalysisPlaybookExtensionParams) => DeepAnalysisPlaybookExtension | undefined;
    /**

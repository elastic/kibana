 ...
 */
export declare const useAdditionalCellActions: ({ dataSource, dataView, query, filters, timeRange, }: Omit<AdditionalCellActionContext, "field" | "value">) => DiscoverCellActionMetadata;

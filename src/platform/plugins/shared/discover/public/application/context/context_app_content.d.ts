...
export declare function ContextAppContent({ columns, grid, onAddColumn, onRemoveColumn, onSetColumns, dataView, predecessorCount, successorCount, rows, predecessors, successors, anchorStatus, predecessorsStatus, successorsStatus, interceptedWarnings, setAppState, addFilter, expandedDoc, initialDocViewerTabId, docViewerRef, setExpandedDoc, }: ContextAppContentProps): React.JSX.Element;

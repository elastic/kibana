...
import { type NotificationsStart, type IUiSettingsClient } from '@kbn/core/public';
import { type Filter, compareFilters, COMPARE_ALL_OPTIONS, FilterStateStore } from '@kbn/es-query';
import {
...
import { connectToQueryState, type DataPublicPluginStart, type FilterManager } from '@kbn/data-plugin/public';

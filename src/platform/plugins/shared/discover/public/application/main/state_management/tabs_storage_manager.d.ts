...
export interface TabsStorageManager {
    ...
    updateTabStateLocally: (tabId: string, tabState: Pick<TabStateInLocalStorage, 'internalState' | 'attributes' | 'appState' | 'globalState' | 'profileState'>) => void;
    loadLocally: (props: {
        userId: string;
        spaceId: string;
...
export declare const createTabsStorageManager: ({ urlStateStorage, storage, profileStateRegistry, enabled, }: {

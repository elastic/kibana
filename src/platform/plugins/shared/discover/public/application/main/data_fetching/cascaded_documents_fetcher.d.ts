...
export declare class CascadedDocumentsFetcher {
    ...
    fetchCascadedDocuments({ nodeId, nodeType, nodePath, nodePathMap, query, esqlVariables, dataView, timeRange, isApproximate, }: FetchCascadedDocumentsParams): Promise<DataTableRecord[]>;

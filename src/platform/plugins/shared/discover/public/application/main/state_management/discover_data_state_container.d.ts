 ...
 */
export declare function getDataStateContainer({ services, searchSessionManager, internalState, runtimeStateManager, urlStateStorage, injectCurrentTab, getCurrentTab, }: {

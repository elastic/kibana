...
import { type InternalStateThunkActionCreator, type InternalStateThunkAction, type TabActionPayload } from '../internal_state';
 ...
 */
export declare const setProfileState: <TState extends SerializableRecord>(payload: ProfileStatePayload<TState>) => InternalStateThunkAction;
/**

...
import { type ProfileStateMap, type ProfileStateRegistry } from '../../../../../common/context_awareness';
...
export declare const createTabRuntimeState: ({ services, toolkit, cascadedDocumentsStateManager, initialValues, }: {
...
export declare const selectCurrentProfileStateDefinition: (runtimeStateManager: RuntimeStateManager, tabId: string) => import("../../../../../common/context_awareness").ProfileStateDefinition<import("@kbn/utility-types").SerializableRecord> | undefined;
export declare const selectCurrentProfileUrlState: ({ runtimeStateManager, tabId, profileStateMap, profileStateRegistry, }: {
    runtimeStateManager: RuntimeStateManager;
    tabId: string;
    profileStateMap: ProfileStateMap;
    profileStateRegistry: ProfileStateRegistry;
}) => ProfileStateMap | undefined;
export declare const selectCurrentProfileLocatorState: ({ runtimeStateManager, tabId, profileStateMap, profileStateRegistry, }: {
    runtimeStateManager: RuntimeStateManager;
    tabId: string;
    profileStateMap: ProfileStateMap;
    profileStateRegistry: ProfileStateRegistry;

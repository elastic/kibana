...
export const initializeTabs = createInternalStateAsyncThunk(
  ...
  async function initializeTabsThunkFn(
    ...
    diag('initTabs:pushSelectedTabIdToUrl', {
      selectedTabId: initialTabsState.selectedTabId,
    ...
    if (locationState) {
      diag('initTabs:historyReplace', { hasLocationState: true });
    ...
    diag('initTabs:end', { selectedTabId: initialTabsState.selectedTabId });

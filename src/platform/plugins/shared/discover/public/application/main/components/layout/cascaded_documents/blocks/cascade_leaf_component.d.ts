 ...
 */
export declare const CustomCascadeGridBodyMemoized: React.MemoExoticComponent<({ isFullScreenMode, data, virtualizerController, cellId, rowIndex, Cell, visibleColumns, visibleRowData, headerRow, footerRow, }: CustomCascadeGridBodyProps) => React.JSX.Element>;

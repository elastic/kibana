...
export declare const getSummaryColumn: (params: SummaryColumnGetterDeps, toolkit: ContextAwarenessToolkit) => (props: Omit<SummaryColumnProps, "core" | "share">) => React.JSX.Element;

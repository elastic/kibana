...
import type {
  DiscoverContextAppLocator} from './application/context/services/locator';
import {
  DiscoverContextAppLocatorDefinition,
} from './application/context/services/locator';
import type {
  DiscoverSingleDocLocator} from './application/doc/locator';
import {
  DiscoverSingleDocLocatorDefinition,
} from './application/doc/locator';
import type {
  DiscoverAppLocator} from '../common';
import {

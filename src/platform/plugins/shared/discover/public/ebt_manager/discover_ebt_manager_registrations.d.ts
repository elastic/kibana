 ...
 */
export declare const QUERY_PERFORMANCE_EVENT_TYPE = "discover_query_performance";
export declare const QUERY_PERFORMANCE_EVENT_NAME = "eventName";
export declare const QUERY_PERFORMANCE_DURATION = "duration";
export declare const QUERY_PERFORMANCE_QUERY_RANGE_SECONDS = "queryRangeSeconds";
export declare const QUERY_PERFORMANCE_PHRASE_QUERY_COUNT = "phraseQueryCount";
export declare const QUERY_PERFORMANCE_MULTI_MATCH_TYPES = "multiMatchTypes";
export declare const QUERY_PERFORMANCE_FETCH_TYPE = "fetchType";
export declare const QUERY_PERFORMANCE_QUERY_SOURCE_COMMAND = "querySourceCommand";
/**

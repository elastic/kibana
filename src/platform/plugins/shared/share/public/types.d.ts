...
type ShareIntegrationOptions = Omit<ShowShareMenuOptions, 'asExport' | 'anchorElement' | 'allowShortUrl' | 'isDirty' | 'sharingData' | 'shareableUrl' | 'shareableUrlForSavedObject' | 'shareableUrlLocatorParams' | 'sharingData'> & {
    sharingData: object;
};
export type ConditionallyTypedShareOptions<ExportType extends ShareActionIntents = ShareActionIntents> = ExportType extends ShareIntegration ? ShareIntegrationOptions : Omit<ShowShareMenuOptions, 'asExport' | 'anchorElement'>;

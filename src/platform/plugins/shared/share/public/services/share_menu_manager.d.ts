...
import type { ConditionallyTypedShareOptions, ShareActionIntents, ShowShareMenuOptions } from '../types';
...
export declare class ShareMenuManager {
    ...
    start({ core, resolveShareItemsForShareContext, isServerless }: ShareMenuManagerStartDeps): {
         ...
         */
        getExportDerivativeHandler: <ExportType extends ShareActionIntents = ShareActionIntents>(options: ConditionallyTypedShareOptions<ExportType>, derivativeId: string) => Promise<(() => Promise<void>) | null>;
    };
    /**

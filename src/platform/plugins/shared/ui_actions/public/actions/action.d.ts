 ...
 */
export type ActionDefinitionContext<Context extends object = object> = Context | ActionExecutionContext<Context>;
export interface ActionMenuItemProps<Context extends object> {
    context: ActionExecutionContext<Context>;
}
export type FrequentCompatibilityChangeAction<Context extends object = object> = Action<Context> & Required<Pick<Action<Context>, 'getCompatibilityChangesSubject' | 'couldBecomeCompatible'>>;
export interface Action<Context extends object = object, ActionExtension extends object = object> extends Partial<Presentable<ActionExecutionContext<Context>>> {
    /**
 ...
 */
export type ActionDefinition<Context extends object = object, ActionExtension extends object = {}> = Partial<Presentable<ActionDefinitionContext<Context>>> & {
    extension?: ActionExtension;
} & {
    /**

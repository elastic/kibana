...
export type UiActionsPublicSetup = Pick<UiActionsService, 'addTriggerAction' | 'addTriggerActionAsync' | 'attachAction' | 'detachAction' | 'registerAction' | 'registerActionAsync' | 'unregisterAction'>;

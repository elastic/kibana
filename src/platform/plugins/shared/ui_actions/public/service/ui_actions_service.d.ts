...
export declare class UiActionsService {
     ...
     */
    readonly registerAction: <Context extends object>(definition: ActionDefinition<Context>) => Action<Context>;
     ...
     */
    readonly addTriggerAction: (triggerId: string, action: ActionDefinition<any>) => void;
    /**

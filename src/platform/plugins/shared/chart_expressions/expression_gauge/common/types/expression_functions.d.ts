...
import type { MakeOverridesSerializable, Simplify, ExpressionValueVisDimension } from '@kbn/chart-expressions-common';
import type { GoalProps } from '@elastic/charts';
import type { EXPRESSION_GAUGE_NAME, GAUGE_FUNCTION_RENDERER_NAME, GaugeShapes, GaugeTicksPositions, GaugeLabelMajorModes, GaugeColorModes, GaugeCentralMajorModes } from '../constants';
...
export type GaugeExpressionFunctionDefinition = ExpressionFunctionDefinition<typeof EXPRESSION_GAUGE_NAME, GaugeInput, GaugeArguments, ExpressionValueRender<GaugeExpressionProps>, ExecutionContext<DefaultInspectorAdapters>>;
...
export type AllowedGaugeOverrides = Partial<Record<'gauge', Simplify<MakeOverridesSerializable<GoalProps>>>>;

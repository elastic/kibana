...
export declare const getMetricFormatter: (accessor: ExpressionValueVisDimension | string, columns: Datatable["columns"], formatOverrides?: FormatOverrides | undefined) => (v: unknown) => string;

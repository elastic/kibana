...
export declare function getBaseIconPlacement(iconPosition: IconPosition | undefined, axesMap?: AxesMap, position?: Position): "top" | "bottom" | "left" | "right";
...
export declare const getLineAnnotationProps: (config: ReferenceLineAnnotationConfig, label: string | undefined, axesMap: AxesMap, isHorizontal: boolean, isTextOnlyMarker: boolean) => {
    ...
    markerPosition: "top" | "bottom" | "left" | "right";
};

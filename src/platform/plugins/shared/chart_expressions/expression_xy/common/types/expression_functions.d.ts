...
import type { Datatable, DatatableColumnMeta, DefaultInspectorAdapters, ExecutionContext, ExpressionFunctionDefinition } from '@kbn/expressions-plugin/common';
import type { EventAnnotationOutput } from '@kbn/event-annotation-plugin/common';
import type { MakeOverridesSerializable, Simplify, ExpressionValueVisDimension, LegendLayout, LegendSize, XYLegendValue } from '@kbn/chart-expressions-common';
import type { AxisExtentModes, FillStyles, FittingFunctions, IconPositions, LayerTypes, LineStyles, SeriesTypes, ValueLabelModes, XScaleTypes, XYCurveTypes, YScaleTypes, AxisModes, REFERENCE_LINE, DATA_DECORATION_CONFIG, REFERENCE_LINE_DECORATION_CONFIG, LEGEND_CONFIG, DATA_LAYER, AXIS_EXTENT_CONFIG, EXTENDED_DATA_LAYER, REFERENCE_LINE_LAYER, ANNOTATION_LAYER, EndValues, X_AXIS_CONFIG, Y_AXIS_CONFIG, AvailableReferenceLineIcons, XY_VIS, LAYERED_XY_VIS, EXTENDED_ANNOTATION_LAYER, EXTENDED_REFERENCE_LINE_DECORATION_CONFIG, PointVisibilityOptions } from '../constants';
...
export type EventAnnotationResultFn = ExpressionFunctionDefinition<'event_annotations_result', null, EventAnnotationResultArgs, EventAnnotationResultResult>;
...
export type XYExtendedLayerConfig = ExtendedDataLayerConfig | ReferenceLineLayerConfig | ExtendedAnnotationLayerConfig | ReferenceLineConfig;
export type XYExtendedLayerConfigResult = ExtendedDataLayerConfigResult | ReferenceLineLayerConfigResult | ReferenceLineConfigResult;
...
export type XAxisConfigResult = AxisConfig & {
    type: typeof X_AXIS_CONFIG;
};
export type YAxisConfigResult = YAxisConfig & {
    type: typeof Y_AXIS_CONFIG;
};
export type LegendConfigResult = LegendConfig & {
    type: typeof LEGEND_CONFIG;
};
export type AxisExtentConfigResult = AxisExtentConfig & {
    type: typeof AXIS_EXTENT_CONFIG;
};
...
export type CommonXYReferenceLineLayerConfigResult = ReferenceLineConfigResult | ReferenceLineLayerConfigResult;
...
export type XyVisFn = ExpressionFunctionDefinition<typeof XY_VIS, Datatable, XYArgs, Promise<XYRender>, ExecutionContext<DefaultInspectorAdapters>>;
export type LayeredXyVisFn = ExpressionFunctionDefinition<typeof LAYERED_XY_VIS, Datatable, LayeredXYArgs, Promise<XYRender>, ExecutionContext<DefaultInspectorAdapters>>;
export type ExtendedDataLayerFn = ExpressionFunctionDefinition<typeof EXTENDED_DATA_LAYER, Datatable, ExtendedDataLayerArgs, Promise<ExtendedDataLayerConfigResult>>;
export type ReferenceLineFn = ExpressionFunctionDefinition<typeof REFERENCE_LINE, Datatable | null, ReferenceLineArgs, ReferenceLineConfigResult>;
export type ReferenceLineLayerFn = ExpressionFunctionDefinition<typeof REFERENCE_LINE_LAYER, Datatable, ReferenceLineLayerArgs, Promise<ReferenceLineLayerConfigResult>>;
export type DataDecorationConfigFn = ExpressionFunctionDefinition<typeof DATA_DECORATION_CONFIG, null, DataDecorationConfig, DataDecorationConfigResult>;
export type ReferenceLineDecorationConfigFn = ExpressionFunctionDefinition<typeof REFERENCE_LINE_DECORATION_CONFIG, null, ReferenceLineDecorationConfig, ReferenceLineDecorationConfigResult>;
export type LegendConfigFn = ExpressionFunctionDefinition<typeof LEGEND_CONFIG, null, LegendConfig, Promise<LegendConfigResult>>;
export type XAxisConfigFn = ExpressionFunctionDefinition<typeof X_AXIS_CONFIG, null, AxisConfig, XAxisConfigResult>;
export type YAxisConfigFn = ExpressionFunctionDefinition<typeof Y_AXIS_CONFIG, null, YAxisConfig, YAxisConfigResult>;
export type ExtendedAnnotationLayerFn = ExpressionFunctionDefinition<typeof EXTENDED_ANNOTATION_LAYER, null, ExtendedAnnotationLayerArgs, ExtendedAnnotationLayerConfigResult>;
export type AllowedXYOverrides = Partial<Record<'axisX' | 'axisLeft' | 'axisRight', Simplify<Omit<MakeOverridesSerializable<AxisProps>, 'id' | 'groupId'>>>>;

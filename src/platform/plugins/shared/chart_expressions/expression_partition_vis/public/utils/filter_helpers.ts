...
import { type LayerValue, type SeriesIdentifier, type TooltipValue } from '@elastic/charts';
import { type Datatable, type DatatableColumn } from '@kbn/expressions-plugin/public';
...
import { type BucketColumns, type PartitionVisParams, type Dimensions } from '../../common/types';

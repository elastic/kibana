...
import { type AllowedPartitionOverrides, type ExpressionValuePartitionLabels } from './expression_functions';
export type PartitionLegendValue = Extract<LegendValue, 'value' | 'percent'>;
export declare enum EmptySizeRatios {
    SMALL = 0.3,
    MEDIUM = 0.54,
    LARGE = 0.7
}
...
export interface MosaicVisConfig extends Omit<VisCommonConfig, 'metrics' | 'metricsToLabels' | 'colorOverrides'> {
...
export declare enum ValueFormats {
    PERCENT = "percent",
    VALUE = "value"
}
export declare enum LegendDisplay {
    SHOW = "show",
    HIDE = "hide",
    DEFAULT = "default"
}

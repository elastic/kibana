...
export const ConnectorActionInputSchemas = new Map<string, Record<string, z.ZodSchema>>([
  ...
  [
    '.sentinelone',
    {
      getAgents: SentinelOneGetAgentsParamsSchema,
      isolateHost: SentinelOneIsolateHostParamsSchema,
      releaseHost: SentinelOneReleaseHostParamsSchema,
      getRemoteScripts: SentinelOneGetRemoteScriptsParamsSchema,
      fetchAgentFiles: SentinelOneFetchAgentFilesParamsSchema,
      downloadAgentFile: SentinelOneDownloadAgentFileParamsSchema,
      getActivities: SentinelOneGetActivitiesParamsSchema,
      executeScript: SentinelOneExecuteScriptParamsSchema,
      getRemoteScriptStatus: SentinelOneGetRemoteScriptStatusParamsSchema,
      getRemoteScriptResults: SentinelOneGetRemoteScriptResultsParamsSchema,
      downloadRemoteScriptResults: SentinelOneDownloadRemoteScriptResultsParamsSchema,
    },
  ],
  [
    '.microsoft_defender_endpoint',
    {
      getAgentDetails: MicrosoftDefenderEndpointGetAgentDetailsParamsSchema,
      getAgentList: MicrosoftDefenderEndpointGetAgentListParamsSchema,
      isolateHost: MicrosoftDefenderEndpointIsolateHostParamsSchema,
      releaseHost: MicrosoftDefenderEndpointReleaseHostParamsSchema,
      testConnector: MicrosoftDefenderEndpointTestConnectorParamsSchema,
      getActions: MicrosoftDefenderEndpointGetActionsParamsSchema,
      getLibraryFiles: MicrosoftDefenderEndpointGetLibraryFilesParamsSchema,
      runScript: MicrosoftDefenderEndpointRunScriptParamsSchema,
      cancelAction: MicrosoftDefenderEndpointCancelActionParamsSchema,
      getActionResults: MicrosoftDefenderEndpointGetActionResultsParamsSchema,
    },
  ],
  [
    '.crowdstrike',
    {
      getAgentDetails: CrowdstrikeGetAgentDetailsParamsSchema,
      getAgentOnlineStatus: CrowdstrikeGetAgentOnlineStatusParamsSchema,
      hostActions: CrowdstrikeHostActionsParamsSchema,
      executeRTRCommand: CrowdstrikeExecuteRTRCommandParamsSchema,
      getRTRCloudScripts: CrowdstrikeGetRTRCloudScriptsParamsSchema,
    },
  ],
]);
...
export const ConnectorActionOutputSchemas = new Map<string, Record<string, z.ZodSchema>>([
  ...
  [
    '.sentinelone',
    {
      getAgents: SentinelOneGetAgentsResponseSchema,
      isolateHost: SentinelOneIsolateHostResponseSchema,
      releaseHost: SentinelOneReleaseHostResponseSchema,
      getRemoteScripts: SentinelOneGetRemoteScriptsResponseSchema,
      fetchAgentFiles: SentinelOneFetchAgentFilesResponseSchema,
      downloadAgentFile: SentinelOneDownloadAgentFileResponseSchema,
      getActivities: SentinelOneGetActivitiesResponseSchema,
      executeScript: SentinelOneExecuteScriptResponseSchema,
      getRemoteScriptStatus: SentinelOneGetRemoteScriptStatusResponseSchema,
      getRemoteScriptResults: SentinelOneGetRemoteScriptResultsResponseSchema,
      downloadRemoteScriptResults: SentinelOneDownloadRemoteScriptResultsResponseSchema,
    },
  ],
  [
    '.microsoft_defender_endpoint',
    {
      getAgentDetails: MicrosoftDefenderEndpointGetAgentDetailsResponseSchema,
      getAgentList: MicrosoftDefenderEndpointGetAgentListResponseSchema,
      isolateHost: MicrosoftDefenderEndpointIsolateHostResponseSchema,
      releaseHost: MicrosoftDefenderEndpointReleaseHostResponseSchema,
      testConnector: MicrosoftDefenderEndpointTestConnectorResponseSchema,
      getActions: MicrosoftDefenderEndpointGetActionsResponseSchema,
      getLibraryFiles: MicrosoftDefenderEndpointGetLibraryFilesResponseSchema,
      runScript: MicrosoftDefenderEndpointRunScriptResponseSchema,
      cancelAction: MicrosoftDefenderEndpointCancelActionResponseSchema,
      getActionResults: MicrosoftDefenderEndpointGetActionResultsResponseSchema,
    },
  ],
  [
    '.crowdstrike',
    {
      getAgentDetails: CrowdstrikeGetAgentDetailsResponseSchema,
      getAgentOnlineStatus: CrowdstrikeGetAgentOnlineStatusResponseSchema,
      hostActions: CrowdstrikeHostActionsResponseSchema,
      executeRTRCommand: CrowdstrikeExecuteRTRResponseSchema,
      getRTRCloudScripts: CrowdstrikeGetRTRCloudScriptsResponseSchema,
    },
  ],
]);

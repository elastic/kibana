 ...
 * Generated at: 2025-09-08T07:30:27.196Z
...
export const GENERATED_ELASTICSEARCH_CONNECTORS: InternalConnectorContract[] = [
  ...
  },
  {
    ...
    paramsSchema: z.object({
      ...
      max_read_request_operation_count: z
        .any()
        .optional()
        .describe('max_read_request_operation_count'),
      ...
      max_write_request_operation_count: z
        .any()
        .optional()
        .describe('max_write_request_operation_count'),

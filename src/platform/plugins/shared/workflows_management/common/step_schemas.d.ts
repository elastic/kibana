import type { ConnectorContractUnion, ConnectorTypeInfo, StepDeprecationInfo } from '@kbn/workflows';
...
declare class StepSchemas {
    ...
    private deprecatedStepMetadataCache;
    ...
    getDeprecatedStepMetadataCache(): Readonly<Record<string, StepDeprecationInfo>> | null;
    setDeprecatedStepMetadataCache(cache: Readonly<Record<string, StepDeprecationInfo>> | null): void;

...
export declare function getConnectorType(workflowsManagementApi: WorkflowsManagementApi): ConnectorType<Record<string, unknown>, Record<string, unknown>, ExecutorParams, WorkflowsExecutorResultData>;

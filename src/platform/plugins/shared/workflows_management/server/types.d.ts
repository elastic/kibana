import type { ActionsApiRequestHandlerContext, PluginSetupContract as ActionsPluginSetupContract, PluginStartContract as ActionsPluginStartContract } from '@kbn/actions-plugin/server';
import type { AlertingApiRequestHandlerContext, AlertingServerSetup } from '@kbn/alerting-plugin/server';
...
import type { LicensingApiRequestHandlerContext, LicensingPluginStart } from '@kbn/licensing-plugin/server';

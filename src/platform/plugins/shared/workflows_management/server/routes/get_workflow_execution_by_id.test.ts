...
describe('GET /api/workflows-executions/{executionId}', () => {
  ...
  describe('handler logic', () => {
    ...
    beforeEach(() => {
      ...
      const route = mockRouter.versioned.getRoute('get', WORKFLOWS_EXECUTIONS_API_PATHS.BY_ID);
    ...
    it('should return workflow execution successfully', async () => {
      ...
      const mockRequest = {
        ...
        headers: {},
        url: { pathname: '/api/workflows-executions/execution-123' },
      };
    ...
    it('should return 404 when execution is not found', async () => {
      ...
      const mockContext = {};
      const mockRequest = {
        params: { executionId: 'non-existent-execution' },
        headers: {},
        url: { pathname: '/api/workflows-executions/non-existent-execution' },
      };
      const mockResponse = createMockResponse();
    ...
    it('should work with different space contexts', async () => {
      ...
      const mockRequest = {
        ...
        headers: {},
        url: { pathname: '/s/custom-space/api/workflows-executions/execution-456' },
      };
      const mockResponse = createMockResponse();

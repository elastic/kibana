...
describe('GET /api/workflows-executions/{executionId}/logs', () => {
  ...
  describe('handler logic', () => {
    ...
    beforeEach(() => {
      ...
      const route = mockRouter.versioned.getRoute('get', WORKFLOWS_EXECUTIONS_API_PATHS.LOGS);
        ...
        logs: [
          {
            ...
            additionalData: {
              ...
              event: { action: 'workflow_started', duration: 1000 },
          ...
          },
          {
            ...
            additionalData: {
              ...
              workflowName: 'Test Workflow',
              executionId: 'execution-123',
              event: { action: 'step_completed', duration: 5000 },
              tags: ['workflow', 'step'],
              error: null,
            },
          },

...
import { GetWorkflowJsonSchemaRequestQuery } from '../../common/model/api/workflows.gen';
...
export function registerGetWorkflowJsonSchemaRoute({
  ...
  router.versioned
    .get({
      access: 'public',
      path: WORKFLOWS_API_PATHS.JSON_SCHEMA,
    ...
    .addVersion(
      {
        ...
        validate: {
          request: {
            query: buildRouteValidationWithZod(GetWorkflowJsonSchemaRequestQuery),
          },
        },
      },

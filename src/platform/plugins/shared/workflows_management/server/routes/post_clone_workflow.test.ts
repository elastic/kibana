...
describe('POST /api/workflows/{id}/clone', () => {
  ...
  describe('handler logic', () => {
    ...
    beforeEach(() => {
      ...
      const route = mockRouter.versioned.getRoute('post', WORKFLOWS_API_PATHS.CLONE);
    ...
    it('should work with different space contexts', async () => {
      const mockOriginalWorkflow = {
        ...
        enabled: true,
        valid: true,
        definition: { name: 'Space-specific Workflow', steps: [] },
      ...
      const mockClonedWorkflow = {
        ...
        enabled: true,
        valid: true,
        definition: { name: 'Space-specific Workflow Copy', steps: [] },
    ...
    it('should handle clone operation errors', async () => {
      const mockOriginalWorkflow = {
        ...
        enabled: true,
        valid: true,
        definition: { name: 'Original Workflow', steps: [] },
        yaml: 'name: Original Workflow',
      };

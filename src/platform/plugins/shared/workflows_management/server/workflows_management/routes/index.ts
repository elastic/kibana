...
import { registerGetWorkflowVersionRoute } from './get_workflow_version';
...
import { registerPostRestoreWorkflowRoute } from './post_restore_workflow';
...
export function defineRoutes(
  ...
  registerGetWorkflowVersionRoute(deps);
  ...
  registerPostRestoreWorkflowRoute(deps);

...
`;
    ...
    // Count lines: name (1), triggers (2), type:manual (3), inputs (4), properties (5), analyst (6), type (7), properties (8), email (9), type (10), format (11), default (12)
    expect(errors[0].startLineNumber).toBe(12);
    expect(errors[0].message).toContain('email');
  });

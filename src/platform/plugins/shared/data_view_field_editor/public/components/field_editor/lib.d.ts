...
export declare const valueToComboBoxOption: (value: string) => import("@elastic/eui/src/components/combo_box/types").EuiComboBoxOptionOption<"boolean" | "composite" | "ip" | "date" | "geo_point" | "double" | "keyword" | "long"> | undefined;

...
export declare const valueToComboBoxOption: (value: string) => import("@elastic/eui/src/components/combo_box/types").EuiComboBoxOptionOption<"boolean" | "date" | "ip" | "composite" | "long" | "geo_point" | "double" | "keyword"> | undefined;

...
export declare const valueToComboBoxOption: (value: string) => import("@elastic/eui/src/components/combo_box/types").EuiComboBoxOptionOption<"boolean" | "ip" | "keyword" | "date" | "long" | "double" | "composite" | "geo_point"> | undefined;

...
import { FormattedValue, FIELD_FORMAT_IDS } from '@kbn/field-formats-plugin/common';
    ...
    () =>
      Object.values(fieldMap)
        .map((field) => {
          ...
          const isImageFormatter =
            formatter.type?.id === FIELD_FORMAT_IDS.URL && formatter.param('type') === 'img';

...
import type { RuntimeType, RuntimeField, SerializedFieldFormat, RuntimePrimitiveTypes, DataViewField } from '../../shared_imports';
...
interface PreviewError {
    ...
    error: RuntimeFieldPainlessError | {
        reason?: string;
        [key: string]: unknown;
    };
}
...
export interface Context {
    ...
    validation: {
        setScriptEditorValidation: React.Dispatch<React.SetStateAction<{
            isValid: boolean;
            isValidating: boolean;
            message: string | null;
        }>>;
...
export type PainlessExecuteContext = 'boolean_field' | 'date_field' | 'double_field' | 'geo_point_field' | 'ip_field' | 'keyword_field' | 'long_field';

...
import type { CreateFileArgs, UpdateFileArgs, DeleteFileArgs, BulkDeleteFilesArgs, GetByIdArgs, BulkGetByIdArgs, FindFileArgs } from './file_action_types';
/**
...
export interface FileServiceStart {
     ...
     */
    find<M>(args: FindFileArgs): Promise<{

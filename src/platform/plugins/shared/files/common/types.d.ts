...
export type { FileKindBase, FileKindBrowser, FileJSON, FileStatus, FileMetadata, BaseFilesClient, FileCompression, BaseFileMetadata, FileImageMetadata, } from '@kbn/shared-ux-file-types';
...
export interface File<Meta = unknown> {
     ...
     */
    uploadContent(content: Readable, abort$?: Observable<unknown>, options?: Partial<Pick<UploadOptions, 'transforms'>>): Promise<File<Meta>>;
    /**

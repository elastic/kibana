...
export declare function getPanelSchema(): Type<Readonly<{
    id?: string | undefined;
...
export declare function getSectionSchema(): ObjectType<{
    title: Type<string>;
...
export declare function getPinnedPanelsSchema(isDashboardAppRequest?: boolean, isReadRequest?: boolean): Type<(Readonly<{
    id?: string | undefined;
} & {
    type: "esql_control";
...
export declare function getDashboardStateSchema(isDashboardAppRequest: boolean, isReadRequest?: boolean): ObjectType<{
    ...
    esql_approximation: Type<boolean | undefined>;
    query: Type<Readonly<{} & {
        language: "lucene" | "kql";
        expression: string;
    }> | undefined>;

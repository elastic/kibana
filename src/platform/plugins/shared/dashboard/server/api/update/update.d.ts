 ...
 *
 */
export declare function update(requestCtx: RequestHandlerContext, strictValidationSchema: ReturnType<typeof getDashboardStateSchema>, id: string, updateBody: DashboardState, serverTiming?: RequestTiming, isDashboardAppRequest?: boolean): Promise<{

...
import type { PluginInitializerContext, CoreSetup, CoreStart, Plugin, SavedObjectsClientContract } from '@kbn/core/server';
...
export declare class DashboardPlugin implements Plugin<DashboardPluginSetup, DashboardPluginStart, SetupDeps, StartDeps> {
    ...
    start(core: CoreStart, plugins: StartDeps): {
        scanDashboards: (savedObjectsClient: SavedObjectsClientContract, page: number, perPage: number) => Promise<import("./scan_dashboards").ScanDashboardsResult>;
        client: {
            read: (savedObjectsClient: SavedObjectsClientContract, id: string) => Promise<Readonly<{
                warnings?: (Readonly<{

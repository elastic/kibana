...
import type { DashboardGetOut, DashboardState, GridData } from '../../server/content_management';
...
export interface DashboardCreationOptions {
  ...
  validateLoadedSavedObject?: (result: DashboardGetOut) => 'valid' | 'invalid' | 'redirected';

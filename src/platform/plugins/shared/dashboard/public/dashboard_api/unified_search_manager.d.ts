...
export declare function initializeUnifiedSearchManager(initialState: DashboardState, timeRestore$: PublishingSubject<boolean>, waitForPanelsToLoad$: Observable<void>, getLastSavedState: () => DashboardState | undefined, userActivity$: DashboardApi['userActivity$'], creationOptions?: DashboardCreationOptions): {
    api: {
        reload$: Subject<void>;
        forceRefresh: () => void;
    ...
    internalApi: {
        ...
        }>>, "query" | "filters" | "time_range" | "refresh_interval">>>;

...
export declare function getDashboardApi({ creationOptions, panelFlyoutType, incomingEmbeddables, initialState, readResult, savedObjectId, user, isAccessControlEnabled, }: {

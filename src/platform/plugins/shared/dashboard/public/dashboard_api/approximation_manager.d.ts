...
export declare function initializeApproximationManager(initialState: DashboardState): {
    api: {
        isApproximate$: BehaviorSubject<boolean>;
        setEsqlApproximation: (value: boolean) => void;
    };
    internalApi: {
        ...
        getState: () => Pick<DashboardState, "esql_approximation">;

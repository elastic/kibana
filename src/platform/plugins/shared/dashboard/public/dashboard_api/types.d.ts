...
import type { CanExpandPanels, CanIndicateRelatedChildren, CanPinPanels, HasLastSavedChildState, HasSections, HasSerializedChildState, PresentationContainer, PublishesSettings, TrackContentfulRender, EmbeddableAppContext, HasAppContext, HasExecutionContext, HasType, HasUniqueId, PublishesDataLoading, PublishesDataViews, PublishesDescription, PublishesEditablePauseFetch, PublishesHideBorder, PublishesSavedObjectId, PublishesTitle, PublishesUnifiedSearch, PublishesProjectRouting, PublishesApproximation, PublishesViewMode, PublishesWritableViewMode, PublishingSubject, ViewMode, PublishesSearchSession, PublishesReload } from '@kbn/presentation-publishing';
 ...
 */
export type DashboardApi = CanExpandPanels & CanIndicateRelatedChildren & CanPinPanels & HasSections & HasAppContext & HasExecutionContext & HasLastSavedChildState & HasSerializedChildState & HasType<typeof DASHBOARD_API_TYPE> & HasUniqueId & PresentationContainer & PublishesDataLoading & PublishesDataViews & PublishesDescription & PublishesHideBorder & Pick<PublishesTitle, 'title$' | 'hideTitle$'> & PublishesReload & PublishesSavedObjectId & PublishesESQLVariables & PublishesSearchSession & PublishesSettings & PublishesUnifiedSearch & PublishesProjectRouting & PublishesApproximation & PublishesViewMode & PublishesWritableViewMode & PublishesEditablePauseFetch & TrackContentfulRender & TracksOverlays & PublishesOnSave & {
...
export type DashboardInternalApi = ReturnType<typeof initializeUnsavedChangesManager>['internalApi'] & {

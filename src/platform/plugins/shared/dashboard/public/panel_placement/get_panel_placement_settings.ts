...
export async function getDashboardPanelPlacementSetting(embeddableType: string, serializedState?: SerializedPanelState<object>): Promise<undefined | PanelPlacementSettings> {

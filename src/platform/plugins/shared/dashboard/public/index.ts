...
export { OPEN_DASHBOARD_PRETTIFY_ACTION_ID } from './dashboard_app/prettify/dashboard_prettify_action';
export type { OpenDashboardPrettifyActionContext } from './dashboard_app/prettify/dashboard_prettify_action';

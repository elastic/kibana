...
export declare function DashboardRenderer({ locator, savedObjectId, showPlainSpinner, panelFlyoutType, dashboardRedirect, getCreationOptions, onApiAvailable, onApiCleanup, }: DashboardRendererProps): React.JSX.Element;

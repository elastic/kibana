...
import { type Query, type METRIC_TYPES, type KBN_FIELD_TYPES } from '@kbn/data-plugin/common';
import { type PANEL_TYPES, type TOOLTIP_MODES, type TSVB_METRIC_TYPES } from '../enums';

...
import { getIndexPatternIds, type Layer } from '@kbn/visualizations-plugin/common/convert_to_lens';
...
import { type Layer as ExtendedLayer, excludeMetaFromColumn } from '../lib/convert';

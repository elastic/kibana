...
// To be updated when Kibana only ships the Borealis theme
export const DEFAULT_EMS_ROADMAP_DESATURATED_ID = EMS_ROADMAP_BOREALIS_DESATURATED_ID;
export const DEFAULT_EMS_DARKMAP_ID = EMS_DARKMAP_BOREALIS_ID;

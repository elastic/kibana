...
import type { CanLockHoverActions, HasParentApi, HasUniqueId, PublishesBlockingError, PublishesDataLoading, PublishesDisabledActionIds, PublishesDescription, PublishesTitle, CanOverrideHoverActions, ViewMode } from '@kbn/presentation-publishing';
import type { UiActionsStart } from '@kbn/ui-actions-plugin/public';
import type { MaybePromise } from '@kbn/utility-types';
/** ------------------------------------------------------------------------------------------
 * Panel Types
 * ------------------------------------------------------------------------------------------ */
export type PanelCompatibleComponent<ApiType extends DefaultPresentationPanelApi = DefaultPresentationPanelApi, PropsType extends {} = {}> = React.ForwardRefExoticComponent<PropsType & React.RefAttributes<ApiType>>;
export interface PresentationPanelInternalProps<ApiType extends DefaultPresentationPanelApi = DefaultPresentationPanelApi, PropsType extends {} = {}> {
...
export type PresentationPanelProps<ApiType extends DefaultPresentationPanelApi = DefaultPresentationPanelApi, PropsType extends {} = {}> = Omit<PresentationPanelInternalProps<ApiType, PropsType>, 'Component'> & {

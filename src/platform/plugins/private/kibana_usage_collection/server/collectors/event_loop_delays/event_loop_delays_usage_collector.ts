...
import { type SavedObjectsServiceSetup, type ISavedObjectsRepository, type Logger } from '@kbn/core/server';
import { type UsageCollectionSetup } from '@kbn/usage-collection-plugin/server';
import { rollDailyData } from './rollups';
import { registerSavedObjectTypes, type EventLoopDelaysDaily } from './saved_objects';
import { eventLoopDelaysUsageSchema, type EventLoopDelaysUsageReport } from './schema';

...
import { type Vis, type VisEditorOptionsProps } from '@kbn/visualizations-plugin/public';

import { DefaultEditorDataTab, type DefaultEditorDataTabProps } from './data_tab';

...
const lodashPatch = require('./lodash_template');
const patchChildProcess = require('./child_process');
const hardenPrototypes = require('./prototype');
...
new ritm.Hook(
  ...
  function (module: any, name: string) {
    switch (name) {
      case 'child_process': {

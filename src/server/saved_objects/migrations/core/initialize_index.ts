...
/**
 * Initializes the specified index, ensuring it has the proper mappings and index template.
 *
 * @param opts
 ...
 * @prop {MigrationPlugin[]} plugins - A list of plugins whose mappings and transforms will

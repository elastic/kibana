...
describe('GET /api/saved_objects/_find', () => {
  ...
  it('calls upon savedObjectClient.find with defaults', async () => {
    ...
    expect(options).toEqual({ perPage: 20, page: 1, type: ['foo', 'bar'], searchOperator: 'OR' });
  });
  ...
  it('accepts the query parameter page/per_page', async () => {
    ...
    const options = savedObjectsClient.find.getCall(0).args[0];
    expect(options).toEqual({ perPage: 10, page: 50, type: ['foo'], searchOperator: 'OR' });
  });
  ...
  it('accepts the query parameter search_fields', async () => {
    ...
    const options = savedObjectsClient.find.getCall(0).args[0];
    expect(options).toEqual({ perPage: 20, page: 1, searchFields: ['title'], type: ['foo'], searchOperator: 'OR' });
  });
  ...
  it('accepts the query parameter fields as a string', async () => {
    ...
    const options = savedObjectsClient.find.getCall(0).args[0];
    expect(options).toEqual({ perPage: 20, page: 1, fields: ['title'], type: ['foo'], searchOperator: 'OR' });
  });
  ...
  it('accepts the query parameter fields as an array', async () => {
    ...
    expect(options).toEqual({
      perPage: 20, page: 1, fields: ['title', 'description'], type: ['foo'], searchOperator: 'OR'
    });
  });
  ...
  it('accepts the query parameter type as a string', async () => {
    ...
    const options = savedObjectsClient.find.getCall(0).args[0];
    expect(options).toEqual({ perPage: 20, page: 1, type: ['index-pattern'], searchOperator: 'OR' });
  });
  ...
  it('accepts the query parameter type as an array', async () => {
    ...
    const options = savedObjectsClient.find.getCall(0).args[0];
    expect(options).toEqual({ perPage: 20, page: 1, type: ['index-pattern', 'visualization'], searchOperator: 'OR' });
  });
});

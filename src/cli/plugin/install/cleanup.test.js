  ...
  describe('plugin installer', function () {
    describe('pluginCleaner', function () {
      ...
      describe('cleanPrevious', function () {
        ...
        it('should rethrow any exception from del.deleteSync', function () {
          sinon.stub(fs, 'statSync');
          sinon.stub(del, 'deleteSync').throws(new Error('I am an error thrown by del'));
      ...
      describe('cleanArtifacts', function () {
        ...
        it('should attempt to delete the working directory', function () {
          ...
          expect(del.deleteSync.calledWith(settings.workingPath)).toBe(true);
        });

        it('should swallow any errors thrown by del.deleteSync', function () {
          sinon.stub(del, 'deleteSync').throws(new Error('Something bad happened.'));

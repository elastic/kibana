...
describe('kibana cli', function () {
  ...
  describe('plugin downloader', function () {
    ...
    describe('_downloadSingle', function () {
      ...
      it('should download from a valid http url', function (done) {
      ...
      it.skip('should throw an ENOTFOUND error for an invalid local file', function (done) {

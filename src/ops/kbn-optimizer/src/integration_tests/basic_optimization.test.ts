...
it('builds expected bundles, saves bundle counts to metadata', async () => {
  ...
  expect(foo.cache.getReferencedPaths()).toMatchInlineSnapshot(`
    Array [
      <absolute path>/src/ops/kbn-optimizer/src/__fixtures__/__tmp__/mock_repo/bazel-out/<platform>-fastbuild/bin/src/ops/kbn-ui-shared-deps-npm/target_node/public_path_module_creator.js,
      <absolute path>/src/ops/kbn-optimizer/src/__fixtures__/__tmp__/mock_repo/plugins/foo/kibana.json,
      <absolute path>/src/ops/kbn-optimizer/src/__fixtures__/__tmp__/mock_repo/plugins/foo/public/async_import.ts,
      <absolute path>/src/ops/kbn-optimizer/src/__fixtures__/__tmp__/mock_repo/plugins/foo/public/ext.ts,
      <absolute path>/src/ops/kbn-optimizer/src/__fixtures__/__tmp__/mock_repo/plugins/foo/public/index.ts,
      <absolute path>/src/ops/kbn-optimizer/src/__fixtures__/__tmp__/mock_repo/plugins/foo/public/lib.ts,
      <absolute path>/src/ops/kbn-optimizer/src/worker/entry_point_creator.ts,
    ]
  `);
  ...
  expect(bar.cache.getReferencedPaths()).toMatchInlineSnapshot(`
    Array [
      ...
      <absolute path>/src/ops/kbn-optimizer/src/__fixtures__/__tmp__/mock_repo/bazel-out/<platform>-fastbuild/bin/src/ops/kbn-ui-shared-deps-npm/target_node/public_path_module_creator.js,
      <absolute path>/src/ops/kbn-optimizer/src/__fixtures__/__tmp__/mock_repo/plugins/bar/kibana.json,
      <absolute path>/src/ops/kbn-optimizer/src/__fixtures__/__tmp__/mock_repo/plugins/bar/public/index.scss,
      <absolute path>/src/ops/kbn-optimizer/src/__fixtures__/__tmp__/mock_repo/plugins/bar/public/index.ts,
      <absolute path>/src/ops/kbn-optimizer/src/__fixtures__/__tmp__/mock_repo/plugins/bar/public/legacy/_other_styles.scss,
      <absolute path>/src/ops/kbn-optimizer/src/__fixtures__/__tmp__/mock_repo/plugins/bar/public/legacy/styles.scss,
      <absolute path>/src/ops/kbn-optimizer/src/__fixtures__/__tmp__/mock_repo/plugins/bar/public/lib.ts,
      <absolute path>/src/ops/kbn-optimizer/src/__fixtures__/__tmp__/mock_repo/src/core/public/core_app/styles/_globals_v8dark.scss,
      <absolute path>/src/ops/kbn-optimizer/src/__fixtures__/__tmp__/mock_repo/src/core/public/core_app/styles/_globals_v8light.scss,
      <absolute path>/src/ops/kbn-optimizer/src/worker/entry_point_creator.ts,
    ]
  `);
  ...
  expect(baz.cache.getReferencedPaths()).toMatchInlineSnapshot(`
    Array [
      <absolute path>/src/ops/kbn-optimizer/src/__fixtures__/__tmp__/mock_repo/bazel-out/<platform>-fastbuild/bin/src/ops/kbn-ui-shared-deps-npm/target_node/public_path_module_creator.js,
      <absolute path>/src/ops/kbn-optimizer/src/__fixtures__/__tmp__/mock_repo/x-pack/baz/kibana.json,
      <absolute path>/src/ops/kbn-optimizer/src/__fixtures__/__tmp__/mock_repo/x-pack/baz/public/index.ts,
      <absolute path>/src/ops/kbn-optimizer/src/worker/entry_point_creator.ts,
    ]
  `);
});

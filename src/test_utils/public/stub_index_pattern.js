...
import { FieldList, fieldFormats, IndexPattern, indexPatterns } from '../../plugins/data/public';
...
export default function StubIndexPattern(pattern, getConfig, timeField, fields, core) {
  ...
  this.formatHit = indexPatterns.formatHitProvider(
    this,
    registeredFieldFormats.getDefaultInstance(fieldFormats.FIELD_FORMAT_IDS.STRING)
  );

...
describe('mergeCapabilities', () => {
  it(`"{ foo: {} }" doesn't clobber "{ foo: { bar: true } }"`, () => {
  ...
  it(`"{ foo: { bar: true } }" doesn't clobber "{ baz: { quz: true } }"`, () => {
  ...
  it(`"{ foo: { bar: { baz: true } } }" doesn't clobber "{ foo: { bar: { quz: true } } }"`, () => {
  ...
  it(`error is thrown if boolean and object clash`, () => {
    expect(() => {
  ...
  it(`supports duplicates as long as the booleans are the same`, () => {
  ...
  it(`error is thrown if merging "true" and "false"`, () => {
    expect(() => {

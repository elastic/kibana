  ...
  it('detecting migration related changes in registered types', () => {
    ...
    expect(hashMap).toMatchInlineSnapshot(`
      Object {
        ...
        "cases-user-actions": "ca0dbab8f8f169ef66f92570b45ec02e57a82d78",
        "config": "0090bed77e173b5d2e4b13a60388c153910cd967",
        ...
        "ingest-package-policies": "af65ee5c419bcf8ecc05ec2d74b3662f0fb30d21",

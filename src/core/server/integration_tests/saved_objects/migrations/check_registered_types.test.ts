  ...
  it('detecting migration related changes in registered types', () => {
    ...
    expect(hashMap).toMatchInlineSnapshot(`
      Object {
        ...
        "guided-setup-state": "c8148eb90d0c5950c72520af889775e695eb10d4",
        ...
        "ingest_manager_settings": "13c53a20c9af015acde7ea42379133f72c3a9b3f",
        ...
        "search-session": "49ba6260aeefe7dd32ad15a22042ed24c21390ab",
        ...
        "synthetics-monitor": "cffb4dfe9e0a36755a226d5cf983c21aac2b5b1e",

  ...
  it('detecting migration related changes in registered types', () => {
    ...
    expect(hashMap).toMatchInlineSnapshot(`
      Object {
        ...
        "osquery-pack": "f1c9cf480a2aab6e1874810439c77e5bbc394df6",
        "osquery-pack-asset": "cdeaa93deb7c8fe8af186b8a5e4dae2442d57c0b",
        "osquery-saved-query": "587df143fe0b96ae4d96a78837e05468a773ad87",

  ...
  it('detecting migration related changes in registered types', () => {
    ...
    expect(hashMap).toMatchInlineSnapshot(`
      Object {
        ...
        "security-rule": "7942bb7d8d0daf75925a8e7929ef14018c8e8445",
  ...
  it('detecting modelVersions are properly defined whenever mappings change', () => {
    ...
    expect(hashMap).toMatchInlineSnapshot(`
      Array [
        ...
        "security-rule|10.2.0: a03943bc69e25153cc3c6c7dcc458d3a393abc7c",
        "security-rule|10.1.0: 0d2717cd89bf4654e5e4b45c4226cde72d36cc17",
        "==============================================================",

  ...
  it('detecting migration related changes in registered types', () => {
    ...
    expect(hashMap).toMatchInlineSnapshot(`
      Object {
        ...
        "epm-packages": "078339e20d7f93251739bbb3fa1562bf53ce6042cf8fc6c9528405dbb13fdb23",
  ...
  it('detecting modelVersions are properly defined whenever mappings change', () => {
    ...
    expect(hashMap).toMatchInlineSnapshot(`
      Array [
        ...
        "epm-packages|mappings: f7ac11bf27969cd9cda004797ca156b4c71b12b9",
        "epm-packages|schemas: da39a3ee5e6b4b0d3255bfef95601890afd80709",
        "epm-packages|10.9.0: f27d42dbbdf71fea41cf582c9148d3cf40207872964a2f297e44b4e28fb332fe",

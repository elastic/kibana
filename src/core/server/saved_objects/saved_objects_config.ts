...
const createSavedObjectsSchema = schema.object({
  placeholder: schema.string({ defaultValue: 'placeholder' }),
});

type SavedObjectsConfigType = TypeOf<typeof createSavedObjectsSchema>;

export class SavedObjectsConfig {
  /**
   * @internal
   */
  public static schema = createSavedObjectsSchema;

...
/**
 * The default Elasticsearch client requestTimeout is 30s so we choose a
 * shorter timeout to avoid the client aborting our requests before we receive a response
 */
export const DEFAULT_TIMEOUT = '29s';

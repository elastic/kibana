 ...
 * Request handler is expected to return a result of one of {@link ResponseFactory} functions.
 ...
 * @param createResponse {@link ResponseFactory} - a set of helper functions used to respond to a request.
 *
 * @example
 * ```ts
 * const router = new Router('my-app');

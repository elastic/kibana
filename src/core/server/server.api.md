...
// Warning: (ae-forgotten-export) The symbol "SharedGlobalConfigKeys" needs to be exported by the entry point index.d.ts
//
// @public (undocumented)
...
// src/core/server/plugins/types.ts:386:3 - (ae-forgotten-export) The symbol "SavedObjectsConfigType" needs to be exported by the entry point index.d.ts
// src/core/server/plugins/types.ts:492:5 - (ae-unresolved-link) The @link reference could not be resolved: The package "kibana" does not have an export "create"

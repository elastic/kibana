...
| Legacy Platform                                        | New Platform                               | Notes                                                                                                                                  |
|--------------------------------------------------------|--------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------|
| `import 'ui/apply_filters'`                            | `import { ApplyFiltersPopover } from 'data plugin'`         | `import 'data plugin/legacy` should be called to load legacy directives                                               |
| `import 'ui/filter_bar'`                               | `import { FilterBar } from 'data plugin'`                   | `import 'data plugin/legacy` should be called to load legacy directives                                               |
| `import 'ui/query_bar'`                                | `import { QueryBar, QueryBarInput } from 'data plugin'`     | Directives are deprecated.                                                                                            |
| `import 'ui/search_bar'`                               | `import { SearchBar } from 'kibana react plugin'`           | Directive is deprecated.                                                                                              |
| `import 'ui/kbn_top_nav'`                              | `import { TopNavMenu } from 'kibana react plugin'`          | Directive is still available in `ui/kbn_top_nav`.                                                                     |              

...
import { ConfigService, type Env, type RawConfigurationProvider } from '@kbn/config';
import { DocLinksService } from '@kbn/core-doc-links-server-internal';
import { LoggingService, type ILoggingSystem } from '@kbn/core-logging-server-internal';
...
import { type DiscoveredPlugins, PluginsService } from '@kbn/core-plugins-server-internal';

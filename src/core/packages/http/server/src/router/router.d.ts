 ...
 * @public
 */
export type RouteRegistrar<Method extends RouteMethod, Context extends RequestHandlerContextBase = RequestHandlerContextBase> = <P, Q, B>(route: RouteConfig<P, Q, B, Method>, handler: RequestHandler<P, Q, B, Context, Method>) => void;
/**
...
export interface RouterRoute {
    ...
    handler: (req: Request, responseToolkit: ResponseToolkit) => Promise<ResponseObject | Boom.Boom<any>>;
    isVersioned: boolean;
}
/** @public */

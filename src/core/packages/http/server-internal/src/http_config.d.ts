...
declare const configSchema: import("@kbn/config-schema").ObjectType<{
    ...
    securityResponseHeaders: import("@kbn/config-schema").ObjectType<{
        ...
        referrerPolicy: import("@kbn/config-schema").Type<"same-origin" | "no-referrer" | "no-referrer-when-downgrade" | "origin" | "origin-when-cross-origin" | "strict-origin" | "strict-origin-when-cross-origin" | "unsafe-url" | null>;
    ...
    protocol: import("@kbn/config-schema").ConditionalType<import("@kbn/config-schema").Type<true>, "http1" | "http2", "http1" | "http2">;
    ...
    ssl: import("@kbn/config-schema").ObjectType<{
        ...
        clientAuthentication: import("@kbn/config-schema").Type<"optional" | "required" | "none">;
    }>;
    ...
    xsrf: import("@kbn/config-schema").ObjectType<{
        ...
        allowedSchemes: import("@kbn/config-schema").ConditionalType<true, ("apikey" | "bearer")[], ("apikey" | "bearer")[]>;
    }>;
    ...
    rateLimiter: import("@kbn/config-schema").ObjectType<{
        ...
        term: import("@kbn/config-schema").ConditionalType<false, never, "short" | "long" | "medium">;
    }>;

...
import { type Server, type Request } from '@hapi/hapi';
import HapiStaticFiles from '@hapi/inert';
import url from 'url';
import { v4 as uuidv4 } from 'uuid';
import { createServer, getServerOptions, setTlsConfig, getRequestId } from '@kbn/server-http-tools';
import type { Duration } from 'moment';
import { type Observable, type Subscription, firstValueFrom, pairwise, take } from 'rxjs';
import apm from 'elastic-apm-node';
import Brok from 'brok';
import type { Logger, LoggerFactory } from '@kbn/logging';
import type { InternalExecutionContextSetup } from '@kbn/core-execution-context-server-internal';
import { type CoreVersionedRouter, isSafeMethod, type Router } from '@kbn/core-http-router-server-internal';
import type {
  IRouter,
  RouteConfigOptions,
  KibanaRouteOptions,

...
/** @internal */
export type CoreHandlerDependencies = Pick<HttpServerSetup, 'registerOnPreRouting' | 'registerOnPreAuth' | 'registerAuth' | 'registerOnPostAuth' | 'registerOnPreResponse' | 'auth'>;

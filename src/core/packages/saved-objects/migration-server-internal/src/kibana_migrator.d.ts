...
import { type IKibanaMigrator, type IndexMapping, type ISavedObjectTypeRegistryInternal, type KibanaMigratorStatus, type MigrateDocumentOptions, type MigrationResult, type SavedObjectsMigrationConfigType } from '@kbn/core-saved-objects-base-server-internal';
...
export declare class KibanaMigrator implements IKibanaMigrator {
     ...
     */
    constructor({ client, typeRegistry, kibanaIndex, hashToVersionMap, soMigrationsConfig, kibanaVersion, logger, docLinks, waitForMigrationCompletion, nodeRoles, esCapabilities, kibanaVersionCheck, }: KibanaMigratorOptions);

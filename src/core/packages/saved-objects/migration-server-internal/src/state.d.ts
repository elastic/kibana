...
export type State = Readonly<CheckTargetTypesMappingsState | CheckVersionIndexReadyActions | CleanupUnknownAndExcluded | CleanupUnknownAndExcludedWaitForTaskState | CompatibleUpdateCheckClusterRoutingAllocationState | CreateIndexCheckClusterRoutingAllocationState | CreateNewTargetState | DoneState | FatalState | InitState | MarkVersionIndexReady | MarkVersionIndexReadyConflict | OutdatedDocumentsRefresh | OutdatedDocumentsSearchClosePit | OutdatedDocumentsSearchOpenPit | OutdatedDocumentsSearchRead | OutdatedDocumentsTransform | PrepareCompatibleMigration | RefreshSource | TransformedDocumentsBulkIndex | UpdateSourceMappingsPropertiesState | UpdateTargetMappingsMeta | UpdateTargetMappingsPropertiesState | UpdateTargetMappingsPropertiesWaitForTaskState | WaitForMigrationCompletionState | WaitForYellowSourceState>;

...
import type { SavedObjectsRawDoc, SavedObjectTypeExcludeFromUpgradeFilterHook } from '@kbn/core-saved-objects-server';
import type { IndexMapping, IndexTypesMap, VirtualVersionMap } from '@kbn/core-saved-objects-base-server-internal';
...
export type State = Readonly<CalculateExcludeFiltersState | CheckTargetTypesMappingsState | CheckUnknownDocumentsState | CheckVersionIndexReadyActions | CleanupUnknownAndExcluded | CleanupUnknownAndExcludedWaitForTaskState | CloneTempToTarget | CreateIndexCheckClusterRoutingAllocationState | CreateNewTargetState | CreateReindexTempState | DoneReindexingSyncState | DoneState | FatalState | InitState | LegacyCheckClusterRoutingAllocationState | LegacyCreateReindexTargetState | LegacyDeleteState | LegacyReindexState | LegacyReindexWaitForTaskState | LegacySetWriteBlockState | MarkVersionIndexReady | MarkVersionIndexReadySync | MarkVersionIndexReadyConflict | OutdatedDocumentsRefresh | OutdatedDocumentsSearchClosePit | OutdatedDocumentsSearchOpenPit | OutdatedDocumentsSearchRead | OutdatedDocumentsTransform | PrepareCompatibleMigration | ReadyToReindexSyncState | RefreshSource | RefreshTarget | ReindexCheckClusterRoutingAllocationState | ReindexSourceToTempClosePit | ReindexSourceToTempIndexBulk | ReindexSourceToTempOpenPit | ReindexSourceToTempRead | ReindexSourceToTempTransform | RelocateCheckClusterRoutingAllocationState | SetSourceWriteBlockState | SetTempWriteBlock | TransformedDocumentsBulkIndex | UpdateSourceMappingsPropertiesState | UpdateTargetMappingsMeta | UpdateTargetMappingsPropertiesState | UpdateTargetMappingsPropertiesWaitForTaskState | WaitForMigrationCompletionState | WaitForYellowSourceState>;

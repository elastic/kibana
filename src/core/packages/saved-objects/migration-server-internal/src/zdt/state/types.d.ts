...
import type { SavedObjectsRawDoc, SavedObjectsMappingProperties, SavedObjectTypeExcludeFromUpgradeFilterHook } from '@kbn/core-saved-objects-server';
...
export interface PostDocInitState extends PostInitState {
    ...
    readonly excludeFromUpgradeFilterHooks: Record<string, SavedObjectTypeExcludeFromUpgradeFilterHook>;

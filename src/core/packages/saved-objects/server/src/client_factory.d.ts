 ...
 * @public
 */
export type SavedObjectsClientFactory = ({ request, includedHiddenTypes, extensions, }: {
 ...
 * @public
 */
export type SavedObjectsEncryptionExtensionFactory = SavedObjectsExtensionFactory<ISavedObjectsEncryptionExtension | undefined>;
/**
 * Describes the factory used to create instances of the Saved Objects Security Extension.
 * @public
 */
export type SavedObjectsSecurityExtensionFactory = SavedObjectsExtensionFactory<ISavedObjectsSecurityExtension | undefined>;
/**
 * Describes the factory used to create instances of the Saved Objects Spaces Extension.
 * @public
 */
export type SavedObjectsSpacesExtensionFactory = SavedObjectsExtensionFactory<ISavedObjectsSpacesExtension | undefined>;
/**
...
export interface SavedObjectsRepositoryFactory {
     ...
     */
    createInternalRepository: (includedHiddenTypes?: string[], extensions?: SavedObjectsExtensions, serverTiming?: RequestTiming) => ISavedObjectsRepository;
}

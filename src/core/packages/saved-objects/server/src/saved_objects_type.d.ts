...
import type { SavedObjectsModelVersionMap, SavedObjectsModelVersionMapProvider } from './model_version';
 ...
 * @public
 */
export type SavedObjectTypeVersionGuesser = (document: SavedObjectUnsanitizedDoc) => string | number;
/**

...
import type { SavedObjectsImportRetry, SavedObjectsImportWarning, SavedObjectsImportResponse, SavedObjectsImportFailure } from '@kbn/core-saved-objects-common';
...
export type AccessControlImportTransformsFactory = (typeRegistry: ISavedObjectTypeRegistry, errors: SavedObjectsImportFailure[]) => AccessControlImportTransforms;

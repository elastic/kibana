...
import { ENCRYPTION_EXTENSION_ID, SPACES_EXTENSION_ID } from '../..';
import {
  SavedObjectConfig,
...
import { SavedObjectsClient, SavedObjectsClientProvider } from '../api';
import { KibanaMigrator } from '../migration';
import { SavedObjectsRepository } from '../api';
...
import type { SavedObjectsAccessControlTransforms } from '../contracts';

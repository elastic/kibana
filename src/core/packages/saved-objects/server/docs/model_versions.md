...
As for old migrations, model versions are bound to a given [savedObject type](https://github.com/elastic/kibana/blob/main/src/core/packages/saved-objects/server/src/saved_objects_type.ts#L22-L27)

When registering a SO type, a new [modelVersions](https://github.com/elastic/kibana/blob/main/src/core/packages/saved-objects/server/src/saved_objects_type.ts#L138-L177)
property is available. This attribute is a map of [SavedObjectsModelVersion](https://github.com/elastic/kibana/blob/main/src/core/packages/saved-objects/server/src/model_version/model_version.ts#L12-L20)
...
[Model versions](https://github.com/elastic/kibana/blob/main/src/core/packages/saved-objects/server/src/model_version/model_version.ts#L12-L20)
...
[link to the TS doc for `changes`](https://github.com/elastic/kibana/blob/main/src/core/packages/saved-objects/server/src/model_version/model_version.ts#L21-L51)
...
[link to the TS doc for `schemas`](https://github.com/elastic/kibana/blob/main/src/core/packages/saved-objects/server/src/model_version/schemas.ts#L11-L16)
...
This is a direct replacement for [the old SavedObjectType.schemas](https://github.com/elastic/kibana/blob/main/src/core/packages/saved-objects/server/src/saved_objects_type.ts#L75-L82)

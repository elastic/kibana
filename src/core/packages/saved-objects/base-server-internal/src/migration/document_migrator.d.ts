...
export interface IDocumentMigrator {
     ...
     */
    migrate(doc: SavedObjectUnsanitizedDoc, options?: DocumentMigrateOptions): SavedObjectUnsanitizedDoc;
    /**
     ...
     */
    isDowngradeRequired(doc: SavedObjectUnsanitizedDoc, options?: IsDowngradeRequiredOptions): boolean;
}
/**

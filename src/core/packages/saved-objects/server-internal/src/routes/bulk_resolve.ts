  ...
  router.post(
    {
      ...
      options: {
        ...
        description: `Retrieve multiple Kibana saved objects by identifier using any legacy URL aliases if they exist.
...
Consider using the export API for your use case.`,
        oasOperationObject: () => path.resolve(__dirname, './bulk_resolve.examples.yaml'),
      },
      security: {
        authz: {
          enabled: false,

...
test located at `src/core/packages/core/server/integration_tests/saved_objects/migrations/check_registered_types.test.ts`.
...
We have another integration test detecting this scenario (`src/core/packages/core/server/integration_tests/saved_objects/migrations/type_registrations.test.ts`)

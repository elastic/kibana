...
import { createTestHarness, SavedObjectTestHarness } from '../../../test-helpers/so_migrations';

/**
 * These tests are a little unnecessary because these migrations are incredibly simple, however
 * this file serves as an example of how to use test-helpers/so_migrations.
 */

...
import { type ConfigPath, ConfigService, Env } from '@kbn/config';
...
import { config, type PluginsConfigType } from './plugins_config';
import { take } from 'rxjs';
import type { PluginConfigDescriptor } from '@kbn/core-plugins-server';
import { type DiscoveredPlugin, PluginType } from '@kbn/core-base-common';

...
export interface UiamOAuthType {
     ...
     */
    listClients(request: KibanaRequest, clientId?: string, projectId?: string): Promise<{
     ...
     */
    resolveUsers(request: KibanaRequest, userIds: string[]): Promise<UiamResolvedUsersResponse | null>;
}

import type { UserProvidedValues, UiSettingsParams, GetUiSettingsContext } from '@kbn/core-ui-settings-common';
...
export interface IUiSettingsClient {
     ...
     */
    getUserProvided: <T = any>(bypassCache?: boolean) => Promise<Record<string, UserProvidedValues<T>>>;
    /**

...
describe('Both modes', () => {
  ...
  describe('Responsive mode', () => {
     ...
     */
    it.todo(
      'should render in collapsed mode if the screen size is less than `s` (767px)',
      () => {}
    );
     ...
     */
    it.todo(
      'should render in expanded mode if the screen size is more or equal to `s` (767px)',
      () => {}
    );
  });
  ...
  describe('Primary menu', () => {
    describe('Primary menu item', () => {
       ...
       */
      it.todo(
        'should have active state if the initial active item is the primary menu item',
        () => {}
      );
    ...
    describe('More menu', () => {
       ...
       */
      it.todo(
        'should have persistent popover on hover out after the trigger was clicked',
        () => {}
      );
       ...
       */
      it.todo(
        'should have active state if the initial active item is the "More" menu item',
        () => {}
      );
    });
  });
  ...
  describe('Footer', () => {
    describe('Footer item', () => {
       ...
       */
      it.todo(
        'should have active state if the initial active item is the footer submenu item',
        () => {}
      );
       ...
       */
      it.todo(
        'should display a tooltip with the item label on hover, and hide on hover out',
        () => {
    ...
    describe('Beta badge', () => {
       ...
       */
      it.todo(
        'should render a tooltip with the item label and a beta badge with beta icon',
        () => {}
      );
    });
    ...
    describe('Tech preview badge', () => {
       ...
       */
      it.todo(
        'should render a tooltip with the item label and a beta badge with flask icon',
        () => {}
      );
    });
  });
  ...
  describe('Keyboard navigation', () => {
     ...
     */
    it.todo(
      'should move focus to the first or last item in the menu when pressing Home or End',
      () => {}
    );
     ...
     */
    it.todo(
      'should return focus to the menu item that opened the popover when it is closed',
      () => {}
    );
  });
});

...
describe('toNavigationItems', () => {
  ...
  it('should warn about issues with navigation tree', async () => {
    ...
    expect(consoleWarnSpy.mock.calls[0][0]).toMatchInlineSnapshot(`
      ...
      • Navigation item \\"securityGroup:rules\\" is missing a \\"href\\". Using fallback value: \\"/tzo/s/sec/app/security/rules\\".
      ...
      • Navigation item \\"securityGroup:explore\\" is missing a \\"href\\". Using fallback value: \\"/tzo/s/sec/app/security/hosts\\".
      ...
      • Navigation item \\"securityGroup:investigations\\" is missing a \\"href\\". Using fallback value: \\"/tzo/s/sec/app/security/timelines\\".
      ...
      • Navigation item \\"securityGroup:assets\\" is missing a \\"href\\". Using fallback value: \\"/tzo/s/sec/app/fleet/agents\\".
      • Navigation item \\"securityGroup:machineLearning\\" is missing a \\"icon\\". Using fallback value: \\"machineLearningApp\\".
      • Navigation item \\"securityGroup:machineLearning\\" is missing a \\"href\\". Using fallback value: \\"/tzo/s/sec/app/ml/datavisualizer\\".
      • Navigation item \\"stack_management\\" is missing a \\"icon\\". Using fallback value: \\"gear\\".
      • Navigation item \\"stack_management\\" is missing a \\"href\\". Using fallback value: \\"/tzo/s/sec/app/management/ingest/ingest_pipelines\\".

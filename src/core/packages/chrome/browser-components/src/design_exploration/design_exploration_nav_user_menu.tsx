...
const USER_MENU_ARIA_LABEL = i18n.translate(
  'core.ui.chrome.designExplorationNav.userMenu.ariaLabel',
  {
...
const DesignExplorationNavUserMenuButton = ({ isOpen, toggleMenu, avatar }: UserMenuButtonProps) => {
  ...
  return (
    <div css={navFooterItemWrapperStyles} data-footer-label={USER_FOOTER_LABEL}>
      <EuiButtonIcon
        ...
        data-menu-item="true"
        data-test-subj="designExplorationNavUserMenuButton"
...
export const DesignExplorationNavUserMenu = () => {
  ...
  const navUserMenu = isValidElement(securityNavControl)
    ? React.cloneElement(securityNavControl, {
        ...
        avatarSize: 's',
        renderButton: (props: UserMenuButtonProps) => (
          <DesignExplorationNavUserMenuButton {...props} />
        ),
  ...
  return (
    <div
      ...
      `}
      data-test-subj="designExplorationNavUserMenu"
    >

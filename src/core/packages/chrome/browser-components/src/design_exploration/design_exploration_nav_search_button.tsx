...
const ARIA_LABEL = i18n.translate('core.ui.chrome.designExplorationNav.searchButton.ariaLabel', {
  defaultMessage: 'Search',
});

const SHORTCUT = { key: '/', meta: true };

export const DesignExplorationNavSearchButton = () => {
    ...
    >
      ...
      >
        <EuiButtonIcon
          ...
          color="text"
          data-menu-item="true"
          data-test-subj="designExplorationNavSearchButton"
          display="empty"
          iconType="search"

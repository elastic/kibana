...
const createStartContractMock = () => {
  ...
  const startContract: DeeplyMockedKeys<InternalChromeStart> = lazyObject({
    ...
    applicationWorkspace: lazyObject({
      getIsOpen$: jest.fn().mockReturnValue(new BehaviorSubject(true)),
      getIsOpen: jest.fn().mockReturnValue(true),
      setIsOpen: jest.fn(),
      open: jest.fn(),
      close: jest.fn(),
      registerOnClose: jest.fn().mockReturnValue(jest.fn()),
    }),
    agentWorkspace: lazyObject({
      getIsOpen$: jest.fn().mockReturnValue(new BehaviorSubject(true)),
      getIsOpen: jest.fn().mockReturnValue(true),
      setIsOpen: jest.fn(),
      open: jest.fn(),

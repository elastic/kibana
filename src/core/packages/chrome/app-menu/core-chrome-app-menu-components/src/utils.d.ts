...
import type { AppMenuConfig, AppMenuItemCommon, AppMenuItemType, AppMenuPopoverItem, AppMenuPrimaryActionItem } from './types';
/**
 ...
 */
export declare const getPopoverPanels: ({ items, staticItems, primaryActionItem, startPanelId, rootPanelWidth, rootPopoverTestId, onClose, onCloseOverflowButton, anchorDomElement, }: {

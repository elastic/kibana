...
const slots: Array<{ name: string; style: React.CSSProperties }> = [
  ...
  },
  {
    ...
    style: {
      top: layoutVar('application-top-bar-top'),
      bottom: layoutVar('application-top-bar-bottom'),
      left: layoutVar('application-top-bar-left'),
      right: layoutVar('application-top-bar-right'),
      width: layoutVar('application-top-bar-width'),
  ...
  },
  {
    ...
    style: {
      top: layoutVar('application-bottom-bar-top'),
      bottom: layoutVar('application-bottom-bar-bottom'),
      left: layoutVar('application-bottom-bar-left'),
      right: layoutVar('application-bottom-bar-right'),
      width: layoutVar('application-bottom-bar-width'),

...
export const LayoutGlobalCSS = () => {
  ...
  const applicationTopBar = css`
    --kbn-layout--application-top-bar-height: ${applicationTopBarHeight}px;
    --kbn-layout--application-top-bar-top: var(--kbn-layout--application-top);
    --kbn-layout--application-top-bar-left: var(--kbn-layout--application-left);
    --kbn-layout--application-top-bar-width: var(--kbn-layout--application-width);
    --kbn-layout--application-top-bar-right: var(--kbn-layout--application-right);
    --kbn-layout--application-top-bar-bottom: calc(
      var(--kbn-layout--application-top) + var(--kbn-layout--application-top-bar-height)
    );
  `;

  const applicationBottomBar = css`
    --kbn-layout--application-bottom-bar-height: ${applicationBottomBarHeight}px;
    --kbn-layout--application-bottom-bar-top: calc(
      --kbn-layout--application-bottom - var(--kbn-layout--application-bottom-bar-height)
    );
    --kbn-layout--application-bottom-bar-left: var(--kbn-layout--application-left);
    --kbn-layout--application-bottom-bar-width: var(--kbn-layout--application-width);
    --kbn-layout--application-bottom-bar-right: var(--kbn-layout--application-right);
    --kbn-layout--application-bottom-bar-bottom: calc(var(--kbn-layout--application-bottom));
  `;
  ...
  const applicationContent = css`
    --kbn-layout--application-content-top: calc(
      var(--kbn-layout--application-top) + var(--kbn-layout--application-top-bar-height)
    );
    --kbn-layout--application-content-bottom: calc(
      var(--kbn-layout--application-bottom) - var(--kbn-layout--application-bottom-bar-height)
    );
    --kbn-layout--application-content-left: var(--kbn-layout--application-left);
    --kbn-layout--application-content-right: var(--kbn-layout--application-right);
    --kbn-layout--application-content-height: calc(
      var(--kbn-layout--application-height) - var(--kbn-layout--application-top-bar-height) -
        var(--kbn-layout--application-bottom-bar-height)
    );
    --kbn-layout--application-content-width: var(--kbn-layout--application-width);
  `;

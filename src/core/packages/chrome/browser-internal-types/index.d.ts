...
import type { ChromeSetup, ChromeStart, ChromeBadge, ChromeBreadcrumb, ChromeBreadcrumbsAppendExtension, ChromeProjectNavigationNode, ChromeSetProjectBreadcrumbsParams, ChromeUserBanner, AppDeepLinkId, NavigationTreeDefinition, NavigationTreeDefinitionUI, CloudURLs, SolutionId } from '@kbn/core-chrome-browser';
/** @internal */

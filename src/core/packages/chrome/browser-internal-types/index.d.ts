...
import type { ChromeSetup, ChromeStart, AppHeaderConfig, ChromeBadge, ChromeBreadcrumb, ChromeBreadcrumbsAppendExtension, ChromeBreadcrumbsBadge, ChromeNext, GlobalHeaderAiButton, ChromeProjectNavigationNode, ChromeSetProjectBreadcrumbsParams, ChromeUserBanner, GlobalSearchConfig, AppDeepLinkId, NavigationCustomization, NavigationTreeDefinition, NavigationTreeDefinitionUI, CloudURLs, SolutionId } from '@kbn/core-chrome-browser';
/** @internal */
...
export interface InternalChromeStart extends ChromeStart {
    ...
    project: {
        ...
        initNavigation<LinkId extends AppDeepLinkId = AppDeepLinkId, Id extends string = string, ChildrenId extends string = Id>(id: SolutionId, navigationTree$: Observable<NavigationTreeDefinition<LinkId, Id, ChildrenId>>): void;

...
import type { SidebarAppDefinition, SidebarAppId, SidebarStart } from '@kbn/core-chrome-sidebar';
...
const TestComponent = jest.fn((_props: Record<string, unknown>) => (
  <div>Sidebar App Content</div>
));

/** Single cast point — TestComponent is a mock that accepts any sidebar component props */
const loadTestComponent = () =>
  Promise.resolve(TestComponent as unknown as SidebarComponentType);
...
const startService = (...apps: Array<SidebarAppDefinition<any, any>>): SidebarStart => {

...
export class CoreInjectionService {
  ...
  public getContainer(id: PluginOpaqueId, root = this.root) {
    return root.isBoundNamed(CoreInjectionService.Scope, id)
      ? root.getNamed(CoreInjectionService.Scope, id)
      : undefined;
  }

  public load(id: PluginOpaqueId, module: interfaces.ContainerModule): void {
  ...
  public dispose(container: interfaces.Container) {
  ...
  public fork(root: interfaces.Container = this.root) {

...
/**
 * A handler that will be executed before leaving the pricing, either when
 * going to another pricing or when closing the browser tab or manually changing
 * the url.
...
/**
 * Possible type of actions on pricing leave.
 *
 * @public
 */
 ...
 * behaviour when leaving the pricing.
 *
 ...
 * message when trying to leave an pricing.
 *
 * See {@link AppLeaveActionFactory}
 *
 * @public
...
export interface AppLeaveActionFactory {
   ...
   * pricing, allowing him to choose if he wants to stay on the app or confirm that he
   * wants to leave.
   *
   ...
   * the user tries to leave an pricing
   */

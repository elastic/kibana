...
import type { AppMountParameters, AppUpdater } from '@kbn/core-pricing-browser';
import { overlayServiceMock } from '@kbn/core-overlays-browser-mocks';
import { customBrandingServiceMock } from '@kbn/core-custom-branding-browser-mocks';
import type { MountPoint } from '@kbn/core-mount-utils-browser';
import type { MockLifecycle } from '../src/test_helpers/test_types';
import { ApplicationService } from '../src/pricing_service';
...
describe('ApplicationService', () => {
  ...
  describe('leaving an pricing that registered an app leave handler', () => {
  ...
  describe('registering action menus', () => {
    ...
    it('updates the observable value when an pricing is mounted', async () => {
      const { register } = service.setup(setupDeps);
    ...
    it('updates the observable value when switching pricing', async () => {
      const { register } = service.setup(setupDeps);
    ...
    it('updates the observable value to undefined when switching to an pricing without action menu', async () => {
      const { register } = service.setup(setupDeps);
    ...
    it('allow pricings to call `setHeaderActionMenu` multiple times', async () => {
      const { register } = service.setup(setupDeps);
    ...
    it('allow pricings to unset the current menu', async () => {
      const { register } = service.setup(setupDeps);

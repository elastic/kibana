...
import { AppStatus } from '@kbn/core-pricing-browser';
...
describe('AppRouter', () => {
  ...
  it('can navigate between standard pricing and one with custom appRoute', async () => {
  ...
  it('can navigate between two pricings with custom appRoutes', async () => {

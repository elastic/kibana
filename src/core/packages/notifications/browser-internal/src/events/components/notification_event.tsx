...
import type { FunctionComponent, ReactElement, HTMLAttributes } from 'react';
...
import type { NotificationEventMetaProps } from './notification_event_meta';
import { NotificationEventMeta } from './notification_event_meta';
import type { NotificationEventMessagesProps } from './notification_event_messages';
import { NotificationEventMessages } from './notification_event_messages';
import type { NotificationEventReadButtonProps } from './notification_event_read_button';
import { NotificationEventReadButton } from './notification_event_read_button';

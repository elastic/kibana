...
import { EuiAccordion, EuiText, useEuiTheme, useGeneratedHtmlId } from '@elastic/eui';
...
export const NotificationEventMessages: FunctionComponent<NotificationEventMessagesProps> = ({
  ...
  const accordionButtonText = i18n.translate(
    'core.notifications.eventMessages.accordionButtonText',
    {
      defaultMessage: '+ {messagesLength} more',
      values: { messagesLength: messagesLength - 1 },
    }
  );

  const accordionAriaLabelButtonText = i18n.translate(
    'core.notifications.eventMessages.accordionAriaLabelButtonText',
    {
  ...
  const accordionHideText = i18n.translate('core.notifications.eventMessages.accordionHideText', {
    defaultMessage: 'hide',
  });

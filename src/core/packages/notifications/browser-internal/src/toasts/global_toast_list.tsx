...
import { EuiGlobalToastList, type EuiGlobalToastListToast as EuiToast } from '@elastic/eui';
...
import { deduplicateToasts, type ToastWithRichTitle } from './deduplicate_toasts';

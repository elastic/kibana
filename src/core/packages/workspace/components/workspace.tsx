...
import { useIsNavigationCollapsed, useIsToolbarOpen } from '@kbn/core-workspace-state';
...
const WorkspaceLayout = ({ children }: WorkspaceProps) => {
  ...
  const component = (
    <>
      <WorkspaceGlobalCSS />
      <WorkspaceComponent {...{ isNavigationCollapsed, isToolbarOpen }}>
        {children}
      </WorkspaceComponent>
    </>
  );
...
export const Workspace = Object.assign(WorkspaceLayout, {
  ...
  Toolbar: WorkspaceComponent.Toolbar,

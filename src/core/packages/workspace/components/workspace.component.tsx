...
import { WorkspaceToolbar as Toolbar, WorkspaceTool as Tool } from './toolbar';
...
export interface WorkspaceComponentProps {
  children: {
    ...
    toolbar: ReturnType<typeof Toolbar>;
  };
}

const Workspace = ({
  children: { application, banner, footer, navigation, header, tool, toolbar },

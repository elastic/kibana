...
import type { WorkspaceTool } from './toolbox';
...
export const WorkspaceProvider = ({ children, tools }: WorkspaceProviderProps) => (
  <WorkspaceContext.Provider value={{ tools }}>{children}</WorkspaceContext.Provider>
);

export const useWorkspaceContext = () => React.useContext(WorkspaceContext);
export const useWorkspaceTools = () => useWorkspaceContext().tools;

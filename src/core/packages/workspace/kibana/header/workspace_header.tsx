...
import {
  KibanaWorkspaceHeaderComponent,
  KibanaWorkspaceHeaderComponentProps,
} from './workspace_header.component';

export type KibanaWorkspaceHeaderProps = Pick<
  KibanaWorkspaceHeaderComponentProps,
  'logo' | 'breadcrumbs' | 'children'
>;

export const KibanaWorkspaceHeader = (props: KibanaWorkspaceHeaderProps) => {
  ...
  return (
    <KibanaWorkspaceHeaderComponent {...{ isNavigationCollapsed, onNavigationToggle, ...props }} />
  );
};

...
export declare const userActivityActions: {
    ...
    readonly dashboard_create: {
        readonly description: "User created a dashboard.";
        readonly ownerTeam: "@elastic/kibana-presentation";
        readonly groupName: "Dashboard";
        readonly versionAddedAt: "9.5";
    };
    readonly dashboard_update: {
        readonly description: "User updated a dashboard.";
        readonly ownerTeam: "@elastic/kibana-presentation";
        readonly groupName: "Dashboard";
        readonly versionAddedAt: "9.5";
    };
    ...
    readonly dashboard_view: {
        readonly description: "User viewed a dashboard.";
        readonly ownerTeam: "@elastic/kibana-presentation";
        readonly groupName: "Dashboard";
        readonly versionAddedAt: "9.5";
    };
    readonly dashboard_refresh: {
        readonly description: "The dashboard was refreshed (either by the user or auto-refresh interval).";
        readonly ownerTeam: "@elastic/kibana-presentation";
        readonly groupName: "Dashboard";
        readonly versionAddedAt: "9.5";
    };

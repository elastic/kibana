...
export function toNavLink(app: AppInfo | LegacyAppInfo, basePath: IBasePath): NavLinkWrapper {
...
function isLegacyApp(app: AppInfo | LegacyAppInfo): app is LegacyAppInfo {

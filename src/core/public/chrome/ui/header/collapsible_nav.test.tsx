...
// import { DEFAULT_APP_CATEGORIES, ChromeNavLink } from '../../..';
...
// function mockLink({ label = 'discover', category, onClick }: Partial<ChromeNavLink>) {
//   return {
//     key: label,
//     label,
//     href: label,
...
// function mockRecentNavLink({
//   label = 'recent',
//   onClick,
// }: Partial<ChromeRecentlyAccessedHistoryItem>) {
//   return {
//     href: label,
//     label,
//     title: label,

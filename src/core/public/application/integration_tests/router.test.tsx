...
describe('AppRouter', () => {
  ...
  it('calls mount handler and returned unmount function when navigating between apps', async () => {
    ...
    expect(dom?.html()).toMatchInlineSnapshot(`
      "<span class=\\"euiLoadingElastic euiLoadingElastic--xxLarge appContainer__loading\\" aria-label=\\"Loading application\\"><span data-euiicon-type=\\"logoElastic\\"></span></span><div class="kbnAppWrapper" aria-busy="true"><div>
      basename: /app/app1

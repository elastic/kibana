    ...
    return deepFreeze({
      ...
      links: {
        ...
        ml: {
          ...
          anomalyDetectionAggs: `${ELASTIC_WEBSITE_URL}guide/en/machine-learning/${DOC_LINK_VERSION}/ml-configuring-aggregation.html`,
          anomalyDetectionCategories: `${ELASTIC_WEBSITE_URL}guide/en/machine-learning/${DOC_LINK_VERSION}/ml-configuring-categories.html`,
          ...
          anomalyDetectionJobTipsBucketSpan: `${ELASTIC_WEBSITE_URL}guide/en/machine-learning/${DOC_LINK_VERSION}/#bucket-span`,
          anomalyDetectionJobTipsCardinality: `${ELASTIC_WEBSITE_URL}guide/en/machine-learning/${DOC_LINK_VERSION}/create-jobs.html#cardinality`,
          anomalyDetectionJobTipsDetectors: `${ELASTIC_WEBSITE_URL}guide/en/machine-learning/${DOC_LINK_VERSION}/create-jobs.html#detectors`,
          anomalyDetectionJobTipsModelMemory: `${ELASTIC_WEBSITE_URL}guide/en/machine-learning/${DOC_LINK_VERSION}/create-jobs.html#model-memory-limits`,
          ...
          influencers: `${ELASTIC_WEBSITE_URL}guide/en/machine-learning/${DOC_LINK_VERSION}/ml-influencers.html`,
        ...
        apis: {
          createAnomalyDetectionJobsPathParams: `${ELASTICSEARCH_DOCS}ml-put-job.html#ml-put-job-path-parms`,
          createAnomalyDetectionJobsRequestBody: `${ELASTICSEARCH_DOCS}ml-put-job-request-body`,

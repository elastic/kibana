    ...
    return deepFreeze({
      ...
      links: {
        ...
        elasticsearch: {
          ...
          remoteClusters: `${ELASTIC_WEBSITE_URL}guide/en/elasticsearch/reference/master/remote-clusters.html`,
          remoteClustersProxy: `${ELASTIC_WEBSITE_URL}guide/en/elasticsearch/reference/master/remote-clusters.html#proxy-mode`,
          remoteClusersProxySettings: `${ELASTIC_WEBSITE_URL}guide/en/elasticsearch/reference/master/remote-clusters-settings.html#remote-cluster-proxy-settings`,

...
export class SavedObjectsClient {
    ...
    find: <T extends SavedObjectAttributes>(options: Pick<SavedObjectsFindOptions, "search" | "filter" | "type" | "page" | "searchFields" | "defaultSearchOperator" | "hasReference" | "sortField" | "perPage" | "fields">) => Promise<SavedObjectsFindResponsePublic<T>>;

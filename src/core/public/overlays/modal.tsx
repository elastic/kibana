...
export class ModalRef {
  /**
   * An Promise that will resolve once this modal is closed.
   *
   * Modals can close from user interaction, calling `close()` on the modal
   * reference or another call to `openModal()` replacing your modal.
   */

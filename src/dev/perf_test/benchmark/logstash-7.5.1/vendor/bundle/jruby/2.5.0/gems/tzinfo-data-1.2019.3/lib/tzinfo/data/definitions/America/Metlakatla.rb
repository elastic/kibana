      ...
      module America
        module Metlakatla
          ...
          timezone 'America/Metlakatla' do |tz|
            ...
            tz.transition 2018, 11, :o2, 1541325600
            tz.transition 2019, 1, :o6, 1547978400
            ...
            tz.transition 2069, 3, :o7, 3130138800, 59443583, 24
            tz.transition 2069, 11, :o6, 3150698400, 29724647, 12
          end
        end
      end
    end

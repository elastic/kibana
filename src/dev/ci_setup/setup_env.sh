...
export GECKODRIVER_CDNURL="https://ci-proxy-cache.kibana.dev"
export CHROMEDRIVER_CDNURL="https://ci-proxy-cache.kibana.dev"
export RE2_DOWNLOAD_MIRROR="https://ci-proxy-cache.kibana.dev"
export CYPRESS_DOWNLOAD_MIRROR="https://ci-proxy-cache.kibana.dev/cypress"

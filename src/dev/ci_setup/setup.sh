...
###
### generate .bazelrc-ci.auth
###
echo "# Generated by src/dev/ci_setup/setup.sh" > src/dev/ci_setup/.bazelrc-ci.auth
echo "build --bes_results_url=https://app.buildbuddy.io/invocation/" >> src/dev/ci_setup/.bazelrc-ci.auth
echo "build --bes_backend=grpcs://cloud.buildbuddy.io" >> src/dev/ci_setup/.bazelrc-ci.auth
echo "build --remote_cache=grpcs://cloud.buildbuddy.io" >> src/dev/ci_setup/.bazelrc-ci.auth
echo "build --remote_timeout=3600" >> src/dev/ci_setup/.bazelrc-ci.auth
echo "build --remote_header=x-buildbuddy-api-key=$KIBANA_BUILDBUDDY_CI_API_KEY" >> src/dev/ci_setup/.bazelrc-ci.auth

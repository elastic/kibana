...
export const LICENSE_OVERRIDES = {
  ...
  '@elastic/eui-theme-base@0.0.1': ['Elastic License 2.0 OR AGPL-3.0-only OR SSPL-1.0'],
  '@elastic/eui-theme-borealis@0.0.1': ['Elastic License 2.0 OR AGPL-3.0-only OR SSPL-1.0'],
  '@elastic/eui-theme-borealis-grey@0.0.1': ['Elastic License 2.0 OR AGPL-3.0-only OR SSPL-1.0'],
  '@elastic/eui-common@0.0.1': ['Elastic License 2.0 OR AGPL-3.0-only OR SSPL-1.0'],
  '@elastic/eui@97.2.0': ['Elastic License 2.0 OR AGPL-3.0-only OR SSPL-1.0'],

...
export const LICENSE_OVERRIDES = {
  ...
  '@elastic/eui@98.2.0-borealis.0': ['Elastic License 2.0 OR AGPL-3.0-only OR SSPL-1.0'],
  '@elastic/eui-theme-borealis@0.0.5': ['Elastic License 2.0 OR AGPL-3.0-only OR SSPL-1.0'],

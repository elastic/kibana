...
export const LICENSE_OVERRIDES = {
  ...
  '@elastic/eui@106.3.0': ['Elastic License 2.0 OR AGPL-3.0-only OR SSPL-1.0'],
  '@elastic/eui-amsterdam@106.3.0-amsterdam.0': [
    'Elastic License 2.0 OR AGPL-3.0-only OR SSPL-1.0',
  ],
  '@elastic/eui-theme-borealis@3.3.1': ['Elastic License 2.0 OR AGPL-3.0-only OR SSPL-1.0'],
  '@elastic/eui-theme-common@4.0.0': ['Elastic License 2.0 OR AGPL-3.0-only OR SSPL-1.0'],

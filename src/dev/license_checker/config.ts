...
export const LICENSE_OVERRIDES = {
  // conversion to a public-domain like license
  'cycle@1.0.3': ['CC0-1.0'],

  // cf. https://github.com/bjornharrtell/jsts
  'jsts@1.1.2': ['Eclipse Distribution License - v 1.0'],
  'jsts@1.6.2': ['Eclipse Distribution License - v 1.0'],

  // license in readme https://github.com/tmcw/jsonlint

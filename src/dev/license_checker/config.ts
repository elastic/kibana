...
export const LICENSE_OVERRIDES = {
  ...
  '@elastic/esql@0.0.4': ['Elastic License 2.0'],
  '@elastic/eui@113.0.0': ['Elastic License 2.0 OR AGPL-3.0-only OR SSPL-1.0'],
  '@elastic/eui-theme-borealis@6.0.0': ['Elastic License 2.0 OR AGPL-3.0-only OR SSPL-1.0'],

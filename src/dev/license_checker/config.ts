...
export const LICENSE_OVERRIDES = {
  ...
  '@elastic/eui@97.3.1-borealis.1': ['Elastic License 2.0 OR AGPL-3.0-only OR SSPL-1.0'],
  '@elastic/eui-theme-borealis@0.0.2': ['Elastic License 2.0 OR AGPL-3.0-only OR SSPL-1.0'],

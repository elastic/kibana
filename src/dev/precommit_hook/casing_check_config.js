...
export const TEMPORARILY_IGNORED_PATHS = [
  ...
  'x-pack/test/functional/es_archives/monitoring/beats-with-restarted-instance_mb/data.json.gz',
  ...
  'x-pack/test/functional/es_archives/monitoring/beats-with-restarted-instance_mb/mappings.json',
  'x-pack/test/functional/es_archives/monitoring/logstash-pipelines/data.json.gz',
  'x-pack/test/functional/es_archives/monitoring/logstash-pipelines_mb/data.json.gz',
  'x-pack/test/functional/es_archives/monitoring/logstash-pipelines/mappings.json',
  'x-pack/test/functional/es_archives/monitoring/logstash-pipelines_mb/mappings.json',
  'x-pack/test/functional/es_archives/monitoring/multi-basic/data.json.gz',
  'x-pack/test/functional/es_archives/monitoring/multi-basic_mb/data.json.gz',
  'x-pack/test/functional/es_archives/monitoring/multi-basic/mappings.json',
  'x-pack/test/functional/es_archives/monitoring/multi-basic_mb/mappings.json',
  'x-pack/test/functional/es_archives/monitoring/singlecluster-basic-beats/data.json.gz',
  'x-pack/test/functional/es_archives/monitoring/singlecluster-basic-beats_mb/data.json.gz',
  'x-pack/test/functional/es_archives/monitoring/singlecluster-basic-beats/mappings.json',
  'x-pack/test/functional/es_archives/monitoring/singlecluster-basic-beats_mb/mappings.json',
  'x-pack/test/functional/es_archives/monitoring/singlecluster-green-gold/data.json.gz',
  'x-pack/test/functional/es_archives/monitoring/singlecluster-green-gold_mb/data.json.gz',
  'x-pack/test/functional/es_archives/monitoring/singlecluster-green-gold/mappings.json',
  'x-pack/test/functional/es_archives/monitoring/singlecluster-green-gold_mb/mappings.json',
  'x-pack/test/functional/es_archives/monitoring/singlecluster-green-platinum/data.json.gz',
  'x-pack/test/functional/es_archives/monitoring/singlecluster-green-platinum_mb/data.json.gz',
  'x-pack/test/functional/es_archives/monitoring/singlecluster-green-platinum/mappings.json',
  'x-pack/test/functional/es_archives/monitoring/singlecluster-green-platinum_mb/mappings.json',
  'x-pack/test/functional/es_archives/monitoring/singlecluster-green-trial-two-nodes-one-cgrouped/data.json.gz',
  'x-pack/test/functional/es_archives/monitoring/singlecluster-green-trial-two-nodes-one-cgrouped_mb/data.json.gz',
  'x-pack/test/functional/es_archives/monitoring/singlecluster-green-trial-two-nodes-one-cgrouped/mappings.json',
  'x-pack/test/functional/es_archives/monitoring/singlecluster-green-trial-two-nodes-one-cgrouped_mb/mappings.json',
  'x-pack/test/functional/es_archives/monitoring/singlecluster-red-platinum/data.json.gz',
  'x-pack/test/functional/es_archives/monitoring/singlecluster-red-platinum_mb/data.json.gz',
  'x-pack/test/functional/es_archives/monitoring/singlecluster-red-platinum/mappings.json',
  'x-pack/test/functional/es_archives/monitoring/singlecluster-red-platinum_mb/mappings.json',
  'x-pack/test/functional/es_archives/monitoring/singlecluster-three-nodes-shard-relocation/data.json.gz',
  'x-pack/test/functional/es_archives/monitoring/singlecluster-three-nodes-shard-relocation_mb/data.json.gz',
  'x-pack/test/functional/es_archives/monitoring/singlecluster-three-nodes-shard-relocation/mappings.json',
  'x-pack/test/functional/es_archives/monitoring/singlecluster-three-nodes-shard-relocation_mb/mappings.json',
  ...
  'x-pack/test/functional/es_archives/monitoring/singlecluster-yellow-platinum--with-10-alerts_mb/mappings.json',
  'x-pack/test/functional/es_archives/monitoring/singlecluster-yellow-platinum/data.json.gz',
  'x-pack/test/functional/es_archives/monitoring/singlecluster-yellow-platinum_mb/data.json.gz',
  'x-pack/test/functional/es_archives/monitoring/singlecluster-yellow-platinum/mappings.json',
  'x-pack/test/functional/es_archives/monitoring/singlecluster-yellow-platinum_mb/mappings.json',
];

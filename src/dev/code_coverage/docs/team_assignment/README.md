...
#CC# /x-pack/solutions/security/solutions/security/plugins/security_solution/ @elastic/siem
```
...
```
x-pack/solutions/security/solutions/security/plugins/security_solution/common/constants.ts siem
x-pack/solutions/security/solutions/security/plugins/security_solution/common/detection_engine/build_exceptions_query.test.ts siem
x-pack/solutions/security/solutions/security/plugins/security_solution/common/detection_engine/build_exceptions_query.ts siem
...
```
...
We search the data file, for any given "coveredFilePath"
 - Given the above assignments block, and lets say the "coveredFilePath" during ingestion is 
   - `x-pack/solutions/security/solutions/security/plugins/security_solution/common/constants.ts`

...
There are several commands supported by `@kbn/pm`, but rather than documenting them here they are documented in the help text. Please run `pnpm kbn --help` locally to see the most up-to-date info.

...
module.exports = {
  ...
  setupFiles: [
    ...
    '<rootDir>/src/dev/packages/test/src/jest/setup/polyfills.jsdom.js',
    '<rootDir>/src/dev/packages/test/src/jest/setup/enzyme.js',
  ],

  // A list of paths to modules that run some code to configure or set up the testing framework before each test
  setupFilesAfterEnv: [
    '<rootDir>/src/dev/packages/test/src/jest/setup/setup_test.js',
    '<rootDir>/src/dev/packages/test/src/jest/setup/mocks.moment_timezone.js',
    '<rootDir>/src/dev/packages/test/src/jest/setup/mocks.eui.js',
    '<rootDir>/src/dev/packages/test/src/jest/setup/react_testing_library.js',
    '<rootDir>/src/dev/packages/test/src/jest/setup/mocks.kbn_i18n_react.js',
    process.env.CI ? '<rootDir>/src/dev/packages/test/src/jest/setup/disable_console_logs.js' : [],
  ].flat(),
  ...
  snapshotSerializers: [
    ...
    '<rootDir>/src/dev/packages/test/src/jest/setup/emotion.js',
  ],
  ...
  transform: {
    '^.+\\.(js|tsx?)$': '<rootDir>/src/dev/packages/test/src/jest/transforms/babel/index.js',
    '^.+\\.(txt|html)?$': '<rootDir>/src/dev/packages/test/src/jest/transforms/raw.js',
    '^.+\\.peggy?$': '<rootDir>/src/dev/packages/test/src/jest/transforms/peggy.js',
  },
  ...
  resolver: '<rootDir>/src/dev/packages/test/src/jest/resolver.js',
  ...
  testResultsProcessor:
    '<rootDir>/src/dev/packages/test/src/jest/result_processors/logging_result_processor.js',
};

...
export interface ServerlessOptions extends EsClusterExecOptions, BaseOptions {
   ...
   * (see list of files that can be overwritten under `src/dev/packages/es/src/serverless_resources/users`)
   */
...
export async function runServerlessCluster(log: ToolingLog, options: ServerlessOptions) {
  ...
  See src/dev/packages/es/src/serverless_resources/README.md for additional information on authentication.

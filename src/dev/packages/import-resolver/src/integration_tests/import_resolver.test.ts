...
describe('#resolve()', () => {
  it('resolves imports to packages', () => {
    expect(resolver.resolve('@kbn/box', FIXTURES_DIR)).toMatchInlineSnapshot(`
      Object {
        "absolute": <absolute path>/src/dev/packages/import-resolver/src/__fixtures__/packages/box/index.js,
        "pkgId": "@kbn/box",
        "type": "file",
      }
    `);
  ...
  it('resolves node_module imports', () => {
    expect(resolver.resolve('foo', FIXTURES_DIR)).toMatchInlineSnapshot(`
      Object {
        "absolute": <absolute path>/src/dev/packages/import-resolver/src/__fixtures__/node_modules/foo/index.js,
        "nodeModule": "foo",
        "type": "file",
      }
    `);
  ...
  it('resolves nested node_module imports', () => {
    expect(resolver.resolve('bar', Path.join(FIXTURES_DIR, 'packages', 'box')))
      ...
      Object {
        "absolute": <absolute path>/src/dev/packages/import-resolver/src/__fixtures__/packages/box/node_modules/bar/index.js,
        "nodeModule": "bar",
        "type": "file",
      }
    `);
  ...
  it('resolves relative paths', () => {
    expect(resolver.resolve('./bar', Path.resolve(FIXTURES_DIR, 'src/bar'))).toMatchInlineSnapshot(`
      Object {
        "absolute": <absolute path>/src/dev/packages/import-resolver/src/__fixtures__/src/bar/bar.js,
        "pkgId": "@kbn/bar",
        "type": "file",
      }
    `);
...
describe('#getAbsolutePackageDir()', () => {
  it('returns path for package', () => {
    expect(resolver.getAbsolutePackageDir('@kbn/box')).toMatchInlineSnapshot(
      `<absolute path>/src/dev/packages/import-resolver/src/__fixtures__/packages/box`
    );
    expect(resolver.getAbsolutePackageDir('@kbn/bar')).toMatchInlineSnapshot(
      `<absolute path>/src/dev/packages/import-resolver/src/__fixtures__/src/bar`
    );
  });

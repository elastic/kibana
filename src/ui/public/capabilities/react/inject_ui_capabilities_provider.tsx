...
export function injectUICapabilitiesProvider<P>(WrappedComponent: React.ComponentType<P>) {
  const UICapabilitiesProviderWrapper: React.SFC<P> = props => {
    return (
  ...
  UICapabilitiesProviderWrapper.propTypes = WrappedComponent.propTypes;

  return UICapabilitiesProviderWrapper;
}

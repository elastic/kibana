...
describe('add filters', function () {
  ...
  describe('adding filters', function () {
    ...
    it('should not add filters to appState because alt key pressed', function () {
      const evt = document.createEvent('MouseEvents');
      evt.initMouseEvent('mousedown', true, true, window, 0, 0, 0, 80, 20, false, true, false, false, 0, null);

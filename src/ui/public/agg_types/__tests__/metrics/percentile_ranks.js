...
import { AggTypeMetricsPercentileRanksProvider } from 'ui/agg_types/metrics/percentile_ranks';
import VisProvider from 'ui/vis';
import FixturesStubbedLogstashIndexPatternProvider from 'fixtures/stubbed_logstash_index_pattern';

describe('AggTypeMetricsPercentileRanksProvider class', function () {
  ...
  beforeEach(ngMock.inject(function (Private) {
    ...
    aggTypeMetricPercentileRanks = Private(AggTypeMetricsPercentileRanksProvider);
  }));

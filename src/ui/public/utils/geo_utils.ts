...
/**
 * A Map collar that describe the original bounds information of a map
 */
...
export function geoContains(collar: Collar, bounds: Collar): boolean {
  ...
  // oth corners are inside collar so collar contains bounds
  return true;
}

export function scaleBounds(bounds: Collar): Collar {

...
function scan(type) {
  let dir = fromRoot('src/ui/public', type);
...
function findStyles() {
  let base = ['ui/styles/theme.less', 'ui/styles/base.less'];
  let exclude = ['ui/styles/mixins.less', 'ui/styles/variables.less'];
  let found = scan('styles', true);

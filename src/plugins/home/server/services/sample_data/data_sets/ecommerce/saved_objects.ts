...
import { euiPaletteGreen, euiPaletteRed } from '@kbn/palettes';

const redColors = euiPaletteRed(5);
const greenColors = euiPaletteGreen(5);
      ...
      panelsJSON: JSON.stringify([
        {
          ...
          embeddableConfig: {
            attributes: {
              title: '[eCommerce] Promotion Tracking (converted)',
              ...
              references: [
                {
                  type: 'index-pattern',
                  id: 'ff959d40-b880-11e8-a6d9-e546fe2bba5f',
                  name: 'indexpattern-datasource-layer-e3b3cb5c-e3b1-497f-a5d5-fddb0dabc94e',
                },
                {
                  type: 'index-pattern',
                  id: 'ff959d40-b880-11e8-a6d9-e546fe2bba5f',
                  name: 'indexpattern-datasource-layer-1d08a43c-8913-4692-a3e0-8d77902f6e46',
                },
                {
                  type: 'index-pattern',
                  id: 'ff959d40-b880-11e8-a6d9-e546fe2bba5f',
                ...
                },
                {
                  type: 'index-pattern',
                  id: 'ff959d40-b880-11e8-a6d9-e546fe2bba5f',
                  name: 'indexpattern-datasource-layer-2031d0f8-01fc-4009-b1ad-a7b7ca9266c0',
                },
                {
                  type: 'index-pattern',
                  id: 'ff959d40-b880-11e8-a6d9-e546fe2bba5f',
                  name: 'xy-visualization-layer-192ad2e4-2bb7-44a9-b345-e96045fa6ccd',
                },
              ],
              state: {
                visualization: {
                  ...
                  layers: [
                    {
                      seriesType: 'line',
                      layerType: 'data',
                      layerId: 'e3b3cb5c-e3b1-497f-a5d5-fddb0dabc94e',
                      accessors: ['a69956c9-43cd-4756-a3c0-e93cb1502a0b'],
                      yConfig: [
                        {
                          forAccessor: 'a69956c9-43cd-4756-a3c0-e93cb1502a0b',
                          axisMode: 'left',
                        },
                      ],
                      xAccessor: 'f3cc8168-6360-4727-a410-a57f5a325091',
                      palette: { name: 'default', type: 'palette' },
                    },
                    {
                      seriesType: 'line',
                      layerType: 'data',
                      layerId: '1d08a43c-8913-4692-a3e0-8d77902f6e46',
                      accessors: ['9a3d8abd-81a5-40ae-9616-020d5a5b2ee2'],
                      yConfig: [
                        {
                          forAccessor: '9a3d8abd-81a5-40ae-9616-020d5a5b2ee2',
                          axisMode: 'left',
                        },
                      ],
                      xAccessor: '644b06ea-73a3-47b1-9b40-3035844c4621',
                      palette: { name: 'default', type: 'palette' },
                    },
                    {
                      seriesType: 'line',
                      layerType: 'data',
                      layerId: '9725cdbd-a9f3-479f-a349-0f11244e5239',
                      accessors: ['b5588228-9c46-4a4b-92ee-d140c327bca0'],
                      yConfig: [
                        {
                          forAccessor: 'b5588228-9c46-4a4b-92ee-d140c327bca0',
                          axisMode: 'left',
                        },
                      ],
                      xAccessor: '6749b404-4784-4fd6-8bf6-5712e84c7310',
                      palette: { name: 'default', type: 'palette' },
                    },
                    {
                      seriesType: 'line',
                      layerType: 'data',
                      layerId: '2031d0f8-01fc-4009-b1ad-a7b7ca9266c0',
                      accessors: ['985e05c0-3a0b-4e55-84bb-1f02128388a9'],
                      yConfig: [
                        {
                          forAccessor: '985e05c0-3a0b-4e55-84bb-1f02128388a9',
                          axisMode: 'left',
                        },
                      ],
                      xAccessor: '1b199cb1-b47f-48e6-b209-74eb81b303f5',
                      palette: { name: 'default', type: 'palette' },
                    },
                    {
                      layerId: '192ad2e4-2bb7-44a9-b345-e96045fa6ccd',
                ...
                datasourceStates: {
                  formBased: {
                    layers: {
                      'e3b3cb5c-e3b1-497f-a5d5-fddb0dabc94e': {
                        columns: {
                          'f3cc8168-6360-4727-a410-a57f5a325091': {
                            label: 'order_date',
                            dataType: 'date',
                          ...
                          'a69956c9-43cd-4756-a3c0-e93cb1502a0b': {
                            ...
                            params: { format: { id: 'number' }, emptyAsNull: true },
                            customLabel: true,
                          },
                        },
                        columnOrder: [
                      ...
                      '1d08a43c-8913-4692-a3e0-8d77902f6e46': {
                        columns: {
                          '644b06ea-73a3-47b1-9b40-3035844c4621': {
                            label: 'order_date',
                            dataType: 'date',
                            operationType: 'date_histogram',
                            sourceField: 'order_date',
                          ...
                          '9a3d8abd-81a5-40ae-9616-020d5a5b2ee2': {
                            ...
                            isBucketed: false,
                            scale: 'ratio',
                            filter: { query: 'products.product_name:*watch*', language: 'lucene' },
                            params: { format: { id: 'number' }, emptyAsNull: true },
                            customLabel: true,
                          },
                        },
                      ...
                      '9725cdbd-a9f3-479f-a349-0f11244e5239': {
                        columns: {
                          '6749b404-4784-4fd6-8bf6-5712e84c7310': {
                            label: 'order_date',
                            dataType: 'date',
                            operationType: 'date_histogram',
                            sourceField: 'order_date',
                          ...
                          'b5588228-9c46-4a4b-92ee-d140c327bca0': {
                            label: 'Revenue Bags',
                            dataType: 'number',
                            operationType: 'sum',
                            sourceField: 'taxful_total_price',
                            isBucketed: false,
                            scale: 'ratio',
                            filter: { query: 'products.product_name:*bag*', language: 'lucene' },
                            params: { format: { id: 'number' }, emptyAsNull: true },
                            customLabel: true,
                          },
                        },
                      ...
                      '2031d0f8-01fc-4009-b1ad-a7b7ca9266c0': {
                        columns: {
                          '1b199cb1-b47f-48e6-b209-74eb81b303f5': {
                            label: 'order_date',
                            dataType: 'date',
                            operationType: 'date_histogram',
                            sourceField: 'order_date',
                          ...
                          '985e05c0-3a0b-4e55-84bb-1f02128388a9': {
        ...
        },
        {
          version: '8.11.0',
          type: 'lens',
          gridData: { x: 36, y: 7, w: 12, h: 7, i: '7' },
          panelIndex: '7',
          embeddableConfig: {
            attributes: {
              title: 'Sold Products per Day',
              description: '',
              ...
              references: [
                {
                  type: 'index-pattern',
                  id: 'ff959d40-b880-11e8-a6d9-e546fe2bba5f',
                  name: 'indexpattern-datasource-layer-037375ae-9e23-4dd5-a4f0-5f117bb7dac1',
                },
              ],
              state: {
                visualization: {
                  layerId: '037375ae-9e23-4dd5-a4f0-5f117bb7dac1',
                  layerType: 'data',
                  metricAccessor: 'c27bd77c-68e2-4d75-8fda-41c45d22f8d4',
                  maxAccessor: 'ce816876-e92d-4b1a-bbb0-ed7637fc0eea',
                  showBar: true,
                  palette: {
                    type: 'palette',
                    name: 'positive',
                ...
                datasourceStates: {
                  formBased: {
                    layers: {
                      '037375ae-9e23-4dd5-a4f0-5f117bb7dac1': {
                        ignoreGlobalFilters: false,
                        columns: {
                          'c27bd77c-68e2-4d75-8fda-41c45d22f8d4X0': {
                            label: 'Part of count() / (time_range() / 1000 / 60 / 60 / 24)',
                            dataType: 'number',
                            operationType: 'count',
                            isBucketed: false,
                            scale: 'ratio',
                          ...
                          'c27bd77c-68e2-4d75-8fda-41c45d22f8d4X1': {
                            label: 'Part of count() / (time_range() / 1000 / 60 / 60 / 24)',
                            dataType: 'number',
                          ...
                          'c27bd77c-68e2-4d75-8fda-41c45d22f8d4X2': {
                            label: 'Part of count() / (time_range() / 1000 / 60 / 60 / 24)',
                            dataType: 'number',
                            operationType: 'math',
                            isBucketed: false,
                              ...
                              tinymathAst: {
                                ...
                                args: [
                                  'c27bd77c-68e2-4d75-8fda-41c45d22f8d4X0',
                                  {
                                    ...
                                    location: { min: 11, max: 45 },
                                    text: 'time_range() / 1000 / 60 / 60 / 24',
                                  },
                                ],
                                location: { min: 0, max: 46 },
                                text: 'count() / (time_range() / 1000 / 60 / 60 / 24)',
                              },
                            },
                            references: [
                              'c27bd77c-68e2-4d75-8fda-41c45d22f8d4X0',
                          ...
                          'c27bd77c-68e2-4d75-8fda-41c45d22f8d4': {
                            label: 'Trxns / day',
                            dataType: 'number',
                            ...
                            params: {
                              format: { id: 'number' },
                              formula: 'count() / (time_range() / 1000 / 60 / 60 / 24)',
                              isFormulaBroken: false,
                            },
                            references: ['c27bd77c-68e2-4d75-8fda-41c45d22f8d4X2'],
                            customLabel: true,
                          },
                          'ce816876-e92d-4b1a-bbb0-ed7637fc0eea': {
                            label: 'Static value: 300',
                            dataType: 'number',
        ...
        },
        {
          version: '8.11.0',
          type: 'search',
          gridData: { x: 0, y: 54, w: 48, h: 18, i: '10' },
          panelIndex: '10',
        ...
        },
        {
          version: '8.11.0',
          type: 'map',
          gridData: { x: 0, y: 31, w: 24, h: 14, i: '11' },
          panelIndex: '11',
          embeddableConfig: {
        ...
        },
        {
          version: '8.11.0',
          type: 'visualization',
          gridData: { x: 0, y: 0, w: 24, h: 7, i: 'a71cf076-6895-491c-8878-63592e429ed5' },
          panelIndex: 'a71cf076-6895-491c-8878-63592e429ed5',
          embeddableConfig: { enhancements: {} },
          panelRefName: 'panel_a71cf076-6895-491c-8878-63592e429ed5',
        },
        {
          version: '8.11.0',
          type: 'lens',
          gridData: { x: 24, y: 0, w: 12, h: 7, i: '75283285-dffd-48a7-a0c2-2235184b5282' },
          panelIndex: '75283285-dffd-48a7-a0c2-2235184b5282',
          embeddableConfig: {
            enhancements: {},
            attributes: {
              visualizationType: 'lnsMetric',
              state: {
                visualization: {
                  ...
                  layerType: 'data',
                  metricAccessor: '041db33b-5c9c-47f3-a5d3-ef5e255d1663',
                },
        ...
        },
        {
          version: '8.11.0',
          type: 'lens',
          gridData: { x: 36, y: 0, w: 12, h: 7, i: '58774330-b1b3-42dd-a04c-fbce9cc4d288' },
          panelIndex: '58774330-b1b3-42dd-a04c-fbce9cc4d288',
          embeddableConfig: {
            enhancements: {},
            attributes: {
              ...
              state: {
                visualization: {
                  ...
                  layerType: 'data',
                  metricAccessor: '020bbfdf-9ef8-4802-aa9e-342d2ea0bebf',
                },
                query: { language: 'kuery', query: '' },
                filters: [],
                datasourceStates: {
        ...
        },
        {
          version: '8.11.0',
          type: 'lens',
          gridData: { x: 24, y: 7, w: 12, h: 7, i: 'b63ec47d-aace-4980-b928-6be8adafa5a4' },
          panelIndex: 'b63ec47d-aace-4980-b928-6be8adafa5a4',
          embeddableConfig: {
            enhancements: {},
            attributes: {
              visualizationType: 'lnsMetric',
              state: {
                visualization: {
                  ...
                  layerType: 'data',
                  metricAccessor: 'c52c2003-ae58-4604-bae7-52ba0fb38a01',
                },
                query: { language: 'kuery', query: '' },
                filters: [],
                datasourceStates: {
                      ...
                      '667067a2-7cdf-4f0e-a9fe-eb4f4f1f2f17': {
                        ...
                        columns: {
                          'c52c2003-ae58-4604-bae7-52ba0fb38a01': {
                            ...
                            params: {
                              format: { id: 'number', params: { decimals: 1, compact: true } },
                            },
                            scale: 'ratio',
        ...
        },
        {
          version: '8.11.0',
          type: 'lens',
          gridData: { x: 0, y: 14, w: 24, h: 7, i: 'd9495793-80ba-4a9a-b0e3-d1155ec99b09' },
          panelIndex: 'd9495793-80ba-4a9a-b0e3-d1155ec99b09',
          embeddableConfig: {
            enhancements: {},
            attributes: {
              state: {
        ...
        },
        {
          version: '8.11.0',
          type: 'lens',
          gridData: { x: 24, y: 31, w: 24, h: 14, i: 'bda054f7-2d06-4936-b461-365d1be621fa' },
          panelIndex: 'bda054f7-2d06-4936-b461-365d1be621fa',
          embeddableConfig: {
            enhancements: {},
            attributes: {
              state: {
                        ...
                        columns: {
                          ...
                          'bf51c1af-443e-49f4-a21f-54c87bfc5677': {
                            ...
                            params: {
                              ...
                              formula:
                                "sum(taxful_total_price) - sum(taxful_total_price, shift='1w')",
                              isFormulaBroken: false,
                            },
                ...
                visualization: {
                  columns: [
                    ...
                    { alignment: 'left', columnId: '826b2f39-b616-40b2-a222-972fdc1d7596' },
                    { columnId: 'cfd45c47-fc41-430c-9e7a-b71dc0c916b0' },
                    {
                      ...
                      palette: {
                        ...
                        params: {
                          colorStops: [
                            { color: redColors.at(-1), stop: -10000 },
                            { color: greenColors.at(-1), stop: 0 },
                          ],
                          continuity: 'above',
                          name: 'custom',
                          rangeMax: 0,
                          ...
                          steps: 5,
                          stops: [
                            { color: redColors.at(-1), stop: 0 },
                            { color: greenColors.at(-1), stop: 2249.03125 },
                          ],
                        },
                        type: 'palette',
                      },
        ...
        },
        {
          version: '8.11.0',
          type: 'lens',
          gridData: { x: 0, y: 45, w: 24, h: 9, i: 'd68e91dd-1539-48b0-9279-b43bba2054fe' },
          panelIndex: 'd68e91dd-1539-48b0-9279-b43bba2054fe',
          embeddableConfig: {
            hidePanelTitles: false,
            enhancements: {},
            attributes: {
        ...
        },
        {
          version: '8.11.0',
          type: 'lens',
          gridData: { x: 24, y: 45, w: 24, h: 9, i: '39d96714-152f-414b-992c-ce2492fc69f3' },
          panelIndex: '39d96714-152f-414b-992c-ce2492fc69f3',
          embeddableConfig: {
            timeRange: { from: 'now-2w', to: 'now-1w' },
            hidePanelTitles: false,
            enhancements: {},
            attributes: {
              state: {
        ...
        },
        {
          version: '8.11.0',
          type: 'lens',
          gridData: { x: 24, y: 14, w: 24, h: 17, i: 'cd47b7cb-0ac0-43e0-b8c6-53489648bdef' },
          panelIndex: 'cd47b7cb-0ac0-43e0-b8c6-53489648bdef',
          embeddableConfig: {
            enhancements: {},
            attributes: {
              state: {
        ...
        },
        {
          version: '8.11.0',
          type: 'lens',
          gridData: { x: 0, y: 7, w: 24, h: 7, i: 'bdb525ab-270b-46f1-a847-dd29be19aadb' },
          panelIndex: 'bdb525ab-270b-46f1-a847-dd29be19aadb',
          embeddableConfig: {
            enhancements: {},
            hidePanelTitles: false,
            attributes: {

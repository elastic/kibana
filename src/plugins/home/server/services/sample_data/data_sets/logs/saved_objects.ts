...
import { euiPaletteForStatus, euiPaletteRed } from '@kbn/palettes';

const statusColors = euiPaletteForStatus(3);
const redColors = euiPaletteRed(3);
      ...
      panelsJSON: JSON.stringify([
        {
          version: '8.8.0',
          type: 'map',
          gridData: { x: 0, y: 14, w: 24, h: 18, i: '4' },
          panelIndex: '4',
          embeddableConfig: {
        ...
        },
        {
          version: '8.8.0',
          type: 'lens',
          gridData: { x: 36, y: 0, w: 12, h: 7, i: '11' },
          panelIndex: '11',
          embeddableConfig: {
            attributes: {
              title: '',
              ...
              state: {
                visualization: {
                  layerId: '28b89898-3feb-415a-8dd9-74d755ac7c2a',
                  layerType: 'data',
                  metricAccessor: 'f92c482e-1eee-4c2a-9338-64fb3eec286a',
                  palette: {
                    name: 'custom',
                    type: 'palette',
                    params: {
                      ...
                      progression: 'fixed',
                      stops: [
                        { color: statusColors[2], stop: 500 },
                        { color: statusColors[1], stop: 1000 },
                        { color: statusColors[0], stop: 1658 },
                      ],
                      colorStops: [
                        { color: statusColors[2], stop: 0 },
                        { color: statusColors[1], stop: 500 },
                        { color: statusColors[0], stop: 1000 },
                      ],
                      continuity: 'above',
                      maxSteps: 5,
                    },
                ...
                datasourceStates: {
                  formBased: {
                    layers: {
                      '28b89898-3feb-415a-8dd9-74d755ac7c2a': {
                        columns: {
                          'f92c482e-1eee-4c2a-9338-64fb3eec286a': {
                        ...
                        columnOrder: ['f92c482e-1eee-4c2a-9338-64fb3eec286a'],
                        incompleteColumns: {},
                      },
                    },
                  },
        ...
        },
        {
          version: '8.8.0',
          type: 'visualization',
          gridData: { x: 24, y: 14, w: 24, h: 33, i: '14' },
          panelIndex: '14',
        ...
        },
        {
          version: '8.8.0',
          type: 'lens',
          gridData: { x: 0, y: 7, w: 24, h: 7, i: '15' },
          panelIndex: '15',
          embeddableConfig: {
            attributes: {
              title: '[Logs] Response Codes Over Time + Annotations (converted)',
              visualizationType: 'lnsXY',
              type: 'lens',
              references: [
                {
                  type: 'index-pattern',
                  id: '90943e30-9a47-11e8-b64d-95841ca0b247',
                  name: 'indexpattern-datasource-layer-b38fe501-4b47-4de8-a423-6656d1162174',
                },
                {
                  type: 'index-pattern',
                  id: '90943e30-9a47-11e8-b64d-95841ca0b247',
                  name: 'xy-visualization-layer-f265e722-ae38-495c-903c-48aa7931fa82',
                },
              ],
              state: {
                visualization: {
                  ...
                  layers: [
                    {
                      ...
                      layerType: 'data',
                      layerId: 'b38fe501-4b47-4de8-a423-6656d1162174',
                      accessors: ['896c5eb2-81c5-44f1-a4a1-57344161ea62'],
                      yConfig: [
                        {
                          forAccessor: '896c5eb2-81c5-44f1-a4a1-57344161ea62',
                          axisMode: 'left',
                        },
                      ],
                      xAccessor: '8986e393-d24f-49b0-96ca-118fd66d75e5',
                      splitAccessor: '43f5bb0f-c6da-43a0-8a0a-50e9838ed34b',
                      palette: { name: 'default', type: 'palette' },
                    },
                    {
                      layerId: 'f265e722-ae38-495c-903c-48aa7931fa82',
                ...
                datasourceStates: {
                  formBased: {
                    layers: {
                      'b38fe501-4b47-4de8-a423-6656d1162174': {
                        columns: {
                          '8986e393-d24f-49b0-96ca-118fd66d75e5': {
                            label: 'timestamp',
                            dataType: 'date',
                          ...
                          '43f5bb0f-c6da-43a0-8a0a-50e9838ed34b': {
                            label: 'Filters',
                            dataType: 'string',
                            ...
                            params: {
                              filters: [
                                ...
                                {
                                  input: { query: 'response.keyword >= 500', language: 'kuery' },
                                  label: 'HTTP 5xx',
                                },
                              ],
                            },
                          },
                          '896c5eb2-81c5-44f1-a4a1-57344161ea62': {
        ...
        },
        {
          version: '8.8.0',
          type: 'visualization',
          gridData: { x: 0, y: 0, w: 24, h: 7, i: '343f0bef-0b19-452e-b1c8-59beb18b6f0c' },
          panelIndex: '343f0bef-0b19-452e-b1c8-59beb18b6f0c',
          embeddableConfig: {
            savedVis: {
        ...
        },
        {
          version: '8.8.0',
          type: 'lens',
          gridData: { x: 24, y: 0, w: 12, h: 7, i: 'bb94016e-f4a6-49ca-87a9-296a2869d570' },
          panelIndex: 'bb94016e-f4a6-49ca-87a9-296a2869d570',
          embeddableConfig: {
            attributes: {
              title: '',
              visualizationType: 'lnsMetric',
              ...
              references: [
                {
                  type: 'index-pattern',
                  id: '90943e30-9a47-11e8-b64d-95841ca0b247',
                  name: 'indexpattern-datasource-layer-483defd2-775b-4a62-bdef-496c819bb8ed',
                },
              ],
              state: {
                visualization: {
                  layerId: '483defd2-775b-4a62-bdef-496c819bb8ed',
                  layerType: 'data',
                  metricAccessor: '37430d12-7452-4cc9-b035-5cfd4061edf0',
                },
                query: { query: '', language: 'kuery' },
                filters: [],
                datasourceStates: {
                  formBased: {
                    layers: {
                      '483defd2-775b-4a62-bdef-496c819bb8ed': {
                        columns: {
                          '37430d12-7452-4cc9-b035-5cfd4061edf0': {
                            label: 'Visits',
                            dataType: 'number',
                            operationType: 'count',
                            isBucketed: false,
                        ...
                        columnOrder: ['37430d12-7452-4cc9-b035-5cfd4061edf0'],
                        incompleteColumns: {},
                      },
                    },
                  },
        ...
        },
        {
          version: '8.8.0',
          type: 'lens',
          gridData: { x: 36, y: 7, w: 12, h: 7, i: '8c1456d4-1993-4ba2-b701-04aca02c9fef' },
          panelIndex: '8c1456d4-1993-4ba2-b701-04aca02c9fef',
          embeddableConfig: {
            attributes: {
              title: '',
              visualizationType: 'lnsMetric',
              ...
              references: [
                {
                  type: 'index-pattern',
                  id: '90943e30-9a47-11e8-b64d-95841ca0b247',
                  name: 'indexpattern-datasource-layer-f3793bb7-3971-4753-866d-4008e77a9f9a',
                },
              ],
              state: {
                visualization: {
                  layerId: 'f3793bb7-3971-4753-866d-4008e77a9f9a',
                  layerType: 'data',
                  metricAccessor: '71c076a6-e782-4866-b8df-5fd85a41f08b',
                },
                query: { query: '', language: 'kuery' },
                filters: [],
                datasourceStates: {
                  formBased: {
                    layers: {
                      'f3793bb7-3971-4753-866d-4008e77a9f9a': {
                        columns: {
                          '71c076a6-e782-4866-b8df-5fd85a41f08bX0': {
                            label: 'Part of HTTP 5xx',
                            dataType: 'number',
                            operationType: 'count',
                            isBucketed: false,
                            scale: 'ratio',
                            sourceField: '___records___',
                            filter: { query: 'response.keyword >= 500', language: 'kuery' },
                            params: { emptyAsNull: false },
                            customLabel: true,
                          },
                          '71c076a6-e782-4866-b8df-5fd85a41f08bX1': {
                            label: 'Part of HTTP 5xx',
                            dataType: 'number',
                            operationType: 'count',
                            isBucketed: false,
                          ...
                          '71c076a6-e782-4866-b8df-5fd85a41f08bX2': {
                            label: 'Part of HTTP 5xx',
                            dataType: 'number',
                            operationType: 'math',
                            isBucketed: false,
                            ...
                            params: {
                              tinymathAst: {
                                ...
                                text: "count(kql='response.keyword >= 500') / count()",
                              },
                            },
                            references: [
                              '71c076a6-e782-4866-b8df-5fd85a41f08bX0',
                          ...
                          '71c076a6-e782-4866-b8df-5fd85a41f08b': {
                            label: 'HTTP 5xx',
                            dataType: 'number',
                            operationType: 'formula',
                            isBucketed: false,
                            scale: 'ratio',
                            params: {
                              formula: "count(kql='response.keyword >= 500') / count()",
                              isFormulaBroken: false,
                              format: { id: 'percent', params: { decimals: 1 } },
                            },
                            references: ['71c076a6-e782-4866-b8df-5fd85a41f08bX2'],
                            customLabel: true,
                          },
                        },
                        columnOrder: [
        ...
        },
        {
          version: '8.8.0',
          type: 'lens',
          gridData: { x: 24, y: 7, w: 12, h: 7, i: '01d8e435-91c0-484f-a11e-856747050b0a' },
          panelIndex: '01d8e435-91c0-484f-a11e-856747050b0a',
          embeddableConfig: {
            attributes: {
              title: '',
              visualizationType: 'lnsMetric',
                          ...
                          '71c076a6-e782-4866-b8df-5fd85a41f08bX2': {
                            ...
                            params: {
                              tinymathAst: {
                                ...
                                location: { min: 0, max: 73 },
                                text: "count(kql='response.keyword >= 400 and response.keyword < 500') / count()",
                              },
                            },
                            references: [
                              '71c076a6-e782-4866-b8df-5fd85a41f08bX0',
        ...
        },
        {
          version: '8.8.0',
          type: 'visualization',
          gridData: { x: 0, y: 32, w: 24, h: 15, i: '8e59c7cf-6e42-4343-a113-c4a255fcf2ce' },
          panelIndex: '8e59c7cf-6e42-4343-a113-c4a255fcf2ce',
          embeddableConfig: {
            savedVis: {
              title: '',
              description: '',
          ...
          panelRefName: 'panel_8e59c7cf-6e42-4343-a113-c4a255fcf2ce',
        },
        {
          version: '8.8.0',
          type: 'lens',
          gridData: { x: 0, y: 47, w: 24, h: 13, i: '21bb0939-ee09-4021-8848-6552b3a6a788' },
          panelIndex: '21bb0939-ee09-4021-8848-6552b3a6a788',
          embeddableConfig: {
            attributes: {
              title: '',
              ...
              references: [
                {
                  type: 'index-pattern',
                  id: '90943e30-9a47-11e8-b64d-95841ca0b247',
                  name: 'indexpattern-datasource-layer-c840e93e-2949-4723-ad35-6bdb2d724404',
                },
              ],
              state: {
                visualization: {
                  columns: [
                    { columnId: '4e64d6d7-4f92-4d5e-abbb-13796604db30', isTransposed: false },
                    { columnId: 'fb9a848d-76f3-4005-a067-4259a50b5621', isTransposed: false },
                    { columnId: 'a2760bc2-9a6e-46a1-8595-86f61573c7cf', isTransposed: false },
                    {
                      columnId: '2c8bd8d5-35ff-4386-8d27-3ba882b13e43',
                      isTransposed: false,
                      colorMode: 'text',
                      palette: {
                        name: 'custom',
                        ...
                        params: {
                          steps: 5,
                          stops: [
                            { color: statusColors[2], stop: 1000 },
                            { color: statusColors[1], stop: 1500 },
                            { color: statusColors[0], stop: 1501 },
                          ],
                          rangeType: 'number',
                          rangeMin: 0,
                          rangeMax: null,
                          ...
                          colorStops: [
                            { color: statusColors[2], stop: 0 },
                            { color: statusColors[1], stop: 1000 },
                            { color: statusColors[0], stop: 1500 },
                          ],
                          name: 'custom',
                        },
                      },
                    ...
                    {
                      columnId: 'defa6f97-b874-4556-8438-056fb437787b',
                      isTransposed: false,
                      colorMode: 'text',
                      palette: {
                        name: 'custom',
                        ...
                        params: {
                          steps: 5,
                          stops: [
                            { color: statusColors[2], stop: 10 },
                            { color: statusColors[1], stop: 25 },
                            { color: statusColors[0], stop: 26 },
                          ],
                          rangeType: 'number',
                          rangeMin: 0,
                          rangeMax: null,
                          ...
                          colorStops: [
                            { color: statusColors[2], stop: 0 },
                            { color: statusColors[1], stop: 10 },
                            { color: statusColors[0], stop: 25 },
                          ],
                          name: 'custom',
                        },
                      },
                  ...
                  layerId: 'c840e93e-2949-4723-ad35-6bdb2d724404',
                  layerType: 'data',
                },
                query: { query: '', language: 'kuery' },
                filters: [],
                datasourceStates: {
                  formBased: {
                    layers: {
                      'c840e93e-2949-4723-ad35-6bdb2d724404': {
                        columns: {
                          '4e64d6d7-4f92-4d5e-abbb-13796604db30': {
                            label: 'Type',
                            dataType: 'string',
                            operationType: 'terms',
                            scale: 'ordinal',
                            ...
                            params: {
                              ...
                              orderBy: {
                                type: 'column',
                                columnId: 'fb9a848d-76f3-4005-a067-4259a50b5621',
                              },
                              orderDirection: 'desc',
                              otherBucket: true,
                              missingBucket: false,
                          ...
                          'fb9a848d-76f3-4005-a067-4259a50b5621': {
                            label: 'Bytes (Total)',
                            dataType: 'number',
                            operationType: 'sum',
                            sourceField: 'bytes',
                          ...
                          'a2760bc2-9a6e-46a1-8595-86f61573c7cf': {
                          ...
                          '2c8bd8d5-35ff-4386-8d27-3ba882b13e43': {
                          ...
                          'defa6f97-b874-4556-8438-056fb437787b': {
                            label: 'Unique count of clientip',
                            dataType: 'number',
                            operationType: 'unique_count',
                            scale: 'ratio',
                            sourceField: 'clientip',
        ...
        },
        {
          version: '8.8.0',
          type: 'lens',
          gridData: { x: 24, y: 47, w: 24, h: 13, i: 'cbca842c-b9fa-4523-9ce0-14e350866e33' },
          panelIndex: 'cbca842c-b9fa-4523-9ce0-14e350866e33',
          embeddableConfig: { hidePanelTitles: false, enhancements: {} },
          title: '[Logs] Bytes distribution',
          panelRefName: 'panel_cbca842c-b9fa-4523-9ce0-14e350866e33',
        },
        {
          version: '8.8.0',
          type: 'lens',
          gridData: { x: 0, y: 60, w: 48, h: 19, i: '1d5f0b3f-d9d2-4b26-997b-83bc5ca3090b' },
          panelIndex: '1d5f0b3f-d9d2-4b26-997b-83bc5ca3090b',
          embeddableConfig: {
            attributes: {
              title: '',
              type: 'lens',
              ...
              state: {
                datasourceStates: {
                  formBased: {
                    layers: {
                      'c35dc8ee-50d1-4ef7-8b4b-9c21a7e7d3b0': {
                        columns: {
                          '42783ad7-dbcf-4310-bc06-f21f4eaaac96': {
                            label: 'URL',
                            dataType: 'string',
                            operationType: 'terms',
                            scale: 'ordinal',
                            ...
                            params: {
                              ...
                              orderBy: {
                                type: 'column',
                                columnId: 'f7835375-4d5b-4839-95ea-41928192a319',
                              },
                              orderDirection: 'desc',
                              otherBucket: true,
                              missingBucket: false,
                          ...
                          'f7835375-4d5b-4839-95ea-41928192a319': {
                            label: 'Visits',
                            dataType: 'number',
                            operationType: 'count',
                            isBucketed: false,
                          ...
                          '07fc84ca-4147-4ba9-879e-d1b4e086e1daX0': {
                            label: 'Part of HTTP 4xx',
                            dataType: 'number',
                            operationType: 'count',
                            isBucketed: false,
                          ...
                          '07fc84ca-4147-4ba9-879e-d1b4e086e1daX1': {
                            label: 'Part of HTTP 4xx',
                            dataType: 'number',
                            operationType: 'count',
                            isBucketed: false,
                          ...
                          '07fc84ca-4147-4ba9-879e-d1b4e086e1daX2': {
                            label: 'Part of HTTP 4xx',
                            dataType: 'number',
                            operationType: 'math',
                            isBucketed: false,
                          ...
                          '07fc84ca-4147-4ba9-879e-d1b4e086e1da': {
                            label: 'HTTP 4xx',
                            dataType: 'number',
                            operationType: 'formula',
                            isBucketed: false,
                            ...
                            references: ['07fc84ca-4147-4ba9-879e-d1b4e086e1daX2'],
                            customLabel: true,
                          },
                          '791d5a5b-a7ba-4e9e-b533-51b33c7d7747': {
                            label: 'Unique',
                            dataType: 'number',
                            operationType: 'unique_count',
                            scale: 'ratio',
                          ...
                          '611e3509-e834-4fdd-b573-44e959e95d27': {
                          ...
                          '9f79ecca-123f-4098-a658-6b0e998da003': {
                            ...
                            isBucketed: false,
                            scale: 'ratio',
                            params: { format: { id: 'bytes', params: { decimals: 0 } } },
                          },
                          '491285fd-0196-402c-9b7f-4660fdc1c22aX0': {
                            label: 'Part of HTTP 5xx',
                            dataType: 'number',
                            operationType: 'count',
                            isBucketed: false,
                          ...
                          '491285fd-0196-402c-9b7f-4660fdc1c22aX1': {
                            label: 'Part of HTTP 5xx',
                            dataType: 'number',
                            operationType: 'count',
                            isBucketed: false,
                          ...
                          '491285fd-0196-402c-9b7f-4660fdc1c22aX2': {
                            label: 'Part of HTTP 5xx',
                            dataType: 'number',
                            operationType: 'math',
                            isBucketed: false,
                          ...
                          '491285fd-0196-402c-9b7f-4660fdc1c22a': {
                            label: 'HTTP 5xx',
                            dataType: 'number',
                            operationType: 'formula',
                            isBucketed: false,
                            ...
                            references: ['491285fd-0196-402c-9b7f-4660fdc1c22aX2'],
                            customLabel: true,
                          },
                        },
                        columnOrder: [
                ...
                visualization: {
                  layerId: 'c35dc8ee-50d1-4ef7-8b4b-9c21a7e7d3b0',
                  columns: [
                    { columnId: '42783ad7-dbcf-4310-bc06-f21f4eaaac96', width: 650.6666666666666 },
                    { columnId: 'f7835375-4d5b-4839-95ea-41928192a319' },
                    {
                      columnId: '491285fd-0196-402c-9b7f-4660fdc1c22a',
                      isTransposed: false,
                      ...
                      palette: {
                        ...
                        params: {
                          steps: 5,
                          stops: [
                            { color: redColors[1], stop: 0.1 },
                            { color: redColors[2], stop: 1 },
                          ],
                          rangeType: 'number',
                          name: 'custom',
                          colorStops: [
                            { color: redColors[1], stop: 0.05 },
                            { color: redColors[2], stop: 0.1 },
                          ],
                          rangeMin: 0.05,
                          rangeMax: 0.1,
                        },
                    ...
                    {
                      columnId: '07fc84ca-4147-4ba9-879e-d1b4e086e1da',
                      isTransposed: false,
                      colorMode: 'cell',
                      palette: {
                        name: 'custom',
                    ...
                    { columnId: '791d5a5b-a7ba-4e9e-b533-51b33c7d7747', isTransposed: false },
                    { columnId: '611e3509-e834-4fdd-b573-44e959e95d27', isTransposed: false },
                    { columnId: '9f79ecca-123f-4098-a658-6b0e998da003', isTransposed: false },
                  ],
                  sorting: { columnId: '491285fd-0196-402c-9b7f-4660fdc1c22a', direction: 'desc' },
                  layerType: 'data',
                  rowHeight: 'single',
                  rowHeightLines: 1,
                },
              ...
              references: [
                ...
                {
                  id: '90943e30-9a47-11e8-b64d-95841ca0b247',
                  name: 'indexpattern-datasource-layer-c35dc8ee-50d1-4ef7-8b4b-9c21a7e7d3b0',
                  type: 'index-pattern',
                },
              ],
            },

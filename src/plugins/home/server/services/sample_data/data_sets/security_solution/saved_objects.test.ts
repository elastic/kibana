...
describe('getSavedObjects', () => {
  ...
  it('returns a data view saved objects', () => {
    expect(results[0].id).toEqual('c89b196d-d0cd-4cfb-8d95-787e4ce51551');
  ...
  it('returns a search saved objects', () => {
    expect(results[1].id).toEqual('717d50d0-3c37-11ee-ae29-adafdb6b4012');
  ...
  it('returns a dashboard saved objects', () => {
    ...
    expect(results[2].references.length).toEqual(23);

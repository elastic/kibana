...
export function nginxMetricsSpecProvider(context: TutorialContext): TutorialSchema {
  ...
  return {
    ...
    shortDescription: i18n.translate('home.tutorials.nginxMetrics.shortDescription', {
      defaultMessage: 'Collect internal metrics from Nginx HTTP servers with Metricbeat.',
    }),
    longDescription: i18n.translate('home.tutorials.nginxMetrics.longDescription', {
      defaultMessage:
        'The `nginx` Metricbeat module fetches internal metrics from Nginx HTTP server. \
The module scrapes the server status data from web page generated by the \
{statusModuleLink}, \

...
export function useUnifiedDocViewerServices(): UnifiedDocViewerServices {
  ...
  const { analytics, data, fieldFormats, storage, uiSettings, unifiedDocViewer, uiActions } =
    services;
  return { analytics, data, fieldFormats, storage, uiSettings, unifiedDocViewer, uiActions };
}

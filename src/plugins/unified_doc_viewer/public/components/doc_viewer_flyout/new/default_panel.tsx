...
export interface UnifiedDocViewerPanelProps {
...
export const DiscoverRightPanelKey = 'unifiedDocViewer:discover:right';
/**
 * Flyout displaying an expanded row details
 */
export function UnifiedDocViewerPanel({
  flyoutTitle,
  flyoutActions,
  FlyoutCustomBody,
  services,

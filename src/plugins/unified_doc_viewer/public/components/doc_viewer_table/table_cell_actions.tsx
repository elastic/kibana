...
export const TableActions = ({
  ...
  const filterAddLabel = i18n.translate(
    'unifiedDocViewerPlugin.table.filterForValueButtonTooltip',
    {
  ...
  const filterOutLabel = i18n.translate(
    'unifiedDocViewerPlugin.table.filterOutValueButtonTooltip',
    {
  ...
  const filtersExistsToolTip =
    (filtersExistsDisabled &&
      (fieldMapping && fieldMapping.scripted
        ...
        : i18n.translate(
            'unifiedDocViewerPlugin.table.unableToFilterForPresenceOfMetaFieldsTooltip',
            {
  ...
  const pinnedLabel = pinned
    ? i18n.translate('unifiedDocViewerPlugin.table.unpinFieldLabel', {
  ...
  const pinnedAriaLabel = pinned
    ...
    : i18n.translate('unifiedDocViewerPlugin.table.pinFieldAriaLabel', {

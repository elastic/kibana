require.config({
  baseUrl: '../../',
  paths: {
    chrome: 'plugins/ui/chrome',
    ui: 'plugins/ui/ui',
    components: 'plugins/ui/components',
    utils: 'plugins/ui/utils',
    routes: 'plugins/ui/routes/index',
    errors: 'plugins/ui/errors',
    modules: 'plugins/ui/modules',
    lodash: 'plugins/ui/mixins',

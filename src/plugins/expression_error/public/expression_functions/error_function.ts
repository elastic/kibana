...
import { ExpressionErrorrFunction, Origin } from '../../common/types';

export const errorFunction: ExpressionErrorFunction = () => {
  const { help, args: argHelp } = getFunctionHelp().error;
  const errors = getFunctionErrors().error;

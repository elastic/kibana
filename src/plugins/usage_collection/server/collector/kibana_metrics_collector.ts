 ...
 */
export type KibanaMetricsCollectorOptions<
 ...
 */
export class KibanaMetricsCollector<
  TFetchReturn,
  ExtraOptions extends object = {}
> extends Collector<TFetchReturn, ExtraOptions> {
  constructor(
    log: Logger,
    // Needed because it doesn't affect on anything here but being explicit creates a lot of pain down the line
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    collectorOptions: KibanaMetricsCollectorOptions<TFetchReturn, any, ExtraOptions>
  ) {

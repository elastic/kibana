...
import { TrackApplicationViewComponent } from './track_application_view';
 ...
 * @private
 */
const applicationUsageTracker$ = new ReplaySubject<IApplicationUsageTracker>(1);
...
export function setApplicationUsageTracker(newApplicationUsageTracker: IApplicationUsageTracker) {
  applicationUsageTracker$.next(newApplicationUsageTracker);
}

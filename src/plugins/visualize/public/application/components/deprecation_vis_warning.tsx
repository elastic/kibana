...
export const DeprecationWarning = () => {
  ...
  const advancedSettingsLink = services.application.getUrlForApp('management', {
    path: `/kibana/settings?query=${LEGACY_PIE_CHARTS_LIBRARY}`,
  });
    ...
    <EuiCallOut
      ...
      title={
        <FormattedMessage
          ...
          defaultMessage="You are using the legacy charts library, which will be removed in 8.2. {conditionalMessage}"
          values={{
            conditionalMessage: (
              <>

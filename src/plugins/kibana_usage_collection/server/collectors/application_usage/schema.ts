...
export const applicationUsageSchema = {
  ...
  searchInferenceEndpointsRedirect: commonSchema,
  ...
  searchElasticsearchRedirect: commonSchema,
  searchVectorsearchRedirect: commonSchema,
  searchSemanticsearchRedirect: commonSchema,
  searchAIsearchRedirect: commonSchema,

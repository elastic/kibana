...
export function registerManagementUsageCollector(
  ...
  const collector = usageCollection.makeUsageCollector<UsageStats | undefined>({
    ...
    schema: {
      ...
      'history:limit': {
        type: 'long',
        _meta: { description: 'Non-default value of history:limit' },
      },
      ...
      defaultIndex: {
        type: 'keyword',
        _meta: { description: 'Non-default value of defaultIndex' },
      },
      ...
      defaultRoute: {
        type: 'keyword',
        _meta: { description: 'Non-default value of defaultRoute' },
      },
      'dateFormat:tz': {
        type: 'keyword',

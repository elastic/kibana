...
const InnerVerificationProvider: FunctionComponent<PropsWithChildren> = ({ children }) => {
...
export const VerificationProvider: FunctionComponent<PropsWithChildren<VerificationProps>> = ({
  defaultCode,
  children,
}) => {
  return (

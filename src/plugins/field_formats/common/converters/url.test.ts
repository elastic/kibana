...
describe('UrlFormat', () => {
  test('outputs a simple <a> tag by default', () => {
    ...
    expect(url.convert('http://elastic.co', HTML_CONTEXT_TYPE)).toBe(
      '<span><a href="http://elastic.co" target="_blank" rel="noopener noreferrer">http://elastic.co</a></span>'
    );
  });
  ...
  test('outputs an <audio> if type === "audio"', () => {
    ...
    expect(url.convert('http://elastic.co', HTML_CONTEXT_TYPE)).toBe(
      '<span><audio controls preload="none" src="http://elastic.co"></span>'
    );
  });
  ...
  describe('outputs an <image> if type === "img"', () => {
    test('default', () => {
      ...
      expect(url.convert('http://elastic.co', HTML_CONTEXT_TYPE)).toBe(
        '<span><img src="http://elastic.co" alt="A dynamically-specified image located at http://elastic.co" ' +
  ...
  describe('allow-list', () => {
    test('should assume a relative url if the value is not in the allow-list without a base path', () => {
      ...
      expect(converter('www.elastic.co')).toBe(
        '<span><a href="http://kibana/app/www.elastic.co" target="_blank" rel="noopener noreferrer">www.elastic.co</a></span>'
      );

      expect(converter('elastic.co')).toBe(
        '<span><a href="http://kibana/app/elastic.co" target="_blank" rel="noopener noreferrer">elastic.co</a></span>'
      );

      expect(converter('elastic')).toBe(
        '<span><a href="http://kibana/app/elastic" target="_blank" rel="noopener noreferrer">elastic</a></span>'
      );

      expect(converter('ftp://elastic.co')).toBe(
        '<span><a href="http://kibana/app/ftp://elastic.co" target="_blank" rel="noopener noreferrer">ftp://elastic.co</a></span>'
      );
    });
    ...
    test('should assume a relative url if the value is not in the allow-list with a basepath', () => {
      ...
      expect(converter('www.elastic.co')).toBe(
        '<span><a href="http://kibana/xyz/app/www.elastic.co" target="_blank" rel="noopener noreferrer">www.elastic.co</a></span>'
      );

      expect(converter('elastic.co')).toBe(
        '<span><a href="http://kibana/xyz/app/elastic.co" target="_blank" rel="noopener noreferrer">elastic.co</a></span>'
      );

      expect(converter('elastic')).toBe(
        '<span><a href="http://kibana/xyz/app/elastic" target="_blank" rel="noopener noreferrer">elastic</a></span>'
      );

      expect(converter('ftp://elastic.co')).toBe(
        '<span><a href="http://kibana/xyz/app/ftp://elastic.co" target="_blank" rel="noopener noreferrer">ftp://elastic.co</a></span>'
      );
    });
    ...
    test('should rely on parsedUrl', () => {
      ...
      expect(converter('../app/kibana')).toBe(
        '<span><a href="http://kibana.host.com/abc/app/../app/kibana" target="_blank" rel="noopener noreferrer">../app/kibana</a></span>'
      );
    });
    ...
    test('should fail gracefully if there are no parsedUrl provided', () => {
      ...
      expect(url.convert('../app/kibana', HTML_CONTEXT_TYPE)).toBe('<span>../app/kibana</span>');

      expect(url.convert('http://www.elastic.co', HTML_CONTEXT_TYPE)).toBe(
        '<span><a href="http://www.elastic.co" target="_blank" rel="noopener noreferrer">http://www.elastic.co</a></span>'
      );
    });
    ...
    test('should support multiple types of relative urls', () => {
      ...
      expect(converter('#/foo')).toBe(
        '<span><a href="http://kibana.host.com/nbc/app/discover#/#/foo" target="_blank" rel="noopener noreferrer">#/foo</a></span>'
      );

      expect(converter('/nbc/app/discover#/')).toBe(
        '<span><a href="http://kibana.host.com/nbc/app/discover#/" target="_blank" rel="noopener noreferrer">/nbc/app/discover#/</a></span>'
      );

      expect(converter('../foo/bar')).toBe(
        '<span><a href="http://kibana.host.com/nbc/app/../foo/bar" target="_blank" rel="noopener noreferrer">../foo/bar</a></span>'
      );
    });
    ...
    test('should support multiple types of urls w/o basePath', () => {
      ...
      expect(converter('10.22.55.66')).toBe(
        '<span><a href="http://kibana.host.com/app/10.22.55.66" target="_blank" rel="noopener noreferrer">10.22.55.66</a></span>'
      );
      ...
      expect(converter('/app/kibana')).toBe(
        '<span><a href="http://kibana.host.com/app/kibana" target="_blank" rel="noopener noreferrer">/app/kibana</a></span>'
      );

      expect(converter('kibana#/dashboard/')).toBe(
        '<span><a href="http://kibana.host.com/app/kibana#/dashboard/" target="_blank" rel="noopener noreferrer">kibana#/dashboard/</a></span>'
      );

      expect(converter('#/dashboard/')).toBe(
        '<span><a href="http://kibana.host.com/app/kibana#/dashboard/" target="_blank" rel="noopener noreferrer">#/dashboard/</a></span>'
      );
    });
  });
});

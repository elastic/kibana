...
describe('Source Format', () => {
  ...
  test('should render a description list if a field is passed', () => {
    ...
    expect(
      ...
      `"<span><dl class=\\"source truncate-by-height\\"><dt>foo:</dt><dd>bar</dd> <dt>number:</dt><dd>42</dd> <dt>hello:</dt><dd><h1>World</h1></dd> <dt>also:</dt><dd>with \\"quotes\\" or 'single quotes'</dd> </dl></span>"`
    );
  });
});

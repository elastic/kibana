...
export const getUiSettings: (docLinks: DocLinksServiceSetup) => Record<string, UiSettingsParams> = (
  ...
  [ENABLE_TEXT_BASED]: {
    ...
    description: i18n.translate('discover.advancedSettings.enableSQLDescription', {
      defaultMessage:
        '{technicalPreviewLabel} This tech preview feature is highly experimental--do not rely on this for production saved searches or dashboards. This setting enables SQL and ESQL as a text-based query languages in Discover. If you have feedback on this experience please reach out to us on {link}',
      values: {
        link:

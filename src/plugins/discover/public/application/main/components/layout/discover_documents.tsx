...
function DiscoverDocumentsComponent({
  ...
  const onUpdateRowsPerPage = useCallback(
    (nextRowsPerPage: number) => {
      stateContainer.setAppState({ rowsPerPage: nextRowsPerPage }, true);
    },
    [stateContainer]
  );
  ...
  const onSort = useCallback(
    (nextSort: string[][]) => {
      stateContainer.setAppState({ sort: nextSort }, false);
    },
    [stateContainer]
  );
  ...
  const onUpdateRowHeight = useCallback(
    (newRowHeight: number) => {
      stateContainer.setAppState({ rowHeight: newRowHeight }, true);
    },
    [stateContainer]
  );

...
export const DiscoverGridFlyoutAdvancedGrid = function DiscoverGridInner({
  indexPattern,
  rows,
  selected,
    ...
    <EuiPortal>
      <EuiFlyout onClose={() => onClose()} size="m">
              ...
              <EuiFlexGroup justifyContent="flexEnd">
                <EuiFlexItem>
                  <EuiButtonGroup
                    ...
                    idToSelectedMap={{ [direction]: true }}
        ...
        <EuiFlyoutBody>
          ...
          {selected.length > 0 && (
            <EuiDataGrid
              aria-labelledby="documentSelectionAriaLabel"
              className="dscEuiDataGridRowCell"
              columns={
                direction === 'column'
                  ? [{ id: '_source', isExpandable: false }]
                  : selected.map((id) => ({
                      id: String(id),
                      isExpandable: false,
                      width: 300,
              ...
              columnVisibility={{
                visibleColumns:
                  direction === 'column' ? ['_source'] : selected.map((id) => String(id)),
                ...
                return (
                  <div>
                    ...
                    >
                      <div
                        style={{
                          maxHeight: direction === 'column' ? '300px' : undefined,
                          overflow: 'hidden',
                          overflowY: 'scroll',
                          paddingBottom: '1em',
                        }}

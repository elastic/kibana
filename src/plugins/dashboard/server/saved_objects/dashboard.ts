    ...
    properties: {
      ...
      refreshInterval: {
        properties: {
          ...
          pause: { type: 'boolean', index: false },
          section: { type: 'integer', index: false },
          value: { type: 'integer', index: false },
        },
      },
      timeFrom: { type: 'keyword', index: false },
      timeRestore: { type: 'boolean', index: false },
      timeTo: { type: 'keyword', index: false },
      title: { type: 'text' },

...
import { SavedObjectNotFound, unhashUrl } from '../../../kibana_utils/public';
import { addFatalError, AngularHttpError, subscribeWithScope } from '../../../kibana_legacy/public';
...
export function DashboardApp({ savedDashboardId, history }: DashboardAppProps) {
  ...
  const loadDashboardUseEffect = useEffect(() => {
    data.indexPatterns
      .ensureDefaultIndexPattern()
      ?.then(() => savedDashboards.get(savedDashboardId))
      .then((savedDashboard) => {
...
//   constructor({ dashboardConfig, savedDashboardId, history }: DashboardAppProps) {

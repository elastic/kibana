      ...
      <EuiCallOut
        title={
          <FormattedMessage
            ...
            defaultMessage="Deprecated since 7.0, the Timelion app will be removed in the latest 7.x minor. To continue using your Timelion worksheets, {timeLionDeprecationLink}."
            values={{

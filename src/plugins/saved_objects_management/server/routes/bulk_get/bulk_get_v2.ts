...
import { BulkGetHTTPResponseV2 } from '../../../common';
...
export const registerBulkGetRoute = (
  ...
  router.post(
    {
      path: '/v2/api/kibana/management/saved_objects/_bulk_get',
      validate: {
        body: schema.arrayOf(
          schema.object({
            type: schema.string(),
    ...
    router.handleLegacyErrors(
      async (context, req, res): Promise<IKibanaResponse<BulkGetHTTPResponseV2>> => {

...
describe('NotFoundErrors component', () => {
  ...
  it('renders correctly for search type', () => {
    ...
    expect(mounted.text()).toMatchInlineSnapshot(
      `"There is a problem with this saved objectThe discover view associated with this object no longer exists.If you know what this error means, you can use the Saved objects APIsExternal link(opens in a new tab or window) to fix it — otherwise click the delete button above."`
    );
  });

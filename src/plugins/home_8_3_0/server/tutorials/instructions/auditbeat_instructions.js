...
exports.createAuditbeatInstructions = exports.createAuditbeatCloudInstructions = void 0;
    ...
    INSTALL: {
      OSX: {
        title: _i18n.i18n.translate(
          'home.tutorials.common.auditbeatInstructions.install.osxTitle',
          {
            defaultMessage: 'Download and install Auditbeat',
          }
        ),
        textPre: _i18n.i18n.translate(
          'home.tutorials.common.auditbeatInstructions.install.osxTextPre',
          {
      ...
      DEB: {
        title: _i18n.i18n.translate(
          'home.tutorials.common.auditbeatInstructions.install.debTitle',
          {
            defaultMessage: 'Download and install Auditbeat',
          }
        ),
        textPre: _i18n.i18n.translate(
          'home.tutorials.common.auditbeatInstructions.install.debTextPre',
          {
            defaultMessage: 'First time using Auditbeat? See the [Quick Start]({linkUrl}).',
            values: {
              linkUrl: '{config.docs.beats.auditbeat}/auditbeat-installation-configuration.html',
      ...
      RPM: {
        title: _i18n.i18n.translate(
          'home.tutorials.common.auditbeatInstructions.install.rpmTitle',
          {
            defaultMessage: 'Download and install Auditbeat',
          }
        ),
        textPre: _i18n.i18n.translate(
          'home.tutorials.common.auditbeatInstructions.install.rpmTextPre',
          {
            defaultMessage: 'First time using Auditbeat? See the [Quick Start]({linkUrl}).',
            values: {
              linkUrl: '{config.docs.beats.auditbeat}/auditbeat-installation-configuration.html',
      ...
      WINDOWS: {
        title: _i18n.i18n.translate(
          'home.tutorials.common.auditbeatInstructions.install.windowsTitle',
          {
            defaultMessage: 'Download and install Auditbeat',
          }
        ),
 ...
 5. From the PowerShell prompt, run the following commands to install Auditbeat as a Windows service.',
    ...
    START: {
      OSX: {
        ...
        textPre: _i18n.i18n.translate(
          'home.tutorials.common.auditbeatInstructions.start.osxTextPre',
          {
            defaultMessage:
      ...
      DEB: {
        ...
        textPre: _i18n.i18n.translate(
          'home.tutorials.common.auditbeatInstructions.start.debTextPre',
          {
            defaultMessage:
              'The `setup` command loads the Kibana dashboards. If the dashboards are already set up, omit this command.',
          }
      ...
      RPM: {
        ...
        textPre: _i18n.i18n.translate(
          'home.tutorials.common.auditbeatInstructions.start.rpmTextPre',
          {
            defaultMessage:
              'The `setup` command loads the Kibana dashboards. If the dashboards are already set up, omit this command.',
          }
      ...
      WINDOWS: {
        title: _i18n.i18n.translate(
          'home.tutorials.common.auditbeatInstructions.start.windowsTitle',
          {
            defaultMessage: 'Start Auditbeat',
          }
        ),
    ...
    CONFIG: {
      OSX: {
        ...
        textPre: _i18n.i18n.translate(
          'home.tutorials.common.auditbeatInstructions.config.osxTextPre',
          {
      ...
      DEB: {
        ...
        textPre: _i18n.i18n.translate(
          'home.tutorials.common.auditbeatInstructions.config.debTextPre',
          {
            defaultMessage: 'Modify {path} to set the connection information:',
            values: {
      ...
      RPM: {
        ...
        textPre: _i18n.i18n.translate(
          'home.tutorials.common.auditbeatInstructions.config.rpmTextPre',
          {
            defaultMessage: 'Modify {path} to set the connection information:',
            values: {
              path: '`/etc/auditbeat/auditbeat.yml`',
      ...
      WINDOWS: {
        title: _i18n.i18n.translate(
          'home.tutorials.common.auditbeatInstructions.config.windowsTitle',
          {
            defaultMessage: 'Edit the configuration',
          }
        ),
...
const createAuditbeatCloudInstructions = () => ({
  CONFIG: {
    OSX: {
      title: _i18n.i18n.translate(
        'home.tutorials.common.auditbeatCloudInstructions.config.osxTitle',
        {
          defaultMessage: 'Edit the configuration',
        }
      ),
    ...
    DEB: {
      title: _i18n.i18n.translate(
        'home.tutorials.common.auditbeatCloudInstructions.config.debTitle',
        {
          defaultMessage: 'Edit the configuration',
        }
      ),
    ...
    RPM: {
      title: _i18n.i18n.translate(
        'home.tutorials.common.auditbeatCloudInstructions.config.rpmTitle',
        {
          defaultMessage: 'Edit the configuration',
        }
      ),
...
function onPremCloudInstructions(platforms, context) {
  const AUDITBEAT_INSTRUCTIONS = createAuditbeatInstructions(context);
...
function cloudInstructions(platforms, context) {
  const AUDITBEAT_INSTRUCTIONS = createAuditbeatInstructions(context);

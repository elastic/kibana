    ...
    INSTALL: {
      OSX: {
        title: _i18n.i18n.translate(
          'home.tutorials.common.functionbeatInstructions.install.osxTitle',
          {
      ...
      LINUX: {
        title: _i18n.i18n.translate(
          'home.tutorials.common.functionbeatInstructions.install.linuxTitle',
          {
            defaultMessage: 'Download and install Functionbeat',
          }
        ),
...
**Run As Administrator**). If you are running Windows XP, you might need to download and install PowerShell.\n\
 5. From the PowerShell prompt, go to the Functionbeat directory:',
    ...
    DEPLOY: {
      OSX_LINUX: {
        title: _i18n.i18n.translate(
          'home.tutorials.common.functionbeatInstructions.deploy.osxTitle',
          {
...
Kibana index pattern. It is normally safe to omit this command.',
    ...
    CONFIG: {
      OSX_LINUX: {
        title: _i18n.i18n.translate(
          'home.tutorials.common.functionbeatInstructions.config.osxTitle',
          {
...
const createFunctionbeatCloudInstructions = () => ({
  CONFIG: {
    OSX_LINUX: {
      title: _i18n.i18n.translate(
        'home.tutorials.common.functionbeatCloudInstructions.config.osxTitle',
        {
          defaultMessage: 'Edit the configuration',
        }
      ),
...
function functionbeatAWSInstructions() {
  const defaultTitle = _i18n.i18n.translate(
    'home.tutorials.common.functionbeatAWSInstructions.title',
    {
      defaultMessage: 'Set AWS credentials',
    }
  );

  const defaultPre = _i18n.i18n.translate(
    'home.tutorials.common.functionbeatAWSInstructions.textPre',
    {
      defaultMessage: 'Set your AWS account credentials in the environment:',
    }
  );

  const defaultPost = _i18n.i18n.translate(
    'home.tutorials.common.functionbeatAWSInstructions.textPost',
    {
      defaultMessage:

...
function redisenterpriseMetricsSpecProvider(context) {
  ...
  return {
    ...
    shortDescription: _i18n.i18n.translate('home.tutorials.redisenterpriseMetrics.shortDescription', {
    ...
    longDescription: _i18n.i18n.translate('home.tutorials.redisenterpriseMetrics.longDescription', {
      defaultMessage: 'The `redisenterprise` Metricbeat module fetches metrics from Redis Enterprise Server \
[Learn more]({learnMoreLink}).',
    ...
    artifacts: {
      application: {
        label: _i18n.i18n.translate('home.tutorials.redisenterpriseMetrics.artifacts.application.label', {

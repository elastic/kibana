...
const dashboardSchema = _configSchema.schema.object({
  ...
  linkLabel: _configSchema.schema.conditional(
    _configSchema.schema.siblingRef('isOverview'),
    true,
...
const artifactsSchema = _configSchema.schema.object({
  ...
  exportedFields: _configSchema.schema.maybe(
  ...
  application: _configSchema.schema.maybe(
    _configSchema.schema.object({
...
const statusCheckSchema = _configSchema.schema.object({
  ...
  esHitsCheck: _configSchema.schema.object({
    index: _configSchema.schema.oneOf([
      _configSchema.schema.string(),
...
const instructionSetSchema = _configSchema.schema.object({
  title: _configSchema.schema.maybe(_configSchema.schema.string()),
  callOut: _configSchema.schema.maybe(
    _configSchema.schema.object({
...
const paramSchema = _configSchema.schema.object({
  ...
  type: _configSchema.schema.oneOf([
    _configSchema.schema.literal('number'),
    _configSchema.schema.literal('string'),
  ]),
});
...
const tutorialSchema = _configSchema.schema.object({
  ...
  category: _configSchema.schema.oneOf([
    _configSchema.schema.literal('logging'),
    _configSchema.schema.literal('security'),
    _configSchema.schema.literal('metrics'),
    _configSchema.schema.literal('other'),
  ]),
  ...
  completionTimeMinutes: _configSchema.schema.maybe(
  ...
  savedObjects: _configSchema.schema.maybe(
    _configSchema.schema.arrayOf(_configSchema.schema.any())
  ),
  ...
  integrationBrowserCategories: _configSchema.schema.maybe(
    _configSchema.schema.arrayOf(_configSchema.schema.string())
  ),

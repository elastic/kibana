...
describe('convertMetricToColumns invalid cases', () => {
  ...
  test.each<[string, Parameters<typeof convertMetricToColumns>, null, jest.Mock | undefined]>([
    [
      ...
      [
        { aggType: METRIC_TYPES.GEO_BOUNDS } as unknown as SchemaConfig<METRIC_TYPES>,
        dataView,
        [],
    ...
    [
      ...
      [
        { aggType: METRIC_TYPES.AVG } as SchemaConfig<METRIC_TYPES>,
        dataView,
        [],
        { isPercentageMode: false },
      ],
    ...
    [
      ...
      [
        { aggType: METRIC_TYPES.MIN } as SchemaConfig<METRIC_TYPES>,
        dataView,
        [],
        { isPercentageMode: false },
      ],
    ...
    [
      ...
      [
        { aggType: METRIC_TYPES.MAX } as SchemaConfig<METRIC_TYPES>,
        dataView,
        [],
        { isPercentageMode: false },
      ],
    ...
    [
      ...
      [
        { aggType: METRIC_TYPES.SUM } as SchemaConfig<METRIC_TYPES>,
        dataView,
        [],
        { isPercentageMode: false },
      ],
    ...
    [
      ...
      [
        { aggType: METRIC_TYPES.COUNT } as SchemaConfig<METRIC_TYPES>,
        dataView,
        [],
        { isPercentageMode: false },
      ],
    ...
    [
      ...
      [
        { aggType: METRIC_TYPES.CARDINALITY } as SchemaConfig<METRIC_TYPES>,
        dataView,
        [],
        { isPercentageMode: false },
      ],
    ...
    [
      ...
      [
        { aggType: METRIC_TYPES.VALUE_COUNT } as SchemaConfig<METRIC_TYPES>,
        dataView,
        [],
        { isPercentageMode: false },
      ],
    ...
    [
      ...
      [
        { aggType: METRIC_TYPES.MEDIAN } as SchemaConfig<METRIC_TYPES>,
        dataView,
        [],
        { isPercentageMode: false },
      ],
    ...
    [
      ...
      [
        { aggType: METRIC_TYPES.STD_DEV } as SchemaConfig<METRIC_TYPES>,
        dataView,
        [],
        { isPercentageMode: false },
      ],
    ...
    [
      ...
      [
        { aggType: METRIC_TYPES.PERCENTILES } as SchemaConfig<METRIC_TYPES>,
        dataView,
        [],
        { isPercentageMode: false },
      ],
    ...
    [
      ...
      [
        { aggType: METRIC_TYPES.SINGLE_PERCENTILE } as SchemaConfig<METRIC_TYPES>,
        dataView,
        [],
        { isPercentageMode: false },
      ],
    ...
    [
      ...
      [
        { aggType: METRIC_TYPES.PERCENTILE_RANKS } as SchemaConfig<METRIC_TYPES>,
        dataView,
        [],
        { isPercentageMode: false },
      ],
    ...
    [
      ...
      [
        { aggType: METRIC_TYPES.SINGLE_PERCENTILE_RANK } as SchemaConfig<METRIC_TYPES>,
        dataView,
        [],
        { isPercentageMode: false },
      ],
    ...
    [
      ...
      [
        { aggType: METRIC_TYPES.TOP_HITS } as SchemaConfig<METRIC_TYPES>,
        dataView,
        [],
        { isPercentageMode: false },
      ],
    ...
    [
      ...
      [
        { aggType: METRIC_TYPES.TOP_METRICS } as SchemaConfig<METRIC_TYPES>,
        dataView,
        [],
        { isPercentageMode: false },
      ],
    ...
    [
      ...
      [
        { aggType: METRIC_TYPES.CUMULATIVE_SUM } as SchemaConfig<METRIC_TYPES>,
        dataView,
        [],
        { isPercentageMode: false },
      ],
    ...
    [
      ...
      [
        { aggType: METRIC_TYPES.DERIVATIVE } as SchemaConfig<METRIC_TYPES>,
        dataView,
        [],
        { isPercentageMode: false },
      ],
    ...
    [
      ...
      [
        { aggType: METRIC_TYPES.MOVING_FN } as SchemaConfig<METRIC_TYPES>,
        dataView,
        [],
        { isPercentageMode: false },
      ],
    ...
    [
      ...
      [
        { aggType: METRIC_TYPES.SUM_BUCKET } as SchemaConfig<METRIC_TYPES>,
        dataView,
        [],
        { isPercentageMode: false },
      ],
    ...
    [
      ...
      [
        { aggType: METRIC_TYPES.MIN_BUCKET } as SchemaConfig<METRIC_TYPES>,
        dataView,
        [],
        { isPercentageMode: false },
      ],
    ...
    [
      ...
      [
        { aggType: METRIC_TYPES.MAX_BUCKET } as SchemaConfig<METRIC_TYPES>,
        dataView,
        [],
        { isPercentageMode: false },
      ],
    ...
    [
      ...
      [
        { aggType: METRIC_TYPES.SERIAL_DIFF } as SchemaConfig<METRIC_TYPES>,
        dataView,
        [],
        { isPercentageMode: false },
      ],

...
export const help = {
  ...
  args: {
    image: i18n.translate('expressionShape.functions.shape.args.imageHelpText', {
      defaultMessage:
    ...
    emptyImage: i18n.translate('expressionShape.functions.shape.args.emptyImageHelpText', {
      defaultMessage:
    ...
    origin: i18n.translate('expressionShape.functions.shape.args.originHelpText', {
...
export const errors = {
  invalidPercent: (percent: number) =>
    new Error(
      i18n.translate('expressionShape.functions.shape.invalidPercentErrorMessage', {

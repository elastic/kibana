...
const schema7x = _configSchema.schema.object(
  {
    ...
    proxyConfig: _configSchema.schema.arrayOf(
  ...
  deprecations: ({ unused }) => [
    ...
    (completeConfig, rootPath, addDeprecation) => {
      ...
      addDeprecation({
        ...
        correctiveActions: {
          manualSteps: [
            _i18n.i18n.translate('console.deprecations.enabled.manualStepOneMessage', {
    ...
    (completeConfig, rootPath, addDeprecation) => {
      ...
      addDeprecation({
        ...
        correctiveActions: {
          manualSteps: [
            _i18n.i18n.translate('console.deprecations.proxyConfig.manualStepOneMessage', {
              defaultMessage: 'Open the kibana.yml config file.',
            }),
    ...
    (completeConfig, rootPath, addDeprecation) => {
      ...
      addDeprecation({
        ...
        correctiveActions: {
          manualSteps: [
            _i18n.i18n.translate('console.deprecations.proxyFilter.manualStepOneMessage', {
              defaultMessage: 'Open the kibana.yml config file.',
            }),

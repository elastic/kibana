...
const rules = {
  '*': {
    ...
    significant_text: { ...significantTermsArgs, filter_duplicate_text: '__flag__' },
    ...
    extended_stats_bucket: { ...simple_pipeline, sigma: '' },
    percentiles_bucket: { ...simple_pipeline, percents: [] },

...
export interface TabsApi {
  updateTab: (newTab: Pick<EuiTabbedContentTab, 'id'>) => void;
  updateFieldTypeFilter: (newIndexedFieldTypeFilter: string[]) => void;
  updateFieldFilter: (newFieldFilter: string) => void;
}
...
export const Tabs = forwardRef<TabsApi, TabsProps>(
  (
    {
      indexPattern,
      saveIndexPattern,
    ...
    useImperativeHandle(
      ...
      () => ({
        ...
        updateFieldFilter: setFieldFilter,
      }),
      [updateFieldTypeFilter, updateTab]
    );

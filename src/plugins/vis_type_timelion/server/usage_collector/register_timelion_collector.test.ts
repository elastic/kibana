...
import { registerTimelionUsageCollector } from './register_timelion_collector';
...
describe('registerTimelionUsageCollector', () => {
  ...
  it('makes a usage collector and registers it`', () => {
    ...
    registerTimelionUsageCollector(mockCollectorSet, mockConfig);
  ...
  it('makeUsageCollector config.fetch calls getStats', async () => {
    ...
    expect(mockGetStats).toBeCalledWith(mockedCollectorFetchContext.esClient, mockedCollectorFetchContext.soClient, mockIndex);

...
function peg$parse(input, options) {
  ...
  var peg$c3 = function(first, arg) {return arg};
  var peg$c4 = function(first, rest) {
    return [first].concat(rest);
   };
  var peg$c5 = "=";
  var peg$c6 = peg$literalExpectation("=", false);
  var peg$c7 = function(name, value) {
    var arg = {
     type: 'namedArg',
     name: name,
     value: value,
  ...
  var peg$c10 = function(element) {return element};
  var peg$c11 = function(literal) {
  ...
  var peg$c15 = function(name, value) {
    variables[name] = value;
   };
  var peg$c16 = function(first, series) {return series};
  var peg$c17 = function(first, rest) {
    return [first].concat(rest)
   };
  var peg$c18 = /^[a-zA-Z]/;
  var peg$c19 = peg$classExpectation([["a", "z"], ["A", "Z"]], false, false);
  var peg$c20 = /^[.a-zA-Z0-9_\-]/;
  var peg$c21 = peg$classExpectation([".", ["a", "z"], ["A", "Z"], ["0", "9"], "_", "-"], false, false);
  var peg$c22 = function(first, rest) {
    currentFunction = first.join('') + rest.join('');
    currentArgs = [];
    return currentFunction;
  };
  var peg$c23 = function(first, rest) { return first.join('') + rest.join('') };
  var peg$c24 = peg$otherExpectation("function");
  var peg$c25 = ".";
  ...
  var peg$c31 = function(name, arg_list) {
    var result = {
      type: 'function',
      function: name,
      arguments: arg_list || [],
  ...
  var peg$c37 = function(plot, series) {
    return {
     type: 'reference',
     plot: plot,
     series: series
  ...
  var peg$c38 = function(plot) {
    return {
     type: 'reference',
     plot: plot
    }
   };
  var peg$c39 = function(func, rest) {return {type: 'chain', chain: [func].concat(rest)}};
  var peg$c40 = function(grouped, functions) {
    var first = {
      type: 'chainList',
      list: grouped
    }
  ...
  var peg$c41 = peg$otherExpectation("literal");
  var peg$c42 = "\"";
  var peg$c43 = peg$literalExpectation("\"", false);
  var peg$c44 = function(chars) { return chars.join(''); };
  var peg$c45 = "'";
  var peg$c46 = peg$literalExpectation("'", false);
  var peg$c47 = "true";
  var peg$c48 = peg$literalExpectation("true", false);
  var peg$c49 = function() { return true; };
  var peg$c50 = "false";
  var peg$c51 = peg$literalExpectation("false", false);
  var peg$c52 = function() { return false; };
  var peg$c53 = "null";
  var peg$c54 = peg$literalExpectation("null", false);
  var peg$c55 = function() { return null; };
  var peg$c56 = /^[^()"',= \t]/;
  var peg$c57 = peg$classExpectation(["(", ")", "\"", "'", ",", "=", " ", "\t"], true, false);
  var peg$c58 = function(string) { // this also matches numbers via Number()
  ...
  var peg$c70 = function(digits) {return parseInt(digits.join(''))};

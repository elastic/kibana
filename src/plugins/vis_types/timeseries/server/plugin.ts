...
export interface VisTypeTimeseriesSetup {
  getVisData: (
    ...
    // ideally this should be VisPayload type, but currently has inconsistencies with x-pack/solutions/observability/solutions/observability/plugins/observability_solution/infra/server/lib/adapters/framework/kibana_framework_adapter.ts
    options: any

...
const getConvertFnByType = async (
  ...
  const convertionFns: Record<PANEL_TYPES | string, () => Promise<ConvertTsvbToLensVisualization>> =
    {
      [PANEL_TYPES.TIMESERIES]: async (): Promise<ConvertTsvbToLensVisualization> => {

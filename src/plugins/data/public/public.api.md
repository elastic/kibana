...
//
// @public (undocumented)
export const baseFormattersPublic: (
  | import('../../common').FieldFormatInstanceType
  | typeof DateFormat
)[];
...
export const connectToQueryState: <S extends QueryState>(
  {
    ...
    'state$' | 'timefilter' | 'filterManager'
  >,
...
export const createSavedQueryService: (
  savedObjectsClient: Pick<
    import('../../../../../core/public').SavedObjectsClient,
    'update' | 'find' | 'get' | 'delete' | 'create' | 'bulkCreate' | 'bulkGet' | 'bulkUpdate'
  >
) => SavedQueryService;
...
export const esFilters: {
  ...
  toggleFilterNegated: (
    ...
    meta: {
      ...
      value?:
        | string
        | ((formatter?: import('../common').FilterValueFormatter | undefined) => string)
        | undefined;
    };
  ...
  compareFilters: (
    first: import('../common').Filter | import('../common').Filter[],
    second: import('../common').Filter | import('../common').Filter[],
    comparatorOptions?: import('../common').FilterCompareOptions
  ) => boolean;
  COMPARE_ALL_OPTIONS: import('../common').FilterCompareOptions;
  generateFilters: typeof generateFilters;
  onlyDisabledFiltersChanged: (
    newFilters?: import('../common').Filter[] | undefined,
    oldFilters?: import('../common').Filter[] | undefined
  ) => boolean;
...
export const esKuery: {
  ...
  ) => import('../../kibana_utils/common').JsonObject;
};
...
export const esQuery: {
  ...
  buildQueryFromFilters: (
    filters: import('../common').Filter[] | undefined,
    indexPattern: import('../common').IIndexPattern | undefined,
...
export const fieldFormats: {
  ...
  serialize: (
    agg: import('./search').AggConfig
  ) => import('../../expressions').SerializedFieldFormat<object>;
...
//
// @public (undocumented)
export const FilterBar: React.ComponentClass<
  Pick<Props_2, 'className' | 'filters' | 'indexPatterns' | 'onFiltersUpdated'>,
  any
> & {
...
//
// @public (undocumented)
export function getSearchErrorType({
  message,
}: Pick<SearchError, 'message'>): 'UNSUPPORTED_QUERY' | undefined;
...
export class IndexPatternField implements IFieldType {
  ...
  constructor(
    ...
    spec: FieldSpec | IndexPatternField,
...
//
// @public (undocumented)
export const QueryStringInput: React.FC<Pick<
  Props_3,
  | 'query'
  | 'placeholder'
  | 'onChange'
  ...
  aggs: {
    ...
    intervalOptions: (
      | {
          ...
          val: string;
          enabled(
            agg: import('./search/aggs/buckets/bucket_agg_type').IBucketAggConfig
          ): boolean | '' | undefined;
        }
      | {
          display: string;
...
export class SearchInterceptor {
  ...
  search: (
    ...
    options?: ISearchOptions | undefined
  ) => import('rxjs').Observable<import('../../common/search').IEsSearchResponse<unknown>>;
  // (undocumented)

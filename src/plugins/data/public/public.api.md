...
// src/plugins/data/common/search/aggs/types.ts:134:51 - (ae-forgotten-export) The symbol "AggTypesRegistryStart" needs to be exported by the entry point index.d.ts
...
// src/plugins/data/public/search/session/session_service.ts:35:5 - (ae-forgotten-export) The symbol "UrlGeneratorStateMapping" needs to be exported by the entry point index.d.ts

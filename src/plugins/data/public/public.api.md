...
// src/plugins/data/common/index_patterns/index_patterns/index_pattern.ts:130:7 - (ae-forgotten-export) The symbol "FieldAttrSet" needs to be exported by the entry point index.d.ts

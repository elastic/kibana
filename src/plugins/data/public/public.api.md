...
// src/plugins/data/public/search/session/session_service.ts:47:5 - (ae-forgotten-export) The symbol "UrlGeneratorStateMapping" needs to be exported by the entry point index.d.ts

...
// Warning: (ae-missing-release-tag) "INDEX_PATTERN_MANAGEMENT_SECTION_PATH" is exported by the package, but it is missing a release tag (@alpha, @beta, @public, or @internal)
//
// @public (undocumented)

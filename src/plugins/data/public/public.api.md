...
// src/plugins/data/public/index.ts:178:26 - (ae-forgotten-export) The symbol "FieldFormat" needs to be exported by the entry point index.d.ts
...
// src/plugins/data/public/index.ts:235:27 - (ae-forgotten-export) The symbol "getRoutes" needs to be exported by the entry point index.d.ts

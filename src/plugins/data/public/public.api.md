...
// src/plugins/data/common/index_patterns/index_patterns/index_pattern.ts:68:5 - (ae-forgotten-export) The symbol "FormatFieldFn" needs to be exported by the entry point index.d.ts

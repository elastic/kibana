...
// src/plugins/data/server/search/types.ts:95:5 - (ae-forgotten-export) The symbol "ISearchStartSearchSource" needs to be exported by the entry point index.d.ts

...
// src/plugins/data/server/search/types.ts:111:5 - (ae-forgotten-export) The symbol "ISearchStartSearchSource" needs to be exported by the entry point index.d.ts

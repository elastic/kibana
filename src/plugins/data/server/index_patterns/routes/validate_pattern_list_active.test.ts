...
const prev = [
  ...
  { pattern: 'auditbeat-*', matchesIndices: false },
  { pattern: 'endgame-*', matchesIndices: true },
...
const active = ['endgame-*', 'filebeat-*', 'packetbeat-*', 'winlogbeat-*'];
const newActive = ['auditbeat-*', 'filebeat-*', 'packetbeat-*', 'winlogbeat-*'];

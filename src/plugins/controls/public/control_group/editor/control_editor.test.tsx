...
import { ControlWidth, OPTIONS_LIST_CONTROL, RANGE_SLIDER_CONTROL } from '../../../common';
...
describe('Data control editor', () => {
  ...
  describe('selecting a keyword field', () => {
    ...
    test('creates an options list control', async () => {
      expect(findTestSubject(controlEditor, 'control-editor-type').text()).toEqual('Options list');
    });
  ...
  describe('selecting a number field', () => {
    ...
    test('creates a range slider control', async () => {
      expect(findTestSubject(controlEditor, 'control-editor-type').text()).toEqual('Range slider');
    });
  ...
  test('selects given width and grow', async () => {
    ...
    expect(findTestSubject(controlEditor, 'control-editor-grow-switch').prop('aria-checked')).toBe(
      false
    );
  });
});

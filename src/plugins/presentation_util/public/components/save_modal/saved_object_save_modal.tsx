...
export class SavedObjectSaveModal extends React.Component<Props, SaveModalState> {
    ...
    const formBodyContent = (
      <>
        <EuiFormRow
          fullWidth
          label={
            <FormattedMessage id="presentationUtil.saveModal.titleLabel" defaultMessage="Title" />
          }
        >
          <EuiFieldText
            fullWidth
      ...
      >
        <form onSubmit={this.onFormSubmit} className="euiModal__flex">
          <EuiModalHeader>
            <EuiModalHeaderTitle>
              <FormattedMessage
                id="presentationUtil.saveModal.saveTitle"
          ...
          <EuiModalFooter>
            <EuiButtonEmpty data-test-subj="saveCancelButton" onClick={this.props.onClose}>
              <FormattedMessage
                id="presentationUtil.saveModal.cancelButtonLabel"
  ...
  private renderViewDescription = () => {
    ...
    return (
      <EuiFormRow
        ...
        label={
          <FormattedMessage
            id="presentationUtil.saveModal.descriptionLabel"
  ...
  private renderConfirmButton = () => {
    ...
    let confirmLabel: string | React.ReactNode = i18n.translate(
      'presentationUtil.saveModal.saveButtonLabel',
      {
        defaultMessage: 'Save',
      }
    );
      ...
      <>
        <div ref={this.warning} tabIndex={-1}>
          <EuiCallOut
            title={
              <FormattedMessage
                id="presentationUtil.saveModal.duplicateTitleLabel"
          ...
          >
            <p>
              <FormattedMessage
                id="presentationUtil.saveModal.duplicateTitleDescription"
    ...
    return (
      <>
        ...
        <EuiSwitch
          ...
          label={
            <FormattedMessage
              id="presentationUtil.saveModal.saveAsNewLabel"

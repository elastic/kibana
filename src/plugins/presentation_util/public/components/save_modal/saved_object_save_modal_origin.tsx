...
export function SavedObjectSaveModalOrigin(props: OriginSaveModalProps) {
  ...
  const returnLabel = i18n.translate('presentationUtil.saveModalOrigin.returnToOriginLabel', {
    defaultMessage: 'Return',
  });
  const addLabel = i18n.translate('presentationUtil.saveModalOrigin.addToOriginLabel', {
    defaultMessage: 'Add',
  });
            ...
            <EuiSwitch
              ...
              label={
                props.returnToOriginSwitchLabel ?? (
                  <FormattedMessage
                    id="presentationUtil.saveModalOrigin.originAfterSavingSwitchLabel"
  ...
  const confirmButtonLabel = returnToOriginMode
    ? i18n.translate('presentationUtil.saveModalOrigin.saveAndReturnLabel', {

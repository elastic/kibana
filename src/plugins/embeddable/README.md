...
#### Comparitors
Comparitors allow a page to track embeddable changes. For example, Dashboard uses comparitors to display UI notification of unsaved changes, reset changes, and perserve unsaved changes to local storage.

...
export const EmbeddablePanelHeader = ({
  ...
  const { notificationComponents, badgeComponents } = useEmbeddablePanelBadges(embeddable);
  ...
  const titleElement = useEmbeddablePanelTitle(embeddable, universalActions.customizePanel);

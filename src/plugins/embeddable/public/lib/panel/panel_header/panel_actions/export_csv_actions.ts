...
import { ACTION_EXPORT_CSV } from '../../../triggers';
...
export class ExportCSVAction implements Action<ExportContext> {
  ...
  public readonly getDisplayName = (context: ExportContext): string =>
    i18n.translate('embeddableApi.panel.DownloadCreateDrilldownAction.displayName', {
        ...
        (memo, datatable, i) => {
          ...
          if (datatable) {
            ...
            const untitledFilename = i18n.translate(
              'embeddableApi.panel.downloadOptionsUnsavedFilename',
              {

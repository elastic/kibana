...
export const registerPutRuntimeFieldRoute = putRuntimeFieldRouteFactory(RUNTIME_FIELD_PATH);

export const registerPutRuntimeFieldRouteLegacy =
  putRuntimeFieldRouteFactory(RUNTIME_FIELD_PATH_LEGACY);

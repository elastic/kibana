...
//
// @public (undocumented)
export class Execution<ExtraContext extends Record<string, unknown> = Record<string, unknown>, Input = unknown, Output = unknown, InspectorAdapters = ExtraContext['inspectorAdapters'] extends object ? ExtraContext['inspectorAdapters'] : DefaultInspectorAdapters> {
...
export class ExpressionRenderHandler {
    ...
    // Warning: (ae-forgotten-export) The symbol "RenderError" needs to be exported by the entry point index.d.ts
    //
    // (undocumented)
...
//
// @public (undocumented)
class ExpressionsPublicPlugin implements Plugin_2<ExpressionsSetup, ExpressionsStart, ExpressionsSetupDeps, ExpressionsStartDeps> {
...
// Warning: (ae-missing-release-tag) "ExpressionsSetupDeps" is exported by the package, but it is missing a release tag (@alpha, @beta, @public, or @internal)
//
// @public (undocumented)
export interface ExpressionsSetupDeps {
    // Warning: (ae-forgotten-export) The symbol "BfetchPublicSetup" needs to be exported by the entry point index.d.ts
    //
    // (undocumented)
...
export interface ExpressionsStart extends ExpressionsServiceStart {
    ...
    // Warning: (ae-forgotten-export) The symbol "loader" needs to be exported by the entry point index.d.ts
    //
    // (undocumented)
...
// Warning: (ae-missing-release-tag) "ExpressionsStartDeps" is exported by the package, but it is missing a release tag (@alpha, @beta, @public, or @internal)
//
// @public (undocumented)
export interface ExpressionsStartDeps {
    // Warning: (ae-forgotten-export) The symbol "BfetchPublicStart" needs to be exported by the entry point index.d.ts
    //
    // (undocumented)
...
//
// @public (undocumented)
export function format(ast: ExpressionAstExpression | ExpressionAstArgument, type: 'expression' | 'argument'): string;
...
//
// @public (undocumented)
export function parse(expression: string, startRule: 'expression' | 'argument'): ExpressionAstExpression | ExpressionAstArgument;
...
//
// @public (undocumented)
export const ReactExpressionRenderer: ({ className, dataAttrs, padding, renderError, expression, onEvent, ...expressionLoaderOptions }: ReactExpressionRendererProps) => JSX.Element;

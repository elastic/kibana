...
const errorWithBodyRequest = { method: 'post', path: '/errorWithBody', body: {} };
const errorWithBodyResponse = { body: errorValue };

export const createUseRequestHelpers = () => {
  ...
  const setupUseRequest = (config) => {
    ...
    const TestComponent = ({ requestConfig }) => {

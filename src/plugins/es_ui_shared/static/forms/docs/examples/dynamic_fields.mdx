...
Dynamic fields are fields that the user can add or remove in your form. Those fields will end up in an array of _values_ or an array of _objects_.  To enable dynamic fields in your form you use <DocLink id="formLibCoreUseArray" text="the <UseArray /> component"/>.

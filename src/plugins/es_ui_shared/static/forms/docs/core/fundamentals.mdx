...
In Kibana we work with [the EUI component library](https://elastic.github.io/eui) and have created <DocLink id="formLibHelpersComponents" text="field components"/> that wrap EUI components. With these components, connection with the form lib is already done for you.  

## Main building blocks

The three required components to build a form are:

- <DocLink id="formLibCoreUseForm" text="useForm()"/> hook to declare a new form
- <DocLink id="formLibCoreFormComponent" text="<Form />"/> component that will wrap your form and create a context for it
- <DocLink id="formLibCoreUseField" text="<UseField />"/> component to declare a field

...
<!-- 
The elastic docs system does not support yet rendering mermaid in .mdx
I've asked the docs engineers on how to enable it. For now we will use the
Whimsical image.
-->

<img src="./form_lib_field_value_change.png" alt="Field value change sequence diagram" style="height: auto; width:100%;"/>
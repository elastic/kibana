      ...
      <EuiCallOut title={bannerTitle}>
        <FormattedMessage
          ...
          values={{
            ...
            disableLink: (
              <EuiLink
                data-test-subj="pluginsDisableUsageDataHereLink"
                href={`${basePath}${PATH_TO_ADVANCED_SETTINGS}`}
                onClick={onSeenBanner}
              >
                <FormattedMessage
        ...
        />
        <EuiSpacer size="s" />
        <EuiButton data-test-subj="pluginsDismissButton" size="s" onClick={onSeenBanner}>
          <FormattedMessage

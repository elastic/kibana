...
export const createNodeAgentInstructions = (apmServerUrl = '', secretToken = '') => [
  {
    title: i18n.translate('apm.tutorial.nodeClient.install.title', {
      defaultMessage: 'Install the APM agent',
    }),
    textPre: i18n.translate('apm.tutorial.nodeClient.install.textPre', {
  ...
  {
    title: i18n.translate('apm.tutorial.nodeClient.configure.title', {
      defaultMessage: 'Configure the agent',
    }),
    textPre: i18n.translate('apm.tutorial.nodeClient.configure.textPre', {
      defaultMessage:
...
This agent supports a vararity of frameworks but can also be used with your custom stack.',
    ...
    commands: `// ${i18n.translate(
      'apm.tutorial.nodeClient.configure.commands.addThisToTheFileTopComment',
      {
...
var apm = require('elastic-apm-node').start({curlyOpen}
  // ${i18n.translate('apm.tutorial.nodeClient.configure.commands.setRequiredServiceNameComment', {
    defaultMessage: 'Override service name from package.json',
  })}
  // ${i18n.translate('apm.tutorial.nodeClient.configure.commands.allowedCharactersComment', {
    defaultMessage: 'Allowed characters: a-z, A-Z, 0-9, -, _, and space',
  })}
  serviceName: '',

  // ${i18n.translate('apm.tutorial.nodeClient.configure.commands.useIfApmRequiresTokenComment', {
    defaultMessage: 'Use if APM Server requires a token',
  })}
  secretToken: '${secretToken}',

  // ${i18n.translate('apm.tutorial.nodeClient.configure.commands.setCustomApmServerUrlComment', {
    defaultMessage: 'Set custom APM Server URL (default: {defaultApmServerUrl})',
    values: { defaultApmServerUrl: 'http://localhost:8200' },
  })}
  serverUrl: '${apmServerUrl}'
{curlyClose})`.split('\n'),
    textPost: i18n.translate('apm.tutorial.nodeClient.configure.textPost', {
      defaultMessage:
...
export const createDjangoAgentInstructions = (apmServerUrl = '', secretToken = '') => [
  {
    title: i18n.translate('apm.tutorial.djangoClient.install.title', {
      defaultMessage: 'Install the APM agent',
    }),
    textPre: i18n.translate('apm.tutorial.djangoClient.install.textPre', {
      defaultMessage: 'Install the APM agent for Python as a dependency.',
    }),
    commands: ['$ pip install elastic-apm'],
  },
  {
    title: i18n.translate('apm.tutorial.djangoClient.configure.title', {
      defaultMessage: 'Configure the agent',
    }),
    textPre: i18n.translate('apm.tutorial.djangoClient.configure.textPre', {
      defaultMessage:
        'Agents are libraries that run inside of your application process. \
APM services are created programmatically based on the `SERVICE_NAME`.',
    }),
    commands: `# ${i18n.translate('apm.tutorial.djangoClient.configure.commands.addAgentComment', {
...
ELASTIC_APM = {curlyOpen}
  # ${i18n.translate('apm.tutorial.djangoClient.configure.commands.setRequiredServiceNameComment', {
    defaultMessage: 'Set required service name. Allowed characters:',
  })}
  # ${i18n.translate('apm.tutorial.djangoClient.configure.commands.allowedCharactersComment', {
    defaultMessage: 'a-z, A-Z, 0-9, -, _, and space',
  })}
  'SERVICE_NAME': '',

  # ${i18n.translate(
    'apm.tutorial.djangoClient.configure.commands.useIfApmServerRequiresTokenComment',
    {
      defaultMessage: 'Use if APM Server requires a token',
    }
  )}
  ...
  # ${i18n.translate('apm.tutorial.djangoClient.configure.commands.setCustomApmServerUrlComment', {
    defaultMessage: 'Set custom APM Server URL (default: {defaultApmServerUrl})',
    values: { defaultApmServerUrl: 'http://localhost:8200' },
  })}
...
# ${i18n.translate('apm.tutorial.djangoClient.configure.commands.addTracingMiddlewareComment', {
...
MIDDLEWARE = (
  ...
  #...
    ...
    textPost: i18n.translate('apm.tutorial.djangoClient.configure.textPost', {
...
export const createFlaskAgentInstructions = (apmServerUrl = '', secretToken = '') => [
  {
    title: i18n.translate('apm.tutorial.flaskClient.install.title', {
      defaultMessage: 'Install the APM agent',
    }),
    textPre: i18n.translate('apm.tutorial.flaskClient.install.textPre', {
      defaultMessage: 'Install the APM agent for Python as a dependency.',
    }),
    commands: ['$ pip install elastic-apm[flask]'],
  },
  {
    title: i18n.translate('apm.tutorial.flaskClient.configure.title', {
      defaultMessage: 'Configure the agent',
    }),
    textPre: i18n.translate('apm.tutorial.flaskClient.configure.textPre', {
      defaultMessage:
        'Agents are libraries that run inside of your application process. \
APM services are created programmatically based on the `SERVICE_NAME`.',
    }),
    commands: `# ${i18n.translate(
      'apm.tutorial.flaskClient.configure.commands.initializeUsingEnvironmentVariablesComment',
      {
...
# ${i18n.translate('apm.tutorial.flaskClient.configure.commands.configureElasticApmComment', {
      defaultMessage: "or configure to use ELASTIC_APM in your application's settings",
    })}
from elasticapm.contrib.flask import ElasticAPM
app.config['ELASTIC_APM'] = {curlyOpen}
  # ${i18n.translate('apm.tutorial.flaskClient.configure.commands.setRequiredServiceNameComment', {
    defaultMessage: 'Set required service name. Allowed characters:',
  })}
  # ${i18n.translate('apm.tutorial.flaskClient.configure.commands.allowedCharactersComment', {
    defaultMessage: 'a-z, A-Z, 0-9, -, _, and space',
  })}
  'SERVICE_NAME': '',

  # ${i18n.translate(
    'apm.tutorial.flaskClient.configure.commands.useIfApmServerRequiresTokenComment',
    {
      defaultMessage: 'Use if APM Server requires a token',
    }
  )}
  ...
  # ${i18n.translate('apm.tutorial.flaskClient.configure.commands.setCustomApmServerUrlComment', {
    defaultMessage: 'Set custom APM Server URL (default: {defaultApmServerUrl})',
    values: { defaultApmServerUrl: 'http://localhost:8200' },
  })}
  'SERVER_URL': '${apmServerUrl}',
...
apm = ElasticAPM(app)`.split('\n'),
    textPost: i18n.translate('apm.tutorial.flaskClient.configure.textPost', {
      defaultMessage: 'See the [documentation]({documentationLink}) for advanced usage.',
      values: {
        documentationLink:
...
export const createRailsAgentInstructions = (apmServerUrl = '', secretToken = '') => [
  {
    title: i18n.translate('apm.tutorial.railsClient.install.title', {
      defaultMessage: 'Install the APM agent',
    }),
    textPre: i18n.translate('apm.tutorial.railsClient.install.textPre', {
      defaultMessage: 'Add the agent to your Gemfile.',
    }),
    commands: [`gem 'elastic-apm'`],
  },
  {
    title: i18n.translate('apm.tutorial.railsClient.configure.title', {
      defaultMessage: 'Configure the agent',
    }),
    textPre: i18n.translate('apm.tutorial.railsClient.configure.textPre', {
      defaultMessage:
...
# server_url: '${apmServerUrl || 'http://localhost:8200'}'`.split('\n'),
    textPost: i18n.translate('apm.tutorial.railsClient.configure.textPost', {
      defaultMessage:
...
export const createRackAgentInstructions = (apmServerUrl = '', secretToken = '') => [
  {
    title: i18n.translate('apm.tutorial.rackClient.install.title', {
      defaultMessage: 'Install the APM agent',
    }),
    textPre: i18n.translate('apm.tutorial.rackClient.install.textPre', {
      defaultMessage: 'Add the agent to your Gemfile.',
    }),
    commands: [`gem 'elastic-apm'`],
  },
  {
    title: i18n.translate('apm.tutorial.rackClient.configure.title', {
      defaultMessage: 'Configure the agent',
    }),
    textPre: i18n.translate('apm.tutorial.rackClient.configure.textPre', {
      defaultMessage:
  ...
  ElasticAPM.start(
    app: MySinatraApp, # ${i18n.translate(
      'apm.tutorial.rackClient.configure.commands.requiredComment',
      {
        defaultMessage: 'required',
      }
    )}
    config_file: '' # ${i18n.translate(
      'apm.tutorial.rackClient.configure.commands.optionalComment',
      {
  ...
  {
    title: i18n.translate('apm.tutorial.rackClient.createConfig.title', {
      defaultMessage: 'Create config file',
    }),
    textPre: i18n.translate('apm.tutorial.rackClient.createConfig.textPre', {
      defaultMessage: 'Create a config file {configFile}:',
      values: { configFile: '`config/elastic_apm.yml`' },
    }),
    commands: `# config/elastic_apm.yml:

# ${i18n.translate('apm.tutorial.rackClient.createConfig.commands.setServiceNameComment', {
      defaultMessage: 'Set service name - allowed characters: a-z, A-Z, 0-9, -, _ and space',
    })}
# ${i18n.translate(
      'apm.tutorial.rackClient.createConfig.commands.defaultsToTheNameOfRackAppClassComment',
      {
...
# ${i18n.translate(
      'apm.tutorial.rackClient.createConfig.commands.useIfApmServerRequiresTokenComment',
      {
        defaultMessage: 'Use if APM Server requires a token',
      }
    )}
...
# ${i18n.translate('apm.tutorial.rackClient.createConfig.commands.setCustomApmServerComment', {
      defaultMessage: 'Set custom APM Server URL (default: {defaultServerUrl})',
      values: { defaultServerUrl: 'http://localhost:8200' },
    })}
# server_url: '${apmServerUrl || 'http://localhost:8200'}'`.split('\n'),
    textPost: i18n.translate('apm.tutorial.rackClient.createConfig.textPost', {
      defaultMessage:
        'See the [documentation]({documentationLink}) for configuration options and advanced usage.\n\n',
      values: {
        documentationLink: '{config.docs.base_url}guide/en/apm/agent/ruby/current/index.html',
...
export const createJsAgentInstructions = (apmServerUrl = '') => [
  {
    title: i18n.translate('apm.tutorial.jsClient.enableRealUserMonitoring.title', {
      defaultMessage: 'Enable Real User Monitoring support in APM Server',
    }),
    textPre: i18n.translate('apm.tutorial.jsClient.enableRealUserMonitoring.textPre', {
      defaultMessage:
...
for details on how to enable RUM support.',
  ...
  {
    title: i18n.translate('apm.tutorial.jsClient.installDependency.title', {
      defaultMessage: 'Set up the Agent as a dependency',
    }),
    textPre: i18n.translate('apm.tutorial.jsClient.installDependency.textPre', {
      defaultMessage:
...
var apm = initApm({curlyOpen}
  ...
  // ${i18n.translate(
    'apm.tutorial.jsClient.installDependency.commands.setRequiredServiceNameComment',
    {
      defaultMessage:
  ...
  // ${i18n.translate(
    'apm.tutorial.jsClient.installDependency.commands.setCustomApmServerUrlComment',
    {
      defaultMessage: 'Set custom APM Server URL (default: {defaultApmServerUrl})',
      values: { defaultApmServerUrl: 'http://localhost:8200' },
    }
  ...
  // ${i18n.translate('apm.tutorial.jsClient.installDependency.commands.setServiceVersionComment', {
    defaultMessage: 'Set service version (required for source map feature)',
  })}
  serviceVersion: ''
{curlyClose})`.split('\n'),
    textPost: i18n.translate('apm.tutorial.jsClient.installDependency.textPost', {
      defaultMessage:
...
See the [integration documentation]({docLink}) for more information.',
  ...
  {
    title: i18n.translate('apm.tutorial.jsClient.scriptTags.title', {
      defaultMessage: 'Set up the Agent with Script Tags',
    }),
    textPre: i18n.translate('apm.tutorial.jsClient.scriptTags.textPre', {
      defaultMessage:
...
export const createGoAgentInstructions = (apmServerUrl = '', secretToken = '') => [
  {
    title: i18n.translate('apm.tutorial.goClient.install.title', {
      defaultMessage: 'Install the APM agent',
    }),
    textPre: i18n.translate('apm.tutorial.goClient.install.textPre', {
      defaultMessage: 'Install the APM agent packages for Go.',
    }),
    commands: ['go get go.elastic.co/apm'],
  },
  {
    title: i18n.translate('apm.tutorial.goClient.configure.title', {
      defaultMessage: 'Configure the agent',
    }),
    textPre: i18n.translate('apm.tutorial.goClient.configure.textPre', {
      defaultMessage:
        'Agents are libraries that run inside of your application process. \
...
file name, or the `ELASTIC_APM_SERVICE_NAME` environment variable.',
    ...
    commands: `# ${i18n.translate(
      'apm.tutorial.goClient.configure.commands.initializeUsingEnvironmentVariablesComment',
      {
        defaultMessage: 'Initialize using environment variables:',
      }
    )}

# ${i18n.translate('apm.tutorial.goClient.configure.commands.setServiceNameComment', {
      defaultMessage: 'Set the service name. Allowed characters: # a-z, A-Z, 0-9, -, _, and space.',
    })}
# ${i18n.translate('apm.tutorial.goClient.configure.commands.usedExecutableNameComment', {
      defaultMessage:
        'If ELASTIC_APM_SERVICE_NAME is not specified, the executable name will be used.',
    })}
export ELASTIC_APM_SERVICE_NAME=

# ${i18n.translate('apm.tutorial.goClient.configure.commands.setCustomApmServerUrlComment', {
      defaultMessage: 'Set custom APM Server URL (default: {defaultApmServerUrl})',
      values: { defaultApmServerUrl: 'http://localhost:8200' },
    })}
export ELASTIC_APM_SERVER_URL=${apmServerUrl}

# ${i18n.translate('apm.tutorial.goClient.configure.commands.useIfApmRequiresTokenComment', {
      defaultMessage: 'Use if APM Server requires a token',
    })}
export ELASTIC_APM_SECRET_TOKEN=${secretToken}
`.split('\n'),
    textPost: i18n.translate('apm.tutorial.goClient.configure.textPost', {
  ...
  {
    title: i18n.translate('apm.tutorial.goClient.instrument.title', {
      defaultMessage: 'Instrument your application',
    }),
    textPre: i18n.translate('apm.tutorial.goClient.instrument.textPre', {
      defaultMessage:
...
{curlyClose}
`.split('\n'),
    textPost: i18n.translate('apm.tutorial.goClient.instrument.textPost', {
      defaultMessage:
...
export const createJavaAgentInstructions = (apmServerUrl = '', secretToken = '') => [
  {
    title: i18n.translate('apm.tutorial.javaClient.download.title', {
      defaultMessage: 'Download the APM agent',
    }),
    textPre: i18n.translate('apm.tutorial.javaClient.download.textPre', {
      defaultMessage:
...
Do **not** add the agent as a dependency to your application.',
  ...
  {
    title: i18n.translate('apm.tutorial.javaClient.startApplication.title', {
      defaultMessage: 'Start your application with the javaagent flag',
    }),
    textPre: i18n.translate('apm.tutorial.javaClient.startApplication.textPre', {
      defaultMessage:
...
* Set the base package of your application',
    ...
    textPost: i18n.translate('apm.tutorial.javaClient.startApplication.textPost', {
      defaultMessage:
...
export const createDotNetAgentInstructions = (apmServerUrl = '', secretToken = '') => [
  {
    title: i18n.translate('apm.tutorial.dotNetClient.download.title', {
      defaultMessage: 'Download the APM agent',
    }),
    textPre: i18n.translate('apm.tutorial.dotNetClient.download.textPre', {
      defaultMessage:
  ...
  {
    title: i18n.translate('apm.tutorial.dotNetClient.configureApplication.title', {
      defaultMessage: 'Add the agent to the application',
    }),
    textPre: i18n.translate('apm.tutorial.dotNetClient.configureApplication.textPre', {
      defaultMessage:
...
{curlyOpen}
  ...
  //…rest of the class
{curlyClose}`.split('\n'),
    textPost: i18n.translate('apm.tutorial.dotNetClient.configureApplication.textPost', {
      defaultMessage:
  ...
  {
    title: i18n.translate('apm.tutorial.dotNetClient.configureAgent.title', {
  ...
  {curlyClose}
{curlyClose}`.split('\n'),
    textPost: i18n.translate('apm.tutorial.dotNetClient.configureAgent.textPost', {
      defaultMessage:

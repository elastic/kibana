...
export const AnnotationList = ({
  ...
  const addAnnotationText = i18n.translate('eventAnnotationApplication.annotationList.add', {
      ...
      <ReorderProvider>
        {annotations.map((annotation, index) => (
          ...
          >
            ...
            >
              <DimensionButton
                groupLabel={i18n.translate('eventAnnotationApplication.groupEditor.addAnnotation', {

...
import { LayerTypes, YAxisModes } from '../../common/constants';
import type { DataLayerConfigResult, XYLayerConfig, YConfig } from '../../common';
import type { XYState, AccessorConfig, DatasourcePublicAPI, FramePublicAPI } from '../types';
import { groupAxesByType } from './axes_configuration';
import { isHorizontalChart, isPercentageSeries, isStackedChart } from './state';
import { checkScaleOperation, getAxisName, getDataLayers, isNumericMetric } from './visualization';
import { BarReferenceLineIcon } from '../icons';
...
export function getStaticValue(
  ...
  layerHasNumberHistogram: (layer: DataLayerConfigResult) => boolean
) {

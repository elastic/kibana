...
import { ExpressionTagcloudFunction, Origin, Position } from '../types';
...
const strings = {
  ...
  args: {
    image: i18n.translate('expressionTagcloud.functions.tagcloud.args.imageHelpText', {
      defaultMessage:
        'The image to reveal. Provide an image asset as a {BASE64} data {URL}, ' +
        'or pass in a sub-expression.',
    }),
    emptyImage: i18n.translate('expressionTagcloud.functions.tagcloud.args.emptyImageHelpText', {
      defaultMessage:
        'An optional background image to reveal over. ' +
        'Provide an image asset as a `{BASE64}` data {URL}, or pass in a sub-expression.',
    }),
    origin: i18n.translate('expressionTagcloud.functions.tagcloud.args.originHelpText', {

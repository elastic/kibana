        ...
        link: function(scope, elem) {
          ...
          function build_results() {
            ...
            _.each(scope.results.facets.terms.terms, function(v) {
              var slice = filter_having_results(scope,v,k);
          ...
          function filter_having_results(scope, v,k) {
            var slice;
            var havingfield = "";
            var evaluate = "";
            var andCondition = "";

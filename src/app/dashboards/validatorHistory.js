...
// Set a title
dashboard.title = 'ValidatorHistory';
// Don't fail to default
dashboard.failover = false;
dashboard.index = {
  default: 'validator_history_logs-*',
  interval: 'none',
...
dashboard.services.filter = {
  list: {
    0: {
      "type": "terms",
      "field": "employeeID",
      "value": ARGS.employeeID,
      "mandate": "must",
      "active": !_.isUndefined(ARGS.employeeID),
      "alias": "",
      "id": 0
    },
    1: {
...
if(!_.isUndefined(ARGS.webapp)) {
  dashboard.rows[0].panels.title = "Documents with chosen employeeID:"+ARGS.clientID;
}

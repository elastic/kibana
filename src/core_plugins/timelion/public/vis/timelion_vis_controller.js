define(function (require) {
  ...
  let module = require('ui/modules').get('kibana/timelion_vis', ['kibana']);
  module.controller('TimelionVisController', function (
    ...
    let dashboardContext = Private(require('plugins/timelion/services/dashboard_context'));
    ...
    $scope.search = function run() {
      let expression = $scope.vis.params.expression;

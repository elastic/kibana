...
export const Header = () => (
  <div>
    <EuiTitle size="s">
      <h3>
        <FormattedMessage id="kbn.management.editIndexPattern.source.header" defaultMessage="Source filters"/>
      </h3>
    </EuiTitle>
    <EuiText>
      <p>
        <FormattedMessage
          id="kbn.management.editIndexPattern.source.label"
      ...
      <p>
        <FormattedMessage
          id="kbn.management.editIndexPattern.source.note.label"

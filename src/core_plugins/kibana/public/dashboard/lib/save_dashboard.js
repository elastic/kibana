 ...
 * dashboard.
 */
export function saveDashboard(toJson, timeFilter, intervalFilter, dashboardStateManager) {
  ...
  updateSavedDashboard(savedDashboard, appState, timeFilter, intervalFilter, toJson);

...
export default function (scenarioManager, request) {
  describe('POST ingest', function postIngest() {
    ...
    it('should return 204 when an ingest config is successfully created', function createIngestConfig() {
      return request.post('/kibana/ingest')
        .send(createTestData())
        .expect(204);
    });

    it('should create an index template if a fields array is included', function createTemplate() {
      return request.post('/kibana/ingest')
        .send(createTestData())
        .expect(204)
        .then(function () {
    ...
    it('should successfully create new indices based on the template', function newIndices() {
      return request.post('/kibana/ingest')
        .send(createTestData())
        .expect(204)
        .then(function () {
    ...
    it('should provide defaults for field properties', function createTemplate() {
      return request.post('/kibana/ingest')
        .send(createTestData())
        .expect(204)
        .then(function () {
    ...
    it('should include meta fields specified in uiSettings in the index pattern', function metaFields() {
      return request.post('/kibana/ingest')
        .send(createTestData())
        .expect(204)
        .then(function () {
    ...
    it('should create index template with _default_ mappings based on the info in the ingest config',
    ...
    it('should create a pipeline if one is included in the request', function () {
      return request.post('/kibana/ingest')
        .send(createTestData())
        .expect(204)
        .then(function () {
    ...
    it('pipeline should be optional', function optionalPipeline() {
    ...
    it('should return 409 conflict when a pattern with the given ID already exists', function patternConflict() {
      return request.post('/kibana/ingest')
        .send(createTestData())
        .expect(204)
        .then(function () {
    ...
    it('should return 409 conflict when an index template with the given ID already exists', function templateConflict() {
    ...
    it('should return 409 conflict when the pattern matches existing indices',
    ...
    it('should enforce snake_case in the request body', function () {
      const ingestConfig = createTestData();

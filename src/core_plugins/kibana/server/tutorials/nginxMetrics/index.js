...
export function nginxMetricsSpecProvider() {
  return {
    ...
    shortDescription: 'This module fetches internal metrics from the Nginx HTTP server.',
    longDescription: 'This module fetches internal metrics from the Nginx HTTP server.' +
                     ' You can read more about the Metricbeat Nginx module in the [documentation].' +
                     ' The module scrapes the server status data from the web page generated by the' +
                     ' [ngx_http_stub_status] module, which needs to be enabled in you Nginx installation',
    //iconPath: '', TODO
        ...
        instructionVariants: [
          {
            ...
            instructions: [
              ...
              },
              {
                ...
                textPre: 'In the Metricbeat install directory, run the following commands to enable the Nginx module.',
                commands: [
          ...
          },
          {
            ...
            instructions: [
              ...
              {
                title: 'Enable and configure the Nginx module',
                textPre: 'In the `C:\\Program Files\\Metricbeat` folder, run the following commands to enable the Nginx module.',
                commands: [

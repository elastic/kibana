...
export const COMMON_NETFLOW_INSTRUCTIONS = {
  CONFIG: {
    ON_PREM: {
      OSX: [
        {
          ...
          textPre: i18n.translate('kbn.server.tutorials.netflow.common.config.onPrem.osxTextPre', {
      ...
      WINDOWS: [
        {
          title: i18n.translate('kbn.server.tutorials.netflow.common.config.onPrem.windowsTitle', {
            defaultMessage: 'Edit the configuration',
          }),

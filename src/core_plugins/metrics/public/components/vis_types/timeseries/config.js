...
function TimeseriesConfig(props) {
  ...
  return (
    <Layout.Grid isContainer={true} gutter={false} style={{ padding: '1em' }}>
      <Layout.Grid>
        <Layout.Cell size="1/2">
      ...
      <Layout.Grid>
        ...
        />
        <Form.Select label="Stacked" onChange={onChange} clearable={false} options={stackedOptions} name="stacked" value={model.stacked} />
      ...
      <Layout.Grid>
        <Form.YesNo label="Override Index Pattern" value={model.override_index_pattern} name="override_index_pattern" onChange={onChange} />
        <IndexPattern
          {...props}
          prefix="series_"

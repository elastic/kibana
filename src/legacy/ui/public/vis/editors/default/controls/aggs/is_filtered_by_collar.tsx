...
function IsFilteredByCollarParamEditor(props: AggParamEditorProps<boolean>) {
  return (
    <SwitchParamEditor
      displayLabel={i18n.translate('data.aggTypes.onlyRequestDataAroundMapExtentLabel', {
        defaultMessage: 'Only request data around map extent',
      })}
      displayToolTip={i18n.translate('data.aggTypes.onlyRequestDataAroundMapExtentTooltip', {
        defaultMessage:

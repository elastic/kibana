...
function MissingBucketParamEditor(props: AggParamEditorProps<boolean>) {
  ...
  return (
    <SwitchParamEditor
      ...
      displayLabel={i18n.translate('data.aggTypes.otherBucket.showMissingValuesLabel', {
        defaultMessage: 'Show missing values',
      })}
      displayToolTip={i18n.translate('data.aggTypes.otherBucket.showMissingValuesTooltip', {
        defaultMessage:

...
const label = (
  <>
    <FormattedMessage
      id="data.aggTypes.numberInterval.minimumIntervalLabel"
    ...
    <EuiIconTip
      ...
      content={
        <FormattedMessage
          id="data.aggTypes.numberInterval.minimumIntervalTooltip"
  ...
  return (
    ...
    >
      <EuiFieldNumber
        ...
        onBlur={setTouched}
        fullWidth={true}
        placeholder={i18n.translate('data.aggTypes.numberInterval.selectIntervalPlaceholder', {

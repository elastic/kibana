...
import { isType } from '../../../../../../../core_plugins/data/public/np_ready/agg_types/buckets/migrate_include_exclude_format';
...
function HasExtendedBoundsParamEditor(props: AggParamEditorProps<boolean>) {
  ...
  return (
    <SwitchParamEditor
      displayLabel={i18n.translate('data.aggTypes.extendedBoundsLabel', {
        defaultMessage: 'Extend bounds',
      })}
      displayToolTip={i18n.translate('data.aggTypes.extendedBoundsTooltip', {
        defaultMessage:

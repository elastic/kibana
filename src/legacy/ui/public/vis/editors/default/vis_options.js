...
/** @internal */
export const createVisOptionsDirective = ($compile) => {
  return {
    restrict: 'E',
    require: '?^ngModel',
    scope: {
...
uiModules
  .get('app/visualize')
  .directive('visOptionsReactWrapper', reactDirective => reactDirective(wrapInI18nContext(VisOptionsReactWrapper), visOptionsDeps))

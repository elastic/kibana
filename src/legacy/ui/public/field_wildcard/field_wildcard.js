...
export function fieldWildcardMatcher(metaFields, globs = []) {
...
// Note that this will return an essentially noop function if globs is undefined.
export function fieldWildcardFilter(metaFields, globs = []) {
  const matcher = fieldWildcardMatcher(metaFields, globs);

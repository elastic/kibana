...
describe('buildHierarchicalData convertTable', () => {
  ...
  describe('oneHistogramBucket', () => {
    ...
    beforeEach(async () => {
      const tabifyResponse = {
        columns: [{ id: 'col-0-agg_2', name: 'bytes' }, { id: 'col-1-1', name: 'Count' }],
        rows: [
  ...
  describe('oneRangeBucket', () => {
    ...
    beforeEach(async () => {
      const tabifyResponse = {
        columns: [{ id: 'col-0-agg_2', name: 'bytes ranges' }, { id: 'col-1-1', name: 'Count' }],
        rows: [
  ...
  describe('oneFilterBucket', () => {
    ...
    beforeEach(async () => {
      const tabifyResponse = {
        columns: [{ id: 'col-0-agg_2', name: 'filters' }, { id: 'col-1-1', name: 'Count' }],
        rows: [

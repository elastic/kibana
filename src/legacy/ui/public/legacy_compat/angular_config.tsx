...
const getEsUrl = (newPlatform: LegacyCoreStart) => {
...
const setupLocationProvider = (newPlatform: LegacyCoreStart) => (
 ...
 * @return {undefined}
 */
const capture$httpLoadingCount = (newPlatform: LegacyCoreStart) => (
 ...
 */
const $setupBreadcrumbsAutoClear = (newPlatform: LegacyCoreStart) => (
  $rootScope: IRootScopeService,
  $injector: any
) => {
 ...
 */
const $setupBadgeAutoClear = (newPlatform: LegacyCoreStart) => (
  $rootScope: IRootScopeService,
  $injector: any
) => {
  // A flag used to determine if we should automatically
 ...
 * helpExtension
 */
const $setupHelpExtensionAutoClear = (newPlatform: LegacyCoreStart) => (
  $rootScope: IRootScopeService,
  $injector: any
) => {
  /**
...
const $setupUrlOverflowHandling = (newPlatform: LegacyCoreStart) => (

    ...
    const columns = [
      ...
      },
      {
        actions: [
          {
            name: intl.formatMessage({
              id: 'common.ui.fieldEditor.staticLookup.deleteAria',
              defaultMessage: 'Delete',
            }),
            description: intl.formatMessage({
              id: 'common.ui.fieldEditor.staticLookup.deleteTitle',
        ...
        >
          <EuiFieldText
            ...
            placeholder={intl.formatMessage({
              id: 'common.ui.fieldEditor.staticLookup.leaveBlankPlaceholder',

...
describe('getDefaultFormat', () => {
  it('should create default format', () => {
    const DefaultFormat = getDefaultFormat(DefaultNumberFormat);
    const defaultFormatObject = new DefaultFormat(null, getConfig);
    const formatObject = new DefaultNumberFormat(null, getConfig);

    expect(DefaultFormat.id).toEqual('');
    expect(DefaultFormat.resolvedTitle).toEqual(DefaultNumberFormat.title);

    ...
    describe('interval', function() {
      ...
      describe('interval scaling', () => {
        ...
        it('will respect the histogram:maxBars setting', () => {
          ...
          const output = paramWriter.write({ interval: 5 }, aggConfig =>
            aggConfig.setAutoBounds({ min: 0, max: 10000 })
          );
        ...
        it('will round to intervalBase after scaling histogram:maxBars', () => {
          ...
          const output = paramWriter.write({ interval: 5, intervalBase: 6 }, aggConfig =>
            aggConfig.setAutoBounds({ min: 0, max: 1000 })
          );

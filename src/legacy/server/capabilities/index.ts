...
export function capabilitiesMixin(knbServer: KbnServer, server: Server) {
  const providers: CapabilitiesProvider[] = [];

  server.decorate('server', 'registerCapabilitiesProvider', (provider: CapabilitiesProvider) => {

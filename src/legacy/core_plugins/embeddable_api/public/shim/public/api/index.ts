...
import { EmbeddableApiPure, EmbeddableDependencies, EmbeddableApi, EmbeddableDependenciesInternal, Embeddables } from './types';
...
export const createEmbeddables = (deps: EmbeddableDependencies): Embeddables => {
  ...
  const addDependencies: Embeddables['addDependencies'] = (deps) => {
    Object.assign(depsInternal, deps);
  };
  return {
    api,
    addDependencies,

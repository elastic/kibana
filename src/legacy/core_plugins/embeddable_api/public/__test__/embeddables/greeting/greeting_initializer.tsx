...
export interface GreetingInitializerProps {
...
export class GreetingInitializer extends Component<GreetingInitializerProps, State> {
  constructor(props: GreetingInitializerProps) {
    super(props);
    this.state = {};
  }

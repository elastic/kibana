...
import { GreetingEmbeddableOutput } from '../__test__/embeddables/greeting';
...
test('Updates when hidePanelTitles is toggled', async () => {
  ...
  let title = findTestSubject(component, `dashboardPanelHeading-HelloRobStark`);
  ...
  title = findTestSubject(component, `dashboardPanelHeading-HelloRobStark`);

...
import { getSerializedFieldFormat } from './field_format_utils';
import { AggConfig, setBounds, isDateHistogramBucketAggConfig } from '../../../legacy_imports';
...
export const getSchemas = (vis: Vis, timeRange?: any): Schemas => {
  const createSchemaConfig = (accessor: number, agg: AggConfig): SchemaConfig => {
    ...
    const format = getSerializedFieldFormat(
      hasSubAgg

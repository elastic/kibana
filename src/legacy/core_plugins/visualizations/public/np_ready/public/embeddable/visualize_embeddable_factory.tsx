...
export const createVisualizeEmbeddableFactory = (): EmbeddableFactoryDefinition<
  VisualizeInput,
  VisualizeOutput | EmbeddableOutput,
  VisualizeEmbeddable | DisabledLabEmbeddable,
  VisualizationAttributes
> => {
  const isEditable = async () => getCapabilities().visualize.save as boolean;
  const createFromObject = async (
  ...
  return {
    ...
    createFromSavedObject: async (
      ...
      try {
        ...
        return createFromObject(savedObject, input, parent);
      } catch (e) {
        console.error(e); // eslint-disable-line no-console
        return new ErrorEmbeddable(e, input, parent);
      }

...
import { DashboardPanelState, GridData, PanelStateMap } from '../types';
...
class DashboardGridUi extends React.Component<DashboardGridProps, State> {
  ...
  public componentDidMount() {
    ...
    this.subscription = this.props.container.getInput$().subscribe(changes => {
  ...
  public renderDOM() {
    const { maximizedPanelId } = this.props;
    const { focusedPanelIndex, panels } = this.state;
  ...
  public render() {
    ...
    const { maximizedPanelId, useMargins } = this.props;

...
export interface DashboardInheritedInput {
  filters: Filter[];
  query: Query;
  timeRange: TimeRange;
  refreshConfig?: RefreshConfig;
...
> {
  ...
  protected getInheritedInput(id: string): DashboardInheritedInput {
    ...
    return {
      ...
      refreshConfig: refreshConfig ? { ...refreshConfig } : undefined,
      viewMode,
      id,
    };
  }

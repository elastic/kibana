...
describe('NumberFormat', function () {
  ...
  it('time', ()=> {
    const formatter = new NumberFormat({ pattern: '00:00:00' }, getConfig);
    expect(formatter.convert('10000')).to.be('2:46:40');
    expect(formatter.convert('1')).to.be('0:00:01');
    expect(formatter.convert('-1')).to.be('-00:00:01');
  });

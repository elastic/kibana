...
export function savedVisFactory({ app, VisProvider, updateOldState, SavedObjectProvider, createLegacyClass }) {
  app.factory('SavedVis', function (config, $injector, Promise, savedSearches, Private, i18n) {

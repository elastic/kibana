...
export interface AddPanelPopoverProps {
  addExistingAction: NavAction;
  addNewAction: NavAction;
}

export function AddPanelPopover({ addExistingAction, addNewAction }: AddPanelPopoverProps) {
  return (
    <EuiContextMenuPanel
      items={[

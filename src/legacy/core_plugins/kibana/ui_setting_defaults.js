...
`{
  ...
  "value": 0
    ...
    'dashboard:defaultDarkTheme': {
      name: _toi18n('Dark theme', 'dashboardDarkThemeTitle'),
      value: false,
      description: _toi18n('New dashboards use dark theme by default', 'dashboardDarkThemeText'),
      category: ['dashboard'],
    },
    ...
    'filterEditor:suggestValues': {
      name: _toi18n('Filter editor suggest values', 'suggestFilterValuesTitle'),
      value: true,

...
import { type ApiDeclaration, type ApiStats, type PluginMetaInfo } from './types';
...
import { countEslintDisableLines, type EslintDisableCounts } from './count_eslint_disable';

...
var findTestSubject = function findTestSubject(mountedComponent, testSubjectSelector) {
  var testSubject = mountedComponent.find("[data-test-subj=\"".concat(testSubjectSelector, "\"]")); // restore enzyme 2 default find behavior of only returning ReactWrappers around DOM element

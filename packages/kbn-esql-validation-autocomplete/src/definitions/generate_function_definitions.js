...
const showFunctionsOutput = {
  ...
  values: [
    ...
    [
      ...
      ['The string from which to return a substring.', 'The number of characters to return.'],
      'keyword',
    ...
    [
      ...
      ['field', 'start', 'end'],
      [
        'boolean|cartesian_point|cartesian_shape|date|double|geo_point|geo_shape|integer|ip|keyword|long|text|version',
        'integer',
        'integer',
      ],
      ['A multivalued field', 'start index', 'end index (included)'],
      'boolean|cartesian_point|cartesian_shape|date|double|geo_point|geo_shape|integer|ip|keyword|long|text|version',
    ...
    [
      ...
      ['field', 'order'],
      ['boolean|date|double|integer|ip|keyword|long|text|version', 'keyword'],
      ['A multivalued field', 'sort order'],
      'boolean|date|double|integer|ip|keyword|long|text|version',
    ...
    [
      ...
      ['string1', 'string2', 'delim'],
      ['keyword|text', 'keyword|text', 'keyword|text'],
      ['A multivalued field', 'A multivalued field', 'delimiter'],
      'keyword',
    ...
    [
      'sin',
      'double sin(number:double|integer|long|unsigned_long)',
      'number',
      'double|integer|long|unsigned_long',
      'An angle, in radians',
      'double',
    ...
    [
      ...
      ['geomA', 'geomB'],
      [
        'geo_point|cartesian_point|geo_shape|cartesian_shape',
        'geo_point|cartesian_point|geo_shape|cartesian_shape',
      ],
      [
    ...
    [
      'tan',
      'double tan(number:double|integer|long|unsigned_long)',
      'number',
      'double|integer|long|unsigned_long',
      'An angle, in radians',
      'double',

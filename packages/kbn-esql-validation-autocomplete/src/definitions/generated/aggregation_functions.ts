...
// Do not edit this manually... generated by scripts/generate_function_definitions.ts
    ...
    type: 'agg',
    name: 'avg',
    description: i18n.translate('kbn-esql-validation-autocomplete.esql.definitions.avg', { defaultMessage: "The average of a numeric field." }),
    alias: undefined,
    signatures: [
  {
    "params": [
...
// Do not edit this manually... generated by scripts/generate_function_definitions.ts
    ...
    type: 'agg',
    name: 'count',
    description: i18n.translate('kbn-esql-validation-autocomplete.esql.definitions.count', { defaultMessage: "Returns the total number (count) of input values." }),
    alias: undefined,
    signatures: [
  {
    "params": [
...
// Do not edit this manually... generated by scripts/generate_function_definitions.ts
    ...
    type: 'agg',
    name: 'count_distinct',
    description: i18n.translate('kbn-esql-validation-autocomplete.esql.definitions.count_distinct', { defaultMessage: "Returns the approximate number of distinct values." }),
    alias: undefined,
    signatures: [
  {
    "params": [
...
// Do not edit this manually... generated by scripts/generate_function_definitions.ts
    ...
    type: 'agg',
    name: 'max',
    description: i18n.translate('kbn-esql-validation-autocomplete.esql.definitions.max', { defaultMessage: "The maximum value of a field." }),
    alias: undefined,
    signatures: [
  {
    "params": [
...
// Do not edit this manually... generated by scripts/generate_function_definitions.ts
    ...
    type: 'agg',
    name: 'median',
    description: i18n.translate('kbn-esql-validation-autocomplete.esql.definitions.median', { defaultMessage: "The value that is greater than half of all values and less than half of all values, also known as the 50% `PERCENTILE`." }),
    alias: undefined,
    signatures: [
  {
    "params": [
...
// Do not edit this manually... generated by scripts/generate_function_definitions.ts
    ...
    type: 'agg',
    name: 'min',
    description: i18n.translate('kbn-esql-validation-autocomplete.esql.definitions.min', { defaultMessage: "The minimum value of a field." }),
    alias: undefined,
    signatures: [
  {
    "params": [
...
// Do not edit this manually... generated by scripts/generate_function_definitions.ts
    ...
    description: i18n.translate('kbn-esql-validation-autocomplete.esql.definitions.st_centroid_agg', { defaultMessage: "Calculate the spatial centroid over a field with spatial point geometry type." }),
    alias: undefined,
    signatures: [
  {
    "params": [
...
// Do not edit this manually... generated by scripts/generate_function_definitions.ts
    ...
    type: 'agg',
    name: 'sum',
    description: i18n.translate('kbn-esql-validation-autocomplete.esql.definitions.sum', { defaultMessage: "The sum of a numeric expression." }),
    alias: undefined,
    signatures: [
  {
    "params": [
...
// Do not edit this manually... generated by scripts/generate_function_definitions.ts
    ...
    type: 'agg',
    name: 'top',
    description: i18n.translate('kbn-esql-validation-autocomplete.esql.definitions.top', { defaultMessage: "Collects the top values for a field. Includes repeated values." }),
    alias: undefined,
    signatures: [
  {
    "params": [
...
// Do not edit this manually... generated by scripts/generate_function_definitions.ts
    ...
    type: 'agg',
    name: 'values',
    description: i18n.translate('kbn-esql-validation-autocomplete.esql.definitions.values', { defaultMessage: "Returns all values in a group as a multivalued field. The order of the returned values isn't guaranteed. If you need the values returned in order use esql-mv_sort." }),
    alias: undefined,
    signatures: [
  {
    "params": [
...
// Do not edit this manually... generated by scripts/generate_function_definitions.ts
    ...
    type: 'agg',
    name: 'weighted_avg',
    description: i18n.translate('kbn-esql-validation-autocomplete.esql.definitions.weighted_avg', { defaultMessage: "The weighted average of a numeric expression." }),
    alias: undefined,
    signatures: [
  {
    "params": [
  ...
  export const aggregationFunctionDefinitions = [avgDefinition,
countDefinition,

...
module.exports = (function () {
  ...
  function peg$parse(input) {
    ...
    const peg$startRuleFunctions = { start: peg$parsestart, Literal: peg$parseLiteral };
    ...
    const peg$c10 = ':';
    const peg$c11 = { type: 'literal', value: ':', description: '":"' };
    const peg$c12 = '{';
    const peg$c13 = { type: 'literal', value: '{', description: '"{"' };
    const peg$c14 = '}';
    const peg$c15 = { type: 'literal', value: '}', description: '"}"' };
    ...
    const peg$c17 = { type: 'other', description: 'fieldName' };
    ...
    const peg$c26 = { type: 'other', description: 'value' };
    ...
    const peg$c29 = { type: 'other', description: 'OR' };
    const peg$c30 = 'or';
    const peg$c31 = { type: 'literal', value: 'or', description: '"or"' };
    const peg$c32 = { type: 'other', description: 'AND' };
    const peg$c33 = 'and';
    const peg$c34 = { type: 'literal', value: 'and', description: '"and"' };
    const peg$c35 = { type: 'other', description: 'NOT' };
    const peg$c36 = 'not';
    const peg$c37 = { type: 'literal', value: 'not', description: '"not"' };
    const peg$c38 = { type: 'other', description: 'literal' };
    const peg$c39 = function () {
      return parseCursor;
    };
    const peg$c40 = '"';
    const peg$c41 = { type: 'literal', value: '"', description: '"\\""' };
    ...
    const peg$c46 = /^[\\"]/;
    const peg$c47 = { type: 'class', value: '[\\\\"]', description: '[\\\\"]' };
    const peg$c48 = function (char) {
      return char;
    };
    const peg$c49 = /^[^"]/;
    const peg$c50 = { type: 'class', value: '[^"]', description: '[^"]' };
    ...
    const peg$c52 = { type: 'any', description: 'any character' };
    const peg$c53 = '*';
    const peg$c54 = { type: 'literal', value: '*', description: '"*"' };
    const peg$c55 = function () {
      return wildcardSymbol;
    };
    const peg$c56 = '\\t';
    const peg$c57 = { type: 'literal', value: '\\t', description: '"\\\\t"' };
    const peg$c58 = function () {
      return '\t';
    };
    const peg$c59 = '\\r';
    const peg$c60 = { type: 'literal', value: '\\r', description: '"\\\\r"' };
    ...
    const peg$c66 = /^[\\():<>"*{}]/;
    const peg$c67 = { type: 'class', value: '[\\\\():<>"*{}]', description: '[\\\\():<>"*{}]' };
    const peg$c68 = function (sequence) {
      return sequence;
    };
    const peg$c69 = 'u';
    const peg$c70 = { type: 'literal', value: 'u', description: '"u"' };
    const peg$c71 = function (digits) {
      return String.fromCharCode(parseInt(digits, 16));
    };
    const peg$c72 = /^[0-9a-f]/i;
    const peg$c73 = { type: 'class', value: '[0-9a-f]i', description: '[0-9a-f]i' };
    const peg$c74 = '<=';
    const peg$c75 = { type: 'literal', value: '<=', description: '"<="' };
    const peg$c76 = function () {
      return 'lte';
    };
    const peg$c77 = '>=';
    const peg$c78 = { type: 'literal', value: '>=', description: '">="' };
    const peg$c79 = function () {
      return 'gte';
    };
    const peg$c80 = '<';
    const peg$c81 = { type: 'literal', value: '<', description: '"<"' };
    const peg$c82 = function () {
      return 'lt';
    };
    const peg$c83 = '>';
    const peg$c84 = { type: 'literal', value: '>', description: '">"' };
    const peg$c85 = function () {
      return 'gt';
    };
    const peg$c86 = { type: 'other', description: 'whitespace' };
    const peg$c87 = /^[ \t\r\n\xA0]/;
    const peg$c88 = {
      type: 'class',
      value: '[\\ \\t\\r\\n\\u00A0]',
    ...
    const peg$c90 = { type: 'literal', value: '@kuery-cursor@', description: '"@kuery-cursor@"' };

  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
      ...
      return buildFunctionNode('or', [left, right]);
        ...
        peg$c3 = function peg$c3(left, right) {
      var cursor = [left, right].find(function (node) {
        return node.type === 'cursor';
      });
      if (cursor) return cursor;
      ...
      description: "\")\""
        ...
        peg$c9 = function peg$c9(query, trailing) {
      if (trailing.type === 'cursor') {
        return _objectSpread({}, trailing, {
          suggestionTypes: ['conjunction']
        });
      ...
      description: "fieldName"
        ...
        peg$c11 = function peg$c11(field, operator, value) {
      ...
      description: "\":\""
        ...
        peg$c14 = function peg$c14(field, partial) {
      if (partial.type === 'cursor') {
        return _objectSpread({}, partial, {
      ...
      return partial(field);
        ...
        peg$c15 = function peg$c15(partial) {
      if (partial.type === 'cursor') {
        var fieldName = "".concat(partial.prefix).concat(partial.suffix).trim();
        return _objectSpread({}, partial, {
          fieldName: fieldName,
      ...
      return partial(field);
        ...
        peg$c16 = function peg$c16(partial, trailing) {
      if (trailing.type === 'cursor') {
        return _objectSpread({}, trailing, {
          suggestionTypes: ['conjunction']
        });
      ...
      return partial;
        ...
        peg$c17 = function peg$c17(partialLeft, partialRight) {
      ...
      return function (field) {
        ...
        peg$c18 = function peg$c18(partialLeft, partialRight) {
      var cursor = [partialLeft, partialRight].find(function (node) {
        return node.type === 'cursor';
      });
      ...
      return function (field) {
        ...
        peg$c19 = function peg$c19(partial) {
      if (partial.type === 'cursor') {
      ...
      return function (field) {
        ...
        peg$c22 = function peg$c22(value) {
      if (value.type === 'cursor') return value;
      ...
      description: "\"\\\"\""
        ...
        peg$c35 = function peg$c35(prefix, cursor, suffix) {
      ...
      return {
        ...
        peg$c36 = function peg$c36(chars) {
      ...
      return '\n';
        ...
        peg$c58 = function peg$c58(keyword) {
      return keyword;
    },
        peg$c59 = /^[\\():<>"*]/,
        peg$c60 = {
    ...
    var errorOnLuceneSyntax = options.errorOnLuceneSyntax,
        parseCursor = options.parseCursor,
        cursorSymbol = options.cursorSymbol,
        _options$allowLeading = options.allowLeadingWildcards,
        allowLeadingWildcards = _options$allowLeading === void 0 ? true : _options$allowLeading,

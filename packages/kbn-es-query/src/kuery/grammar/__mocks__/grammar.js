...
function peg$parse(input, options) {
  ...
  var peg$f16 = function(value) {
      ...
      if (
        ...
        && value.type === 'wildcard'
        && value.indexOf(wildcardSymbol) === 0
        && value.length > wildcardSymbol.length
      ) {
  ...
  var peg$f29 = function() { return buildLiteralNode('lte'); };
  var peg$f30 = function() { return buildLiteralNode('gte'); };
  var peg$f31 = function() { return buildLiteralNode('lt'); };
  var peg$f32 = function() { return buildLiteralNode('gt'); };

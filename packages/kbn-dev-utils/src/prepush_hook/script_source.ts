...
#
# GENERATED BY \`node scripts/register_git_prepush_hook.js\`
# IF YOU CHANGE SOMETHING IN THIS SCRIPT IT WILL
# BE REWRITTEN BY 'node scripts/register_git_prepush_hook'

# pre-commit script takes two arguments: https://git-scm.com/docs/githooks#_pre_push
...
execute_prepush_hook() {
  ...
  if [ -x "\${PREPUSH_FILE}" ]; then
    echo "Executing local prepush hook found in \${PREPUSH_FILE}"

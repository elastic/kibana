...
metadataOption: METADATA fromIdentifier (COMMA fromIdentifier)*;
...
fromIdentifier: FROM_UNQUOTED_IDENTIFIER | QUOTED_IDENTIFIER;
...
metaCommand: SHOW FUNCTIONS # metaFunctions;

...
it('builds a generated plugin into a viable archive', async () => {
  ...
  expect(filterLogs(generateProc.all)).toMatchInlineSnapshot(`
    "Kibana is currently running with legacy OpenSSL providers enabled! For details and instructions on how to disable see https://www.elastic.co/guide/en/kibana/9.0/production.html#openssl-legacy-provider
     succ 🎉

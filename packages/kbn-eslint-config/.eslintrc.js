...
const JS_YAML_LEGACY_CONSUMERS = [
  ...
  /^x-pack[\/\\]platform[\/\\]plugins[\/\\]shared[\/\\]cases[\/\\]public[\/\\]components[\/\\]templates_v2[\/\\]components[\/\\]template_preview\.tsx$/,
  /^x-pack[\/\\]platform[\/\\]plugins[\/\\]shared[\/\\]cases[\/\\]public[\/\\]components[\/\\]templates_v2[\/\\]field_types[\/\\]field_renderer\.test\.tsx$/,
  /^x-pack[\/\\]platform[\/\\]plugins[\/\\]shared[\/\\]cases[\/\\]public[\/\\]components[\/\\]templates_v2[\/\\]field_types[\/\\]field_types_registry\.test\.tsx$/,
  /^x-pack[\/\\]platform[\/\\]plugins[\/\\]shared[\/\\]cases[\/\\]public[\/\\]components[\/\\]templates_v2[\/\\]hooks[\/\\]use_import_templates\.ts$/,
  /^x-pack[\/\\]platform[\/\\]plugins[\/\\]shared[\/\\]cases[\/\\]public[\/\\]components[\/\\]templates_v2[\/\\]hooks[\/\\]use_templates_actions\.ts$/,
  /^x-pack[\/\\]platform[\/\\]plugins[\/\\]shared[\/\\]cases[\/\\]public[\/\\]components[\/\\]templates_v2[\/\\]hooks[\/\\]use_validate_yaml\.ts$/,
  /^x-pack[\/\\]platform[\/\\]plugins[\/\\]shared[\/\\]cases[\/\\]public[\/\\]components[\/\\]templates_v2[\/\\]pages[\/\\]edit_template[\/\\]page\.tsx$/,
  /^x-pack[\/\\]platform[\/\\]plugins[\/\\]shared[\/\\]cases[\/\\]public[\/\\]components[\/\\]templates_v2[\/\\]utils[\/\\]update_yaml_field_default\.ts$/,
  /^x-pack[\/\\]platform[\/\\]plugins[\/\\]shared[\/\\]cases[\/\\]server[\/\\]routes[\/\\]api[\/\\]templates[\/\\]mock_data\.ts$/,
  /^x-pack[\/\\]platform[\/\\]plugins[\/\\]shared[\/\\]cases[\/\\]server[\/\\]routes[\/\\]api[\/\\]templates[\/\\]parse_template\.test\.ts$/,
  /^x-pack[\/\\]platform[\/\\]plugins[\/\\]shared[\/\\]cases[\/\\]server[\/\\]routes[\/\\]api[\/\\]templates[\/\\]parse_template\.ts$/,
  /^x-pack[\/\\]platform[\/\\]plugins[\/\\]shared[\/\\]cases[\/\\]server[\/\\]routes[\/\\]api[\/\\]templates[\/\\]patch_template_route\.ts$/,
  /^x-pack[\/\\]platform[\/\\]plugins[\/\\]shared[\/\\]cases[\/\\]server[\/\\]routes[\/\\]api[\/\\]templates[\/\\]post_template_route\.ts$/,
  /^x-pack[\/\\]platform[\/\\]plugins[\/\\]shared[\/\\]cases[\/\\]server[\/\\]routes[\/\\]api[\/\\]templates[\/\\]put_template_route\.ts$/,
  /^x-pack[\/\\]platform[\/\\]plugins[\/\\]shared[\/\\]cases[\/\\]server[\/\\]routes[\/\\]api[\/\\]templates[\/\\]template_routes\.test\.ts$/,
  /^x-pack[\/\\]platform[\/\\]plugins[\/\\]shared[\/\\]cases[\/\\]server[\/\\]services[\/\\]templates[\/\\]index\.test\.ts$/,
  /^x-pack[\/\\]platform[\/\\]plugins[\/\\]shared[\/\\]cases[\/\\]server[\/\\]services[\/\\]templates[\/\\]index\.ts$/,

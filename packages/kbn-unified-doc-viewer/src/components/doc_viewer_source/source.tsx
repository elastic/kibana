...
export const DocViewerSource = ({
  ...
  const loadingState = (
    <div className="sourceViewer__loading">
      ...
      <EuiText size="xs" color="subdued">
        <FormattedMessage id="unifiedDocViewerPackage.loadingJSON" defaultMessage="Loading JSON" />
      </EuiText>
    </div>
  );
  ...
  const errorMessageTitle = (
    <h2>
      {i18n.translate('unifiedDocViewerPackage.sourceViewer.errorMessageTitle', {
  ...
  const errorMessage = (
    <div>
      {i18n.translate('unifiedDocViewerPackage.sourceViewer.errorMessage', {
      ...
      <EuiButton iconType="refresh" onClick={onRefresh}>
        {i18n.translate('unifiedDocViewerPackage.sourceViewer.refresh', {

...
Assertion.prototype['throw'] =
  ...
  Assertion.prototype.throwException =
    function (fn) {
      expect(this.obj).to.be.a('function');
...
Assertion.prototype.be = Assertion.prototype.equal = function (obj, msg) {
...
Assertion.prototype.greaterThan = Assertion.prototype.above = function (n, msg) {
  if (typeof msg === 'string') {
    this.customMsg = msg;
  }
  this.assert(
...
Assertion.prototype.lessThan = Assertion.prototype.below = function (n, msg) {
  if (typeof msg === 'string') {
    this.customMsg = msg;
  }
  this.assert(
...
Assertion.prototype.string = Assertion.prototype.contain = function (obj, msg) {
  if (typeof msg === 'string') {
    this.customMsg = msg;
  }
  if ('string' == typeof this.obj) {

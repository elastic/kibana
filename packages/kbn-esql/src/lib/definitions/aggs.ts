    ...
    signatures: [
      {
        params: [
          ...
          ...args.map(({ name: paramName, literalOnly, type }) => ({
            name: paramName,
            type,
...
export const statsAggregationFunctionDefinitions: FunctionDefinition[] = [
  {
    name: 'avg',
    description: i18n.translate('kbn-esql.definitions.avgDoc', {
      defaultMessage: 'Returns the average of the values in a field',
    }),
  },
  {
    name: 'max',
    description: i18n.translate('kbn-esql.definitions.maxDoc', {
      defaultMessage: 'Returns the maximum value in a field.',
    }),
  },
  {
    name: 'min',
    description: i18n.translate('kbn-esql.definitions.minDoc', {
      defaultMessage: 'Returns the minimum value in a field.',
    }),
  },
  {
    name: 'sum',
    description: i18n.translate('kbn-esql.definitions.sumDoc', {
      defaultMessage: 'Returns the sum of the values in a field.',
    }),
  },
  {
    name: 'median',
    description: i18n.translate('kbn-esql.definitions.medianDoc', {
      defaultMessage: 'Returns the 50% percentile.',
    }),
  },
  {
    name: 'median_absolute_deviation',
    description: i18n.translate('kbn-esql.definitions.medianDeviationDoc', {
      defaultMessage:
  ...
  {
    name: 'percentile',
    description: i18n.translate('kbn-esql.definitions.percentiletDoc', {
  ...
  .concat([
    {
      name: 'count',
      type: 'agg',
      description: i18n.translate('kbn-esql.definitions.countDoc', {
    ...
    },
    {
      name: 'count_distinct',
      type: 'agg',
      description: i18n.translate('kbn-esql.definitions.countDistinctDoc', {
    ...
    },
    {
      name: 'st_centroid',
      type: 'agg',
      description: i18n.translate('kbn-esql.definitions.stCentroidDoc', {
        defaultMessage: 'Returns the count of distinct values in a field.',
      }),
      supportedCommands: ['stats'],
      signatures: [

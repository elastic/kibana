...
export class esql_parser extends Parser {
                ...
                case 1:
                  {
                    ...
                    if (
                      !(
                        ((_la - 58) & ~0x1f) === 0 &&
                        ((1 << (_la - 58)) &
                          ((1 << (esql_parser.ASTERISK - 58)) |
                            (1 << (esql_parser.SLASH - 58)) |
                            (1 << (esql_parser.PERCENT - 58)))) !==
                          0
                      )
                    ) {
  ...
  public grouping(): GroupingContext {
    const _localctx: GroupingContext = new GroupingContext(this._ctx, this.state);
  ...
  public sourceIdentifier(): SourceIdentifierContext {
    const _localctx: SourceIdentifierContext = new SourceIdentifierContext(this._ctx, this.state);
    ...
    try {
      this.enterOuterAlt(_localctx, 1);
      {
        ...
        if (
          !(
            _la === esql_parser.SRC_UNQUOTED_IDENTIFIER || _la === esql_parser.SRC_QUOTED_IDENTIFIER
          )
        ) {
          this._errHandler.recoverInline(this);
        } else {
      ...
      this.enterOuterAlt(_localctx, 1);
      {
        ...
        if (
          !(
            ...
            ((1 << (_la - 50)) &
              ((1 << (esql_parser.EQ - 50)) |
                (1 << (esql_parser.NEQ - 50)) |
                (1 << (esql_parser.LT - 50)) |
                (1 << (esql_parser.LTE - 50)) |
                (1 << (esql_parser.GT - 50)) |
                (1 << (esql_parser.GTE - 50)))) !==
              0
          )
        ) {
          this._errHandler.recoverInline(this);
...
export class GroupingContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return esql_parser.RULE_grouping;
  }
  // @Override
  public enterRule(listener: esql_parserListener): void {
...
export class SourceIdentifierContext extends ParserRuleContext {
  public SRC_UNQUOTED_IDENTIFIER(): TerminalNode | undefined {
    return this.tryGetToken(esql_parser.SRC_UNQUOTED_IDENTIFIER, 0);
  }
  public SRC_QUOTED_IDENTIFIER(): TerminalNode | undefined {
...
export class KeepCommandContext extends ParserRuleContext {
  public KEEP(): TerminalNode | undefined {
    return this.tryGetToken(esql_parser.KEEP, 0);
  }
  public sourceIdentifier(): SourceIdentifierContext[];
  public sourceIdentifier(i: number): SourceIdentifierContext;
  public sourceIdentifier(i?: number): SourceIdentifierContext | SourceIdentifierContext[] {
  ...
  public PROJECT(): TerminalNode | undefined {
    return this.tryGetToken(esql_parser.PROJECT, 0);
  }
  constructor(parent: ParserRuleContext | undefined, invokingState: number) {
    super(parent, invokingState);
  }

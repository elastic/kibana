...
// @ts-nocheck
// Generated from src/antlr/esql_lexer.g4 by ANTLR 4.7.3-SNAPSHOT
...
export class esql_lexer extends Lexer {
  ...
  // tslint:disable:no-trailing-whitespace
  public static readonly modeNames: string[] = ['DEFAULT_MODE', 'EXPRESSION', 'SOURCE_IDENTIFIERS'];
  ...
  public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(
    esql_lexer._LITERAL_NAMES,
    esql_lexer._SYMBOLIC_NAMES,
    []
  );
  ...
  public static readonly _serializedATN: string = Utils.join(
    [esql_lexer._serializedATNSegment0, esql_lexer._serializedATNSegment1],
    ''
  );
  public static __ATN: ATN;
  public static get _ATN(): ATN {
    if (!esql_lexer.__ATN) {
      esql_lexer.__ATN = new ATNDeserializer().deserialize(
        Utils.toCharArray(esql_lexer._serializedATN)
      );
    }

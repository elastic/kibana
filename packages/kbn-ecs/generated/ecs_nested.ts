...
export const EcsNested = {
  ...
  file: {
    ...
    group: 2,
    name: 'file',
    nestings: ['file.code_signature', 'file.elf', 'file.hash', 'file.pe', 'file.x509'],
    prefix: 'file.',
    reusable: {
      expected: [
  ...
  os: {
    ...
    fields: {
      ...
      'os.full': {
        ...
        ignore_above: 1024,
        level: 'extended',
        multi_fields: [{ flat_name: 'os.full.text', name: 'text', type: 'match_only_text' }],
        name: 'full',
        normalize: [],
        short: 'Operating system name, including the version or code name.',
        type: 'keyword',
      ...
      'os.name': {
        ...
        ignore_above: 1024,
        level: 'extended',
        multi_fields: [{ flat_name: 'os.name.text', name: 'text', type: 'match_only_text' }],
        name: 'name',
        normalize: [],
        short: 'Operating system name, without the version.',
        type: 'keyword',
  ...
  user: {
    ...
    group: 2,
    name: 'user',
    nestings: ['user.changes', 'user.effective', 'user.group', 'user.risk', 'user.target'],
    prefix: 'user.',
    reusable: {
      expected: [

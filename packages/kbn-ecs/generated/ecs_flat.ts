...
export const EcsFlat = {
  ...
  'file.path': {
    ...
    ignore_above: 1024,
    level: 'extended',
    multi_fields: [{ flat_name: 'file.path.text', name: 'text', type: 'match_only_text' }],
    name: 'path',
    normalize: [],
  ...
  'host.os.full': {
    ...
    ignore_above: 1024,
    level: 'extended',
    multi_fields: [{ flat_name: 'host.os.full.text', name: 'text', type: 'match_only_text' }],
    name: 'full',
    normalize: [],
    original_fieldset: 'os',
  ...
  'host.os.name': {
    ...
    ignore_above: 1024,
    level: 'extended',
    multi_fields: [{ flat_name: 'host.os.name.text', name: 'text', type: 'match_only_text' }],
    name: 'name',
    normalize: [],
    original_fieldset: 'os',
  ...
  'process.name': {
    ...
    ignore_above: 1024,
    level: 'extended',
    multi_fields: [{ flat_name: 'process.name.text', name: 'text', type: 'match_only_text' }],
    name: 'name',
    normalize: [],
    short: 'Process name.',
    type: 'keyword',
  ...
  'url.full': {
    ...
    flat_name: 'url.full',
    level: 'extended',
    multi_fields: [{ flat_name: 'url.full.text', name: 'text', type: 'match_only_text' }],
    name: 'full',
    normalize: [],
    short: 'Full unparsed URL.',
    type: 'wildcard',
  ...
  'url.original': {
    ...
    level: 'extended',
    multi_fields: [{ flat_name: 'url.original.text', name: 'text', type: 'match_only_text' }],
    name: 'original',
    normalize: [],
    short: 'Unmodified original url as seen in the event source.',
    type: 'wildcard',
  ...
  'user.name': {
    ...
    ignore_above: 1024,
    level: 'core',
    multi_fields: [{ flat_name: 'user.name.text', name: 'text', type: 'match_only_text' }],
    name: 'name',
    normalize: [],
    short: 'Short name or login of the user.',
    type: 'keyword',

...
- [ ] `.buildkite/scripts/steps/verify_legacy_optimizer_build.sh`: Delete the file.
- [ ] `.buildkite/scripts/pipelines/pull_request/pipeline.ts`: Remove `verify_legacy_optimizer_build` from the `cancel_on_gate_failure` registration loop.

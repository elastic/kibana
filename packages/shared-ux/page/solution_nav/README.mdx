...
| Export | Description |
|---|---|
| `EuiSolutionNav` | The `EuiSolutionNav` component |
| `withSolutionNav` | The HOC which can provide the navigation to any component aligning with `EuiPageTemplate` and its props. |
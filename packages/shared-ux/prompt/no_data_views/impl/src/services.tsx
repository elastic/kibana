...
export const NoDataViewsPromptProvider: FC<NoDataViewsPromptServices> = ({
  ...
  const { canCreateNewDataView, dataViewsDocLink, openDataViewEditor, redirectToESQL } = services;
  ...
  return (
    <NoDataViewsPromptContext.Provider
      value={{
        ...
        showESQLViewLocator: services.discover,
        dataViews: services.dataView,
      }}
    >
      {children}
    </NoDataViewsPromptContext.Provider>

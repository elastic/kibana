...
This markdown component uses the **EuiMarkdownEditor** and **EuiMarkdownFormat** managed by `@elastic/eui`. The height of the component can be set, but in order the control the width of the component, you can place the `<Markdown />` component in another component.

...
export type Params<Props, Services> = Record<
  keyof ArgTypes<ReturnType<AbstractStorybookMock<Props, Services>['getServiceArgumentTypes']>>,
  any
>;
...
export abstract class AbstractStorybookMock<Props, Services> {
  protected abstract propArguments: Partial<ArgTypes<Props>>;
  protected abstract serviceArguments: Partial<ArgTypes<Services>>;
  protected abstract dependencies: Array<AbstractStorybookMock<unknown, unknown>>;

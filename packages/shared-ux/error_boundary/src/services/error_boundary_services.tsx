 ...
 * @internal
 */
export const KibanaErrorBoundaryDepsProvider: FC<PropsWithChildren<KibanaErrorBoundaryServices>> =
 ...
 * @public
 */
export const KibanaErrorBoundaryProvider: FC<PropsWithChildren<KibanaErrorBoundaryProviderDeps>> =
  ({ children, analytics }) => {

...
export const errorMessageStrings = {
  fatal: {
    ...
    toast: {
      title: () =>
        i18n.translate('sharedUXPackages.error_boundary.fatal.toast.title', {
          defaultMessage: 'A fatal error was encountered.',
        }),
      showDetailsButton: () =>
        i18n.translate('sharedUXPackages.error_boundary.fatal.toast.details', {
          defaultMessage: 'Show details',
        }),
      pageReloadButton: () =>
        i18n.translate('sharedUXPackages.error_boundary.fatal.toast.pageReloadButton', {
          defaultMessage: 'Refresh',
        }),
    },
  },
  recoverable: {
    ...
    toast: {
      title: () =>
        i18n.translate('sharedUXPackages.error_boundary.recoverable.toast.title', {
          defaultMessage: 'Sorry, please refresh',
        }),
      body: () =>
        i18n.translate('sharedUXPackages.error_boundary.recoverable.toast.body', {
          defaultMessage:
            'An error occurred when trying to load a part of the page. Please try refreshing.',
        }),
      pageReloadButton: () =>
        i18n.translate('sharedUXPackages.error_boundary.recoverable.toast.pageReloadButton', {
          defaultMessage: 'Refresh',
        }),
    },
  },

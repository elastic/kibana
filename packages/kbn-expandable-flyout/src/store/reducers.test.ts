...
import { initialDataState, DataState } from './state';
import {
...
describe('dataReducer', () => {
  describe('should handle openFlyout action', () => {
    it('should add panels to empty state', () => {
      const state: DataState = initialDataState;
      ...
      const newState: DataState = dataReducer(state, action);

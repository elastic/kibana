...
/** ***********************************************************
 *
 *  Run `node scripts/big_data_loader --help` for usage information
 *
 *************************************************************/
...
import { BigDataLoader } from './big_data_loader';
...
export function runCli() {
  new RunWithCommands({
    description: 'CLI to manage loading big data in elasticsearch',
    // globalFlags: {
    ...
    async extendContext({ log, flags }) {
      ...
      const bigDataLoader = new BigDataLoader({
        log,
        // client,
        baseDir: process.cwd(),
        // kbnClient,

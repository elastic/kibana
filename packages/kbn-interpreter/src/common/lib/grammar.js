...
function peg$parse(input, options) {
  ...
  var peg$c2 = function(first, fn) { return fn; };
  var peg$c3 = function(first, rest) {
      return addMeta({
        type: 'expression',
        chain: first ? [first].concat(rest) : []
      }, text(), location());
    };
  var peg$c4 = peg$otherExpectation("function");
  var peg$c5 = function(name, arg_list) {
      return addMeta({
        type: 'function',
        function: name,
        arguments: arg_list
  ...
  var peg$c8 = function(name, value) {
      return { name, value };
    };
  var peg$c9 = function(value) {
      return { name: '_', value };
    };
  var peg$c10 = "$";
  ...
  var peg$c16 = function(expression) { return expression; };
  var peg$c17 = function(value) {
      return addMeta(value, text(), location());
    };
  var peg$c18 = function(arg) { return arg; };
  var peg$c19 = function(args) {
      return args.reduce((accumulator, { name, value }) => ({
        ...accumulator,
        [name]: (accumulator[name] || []).concat(value)
      }), {});
    };
  var peg$c20 = /^[a-zA-Z0-9_\-]/;
  var peg$c21 = peg$classExpectation([["a", "z"], ["A", "Z"], ["0", "9"], "_", "-"], false, false);
  var peg$c22 = function(name) {
      return name.join('');
    };
  var peg$c23 = peg$otherExpectation("literal");
  var peg$c24 = "\"";
  var peg$c25 = peg$literalExpectation("\"", false);
  var peg$c26 = function(chars) { return chars.join(''); };
  var peg$c27 = "'";
  var peg$c28 = peg$literalExpectation("'", false);
  var peg$c29 = function(string) { // this also matches nulls, booleans, and numbers
  ...
  var peg$c34 = /^["'(){}<>[\]$`|= \t\n\r]/;
  var peg$c35 = peg$classExpectation(["\"", "'", "(", ")", "{", "}", "<", ">", "[", "]", "$", "`", "|", "=", " ", "\t", "\n", "\r"], false, false);
  var peg$c36 = function(sequence) { return sequence; };
  var peg$c37 = /^[^"'(){}<>[\]$`|= \t\n\r]/;
  var peg$c38 = peg$classExpectation(["\"", "'", "(", ")", "{", "}", "<", ">", "[", "]", "$", "`", "|", "=", " ", "\t", "\n", "\r"], true, false);
  var peg$c39 = /^[^"]/;

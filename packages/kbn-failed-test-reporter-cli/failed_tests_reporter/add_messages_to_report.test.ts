...
it('rewrites ftr reports with minimal changes', async () => {
  ...
  expect(createPatch('ftr.xml', FTR_REPORT, xml)).toMatchInlineSnapshot(`
    ...
    +
           ...
           ‹skipped/›
         ‹/testcase›
         ‹testcase name="machine learning anomaly detection saved search  with lucene query job creation opens the advanced section" classname="Firefox XPack UI Functional Tests.x-pack/platform/test/functional/apps/machine_learning/anomaly_detection/saved_search_job·ts" time="6.040" owners="elastic/search-ml-ux"›

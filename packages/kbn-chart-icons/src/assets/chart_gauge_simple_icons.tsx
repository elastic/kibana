...
export const IconChartLinearSimple = ({ title, titleId, ...props }: Omit<EuiIconProps, 'type'>) => {
  return (
    <IconGaugeSimpleWrapper {...props}>
      <path
        fillRule="evenodd"
        clipRule="evenodd"

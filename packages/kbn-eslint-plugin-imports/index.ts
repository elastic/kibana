...
import { RequireDynamicImportExtensionRule } from './src/rules/require_dynamic_import_extension';
...
export const rules = {
  ...
  require_dynamic_import_extension: RequireDynamicImportExtensionRule,
};

...
```bash
node scripts/generate_openapi --rootDir ./x-pack/solutions/security/solutions/security/plugins/security_solution
```
...
(cd x-pack/solutions/security/solutions/security/plugins/security_solution && yarn openapi:generate)

...
- [Algorithm steps](#algorithm-steps)
  ...
  - [OUTDATED\_DOCUMENTS\_SEARCH](#outdated_documents_search)
  ...
  - [UPDATE\_TARGET\_MAPPINGS](#update_target_mappings)
    - [Next action](#next-action-21)
    - [New control state](#new-control-state-21)
  - [UPDATE\_TARGET\_MAPPINGS\_WAIT\_FOR\_TASK](#update_target_mappings_wait_for_task)

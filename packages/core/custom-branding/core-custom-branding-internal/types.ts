...
import type { CustomBrandingServiceSetup, CustomBrandingStart  } from '@kbn/core-custom-branding';

/**@internal */
export interface InternalCustomBrandingSetup extends Pick<CustomBrandingServiceSetup, ''> {
    /**
     * Register the plugin
     */
    register(): void;

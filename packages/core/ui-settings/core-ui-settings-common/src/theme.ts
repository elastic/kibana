 ...
 */
export const DEFAULT_THEME_TAGS: ThemeTags = SUPPORTED_THEME_TAGS; // TODO: (tonyghiani) remove after design QA on deployment
// export const DEFAULT_THEME_TAGS: ThemeTags = ThemeAmsterdamTags; // TODO: (tonyghiani) uncomment after design QA on deployment

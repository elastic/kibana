...
addLocaleData({
  ...
  fields: {
    year: {
      displayName: 'ýéààŕ',
      relative: { 0: 'ţĥîîš ýééàŕ', 1: 'ñéẋẋţ ýééàŕ', '-1': 'ļàššţ ýééàŕ' },
      relativeTime: {
        future: { one: 'îñ {0} ýýéàŕŕ', other: 'îñ {0} ýýéàŕŕš' },
        past: { one: '{0} ýéààŕ àĝĝô', other: '{0} ýéààŕš ààĝô' },
      },
    },
    'year-short': {
      displayName: 'ýŕ.',
      relative: { 0: 'ţĥîîš ýŕŕ.', 1: 'ñéẋẋţ ýŕŕ.', '-1': 'ļàššţ ýŕŕ.' },
      relativeTime: {
        future: { one: 'îñ {0} ýýŕ.', other: 'îñ {0} ýýŕ.' },
        past: { one: '{0} ýŕ. ààĝô', other: '{0} ýŕ. ààĝô' },
      },
    },
    month: {
      displayName: 'ɱôññţĥ',
      relative: { 0: 'ţĥîîš ɱôôñţĥĥ', 1: 'ñéẋẋţ ɱôôñţĥĥ', '-1': 'ļàššţ ɱôôñţĥĥ' },
      relativeTime: {
        future: { one: 'îñ {0} ɱɱôñţţĥ', other: 'îñ {0} ɱɱôñţţĥš' },
        past: { one: '{0} ɱôññţĥ ààĝô', other: '{0} ɱôññţĥšš àĝôô' },
      },
    },
    'month-short': {
      displayName: 'ɱô.',
      relative: { 0: 'ţĥîîš ɱôô.', 1: 'ñéẋẋţ ɱôô.', '-1': 'ļàššţ ɱôô.' },
      relativeTime: {
        future: { one: 'îñ {0} ɱɱô.', other: 'îñ {0} ɱɱô.' },
        past: { one: '{0} ɱô. ààĝô', other: '{0} ɱô. ààĝô' },
      },
    },
    day: {
      displayName: 'ðàýý',
      relative: { 0: 'ţôððàý', 1: 'ţôɱɱôŕŕŕôŵ', '-1': 'ýéššţéŕŕðàýý' },
      relativeTime: {
        future: { one: 'îñ {0} ððàý', other: 'îñ {0} ððàýšš' },
        past: { one: '{0} ðàýý àĝôô', other: '{0} ðàýýš àĝĝô' },
      },
    },
    'day-short': {
      displayName: 'ðàýý',
    ...
    hour: {
      displayName: 'ĥôûûŕ',
      relative: { 0: 'ţĥîîš ĥôôûŕ' },
      relativeTime: {
        future: { one: 'îñ {0} ĥĥôûŕŕ', other: 'îñ {0} ĥĥôûŕŕš' },
        past: { one: '{0} ĥôûûŕ àĝĝô', other: '{0} ĥôûûŕš ààĝô' },
      },
    },
    'hour-short': {
      displayName: 'ĥŕ.',
      relative: { 0: 'ţĥîîš ĥôôûŕ' },
      relativeTime: {
        future: { one: 'îñ {0} ĥĥŕ.', other: 'îñ {0} ĥĥŕ.' },
        past: { one: '{0} ĥŕ. ààĝô', other: '{0} ĥŕ. ààĝô' },
      },
    },
    minute: {
      displayName: 'ɱîññûţéé',
      relative: { 0: 'ţĥîîš ɱîîñûţţé' },
      relativeTime: {
        future: { one: 'îñ {0} ɱɱîñûûţé', other: 'îñ {0} ɱɱîñûûţéšš' },
        past: { one: '{0} ɱîññûţéé àĝôô', other: '{0} ɱîññûţééš àĝĝô' },
      },
    },
    'minute-short': {
      displayName: 'ɱîññ.',
      relative: { 0: 'ţĥîîš ɱîîñûţţé' },
      relativeTime: {
        future: { one: 'îñ {0} ɱɱîñ.', other: 'îñ {0} ɱɱîñ.' },
        past: { one: '{0} ɱîññ. àĝôô', other: '{0} ɱîññ. àĝôô' },
      },
    },
    second: {
      ...
      relative: { 0: 'ñôŵŵ' },
      relativeTime: {
        future: { one: 'îñ {0} ššéçôôñð', other: 'îñ {0} ššéçôôñðšš' },
        past: { one: '{0} šéççôñðð àĝôô', other: '{0} šéççôñððš àĝĝô' },
      },
    },
    'second-short': {
      displayName: 'šéçç.',
      relative: { 0: 'ñôŵŵ' },
      relativeTime: {
        future: { one: 'îñ {0} ššéç.', other: 'îñ {0} ššéç.' },
        past: { one: '{0} šéçç. àĝôô', other: '{0} šéçç. àĝôô' },
      },
    },
  },
});
addLocaleData({
  ...
  fields: {
    ...
    day: {
      displayName: 'día',
      relative: { 0: 'hoy', 1: 'mañana', 2: 'pasado mañana', '-2': 'anteayer', '-1': 'ayer' },
      relativeTime: {
...
addLocaleData({
  ...
  fields: {
    ...
    day: {
      displayName: '日',
      relative: { 0: '今日', 1: '明日', 2: '明後日', '-2': '一昨日', '-1': '昨日' },
    ...
    hour: {
      displayName: '時',
      relative: { 0: '1 時間以内' },
      relativeTime: { future: { other: '{0} 時間後' }, past: { other: '{0} 時間前' } },
    },
    'hour-short': {
      displayName: '時',
      relative: { 0: '1 時間以内' },
    ...
    minute: {
      displayName: '分',
      relative: { 0: '1 分以内' },
      relativeTime: { future: { other: '{0} 分後' }, past: { other: '{0} 分前' } },
    },
    'minute-short': {
      displayName: '分',
      relative: { 0: '1 分以内' },
...
addLocaleData({
  ...
  fields: {
    ...
    'year-short': {
      displayName: 'a',
      relative: { 0: 'este ano', 1: 'próximo ano', '-1': 'último ano' },
      relativeTime: {
        future: { one: 'em {0} ano', other: 'em {0} anos' },
        past: { one: 'há {0} ano', other: 'há {0} anos' },
      },
    ...
    'month-short': {
      displayName: 'm',
      relative: { 0: 'este mês', 1: 'próximo mês', '-1': 'último mês' },
      relativeTime: {
        future: { one: 'em {0} mês', other: 'em {0} meses' },
        past: { one: 'há {0} mês', other: 'há {0} meses' },
      },
    ...
    day: {
      displayName: 'dia',
      relative: { 0: 'hoje', 1: 'amanhã', '-1': 'ontem' },
      relativeTime: {
    ...
    'hour-short': {
      ...
      relative: { 0: 'nesta hora' },
      relativeTime: {
        future: { one: 'em {0} h', other: 'em {0} h' },
        past: { one: 'há {0} h', other: 'há {0} h' },
      },
    },
    minute: {
      displayName: 'minuto',
    ...
    'minute-short': {
      ...
      relative: { 0: 'neste minuto' },
      relativeTime: {
        future: { one: 'em {0} min', other: 'em {0} min' },
        past: { one: 'há {0} min', other: 'há {0} min' },
      },
    },
    second: {
      displayName: 'segundo',
    ...
    'second-short': {
      ...
      relative: { 0: 'agora' },
      relativeTime: {
        future: { one: 'em {0} s', other: 'em {0} s' },
        past: { one: 'há {0} s', other: 'há {0} s' },
      },
    },
  },
});

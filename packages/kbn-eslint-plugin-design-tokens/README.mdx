---
id: kibSharedUXEslintPluginDesignTokens
slug: /kibana-dev-docs/shared-ux/packages/kbn-eslint-plugin-design-tokens
...
`@kbn/eslint-plugin-design-tokens` is an ESLint plugin providing custom ESLint rules to help setup guardrails for using eui in the Kibana repo especially around styling.

...
import { buildDataTableRecord } from '@kbn/doc-table-browser/src/utils/build_data_record'; // todo shorter
import { convertValueToString } from '@kbn/doc-table-browser/src/utils/convert_value_to_string'; // todo shorter
import { GridContext } from '@kbn/doc-table-browser/src/discover_grid/discover_grid_context'; // todo shorter

...
// kibana.alert.consecutive_match_count - count of consecutive times the alert has been active
const ALERT_CONSECUTIVE_MATCH_COUNT = `${ALERT_NAMESPACE}.consecutive_match_count` as const;

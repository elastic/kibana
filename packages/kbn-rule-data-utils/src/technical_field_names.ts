...
const ALERT_GROUPS = `${ALERT_NAMESPACE}.groups` as const;
const ALERT_GROUPS_FIELD = `${ALERT_GROUPS}.field` as const;
const ALERT_GROUPS_VALUE = `${ALERT_GROUPS}.value` as const;

...
const ALERT_THROTTLE_META = `${ALERT_NAMESPACE}.throttle` as const;
const ALERT_THROTTLE_FIELDS = `${ALERT_THROTTLE_META}.fields` as const;
const ALERT_THROTTLE_VALUES = `${ALERT_THROTTLE_META}.values` as const;
const ALERT_THROTTLE_START = `${ALERT_THROTTLE_META}.start` as const;
const ALERT_THROTTLE_END = `${ALERT_THROTTLE_META}.end` as const;
const ALERT_THROTTLE_COUNT = `${ALERT_THROTTLE_META}.count` as const;

...
const ALERT_SUPPRESSION_FIELDS = `${ALERT_SUPPRESSION_META}.fields` as const;
const ALERT_SUPPRESSION_VALUES = `${ALERT_SUPPRESSION_META}.values` as const;
...
const ALERT_SUPPRESSION_COUNT = `${ALERT_SUPPRESSION_META}.count` as const;

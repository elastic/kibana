...
const ALERT_GROUPINGS = `${ALERT_NAMESPACE}.groupings` as const;
const ALERT_GROUPINGS_FIELD = `${ALERT_GROUPINGS}.field` as const;
const ALERT_GROUPINGS_VALUE = `${ALERT_GROUPINGS}.value` as const;
...
const fields = {
  ...
  ALERT_GROUPINGS,
  ALERT_GROUPINGS_FIELD,
  ALERT_GROUPINGS_VALUE,
  ALERT_FLAPPING,
  ALERT_MAINTENANCE_WINDOW_IDS,
  ALERT_INSTANCE_ID,
  ALERT_RULE_CONSUMER,

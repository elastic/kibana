...
const ALERT_RULE_RULE_PARENT_ID = `${ALERT_RULE_NAMESPACE}.rule_parent_id` as const;
const ALERT_RULE_RULE_CHILDREN_IDS = `${ALERT_RULE_NAMESPACE}.rule_children_ids` as const;

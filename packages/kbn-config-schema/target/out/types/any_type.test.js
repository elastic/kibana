...
test('is required by default', () => {
    expect(() => __1.schema.any().validate(undefined)).toThrowErrorMatchingSnapshot();
});
test('includes namespace in failure', () => {
    expect(() => __1.schema.any().validate(undefined, {}, 'foo-namespace')).toThrowErrorMatchingSnapshot();
});

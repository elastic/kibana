...
module.exports = {
  ...
  transformIgnorePatterns: [
    ...
    '[/\\\\]node_modules(?![\\/\\\\](byte-size|monaco-editor|monaco-yaml|monaco-languageserver-types|monaco-marker-data-provider|monaco-worker-manager|vscode-languageserver-types|react-monaco-editor|d3-interpolate|d3-color|langchain|@langchain|langsmith|@cfworker|gpt-tokenizer))[/\\\\].+\\.js$',

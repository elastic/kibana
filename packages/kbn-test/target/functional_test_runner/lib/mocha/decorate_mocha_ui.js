...
exports.decorateMochaUi = decorateMochaUi;

var _assignment_proxy = require("./assignment_proxy");

var _wrap_function = require("./wrap_function");

var _wrap_runnable_args = require("./wrap_runnable_args");
 ...
 * under the License.
 */
function decorateMochaUi(lifecycle, context) {
  ...
  let suiteLevel = 0; // incremented at the start of each suite, used to know when a
  ...
  function wrapTestFunction(name, fn) {
    return wrapNonSuiteFunction(name, (0, _wrap_runnable_args.wrapRunnableArgsWithErrorHandler)(fn, async (err, test) => {
  ...
  function assignmentInterceptor(property, value) {
    ...
    value = (0, _assignment_proxy.createAssignmentProxy)(value, (subProperty, subValue) => {
  ...
  return (0, _assignment_proxy.createAssignmentProxy)(context, assignmentInterceptor);
}
 ...
 * under the License.
 */
const kbnTestConfig = new class KbnTestConfig {
  getPort() {
  ...
  getUrlParts() {
    ...
    if (process.env.TEST_KIBANA_URL) {
      const testKibanaUrl = _url.default.parse(process.env.TEST_KIBANA_URL);
    ...
    const username = process.env.TEST_KIBANA_USERNAME || _users.kibanaTestUser.username;
    const password = process.env.TEST_KIBANA_PASSWORD || _users.kibanaTestUser.password;
    return {
...
exports.kbnTestConfig = kbnTestConfig;
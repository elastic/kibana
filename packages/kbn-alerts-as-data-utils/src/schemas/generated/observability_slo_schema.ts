...
// prettier-ignore
export const ObservabilitySloAlertFlattenedSchema = rt.intersection([ObservabilitySloAlertRequiredFlattened, ObservabilitySloAlertOptionalFlattened]);
export type ObservabilitySloAlertFlattened = rt.TypeOf<typeof ObservabilitySloAlertFlattenedSchema>;

// prettier-ignore
export const ObservabilitySloAlertSchema = rt.intersection([ObservabilitySloAlertRequired, ObservabilitySloAlertOptional]);

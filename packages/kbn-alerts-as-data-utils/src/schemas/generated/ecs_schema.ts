...
// prettier-ignore
const EcsRequiredFlattened = rt.type({
  '@timestamp': schemaDate,
  'ecs.version': schemaString,
});
const EcsOptionalFlattened = rt.partial({
...
// prettier-ignore
export const EcsFlattenedSchema = rt.intersection([EcsRequiredFlattened, EcsOptionalFlattened]);
// prettier-ignore
export type EcsFlattened = rt.TypeOf<typeof EcsFlattenedSchema>;

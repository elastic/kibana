...
setAndSetWithFunctions.forEach(set => {
  ...
  const testCases = [
    ...
    ['.constructor.something.prototype', { '': { constructor: { something: { prototype: 'foo' } } } }],
    ['o.constructor.something.prototype', { o: { constructor: { something: { prototype: 'foo' } } } }],
    ['a[0].constructor.something.prototype', { a: [{ constructor: { something: { prototype: 'foo' } } }] }]
  ]
...
setWithFunctions.forEach(setWith => {
  // Return undefined
  assert.deepStrictEqual(setWith({}, 'a.b', 'foo', () => {}), { a: { b: 'foo' } })

...
describe('toSnippets()', () => {
  ...
  it('produces source, export, and id snippets', async () => {
    ...
    expect(indexer.toSnippets(foo!.rootSymbol.declarations[0])).toMatchInlineSnapshot(`
      Array [
        Object {
          "type": "source",
          "value": "/**
    ...
    `);
    expect(indexer.toSnippets(bar!.rootSymbol.declarations[0])).toMatchInlineSnapshot(`
      Array [
        Object {
          "noExportRequiresDeclare": false,
          "type": "export",

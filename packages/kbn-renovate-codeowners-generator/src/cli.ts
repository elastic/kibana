...
export function runCLI(): void {
  run(
    ...
    {
      description: 'Regenerate Renovate packageRules based on actual code usage and CODEOWNERS',
      usage: 'node scripts/generate_renovate_codeowners.js',
      flags: {
        boolean: ['write', 'check'],
        string: ['report-json'],
        help: `
  --write            Write updates back to renovate.json (default is dry-run)
  --check            Exit non-zero if reviewer drift or missing coverage is found (no write)

              ...
              <EuiToolTip
                content={
                  <FormattedMessage
                    ...
                    defaultMessage="Number of {delete} operations the connector sent to the Elasticsearch _bulk API. May include documents dropped by Sync Rules. Does not include documents dropped by ingest processors. Documents are deleted if the connector determines they are no longer present in the 3rd-party source."

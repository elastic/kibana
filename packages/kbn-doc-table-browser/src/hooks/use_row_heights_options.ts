...
import { ROW_HEIGHT_OPTION } from '../constants';
...
interface UseRowHeightServices {
  storage: any;
  uiSettings: any;
}
...
export const useRowHeightsOptions = (
  { rowHeightState, onUpdateRowHeight }: UseRowHeightProps,
  { storage, uiSettings }: UseRowHeightServices
) => {

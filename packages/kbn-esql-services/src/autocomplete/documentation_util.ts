...
const declarationLabel = i18n.translate('kbn-esql-services.esql.autocomplete.declarationLabel', {
  defaultMessage: 'Declaration:',
});

const examplesLabel = i18n.translate('kbn-esql-services.esql.autocomplete.examplesLabel', {

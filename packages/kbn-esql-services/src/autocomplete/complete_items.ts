...
export const pipeCompleteItem = buildCharCompleteItem(
  '|',
  i18n.translate('kbn-esql-services.esql.autocomplete.pipeDoc', {
    defaultMessage: 'Pipe (|)',
  }),
...
export const commaCompleteItem = buildCharCompleteItem(
  ',',
  i18n.translate('kbn-esql-services.esql.autocomplete.commaDoc', {
...
export const colonCompleteItem = buildCharCompleteItem(
  ':',
  i18n.translate('kbn-esql-services.esql.autocomplete.colonDoc', {
...
export const semiColonCompleteItem = buildCharCompleteItem(
  ';',
  i18n.translate('kbn-esql-services.esql.autocomplete.semiColonDoc', {

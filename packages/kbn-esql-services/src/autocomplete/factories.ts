...
export const buildNoPoliciesAvailableDefinition = (): SuggestionRawDefinition => ({
  label: i18n.translate('kbn-esql-services.esql.autocomplete.noPoliciesLabel', {
  ...
  command: {
    ...
    title: i18n.translate('kbn-esql-services.esql.autocomplete.createNewPolicy', {
      defaultMessage: 'Click to create',
    }),
  },
});
      ...
      if (/pattern/.test(names[index])) {
        suggestions.push(
          ...buildConstantsDefinitions(
            ...
            i18n.translate('kbn-esql-services.esql.autocomplete.aPatternString', {

...
function getMessageAndTypeFromId<K extends ErrorTypes>({
  ...
  switch (messageId) {
    case 'wrongArgumentType':
      return {
        message: i18n.translate('kbn-esql-services.esql.validation.wrongArgumentType', {
          defaultMessage:
    ...
    case 'unknownColumn':
      return {
        message: i18n.translate('kbn-esql-services.esql.validation.unknownColumn', {
    ...
    case 'unknownIndex':
      return {
        message: i18n.translate('kbn-esql-services.esql.validation.unknownIndex', {
    ...
    case 'unknownFunction':
      return {
        message: i18n.translate('kbn-esql-services.esql.validation.missingFunction', {
    ...
    case 'wrongArgumentNumber':
      return {
        message: i18n.translate('kbn-esql-services.esql.validation.wrongArgumentExactNumber', {
          defaultMessage:
    ...
    case 'wrongArgumentNumberTooMany':
      return {
        message: i18n.translate('kbn-esql-services.esql.validation.wrongArgumentTooManyNumber', {
          defaultMessage:
    ...
    case 'wrongArgumentNumberTooFew':
      return {
        message: i18n.translate('kbn-esql-services.esql.validation.wrongArgumentTooFewNumber', {
          defaultMessage:
    ...
    case 'noNestedArgumentSupport':
      return {
        message: i18n.translate('kbn-esql-services.esql.validation.noNestedArgumentSupport', {
          defaultMessage:
    ...
    case 'shadowFieldType':
      return {
        message: i18n.translate('kbn-esql-services.esql.validation.typeOverwrite', {
          defaultMessage:
    ...
    case 'unsupportedColumnTypeForCommand':
      return {
        message: i18n.translate(
          'kbn-esql-services.esql.validation.unsupportedColumnTypeForCommand',
          {
            defaultMessage:
    ...
    case 'unknownOption':
      return {
        message: i18n.translate('kbn-esql-services.esql.validation.unknownOption', {
    ...
    case 'unsupportedFunctionForCommand':
      return {
        message: i18n.translate('kbn-esql-services.esql.validation.unsupportedFunctionForCommand', {
    ...
    case 'unsupportedFunctionForCommandOption':
      return {
        message: i18n.translate(
          'kbn-esql-services.esql.validation.unsupportedFunctionforCommandOption',
          {
    ...
    case 'unknownInterval':
      return {
        message: i18n.translate('kbn-esql-services.esql.validation.unknownInterval', {
    ...
    case 'unsupportedTypeForCommand':
      return {
        message: i18n.translate('kbn-esql-services.esql.validation.unsupportedTypeForCommand', {
    ...
    case 'unknownPolicy':
      return {
        message: i18n.translate('kbn-esql-services.esql.validation.unknownPolicy', {
    ...
    case 'unknownAggregateFunction':
      return {
        message: i18n.translate('kbn-esql-services.esql.validation.unknowAggregateFunction', {
          defaultMessage:
    ...
    case 'wildcardNotSupportedForCommand':
      return {
        message: i18n.translate(
          'kbn-esql-services.esql.validation.wildcardNotSupportedForCommand',
          {
    ...
    case 'noWildcardSupportAsArg':
      return {
        message: i18n.translate(
          'kbn-esql-services.esql.validation.wildcardNotSupportedForFunction',
          {
    ...
    case 'unsupportedFieldType':
      return {
        message: i18n.translate('kbn-esql-services.esql.validation.unsupportedFieldType', {
          defaultMessage:
    ...
    case 'unsupportedSetting':
      return {
        message: i18n.translate('kbn-esql-services.esql.validation.unsupportedSetting', {
    ...
    case 'unsupportedSettingCommandValue':
      return {
        message: i18n.translate('kbn-esql-services.esql.validation.unsupportedSettingValue', {
          defaultMessage:
    ...
    case 'expectedConstant':
      return {
        message: i18n.translate('kbn-esql-services.esql.validation.expectedConstantValue', {
    ...
    case 'metadataBracketsDeprecation':
      return {
        message: i18n.translate('kbn-esql-services.esql.validation.metadataBracketsDeprecation', {
    ...
    case 'unknownMetadataField':
      return {
        message: i18n.translate('kbn-esql-services.esql.validation.wrongMetadataArgumentType', {
          defaultMessage:
    ...
    case 'wrongDissectOptionArgumentType':
      return {
        message: i18n.translate(
          'kbn-esql-services.esql.validation.wrongDissectOptionArgumentType',
          {
            defaultMessage:
...
export function getUnknownTypeLabel() {
  return i18n.translate('kbn-esql-services.esql.validation.unknownColumnType', {

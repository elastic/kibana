...
export const byOption: CommandOptionsDefinition = {
  name: 'by',
  description: i18n.translate('kbn-esql-services.esql.definitions.byDoc', {
    defaultMessage: 'By',
  }),
  signature: {
    multipleParams: true,
...
export const metadataOption: CommandOptionsDefinition = {
  name: 'metadata',
  description: i18n.translate('kbn-esql-services.esql.definitions.metadataDoc', {
...
export const asOption: CommandOptionsDefinition = {
  name: 'as',
  description: i18n.translate('kbn-esql-services.esql.definitions.asDoc', { defaultMessage: 'As' }),
  signature: {
...
export const onOption: CommandOptionsDefinition = {
  name: 'on',
  description: i18n.translate('kbn-esql-services.esql.definitions.onDoc', { defaultMessage: 'On' }),
  signature: {
    multipleParams: false,
...
export const withOption: CommandOptionsDefinition = {
  name: 'with',
  description: i18n.translate('kbn-esql-services.esql.definitions.withDoc', {
    defaultMessage: 'With',
  }),
  signature: {
    multipleParams: true,
...
export const appendSeparatorOption: CommandOptionsDefinition = {
  ...
  description: i18n.translate('kbn-esql-services.esql.definitions.appendSeparatorDoc', {
    defaultMessage:

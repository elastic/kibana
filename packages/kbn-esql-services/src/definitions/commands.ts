...
export const commandDefinitions: CommandDefinition[] = [
  {
    name: 'row',
    description: i18n.translate('kbn-esql-services.esql.definitions.rowDoc', {
      defaultMessage:
  ...
  {
    name: 'from',
    description: i18n.translate('kbn-esql-services.esql.definitions.fromDoc', {
      defaultMessage:
  ...
  {
    name: 'show',
    description: i18n.translate('kbn-esql-services.esql.definitions.showDoc', {
  ...
  {
    name: 'stats',
    description: i18n.translate('kbn-esql-services.esql.definitions.statsDoc', {
      defaultMessage:
    ...
    validate: (command: ESQLCommand) => {
      ...
      if (!command.args.length) {
        messages.push({
          ...
          text: i18n.translate('kbn-esql-services.esql.validation.statsNoArguments', {
        ...
        if (noAggsExpressions.length) {
          messages.push(
            ...noAggsExpressions.map((fn) => ({
              ...
              text: i18n.translate('kbn-esql-services.esql.validation.statsNoAggFunction', {
                defaultMessage:
          ...
          if (invalidExpressions.length) {
            messages.push(
              ...invalidExpressions.map((fn) => ({
                location: fn.location,
                text: i18n.translate(
                  'kbn-esql-services.esql.validation.noCombinationOfAggAndNonAggValues',
                  {
                    defaultMessage:
  ...
  {
    name: 'eval',
    description: i18n.translate('kbn-esql-services.esql.definitions.evalDoc', {
      defaultMessage:
  ...
  {
    name: 'rename',
    description: i18n.translate('kbn-esql-services.esql.definitions.renameDoc', {
  ...
  {
    name: 'limit',
    description: i18n.translate('kbn-esql-services.esql.definitions.limitDoc', {
      defaultMessage:
  ...
  {
    name: 'keep',
    description: i18n.translate('kbn-esql-services.esql.definitions.keepDoc', {
  ...
  {
    name: 'drop',
    description: i18n.translate('kbn-esql-services.esql.definitions.dropDoc', {
    ...
    validate: (command: ESQLCommand) => {
      ...
      if (wildcardItems.length) {
        messages.push(
          ...wildcardItems.map((column) => ({
            ...
            text: i18n.translate('kbn-esql-services.esql.validation.dropAllColumnsError', {
      ...
      if (droppingTimestamp) {
        messages.push({
          ...
          text: i18n.translate('kbn-esql-services.esql.validation.dropTimestampWarning', {
  ...
  {
    name: 'sort',
    description: i18n.translate('kbn-esql-services.esql.definitions.sortDoc', {
      defaultMessage:
  ...
  {
    name: 'where',
    description: i18n.translate('kbn-esql-services.esql.definitions.whereDoc', {
      defaultMessage:
  ...
  {
    name: 'dissect',
    description: i18n.translate('kbn-esql-services.esql.definitions.dissectDoc', {
      defaultMessage:
  ...
  {
    name: 'grok',
    description: i18n.translate('kbn-esql-services.esql.definitions.grokDoc', {
      defaultMessage:
        'Extracts multiple string values from a single string input, based on a pattern',
    }),
  ...
  {
    name: 'mv_expand',
    description: i18n.translate('kbn-esql-services.esql.definitions.mvExpandDoc', {
  ...
  {
    name: 'enrich',
    description: i18n.translate('kbn-esql-services.esql.definitions.enrichDoc', {
      defaultMessage:

...
async function build() {
  ...
  try {
    ...
    // Note: Declaration generation may fail due to moduleResolution issues, but the
    // actual JS bundles are built by esbuild above
    try {
      ...
      console.warn('@kbn/vite-config: TypeScript declaration generation had errors, continuing...');
    }

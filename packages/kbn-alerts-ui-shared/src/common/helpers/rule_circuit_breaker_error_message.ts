...
const getCreateRuleErrorSummary = (name: string) => {
  return i18n.translate('alertsUIShared.ruleCircuitBreaker.error.createSummary', {
...
const getUpdateRuleErrorSummary = (name: string) => {
  return i18n.translate('alertsUIShared.ruleCircuitBreaker.error.updateSummary', {
...
const getEnableRuleErrorSummary = (name: string) => {
  return i18n.translate('alertsUIShared.ruleCircuitBreaker.error.enableSummary', {
...
const getBulkEditRuleErrorSummary = () => {
  return i18n.translate('alertsUIShared.ruleCircuitBreaker.error.bulkEditSummary', {
...
const getBulkEnableRuleErrorSummary = () => {
  return i18n.translate('alertsUIShared.ruleCircuitBreaker.error.bulkEnableSummary', {
...
const getRuleCircuitBreakerErrorDetail = ({
  ...
  if (rules === 1) {
    return i18n.translate('alertsUIShared.ruleCircuitBreaker.error.ruleDetail', {
  ...
  return i18n.translate('alertsUIShared.ruleCircuitBreaker.error.multipleRuleDetail', {

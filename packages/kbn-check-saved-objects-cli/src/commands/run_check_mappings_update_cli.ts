...
/**
 * Check whether a snapshot of current mappings (i.e., mappings on main)
 * is compatible with mappings we can extract from the current code
 */
export function runCheckMappingsUpdateCli() {
  run(

...
export const getDocLinks = ({ kibanaBranch, buildFlavor }: GetDocLinkOptions): DocLinks => {
  ...
  return deepFreeze({
    ...
    dashboard: {
      ...
      urlDrilldownTemplateSyntax: `${KIBANA_DOCS}drilldowns.html#url_templating-language`,
      urlDrilldownVariables: `${KIBANA_DOCS}drilldowns.html#url-template-variables`,
    },
    discover: {
    ...
    visualize: {
      ...
      tsvbIndexPatternMode: `${KIBANA_DOCS}legacy-editors.html#tsvb-index-pattern-mode`,
    },
    observability: {
      guide: isServerless

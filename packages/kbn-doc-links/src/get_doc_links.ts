...
export const getDocLinks = ({ kibanaBranch }: GetDocLinkOptions): DocLinks => {
  ...
  return deepFreeze({
    ...
    workplaceSearch: {
      ...
      externalSharePointOnline: `${WORKPLACE_SEARCH_DOCS}content-sources/sharepoint-online-external.html`,
      ...
      sharePointServer: `${WORKPLACE_SEARCH_DOCS}content-sources/sharepoint-server.html`,

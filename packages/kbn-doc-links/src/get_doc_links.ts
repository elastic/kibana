...
export const getDocLinks = ({ kibanaBranch }: GetDocLinkOptions): DocLinks => {
  ...
  return deepFreeze({
    ...
    clients: {
      ...
      phpConnecting: `${ELASTIC_WEBSITE_URL}guide/en/elasticsearch/client/php-api/${DOC_LINK_VERSION}/connceting.html`, // typo in the docs url
      ...
      rubyQueryDsl: `${ELASTIC_WEBSITE_URL}guide/en/elasticsearch/client/ruby-api/${DOC_LINK_VERSION}/query-dsl.html`,

      ...
      description: (
        <Markdown
          ...
          markdownContent={i18n.translate(
            'languageDocumentation.documentationESQL.avg.markdown',
            {
              defaultMessage: `<!--
  ...
  `,
    ...
    // Do not edit manually... automatically generated by scripts/generate_esql_docs.ts
    {
      label: i18n.translate(
        'languageDocumentation.documentationESQL.median_absolute_deviation',
        {
    ...
    // Do not edit manually... automatically generated by scripts/generate_esql_docs.ts
    {
      ...
      description: (
        <Markdown
          ...
          enableSoftLineBreaks
          markdownContent={i18n.translate(
            'languageDocumentation.documentationESQL.min.markdown',
            {
              defaultMessage: `<!--
  This is generated by ESQL's AbstractFunctionTestCase. Do no edit it. See ../README.md for how to regenerate it.
  -->
    ...
    // Do not edit manually... automatically generated by scripts/generate_esql_docs.ts
    {
      ...
      description: (
        <Markdown
          ...
          enableSoftLineBreaks
          markdownContent={i18n.translate(
            'languageDocumentation.documentationESQL.sum.markdown',
            {
              defaultMessage: `<!--
  This is generated by ESQL's AbstractFunctionTestCase. Do no edit it. See ../README.md for how to regenerate it.
  -->
    ...
    // Do not edit manually... automatically generated by scripts/generate_esql_docs.ts
    {
      ...
      description: (
        <Markdown
          ...
          enableSoftLineBreaks
          markdownContent={i18n.translate(
            'languageDocumentation.documentationESQL.top.markdown',
            {
              defaultMessage: `<!--
  This is generated by ESQL's AbstractFunctionTestCase. Do no edit it. See ../README.md for how to regenerate it.
  -->

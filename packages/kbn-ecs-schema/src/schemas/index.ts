...
export const ecsSchema = {
  ...
  client: {...clientEcs},
  cloud: {...cloudEcs},
  codeSignature: {...codeSignatureEcs},
  container: {...containerEcs},
  dataStream: {...dataStreamEcs},
  ...
  host: {...hostEcs},
  http: {...httpEcs},
  interface: {...interfaceEcs},
  log: {...logEcs},
  network: {...networkEcs},
  observer: {...observerEcs},
  orchestrator: {...orchestratorEcs},
  organization: {...organizationEcs},
  os: {...osEcs},
  package: {...packageEcs},
  pe: {...peEcs},
  process: {...processEcs},
  ...
  url: {...urlEcs},
  user: {...userEcs},
  userAgent: {...userAgentEcs},
  vlan: {...vlanEcs},
  vulnerability: {...vulnerabilityEcs},
  x509: {...x509Ecs},
};
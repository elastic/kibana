...
import { KpiHostsEmbeddableComponent } from './kpi_hosts_component';

export const KPI_HOSTS_EMBEDDABLE = 'KPI_HOSTS_EMBEDDABLE';

export interface KpiHostsInput extends EmbeddableInput {
  task: string;
  icon?: string;
  search?: string;
}

export interface KpiHostsOutput extends EmbeddableOutput {
  hasMatch: boolean;
}

function getOutput(input: KpiHostsInput): KpiHostsOutput {
  return {
...
export class KpiHostsEmbeddable extends Embeddable<KpiHostsInput, KpiHostsOutput> {
  ...
  constructor(initialInput: KpiHostsInput, parent?: IContainer) {
  ...
  public render(node: HTMLElement) {
    ...
    ReactDOM.render(<KpiHostsEmbeddableComponent embeddable={this} />, node);
  }

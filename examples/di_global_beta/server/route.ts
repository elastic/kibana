 ...
 *
 * This route lives in the Beta plugin but injects `AlphaServiceToken`
 * which is published globally by the Alpha plugin.  Neither plugin
 * declares the other in `requiredPlugins`.
 */
@injectable()
export class BetaRoute {
  static method = 'get' as const;
  static path = '/api/di/global/beta';
  static validate = {};
  static options = {
    xsrfRequired: false,
  ...
  /**
   * Returns greetings from both the Beta and Alpha services to confirm that

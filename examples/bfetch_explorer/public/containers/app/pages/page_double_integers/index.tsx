  ...
  return (
    <EuiPageBody>
      ...
      <EuiPageContent>
        <EuiPageContentBody>
          <EuiText>
            Below is a list of numbers in milliseconds. They are sent as a batch to the server. For
            each number server waits given number of milliseconds than doubles the number and
            streams it back.
          </EuiText>
          <br />
          <EuiPanel

...
import { GuidedOnboardingPluginSetup, testGuideConfig } from '@kbn/guided-onboarding-plugin/server';
...
export class GuidedOnboardingExamplePlugin implements Plugin {
  ...
  public setup(coreSetup: CoreSetup, { guidedOnboarding }: PluginsSetup) {
    ...
    guidedOnboarding.registerGuideConfig('testGuide', testGuideConfig);
    return {};
  }

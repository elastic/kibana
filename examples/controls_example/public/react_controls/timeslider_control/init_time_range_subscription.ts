...
import { apiHasParentApi, apiPublishesTimeRange, PublishingSubject } from "@kbn/presentation-publishing";
...
export function initTimeRangeSubscription(api: unknown, services: Services) {
  ...
  const timeRangeMeta$ = new BehaviorSubject<TimeRangeMeta>(getTimeRangeMeta(rootTimeRange$.value, services));

  ...
  implements Plugin<void, void, SetupDependencies, StartDependencies>
{
  public setup(core: CoreSetup<StartDependencies>, { developerExamples }: SetupDependencies) {
    ...
    developerExamples.register({
      ...
      description: 'Validate ES|QL queries using the @kbn/esql-ast package.',
      image,
      links: [
        {
          label: 'README',
          href: 'https://github.com/elastic/kibana/tree/main/src/platform/packages/shared/kbn-esql-ast/src/language/README.md',
          iconType: 'logoGithub',
          size: 's',
          target: '_blank',
        },

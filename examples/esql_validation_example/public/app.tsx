...
import { ESQLCallbacks } from '@kbn/esql-validation-autocomplete/src/shared/types';
import { ESQLRealField } from '@kbn/esql-validation-autocomplete/src/validation/types';

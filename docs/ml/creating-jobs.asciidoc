...
TIP: Alternatively, after you load a sample data set you can click
*View data* > *ML jobs*. There are {ml} jobs for both the sample eCommerce
orders data set and the sample web logs data set.

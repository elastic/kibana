...
{anomaly-detect-cap} runs in and scales with {es}, and include an
...
size). {anomaly-detect-cap} identifies the file format and field mappings. You 
...
NOTE: The {kib} {ml} {anomaly-detect} use pop-ups. You must configure your web 

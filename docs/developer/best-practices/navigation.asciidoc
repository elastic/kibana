[[kibana-navigation]]
== Routing, Navigation and URL FAQ
...
Some of that tooling is inside the `core`, some are available as plugins.  

The purpose of this guide is to give you (a {kib} contributor}) a high-level overview of available tools and common approaches around routing,
browser navigation and, in general, working with URL.

This FAQ covers following topics:

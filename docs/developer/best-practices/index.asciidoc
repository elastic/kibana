...
** If so, have you considered using the streaming {kib-repo}tree/master/src/plugins/bfetch[bfetch service]?
...
services]
** https://github.com/elastic/kibana/blob/master/src/plugins/data/public/search/README.md[Search
strategies]

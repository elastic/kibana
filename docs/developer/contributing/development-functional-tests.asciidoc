...
[horizontal]
`log`::: An instance of the {blob}src/ops/kbn-dev-utils/src/tooling_log/tooling_log.js[`ToolingLog`] that is ready for use
...
**log:**:::
* Source: {blob}src/ops/kbn-dev-utils/src/tooling_log/tooling_log.js[src/ops/kbn-dev-utils/src/tooling_log/tooling_log.js]

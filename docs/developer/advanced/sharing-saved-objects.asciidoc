...
* Nonstandard links to other objects can break - _mitigated by <<sharing-saved-objects-step-1.1>>_
* "Deep link" pages (URLs) to objects can break - _mitigated by <<sharing-saved-objects-step-1.2>> and <<sharing-saved-objects-step-1.3>>_
* Encrypted objects may not be able to be decrypted - _mitigated by <<sharing-saved-objects-step-1.5>>_
...
[[sharing-saved-objects-step-1.1]]
==== Step 1.1
...
image::images/sharing-saved-objects-step-1.1.png["Sharing Saved Objects step 1"]
...
[[sharing-saved-objects-step-1.2]]
==== Step 1.2
...
[[sharing-saved-objects-step-1.3]]
==== Step 1.3
...
image::images/sharing-saved-objects-step-1.3.png["Sharing Saved Objects resolve outcomes overview"]
...
[[sharing-saved-objects-step-1.4]]
==== Step 1.4
...
After <<sharing-saved-objects-step-1.3>> is complete, you can add the code to convert your objects.
...
image::images/sharing-saved-objects-step-1.4.png["Sharing Saved Objects conversion code"]
...
[[sharing-saved-objects-step-1.5]]
==== Step 1.5
...
image::images/sharing-saved-objects-step-1.5.png["Sharing Saved Objects ESO migration"]
...
[[sharing-saved-objects-step-2.1]]
==== Step 2.1
...
image::images/sharing-saved-objects-step-2.1.png["Sharing Saved Objects registration (shareable)"]

[[sharing-saved-objects-step-2.2]]
==== Step 2.2
...
image::images/sharing-saved-objects-step-2.2.png["Sharing Saved Objects deletion warning"]

[[sharing-saved-objects-step-2.3]]
==== Step 2.3
...
* The "primary" object on the page should always handle the three `resolve()` outcomes as described in <<sharing-saved-objects-step-1.3>>.

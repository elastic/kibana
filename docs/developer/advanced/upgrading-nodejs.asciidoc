...
These files must be updated when upgrading Node.js:
  ...
  - {kib-repo}blob/{branch}/WORKSPACE.bazel[`WORKSPACE.bazel`] - The version is specified in the `node_version` property.
    ...
    Example for Node.js v18.18.2: https://console.cloud.google.com/storage/browser/_details/kibana-custom-node-artifacts/node-glibc-217/dist/v18.18.2/SHASUMS256.txt[kibana-custom-node-artifacts/node-glibc-217/dist/v18.18.2/SHASUMS256.txt]

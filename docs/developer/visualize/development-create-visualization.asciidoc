...
- *editor*: A React component with a custom editor
...
This is the sidebar editor you see in many of the Kibana visualizations. You can also write your own editor. To specify custom editor use `editor` parameter as a key and a React component as a value.

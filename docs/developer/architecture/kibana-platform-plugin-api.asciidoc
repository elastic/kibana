...
Learn about the {kib-repo}blob/{branch}/src/core/packages/core-plugins-server/src/types.ts[manifest
file format].
...
receive {kib-repo}blob/{branch}/src/core/packages/core-plugins-browser/src/plugin_initializer.ts[a standard set of core capabilities] as an argument.
...
this plugin. {kib-repo}blob/{branch}/src/core/packages/core-plugins-server/src/types.ts[It is identical] in almost every way to the client-side
entry-point:
...
|_constructor_
|{kib-repo}blob/{branch}/src/core/packages/core-plugins-server/src/types.ts[PluginInitializerContext]
|{kib-repo}blob/{branch}/src/core/packages/core-plugins-browser/src/plugin_initializer.ts[PluginInitializerContext]
...
plugin as a dependency in it's {kib-repo}blob/{branch}/src/core/packages/core-plugins-server/src/types.ts[`kibana.json`] manifest file.

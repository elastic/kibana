...
* The {kibana-ref-all}/8.0/release-notes-8.0.0.html#breaking-changes-8.0.0[8.0.0 breaking changes] documentation, where we try to capture any changes to the APIs as they occur across minors.

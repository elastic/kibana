...
|{kib-repo}blob/{branch}/src/platform/plugins/shared/bfetch/README.md[bfetch]
...
|{kib-repo}blob/{branch}/x-pack/platform/plugins/shared/apm_sources_access/README.md[apmSourcesAccess]
...
|{kib-repo}blob/{branch}/x-pack/solutions/observability/plugins/client_apps/README.md[clientApps]
...
|{kib-repo}blob/{branch}/x-pack/solutions/security/plugins/elastic_assistant_shared_state/README.md[elasticAssistantSharedState]
...
|{kib-repo}blob/{branch}/x-pack/platform/plugins/shared/embeddable_alerts_table/README.md[embeddableAlertsTable]
...
|{kib-repo}blob/{branch}/x-pack/platform/plugins/private/intercepts/README.md[intercepts]
...
|{kib-repo}blob/{branch}/x-pack/platform/plugins/private/product_intercept/README.md[productIntercept]
...
|{kib-repo}blob/{branch}/x-pack/solutions/search/plugins/search_query_rules/README.md[searchQueryRules]
...
|{kib-repo}blob/{branch}/x-pack/platform/plugins/private/task_manager_dependencies/README.md[taskManagerDependencies]

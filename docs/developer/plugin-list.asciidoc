...
|{kib-repo}blob/{branch}/src/platform/plugins/shared/otel_metrics[openTelemetryInstrumentedPlugin]
|WARNING: Missing README.
...
|{kib-repo}blob/{branch}/x-pack/solutions/observability/plugins/Users/gsoldevila/Work/kibana-quaternary/x-pack/examples/exploratory_view_example/README.md[exploratoryViewExample]

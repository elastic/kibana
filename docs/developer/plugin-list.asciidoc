...
|{kib-repo}blob/{branch}/src/plugins/metadata_events_streams/README.md[metadataEventsStreams]
...
|{kib-repo}blob/{branch}/src/plugins/user_content/README.md[userContent]

...
|{kib-repo}blob/{branch}/x-pack/plugins/observability_solution/log_explorer/README.md[logExplorer]
...
|{kib-repo}blob/{branch}/x-pack/plugins/observability_solution/serverless_observability/README.mdx[serverlessObservability]

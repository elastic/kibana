...
|{kib-repo}blob/{branch}/x-pack/solutions/observability/plugins/observability_solution/apm/readme.md[apm]
...
|{kib-repo}blob/{branch}/x-pack/solutions/observability/plugins/observability_solution/apm_data_access[apmDataAccess]
|WARNING: Missing README.
...
|{kib-repo}blob/{branch}/x-pack/solutions/observability/plugins/Users/gsoldevila/Work/kibana-obs-ux-infra_services-team/Users/gsoldevila/Work/kibana-obs-ux-infra_services-team/x-pack/examples/exploratory_view_example/README.md[exploratoryViewExample]
...
|{kib-repo}blob/{branch}/x-pack/solutions/observability/plugins/observability_solution/inventory/README.md[inventory]
...
|{kib-repo}blob/{branch}/x-pack/solutions/observability/plugins/observability_solution/metrics_data_access/README.md[metricsDataAccess]
...
|{kib-repo}blob/{branch}/x-pack/solutions/observability/plugins/observability_solution/profiling/README.md[profiling]
...
|{kib-repo}blob/{branch}/x-pack/solutions/observability/plugins/observability_solution/profiling_data_access[profilingDataAccess]
|WARNING: Missing README.
...
|{kib-repo}blob/{branch}/x-pack/solutions/observability/plugins/observability_solution/ux/readme.md[ux]

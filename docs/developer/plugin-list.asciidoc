...
|{kib-repo}blob/{branch}/x-pack/solutions/observability/plugins/observability_solution/exploratory_view/README.md[exploratoryView]
...
|{kib-repo}blob/{branch}/x-pack/solutions/observability/plugins/observability_solution/investigate/README.md[investigate]
|undefined


|{kib-repo}blob/{branch}/x-pack/solutions/observability/plugins/observability_solution/investigate_app/README.md[investigateApp]
|undefined
...
|{kib-repo}blob/{branch}/x-pack/solutions/observability/plugins/observability_solution/observability/README.md[observability]
...
|{kib-repo}blob/{branch}/x-pack/solutions/observability/plugins/observability_solution/slo/README.md[slo]
|A Kibana plugin
...
|{kib-repo}blob/{branch}/x-pack/solutions/observability/plugins/observability_solution/synthetics/README.md[synthetics]
...
|{kib-repo}blob/{branch}/x-pack/solutions/observability/plugins/observability_solution/uptime/README.md[uptime]
|The purpose of this plugin is to provide users of Heartbeat more visibility of what's happening
in their infrastructure.

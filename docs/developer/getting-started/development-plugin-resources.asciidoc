...
[discrete]
=== Some light reading
If you haven't already, start with  development-getting-started>>. If you are planning to add your plugin to the {kib} repo, read the  contributing>> guide, if you are building a plugin externally, read Plugins. In both cases, read up on our recommended  development-best-practices>>.
...
If you are building a plugin outside of the {kib} repo, read Plugins.

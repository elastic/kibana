...
NOTE: Prior to the 4.1.10 release of Kibana, tilemap visualizations used an external source of map data. The 4.1.10
release of Kibana uses the Elastic Tile Service. You can configure the <<tilemap-settings,tilemap settings>> for Kibana in the

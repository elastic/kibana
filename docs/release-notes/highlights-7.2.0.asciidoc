...
See <<elasticsearch-metrics>>. If these recent log entries are not sufficient to
diagnose problems, you can follow a link to the <<xpack-logs,Logs UI>> and
continue your investigation there.

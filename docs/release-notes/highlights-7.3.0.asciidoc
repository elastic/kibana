...
In 7.3, Canvas releases three new templates: Summary, Pitch, and Status.

The Summary template can help you create a report with live representations 
of your data.
...
[role="screenshot"]
image::release-notes/images/7.3-canvas-pitch.png[Canvas summary template]

The Status template gives you a solid, professional, and clean template 
for status reports and other updates. 

[role="screenshot"]
image::release-notes/images/7.3-canvas-status.png[Canvas summary template]

...
experimental[] If you upload a file to the *{data-viz}*, it now has the ability to recommend a {filebeat} 
configuration. You can then use {filebeat} to add more data of 
...
For more information about *{data-viz}*, see <<xpack-ml>>.
[float]
=== Learn more

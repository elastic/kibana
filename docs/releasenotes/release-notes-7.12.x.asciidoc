...
// Breaking changes can prevent your application from optimal operation and performance. Before you upgrade to n.n.n, review the breaking change, then mitigate the
...
// *Impact* +
// The impact of the breaking change to {kib}.

// For more information, refer to {kibana-pull}[#].
====
...
// The following functionality is deprecated in n.n.n, and will be removed in 8.0.0. Deprecated functionality does not have an immediate impact on your application, but 
// we strongly recommend you make the necessary updates after you upgrade to n.n.n. 

// [discrete]
// [[app-7.12.0-deprecation]]
// ==== Management deprecation
// .Deprecation title
// [%collapsible]
// ====
// *Details* +
// Details about the deprecation. For more information, refer to {kibana-pull}[#].

// *Impact* +
// The impact of the deprectation to {kib}.
====
...
// {kib} n.n.n adds the following new and notable features. For detailed information about the features introduced in n.n.n, refer to 
// link:[].
// TODO: Update with n.n.n blog link.

For detailed information about the n.n.n release, refer to <<enhancements-and-bug-fixes-7.12.0, Enhancements and bug fixes>>.
...
{kib} 7.12.0 adds the following new and notable features. For detailed information about the features introduced in 7.12.0, refer to 
...
// TODO: Update with 7.12.0 blog link.
...
For detailed information about the 7.12.0 release, refer to <<enhancement-v7.12.0,Enhancements>> and <<bug-v7.12.0,Bug fixes>>.

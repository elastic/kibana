...
[source,shell]
$ bin/kibana-plugin install https://download.elastic.co/kibana/x-pack/x-pack-5.0.0-alpha5.zip
Attempting to transfer from https://download.elastic.co/kibana/x-pack/x-pack-5.0.0-alpha5.zip

...
+
[role="screenshot"]
image::images/tutorial-visualize-wizard-step-1.png[Image showing different options for your new visualization, such as "lens", "area", "control", and others]
...
+
[role="screenshot"]
image::images/tutorial-visualize-bar-1.5.png[Bar chart showing "speaking parts" data]
...
+
[role="screenshot"]
image::images/tutorial-visualize-pie-3.png[Final pie chart, displaying all of the above mentioned changes.]
...
+
[role="screenshot"]
image::images/gs_maps_time_filter.png[Image displaying time filter for Maps tutorial]
...
[role="screenshot"]
image::images/tutorial-dashboard.png[Updated, finalized visualization with bar chart, pie chart, map, and markdown text field.]

...
Learn how to Secure access to {kib}, or refer to {ref}/security-privileges.html[Security privileges] for more information.
...
*Add your own data.* Ready to add your own data? Go to {observability-guide}/ingest-logs-metrics-uptime.html[Ingest logs, metrics, and uptime data with {agent}], or go to Add data to {kib} and learn about all the other ways you can add data.

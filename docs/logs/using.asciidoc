...
[float]
=== View log anomalies
If you have a license that includes the machine learning features, you can click *Analysis* to <<analysis-tab, use machine learning to detect and inspect anomalies>> in your log data.

...
If the {ml} {anomaly-detect} features are enabled, you can click *Log rate* to <<xpack-logs-analysis, use machine learning to detect and inspect anomalies>> in your log data.

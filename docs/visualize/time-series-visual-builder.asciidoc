...
The table visualization allows you to present data from multiple series in one
table. You can define a grouping field to define rows in your table and add multiple
columns via series to the table.

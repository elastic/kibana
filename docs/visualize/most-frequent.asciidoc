...
{es} {ref}/search-aggregations-metrics.html[metric] aggregations, and one or more
...
You configure visualizations using the default editor, which is broken into metric and bucket aggregations, and includes a default count

...
NOTE: {kib} versions 7.9.0, 7.9.1, and 7.9.2 require a workaround of setting `width: container`
and `height: container` to get the automatic sizing behavior. Earlier and later versions apply the

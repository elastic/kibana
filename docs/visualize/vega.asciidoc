...
** *Note*: The default graph is written in Vega-Lite, but you can build visualizations in either of the languages.
Edit the `schema` value in the dev tools to the left of the graph to define which language you would like to use.
For example: `$schema: https://vega.github.io/schema/vega-lite/v2.json`
...
Vega-Lite is a simplified version of Vega, useful to quickly get started,
but has a number of limitations. Vega-Lite is automatically converted

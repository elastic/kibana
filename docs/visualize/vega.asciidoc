...
WARNING: Vega supports dynamic data loading, e.g. by setting signals as data urls. This is not supported in Kibana since all data is fetched at once prior to passing it to the vega renderer.

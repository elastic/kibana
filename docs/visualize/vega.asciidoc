...
* In {kib}, choose *Visualize*, and add Vega visualization. You should see a default graph.
...
may need to make URLs absolute, for example, replace
...
* For more examples, check out our https://www.elastic.co/blog/getting-started-with-vega-visualizations-in-kibana[Getting started blog post].  

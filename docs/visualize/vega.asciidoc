...
** The default graph is written in Vega-Lite, but you can build visualizations in either of the languages.
Edit the `schema` value at the top of the graph to define which language you would like to use.

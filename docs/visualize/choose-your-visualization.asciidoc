...
[role="screenshot"]
include::images/visualize-area-chart.png[Area chart with Flights Delay Type sample data]
...
[role="screenshot"]
include::images/visualize-metric.png[Metric with Flights Average Ticket Price sample data]
...
[role="screenshot"]
include::images/visualize-pie-chart.png[Pie chart with Flights Airline Carrier sample data]
...
[role="screenshot"]
image::images/timlion-customize04.png[]

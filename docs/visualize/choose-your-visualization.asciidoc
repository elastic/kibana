...
Ready to create a data table? Refer to the data table example <link to example>.
...
Ready to create a gauge visualization? Refer to the gauge example <link to example>.
...
Ready to create a goal visualization? Refer to the goal visualization example <link to example>.

[[visualize-metric]]
=== Metric

The metric visualization displays a single numeric value for the specified aggregation.
...
Ready to create a metric visualization? Refer to the metric visualization example <link to example>.
...
Ready to add a Controls visualization to your dashboard? Refer to the example here.
...
Ready to add the Markdown widget? Refer to the example here.
...
Ready to create a tag cloud? Refer to the tag cloud example <insert link to example>.
...
Ready to create a Timelion visualization? Refer to the Timelion tutorial <insert link to tutorial>.

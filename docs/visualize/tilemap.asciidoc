...
If you still wish to create coordinate maps in Visualize:
...
the elements in the index pattern. The default _metrics_ aggregation for a coordinate map is *Count*.
...
Explore the map with the following options:

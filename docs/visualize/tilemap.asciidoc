...
Kibana’s out-of-the-box settings do not show coordinate map in the New Visualization menu. Use <<maps>> instead, which offers more functionality and is easier to use.

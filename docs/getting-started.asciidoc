...
include::getting-started/add-sample-data.asciidoc[leveloffset=+1]

include::getting-started/tutorial-sample-data.asciidoc[leveloffset=+1]

include::getting-started/tutorial-full-experience.asciidoc[leveloffset=+1]

include::getting-started/tutorial-define-index.asciidoc[leveloffset=+1]

include::getting-started/tutorial-discovering.asciidoc[leveloffset=+1]

include::getting-started/tutorial-visualizing.asciidoc[leveloffset=+1]

include::getting-started/tutorial-dashboard.asciidoc[leveloffset=+1]

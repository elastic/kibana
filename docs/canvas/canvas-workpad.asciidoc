...
. On the *Add Data* page, click the *View data* dropdown list, then select *Canvas*.
...
Add more pages when you've run out of room, or for when you'd like to separate your ideas across several pages.

...
<<a_fns,A>> | <<b_fns,B>> | <<c_fns,C>> | <<d_fns,D>> | <<e_fns,E>> | <<f_fns,F>> | <<g_fns,G>> | <<h_fns,H>> | <<i_fns,I>> | <<j_fns,J>> | <<k_fns,K>> | <<l_fns,L>> | <<m_fns,M>> | <<n_fns,N>> | <<o_fns,O>> | <<p_fns,P>> | <<q_fns,Q>> | <<r_fns,R>> | <<s_fns,S>> | <<t_fns,T>> | <<u_fns,U>> | <<v_fns,V>> | <<w_fns,W>> | <<x_fns,X>> | <<y_fns,Y>> | <<z_fns,Z>>
...
Alias: `this`, `b`
|`any`
|The value to compare the _context_ to, usually returned by a subexpression
|===

...
Formats a number into a formatted number string using the <<numeral, Elastic Numeral>> pattern syntax.
...
Alias: `format`
|`string`
|An <<numeral, Elastic numeral>> format string. For example, `"0.0a"` or `"0%"`.
|===

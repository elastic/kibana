...
- *Arguments*
+
_Unnamed_*::  (string) A name to give the column. The default is `value`.
Alias: name
...
- *Arguments*
+
show:: (boolean) The default is `true.`
 +
...
- *Arguments*
+
_Unnamed_::  (string) An optional date string to be parsed into milliseconds 
...
- *Arguments*
+
_Unnamed*_:: (string) Moment.js Format with which to bucket. See the https://momentjs.com/docs/#/displaying/[Moment.js documentation].
...
- *Arguments*
+
_Unnamed*_:: (string) Numeral.js format string. See the http://numeraljs.com/#format[Numeral.js documentation]
...
Returns whether the context is greater than or equal to the argument passed in.
...
- *Arguments*
+
dataurl:: (string) An image asset can be provided as a base64 dataurl, or passed in 
as a subexpression. Alias: _, url
+
mode:: (string)
...
+
gradient:: (boolean) The default is `false`.
+
...
- *Arguments*
+
image:: (string) An image asset can be provided as a base64 dataurl, or passed 
in as a subexpression. 
+
...
- *Arguments*
+
_Unnamed*_:: (string)	One or more strings to join together; include spaces where
needed.

...
<|include
<|string
<|A comma separated list of column names to keep in the table (default: `null`)

<|exclude
<|string
<|A comma separated list of column names to remove from the table (default: `null`)
|===
...
`gte` (greater than eq). The default is `eq`. 

...
deprecated:[8.10.0,This setting has no effect.] How often Reporting creates a new index to store report jobs and file contents.
...
Specifies the {time-units}[time] that the reporting poller waits between polling the internal queue for any

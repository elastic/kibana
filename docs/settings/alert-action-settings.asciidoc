...
For an <<xmatters-action-type,xMatters connector>>, specifies the request URL for the Elastic Alerts trigger in xMatters.
...
For an <<xmatters-action-type,xMatters connector>>, specifies the request URL for the Elastic Alerts trigger in xMatters with the API key included in the URL.

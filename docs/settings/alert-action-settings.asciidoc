...
| `xpack.actions.maxResponseContentLength` {ess-icon}
  | Defines the max size of the http response content in bytes allowed in node.js. Defaults to 1000000 (1MB).

| `xpack.actions.responseTimeout` {ess-icon}
  | Specifies the time before the request times out. If the request takes longer than `xpack.actions.responseTimeout`, the request will be aborted. Defaults to 60s.

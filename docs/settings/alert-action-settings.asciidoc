...
+
--
* For an <<bedrock-action-type,AWS Bedrock connector>>, specifies the AWS Bedrock request URL.
...
+
--
* For an <<bedrock-action-type,AWS Bedrock connector>>, current support is for the Anthropic Claude models. Defaults to `anthropic.claude-v2`.
...
For an <<bedrock-action-type,AWS Bedrock connector>>, specifies the AWS access key for authentication.
...
For an <<bedrock-action-type,AWS Bedrock connector>>, specifies the AWS secret for authentication.

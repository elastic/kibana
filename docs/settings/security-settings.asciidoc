...
| Optional. Specifies where audit logs should be written to and how they should be formatted. *Default:* console
...
| Mandatory. Specifies where audit logs should be written to. Allowed values are `console` or `file` appender.
|===

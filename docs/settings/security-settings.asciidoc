...
| Sets the interval at which {kib} tries to remove expired and invalid sessions from the session index. By default this value is 1 hour. The minimum value is 1 minute.

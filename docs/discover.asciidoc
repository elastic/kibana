...
include::discover/set-time-filter.asciidoc[leveloffset=+1]

include::discover/search.asciidoc[leveloffset=+1]

include::discover/field-filter.asciidoc[leveloffset=+1]

include::discover/document-data.asciidoc[leveloffset=+1]

include::discover/context.asciidoc[leveloffset=+1]

include::discover/viewing-field-stats.asciidoc[leveloffset=+1]

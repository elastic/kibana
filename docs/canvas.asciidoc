...
include::canvas/canvas-tutorial.asciidoc[leveloffset=+1]

include::canvas/canvas-workpad.asciidoc[leveloffset=+1]

include::canvas/canvas-elements.asciidoc[leveloffset=+1]

include::canvas/canvas-present-workpad.asciidoc[leveloffset=+1]

include::canvas/canvas-share-workpad.asciidoc[leveloffset=+1]

//include::canvas/canvas-expressions.asciidoc[leveloffset=+1]

include::canvas/canvas-function-reference.asciidoc[leveloffset=+1]

include::canvas/canvas-tinymath-functions.asciidoc[leveloffset=+1]

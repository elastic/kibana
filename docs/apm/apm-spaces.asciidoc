...
The APM app uses data views to query your APM data.
A data view is a pattern that matches data streams, indices, and/or aliases.
The default values are:

[options="header"]
|====
| Index setting     | Default data view
| Error             | `logs-apm*`

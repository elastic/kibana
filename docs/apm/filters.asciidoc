...
v|*Go:* {apm-go-ref-v}/configuration.html#config-environment[`ELASTIC_APM_ENVIRONMENT`]
*Java:* {apm-java-ref-v}/config-core.html#config-environment[`environment`]
//*Node.js:* {apm-node-ref-v}/configuration.html#environment[`environment`]
*Python:* {apm-py-ref-v}/configuration.html#config-environment[`environment`]
*Ruby:* {apm-ruby-ref-v}/configuration.html#config-environment[`environment`]
*Rum:* {apm-rum-ref-v}/configuration.html#environment[`environment`]
|===

...
If you're using the JavaScript RUM Agent, you'll notice the transaction overview page is a little different.
...
This data is available due to the geo-ip and user agent pipelines being enabled by default, which allows the capture or geolocation and user agent data.
This visualization makes it easy for you to visualize performance information about your end users' experience based on their location.

...
Finally, use the *Logs* tab to display logs related to the selected trace.
...
By correlating your application's logs and traces, you never have to search for relevant data;
it's all provided on one page. Viewing log and trace data together allows you to quickly diagnose
and solve problems.

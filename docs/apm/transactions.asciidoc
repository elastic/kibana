...
[role="screenshot"]
image::apm/images/apm-transactions-table.png[Example view of transactions table in the APM app in Kibana]
...
This feature allows you to tag each of your deployments and easily see if your deploy has increased response times

...
correlation value is added to the chart. You can hover over other rows in the
table to compare the latency distribution of transactions with that attribute.

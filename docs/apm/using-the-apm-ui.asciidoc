...
The Traces overview page displays every *transaction* occurring in your application,
regardless of the service it originated from.
...
To return to the full trace, simply click the "View full trace" button in the upper right hand corner of the page.
...
The _Errors overview_ page provides a high-level view of the error message and culprit,
the number of occurrences, and the most recent occurrence.
Just like on the _Transaction overview_ page, you'll notice we group together like errors.
...
Selecting an _error group ID_ or _error message_ brings you to the _Error group_ page.

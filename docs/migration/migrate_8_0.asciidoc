...
[float]
==== bin/kibana-keystore has moved from the `data` folder to `config`
*Details:* The Kibana keystore is used to add configuration changes.  It has been moved to Kibana's confugration directory.

...
*Impact:*
For any configurations beginning with `xpack.telemetry.`, remove the `xpack.` prefix. For example, use {kibana-ref}/telemetry-settings-kbn.html#telemetry-general-settings[`telemetry.enabled`] instead.

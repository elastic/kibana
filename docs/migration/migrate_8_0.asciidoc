...
[float]
=== `xpack.xpack_main.xpack_api_polling_frequency_millis` is no longer valid
*Details:* The deprecated `xpack.xpack_main.xpack_api_polling_frequency_millis` setting is no longer valid

*Impact:* Configure `xpack.licensing.api_polling_frequency` instead.

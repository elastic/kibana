...
[role="screenshot"]
image::images/coonectors-import-banner.png[Connectors import banner]

Connectors with the missing user sensitive information due to the import will be shown with the 'Fix' button in the list:
[role="screenshot"]

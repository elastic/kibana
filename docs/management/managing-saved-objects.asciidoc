...
Copy, edit, delete, import, and export your saved dashboards, visualizations, maps, {data-sources}, *Canvas* workpads, and other saved objects.
...
The `Saved Objects Management` {kib} privilege is required to access *Saved Objects*.
...
* To export specific objects, select their checkboxes in the table, and then click *Export*.
...
+
Not all saved object types are shareable. If an object is shareable, the Spaces column shows which spaces it exists in. You can click

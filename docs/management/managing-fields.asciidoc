...
[[scripted-fields]]
=== Scripted fields
deprecated:[7.13.0,Scripted fields are deprecated] Use {ref}/runtime.html[runtime fields] instead of scripted fields. Runtime fields
support Painless scripts and provide greater flexibility.

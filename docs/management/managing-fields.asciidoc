...
index pattern whenever you load your own data into Kibana.
For example, Logstash typically creates a series of indices in the
format `logstash-YYYY.MMM.DD`. To explore all of the log data from May 2018,
you could specify the index pattern `logstash-2018.05*`.
...
To view and edit a field's properties, click the edit icon in the detail view.

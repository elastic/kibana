...
data, raw data, or both. For more information, refer to <<visualize-rollup-data, Using rolled up data in a visualization>>
for more information.

Dashboards can have a mixture of rollup visualizations and regular visualizations.

NOTE: Some queries and filters do not support rollups.

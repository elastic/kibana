...
To get started, open the menu, then click *Stack Management > Rollup Jobs*. With this UI,
you can:
...
. Open the menu, then click *Stack Management > Index Patterns*.
...
. Open the menu, click *Dashboard*, then create and add a vertical bar chart.

...
xpack.actions.preconfigured:
  my-slack:
    ...
    actionTypeId: .slack
    secrets:
      webhookUrl: '<SLACK_WEBHOOK_URL>' <1>
--
...
my-tines:
    ...
    config:
      url: <TENANT_URL> <1>
    secrets:
      email: some.address@example.com <2>
...
xpack.actions.preconfigured:
  my-torq:
    ...
    actionTypeId: .torq
    config:
      webhookIntegrationUrl: <WEBHOOK_URL> <1>
    secrets:
      token: mytorqtoken <2>
--

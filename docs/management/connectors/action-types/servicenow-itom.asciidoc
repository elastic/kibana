...
=== Prerequisites
After upgrading to 7.16, you must create an integration user in ServiceNow and assign it the `personalize_choices` and `evt_mgmt_integration` roles before creating a new ServiceNow ITOM connector.

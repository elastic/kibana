...
=== Prerequisites
After upgrading to 7.16, you must complete the following within your ServiceNow instance before creating a new ServiceNow ITSM connector or <<updating an existing one, sservicenow-itsm-connector-update>>:

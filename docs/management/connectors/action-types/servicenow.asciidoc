...
The ServiceNow user requires at minimum read/create/update access to the Incident table and read access to the sys_choice. If access is not provided to sys_choice, then the choices on test will not render.

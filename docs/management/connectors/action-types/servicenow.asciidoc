...
The ServiceNow connector uses the https://docs.servicenow.com/bundle/orlando-application-development/page/integrate/inbound-rest/concept/c_TableAPI.html[V2 Table API] to create ServiceNow incidents. You can use the {sn-itsm} connector for rule actions and cases. The {sn-sir} connector can be used with cases.

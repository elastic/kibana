...
First Elastic must be configured within your xMatters instance. In your xMatters instance, navigate to workflows. Once you have installed the Elastic workflow template or created a custom workflow with the Elastic trigger, you can begin configuration.
...
For more information and documentation visit https://help.xmatters.com/integrations/#cshid=Elastic[xMatters Documentation].

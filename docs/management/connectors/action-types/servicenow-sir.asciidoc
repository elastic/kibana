...
The {sn-sir} connector uses the https://developer.servicenow.com/dev.do#!/reference/api/sandiego/rest/c_ImportSetAPI[Import Set API] to create {sn} security incidents.
...
Define {sn-sir} connector properties. Choose whether to use OAuth for authentication.

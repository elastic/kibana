...
==== Prerequisites
After upgrading to 7.16, you must complete the following within your {sn} instance before creating a new {sn} SecOps connector or <<servicenow-sir-connector-update, updating an existing one>>:
...
* Create a Cross-Origin Resource Sharing () rule in {sn}.

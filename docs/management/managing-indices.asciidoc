...
{ref}/data-streams.html[data streams]. Data streams let you store time series
data across multiple hidden indices while giving you a single named resource to
use in requests.

...
data across multiple backing indices while giving you the simplicity of a single
...
To view statistics about a data stream, such as its generation or its current
index lifecycle policy, click the stream's name.

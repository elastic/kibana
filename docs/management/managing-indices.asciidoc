...
Practicing good index management helps ensure that your data is stored in the
most cost-effective way possible. This page shows you how to use {kib}'s *Index
Management* features to:

* View and edit index settings.
* View mappings and statistics for an index.
* Perform index-level operations, such as refreshes, freezing indices, and more.
* Create index templates to automatically configure indices when they're created.
...
Component templates are optional. For this example, click *Next >* to skip this
step.

*Step 3: Index settings*

The third step in the *Create template* wizard allows you to define index
settings. These settings are optional, and this example skips this step. Click
*Next >*.

...
To get started, open the menu, then click *Stack Management > Snapshot and Restore*.
...
. Open the menu, then click *Stack Management > Snapshot and Restore*.
...
. Open the menu, click *Dev Tools*, then select *Console*.
. Create the snapshot:
+
[source,js]

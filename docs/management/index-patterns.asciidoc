...
[float]
[[configure-rollup-index-pattern]]
...
You can match an index pattern to only rolled up data, or mix rolled up 
...
See <<visualize-rollup-data, Use rolled up data in a visualization>> 

...
When  you don't have an index pattern, {kib} prompts you to create one. Or, you can go directly to *Index Patterns* UI:
. Open the menu, then click *Stack Management*.
. From the *Kibana* menu, click *Index Patterns*.

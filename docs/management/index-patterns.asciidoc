...
Deleting an Index Pattern removes the index-pattern Saved Object from the kibana index.
You will be unable to recover field formatters, scripted fields, source filters, and field popularity data
associated with the Index Pattern once an Index Pattern has been deleted.
Deleting an Index Pattern will break all Visualizations, Saved Searches, and any other Saved Objects that
references the deleted Index Pattern.
Deleting an Index Pattern does not remove any indicies or data documents from Elasticsearch.

...
`format:bytes:defaultPattern`:: The default <<numeral, Elastic numeral>> format for the "bytes" format.
`format:currency:defaultPattern`:: The default <<numeral, Elastic numeral>> format for the "currency" format.
...
`format:number:defaultLocale`:: The <<numeral, Elastic numeral>> locale.
`format:number:defaultPattern`:: The <<numeral, Elastic numeral>> for the "number" format.
`format:percent:defaultPattern`:: The <<numeral, Elastic numeral>> for the "percent" format.

...
The visualize editor uses new heatmap charts with improved performance, legend settings, and more. Enable this option if you prefer to use the legacy charts library.

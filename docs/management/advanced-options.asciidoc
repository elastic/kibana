...
does not have an effect when loading a discover view.
...
Hides the "Time" column in *Discover* and in all discover viewes on dashboards.

[[doctable-highlight]]`doc_table:highlight`::
Highlights results in *Discover* and discover viewes on dashboards. Highlighting

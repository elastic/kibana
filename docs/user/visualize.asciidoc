...
Want to quickly create a visualization? Have zero experience with creating visualizations? 
Start with Lens, where you simply drag and drop data fields to get an immediate view of your data. 
...
Build tools that enable you to interact with the data on your dashboards in real time.

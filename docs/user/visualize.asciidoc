...
_Visualize_ enables you to create visualizations of the data from your {es} indices. To extract and process your data, you use a series of {es} {ref}/search-aggregations.html[aggregations], then create meaningful visualizations that show you the trends, spikes, and dips you need to know about.
...
* [beta] Visualize <<rollup-index-pattern,rolled up data>> in a variety of visualizations.
...
if the rollup job is aggregated by hours, use buckets of days.

...
<<most-frequent,Pie chart>>:: Display each source contribution to a total.
...
<<most-frequent,Heat maps>>:: Display shaded cells within a matrix.
<<most-frequent,Tag cloud>>:: Display words in a cloud, where the size of the word corresponds to its importance.

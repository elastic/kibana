...
context menu. You can either preserve the applied time range or use the time bound from the page date picker, configure a specific 
partition, or set the maximum number of top change points to plot. You can also add or 

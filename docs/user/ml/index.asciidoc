...
the first 10,000 partition, sorted by document count, are analyzed.

If at least one change point is detected, a chart visualizes the change point in 
its context, making the interpretation easier. If you split the analysis by a 

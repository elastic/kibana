...
Discover is the window into your Elasticsearch data. It enables you to 
quickly search and filter, get information about structure, 
and quickly navigate to Visualize and Maps to present your data.

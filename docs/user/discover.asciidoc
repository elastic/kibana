...
To create an alert rule from *Discover*,
click *Alerts* in the toolbar. Then build the data view, query,
and filters that match the data for which you want the alert notification.
For detailed information, refer to <<alerting-getting-started, Alerting>>.

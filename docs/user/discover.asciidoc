...
[partintro]
--
**_The window into your data in {es}._**

*Discover* enables you to quickly search and filter your data, get information
about structure of the fields, and navigate to *Visualize* and *Maps* to present your data.
...
Given your documents contain geo point fields (image:images/geoip-icon.png[Geo point field icon, width=20px]), you can visualize them in **Maps**.

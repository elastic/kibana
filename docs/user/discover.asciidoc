...
. Select *:* for equals some value and *US*, and then click
image:images/update-button.png[button at the end of the query bar for updating your search, width=24px].
...
. In the *Add filer** popover, set **Field** to *day_of_week*, **Operator** to *is not*, and **Value** to *Wednesday*.
+
[role="screenshot"]

...
From *Discover*, you can create an alert to periodically
...
. Configure your query and actions, and then save your alert.
+
For details about configuring your query, refer to <<rule-type-es-query, this doc>>.

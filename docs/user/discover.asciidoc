...
about the structure of the fields, and present your findings in a visualization.
...
your {es} data.
To view the ecommerce sample data, make sure the data view is set to **kibana_sample_data_ecommerce**.
+
[role="screenshot"]
image::images/discover-data-view.png[How to set the data view in Discover, width=50%]
...
You can add a runtime field to your data view from inside of **Discover**,
...
+
[role="screenshot"]
image:images/add-field-to-data-view.png[Dropdown menu located next to data view field with item for adding a field to a data view, width=50%]
...
and current view of *Discover*&mdash;the columns selected in the document table, the sort order, and the data view.

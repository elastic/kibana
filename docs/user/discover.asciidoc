...
* <<alerting-getting-started, Create an alert from Discover>>.
In the toolbar, click *Alerts*, and then
click *Create search threshold rule*. Follow the prompts to
create an alert that periodically checks when data goes above or below a certain

...
[partintro]
--
**_Exploring and querying your data._**

*Discover* is your window into your data in {es}. *Discover* enables you to 
quickly search and filter your data, get information about structure of the fields, 
and navigate to *Visualize* and *Maps* to present your data.
...
[float]
=== Select, explore, and present your data
...
Given your documents contain fields of type geo point, you can visualize them in **Maps**.

. Make sure the index pattern is set to **kibana_sample_data_flights**. And the configured time range 
contains data.

. From the **Available fields** list, click `OriginLocation` and then click **Visualize**.
+
[role="screenshot"]

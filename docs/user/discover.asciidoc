...
By default, the table includes a column for the time field and a second column that
lists every field and its value, which can be overwhelming to go through.

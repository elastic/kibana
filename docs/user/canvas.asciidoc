...
A _workpad_ provides you with a workspace where you can build presentations of your live data.
...
include::{kib-repo-dir}/canavs/canvas-present-workpad.asciidoc[]

include::{kib-repo-dir}/canavs/canvas-share-workpad.asciidoc[]

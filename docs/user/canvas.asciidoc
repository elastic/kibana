...
* *Panel settings* &mdash; Allows you to change the title, description, and time range for the panel.
...
include::{kibana-root}/docs/canvas/canvas-edit-workpads.asciidoc[]

include::{kibana-root}/docs/canvas/canvas-present-workpad.asciidoc[]

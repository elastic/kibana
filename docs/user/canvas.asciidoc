...
. Add a {kibana-ref}/gs-get-data-into-kibana.html[sample data set].
...
Use *{es} documents* when you have low volume datasets, to view raw documents, or to plot exact, non-aggregated values on a chart.

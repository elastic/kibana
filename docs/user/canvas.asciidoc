...
Hint: If you click on the text showing the actual positon at the bottom, it shows all the pages of the current canvas. If you hover your mouse over, you have the option to clone or delete the selected page.

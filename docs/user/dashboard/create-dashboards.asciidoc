...
. Move any panels you want into the section by dragging and dropping them. +
+
NOTE: The section must be expanded in order to place panels into it.

. Just like any other panel, you can move the collapsible section to a different position in the dashboard using drag and drop.

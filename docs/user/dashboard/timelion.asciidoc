...
IMPORTANT: **Timelion** was deprecated in version 7.10.
...
. Go to the **Visualize Library** and select **Create visualization**.
. In the **Legacy** tab, select **Aggregation-based**, then **Timelion**.

...
You create panels using the editors, which you access from the dashboard toolbar. 

On the dashboard, choose one of the following options:

* *Create visualization* &mdash; Opens the drag-and-drop editor, the recommended way to create visualizations of your data.

* *All types* &mdash; Opens the menu for the advanced editors, *Machine Learning* panels, and *Log stream* panel. 

...
Before you create dashboards, review the best practices to help your users complete their tasks quickly and efficiently.

[discrete]
[[dashboard-identify-your-audience]]
=== Identify your audience and goal

Identify the primary dashboard users and their goals for using the dashboard. 

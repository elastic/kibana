...
The best way to understand your data is to visualize it. With dashboards, you can turn your data from one or more <<index-patterns, {data-sources}>> into a collection of panels 

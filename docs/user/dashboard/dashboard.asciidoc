...
A dashboard is a collection of panels that you use to analyze your data. Each panel contains data from one or more <<index-patterns, index patterns>>, which allows
...
* *Embed code* &mdash; Embed the dashboard as an iframe in a web page. User authentication is required, 
...
>>>>>>> 077c81ff0e49ae1fb3466b7188b3a767f227c4a0
...
To manually create a back up of the dashboard, export the dashboard as a saved object.
...
To automate regular back ups of the dashboard, refer to <<Export dashboard API,dashboard-api-export>>.

...
To share the dashboard with a larger audience, click *Share* in the toolbar, then choose an option. For information about the sharing options, refer to <reporting-getting-started,Sharing>>.

[float]
[[import-dashboards]]
=== Export the dashboard

To automate the export of dashboards as JSON, use the <<dashboard-api,import and export dashboard APIs>>. It is important to export dashboards with all references needed.

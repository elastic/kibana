...
You create panels using the editors, which you can access from the dashboard toolbar or the *Visualize Library*.  
...
Add panels that are saved in the *Visualize Library* or search results that you saved in <<save-your-search,*Discover*>>.

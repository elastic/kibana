...
Dashboards support many types of panels, and provide several ways to create panels, including:

* <<create-panels-with-lens,Lens>> &mdash; The drag and drop editor that creates visualizations of your data. *Lens* is recommended for most users.

* <<maps,Maps>> &mdash; Displays your geographical data. 

* <<add-panels-with-advanced-editors,Advanced editors>> &mdash; Manually create panels of your data with the *TSVB*, *Vega*, and *Timelion* editors. 

* <<add-aggregation-based-visualization-panels,Aggregation-based visualization panels>> &mdash; Manually create panels based on <<aggregation-reference,aggregations>>.

* <<enhance-dashboards,Tools>> &mdash; Add context to your panels with <<add-text,text>>, or filter the data in real-time with <<add-controls,*Controls*>> . 

* <<save-your-search,Saved search>> &mdash; Add a saved search from *Discover*.

* <<xpack-ml-anomalies,Machine Learning>> &mdash; Create a panel with your machine learning anomaly detection data.
...
Dashboards provide you with the space where you add panels of your data to create a story. You can begin with an empty dashboard, or open an existing dashboard. 
...
To build and add to a dashboard that's already been started, open an existing dashboard.
...
* Add context to your panels with <<add-text,text>>, or filter the data in real-time with a <<add-controls,*Controls*>> panel. 

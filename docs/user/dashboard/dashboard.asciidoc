...
Use dashboards to analyze and monitor your data. A dashboard is a collection of panels that display the data from one or more <<index-patterns, index patterns>>. 
...
To create dashboards, use the *Lens* visualization builder to create panels, or add existing panels. 
...
== Tutorial: Create a dashboard of panels with website data

You've collected data from your web server, and you're ready to create a dashboard and visualize your data in one place. In this tutorial, you'll learn how to 
create a variety of panels using the *Lens* visualization builder. With *Lens*, you drag and drop your data fields, 
then *Lens* uses heuristics to apply each field and create a visualization for you.
...
create a donut chart that displays the top operating systems that your visitors use to access your website.
...
That's it! You've created a dashboard that provides you with a complete picture of the data from your web server.
...
[[share-the-dashboard]]
To share the dashboard with a larger audience:

From the toolbar, click *Share*, then choose one of the following options:

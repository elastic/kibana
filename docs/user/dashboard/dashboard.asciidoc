...
Dashboards support many types of panels and editors to create panels, including:
...
| <<maps,Maps>>
| Displays your geographical data.

| <<add-panels-with-advanced-editors,Advanced editors>>
| Manually create panels of your data with the *TSVB*, *Vega*, and *Timelion* editors.

| <<add-aggregation-based-visualization-panels,Aggregation-based visualization panels>>
| Manually create panels based on <<aggregation-reference,aggregations>>.

| <<enhance-dashboards,Tools>>
| Add context to your panels with <<add-text,text>>, or filter the data in real-time with <<add-controls,*Controls*>>.

| <<save-your-search,Saved search>>
| Add a saved search from *Discover*.

| <<xpack-ml-anomalies,Machine Learning>>
| Create a panel with your machine learning anomaly detection data.

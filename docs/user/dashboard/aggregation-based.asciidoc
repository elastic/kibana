...
From 7.12, XY axis charts use a new charts library. 

NOTE: The legacy XY charts library will be removed in 7.16. If you are still using it, turn off the *XY axis legacy charts library* switch.

The new library comes with new cool features:

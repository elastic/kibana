...
NOTE: Make sure you are using the new charts library. The legacy charts library for area, bar, line, and pie charts will be removed in 7.16. For more information, refer to <<kibana-visualization-settings>>.

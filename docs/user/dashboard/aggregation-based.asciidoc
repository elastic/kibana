...
* Use a <<save-open-search,discover view>> as an input
...
+
NOTE: There is no performance impact on the data source you select. For example, *Discover* discover viewes perform the same as {data-sources}. 

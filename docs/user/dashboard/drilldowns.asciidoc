...
| Open a dashboard from another dashboard,
...
| beta[] URL drilldowns allow you to navigate from a dashboard to internal or external URLs.
...
To learn about code drilldowns, refer to {kib-repo}blob/{branch}/x-pack/examples/ui_actions_enhanced_examples[this example plugin].

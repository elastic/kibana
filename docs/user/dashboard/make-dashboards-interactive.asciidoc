...
* If you are adding a *Control* to an existing dashboard, click *Edit*, click *Controls* in the dashboard toolbar, then select *Add time slider control*.

* If you are adding a *Control* to a new dashboard, click *Controls* in the dashboard toolbar, then select *Add time slider control*.

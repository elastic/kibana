...
* *Explore underlying data* &mdash; Opens visualization editor panel data in *Discover*.

* *Open in Discover* &mdash; Opens *Discover* saved search data in *Discover*.

Series data interactions::
Opens the series data in *Discover*.
+

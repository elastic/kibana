...
* *Discover view interactions* &mdash; Opens <<save-your-search,discover view>> data in *Discover*.
+
To use discover view interactions, open the panel menu, then click *More > View discover view*.

...
* Display multiple <<index-patterns, {data-sources}>> in each visualization.
...
. Create a runtime field. Refer to <<managing-index-patterns, *Manage {data-sources} data fields*>> for more information.
+
[role="screenshot"]

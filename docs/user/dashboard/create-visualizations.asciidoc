...
| Organize your dashboard into sections that can be collapsed and save loading time

| <<add-text, Markdown text>>
...
* {observability-guide}/create-an-elasticsearch-query-rule.html[Configure] your {es} rule.

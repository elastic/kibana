...
To compare the data in the dashboard panels, move, resize, and customize the panels, or remove the panels from the dashboards.
...
visualization or saved search from the panel is still available in {kib}.

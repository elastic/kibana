...
Use formulas to change aggregated metrics and data, such as {es} aggregations, time shifts, and filters, and combine aggregated fields. Formulas apply only to *Lens* panels and are computationally intensive.
====

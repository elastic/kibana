...
* To add fields, open the {data-source} dropdow, then select *Add a field to this {data-source}*.
+
[role="screenshot"]
image:images/lens_runtimeFieldMenu_8.3.png[Dropdown menu located next to {data-source} field with items for adding and managing fields]
+

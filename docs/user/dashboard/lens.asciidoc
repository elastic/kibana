...
With the **Display**, **Legend layout**, **Legend position**, and **Legend width** options, you can adjust the way the legend appears in or next to the visualization.
...
To make your legend as informative as possible, you can show some additional statistics for each element of the visualization.

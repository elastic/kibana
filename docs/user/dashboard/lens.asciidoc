...
[%collapsible]
====
Use the <<kuery-query, query bar>> to focus on a known set of data for the entire visualization. You can combine KQL filters with other filters using AND logic.

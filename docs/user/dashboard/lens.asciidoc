...
To identify specified values, add static, dynamic, and formula reference line layers to your visualization axes. You can add reference lines to any visualization type that displays axes.

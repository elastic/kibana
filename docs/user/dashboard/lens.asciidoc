...
*Lens* provides a set of pre-defined color palette to apply for the entire visualization.

In the datatable visualization, in *Lens*, there's a new palette editor pattern which enables you either tweak existing predefined palettes, or even to create a custom palette for the column:
+
[role="screenshot"]
image::images/lens_datatable_palette_editor.png[Lens data table palette panel editor]
+
[role="screenshot"]
image::images/lens_datatable_custom_palette.png[Lens data table custom palette panel editor]

The feature is available for numeric columns in the datatable.

...
Visualizations in Lens now support a color to term mapping system. These color mappings provide a visual guide for understanding the data presented in our visualizations. The feature is enabled by default and a maximum of 10 colors can be mapped to terms. 

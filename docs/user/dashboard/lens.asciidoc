...
To make your legend as informative as possible, you can show some additional **Statistics** for each element of the visualization and add a **Series header**.
...
- **Different %**: % difference between first and last values

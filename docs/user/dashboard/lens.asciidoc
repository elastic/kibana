...
Use formulas to change metrics and data that are aggregations, such as {es} aggregations, time shifts, and filters. Formulas apply only to *Lens* panels and are computationally intensive.
====

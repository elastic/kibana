...
How you deploy {kib} largely depends on your use case. Predicting the throughput a deployment might require to support Task Management is difficult because features can schedule an unpredictable number of tasks at a variety of scheduled cadences.

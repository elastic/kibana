...
{kib} Task Manager is leveraged by features such as Alerting, Actions, Reporting, and Telemetry to run mission critical work as persistent background tasks.

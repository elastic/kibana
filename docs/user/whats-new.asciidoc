...
[float]
=== Display data labels in heatmaps
...
*Canvas* now also has the following new features:

* Create embedded visualizations in your *Canvas* workpads.
Promote favorites to the *Visualization Library* for re-use.

* For fewer clicks to author and edit existing workpads, editing visualizations in *Canvas* now returns you to *Canvas* when you

...
A channel white listing ability is now available as part of the <<slack-action-type,Slack API connector>>.
You can restrict the Slack channels that the connector provides for rules actions.

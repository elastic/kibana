...
[discrete]
==== Slack API connector channel improvements

A channel white listing ability is now available as part of the <<slack-action-type,Slack API connector>> configuration so admins can restrict slack channels to be configured as part of the actions.

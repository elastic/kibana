...
Maps introduces {kibana-ref}/maps-grid-aggregation.html[geo_shape fields with {es} aggregations].
...
{kibana-ref}//tile-layer.html[Vector tile layers] are also enhanced&mdash;add layers to your map for data services that implement the

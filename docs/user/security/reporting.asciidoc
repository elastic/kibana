...
. Open the menu, then click *Stack Management > Users*, add a new user, and assign the user the built-in
...
. Open the menu, then click *Stack Management > Users* and create a new user with

...
access to {kib} with administrator privileges. Alternatively, you can create additional roles that grant more limited access to {kib}.

If you're using the default native realm with Basic Authentication, open then main menu, then click *Stack Management > Users* to create

...
Encryption for {kib}'s reporting and saved objects features also requires
encryption key settings. Refer to
<<xpack-reporting-encryptionKey,`xpack.reporting.encryptionKey`>> and

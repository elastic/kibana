...
To manage privileges, go to on the *Stack Management > Security > Roles*.

If you're using the native realm with Basic Authentication, assign roles
using the *Management > Security > Users* page, or the

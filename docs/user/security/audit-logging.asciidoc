...
| `success` | User has accessed cases as part of a search operation.
| `failure` | User is not authorized to search for cases.
...
| `success` | User has accessed a case user action.
| `failure` | User is not authorized to access case user actions.

.2+| `case_user_action_get_metrics`
| `success` | User has accessed case user actions.
| `failure` | User is not authorized to access case user actions.

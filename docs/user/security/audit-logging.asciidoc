...
[IMPORTANT]
============================================================================
Audit events correlation requires the use of <<xpack-security-ecs-audit-logging, ECS audit logger>>.
`trace.id` field is only produced when `xpack.security.audit.appender` is configured.
============================================================================

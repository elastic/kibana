...
TIP: Want Single Sign-on? {kib} supports a wide range of SSO implementations, including SAML, OIDC, LDAP/AD, and Kerberos. Learn more about {kib}'s SSO features>>.
...
* View the authorization guide to learn more about authorizing access to {kib}'s features.

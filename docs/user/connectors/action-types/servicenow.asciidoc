...
[role="screenshot"]
image::user/connectors/images/servicenow-connector.png[ServiceNow connector]

Test ServiceNow action parameters.

[role="screenshot"]
image::user/connectors/images/servicenow-params-test.png[ServiceNow params test]

...
[float]
[[email-stack-management]]
=== Define connector in Stack Management

Define email connector properties.

[role="screenshot"]
image::user/connectors/images/email-connector.png[Email connector]

Test email action parameters.

[role="screenshot"]
image::user/connectors/images/email-params-test.png[Email params test]

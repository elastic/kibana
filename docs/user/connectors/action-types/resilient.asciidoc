...
[role="screenshot"]
image::user/connectors/images/resilient-connector.png[IBM Resilient connector]

Test IBM Resilient action parameters.

[role="screenshot"]
image::user/connectors/images/resilient-params-test.png[IBM Resilient params test]

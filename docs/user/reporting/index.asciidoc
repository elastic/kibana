...
To generate a report, you mut have the `reporting_user` role. You also need
the appropriate <<kibana-privileges, {kib} privileges>> to access the objects that you
want to report on and the {es} indices.
...
From this view, you can monitor generation of a report and 

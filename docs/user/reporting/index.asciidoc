...
* *PNG Reports* &mdash; Generate and download PNG files of dashboards and visualization. PNG reports are a link:https://www.elastic.co/subscriptions[subscription feature].

* *CSV Reports* &mdash; Generate and download CSV files of *Discover* saved searches.

* *CSV Download* &mdash; Generate and download CSV files of *Lens* visualizations.

* *Get links* &mdash; Share direct links to *Discover* saved searches, dashboards, and visualizations.
...
For information about granting access to embedded dashboards, refer to <<anonymous-access-and-embedding>> and <<embedded-content-authentication>>.

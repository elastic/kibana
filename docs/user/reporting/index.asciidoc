...
--
:frontmatter-description: {kib} provides you with several options to share *Discover* discover viewes, dashboards, *Visualize Library* visualizations, and *Canvas* workpads with others, or on a website.
:frontmatter-tags-products: [kibana]

{kib} provides you with several options to share *Discover* discover viewes, dashboards, *Visualize Library* visualizations, and *Canvas* workpads.
...
* *CSV Reports* &mdash; Generate and download CSV files of discover viewes. <<csv-limitations,Certain limitations apply>>.

* *CSV Download* &mdash; Generate and download CSV files of *Lens* visualizations.

* *Get links* &mdash; Share direct links to discover viewes, dashboards, and visualizations.
...
Create and download PDF, PNG, or CSV reports of discover viewes, dashboards, visualizations, and workpads.

[[reporting-layout-sizing]]
The layout and size of the report depends on what you are sharing.
For discover viewes, dashboards, and visualizations, the layout depends on the size of the panels.
...
. Open the main menu, then open the discover view, dashboard, visualization, or workpad you want to share.
...
+
NOTE: When you create a dashboard report that includes a data table or discover view, the PDF includes only the visible data.
...
Create and share direct links to discover viewes, dashboards, and visualizations. To access the shared object, authentication is required.

. Open the main menu, then open the discover view, dashboard, or visualization you want to share.

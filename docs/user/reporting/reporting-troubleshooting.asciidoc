...
** For <a href="https://commondatastorage.googleapis.com/chromium-browser-snapshots/Mac/901912/chrome-mac.zip">x64</a> systems
** For <a href="https://commondatastorage.googleapis.com/chromium-browser-snapshots/Mac_Arm/901913/chrome-mac.zip">ARM</a> systems
...
When {kib} starts, it will automatically extract the browser from the zip file, and it is ready to use for PNG and PDF reports.

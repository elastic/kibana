...
A report can contain a dashboard, visualization, discover view, or Canvas workpad.
...
| Manage your discover view sessions, groups of queries that run in the background.

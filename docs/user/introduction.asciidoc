...
* Use the {es} {ref}/docs-bulk.html[bulk] API to load your own data.
...
and are good to start exploring. If you load your own data, you can create an index
pattern in <<management, Management>>.

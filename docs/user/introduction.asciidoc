...
You might be managing tens, hundreds, or even thousands of dashboards, visualizations, and other Kibana assets.
...
{kib}
<<xpack-spaces, Spaces>> is built for organizing your visualizations, dashboards, and index patterns.
...
To view the full list of {kib} apps and features, go https://www.elastic.co/kibana/features[{kib} features].

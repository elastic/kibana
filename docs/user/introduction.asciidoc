...
A dedicated view for creating, searching, and editing rules is in <<managing-alerts-and-actions,*Rules and Connectors*>>.
...
|Set up rules
|<<managing-alerts-and-actions,Stack Management > Rules and Connectors>>

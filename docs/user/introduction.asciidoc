...
{kib} is an extensible user interface that enables you to
shape your data and navigate the Elastic Stack.  With {kib}, you can:
...
For a reference of all {kib} use cases, refer to <<whats-the-right-app,What’s the right app for you?>>
...
Hidden by default, you can open the main menu by clicking the
hamburger icon. To keep the main menu visible at all times, open the main menu, and then click *Dock navigation*.
...
search for applications and objects, including

...
A dedicated view for creating, searching, and editing rules is in <<rule-management,*Rules and Connectors*>>.
...
|Set up rules
|<<rule-management,Stack Management > Rules and Connectors>>

...
* Generate a PDF report https://www.elastic.co/subscriptions[(only available with Gold licence and above)]
* Generate a PNG report https://www.elastic.co/subscriptions[(only available with Gold licence and above)]

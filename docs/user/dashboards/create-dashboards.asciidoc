...
** **Add panel**. Choose one of the available panels to add and configure content to your dashboard.
...
You can import dashboards from the **Saved Objects** page under **Stack Management**

...
NOTE: The {kib} Console enables you to interact only with the {es} REST API, not the {kib} REST API. For more information about the {es} REST API, refer to the <<console-kibana, Console>> documentation. 

...
. <<defining-rules-general-details, General rule details>>
. <<defining-rules-type-conditions, Rule type and conditions>>
. <<defining-rules-actions-details, Action type and action details>>

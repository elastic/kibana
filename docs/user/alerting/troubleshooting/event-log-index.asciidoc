...
Usually, the most expensive Rules also have the highest `event.duration`. You can check 
top expensive rules by loading https://gist.github.com/pmuellr/e9ac5cda106589dc52477ede9accb20c[this dashboard] or running this query:
      ...
      "must": [
        {
          "query_string": {
            ...
            "query": "event.provider:alerting AND event.action:execute"
          }
        }
      ]
    }

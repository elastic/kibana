...
For <<alerting-scaling-guidance>> when relying on alerts and actions as mission critical services, see <<alerting-production-considerations,Alerting production considerations>>.

...
At a higher level, Alerting allows rich integrations across use cases like {apm-guide-ref}/apm-overview.html[APM], {observability-guide}/ingest-metrics.html[Metrics], {security-guide}/es-overview.html[Security], and {observability-guide}/ingest-uptime.html[Uptime].

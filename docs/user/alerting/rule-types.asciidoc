...
You can create most rules types in Stack Management > Rules and Connectors. For information on creating security rules, refer to {security-guide}/rules-ui-create.html[Create a detection rule].
...
Stack rules are built into {kib}. To access the *Stack Rules* feature and create and edit rules, users require the `all` privilege. See {kib} privileges for more information.

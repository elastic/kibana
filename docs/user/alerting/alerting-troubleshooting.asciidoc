...
<3> Execution durations are stored as nanoseconds. This interval buckets the duration into 10 second intervals. Update this value to change the granularity of the buckets.
<4> This retrieves the top 10 rule ids for this duration interval. Update this value to retrieve more rule ids.

...
Connectors for actions could be created in the UI or via API.
For out-of-the-box and standardized connectors there is the ability to <<pre-configured-connectors, pre-configure connectors>>, before {kib} has even started.

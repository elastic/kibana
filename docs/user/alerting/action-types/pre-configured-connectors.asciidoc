...
When you open the menu, click *Stack Management > Alerts and Actions*. Preconfigured connectors
...
. Open the menu, click *Stack Management > Alerts and Actions*, then open the *Connectors* tab.

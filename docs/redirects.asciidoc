...
For more {kib} configuration settings, Settings.
...
This content has moved. Refer to Secure access to {kib}.
...
This content has moved. Refer to {kib} role management.

...
This page was deleted. Please see <<dashboard>>.

[float]
[[development-functional-tests]]
=== Development Functional Tests

This page has been moved. Please see <<Testing>>.

[float]
[[kibana-keystore-has-moved-from-the-data-folder-to-the-config-folder]]
=== Kibana Keystore has moved from the Data Folder to the Config Folder

This page has been deleted. Please see link:https://www.elastic.co/guide/en/kibana/7.9/breaking-changes-7.9.html#user-facing-changes-79[Breaking changes in 7.9].

[float]
[[createvis]]
=== Create Visualization

This page has been deleted. Please see <<dashboard>>.
...
This page has been moved. Please see <<Watcher>>.

[float]
[[add-canvas-events]]
=== Add Canvas Elements

This page has been moved. Please see <<Canvas>>.

[float]
[[vega-lite-tutorial]]
=== Vega-Lite Tutorial

This page has been moved. Please see <<Create your first visualization with Vega-Lite>>.

[float]
[[heatmap-chart]]
=== Heatmap Chart

This page has been moved. Please see <<Heat map layer>>.

[float]
[[interface-overview]]
=== Interface Overview

This page has been moved. Please see <<Dashboard>>.
...
This page has been moved. Please see <<Create custom dashboard actions>>.

[float]
[[rpm]]
=== Install Kibana with RPM

This page has been moved. Please see <<Install Kibana with RPM>>.

[float]
[[automating-report-generation]]
=== Automating Report Generation

This page has been moved. Please see <<Automating Report generation>>.

[float]
[[development-plugin-localization]]
=== Localization for plugins

This page has been moved. Please see <<Localization for plugins outside the Kibana repo>>.

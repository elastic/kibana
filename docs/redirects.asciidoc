...
This content has moved. Refer to <<embedded-content-authentication>> and <<reporting-getting-started>>.

[role="exclude",id="workpad-share-options"]
== Share your workpad

This content has moved. Refer to <<reporting-getting-started>>.

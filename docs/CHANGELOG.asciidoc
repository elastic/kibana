...
*Impact* +
To attach alerts to cases, you must have `Read` access to Observability or Security, and `Write` access to the case. For detailed information, check <<kibana-privileges, {kib} privileges>> and <<setup-cases>>. 
====
...
*Impact* +
To improve task execution resiliency, remove the deprecated settings from the `kibana.yml` file. For detailed information, check <<task-manager-settings>>.
====
...
Dashboard::
Adds the ability to scroll the panel section {kibana-pull}145628[#145628]
...
* Adds button and minimal editor settings {kibana-pull}151161[#151161]
...
Machine Learning::
* DFA creation wizard: add ability to add time field to result data view {kibana-pull}155669[#155669]
...
* Data Frame Analytics: support custom urls in jobs {kibana-pull}154287[#154287]
...
* Explain Log Rate Spikes: Support to filter fields from grouping {kibana-pull}153864[#153864]
* Custom sorting by message level on Notifications page {kibana-pull}153462[#153462]
* Log pattern analysis in Discover {kibana-pull}153449[#153449]
...
* Adds more system indices for storing internal data {kibana-pull}154888[#154888]
* Adds option to Reauthorize transform in Management page {kibana-pull}154736[#154736]
* Adds secondary authorization header to Transforms in Fleet {kibana-pull}154665[#154665]
...
* Adds link from Index management {kibana-pull}152640[#152640]
...
Security::
* Adds the ability to configure remote index privileges directly from Role management {kibana-pull}154948[#154948]
* Adds the Cloud_defend process index as a source and merged process event handling {kibana-pull}153213[#153213]
...
* Fixes Changing label of a geospatial filter on causes filter disappear from map {kibana-pull}154087[#154087]
...
Fleet::
* Fixes package license check to use new constraints.elastic.subs… {kibana-pull}154831[#154831]
...
Security::
Fixes Session view and k8s dashboard {kibana-pull}154982[#154982]

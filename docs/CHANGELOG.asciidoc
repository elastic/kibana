...
*Impact* +
To attach alerts to cases, you must have `Read` access to Observability or Security, and `Write` access to the case. For detailed information, check <<kibana-privileges>> and <<setup-cases>>. 
====

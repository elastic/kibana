...
=== Bug Fixes
Canvas::
* Fixes bugs in interactive workpad {kibana-pull}110385[#110385]
...
Machine Learning::
* Fixes Anomaly Explorer data points not showing up because of missing indices {kibana-pull}110899[#110899]
Maps::
...
Uptime::
* Search filter input - remove undesired blur {kibana-pull}110314[#110314]

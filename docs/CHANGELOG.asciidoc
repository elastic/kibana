...
* Removes `error.id` in `getErrorGroupMainStatistics` query ({kibana-pull}210613[#210613]).
...
* Handles empty categorization results from LLM ({kibana-pull}210420[#210420]).
Platform::

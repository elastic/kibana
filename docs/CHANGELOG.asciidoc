...
[discrete]
[[known-185691]]
.When using the AI Assistant with the OpenAI Connector, function calling will result in an error
[%collapsible]
====
*Details* +
In 8.14.3, if you are using the AI Assistant with the OpenAI Connector, function calling will result in an error.
...
. Toggle the option for _Simulate function calling_ to *On*.

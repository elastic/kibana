...
Discover::
* Fixes an issue with CSV Post URLs incorrectly using an absolute time range instead of a relative one ({kibana-pull}223249[#223249]).

Elastic Observability solution::
* Fixes an issue in Synthetics that could cause the screenshot of the first step to show for each step of the last successful test run ({kibana-pull}224220[#224220]).
...
* Fixes an APM error count waterfall navigation reload issue ({kibana-pull}221664[#221664]).
* Fixes an issue preventing metrics graphs from correctly showing in the Services Inventory page ({kibana-pull}222439[#222439]).
* Fixes pagination not working on Service Inventory page when progressive loading is enabled ({kibana-pull}220514[#220514]).
...
* Anomaly Explorer: Correctly respect the selected Overall swimlane bucket for view by `jobId` ({kibana-pull}222845[#222845]).
* File upload: Fixes adding additional field when a pipeline is blank ({kibana-pull}222775[#222775]).
* Trained Models: Fixes inference endpoints assignment ({kibana-pull}222076[#222076]).
* File upload: Correctly restrict auto-deployment to Elastic models ({kibana-pull}221357[#221357]).

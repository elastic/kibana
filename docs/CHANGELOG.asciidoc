...
[partintro]
--
// Use these for links to issue and pull requests. 
// NOTE: Issues and pull requests redirect to each other on Github, so don't worry about using the right prefix.
:issue: https://github.com/elastic/kibana/issues/
:pull: https://github.com/elastic/kibana/pull/

Review important information about {kib} 7.x.x releases. 
...
The {kib} 7.12.0 breaking changes can prevent your application from optimal operation and performance. Before you upgrade to 7.12.0, review the breaking changes, then mitigate the
...
====
*Details:* +
The `ingestManager` plugin has been renamed `fleet`.
...
For more information, refer to https://github.com/elastic/kibana/pull/83200[#83200].
====

[discrete]
[[reporting_plugin_added_new_validation_for_protocol]]
==== Reporting changes
...
*Impact* +
Refer to {kibana-ref}/reporting-network-policy.html[Restrict requests with a Reporting network policy].
...
will fail and {kib} will not start.

For more information, refer to https://github.com/elastic/kibana/pull/80766[#80766].
====
...
[discrete]
[[lens-and-visualizations-deprecations]]
==== Lens and visualizations deprecation
.Deprecates the `visualization:colorMapping` advanced setting
[%collapsible]
====
*Details* +
The `visualization:colorMapping` advanced setting is deprecated in the 7.12.0 release. For more information, refer to {kibana-pull}83372[#83372].

*Impact* +
The `visualization:colorMapping` advanced setting is no longer available in kibana.yml.
====

[discrete]
[[management-deprecations]]
==== Management deprecations
.Deprecates three Stack Management settings
[%collapsible]
====
*Details* +
* Deprecates the `kibana.index` setting. For more information, refer to {kibana-pull}83988[#83988].
* Deprecates the `reporting.index` setting. For more information, refer to {kibana-pull}84005[#84005].
* Deprecates the `xpack.task_manager.index` setting. For more information, refer to {kibana-pull}84155[#84155].

*Impact* +
The `kibana.index`, `reporting.index`, and `xpack.task_manager.index` settings are no longer available in kibana.yml.
====

[discrete]
[[security-deprecations]]
==== Security deprecations
.Deprecates two Security settings
[%collapsible]
====
*Details* +
* Deprecates disabling the spaces plugin. For more information, refer to {kibana-pull}83984[#83984].
* Deprecates disabling the security plugin. For more information, refer to {kibana-pull}85159[#85159].

*Impact* +
The space and security plugins are enabled.
====
...
APM::
* Adds APM agent config options {kibana-pull}84678[#84678]
Canvas::
* Adds a layout option to generate full-page *Canvas* reports {kibana-pull}84959[#84959]
Dashboard::
* Adds the ability to export CSV *Lens* visualizations {kibana-pull}83654[#83654]
Discover::
* Adds new responsive layout {kibana-pull}83633[#83633]
Fleet::
* Adds the *Agent logs* UI {kibana-pull}83356[#83356]
Lens and visualizations::
Lens:::
* Adds the *Median* function {kibana-pull}79453[#79453]
* Adds in-product help to the fields list {kibana-pull}85544[#85544]
* Adds value labels in bar charts {kibana-pull}81776[#81776]
* Adds *Last value* setting {kibana-pull}83437[#83437]
* Adds sorting to data tables {kibana-pull}84435[#84435]
TSVB:::
* Adds support for HDR percentiles {kibana-pull}78306[#78306]
* Adds *Ignore global filters* to series options{kibana-pull}79337[#79337]
Machine Learning::
...
Management::
* Adds the *Form* UI {kibana-pull}81766[#81766]
Maps::
* Adds support for URL drilldowns {kibana-pull}83732[#83732]
* Adds the ability to tag saved objects {kibana-pull}83197[#83197]
* Adds percentile {kibana-pull}85367[#85367]
* Adds on-prem EMS configuration {kibana-pull}82525[#82525]
Metrics::
...
For more information about the features introduced in 7.12.0, refer to 
link:https://www.elastic.co/blog/whats-new-kibana-7-11-0-alerting-generally-available[What’s new in Kibana 7.11.0: Alerting is now generally available].

For detailed information about the 7.12.0 release, refer to <<enhancement-v7.11.0,Enhancements>> and <<bug-v7.11.0,Bug fixes>>.
...
The 7.11.1 release includes the following enhancements and bug fixes. For information on the breaking changes, refer to breaking changes.
...
For the 7.11.0 breaking changes, refer to breaking changes.
...
For detailed information about the 7.10.2 release, review the following bug fixes. For the breaking changes, refer to the breaking changes in 7.10.
...
For the breaking changes, refer to the breaking changes.
...
For more information, refer to breaking changes.

[[release-notes-7.9.3]]
== {kib} 7.9.3

For breaking changes, refer to breaking changes.
...
See breaking changes for the changes to be aware of when migrating your application

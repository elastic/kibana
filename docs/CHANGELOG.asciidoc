...
The 8.2.1 release includes the following bug fixes.
...
* Removes the rule of color applying {kibana-pull}131128[#131128]
Machine Learning::
...
* Fixes condition auto-completion for templates {kibana-pull}126881[#126881]
Maps::

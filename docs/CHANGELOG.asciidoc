...
Multipage Canvas visualizations stops advancing after one page when in autoplay mode. 

*Workaround* +
Manually advance to the next page or upgrade to 8.19.18, 9.3.7.

*Resolved* + 
This issue is resolved in 8.19.18, 9.3.7.
====

...
Reporting::
* Config setting `xpack.reporting.enabled` has a bug and Kibana will fail to
start up if the config key exists in `kibana.yml`. There is no workaround until
a patch fix is released. {kib-pull}69645[#69645]

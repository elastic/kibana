...
Security::
* Adds context information in Risk Summary ({kibana-pull}174574[#174574]).
* Adds the Asset Criticality selector for new entity flyouts ({kibana-pull}174438[#174438]).
...
Cases::
* Adds support default values for required custom fields ({kibana-pull}175961[#175961]).
* Collects custom fields telemetry metrics for cases plugin in {kib} ({kibana-pull}175425[#175425]).
* Persists all filter options of the cases table in the URL ({kibana-pull}175237[#175237]).
Dashboard::
...
* Adds external link icon ({kibana-pull}174407[#174407]).
* Re-adds filtering settings in the Control settings UI ({kibana-pull}172857[#172857]).
* Adds numeric options list ({kibana-pull}172106[#172106]).
Discover::
* Hides the Empty fields section if there are no fields in it ({kibana-pull}172956[#172956]).
* Adds tabs to Discover and Log Explorer ({kibana-pull}171467[#171467]).
* Adds multiple improvements to saved query management ({kibana-pull}170599[#170599]).
* Adds header row height configuration ({kibana-pull}175501[#175501]).
* Adds new fields ingested in the background with valid mappings ({kibana-pull}172329[#172329]).
...
* Adds line breaks redesign ({kibana-pull}173596[#173596]).
...
Management::
* Change the column components in the index templates table ({kibana-pull}175823[#175823]).
Maps::
...
* Adds the asset criticality UI ({kibana-pull}173512[#173512]).
* Show Asset Criticality in Risk Input flyout ({kibana-pull}174638[#174638]).
* Restrict management page based on user privileges ({kibana-pull}173178[#173178]).
* Merge risk input and asset integration expandable panels ({kibana-pull}173028[#173028]).
* Require full risk engine privileges to enable, disable and init the risk engine ({kibana-pull}172932[#172932]).
...
Cases::
* Update UI to use custom field internal API ({kibana-pull}176574[#176574]).
Dashboard::
...
* Reverts changes to `useLicense` hook ({kibana-pull}174372[#174372]).
...
Security::
* Prevents multiple duplicated calls to index_status API on alert details page ({kibana-pull}176573[#176573]).
SharedUX::

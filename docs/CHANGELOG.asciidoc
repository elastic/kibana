...
Geo::
* Removes geojson deep clone logic, handle on maps side {pull}41835[#41835]
* Fixes maps geojson upload hanging on index step {pull}42623[#42623]
* Formats doc-ids as strings {pull}42011[#42011]
* Fits only on visible features {pull}42020[#42020]
Infra Logs UI::
...
* Restores discover histogram selection triggering fetch {pull}43097[#43097]

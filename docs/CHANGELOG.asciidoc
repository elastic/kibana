...
[discrete]
[[breaking-184036]]
* Adds rate limiting to install by upload endpoint ({kibana-pull}184036[#184036]).
...
* Kibana's `rolling-file` appender now supports more advanced retention policies. Refer to the [Kibana logging documentation](https://www.elastic.co/guide/en/kibana/current/logging-configuration.html#rolling-file-appender) for more details ({kibana-pull}182346[#182346]).
Security::

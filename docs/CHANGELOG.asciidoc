...
The 7.12.0 breaking changes can prevent your application from optimal operation and performance. Before you upgrade to 7.12.0, review the breaking changes, then mitigate the
...
[discrete]
[[breaking-change-title-1]]
==== Application changes
.Information about the breaking change.
[%collapsible]
====
*Details:* +
Details about the breaking change.

*Impact* +
Impact from the breaking change.

For more information, refer to https://github.com/elastic/kibana/pull/83200[#83200].
====

[discrete]
[[breaking-change-title-2]]
==== Application changes
.Information about the breaking change.
[%collapsible]
====
*Details:* +
Details about the breking change. 
...
The 7.12.0 release includes the following new and notable features. 

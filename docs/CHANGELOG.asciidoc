...
Canvas::
* Updates the https://github.com/elastic/kibana/blob/master/x-pack/plugins/canvas/README.md[README.md] to reflect that Canvas plugins must now use the Kibana platform. {pull}30816[#30816]

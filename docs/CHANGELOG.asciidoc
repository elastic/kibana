...
* Data Frame Analytics creation wizard: add validation step (Part 1) {kibana-pull}93478[#93478]
...
* Support Kibana index patterns in the Logs UI settings UI {kibana-pull}94849[#94849]
Machine Learning::
...
* Anomaly detection rule lookback interval improvements {kibana-pull}97370[#97370]
* Adds annotation markers to the Anomaly Swimlane axis {kibana-pull}97202[#97202]
...
Metrics::
* Increase groupBy pagination size on Metric Threshold alerts {kibana-pull}99683[#99683]
* Adds anomalies tab to enhanced node details {kibana-pull}96967[#96967]
...
APM::
* Transaction type is not persisted from service inventory {kibana-pull}99407[#99407]
* Service overview page fetches data with wrong transaction type {kibana-pull}98657[#98657]
* Transaction duration histogram buckets without samples are clickable {kibana-pull}98540[#98540]
* Bug: Fix header controls (type, search, comparison, and date picker) responsive breakpoints {kibana-pull}98179[#98179]
* Home page is showing incorrect value of APM throughput (tpm) {kibana-pull}95991[#95991]
* Fixes spaces issue for static index patterns {kibana-pull}95799[#95799]
* The Observability Getting Started page infinitely redirects, breaking browser's back button {kibana-pull}95083[#95083]
Canvas::
...
* Fixes default integration name when adding 10+ names {kibana-pull}93278[#93278]
...
* DF Analytics map: deselect node after node action or flyout close {kibana-pull}97922[#97922]
...
* Fixes switches positioning on the Transform and DFA wizards {kibana-pull}96535[#96535]
...
* Adds pagination control to datavisualizer failures to rendering all errors at a single time {kibana-pull}93839[#93839]

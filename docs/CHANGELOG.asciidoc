...
[[release-notes-prototype-major]]
== {kib} 7.0.0 released with a fresh, sleek look and more



To learn more about the {kib} 7.0.0 release, review the following:

<<enhancements-7.0.0>> | <<breaking-changes-7.0.0>> | <<deprecations-7.0.0>> | <<bug-fixes-7.0.0>> | <<security-updates-7.0.0>> | <<known-issues-7.0.0>>

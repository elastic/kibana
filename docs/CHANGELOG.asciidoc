...
The 7.11.2 release includes the following security update, known issues, and bug fixes. For information on the breaking changes, refer to <<breaking-changes-7.11,Breaking changes in 7.11>>.

[float]
[[security-update-v7.11.2]]
=== Security update

Security update for 7.11.2.

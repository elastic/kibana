...
Kibana platform::
* Remembers the user grid state when navigating back from edit on the **Users** page ({kibana-pull}261152[#261152]).
...
* Fixes missing sort-state announcements for screen readers on the ingest pipelines table ({kibana-pull}262226[#262226]).
* Fixes screen readers announcing duplicate row indices on the ingest pipelines table ({kibana-pull}261369[#261369]).

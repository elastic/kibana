...
You configure the cleanup interval with the `xpack.security.session.cleanupInterval` setting.
...
share cookie across all applications hosted using the same host name, ignoring ports.

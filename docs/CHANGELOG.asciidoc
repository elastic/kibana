...
Querying & Filtering::
* Filter sets can now be shared between multiple spaces ({kibana-pull}163436[#163436]).
Uptime::
...
* Adds improvements to the filter set terminology {kibana-pull}154517[#154517]
...
Lens & Visualizations::
* All filter sets are now returned on the list instead of only the first 50 {kibana-pull}145554[#145554]

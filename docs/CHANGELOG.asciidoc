...
The 7.17.29 release includes the following fixes.
...
* Allows grouping for IP type fields in custom threshold rules ({kibana-pull}216062[#216062]).

Kibana security::
* Fixes an issue where the Saved Objects Rotate Encryption Key API would not affect sharable encrypted object types that exist in all spaces ({kibana-pull}217625[#217625]).
...
The 7.17.24 release includes the following bug fixes.
...
Machine Learning::
* Improving empty object creation ({kibana-pull}191836[#191836]).
* Improving empty object creation ({kibana-pull}191518[#191518]).

Observability::
* Change infra plugin feature name from Metrics to Infrastructure ({kibana-pull}189432[#189432]).

[float]
[[deprecations-7.17.24]]
=== Deprecations

* Removes support for Heartbeat browser monitor screenshots for lower versions of Heartbeat. Please upgrade to Heartbeat 7.17.24 to continue using Heartbeat browser monitor screenshots. ({kibana-pull}189911[#189911])

[[release-notes-7.17.23]]
== {kib} 7.17.23

The 7.17.23 release includes the following known issues and bug fixes.
...
=== Bug Fixes
Machine Learning::
* Fixes an issue with empty object creation ({kibana-pull}186821[#186821]).
* Removes the use of the **RE2** library ({kibana-pull}186104[#186104]).

Platform::
* Fixes a race condition that could cause intermittent upgrade migration failures when Kibana connects to a single-node Elasticsearch cluster ({kibana-pull}158182[#158182]).

Security::
* Updates node spawn process hardening ({kibana-pull}186786[#186786]).
...
The 7.17.19 release includes the following enhancements.

[float]
[[fixes-v7.17.19]]
=== Enhancements
Discover::
* Improves the performance of `getFieldsToShow` for large data views ({kibana-pull}144672[#144672]).
...
The 7.17.17 release includes the following bug fixes.

[float]
[[fixes-v7.17.17]]
=== Bug Fixes
Reporting::
* Fixes the handling of content stream errors in reports before deletion ({kibana-pull}173792[#173792]).

[[release-notes-7.17.16]]
== {kib} 7.17.16

Review the following information about the {kib} 7.17.16 release.

[float]
[[security-update-v7.17.16]]
=== Security updates
...
=== Bug Fixes
Discover::
* Fixes support for nested field columns in CSV reports {kibana-pull}172240[#172240].
...
that {kib} 7.x versions are not affected by this issue. We previously
reported this issue impacted {kib} versions before 7.17.15.

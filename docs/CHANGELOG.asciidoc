...
*Impact* +
To auto-fit the table row height, create an <<add-aggregation-based-visualization-panels,aggregation-based data table>>, click *Options*, then select *Auto fit rows to content*.
====
...
*Impact* +
When you upgrade to 7.16.0, you are unable to use the *Timelion* app. The <<timelion,*Timelion*>> visualization editor is still supported. 
====
...
[discrete]
[[deprecation-111676]]
.Deprecates `xpack.security.enabled`
[%collapsible]
====
*Details* +
The `xpack.security.enabled` setting is deprecated and will be removed in 8.0.0. For more information, refer to {kibana-pull}111676[#111676].
...
Lens & Visualizations::
* Thresholds added in *Lens* {kibana-pull}108342[#108342]
...
* APM Correlations: Log log chart enhancements {kibana-pull}113039[#113039]
* Adds KQL filter bar, filtering functionality, and compact design to Index data visualizer {kibana-pull}112870[#112870]
* APM Correlations: Chart for failed transactions correlations tab {kibana-pull}110172[#110172]
Management::
...
* Replaces Select with GroupButtons to show available platforms {kibana-pull}114818[#114818]
...
* Adds icons to Integrations global search results {kibana-pull}111131[#111131]
...
* Display advanced mode toggle for the APM failed transactions table {kibana-pull}114363[#114363]
...
* Convert APM transaction anomaly detection job to analyze metric data {kibana-pull}111957[#111957]
* APM Correlations: Chart for failed transactions correlations tab {kibana-pull}110172[#110172]
...
* Populate date fields for Transform {kibana-pull}108804[#108804]
...
Monitoring::
* Remove angular dep from legacy shims {kibana-pull}109132[#109132]
Observability::
* APM-Fleet integration version check & upgrade message {kibana-pull}115297[#115297]
* Enhancements errors list page {kibana-pull}115194[#115194]
* Revert multi-metric ML job {kibana-pull}114961[#114961]
* Alert creation and freeform selection {kibana-pull}111883[#111883]
...
* Browser monitors - Zip Url - add TLS Options and Proxy Url {kibana-pull}112554[#112554]
* Adds "Add to case" button {kibana-pull}112463[#112463]

...
=== Bug Fixes
APM::
* Only filter on transaction metrics for instance throughput stats {kibana-pull}114758[#114758]
* Fix loading of latency distribution chart on trace samples tab in load balanced setups {kibana-pull}114615[#114615]
* Show trace samples even when overall histogram chart fails to load {kibana-pull}114247[#114247]
Elastic Security::
...
Operations::
* Fixes the creation of multiple processes at start {kibana-pull}114940[#114940]
Osquery Manager::
* Fixes the bug that caused the live query search to return irrelevant results for agents {kibana-pull}116332[#116332]
* Improves Osquery SQL query parser logic {kibana-pull}114932[#114932]
...
[float]
[[known-issues-v7.15.1]]
=== Known issues

Before you upgrade, review the known issues, then mitigate the impact to your application. 

There are no known issues in 7.15.1. 

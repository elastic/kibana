...
[[known-issue-tofillin]]
.Metric visualization progress bars get turned off on upgrade
[%collapsible]
====
*Details* +
When upgrading to 8.6, progress bars on existing Lens metric visualizations get hidden.

To show the progress bar again, open the visualization in the Lens editor. Click the dimension button for the primary metric to open the dimension editor. Then, under "Supporting visualization," select "Bar."
====

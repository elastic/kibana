...
*Impact* +
For each <<xpack-spaces,space>>, complete the following to change *histogram:maxBars* to the previous default setting:
...
Security::
The API Keys screen can be accessed in a Read Only view with the the cluster privilege `read_security` {kibana-pull}144923[#144923]
...
APM::
* Mobile most used pie charts with Lens {kibana-pull}144232[#144232]
* Multi metric partition charts {kibana-pull}143966[#143966]
* Adds missing options to APM central config {kibana-pull}143668[#143668]
* Adds waterfall to dependency operations {kibana-pull}143257[#143257]
* Display configuration table above code sample {kibana-pull}143178[#143178]
* Implement improvements to AWS Lambda metrics view {kibana-pull}143113[#143113]
* Display featured integrations at top of integrations list per category {kibana-pull}142771[#142771]
...
* Improves the Quickfunction in-product assistance in *Lens* {kibana-pull}141399[#141399]
...
Platform::
* Allow date functions in formula {kibana-pull}143632[#143632]
...
Security::
* Adds readonly view to user management {kibana-pull}143438[#143438]
* Adds `user.id` field to audit log {kibana-pull}141092[#141092]
...
APM::
* Show recommended minimum size when going below 5 minutes {kibana-pull}144170[#144170]
* Fixes ml permissions by removing usage of `canAccessML` {kibana-pull}143631[#143631]
* Fallback to terms agg search if terms enum doesn’t return results {kibana-pull}143619[#143619]
...
Dashboard::
* Skip First Reload {kibana-pull}142868[#142868]

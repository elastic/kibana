...
For detailed information about the {kib} 7.12.0 release, review the following information.
...
====
*Details:* +
Geo containment alerts and the Geo threshold alert type have similar functionality, so the Geo threshold alert type has been removed.

*Impact* +
Use Geo containment alerts.

For more information, refer to {kibana-pull}89632[#89632].
====
...
{kib} 7.12.0 adds the following new and notable features. For more information about the features introduced in 7.12.0, refer to 
...
* Adds support for histogram mapping type for all numeric functions {kibana-pull}90357[#90357]
...
For detailed information about the 7.12.0 release, refer to <<enhancements-and-bug-fixes,Enhancements and bug fixes>>.
...
Lens and visualizations::
* Adds more in-editor Advanced documentation {kibana-pull}86821[#86821]
* Adds specific IP and Range/Interval sorting to datatable {kibana-pull}87006[#87006]
* Use datagrid with resizable columns for datatable {kibana-pull}88069[#88069]
* Use first decimal when required for data summaries {kibana-pull}88463[#88463]
* Hide column in table {kibana-pull}88680[#88680]
* Table column text alignment {kibana-pull}89300[#89300]
* Allow custom label for fields via index pattern field management {kibana-pull}84612[#84612]
...
* User should be able to set a specific tilemap service using the mapStyle property {kibana-pull}88440[#88440]
* Leaflet (https://leafletjs.com/) map layer in *Vega* was replaced by MapBox (https://www.mapbox.com/) {kibana-pull}88605[#88605]
* Communicate the index pattern to the dashboard {kibana-pull}90623[#90623]
* Adds a new "Series Agg" to count the number of series {kibana-pull}91225[#91225]
* Support min and max with histogram data types {kibana-pull}91581[#91581]
...
The 7.11.1 release includes the following enhancements and bug fixes. For information about the breaking changes, 
refer to link:https://www.elastic.co/guide/en/kibana/7.11/breaking-changes-7.11.html[Breaking changes in 7.11].
...
For the 7.11.0 breaking changes, refer to link:https://www.elastic.co/guide/en/kibana/7.11/breaking-changes-7.11.html[Breaking changes in 7.11].
...
For detailed information about the 7.10.2 release, review the following bug fixes. For the breaking changes, 
refer to the link:https://www.elastic.co/guide/en/kibana/7.10/breaking-changes-7.10.html[Breaking changes in 7.10].
...
For the breaking changes, refer to the link:https://www.elastic.co/guide/en/kibana/7.10/breaking-changes-7.10.html[Breaking changes in 7.10].
...
<<enhancement-v7.10.0,Enhancements>> | <<bug-v7.10.0,Bug fixes>> | <<deprecation-v7.10.0,Deprecations>>
...
For breaking changes, refer to link:https://www.elastic.co/guide/en/kibana/7.9/breaking-changes-7.9.html[Breaking changes in 7.9].
...
See also link:https://www.elastic.co/guide/en/kibana/7.9/breaking-changes-7.9.html[Breaking changes in 7.9].
...
See also link:https://www.elastic.co/guide/en/kibana/7.8/breaking-changes-7.8.html[Breaking changes in 7.8].
...
See link:https://www.elastic.co/guide/en/kibana/7.7/breaking-changes-7.7.html[Breaking changes in 7.7].
...
See link:https://www.elastic.co/guide/en/kibana/7.6/breaking-changes-7.6.html[Breaking changes in 7.6].
...
See also link:https://www.elastic.co/guide/en/kibana/7.6/breaking-changes-7.6.html[Breaking changes in 7.6].
...
See link:https://www.elastic.co/guide/en/kibana/7.5/breaking-changes-7.5.html[Breaking changes in 7.5].
...
See also link:https://www.elastic.co/guide/en/kibana/7.5/breaking-changes-7.5.html[Breaking changes in 7.5].
...
Also see link:https://www.elastic.co/guide/en/kibana/7.4/breaking-changes-7.4.html[Breaking changes in 7.4].
...
See also link:https://www.elastic.co/guide/en/kibana/7.4/breaking-changes-7.4.html[Breaking changes in 7.4].
...
See also link:https://www.elastic.co/guide/en/kibana/7.3/breaking-changes-7.3.html[Breaking changes in 7.3].
...
See also link:https://www.elastic.co/guide/en/kibana/7.2/breaking-changes-7.2.html[Breaking changes in 7.2].
...
See link:https://www.elastic.co/guide/en/kibana/7.2/breaking-changes-7.2.html[Breaking changes in 7.2] for more information.
...
See link:https://www.elastic.co/guide/en/kibana/7.0/breaking-changes-7.0.html[Breaking changes in 7.0] for the changes to be aware of when migrating your application
...
link:https://www.elastic.co/guide/en/kibana/7.0/breaking-changes-7.0.html[Breaking changes in 7.0].

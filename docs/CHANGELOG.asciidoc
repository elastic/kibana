...
* Register ML embeddables synchronously ({kibana-pull}225110[#225110]).
Data ingestion and Fleet::
* Fixes backfill agentless logic for all packages ({kibana-pull}225767[#225767]).
* Update query in delete unenrolled agents task ({kibana-pull}224808[#224808]).
Elastic Observability solution::
For the Elastic Observability 8.18.4 release information, refer to [Elastic Observability Solution Release Notes](docs-content://release-notes/elastic-observability/index.md).
Elastic Security solution::
For the Elastic Security 8.18.4 release information, refer to [Elastic Security Solution Release Notes](docs-content://release-notes/elastic-security/index.md).
Search::

...
[[release-notes-prototype]]
== {kib} 7.0.0 -- high-level of cool, or group of cool, new features in this release

coming[7.0.0]

This is a summary of a cool, or a group of cool, new features in this release. For the features introduced in 7.0.0, refer to link:https://www.elastic.co/blog/kibana-7-0-0-released[Kibana 7.0.0 released].

To learn more about the {kib} 7.0.0 release, review the following:

...
this version of Kibana is not available in the Red Hat Ecosystem Catalog.
This bug will be fixed in the next release.
Please use the https://www.docker.elastic.co/r/kibana/kibana[Elastic docker registry] to download the 8.5.0 Kibana image.

...
[discrete]
[[breaking-103652]]
.Migrates machine learning URL generators to locators
[%collapsible]
====
*Details* +
In *Machine Learning*, *APM*, *Logs*, and *Security*, the machine learning URL generator has been replaced with a machine learning locator. For more information, refer to {kibana-pull}103652[#103652].

*Impact* +
When you upgrade, the URL generators are automatically migrated to use the new locators. 
====

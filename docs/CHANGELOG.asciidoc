...
Code::
* Adding more coverage for syntax highlighting {pull}41393[#41393]
* Fix mocha, jest test file path {pull}40574[#40574]
* Append go env variable 'GOCACHE'  to go lsp spawn command. {pull}44864[#44864]
* Fix the env $PATH when the go lsp spawned in windows {pull}45011[#45011]
* Update git repository update frequency {pull}41541[#41541]
* Remove the disableIndexScheduler flag {pull}42179[#42179]
* Do not persist git update error {pull}42629[#42629]
* Enforce progress update at the end of the index job {pull}43381[#43381]
* Exclude from getting write privilege when choosing all {pull}43700[#43700]
* Adjust the orders of delete steps to avoid long lang server initialization stage {pull}43893[#43893]
* Fixed the issue that the repository can not be deleted in some cases. {pull}42841[#42841]
* Test colorize before load a file {pull}41645[#41645]
* Handle status when repo is not exists {pull}41643[#41643]
* Bump nodegit version {pull}42332[#42332]
* Fixed lang server install status {pull}43164[#43164]
* Fix workspace dir case-sensitive problem {pull}43571[#43571]
* Fix a launching embed ctag-langserver problem {pull}43561[#43561]
* Fix git for large repos {pull}43669[#43669]
* Don't show &quot;NO DEFINITION&quot; if multiple definitions found {pull}43964[#43964]
* Remove 'server is initializing error' {pull}44074[#44074]
* Try fix this test {pull}43692[#43692]
* Try fix ts-lang shutdown unit test {pull}37618[#37618]
Dashboard::
...
Security::
* Spaces - allow for hex color codes that include uppercase characters {pull}43470[#43470]
...
Code::
* Localization support for Code {pull}41751[#41751]
* Downgrade the log level of error message from subprocess {pull}42925[#42925]
* Remove the redundant content in the reference title. {pull}40481[#40481]
* Enable go langserver under non-detach mode. {pull}42352[#42352]
* Enable go langserver under production mode {pull}42678[#42678]
* Add option to turn the go dependency download on/off. {pull}43096[#43096]
* Remove the outdated deps download control approach {pull}43940[#43940]
* Make delete job be able to wait on the cancellations of other jobs {pull}41417[#41417]
* Initial server side refactor to shim the new platform server API {pull}41192[#41192]
* Initial browser side refactor to shim the new platform browser API {pull}41722[#41722]
* Disk watermark check for clone and update {pull}42174[#42174]
* Disk watermark supports percentage and absolute modes {pull}42987[#42987]
* Cancel clone/update job in the middle if disk space over the watermark {pull}42890[#42890]
* Initial commit Indexer {pull}39599[#39599]
* Add commit history search API {pull}43930[#43930]
* Add a resolveSnippets API to resolve APM stacktrace item to source code {pull}43822[#43822]
* Support case insensitive repository uri in files Apis and LSP requests {pull}41665[#41665]
* Refactored the queue to process tasks belong to local node only. {pull}42708[#42708]
* Refactored the queue to process tasks belong to local node only. {pull}42601[#42601]
* Implement filtree api by using isogit {pull}41558[#41558]
* Distributed Code abstraction {pull}41374[#41374]
* Be able to fallback to generic lang server if dedicated lang s… {pull}42317[#42317]
* Make ctag lang server embed {pull}43170[#43170]
* Show multiple definition results in panel {pull}43249[#43249]
Dashboard::

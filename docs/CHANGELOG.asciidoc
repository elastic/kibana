...
* Visualizes renderer to support Canvas visualizations {pull}29170[#29170]
Machine Learning::
...
Visualizations::
* Adds autocomplete to TSVB {pull}30158[#30158]
* Fixes missing markdown variables {pull}28173[#28173]
* Removes filterbar for markdown visualizations {pull}30354[#30354]

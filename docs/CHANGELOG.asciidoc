...
The 8.19.1 release includes the following fixes.
...
For the Elastic Security 8.19.1 release information, refer to [Elastic Security Solution Release Notes](docs-content://release-notes/elastic-security/index.md).
...
* Fixes an issue in Firefox preventing from scrolling in the Lens editor flyout ({kibana-pull}228625[#228625]).
* Fixes an issue in reports where a PNG or PDF export would offset and clip part of the visualization in Lens ({kibana-pull}228603[#228603]).
* Fixes an issue preventing from saving linked TSVB visualizations when changing data view ({kibana-pull}228685[#228685]).
Data ingestion and Fleet::
...
Elastic Observability solution::
* Fixes an issue with column sorting in the **Services** Errors table ({kibana-pull}229199[#229199]).
* Fixes an issue with dependencies infinite loading when no data exists ({kibana-pull}228094[#228094]).
Kibana platform::
* Fixes a display issue with counter indicators on toast messages ({kibana-pull}229300[#229300]).

...
[discrete]
[[breaking-163150]]
.Case comments changes
[%collapsible]
====
*Details* +
Updating a case comment is now included in the 10000 user actions restriction. For more information, refer to ({kibana-pull}163150[#163150]).

Updating a case now fails if the operation makes it reach more than 10000 user actions. For more information, refer to ({kibana-pull}161848[#161848]

The total number of characters per comment is limited to 30000. For more information, refer to ({kibana-pull}161357[#161357]).
====
...
[discrete]
[[breaking-162492]]
.Cases APIs have new limits on objects processed and amount of data stored in objects
[%collapsible]
====
*Details* +
For Cases APIs, limits are now imposed on the number of objects that can be processed or the amount of data those objects can store. For more information, refer to ({kibana-pull}162492[#162492]).
====

[discrete]
[[breaking-161282]]
.The getConnectors API new limit
[%collapsible]
====
*Details* +
The getConnectors API now limits the number of supported connectors returned to 1000. For more information, refer to ({kibana-pull}161282[#161282]).
====
      
[discrete]
[[breaking-162411]]
.Find Cases API new limits
[%collapsible]
====
*Details* +
New limits:
...
For more information, refer to ({kibana-pull}162411[#162411]).
====
      
[discrete]
[[breaking-162245]]
.Find Cases API new restrictions
[%collapsible]
====
*Details* +
New restrictions:

* Restrict searchFields, sortField and remove rootSearchFields from find_cases API.
...
For more information, refer to ({kibana-pull}162245[#162245]).
====
      
[discrete]
[[breaking-162071]]
.Case external references limit change
[%collapsible]
====
*Details* +
A case can now only have 100 external references and persistable state(excluding files) attachments combined. For more information, refer to ({kibana-pull}162071[#162071]).
====
      
[discrete]
[[breaking-161111]]
.Find Cases API max value change
[%collapsible]
====
*Details* +
Max value for perPage parameter in find Cases API is now 100. For more information, refer to ({kibana-pull}161111[#161111]).
====
...
[discrete]
[[breaking-161076]]
* The maximum number of cases that can be updated simultaneously is now 100. The minimum is 1.
[%collapsible]
====
*Details* +
!!TODO!! For more information, refer to ({kibana-pull}161076[#161076]).
...
====
*Details* +
!!TODO!! For more information, refer to ({kibana-pull}160846[#160846]).
...
====
*Details* +
!!TODO!! For more information, refer to ({kibana-pull}160844[#160844]).
...
====
*Details* +
!!TODO!! For more information, refer to ({kibana-pull}160705[#160705]).
...
[discrete]
[[breaking-159839]]
* Use header-based versioned APIs instead of path-based.
[%collapsible]
====
*Details* +
!!TODO!! For more information, refer to ({kibana-pull}159839[#159839]).
...
====
*Details* +
!!TODO!! For more information, refer to ({kibana-pull}159041[#159041]).
...
Presentation::
* Time series geo line ({kibana-pull}159267[#159267]).
Other::
* Handle lens actions in Serverless ({kibana-pull}163581[#163581]).
* UI for crawler that enables to register multiple schedules with different crawl configurations ({kibana-pull}163425[#163425]).
* ## Risk score from new Risk Engine showing in UI ({kibana-pull}163237[#163237]).
* Hide cases in stack management UI ({kibana-pull}163037[#163037]).
* Feat(slo): introduce new search capabilities ({kibana-pull}162665[#162665]).
////
!!TODO!! The above PR had a lengthy release note description:
SLO definition and computed values are now summarized periodically into a summary search index, allowing users to **search** by name, tags, SLO budgeting type or time window, and even by and **sort** by error budget consumed, error budget remaining, SLI value or status.
////
* Risk engine initialisation, update from legacy risk engine workflow and status change ({kibana-pull}162400[#162400]).
* Process blocking now enabled for process responses ({kibana-pull}162082[#162082]).
* Adds support for self-signed SSL certificate auth in webhook connector ({kibana-pull}161894[#161894]).
* Adds indicator to support histogram fields ({kibana-pull}161582[#161582]).
* Risk score management page ({kibana-pull}160507[#160507]).
* Allow runtime fields to be selected for Elasticsearch query rule type group by or aggregate over options ({kibana-pull}160319[#160319]).
...
====
*Details* +
!!TODO!! For more information, refer to ({kibana-pull}163150[#163150]).
...
====
*Details* +
!!TODO!! For more information, refer to ({kibana-pull}162665[#162665]).
...
====
*Details* +
!!TODO!! For more information, refer to ({kibana-pull}162506[#162506]).
...
[discrete]
[[breaking-162492]]
* Update docs for remaining guardrails.
[%collapsible]
====
*Details* +
!!TODO!! For more information, refer to ({kibana-pull}162492[#162492]).
...
====
*Details* +
!!TODO!! For more information, refer to ({kibana-pull}162411[#162411]).
...
====
*Details* +
!!TODO!! For more information, refer to ({kibana-pull}162245[#162245]).
...
====
*Details* +
!!TODO!! For more information, refer to ({kibana-pull}162071[#162071]).
...
====
*Details* +
!!TODO!! For more information, refer to ({kibana-pull}161871[#161871]).
...
====
*Details* +
!!TODO!! For more information, refer to ({kibana-pull}161848[#161848]).
...
====
*Details* +
!!TODO!! For more information, refer to ({kibana-pull}161357[#161357]).
...
====
*Details* +
!!TODO!! For more information, refer to ({kibana-pull}161282[#161282]).
...
====
*Details* +
!!TODO!! For more information, refer to ({kibana-pull}161200[#161200]).
...
====
*Details* +
!!TODO!! For more information, refer to ({kibana-pull}161111[#161111]).
...
====
*Details* +
!!TODO!! For more information, refer to ({kibana-pull}161087[#161087]).
...
* Adds KQL filtering in APM rules ({kibana-pull}163825[#163825]).
* Adds several function implementations to the AI Asssistant ({kibana-pull}163764[#163764]).
* Make service group saved objects exportable ({kibana-pull}163569[#163569]).
...
* Create a filter with field:value when last value metric is used on a datatable in *Lens* ({kibana-pull}160509[#160509]).
Machine Learning::
...
Management::
* REST endpoint for swapping saved object references ({kibana-pull}157665[#157665]).
* Adds Multi format for geopoint and consolidate geo converstion tools i… ({kibana-pull}147272[#147272]).
Operations::
* Change dev-cli's config merging logic ({kibana-pull}163928[#163928]).
Presentation::
* Support time series split for top hits per entity source ({kibana-pull}161799[#161799]).
* Time series geo line ({kibana-pull}159267[#159267]).
Reporting::
* Enable CSV reporting in serverless ({kibana-pull}162358[#162358]).
* Separate internal and public API endpoints in Reporting ({kibana-pull}162288[#162288]).
////
!!TODO!! The above PR had a lengthy release note description:
...
* Security ({kibana-pull}161375[#161375]).
SharedUX::
* Merge similar toast messages in case of a toast-flood/storm ({kibana-pull}161738[#161738]).
...
Other::
* Adds Webhook connector configuration details ({kibana-pull}163899[#163899]).
...
* UI for crawler that enables to register multiple schedules with different crawl configurations ({kibana-pull}163425[#163425]).
* ## Risk score from new Risk Engine showing in UI ({kibana-pull}163237[#163237]).
* Change to use Data stream lifecycle instead of ILM ({kibana-pull}163210[#163210]).
////
!!TODO!! The above PR had a lengthy release note description:
...
////
* Hide cases in stack management UI ({kibana-pull}163037[#163037]).
* Remove improve_these_results link ({kibana-pull}163001[#163001]).
* Prepopulate ingest pipeline name using index name ({kibana-pull}162933[#162933]).
* Rename Search Preview tab ({kibana-pull}162829[#162829]).
* Make defaultModel a property of the connector ({kibana-pull}162754[#162754]).
* Risk engine initialisation, update from legacy risk engine workflow and status change ({kibana-pull}162400[#162400]).
...
* Allow runtime fields to be selected for Elasticsearch query rule type group by or aggregate over options ({kibana-pull}160319[#160319]).
* KQL search bar for rules ({kibana-pull}158106[#158106]).
...
* 162224 fix action menu overlaps flyout ({kibana-pull}162664[#162664]).
* Adds range query to terms enum call ({kibana-pull}162614[#162614]).
* Improve service groups error messages and validatons ({kibana-pull}162556[#162556]).
...
Dashboard::
* Disables top nav actions when cloning or overlay is showing ({kibana-pull}162091[#162091]).
Data Discovery::
* Encode context anchor ID ({kibana-pull}160239[#160239]).
Discover::
* Adjust NoData screen ({kibana-pull}160747[#160747]).
Elastic Security::
For the Elastic Security 8.10.0 release information, refer to {security-guide}/release-notes.html[_Elastic Security Solution Release Notes_].
Fleet::
...
* Fixing the path of manifets for hints autodiscover ({kibana-pull}161075[#161075]).
Lens & Visualizations::
* Fixes params._interval conversion to Lens formula ({kibana-pull}164150[#164150]).
* Fixes issues with field name that contains `:` char in it in *Lens* ({kibana-pull}163626[#163626]).
* Fixes other request merge behaviour when empty string key is retrieved ({kibana-pull}163187[#163187]).
* Fixes editing of multi values filters whend adding a custom item ({kibana-pull}161940[#161940]).
* Allow setting custom colours to collapsed by slices pie's multiple metrics in *Lens* ({kibana-pull}160592[#160592]).
* Fixes datatable sorting for keyword values in *Lens* ({kibana-pull}160163[#160163]).
Logs::
...
Management::
* Fixes a problem in a way to process bulk request body with variables ({kibana-pull}162745[#162745]).
* Improves a way of variable substitution and its documentation ({kibana-pull}162382[#162382]).
* Transforms: Reduces rerenders and multiple fetches of source index on transform wizard load ({kibana-pull}160979[#160979]).
* Fixes overwrite param for create ({kibana-pull}160953[#160953]).
Metrics::
* Smooth out spikey charts ({kibana-pull}163608[#163608]).
Monitoring::
* Rewrite CPU usage rule to improve accuracy ({kibana-pull}159351[#159351]).
Platform::
* Default route access to `internal` ({kibana-pull}161672[#161672]).
Presentation::
* Fixes Map layer preview blocks adding layer until all tiles are loaded ({kibana-pull}161994[#161994]).
SharedUX::
* Make download route public ({kibana-pull}163408[#163408]).
* Allow Chromium to work by default in Docker ({kibana-pull}149080[#149080]).
////
!!TODO!! The above PR had a lengthy release note description:
Fixed a bug where Kibana Reporting would not work in Elastic Docker without adding a special setting in kibana.yml to disable the Chromium sandbox.
////
Uptime::
* Fixes auto-expand feature for failed step detail ({kibana-pull}162747[#162747]).
Other::
* Enable requeue_invalid_tasks config for functional tests ({kibana-pull}163768[#163768]).
...
* Fixing skipped unit tests for metric threshold rule ({kibana-pull}162189[#162189]).
* Fix(slo): timeslice objective definition ({kibana-pull}161863[#161863]).
* Fixes wrong regex for CJK character detection ({kibana-pull}161825[#161825]).
* Risk score management page ({kibana-pull}160507[#160507]).

...
Observability::
* Fixes a bug show toast error when deleting a rule from rule details page {kibana-pull}135132[#135132]
* Fixes viewInAppUrl for custom metrics for Inventory Threshold Rule {kibana-pull}134114[#134114]

Platform::
* Preserve originId when overwriting existing objects {kibana-pull}135358[#135358]

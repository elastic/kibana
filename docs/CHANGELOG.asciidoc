...
====
*Details* +
The `metrics:allowCheckingForFailedShards` advanced setting has been removed. With ths change, it is no longer possible to suppress warnings about failed shards in TSVB. For more information, refer to ({kibana-pull}197227[#197227]).
====
...
* Fixes react Error When Rendering Recoverable Error in *Lens* ({kibana-pull}196285[#196285]).

...
====
*Details* +
APM NodeJS and RUM Javascript anomaly detection job modules have been removed. For more information, refer to {kibana-pull}119945[#119945].

*Impact* +
When you upgrade to 8.0.0, you are unable to create and view the APM NodeJS and RUM Javascript jobs in Machine Learning.
====
...
[discrete]
[[breaking-116821]]
.Removes deprecated config fields from Logs and Metrics APIs and SavedObjects
[%collapsible]
====
*Details* +
...
* Data frame analytics wizard: Only allow data view creation if job will be started {kibana-pull}120042[#120042]
* Fixes anomaly detection module manifest queries to ignore frozen and cold data tiers {kibana-pull}119635[#119635]
* Catching error for syntax error in job wizard editor {kibana-pull}119457[#119457]
* Fixes error handling for missing data view in data frame analytics wizard {kibana-pull}119455[#119455]
* Data Frame Analytics list - ensure refresh works as expected {kibana-pull}117959[#117959]
* Set data recognizer to ignore frozen indices {kibana-pull}117208[#117208]
* Data view loading refactor {kibana-pull}116455[#116455]
Management::

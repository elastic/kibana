...
* API Keys can now be updated with new Role Descriptors and Metadata via the API Keys Management screen {kibana-pull}146237[#146237]
...
APM::
* Allow alert table to show new alert status on apm {kibana-pull}150500[#150500]
* Switch get environment function to use terms_enum api {kibana-pull}150175[#150175]
* Use (rolled up) service metrics for service inventory {kibana-pull}149938[#149938]
* Adds KQL filter bar to the service map page {kibana-pull}149900[#149900]
* Integrate Alert Search bar in alert tab {kibana-pull}149610[#149610]
* Added Azure Functions support in the APM UI {kibana-pull}149479[#149479]
* Adds 404 page {kibana-pull}149471[#149471]
* Single-click setup from Kibana {kibana-pull}148959[#148959]
* Update the sparklines to support the bar chart graph style {kibana-pull}148702[#148702]
* Flamegraph legend {kibana-pull}147910[#147910]
* Adds api key to APM package policies {kibana-pull}147650[#147650]
* Only renders waterfall items up until 3 levels {kibana-pull}147569[#147569]
* Improve span links navigation {kibana-pull}147426[#147426]
* Update default refresh interval to 60 seconds {kibana-pull}146791[#146791]
* Adds pagination to source map API {kibana-pull}145959[#145959]
* Ability to offset point labels on maps {kibana-pull}145773[#145773]

Dashboard::
* Unified panel options pane {kibana-pull}148301[#148301]
...
* Integrate unified field list filters into Discover {kibana-pull}148547[#148547]
...
* Integrate unified field list sections into Discover {kibana-pull}144412[#144412]
* Update unified histogram to use Lens {kibana-pull}143117[#143117]
...
* Include IP address in audit log {kibana-pull}148055[#148055]
* Include Cross-Origin-Opener-Policy in default response headers {kibana-pull}147874[#147874]
* Include IP address in audit log {kibana-pull}147526[#147526]
...
* Allows cleaning up of the filters agg custom label in *Lens* {kibana-pull}148535[#148535]

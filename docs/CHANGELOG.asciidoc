...
====
*Details* +
The terminology has changed for audit events logged by the alerting framework alerts client when CRUD operations are performed on rules. 
...
There are no changes to the rules role-based access control (RBAC).
...
* Updated terminology in the `AlertsAuthorization` class to reflect the changed rule terminology.

* Updated authorization filter builder to return EsQuery or KQL.

* Updated authorization filter to allow specified field names.

* `getAlertingAuthorizationWithRequest` is now exposed through alerting plugin start, which allows other plugins to use it.

* `AlertsAuthorization` is now `AlertingAuthorization`.

The formatting for the following recorded audit events was changed:

* Audit event types now use `alerting_ prefix` instead of `alerts_ prefix`:
...
* Audit events have been updated to reflect the new alerting terminology:

** `alerts` are now `rules`. For example, the audit event `user Authorized to create a ".index-threshold" alert by "app"` is now `user Authorized to create a ".index-threshold" rule by "app"`.

** `alert instances` are now `alert`. For example, audit events for `muteInstance` and `unmuteInstance` operations now reference `muteAlert` and `unmuteAlert`.
...
Machine Learning::
* Anomaly Detection: add ability to clear warning notification from jobs list {kibana-pull}103608[#103608]
...
* Anomaly Detection: Visualize delayed data {kibana-pull}101236[#101236]
* Rare anomaly detection job wizard {kibana-pull}100390[#100390]
* APM Latency Correlations {kibana-pull}99905[#99905]
* Data Visualizer: add choropleth map for index and file {kibana-pull}99434[#99434]
...
* Export rules and connectors {kibana-pull}98802[#98802]
* Updates connectors with isMissingSecrets flag {kibana-pull}98223[#98223]
...
Machine Learning::
* Sets max height and preserve whitespace in categorization wizard examples {kibana-pull}103637[#103637]
* Anomaly Detection: add ability to clear warning notification from jobs list {kibana-pull}103608[#103608]
...
* Adds Authentication module with six ML jobs for ECS data (Auditbeat, Winlogbeat, Filebeat and Logs) {kibana-pull}101840[#101840]
* Switching to new datafeed preview {kibana-pull}101780[#101780]
* Adds index pattern management to index Data Visualizer {kibana-pull}101316[#101316]
* Anomaly Detection: Visualize delayed data {kibana-pull}101236[#101236]
* Adding file upload to add data page {kibana-pull}100863[#100863]
* Rare anomaly detection job wizard {kibana-pull}100390[#100390]
* APM Latency Correlations {kibana-pull}99905[#99905]
* Severity control for Anomaly timeline {kibana-pull}99489[#99489]
* Data Visualizer: add choropleth map for index and file {kibana-pull}99434[#99434]
* Support trained model aliases {kibana-pull}99174[#99174]
* Anomaly Detection Explorer: adds choropleth map {kibana-pull}98847[#98847]
Management::
...
* Adds capacity estimation to the TM health endpoint {kibana-pull}100475[#100475]
...
Security::
* Create API keys with metadata {kibana-pull}100682[#100682]
* Role Management: improve editing experience for DLS queries {kibana-pull}99977[#99977]
* Simplify deleting spaces {kibana-pull}99960[#99960]
* Use `vega-interpreter` to safely evaluate Vega expressions {kibana-pull}98832[#98832]
* Handle session timeout and user activity {kibana-pull}98461[#98461]
Sharing::
...
* Fixes Anomaly Explorer annotations misaligned {kibana-pull}105696[#105696]
* Anomaly Detection explorer: ensure geo points show up in embeddable map chart area {kibana-pull}105671[#105671]
* Fixing job wizard with missing description {kibana-pull}105574[#105574]
...
* Fixing annotations table loading hang {kibana-pull}104825[#104825]
...
* Data Frame Analytics creation: ensure included fields selection table is shown when no docs contain all mapped fields {kibana-pull}104191[#104191]
* Data Frame Analytics creation wizard: ensure included fields table updates correctly {kibana-pull}103191[#103191]
* Fixing categorization token highlighting for multi-line messages {kibana-pull}103007[#103007]
* Improvements to job saved object sync {kibana-pull}101899[#101899]
* Fixes categorization job view examples link when datafeed uses multiple indices {kibana-pull}100789[#100789]
* Fixing use_null setting in advanced job wizard {kibana-pull}100028[#100028]
Management::
...
* Load FLS suggestions on-demand {kibana-pull}98681[#98681]
Uptime::

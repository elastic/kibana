...
The {kib} log contains error messages like the following example:

[source,text]
----
Error installing common resources for AlertsService.
No additional resources will be installed and rule execution may be impacted.
- Failure during installation. Cannot read properties of undefined ...
----

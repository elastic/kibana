...
*Details* +
In {kib} 7.10.2 to 7.14.0, users with Fleet admin privileges could insecurely upload malicious packages due to an older version of the js-yaml library, allowing attackers to execute commands on the {kib} server. https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2021-XXXXX[CVE-2021-XXXXX]

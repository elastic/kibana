...
Discover::
* New responsive layout using EUI components {kibana-pull}83633[#83633]
Lens and visualizations::
* Categorical color palettes {kibana-pull}75309[#75309]
* [Fixes #68405] Color in dimension trigger {kibana-pull}76871[#76871]
* [Fixes #74889] Add median operation {kibana-pull}79453[#79453]
* [Fixes #77881] Improved range formatter {kibana-pull}80132[#80132]
* [Fixes #67226] Drag within dimension group to reorder {kibana-pull}80547[#80547]
* [Fixes #80824] Rename X/Y axis to horizontal/vertical {kibana-pull}80991[#80991]
* Visualization validation and better error messages {kibana-pull}81439[#81439]
* [Fixes #69100] New value labels config option for bar charts {kibana-pull}81776[#81776]
* [Fixes #77749, #81513] Enable other bucket for top values operation {kibana-pull}82704[#82704]
* CSV Export for Lens {kibana-pull}83430[#83430]
* [Fixes #55895] Provide single-value functions to show the "Last" value of some field {kibana-pull}83437[#83437]
* [Fixes #76962] New sorting feature for the datatable visualization {kibana-pull}84435[#84435]
* [Fixes #83321] Add datasource fields group help text {kibana-pull}85544[#85544]
* Show toolbar option adds an ability to show/hide the visualization toolbar, where the only Export button currently live (the toolbar will be expanded in future releases) {kibana-pull}70801[#70801]
* [Fixes #64238] Add support for HDR percentiles in TSVB visualizations {kibana-pull}78306[#78306]
* [Fixes #75634] Display epoch on a more human readable format {kibana-pull}79110[#79110]
* [Fixes #66602] Add ignore global filters to series options {kibana-pull}79337[#79337]
* [Fixes #73418] New visualization wizard {kibana-pull}79627[#79627]
* [Fixes #80325] user should be able to toggle "textTruncate" option for tooltips {kibana-pull}80524[#80524]
* Renamed 'positive rate' to 'counter rate' {kibana-pull}80939[#80939]
* [Fixes #82711] Remove kui usage {kibana-pull}82810[#82810]
* Update the texts on the wizard {kibana-pull}82926[#82926]
* [Fixes #54012] TSVB should use "histogram:maxBars" and "histogram:barTarget" settings for auto instead of a default 100 buckets {kibana-pull}83628[#83628]
* Remove jQuery dependency from plugins {kibana-pull}83809[#83809]
* [Fixes #34989, #34997] Fix graph saved object references {kibana-pull}85295[#85295]
Logs::
...
Lens and visualizations::
* [Fixes #81749] Do not reset formatting when switching between custom ranges and auto histogram {kibana-pull}82694[#82694]
* [Fixes #82253] Make incomplete switches possible {kibana-pull}83519[#83519]
* [Fixes #81580] Fix bug causing bar charts to render bars at the wrong width {kibana-pull}83545[#83545]
* [Fixes #83818] Fix label input debouncing {kibana-pull}84121[#84121]

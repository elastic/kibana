...
Management::
* Fixes the positioning of a button popover in *Index Management* {pull}23801[#23801]
...
and then calling `vis.updateState()` works correctly {pull}24484[#24484]
* Fixes a memory leak in `vislib`, where the scope used for the legend was never 
destroyed. As a result, memory piled up in a dashboard with auto-refresh enabled. {pull}24282[#24282]

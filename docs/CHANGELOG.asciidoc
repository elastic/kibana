...
* Uses embeddable registry in add panel {pull}31400[#31400]
...
* Always show time warning message in delete modal in Job Management {pull}36729[#36729]
...
* Removes check for forecast duration 8 weeks or less {pull}35583[#35583]
* Add links to ML jobs to the Kibana sample dataset View data menu {pull}36702[#36702]
...
Operations::
* Sets branch in package.json to 7.2 {pull}37446[#37446]
...
* Derives bootstrap cache path from base branch, makes optional {pull}32793[#32793]
...
* Enables the use of the cache-loader across all the environments {pull}35406[#35406]
* Adds exception to transpile normalize-url mode to es5 when bundled into the DLL {pull}35804[#35804]
* Uses script to clean Storybook DLL {pull}35243[#35243]
...
* Updates Japanese translation files {pull}37993[#37993]
* Adds Japanese locale {pull}36940[#36940]
* Adds Japanese translations {pull}37229[#37229]
* Prefers third-party plugin development in ./plugins instead of ../kibana-extra {pull}31748[#31748]
* Exposes an HTTP-request browser client {pull}35486[#35486]
* Removes dependency on config inject {pull}36109[#36109]
...
* Restricts import from core and plugin internals for ts files {pull}34688[#34688]
* Overlays core service {pull}34261[#34261]
...
* Integrates HTTP and Security in New Platform {pull}34631[#34631]

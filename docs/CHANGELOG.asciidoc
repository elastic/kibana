...
[discrete]
[[known-179457]]
.Canvas workpad image rendering displays a fail toast notification
[%collapsible]
====
*Details* +
When opening an ecommerce sample data in a Canvas workpad, a toast notification stating that rending the image has failed is incorrectly displayed. For more information, refer to ({kibana-pull}179457[#179457]).
====

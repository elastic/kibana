...
See <<breaking-changes-7.8.0,breaking changes in 7.8>>.
...
* Deangularizes navbar, attempt nr. 2 {pull}61611[#61611]
...
* Adds configurable file size to file data visualizer {pull}62752[#62752]
...
* Changes file data visualizer max upload setting to string {pull}63502[#63502]
* Adds {kib} setting for file data visualizer max file size {pull}64427[#64427]
...
* Progress including step {pull}65305[#65305]
Management::
...
* Adds template timeline UI {pull}64439[#64439]
...
* DFA: ensure at least one field is included in analysis before job can be created {pull}65320[#65320]
...
* Refactors nav links and header components {pull}66685[#66685]
...
* Warning and link to support matrix for IE11 {pull}66512[#66512]
Security::
...
=== Breaking Changes
Alerting::
* [Fixes #63130] Changed actions API endpoints urls to follow Kibana STYLEGUIDE {pull}65936[#65936]
Metrics::

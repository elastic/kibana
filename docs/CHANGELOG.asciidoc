...
For breaking changes, refer to <<breaking-changes-7.10>,breaking changes in 7.10>>.
...
* [Fixes #20660] Implement nest level expand/collapse toggle for each span row {kibana-pull}75259[#75259]
...
* DF Analytics creation wizard: default destination index to job id {kibana-pull}72758[#72758]
* Adds decision path charts to exploration results table {kibana-pull}73561[#73561]
* DF Analytics creation wizard: ensures user can switch back to form from JSON editor {kibana-pull}73752[#73752]
* Adds datafeed query reset button {kibana-pull}73958[#73958]
* DF Analytics creation wizard: shows link to results {kibana-pull}74025[#74025]
* Adds initial file analysis overrides {kibana-pull}74376[#74376]
* ML on Kibana Management: Add ability to pass a group ID filter to job management page {kibana-pull}74533[#74533]
* DF Analytics: adds memory status to job list {kibana-pull}74570[#74570]
...
* Adds option to Advanced Settings to set default time range filter for AD jobs {kibana-pull}76347[#76347]
* Adds ML modules for Metrics UI Integration {kibana-pull}76460[#76460]
* DF Analytics: Collapsable sections on results pages {kibana-pull}76641[#76641]
...
* Adds option to create AD jobs without starting the datafeed {kibana-pull}77484[#77484]
* Adds feature importance summary charts  {kibana-pull}78238[#78238]
* DF Analytics exploration: default filter of results page by `defaultIsTraining` value in url {kibana-pull}78303[#78303]
...
* DF Analytics exploration: adds `ml.is_training` filter to regression/classification views {kibana-pull}78702[#78702]
* DF Analytics creation wizard: replaces select input with job type cards with icons {kibana-pull}78872[#78872]
* DF Analytics results view: ensures boolean values in charts shown without formatting {kibana-pull}78888[#78888]
* Only adjust the bounds of SMV if annotations are visible {kibana-pull}79210[#79210]
* DF Analytics creation wizard: ensures job creation possible when model memory lower than estimate {kibana-pull}79229[#79229]
* Data Frame Analytics: Expandable sections for classification and regression {kibana-pull}79414[#79414]
Management::
...
* DF Analytics creation wizard: Fixes field loading race condition {kibana-pull}77326[#77326]
* Improves calendar ics file parsing {kibana-pull}78986[#78986]
* DF Analytics creation wizard: Resolves clone usability issues {kibana-pull}79048[#79048]
* Fixes jobs so it limit job menu actions for jobs that are closing {kibana-pull}79303[#79303]
* DataFrame Analytics: Ensures clear error when index pattern missing {kibana-pull}79378[#79378]
* Avoids full page reload for links following CSV import {kibana-pull}79539[#79539]
* DF Analytics classification results: Ensures confusion matrix doesn't span full width {kibana-pull}79790[#79790]
...
* DF Analytics results: Ensures boolean values in confusion matrix are not capitalized {kibana-pull}80350[#80350]
* Fixes values for decision path not showing correctly for regression due to rounding #80448 {kibana-pull}80555[#80555]
...
* Fixes exclude frequent in advanced wizard (#81121) {kibana-pull}81155[#81155]
Management::
* Fixes the copy of the success notification that displays after creating or saving a watch {kibana-pull}73982[#73982]
* DF Analytics / Transforms: Fixes job row actions menu invalid DOM nesting warning {kibana-pull}74499[#74499]
...
* Transforms/DF Analytics: Fixes data grid column sorting. {kibana-pull}80618[#80618]
...
* [Fixes #68076, #70175] Use spaceId from request in export generation {kibana-pull}76998[#76998]
  - Fixed the reporting exports to use the correct Space for advanced settings.
* [Fixes #76543] Add Refresh parameter to Delete query {kibana-pull}78516[#78516]
  - fixed a problem in the list of Reports jobs in Management would not refresh with the correct items immediately after deleting a report from the listing.
Security::
* [Fixes #76688] Display useful error when role creation fails {kibana-pull}77600[#77600]
* [Fixes #75338] Ignore intermediate unauthenticated session during repeated authentication attempt. {kibana-pull}79300[#79300]
...
* [Fixes #22374] Allow idleTimeout/lifespan larger than 32-bit signed integer. {kibana-pull}79858[#79858]
  - Kibana can now properly handle values for xpack.security.session.idleTimeout and xpack.security.session.lifespan that are larger than ~24 days.
* [Fixes #66412] Properly encode links to edit user page {kibana-pull}81562[#81562]
* [Fixes #76715] Fix display of multiple roles in table views {kibana-pull}81603[#81603]
Sharing::
* [Fixes #75376] Use App Title for Display Instead of App Id {kibana-pull}75457[#75457]
SIEM::
* Fixes a bug where invalid regular expressions within the index patterns can cause UI toaster errors {kibana-pull}73754[#73754]
* Fixes toaster errors when siemDefault index is an empty or empty spaces {kibana-pull}73991[#73991]
* [Exceptions] - Updates autocomplete validation for numbers and boolean {kibana-pull}74561[#74561]
* Fix app layout {kibana-pull}76668[#76668]
* [Fixes #77342] [Detection Engine] Fixes degraded state when signals detected are between 0 and 100 {kibana-pull}77658[#77658]
* [Fixes #77255] [Detection Engine] Bubbles up errors when it cannot create signal documents {kibana-pull}77687[#77687]
* [Fixes #77254] [Detection Engine] Bubbles up more error messages from ES queries to the UI {kibana-pull}78004[#78004]
* [Fixes #74170] [Detections] Only display actions options if user has "read" privileges {kibana-pull}78812[#78812]
* [Fixes #67299] Update TLS fields used in drag-and-drop {kibana-pull}78815[#78815]
* Fix source.ip and destination.ip draggables {kibana-pull}79399[#79399]
* [Detection Engine] Fixes date time errors when source index does not have date time stamps   {kibana-pull}79784[#79784]
* [Exception Modal] Removes list operators in exception modal for EQL rules {kibana-pull}79871[#79871]
* [Fixes #79865] [Detection Engine] Fixes critical date time format issues {kibana-pull}79911[#79911]
* [Detections] Immediately refresh exceptions when new list is created after rule creation {kibana-pull}81014[#81014]
* critical pref bug with browser fields reducer {kibana-pull}81675[#81675]
Uptime::
* [Fixes #75080] Ml anomaly alert edit {kibana-pull}76909[#76909]
* [Fixes #80442] Remove custom handling of license enabling {kibana-pull}82019[#82019]
Visualizations::
* [Fixes #62081] TSVB Inaccurate Group By {kibana-pull}73683[#73683]
* [Fixes #73018] Fix download filename when using split table {kibana-pull}74231[#74231]
* [Fixes #70646, #70771] Disable enableHistogramMode prop when user selects non-stacked bar {kibana-pull}74930[#74930]
* [Fixes #72604] Fixes bug on TopN weird behavior with zero values {kibana-pull}74942[#74942]
* [Fixes #74959] Do not apply search source data for tsvb {kibana-pull}75137[#75137]
...
* [Fixes #74986] Horizontal Bar Percentiles Overlapping {kibana-pull}75315[#75315]
* [Fixes #68506] Fix panel config updates on history changes {kibana-pull}75896[#75896]
* [Fixes #77362] Fix unexpected change in autosizing behavior post upgrade {kibana-pull}77408[#77408]
* [Fixes #77681] Hide app from search results when the setting is disabled {kibana-pull}77763[#77763]
* [Fixes #67581] Allow string fields on value count aggregation {kibana-pull}79267[#79267]
* [Fixes #72664] Input controls crashes if index pattern is not available {kibana-pull}79431[#79431]
Unknown::
* [Fixes #71461] Improve state sync error handling {kibana-pull}74264[#74264]
  - Fix apps break on unrestorable session state in URL
* node list and node detail tests {kibana-pull}74421[#74421]
* Improve simulator. Add more click-through tests and panel tests. {kibana-pull}74601[#74601]
* fix removing ingest pipelines from elasticsearch {kibana-pull}75092[#75092]
* Fix docs in trigger alerting UI {kibana-pull}75363[#75363]
* [Detections] Refactor signal ancestry to allow multiple parents {kibana-pull}76531[#76531]
* install previous version of package if update fails {kibana-pull}76694[#76694]
* Prevent pageload on drilldown in tsvb {kibana-pull}78005[#78005]
* Fixes for the Ticket 78375 {kibana-pull}79004[#79004]
* [Fixes #71651] Agent Policy names are unique {kibana-pull}79201[#79201]
* Resolver Tree Events tests {kibana-pull}79344[#79344]
* Handle errors better in spaces selector {kibana-pull}79471[#79471]
  - Fixes infinite loading spinner on the spaces selector screen. In the case an error occurs while trying to load the spaces that the current user has access to, an error message will now be shown instead of the loading spinner.
* [Fixes #79370] Fix package upgrade breaking after first rollover before new data has arrived {kibana-pull}79887[#79887]
* add the correct class to truncate the names in Endpoint list {kibana-pull}79921[#79921]
* add the correct class to truncate the names (#79921) {kibana-pull}79957[#79957]
* Index pattern installation use requested package version {kibana-pull}80079[#80079]
* Remove fields from index pattern during package uninstall {kibana-pull}80082[#80082]
* [Detections] - Fix remaining render and validation bug with query preview + tests {kibana-pull}80110[#80110]
* New events resolver {kibana-pull}80850[#80850]
* Fix logs permissions for alert management  {kibana-pull}81199[#81199]
* [Fixes #74515] Allow default packages to be deleted from the default agent policy {kibana-pull}81535[#81535]
...
=== Deprecations
Monitoring::
* [Fixes #51718] "Internal Monitoring" deprecation warning {kibana-pull}72020[#72020]
Platform::
* Migrate status & stats APIs to KP + remove legacy status lib {kibana-pull}76054[#76054]
  - The /api/status endpoint response format is now deprecated and will change in 8.0.
* Move metrics to setup and add cgroup metrics {kibana-pull}76730[#76730]
  - These two config keys have been renamed and the old names will no longer work as of 8.0:
Visualizations::
* [Fixes #63012] Timelion app deprecation warning {kibana-pull}74660[#74660]

[float]
[[breaking-v7.10.0]]
=== Breaking Changes
Operations::
* support KP plugins instead {kibana-pull}74604[#74604]
...
Platform::
* [Fixes #71927] Remove legacy plugins support {kibana-pull}77599[#77599]
...
SIEM::
* [Case] Settings per case per connector {kibana-pull}77327[#77327]
* [Detections] Update signals template if outdated and rollover indices {kibana-pull}80019[#80019]
Visualizations::
* [Fixes #30951] Deprecate schema-less specs in Vega {kibana-pull}73805[#73805]
...
=== Unknown
Alerting::
* [Fixes #63961] Use Alerts client & Actions client when fetching these types of SOs {kibana-pull}73257[#73257]
Management::
* Remove dependencies from index pattern field and index pattern list {kibana-pull}75185[#75185]
  - The index pattern fields class has the following changes
* IndexPattern class - no longer use `getConfig` or `uiSettingsValues` {kibana-pull}75717[#75717]
...
* Index pattern save => Index pattern service {kibana-pull}76706[#76706]
  - IndexPattern.save has been replaced with IndexPatternsService.save
* Index pattern  - refactor constructor {kibana-pull}77791[#77791]
  - The index pattern factory and crud methods have been refactored -
Operations::
* [Fixes #78168] remove from build (take 2) {kibana-pull}79379[#79379]
  - Kibana plugins can no longer rely on their server code being automatically transpiled with Babel. The @kbn/plugin-helpers provide a build task that will transform your plugin's server code to plain JS via Babel, but plugin authors can use any tool they like to accomplish the same result.
Platform::
* Expose new es client {kibana-pull}73651[#73651]
...
* [Fixes #46906] Remove legacy APIs. {kibana-pull}75517[#75517]
...
* [Fixes #77579] Error notification alignment {kibana-pull}77788[#77788]
  - This PR introduces explicit error types to the data.search service:
Querying & Filtering::
* Query Input String manager {kibana-pull}72093[#72093]
...
SIEM::
* [Fixes #56426] [Connectors] Refactor Jira: Generic Implementation (phase one) {kibana-pull}73778[#73778]
* [Connectors] Refactor IBM Resilient: Generic Implementation (phase one) {kibana-pull}74357[#74357]
Uptime::
* [Fixes #62438] Adds Role Based Access-Control to the Alerting & Action plugins based on Kibana Feature Controls {kibana-pull}67157[#67157]
* [Fixes #69665] Control Alerts Management via feature controls & privileges {kibana-pull}72029[#72029]
Unknown::
* [Fixes #73557] Allow routes to specify the idle socket timeout in addition to the payload timeout {kibana-pull}73730[#73730]
  - Route definitions can now specify the idleSocket timeout in addition to the payload timeout.
* Move some SearchSource dependencies to the server. {kibana-pull}74607[#74607]
...
* Rename agent/package config(s) to agent/package policy(ies) {kibana-pull}74914[#74914]
  - The following Ingest Manager API routes were changed:
* Extract dependencies and pass them in from the service definition. {kibana-pull}75368[#75368]
...
* [Fixes #75321] Add a new advanced setting searchTimeout {kibana-pull}75728[#75728]
  - This PR changes the behavior of how we timeout search requests:
* Remove legacy ES client APIs. {kibana-pull}75943[#75943]
...
* Replace FetchOptions with ISearchOptions {kibana-pull}76538[#76538]
  - The FetchOptions type was removed, use the ISearchOptions type instead.
The ISearchOptions signal option was renamed to abortSignal.
* Adding KibanaRequest#uuid {kibana-pull}76822[#76822]
  - The KibanaRequest now has a uuid property which is a UUID that uniquely identifies the request.
* Adding `className` prop to QueryStringInput component {kibana-pull}76848[#76848]
  - This PR allows to add a className prop to QueryStringInput that will be added to the main container of the component.
* Add response status helpers {kibana-pull}78006[#78006]
  - Introduces the following search helpers
* Rename API /api/ingest_manager => /api/fleet {kibana-pull}79193[#79193]
  - The following Ingest Manager API routes changed:
* Move config from xpack.ingestManager to xpack.fleet {kibana-pull}79406[#79406]
  - In the effort of renaming the ingest manger plugin fleet:
...
Machine Learning::
* DF Analytics Results: do not hide query bar and table on query syntax error {kibana-pull}69196[#69196]
...
* DF Analytics creation: ensure `monitor` cluster privilege not required to create job {kibana-pull}71934[#71934]
...
* Stops annotation flyout re-rendering on each keystoke {kibana-pull}72299[#72299]
...
* DF Analytics results: add index-pattern management link to 'click here' error prompt {kibana-pull}72470[#72470]
...
* Fixes deleting DFA not showing index pattern check {kibana-pull}72904[#72904]
...
* Disables ML if license feature is disabled {kibana-pull}73187[#73187]
* DF Analytics results: ensure `View` link is only enabled when job has successfully completed {kibana-pull}73539[#73539]
Management::
...
* Adds DF Transform Analytics list to {kib} management {kib-pull}43151[#43151]

...
*Impact* +
To auto-fit the table row height, <<add-aggregation-based-visualization-panels,create an aggregation-based data table>>, click *Options*, then select *Auto fit rows to content*.
====

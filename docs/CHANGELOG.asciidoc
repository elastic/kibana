...
[discrete]
.Now the fields / functions variables are being described with ?? in the query. The values variables use ? as before.
[%collapsible]
====
*Details* +
!!TODO!!
...
View ({kibana-pull}213916[#213916])
====
...
The following functionality is deprecated in 8.19.0, and will be removed in 9.0.0.
Deprecated functionality does not have an immediate impact on your application, but we strongly recommend
you make the necessary updates after you upgrade to 8.19.0.
...
View ({kibana-pull}225536[#225536])
====
...
View ({kibana-pull}197684[#197684])
====
...
Alerting::
* Added the ability to schedule reports with a recurring schedule and view previously scheduled reports ({kibana-pull}224849[#224849]).
* Cases analytics index ({kibana-pull}223405[#223405]).
////
...
////
* New kibana setting `xpack.actions.email.services.enabled` to enable/disable email services for email connector ({kibana-pull}223363[#223363]).
* New `xpack.actions.webhook.ssl.pfx.enabled` config ({kibana-pull}222507[#222507]).
////
!!TODO!! The above PR had a lengthy release note description:
...
////
* `xpack.actions.email.services.ses.host/port` kibana config ({kibana-pull}221389[#221389]).
////
!!TODO!! The above PR had a lengthy release note description:
New AWS SES Email configuration options `xpack.actions.email.services.ses.host` and `xpack.actions.email.services.ses.port`.
////
* Scheduled Reports ({kibana-pull}221028[#221028]).
* Support rrule for task scheduling ({kibana-pull}217728[#217728]).
* Publish new public APIs for the Maintenance Window ({kibana-pull}216756[#216756]).
* Alert Delete ({kibana-pull}216613[#216613]).
////
!!TODO!! The above PR had a lengthy release note description:
...
////
* Added an embeddable panel for Dashboards to display alerts ({kibana-pull}216076[#216076]).
Dashboards and Visualizations::
* Adds collapsible sections ({kibana-pull}220877[#220877]).
////
!!TODO!! The above PR had a lengthy release note description:
...
////
* Migrate by-term `palettes` to `colorMapping` configs in *Lens* ({kibana-pull}220296[#220296]).
////
!!TODO!! The above PR had a lengthy release note description:
...
////
* "Compare to" badge for Metric chart in *Lens* ({kibana-pull}214811[#214811]).
* [dashboard] Basic keyboard interaction ({kibana-pull}208286[#208286]).
Data ingestion and Fleet::
* Enable feature flag `enableAutomaticAgentUpgrades` ({kibana-pull}219932[#219932]).
* Adds Cloud Connectors CSPM Support ({kibana-pull}212200[#212200]).
Discover::
* Display Attributes doc viewer tab for Observability ({kibana-pull}222391[#222391]).
* Show partial results after timeout ({kibana-pull}219027[#219027]).
////
!!TODO!! The above PR had a lengthy release note description:
...
////
* Creates control by typing a questionmark ({kibana-pull}216839[#216839]).
* Implementing click action for Stacktrace and Degraded Fields on Discover ({kibana-pull}214413[#214413]).
* Added context aware logic for logs view in discover to show Load More… ({kibana-pull}211176[#211176]).
Elastic Observability solution::
For the Elastic Observability 8.19.0 release information, refer to [Elastic Observability Solution Release Notes](docs-content://release-notes/elastic-observability/index.md).
Elastic Security solution::
For the Elastic Security 8.19.0 release information, refer to [Elastic Security Solution Release Notes](docs-content://release-notes/elastic-security/index.md).
Management::
* These changes add autocompletion for ESQL query requests in Console ({kibana-pull}219980[#219980]).
* Introduce GroupStreams ({kibana-pull}208126[#208126]).
Platform::
* Create a rule from a dashboard ES|QL visualization ({kibana-pull}217719[#217719]).
////
!!TODO!! The above PR had a lengthy release note description:
...
////
Search::
* Enable query rules by default ({kibana-pull}227226[#227226]).
////
!!TODO!! The above PR had a lengthy release note description:
...
////
Other::
* Indicate if failure store isn't enabled for data stream ({kibana-pull}221644[#221644]).
...
==== Enhancements
Alerting::
* Report UI should only show reports generated in the current space ({kibana-pull}221375[#221375]).
* Moves rule settings to a flyout instead of a modal ({kibana-pull}216162[#216162]).
* Allow users to delete a snooze schedule from a rule using schedule id ({kibana-pull}213247[#213247]).
* Allow users to create a snooze schedule for rule via API ({kibana-pull}210584[#210584]).
* Implement functionality to add observables, procedures and custom fields to alerts for TheHive ({kibana-pull}207255[#207255]).
Dashboards and Visualizations::
* Adds point visibility option for area/line charts in *Lens* ({kibana-pull}222187[#222187]).
* [Data Table] Add settings for data grid density in *Lens* ({kibana-pull}220252[#220252]).
* Flatten grid layout ({kibana-pull}218900[#218900]).
* Adds "Open in lens" in the same tab ({kibana-pull}217528[#217528]).
* Adds ability to open links in *Vega* in new window ({kibana-pull}216200[#216200]).
* Inject / extract tag references ({kibana-pull}214788[#214788]).
* Globe projection ({kibana-pull}212437[#212437]).
* Keeps the chart configuration changes done by the user when changing the query whenever it is possible ({kibana-pull}210780[#210780]).
* Update @elastic/charts to v70, remove legacy time axis support ({kibana-pull}210579[#210579]).
////
!!TODO!! The above PR had a lengthy release note description:
...
////
Data ingestion and Fleet::
* Reuse shared integration policies when duplicating agent policies ({kibana-pull}217872[#217872]).
Discover::
* Expand to fit the query on editor mount ({kibana-pull}225509[#225509]).
* Flip LOOKUP JOIN to GA in docs ({kibana-pull}225117[#225117]).
* Listen to ?_tstart and ?_tend named params ({kibana-pull}225054[#225054]).
* Enable `COMPLETION` in tech preview ({kibana-pull}224811[#224811]).
* Moves fork in tech preview ({kibana-pull}224680[#224680]).
* Suggest all operators in the editor ({kibana-pull}223503[#223503]).
* Better handling of long fields in the editor ({kibana-pull}223222[#223222]).
* Adds shortcuts in the editor ({kibana-pull}221331[#221331]).
* Suggests full text search in our recommendations ({kibana-pull}221239[#221239]).
* Adds full text search to `STATS ... WHERE` ({kibana-pull}220691[#220691]).
* Hide "Selected only" toggle in pages that don't filter by value ({kibana-pull}220624[#220624]).
* Adds an ES|QL control option on the dashboard controls dropdown ({kibana-pull}219495[#219495]).
* Adds 'Copy value' button to field value cells ({kibana-pull}218817[#218817]).
* Enable suggestions for `CHANGE_POINT` command ({kibana-pull}218100[#218100]).
* Autocomplete for `STATS...WHERE` ({kibana-pull}216379[#216379]).
* Validation and autocomplete support for the `CHANGE_POINT` command ({kibana-pull}216043[#216043]).
...
* Display a warning and a tooltip for the `_score` column in the grid ({kibana-pull}211013[#211013]).
* Allow command/ctrl click for "New" action in top nav ({kibana-pull}210982[#210982]).
...
For the Elastic Security 8.19.0 release information, refer to [Elastic Security Solution Release Notes](docs-content://release-notes/elastic-security/index.md).
Kibana platform::
* Adds unused url cleanup task ({kibana-pull}220138[#220138]).
* Adds badge to all items except section header ({kibana-pull}217301[#217301]).
* Adds back external link indicator to sidenav ({kibana-pull}215946[#215946]).
* Adds the ability to add badges to subitems ({kibana-pull}214854[#214854]).
Kibana security::
* Render accordion in integration readme ({kibana-pull}223916[#223916]).
* Adds defaultSolution to spaces config ({kibana-pull}218360[#218360]).
...
Machine Learning::
* Update NL-2-ESQL docs ({kibana-pull}224868[#224868]).
* Trained Models: Hides Adaptive Allocations Toggle in Serverless ({kibana-pull}224097[#224097]).
...
* ES|QL pattern formatting ({kibana-pull}222871[#222871]).
* AI Connector creation UI: ensures error message is bubbled up in Kibana ({kibana-pull}221859[#221859]).
* AIOps: Adds ability to disable AIOps features in Kibana ({kibana-pull}221286[#221286]).
* Trained Models: Prevents download of models already present in other spaces and shows warning ({kibana-pull}220238[#220238]).
* AIOps: Enhances `No Results` state for Change Point Detection ({kibana-pull}219072[#219072]).
...
* Anomalies table: Enhances display for anomaly time function values ({kibana-pull}216142[#216142]).
* Trained models: Improves UX for deploy action ({kibana-pull}205699[#205699]).
Management::
* Adds loader when datasources are being loaded ({kibana-pull}225005[#225005]).
* Listing and overview page improvements ({kibana-pull}223603[#223603]).
* Remove enablement check in `PUT /api/streams/{id}` for classic streams ({kibana-pull}212289[#212289]).
* Enable `/api/streams/{id}/_group` endpoints for GroupStreams ({kibana-pull}210114[#210114]).
* Update styles for Color formatter to look like a badge ({kibana-pull}189391[#189391]).
Sharing::
* Adds the ability to switch between relative and absolute time range ({kibana-pull}218056[#218056]).
Other::
* ES|QL support for partial results ({kibana-pull}223198[#223198]).
* Extend default log pattern on server-side to include error information ({kibana-pull}219940[#219940]).
////
!!TODO!! The above PR had a lengthy release note description:
...
* Update task state version after execution ({kibana-pull}215559[#215559]).
* Fixes a regression that caused the cases actions to disappear from the detections engine alerts table bulk actions menu ({kibana-pull}215111[#215111]).
Dashboards and Visualizations::
* Forward secondary prefix correctly when state value is an empty string (`None` option) in *Lens* ({kibana-pull}228183[#228183]).
* Fixes an issue where a Lens Partition chart (i.e. `Pie`) prevented the user from selecting a legacy palette. in *Lens* ({kibana-pull}228051[#228051]).
* (Accessibility) Dashboard controls should be grouped as a labelled list ({kibana-pull}227633[#227633]).
* Fixes disabled range slider tooltip, clean up delete control button ({kibana-pull}227295[#227295]).
* Fixes secondary metric styles to prevent wrapping in *Lens* ({kibana-pull}227234[#227234]).
* Save button is disabled in case of save error ({kibana-pull}227091[#227091]).
* Skip all references fallback ({kibana-pull}225908[#225908]).
* [Controls] Do not recommend adhoc dataviews ({kibana-pull}225705[#225705]).
* Fixes Lens Embeddable defaultTitle from being overwritten by custom title after reload ({kibana-pull}225664[#225664]).
* Fixes panel title sync with saved object when using defaultTitle ({kibana-pull}225237[#225237]).
* Refresh "Values from a query" options on dashboard reload ({kibana-pull}225101[#225101]).
* Fixes a performance issue in the Lens ES|QL charts in case of errors in the query. in *Lens* ({kibana-pull}225067[#225067]).
* Fixes for controls selections causing multiple fetches ({kibana-pull}224761[#224761]).
* Adds saved object version for collapsible sections ({kibana-pull}222450[#222450]).
* Do not break when the table has no data in *Lens* ({kibana-pull}217937[#217937]).
* Fixes coloring/palette assignment on partition charts in *Lens* ({kibana-pull}215426[#215426]).
* Fixes invalid dashboard displayed as 404 instead of showing validation error ({kibana-pull}211661[#211661]).
* Adds `useCustomDragHandle` prop ({kibana-pull}210463[#210463]).
...
* Fixes issue assigning color mappings when multiple layers are defined. in *Lens* ({kibana-pull}208571[#208571]).
* Store assignments as raw/serialized values ({kibana-pull}207957[#207957]).
////
!!TODO!! The above PR had a lengthy release note description:
...
////
Data ingestion and Fleet::
* Fixes backfill agentless logic for all packages ({kibana-pull}225767[#225767]).
* Fixes UI error when no tags filter is selected ({kibana-pull}225413[#225413]).
* Revert " Added instructions for installing elastic agent complete" ({kibana-pull}223520[#223520]).
...
* Fixes search session rename error in dev ({kibana-pull}226757[#226757]).
* Fixes drag & drop when animations are disabled ({kibana-pull}226592[#226592]).
* Return namespaces from update ({kibana-pull}226569[#226569]).
* Don't change selected document when resizing flyout with keyboard ({kibana-pull}225594[#225594]).
* Fixes edited query overwriting when a request is finished ({kibana-pull}224671[#224671]).
* Update aria tags in patterns selected field ({kibana-pull}224224[#224224]).
* Fixes z-index for esql query editor ({kibana-pull}222841[#222841]).
* Fixes in the bucket function signatures ({kibana-pull}222553[#222553]).
* Fixes COALESCE validation ({kibana-pull}222425[#222425]).
* Fixing the suggestions in WHERE after a variable such as ?value ({kibana-pull}222312[#222312]).
* Adds info icon to doc viewer table ({kibana-pull}222299[#222299]).
* Show ES|QL request URL in Inpector flyout ({kibana-pull}221816[#221816]).
* Adds skip to next section in field list grouped ({kibana-pull}221792[#221792]).
* Update aria-label in doc viewer table ({kibana-pull}221736[#221736]).
* Change icon of field list when mapping changes from unmapped to mapped ({kibana-pull}221308[#221308]).
* Remove not needed tabindex from svg inside button ({kibana-pull}221265[#221265]).
* Fixes classic and ES|QL switch button a11y issues ({kibana-pull}221246[#221246]).
* Fixes suggestions after triple quote pair ({kibana-pull}221200[#221200]).
* Update aria-label for field type filter ({kibana-pull}221090[#221090]).
* Fixes indexpattern parsing leading to incomplete index pattern values being displayed ({kibana-pull}221084[#221084]).
* Improve discover session input focus behavior ({kibana-pull}220876[#220876]).
* Adds Actions header to unified data table ({kibana-pull}220824[#220824]).
* Fixes rename wrong validation for asterisc in name ({kibana-pull}219832[#219832]).
* Make icon only presentational ({kibana-pull}219696[#219696]).
* Make pin button focusable with keyboard ({kibana-pull}219230[#219230]).
* Fixes the wrong source validation in case of unknown patterns ({kibana-pull}218352[#218352]).
* Fixes editor menus on safari ({kibana-pull}218167[#218167]).
* Fixes the broken tooltip suggestions descriptions ({kibana-pull}218067[#218067]).
* Pass app state and global state to locator when redirecting from /stream path ({kibana-pull}215867[#215867]).
* Enables the timepicker if the time params are used with cast ({kibana-pull}215820[#215820]).
* Calculate the query for retrieving the values correctly ({kibana-pull}214905[#214905]).
* Make sure that the variables in the editor are always up to date ({kibana-pull}214833[#214833]).
* Fixes the visibility of the datepicker ({kibana-pull}214728[#214728]).
* Fixes warnings with escaped quotes ({kibana-pull}213685[#213685]).
* Fixes the wrong validation when a named param is used as function ({kibana-pull}213355[#213355]).
* Supports date_nanos in bucket ({kibana-pull}213319[#213319]).
* Exclude Elasticsearch metadata fields from Display in Content Column ({kibana-pull}213255[#213255]).
* Fixes the suggestion problem in where for multiline queries ({kibana-pull}213240[#213240]).
* Suggest triple quotes when the user selects the `KQL` / `QSTR` ({kibana-pull}211457[#211457]).
Elastic Observability solution::
For the Elastic Observability 8.19.0 release information, refer to [Elastic Observability Solution Release Notes](docs-content://release-notes/elastic-observability/index.md).
Elastic Security solution::
...
* Hide Kibana's header and side navigation when trying to print or use the dashboard export with print mode ({kibana-pull}227095[#227095]).
* Remove listing limit warning ({kibana-pull}217945[#217945]).
Kibana security::
* Fixed spaces search functionality for spaces created with avatar type as image ({kibana-pull}220398[#220398]).
* Ensure that when an SLO is created, the id is verified across all spaces ({kibana-pull}214496[#214496]).
* Fixed image resize for image used in `xpack.security.loginAssistanceMessage` ({kibana-pull}212035[#212035]).
Machine Learning::
* Fixes handling of time range in embedded anomaly swim lane ({kibana-pull}225803[#225803]).
* Anomaly Detection Rule: Fallback to the default value when `lookbackInterval` is empty ({kibana-pull}225249[#225249]).
* Hides node allocation warning on serverless ({kibana-pull}224406[#224406]).
* Fixes unknown fields not supported in Data Visualizer and Field Statistics ({kibana-pull}223903[#223903]).
* Change Point Detection: Fixes 'Use full data' button issue which could cause page to crash ({kibana-pull}217291[#217291]).
...
* Anomaly Explorer: Fix incorrect overall swim lane height in Anomaly Explorer ({kibana-pull}213245[#213245]).
* Trained Models: Prevents multiple clicks in Delete Model dialog ({kibana-pull}211580[#211580]).
* Trained Models: Fixes further deployment of models after a failed deployment ({kibana-pull}211459[#211459]).
* AIOps Hides saved query controls ({kibana-pull}210556[#210556]).
Management::
* Fixes flyout styles ({kibana-pull}228078[#228078]).
* Display dataview pattern as tooltip during rule creation ({kibana-pull}226909[#226909]).
* Fixes Outcome Preview Table so columns always fill width after resize ({kibana-pull}226000[#226000]).
* Adds discernible text for refresh data preview button ({kibana-pull}225816[#225816]).
* Fixes inability to clear Document ID in data view field editor preview ({kibana-pull}220891[#220891]).
* Ensure the members array is unique for GroupStreamDefinitions ({kibana-pull}210089[#210089]).
Platform::
* Passing the correct namespace to migrateInputDocument ({kibana-pull}222313[#222313]).
Search::
* Fixes issue in Search Playground where context limit errors were not handled well when using the Elastic Managed LLM ({kibana-pull}225360[#225360]).
* Adjusted `z-index` of app menu header to not conflict with the portable dev console ({kibana-pull}224708[#224708]).
Other::
* Fixed a bug with the solution nav submenu items when the nav is collapsed ({kibana-pull}227705[#227705]).
* Fixes false positive alerts for IM ({kibana-pull}225248[#225248]).
* Apply chunking algorithm for getIndexBasicStats ({kibana-pull}221153[#221153]).
* Improve finding a function ({kibana-pull}210437[#210437]).

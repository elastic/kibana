...
. Capture the `_id` field, which will be formatted as `inventory-view:<id>`. For example, `inventory-view:3d3d06b0-f873-4373-8446-f6a8341cd8b1`.
...
As a result, the `inventory-view:` portion of the `_id` field will be removed.

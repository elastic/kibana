...
If you have changed the default <<visualization-visualize-chartslibrary,Advanced settings>>, you must disable the legacy charts library to use the new charts library:

...
* Fixed an issue with the handling of the `viewMode` check in *Lens* ({kibana-pull}213887[#213887]).
...
* Fixed an error with the `retrieve-elastic-doc` function being unavailable ({kibana-pull}212676[#212676]).

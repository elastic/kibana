...
* Don't use service transaction metrics on transaction detail page {kibana-pull}159085[#159085]
...
* Fixes not blocking forced downgrades/installation if cannot delete indices {kibana-pull}159814[#159814]

Maps::
* Fixes layer group loading indicator always on when group has non-visible layer {kibana-pull}159517[#159517]
* Fixes geo line source not loaded unless maps application is opened {kibana-pull}159432[#159432]
* Fixes map orphans sources on layer deletion {kibana-pull}159067[#159067]
...
* Fixes an issue where alerting on Synthetics monitors could sometimes become delayed {kibana-pull}159511[#159511]

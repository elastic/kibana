...
* Improves the Differential TopN functions grid view ({kibana-pull}170008[#170008]).
Cases::
...
* Adds a sampled percentage of documents, and cardinality, for text fields for the Data Visualizer Field statistics tab and addresses and issue with a missing bucket in the document count chart ({kibana-pull}172378[#172378]).
...
* Adds a Add a trained model flyout with available models to download for in the Trained Models UI ({kibana-pull}171024[#171024]).
...
* Aligns data view and destination index creation workflows in Transforms and Data Fame Analytics wizards ({kibana-pull}171202[#171202]).
...
Security::
* Allows using JWT credentials to grant API keys ({kibana-pull}172444[#172444]).

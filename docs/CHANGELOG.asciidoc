...
* Moves create new to the top of SavedObjectFinder {pull}56428[#56428]
Lens::
...
* Simplifies state management from visualization {pull}58279[#58279]
* Improves suggestions when dragging field for the second time {pull}60687[#60687]
...
* Median label shows &quot;Median&quot; instead of &quot;50th percentile of&quot; {pull}58521[#58521]
Logs::
...
Management::
* Adds support for proxy mode {pull}59221[#59221]
...
* Allows reports to be deleted in Management &gt; Kibana &gt; Reporting {pull}60077[#60077]
SIEM::
* Overview: Recent cases widget {pull}60993[#60993]
...
* Adds support for deprecated roles {pull}57209[#57209]
* Supports for sub-feature privileges {pull}60563[#60563]
Telemetry::
...
Visualizations::
* Adds Positive Rate to Aggregations {pull}59843[#59843]
* Fixes linked search behavior {pull}59690[#59690]
...
* Upgrade assistant migration meta data can become stale {pull}60789[#60789]
* Fixes doc links {pull}61331[#61331]
* Fixes for console error handling and loading of autocomplete {pull}58587[#58587]
* Fixes grokdebugger simulate call in non-default space {pull}61423[#61423]
* Handles the case where saving to history may throw an error {pull}62424[#62424]
* Escapes single quotes surrounded by double quotes {pull}63229[#63229]
...
* Fixes formatter on range aggregation {pull}58651[#58651]
Reporting::
...
=== Deprecations
Monitoring::
* Changes all configs to `monitoring.*` {pull}54919[#54919]
* Changes all configs to `monitoring.*` {pull}56215[#56215]
Platform::

...
* Indicates missing required privileges for import in File Data Viz {pull}50147[#50147]
* Stats bar for data frame analytics {pull}49464[#49464]
* Adds the job message tab to data frame analytics {pull}50468[#50468]
* Reactive time-range selection in SMV {pull}51008[#51008]
...
* Fetches the latest job messages and enable sorting by time {pull}52388[#52388]
...
* MML calculator enhancements for multi-metric job wizard  {pull}54573[#54573]
...
Maps::
* Data load event handlers {pull}49373[#49373]
...
* MapEmbeddable setLayerList {pull}52573[#52573]
...
* Feature/hide view/layer control in embeddable {pull}53469[#53469]
...
* Lists externel linking {pull}53098[#53098]
...
* Don't throw exception when refreshing fields of an indexpattern {pull}55836[#55836]
...
* Shows fields when using indexpattern without time field {pull}54804[#54804]
...
* Index Lifecycle Policies show wrong unit in Kibana UI {pull}55228[#55228]
...
* Fixes handling of bad profile data and update tab behaviour {pull}55806[#55806]
...
* Only provide visiblity check when vector layer has joins {pull}51388[#51388]
...
* Fixes monitor list pageination arrows {pull}51912[#51912]

...
* Adds UI components to crete and edit output secrets ({kibana-pull}169429[#169429]).
...
Lens & Visualizations::
* Adds the ability to edit ES|QL queries in Dashboard ({kibana-pull}169911[#169911]).
Machine Learning::
...
* Enables the addition of columns from the document viewer ({kibana-pull}171083[#171083]).

...
[discrete]
[[known-179611]]
In Dashboard, base font size changes are not applied
[%collapsible]
====
*Details* +
In Dashboard, base font size changes to a text panel are not applied to the content. For more information, refer to ({kibana-issue}179611[#179611]).
====
...
====
*Details* +
In Dashboard, custom CSS in markdown for TSVB panels is no longer applied. For more information, refer to ({kibana-issue}179498[#179498]).
====
...
====
*Details* +
In Canvas, markdown text settings are no longer applied. For more information, refer to ({kibana-issue}179940[#179940]).
====

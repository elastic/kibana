...
Review important information about the {kib} 7.13.x releases.
...
There are no known issues in 7.13.4. 

For the known issues in previous releases, refer to the following:

<<known-issue-7.13.1,7.13.1>> | <<known-issue-7.13.0, 7.13.0>>
...
{kibana-ref-all}/7.12/release-notes-7.12.0.html#breaking-changes-7.12.0[7.12] | {kibana-ref-all}/7.11/breaking-changes-7.11.html[7.11] | {kibana-ref-all}/7.10/breaking-changes-7.10.html[7.10] |
...
There are no known issues in 7.13.3. 
...
There are no known issues in 7.13.2. 
...
Before you upgrade, review the known issues, then mitigate the impact to your application. For known issues in the previous release, refer to the <<known-issue-7.13.0,known issues in 7.13.0>>.
...
For more information, refer to {kibana-ref}/upgrade-migrations.html[saved object
upgrade migrations].

*Impact* +
Before you upgrade to 7.12.0, review the documentation for
{kibana-ref}/upgrade-migrations.html#upgrade-migrations-rolling-back[rolling
back to a previous version of {kib}].
====

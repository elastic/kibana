...
[discrete]
[[breaking-141757]]
.Updates bulk action API to return actionId instead of agents success for consistency
[%collapsible]
====
*Details* +
...
====
*Details* +
The bi directionnal foreign key between agent policy and package policy has been removed. For more information, refer to {kibana-pull}138677[#138677].
...
Alerting::
* 137988 browser fields UI {kibana-pull}140516[#140516]
...
APM::
* Support Input Packages {kibana-pull}140035[#140035]
...
Fleet::
* Agent activity {kibana-pull}140510[#140510]
* Config options added to policy {kibana-pull}139421[#139421]
* Moving action batching to async {kibana-pull}138870[#138870]
* Tagging of integration assets {kibana-pull}137184[#137184]
...
Osquery::
Adds Osquery results to Case {kibana-pull}139909[#139909]
...
APM::
* Service metrics on inventory page {kibana-pull}140868[#140868]
* Sort trace samples {kibana-pull}140589[#140589]
* Setting for tail sampling storage limit in Fleet integration {kibana-pull}140567[#140567]
* Adds AWS Lambda metrics to "Metrics" tab UI {kibana-pull}140550[#140550]
* Adds Experimental Mode for APM UI {kibana-pull}139553[#139553]
* Rename JVMs to Metrics {kibana-pull}138437[#138437]
* Display partial data buckets differently and message in the chart tooltips {kibana-pull}137533[#137533]

Dashboard::
Adds the ability to view panel-level filters and queries {kibana-pull}136655[#136655]

Discover::
* Adds the ability to only show reset height button when current height is not the default {kibana-pull}143013[#143013]
* Adds the ability to persist histogram height to local storage {kibana-pull}140997[#140997]
...
Lens & Visualizations::
* Adds support for noPadding option to Lens embeddable {kibana-pull}140442[#140442]
...
* Moves field existence from *Lens* to UnifiedFieldList plugin in *Lens* {kibana-pull}139453[#139453]
...
Security::
Audit events for user_login can be missing when using PKI or Kerberos {kibana-pull}139492[#139492]
...
Discover::
* Fixes an issue where histogram does not fill its container when time interval is not auto {kibana-pull}143004[#143004]
...
Fleet::
* Bugfix: Refresh search results when clearing category filter {kibana-pull}142853[#142853]
...
* Fixes and issue where columns normalized by unit were unable to display properly on Dashboards for *Lens* metric visualizations {kibana-pull}142741[#142741]
...
* Fixes and issue where using annotations from different data views than the visualizations created panel breaks in *TSVB* {kibana-pull}141104[#141104]
...
=== Enhancements
Security::
Logs a hash of the Saved Objects encryption key (`xpack.encryptedSavedObjects.encryptionKey`) when {kib} starts to make it easier to spot mismatched encryption keys {kibana-pull}139874[#139874]

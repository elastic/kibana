...
Alerting::
* Support TheHive connector to cases ({kibana-pull}180931[#180931]).
* TheHive Case Connector ({kibana-pull}180138[#180138]).
* Inference Service Kibana connector ({kibana-pull}189027[#189027]).
...
Discover::
* When editing ES|QL queries, you now get recommendations to help you get started ({kibana-pull}194418[#194418]).
...
* Enable page for metrics and traces ({kibana-pull}190043[#190043]).
...
Machine Learning::
* Daylight saving time calendar events ({kibana-pull}193605[#193605]).
...
* Improves metric styling options in *Lens* ({kibana-pull}186929[#186929]).
...
* Allow +build agent upgrade versions ({kibana-pull}192171[#192171]).
...
* Change UX of edit integration policy agent policies ({kibana-pull}190583[#190583]).
...
* Adds support for client-side `INLINESTATS` validation for ES|QL queries ({kibana-pull}189827[#189827]).
...
* Deactivates client-side pagination for ES|QL results ({kibana-pull}189715[#189715]).
...
Machine Learning::
* File upload: enabling check for model allocations ({kibana-pull}197395[#197395]).
* Data visualizer: Add icons for semantic text, sparse vector and dense vector ({kibana-pull}196069[#196069]).
* Update vCPUs ranges for start model deployment ({kibana-pull}195617[#195617]).
...
* Log rate analysis: ensure ability to sort on Log rate change ({kibana-pull}193501[#193501]).
* Single Metric Viewer: Enable cross-filtering for 'by', 'over' and 'partition' field values ({kibana-pull}193255[#193255]).
* Adds link to anomaly detection configurations from Integration > Assets tab ({kibana-pull}193105[#193105]).
* Anomaly Explorer: Display markers for scheduled events in distribution type anomaly charts ({kibana-pull}192377[#192377]).
* Serverless Security: Adds ES|QL visualizer menu item in nav ({kibana-pull}192314[#192314]).
* Updates icons for Machine Learning embeddable dashboard panel types ({kibana-pull}191718[#191718]).
* AIOps: Using no minimum time range by default for pattern analysis ({kibana-pull}191192[#191192]).
* Link to ML assets from Integration > Assets tab ({kibana-pull}189767[#189767]).
* Utilize the `DataViewLazy` in ML plugin ({kibana-pull}189188[#189188]).
* AIOps: Chunk groups of field candidates into single queries for top items and histograms ({kibana-pull}189155[#189155]).
* AIOps: Update fields filter popover to be able to filter fields from analysis (not just grouping) ({kibana-pull}188913[#188913]).
* Single Metric Viewer embeddable: add forecasting ({kibana-pull}188791[#188791]).
* Adds new custom rule action to force time shift ({kibana-pull}188710[#188710]).
* AIOps: Chunk groups of field candidates into single queries ({kibana-pull}188137[#188137]).
...
* Adds proxy args to install snippets ({kibana-pull}193922[#193922]).
...
* Avoid showing error toast when action is aborted b… ({kibana-pull}195331[#195331]).
...
Elastic Search solution::
* Fixes an issue with the https://www.elastic.co/guide/en/enterprise-search/current/connectors-network-drive.html[Network Drive connector] where advanced configuration fields were not displayed for CSV file role mappings with `Drive Type: Linux` selected.
Elastic Security solution::
For the Elastic Security 8.16.0 release information, refer to {security-guide}/release-notes.html[_Elastic Security Solution Release Notes_].
Kibana platform::
...
Machine Learning::
* File upload fixing PDF character count limit ({kibana-pull}197333[#197333]).
* Data Drift: Update brush positions on window resize fix ({kibana-pull}196830[#196830]).
* AIOps: Fixes issue where some queries cause filters to not be applied ({kibana-pull}196585[#196585]).
* Transforms: Limit the data grid result window ({kibana-pull}196510[#196510]).
* Fixes Anomaly Swim Lane Embeddable not updating properly on query change ({kibana-pull}195090[#195090]).
* Hide ES|QL based saved searches in ML & Transforms ({kibana-pull}195084[#195084]).
* Fixes query for pattern analysis and change point analysis ({kibana-pull}194742[#194742]).
* Various fixes for possible prototype pollution vulnerabilities ({kibana-pull}194529[#194529]).
* Anomaly explorer: Show Data Gaps and Connect Anomalous Points on Single Metric Charts ({kibana-pull}194119[#194119]).
* Fixes file upload with no ingest pipeline ({kibana-pull}193744[#193744]).
* Disable field statistics panel in Dashboard if ES|QL is disabled ({kibana-pull}193587[#193587]).
* Fixes display of assignees when attaching ML panels to a new case ({kibana-pull}192163[#192163]).
* Anomaly explorer: Fix the order of the coordinates displayed on the map tooltip ({kibana-pull}192077[#192077]).
...
* File upload: Increasing timeout for upload request ({kibana-pull}191770[#191770]).
* Improve expired license check ({kibana-pull}191503[#191503]).
Management::

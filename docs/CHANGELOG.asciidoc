...
====
*Details* +
The Elastic Managed LLM may be automatically be selected as your default connector because of existing connector selection logic. 
This may occur if you had not previously selected a specific connector for any of the following reasons:

- You only had one connector available and it was always automatically picked for your conversations.
- You had multiple connectors available but didn’t make a specific selection and used the automatically picked connector for their conversations.
- You previously selected a connector but cleared browser local storage or switched browsers/devices.
- All of your existing connector names sort alphabetically after “Elastic Managed LLM connector."

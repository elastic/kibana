...
* Adds error rate chart to Errors overview and detail views {kibana-pull}67327[#67327]
...
Dashboard::
* Adds Lens drilldowns {kibana-pull}65675[#65675]
* Enables "Explore underlying data" actions for Lens visualizations {kibana-pull}70047[#70047]
* Improves duplicate panel positioning {kibana-pull}67461[#67461]
Discover::
...
Kibana UI::
* Adds link for Cloud deployment settings {kibana-pull}66486[#66486]
...
* Adds visualization by value to dashboard {kibana-pull}69898[#69898]
Logs::
...
* Adds optional ability to delete target index and index pattern when deleting DFA job {kibana-pull}66934[#66934]
* DF Analytics: Creation wizard part 1 {kibana-pull}67564[#67564]
* Extends population preview chart to show actual and typical value {kibana-pull}67569[#67569]
* Adds minor refresh button to DFA and AD Job Messages tabs {kibana-pull}67750[#67750]
...
* DF Analytics: Creation wizard part 2 {kibana-pull}68462[#68462]
* Removes sub navigation menu from the Anomaly Detection pages {kibana-pull}68663[#68663]
* Adds Anomaly Swimlane Embeddable to the dashboard from the Anomaly Explorer page {kibana-pull}68784[#68784]
...
* DF Analytics: add ability to edit job for fields supported by API {kibana-pull}70489[#70489]
* DF Analytics: adds prompt for destination index pattern creation {kibana-pull}70651[#70651]
...
Security::
* Searches across spaces {kibana-pull}67644[#67644]
SIEM::
* [Detection Engine] Incorporate large lists to rule execution {kibana-pull}65372[#65372]
* Updates signals index ECS mapping to 1.6-dev, add endpoint alert fields {kibana-pull}65740[#65740]
* [Detection Engine] Increases the template limit for ECS mappings {kibana-pull}65873[#65873]
* [CASE] IBM Resilient Connector {kibana-pull}66385[#66385]
* [Lists] Adds 90% of the REST API and client API for exception lists and exception items {kibana-pull}66443[#66443]
* [Exceptions] - Exception builder component {kibana-pull}67013[#67013]
* [Detections] Value Lists Management Modal {kibana-pull}67068[#67068]
* [Timeline] Persist timeline to localStorage {kibana-pull}67156[#67156]
* [Exceptions] - Added exception list hooks for UI {kibana-pull}67300[#67300]
* [Lists] Adds _find to value lists  {kibana-pull}67395[#67395]
* [Exceptions] Add success/error toast component on alert state change {kibana-pull}67406[#67406]
* [Exceptions] - Update exceptions hooks to include _find filtering {kibana-pull}67435[#67435]
* [Detections] Renames Signals to Alerts {kibana-pull}67731[#67731]
* Manages timeline templates user flow {kibana-pull}67837[#67837]
* Renames siem plugin to security_solution {kibana-pull}67902[#67902]
* [Exceptions] - Part 1 of ExceptionViewer UI {kibana-pull}68027[#68027]
* Updates links for add-data button {kibana-pull}68240[#68240]
* [Exceptions] - ExceptionsViewer UI component part 2 {kibana-pull}68294[#68294]
* [Detections] Increase lookback when gap is detected {kibana-pull}68339[#68339]
* [Detections] In progress alert state {kibana-pull}68569[#68569]
* [Cases] Attach timeline to existing case {kibana-pull}68580[#68580]
* [Detections Engine] - Exceptions viewer cleanup {kibana-pull}68651[#68651]
* [Exceptions] - ExceptionsViewer cleanup {kibana-pull}68739[#68739]
* Introduces kibana nav {kibana-pull}68862[#68862]
* [Exceptions] - Updates exception list item comments structure {kibana-pull}68864[#68864]
* Removes endpoint alert fields from signal mapping {kibana-pull}68934[#68934]
* [Exceptions] - Updates exception structure and corresponding UI types {kibana-pull}69120[#69120]
* [Exceptions] - Cleaned up and updated exception list item comment structure {kibana-pull}69532[#69532]
* Allows to configure Event Renderers settings {kibana-pull}69693[#69693]
* [Detection Engine] - Update DE to work with new exceptions schema {kibana-pull}69715[#69715]
* Investigates in Resolver Timeline Integration {kibana-pull}70111[#70111]
* [Detection Engine][Lists] Adds additional data types to value based lists {kibana-pull}70256[#70256]
* [Fixes #65941] Adds field mapping support to rule creation Part I {kibana-pull}70288[#70288]
* [Exceptions] - Exception Modal Part I {kibana-pull}70639[#70639]
* [Detection Engine] Speeds up value list imports by enabling streaming of files {kibana-pull}70685[#70685]
* Changes default index pattern {kibana-pull}70797[#70797]
* [Exceptions] - Exceptions modal pt 2 {kibana-pull}70886[#70886]
* [Exceptions] - Tie server and client code together {kibana-pull}70918[#70918]
* [Detection Engine][Lists] Removes feature flag for lists {kibana-pull}71011[#71011]
* [Exceptions] Exception modal bulk close alerts that match exception attributes {kibana-pull}71321[#71321]
* [Detection Engine][Lists] Adds read_privileges route for lists and list items {kibana-pull}71351[#71351]
* [Detections] Create value list indexes if they do not exist {kibana-pull}71360[#71360]
* [Detections] Create Threshold-based Rule type {kibana-pull}71371[#71371]
* [Hosts] Endpoint overview on host details page {kibana-pull}71466[#71466]
* [Detection Engine] - Update exceptions logic {kibana-pull}71512[#71512]
* [Detection Engine][Lists] Adds the ability for exception lists to be multi-list queried {kibana-pull}71540[#71540]
* [DETECTIONS] Set rule status to failure only on large gaps {kibana-pull}71549[#71549]
* [Lists] - Update exception comments logic in API {kibana-pull}71602[#71602]
* [Exceptions] - Adds filtering to endpoint index patterns by exceptional fields {kibana-pull}71757[#71757]
* Full screen timeline, Collapse event {kibana-pull}71786[#71786]
* [Detection Engine][Lists] Adds specific endpoint_list REST API and API for abilities to auto-create the endpoint_list if it gets deleted {kibana-pull}71792[#71792]
* [Detections] Associate Endpoint Exceptions List to Rule during rule creation/update {kibana-pull}71794[#71794]
* [Detections] Disable exceptions for Threshold and ML rules {kibana-pull}72137[#72137]
* [Detection Engine][Lists] Adds list permissions {kibana-pull}72335[#72335]
* [Exceptions] - Make esTypes and subType available to index patterns {kibana-pull}72336[#72336]
* [Detection Engine][Lists] Adds conflict versioning and io-ts improvements to lists {kibana-pull}72337[#72337]
* [Exceptions] - Update UI exceptions builder nested logic {kibana-pull}72490[#72490]
* [Detection Engine][Lists] Adds version and immutability data structures {kibana-pull}72730[#72730]
* [Exceptions] - Require non empty entries and non empty string values in exception list items {kibana-pull}72748[#72748]
* [Exceptions] - Update exception item comments to include id {kibana-pull}73129[#73129]
* [Exceptions] - Update rule.exceptions_list to include exception list list_id {kibana-pull}73349[#73349]
* [Exceptions] - Updates exception hooks and viewer {kibana-pull}73588[#73588]
* [Exceptions] - Update how nested entries are displayed in exceptions viewer {kibana-pull}73745[#73745]
* [Exceptions] Adds autocomplete workaround for .text fields {kibana-pull}73761[#73761]
* [Endpoint][Exceptions] Only write manifest to policy when there are changes {kibana-pull}72000[#72000]
* [Exceptions] Use semantic version for manifest version + Scaling Tweaks {kibana-pull}73388[#73388]
* Resolver in timeline {kibana-pull}69728[#69728]
Uptime::
...
* Migrates the old `alerting` consumer to be `alerts` {kibana-pull}69982[#69982]
* Displaya Too Many Buckets error when previewing Inventory Alerts {kibana-pull}70508[#70508]
...
Security::
* Clones role button going to edit page {kibana-pull}70768[#70768]
Sharing::
* Adds panel flyout opens 2 flyouts {kibana-pull}65861[#65861]
SIEM::
* [Detections Engine] - Fix reference rule url overflow {kibana-pull}68640[#68640]
* [Detection Engine] Fixes a stale view/query within the signals table when re-opening/closing signals  {kibana-pull}69217[#69217]
* Repositions EuiPopovers on scroll {kibana-pull}69433[#69433]
* [Detection Engine] Fixes 7.8 and 7.9 upgrade issue within rules where you can get the error "params invalid: [lists]: definition for this key is missing" {kibana-pull}69464[#69464]
* Renames old xpack.siem kibana config to xpack.securitySolution {kibana-pull}69874[#69874]
* [Exceptions Builder] - Fixes operator selection bug {kibana-pull}71178[#71178]
* Deduplicates of entries and items before sending to endpoint {kibana-pull}71297[#71297]
* [Exceptions] - Remove initial add exception item button in builder {kibana-pull}72215[#72215]
* [Detection Engine][Lists] Limits the upload size of lists to 9 meg size {kibana-pull}72898[#72898]
* [Exceptions] Preserve rule exceptions when updating rule {kibana-pull}72977[#72977]
* [Detection Engine][Lists] Adds the ability to change the timeout limits from 10 seconds for loads for imports {kibana-pull}73103[#73103]
* Fixes broken maps link to Kibana index management {kibana-pull}73757[#73757]
* [Detection Engine] Fixes tags to accept characters such as AND, OR, (, ), ", * {kibana-pull}74003[#74003]
* Changes signal.rule.risk score mapping from keyword to float {kibana-pull}71126[#71126]
* Limits concurrent access to  download API + Replace with LRU cache {kibana-pull}72503[#72503]
Uptime::

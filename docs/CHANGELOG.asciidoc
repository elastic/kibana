...
* Saves time selected in Threat intelligence insights to local storage ({kibana-pull}243571[#243571]).
* Saves time selected in Prevalence insights to local storage ({kibana-pull}243543[#243543]).
...
Elastic Security solution::
* Ignores `resource_already_exists_exception` for value list creation ({kibana-pull}243642[#243642]).
* Fixes an issue with displaying ES|QL queries in full screen mode in Timeline ({kibana-pull}243013[#243013]).
Kibana platform::

...
which describes changes to the visualizations response handler, data schema, and aggregations.

[float]
[[features-6.0.0]]
=== New features
For an overview of the new features that were added in 6.6.0 and how the user experience 
improved, see the <<release-highlights-6.6.0, 6.6.0 Release Highlights>>.
...
* [Fixes #26244] Add setting to enable frozen index search {pull}27297[#27297]
...
* Moves SavedObjectClient types alongside js source {pull}26448[#26448]
...
* Refactors 'capabilites' to 'metadata'. {pull}25580[#25580]

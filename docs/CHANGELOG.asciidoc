...
For information about the {kib} 8.18.0 release, review the following information.
...
====
*Details* +
!!TODO!! For more information, refer to ({kibana-pull}201100[#201100]).
...
[discrete]
[[deprecation-206904]]
* Adds management deprecated apis to the upgrade assistant.
[%collapsible]
====
*Details* +
!!TODO!! For more information, refer to ({kibana-pull}206904[#206904]).
...
[discrete]
[[deprecation-206903]]
* Adds upgrade notes for management deprecated apis.
[%collapsible]
====
*Details* +
!!TODO!! For more information, refer to ({kibana-pull}206903[#206903]).
...
[discrete]
[[deprecation-202775]]
* Adds deprecation warning for the legacy risk score modules.
[%collapsible]
====
*Details* +
!!TODO!! For more information, refer to ({kibana-pull}202775[#202775]).
...
====
*Details* +
!!TODO!! For more information, refer to ({kibana-pull}202662[#202662]).
...
====
*Details* +
!!TODO!! For more information, refer to ({kibana-pull}201625[#201625]).
...
====
*Details* +
!!TODO!! For more information, refer to ({kibana-pull}199656[#199656]).
...
* Improves Dashboard layout engine by switching to the internally developed `kbn-grid-layout` ({kibana-pull}205341[#205341]).
* [Heatmap] Add ability to rotate X axis label in *Lens* ({kibana-pull}202143[#202143]).
Data ingestion and Fleet::
* Display next steps and actions in agentless integrations flyout ({kibana-pull}203824[#203824]).
* Feature to support columns when exporting agents to CSV ({kibana-pull}203103[#203103]).
...
* Added createdBy and updatedBy fields in summary documents !! ({kibana-pull}205784[#205784]).
* Space aware private locations !! ({kibana-pull}202634[#202634]).
* Sub-feature for managing private locations !! ({kibana-pull}201100[#201100]).
////
...
////
* Feat(slo): allow configuration of advanced settings from UI ({kibana-pull}200822[#200822]).
////
!!TODO!! The above PR had a lengthy release note description:
...
* Adds new security module to detect anomalous activity in host-based logs ({kibana-pull}195582[#195582]).
Platform::
* Dashboard variables ({kibana-pull}202875[#202875]).
////
!!TODO!! The above PR had a lengthy release note description:
...
=== Enhancements
Alerting::
* Allow pre-configured connectors to opt-in to exposing their config by setting `exposeConfig` ({kibana-pull}207654[#207654]).
...
* Pass any field to ServiceNow using the ServiceNow SecOps connector with a JSON field called "additional fields" ({kibana-pull}201948[#201948]).
Dashboards & Visualizations::
* Fixes the values control FT ({kibana-pull}211159[#211159]).
* Allow custom MVT sources to style the map layers and provide custom legend ({kibana-pull}200656[#200656]).
Data ingestion and Fleet::
* Enable subfeature privileges ({kibana-pull}203182[#203182]).
Discover::
* Adds "All logs" data view to classic nav ({kibana-pull}209042[#209042]).
* Sets the KQL/Lucene query on dataview to ES|QL transition ({kibana-pull}206391[#206391]).
* Remove redundant data fetching when hiding/showing the histogram/chart ({kibana-pull}206389[#206389]).
...
* Make Copy action visible on cell hover ({kibana-pull}204744[#204744]).
* Rename Saved Search to Discover Session ({kibana-pull}202217[#202217]).
* Supports custom formatters in charts ({kibana-pull}201540[#201540]).
Elastic Observability solution::
* Default to "native" function calling if the connector config is not exposed ({kibana-pull}210455[#210455]).
* Adds selector syntax support to log source profile ({kibana-pull}206937[#206937]).
* Use rule form to create rules in observability ({kibana-pull}206774[#206774]).
* Display stacktrace in the logs overview tab ({kibana-pull}204521[#204521]).
Elastic Security solution::
For the Elastic Security 8.18.0 release information, refer to {security-guide}/release-notes.html[_Elastic Security Solution Release Notes_].
Kibana platform::
* Configure appearance color mode ({kibana-pull}203406[#203406]).
////
!!TODO!! The above PR had a lengthy release note description:
...
* Reindexing the .kibana_security_session_1 index to the 8.x format ({kibana-pull}204097[#204097]).
////
!!TODO!! The above PR had a lengthy release note description:
...
////
* Enable on-prem ({kibana-pull}203239[#203239]).
////
!!TODO!! The above PR had a lengthy release note description:
...
////
* Operator privileges ({kibana-pull}196583[#196583]).
////
!!TODO!! The above PR had a lengthy release note description:
...
Management::
* Update JSON schemas for code editors ({kibana-pull}207706[#207706]).
* Update knn search and query template autocomplete ({kibana-pull}207187[#207187]).
* Transforms: Improve messages for recovered alerts ({kibana-pull}205721[#205721]).
* Adds support for rawValue in url label ({kibana-pull}204192[#204192]).
* Allow boolean field to be colored ({kibana-pull}203498[#203498]).
...
* Chore: bump kube-stack Helm chart onboarding version ({kibana-pull}208217[#208217]).
...
=== Bug fixes
Alerting::
* Fixes editing alerts filter for multi-consumer rule types on serverless ({kibana-pull}206848[#206848]).
* Fixes alert mute/unmute action ({kibana-pull}204182[#204182]).
Dashboards & Visualizations::
* [Embeddable] Make sure to not serialize searchSessionId in *Lens* ({kibana-pull}210765[#210765]).
////
!!TODO!! The above PR had a lengthy release note description:
...
* [Embeddable] Restore show missing dataView error message in case of missing datasource in *Lens* ({kibana-pull}208363[#208363]).
* Make drag preview absolute positioned ({kibana-pull}208247[#208247]).
* Improve help text of creator and view count features on dashboard listing page ({kibana-pull}202488[#202488]).
* Debounce time slider selections ({kibana-pull}201885[#201885]).
Data ingestion and Fleet::
* Support `is_default` on integration deployment modes ({kibana-pull}208284[#208284]).
* Fixes UI error when agent goes to orphaned state ({kibana-pull}207746[#207746]).
* Restrict non-local ES output types for agentless integrations and policies ({kibana-pull}207296[#207296]).
* Fixes bulk actions timing out sometimes ({kibana-pull}205735[#205735]).
* Fixes generation of dynamic mapping for object with specific subfield ({kibana-pull}204104[#204104]).
* Fixes stuck in updating logic when agent is scheduled for upgrading ({kibana-pull}202126[#202126]).
Discover::
...
* Fixes CSV export with named params ({kibana-pull}206914[#206914]).
* Prevent redundant requests when loading Discover sessions and toggling chart visibility ({kibana-pull}206699[#206699]).
* Query history fixes ({kibana-pull}206418[#206418]).
* Allows the editor suggestions to be visible when inline docs flyout is open ({kibana-pull}206064[#206064]).
* QL] Ensure the same time range is being used for documents and histogram ({kibana-pull}204694[#204694]).
...
* Highlight matching field values when performing a KQL search on a keyword field ({kibana-pull}201952[#201952]).
Elastic Observability solution::
* Pass system message to inferenceCliente.chatComplete ({kibana-pull}211263[#211263]).
* Fixes connector test in MKI ({kibana-pull}211235[#211235]).
* Adds KB re-indexing when encountering `semantic_text` bug ({kibana-pull}210386[#210386]).
...
* Fixes access bug with user instructions ({kibana-pull}207069[#207069]).
* Error when using ollama model locally ({kibana-pull}206739[#206739]).
* Fixes editing prompt from contextual insights ({kibana-pull}206673[#206673]).
* Install Knowledge Base from ai assistant settings ({kibana-pull}206408[#206408]).
* Fixes logger on telemetry ({kibana-pull}204388[#204388]).
* _count guards against no valid sources ({kibana-pull}204224[#204224]).
* Switch to the latest CloudFormation template ({kibana-pull}204185[#204185]).
* Fix: Improve tool choice handling in Observability AI Assistant client ({kibana-pull}203928[#203928]).
* Fix(slo): introduce cursor pagination in Find SLO API ({kibana-pull}203712[#203712]).
////
!!TODO!! The above PR had a lengthy release note description:
Enhanced the Find API by introducing cursor-based pagination (`search_after`) to complement the existing offset-based approach. This update addresses issues with large result sets exceeding the Elasticsearch limit and allows seamless navigation through extensive lists of SLOs without manual filtering.
////
* Fixes alerts function ({kibana-pull}203695[#203695]).
* Update required field from 'score' to 'scores' ({kibana-pull}203584[#203584]).
* Fixes APM rule error msg when KQL filter is invalid ({kibana-pull}203096[#203096]).
* Fixes service names with spaces are not being URL encoded properly for {{context.viewInAppUrl}} ({kibana-pull}202890[#202890]).
...
* Remove flaky test skip for AI assistant chat complete endpoint ({kibana-pull}200871[#200871]).
Elastic Security solution::
For the Elastic Security 8.18.0 release information, refer to {security-guide}/release-notes.html[_Elastic Security Solution Release Notes_].
Kibana platform::
* Fixes Dropdown Label Sync Issue on Sorting by "Type" ({kibana-pull}206424[#206424]).
* Consistent help dropdown UI ({kibana-pull}206280[#206280]).
* Listing page papercuts part 1 ({kibana-pull}205914[#205914]).
Kibana security::
...
* Fixed privileges display for features/subFeatures that require all spaces ({kibana-pull}204402[#204402]).
...
* Removed `panelled` property that was covering the background image for Spaces Selector page ({kibana-pull}199981[#199981]).
...
* Notifications: Fix table responsiveness ({kibana-pull}206956[#206956]).
...
* Removing ignore_throttled from anomaly detection job results searches ({kibana-pull}203788[#203788]).
* Anomaly Explorer: Fixes handling of job group IDs when opening from dashboard panels ({kibana-pull}203224[#203224]).
* AiOps: Fix Log Rate Analysis Embeddable Error on the Alerts Page ({kibana-pull}203093[#203093]).
* Initialize saved objects on trained model page load ({kibana-pull}201426[#201426]).
Management::
* Better privilege checking for component index templates ({kibana-pull}202251[#202251]).
Sharing::
* Update Library Transforms and Duplicate ({kibana-pull}206140[#206140]).
Other::
* Fixes error page for workplace search ({kibana-pull}211011[#211011]).
...
* Show all alerts in Infra views (Host + Containers) for consistency with entity inventory ({kibana-pull}202188[#202188]).

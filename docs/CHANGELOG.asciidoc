...
{kibana-ref-all}/7.13/release-notes-7.14.0.html#breaking-changes-7.14.0[7.14] | {kibana-ref-all}/7.13/release-notes-7.13.0.html#breaking-changes-7.13.0[7.13] | 
...
* Set code editor height to solve an overlap in default policy settings {kibana-pull}113763[#113763]
* Fixes some vars from preconfiguration not being added to package policies {kibana-pull}113204[#113204]
Lens & Visualizations::

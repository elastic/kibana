...
====
*Details* +
Removes the `apm_user` role from the APM documentation. For more information, check {kibana-pull}132790[#132790].
...
* APM anomaly rule type should appear in o11y rules page {kibana-pull}132476[#132476]
...
Platform::
Retry INIT step when hitting incompatible_cluster_routing_allocation {kibana-pull}131809[#131809]

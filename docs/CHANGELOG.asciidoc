...
Fleet::
* Elastic Agent now installs when updating policy with monitoring_enabled {kibana-pull}133530[#133530]
* Removes misc beats tutorials from elastic_stack category {kibana-pull}132957[#132957]
Management::

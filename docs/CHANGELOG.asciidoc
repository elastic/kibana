...
If you have changed the default https://www.elastic.co/guide/en/kibana/current/advanced-options.html#visualization-visualize-chartslibrary[Advanced Settings], you must disable the legacy charts library to use the new charts library:

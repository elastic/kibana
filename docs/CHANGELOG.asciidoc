...
* Adds Cases to the Stack Management page {kibana-pull}125224[#125224]
...
Machine Learning::
* Anomaly Detection: Add link to maps in charts section of Anomaly Explorer {kibana-pull}128697[#128697]
...
* Enables document explorer as default {kibana-pull}125485[#125485]
...
Fleet::
* Adds link to ILM policy documentation {kibana-pull}128656[#128656]
...
* Adds embeddable enhancement {kibana-pull}125299[#125299]
...
* Adds new autoExtendBounds setting to histogram agg config {kibana-pull}118855[#118855]

Machine Learning::
* Combines annotations into one block if multiple of them overlap {kibana-pull}128782[#128782]
* Adds `throughput_last_minute` to the Deployment stats {kibana-pull}128611[#128611]
* Anomaly Charts API endpoint {kibana-pull}128165[#128165]
...
* Fixes Single Metric Viewer for jobs that hasn't been run {kibana-pull}129063[#129063]
* Data Frame Analytics: Fix Outlier detection results exploration color legend display {kibana-pull}129058[#129058]
* Fixes new AD job from saved search with no query filter {kibana-pull}129022[#129022]
* Fixes DFA map saved object sync warning {kibana-pull}128876[#128876]
* Fixes get_filter endpoint {kibana-pull}128238[#128238]
* Adds error toast to Data visualizer when using unpopulated time field {kibana-pull}127196[#127196]
* Adds data recognizer module config cache {kibana-pull}126338[#126338]
...
Platform::
* Duplicated datatable available as inspector data for Heatmap chart {kibana-pull}126786[#126786]
* We fixed an issue that would cause Kibana to become unresponsive while generating a PDF report {kibana-pull}124787[#124787]
* We fixed a bug that resulted in an unfriendly notification title being displayed after a report has run {kibana-pull}123607[#123607]

...
====
*Details* +
The Uptime app is already hidden from Kibana when there is no recent Heartbeat data, but will be completely removed in 9.0.0. You should migrate to Synthetics as an alternative. See the https://www.elastic.co/guide/en/observability/8.15/uptime-intro.html[_Uptime documentation_] for more details.
====

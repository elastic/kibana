...
====
*Details* +
Upgrading {kib} from version 8.x to 8.18.2 fails due to a configuration conflict in the `kibana.yml` file. {kib} fails to boot and shows a fatal error message in the {kib} logs:

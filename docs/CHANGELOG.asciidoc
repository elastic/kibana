...
The 7.12.2 release includes the following bug fixes.
...
Elastic Security::
For the Elastic Security 7.12.2 release information, refer to {security-guide}/release-notes.html[_Elastic Security Solution Release Notes_].
...
Management::
* Fixes the search sessions documentation link {kibana-pull}98918[#98918]
* Fixes displaying expired search sessions on the management screen {kibana-pull}98915[#98915]
* Transforms/Data Frame Analytics: Fix freezing wizard for indices with massive amounts of fields {kibana-pull}98259[#98259]
* Console's handling of responses from the cluster have been made more robust as well as a fix for editor mode switching that ensures we do not continuing to show XJSON syntax highlighting for text and csv based responses {kibana-pull}97983[#97983]
* Fixes the "Copy as cURL" functionality in Console which was not copying to the system clipboard on newer browser versions {kibana-pull}97968[#97968]
...
{kibana-ref-all}/7.11/breaking-changes-7.11.html[7.11] | {kibana-ref-all}/7.10/breaking-changes-7.10.html[7.10] |

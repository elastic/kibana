...
[discrete]
[[breaking-108961]]
.Updating UI to work with new kibana privileges abstraction on alerts
[%collapsible]
====
*Details* +
!!TODO!! For more information, refer to {kibana-pull}108961[#108961]
...
[discrete]
[[breaking-104196]]
.Remove metadata query strategy v1
[%collapsible]
====
*Details* +
!!TODO!! For more information, refer to {kibana-pull}104196[#104196]
...
====
*Details* +
!!TODO!! For more information, refer to {kibana-pull}103652[#103652]
...
[discrete]
[[breaking-103494]]
.Create expression functions for object types used in agg params
[%collapsible]
====
*Details* +
!!TODO!! For more information, refer to {kibana-pull}103494[#103494]
...
[discrete]
[[breaking-tbd]]
.New scheduled query action ID format
[%collapsible]
====
*Details* +
...
[discrete]
[[deprecation-108826]]
.Adds deprecation notice to dashboard import/export docs
[%collapsible]
====
*Details* +
!!TODO!! For more information, refer to {kibana-pull}108826[#108826]
...
[discrete]
[[deprecation-108281]]
.Deprecate ability to disable alerting, actions, task manager, stack alerts, and event log plugins
[%collapsible]
====
*Details* +
!!TODO!! For more information, refer to {kibana-pull}108281[#108281]
...
[discrete]
[[deprecation-106566]]
.Move more filter utils to package and cleanup API
[%collapsible]
====
*Details* +
!!TODO!! For more information, refer to {kibana-pull}106566[#106566]
...
[discrete]
[[deprecation-106232]]
.Textarea ui argument refactor
[%collapsible]
====
*Details* +
!!TODO!! For more information, refer to {kibana-pull}106232[#106232]
...
[discrete]
[[deprecation-105981]]
.Deprecate xpack.maps.showMapVisualizationTypes
[%collapsible]
====
*Details* +
!!TODO!! For more information, refer to {kibana-pull}105981[#105981]
...
[discrete]
[[deprecation-105742]]
.String ui argument refactor
[%collapsible]
====
*Details* +
!!TODO!! For more information, refer to {kibana-pull}105742[#105742]
...
[discrete]
[[deprecation-104685]]
.Security/document audit deprecation
[%collapsible]
====
*Details* +
!!TODO!! For more information, refer to {kibana-pull}104685[#104685]
...
[discrete]
[[deprecation-100781]]
.Use deprecation api for scripted fields
[%collapsible]
====
*Details* +
!!TODO!! For more information, refer to {kibana-pull}100781[#100781]
...
[discrete]
[[deprecation-105055]]
.Deprecates legacy charts library
[%collapsible]
====
*Details* +
The legacy area, line, bar, and pie charts library are deprecated in 7.15.0. In 7.16.0, support for the legacy charts library will be removed. For more information, refer to {kibana-pull}105055[#105055].

*Impact* +
You must use the new charts library to create area, line, bar, and pie charts, which includes improved performance, color palettes, fill capacity, and more. 

To use the new charts library, you must disable the legacy charts library:
...
APM::
* Enable metric-powered ui {kibana-pull}104929[#104929]
Data ingest::
...
Lens & Visualizations::
* Synchronize cursor position for X-axis across all Lens visualizations in a dashboard in *Lens* {kibana-pull}106845[#106845]
* Client Side caching in *Visualize* {kibana-pull}105589[#105589]
Machine Learning::
* Check for error messages in the Anomaly Detection jobs health rule type {kibana-pull}108701[#108701]
* Adding reset anomaly detection jobs link to jobs list {kibana-pull}108039[#108039]
...
Osquery Manager::
* Adds RBAC {kibana-pull}106669[#106669]
* Adds ECS mapping editor {kibana-pull}107706[#107706]
Querying & Filtering::
...
APM::
* Enable JVM metrics for the Ruby Agent running on a JVM (jRuby) {kibana-pull}108933[#108933]
* APM agent instrumentation instructions in Fleet {kibana-pull}108242[#108242]
* Displays callout when transaction events are used instead of aggregrated metrics {kibana-pull}108080[#108080]
* Rename "Error rate" to "Failed transaction rate" {kibana-pull}107895[#107895]
* Fixing service inventory responsive design {kibana-pull}107690[#107690]
* Adds a logs tab for services {kibana-pull}107664[#107664]
* Share components across Service overview and transactions. Add time comparison to the Transactions page {kibana-pull}107299[#107299]
* Services inventory: add time comparisons to match service overview design {kibana-pull}107094[#107094]
* Adds backend info and icons to flyouts {kibana-pull}107089[#107089]
* Visualizing composite spans {kibana-pull}106862[#106862]
* Allow editing of APM rules {kibana-pull}106598[#106598]
* Fleet: APM Integration settings (fleet editor) redesign {kibana-pull}106535[#106535]
...
* Improve empty state page {kibana-pull}103602[#103602]
Elastic Security::
For the Elastic Security 7.15.0 release information, refer to {security-guide}/release-notes.html[_Elastic Security Solution Release Notes_].
Enterprise Search::
...
Fleet::
* Update Package Policy UI to Support Upgrading Package Policies {kibana-pull}107171[#107171]
* Remove subseconds from event.ingested {kibana-pull}104044[#104044]
...
Lens & Visualizations::
* Long legend values support {kibana-pull}108365[#108365]
...
* Fixes do not submit invalid query in filtered metric in *Lens* {kibana-pull}107542[#107542]
...
* Fixes the values inside bar charts {kibana-pull}106198[#106198]
* Client Side caching in *Visualize* {kibana-pull}105589[#105589]
...
* Check for error messages in the Anomaly Detection jobs health rule type {kibana-pull}108701[#108701]
* Replace APM error rate table with failed transactions correlations {kibana-pull}108441[#108441]
* Adds initial record score to the anomalies table expanded row content {kibana-pull}108216[#108216]
* Adding reset anomaly detection jobs link to jobs list {kibana-pull}108039[#108039]
* Data Frame Analytics: add evaluation quality metrics to Classification exploration view {kibana-pull}107862[#107862]
* Adds a 30 day model prune window to non-rare Security jobs {kibana-pull}107752[#107752]
* APM Latency Correlations: Field/value candidates prioritization {kibana-pull}107370[#107370]
* Move APM Latency Correlations from flyout to transactions page {kibana-pull}107266[#107266]
* Delayed data test for Anomaly Detection jobs health rule type {kibana-pull}107183[#107183]
* Model memory state test for Anomaly Detection jobs health rule type {kibana-pull}106763[#106763]
* Enable Index data visualizer document count chart to update time range query {kibana-pull}106438[#106438]
* Alerting rule for Anomaly Detection jobs monitoring {kibana-pull}106084[#106084]
* Edits rare anomaly detection job summaries {kibana-pull}105694[#105694]
* Jobs import and export {kibana-pull}101037[#101037]
Management::
* Added index templates flyout to the edit policy form {kibana-pull}108362[#108362]
...
* Added a flyout with linked index templates {kibana-pull}106734[#106734]
* Adding es version field support {kibana-pull}104870[#104870]
...
Metrics::
* Move saved views button to page header {kibana-pull}107951[#107951]
...
Monitoring::
* Enable OOTB alerts in RAC page and multiple rules of a rule type {kibana-pull}106457[#106457]
Osquery Manager::
* Fixes scheduled query status {kibana-pull}106600[#106600]
Platform::
* Improves not found response handling in the saved objects repository {kibana-pull}108749[#108749]
* Update `esaggs` expressions function to return partial results {kibana-pull}105620[#105620]
* Update expressions public API to expose partial results support {kibana-pull}102403[#102403]
* Change execution of alerts from async to sync {kibana-pull}97311[#97311]
Querying & Filtering::
...
Other::
* Added Thumbnails to Search UI {kibana-pull}104199[#104199]
...
* Agent policy search, support simple text filter {kibana-pull}107306[#107306]
Kibana Home & Add Data::
* Fixed `tabindex` and collapsible functionality {kibana-pull}107462[#107462]
Lens & Visualizations::
...
* Data Grid: Fix alignment of sorting arrow when histogram charts are enabled {kibana-pull}110053[#110053]
* Removes hardcoded datafeed indices for security auth and network modules {kibana-pull}109692[#109692]
* Fixing missing final new line character issue {kibana-pull}109274[#109274]
* Data Frame Analytics wizard: ensure cloning retains hyperparameters and results field is correct {kibana-pull}107811[#107811]
* Disable query delay editing for non-admin users {kibana-pull}107517[#107517]
* Data frame analytics: ensure results view loads correctly for job created in dev tools {kibana-pull}107024[#107024]
Management::
* Remove index pattern placeholder advanced setting {kibana-pull}110334[#110334]
...
* Remove alert previews {kibana-pull}107978[#107978]
* Ensure alert dropdown closes properly {kibana-pull}106343[#106343]
...
Platform::
* Migrationsv2: limit batch sizes to migrations.batchSizeBytes (= 100mb by default) {kibana-pull}109540[#109540]
Reporting::

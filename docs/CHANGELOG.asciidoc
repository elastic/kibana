...
[discrete]
[[breaking-182074]]
.Renamed the an advanced setting to enable {esql}.
[%collapsible]
====
*Details* +
...
[discrete]
[[breaking-177549]]
.The region map visualization type is Generally Available.
[%collapsible]
====
*Details* +
...
* Adds a chart switcher to {esql} in *Lens* ({kibana-pull}177790[#177790]).
Fleet::
...
For the Elastic Security 8.14.0 release information, refer to {security-guide}/release-notes.html[_Elastic Security Solution Release Notes_].
Elastic Search::
* Adds Playground telemetry ({kibana-pull}181587[#181587]).
ES|QL::

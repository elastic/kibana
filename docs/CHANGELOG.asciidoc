...
Breaking changes can prevent your application from optimal operation and performance. Review the following breaking changes, then mitigrate the impact to your appilication.
...
*Impact* +
When you upgrade, the legacy dashboard-only mode will no longer be available.
====

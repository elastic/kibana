...
Review the {kib} 8.0.0 changes, then use the <<upgrade-assistant,Upgrade Assistant>> to complete the upgrade.
...
==== Bug Fixes
APM::
Restrict aggregated tx metrics search to date range {kibana-pull}123445[#123445]

...
=== Known issues
Visualizations::
A known issue prevents users from creating or viewing visualizations outside
of the default space. {pull}27257[#27257]
+
This same issue prevents Canvas from loading outside of the default space. {pull}27262[#27262]   
+

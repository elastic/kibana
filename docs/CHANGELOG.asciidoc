...
Before you upgrade to 7.13.4, review the <<breaking-changes-7.13.0,breaking changes>>, then mitigate the impact to your application.
...
Breaking changes can prevent your application from optimal operation and performance.
Before you upgrade to 7.13.3, review the <<breaking-changes-7.13.0,breaking changes>>, then mitigate the impact to your application.
...
Breaking changes can prevent your application from optimal operation and performance.
Before you upgrade to 7.13.2, review the <<breaking-changes-7.13.0,breaking changes>>, then mitigate the impact to your application.
...
Breaking changes can prevent your application from optimal operation and performance.
Before you upgrade to 7.13.1, review the <<breaking-changes-7.13.0,breaking changes>>, then mitigate the impact to your application.

...
*Impact* +
In 7.14.0 and later, the new aggregation-based pie chart visualization is available by default. For more information, check https://www.elastic.co/guide/en/kibana/8.8/add-aggregation-based-visualization-panels.html[Aggregation-based visualizations]..
====

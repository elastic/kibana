...
[discrete]
[[deprecation-111676]]
.Expands parameters for `xpack.security.enabled` deprecation message 
[%collapsible]
====
*Details* +
When the deprecated `xpack.security.enabled` setting is set to any value, the deprecation message now automatically appears. For more information, refer to {kibana-pull}111676[#111676].

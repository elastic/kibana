...
Dashboards and Visualizations::
* Fixes issues with dashboard sharing links where copied links were not shortened and some users were unable to copy links in new spaces ({kibana-pull}227625[#227625]).
Data ingestion and Fleet::

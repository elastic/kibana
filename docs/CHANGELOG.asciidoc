...
* Fixes the issue with Stack Monitoring showing an "Unable to load page" error ({kibana-pull}200043[#200043]). 
* Fixes the issue with the APM and OpenTelemetry tutorial showing an "Unable to load page" error ({kibana-pull}199301[#199301]).

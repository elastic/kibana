...
*Impact* +
To auto-fit the table row height, create an <<create-aggregation-based-panel, aggregation-based data table>>, click *Options*, then select *Auto fit rows to content*.
====

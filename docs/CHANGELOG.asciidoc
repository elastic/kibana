...
The 8.17.3 release includes the following bug fixes and known issue.

[float]
[[known-issues-8.17.3]]
=== Known issues
.Error migrating and validating the inventory-view saved object
...
For more information, refer to https://github.com/elastic/kibana/issues/209996[#209996].

*Impact* +

The validation error prevents Kibana from completing the bootstrap process, which may affect Kibana availability. Additionally, it blocks users from saving views in the Infrastructure Inventory page.
====

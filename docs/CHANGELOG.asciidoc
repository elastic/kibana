...
To learn about the {kib} 7.0.0 release, review the following:
...
For more details about the breaking changes, refer to link:https://www.elastic.co/guide/en/kibana/7.0/breaking-changes-7.0.html[Breaking changes in 7.0].
...
For the features introduced in 7.0.0, refer to link:https://www.elastic.co/blog/kibana-7-0-0-released[Kibana 7.0.0 released].

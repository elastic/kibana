...
The "By Indices" view lists each index and shows you how it's shards are
distributed across nodes. The "By Nodes" view lists each node and shows you which shards the node current host.

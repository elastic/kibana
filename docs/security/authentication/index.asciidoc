...
. If only one SAML realm is in use in Elasticsearch, it is possible to set the name of the realm in the following setting:
+
[source,yaml]
--------------------------------------------------------------------------------
xpack.security.saml.realm: realm-name
--------------------------------------------------------------------------------

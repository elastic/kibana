...
NOTE: Kibana API endpoints are not accessible via this plugin; the Elasticsearch API is currently the only service that you can interact with via the Console.

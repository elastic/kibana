...
{shield-13}kibana.html#kibana4-server-role[Configuring a Role for the Kibana 4 Server]
...
For more information, see {shield-13}/kibana.html#kibana4-server-role[Configuring Roles for Kibana 4 Users] in the Shield documentation.
...
information, see {shield-13}/kibana.html#using-kibana4-with-shield[Shield with Kibana 4][Using Shield with Kibana 4].
...
gather and return the results. For more information, see {ref}/modules-node.html[Node] in the Elasticsearch reference.

...
--------
. Check your transport and HTTP host configs. Kibana wants to connect to localhost:9200, but your client node needs to be reachable to the other members of the cluster on the transport port.
--------

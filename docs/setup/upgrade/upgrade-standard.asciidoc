...
NOTE: {kib} includes an {kibana-ref-all}/7.17/upgrade-assistant.html[Upgrade Assistant] to help you prepare for an upgrade. To access the assistant, go to *Stack Management > Upgrade Assistant*.

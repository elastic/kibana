...
This can be achieved with a new configuration flag `migrations.ignoreUnknownObjects` that must be set to the version you are upgrading to. For instance, for an upgrade to 8.3, you can define the following setting in kibana.yml:

[source,yaml]
--------------------------------------------
migrations.ignoreUnknownObjects: "8.3"
--------------------------------------------

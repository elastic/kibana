...
WARNING: Before you roll back {kib}, ensure that the version you want to rollback to is compatible with
...
. To remove the write block from the rollback indices, use

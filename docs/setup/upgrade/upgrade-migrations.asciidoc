...
2. {ref}/snapshots-take-snapshot.html[Take a snapshot] that includes the `kibana` feature state. The default snapshot
   configuration includes this feature state.

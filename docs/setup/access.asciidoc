...
+
* {ref}/size-your-shards.html#_this_action_would_add_x_total_shards_but_this_cluster_currently_has_yz_maximum_shards_open[`this action would add [x] total shards, but this cluster currently has [y]/[z] maximum shards open`]

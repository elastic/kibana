...
For more information, refer to our https://www.elastic.co/blog/troubleshooting-kibana-health[walkthrough on troubleshooting Kibana Health]. See link:https://www.youtube.com/watch?v=AlgGYcpGvOA[here for a video walkthrough]. 

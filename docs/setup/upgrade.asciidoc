...
instructions. The recommended path is to upgrade to 6.7 before upgrading to 7.0.
...
<<upgrade-standard,upgrade to 7.0>>, you can use the <<upgrade-standard, Standard upgrade>> 
instructions to upgrade to 7.0.

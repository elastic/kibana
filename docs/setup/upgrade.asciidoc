...
NOTE: {kib} logging system may have changed, depending on your target version. For details, see <<logging-configuration-migration, Logging configuration migration>>.

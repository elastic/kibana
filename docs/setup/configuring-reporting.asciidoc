...
<3> Grants access to generate CSV reports from saved Discover Session in *Discover*.
...
<1> Grants access to generate CSV reports from saved Discover Session in *Discover*.
<2> Grants access to generate CSV reports from saved Discover Session panels in *Dashboard*.

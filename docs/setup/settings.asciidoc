...
If the average event loop utilization for the last 60, 30, and 15 seconds exceeds the configured threshold, the server will respond with a `429 Too Many Requests` status code.
*Default: `false`*

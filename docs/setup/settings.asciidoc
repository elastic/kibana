...
Add sources for the https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Content-Security-Policy/object-src[Content Security Policy `object-src` directive] in reporting mode.
...
include::{kibana-root}/docs/settings/alert-action-settings.asciidoc[]

...
include::{kibana-root}/docs/settings/dev-settings.asciidoc[]
include::{kibana-root}/docs/settings/graph-settings.asciidoc[]
...
include::{kibana-root}/docs/settings/ml-settings.asciidoc[]

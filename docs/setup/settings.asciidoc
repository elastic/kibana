...
Refer to documentation for defined directives, values, and text format. To disable, set to `null`.
*Default:* `camera=(), display-capture=(self), fullscreen=(self), geolocation=(), microphone=(), web-share=()`

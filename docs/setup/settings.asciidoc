...
[TIP]
============================================================================
To get the most value from logging {es} queries, we recommend configuring the `http.server.response` logger as well. With both loggers configured, you will be able to see the responses from {es} on each request {kib} makes to {es}.
============================================================================
...
[WARNING]
============================================================================
While combining deprecated logging configuration with the current configuration, we strongly recommend switching over completely to avoid unforeseen consequences. If you use log rotation, combining deprecated with current configuration can lead to accidentally overwriting log files.
============================================================================

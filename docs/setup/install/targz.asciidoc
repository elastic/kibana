...
shasum -a 512 -c kibana-{version}-linux-x86_64.tar.gz.sha512 <1>
...
curl -O https://artifacts.elastic.co/downloads/kibana/kibana-{version}-darwin-x86_64.tar.gz.sha512
shasum -a 512 -c kibana-{version}-darwin-x86_64.tar.gz.sha512 <1>

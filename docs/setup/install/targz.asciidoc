...
These packages are free to use under the Elastic license. They contain open source, 
...
Apache 2.0 licensed code:  https://artifacts.elastic.co/downloads/kibana/kibana-oss-{version}-darwin-x86_64.tar.gz  

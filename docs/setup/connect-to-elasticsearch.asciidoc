...
** Create searchable mirrors of your data in Sharepoint Online, S3, Google Drive, and many other web services using our open code
** {enterprise-search-ref}/connectors.html[Elastic connectors].

...
`KBN_KEYSTORE_PASSWORD_FILE` can be used to point to a file containing the password,
the environment variable `KBN_KEYSTORE_PASSWORD` can be defined, or you will be prompted

...
What if you want to explore your data or create a visualization without first saving it as a data view?
You can do just that by selecting *Use without saving* in the *Create {data-source}* form in *Discover*
or *Lens*. With an ad-hoc {data-source}, you can
do all the normal things you'd do with a saved
{data-source} in *Discover* and *Lens*,
including adding fields and creating an {es} query alert. Your work won't be visible to others in your space.

An ad-hoc {data-source} stays around until you change apps, or until you save it.
...
Ad-hoc {data-sources} are not available in *Stack Management.*

[float]
[[rollup-data-view]]
==== Data views for rolled up data
...
==== Data views that search across clusters

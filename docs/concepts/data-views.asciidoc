...
A data view can point to a specific index, for example, your log data from yesterday,
...
* To access the *Data Views* view, you must have the {kib} privilege
`Data View Management`.  To create a data view, you must have the {es} privilege
...
[role="screenshot"]
image:management/data-views/images/create-index-pattern.jpg["Create data view"]
...
you can create a data view to search across the clusters of your choosing. Use the
...
use a standalone wildcard for your cluster name in your data view:
...
Once a data view is configured using the {ccs} syntax, all searches and
...
When you delete a data view, you are unable to recover the associated field formatters, scripted fields, source filters,
...
. Click the data view you want to delete.

. Delete (image:management/data-views/images/delete.png[Delete icon]) the index pattern.

[float]
[[reload-fields]]
=== What’s next

Learn how to <<managing-data-views,manage the data fields>> in your index patterns.

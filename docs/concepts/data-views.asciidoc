...
[role="screenshot"]
image:management/data-views/images/create-index-pattern.png["Create data view"]
...
When you delete a dat aview, you cannot recover the associated field formatters, runtime fields, source filters,
...
. Delete (image:management/data-views/images/delete.png[Delete icon]) the data view.

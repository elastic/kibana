...
based on different timestamps.z
+
...
You can do that by selecting *Use without saving* in the *Create {data-source}* form in *Discover*
or *Lens*. With a temporary {data-source}, you can
do everything you'd do with a saved
{data-source},

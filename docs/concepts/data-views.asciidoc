...
+
{kib}[[reload-fields]] {kib} is now configured to use your {es} data. When a new field is added to an index,
...
+
To explore your data without creating a {data-source}
that others in your space can see, click *Use without saving*.
This is useful if you want to explore different formats of your data in *Discover*, *Lens*, and *Maps*.
When you finish your explorations,
you'll get a reminder to save the {data-source} when you click the *Save* button.

...
{data-source},
such as adding fields and creating {es} query alerts. Your work won't be visible to others in your space.

A temporary {data-source} remains in your space until you change apps, or until you save it.
The temporary {data-sources} you create are unavailable in *Stack Management.*

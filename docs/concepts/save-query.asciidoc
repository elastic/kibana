...
. In the menu, click *Save saved query*.
. Enter a unique name to identify the query.
...
. To clear, add filters, and delete saved queries, use the *Saved query* menu.

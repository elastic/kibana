...
. Select the rows you want to compare from the Documents or Results tab in Discover.

. From the **Selected** menu in the table toolbar, choose **Compare selected**. The comparison view opens and shows the selected entries next to each other.

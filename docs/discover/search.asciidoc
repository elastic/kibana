...
[role="xpack"]
==== Read only access
If you have insufficient privileges to save queries, the *Save current query* button isn't visible in the saved query management popover.

[role="screenshot"]
image::discover/images/saved-query-management-component-readonly-view.png["Example of the saved query management popover with read only access to Discover",width="80%"]
...
+
[role="screenshot"]
image::discover/images/saved-query-management-component-save-as-new-query.png["Example of the saved query management popover when a query is loaded and we are about to delete a query",width="80%"]

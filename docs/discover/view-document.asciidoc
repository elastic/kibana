...
. In the document table, click the expand icon (image:images/expand-icon.png[Expand icon in document table, width=20px]).
. In the expanded view, click **Single document**.
+
...
. In the document table, click the expand icon (image:images/expand-icon.png[Expand icon in document table, width=20px]).
. In the expanded view, click **Surrounding documents**
+

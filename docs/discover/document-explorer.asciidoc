...
The *Document Explorer* displays your data table format,
enabling you to perform advanced sorting, resize columns,
adjust row density, view data in fullscreen, and more.
...
. In the *Document Explorer*, click the *field sorted* option.
+
[role="screenshot"]

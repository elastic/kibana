...
* https://github.com/lmangani/timelion-influxdb[influxdb] (lmangani) - enables rendering data from the InfluxDB queries in Timelion
...
* https://github.com/chrisfischer/kibana-button-vis[Button] (chrisfischer)
...
* https://github.com/lmangani/kibana_diagram[Flow Diagram] (lmangani)

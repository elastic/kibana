...
https://github.com/bondib/kibana-iframe-communicator-plugin[Kibana-Iframe-Communicator] (bondib) A kibana plugin that enables  to communicate directly with Kibana hosted inside an IFrame, without the need to reload the iframe

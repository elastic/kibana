...
* https://github.com/Webiks/kibana-API.git[Kibana-API] (webiks) Expose kibana functionality to your application, like create visualization dynamiclly, delete visualization and more..

...
* https://github.com/flexmonster/pivot-kibana [Flexmonster Pivot Table & Charts plugin for Kibana] - a customizable pivot table component for advanced data analysis and reporting.

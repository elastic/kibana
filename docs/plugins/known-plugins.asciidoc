...
* https://github.com/Webiks/kibana-API.git[Kibana-API] (ytzlax) Expose kibana functionality to your application, like create visualization dynamiclly, delete visualization and more.. 

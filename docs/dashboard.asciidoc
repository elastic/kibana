...
. [[adding-visualizations-to-a-dashboard]]To add a visualization, select its name from the list of visualizations
...
. [[saving-dashboards]]When you're finished adding and arranging the dashboard content,

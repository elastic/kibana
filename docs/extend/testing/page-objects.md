...
::::::{tip}
For interacting with individual EUI components (combo boxes, data grids, etc.), use the [EUI test helpers](./eui-test-helpers.md) exposed through `page.components` rather than hand-rolling selectors in a page object.
::::::

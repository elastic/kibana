...
For practical tips, see the page object guidelines in [UI test best practices](./scout-best-practices.md#use-existing-page-objects-to-interact-with-the-kibana-ui).

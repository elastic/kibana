...
Scout is designed to be **deployment-agnostic**. Write your Scout test and Playwright config **once**, and run it everywhere: locally and on Elastic Cloud. Use tags to specify which deployment types your test supports (e.g., tags.stateful.classic, tags.serverless.observability.complete, tags.serverless.security.complete).

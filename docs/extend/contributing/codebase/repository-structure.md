...
This folder contains manually generated Markdown docs that end up hosted in our [public documentation site](https://www.elastic.co/docs), including these developer docs.
...
We used to write RFCs in `md` format and keep them in the repository, but the RFC process has since moved out of the repository. We kept the folder around, since some of these older RFCs are still useful references.

...
Every file in here is auto-generated by the [API Docs system](../../key-concepts/api-documentation.md) and used to render our API documentation. If you edit a public plugin or package API and run `node scripts/build_api_docs` you will see files changed in this folder. Do not edit the contents of this folder directly!

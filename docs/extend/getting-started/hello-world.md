...
2. Create the [kibana.jsonc manifest file](../key-concepts/anatomy-of-a-plugin.md#kibanajson).
...
3. Create a [tsconfig.json file](../key-concepts/anatomy-of-a-plugin.md#tsconfigjson).
...
4. Create a [`public/plugin.tsx` file ](../key-concepts/anatomy-of-a-plugin.md#publicindexts).
...
5. Create a [`public/index.ts` file ](../key-concepts/anatomy-of-a-plugin.md#publicplugints).

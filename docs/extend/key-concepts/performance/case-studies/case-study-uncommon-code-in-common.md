---
navigation_title: "Case Study - Uncommon code in common"
...
```bash
node scripts/build_kibana_platform_plugins.js --dist --profile-stats-only --profile-focus=console
```

Then, I loaded `target/public/bundles/stats.json` in the [Webpack Bundle Analyzer](https://chrisbateman.github.io/webpack-visualizer/):

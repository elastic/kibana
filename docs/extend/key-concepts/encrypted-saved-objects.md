...
`registerType` function. More information can be found in the [Register a new saved object type](../tutorials/register-a-new-saved-object-type.md) tutorial. Once the

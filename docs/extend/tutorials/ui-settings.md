...
After you register or change a UI setting, document it in `docs/reference/advanced-settings-space.yml` or `docs/reference/advanced-settings-global.yml`. Follow [`.agents/skills/kibana-settings-docs/SKILL.md`](../../../.agents/skills/kibana-settings-docs/SKILL.md).

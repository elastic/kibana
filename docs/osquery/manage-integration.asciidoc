...
running filter sets, saving queries, and scheduling packs. For example,
you can create roles for users who can only run live or filter sets, but who cannot save or schedule queries.

...
*Maps* comes with a lot of https://maps.elastic.co/#file[predefined regions] allowing you to quicky visualize regions by metrics. *Maps* also offers the ability to easily map your own regions. You can use any region data you'd like, as long as your source data contains an identifier for the corresponding region. How can you map regions when your source data does not contain a region identifier? This is where reverse geocoding comes in. Reverse geocoding is the process of assigning a region identifer to a feature based on its location.
...
To use it in Kibana, GeoJSON format is required. You can use QGIS to convert the Cartographic Boundary shapefile to GeoJSON. Follow this https://gist.github.com/YKCzoli/b7f5ff0e0f641faba0f47fa5d16c4d8d[helpful tutorial] if you'd like to do the same or you can https://gist.githubusercontent.com/thomasneirynck/3813ddde31052b6b58b458ec2a86f81f/raw/2925c87f13324c75b6ed82ead9bf593f3224e847/csba.geojson[Download a prebuilt GeoJSON version].
...
[float]
=== Step 3: Visualize Combined Statistical Area (CSA) regions by web traffic
Now that our web traffic contains CSA region identifiers, lets visualize CSA regions by web traffic.

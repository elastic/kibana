...
*Ready to get started?* Start your tour of Maps with the <<maps-getting-started, getting started tutorial>> or watch the https://videos.elastic.co/watch/BYzRDtH4u7RSD8wKhuEW1b[getting started video].

...
*Terms joins* combine the result of an Elasticsearch terms aggregation and vector features based on a shared key.

Use *Terms joins* to augment vector features with additional properties.
You can then use these additional property values to symbolize features

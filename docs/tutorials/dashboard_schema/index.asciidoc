...
image:./schema_dashboard.png[image]
...
schema here: link:./schema.json[schema.json]
...
see link:../kibana/panels.html[Kibana Panels]
...
link:../kibana/panels.html[Kibana Panels]

...
To introduce localization for your plugin, use our i18n tool to create IDs and default messages. You can then extract these IDs into localization JSON files for Kibana to use when running your plugin.
...
An example Kibana `.i18nrc.json` is {blob}6.7/.i18nrc.json[here].

Full documentation about i18n tooling is {blob}6.7/src/dev/i18n/README.md[here].
...
To learn more about i18n tooling, see {blob}6.7/src/dev/i18n/README.md[i18n dev tooling].

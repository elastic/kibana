...
export default async function ({ readConfigFile }) {
  ...
  return {
    ...
    // defined in the config schema. See {blob}packages/kbn-test/src/functional_test_runner/lib/config/schema.js[src/functional_test_runner/lib/config/schema.js]
  };
}

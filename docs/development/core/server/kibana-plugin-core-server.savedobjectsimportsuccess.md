...
|  [newId](./kibana-plugin-core-server.savedobjectsimportsuccess.newid.md) | <code>string</code> | If <code>newId</code> is specified, the new object has a new ID that is different from the import ID. |

...
|  [find({ search, defaultSearchOperator, searchFields, hasReference, page, perPage, sortField, sortOrder, fields, namespace, type, filter, preference, aggs, })](./kibana-plugin-core-server.savedobjectsrepository.find.md) |  |  |

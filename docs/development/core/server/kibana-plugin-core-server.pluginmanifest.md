...
|  [enableForAnonymousPages?](./kibana-plugin-core-server.pluginmanifest.enableforanonymouspages.md) | boolean | <i>(Optional)</i> Specifies whether this plugin will be enabled for anonymous pages (login page, status page when configured, etc.) Default is false. |

...
|  [upsertAttributes](./kibana-plugin-core-server.savedobjectsincrementcounteroptions.upsertattributes.md) | <code>T</code> | Attributes to use when upserting the document if it doesn't exist. |

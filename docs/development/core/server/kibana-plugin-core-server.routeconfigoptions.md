...
|  [timeout](./kibana-plugin-core-server.routeconfigoptions.timeout.md) | <code>{</code><br/><code>        server?: boolean &#124; number;</code><br/><code>        socket?: boolean &#124; number;</code><br/><code>    }</code> | Timeouts for processing durations. Default value: { server: false } |

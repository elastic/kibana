...
|  [createPointInTimeFinder(findOptions, dependencies)](./kibana-plugin-core-server.savedobjectsclient.createpointintimefinder.md) |  | Returns a generator help page through large sets of saved objects by wrapping calls to [SavedObjectsClient.find()](./kibana-plugin-core-server.savedobjectsclient.find.md) |

...
|  [isPrivate(type)](./kibana-plugin-core-server.savedobjecttyperegistry.isprivate.md) |  | Returns <code>true</code> if the given type is marked as <code>private</code>, and <code>false</code> otherwise. |

...
[Home](./index.md) &gt; [kibana-plugin-core-server](./kibana-plugin-core-server.md) &gt; [SavedObjectsType](./kibana-plugin-core-server.savedobjectstype.md) &gt; [onImport](./kibana-plugin-core-server.savedobjectstype.onimport.md)

## SavedObjectsType.onImport property

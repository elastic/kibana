...
|  --- | --- | --- |
|  [createExporter](./kibana-plugin-core-server.savedobjectsservicestart.createexporter.md) | <code>(client: SavedObjectsClientContract) =&gt; ISavedObjectExporter</code> | Creates a [exporter](./kibana-plugin-core-server.isavedobjectexporter.md) bound to given client. |

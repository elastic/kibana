...
|  --- | --- | --- |
|  [createExporter](./kibana-plugin-core-server.savedobjectsservicestart.createexporter.md) | <code>(client: SavedObjectsClientContract) =&gt; ISavedObjectsExporter</code> | Creates a [exporter](./kibana-plugin-core-server.isavedobjectsexporter.md) bound to given client. |
|  [createImporter](./kibana-plugin-core-server.savedobjectsservicestart.createimporter.md) | <code>(client: SavedObjectsClientContract) =&gt; ISavedObjectsImporter</code> | Creates a [importer](./kibana-plugin-core-server.isavedobjectsimporter.md) bound to given client. |

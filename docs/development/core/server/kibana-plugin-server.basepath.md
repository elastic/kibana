...
|  --- | --- | --- | --- |
|  [get](./kibana-plugin-server.basepath.get.md) |  | <code>(request: KibanaRequest&lt;import(&quot;hapi&quot;).Util.HTTP_METHODS_PARTIAL_LOWERCASE, unknown, unknown, unknown&gt; &#124; LegacyRequest) =&gt; string</code> | returns <code>basePath</code> value, specific for an incoming request. |
...
|  [set](./kibana-plugin-server.basepath.set.md) |  | <code>(request: KibanaRequest&lt;import(&quot;hapi&quot;).Util.HTTP_METHODS_PARTIAL_LOWERCASE, unknown, unknown, unknown&gt; &#124; LegacyRequest, requestSpecificBasePath: string) =&gt; void</code> | sets <code>basePath</code> value, specific for an incoming request. |

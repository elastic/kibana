...
|  [maxSockets?](./kibana-plugin-core-server.elasticsearchconfig.maxsockets.md) |  | number | <i>(Optional)</i> The maximum number of sockets that can be used for communications with elasticsearch. |

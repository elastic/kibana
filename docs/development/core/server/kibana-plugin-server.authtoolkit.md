...
|  --- | --- | --- |
|  [authenticated](./kibana-plugin-server.authtoolkit.authenticated.md) | <code>(data?: AuthResultData) =&gt; AuthResult</code> | Authentication is successful with given credentials, allow request to pass through |

...
|  --- | --- | --- |
|  [excludeExportDetails](./kibana-plugin-server.savedobjectsexportoptions.excludeexportdetails.md) | <code>boolean</code> | flag to not add export details entry at the end of the stream. |

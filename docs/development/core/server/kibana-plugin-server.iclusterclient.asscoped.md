...
[Home](./index.md) &gt; [kibana-plugin-server](./kibana-plugin-server.md) &gt; [IClusterClient](./kibana-plugin-server.iclusterclient.md) &gt; [asScoped](./kibana-plugin-server.iclusterclient.asscoped.md)

## IClusterClient.asScoped() method

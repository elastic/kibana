...
|  --- | --- | --- |
|  [migratedIndices](./kibana-plugin-core-server.savedobjectstatusmeta.migratedindices.md) | <code>{</code><br/><code>        skipped: number;</code><br/><code>        patched: number;</code><br/><code>        migrated: number;</code><br/><code>    }</code> |  |

...
|  --- | --- | --- |
|  [refresh](./kibana-plugin-core-server.savedobjectsremovereferencestooptions.refresh.md) | <code>boolean</code> | Elasticsearch only supports boolean values for this operation. Defaults to <code>true</code> |

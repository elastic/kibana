...
```typescript
export declare function resolveSavedObjectsImportErrors({ readStream, objectLimit, retries, savedObjectsClient, typeRegistry, namespace, trueCopy, }: SavedObjectsResolveImportErrorsOptions): Promise<SavedObjectsImportResponse>;
```
...
|  --- | --- | --- |
|  { readStream, objectLimit, retries, savedObjectsClient, typeRegistry, namespace, trueCopy, } | <code>SavedObjectsResolveImportErrorsOptions</code> |  |

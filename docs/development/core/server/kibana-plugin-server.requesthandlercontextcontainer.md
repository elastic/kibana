...
```typescript
export declare type RequestHandlerContextContainer = IContextContainer<RequestHandlerContext, RequestHandlerReturn | Promise<RequestHandlerReturn>, RequestHandlerParams>;
```

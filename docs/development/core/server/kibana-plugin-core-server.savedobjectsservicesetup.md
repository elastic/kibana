...
|  [post](./kibana-plugin-core-server.savedobjectsservicesetup.post.md) | SavedObjectsHooksRegistry\['post'\] | Register a "post" hook to execute after a SavedObject clients API method ("get", "create"...) |
|  [pre](./kibana-plugin-core-server.savedobjectsservicesetup.pre.md) | SavedObjectsHooksRegistry\['pre'\] | Register a "pre" hook to execute before a SavedObject clients API method ("get", "create"...) |

...
|  [registerImportHook](./kibana-plugin-core-server.savedobjectsservicesetup.registerimporthook.md) | <code>(type: string, hook: SavedObjectsImportHook) =&gt; void</code> | Register an [import hook](./kibana-plugin-core-server.savedobjectsimporthook.md) for given type.<!-- -->Import hooks are executed during the savedObjects import process and allow to interact with the imported objects. See the [hook documentation](./kibana-plugin-core-server.savedobjectsimporthook.md) for more info. |

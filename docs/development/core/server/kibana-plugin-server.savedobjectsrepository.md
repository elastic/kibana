...
|  --- | --- | --- |
|  [(constructor)(options)](./kibana-plugin-server.savedobjectsrepository.(constructor).md) |  | Constructs a new instance of the <code>SavedObjectsRepository</code> class |
...
|  [deleteByNamespace(namespace)](./kibana-plugin-server.savedobjectsrepository.deletebynamespace.md) |  | Deletes all objects from the provided namespace. |
|  [find({ search, defaultSearchOperator, searchFields, hasReference, page, perPage, sortField, sortOrder, fields, namespace, type, })](./kibana-plugin-server.savedobjectsrepository.find.md) |  |  |

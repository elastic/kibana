...
|  --- | --- | --- |
|  [(constructor)(options)](./kibana-plugin-server.savedobjectsrepository._constructor_.md) |  | Constructs a new instance of the <code>SavedObjectsRepository</code> class |

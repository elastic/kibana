...
|  [headerChangedFromDefault](./kibana-plugin-server.icspconfig.headerchangedfromdefault.md) | <code>boolean</code> | Flag indicating that the configuraion changes the csp rules from the defaults |

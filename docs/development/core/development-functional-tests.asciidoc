...
**config:**:::
* Source: {blob}packages/kbn-test/src/functional_test_runner/lib/config/config.ts[packages/kbn-test/src/functional_test_runner/lib/config/config.ts]
* Schema: {blob}packages/kbn-test/src/functional_test_runner/lib/config/schema.ts[packages/kbn-test/src/functional_test_runner/lib/config/schema.ts]
...
**lifecycle:**:::
* Source: {blob}packages/kbn-test/src/functional_test_runner/lib/lifecycle.ts[packages/kbn-test/src/functional_test_runner/lib/lifecycle.ts]

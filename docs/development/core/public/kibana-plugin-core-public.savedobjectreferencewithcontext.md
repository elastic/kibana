...
|  [isMissing?](./kibana-plugin-core-public.savedobjectreferencewithcontext.ismissing.md) |  | boolean | _(Optional)_ Whether or not this object or reference is missing |
...
|  [spacesWithMatchingAliases?](./kibana-plugin-core-public.savedobjectreferencewithcontext.spaceswithmatchingaliases.md) |  | string\[\] | _(Optional)_ The space(s) that legacy URL aliases matching this type/id exist in |

...
|  [navigateToUrlSkipUnload(url)](./kibana-plugin-core-public.applicationstart.navigatetourlskipunload.md) | Navigate to a given url<!-- -->The method removes the eventListener and assigns the window location to the url provided |

...
[Home](./index.md) &gt; [kibana-plugin-public](./kibana-plugin-public.md) &gt; [IToasts](./kibana-plugin-public.itoasts.md) &gt; [addDanger](./kibana-plugin-public.itoasts.adddanger.md)

## IToasts.addDanger() method

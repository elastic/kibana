...
|  [namespaces?](./kibana-plugin-core-public.savedobject.namespaces.md) |  | string\[\] | _(Optional)_ Space(s) that this saved object exists in. This attribute is not used for "global" saved object types which are registered with <code>namespaceType: 'agnostic'</code>. |

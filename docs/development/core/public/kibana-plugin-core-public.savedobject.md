...
|  [error](./kibana-plugin-core-public.savedobject.error.md) | <code>{</code><br/><code>        error: string;</code><br/><code>        message: string;</code><br/><code>        statusCode: number;</code><br/><code>        metadata?: Record&lt;string, unknown&gt;;</code><br/><code>    }</code> |  |

...
|  --- | --- | --- |
|  [docTitle](./kibana-plugin-public.chromestart.doctitle.md) | <code>ChromeDocTitle</code> | [APIs](./kibana-plugin-public.chromedoctitle.md) for accessing and updating the document title. |

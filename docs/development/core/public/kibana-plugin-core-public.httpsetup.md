...
|  --- | --- | --- |
|  [anonymousPaths](./kibana-plugin-core-public.httpsetup.anonymouspaths.md) | <code>AnonymousPathsSetup</code> | APIs for denoting certain paths for not requiring authentication |

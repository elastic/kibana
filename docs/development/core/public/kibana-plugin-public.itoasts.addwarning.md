...
[Home](./index.md) &gt; [kibana-plugin-public](./kibana-plugin-public.md) &gt; [IToasts](./kibana-plugin-public.itoasts.md) &gt; [addWarning](./kibana-plugin-public.itoasts.addwarning.md)

## IToasts.addWarning() method

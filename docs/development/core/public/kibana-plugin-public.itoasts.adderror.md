...
[Home](./index.md) &gt; [kibana-plugin-public](./kibana-plugin-public.md) &gt; [IToasts](./kibana-plugin-public.itoasts.md) &gt; [addError](./kibana-plugin-public.itoasts.adderror.md)

## IToasts.addError() method

...
```typescript
export declare type PluginInitializer<TSetup, TStart, TPluginsSetup extends Record<PluginName, any> = {}, TPluginsStart extends Record<PluginName, any> = {}> = (core: PluginInitializerContext) => Plugin<TSetup, TStart, TPluginsSetup, TPluginsStart>;
```

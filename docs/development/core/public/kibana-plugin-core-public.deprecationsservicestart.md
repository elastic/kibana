...
|  [resolveDeprecation](./kibana-plugin-core-public.deprecationsservicestart.resolvedepreaction.md) | <code>&lt;Payload = unknown&gt;(details: DomainDeprecationDetails) =&gt; Promise&lt;ResolveDeprecationResponse&lt;Payload&gt;&gt;</code> | Calls the correctiveActions.api to automatically resolve the depprecation. |

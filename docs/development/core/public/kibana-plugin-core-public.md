...
|  [SavedObjectsTypeMappingDefinition](./kibana-plugin-core-public.savedobjectstypemappingdefinition.md) | Describe a saved object type mapping. |
...
|  [SavedObjectsFieldMapping](./kibana-plugin-core-public.savedobjectsfieldmapping.md) | Describe a [saved object type mapping](./kibana-plugin-core-public.savedobjectstypemappingdefinition.md) field.<!-- -->Please refer to [elasticsearch documentation](https://www.elastic.co/guide/en/elasticsearch/reference/current/mapping-types.html) For the mapping documentation |

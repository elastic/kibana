...
|  [HttpClient](./kibana-plugin-core-public.httpclient.md) | Convenience type compatible with both [HttpSetup](./kibana-plugin-core-public.httpsetup.md) and [HttpStart](./kibana-plugin-core-public.httpstart.md) |

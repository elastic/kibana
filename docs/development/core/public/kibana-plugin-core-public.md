...
|  [AppMeta](./kibana-plugin-core-public.appmeta.md) | Input type for meta data for an application.<!-- -->Meta fields include at least <code>keywords</code>, an array of strings with which to associate the app. Keywords must include at least one unique string as an array. |

...
|  [getExecutionContext](./kibana-plugin-plugins-expressions-server.executioncontext.getexecutioncontext.md) | <code>() =&gt; KibanaExecutionContext &#124; undefined</code> | Contains the meta-data about the source of the expression. |

...
|  [executionContext](./kibana-plugin-plugins-expressions-server.executioncontext.executioncontext.md) | <code>IExecutionContextContainer</code> | Contains the meta-data about the source of the expression. |

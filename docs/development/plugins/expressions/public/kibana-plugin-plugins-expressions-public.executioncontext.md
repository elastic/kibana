...
|  [executionContext](./kibana-plugin-plugins-expressions-public.executioncontext.executioncontext.md) | <code>IExecutionContextContainer</code> | Contains the meta-data about the source of the expression. |

...
|  [search](./kibana-plugin-plugins-data-public.searchinterceptor.search.md) |  | <code>&lt;T extends string&gt;(search: ISearch&lt;T&gt;, request: IKibanaSearchRequest, options?: ISearchOptions &#124; undefined) =&gt; import(&quot;rxjs&quot;).Observable&lt;import(&quot;./i_search&quot;).IResponseTypesMap[T]&gt;</code> | Searches using the given <code>search</code> method. Overrides the <code>AbortSignal</code> with one that will abort either when <code>cancelPending</code> is called, when the request times out, or when the original <code>AbortSignal</code> is aborted. Updates the <code>pendingCount</code> when the request is started/finalized. |

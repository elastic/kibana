...
|  [hasIndexPatternWithUserData()](./kibana-plugin-plugins-data-public.indexpatternsservice.hasindexpatternwithuserdata.md) |  | Guess if there is an existing index pattern with real user data |

...
|  --- | --- | --- |
|  [(constructor)(indexPattern, specs, onNotification)](./kibana-plugin-plugins-data-public.fieldlist._constructor_.md) |  | Constructs a new instance of the <code>FieldList</code> class |

...
|  [waitForCompletion](./kibana-plugin-plugins-data-server.isearchoptions.waitforcompletion.md) | <code>boolean</code> | If this option is true, the stream will be completed only upon receiving is\_partial = false and is\_running = false |

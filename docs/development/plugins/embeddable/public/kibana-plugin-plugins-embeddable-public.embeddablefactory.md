...
|  --- | --- | --- |
|  [canShareSessionDuringEdit](./kibana-plugin-plugins-embeddable-public.embeddablefactory.cansharesessionduringedit.md) | <code>boolean</code> | True if search session can be shared when editing an embeddable instance of this factory |

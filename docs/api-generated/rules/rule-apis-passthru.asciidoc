...
<div class="openapi">
  ...
  <div class="method"><a name="getRule"/>
    ...
    <div class="field-items">
      ...
      <div class="param-desc"><span class="param-type">Path Parameter</span> &mdash; The ID of the rule that you want to retrieve. default: null </div><div class="param">spaceId (required)</div>
  ...
  <div class="method"><a name="updateRule"/>
    ...
    <div class="field-items">
      ...
      <div class="param-desc"><span class="param-type">Path Parameter</span> &mdash; The ID of the rule that you want to update. default: null </div><div class="param">spaceId (required)</div>

...
<div class="openapi">
  ...
  <ol>
    ...
    <li><a href="#config_properties_slack_api"><code>config_properties_slack_api</code> - Connector request properties for a Slack API connector</a></li>
    ...
    <li><a href="#secrets_properties_slack_webhook"><code>secrets_properties_slack_webhook</code> - Connector secrets properties for a Slack connector</a></li>
...
<div class="param">userIdentifierValue (optional)</div><div class="param-desc"><span class="param-type"><a href="#string">String</a></span> The identifier to use for OAuth authentication. This identifier should be the user field you selected when you created an OAuth JWT API endpoint for external clients in your ServiceNow instance. For example, if the selected user field is <code>Email</code>, the user identifier should be the user's email address. This property is required when <code>isOAuth</code> is <code>true</code>. </div>
  ...
  <div class="model">
    <h3><a name="config_properties_slack_api"><code>config_properties_slack_api</code> - Connector request properties for a Slack API connector</a> <a class="up" href="#__Models">Up</a></h3>
    <div class='model-description'>Defines properties for connectors when type is <code>.slack_api</code>.</div>
    <div class="field-items">
      <div class="param">allowedChannels (optional)</div><div class="param-desc"><span class="param-type"><a href="#string">array[String]</a></span> The list of channels that the connector can access. By default, it can access all channels within the scope of the Slack app. </div>
    </div>  <!-- field-items -->
  </div>
  <div class="model">
...
<div class="param">name </div><div class="param-desc"><span class="param-type"><a href="#string">String</a></span> The display name for the connector. </div>
  ...
  <div class="model">
    ...
    <div class='model-description'></div>
    <div class="field-items">
      <div class="param">config (optional)</div><div class="param-desc"><span class="param-type"><a href="#config_properties_slack_api">config_properties_slack_api</a></span>  </div>
<div class="param">connector_type_id </div><div class="param-desc"><span class="param-type"><a href="#string">String</a></span> The type of connector. </div>
        <div class="param-enum-header">Enum:</div>
...
<div class="param">name </div><div class="param-desc"><span class="param-type"><a href="#string">String</a></span> The display name for the connector. </div>
  ...
  <div class="model">
    ...
    <div class='model-description'></div>
    <div class="field-items">
      <div class="param">config (optional)</div><div class="param-desc"><span class="param-type"><a href="#">Object</a></span> Configuration properties for the connector. </div>
<div class="param">connector_type_id </div><div class="param-desc"><span class="param-type"><a href="#string">String</a></span> The type of connector. </div>
        <div class="param-enum-header">Enum:</div>
...
<div class="param">secrets </div><div class="param-desc"><span class="param-type"><a href="#secrets_properties_servicenow">secrets_properties_servicenow</a></span>  </div>
  ...
  <div class="model">
    ...
    <div class='model-description'>The Slack connector uses an API method to send Slack messages.</div>
    <div class="field-items">
      <div class="param">config (optional)</div><div class="param-desc"><span class="param-type"><a href="#config_properties_slack_api">config_properties_slack_api</a></span>  </div>
<div class="param">connector_type_id </div><div class="param-desc"><span class="param-type"><a href="#string">String</a></span> The type of connector. </div>
        <div class="param-enum-header">Enum:</div>
...
<div class="param">secrets </div><div class="param-desc"><span class="param-type"><a href="#secrets_properties_slack_api">secrets_properties_slack_api</a></span>  </div>
  ...
  <div class="model">
    ...
    <div class='model-description'>The Slack connector uses incoming webhooks to send Slack messages.</div>
    <div class="field-items">
      <div class="param">config (optional)</div><div class="param-desc"><span class="param-type"><a href="#">Object</a></span> Defines properties for connectors when type is <code>.slack</code>. </div>
<div class="param">connector_type_id </div><div class="param-desc"><span class="param-type"><a href="#string">String</a></span> The type of connector. </div>
        <div class="param-enum-header">Enum:</div>
        <div class="param-enum">.slack</div>
<div class="param">name </div><div class="param-desc"><span class="param-type"><a href="#string">String</a></span> The display name for the connector. </div>
...
<div class="param">username (optional)</div><div class="param-desc"><span class="param-type"><a href="#string">String</a></span> The username for HTTP basic authentication. This property is required when <code>isOAuth</code> is <code>false</code>. </div>
  ...
  <div class="model">
    <h3><a name="secrets_properties_slack_api"><code>secrets_properties_slack_api</code> - Connector secrets properties for a Slack API connector</a> <a class="up" href="#__Models">Up</a></h3>
  ...
  <div class="model">
    <h3><a name="secrets_properties_slack_webhook"><code>secrets_properties_slack_webhook</code> - Connector secrets properties for a Slack connector</a> <a class="up" href="#__Models">Up</a></h3>

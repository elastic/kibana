...
<div class="openapi">
  ...
  <ol>
    ...
    <li><a href="#Update_case_request_with_ServiceNow_SecOps_connector"><code>Update_case_request_with_ServiceNow_SecOps_connector</code> - Update case request with ServiceNow SecOps connector</a></li>
    <li><a href="#Update_case_request_with_ServiceNow_SecOps_connector_cases"><code>Update_case_request_with_ServiceNow_SecOps_connector_cases</code> - </a></li>
    <li><a href="#Update_case_request_with_a_Cases_Webhook_connector"><code>Update_case_request_with_a_Cases_Webhook_connector</code> - Update case request with a Cases Webhook connector</a></li>
    <li><a href="#Update_case_request_with_a_Cases_Webhook_connector_cases"><code>Update_case_request_with_a_Cases_Webhook_connector_cases</code> - </a></li>
    <li><a href="#Update_case_request_with_a_Jira_connector"><code>Update_case_request_with_a_Jira_connector</code> - Update case request with a Jira connector</a></li>
    <li><a href="#Update_case_request_with_a_Jira_connector_cases"><code>Update_case_request_with_a_Jira_connector_cases</code> - </a></li>
    <li><a href="#Update_case_request_with_a_ServiceNow_ITSM_connector"><code>Update_case_request_with_a_ServiceNow_ITSM_connector</code> - Update case request with a ServiceNow ITSM connector</a></li>
    <li><a href="#Update_case_request_with_a_ServiceNow_ITSM_connector_cases"><code>Update_case_request_with_a_ServiceNow_ITSM_connector_cases</code> - </a></li>
    <li><a href="#Update_case_request_with_a_Swimlane_connector"><code>Update_case_request_with_a_Swimlane_connector</code> - Update case request with a Swimlane connector</a></li>
    <li><a href="#Update_case_request_with_a_Swimlane_connector_cases"><code>Update_case_request_with_a_Swimlane_connector_cases</code> - </a></li>
    <li><a href="#Update_case_request_with_an_IBM_Resilient_connector"><code>Update_case_request_with_an_IBM_Resilient_connector</code> - Update case request with an IBM Resilient connector</a></li>
    <li><a href="#Update_case_request_with_an_IBM_Resilient_connector_cases"><code>Update_case_request_with_an_IBM_Resilient_connector_cases</code> - </a></li>
    <li><a href="#Update_case_request_with_no_connector"><code>Update_case_request_with_no_connector</code> - Update case request with no connector</a></li>
    <li><a href="#Update_case_request_with_no_connector_cases"><code>Update_case_request_with_no_connector_cases</code> - </a></li>
...
<div class="param">type </div><div class="param-desc"><span class="param-type"><a href="#string">String</a></span> The type of connector. </div>
  ...
  <div class="model">
    <h3><a name="Update_case_request_with_ServiceNow_SecOps_connector"><code>Update_case_request_with_ServiceNow_SecOps_connector</code> - Update case request with ServiceNow SecOps connector</a> <a class="up" href="#__Models">Up</a></h3>
    <div class='model-description'></div>
    <div class="field-items">
      <div class="param">cases </div><div class="param-desc"><span class="param-type"><a href="#Update_case_request_with_ServiceNow_SecOps_connector_cases">array[Update_case_request_with_ServiceNow_SecOps_connector_cases]</a></span> An array containing one or more case objects. </div>
    </div>  <!-- field-items -->
  </div>
  <div class="model">
    <h3><a name="Update_case_request_with_ServiceNow_SecOps_connector_cases"><code>Update_case_request_with_ServiceNow_SecOps_connector_cases</code> - </a> <a class="up" href="#__Models">Up</a></h3>
    <div class='model-description'></div>
    <div class="field-items">
...
<div class="param">version </div><div class="param-desc"><span class="param-type"><a href="#string">String</a></span> The current version of the case. To determine this value, use the get case or find cases APIs. </div>
  ...
  <div class="model">
    <h3><a name="Update_case_request_with_a_Cases_Webhook_connector"><code>Update_case_request_with_a_Cases_Webhook_connector</code> - Update case request with a Cases Webhook connector</a> <a class="up" href="#__Models">Up</a></h3>
    <div class='model-description'></div>
    <div class="field-items">
      <div class="param">cases </div><div class="param-desc"><span class="param-type"><a href="#Update_case_request_with_a_Cases_Webhook_connector_cases">array[Update_case_request_with_a_Cases_Webhook_connector_cases]</a></span> An array containing one or more case objects. </div>
    </div>  <!-- field-items -->
  </div>
  <div class="model">
    <h3><a name="Update_case_request_with_a_Cases_Webhook_connector_cases"><code>Update_case_request_with_a_Cases_Webhook_connector_cases</code> - </a> <a class="up" href="#__Models">Up</a></h3>
    <div class='model-description'></div>
    <div class="field-items">
...
<div class="param">version </div><div class="param-desc"><span class="param-type"><a href="#string">String</a></span> The current version of the case. To determine this value, use the get case or find cases APIs. </div>
  ...
  <div class="model">
    <h3><a name="Update_case_request_with_a_Jira_connector"><code>Update_case_request_with_a_Jira_connector</code> - Update case request with a Jira connector</a> <a class="up" href="#__Models">Up</a></h3>
    <div class='model-description'></div>
    <div class="field-items">
      <div class="param">cases </div><div class="param-desc"><span class="param-type"><a href="#Update_case_request_with_a_Jira_connector_cases">array[Update_case_request_with_a_Jira_connector_cases]</a></span> An array containing one or more case objects. </div>
    </div>  <!-- field-items -->
  </div>
  <div class="model">
    <h3><a name="Update_case_request_with_a_Jira_connector_cases"><code>Update_case_request_with_a_Jira_connector_cases</code> - </a> <a class="up" href="#__Models">Up</a></h3>
    <div class='model-description'></div>
    <div class="field-items">
...
<div class="param">version </div><div class="param-desc"><span class="param-type"><a href="#string">String</a></span> The current version of the case. To determine this value, use the get case or find cases APIs. </div>
  ...
  <div class="model">
    <h3><a name="Update_case_request_with_a_ServiceNow_ITSM_connector"><code>Update_case_request_with_a_ServiceNow_ITSM_connector</code> - Update case request with a ServiceNow ITSM connector</a> <a class="up" href="#__Models">Up</a></h3>
    <div class='model-description'></div>
    <div class="field-items">
      <div class="param">cases </div><div class="param-desc"><span class="param-type"><a href="#Update_case_request_with_a_ServiceNow_ITSM_connector_cases">array[Update_case_request_with_a_ServiceNow_ITSM_connector_cases]</a></span> An array containing one or more case objects. </div>
    </div>  <!-- field-items -->
  </div>
  <div class="model">
    <h3><a name="Update_case_request_with_a_ServiceNow_ITSM_connector_cases"><code>Update_case_request_with_a_ServiceNow_ITSM_connector_cases</code> - </a> <a class="up" href="#__Models">Up</a></h3>
    <div class='model-description'></div>
    <div class="field-items">
...
<div class="param">version </div><div class="param-desc"><span class="param-type"><a href="#string">String</a></span> The current version of the case. To determine this value, use the get case or find cases APIs. </div>
  ...
  <div class="model">
    <h3><a name="Update_case_request_with_a_Swimlane_connector"><code>Update_case_request_with_a_Swimlane_connector</code> - Update case request with a Swimlane connector</a> <a class="up" href="#__Models">Up</a></h3>
    <div class='model-description'></div>
    <div class="field-items">
      <div class="param">cases </div><div class="param-desc"><span class="param-type"><a href="#Update_case_request_with_a_Swimlane_connector_cases">array[Update_case_request_with_a_Swimlane_connector_cases]</a></span> An array containing one or more case objects. </div>
    </div>  <!-- field-items -->
  </div>
  <div class="model">
    <h3><a name="Update_case_request_with_a_Swimlane_connector_cases"><code>Update_case_request_with_a_Swimlane_connector_cases</code> - </a> <a class="up" href="#__Models">Up</a></h3>
    <div class='model-description'></div>
    <div class="field-items">
...
<div class="param">version </div><div class="param-desc"><span class="param-type"><a href="#string">String</a></span> The current version of the case. To determine this value, use the get case or find cases APIs. </div>
  ...
  <div class="model">
    <h3><a name="Update_case_request_with_an_IBM_Resilient_connector"><code>Update_case_request_with_an_IBM_Resilient_connector</code> - Update case request with an IBM Resilient connector</a> <a class="up" href="#__Models">Up</a></h3>
    <div class='model-description'></div>
    <div class="field-items">
      <div class="param">cases </div><div class="param-desc"><span class="param-type"><a href="#Update_case_request_with_an_IBM_Resilient_connector_cases">array[Update_case_request_with_an_IBM_Resilient_connector_cases]</a></span> An array containing one or more case objects. </div>
    </div>  <!-- field-items -->
  </div>
  <div class="model">
    <h3><a name="Update_case_request_with_an_IBM_Resilient_connector_cases"><code>Update_case_request_with_an_IBM_Resilient_connector_cases</code> - </a> <a class="up" href="#__Models">Up</a></h3>
    <div class='model-description'></div>
    <div class="field-items">
...
<div class="param">version </div><div class="param-desc"><span class="param-type"><a href="#string">String</a></span> The current version of the case. To determine this value, use the get case or find cases APIs. </div>
  ...
  <div class="model">
    <h3><a name="Update_case_request_with_no_connector"><code>Update_case_request_with_no_connector</code> - Update case request with no connector</a> <a class="up" href="#__Models">Up</a></h3>
    <div class='model-description'></div>
    <div class="field-items">
      <div class="param">cases </div><div class="param-desc"><span class="param-type"><a href="#Update_case_request_with_no_connector_cases">array[Update_case_request_with_no_connector_cases]</a></span> An array containing one or more case objects. </div>
    </div>  <!-- field-items -->
  </div>
  <div class="model">
    <h3><a name="Update_case_request_with_no_connector_cases"><code>Update_case_request_with_no_connector_cases</code> - </a> <a class="up" href="#__Models">Up</a></h3>
    <div class='model-description'></div>
    <div class="field-items">

...
<div class="openapi">
  ...
  <ol>
    ...
    <li><a href="#payload_assignees_assignees_inner"><code>payload_assignees_assignees_inner</code> - </a></li>
...
<div class="param">type (optional)</div><div class="param-desc"><span class="param-type"><a href="#string">String</a></span>  </div>
  ...
  <div class="model">
    ...
    <div class='model-description'></div>
    <div class="field-items">
      <div class="param">assignees (optional)</div><div class="param-desc"><span class="param-type"><a href="#payload_assignees_assignees_inner">array[payload_assignees_assignees_inner]</a></span>  </div>
    </div>  <!-- field-items -->
  </div>
  <div class="model">
    <h3><a name="payload_assignees_assignees_inner"><code>payload_assignees_assignees_inner</code> - </a> <a class="up" href="#__Models">Up</a></h3>
    <div class='model-description'></div>
    <div class="field-items">

...
<div class="openapi">
  ...
  <h3>Table of Contents</h3>
  <ol>
    <li><a href="#Add_alert_to_case_request"><code>Add_alert_to_case_request</code> - Add alert to case request</a></li>
    <li><a href="#Add_alert_to_case_request_rule"><code>Add_alert_to_case_request_rule</code> - </a></li>
    <li><a href="#Add_case_comment_request"><code>Add_case_comment_request</code> - Add case comment request</a></li>
    <li><a href="#Add_comment_to_case_request"><code>Add_comment_to_case_request</code> - Add comment to case request</a></li>
    <li><a href="#alert"><code>alert</code> - Add case comment request properties for alerts</a></li>
    ...
    <li><a href="#commentRequest"><code>commentRequest</code> - Add case comment request properties</a></li>
    ...
    <li><a href="#update_alert_comment_request_properties_alertId"><code>update_alert_comment_request_properties_alertId</code> - </a></li>
    <li><a href="#update_alert_comment_request_properties_index"><code>update_alert_comment_request_properties_index</code> - </a></li>
    <li><a href="#update_alert_comment_request_properties_rule"><code>update_alert_comment_request_properties_rule</code> - </a></li>
    <li><a href="#update_user_comment_request_properties"><code>update_user_comment_request_properties</code> - </a></li>
    <li><a href="#user"><code>user</code> - Add case comment request properties for alerts</a></li>
  ...
  <div class="model">
    <h3><a name="Add_alert_to_case_request"><code>Add_alert_to_case_request</code> - Add alert to case request</a> <a class="up" href="#__Models">Up</a></h3>
    <div class='model-description'></div>
    <div class="field-items">
      <div class="param">alertId (optional)</div><div class="param-desc"><span class="param-type"><a href="#oneOf<string,array>">oneOf<string,array></a></span> The alert identifier. It is required only when <code>type</code> is <code>alert</code>. If it is an array, <code>index</code> must also be an array. This functionality is in technical preview and may be changed or removed in a future release. Elastic will apply best effort to fix any issues, but features in technical preview are not subject to the support SLA of official GA features. </div>
<div class="param">index (optional)</div><div class="param-desc"><span class="param-type"><a href="#oneOf<string,array>">oneOf<string,array></a></span> The alert index. It is required only when <code>type</code> is <code>alert</code>. If it is an array, <code>alertId</code> must also be an array. This functionality is in technical preview and may be changed or removed in a future release. Elastic will apply best effort to fix any issues, but features in technical preview are not subject to the support SLA of official GA features. </div>
<div class="param">rule (optional)</div><div class="param-desc"><span class="param-type"><a href="#Add_alert_to_case_request_rule">Add_alert_to_case_request_rule</a></span>  </div>
    </div>  <!-- field-items -->
  </div>
  <div class="model">
    <h3><a name="Add_alert_to_case_request_rule"><code>Add_alert_to_case_request_rule</code> - </a> <a class="up" href="#__Models">Up</a></h3>
...
<div class="param">type </div><div class="param-desc"><span class="param-type"><a href="#string">String</a></span> The type of comment. </div>
        ...
        <div class="param-enum">alert</div><div class="param-enum">user</div>
<div class="param">alertId (optional)</div><div class="param-desc"><span class="param-type"><a href="#oneOf<string,array>">oneOf<string,array></a></span> The alert identifier. It is required only when <code>type</code> is <code>alert</code>. If it is an array, <code>index</code> must also be an array. This functionality is in technical preview and may be changed or removed in a future release. Elastic will apply best effort to fix any issues, but features in technical preview are not subject to the support SLA of official GA features. </div>
<div class="param">index (optional)</div><div class="param-desc"><span class="param-type"><a href="#oneOf<string,array>">oneOf<string,array></a></span> The alert index. It is required only when <code>type</code> is <code>alert</code>. If it is an array, <code>alertId</code> must also be an array. This functionality is in technical preview and may be changed or removed in a future release. Elastic will apply best effort to fix any issues, but features in technical preview are not subject to the support SLA of official GA features. </div>
<div class="param">rule (optional)</div><div class="param-desc"><span class="param-type"><a href="#Add_alert_to_case_request_rule">Add_alert_to_case_request_rule</a></span>  </div>
<div class="param">comment </div><div class="param-desc"><span class="param-type"><a href="#string">String</a></span> The new comment. It is required only when <code>type</code> is <code>user</code>. </div>
  ...
  <div class="model">
    <h3><a name="Add_comment_to_case_request"><code>Add_comment_to_case_request</code> - Add comment to case request</a> <a class="up" href="#__Models">Up</a></h3>
    <div class='model-description'></div>
    <div class="field-items">
      <div class="param">comment </div><div class="param-desc"><span class="param-type"><a href="#string">String</a></span> The new comment. It is required only when <code>type</code> is <code>user</code>. </div>
    </div>  <!-- field-items -->
  ...
  <div class="model">
    <h3><a name="alert"><code>alert</code> - Add case comment request properties for alerts</a> <a class="up" href="#__Models">Up</a></h3>
    <div class='model-description'></div>
    <div class="field-items">
      <div class="param">owner </div><div class="param-desc"><span class="param-type"><a href="#owners">owners</a></span>  </div>
<div class="param">type </div><div class="param-desc"><span class="param-type"><a href="#string">String</a></span> The type of comment. </div>
...
<div class="param">index (optional)</div><div class="param-desc"><span class="param-type"><a href="#string">String</a></span> The alert index. </div>
  ...
  <div class="model">
    <h3><a name="commentRequest"><code>commentRequest</code> - Add case comment request properties</a> <a class="up" href="#__Models">Up</a></h3>
    <div class='model-description'></div>
    <div class="field-items">
      <div class="param">owner </div><div class="param-desc"><span class="param-type"><a href="#owners">owners</a></span>  </div>
<div class="param">type </div><div class="param-desc"><span class="param-type"><a href="#string">String</a></span> The type of comment. </div>
...
<div class="param">settings (optional)</div><div class="param-desc"><span class="param-type"><a href="#setCaseConfiguration_request_settings">setCaseConfiguration_request_settings</a></span>  </div>
  ...
  <div class="model">
    ...
    <div class='model-description'></div>
    <div class="field-items">
      <div class="param">alertId </div><div class="param-desc"><span class="param-type"><a href="#update_alert_comment_request_properties_alertId">update_alert_comment_request_properties_alertId</a></span>  </div>
...
<div class="param">index </div><div class="param-desc"><span class="param-type"><a href="#update_alert_comment_request_properties_index">update_alert_comment_request_properties_index</a></span>  </div>
<div class="param">owner </div><div class="param-desc"><span class="param-type"><a href="#owners">owners</a></span>  </div>
<div class="param">rule </div><div class="param-desc"><span class="param-type"><a href="#update_alert_comment_request_properties_rule">update_alert_comment_request_properties_rule</a></span>  </div>
<div class="param">type </div><div class="param-desc"><span class="param-type"><a href="#string">String</a></span> The type of comment. </div>
        <div class="param-enum-header">Enum:</div>
        <div class="param-enum">user</div>
...
<div class="param">version </div><div class="param-desc"><span class="param-type"><a href="#string">String</a></span> The current comment version. To retrieve version values, use the get comments API. </div>
  ...
  <div class="model">
    <h3><a name="update_alert_comment_request_properties_alertId"><code>update_alert_comment_request_properties_alertId</code> - </a> <a class="up" href="#__Models">Up</a></h3>
  ...
  <div class="model">
    <h3><a name="update_alert_comment_request_properties_index"><code>update_alert_comment_request_properties_index</code> - </a> <a class="up" href="#__Models">Up</a></h3>
  ...
  <div class="model">
    <h3><a name="update_alert_comment_request_properties_rule"><code>update_alert_comment_request_properties_rule</code> - </a> <a class="up" href="#__Models">Up</a></h3>
    <div class='model-description'>The rule that is associated with the alert. It is required only when <code>type</code> is <code>alert</code>. This functionality is in technical preview and may be changed or removed in a future release. Elastic will apply best effort to fix any issues, but features in technical preview are not subject to the support SLA of official GA features.</div>
    <div class="field-items">
      <div class="param">id (optional)</div><div class="param-desc"><span class="param-type"><a href="#string">String</a></span> The rule identifier. </div>
<div class="param">name (optional)</div><div class="param-desc"><span class="param-type"><a href="#string">String</a></span> The rule name. </div>
...
<div class="param">version </div><div class="param-desc"><span class="param-type"><a href="#string">String</a></span> The current comment version. To retrieve version values, use the get comments API. </div>
  ...
  <div class="model">
    <h3><a name="user"><code>user</code> - Add case comment request properties for alerts</a> <a class="up" href="#__Models">Up</a></h3>
    <div class='model-description'></div>
    <div class="field-items">
      <div class="param">owner </div><div class="param-desc"><span class="param-type"><a href="#owners">owners</a></span>  </div>
<div class="param">type </div><div class="param-desc"><span class="param-type"><a href="#string">String</a></span> The type of comment. </div>
  ...
  <div class="model">
    ...
    <div class="field-items">
      <div class="param">action (optional)</div><div class="param-desc"><span class="param-type"><a href="#string">String</a></span>  </div>
        <div class="param-enum-header">Enum:</div>
        <div class="param-enum">add</div><div class="param-enum">create</div><div class="param-enum">delete</div><div class="param-enum">push_to_service</div><div class="param-enum">update</div>

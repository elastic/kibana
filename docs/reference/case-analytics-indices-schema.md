...
This page lists fields that can appear in case analytics indices documents. These fields are used display general data about cases, in addition to data about case comments, attachments, and activity. To learn more about the indices and cases as data feature, refer to 

...
## Connector networking configuration [tavily-connector-networking-configuration]
...
4. Enter the API key in the **API Key** field when configuring the Tavily connector in {{kib}}.

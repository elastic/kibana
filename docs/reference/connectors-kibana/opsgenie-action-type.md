...
Message
:   The message for the alert (required). {{opsgenie}} limits this field to 130 characters. {{kib}} truncates longer values, including values expanded from Mustache templates, instead of failing the action.

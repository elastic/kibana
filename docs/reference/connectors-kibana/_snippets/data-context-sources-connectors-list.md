...
- [Azure DevOps](/reference/connectors-kibana/azure-devops-action-type.md): Search work items, manage repositories and pull requests, and trigger pipelines in Azure DevOps.

...
* [Snowflake](/reference/connectors-kibana/snowflake-action-type.md): Execute SQL, discover databases, schemas, tables and views, and run semantic searches via Cortex Search in Snowflake.

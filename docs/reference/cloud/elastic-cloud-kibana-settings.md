...
## Fleet and integrations [ec-fleet-settings]
...
## Reporting [ec-reporting-settings]
...
## Security Solution [ec-security-solution-settings]

::::{settings} /reference/configuration-reference/security-solution-settings.yml
:deployment: ech
::::

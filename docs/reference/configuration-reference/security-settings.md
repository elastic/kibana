...
:   Specifies the origin(s) where the provider will appear to users in the browser. Each origin must be a valid URI only containing an origin. By default, providers are not restricted to specific origins.

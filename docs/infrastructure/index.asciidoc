...
By default the Infrastructure UI uses the `metricbeat-*` index pattern to query
the data.  If your metrics are located in a different set of indices or use a

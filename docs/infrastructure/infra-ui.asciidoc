...
Use the Infrastructure application in {kib} to monitor your infrastructure and identify problems in real time.
...
The default source configuration for metrics is specified in the {kibana-ref}/infrastructure-ui-settings-kb.html[Infrastructure application settings] in the {kibana-ref}/settings.html[Kibana configuration file].
...
* Select *View Logs* to <<xpack-logs-using, view the logs for that component>> in the *Logs* application.

Depending on the features you have installed and configured, you may also be able to:

* Select *View APM* to <<traces, view APM traces for the selected component>> in the *APM* application.

* Select *View Uptime* to <<uptime-overview, view uptime information for the selected component>> in the *Uptime* application.

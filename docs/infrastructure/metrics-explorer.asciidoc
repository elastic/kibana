...
The metrics explorer gives the user the ability to easily visualize Metricbeat data and group by arbitary attributes. It empowers the user to visualize multiple metrics and can be a jumping off point for further investigations.

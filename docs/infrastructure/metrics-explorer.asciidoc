...
Metrics Explorer in the <<infra-ui, Infrastructure application in Kibana>> allows you to group and visualise multiple customisable metrics for one or more components in a graphical format.
...
* To use *Open in Visualize* you need access to the Visualize application.

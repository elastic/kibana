...
* view actionable information to pin down the root causes in an effective manner (for example, detailed event logs, granular resource usage information, and application traces)
...
// XXXXXX Either a single graphic, or an example, as below, with several graphics
...
// XXXX This may be better as a "getting started with observability" topic.
[float]

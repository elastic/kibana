...
When you select *View Metrics* for a component in your infrastructure from the <<infra-ui, Infrastructure application in Kibana>>, you can view detailed metrics for that component, and for any related components.

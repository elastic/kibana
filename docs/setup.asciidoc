...
include::setup/install.asciidoc[leveloffset=+1]

include::setup/start-stop.asciidoc[leveloffset=+1]

include::setup/settings.asciidoc[leveloffset=+1]

include::setup/docker.asciidoc[leveloffset=+1]

include::setup/access.asciidoc[leveloffset=+1]

include::setup/connect-to-elasticsearch.asciidoc[leveloffset=+1]

include::setup/production.asciidoc[leveloffset=+1]

include::setup/upgrade.asciidoc[leveloffset=+1]

...
* A modern web browser - http://www.elastic.co/subscriptions/matrix#show_browsers[Supported Browsers].
...
. Download the https://www.elastic.co/downloads/kibana[Kibana binary package] for your platform.

...
* <<add-monitor-api, Add a monitor>> - Add a new monitor to Synthetics app.

* <<update-monitor-api, Update a monitor>> - Update an existing monitor in Synthetics app.

* <<delete-monitors-api, Delete a monitor>> - Delete an existing monitor from Synthetics app.

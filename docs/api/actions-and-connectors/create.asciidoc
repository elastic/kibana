...
=====
`apiUrl`::
(Required, string) The {sn-itom} instance URL.

`clientId`::
(Optional^*^, string) The client ID assigned to your OAuth application. This
...
`jwtKeyId`::
(Optional^*^, string) The key identifier assigned to the JWT verifier map of
your OAuth application. This property is required when `isOAuth` is `true`.

`userIdentifierValue`::
(Optional^*^, string) The identifier to use for OAuth authentication. This

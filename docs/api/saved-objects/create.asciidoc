...
`initialNamespaces`::
  (Optional, string array) Identifiers for the <<xpack-spaces,spaces>> in which this object should be created. If this is provided, the
  object will only be created in the explicitly defined spaces. If this is not provided, the object will be created in the current space
  (default behavior).

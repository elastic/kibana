...
=== Copy to Space
++++
<titleabbrev>Copy to Space</titleabbrev>
++++
...
[[saved-objects-api-copy-to-space-request]]
==== {api-request-title}
////
...
////
[[saved-objects-api-copy-to-space-prereqs]]
==== {api-prereq-title}
////
////
...
[[saved-objects-api-copy-to-space-desc]]
...
<<saved-objects-api-resolve-copy-to-space-conflicts, Copy to Space Conflict Resolution API>> to do this on a per-object basis.
...
[[saved-objects-api-copy-to-space-path-params]]
...
//// 
[[saved-objects-api-copy-to-space-params]]
...
[[saved-objects-api-copy-to-space-request-body]]
...
[[saved-objects-api-copy-to-space-response-body]]
...
`<space_id>`::
  ...
  `errors`:::
    ...
    `error`::::
      ...
      `type`:::::
        (string) Indicates the type of error. May be one of: `conflict`, `unsupported_type`, `missing_references`, `unknown`. Errors marked as `conflict` may be resolved by using the <<saved-objects-api-resolve-copy-to-space-conflicts, Copy to Space Conflict Resolution API>>.

//// 
[[saved-objects-api-copy-to-space-response-codes]]
...
[[saved-objects-api-copy-to-space-example]]
==== {api-examples-title}
////

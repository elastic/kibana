...
The import saved objects API enables you to create a set of Kibana saved objects with a file from the _export API.
...
`file`::
  A file exported using the _export API.

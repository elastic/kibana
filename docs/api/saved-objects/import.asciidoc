...
The import saved objects API enables you to create a set of Kibana saved objects from a given file.
...
The call returns a response code of `409` and a response body
containing a JSON structure similar to the following example:

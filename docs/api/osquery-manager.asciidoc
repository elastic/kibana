...
* Live queries
    ...
    ** <<osquery-manager-live-queries-api-create, Create live query API>> to create live query
    ** <<osquery-manager-live-queries-api-get-results, Get live query results API>> to retrieve a single live query results
* Packs

...
NOTE: Creating some rule types may be limited to specific features, in which case they will not be available when <<defining-alerts, defining rules>> within <<management,Stack Management>>.

...
=====
  ...
  `connector_type_id`:::
    (Required, string) The id of the <<action-types,connector type>>.
...
[[rules-update-api-response-codes]]
==== Response code

`200`::
    Indicates a successful call.

[[rules-update-api-example]]
==== Example

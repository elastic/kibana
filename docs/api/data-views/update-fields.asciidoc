...
=== Update data view fields API (deprecated)

[[data-views-fields-api-update-request-deprecated]]
==== Request
...
[[data-views-fields-api-update-path-params-deprecated]]
==== Path parameters
...
[[data-views-fields-api-update-request-body-deprecated]]
==== Request body
...
[[data-views-fields-api-update-errors-codes-deprecated]]
==== Response code

`200`::
Indicates a successful call.

[[data-views-fields-api-update-example-deprecated]]
==== Examples

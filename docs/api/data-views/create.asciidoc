...
To create {data-sources} based on {ref}/xpack-rollup.html[rollup indices] deprecated:[8.11.0,'Rollups are deprecated and will be removed in a future version. Use {ref}/downsampling.html\[downsampling\] instead.'], use the `data_view.type` and `data_view.typeMeta` properties :

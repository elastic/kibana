...
* <<actions-and-connectors-api-create, Create action API>> to create {kib} action
...
* <<actions-and-connectors-api-delete, Delete action API>> to remove {kib} action by ID

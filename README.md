...
| platform |  |
| --- | --- |
| OSX | [tar](https://snapshots.elastic.co/downloads/kibana/kibana-5.6.12-SNAPSHOT-darwin-x86_64.tar.gz) |
| Linux x64 | [tar](https://snapshots.elastic.co/downloads/kibana/kibana-5.6.12-SNAPSHOT-linux-x86_64.tar.gz) [deb](https://snapshots.elastic.co/downloads/kibana/kibana-5.6.12-SNAPSHOT-amd64.deb) [rpm](https://snapshots.elastic.co/downloads/kibana/kibana-5.6.12-SNAPSHOT-x86_64.rpm) |
| Linux x86 | [tar](https://snapshots.elastic.co/downloads/kibana/kibana-5.6.12-SNAPSHOT-linux-x86.tar.gz) [deb](https://snapshots.elastic.co/downloads/kibana/kibana-5.6.12-SNAPSHOT-i386.deb) [rpm](https://snapshots.elastic.co/downloads/kibana/kibana-5.6.12-SNAPSHOT-i686.rpm) |
| Windows | [zip](https://snapshots.elastic.co/downloads/kibana/kibana-5.6.12-SNAPSHOT-windows-x86.zip) |

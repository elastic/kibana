...
- **Don't `Promise.all` Playwright APIs** — parallel waits share one timeout window and amplify backend contention. See `docs/extend/scout/ui-best-practices.md` § "Don't use `Promise.all` with Playwright APIs".

...
- **Oversized specs**: planned Scout files that mix roles/flows, would become worker bottlenecks, or would give a skip a large blast radius. Aim for about a minute per spec and split them in the plan, not after the fact.

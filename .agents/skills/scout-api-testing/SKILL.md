...
- Keep API spec files focused: one endpoint/role + one flow. `@kbn/eslint/scout_max_tests_per_file` warns above 15 tests. Prefer splitting when roles or endpoints diverge rather than growing one contract table.

...
> **Source**: `<FTR directory path>` > **Target module root**: `<Scout module root>` > **Generated**: `<date>` > **Deployment targets**: `<stateful | serverless | both>` > **FTR config chain**: `<config.ts> > <base.config.ts> > ...`

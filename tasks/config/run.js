...
module.exports = function (grunt) {
  ...
  return {
    ...
    functionalTestsReleaseUngrouped: {
      cmd: process.execPath,
      args: [
        'scripts/functional_tests',
        '--grep', '@ciGroup', '--invert',

...
index 9c04035d12e7..cba90dc5baa9 100644
...
index 0caf254d8150..78067e1f5f2f 100644
...
index 6c2a9635909a..c1a07b26b21d 100644
...
index 2b77eded5537..8b34c2665a32 100644
...
@@ -25,7 +25,7 @@ import { loadDashboardApi } from '../dashboard_api/load_dashboard_api';
...
@@ -116,51 +116,48 @@ export function DashboardRenderer({
...
+    return (
+      <div>
+        <EuiButton iconType="plusInCircle" onClick={() => openOneChat({})}>
+          Opens the flyout with no props
+        </EuiButton>
+        <EuiButton
+          iconType="plusInCircle"
+          onClick={() => openOneChat({ newConversation: true, agentId: 'elastic-ai-agent' })}
+        >
+          Starts a new conversation (elastic ai agent)
+        </EuiButton>
+        <EuiButton
+          iconType="plusInCircle"
+          onClick={() =>
...
-        </ExitFullScreenButtonKibanaProvider>
+          Starts a new conversation with initial message (scottish agent)
+        </EuiButton>
       </div>
-    ) : (
-      loadingSpinner
...
index 0c1c389b472b..b2f01d3827c5 100644
...
index 9aed7fffb649..7a1357a99dae 100644

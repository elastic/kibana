...
To NOT include your change in the Release Notes, please use lable`non-issue`. PRs with the following lables won't be included in the Release Notes:
`build`, `docs`, `test`, `non-issue`, `jenkins` and `chore`

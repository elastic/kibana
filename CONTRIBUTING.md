...
- [Contributing to Kibana](#contributing-to-kibana)
  ...
  - [Effective issue reporting in Kibana](#effective-issue-reporting-in-kibana)
    ...
    - ["My issue isn't getting enough attention"](#%22my-issue-isnt-getting-enough-attention%22)
    - ["I want to help!"](#%22i-want-to-help%22)
  ...
  - [Contributing Code](#contributing-code)
    ...
    - [Cross-browser Compatibility](#cross-browser-compatibility)
      - [Testing Compatibility Locally](#testing-compatibility-locally)
        - [Testing IE on OS X](#testing-ie-on-os-x)

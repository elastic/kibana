...
function bdr(color = C.gray3) {
  return { style: BorderStyle.SINGLE, size: 1, color };
}
function bdrs(c = C.gray3) {
  const b = bdr(c);
...
function sp(n = 1) {
  return new Paragraph({ children: [], spacing: { before: 0, after: n * 100 } });
}
function rule() {
  return new Paragraph({
...
function gapCard(id, title, prio, effort, area, files, deps, current, required, criteria) {
  ...
  const metaRow = new TableRow({
    children: [
      ...
      cell([p(statusLabel, { size: 18, bold: true, color: pc.text })], metaCols[1], {
        fill: pc.bg,
        bc: pc.bd,
      }),
    ...
    children: [
      new TableCell({
        ...
        children: [
          new Paragraph({
            children: [
              new TextRun({ text: title, bold: true, size: 22, color: pc.text, font: 'Arial' }),
            ],
          }),
        ],
      }),
        ...
        children: [
          new TableCell({
            ...
            children: [
              new Paragraph({
                children: [
                  new TextRun({ text, bold: true, size: 24, color: C.white, font: 'Arial' }),
                ],
              }),
            ],
          }),
...
const fleetGaps = [
  gapCard(
    ...
    [
      {
        'x-pack/platform/plugins/shared/fleet/common/types/models/epm.ts':
          'KibanaAssetType + KibanaSavedObjectType enums, INSTALL_STATES enum',
      },
    ]
  ),
  gapCard(
  ...
  gapCard(
    ...
    'New',
    'S',
    'Fleet / public  (UI constants + accordion)',
    [
...
const wfGaps = [
  gapCard(
    ...
    'New',
    'M',
    'kbn-workflows  (step definitions)',
  ...
  gapCard(
    ...
    'New',
    'L',
    'kbn-workflows  (concurrency model)',
  ...
  gapCard(
    ...
    'New',
    'S',
    'kbn-connector-specs  (ActionDefinition) + kbn-workflows  (spec docs)',
    [
...
const connGaps = [
  ...
  gapCard(
    ...
    'Done',
    'M',
    'kbn-connector-specs  (.salesforce)',
  ...
  gapCard(
    ...
    'New',
    'S',
    'kbn-connector-specs  (.google_drive)',
  ...
  gapCard(
    ...
    'New',
    'S',
    'kbn-connector-specs  (test infrastructure)',
...
const agentGaps = [
  gapCard(
    ...
    'New',
    'M',
    'Agent Builder  + kbn-agent-builder-common',
    [
...
const keGaps = [
  gapCard(
    ...
    'New',
    'L',
    'Elastic AI Assistant  (plugin setup API)',
    [
  ...
  gapCard(
    ...
    'New',
    'S',
    'AI Assistant  + Fleet packaging spec',
    [
...
const allGapRows = [
  ...
  [
    ...
    'S',
    'Done',
    '[Fleet/EPM] KibanaAssetType.workflow + KibanaSavedObjectType.workflow',
  ],
  [
    'FLEET-002',
    'Done',
    'M',
    'Done',
    '[Fleet/EPM] stepInstallWorkflowAssets — install workflow YAML from package',
  ],
  ...
  [
    ...
    'S',
    'Done',
    '[Fleet/EPM] Register workflowsManagement as optional Fleet plugin dep',
  ],
  ...
  [
    ...
    'M',
    'New',
    '[Fleet/EPM] KibanaAssetType.knowledgeEntry + stepInstallKnowledgeEntries',
  ],
  [
    'FLEET-007',
    'P1',
    'S',
    'New',
    '[Fleet UI] Display workflow/agent/knowledge-entry assets in package detail',
  ],
  [
    'FLEET-008',
    'P2',
    'M',
    'New',
    '[Fleet/EPM] Validate connector ID manifest vars against existing connectors',
  ],
  [
    'FLEET-009',
    'P2',
    'S',
    'New',
    '[Fleet/EPM] Surface workflow YAML validation errors in install response',
  ],
  // Workflows
  ...
  [
    ...
    'S',
    'New',
    '[Connector V2] Document and lint isTool: false ingest-plane contract',
  ],
  [
    'CONN-002',
    'Done',
    'M',
    'Done',
    '[Connector V2] GitHub ingest-plane actions (runQueryTemplate, graphqlQuery, listQueryTemplates)',
  ],
  [
    'CONN-003',
    'Done',
    'M',
    'Done',
    '[Connector V2] Slack ingest-plane actions (listUsers, getChannelHistory, getConversationReplies)',
  ],
  ...
  [
    ...
    'S',
    'New',
    '[Connector V2] Integration test helper for isTool: false actions',
  ],
  // Agent Builder
  [
    'AGENT-001',
    ...
    'M',
    'New',
    '[Agent Builder] YAML package format spec for Fleet-installable agents',
  ],
  [
    'AGENT-002',
    'P2',
    'M',
    'New',
    '[Agent Builder] Index pattern scoping for Fleet-installed agents',
  ],
  ...
  sections: [
    {
        ...
        default: new Header({
          children: [
            new Paragraph({
              ...
              children: [
                new TextRun({
                  text: 'SDLC Intel Fleet Package  —  Platform Gaps & Requirements',
                  bold: true,
                  size: 18,
                  font: 'Arial',
                  color: C.navy,
                ...
                new TextRun({
                  text: '   |   Generic Platform Capabilities Only',
                  size: 18,
                  font: 'Arial',
                  color: C.gray4,
                }),
        ...
        default: new Footer({
          children: [
            new Paragraph({
              ...
              children: [
                new TextRun({
                  text: 'Elastic  •  Confidential  •  Page ',
                  size: 16,
                  font: 'Arial',
                  color: C.gray4,
                }),
      ...
      children: [
        ...
        new Paragraph({
          children: [
            new TextRun({
              text: 'Platform Gaps & Requirements',
              bold: true,
              size: 72,
              font: 'Arial',
              color: C.navy,
        ...
        new Paragraph({
          children: [
            new TextRun({
              text: 'For shipping the SDLC Intel integration as a Fleet package',
              size: 38,
              font: 'Arial',
              color: C.blue,
            }),
        ...
        new Paragraph({
          children: [
            new TextRun({
              text: 'Generic Kibana platform capabilities only  —  no SDLC-specific content',
              size: 26,
              font: 'Arial',
              color: C.gray4,
              italics: true,
            ...
            new TableRow({
              children: [
                new TableCell({
                  ...
                  children: [
                    p(
                      'This document catalogues every generic platform capability required to install, manage, and operate the SDLC Intel Fleet integration package. Each entry maps directly to one GitHub issue or pull request. SDLC-specific content (workflows, agents, dashboards, index templates shipped inside the package) is out of scope — this document covers only what the Kibana platform itself must provide.',
                      { size: 22 }
                    ),
                  ],
                }),
        ...
        new Table({
          width: { size: CW, type: WidthType.DXA },
          columnWidths: [2400, 2400, 2400, 2880],
          rows: [
            new TableRow({
              children: [
                cell(
                  [
                    p('Version', { size: 17, bold: true, color: C.gray4 }),
                    p('0.1.0  (sdlc-poc branch)', { size: 19 }),
                  ],
                  2400
                ),
                cell(
                  [
                    p('Author', { size: 17, bold: true, color: C.gray4 }),
                    p('Yuliia Naumenko  /  Elastic', { size: 19 }),
                  ],
                  2400
                ),
                cell(
                  [
                    p('Date', { size: 17, bold: true, color: C.gray4 }),
                    p('June 2026', { size: 19 }),
                  ],
                  2400
                ),
                cell(
                  [
                    p('Total gaps', { size: 17, bold: true, color: C.gray4 }),
                    p('26  (11 Done in sdlc-poc  /  15 New)', { size: 19 }),
                  ],
                  2880
                ),
              ],
        ...
        p(
          'This document covers generic Kibana platform capabilities. A capability is "generic" if it could benefit any Fleet integration package, not only sdlc_intel. Each gap describes what the platform must provide so that package authors can ship workflows, agents, and knowledge entries without modifying shared platform code themselves.'
        ),
        sp(1),
        p('Components in scope:'),
        bullet(
          'Fleet / EPM — asset type registration, install steps, uninstall, UI display, manifest var validation'
        ),
        bullet(
          'Kibana Workflows (kbn-workflows) — built-in step types, concurrency model, execution querying'
        ),
        bullet(
          'Connector V2 (kbn-connector-specs) — isTool contract, ingest-plane actions for GitHub / Slack / Salesforce / Google Drive'
        ),
        bullet(
          'Agent Builder — Fleet-installable agent YAML format, index pattern scoping, tool allowlist'
        ),
        bullet('AI Assistant Knowledge — programmatic create/delete API, Fleet package format'),
        sp(1),
        h2('1.2 What is out of scope'),
        bullet(
          'SDLC-specific content: the 29 workflow YAMLs, 6 agent YAMLs, 25 index templates, 7 dashboards — these live inside the Fleet package, not the platform.'
        ),
        bullet(
          'Infrastructure: Elasticsearch cluster sizing, ILM policy values, Kibana memory tuning.'
        ),
        ...
        new Table({
          ...
          rows: [
            ...[
              ...
              [
                'Priority',
                'P0 = blocker (nothing works without it)  •  P1 = required for GA  •  P2 = important but workaroundable  •  P3 = nice to have  •  Done = already implemented in sdlc-poc branch, pending productionization',
              ],
        ...
        new Table({
          ...
          rows: [
            ...[
              [
                'P0',
                'Blocker. Without this, the Fleet package cannot install at all. No workaround exists.',
              ],
              [
                'P1',
                'Required for GA release of sdlc_intel package. Must be merged before the integration ships.',
              ],
              [
                'P2',
                'Important for a complete experience. Can ship with a workaround but should be resolved in the same release cycle.',
              ],
              ['P3', 'Quality-of-life improvement. Can be deferred to a follow-up release.'],
              [
                'Done',
                'Already implemented in the sdlc-poc branch. Needs code review, tests, and merge to platform main. No new design work required.',
              ],
            ].map(([prio, desc]) => {
              const pc = PRIO_COLORS[prio] || {};
              return new TableRow({
                children: [
                  cell([p(prio, { size: 18, bold: true, color: pc.text || C.black })], 900, {
                    fill: pc.bg,
                  }),
        ...
        p(
          'All 26 gaps across five components. "Done" items exist in the sdlc-poc branch and require review + merge. "New" items require implementation.'
        ),
        sp(1),
        ...
        h1('3. Fleet / EPM'),
        p(
          "Fleet's Extensible Package Manager (EPM) is responsible for installing, upgrading, and removing integration packages. The gaps in this section enable Fleet to manage three new Kibana asset types: workflow, agent, and knowledge_entry."
        ),
        sp(1),
        ...
        bullet(
          'Add a CREATE_X_ASSETS state to the install state machine (_state_machine_package_install.ts).'
        ),
        bullet(
          'Implement stepInstallXAssets: traverse kibana/x/ entries in the package zip, substitute REPLACE_WITH_* placeholders from policy vars, upsert via the relevant plugin API (workflowsManagement / agentBuilderManagement / aiAssistantManagement). Graceful skip when plugin unavailable.'
        ),
        bullet(
          'Handle deletion in remove.ts: separate X-typed asset refs, call plugin delete API.'
        ),
        ...
        p(
          'The kbn-workflows package defines the YAML spec for Kibana Workflow automations. The gaps here add new built-in step types needed by ingest workflows, stabilize async execution, and improve operational observability.'
        ),
        sp(1),
        ...
        p(
          'Connector V2 exposes external service integrations to both AI agents (isTool: true) and workflow automation (isTool: false). The ingest plane — isTool: false actions with watermark and pagination support — is the foundation of the entire data pipeline. Several ingest-plane actions are already implemented in the sdlc-poc branch; the remaining gaps are a new Google Drive action, contract formalization, and test infrastructure.'
        ),
        sp(1),
        ...
        p(
          'The Elastic AI Assistant has a knowledge base that can be populated with domain-specific content. Shipping knowledge entries as part of a Fleet package requires a programmatic plugin API and a defined file format. Both are new capabilities with no existing implementation.'
        ),
        sp(1),
        ...
        h1('8. Dependency Map'),
        p(
          'Implement in this order to avoid blocked work. Each row must complete before its dependents can start.'
        ),
        sp(1),
        new Table({
          width: { size: CW, type: WidthType.DXA },
          columnWidths: [2000, 3200, 4880],
          rows: [
            new TableRow({
              children: [hcell('Gap', 2000), hcell('Blocks', 3200), hcell('Notes', 4880)],
              tableHeader: true,
            }),
            ...[
              [
                'FLEET-001 (Done)',
                'FLEET-002, FLEET-003, FLEET-005, FLEET-007',
                'Foundation. KibanaAssetType enum change unlocks all install steps.',
              ],
              [
                'FLEET-004 (Done)',
                'FLEET-002',
                'Plugin wiring must land before install step can call workflowsManagement.',
              ],
              [
                'FLEET-002 (Done)',
                'FLEET-003, FLEET-009',
                'Install step needed before uninstall cleanup and error surfacing.',
              ],
              [
                'FLEET-005 (Done)',
                'FLEET-007, AGENT-001',
                'Agent install step needed before UI display and YAML format spec.',
              ],
              [
                'FLEET-006 (New)',
                'KE-001, KE-002, FLEET-007',
                'Knowledge entry asset type needed before install step and UI.',
              ],
              [
                'KE-001 (New)',
                'FLEET-006',
                'Plugin API needed before Fleet install step can call it.',
              ],
              [
                'CONN-001 (New)',
                'CONN-005, WF-006',
                'isTool contract formalization should precede new ingest actions and backoff docs.',
              ],
              [
                'AGENT-001 (New)',
                'AGENT-002, AGENT-003',
                'YAML format spec needed before scoping and allowlist can be defined.',
              ],
              [
                'WF-001 (New)',
                '—',
                'Independent. checkpoint step simplifies all ingest workflows.',
              ],
              [
                'WF-002 (New)',
                '—',
                'Independent. data.extract step needed by feedback-loop enrichment workflows.',
              ],
              [
                'WF-003 (New)',
                '—',
                'Independent. Stabilizes executeAsync for Tier 5 agentic flows.',
              ],
            ].map(
              ([gap, blocks, notes]) =>
                new TableRow({
        ...
        new Table({
          width: { size: CW, type: WidthType.DXA },
          columnWidths: [2000, 4000, 4080],
          rows: [
            new TableRow({
              children: [hcell('Milestone', 2000), hcell('Gaps', 4000), hcell('Outcome', 4080)],
              tableHeader: true,
            }),
            ...[
              [
                'M1 — Merge Done',
                'FLEET-001, 002, 003, 004, 005\nCONN-002, 003, 004',
                'All sdlc-poc work reviewed and merged to platform main. Workflows and agents install via Fleet.',
              ],
              [
                'M2 — Knowledge',
                'KE-001, KE-002\nFLEET-006\nFLEET-007 (all three types)',
                'Knowledge entries install via Fleet. All three new asset types visible in Fleet UI.',
              ],
              [
                'M3 — Contracts',
                'CONN-001, CONN-005\nWF-006\nAGENT-001',
                'isTool: false contract documented and linted. Google Drive ingest action. Agent YAML format spec.',
              ],
              [
                'M4 — Workflow DX',
                'WF-001, WF-002, WF-003, WF-004',
                'checkpoint and data.extract steps. executeAsync GA. Package-name indexed on runs.',
              ],
              [
                'M5 — Quality',
                'FLEET-008, FLEET-009\nCONN-006\nAGENT-002, AGENT-003\nWF-005',
                'Connector ID validation, YAML error surfacing, test helpers, agent scoping, queue concurrency.',
              ],
            ].map(
              ([m, gaps, outcome]) =>
                new TableRow({
        ...
        p(
          'Use this template when creating GitHub issues from each gap card. The gap ID becomes the issue label for cross-referencing.'
        ),
        sp(1),
        new Table({
          width: { size: CW, type: WidthType.DXA },
        ...
        p(
          [
            new TextRun({
              text: 'Platform Gaps & Requirements  •  SDLC Intel Fleet Package  •  v0.1.0  •  June 2026  •  Elastic Security AI Dev Accelerators',
              font: 'Arial',
              size: 16,
              color: C.gray4,
              italics: true,

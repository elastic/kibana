...
`kibanaVersion` - [Optional] If your plugin is only compatible with a specific version of Kibana, put it here. Note that internal, first-party plugins shouldn't use this, as they are expected to be compatible with every Kibana version as it's bumped.
...
`owner` - [Required] Help users of your plugin know who manages this plugin and how to get in touch. This is required for internal plugins.

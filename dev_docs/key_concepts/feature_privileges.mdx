...
slug: /kibana-dev-docs/designing-feature-privileges
title: Control access to your plugin using Feature Privlieges
...
![Screen of example plugin](../assets/feature_privileges_example_plugin.png?raw=true)

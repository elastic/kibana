...
`KibanaRouteOptions` provides a security configuration at the route definition level.
It provides robust security configurations for both **Classic** and **Versioned** routes.
...
**Example1: All Privileges Required**

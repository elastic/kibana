---
navigation_title: "How to register a new advanced setting"
...
There are several ways to configure an advanced setting:
 - [Through the Advanced Settings UI](./how-to-register-a-new-advanced-setting.md#configuration-with-advanced-settings-ui)
 - [Locked via `kibana.yml`](./how-to-register-a-new-advanced-setting.md#configuration-with-ui-settings-overrides)
 - [Through the client-side `uiSettings` service](./how-to-register-a-new-advanced-setting.md#client-side-usage)
 - [Through the server-side `uiSettings` service](./how-to-register-a-new-advanced-setting.md#server-side-usage)

`uiSettings` are registered synchronously during `core`'s setup lifecycle phase. This means that once you add a new advanced setting, you cannot change or remove it without [registering a migration in core](./how-to-register-a-new-advanced-setting.md#registering-migrations).

...
Every file in here is auto-generated by the [API Docs system](../api_welcome.md) and used to render our API documentation. If you edit a public plugin or package API and run `node scripts/build_api_docs` you will see files changed in this folder. Do not edit the contents of this folder directly!
...
We used to write RFCs in `md` format and keep them in the repository, but we have since moved to Google Docs. We kept the folder around, since some folks still read these old docs. If you are an internal contributor you can visit [this document](#ktRFCProcess) to read about our current RFC process.
...
### [x-pack/platform/test](https://github.com/elastic/kibana/tree/main/x-pack/platform/test)

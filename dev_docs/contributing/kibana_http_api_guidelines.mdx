...
<DocCallOut title="Do not break clients!">
  ...
  Linus Torvalds famously said about Kernel development: "WE DO NOT BREAK USERSPACE!" (along with some other expletives). We should adopt this kind of rigor when working with our _public_ HTTP APIs and always proiritise finding ways to avoid breaking our APIs.
</DocCallOut>

...
User authentication is handled globally for all routes but as an API desiginer you still need make some decisions about the appropriate authentication and authorization for your API. This depends on the actions your API performs.

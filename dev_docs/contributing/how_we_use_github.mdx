...
- `backport:prev-minor`: Automatically backport to one branch/version back from main.
- `backport:prev-major`: Automatically backport to whichever branch contains the next patch version of the previous major release.
- `backport:all-open`: Automatically backport to all open branches/versions. This is functionally equivalent to backport:prev-major at the time of writing.

...
- `release highlight`: The PR is included in the release highlights
- `release_note:breaking`: A breaking change
- `release_note:deprecation`: Deprecates a feature
- `release_note:enhancement`: An enhancement
- `release_note:feature`: The PR is included in the condensed release notes
- `release_note:fix`: A fix
- `release_node:plugin_api_changes`: A change to a plugin API

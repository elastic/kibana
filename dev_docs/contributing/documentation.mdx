...
[api_doc_suite.test.ts](https://github.com/elastic/kibana/blob/main/src/ops/kbn-docs-utils/src/api_docs/tests/api_doc_suite.test.ts) is a pretty comprehensive test suite that builds the test docs inside the [**fixtures** folder](https://github.com/elastic/kibana/tree/main/src/ops/kbn-docs-utils/src/api_docs/tests/__fixtures__/src).

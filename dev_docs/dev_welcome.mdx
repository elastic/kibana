...
Get started by <DocLink id="kibDevTutorialSetupDevEnv" text="setting up your development environment"/> and writing a simple <DocLink id="kibHelloWorldApp" text="Hello World plugin"/>. Then work your way into more advanced concepts and tutorials.

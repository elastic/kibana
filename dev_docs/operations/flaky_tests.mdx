...
Identifying when tests are flaky enough that they should be skipped is the responsibility of members of the Operations team. When making that decision we consider a few different criteria:

### flaky criteria: age of the test
...
### flaky criteria: frequency of failures
...
### flaky criteria: the owning teams ability to fix the flakiness

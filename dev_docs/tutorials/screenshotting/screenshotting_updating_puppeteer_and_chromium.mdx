...
- Install the current version by running `yarn add puppeteer@23.3.1` if we assume for the sake of this guide that the latest version is `23.3.1`. Run `pnpm kbn bootstrap` after installing.

---
navigation_title: "Updating Puppeteer and Chromium"
...
We build a custom headless chromium variant for Linux on a GCP VM. Before starting this, ensure you have all the required pre-requisites.

---
id: kibDevTutorialSetupDevWindowsWSL
slug: /kibana-dev-docs/tutorial/setup-dev-windows-wsl
title: Development on Windows with WSL
summary: Learn how to setup a development environment on Windows using WSL
date: 2022-06-16
tags: ['kibana', 'onboarding', 'dev', 'windows', 'setup', 'wsl']
---

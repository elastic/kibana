...
[test loader](https://github.com/elastic/kibana/blob/master/test/api_integration/apis/index.js). More about the existing FTR setup in the
...
By following the [renderApp](https://github.com/elastic/kibana/blob/master/CONVENTIONS.md#applications) convention, you can greatly reduce the amount of logic in your application's mount function. This makes testing your application's actual rendering logic easier.

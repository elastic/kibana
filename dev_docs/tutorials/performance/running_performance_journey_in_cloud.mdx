...
If you would like to report APM metrics to a different cluster, make sure to change `secret_token` and `server_url` values.
...
"user_settings_override_json": {
  ...
  "tracing.apm.agent.server_url": "https://kibana-ops-e2e-perf.apm.us-central1.gcp.cloud.es.io:443",
...
"user_settings_override_json": {
  ...
  "elastic.apm.secretToken": "CTs9y3cvcfq13bQqsB",
  "elastic.apm.serverUrl": "https://kibana-ops-e2e-perf.apm.us-central1.gcp.cloud.es.io:443",

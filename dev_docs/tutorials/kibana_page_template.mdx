...
![Screenshot of Stack Management empty state with a provided solution navigation.](../assets/kibana_template_solution_nav.png)

![Screenshots of Stack Management page in mobile view. One with the menu closed, one with it open.](../assets/kibana_template_solution_nav_mobile.png)
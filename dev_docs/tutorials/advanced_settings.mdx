...
For all current advanced settings migrations see: `src/core/packages/ui-settings/server-internal/src/saved_objects/migrations.ts`
...
See `src/core/packages/ui-settings/server-internal/src/saved_objects/transforms.ts` and [#13339](https://github.com/elastic/kibana/pull/133339) for an example.

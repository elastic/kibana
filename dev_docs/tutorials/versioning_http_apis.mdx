...
Public APIs can in one of the following statuses: `experimental`, `beta` or `stable`. This can be configured when creating the route using the router interface:

...
Reporting performance events are easy as it can be seen below, however it's highly suggested to follow guidelines for what to report in certain fields:

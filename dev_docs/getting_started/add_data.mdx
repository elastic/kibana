...
Kibana ships with sample data that you can install at the click of the button. If you are building a feature and need some data to test it out with, sample data is a great option. The only limitation is that this data will not work for SIEM or Observability apps (see [#62962](https://github.com/elastic/kibana/issues/62962)).

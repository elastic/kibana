...
If you already have Yarn installed, make sure its version is 1.22.19 or newer. Versions 2+ of Yarn are incompatible with this project.

In order to set your previously installed Yarn to a compatible version (for example 1.22.19) run
```sh

...
<DocCallOut title="A note about Windows">
  ...
  Please check our <DocLink id="kibDevTutorialSetupWindowsDevWSL" text="tutorial"/> to know how to setup the environment and then follow the rest of this guide inside the *WSL* environment.
</DocCallOut>

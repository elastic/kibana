...
<DocRelatedArticles
  ...
  items={[
    ...
    },
    {
      ...
      description: 'Solution-focused side navigation guidelines and API',
      href: 'https://github.com/elastic/kibana/blob/main/src/platform/kbn-ui/side-navigation/README.md',
    },
    {

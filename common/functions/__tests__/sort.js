...
describe('sort', () => {
  ...
  it('returns a datatable sorted by a specified column in asc order', () => {
    const result = fn(testTable, { _: 'price', reverse: false });
  ...
  describe('args', () => {
    describe('_', () => {
      it('sorts on a specified column', () => {
        const result = fn(testTable, { _: 'quantity', reverse: true });
